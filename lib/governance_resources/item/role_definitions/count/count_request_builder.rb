...
module MicrosoftGraphBeta::GovernanceResources::Item::RoleDefinitions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleDefinitions/$count{?%24search,%24filter}"
