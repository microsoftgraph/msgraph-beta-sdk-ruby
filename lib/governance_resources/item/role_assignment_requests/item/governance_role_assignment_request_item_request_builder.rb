...
module MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item
    ...
    class GovernanceRoleAssignmentRequestItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item::MicrosoftGraphCancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRequest method.
        def microsoft_graph_update_request()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item::MicrosoftGraphUpdateRequest::UpdateRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
