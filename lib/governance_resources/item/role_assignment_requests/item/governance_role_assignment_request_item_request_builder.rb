                ...
                module Item
                    ...
                    class GovernanceRoleAssignmentRequestItemRequestBuilder
                        ...
                        def microsoft_graph_cancel()
                            return MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the updateRequest method.
                        def microsoft_graph_update_request()
                            return MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item::MicrosoftGraphUpdateRequest::MicrosoftGraphUpdateRequestRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
