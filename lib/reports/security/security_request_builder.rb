...
module MicrosoftGraphBeta::Reports::Security
    ...
    class SecurityRequestBuilder
        ...
        def microsoft_graph_get_attack_simulation_repeat_offenders()
            return MicrosoftGraphBeta::Reports::Security::MicrosoftGraphGetAttackSimulationRepeatOffenders::GetAttackSimulationRepeatOffendersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAttackSimulationSimulationUserCoverage method.
        def microsoft_graph_get_attack_simulation_simulation_user_coverage()
            return MicrosoftGraphBeta::Reports::Security::MicrosoftGraphGetAttackSimulationSimulationUserCoverage::GetAttackSimulationSimulationUserCoverageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAttackSimulationTrainingUserCoverage method.
        def microsoft_graph_get_attack_simulation_training_user_coverage()
            return MicrosoftGraphBeta::Reports::Security::MicrosoftGraphGetAttackSimulationTrainingUserCoverage::GetAttackSimulationTrainingUserCoverageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
