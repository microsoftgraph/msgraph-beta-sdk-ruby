        ...
        module Security
            ...
            class SecurityRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def get_attack_simulation_repeat_offenders()
                    return MicrosoftGraphBeta::Reports::Security::GetAttackSimulationRepeatOffenders::GetAttackSimulationRepeatOffendersRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getAttackSimulationSimulationUserCoverage method.
                def get_attack_simulation_simulation_user_coverage()
                    return MicrosoftGraphBeta::Reports::Security::GetAttackSimulationSimulationUserCoverage::GetAttackSimulationSimulationUserCoverageRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getAttackSimulationTrainingUserCoverage method.
                def get_attack_simulation_training_user_coverage()
                    return MicrosoftGraphBeta::Reports::Security::GetAttackSimulationTrainingUserCoverage::GetAttackSimulationTrainingUserCoverageRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
