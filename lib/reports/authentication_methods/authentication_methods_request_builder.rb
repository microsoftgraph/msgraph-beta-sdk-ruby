        ...
        module AuthenticationMethods
            ...
            class AuthenticationMethodsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def users_registered_by_feature()
                    return MicrosoftGraphBeta::Reports::AuthenticationMethods::UsersRegisteredByFeature::UsersRegisteredByFeatureRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the usersRegisteredByMethod method.
                def users_registered_by_method()
                    return MicrosoftGraphBeta::Reports::AuthenticationMethods::UsersRegisteredByMethod::UsersRegisteredByMethodRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
