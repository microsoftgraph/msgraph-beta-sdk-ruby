...
module MicrosoftGraphBeta::Reports::AuthenticationMethods
    ...
    class AuthenticationMethodsRequestBuilder
        ...
        def microsoft_graph_users_registered_by_feature()
            return MicrosoftGraphBeta::Reports::AuthenticationMethods::MicrosoftGraphUsersRegisteredByFeature::MicrosoftGraphUsersRegisteredByFeatureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the usersRegisteredByMethod method.
        def microsoft_graph_users_registered_by_method()
            return MicrosoftGraphBeta::Reports::AuthenticationMethods::MicrosoftGraphUsersRegisteredByMethod::MicrosoftGraphUsersRegisteredByMethodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
