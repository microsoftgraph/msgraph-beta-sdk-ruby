...
require_relative './mfa_telecom_fraud/mfa_telecom_fraud_request_builder'
            ...
            module Daily
                ...
                class DailyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def mfa_telecom_fraud()
                        return MicrosoftGraphBeta::Reports::UserInsights::Daily::MfaTelecomFraud::MfaTelecomFraudRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/reports/userInsights/daily{?%24expand,%24select}")
                    end
                    ## 
