...
require_relative './mfa_registered_users/mfa_registered_users_request_builder'
        ...
        module UserInsights
            module Monthly
                ...
                class MonthlyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def mfa_registered_users()
                        return MicrosoftGraphBeta::Reports::UserInsights::Monthly::MfaRegisteredUsers::MfaRegisteredUsersRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
