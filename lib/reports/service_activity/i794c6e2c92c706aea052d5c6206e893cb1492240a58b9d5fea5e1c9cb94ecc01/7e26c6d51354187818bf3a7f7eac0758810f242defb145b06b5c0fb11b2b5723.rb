...
require_relative './i794c6e2c92c706aea052d5c6206e893cb1492240a58b9d5fea5e1c9cb94ecc01'

module MicrosoftGraphBeta
    module Reports
        module ServiceActivity
            module I794c6e2c92c706aea052d5c6206e893cb1492240a58b9d5fea5e1c9cb94ecc01
                ## 
                # Provides operations to call the getActiveUserMetricsForOutlookWebByAppOpening method.
                class GetActiveUserMetricsForOutlookWebByAppOpeningWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a Fiber of get_active_user_metrics_for_outlook_web_by_app_opening_with_inclusive_interval_start_date_time_with_exclusive_interval_end_date_time_with_aggregation_interval_in_minutes_get_response
                    ## 
                    ...
                    def with_url(raw_url)
                        ...
                        return GetActiveUserMetricsForOutlookWebByAppOpeningWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder.new(raw_url, @request_adapter)
                    end
