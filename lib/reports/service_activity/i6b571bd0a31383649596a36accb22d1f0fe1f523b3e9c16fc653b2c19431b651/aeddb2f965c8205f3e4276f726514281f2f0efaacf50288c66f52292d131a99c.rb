...
require_relative './i6b571bd0a31383649596a36accb22d1f0fe1f523b3e9c16fc653b2c19431b651'

module MicrosoftGraphBeta
    module Reports
        module ServiceActivity
            module I6b571bd0a31383649596a36accb22d1f0fe1f523b3e9c16fc653b2c19431b651
                ## 
                # Provides operations to call the getActiveUserMetricsForEmailByModernAuthentication method.
                class GetActiveUserMetricsForEmailByModernAuthenticationWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a Fiber of get_active_user_metrics_for_email_by_modern_authentication_with_inclusive_interval_start_date_time_with_exclusive_interval_end_date_time_with_aggregation_interval_in_minutes_get_response
                    ## 
                    ...
                    def with_url(raw_url)
                        ...
                        return GetActiveUserMetricsForEmailByModernAuthenticationWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder.new(raw_url, @request_adapter)
                    end
