...
require_relative './idb52a6d75250f5dac1ad06fde5deaa2e1a338b3a602ebf0fe493463cab130958'

module MicrosoftGraphBeta
    module Reports
        module ServiceActivity
            module Idb52a6d75250f5dac1ad06fde5deaa2e1a338b3a602ebf0fe493463cab130958
                ## 
                # Provides operations to call the getActiveUserMetricsForOneNoteWeb method.
                class GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a Fiber of get_active_user_metrics_for_one_note_web_with_inclusive_interval_start_date_time_with_exclusive_interval_end_date_time_with_aggregation_interval_in_minutes_get_response
                    ## 
                    ...
                    def with_url(raw_url)
                        ...
                        return GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder.new(raw_url, @request_adapter)
                    end
