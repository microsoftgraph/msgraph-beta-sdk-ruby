    ...
    module Reports
        module ServiceActivity
            module Ibe61b996d150efb59b2001f2607c7c27457db7c78b97cbae9a7182ace9ed1d16
                ...
                class GetActiveUserMetricsForExcelWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a Fiber of get_active_user_metrics_for_excel_web_with_inclusive_interval_start_date_time_with_exclusive_interval_end_date_time_with_aggregation_interval_in_minutes_get_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Reports::ServiceActivity::Ibe61b996d150efb59b2001f2607c7c27457db7c78b97cbae9a7182ace9ed1d16::GetActiveUserMetricsForExcelWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Get all the active usage based on the number of active users who open or save Excel for the web.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ...
                    def with_url(raw_url)
                        ...
                        return GetActiveUserMetricsForExcelWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder.new(raw_url, @request_adapter)
                    end
