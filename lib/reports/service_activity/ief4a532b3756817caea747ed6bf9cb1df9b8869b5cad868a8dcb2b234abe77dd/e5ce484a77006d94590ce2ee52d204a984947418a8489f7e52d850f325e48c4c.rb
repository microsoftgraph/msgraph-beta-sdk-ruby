...
require_relative './ief4a532b3756817caea747ed6bf9cb1df9b8869b5cad868a8dcb2b234abe77dd'

module MicrosoftGraphBeta
    module Reports
        module ServiceActivity
            module Ief4a532b3756817caea747ed6bf9cb1df9b8869b5cad868a8dcb2b234abe77dd
                ## 
                # Provides operations to call the getActiveUserMetricsForVisioWeb method.
                class GetActiveUserMetricsForVisioWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a Fiber of get_active_user_metrics_for_visio_web_with_inclusive_interval_start_date_time_with_exclusive_interval_end_date_time_with_aggregation_interval_in_minutes_get_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Reports::ServiceActivity::Ief4a532b3756817caea747ed6bf9cb1df9b8869b5cad868a8dcb2b234abe77dd::GetActiveUserMetricsForVisioWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Get all the active usage based on the number of active users who open or save Visio for the web.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ...
                    def with_url(raw_url)
                        ...
                        return GetActiveUserMetricsForVisioWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder.new(raw_url, @request_adapter)
                    end
