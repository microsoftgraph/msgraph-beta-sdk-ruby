        ...
        module GetFormsUserActivityUserDetailWithDate
            ...
            class GetFormsUserActivityUserDetailWithDateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, date=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getFormsUserActivityUserDetail(date={date})")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetFormsUserActivityUserDetailWithDateRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
