...
module MicrosoftGraphBeta::Reports::DailyPrintUsageSummariesByUser::Item
    ## 
    ...
    class PrintUsageByUserItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, print_usage_by_user_id=nil)
            ...
            @url_template = "{+baseurl}/reports/dailyPrintUsageSummariesByUser/{printUsageByUser%2Did}{?%24select,%24expand}"
