...
module MicrosoftGraphBeta
    module Reports
        module GetOffice365ActiveUserCountsWithPeriod
            class GetOffice365ActiveUserCountsWithPeriodGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                ...
                ## @return a get_office365_active_user_counts_with_period_get_response
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return GetOffice365ActiveUserCountsWithPeriodGetResponse.new
                end
                ## 
