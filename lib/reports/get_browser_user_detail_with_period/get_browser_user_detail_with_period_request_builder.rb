...
require_relative './get_browser_user_detail_with_period'

module MicrosoftGraphBeta
    module Reports
        module GetBrowserUserDetailWithPeriod
            ## 
            # Provides operations to call the getBrowserUserDetail method.
            class GetBrowserUserDetailWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getBrowserUserDetail(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetBrowserUserDetailWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
