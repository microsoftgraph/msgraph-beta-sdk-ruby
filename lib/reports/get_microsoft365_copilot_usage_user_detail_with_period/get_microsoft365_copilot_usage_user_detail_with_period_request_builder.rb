...
require_relative './get_microsoft365_copilot_usage_user_detail_with_period'

module MicrosoftGraphBeta
    module Reports
        module GetMicrosoft365CopilotUsageUserDetailWithPeriod
            ## 
            # Provides operations to call the getMicrosoft365CopilotUsageUserDetail method.
            class GetMicrosoft365CopilotUsageUserDetailWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getMicrosoft365CopilotUsageUserDetail(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetMicrosoft365CopilotUsageUserDetailWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
