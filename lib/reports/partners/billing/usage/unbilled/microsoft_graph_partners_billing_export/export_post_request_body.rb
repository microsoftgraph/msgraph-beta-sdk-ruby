                        ...
                        module MicrosoftGraphPartnersBillingExport
                            class ExportPostRequestBody
                                ...
                                def get_field_deserializers()
                                    return {
                                        "attributeSet" => lambda {|n| @attribute_set = n.get_enum_value(MicrosoftGraphBeta::Models::.models.partners.billingAttributeSet) },
                                        "billingPeriod" => lambda {|n| @billing_period = n.get_enum_value(MicrosoftGraphBeta::Models::.models.partners.billingBillingPeriod) },
