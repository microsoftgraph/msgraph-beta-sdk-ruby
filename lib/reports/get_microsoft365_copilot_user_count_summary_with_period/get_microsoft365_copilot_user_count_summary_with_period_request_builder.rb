...
require_relative './get_microsoft365_copilot_user_count_summary_with_period'

module MicrosoftGraphBeta
    module Reports
        module GetMicrosoft365CopilotUserCountSummaryWithPeriod
            ## 
            # Provides operations to call the getMicrosoft365CopilotUserCountSummary method.
            class GetMicrosoft365CopilotUserCountSummaryWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getMicrosoft365CopilotUserCountSummary(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetMicrosoft365CopilotUserCountSummaryWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
