...
require_relative './get_teams_device_usage_distribution_total_user_counts_with_period'

module MicrosoftGraphBeta
    module Reports
        module GetTeamsDeviceUsageDistributionTotalUserCountsWithPeriod
            ## 
            # Provides operations to call the getTeamsDeviceUsageDistributionTotalUserCounts method.
            class GetTeamsDeviceUsageDistributionTotalUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getTeamsDeviceUsageDistributionTotalUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetTeamsDeviceUsageDistributionTotalUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
