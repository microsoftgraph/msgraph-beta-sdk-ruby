        ...
        module GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTime
            ...
            class GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTimeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Reports::GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTime::GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTimeGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Get a list of archived print jobs that were queued for particular printer.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
