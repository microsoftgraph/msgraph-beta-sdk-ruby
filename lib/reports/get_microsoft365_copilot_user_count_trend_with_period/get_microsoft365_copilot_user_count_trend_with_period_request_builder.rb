...
require_relative './get_microsoft365_copilot_user_count_trend_with_period'

module MicrosoftGraphBeta
    module Reports
        module GetMicrosoft365CopilotUserCountTrendWithPeriod
            ## 
            # Provides operations to call the getMicrosoft365CopilotUserCountTrend method.
            class GetMicrosoft365CopilotUserCountTrendWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getMicrosoft365CopilotUserCountTrend(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetMicrosoft365CopilotUserCountTrendWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
