...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::LegalHolds::Item::UnifiedGroupSources::Item
    ## 
    ...
    class UnifiedGroupSourceItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, unified_group_source_id=nil)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/unifiedGroupSources/{unifiedGroupSource%2Did}{?%24select,%24expand}"
