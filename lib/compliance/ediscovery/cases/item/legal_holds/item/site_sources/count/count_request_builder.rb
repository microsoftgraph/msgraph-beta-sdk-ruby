...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::LegalHolds::Item::SiteSources::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/siteSources/$count{?%24search,%24filter}"
