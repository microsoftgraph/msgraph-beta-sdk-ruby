...
require_relative '../../../../../models/ediscovery/legal_hold_collection_response'
                ...
                module Item
                    module LegalHolds
                        ...
                        class LegalHoldsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            ## 
                            ## Provides operations to manage the legalHolds property of the microsoft.graph.ediscovery.case entity.
                            ## @param legal_hold_id Unique identifier of the item
                            ...
                            ## @return a Fiber of legal_hold_collection_response
                            ## 
                            def get(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::LegalHoldCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
