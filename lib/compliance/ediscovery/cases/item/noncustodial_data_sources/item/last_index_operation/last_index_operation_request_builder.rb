...
require_relative '../../../../../../../models/ediscovery/case_index_operation'
                        ...
                        module Item
                            module LastIndexOperation
                                ...
                                class LastIndexOperationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    ## @return a Fiber of case_index_operation
                                    ## 
                                    def get(request_configuration=nil)
                                        ...
                                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::CaseIndexOperation.create_from_discriminator_value(pn) }, error_mapping)
                                    end
                                    ## 
                                    ## Get lastIndexOperation from compliance
                                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
