...
require_relative '../../../../../../../models/ediscovery_case_index_operation'
                            ...
                            module LastIndexOperation
                                ...
                                class LastIndexOperationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/noncustodialDataSources/{noncustodialDataSource%2Did}/lastIndexOperation{?%24select,%24expand}")
                                    end
                                    ## 
                                    ## Get lastIndexOperation from compliance
                                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                                    ## @return a Fiber of ediscovery_case_index_operation
                                    ## 
                                    def get(request_configuration=nil)
                                        ...
                                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryCaseIndexOperation.create_from_discriminator_value(pn) }, error_mapping)
                                    end
                                    ## 
                                    ## Get lastIndexOperation from compliance
                                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
