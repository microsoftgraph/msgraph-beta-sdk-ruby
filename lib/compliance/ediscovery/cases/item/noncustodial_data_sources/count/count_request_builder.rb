...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::NoncustodialDataSources::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/noncustodialDataSources/$count{?%24search,%24filter}"
