...
require_relative '../../../../../models/ediscovery_custodian_collection_response'
...
require_relative './item/custodian_item_request_builder'
                    ...
                    module Custodians
                        ...
                        class CustodiansRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def microsoft_graph_ediscovery_apply_hold()
                                return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::MicrosoftGraphEdiscoveryApplyHold::MicrosoftGraphEdiscoveryApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the removeHold method.
                            def microsoft_graph_ediscovery_remove_hold()
                                return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::MicrosoftGraphEdiscoveryRemoveHold::MicrosoftGraphEdiscoveryRemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the custodians property of the microsoft.graph.ediscovery.case entity.
                            ...
                            ## 
                            def by_custodian_id(custodian_id)
                                raise StandardError, 'custodian_id cannot be null' if custodian_id.nil?
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
                            ...
                            def get(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryCustodianCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ...
                            def to_post_request_information(body, request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians'
                                request_info.path_parameters = @path_parameters
