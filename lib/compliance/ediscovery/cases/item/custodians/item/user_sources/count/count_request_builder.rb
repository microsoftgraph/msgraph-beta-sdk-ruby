...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::UserSources::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/{custodian%2Did}/userSources/$count{?%24search,%24filter}"
