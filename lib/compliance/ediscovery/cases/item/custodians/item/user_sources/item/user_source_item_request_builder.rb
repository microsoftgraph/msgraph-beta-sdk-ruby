...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::UserSources::Item
    ## 
    ...
    class UserSourceItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, user_source_id=nil)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/{custodian%2Did}/userSources/{userSource%2Did}{?%24select,%24expand}"
