...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::UnifiedGroupSources::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/{custodian%2Did}/unifiedGroupSources/$count{?%24search,%24filter}"
