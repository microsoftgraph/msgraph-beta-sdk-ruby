...
require_relative '../../../../../../models/ediscovery/custodian'
...
require_relative './item'
require_relative './microsoft_graph_ediscovery_activate/activate_request_builder'
require_relative './microsoft_graph_ediscovery_apply_hold/apply_hold_request_builder'
require_relative './microsoft_graph_ediscovery_release/release_request_builder'
require_relative './microsoft_graph_ediscovery_remove_hold/remove_hold_request_builder'
require_relative './microsoft_graph_ediscovery_update_index/update_index_request_builder'
...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item
    ## 
    ...
    class CustodianItemRequestBuilder
        ...
        def microsoft_graph_ediscovery_activate()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::MicrosoftGraphEdiscoveryActivate::ActivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyHold method.
        def microsoft_graph_ediscovery_apply_hold()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::MicrosoftGraphEdiscoveryApplyHold::ApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the release method.
        def microsoft_graph_ediscovery_release()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::MicrosoftGraphEdiscoveryRelease::ReleaseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeHold method.
        def microsoft_graph_ediscovery_remove_hold()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::MicrosoftGraphEdiscoveryRemoveHold::RemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateIndex method.
        def microsoft_graph_ediscovery_update_index()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::MicrosoftGraphEdiscoveryUpdateIndex::UpdateIndexRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param custodianId key: id of custodian
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, custodian_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/{custodian%2Did}{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::Custodian.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ...
        def site_sources_by_id(id)
            ...
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::SiteSources::Item::SiteSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property custodians for compliance
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def unified_group_sources_by_id(id)
            ...
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::UnifiedGroupSources::Item::UnifiedGroupSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the userSources property of the microsoft.graph.ediscovery.custodian entity.
        ## @param id Unique identifier of the item
        ...
        def user_sources_by_id(id)
            ...
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::UserSources::Item::UserSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
