...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item
    ...
    class CustodianItemRequestBuilder
        ...
        def activate()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::Activate::ActivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyHold method.
        def apply_hold()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::ApplyHold::ApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def release()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::Release::ReleaseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeHold method.
        def remove_hold()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::RemoveHold::RemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def update_index()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::UpdateIndex::UpdateIndexRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
