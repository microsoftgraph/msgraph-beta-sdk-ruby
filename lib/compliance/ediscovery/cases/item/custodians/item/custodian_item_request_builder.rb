...
require_relative './ediscovery_activate/ediscovery_activate_request_builder'
require_relative './ediscovery_apply_hold/ediscovery_apply_hold_request_builder'
require_relative './ediscovery_release/ediscovery_release_request_builder'
require_relative './ediscovery_remove_hold/ediscovery_remove_hold_request_builder'
require_relative './ediscovery_update_index/ediscovery_update_index_request_builder'
require_relative './item'
                    ...
                    module Custodians
                        module Item
                            ...
                            class CustodianItemRequestBuilder
                                ...
                                def ediscovery_activate()
                                    return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::EdiscoveryActivate::EdiscoveryActivateRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the applyHold method.
                                def ediscovery_apply_hold()
                                    return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::EdiscoveryApplyHold::EdiscoveryApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the release method.
                                def ediscovery_release()
                                    return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::EdiscoveryRelease::EdiscoveryReleaseRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the removeHold method.
                                def ediscovery_remove_hold()
                                    return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::EdiscoveryRemoveHold::EdiscoveryRemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the updateIndex method.
                                def ediscovery_update_index()
                                    return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Custodians::Item::EdiscoveryUpdateIndex::EdiscoveryUpdateIndexRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
