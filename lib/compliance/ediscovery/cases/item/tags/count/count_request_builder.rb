...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Tags::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/tags/$count{?%24search,%24filter}"
