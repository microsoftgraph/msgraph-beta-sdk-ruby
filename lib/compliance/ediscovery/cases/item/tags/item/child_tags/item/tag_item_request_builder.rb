...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Tags::Item::ChildTags::Item
    ...
    class TagItemRequestBuilder
        ...
        ## @param tagId1 key: id of tag
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, tag_id1=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/tags/{tag%2Did}/childTags/{tag%2Did1}{?%24select,%24expand}"
