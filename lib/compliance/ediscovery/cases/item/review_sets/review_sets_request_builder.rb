...
require_relative '../../../../../models/ediscovery_review_set_collection_response'
...
require_relative './item/review_set_item_request_builder'
                ...
                module Item
                    module ReviewSets
                        ...
                        class ReviewSetsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            ## 
                            def by_review_set_id(review_set_id)
                                raise StandardError, 'review_set_id cannot be null' if review_set_id.nil?
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/reviewSets{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
                            ...
                            def to_post_request_information(body, request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/compliance/ediscovery/cases/{case%2Did}/reviewSets'
                                request_info.path_parameters = @path_parameters
