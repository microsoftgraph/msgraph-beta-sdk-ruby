...
require_relative '../item'
require_relative './ediscovery_add_to_review_set'
        ...
        module Ediscovery
            module Cases
                module Item
                    module ReviewSets
                        module Item
                            module EdiscoveryAddToReviewSet
                                ## 
                                # Provides operations to call the addToReviewSet method.
                                class EdiscoveryAddToReviewSetRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/reviewSets/{reviewSet%2Did}/ediscovery.addToReviewSet")
                                    end
                                    ## 
