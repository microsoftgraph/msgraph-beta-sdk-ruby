                        ...
                        module Item
                            module MicrosoftGraphEdiscoveryAddToReviewSet
                                ...
                                class MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    ## @return a microsoft_graph_ediscovery_add_to_review_set_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return MicrosoftGraphEdiscoveryAddToReviewSetRequestBuilder.new(raw_url, @request_adapter)
                                    end
                                end
                            end
                        end
