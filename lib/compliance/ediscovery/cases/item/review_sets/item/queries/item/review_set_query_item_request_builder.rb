...
require_relative './ediscovery_apply_tags/ediscovery_apply_tags_request_builder'
require_relative './item'
                            ...
                            module Queries
                                module Item
                                    ...
                                    class ReviewSetQueryItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def ediscovery_apply_tags()
                                            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::ReviewSets::Item::Queries::Item::EdiscoveryApplyTags::EdiscoveryApplyTagsRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
