...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::ReviewSets::Item::Queries::Item::MicrosoftGraphEdiscoveryApplyTags
    class ApplyTagsPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "tagsToAdd" => lambda {|n| @tags_to_add = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::Tag.create_from_discriminator_value(pn) }) },
                "tagsToRemove" => lambda {|n| @tags_to_remove = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::Tag.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
