...
require_relative './ediscovery_add_to_review_set/ediscovery_add_to_review_set_request_builder'
require_relative './ediscovery_export/ediscovery_export_request_builder'
require_relative './item'
                    ...
                    module ReviewSets
                        module Item
                            ...
                            class ReviewSetItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def ediscovery_add_to_review_set()
                                    return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::ReviewSets::Item::EdiscoveryAddToReviewSet::EdiscoveryAddToReviewSetRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the export method.
                                def ediscovery_export()
                                    return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::ReviewSets::Item::EdiscoveryExport::EdiscoveryExportRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
