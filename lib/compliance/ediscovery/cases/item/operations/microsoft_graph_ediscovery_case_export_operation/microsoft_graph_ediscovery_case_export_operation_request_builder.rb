...
require_relative '../../../../../../models/ediscovery_case_export_operation_collection_response'
                        ...
                        module MicrosoftGraphEdiscoveryCaseExportOperation
                            ...
                            class MicrosoftGraphEdiscoveryCaseExportOperationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/operations/microsoft.graph.ediscovery.caseExportOperation{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
                                ...
                                ## @return a Fiber of ediscovery_case_export_operation_collection_response
                                ## 
                                def get(request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryCaseExportOperationCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Get the items of type microsoft.graph.ediscovery.caseExportOperation in the microsoft.graph.ediscovery.caseOperation collection
                                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
