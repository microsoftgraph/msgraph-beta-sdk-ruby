...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Operations::Item
    ...
    class CaseOperationItemRequestBuilder
        ...
        def case_export_operation()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Operations::Item::CaseExportOperation::CaseExportOperationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
