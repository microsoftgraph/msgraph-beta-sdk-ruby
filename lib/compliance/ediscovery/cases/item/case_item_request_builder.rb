...
require_relative './microsoft_graph_ediscovery_close/close_request_builder'
require_relative './microsoft_graph_ediscovery_reopen/reopen_request_builder'
...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item
    ...
    class CaseItemRequestBuilder
        ...
        def microsoft_graph_ediscovery_close()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::MicrosoftGraphEdiscoveryClose::CloseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reopen method.
        def microsoft_graph_ediscovery_reopen()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::MicrosoftGraphEdiscoveryReopen::ReopenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param caseId key: id of case
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, case_id=nil)
