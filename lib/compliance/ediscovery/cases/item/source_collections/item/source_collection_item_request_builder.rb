...
require_relative './ediscovery_estimate_statistics/ediscovery_estimate_statistics_request_builder'
require_relative './ediscovery_purge_data/ediscovery_purge_data_request_builder'
require_relative './item'
                    ...
                    module SourceCollections
                        module Item
                            ...
                            class SourceCollectionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def ediscovery_estimate_statistics()
                                    return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item::EdiscoveryEstimateStatistics::EdiscoveryEstimateStatisticsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the purgeData method.
                                def ediscovery_purge_data()
                                    return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item::EdiscoveryPurgeData::EdiscoveryPurgeDataRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}{?%24select,%24expand}")
                                end
                                ## 
                                ## Provides operations to manage the custodianSources property of the microsoft.graph.ediscovery.sourceCollection entity.
                                ## @param id Unique identifier of the item
