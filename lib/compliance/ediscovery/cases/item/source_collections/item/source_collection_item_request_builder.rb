...
require_relative './microsoft_graph_ediscovery_estimate_statistics/estimate_statistics_request_builder'
require_relative './microsoft_graph_ediscovery_purge_data/purge_data_request_builder'
...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item
    ...
    class SourceCollectionItemRequestBuilder
        ...
        def microsoft_graph_ediscovery_estimate_statistics()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item::MicrosoftGraphEdiscoveryEstimateStatistics::EstimateStatisticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the purgeData method.
        def microsoft_graph_ediscovery_purge_data()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item::MicrosoftGraphEdiscoveryPurgeData::PurgeDataRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param sourceCollectionId key: id of sourceCollection
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, source_collection_id=nil)
