...
module MicrosoftGraphBeta::DataClassification::SensitivityLabels::Item::Sublabels
    ...
    class SublabelsRequestBuilder
        ...
        def microsoft_graph_evaluate()
            return MicrosoftGraphBeta::DataClassification::SensitivityLabels::Item::Sublabels::MicrosoftGraphEvaluate::EvaluateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
