    ...
    module DataClassification
        module SensitivityLabels
            ...
            class SensitivityLabelsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::DataClassification::SensitivityLabels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the evaluate method.
                def evaluate()
                    return MicrosoftGraphBeta::DataClassification::SensitivityLabels::Evaluate::EvaluateRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the sensitivityLabels property of the microsoft.graph.dataClassificationService entity.
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/dataClassification/sensitivityLabels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/dataClassification/sensitivityLabels'
                    request_info.path_parameters = @path_parameters
