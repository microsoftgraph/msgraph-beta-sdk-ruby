...
module MicrosoftGraphBeta::DataClassification::SensitivityLabels
    ...
    class SensitivityLabelsRequestBuilder
        ...
        def microsoft_graph_evaluate()
            return MicrosoftGraphBeta::DataClassification::SensitivityLabels::MicrosoftGraphEvaluate::MicrosoftGraphEvaluateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/dataClassification/sensitivityLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
