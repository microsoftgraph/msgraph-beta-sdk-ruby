...
module MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/dataClassification/exactMatchDataStores/{exactMatchDataStore%2Did}/sessions/$count{?%24search,%24filter}"
