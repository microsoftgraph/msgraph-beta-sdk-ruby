...
require_relative './microsoft_graph_commit/microsoft_graph_commit_request_builder'
                    ...
                    module Item
                        ...
                        class ExactMatchSessionItemRequestBuilder
                            ...
                            def microsoft_graph_cancel()
                                return MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the commit method.
                            def microsoft_graph_commit()
                                return MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item::MicrosoftGraphCommit::MicrosoftGraphCommitRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the renew method.
                            def microsoft_graph_renew()
                                return MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item::MicrosoftGraphRenew::MicrosoftGraphRenewRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
