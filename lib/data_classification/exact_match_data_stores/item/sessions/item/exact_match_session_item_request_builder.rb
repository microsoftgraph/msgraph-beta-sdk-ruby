...
require_relative './microsoft_graph_commit/commit_request_builder'
...
module MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item
    ...
    class ExactMatchSessionItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item::MicrosoftGraphCancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the commit method.
        def microsoft_graph_commit()
            return MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item::MicrosoftGraphCommit::CommitRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the renew method.
        def microsoft_graph_renew()
            return MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item::MicrosoftGraphRenew::RenewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param exactMatchSessionId key: id of exactMatchSession
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, exact_match_session_id=nil)
