...
require_relative './microsoft_graph_classify_exact_matches/microsoft_graph_classify_exact_matches_request_builder'
require_relative './microsoft_graph_classify_file/microsoft_graph_classify_file_request_builder'
...
module MicrosoftGraphBeta
    module DataClassification
        ...
        class DataClassificationRequestBuilder
            ...
            def microsoft_graph_classify_exact_matches()
                return MicrosoftGraphBeta::DataClassification::MicrosoftGraphClassifyExactMatches::MicrosoftGraphClassifyExactMatchesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the classifyFile method.
            def microsoft_graph_classify_file()
                return MicrosoftGraphBeta::DataClassification::MicrosoftGraphClassifyFile::MicrosoftGraphClassifyFileRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                ...
                @url_template = "{+baseurl}/dataClassification{?%24select,%24expand}"
