...
require_relative './microsoft_graph_classify_exact_matches/classify_exact_matches_request_builder'
require_relative './microsoft_graph_classify_file/classify_file_request_builder'
...
module MicrosoftGraphBeta::DataClassification
    ...
    class DataClassificationRequestBuilder
        ...
        def microsoft_graph_classify_exact_matches()
            return MicrosoftGraphBeta::DataClassification::MicrosoftGraphClassifyExactMatches::ClassifyExactMatchesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the classifyFile method.
        def microsoft_graph_classify_file()
            return MicrosoftGraphBeta::DataClassification::MicrosoftGraphClassifyFile::ClassifyFileRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
