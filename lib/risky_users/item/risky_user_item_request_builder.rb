...
module MicrosoftGraphBeta::RiskyUsers::Item
    ## 
    ...
    class RiskyUserItemRequestBuilder
        ...
        def history()
            return MicrosoftGraphBeta::RiskyUsers::Item::History::HistoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/riskyUsers/{riskyUser%2Did}{?%24select,%24expand}"
