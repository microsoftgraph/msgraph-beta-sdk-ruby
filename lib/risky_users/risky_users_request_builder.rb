...
module MicrosoftGraphBeta::RiskyUsers
    ## 
    ...
    class RiskyUsersRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::RiskyUsers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the confirmCompromised method.
        def microsoft_graph_confirm_compromised()
            return MicrosoftGraphBeta::RiskyUsers::MicrosoftGraphConfirmCompromised::MicrosoftGraphConfirmCompromisedRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the dismiss method.
        def microsoft_graph_dismiss()
            return MicrosoftGraphBeta::RiskyUsers::MicrosoftGraphDismiss::MicrosoftGraphDismissRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/riskyUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
