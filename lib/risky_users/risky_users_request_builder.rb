    ...
    module RiskyUsers
        ...
        class RiskyUsersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def confirm_compromised()
                return MicrosoftGraphBeta::RiskyUsers::ConfirmCompromised::ConfirmCompromisedRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def dismiss()
                return MicrosoftGraphBeta::RiskyUsers::Dismiss::DismissRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ## Provides operations to manage the collection of riskyUser entities.
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/riskyUsers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/riskyUsers'
                request_info.path_parameters = @path_parameters
