        ...
        module BackupRestore
            module SiteInclusionRules
                ...
                class SiteInclusionRulesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Solutions::BackupRestore::SiteInclusionRules::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the siteInclusionRules property of the microsoft.graph.backupRestoreRoot entity.
                    ...
                    def by_site_protection_rule_id(site_protection_rule_id)
                        ...
                        return MicrosoftGraphBeta::Solutions::BackupRestore::SiteInclusionRules::Item::SiteProtectionRuleItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
