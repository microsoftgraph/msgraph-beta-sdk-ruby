                ...
                module Item
                    ...
                    class SharePointProtectionPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def site_inclusion_rules()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::SharePointProtectionPolicies::Item::SiteInclusionRules::SiteInclusionRulesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def site_protection_units()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::SharePointProtectionPolicies::Item::SiteProtectionUnits::SiteProtectionUnitsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def site_protection_units_bulk_addition_jobs()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::SharePointProtectionPolicies::Item::SiteProtectionUnitsBulkAdditionJobs::SiteProtectionUnitsBulkAdditionJobsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
