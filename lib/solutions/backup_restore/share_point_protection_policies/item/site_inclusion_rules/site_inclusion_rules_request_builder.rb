                ...
                module Item
                    module SiteInclusionRules
                        ...
                        class SiteInclusionRulesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::Solutions::BackupRestore::SharePointProtectionPolicies::Item::SiteInclusionRules::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the siteInclusionRules property of the microsoft.graph.sharePointProtectionPolicy entity.
                            ...
                            def by_site_protection_rule_id(site_protection_rule_id)
                                ...
                                return MicrosoftGraphBeta::Solutions::BackupRestore::SharePointProtectionPolicies::Item::SiteInclusionRules::Item::SiteProtectionRuleItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def get(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SiteProtectionRuleCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Get a list of siteProtectionRule objects associated with a sharePointProtectionPolicy. An inclusion rule indicates that a protection policy should contain protection units that match the specified rule criteria. The initial status of a protection rule upon creation is active. After the rule is applied, the state is either completed or completedWithErrors.
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
