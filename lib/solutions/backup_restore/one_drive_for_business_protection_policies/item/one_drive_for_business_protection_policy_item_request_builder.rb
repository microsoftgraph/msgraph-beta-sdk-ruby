                ...
                module Item
                    ...
                    class OneDriveForBusinessProtectionPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def drive_inclusion_rules()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::OneDriveForBusinessProtectionPolicies::Item::DriveInclusionRules::DriveInclusionRulesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def drive_protection_units()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::OneDriveForBusinessProtectionPolicies::Item::DriveProtectionUnits::DriveProtectionUnitsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def drive_protection_units_bulk_addition_jobs()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::OneDriveForBusinessProtectionPolicies::Item::DriveProtectionUnitsBulkAdditionJobs::DriveProtectionUnitsBulkAdditionJobsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::OneDriveForBusinessProtectionPolicy.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
