                ...
                module Item
                    ...
                    class ExchangeRestoreSessionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def granular_mailbox_restore_artifacts()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::ExchangeRestoreSessions::Item::GranularMailboxRestoreArtifacts::GranularMailboxRestoreArtifactsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def mailbox_restore_artifacts()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::ExchangeRestoreSessions::Item::MailboxRestoreArtifacts::MailboxRestoreArtifactsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def mailbox_restore_artifacts_bulk_addition_requests()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::ExchangeRestoreSessions::Item::MailboxRestoreArtifactsBulkAdditionRequests::MailboxRestoreArtifactsBulkAdditionRequestsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ExchangeRestoreSession.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
