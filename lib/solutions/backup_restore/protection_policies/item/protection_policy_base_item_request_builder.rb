            ...
            module ProtectionPolicies
                module Item
                    ...
                    class ProtectionPolicyBaseItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def activate()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::ProtectionPolicies::Item::Activate::ActivateRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the deactivate method.
                        def deactivate()
                            return MicrosoftGraphBeta::Solutions::BackupRestore::ProtectionPolicies::Item::Deactivate::DeactivateRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
