        ...
        module BackupRestore
            ...
            class BackupRestoreRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def drive_inclusion_rules()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::DriveInclusionRules::DriveInclusionRulesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def drive_protection_units()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::DriveProtectionUnits::DriveProtectionUnitsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def drive_protection_units_bulk_addition_jobs()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::DriveProtectionUnitsBulkAdditionJobs::DriveProtectionUnitsBulkAdditionJobsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the enable method.
                def enable()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::Enable::EnableRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def exchange_protection_policies()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::ExchangeProtectionPolicies::ExchangeProtectionPoliciesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def exchange_restore_sessions()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::ExchangeRestoreSessions::ExchangeRestoreSessionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def mailbox_inclusion_rules()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::MailboxInclusionRules::MailboxInclusionRulesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def mailbox_protection_units()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::MailboxProtectionUnits::MailboxProtectionUnitsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def mailbox_protection_units_bulk_addition_jobs()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::MailboxProtectionUnitsBulkAdditionJobs::MailboxProtectionUnitsBulkAdditionJobsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def one_drive_for_business_protection_policies()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::OneDriveForBusinessProtectionPolicies::OneDriveForBusinessProtectionPoliciesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def one_drive_for_business_restore_sessions()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::OneDriveForBusinessRestoreSessions::OneDriveForBusinessRestoreSessionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def protection_policies()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::ProtectionPolicies::ProtectionPoliciesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def protection_units()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::ProtectionUnits::ProtectionUnitsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the restorePoints property of the microsoft.graph.backupRestoreRoot entity.
                def restore_points()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::RestorePoints::RestorePointsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the restoreSessions property of the microsoft.graph.backupRestoreRoot entity.
                def restore_sessions()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::RestoreSessions::RestoreSessionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the serviceApps property of the microsoft.graph.backupRestoreRoot entity.
                def service_apps()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::ServiceApps::ServiceAppsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def share_point_protection_policies()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::SharePointProtectionPolicies::SharePointProtectionPoliciesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def share_point_restore_sessions()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::SharePointRestoreSessions::SharePointRestoreSessionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def site_inclusion_rules()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::SiteInclusionRules::SiteInclusionRulesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def site_protection_units()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::SiteProtectionUnits::SiteProtectionUnitsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def site_protection_units_bulk_addition_jobs()
                    return MicrosoftGraphBeta::Solutions::BackupRestore::SiteProtectionUnitsBulkAdditionJobs::SiteProtectionUnitsBulkAdditionJobsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    error_mapping = Hash.new
                    error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::BackupRestoreRoot.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
