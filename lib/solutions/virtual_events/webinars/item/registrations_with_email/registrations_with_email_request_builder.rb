                ...
                module Item
                    module RegistrationsWithEmail
                        ...
                        class RegistrationsWithEmailRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def cancel()
                                return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::RegistrationsWithEmail::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
