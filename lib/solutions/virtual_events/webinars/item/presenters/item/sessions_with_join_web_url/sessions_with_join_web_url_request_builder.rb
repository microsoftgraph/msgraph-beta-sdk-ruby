...
require_relative '../item'
require_relative './sessions_with_join_web_url'
        ...
        module VirtualEvents
            module Webinars
                module Item
                    module Presenters
                        module Item
                            module SessionsWithJoinWebUrl
                                ## 
                                # Provides operations to manage the sessions property of the microsoft.graph.virtualEventPresenter entity.
                                class SessionsWithJoinWebUrlRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter, join_web_url=nil)
                                        super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/presenters/{virtualEventPresenter%2Did}/sessions(joinWebUrl='{joinWebUrl}'){?%24select,%24expand}")
                                    end
                                    ## 
                                    ...
                                    def with_url(raw_url)
                                        ...
                                        return SessionsWithJoinWebUrlRequestBuilder.new(raw_url, @request_adapter)
                                    end
