                ...
                module Item
                    module RegistrationsWithUserId
                        ...
                        class RegistrationsWithUserIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def cancel()
                                return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::RegistrationsWithUserId::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
