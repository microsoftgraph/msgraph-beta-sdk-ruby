            ...
            module Webinars
                module Item
                    ...
                    class VirtualEventWebinarItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def presenters()
                            return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Presenters::PresentersRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def registration_configuration()
                            return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::RegistrationConfiguration::RegistrationConfigurationRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the registrations property of the microsoft.graph.virtualEventWebinar entity.
                        def registrations()
                            return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Registrations::RegistrationsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the sessions property of the microsoft.graph.virtualEvent entity.
                        def sessions()
                            return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::SessionsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::VirtualEventWebinar.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
