                ...
                module Item
                    module Sessions
                        ...
                        class SessionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the sessions property of the microsoft.graph.virtualEvent entity.
                            ## @param virtual_event_session_id Unique identifier of the item
                            ...
                            def by_virtual_event_session_id(virtual_event_session_id)
                                ...
                                return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::VirtualEventSessionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
