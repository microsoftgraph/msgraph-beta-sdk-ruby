                            ...
                            module Registration
                                module CustomQuestions
                                    ...
                                    class CustomQuestionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def count()
                                            return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::Registration::CustomQuestions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ## Provides operations to manage the customQuestions property of the microsoft.graph.meetingRegistration entity.
                                        ## @param meeting_registration_question_id Unique identifier of the item
                                        ...
                                        def by_meeting_registration_question_id(meeting_registration_question_id)
                                            ...
                                            return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::Registration::CustomQuestions::Item::MeetingRegistrationQuestionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/registration/customQuestions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                                        end
                                        ## 
