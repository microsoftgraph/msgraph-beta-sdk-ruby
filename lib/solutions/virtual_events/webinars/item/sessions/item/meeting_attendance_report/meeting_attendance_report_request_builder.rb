                            ...
                            module MeetingAttendanceReport
                                ...
                                class MeetingAttendanceReportRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def attendance_records()
                                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::MeetingAttendanceReport::AttendanceRecords::AttendanceRecordsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/meetingAttendanceReport{?%24select,%24expand}")
                                    end
                                    ## 
