                        ...
                        module Item
                            module AttendanceReports
                                ...
                                class AttendanceReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::AttendanceReports::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the attendanceReports property of the microsoft.graph.onlineMeetingBase entity.
                                    ...
                                    def by_meeting_attendance_report_id(meeting_attendance_report_id)
                                        ...
                                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::AttendanceReports::Item::MeetingAttendanceReportItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
