                        ...
                        module Item
                            ...
                            class VirtualEventSessionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def alternative_recording()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::AlternativeRecording::AlternativeRecordingRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the attendanceReports property of the microsoft.graph.onlineMeeting entity.
                                def attendance_reports()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::AttendanceReports::AttendanceReportsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the media for the solutionsRoot entity.
                                def attendee_report()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::AttendeeReport::AttendeeReportRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the media for the solutionsRoot entity.
                                def broadcast_recording()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::BroadcastRecording::BroadcastRecordingRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def meeting_attendance_report()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::MeetingAttendanceReport::MeetingAttendanceReportRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the media for the solutionsRoot entity.
                                def recording()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::Recording::RecordingRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the recordings property of the microsoft.graph.onlineMeeting entity.
                                def recordings()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::Recordings::RecordingsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the registration property of the microsoft.graph.onlineMeeting entity.
                                def registration()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::Registration::RegistrationRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the registrations property of the microsoft.graph.virtualEventSession entity.
                                def registrations()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Sessions::Item::Registrations::RegistrationsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
