                        ...
                        module Item
                            module Sessions
                                ...
                                class SessionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Registrations::Item::Sessions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the sessions property of the microsoft.graph.virtualEventRegistration entity.
                                    ...
                                    def by_virtual_event_session_id(virtual_event_session_id)
                                        ...
                                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Registrations::Item::Sessions::Item::VirtualEventSessionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                                    end
                                    ## 
