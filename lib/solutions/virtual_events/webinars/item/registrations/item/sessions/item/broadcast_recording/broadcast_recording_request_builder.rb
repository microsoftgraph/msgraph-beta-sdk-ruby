                                    ...
                                    module BroadcastRecording
                                        ...
                                        class BroadcastRecordingRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}/sessions/{virtualEventSession%2Did}/broadcastRecording")
                                            end
                                            ## 
                                            ...
                                            ## @return a broadcast_recording_request_builder
                                            ## 
                                            def with_url(raw_url)
                                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                return BroadcastRecordingRequestBuilder.new(raw_url, @request_adapter)
                                            end
                                        end
                                    end
                                end
