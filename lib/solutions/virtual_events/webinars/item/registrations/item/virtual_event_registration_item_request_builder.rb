                    ...
                    module Registrations
                        module Item
                            ...
                            class VirtualEventRegistrationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def cancel()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Registrations::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the sessions property of the microsoft.graph.virtualEventRegistration entity.
                                def sessions()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::Registrations::Item::Sessions::SessionsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
