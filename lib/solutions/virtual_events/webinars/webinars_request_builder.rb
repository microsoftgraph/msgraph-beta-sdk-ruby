        ...
        module VirtualEvents
            module Webinars
                ...
                class WebinarsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the webinars property of the microsoft.graph.virtualEventsRoot entity.
                    ## @param virtual_event_webinar_id Unique identifier of the item
                    ...
                    def by_virtual_event_webinar_id(virtual_event_webinar_id)
                        ...
                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Webinars::Item::VirtualEventWebinarItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::VirtualEventWebinarCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
