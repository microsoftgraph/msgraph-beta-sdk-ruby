                            ...
                            module Presenters
                                module Item
                                    ...
                                    class VirtualEventPresenterItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def profile_photo()
                                            return MicrosoftGraphBeta::Solutions::VirtualEvents::Events::Item::Sessions::Item::Presenters::Item::ProfilePhoto::ProfilePhotoRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/presenters/{virtualEventPresenter%2Did}{?%24select,%24expand}")
                                        end
                                        ## 
