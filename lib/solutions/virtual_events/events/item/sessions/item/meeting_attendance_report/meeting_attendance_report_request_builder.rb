                    ...
                    module Sessions
                        module Item
                            module MeetingAttendanceReport
                                ...
                                class MeetingAttendanceReportRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    
                                    ## 
                                    # Provides operations to manage the attendanceRecords property of the microsoft.graph.meetingAttendanceReport entity.
                                    def attendance_records()
                                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Events::Item::Sessions::Item::MeetingAttendanceReport::AttendanceRecords::AttendanceRecordsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/meetingAttendanceReport{?%24select,%24expand}")
                                    end
                                    ## 
                                    ...
                                    ## @return a meeting_attendance_report_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return MeetingAttendanceReportRequestBuilder.new(raw_url, @request_adapter)
                                    end
