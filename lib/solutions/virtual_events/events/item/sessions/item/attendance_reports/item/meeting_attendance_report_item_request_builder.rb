                                ...
                                module Item
                                    ...
                                    class MeetingAttendanceReportItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def attendance_records()
                                            return MicrosoftGraphBeta::Solutions::VirtualEvents::Events::Item::Sessions::Item::AttendanceReports::Item::AttendanceRecords::AttendanceRecordsRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
