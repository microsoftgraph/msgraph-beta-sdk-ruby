                            ...
                            module Registration
                                ...
                                class RegistrationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def custom_questions()
                                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Events::Item::Sessions::Item::Registration::CustomQuestions::CustomQuestionsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the registrants property of the microsoft.graph.meetingRegistrationBase entity.
                                    def registrants()
                                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Events::Item::Sessions::Item::Registration::Registrants::RegistrantsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/events/{virtualEvent%2Did}/sessions/{virtualEventSession%2Did}/registration{?%24select,%24expand}")
                                    end
                                    ## 
