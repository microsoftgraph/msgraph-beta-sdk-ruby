                    ...
                    module Presenters
                        module Item
                            ...
                            class VirtualEventPresenterItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def profile_photo()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Townhalls::Item::Presenters::Item::ProfilePhoto::ProfilePhotoRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the sessions property of the microsoft.graph.virtualEventPresenter entity.
                                def sessions()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Townhalls::Item::Presenters::Item::Sessions::SessionsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/presenters/{virtualEventPresenter%2Did}{?%24select,%24expand}")
                                end
                                ## 
