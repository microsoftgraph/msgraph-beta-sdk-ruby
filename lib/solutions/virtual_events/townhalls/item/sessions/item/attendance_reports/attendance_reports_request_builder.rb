                        ...
                        module Item
                            module AttendanceReports
                                ...
                                class AttendanceReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Townhalls::Item::Sessions::Item::AttendanceReports::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the attendanceReports property of the microsoft.graph.onlineMeetingBase entity.
                                    ...
                                    def by_meeting_attendance_report_id(meeting_attendance_report_id)
                                        ...
                                        return MicrosoftGraphBeta::Solutions::VirtualEvents::Townhalls::Item::Sessions::Item::AttendanceReports::Item::MeetingAttendanceReportItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/attendanceReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                                    end
                                    ## 
                                    ...
                                    def get(request_configuration=nil)
                                        ...
                                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::MeetingAttendanceReportCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                                    end
                                    ## 
