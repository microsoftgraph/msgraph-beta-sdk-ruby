                        ...
                        module Item
                            ...
                            class VirtualEventSessionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def attendance_reports()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Townhalls::Item::Sessions::Item::AttendanceReports::AttendanceReportsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the presenters property of the microsoft.graph.virtualEventSession entity.
                                def presenters()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Townhalls::Item::Sessions::Item::Presenters::PresentersRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the registrations property of the microsoft.graph.virtualEventSession entity.
                                def registrations()
                                    return MicrosoftGraphBeta::Solutions::VirtualEvents::Townhalls::Item::Sessions::Item::Registrations::RegistrationsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}{?%24select,%24expand}")
                                end
                                ## 
