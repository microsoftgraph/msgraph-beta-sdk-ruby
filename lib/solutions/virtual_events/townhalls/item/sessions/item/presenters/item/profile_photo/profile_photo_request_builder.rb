                            ...
                            module Presenters
                                module Item
                                    module ProfilePhoto
                                        ...
                                        class ProfilePhotoRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/presenters/{virtualEventPresenter%2Did}/profilePhoto")
                                            end
                                            ## 
                                            ...
                                            ## @return a profile_photo_request_builder
                                            ## 
                                            def with_url(raw_url)
                                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                return ProfilePhotoRequestBuilder.new(raw_url, @request_adapter)
                                            end
                                        end
                                    end
                                end
