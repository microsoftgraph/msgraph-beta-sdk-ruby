            ...
            module Item
                module CustomQuestions
                    ...
                    class CustomQuestionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Solutions::BookingBusinesses::Item::CustomQuestions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the customQuestions property of the microsoft.graph.bookingBusiness entity.
                        ...
                        def by_booking_custom_question_id(booking_custom_question_id)
                            ...
                            return MicrosoftGraphBeta::Solutions::BookingBusinesses::Item::CustomQuestions::Item::BookingCustomQuestionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
