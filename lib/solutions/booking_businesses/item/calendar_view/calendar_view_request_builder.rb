            ...
            module Item
                module CalendarView
                    ...
                    class CalendarViewRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Solutions::BookingBusinesses::Item::CalendarView::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the calendarView property of the microsoft.graph.bookingBusiness entity.
                        ...
                        def by_booking_appointment_id(booking_appointment_id)
                            ...
                            return MicrosoftGraphBeta::Solutions::BookingBusinesses::Item::CalendarView::Item::BookingAppointmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
