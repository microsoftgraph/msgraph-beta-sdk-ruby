    ...
    module Solutions
        module BookingBusinesses
            ...
            class BookingBusinessesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::Solutions::BookingBusinesses::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the bookingBusinesses property of the microsoft.graph.solutionsRoot entity.
                ...
                def by_booking_business_id(booking_business_id)
                    ...
                    return MicrosoftGraphBeta::Solutions::BookingBusinesses::Item::BookingBusinessItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
