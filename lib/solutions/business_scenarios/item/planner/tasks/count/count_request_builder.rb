...
module MicrosoftGraphBeta::Solutions::BusinessScenarios::Item::Planner::Tasks::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/tasks/$count{?%24search,%24filter}"
