...
module MicrosoftGraphBeta::Solutions::BusinessScenarios::Item::Planner::Tasks::Item
    ...
    class BusinessScenarioTaskItemRequestBuilder
        ...
        ## @param businessScenarioTaskId key: id of businessScenarioTask
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, business_scenario_task_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/tasks/{businessScenarioTask%2Did}{?%24select,%24expand}"
