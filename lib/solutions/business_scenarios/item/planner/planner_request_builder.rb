...
require_relative './microsoft_graph_get_plan/microsoft_graph_get_plan_request_builder'
...
require_relative './tasks/item/business_scenario_task_item_request_builder'
require_relative './tasks/tasks_request_builder'

module MicrosoftGraphBeta::Solutions::BusinessScenarios::Item::Planner
    ## 
    ...
    class PlannerRequestBuilder
        ...
        def microsoft_graph_get_plan()
            return MicrosoftGraphBeta::Solutions::BusinessScenarios::Item::Planner::MicrosoftGraphGetPlan::MicrosoftGraphGetPlanRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner{?%24select,%24expand}"
