...
require_relative './microsoft_graph_get_plan/get_plan_request_builder'
...
module MicrosoftGraphBeta::Solutions::BusinessScenarios::Item::Planner
    ...
    class PlannerRequestBuilder
        ...
        def microsoft_graph_get_plan()
            return MicrosoftGraphBeta::Solutions::BusinessScenarios::Item::Planner::MicrosoftGraphGetPlan::GetPlanRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
