...
module MicrosoftGraphBeta::Solutions::BusinessScenarios::Item::Planner::PlanConfiguration::Localizations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/planConfiguration/localizations/$count{?%24search,%24filter}"
