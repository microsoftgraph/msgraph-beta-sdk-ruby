...
require_relative './business_scenarios_with_unique_name'

module MicrosoftGraphBeta
    module Solutions
        module BusinessScenariosWithUniqueName
            ## 
            # Provides operations to manage the businessScenarios property of the microsoft.graph.solutionsRoot entity.
            class BusinessScenariosWithUniqueNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, unique_name=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/solutions/businessScenarios(uniqueName='{uniqueName}'){?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/solutions/businessScenarios(uniqueName='{uniqueName}')'
                ...
                def with_url(raw_url)
                    ...
                    return BusinessScenariosWithUniqueNameRequestBuilder.new(raw_url, @request_adapter)
                end
