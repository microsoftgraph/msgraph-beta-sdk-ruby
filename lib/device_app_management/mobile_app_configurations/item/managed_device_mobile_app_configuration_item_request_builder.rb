            ...
            module Item
                ...
                class ManagedDeviceMobileAppConfigurationItemRequestBuilder
                    ...
                    def microsoft_graph_assign()
                        return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
