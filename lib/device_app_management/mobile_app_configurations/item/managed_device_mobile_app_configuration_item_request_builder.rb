...
module MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item
    ...
    class ManagedDeviceMobileAppConfigurationItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
