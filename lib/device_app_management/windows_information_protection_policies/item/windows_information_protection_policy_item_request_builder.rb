        ...
        module WindowsInformationProtectionPolicies
            module Item
                ...
                class WindowsInformationProtectionPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def assignments()
                        return MicrosoftGraphBeta::DeviceAppManagement::WindowsInformationProtectionPolicies::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def exempt_app_locker_files()
                        return MicrosoftGraphBeta::DeviceAppManagement::WindowsInformationProtectionPolicies::Item::ExemptAppLockerFiles::ExemptAppLockerFilesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def protected_app_locker_files()
                        return MicrosoftGraphBeta::DeviceAppManagement::WindowsInformationProtectionPolicies::Item::ProtectedAppLockerFiles::ProtectedAppLockerFilesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        error_mapping = Hash.new
                        error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionPolicy.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
