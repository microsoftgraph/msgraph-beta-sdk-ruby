...
module MicrosoftGraphBeta::DeviceAppManagement
    ...
    class DeviceAppManagementRequestBuilder
        ...
        def microsoft_graph_sync_microsoft_store_for_business_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::MicrosoftGraphSyncMicrosoftStoreForBusinessApps::SyncMicrosoftStoreForBusinessAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
