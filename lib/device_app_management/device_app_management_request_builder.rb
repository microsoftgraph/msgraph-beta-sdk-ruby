...
require_relative './mobile_app_catalog_packages/mobile_app_catalog_packages_request_builder'
...
require_relative './mobile_app_relationships/mobile_app_relationships_request_builder'
    ...
    module DeviceAppManagement
        ...
        class DeviceAppManagementRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def mobile_app_catalog_packages()
                return MicrosoftGraphBeta::DeviceAppManagement::MobileAppCatalogPackages::MobileAppCatalogPackagesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def mobile_app_relationships()
                return MicrosoftGraphBeta::DeviceAppManagement::MobileAppRelationships::MobileAppRelationshipsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
