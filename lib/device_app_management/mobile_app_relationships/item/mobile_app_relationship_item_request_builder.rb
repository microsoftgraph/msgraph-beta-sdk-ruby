...
require_relative '../mobile_app_relationships'
require_relative './item'

module MicrosoftGraphBeta
    module DeviceAppManagement
        module MobileAppRelationships
            module Item
                ## 
                ...
                class MobileAppRelationshipItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/mobileAppRelationships/{mobileAppRelationship%2Did}{?%24expand,%24select}")
                    end
                    ## 
