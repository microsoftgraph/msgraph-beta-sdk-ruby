            ...
            module Item
                ...
                class ManagedAppPolicyItemRequestBuilder
                    ...
                    def microsoft_graph_target_apps()
                        return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppPolicies::Item::MicrosoftGraphTargetApps::MicrosoftGraphTargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
