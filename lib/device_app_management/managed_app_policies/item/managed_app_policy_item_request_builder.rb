...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedAppPolicies::Item
    ...
    class ManagedAppPolicyItemRequestBuilder
        ...
        def microsoft_graph_target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppPolicies::Item::MicrosoftGraphTargetApps::TargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
