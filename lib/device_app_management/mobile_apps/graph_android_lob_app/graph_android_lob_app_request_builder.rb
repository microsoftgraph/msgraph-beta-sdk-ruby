        ...
        module MobileApps
            module GraphAndroidLobApp
                ...
                class GraphAndroidLobAppRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphAndroidLobApp::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AndroidLobAppCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Get the items of type microsoft.graph.androidLobApp in the microsoft.graph.mobileApp collection
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
