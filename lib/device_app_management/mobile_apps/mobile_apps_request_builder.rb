...
require_relative './convert_from_mobile_app_catalog_package_with_mobile_app_catalog_package_id/convert_from_mobile_app_catalog_package_with_mobile_app_catalog_package_id_request_builder'
...
require_relative './has_payload_links/has_payload_links_request_builder'
require_relative './item/mobile_app_item_request_builder'
require_relative './mobile_apps'
require_relative './validate_xml/validate_xml_request_builder'
    ...
    module DeviceAppManagement
        module MobileApps
            ...
            class MobileAppsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to androidForWorkApp.
                def graph_android_for_work_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphAndroidForWorkApp::GraphAndroidForWorkAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to androidLobApp.
                def graph_android_lob_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphAndroidLobApp::GraphAndroidLobAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to androidManagedStoreApp.
                def graph_android_managed_store_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphAndroidManagedStoreApp::GraphAndroidManagedStoreAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to androidStoreApp.
                def graph_android_store_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphAndroidStoreApp::GraphAndroidStoreAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to iosLobApp.
                def graph_ios_lob_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphIosLobApp::GraphIosLobAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to iosStoreApp.
                def graph_ios_store_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphIosStoreApp::GraphIosStoreAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to iosVppApp.
                def graph_ios_vpp_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphIosVppApp::GraphIosVppAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to macOSDmgApp.
                def graph_mac_o_s_dmg_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphMacOSDmgApp::GraphMacOSDmgAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to macOSLobApp.
                def graph_mac_o_s_lob_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphMacOSLobApp::GraphMacOSLobAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to macOSPkgApp.
                def graph_mac_o_s_pkg_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphMacOSPkgApp::GraphMacOSPkgAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to managedAndroidLobApp.
                def graph_managed_android_lob_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphManagedAndroidLobApp::GraphManagedAndroidLobAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to managedIOSLobApp.
                def graph_managed_i_o_s_lob_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphManagedIOSLobApp::GraphManagedIOSLobAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to managedMobileLobApp.
                def graph_managed_mobile_lob_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphManagedMobileLobApp::GraphManagedMobileLobAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to microsoftStoreForBusinessApp.
                def graph_microsoft_store_for_business_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphMicrosoftStoreForBusinessApp::GraphMicrosoftStoreForBusinessAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to win32LobApp.
                def graph_win32_lob_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphWin32LobApp::GraphWin32LobAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to windowsAppX.
                def graph_windows_app_x()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphWindowsAppX::GraphWindowsAppXRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to windowsMobileMSI.
                def graph_windows_mobile_m_s_i()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphWindowsMobileMSI::GraphWindowsMobileMSIRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to windowsStoreApp.
                def graph_windows_store_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphWindowsStoreApp::GraphWindowsStoreAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to windowsUniversalAppX.
                def graph_windows_universal_app_x()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphWindowsUniversalAppX::GraphWindowsUniversalAppXRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to windowsWebApp.
                def graph_windows_web_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphWindowsWebApp::GraphWindowsWebAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to winGetApp.
                def graph_win_get_app()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphWinGetApp::GraphWinGetAppRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the hasPayloadLinks method.
                def has_payload_links()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::HasPayloadLinks::HasPayloadLinksRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the validateXml method.
                def validate_xml()
                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::ValidateXml::ValidateXmlRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the mobileApps property of the microsoft.graph.deviceAppManagement entity.
                ...
                ## @return a convert_from_mobile_app_catalog_package_with_mobile_app_catalog_package_id_request_builder
                ## 
                def convert_from_mobile_app_catalog_package_with_mobile_app_catalog_package_id(mobile_app_catalog_package_id)
                    raise StandardError, 'mobile_app_catalog_package_id cannot be null' if mobile_app_catalog_package_id.nil?
                    return ConvertFromMobileAppCatalogPackageWithMobileAppCatalogPackageIdRequestBuilder.new(@path_parameters, @request_adapter, mobileAppCatalogPackageId)
                end
                ## 
                ## The mobile apps.
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::MobileAppCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
