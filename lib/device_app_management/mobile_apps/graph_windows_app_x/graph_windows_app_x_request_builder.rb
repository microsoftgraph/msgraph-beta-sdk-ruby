        ...
        module MobileApps
            module GraphWindowsAppX
                ...
                class GraphWindowsAppXRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GraphWindowsAppX::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::WindowsAppXCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Get the items of type microsoft.graph.windowsAppX in the microsoft.graph.mobileApp collection
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
