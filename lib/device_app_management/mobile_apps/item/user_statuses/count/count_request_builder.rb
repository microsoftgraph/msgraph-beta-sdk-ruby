...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::UserStatuses::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/userStatuses/$count{?%24search,%24filter}"
