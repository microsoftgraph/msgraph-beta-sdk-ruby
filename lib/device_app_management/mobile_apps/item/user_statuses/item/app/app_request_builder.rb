...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::UserStatuses::Item::App
    ## 
    ...
    class AppRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/userStatuses/{userAppInstallStatus%2Did}/app{?%24select,%24expand}"
