...
require_relative '../../../../../models/user_app_install_status'
...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::UserStatuses::Item
    ## 
    ...
    class UserAppInstallStatusItemRequestBuilder
        ...
        def app()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::UserStatuses::Item::App::AppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the deviceStatuses property of the microsoft.graph.userAppInstallStatus entity.
        def device_statuses()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::UserStatuses::Item::DeviceStatuses::DeviceStatusesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param userAppInstallStatusId key: id of userAppInstallStatus
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, user_app_install_status_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/userStatuses/{userAppInstallStatus%2Did}{?%24select,%24expand}"
        ...
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a Fiber of user_app_install_status
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UserAppInstallStatus.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
