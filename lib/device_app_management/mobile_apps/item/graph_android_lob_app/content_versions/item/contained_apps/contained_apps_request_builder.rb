                        ...
                        module Item
                            module ContainedApps
                                ...
                                class ContainedAppsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphAndroidLobApp::ContentVersions::Item::ContainedApps::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the containedApps property of the microsoft.graph.mobileAppContent entity.
                                    ...
                                    def by_mobile_contained_app_id(mobile_contained_app_id)
                                        ...
                                        return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphAndroidLobApp::ContentVersions::Item::ContainedApps::Item::MobileContainedAppItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
