...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::DeviceStatuses::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/deviceStatuses/$count{?%24search,%24filter}"
