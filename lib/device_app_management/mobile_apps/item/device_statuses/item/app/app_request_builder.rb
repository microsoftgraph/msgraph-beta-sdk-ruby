...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::DeviceStatuses::Item::App
    ## 
    ...
    class AppRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/deviceStatuses/{mobileAppInstallStatus%2Did}/app{?%24select,%24expand}"
