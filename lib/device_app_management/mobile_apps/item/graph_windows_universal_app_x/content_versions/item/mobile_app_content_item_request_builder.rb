                    ...
                    module ContentVersions
                        module Item
                            ...
                            class MobileAppContentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def contained_apps()
                                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphWindowsUniversalAppX::ContentVersions::Item::ContainedApps::ContainedAppsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the files property of the microsoft.graph.mobileAppContent entity.
                                def files()
                                    return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphWindowsUniversalAppX::ContentVersions::Item::Files::FilesRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
