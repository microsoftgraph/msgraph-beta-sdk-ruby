            ...
            module Item
                module GraphWindowsAppX
                    ...
                    class GraphWindowsAppXRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def assignments()
                            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphWindowsAppX::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the categories property of the microsoft.graph.mobileApp entity.
                        def categories()
                            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphWindowsAppX::Categories::CategoriesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the contentVersions property of the microsoft.graph.mobileLobApp entity.
                        def content_versions()
                            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphWindowsAppX::ContentVersions::ContentVersionsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the relationships property of the microsoft.graph.mobileApp entity.
                        def relationships()
                            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphWindowsAppX::Relationships::RelationshipsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::WindowsAppX.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Get the item of type microsoft.graph.mobileApp as microsoft.graph.windowsAppX
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
