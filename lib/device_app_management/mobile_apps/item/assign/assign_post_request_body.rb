...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::Assign
    class AssignPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "mobileAppAssignments" => lambda {|n| @mobile_app_assignments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MobileAppAssignment.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
