                ...
                module GraphWin32LobApp
                    module Relationships
                        ...
                        class RelationshipsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphWin32LobApp::Relationships::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the relationships property of the microsoft.graph.mobileApp entity.
                            ...
                            def by_mobile_app_relationship_id(mobile_app_relationship_id)
                                ...
                                return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphWin32LobApp::Relationships::Item::MobileAppRelationshipItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.win32LobApp/relationships{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
                            ...
                            def to_post_request_information(body, request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.win32LobApp/relationships'
                                request_info.path_parameters = @path_parameters
