                        ...
                        module Item
                            ...
                            class MobileAppCategoryItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsStoreApp/categories/{mobileAppCategory%2Did}{?%24expand,%24select}")
                                end
                                ## 
