                ...
                module GetRelatedAppStatesWithUserPrincipalNameWithDeviceId
                    ...
                    class GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter, device_id=nil, user_principal_name=nil)
                            ...
                            @url_template = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/getRelatedAppStates(userPrincipalName='{userPrincipalName}',deviceId='{deviceId}'){?%24top,%24skip,%24search,%24filter,%24count}"
