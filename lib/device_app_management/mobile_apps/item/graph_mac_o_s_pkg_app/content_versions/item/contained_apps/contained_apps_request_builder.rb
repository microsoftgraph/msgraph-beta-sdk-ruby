                        ...
                        module Item
                            module ContainedApps
                                ...
                                class ContainedAppsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphMacOSPkgApp::ContentVersions::Item::ContainedApps::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the containedApps property of the microsoft.graph.mobileAppContent entity.
                                    ...
                                    def by_mobile_contained_app_id(mobile_contained_app_id)
                                        ...
                                        return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::GraphMacOSPkgApp::ContentVersions::Item::ContainedApps::Item::MobileContainedAppItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSPkgApp/contentVersions/{mobileAppContent%2Did}/containedApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                    end
                                    ## 
                                    ...
                                    def to_post_request_information(body, request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSPkgApp/contentVersions/{mobileAppContent%2Did}/containedApps'
                                        request_info.path_parameters = @path_parameters
