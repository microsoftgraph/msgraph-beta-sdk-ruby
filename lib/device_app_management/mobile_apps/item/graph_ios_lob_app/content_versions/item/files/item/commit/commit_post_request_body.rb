                                    ...
                                    module Commit
                                        class CommitPostRequestBody
                                            ...
                                            def get_field_deserializers()
                                                return {
                                                    "fileEncryptionInfo" => lambda {|n| @file_encryption_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::FileEncryptionInfo.create_from_discriminator_value(pn) }) },
                                                }
                                            end
                                            ## 
