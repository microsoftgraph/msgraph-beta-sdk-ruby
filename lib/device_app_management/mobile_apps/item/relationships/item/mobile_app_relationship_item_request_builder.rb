...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::Relationships::Item
    ## 
    ...
    class MobileAppRelationshipItemRequestBuilder
        ...
        ## @param mobileAppRelationshipId key: id of mobileAppRelationship
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, mobile_app_relationship_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/relationships/{mobileAppRelationship%2Did}{?%24select,%24expand}"
