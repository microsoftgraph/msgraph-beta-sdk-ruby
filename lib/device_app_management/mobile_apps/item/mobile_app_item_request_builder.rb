...
require_relative './microsoft_graph_get_related_app_states_with_user_principal_name_with_device_id/get_related_app_states_with_user_principal_name_with_device_id_request_builder'
...
require_relative './microsoft_graph_update_relationships/update_relationships_request_builder'
...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item
    ## 
    ...
    class MobileAppItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to managedMobileLobApp.
        def microsoft_graph_managed_mobile_lob_app()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::MicrosoftGraphManagedMobileLobApp::ManagedMobileLobAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to mobileLobApp.
        def microsoft_graph_mobile_lob_app()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::MicrosoftGraphMobileLobApp::MobileLobAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRelationships method.
        def microsoft_graph_update_relationships()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::MicrosoftGraphUpdateRelationships::UpdateRelationshipsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a get_related_app_states_with_user_principal_name_with_device_id_request_builder
        ## 
        def microsoft_graph_get_related_app_states_with_user_principal_name_with_device_id(device_id, user_principal_name)
            ...
            return GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder.new(@path_parameters, @request_adapter, deviceId, userPrincipalName)
        end
        ## 
