...
require_relative './get_related_app_states_with_user_principal_name_with_device_id/get_related_app_states_with_user_principal_name_with_device_id_request_builder'
...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item
    ...
    class MobileAppItemRequestBuilder
        ...
        def assign()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::Assign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def managed_mobile_lob_app()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::ManagedMobileLobApp::ManagedMobileLobAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to mobileLobApp.
        def mobile_lob_app()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::MobileLobApp::MobileLobAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def update_relationships()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::UpdateRelationships::UpdateRelationshipsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## 
        def get_related_app_states_with_user_principal_name_with_device_id(device_id, user_principal_name)
