        ...
        module ManagedAppRegistrations
            ...
            class ManagedAppRegistrationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def get_user_ids_with_flagged_app_registration()
                    return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::GetUserIdsWithFlaggedAppRegistration::GetUserIdsWithFlaggedAppRegistrationRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the managedAppRegistrations property of the microsoft.graph.deviceAppManagement entity.
