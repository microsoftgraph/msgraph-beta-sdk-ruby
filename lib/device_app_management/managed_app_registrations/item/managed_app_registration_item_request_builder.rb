...
require_relative './managed_app_log_collection_requests/managed_app_log_collection_requests_request_builder'
            ...
            module Item
                ...
                class ManagedAppRegistrationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def managed_app_log_collection_requests()
                        return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::ManagedAppLogCollectionRequests::ManagedAppLogCollectionRequestsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
