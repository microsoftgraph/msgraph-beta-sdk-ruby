...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::AppliedPolicies::Item
    ...
    class ManagedAppPolicyItemRequestBuilder
        ...
        def microsoft_graph_target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::AppliedPolicies::Item::MicrosoftGraphTargetApps::MicrosoftGraphTargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
