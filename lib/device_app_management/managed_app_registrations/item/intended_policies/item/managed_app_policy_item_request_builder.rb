...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::IntendedPolicies::Item
    ...
    class ManagedAppPolicyItemRequestBuilder
        ...
        def microsoft_graph_target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::IntendedPolicies::Item::MicrosoftGraphTargetApps::TargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
