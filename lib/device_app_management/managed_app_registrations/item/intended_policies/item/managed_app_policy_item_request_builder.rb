...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::IntendedPolicies::Item
    ## 
    ...
    class ManagedAppPolicyItemRequestBuilder
        ...
        def microsoft_graph_target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::IntendedPolicies::Item::MicrosoftGraphTargetApps::MicrosoftGraphTargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
