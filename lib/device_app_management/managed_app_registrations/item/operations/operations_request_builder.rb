            ...
            module Item
                module Operations
                    ...
                    class OperationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::Operations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the operations property of the microsoft.graph.managedAppRegistration entity.
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedAppOperationCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedAppOperation.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Zero or more long running operations triggered on the app registration.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
