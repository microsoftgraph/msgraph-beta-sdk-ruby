...
require_relative './microsoft_graph_revoke_licenses/microsoft_graph_revoke_licenses_request_builder'
        ...
        module VppTokens
            module Item
                ...
                class VppTokenItemRequestBuilder
                    ...
                    def microsoft_graph_revoke_licenses()
                        return MicrosoftGraphBeta::DeviceAppManagement::VppTokens::Item::MicrosoftGraphRevokeLicenses::MicrosoftGraphRevokeLicensesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the syncLicenses method.
                    def microsoft_graph_sync_licenses()
                        return MicrosoftGraphBeta::DeviceAppManagement::VppTokens::Item::MicrosoftGraphSyncLicenses::MicrosoftGraphSyncLicensesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
