...
require_relative './microsoft_graph_revoke_licenses/revoke_licenses_request_builder'
...
module MicrosoftGraphBeta::DeviceAppManagement::VppTokens::Item
    ...
    class VppTokenItemRequestBuilder
        ...
        def microsoft_graph_revoke_licenses()
            return MicrosoftGraphBeta::DeviceAppManagement::VppTokens::Item::MicrosoftGraphRevokeLicenses::RevokeLicensesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the syncLicenses method.
        def microsoft_graph_sync_licenses()
            return MicrosoftGraphBeta::DeviceAppManagement::VppTokens::Item::MicrosoftGraphSyncLicenses::SyncLicensesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
