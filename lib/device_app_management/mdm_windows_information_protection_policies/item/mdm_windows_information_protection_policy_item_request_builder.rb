        ...
        module MdmWindowsInformationProtectionPolicies
            module Item
                ...
                class MdmWindowsInformationProtectionPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def assignments()
                        return MicrosoftGraphBeta::DeviceAppManagement::MdmWindowsInformationProtectionPolicies::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def exempt_app_locker_files()
                        return MicrosoftGraphBeta::DeviceAppManagement::MdmWindowsInformationProtectionPolicies::Item::ExemptAppLockerFiles::ExemptAppLockerFilesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def protected_app_locker_files()
                        return MicrosoftGraphBeta::DeviceAppManagement::MdmWindowsInformationProtectionPolicies::Item::ProtectedAppLockerFiles::ProtectedAppLockerFilesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
