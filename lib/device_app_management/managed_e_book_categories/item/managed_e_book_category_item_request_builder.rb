...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedEBookCategories::Item
    ## 
    ...
    class ManagedEBookCategoryItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, managed_e_book_category_id=nil)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/managedEBookCategories/{managedEBookCategory%2Did}{?%24select,%24expand}"
