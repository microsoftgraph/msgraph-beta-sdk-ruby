...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedEBookCategories::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/managedEBookCategories/$count{?%24search,%24filter}"
