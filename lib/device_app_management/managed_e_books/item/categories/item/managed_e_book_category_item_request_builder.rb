...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::Categories::Item
    ## 
    ...
    class ManagedEBookCategoryItemRequestBuilder
        ...
        ## @param managedEBookCategoryId key: id of managedEBookCategory
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, managed_e_book_category_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/categories/{managedEBookCategory%2Did}{?%24select,%24expand}"
