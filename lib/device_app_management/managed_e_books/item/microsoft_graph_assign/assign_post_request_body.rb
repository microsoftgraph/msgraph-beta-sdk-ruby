...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::MicrosoftGraphAssign
    class AssignPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "managedEBookAssignments" => lambda {|n| @managed_e_book_assignments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedEBookAssignment.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
