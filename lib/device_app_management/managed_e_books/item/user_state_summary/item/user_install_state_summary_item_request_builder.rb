...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::UserStateSummary::Item
    ## 
    ...
    class UserInstallStateSummaryItemRequestBuilder
        ...
        def device_states()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::UserStateSummary::Item::DeviceStates::DeviceStatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
