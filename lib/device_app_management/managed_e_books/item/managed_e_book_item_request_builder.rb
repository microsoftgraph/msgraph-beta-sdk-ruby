...
require_relative './categories/item/managed_e_book_category_item_request_builder'
...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item
    ## 
    ...
    class ManagedEBookItemRequestBuilder
        ...
        def assignments()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the categories property of the microsoft.graph.managedEBook entity.
        def categories()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::Categories::CategoriesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the deviceStates property of the microsoft.graph.managedEBook entity.
        def device_states()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::DeviceStates::DeviceStatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the installSummary property of the microsoft.graph.managedEBook entity.
        def install_summary()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::InstallSummary::InstallSummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assign method.
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_state_summary()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::UserStateSummary::UserStateSummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the assignments property of the microsoft.graph.managedEBook entity.
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::Assignments::Item::ManagedEBookAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the categories property of the microsoft.graph.managedEBook entity.
        ## @param id Unique identifier of the item
        ...
        def categories_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::Categories::Item::ManagedEBookCategoryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def device_states_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::DeviceStates::Item::DeviceInstallStateItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## The Managed eBook.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedEBook.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ...
        def user_state_summary_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::UserStateSummary::Item::UserInstallStateSummaryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
