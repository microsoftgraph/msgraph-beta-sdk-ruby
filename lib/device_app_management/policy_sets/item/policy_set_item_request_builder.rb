...
require_relative './microsoft_graph_update/update_request_builder'

module MicrosoftGraphBeta::DeviceAppManagement::PolicySets::Item
    ## 
    ...
    class PolicySetItemRequestBuilder
        ...
        def microsoft_graph_update()
            return MicrosoftGraphBeta::DeviceAppManagement::PolicySets::Item::MicrosoftGraphUpdate::UpdateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param policySetId key: id of policySet
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, policy_set_id=nil)
