...
require_relative './microsoft_graph_update/microsoft_graph_update_request_builder'
...
module MicrosoftGraphBeta::DeviceAppManagement::PolicySets::Item
    ...
    class PolicySetItemRequestBuilder
        ...
        def microsoft_graph_update()
            return MicrosoftGraphBeta::DeviceAppManagement::PolicySets::Item::MicrosoftGraphUpdate::MicrosoftGraphUpdateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
