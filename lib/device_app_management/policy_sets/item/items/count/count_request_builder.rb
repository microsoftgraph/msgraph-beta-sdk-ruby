...
module MicrosoftGraphBeta::DeviceAppManagement::PolicySets::Item::Items::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/policySets/{policySet%2Did}/items/$count{?%24search,%24filter}"
