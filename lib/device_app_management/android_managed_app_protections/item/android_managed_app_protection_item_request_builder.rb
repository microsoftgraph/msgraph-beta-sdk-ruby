        ...
        module AndroidManagedAppProtections
            module Item
                ...
                class AndroidManagedAppProtectionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def assignments()
                        return MicrosoftGraphBeta::DeviceAppManagement::AndroidManagedAppProtections::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
