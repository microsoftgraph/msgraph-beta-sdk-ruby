                ...
                module TargetApps
                    class TargetAppsPostRequestBody
                        ...
                        def get_field_deserializers()
                            return {
                                "appGroupType" => lambda {|n| @app_group_type = n.get_enum_value(MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::TargetApps::TargetAppsPostRequestBodyAppGroupType) },
