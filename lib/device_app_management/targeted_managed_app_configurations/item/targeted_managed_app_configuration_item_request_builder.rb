...
module MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item
    ...
    class TargetedManagedAppConfigurationItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the targetApps method.
        def microsoft_graph_target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::MicrosoftGraphTargetApps::TargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
