...
module MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item
    ...
    class TargetedManagedAppConfigurationItemRequestBuilder
        ...
        def apps()
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::Apps::AppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the assignments property of the microsoft.graph.targetedManagedAppConfiguration entity.
        def assignments()
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def deployment_summary()
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::DeploymentSummary::DeploymentSummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assign method.
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the targetApps method.
        def microsoft_graph_target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::MicrosoftGraphTargetApps::MicrosoftGraphTargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def apps_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::Apps::Item::ManagedMobileAppItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the assignments property of the microsoft.graph.targetedManagedAppConfiguration entity.
        ## @param id Unique identifier of the item
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::Assignments::Item::TargetedManagedAppPolicyAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TargetedManagedAppConfiguration.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
