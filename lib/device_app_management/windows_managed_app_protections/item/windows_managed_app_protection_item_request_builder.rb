...
module MicrosoftGraphBeta::DeviceAppManagement::WindowsManagedAppProtections::Item
    ...
    class WindowsManagedAppProtectionItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceAppManagement::WindowsManagedAppProtections::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the targetApps method.
        def microsoft_graph_target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::WindowsManagedAppProtections::Item::MicrosoftGraphTargetApps::MicrosoftGraphTargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
