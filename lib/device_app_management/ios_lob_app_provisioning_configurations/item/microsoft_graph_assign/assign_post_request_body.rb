...
module MicrosoftGraphBeta::DeviceAppManagement::IosLobAppProvisioningConfigurations::Item::MicrosoftGraphAssign
    class AssignPostRequestBody
        ...
        ## @param value Value to set for the app_provisioning_configuration_group_assignments property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the i_o_s_lob_app_provisioning_config_assignments property.
        ## @return a void
        ## 
