...
module MicrosoftGraphBeta::DeviceAppManagement::IosLobAppProvisioningConfigurations::Item::GroupAssignments::Item
    ...
    class MobileAppProvisioningConfigGroupAssignmentItemRequestBuilder
        ...
        ## @param mobileAppProvisioningConfigGroupAssignmentId key: id of mobileAppProvisioningConfigGroupAssignment
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, mobile_app_provisioning_config_group_assignment_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceAppManagement/iosLobAppProvisioningConfigurations/{iosLobAppProvisioningConfiguration%2Did}/groupAssignments/{mobileAppProvisioningConfigGroupAssignment%2Did}{?%24select,%24expand}"
