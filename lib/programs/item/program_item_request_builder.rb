...
module MicrosoftGraphBeta::Programs::Item
    ## 
    ...
    class ProgramItemRequestBuilder
        ...
        def controls()
            return MicrosoftGraphBeta::Programs::Item::Controls::ControlsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param programId key: id of program
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, program_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/programs/{program%2Did}{?%24select,%24expand}"
