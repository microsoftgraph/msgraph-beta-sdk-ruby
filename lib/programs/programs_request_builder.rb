...
require_relative '../models/program_collection_response'
require_relative './count/count_request_builder'
require_relative './item/program_item_request_builder'
...
module MicrosoftGraphBeta
    module Programs
        ...
        class ProgramsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            
            ## 
            # Provides operations to count the resources in the collection.
            def count()
                return MicrosoftGraphBeta::Programs::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ## Provides operations to manage the collection of program entities.
            ...
            ## 
            def by_program_id(program_id)
                raise StandardError, 'program_id cannot be null' if program_id.nil?
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/programs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/programs'
                request_info.path_parameters = @path_parameters
