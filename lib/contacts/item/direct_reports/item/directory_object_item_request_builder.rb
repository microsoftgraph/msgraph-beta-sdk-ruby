                ...
                module Item
                    ...
                    class DirectoryObjectItemRequestBuilder
                        ...
                        def graph_org_contact()
                            return MicrosoftGraphBeta::Contacts::Item::DirectReports::Item::GraphOrgContact::GraphOrgContactRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Casts the previous resource to user.
                        def graph_user()
                            return MicrosoftGraphBeta::Contacts::Item::DirectReports::Item::GraphUser::GraphUserRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
