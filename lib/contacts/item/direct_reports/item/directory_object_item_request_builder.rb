...
module MicrosoftGraphBeta::Contacts::Item::DirectReports::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def org_contact()
            return MicrosoftGraphBeta::Contacts::Item::DirectReports::Item::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Contacts::Item::DirectReports::Item::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
