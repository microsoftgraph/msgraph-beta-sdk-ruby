...
module MicrosoftGraphBeta::Contacts::Item::DirectReports
    ## 
    ...
    class DirectReportsRequestBuilder
        ...
        def microsoft_graph_org_contact()
            return MicrosoftGraphBeta::Contacts::Item::DirectReports::MicrosoftGraphOrgContact::MicrosoftGraphOrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::Contacts::Item::DirectReports::MicrosoftGraphUser::MicrosoftGraphUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
