...
module MicrosoftGraphBeta::Contacts::Item::DirectReports
    ...
    class DirectReportsRequestBuilder
        ...
        def org_contact()
            return MicrosoftGraphBeta::Contacts::Item::DirectReports::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Contacts::Item::DirectReports::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
