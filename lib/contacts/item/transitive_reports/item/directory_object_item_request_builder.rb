...
module MicrosoftGraphBeta::Contacts::Item::TransitiveReports::Item
    ## 
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/contacts/{orgContact%2Did}/transitiveReports/{directoryObject%2Did}{?%24select,%24expand}"
