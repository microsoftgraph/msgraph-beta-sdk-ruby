...
module MicrosoftGraphBeta::Contacts::Item::TransitiveMemberOf::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Contacts::Item::TransitiveMemberOf::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
