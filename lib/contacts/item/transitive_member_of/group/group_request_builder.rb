...
module MicrosoftGraphBeta::Contacts::Item::TransitiveMemberOf::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Contacts::Item::TransitiveMemberOf::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
