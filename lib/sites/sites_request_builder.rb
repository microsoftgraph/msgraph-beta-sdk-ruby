...
module MicrosoftGraphBeta::Sites
    ## 
    ...
    class SitesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Sites::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the add method.
        def microsoft_graph_add()
            return MicrosoftGraphBeta::Sites::MicrosoftGraphAdd::MicrosoftGraphAddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Sites::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the remove method.
        def microsoft_graph_remove()
            return MicrosoftGraphBeta::Sites::MicrosoftGraphRemove::MicrosoftGraphRemoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
