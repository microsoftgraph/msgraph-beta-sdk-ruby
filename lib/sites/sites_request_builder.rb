...
module MicrosoftGraphBeta
    module Sites
        ...
        class SitesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def add()
                return MicrosoftGraphBeta::Sites::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def delta()
                return MicrosoftGraphBeta::Sites::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the getAllSites method.
            def get_all_sites()
                return MicrosoftGraphBeta::Sites::GetAllSites::GetAllSitesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the remove method.
            def remove()
                return MicrosoftGraphBeta::Sites::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ## Provides operations to manage the collection of site entities.
