            ...
            module ContentModels
                module Item
                    ...
                    class ContentModelItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def add_to_drive()
                            return MicrosoftGraphBeta::Sites::Item::ContentModels::Item::AddToDrive::AddToDriveRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getAppliedDrives method.
                        def get_applied_drives()
                            return MicrosoftGraphBeta::Sites::Item::ContentModels::Item::GetAppliedDrives::GetAppliedDrivesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the removeFromDrive method.
                        def remove_from_drive()
                            return MicrosoftGraphBeta::Sites::Item::ContentModels::Item::RemoveFromDrive::RemoveFromDriveRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/contentModels/{contentModel%2Did}{?%24expand,%24select}")
                        end
                        ## 
