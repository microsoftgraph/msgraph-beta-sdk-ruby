                                            ...
                                            module Item
                                                module Relations
                                                    ...
                                                    class RelationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                        ...
                                                        def count()
                                                            return MicrosoftGraphBeta::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item::Children::Item::Relations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
