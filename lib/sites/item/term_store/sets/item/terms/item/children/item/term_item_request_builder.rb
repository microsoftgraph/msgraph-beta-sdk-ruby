...
module MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Terms::Item::Children::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def relations()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Terms::Item::Children::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Terms::Item::Children::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Terms::Item::Children::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property children for sites
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
