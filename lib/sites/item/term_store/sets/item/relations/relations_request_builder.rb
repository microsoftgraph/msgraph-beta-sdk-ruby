                    ...
                    module Item
                        module Relations
                            ...
                            class RelationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Relations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the relations property of the microsoft.graph.termStore.set entity.
                                ...
                                def by_relation_id(relation_id)
                                    ...
                                    return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
