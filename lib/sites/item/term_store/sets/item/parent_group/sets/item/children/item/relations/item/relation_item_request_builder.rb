                                            ...
                                            module Relations
                                                module Item
                                                    ...
                                                    class RelationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                        ...
                                                        def from_term()
                                                            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Children::Item::Relations::Item::FromTerm::FromTermRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to manage the set property of the microsoft.graph.termStore.relation entity.
                                                        def set()
                                                            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Children::Item::Relations::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to manage the toTerm property of the microsoft.graph.termStore.relation entity.
                                                        def to_term()
                                                            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Children::Item::Relations::Item::ToTerm::ToTermRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
