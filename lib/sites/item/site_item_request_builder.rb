...
require_relative './page_templates/page_templates_request_builder'
    ...
    module Sites
        module Item
            ...
            class SiteItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def archive()
                    return MicrosoftGraphBeta::Sites::Item::Archive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def content_models()
                    return MicrosoftGraphBeta::Sites::Item::ContentModels::ContentModelsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def created_by_user()
                    return MicrosoftGraphBeta::Sites::Item::CreatedByUser::CreatedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def document_processing_jobs()
                    return MicrosoftGraphBeta::Sites::Item::DocumentProcessingJobs::DocumentProcessingJobsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def last_modified_by_user()
                    return MicrosoftGraphBeta::Sites::Item::LastModifiedByUser::LastModifiedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def page_templates()
                    return MicrosoftGraphBeta::Sites::Item::PageTemplates::PageTemplatesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def recycle_bin()
                    return MicrosoftGraphBeta::Sites::Item::RecycleBin::RecycleBinRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def unarchive()
                    return MicrosoftGraphBeta::Sites::Item::Unarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
