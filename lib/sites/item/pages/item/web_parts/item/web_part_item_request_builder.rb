                        ...
                        module Item
                            ...
                            class WebPartItemRequestBuilder
                                ...
                                def microsoft_graph_get_position_of_web_part()
                                    return MicrosoftGraphBeta::Sites::Item::Pages::Item::WebParts::Item::MicrosoftGraphGetPositionOfWebPart::MicrosoftGraphGetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
