                            ...
                            module Item
                                ...
                                class WebPartItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def get_position_of_web_part()
                                        return MicrosoftGraphBeta::Sites::Item::Pages::Item::GraphSitePage::WebParts::Item::GetPositionOfWebPart::GetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/webParts/{webPart%2Did}{?%24select,%24expand}")
                                    end
                                    ## 
