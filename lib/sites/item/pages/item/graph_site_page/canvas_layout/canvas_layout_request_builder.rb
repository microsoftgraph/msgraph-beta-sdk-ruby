                        ...
                        module CanvasLayout
                            ...
                            class CanvasLayoutRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def horizontal_sections()
                                    return MicrosoftGraphBeta::Sites::Item::Pages::Item::GraphSitePage::CanvasLayout::HorizontalSections::HorizontalSectionsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def vertical_section()
                                    return MicrosoftGraphBeta::Sites::Item::Pages::Item::GraphSitePage::CanvasLayout::VerticalSection::VerticalSectionRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/canvasLayout{?%24select,%24expand}")
                                end
                                ## 
