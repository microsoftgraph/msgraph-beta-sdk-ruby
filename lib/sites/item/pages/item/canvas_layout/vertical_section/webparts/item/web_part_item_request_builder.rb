...
module MicrosoftGraphBeta::Sites::Item::Pages::Item::CanvasLayout::VerticalSection::Webparts::Item
    ## 
    ...
    class WebPartItemRequestBuilder
        ...
        def microsoft_graph_get_position_of_web_part()
            return MicrosoftGraphBeta::Sites::Item::Pages::Item::CanvasLayout::VerticalSection::Webparts::Item::MicrosoftGraphGetPositionOfWebPart::GetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, web_part_id=nil)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/verticalSection/webparts/{webPart%2Did}{?%24select,%24expand}"
