...
module MicrosoftGraphBeta::Sites::Item::Pages::Item::CanvasLayout::VerticalSection::Webparts
    ## 
    ...
    class WebpartsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/verticalSection/webparts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
