...
module MicrosoftGraphBeta::Sites::Item::Pages::Item::CanvasLayout::HorizontalSections::Item::Columns::Item::Webparts::Item
    ...
    class WebPartItemRequestBuilder
        ...
        def microsoft_graph_get_position_of_web_part()
            return MicrosoftGraphBeta::Sites::Item::Pages::Item::CanvasLayout::HorizontalSections::Item::Columns::Item::Webparts::Item::MicrosoftGraphGetPositionOfWebPart::MicrosoftGraphGetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
