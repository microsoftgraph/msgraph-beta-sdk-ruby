                ...
                module Item
                    ...
                    class PermissionItemRequestBuilder
                        ...
                        def microsoft_graph_grant()
                            return MicrosoftGraphBeta::Sites::Item::Permissions::Item::MicrosoftGraphGrant::MicrosoftGraphGrantRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the revokeGrants method.
                        def microsoft_graph_revoke_grants()
                            return MicrosoftGraphBeta::Sites::Item::Permissions::Item::MicrosoftGraphRevokeGrants::MicrosoftGraphRevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
