...
module MicrosoftGraphBeta::Sites::Item::Permissions::Item::MicrosoftGraphRevokeGrants
    ## 
    ...
    class RevokeGrantsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/permissions/{permission%2Did}/microsoft.graph.revokeGrants"
