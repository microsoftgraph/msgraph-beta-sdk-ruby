                            ...
                            module Count
                                ...
                                class CountRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/createdByUser/serviceProvisioningErrors/$count{?%24filter,%24search}")
                                    end
                                    ## 
