                                            ...
                                            module Item
                                                ...
                                                class WebPartItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                    ...
                                                    def get_position_of_web_part()
                                                        return MicrosoftGraphBeta::Sites::Item::PageTemplates::Item::CanvasLayout::HorizontalSections::Item::Columns::Item::Webparts::Item::GetPositionOfWebPart::GetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    ...
                                                    def initialize(path_parameters, request_adapter)
                                                        super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout/horizontalSections/{horizontalSection%2Did}/columns/{horizontalSectionColumn%2Did}/webparts/{webPart%2Did}{?%24expand,%24select}")
                                                    end
                                                    ## 
