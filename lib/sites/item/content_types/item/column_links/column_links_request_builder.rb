                ...
                module Item
                    module ColumnLinks
                        ...
                        class ColumnLinksRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::Sites::Item::ContentTypes::Item::ColumnLinks::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
                            ...
                            def by_column_link_id(column_link_id)
                                ...
                                return MicrosoftGraphBeta::Sites::Item::ContentTypes::Item::ColumnLinks::Item::ColumnLinkItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
