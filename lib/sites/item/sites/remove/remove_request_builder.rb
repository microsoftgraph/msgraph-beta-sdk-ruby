                ...
                module Remove
                    ...
                    class RemoveRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Sites::Item::Sites::Remove::RemovePostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Unfollow a user's site or multiple sites.
                        ## @param body The request body
