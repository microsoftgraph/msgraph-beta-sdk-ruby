        ...
        module Item
            module Sites
                ...
                class SitesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def add()
                        return MicrosoftGraphBeta::Sites::Item::Sites::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def remove()
                        return MicrosoftGraphBeta::Sites::Item::Sites::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the sites property of the microsoft.graph.site entity.
