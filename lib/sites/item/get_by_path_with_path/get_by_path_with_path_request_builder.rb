        ...
        module Item
            module GetByPathWithPath
                ...
                class GetByPathWithPathRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def analytics()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the archive method.
                    def archive()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Archive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the columns property of the microsoft.graph.site entity.
                    def columns()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Columns::ColumnsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the contentModels property of the microsoft.graph.site entity.
                    def content_models()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::ContentModels::ContentModelsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the contentTypes property of the microsoft.graph.site entity.
                    def content_types()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::ContentTypes::ContentTypesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the createdByUser property of the microsoft.graph.baseItem entity.
                    def created_by_user()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::CreatedByUser::CreatedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def document_processing_jobs()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::DocumentProcessingJobs::DocumentProcessingJobsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the drive property of the microsoft.graph.site entity.
                    def drive()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Drive::DriveRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the drives property of the microsoft.graph.site entity.
                    def drives()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Drives::DrivesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the externalColumns property of the microsoft.graph.site entity.
                    def external_columns()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::ExternalColumns::ExternalColumnsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def information_protection()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::InformationProtection::InformationProtectionRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the items property of the microsoft.graph.site entity.
                    def items()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the lastModifiedByUser property of the microsoft.graph.baseItem entity.
                    def last_modified_by_user()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::LastModifiedByUser::LastModifiedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the lists property of the microsoft.graph.site entity.
                    def lists()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Lists::ListsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the onenote property of the microsoft.graph.site entity.
                    def onenote()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Onenote::OnenoteRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the operations property of the microsoft.graph.site entity.
                    def operations()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the pages property of the microsoft.graph.site entity.
                    def pages()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the pageTemplates property of the microsoft.graph.site entity.
                    def page_templates()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::PageTemplates::PageTemplatesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the permissions property of the microsoft.graph.site entity.
                    def permissions()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Permissions::PermissionsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the recycleBin property of the microsoft.graph.site entity.
                    def recycle_bin()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::RecycleBin::RecycleBinRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the sites property of the microsoft.graph.site entity.
                    def sites()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Sites::SitesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the termStore property of the microsoft.graph.site entity.
                    def term_store()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::TermStore::TermStoreRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the unarchive method.
                    def unarchive()
                        return MicrosoftGraphBeta::Sites::Item::GetByPathWithPath::Unarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
