...
module MicrosoftGraphBeta::Sites::Item::Onenote::Notebooks::Item::Sections::Item
    ...
    class OnenoteSectionItemRequestBuilder
        ...
        def copy_to_notebook()
            return MicrosoftGraphBeta::Sites::Item::Onenote::Notebooks::Item::Sections::Item::CopyToNotebook::CopyToNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSectionGroup method.
        def copy_to_section_group()
            return MicrosoftGraphBeta::Sites::Item::Onenote::Notebooks::Item::Sections::Item::CopyToSectionGroup::CopyToSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
