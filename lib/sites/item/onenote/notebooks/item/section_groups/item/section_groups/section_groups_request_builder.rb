                            ...
                            module Item
                                module SectionGroups
                                    ...
                                    class SectionGroupsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def count()
                                            return MicrosoftGraphBeta::Sites::Item::Onenote::Notebooks::Item::SectionGroups::Item::SectionGroups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ## Provides operations to manage the sectionGroups property of the microsoft.graph.sectionGroup entity.
                                        ...
                                        def by_section_group_id1(section_group_id1)
                                            ...
                                            return MicrosoftGraphBeta::Sites::Item::Onenote::Notebooks::Item::SectionGroups::Item::SectionGroups::Item::SectionGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                        end
                                        ## 
