...
module MicrosoftGraphBeta::Sites::Item::Onenote::Notebooks
    ...
    class NotebooksRequestBuilder
        ...
        def microsoft_graph_get_notebook_from_web_url()
            return MicrosoftGraphBeta::Sites::Item::Onenote::Notebooks::MicrosoftGraphGetNotebookFromWebUrl::GetNotebookFromWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
