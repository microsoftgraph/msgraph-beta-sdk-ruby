            ...
            module Onenote
                module Resources
                    ...
                    class ResourcesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Sites::Item::Onenote::Resources::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the resources property of the microsoft.graph.onenote entity.
                        ...
                        def by_onenote_resource_id(onenote_resource_id)
                            ...
                            return MicrosoftGraphBeta::Sites::Item::Onenote::Resources::Item::OnenoteResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::OnenoteResourceCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
