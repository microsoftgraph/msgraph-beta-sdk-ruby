        ...
        module Item
            module Lists
                ...
                class ListsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Sites::Item::Lists::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the lists property of the microsoft.graph.site entity.
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ListCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
