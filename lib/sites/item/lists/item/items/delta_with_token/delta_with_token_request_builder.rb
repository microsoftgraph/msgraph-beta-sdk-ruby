                        ...
                        module DeltaWithToken
                            ...
                            class DeltaWithTokenRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter, token=nil)
                                    super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/delta(token='{token}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}")
                                end
                                ## 
                                ...
                                def get(request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Sites::Item::Lists::Item::Items::DeltaWithToken::DeltaWithTokenGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Invoke function delta
                                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
