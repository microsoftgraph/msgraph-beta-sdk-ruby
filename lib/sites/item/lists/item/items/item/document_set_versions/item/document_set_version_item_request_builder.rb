...
module MicrosoftGraphBeta::Sites::Item::Lists::Item::Items::Item::DocumentSetVersions::Item
    ## 
    ...
    class DocumentSetVersionItemRequestBuilder
        ...
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::Sites::Item::Lists::Item::Items::Item::DocumentSetVersions::Item::MicrosoftGraphRestore::MicrosoftGraphRestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
