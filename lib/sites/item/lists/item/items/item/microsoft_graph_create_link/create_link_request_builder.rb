...
module MicrosoftGraphBeta::Sites::Item::Lists::Item::Items::Item::MicrosoftGraphCreateLink
    ## 
    ...
    class CreateLinkRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/microsoft.graph.createLink"
