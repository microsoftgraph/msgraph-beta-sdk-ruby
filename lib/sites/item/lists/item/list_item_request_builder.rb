            ...
            module Lists
                module Item
                    ...
                    class ListItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def created_by_user()
                            return MicrosoftGraphBeta::Sites::Item::Lists::Item::CreatedByUser::CreatedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def last_modified_by_user()
                            return MicrosoftGraphBeta::Sites::Item::Lists::Item::LastModifiedByUser::LastModifiedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
