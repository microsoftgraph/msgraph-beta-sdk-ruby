...
module MicrosoftGraphBeta::Sites::Item::InformationProtection::Policy::Labels::MicrosoftGraphExtractLabel
    ## 
    ...
    class ExtractLabelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/informationProtection/policy/labels/microsoft.graph.extractLabel"
