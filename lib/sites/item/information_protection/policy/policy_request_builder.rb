...
module MicrosoftGraphBeta::Sites::Item::InformationProtection::Policy
    ## 
    ...
    class PolicyRequestBuilder
        ...
        def labels()
            return MicrosoftGraphBeta::Sites::Item::InformationProtection::Policy::Labels::LabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/informationProtection/policy{?%24select,%24expand}"
