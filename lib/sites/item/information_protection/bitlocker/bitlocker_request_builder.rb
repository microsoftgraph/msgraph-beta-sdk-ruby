...
module MicrosoftGraphBeta::Sites::Item::InformationProtection::Bitlocker
    ## 
    ...
    class BitlockerRequestBuilder
        ...
        def recovery_keys()
            return MicrosoftGraphBeta::Sites::Item::InformationProtection::Bitlocker::RecoveryKeys::RecoveryKeysRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/informationProtection/bitlocker{?%24select,%24expand}"
        ...
        def recovery_keys_by_id(id)
            ...
            return MicrosoftGraphBeta::Sites::Item::InformationProtection::Bitlocker::RecoveryKeys::Item::BitlockerRecoveryKeyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get bitlocker from sites
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
