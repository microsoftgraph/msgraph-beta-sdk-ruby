...
module MicrosoftGraphBeta::Sites::Item::InformationProtection
    ## 
    ...
    class InformationProtectionRequestBuilder
        ...
        def microsoft_graph_decrypt_buffer()
            return MicrosoftGraphBeta::Sites::Item::InformationProtection::MicrosoftGraphDecryptBuffer::MicrosoftGraphDecryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the encryptBuffer method.
        def microsoft_graph_encrypt_buffer()
            return MicrosoftGraphBeta::Sites::Item::InformationProtection::MicrosoftGraphEncryptBuffer::MicrosoftGraphEncryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the signDigest method.
        def microsoft_graph_sign_digest()
            return MicrosoftGraphBeta::Sites::Item::InformationProtection::MicrosoftGraphSignDigest::MicrosoftGraphSignDigestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the verifySignature method.
        def microsoft_graph_verify_signature()
            return MicrosoftGraphBeta::Sites::Item::InformationProtection::MicrosoftGraphVerifySignature::MicrosoftGraphVerifySignatureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/informationProtection{?%24select,%24expand}"
