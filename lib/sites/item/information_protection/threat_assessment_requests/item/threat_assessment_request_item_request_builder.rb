...
module MicrosoftGraphBeta::Sites::Item::InformationProtection::ThreatAssessmentRequests::Item
    ## 
    ...
    class ThreatAssessmentRequestItemRequestBuilder
        ...
        def results()
            return MicrosoftGraphBeta::Sites::Item::InformationProtection::ThreatAssessmentRequests::Item::Results::ResultsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}{?%24select,%24expand}"
        ...
        def results_by_id(id)
            ...
            return MicrosoftGraphBeta::Sites::Item::InformationProtection::ThreatAssessmentRequests::Item::Results::Item::ThreatAssessmentResultItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property threatAssessmentRequests for sites
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
