...
module MicrosoftGraphBeta::Sites::Item::InformationProtection::SensitivityLabels::Item::Sublabels::Item
    ## 
    ...
    class SensitivityLabelItemRequestBuilder
        ...
        ## @param sensitivityLabelId1 key: id of sensitivityLabel
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, sensitivity_label_id1=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/{sensitivityLabel%2Did1}{?%24select,%24expand}"
