...
module MicrosoftGraphBeta::Sites::Item::InformationProtection::SensitivityLabels::Item::Sublabels::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/$count{?%24search,%24filter}"
