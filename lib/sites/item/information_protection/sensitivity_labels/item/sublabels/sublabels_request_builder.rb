                    ...
                    module Item
                        module Sublabels
                            ...
                            class SublabelsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::Sites::Item::InformationProtection::SensitivityLabels::Item::Sublabels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the evaluate method.
                                def evaluate()
                                    return MicrosoftGraphBeta::Sites::Item::InformationProtection::SensitivityLabels::Item::Sublabels::Evaluate::EvaluateRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the sublabels property of the microsoft.graph.sensitivityLabel entity.
                                ...
                                def by_sensitivity_label_id1(sensitivity_label_id1)
                                    ...
                                    return MicrosoftGraphBeta::Sites::Item::InformationProtection::SensitivityLabels::Item::Sublabels::Item::SensitivityLabelItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
                                ...
                                def to_post_request_information(body, request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels'
                                    request_info.path_parameters = @path_parameters
                                ...
                                ## @return a sublabels_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return SublabelsRequestBuilder.new(raw_url, @request_adapter)
                                end
