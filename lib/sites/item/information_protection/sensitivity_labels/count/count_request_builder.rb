...
module MicrosoftGraphBeta::Sites::Item::InformationProtection::SensitivityLabels::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/$count{?%24search,%24filter}"
