...
module MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotSettings::Sync
    ## 
    ...
    class SyncRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/windowsAutopilotSettings/microsoft.graph.sync"
