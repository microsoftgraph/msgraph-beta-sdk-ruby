...
require_relative './microsoft_graph_update_language_files'

module MicrosoftGraphBeta::DeviceManagement::GroupPolicyUploadedDefinitionFiles::Item::MicrosoftGraphUpdateLanguageFiles
    class UpdateLanguageFilesPostRequestBody
        ...
        ## @return a update_language_files_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return UpdateLanguageFilesPostRequestBody.new
        end
        ## 
        ...
        ## @param value Value to set for the group_policy_uploaded_language_files property.
        ## @return a void
        ## 
