...
require_relative './revoke_leaf_certificate_by_serial_number'

module MicrosoftGraphBeta
    module DeviceManagement
        module CloudCertificationAuthority
            module Item
                module RevokeLeafCertificateBySerialNumber
                    class RevokeLeafCertificateBySerialNumberPostRequestBody
                        ...
                        ## 
                        ## Instantiates a new RevokeLeafCertificateBySerialNumberPostRequestBody and sets the default values.
                        ## @return a void
                        ## 
                        def initialize()
                        ...
                        ## @return a revoke_leaf_certificate_by_serial_number_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return RevokeLeafCertificateBySerialNumberPostRequestBody.new
                        end
                        ## 
