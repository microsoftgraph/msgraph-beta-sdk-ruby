...
module MicrosoftGraphBeta::DeviceManagement::AdvancedThreatProtectionOnboardingStateSummary::AdvancedThreatProtectionOnboardingDeviceSettingStates::Item
    ...
    class AdvancedThreatProtectionOnboardingDeviceSettingStateItemRequestBuilder
        ...
        ## @param advancedThreatProtectionOnboardingDeviceSettingStateId key: id of advancedThreatProtectionOnboardingDeviceSettingState
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, advanced_threat_protection_onboarding_device_setting_state_id=nil)
