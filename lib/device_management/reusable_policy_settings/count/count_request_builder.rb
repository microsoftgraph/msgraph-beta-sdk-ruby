...
module MicrosoftGraphBeta::DeviceManagement::ReusablePolicySettings::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/reusablePolicySettings/$count{?%24search,%24filter}"
