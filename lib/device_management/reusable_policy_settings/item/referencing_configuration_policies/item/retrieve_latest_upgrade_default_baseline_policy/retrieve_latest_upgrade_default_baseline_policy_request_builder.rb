...
require_relative '../item'
require_relative './retrieve_latest_upgrade_default_baseline_policy'
        ...
        module ReusablePolicySettings
            module Item
                module ReferencingConfigurationPolicies
                    module Item
                        module RetrieveLatestUpgradeDefaultBaselinePolicy
                            ## 
                            # Provides operations to call the retrieveLatestUpgradeDefaultBaselinePolicy method.
                            class RetrieveLatestUpgradeDefaultBaselinePolicyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/reusablePolicySettings/{deviceManagementReusablePolicySetting%2Did}/referencingConfigurationPolicies/{deviceManagementConfigurationPolicy%2Did}/retrieveLatestUpgradeDefaultBaselinePolicy()")
                                end
                                ## 
                                ...
                                ## @return a retrieve_latest_upgrade_default_baseline_policy_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return RetrieveLatestUpgradeDefaultBaselinePolicyRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
