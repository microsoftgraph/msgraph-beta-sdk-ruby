...
module MicrosoftGraphBeta::DeviceManagement::ReusablePolicySettings::Item::ReferencingConfigurationPolicies::Item
    ...
    class DeviceManagementConfigurationPolicyItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::ReusablePolicySettings::Item::ReferencingConfigurationPolicies::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createCopy method.
        def microsoft_graph_create_copy()
            return MicrosoftGraphBeta::DeviceManagement::ReusablePolicySettings::Item::ReferencingConfigurationPolicies::Item::MicrosoftGraphCreateCopy::MicrosoftGraphCreateCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reorder method.
        def microsoft_graph_reorder()
            return MicrosoftGraphBeta::DeviceManagement::ReusablePolicySettings::Item::ReferencingConfigurationPolicies::Item::MicrosoftGraphReorder::MicrosoftGraphReorderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
