                    ...
                    module Item
                        ...
                        class DeviceManagementConfigurationPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def clear_enrollment_time_device_membership_target()
                                return MicrosoftGraphBeta::DeviceManagement::ReusablePolicySettings::Item::ReferencingConfigurationPolicies::Item::ClearEnrollmentTimeDeviceMembershipTarget::ClearEnrollmentTimeDeviceMembershipTargetRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def retrieve_enrollment_time_device_membership_target()
                                return MicrosoftGraphBeta::DeviceManagement::ReusablePolicySettings::Item::ReferencingConfigurationPolicies::Item::RetrieveEnrollmentTimeDeviceMembershipTarget::RetrieveEnrollmentTimeDeviceMembershipTargetRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def set_enrollment_time_device_membership_target()
                                return MicrosoftGraphBeta::DeviceManagement::ReusablePolicySettings::Item::ReferencingConfigurationPolicies::Item::SetEnrollmentTimeDeviceMembershipTarget::SetEnrollmentTimeDeviceMembershipTargetRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
