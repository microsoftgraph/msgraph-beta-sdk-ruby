...
module MicrosoftGraphBeta
    module DeviceManagement
        module GetComanagementEligibleDevicesSummary
            ...
            class GetComanagementEligibleDevicesSummaryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/getComanagementEligibleDevicesSummary()")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetComanagementEligibleDevicesSummaryRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
