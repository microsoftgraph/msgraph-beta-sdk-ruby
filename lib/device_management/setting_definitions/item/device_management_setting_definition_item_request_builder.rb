...
module MicrosoftGraphBeta::DeviceManagement::SettingDefinitions::Item
    ## 
    ...
    class DeviceManagementSettingDefinitionItemRequestBuilder
        ...
        ## @param deviceManagementSettingDefinitionId key: id of deviceManagementSettingDefinition
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_management_setting_definition_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/settingDefinitions/{deviceManagementSettingDefinition%2Did}{?%24select,%24expand}"
