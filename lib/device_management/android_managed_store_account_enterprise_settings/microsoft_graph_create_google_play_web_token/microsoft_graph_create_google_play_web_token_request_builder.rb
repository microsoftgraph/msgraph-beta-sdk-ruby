...
module MicrosoftGraphBeta
    module DeviceManagement
        module AndroidManagedStoreAccountEnterpriseSettings
            module MicrosoftGraphCreateGooglePlayWebToken
                ## 
                ...
                class MicrosoftGraphCreateGooglePlayWebTokenRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        ...
                        @url_template = "{+baseurl}/deviceManagement/androidManagedStoreAccountEnterpriseSettings/microsoft.graph.createGooglePlayWebToken"
                    ...
                    ## @return a Fiber of create_google_play_web_token_response
                    ## 
                    def post(body, request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::AndroidManagedStoreAccountEnterpriseSettings::MicrosoftGraphCreateGooglePlayWebToken::CreateGooglePlayWebTokenResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Generates a web token that is used in an embeddable component.
                    ## @param body The request body
