...
require_relative './microsoft_graph_set_android_device_owner_fully_managed_enrollment_state'
...
module MicrosoftGraphBeta::DeviceManagement::AndroidManagedStoreAccountEnterpriseSettings::MicrosoftGraphSetAndroidDeviceOwnerFullyManagedEnrollmentState
    ...
    class SetAndroidDeviceOwnerFullyManagedEnrollmentStateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/androidManagedStoreAccountEnterpriseSettings/microsoft.graph.setAndroidDeviceOwnerFullyManagedEnrollmentState"
