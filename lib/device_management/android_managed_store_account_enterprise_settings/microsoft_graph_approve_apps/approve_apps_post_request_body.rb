...
require_relative './microsoft_graph_approve_apps'

module MicrosoftGraphBeta::DeviceManagement::AndroidManagedStoreAccountEnterpriseSettings::MicrosoftGraphApproveApps
    class ApproveAppsPostRequestBody
        ...
        ## @param value Value to set for the approve_all_permissions property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the package_ids property.
        ## @return a void
        ## 
