    ...
    module DeviceManagement
        module AndroidManagedStoreAccountEnterpriseSettings
            module SetAndroidDeviceOwnerFullyManagedEnrollmentState
                ...
                class SetAndroidDeviceOwnerFullyManagedEnrollmentStateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/androidManagedStoreAccountEnterpriseSettings/setAndroidDeviceOwnerFullyManagedEnrollmentState")
                    end
                    ## 
                    ...
                    ## @return a set_android_device_owner_fully_managed_enrollment_state_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return SetAndroidDeviceOwnerFullyManagedEnrollmentStateRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
