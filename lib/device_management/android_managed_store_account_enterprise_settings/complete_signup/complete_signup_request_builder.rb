    ...
    module DeviceManagement
        module AndroidManagedStoreAccountEnterpriseSettings
            module CompleteSignup
                ...
                class CompleteSignupRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/androidManagedStoreAccountEnterpriseSettings/completeSignup")
                    end
                    ## 
                    ...
                    ## @return a complete_signup_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return CompleteSignupRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
