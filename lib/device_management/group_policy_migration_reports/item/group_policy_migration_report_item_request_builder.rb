...
require_relative './update_scope_tags/update_scope_tags_request_builder'
    ...
    module DeviceManagement
        module GroupPolicyMigrationReports
            module Item
                ...
                class GroupPolicyMigrationReportItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def update_scope_tags()
                        return MicrosoftGraphBeta::DeviceManagement::GroupPolicyMigrationReports::Item::UpdateScopeTags::UpdateScopeTagsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/groupPolicyMigrationReports/{groupPolicyMigrationReport%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/deviceManagement/groupPolicyMigrationReports/{groupPolicyMigrationReport%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return GroupPolicyMigrationReportItemRequestBuilder.new(raw_url, @request_adapter)
                    end
