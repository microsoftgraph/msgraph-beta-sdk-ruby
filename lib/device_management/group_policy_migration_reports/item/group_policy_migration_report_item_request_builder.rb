...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyMigrationReports::Item
    ...
    class GroupPolicyMigrationReportItemRequestBuilder
        ...
        ## @param groupPolicyMigrationReportId key: id of groupPolicyMigrationReport
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, group_policy_migration_report_id=nil)
