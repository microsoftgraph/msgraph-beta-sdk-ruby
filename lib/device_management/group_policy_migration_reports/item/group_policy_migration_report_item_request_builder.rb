...
require_relative './microsoft_graph_update_scope_tags/microsoft_graph_update_scope_tags_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyMigrationReports::Item
    ...
    class GroupPolicyMigrationReportItemRequestBuilder
        ...
        def microsoft_graph_update_scope_tags()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyMigrationReports::Item::MicrosoftGraphUpdateScopeTags::MicrosoftGraphUpdateScopeTagsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
