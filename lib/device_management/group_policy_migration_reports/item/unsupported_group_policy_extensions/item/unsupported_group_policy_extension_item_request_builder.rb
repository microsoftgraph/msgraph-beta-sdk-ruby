...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyMigrationReports::Item::UnsupportedGroupPolicyExtensions::Item
    ## 
    ...
    class UnsupportedGroupPolicyExtensionItemRequestBuilder
        ...
        ## @param unsupportedGroupPolicyExtensionId key: id of unsupportedGroupPolicyExtension
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, unsupported_group_policy_extension_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/groupPolicyMigrationReports/{groupPolicyMigrationReport%2Did}/unsupportedGroupPolicyExtensions/{unsupportedGroupPolicyExtension%2Did}{?%24select,%24expand}"
