...
module MicrosoftGraphBeta::DeviceManagement::EmbeddedSIMActivationCodePools::Item
    ...
    class EmbeddedSIMActivationCodePoolItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::EmbeddedSIMActivationCodePools::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
