...
module MicrosoftGraphBeta::DeviceManagement::EmbeddedSIMActivationCodePools::Item
    ## 
    ...
    class EmbeddedSIMActivationCodePoolItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::EmbeddedSIMActivationCodePools::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param embeddedSIMActivationCodePoolId key: id of embeddedSIMActivationCodePool
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, embedded_s_i_m_activation_code_pool_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/embeddedSIMActivationCodePools/{embeddedSIMActivationCodePool%2Did}{?%24select,%24expand}"
