...
module MicrosoftGraphBeta::DeviceManagement::EmbeddedSIMActivationCodePools::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/embeddedSIMActivationCodePools/$count{?%24search,%24filter}"
