...
module MicrosoftGraphBeta::DeviceManagement::ConfigurationPolicies::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/configurationPolicies/$count{?%24search,%24filter}"
