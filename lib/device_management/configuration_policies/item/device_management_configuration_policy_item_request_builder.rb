...
require_relative './microsoft_graph_reorder/reorder_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::ConfigurationPolicies::Item
    ## 
    ...
    class DeviceManagementConfigurationPolicyItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::ConfigurationPolicies::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createCopy method.
        def microsoft_graph_create_copy()
            return MicrosoftGraphBeta::DeviceManagement::ConfigurationPolicies::Item::MicrosoftGraphCreateCopy::CreateCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reorder method.
        def microsoft_graph_reorder()
            return MicrosoftGraphBeta::DeviceManagement::ConfigurationPolicies::Item::MicrosoftGraphReorder::ReorderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param deviceManagementConfigurationPolicyId key: id of deviceManagementConfigurationPolicy
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_management_configuration_policy_id=nil)
