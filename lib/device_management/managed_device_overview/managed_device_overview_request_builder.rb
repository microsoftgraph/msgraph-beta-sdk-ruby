...
module MicrosoftGraphBeta::DeviceManagement::ManagedDeviceOverview
    ...
    class ManagedDeviceOverviewRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedDeviceOverview.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Device overview
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
