    ...
    module DeviceManagement
        module ImportedDeviceIdentities
            module SearchExistingIdentities
                ...
                class SearchExistingIdentitiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/importedDeviceIdentities/searchExistingIdentities")
                    end
                    ## 
