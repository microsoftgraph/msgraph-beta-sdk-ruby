...
module MicrosoftGraphBeta::DeviceManagement::ImportedDeviceIdentities::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/importedDeviceIdentities/$count{?%24search,%24filter}"
