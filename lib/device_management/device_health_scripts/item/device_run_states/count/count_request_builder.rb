...
module MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item::DeviceRunStates::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceHealthScripts/{deviceHealthScript%2Did}/deviceRunStates/$count{?%24search,%24filter}"
