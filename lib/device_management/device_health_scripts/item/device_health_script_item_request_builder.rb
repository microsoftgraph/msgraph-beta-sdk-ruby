...
require_relative './microsoft_graph_get_global_script_highest_available_version/get_global_script_highest_available_version_request_builder'
require_relative './microsoft_graph_get_remediation_history/get_remediation_history_request_builder'
require_relative './microsoft_graph_update_global_script/update_global_script_request_builder'
require_relative './run_summary/run_summary_request_builder'

module MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item
    ## 
    ...
    class DeviceHealthScriptItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getGlobalScriptHighestAvailableVersion method.
        def microsoft_graph_get_global_script_highest_available_version()
            return MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item::MicrosoftGraphGetGlobalScriptHighestAvailableVersion::GetGlobalScriptHighestAvailableVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getRemediationHistory method.
        def microsoft_graph_get_remediation_history()
            return MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item::MicrosoftGraphGetRemediationHistory::GetRemediationHistoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateGlobalScript method.
        def microsoft_graph_update_global_script()
            return MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item::MicrosoftGraphUpdateGlobalScript::UpdateGlobalScriptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param deviceHealthScriptId key: id of deviceHealthScript
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_health_script_id=nil)
