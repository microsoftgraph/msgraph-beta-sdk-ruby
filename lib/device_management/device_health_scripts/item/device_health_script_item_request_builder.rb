...
require_relative './microsoft_graph_get_global_script_highest_available_version/microsoft_graph_get_global_script_highest_available_version_request_builder'
require_relative './microsoft_graph_get_remediation_history/microsoft_graph_get_remediation_history_request_builder'
require_relative './microsoft_graph_update_global_script/microsoft_graph_update_global_script_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item
    ...
    class DeviceHealthScriptItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_global_script_highest_available_version()
            return MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item::MicrosoftGraphGetGlobalScriptHighestAvailableVersion::MicrosoftGraphGetGlobalScriptHighestAvailableVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getRemediationHistory method.
        def microsoft_graph_get_remediation_history()
            return MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item::MicrosoftGraphGetRemediationHistory::MicrosoftGraphGetRemediationHistoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateGlobalScript method.
        def microsoft_graph_update_global_script()
            return MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item::MicrosoftGraphUpdateGlobalScript::MicrosoftGraphUpdateGlobalScriptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
