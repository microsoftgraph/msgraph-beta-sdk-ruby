            ...
            module Item
                module UpdateGlobalScript
                    ...
                    class UpdateGlobalScriptRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a Fiber of update_global_script_post_response
                        ## 
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::DeviceHealthScripts::Item::UpdateGlobalScript::UpdateGlobalScriptPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Update the Proprietary Device Health Script
                        ## @param body The request body
                        ...
                        ## @return a update_global_script_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return UpdateGlobalScriptRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
