...
require_relative './microsoft_graph_get_configuration_policy_settings_device_summary_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetConfigurationPolicySettingsDeviceSummaryReport
    class GetConfigurationPolicySettingsDeviceSummaryReportPostRequestBody
        ...
        ## @return a get_configuration_policy_settings_device_summary_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetConfigurationPolicySettingsDeviceSummaryReportPostRequestBody.new
        end
        ## 
