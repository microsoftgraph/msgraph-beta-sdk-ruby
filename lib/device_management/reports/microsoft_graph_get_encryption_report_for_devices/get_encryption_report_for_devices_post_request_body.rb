...
require_relative './microsoft_graph_get_encryption_report_for_devices'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetEncryptionReportForDevices
    class GetEncryptionReportForDevicesPostRequestBody
        ...
        ## @return a get_encryption_report_for_devices_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetEncryptionReportForDevicesPostRequestBody.new
        end
        ## 
