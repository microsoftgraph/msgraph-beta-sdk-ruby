...
require_relative './microsoft_graph_get_mobile_application_management_app_registration_summary_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetMobileApplicationManagementAppRegistrationSummaryReport
    class GetMobileApplicationManagementAppRegistrationSummaryReportPostRequestBody
        ...
        ## @return a get_mobile_application_management_app_registration_summary_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetMobileApplicationManagementAppRegistrationSummaryReportPostRequestBody.new
        end
        ## 
