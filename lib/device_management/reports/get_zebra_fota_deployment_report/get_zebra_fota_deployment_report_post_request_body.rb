...
require_relative './get_zebra_fota_deployment_report'

module MicrosoftGraphBeta
    module DeviceManagement
        module Reports
            module GetZebraFotaDeploymentReport
                class GetZebraFotaDeploymentReportPostRequestBody
                    ...
                    ## @return a get_zebra_fota_deployment_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetZebraFotaDeploymentReportPostRequestBody.new
                    end
                    ## 
