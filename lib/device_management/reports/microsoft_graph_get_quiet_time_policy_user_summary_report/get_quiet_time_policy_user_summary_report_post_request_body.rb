...
require_relative './microsoft_graph_get_quiet_time_policy_user_summary_report'

module MicrosoftGraphBeta
    module DeviceManagement
        module Reports
            module MicrosoftGraphGetQuietTimePolicyUserSummaryReport
                class GetQuietTimePolicyUserSummaryReportPostRequestBody
                    ...
                    ## @return a get_quiet_time_policy_user_summary_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetQuietTimePolicyUserSummaryReportPostRequestBody.new
                    end
                    ## 
