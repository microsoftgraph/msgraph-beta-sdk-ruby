...
require_relative './microsoft_graph_get_certificates_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetCertificatesReport
    class GetCertificatesReportPostRequestBody
        ...
        ## @return a get_certificates_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetCertificatesReportPostRequestBody.new
        end
        ## 
