    ...
    module DeviceManagement
        module Reports
            module GetDevicesStatusBySettingReport
                class GetDevicesStatusBySettingReportPostRequestBody
                    ...
                    ## @return a get_devices_status_by_setting_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetDevicesStatusBySettingReportPostRequestBody.new
                    end
                    ## 
