...
require_relative './retrieve_win32_catalog_apps_update_report'

module MicrosoftGraphBeta
    module DeviceManagement
        module Reports
            module RetrieveWin32CatalogAppsUpdateReport
                class RetrieveWin32CatalogAppsUpdateReportPostRequestBody
                    ...
                    ## 
                    ## Instantiates a new RetrieveWin32CatalogAppsUpdateReportPostRequestBody and sets the default values.
                    ## @return a void
                    ## 
                    def initialize()
                    ...
                    ## @return a retrieve_win32_catalog_apps_update_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return RetrieveWin32CatalogAppsUpdateReportPostRequestBody.new
                    end
                    ## 
