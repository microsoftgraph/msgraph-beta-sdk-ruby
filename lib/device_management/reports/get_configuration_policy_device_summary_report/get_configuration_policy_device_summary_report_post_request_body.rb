...
module MicrosoftGraphBeta::DeviceManagement::Reports::GetConfigurationPolicyDeviceSummaryReport
    class GetConfigurationPolicyDeviceSummaryReportPostRequestBody
        ...
        ## @return a get_configuration_policy_device_summary_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetConfigurationPolicyDeviceSummaryReportPostRequestBody.new
        end
        ## 
