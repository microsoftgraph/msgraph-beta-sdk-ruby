...
require_relative './microsoft_graph_get_remote_assistance_sessions_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetRemoteAssistanceSessionsReport
    class GetRemoteAssistanceSessionsReportPostRequestBody
        ...
        ## @return a get_remote_assistance_sessions_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetRemoteAssistanceSessionsReportPostRequestBody.new
        end
        ## 
