...
require_relative './microsoft_graph_get_app_status_overview_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetAppStatusOverviewReport
    class GetAppStatusOverviewReportPostRequestBody
        ...
        ## @return a get_app_status_overview_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetAppStatusOverviewReportPostRequestBody.new
        end
        ## 
