...
require_relative './get_windows_driver_update_alert_summary_report'

module MicrosoftGraphBeta
    module DeviceManagement
        module Reports
            module GetWindowsDriverUpdateAlertSummaryReport
                class GetWindowsDriverUpdateAlertSummaryReportPostRequestBody
                    ...
                    ## @return a get_windows_driver_update_alert_summary_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetWindowsDriverUpdateAlertSummaryReportPostRequestBody.new
                    end
                    ## 
