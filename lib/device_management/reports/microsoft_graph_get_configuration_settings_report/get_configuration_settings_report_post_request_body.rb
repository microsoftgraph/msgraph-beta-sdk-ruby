...
require_relative './microsoft_graph_get_configuration_settings_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetConfigurationSettingsReport
    class GetConfigurationSettingsReportPostRequestBody
        ...
        ## @return a get_configuration_settings_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetConfigurationSettingsReportPostRequestBody.new
        end
        ## 
