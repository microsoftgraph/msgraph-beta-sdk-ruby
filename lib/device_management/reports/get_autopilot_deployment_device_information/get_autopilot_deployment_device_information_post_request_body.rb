...
require_relative './get_autopilot_deployment_device_information'

module MicrosoftGraphBeta
    module DeviceManagement
        module Reports
            module GetAutopilotDeploymentDeviceInformation
                class GetAutopilotDeploymentDeviceInformationPostRequestBody
                    ...
                    ## @return a get_autopilot_deployment_device_information_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetAutopilotDeploymentDeviceInformationPostRequestBody.new
                    end
                    ## 
