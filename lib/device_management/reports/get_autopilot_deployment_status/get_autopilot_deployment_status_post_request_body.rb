    ...
    module DeviceManagement
        module Reports
            module GetAutopilotDeploymentStatus
                class GetAutopilotDeploymentStatusPostRequestBody
                    ...
                    ## @return a get_autopilot_deployment_status_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetAutopilotDeploymentStatusPostRequestBody.new
                    end
                    ## 
