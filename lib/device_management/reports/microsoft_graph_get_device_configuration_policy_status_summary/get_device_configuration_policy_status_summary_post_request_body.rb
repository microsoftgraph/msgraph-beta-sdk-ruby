...
require_relative './microsoft_graph_get_device_configuration_policy_status_summary'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetDeviceConfigurationPolicyStatusSummary
    class GetDeviceConfigurationPolicyStatusSummaryPostRequestBody
        ...
        ## @return a get_device_configuration_policy_status_summary_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetDeviceConfigurationPolicyStatusSummaryPostRequestBody.new
        end
        ## 
