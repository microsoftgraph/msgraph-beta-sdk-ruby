    ...
    module DeviceManagement
        module Reports
            module GetDeviceStatusByCompliancePolicySettingReport
                class GetDeviceStatusByCompliancePolicySettingReportPostRequestBody
                    ...
                    ## @return a get_device_status_by_compliance_policy_setting_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetDeviceStatusByCompliancePolicySettingReportPostRequestBody.new
                    end
                    ## 
