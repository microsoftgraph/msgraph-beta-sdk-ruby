...
require_relative './microsoft_graph_get_user_install_status_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetUserInstallStatusReport
    class GetUserInstallStatusReportPostRequestBody
        ...
        ## @return a get_user_install_status_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetUserInstallStatusReportPostRequestBody.new
        end
        ## 
