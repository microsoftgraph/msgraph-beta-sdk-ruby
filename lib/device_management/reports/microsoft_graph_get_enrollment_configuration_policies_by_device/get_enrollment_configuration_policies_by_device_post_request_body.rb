...
require_relative './microsoft_graph_get_enrollment_configuration_policies_by_device'

module MicrosoftGraphBeta
    module DeviceManagement
        module Reports
            module MicrosoftGraphGetEnrollmentConfigurationPoliciesByDevice
                class GetEnrollmentConfigurationPoliciesByDevicePostRequestBody
                    ...
                    ## @return a get_enrollment_configuration_policies_by_device_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetEnrollmentConfigurationPoliciesByDevicePostRequestBody.new
                    end
                    ## 
