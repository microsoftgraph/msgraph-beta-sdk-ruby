    ...
    module DeviceManagement
        module Reports
            module GetDeviceStatusSummaryByCompliancePolicySettingsReport
                class GetDeviceStatusSummaryByCompliancePolicySettingsReportPostRequestBody
                    ...
                    ## @return a get_device_status_summary_by_compliance_policy_settings_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetDeviceStatusSummaryByCompliancePolicySettingsReportPostRequestBody.new
                    end
                    ## 
