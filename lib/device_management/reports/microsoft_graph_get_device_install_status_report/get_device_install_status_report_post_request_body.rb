...
require_relative './microsoft_graph_get_device_install_status_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetDeviceInstallStatusReport
    class GetDeviceInstallStatusReportPostRequestBody
        ...
        ## @return a get_device_install_status_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetDeviceInstallStatusReportPostRequestBody.new
        end
        ## 
