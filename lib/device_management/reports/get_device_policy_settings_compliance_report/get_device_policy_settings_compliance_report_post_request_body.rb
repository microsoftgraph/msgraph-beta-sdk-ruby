    ...
    module DeviceManagement
        module Reports
            module GetDevicePolicySettingsComplianceReport
                class GetDevicePolicySettingsComplianceReportPostRequestBody
                    ...
                    ## @return a get_device_policy_settings_compliance_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetDevicePolicySettingsComplianceReportPostRequestBody.new
                    end
                    ## 
