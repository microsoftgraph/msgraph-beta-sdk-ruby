...
require_relative './microsoft_graph_get_failed_mobile_apps_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetFailedMobileAppsReport
    class GetFailedMobileAppsReportPostRequestBody
        ...
        ## @return a get_failed_mobile_apps_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetFailedMobileAppsReportPostRequestBody.new
        end
        ## 
