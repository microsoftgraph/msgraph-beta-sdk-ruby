...
require_relative './microsoft_graph_get_device_configuration_policy_settings_summary_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetDeviceConfigurationPolicySettingsSummaryReport
    class GetDeviceConfigurationPolicySettingsSummaryReportPostRequestBody
        ...
        ## @return a get_device_configuration_policy_settings_summary_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetDeviceConfigurationPolicySettingsSummaryReportPostRequestBody.new
        end
        ## 
