...
require_relative './retrieve_security_task_apps_report'

module MicrosoftGraphBeta
    module DeviceManagement
        module Reports
            module RetrieveSecurityTaskAppsReport
                class RetrieveSecurityTaskAppsReportPostRequestBody
                    ...
                    ## 
                    ## Instantiates a new RetrieveSecurityTaskAppsReportPostRequestBody and sets the default values.
                    ## @return a void
                    ## 
                    def initialize()
                    ...
                    ## @return a retrieve_security_task_apps_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return RetrieveSecurityTaskAppsReportPostRequestBody.new
                    end
                    ## 
