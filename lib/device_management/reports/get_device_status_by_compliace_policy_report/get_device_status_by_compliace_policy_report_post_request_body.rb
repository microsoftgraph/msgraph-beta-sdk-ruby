    ...
    module DeviceManagement
        module Reports
            module GetDeviceStatusByCompliacePolicyReport
                class GetDeviceStatusByCompliacePolicyReportPostRequestBody
                    ...
                    ## @return a get_device_status_by_compliace_policy_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetDeviceStatusByCompliacePolicyReportPostRequestBody.new
                    end
                    ## 
