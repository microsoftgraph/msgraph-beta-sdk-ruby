...
require_relative './microsoft_graph_get_configuration_policies_report_for_device'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetConfigurationPoliciesReportForDevice
    class GetConfigurationPoliciesReportForDevicePostRequestBody
        ...
        ## @return a get_configuration_policies_report_for_device_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetConfigurationPoliciesReportForDevicePostRequestBody.new
        end
        ## 
