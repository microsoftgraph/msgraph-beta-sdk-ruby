...
require_relative './get_device_policies_compliance_report'

module MicrosoftGraphBeta
    module DeviceManagement
        module Reports
            module GetDevicePoliciesComplianceReport
                class GetDevicePoliciesComplianceReportPostRequestBody
                    ...
                    ## @return a get_device_policies_compliance_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetDevicePoliciesComplianceReportPostRequestBody.new
                    end
                    ## 
