...
require_relative './get_failed_mobile_apps_summary_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::GetFailedMobileAppsSummaryReport
    class GetFailedMobileAppsSummaryReportPostRequestBody
        ...
        ## @return a get_failed_mobile_apps_summary_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetFailedMobileAppsSummaryReportPostRequestBody.new
        end
        ## 
