...
require_relative './microsoft_graph_get_config_manager_device_policy_status_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetConfigManagerDevicePolicyStatusReport
    class GetConfigManagerDevicePolicyStatusReportPostRequestBody
        ...
        ## @return a get_config_manager_device_policy_status_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetConfigManagerDevicePolicyStatusReportPostRequestBody.new
        end
        ## 
