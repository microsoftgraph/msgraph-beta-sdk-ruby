...
require_relative './microsoft_graph_get_all_certificates_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetAllCertificatesReport
    class GetAllCertificatesReportPostRequestBody
        ...
        ## @return a get_all_certificates_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetAllCertificatesReportPostRequestBody.new
        end
        ## 
