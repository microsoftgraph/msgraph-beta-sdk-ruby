...
require_relative './get_device_configuration_policy_status_summary'

module MicrosoftGraphBeta::DeviceManagement::Reports::GetDeviceConfigurationPolicyStatusSummary
