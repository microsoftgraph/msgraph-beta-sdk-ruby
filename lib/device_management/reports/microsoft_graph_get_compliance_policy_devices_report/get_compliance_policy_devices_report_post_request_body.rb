...
require_relative './microsoft_graph_get_compliance_policy_devices_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetCompliancePolicyDevicesReport
    class GetCompliancePolicyDevicesReportPostRequestBody
        ...
        ## @return a get_compliance_policy_devices_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetCompliancePolicyDevicesReportPostRequestBody.new
        end
        ## 
