    ...
    module DeviceManagement
        module Reports
            module GetDevicesStatusByPolicyPlatformComplianceReport
                class GetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody
                    ...
                    ## @return a get_devices_status_by_policy_platform_compliance_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody.new
                    end
                    ## 
