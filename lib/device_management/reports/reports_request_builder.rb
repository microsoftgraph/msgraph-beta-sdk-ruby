...
require_relative './get_autopilot_deployment_status/get_autopilot_deployment_status_request_builder'
    ...
    module DeviceManagement
        module Reports
            ...
            class ReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def get_autopilot_deployment_status()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetAutopilotDeploymentStatus::GetAutopilotDeploymentStatusRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
