...
require_relative './get_device_policies_compliance_report/get_device_policies_compliance_report_request_builder'
require_relative './get_device_policy_settings_compliance_report/get_device_policy_settings_compliance_report_request_builder'
require_relative './get_devices_status_by_policy_platform_compliance_report/get_devices_status_by_policy_platform_compliance_report_request_builder'
require_relative './get_devices_status_by_setting_report/get_devices_status_by_setting_report_request_builder'
require_relative './get_device_status_by_compliace_policy_report/get_device_status_by_compliace_policy_report_request_builder'
require_relative './get_device_status_by_compliance_policy_setting_report/get_device_status_by_compliance_policy_setting_report_request_builder'
require_relative './get_device_status_summary_by_compliace_policy_report/get_device_status_summary_by_compliace_policy_report_request_builder'
require_relative './get_device_status_summary_by_compliance_policy_settings_report/get_device_status_summary_by_compliance_policy_settings_report_request_builder'
...
require_relative './get_windows_driver_update_alerts_per_policy_per_device_report/get_windows_driver_update_alerts_per_policy_per_device_report_request_builder'
require_relative './get_windows_driver_update_alert_summary_report/get_windows_driver_update_alert_summary_report_request_builder'
...
require_relative './retrieve_cloud_pki_leaf_certificate_report/retrieve_cloud_pki_leaf_certificate_report_request_builder'
require_relative './retrieve_cloud_pki_leaf_certificate_summary_report/retrieve_cloud_pki_leaf_certificate_summary_report_request_builder'
...
require_relative './retrieve_security_task_apps_report/retrieve_security_task_apps_report_request_builder'
    ...
    module DeviceManagement
        module Reports
            ...
            class ReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def get_device_policies_compliance_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetDevicePoliciesComplianceReport::GetDevicePoliciesComplianceReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getDevicePolicySettingsComplianceReport method.
                def get_device_policy_settings_compliance_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetDevicePolicySettingsComplianceReport::GetDevicePolicySettingsComplianceReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getDevicesStatusByPolicyPlatformComplianceReport method.
                def get_devices_status_by_policy_platform_compliance_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetDevicesStatusByPolicyPlatformComplianceReport::GetDevicesStatusByPolicyPlatformComplianceReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getDevicesStatusBySettingReport method.
                def get_devices_status_by_setting_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetDevicesStatusBySettingReport::GetDevicesStatusBySettingReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getDeviceStatusByCompliacePolicyReport method.
                def get_device_status_by_compliace_policy_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetDeviceStatusByCompliacePolicyReport::GetDeviceStatusByCompliacePolicyReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getDeviceStatusByCompliancePolicySettingReport method.
                def get_device_status_by_compliance_policy_setting_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetDeviceStatusByCompliancePolicySettingReport::GetDeviceStatusByCompliancePolicySettingReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getDeviceStatusSummaryByCompliacePolicyReport method.
                def get_device_status_summary_by_compliace_policy_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetDeviceStatusSummaryByCompliacePolicyReport::GetDeviceStatusSummaryByCompliacePolicyReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getDeviceStatusSummaryByCompliancePolicySettingsReport method.
                def get_device_status_summary_by_compliance_policy_settings_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetDeviceStatusSummaryByCompliancePolicySettingsReport::GetDeviceStatusSummaryByCompliancePolicySettingsReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def get_windows_driver_update_alerts_per_policy_per_device_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReport::GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getWindowsDriverUpdateAlertSummaryReport method.
                def get_windows_driver_update_alert_summary_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::GetWindowsDriverUpdateAlertSummaryReport::GetWindowsDriverUpdateAlertSummaryReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def retrieve_cloud_pki_leaf_certificate_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::RetrieveCloudPkiLeafCertificateReport::RetrieveCloudPkiLeafCertificateReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the retrieveCloudPkiLeafCertificateSummaryReport method.
                def retrieve_cloud_pki_leaf_certificate_summary_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::RetrieveCloudPkiLeafCertificateSummaryReport::RetrieveCloudPkiLeafCertificateSummaryReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def retrieve_device_app_installation_status_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::RetrieveDeviceAppInstallationStatusReport::RetrieveDeviceAppInstallationStatusReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the retrieveSecurityTaskAppsReport method.
                def retrieve_security_task_apps_report()
                    return MicrosoftGraphBeta::DeviceManagement::Reports::RetrieveSecurityTaskAppsReport::RetrieveSecurityTaskAppsReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
