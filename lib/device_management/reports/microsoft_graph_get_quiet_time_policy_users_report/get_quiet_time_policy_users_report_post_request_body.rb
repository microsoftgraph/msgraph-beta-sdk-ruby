...
require_relative './microsoft_graph_get_quiet_time_policy_users_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::MicrosoftGraphGetQuietTimePolicyUsersReport
    class GetQuietTimePolicyUsersReportPostRequestBody
        ...
        ## @return a get_quiet_time_policy_users_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetQuietTimePolicyUsersReportPostRequestBody.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                ...
                "skipToken" => lambda {|n| @skip_token = n.get_string_value() },
        ...
        def serialize(writer)
            ...
            writer.write_string_value("skipToken", @skip_token)
        ...
        ## @param value Value to set for the skip_token property.
        ## @return a void
        ## 
        def skip_token=(value)
            @skip_token = value
        end
        ## 
