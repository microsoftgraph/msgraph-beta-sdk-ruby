                        ...
                        module GetHealthMetricTimeSeries
                            ...
                            class GetHealthMetricTimeSeriesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def post(body, request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::MicrosoftTunnelSites::Item::MicrosoftTunnelServers::Item::GetHealthMetricTimeSeries::GetHealthMetricTimeSeriesPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Invoke action getHealthMetricTimeSeries
                                ## @param body The request body
