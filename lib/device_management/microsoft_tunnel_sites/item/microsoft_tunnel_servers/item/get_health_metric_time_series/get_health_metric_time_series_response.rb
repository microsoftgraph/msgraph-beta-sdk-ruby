...
require_relative '../../../../../../models/metric_time_series_data_point'
...
module MicrosoftGraphBeta::DeviceManagement::MicrosoftTunnelSites::Item::MicrosoftTunnelServers::Item::GetHealthMetricTimeSeries
    class GetHealthMetricTimeSeriesResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
        ...
        def get_field_deserializers()
            return super.merge({
                "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MetricTimeSeriesDataPoint.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
