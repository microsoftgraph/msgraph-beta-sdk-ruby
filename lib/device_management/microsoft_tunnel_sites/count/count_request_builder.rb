...
module MicrosoftGraphBeta::DeviceManagement::MicrosoftTunnelSites::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/microsoftTunnelSites/$count{?%24search,%24filter}"
