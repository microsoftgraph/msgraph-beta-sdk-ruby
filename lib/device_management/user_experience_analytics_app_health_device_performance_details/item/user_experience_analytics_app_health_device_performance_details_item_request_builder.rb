...
module MicrosoftGraphBeta::DeviceManagement::UserExperienceAnalyticsAppHealthDevicePerformanceDetails::Item
    ...
    class UserExperienceAnalyticsAppHealthDevicePerformanceDetailsItemRequestBuilder
        ...
        ## @param userExperienceAnalyticsAppHealthDevicePerformanceDetailsId key: id of userExperienceAnalyticsAppHealthDevicePerformanceDetails
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, user_experience_analytics_app_health_device_performance_details_id=nil)
