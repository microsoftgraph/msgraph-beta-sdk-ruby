...
module MicrosoftGraphBeta::DeviceManagement::UserExperienceAnalyticsModelScores::Item
    ...
    class UserExperienceAnalyticsModelScoresItemRequestBuilder
        ...
        ## @param userExperienceAnalyticsModelScoresId key: id of userExperienceAnalyticsModelScores
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, user_experience_analytics_model_scores_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/userExperienceAnalyticsModelScores/{userExperienceAnalyticsModelScores%2Did}{?%24select,%24expand}"
