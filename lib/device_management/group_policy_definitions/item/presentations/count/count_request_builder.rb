...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::Presentations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/presentations/$count{?%24search,%24filter}"
