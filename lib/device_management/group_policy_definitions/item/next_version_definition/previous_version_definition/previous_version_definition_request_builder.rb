            ...
            module Item
                module NextVersionDefinition
                    module PreviousVersionDefinition
                        ...
                        class PreviousVersionDefinitionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            
                            ## 
                            # Provides operations to manage the category property of the microsoft.graph.groupPolicyDefinition entity.
                            def category()
                                return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::NextVersionDefinition::PreviousVersionDefinition::Category::CategoryRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the definitionFile property of the microsoft.graph.groupPolicyDefinition entity.
                            def definition_file()
                                return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::NextVersionDefinition::PreviousVersionDefinition::DefinitionFile::DefinitionFileRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the presentations property of the microsoft.graph.groupPolicyDefinition entity.
                            def presentations()
                                return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::NextVersionDefinition::PreviousVersionDefinition::Presentations::PresentationsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/previousVersionDefinition{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/previousVersionDefinition'
                            ...
                            ## @return a previous_version_definition_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return PreviousVersionDefinitionRequestBuilder.new(raw_url, @request_adapter)
                            end
