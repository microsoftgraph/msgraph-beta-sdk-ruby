                    ...
                    module PreviousVersionDefinition
                        ...
                        class PreviousVersionDefinitionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/previousVersionDefinition{?%24select,%24expand}")
                            end
                            ## 
                            ...
                            def presentations_by_id(id)
                                ...
                                return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::NextVersionDefinition::PreviousVersionDefinition::Presentations::Item::GroupPolicyPresentationItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ## Delete navigation property previousVersionDefinition for deviceManagement
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
