...
module MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item
    ...
    class DeviceCustomAttributeShellScriptItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param deviceCustomAttributeShellScriptId key: id of deviceCustomAttributeShellScript
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_custom_attribute_shell_script_id=nil)
