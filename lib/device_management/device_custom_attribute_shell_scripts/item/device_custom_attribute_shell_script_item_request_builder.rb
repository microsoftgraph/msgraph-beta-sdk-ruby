...
module MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item
    ...
    class DeviceCustomAttributeShellScriptItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
