...
module MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item::DeviceRunStates::Item
    ## 
    ...
    class DeviceManagementScriptDeviceStateItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, device_management_script_device_state_id=nil)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScript%2Did}/deviceRunStates/{deviceManagementScriptDeviceState%2Did}{?%24select,%24expand}"
