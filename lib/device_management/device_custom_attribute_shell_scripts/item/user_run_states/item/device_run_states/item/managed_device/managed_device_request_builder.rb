...
module MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item::UserRunStates::Item::DeviceRunStates::Item::ManagedDevice
    ## 
    ...
    class ManagedDeviceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScript%2Did}/userRunStates/{deviceManagementScriptUserState%2Did}/deviceRunStates/{deviceManagementScriptDeviceState%2Did}/managedDevice{?%24select,%24expand}"
