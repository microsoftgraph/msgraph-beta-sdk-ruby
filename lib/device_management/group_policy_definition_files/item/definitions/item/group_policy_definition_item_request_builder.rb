                    ...
                    module Item
                        ...
                        class GroupPolicyDefinitionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/groupPolicyDefinitionFiles/{groupPolicyDefinitionFile%2Did}/definitions/{groupPolicyDefinition%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def with_url(raw_url)
                                ...
                                return GroupPolicyDefinitionItemRequestBuilder.new(raw_url, @request_adapter)
                            end
