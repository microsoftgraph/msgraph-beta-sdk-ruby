...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitionFiles::Item::Definitions::Item
    ## 
    ...
    class GroupPolicyDefinitionItemRequestBuilder
        ...
        ## @param groupPolicyDefinitionId key: id of groupPolicyDefinition
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, group_policy_definition_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/groupPolicyDefinitionFiles/{groupPolicyDefinitionFile%2Did}/definitions/{groupPolicyDefinition%2Did}{?%24select,%24expand}"
