...
require_relative './consent_to_data_sharing/consent_to_data_sharing_request_builder'
    ...
    module DeviceManagement
        module DataSharingConsents
            module Item
                ...
                class DataSharingConsentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to call the consentToDataSharing method.
                    def consent_to_data_sharing()
                        return MicrosoftGraphBeta::DeviceManagement::DataSharingConsents::Item::ConsentToDataSharing::ConsentToDataSharingRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/dataSharingConsents/{dataSharingConsent%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/deviceManagement/dataSharingConsents/{dataSharingConsent%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return DataSharingConsentItemRequestBuilder.new(raw_url, @request_adapter)
                    end
