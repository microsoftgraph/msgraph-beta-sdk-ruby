...
require_relative './microsoft_graph_consent_to_data_sharing/microsoft_graph_consent_to_data_sharing_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::DataSharingConsents::Item
    ...
    class DataSharingConsentItemRequestBuilder
        ...
        def microsoft_graph_consent_to_data_sharing()
            return MicrosoftGraphBeta::DeviceManagement::DataSharingConsents::Item::MicrosoftGraphConsentToDataSharing::MicrosoftGraphConsentToDataSharingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
