...
require_relative './microsoft_graph_consent_to_data_sharing/consent_to_data_sharing_request_builder'

module MicrosoftGraphBeta::DeviceManagement::DataSharingConsents::Item
    ## 
    ...
    class DataSharingConsentItemRequestBuilder
        ...
        def microsoft_graph_consent_to_data_sharing()
            return MicrosoftGraphBeta::DeviceManagement::DataSharingConsents::Item::MicrosoftGraphConsentToDataSharing::ConsentToDataSharingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param dataSharingConsentId key: id of dataSharingConsent
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, data_sharing_consent_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/dataSharingConsents/{dataSharingConsent%2Did}{?%24select,%24expand}"
