            ...
            module Item
                module ManagedDevices
                    ...
                    class ManagedDevicesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::DeviceManagement::DetectedApps::Item::ManagedDevices::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the managedDevices property of the microsoft.graph.detectedApp entity.
                        ...
                        def by_managed_device_id(managed_device_id)
                            ...
                            return MicrosoftGraphBeta::DeviceManagement::DetectedApps::Item::ManagedDevices::Item::ManagedDeviceItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
