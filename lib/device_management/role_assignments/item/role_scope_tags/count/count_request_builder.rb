...
module MicrosoftGraphBeta::DeviceManagement::RoleAssignments::Item::RoleScopeTags::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/roleAssignments/{deviceAndAppManagementRoleAssignment%2Did}/roleScopeTags/$count{?%24search,%24filter}"
