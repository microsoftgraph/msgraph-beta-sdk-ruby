...
module MicrosoftGraphBeta
    module DeviceManagement
        module UserExperienceAnalyticsAnomalyDevice
            module Count
                ## 
                ...
                class CountRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAnomalyDevice/$count{?%24search,%24filter}")
                    end
                    ## 
