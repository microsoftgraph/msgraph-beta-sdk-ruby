...
module MicrosoftGraphBeta::DeviceManagement::UserExperienceAnalyticsAnomalyDevice::Item
    ...
    class UserExperienceAnalyticsAnomalyDeviceItemRequestBuilder
        ...
        ## @param userExperienceAnalyticsAnomalyDeviceId key: id of userExperienceAnalyticsAnomalyDevice
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, user_experience_analytics_anomaly_device_id=nil)
