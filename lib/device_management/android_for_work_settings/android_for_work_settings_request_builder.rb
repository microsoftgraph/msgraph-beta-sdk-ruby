...
module MicrosoftGraphBeta::DeviceManagement::AndroidForWorkSettings
    ...
    class AndroidForWorkSettingsRequestBuilder
        ...
        def microsoft_graph_complete_signup()
            return MicrosoftGraphBeta::DeviceManagement::AndroidForWorkSettings::MicrosoftGraphCompleteSignup::MicrosoftGraphCompleteSignupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the requestSignupUrl method.
        def microsoft_graph_request_signup_url()
            return MicrosoftGraphBeta::DeviceManagement::AndroidForWorkSettings::MicrosoftGraphRequestSignupUrl::MicrosoftGraphRequestSignupUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the syncApps method.
        def microsoft_graph_sync_apps()
            return MicrosoftGraphBeta::DeviceManagement::AndroidForWorkSettings::MicrosoftGraphSyncApps::MicrosoftGraphSyncAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unbind method.
        def microsoft_graph_unbind()
            return MicrosoftGraphBeta::DeviceManagement::AndroidForWorkSettings::MicrosoftGraphUnbind::MicrosoftGraphUnbindRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
