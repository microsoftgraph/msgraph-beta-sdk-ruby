...
module MicrosoftGraphBeta::DeviceManagement::AndroidForWorkSettings
    ...
    class AndroidForWorkSettingsRequestBuilder
        ...
        def microsoft_graph_complete_signup()
            return MicrosoftGraphBeta::DeviceManagement::AndroidForWorkSettings::MicrosoftGraphCompleteSignup::CompleteSignupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the requestSignupUrl method.
        def microsoft_graph_request_signup_url()
            return MicrosoftGraphBeta::DeviceManagement::AndroidForWorkSettings::MicrosoftGraphRequestSignupUrl::RequestSignupUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the syncApps method.
        def microsoft_graph_sync_apps()
            return MicrosoftGraphBeta::DeviceManagement::AndroidForWorkSettings::MicrosoftGraphSyncApps::SyncAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unbind method.
        def microsoft_graph_unbind()
            return MicrosoftGraphBeta::DeviceManagement::AndroidForWorkSettings::MicrosoftGraphUnbind::UnbindRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
