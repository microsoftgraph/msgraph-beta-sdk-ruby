...
require_relative './microsoft_graph_get_platform_supported_properties_with_platform'
...
module MicrosoftGraphBeta::DeviceManagement::AssignmentFilters::MicrosoftGraphGetPlatformSupportedPropertiesWithPlatform
    ...
    class GetPlatformSupportedPropertiesWithPlatformRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, platform=nil)
            ...
            @url_template = "{+baseurl}/deviceManagement/assignmentFilters/microsoft.graph.getPlatformSupportedProperties(platform='{platform}'){?%24top,%24skip,%24search,%24filter,%24count}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::AssignmentFilters::MicrosoftGraphGetPlatformSupportedPropertiesWithPlatform::GetPlatformSupportedPropertiesWithPlatformResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function getPlatformSupportedProperties
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
