    ...
    module DeviceManagement
        module AssignmentFilters
            module ValidateFilter
                ...
                class ValidateFilterRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/assignmentFilters/validateFilter")
                    end
                    ## 
                    ...
                    ## @return a validate_filter_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return ValidateFilterRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
