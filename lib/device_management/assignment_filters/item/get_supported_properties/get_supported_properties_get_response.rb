...
module MicrosoftGraphBeta
    module DeviceManagement
        module AssignmentFilters
            module Item
                module GetSupportedProperties
                    class GetSupportedPropertiesGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                        ...
                        ## @return a get_supported_properties_get_response
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return GetSupportedPropertiesGetResponse.new
                        end
                        ## 
