    ...
    module DeviceManagement
        module AssignmentFilters
            module GetPlatformSupportedPropertiesWithPlatform
                class GetPlatformSupportedPropertiesWithPlatformGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                    ...
                    ## @return a get_platform_supported_properties_with_platform_get_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetPlatformSupportedPropertiesWithPlatformGetResponse.new
                    end
                    ## 
