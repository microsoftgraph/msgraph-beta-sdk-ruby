...
require_relative './microsoft_graph_get_scopes_for_user_with_userid/microsoft_graph_get_scopes_for_user_with_userid_request_builder'

module MicrosoftGraphBeta::DeviceManagement::ResourceOperations::Item
    ## 
    ...
    class ResourceOperationItemRequestBuilder
        ...
        ## @return a microsoft_graph_get_scopes_for_user_with_userid_request_builder
        ## 
        def microsoft_graph_get_scopes_for_user_with_userid(userid)
            raise StandardError, 'userid cannot be null' if userid.nil?
            return MicrosoftGraphGetScopesForUserWithUseridRequestBuilder.new(@path_parameters, @request_adapter, userid)
        end
        ## 
