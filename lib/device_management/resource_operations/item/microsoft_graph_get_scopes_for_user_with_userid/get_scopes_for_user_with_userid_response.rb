...
require_relative './microsoft_graph_get_scopes_for_user_with_userid'

module MicrosoftGraphBeta
    module DeviceManagement
        module ResourceOperations
            module Item
                module MicrosoftGraphGetScopesForUserWithUserid
                    class GetScopesForUserWithUseridResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                        ...
                        ## @return a get_scopes_for_user_with_userid_response
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return GetScopesForUserWithUseridResponse.new
                        end
                        ## 
