            ...
            module Item
                module DeviceSettingStateSummaries
                    ...
                    class DeviceSettingStateSummariesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::DeviceSettingStateSummaries::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the deviceSettingStateSummaries property of the microsoft.graph.deviceConfiguration entity.
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SettingStateDeviceSummaryCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SettingStateDeviceSummary.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Device Configuration Setting State Device Summary
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
