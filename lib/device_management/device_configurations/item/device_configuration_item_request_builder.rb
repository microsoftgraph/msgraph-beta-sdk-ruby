...
require_relative './group_assignments/item/device_configuration_group_assignment_item_request_builder'
require_relative './item'
require_relative './microsoft_graph_assign/microsoft_graph_assign_request_builder'
require_relative './microsoft_graph_assigned_access_multi_mode_profiles/microsoft_graph_assigned_access_multi_mode_profiles_request_builder'
...
require_relative './microsoft_graph_windows_privacy_access_controls/microsoft_graph_windows_privacy_access_controls_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item
    ## 
    ...
    class DeviceConfigurationItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assignedAccessMultiModeProfiles method.
        def microsoft_graph_assigned_access_multi_mode_profiles()
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::MicrosoftGraphAssignedAccessMultiModeProfiles::MicrosoftGraphAssignedAccessMultiModeProfilesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the windowsPrivacyAccessControls method.
        def microsoft_graph_windows_privacy_access_controls()
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::MicrosoftGraphWindowsPrivacyAccessControls::MicrosoftGraphWindowsPrivacyAccessControlsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::Assignments::Item::DeviceConfigurationAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def device_setting_state_summaries_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::DeviceSettingStateSummaries::Item::SettingStateDeviceSummaryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the deviceStatuses property of the microsoft.graph.deviceConfiguration entity.
        ## @param id Unique identifier of the item
        ...
        def device_statuses_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::DeviceStatuses::Item::DeviceConfigurationDeviceStatusItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        ## Provides operations to manage the groupAssignments property of the microsoft.graph.deviceConfiguration entity.
        ## @param id Unique identifier of the item
        ## @return a device_configuration_group_assignment_item_request_builder
        ## 
        def group_assignments_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["deviceConfigurationGroupAssignment%2Did"] = id
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::GroupAssignments::Item::DeviceConfigurationGroupAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def user_statuses_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::UserStatuses::Item::DeviceConfigurationUserStatusItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
