...
require_relative './microsoft_graph_assigned_access_multi_mode_profiles/assigned_access_multi_mode_profiles_request_builder'
...
require_relative './microsoft_graph_windows_privacy_access_controls/windows_privacy_access_controls_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item
    ...
    class DeviceConfigurationItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_assigned_access_multi_mode_profiles()
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::MicrosoftGraphAssignedAccessMultiModeProfiles::AssignedAccessMultiModeProfilesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the windowsPrivacyAccessControls method.
        def microsoft_graph_windows_privacy_access_controls()
            return MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::MicrosoftGraphWindowsPrivacyAccessControls::WindowsPrivacyAccessControlsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
