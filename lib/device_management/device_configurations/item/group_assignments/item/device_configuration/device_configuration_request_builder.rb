                ...
                module GroupAssignments
                    module Item
                        module DeviceConfiguration
                            ...
                            class DeviceConfigurationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/groupAssignments/{deviceConfigurationGroupAssignment%2Did}/deviceConfiguration{?%24select,%24expand}")
                                end
                                ## 
                                ...
                                ## @return a device_configuration_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return DeviceConfigurationRequestBuilder.new(raw_url, @request_adapter)
                                end
