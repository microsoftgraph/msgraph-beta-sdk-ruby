...
module MicrosoftGraphBeta::DeviceManagement::ExchangeConnectors::Item::MicrosoftGraphSync
    class SyncPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "syncType" => lambda {|n| @sync_type = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceManagementExchangeConnectorSyncType) },
            }
        end
        ## 
