...
module MicrosoftGraphBeta::DeviceManagement::ExchangeConnectors::Item
    ## 
    ...
    class DeviceManagementExchangeConnectorItemRequestBuilder
        ...
        def microsoft_graph_sync()
            return MicrosoftGraphBeta::DeviceManagement::ExchangeConnectors::Item::MicrosoftGraphSync::MicrosoftGraphSyncRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
