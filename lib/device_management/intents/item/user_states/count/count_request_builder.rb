...
module MicrosoftGraphBeta::DeviceManagement::Intents::Item::UserStates::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/userStates/$count{?%24search,%24filter}"
