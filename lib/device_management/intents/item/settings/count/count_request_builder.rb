...
module MicrosoftGraphBeta::DeviceManagement::Intents::Item::Settings::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/settings/$count{?%24search,%24filter}"
