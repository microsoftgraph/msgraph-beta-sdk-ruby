...
require_relative './microsoft_graph_compare_with_template_id/compare_with_template_id_request_builder'
require_relative './microsoft_graph_create_copy/create_copy_request_builder'
require_relative './microsoft_graph_migrate_to_template/migrate_to_template_request_builder'
require_relative './microsoft_graph_update_settings/update_settings_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::Intents::Item
    ...
    class DeviceManagementIntentItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::Intents::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createCopy method.
        def microsoft_graph_create_copy()
            return MicrosoftGraphBeta::DeviceManagement::Intents::Item::MicrosoftGraphCreateCopy::CreateCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the migrateToTemplate method.
        def microsoft_graph_migrate_to_template()
            return MicrosoftGraphBeta::DeviceManagement::Intents::Item::MicrosoftGraphMigrateToTemplate::MigrateToTemplateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateSettings method.
        def microsoft_graph_update_settings()
            return MicrosoftGraphBeta::DeviceManagement::Intents::Item::MicrosoftGraphUpdateSettings::UpdateSettingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param deviceManagementIntentId key: id of deviceManagementIntent
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_management_intent_id=nil)
