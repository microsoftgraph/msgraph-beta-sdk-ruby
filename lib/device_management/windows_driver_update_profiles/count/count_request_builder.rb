...
module MicrosoftGraphBeta::DeviceManagement::WindowsDriverUpdateProfiles::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/windowsDriverUpdateProfiles/$count{?%24search,%24filter}"
