...
require_relative './microsoft_graph_sync_inventory/microsoft_graph_sync_inventory_request_builder'
            ...
            module Item
                ...
                class WindowsDriverUpdateProfileItemRequestBuilder
                    ...
                    def microsoft_graph_assign()
                        return MicrosoftGraphBeta::DeviceManagement::WindowsDriverUpdateProfiles::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the executeAction method.
                    def microsoft_graph_execute_action()
                        return MicrosoftGraphBeta::DeviceManagement::WindowsDriverUpdateProfiles::Item::MicrosoftGraphExecuteAction::MicrosoftGraphExecuteActionRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the syncInventory method.
                    def microsoft_graph_sync_inventory()
                        return MicrosoftGraphBeta::DeviceManagement::WindowsDriverUpdateProfiles::Item::MicrosoftGraphSyncInventory::MicrosoftGraphSyncInventoryRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
