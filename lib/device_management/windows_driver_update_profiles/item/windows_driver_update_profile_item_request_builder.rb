...
require_relative './microsoft_graph_sync_inventory/sync_inventory_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::WindowsDriverUpdateProfiles::Item
    ...
    class WindowsDriverUpdateProfileItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::WindowsDriverUpdateProfiles::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the executeAction method.
        def microsoft_graph_execute_action()
            return MicrosoftGraphBeta::DeviceManagement::WindowsDriverUpdateProfiles::Item::MicrosoftGraphExecuteAction::ExecuteActionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the syncInventory method.
        def microsoft_graph_sync_inventory()
            return MicrosoftGraphBeta::DeviceManagement::WindowsDriverUpdateProfiles::Item::MicrosoftGraphSyncInventory::SyncInventoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param windowsDriverUpdateProfileId key: id of windowsDriverUpdateProfile
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, windows_driver_update_profile_id=nil)
