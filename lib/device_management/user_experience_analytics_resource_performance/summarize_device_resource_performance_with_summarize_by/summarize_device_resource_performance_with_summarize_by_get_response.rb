    ...
    module DeviceManagement
        module UserExperienceAnalyticsResourcePerformance
            module SummarizeDeviceResourcePerformanceWithSummarizeBy
                class SummarizeDeviceResourcePerformanceWithSummarizeByGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                    include MicrosoftKiotaAbstractions::Parsable
                    ## 
                    # The value property
                    @value
                    ## 
                    ## Instantiates a new SummarizeDeviceResourcePerformanceWithSummarizeByGetResponse and sets the default values.
                    ## @return a void
                    ## 
                    def initialize()
                        super
                    ...
                    ## @return a summarize_device_resource_performance_with_summarize_by_get_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return SummarizeDeviceResourcePerformanceWithSummarizeByGetResponse.new
                    end
                    ## 
