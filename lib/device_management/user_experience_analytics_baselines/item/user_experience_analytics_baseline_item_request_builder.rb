...
module MicrosoftGraphBeta::DeviceManagement::UserExperienceAnalyticsBaselines::Item
    ## 
    ...
    class UserExperienceAnalyticsBaselineItemRequestBuilder
        ...
        ## @param userExperienceAnalyticsBaselineId key: id of userExperienceAnalyticsBaseline
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, user_experience_analytics_baseline_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}{?%24select,%24expand}"
