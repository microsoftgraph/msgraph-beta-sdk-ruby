            ...
            module Item
                ...
                class DeviceCompliancePolicyItemRequestBuilder
                    ...
                    def microsoft_graph_assign()
                        return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the scheduleActionsForRules method.
                    def microsoft_graph_schedule_actions_for_rules()
                        return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::MicrosoftGraphScheduleActionsForRules::MicrosoftGraphScheduleActionsForRulesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
