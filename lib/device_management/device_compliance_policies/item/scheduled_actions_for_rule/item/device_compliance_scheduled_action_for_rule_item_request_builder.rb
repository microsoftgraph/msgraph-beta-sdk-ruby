...
module MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::ScheduledActionsForRule::Item
    ## 
    ...
    class DeviceComplianceScheduledActionForRuleItemRequestBuilder
        ...
        def scheduled_action_configurations()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::ScheduledActionsForRule::Item::ScheduledActionConfigurations::ScheduledActionConfigurationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
