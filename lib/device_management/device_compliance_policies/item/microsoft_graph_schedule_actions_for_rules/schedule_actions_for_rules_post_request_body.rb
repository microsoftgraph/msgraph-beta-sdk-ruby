...
module MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::MicrosoftGraphScheduleActionsForRules
    class ScheduleActionsForRulesPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "deviceComplianceScheduledActionForRules" => lambda {|n| @device_compliance_scheduled_action_for_rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceComplianceScheduledActionForRule.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
