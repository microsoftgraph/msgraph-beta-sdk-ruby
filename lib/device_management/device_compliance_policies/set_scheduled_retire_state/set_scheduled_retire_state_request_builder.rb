    ...
    module DeviceManagement
        module DeviceCompliancePolicies
            module SetScheduledRetireState
                ...
                class SetScheduledRetireStateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/setScheduledRetireState")
                    end
                    ## 
                    ...
                    ## @return a set_scheduled_retire_state_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return SetScheduledRetireStateRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
