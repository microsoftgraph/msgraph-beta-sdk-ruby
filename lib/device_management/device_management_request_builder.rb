...
require_relative './user_experience_analytics_device_timeline_events/item/user_experience_analytics_device_timeline_events_item_request_builder'
require_relative './user_experience_analytics_device_timeline_events/user_experience_analytics_device_timeline_events_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement
    ...
    class DeviceManagementRequestBuilder
        ...
        def user_experience_analytics_device_timeline_events()
            return MicrosoftGraphBeta::DeviceManagement::UserExperienceAnalyticsDeviceTimelineEvents::UserExperienceAnalyticsDeviceTimelineEventsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## Provides operations to manage the userExperienceAnalyticsDeviceTimelineEvents property of the microsoft.graph.deviceManagement entity.
        ## @param id Unique identifier of the item
        ## @return a user_experience_analytics_device_timeline_events_item_request_builder
        ## 
        def user_experience_analytics_device_timeline_events_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["userExperienceAnalyticsDeviceTimelineEvents%2Did"] = id
            return MicrosoftGraphBeta::DeviceManagement::UserExperienceAnalyticsDeviceTimelineEvents::Item::UserExperienceAnalyticsDeviceTimelineEventsItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the userExperienceAnalyticsImpactingProcess property of the microsoft.graph.deviceManagement entity.
        ## @param id Unique identifier of the item
