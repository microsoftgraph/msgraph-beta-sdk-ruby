...
module MicrosoftGraphBeta::DeviceManagement::RoleScopeTags::Item::Assignments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/roleScopeTags/{roleScopeTag%2Did}/assignments/$count{?%24search,%24filter}"
