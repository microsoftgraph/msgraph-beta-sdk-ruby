        ...
        module RoleScopeTags
            module HasCustomRoleScopeTag
                ...
                class HasCustomRoleScopeTagRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a Fiber of has_custom_role_scope_tag_get_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::RoleScopeTags::HasCustomRoleScopeTag::HasCustomRoleScopeTagGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Invoke function hasCustomRoleScopeTag
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ...
                    ## @return a has_custom_role_scope_tag_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return HasCustomRoleScopeTagRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
