...
module MicrosoftGraphBeta::DeviceManagement::DeviceShellScripts::Item::DeviceRunStates::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}/deviceRunStates/$count{?%24search,%24filter}"
