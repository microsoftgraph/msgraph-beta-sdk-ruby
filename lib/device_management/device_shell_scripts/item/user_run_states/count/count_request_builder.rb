...
module MicrosoftGraphBeta::DeviceManagement::DeviceShellScripts::Item::UserRunStates::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}/userRunStates/$count{?%24search,%24filter}"
