        ...
        module SoftwareUpdateStatusSummary
            ...
            class SoftwareUpdateStatusSummaryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SoftwareUpdateStatusSummary.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## The software update status summary.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
