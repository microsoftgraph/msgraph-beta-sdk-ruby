            ...
            module Item
                module RoleAssignments
                    ...
                    class RoleAssignmentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::DeviceManagement::RoleDefinitions::Item::RoleAssignments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the roleAssignments property of the microsoft.graph.roleDefinition entity.
                        ...
                        def by_role_assignment_id(role_assignment_id)
                            ...
                            return MicrosoftGraphBeta::DeviceManagement::RoleDefinitions::Item::RoleAssignments::Item::RoleAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::RoleAssignmentCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
