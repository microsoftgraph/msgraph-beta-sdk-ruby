            ...
            module ImportOffice365DeviceConfigurationPolicies
                ...
                class ImportOffice365DeviceConfigurationPoliciesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def post(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::Templates::ImportOffice365DeviceConfigurationPolicies::ImportOffice365DeviceConfigurationPoliciesPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Invoke action importOffice365DeviceConfigurationPolicies
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
