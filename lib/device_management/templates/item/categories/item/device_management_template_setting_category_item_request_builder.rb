...
module MicrosoftGraphBeta::DeviceManagement::Templates::Item::Categories::Item
    ## 
    ...
    class DeviceManagementTemplateSettingCategoryItemRequestBuilder
        ...
        ## @param deviceManagementTemplateSettingCategoryId key: id of deviceManagementTemplateSettingCategory
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_management_template_setting_category_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/categories/{deviceManagementTemplateSettingCategory%2Did}{?%24select,%24expand}"
