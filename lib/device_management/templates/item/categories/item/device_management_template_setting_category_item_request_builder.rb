            ...
            module Item
                module Categories
                    module Item
                        ...
                        class DeviceManagementTemplateSettingCategoryItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def recommended_settings()
                                return MicrosoftGraphBeta::DeviceManagement::Templates::Item::Categories::Item::RecommendedSettings::RecommendedSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def setting_definitions()
                                return MicrosoftGraphBeta::DeviceManagement::Templates::Item::Categories::Item::SettingDefinitions::SettingDefinitionsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/categories/{deviceManagementTemplateSettingCategory%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/categories/{deviceManagementTemplateSettingCategory%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return DeviceManagementTemplateSettingCategoryItemRequestBuilder.new(raw_url, @request_adapter)
                            end
