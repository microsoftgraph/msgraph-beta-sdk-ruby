...
module MicrosoftGraphBeta::DeviceManagement::Templates::Item
    ## 
    ...
    class DeviceManagementTemplateItemRequestBuilder
        ...
        def microsoft_graph_create_instance()
            return MicrosoftGraphBeta::DeviceManagement::Templates::Item::MicrosoftGraphCreateInstance::CreateInstanceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param deviceManagementTemplateId key: id of deviceManagementTemplate
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_management_template_id=nil)
