...
module MicrosoftGraphBeta::DeviceManagement::Templates::Item
    ...
    class DeviceManagementTemplateItemRequestBuilder
        ...
        def microsoft_graph_create_instance()
            return MicrosoftGraphBeta::DeviceManagement::Templates::Item::MicrosoftGraphCreateInstance::MicrosoftGraphCreateInstanceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
