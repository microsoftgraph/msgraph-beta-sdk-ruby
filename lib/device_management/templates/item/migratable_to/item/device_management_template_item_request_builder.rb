...
require_relative './microsoft_graph_create_instance/create_instance_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::Templates::Item::MigratableTo::Item
    ## 
    ...
    class DeviceManagementTemplateItemRequestBuilder
        ...
        def microsoft_graph_create_instance()
            return MicrosoftGraphBeta::DeviceManagement::Templates::Item::MigratableTo::Item::MicrosoftGraphCreateInstance::CreateInstanceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param deviceManagementTemplateId1 key: id of deviceManagementTemplate
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_management_template_id1=nil)
