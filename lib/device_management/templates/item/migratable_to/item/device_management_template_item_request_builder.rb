                ...
                module MigratableTo
                    module Item
                        ...
                        class DeviceManagementTemplateItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def create_instance()
                                return MicrosoftGraphBeta::DeviceManagement::Templates::Item::MigratableTo::Item::CreateInstance::CreateInstanceRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/migratableTo/{deviceManagementTemplate%2Did1}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/migratableTo/{deviceManagementTemplate%2Did1}'
                            ...
                            def with_url(raw_url)
                                ...
                                return DeviceManagementTemplateItemRequestBuilder.new(raw_url, @request_adapter)
                            end
