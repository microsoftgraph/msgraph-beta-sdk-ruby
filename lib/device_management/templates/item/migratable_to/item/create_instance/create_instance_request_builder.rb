                ...
                module MigratableTo
                    module Item
                        module CreateInstance
                            ...
                            class CreateInstanceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/migratableTo/{deviceManagementTemplate%2Did1}/createInstance")
                                end
                                ## 
                                ...
                                ## @return a create_instance_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return CreateInstanceRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
