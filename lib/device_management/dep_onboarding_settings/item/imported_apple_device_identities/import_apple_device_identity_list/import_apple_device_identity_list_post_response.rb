            ...
            module Item
                module ImportedAppleDeviceIdentities
                    module ImportAppleDeviceIdentityList
                        class ImportAppleDeviceIdentityListPostResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                            ...
                            ## @return a import_apple_device_identity_list_post_response
                            ## 
                            def self.create_from_discriminator_value(parse_node)
                                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                return ImportAppleDeviceIdentityListPostResponse.new
                            end
                            ## 
