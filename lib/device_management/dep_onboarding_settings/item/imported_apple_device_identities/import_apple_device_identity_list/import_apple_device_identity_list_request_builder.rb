                ...
                module ImportedAppleDeviceIdentities
                    module ImportAppleDeviceIdentityList
                        ...
                        class ImportAppleDeviceIdentityListRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            ## @return a Fiber of import_apple_device_identity_list_post_response
                            ## 
                            def post(body, request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::ImportedAppleDeviceIdentities::ImportAppleDeviceIdentityList::ImportAppleDeviceIdentityListPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Invoke action importAppleDeviceIdentityList
                            ## @param body The request body
                            ...
                            ## @return a import_apple_device_identity_list_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return ImportAppleDeviceIdentityListRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
