                ...
                module EnrollmentProfiles
                    module Item
                        module UpdateDeviceProfileAssignment
                            ...
                            class UpdateDeviceProfileAssignmentRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/depOnboardingSettings/{depOnboardingSetting%2Did}/enrollmentProfiles/{enrollmentProfile%2Did}/updateDeviceProfileAssignment")
                                end
                                ## 
                                ...
                                ## @return a update_device_profile_assignment_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return UpdateDeviceProfileAssignmentRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
