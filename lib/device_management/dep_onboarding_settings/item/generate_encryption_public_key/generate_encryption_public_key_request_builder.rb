            ...
            module Item
                module GenerateEncryptionPublicKey
                    ...
                    class GenerateEncryptionPublicKeyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a Fiber of generate_encryption_public_key_post_response
                        ## 
                        def post(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::GenerateEncryptionPublicKey::GenerateEncryptionPublicKeyPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Generate a public key to use to encrypt the Apple device enrollment program token
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ...
                        ## @return a generate_encryption_public_key_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return GenerateEncryptionPublicKeyRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
