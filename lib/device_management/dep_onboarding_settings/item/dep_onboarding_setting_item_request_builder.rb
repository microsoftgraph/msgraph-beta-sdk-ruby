...
require_relative './microsoft_graph_generate_encryption_public_key/generate_encryption_public_key_request_builder'
require_relative './microsoft_graph_get_encryption_public_key/get_encryption_public_key_request_builder'
require_relative './microsoft_graph_share_for_school_data_sync_service/share_for_school_data_sync_service_request_builder'
require_relative './microsoft_graph_sync_with_apple_device_enrollment_program/sync_with_apple_device_enrollment_program_request_builder'
require_relative './microsoft_graph_unshare_for_school_data_sync_service/unshare_for_school_data_sync_service_request_builder'
require_relative './microsoft_graph_upload_dep_token/upload_dep_token_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item
    ...
    class DepOnboardingSettingItemRequestBuilder
        ...
        def microsoft_graph_generate_encryption_public_key()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphGenerateEncryptionPublicKey::GenerateEncryptionPublicKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getEncryptionPublicKey method.
        def microsoft_graph_get_encryption_public_key()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphGetEncryptionPublicKey::GetEncryptionPublicKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_share_for_school_data_sync_service()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphShareForSchoolDataSyncService::ShareForSchoolDataSyncServiceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_sync_with_apple_device_enrollment_program()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphSyncWithAppleDeviceEnrollmentProgram::SyncWithAppleDeviceEnrollmentProgramRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_unshare_for_school_data_sync_service()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphUnshareForSchoolDataSyncService::UnshareForSchoolDataSyncServiceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the uploadDepToken method.
        def microsoft_graph_upload_dep_token()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphUploadDepToken::UploadDepTokenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param depOnboardingSettingId key: id of depOnboardingSetting
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, dep_onboarding_setting_id=nil)
