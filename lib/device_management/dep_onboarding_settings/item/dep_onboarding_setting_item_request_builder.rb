...
require_relative './default_tv_o_s_enrollment_profile/default_tv_o_s_enrollment_profile_request_builder'
require_relative './default_vision_o_s_enrollment_profile/default_vision_o_s_enrollment_profile_request_builder'
            ...
            module Item
                ...
                class DepOnboardingSettingItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def default_tv_o_s_enrollment_profile()
                        return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::DefaultTvOSEnrollmentProfile::DefaultTvOSEnrollmentProfileRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def default_vision_o_s_enrollment_profile()
                        return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::DefaultVisionOSEnrollmentProfile::DefaultVisionOSEnrollmentProfileRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/depOnboardingSettings/{depOnboardingSetting%2Did}{?%24expand,%24select}")
                    end
                    ## 
