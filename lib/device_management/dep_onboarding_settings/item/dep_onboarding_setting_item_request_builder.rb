...
require_relative './microsoft_graph_generate_encryption_public_key/microsoft_graph_generate_encryption_public_key_request_builder'
require_relative './microsoft_graph_get_encryption_public_key/microsoft_graph_get_encryption_public_key_request_builder'
require_relative './microsoft_graph_share_for_school_data_sync_service/microsoft_graph_share_for_school_data_sync_service_request_builder'
require_relative './microsoft_graph_sync_with_apple_device_enrollment_program/microsoft_graph_sync_with_apple_device_enrollment_program_request_builder'
require_relative './microsoft_graph_unshare_for_school_data_sync_service/microsoft_graph_unshare_for_school_data_sync_service_request_builder'
require_relative './microsoft_graph_upload_dep_token/microsoft_graph_upload_dep_token_request_builder'

module MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item
    ## 
    ...
    class DepOnboardingSettingItemRequestBuilder
        ...
        def microsoft_graph_generate_encryption_public_key()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphGenerateEncryptionPublicKey::MicrosoftGraphGenerateEncryptionPublicKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getEncryptionPublicKey method.
        def microsoft_graph_get_encryption_public_key()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphGetEncryptionPublicKey::MicrosoftGraphGetEncryptionPublicKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the shareForSchoolDataSyncService method.
        def microsoft_graph_share_for_school_data_sync_service()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphShareForSchoolDataSyncService::MicrosoftGraphShareForSchoolDataSyncServiceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the syncWithAppleDeviceEnrollmentProgram method.
        def microsoft_graph_sync_with_apple_device_enrollment_program()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphSyncWithAppleDeviceEnrollmentProgram::MicrosoftGraphSyncWithAppleDeviceEnrollmentProgramRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unshareForSchoolDataSyncService method.
        def microsoft_graph_unshare_for_school_data_sync_service()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphUnshareForSchoolDataSyncService::MicrosoftGraphUnshareForSchoolDataSyncServiceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the uploadDepToken method.
        def microsoft_graph_upload_dep_token()
            return MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Item::MicrosoftGraphUploadDepToken::MicrosoftGraphUploadDepTokenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
