...
module MicrosoftGraphBeta::DeviceManagement::DepOnboardingSettings::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/depOnboardingSettings/$count{?%24search,%24filter}"
