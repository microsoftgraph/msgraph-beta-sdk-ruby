...
module MicrosoftGraphBeta::DeviceManagement::NotificationMessageTemplates::Item
    ...
    class NotificationMessageTemplateItemRequestBuilder
        ...
        def microsoft_graph_send_test_message()
            return MicrosoftGraphBeta::DeviceManagement::NotificationMessageTemplates::Item::MicrosoftGraphSendTestMessage::SendTestMessageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
