...
require_relative './item'
require_relative './microsoft_graph_assign_resource_account_to_device/assign_resource_account_to_device_request_builder'
require_relative './microsoft_graph_assign_user_to_device/assign_user_to_device_request_builder'
require_relative './microsoft_graph_unassign_resource_account_from_device/unassign_resource_account_from_device_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item
    ...
    class WindowsAutopilotDeviceIdentityItemRequestBuilder
        ...
        def microsoft_graph_assign_resource_account_to_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::MicrosoftGraphAssignResourceAccountToDevice::AssignResourceAccountToDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assignUserToDevice method.
        def microsoft_graph_assign_user_to_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::MicrosoftGraphAssignUserToDevice::AssignUserToDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_unassign_resource_account_from_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::MicrosoftGraphUnassignResourceAccountFromDevice::UnassignResourceAccountFromDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unassignUserFromDevice method.
        def microsoft_graph_unassign_user_from_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::MicrosoftGraphUnassignUserFromDevice::UnassignUserFromDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateDeviceProperties method.
        def microsoft_graph_update_device_properties()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::MicrosoftGraphUpdateDeviceProperties::UpdateDevicePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
