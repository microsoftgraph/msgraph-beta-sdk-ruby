...
module MicrosoftGraphBeta::DeviceManagement::MobileAppTroubleshootingEvents::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/$count{?%24search,%24filter}"
