...
require_relative './microsoft_graph_set_scheduled_actions/microsoft_graph_set_scheduled_actions_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::CompliancePolicies::Item
    ...
    class DeviceManagementCompliancePolicyItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::CompliancePolicies::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setScheduledActions method.
        def microsoft_graph_set_scheduled_actions()
            return MicrosoftGraphBeta::DeviceManagement::CompliancePolicies::Item::MicrosoftGraphSetScheduledActions::MicrosoftGraphSetScheduledActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
