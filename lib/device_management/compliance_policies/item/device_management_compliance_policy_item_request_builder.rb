...
require_relative './microsoft_graph_set_scheduled_actions/set_scheduled_actions_request_builder'
require_relative './scheduled_actions_for_rule/item/device_management_compliance_scheduled_action_for_rule_item_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::CompliancePolicies::Item
    ## 
    ...
    class DeviceManagementCompliancePolicyItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::CompliancePolicies::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setScheduledActions method.
        def microsoft_graph_set_scheduled_actions()
            return MicrosoftGraphBeta::DeviceManagement::CompliancePolicies::Item::MicrosoftGraphSetScheduledActions::SetScheduledActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::CompliancePolicies::Item::Assignments::Item::DeviceManagementConfigurationPolicyAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Instantiates a new DeviceManagementCompliancePolicyItemRequestBuilder and sets the default values.
        ## @param deviceManagementCompliancePolicyId key: id of deviceManagementCompliancePolicy
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_management_compliance_policy_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy%2Did}{?%24select,%24expand}"
        ...
        def settings_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::CompliancePolicies::Item::Settings::Item::DeviceManagementConfigurationSettingItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property compliancePolicies for deviceManagement
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
