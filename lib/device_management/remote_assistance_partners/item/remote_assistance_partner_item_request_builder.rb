...
module MicrosoftGraphBeta::DeviceManagement::RemoteAssistancePartners::Item
    ## 
    ...
    class RemoteAssistancePartnerItemRequestBuilder
        ...
        def microsoft_graph_begin_onboarding()
            return MicrosoftGraphBeta::DeviceManagement::RemoteAssistancePartners::Item::MicrosoftGraphBeginOnboarding::MicrosoftGraphBeginOnboardingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the disconnect method.
        def microsoft_graph_disconnect()
            return MicrosoftGraphBeta::DeviceManagement::RemoteAssistancePartners::Item::MicrosoftGraphDisconnect::MicrosoftGraphDisconnectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
