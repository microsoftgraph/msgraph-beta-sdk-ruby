...
module MicrosoftGraphBeta::DeviceManagement::DeviceComplianceScripts::Item
    ...
    class DeviceComplianceScriptItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::DeviceComplianceScripts::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
