...
require_relative './device_run_states/item/device_compliance_script_device_state_item_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::DeviceComplianceScripts::Item
    ## 
    ...
    class DeviceComplianceScriptItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::DeviceComplianceScripts::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceComplianceScripts::Item::Assignments::Item::DeviceHealthScriptAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Instantiates a new DeviceComplianceScriptItemRequestBuilder and sets the default values.
        ## @param deviceComplianceScriptId key: id of deviceComplianceScript
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_compliance_script_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/deviceComplianceScripts/{deviceComplianceScript%2Did}{?%24select,%24expand}"
