                ...
                module MicrosoftGraphDeviceManagementGetPortalNotifications
                    ...
                    class MicrosoftGraphDeviceManagementGetPortalNotificationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/monitoring/alertRecords/microsoft.graph.deviceManagement.getPortalNotifications(){?%24top,%24skip,%24search,%24filter,%24count}")
                        end
                        ## 
