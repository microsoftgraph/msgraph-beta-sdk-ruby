                ...
                module MicrosoftGraphDeviceManagementGetPortalNotifications
                    ...
                    class MicrosoftGraphDeviceManagementGetPortalNotificationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/monitoring/alertRecords/microsoft.graph.deviceManagement.getPortalNotifications(){?%24count,%24filter,%24search,%24skip,%24top}")
                        end
                        ## 
