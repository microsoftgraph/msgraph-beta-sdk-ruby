...
module MicrosoftGraphBeta::DeviceManagement::Monitoring::AlertRecords::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/monitoring/alertRecords/$count{?%24search,%24filter}"
