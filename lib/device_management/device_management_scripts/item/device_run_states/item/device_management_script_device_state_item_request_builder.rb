                ...
                module DeviceRunStates
                    module Item
                        ...
                        class DeviceManagementScriptDeviceStateItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def managed_device()
                                return MicrosoftGraphBeta::DeviceManagement::DeviceManagementScripts::Item::DeviceRunStates::Item::ManagedDevice::ManagedDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/deviceManagementScripts/{deviceManagementScript%2Did}/deviceRunStates/{deviceManagementScriptDeviceState%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/deviceManagement/deviceManagementScripts/{deviceManagementScript%2Did}/deviceRunStates/{deviceManagementScriptDeviceState%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return DeviceManagementScriptDeviceStateItemRequestBuilder.new(raw_url, @request_adapter)
                            end
