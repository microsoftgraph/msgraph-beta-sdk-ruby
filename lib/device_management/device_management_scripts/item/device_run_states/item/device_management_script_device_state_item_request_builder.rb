...
module MicrosoftGraphBeta::DeviceManagement::DeviceManagementScripts::Item::DeviceRunStates::Item
    ## 
    ...
    class DeviceManagementScriptDeviceStateItemRequestBuilder
        ...
        ## @param deviceManagementScriptDeviceStateId key: id of deviceManagementScriptDeviceState
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_management_script_device_state_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/deviceManagementScripts/{deviceManagementScript%2Did}/deviceRunStates/{deviceManagementScriptDeviceState%2Did}{?%24select,%24expand}"
