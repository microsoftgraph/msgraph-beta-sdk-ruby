...
module MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeviceIdentities::Item
    ## 
    ...
    class WindowsAutopilotDeviceIdentityItemRequestBuilder
        ...
        def microsoft_graph_assign_resource_account_to_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeviceIdentities::Item::MicrosoftGraphAssignResourceAccountToDevice::MicrosoftGraphAssignResourceAccountToDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assignUserToDevice method.
        def microsoft_graph_assign_user_to_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeviceIdentities::Item::MicrosoftGraphAssignUserToDevice::MicrosoftGraphAssignUserToDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_unassign_resource_account_from_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeviceIdentities::Item::MicrosoftGraphUnassignResourceAccountFromDevice::MicrosoftGraphUnassignResourceAccountFromDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unassignUserFromDevice method.
        def microsoft_graph_unassign_user_from_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeviceIdentities::Item::MicrosoftGraphUnassignUserFromDevice::MicrosoftGraphUnassignUserFromDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateDeviceProperties method.
        def microsoft_graph_update_device_properties()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeviceIdentities::Item::MicrosoftGraphUpdateDeviceProperties::MicrosoftGraphUpdateDevicePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
