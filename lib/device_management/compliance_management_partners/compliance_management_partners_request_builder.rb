    ...
    module DeviceManagement
        module ComplianceManagementPartners
            ...
            class ComplianceManagementPartnersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::DeviceManagement::ComplianceManagementPartners::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the complianceManagementPartners property of the microsoft.graph.deviceManagement entity.
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ComplianceManagementPartnerCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
