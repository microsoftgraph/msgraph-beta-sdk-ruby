...
module MicrosoftGraphBeta::DeviceManagement::DeviceManagementPartners::Item
    ## 
    ...
    class DeviceManagementPartnerItemRequestBuilder
        ...
        def microsoft_graph_terminate()
            return MicrosoftGraphBeta::DeviceManagement::DeviceManagementPartners::Item::MicrosoftGraphTerminate::MicrosoftGraphTerminateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
