...
require_relative '../../../models/hardware_password_info'
require_relative '../../../models/o_data_errors_o_data_error'
require_relative '../../device_management'
require_relative '../hardware_password_info'
require_relative './item'

module MicrosoftGraphBeta
    module DeviceManagement
        module HardwarePasswordInfo
            module Item
                ## 
                # Provides operations to manage the hardwarePasswordInfo property of the microsoft.graph.deviceManagement entity.
                class HardwarePasswordInfoItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/hardwarePasswordInfo/{hardwarePasswordInfo%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of hardware_password_info
                    ## 
                    def get(request_configuration=nil)
                        ...
                        error_mapping = Hash.new
                        error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::HardwarePasswordInfo.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ...
                    ## @return a hardware_password_info_item_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return HardwarePasswordInfoItemRequestBuilder.new(raw_url, @request_adapter)
                    end
