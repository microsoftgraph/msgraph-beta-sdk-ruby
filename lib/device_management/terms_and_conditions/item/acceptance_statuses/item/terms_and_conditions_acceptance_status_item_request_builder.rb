...
module MicrosoftGraphBeta::DeviceManagement::TermsAndConditions::Item::AcceptanceStatuses::Item
    ## 
    ...
    class TermsAndConditionsAcceptanceStatusItemRequestBuilder
        ...
        def terms_and_conditions()
            return MicrosoftGraphBeta::DeviceManagement::TermsAndConditions::Item::AcceptanceStatuses::Item::TermsAndConditions::TermsAndConditionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
