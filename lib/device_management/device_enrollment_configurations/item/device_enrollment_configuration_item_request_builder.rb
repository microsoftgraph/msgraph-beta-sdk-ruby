            ...
            module Item
                ...
                class DeviceEnrollmentConfigurationItemRequestBuilder
                    ...
                    def microsoft_graph_assign()
                        return MicrosoftGraphBeta::DeviceManagement::DeviceEnrollmentConfigurations::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the setPriority method.
                    def microsoft_graph_set_priority()
                        return MicrosoftGraphBeta::DeviceManagement::DeviceEnrollmentConfigurations::Item::MicrosoftGraphSetPriority::MicrosoftGraphSetPriorityRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
