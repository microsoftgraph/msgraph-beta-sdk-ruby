            ...
            module HasPayloadLinks
                ...
                class HasPayloadLinksRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def post(body, request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::DeviceEnrollmentConfigurations::HasPayloadLinks::HasPayloadLinksResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Invoke action hasPayloadLinks
                    ## @param body The request body
