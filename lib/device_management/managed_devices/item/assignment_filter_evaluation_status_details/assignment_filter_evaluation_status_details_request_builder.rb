...
require_relative './item/assignment_filter_evaluation_status_details_item_request_builder'
        ...
        module ManagedDevices
            module Item
                module AssignmentFilterEvaluationStatusDetails
                    ...
                    class AssignmentFilterEvaluationStatusDetailsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to count the resources in the collection.
                        def count()
                            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::AssignmentFilterEvaluationStatusDetails::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the assignmentFilterEvaluationStatusDetails property of the microsoft.graph.managedDevice entity.
                        ...
                        ## 
                        def by_assignment_filter_evaluation_status_details_id(assignment_filter_evaluation_status_details_id)
                            raise StandardError, 'assignment_filter_evaluation_status_details_id cannot be null' if assignment_filter_evaluation_status_details_id.nil?
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/assignmentFilterEvaluationStatusDetails{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/assignmentFilterEvaluationStatusDetails'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a assignment_filter_evaluation_status_details_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return AssignmentFilterEvaluationStatusDetailsRequestBuilder.new(raw_url, @request_adapter)
                        end
