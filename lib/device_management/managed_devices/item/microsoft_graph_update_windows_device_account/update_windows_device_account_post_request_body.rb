...
module MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphUpdateWindowsDeviceAccount
    class UpdateWindowsDeviceAccountPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "updateWindowsDeviceAccountActionParameter" => lambda {|n| @update_windows_device_account_action_parameter = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UpdateWindowsDeviceAccountActionParameter.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
