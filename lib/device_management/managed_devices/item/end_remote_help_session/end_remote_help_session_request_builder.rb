...
module MicrosoftGraphBeta
    module DeviceManagement
        module ManagedDevices
            module Item
                module EndRemoteHelpSession
                    ## 
                    # Provides operations to call the endRemoteHelpSession method.
                    class EndRemoteHelpSessionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/endRemoteHelpSession")
                        end
                        ## 
