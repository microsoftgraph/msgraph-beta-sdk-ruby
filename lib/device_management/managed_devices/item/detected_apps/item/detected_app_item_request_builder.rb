...
module MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::DetectedApps::Item
    ## 
    ...
    class DetectedAppItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/detectedApps/{detectedApp%2Did}{?%24select,%24expand}"
