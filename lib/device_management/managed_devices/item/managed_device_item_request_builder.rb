...
module MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item
    ## 
    ...
    class ManagedDeviceItemRequestBuilder
        ...
        def assignment_filter_evaluation_status_details()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::AssignmentFilterEvaluationStatusDetails::AssignmentFilterEvaluationStatusDetailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the detectedApps property of the microsoft.graph.managedDevice entity.
        def detected_apps()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::DetectedApps::DetectedAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the deviceCategory property of the microsoft.graph.managedDevice entity.
        def device_category()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::DeviceCategory::DeviceCategoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the deviceCompliancePolicyStates property of the microsoft.graph.managedDevice entity.
        def device_compliance_policy_states()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::DeviceCompliancePolicyStates::DeviceCompliancePolicyStatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the deviceConfigurationStates property of the microsoft.graph.managedDevice entity.
        def device_configuration_states()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::DeviceConfigurationStates::DeviceConfigurationStatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def device_health_script_states()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::DeviceHealthScriptStates::DeviceHealthScriptStatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the logCollectionRequests property of the microsoft.graph.managedDevice entity.
        def log_collection_requests()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::LogCollectionRequests::LogCollectionRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def managed_device_mobile_app_configuration_states()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::ManagedDeviceMobileAppConfigurationStates::ManagedDeviceMobileAppConfigurationStatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the activateDeviceEsim method.
        def microsoft_graph_activate_device_esim()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphActivateDeviceEsim::MicrosoftGraphActivateDeviceEsimRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the bypassActivationLock method.
        def microsoft_graph_bypass_activation_lock()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphBypassActivationLock::MicrosoftGraphBypassActivationLockRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cleanWindowsDevice method.
        def microsoft_graph_clean_windows_device()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphCleanWindowsDevice::MicrosoftGraphCleanWindowsDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_create_device_log_collection_request()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphCreateDeviceLogCollectionRequest::MicrosoftGraphCreateDeviceLogCollectionRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createRemoteHelpSession method.
        def microsoft_graph_create_remote_help_session()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphCreateRemoteHelpSession::MicrosoftGraphCreateRemoteHelpSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the deleteUserFromSharedAppleDevice method.
        def microsoft_graph_delete_user_from_shared_apple_device()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphDeleteUserFromSharedAppleDevice::MicrosoftGraphDeleteUserFromSharedAppleDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the deprovision method.
        def microsoft_graph_deprovision()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphDeprovision::MicrosoftGraphDeprovisionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the disable method.
        def microsoft_graph_disable()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphDisable::MicrosoftGraphDisableRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the disableLostMode method.
        def microsoft_graph_disable_lost_mode()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphDisableLostMode::MicrosoftGraphDisableLostModeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the enableLostMode method.
        def microsoft_graph_enable_lost_mode()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphEnableLostMode::MicrosoftGraphEnableLostModeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the endRemoteHelpSession method.
        def microsoft_graph_end_remote_help_session()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphEndRemoteHelpSession::MicrosoftGraphEndRemoteHelpSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the enrollNowAction method.
        def microsoft_graph_enroll_now_action()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphEnrollNowAction::MicrosoftGraphEnrollNowActionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_cloud_pc_remote_action_results()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphGetCloudPcRemoteActionResults::MicrosoftGraphGetCloudPcRemoteActionResultsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getCloudPcReviewStatus method.
        def microsoft_graph_get_cloud_pc_review_status()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphGetCloudPcReviewStatus::MicrosoftGraphGetCloudPcReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getFileVaultKey method.
        def microsoft_graph_get_file_vault_key()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphGetFileVaultKey::MicrosoftGraphGetFileVaultKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getNonCompliantSettings method.
        def microsoft_graph_get_non_compliant_settings()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphGetNonCompliantSettings::MicrosoftGraphGetNonCompliantSettingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getOemWarranty method.
        def microsoft_graph_get_oem_warranty()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphGetOemWarranty::MicrosoftGraphGetOemWarrantyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_initiate_mobile_device_management_key_recovery()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphInitiateMobileDeviceManagementKeyRecovery::MicrosoftGraphInitiateMobileDeviceManagementKeyRecoveryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_initiate_on_demand_proactive_remediation()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphInitiateOnDemandProactiveRemediation::MicrosoftGraphInitiateOnDemandProactiveRemediationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the locateDevice method.
        def microsoft_graph_locate_device()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphLocateDevice::MicrosoftGraphLocateDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the logoutSharedAppleDeviceActiveUser method.
        def microsoft_graph_logout_shared_apple_device_active_user()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphLogoutSharedAppleDeviceActiveUser::MicrosoftGraphLogoutSharedAppleDeviceActiveUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the overrideComplianceState method.
        def microsoft_graph_override_compliance_state()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphOverrideComplianceState::MicrosoftGraphOverrideComplianceStateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the playLostModeSound method.
        def microsoft_graph_play_lost_mode_sound()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphPlayLostModeSound::MicrosoftGraphPlayLostModeSoundRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the rebootNow method.
        def microsoft_graph_reboot_now()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRebootNow::MicrosoftGraphRebootNowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the recoverPasscode method.
        def microsoft_graph_recover_passcode()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRecoverPasscode::MicrosoftGraphRecoverPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reenable method.
        def microsoft_graph_reenable()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphReenable::MicrosoftGraphReenableRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the remoteLock method.
        def microsoft_graph_remote_lock()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRemoteLock::MicrosoftGraphRemoteLockRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_remove_device_firmware_configuration_interface_management()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRemoveDeviceFirmwareConfigurationInterfaceManagement::MicrosoftGraphRemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reprovisionCloudPc method.
        def microsoft_graph_reprovision_cloud_pc()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphReprovisionCloudPc::MicrosoftGraphReprovisionCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the requestRemoteAssistance method.
        def microsoft_graph_request_remote_assistance()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRequestRemoteAssistance::MicrosoftGraphRequestRemoteAssistanceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_request_remote_help_session_access()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRequestRemoteHelpSessionAccess::MicrosoftGraphRequestRemoteHelpSessionAccessRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resetPasscode method.
        def microsoft_graph_reset_passcode()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphResetPasscode::MicrosoftGraphResetPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resizeCloudPc method.
        def microsoft_graph_resize_cloud_pc()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphResizeCloudPc::MicrosoftGraphResizeCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restoreCloudPc method.
        def microsoft_graph_restore_cloud_pc()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRestoreCloudPc::MicrosoftGraphRestoreCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the retire method.
        def microsoft_graph_retire()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRetire::MicrosoftGraphRetireRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the revokeAppleVppLicenses method.
        def microsoft_graph_revoke_apple_vpp_licenses()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRevokeAppleVppLicenses::MicrosoftGraphRevokeAppleVppLicensesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the rotateBitLockerKeys method.
        def microsoft_graph_rotate_bit_locker_keys()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRotateBitLockerKeys::MicrosoftGraphRotateBitLockerKeysRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the rotateFileVaultKey method.
        def microsoft_graph_rotate_file_vault_key()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRotateFileVaultKey::MicrosoftGraphRotateFileVaultKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_send_custom_notification_to_company_portal()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphSendCustomNotificationToCompanyPortal::MicrosoftGraphSendCustomNotificationToCompanyPortalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setCloudPcReviewStatus method.
        def microsoft_graph_set_cloud_pc_review_status()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphSetCloudPcReviewStatus::MicrosoftGraphSetCloudPcReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setDeviceName method.
        def microsoft_graph_set_device_name()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphSetDeviceName::MicrosoftGraphSetDeviceNameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the shutDown method.
        def microsoft_graph_shut_down()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphShutDown::MicrosoftGraphShutDownRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the syncDevice method.
        def microsoft_graph_sync_device()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphSyncDevice::MicrosoftGraphSyncDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_trigger_configuration_manager_action()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphTriggerConfigurationManagerAction::MicrosoftGraphTriggerConfigurationManagerActionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateWindowsDeviceAccount method.
        def microsoft_graph_update_windows_device_account()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphUpdateWindowsDeviceAccount::MicrosoftGraphUpdateWindowsDeviceAccountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the windowsDefenderScan method.
        def microsoft_graph_windows_defender_scan()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphWindowsDefenderScan::MicrosoftGraphWindowsDefenderScanRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the windowsDefenderUpdateSignatures method.
        def microsoft_graph_windows_defender_update_signatures()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphWindowsDefenderUpdateSignatures::MicrosoftGraphWindowsDefenderUpdateSignaturesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the wipe method.
        def microsoft_graph_wipe()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::MicrosoftGraphWipe::MicrosoftGraphWipeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def security_baseline_states()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::SecurityBaselineStates::SecurityBaselineStatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def users()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::Users::UsersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the windowsProtectionState property of the microsoft.graph.managedDevice entity.
        def windows_protection_state()
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::WindowsProtectionState::WindowsProtectionStateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the assignmentFilterEvaluationStatusDetails property of the microsoft.graph.managedDevice entity.
        ...
        def assignment_filter_evaluation_status_details_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::AssignmentFilterEvaluationStatusDetails::Item::AssignmentFilterEvaluationStatusDetailsItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def detected_apps_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::DetectedApps::Item::DetectedAppItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the deviceCompliancePolicyStates property of the microsoft.graph.managedDevice entity.
        ## @param id Unique identifier of the item
        ...
        def device_compliance_policy_states_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::DeviceCompliancePolicyStates::Item::DeviceCompliancePolicyStateItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the deviceConfigurationStates property of the microsoft.graph.managedDevice entity.
        ## @param id Unique identifier of the item
        ...
        def device_configuration_states_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::DeviceConfigurationStates::Item::DeviceConfigurationStateItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def log_collection_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::LogCollectionRequests::Item::DeviceLogCollectionResponseItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the managedDeviceMobileAppConfigurationStates property of the microsoft.graph.managedDevice entity.
        ## @param id Unique identifier of the item
        ...
        def managed_device_mobile_app_configuration_states_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::ManagedDeviceMobileAppConfigurationStates::Item::ManagedDeviceMobileAppConfigurationStateItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def security_baseline_states_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::ManagedDevices::Item::SecurityBaselineStates::Item::SecurityBaselineStateItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property managedDevices for deviceManagement
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
