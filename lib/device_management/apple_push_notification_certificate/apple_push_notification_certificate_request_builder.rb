...
require_relative './microsoft_graph_generate_apple_push_notification_certificate_signing_request/microsoft_graph_generate_apple_push_notification_certificate_signing_request_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::ApplePushNotificationCertificate
    ...
    class ApplePushNotificationCertificateRequestBuilder
        ...
        def microsoft_graph_download_apple_push_notification_certificate_signing_request()
            return MicrosoftGraphBeta::DeviceManagement::ApplePushNotificationCertificate::MicrosoftGraphDownloadApplePushNotificationCertificateSigningRequest::MicrosoftGraphDownloadApplePushNotificationCertificateSigningRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the generateApplePushNotificationCertificateSigningRequest method.
        def microsoft_graph_generate_apple_push_notification_certificate_signing_request()
            return MicrosoftGraphBeta::DeviceManagement::ApplePushNotificationCertificate::MicrosoftGraphGenerateApplePushNotificationCertificateSigningRequest::MicrosoftGraphGenerateApplePushNotificationCertificateSigningRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
