...
module MicrosoftGraphBeta::DeviceManagement::UserExperienceAnalyticsDeviceScopes::Item
    ...
    class UserExperienceAnalyticsDeviceScopeItemRequestBuilder
        ...
        def microsoft_graph_trigger_device_scope_action()
            return MicrosoftGraphBeta::DeviceManagement::UserExperienceAnalyticsDeviceScopes::Item::MicrosoftGraphTriggerDeviceScopeAction::MicrosoftGraphTriggerDeviceScopeActionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
