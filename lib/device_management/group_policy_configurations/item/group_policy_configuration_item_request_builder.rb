...
require_relative './update_definition_values/update_definition_values_request_builder'
    ...
    module DeviceManagement
        module GroupPolicyConfigurations
            module Item
                ...
                class GroupPolicyConfigurationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to call the assign method.
                    def assign()
                        return MicrosoftGraphBeta::DeviceManagement::GroupPolicyConfigurations::Item::Assign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def update_definition_values()
                        return MicrosoftGraphBeta::DeviceManagement::GroupPolicyConfigurations::Item::UpdateDefinitionValues::UpdateDefinitionValuesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/groupPolicyConfigurations/{groupPolicyConfiguration%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/deviceManagement/groupPolicyConfigurations/{groupPolicyConfiguration%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return GroupPolicyConfigurationItemRequestBuilder.new(raw_url, @request_adapter)
                    end
