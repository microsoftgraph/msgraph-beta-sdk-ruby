...
require_relative './microsoft_graph_update_definition_values/microsoft_graph_update_definition_values_request_builder'
            ...
            module Item
                ...
                class GroupPolicyConfigurationItemRequestBuilder
                    ...
                    def microsoft_graph_assign()
                        return MicrosoftGraphBeta::DeviceManagement::GroupPolicyConfigurations::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the updateDefinitionValues method.
                    def microsoft_graph_update_definition_values()
                        return MicrosoftGraphBeta::DeviceManagement::GroupPolicyConfigurations::Item::MicrosoftGraphUpdateDefinitionValues::MicrosoftGraphUpdateDefinitionValuesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
