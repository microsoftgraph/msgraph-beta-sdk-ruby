...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyConfigurations::Item::DefinitionValues::Item::PresentationValues::Item
    ...
    class GroupPolicyPresentationValueItemRequestBuilder
        ...
        ## @param groupPolicyPresentationValueId key: id of groupPolicyPresentationValue
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, group_policy_presentation_value_id=nil)
