...
module MicrosoftGraphBeta::DeviceManagement::ChromeOSOnboardingSettings::Disconnect
    ## 
    ...
    class DisconnectRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/chromeOSOnboardingSettings/microsoft.graph.disconnect"
