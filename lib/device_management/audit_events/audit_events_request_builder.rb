...
module MicrosoftGraphBeta::DeviceManagement::AuditEvents
    ## 
    ...
    class AuditEventsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::DeviceManagement::AuditEvents::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAuditCategories method.
        def microsoft_graph_get_audit_categories()
            return MicrosoftGraphBeta::DeviceManagement::AuditEvents::MicrosoftGraphGetAuditCategories::MicrosoftGraphGetAuditCategoriesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AuditEventCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ...
        def post(body, request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AuditEvent.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## The Audit Events
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
