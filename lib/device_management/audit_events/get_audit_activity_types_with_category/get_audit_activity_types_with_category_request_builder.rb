            ...
            module GetAuditActivityTypesWithCategory
                ...
                class GetAuditActivityTypesWithCategoryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::AuditEvents::GetAuditActivityTypesWithCategory::GetAuditActivityTypesWithCategoryResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Invoke function getAuditActivityTypes
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
