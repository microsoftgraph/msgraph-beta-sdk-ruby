            ...
            module GetAuditCategories
                ...
                class GetAuditCategoriesRequestBuilder
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::AuditEvents::GetAuditCategories::GetAuditCategoriesResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Invoke function getAuditCategories
                    ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
