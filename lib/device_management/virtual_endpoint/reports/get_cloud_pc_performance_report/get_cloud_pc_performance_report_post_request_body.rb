        ...
        module VirtualEndpoint
            module Reports
                module GetCloudPcPerformanceReport
                    class GetCloudPcPerformanceReportPostRequestBody
                        ...
                        ## @return a get_cloud_pc_performance_report_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return GetCloudPcPerformanceReportPostRequestBody.new
                        end
                        ## 
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "reportName" => lambda {|n| @report_name = n.get_enum_value(MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::GetCloudPcPerformanceReport::GetCloudPcPerformanceReportPostRequestBodyReportName) },
                        ...
                        ## @return a get_cloud_pc_performance_report_post_request_body_report_name
                        ## 
                        def report_name
                            return @report_name
                        end
