...
require_relative './get_shared_use_license_usage_report'

module MicrosoftGraphBeta
    module DeviceManagement
        module VirtualEndpoint
            module Reports
                module GetSharedUseLicenseUsageReport
                    class GetSharedUseLicenseUsageReportPostRequestBody
                        ...
                        ## @return a get_shared_use_license_usage_report_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return GetSharedUseLicenseUsageReportPostRequestBody.new
                        end
                        ## 
