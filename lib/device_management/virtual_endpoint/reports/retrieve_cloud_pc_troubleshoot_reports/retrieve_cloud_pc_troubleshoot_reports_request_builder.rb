...
require_relative './retrieve_cloud_pc_troubleshoot_reports'

module MicrosoftGraphBeta
    module DeviceManagement
        module VirtualEndpoint
            module Reports
                module RetrieveCloudPcTroubleshootReports
                    ## 
                    # Provides operations to call the retrieveCloudPcTroubleshootReports method.
                    class RetrieveCloudPcTroubleshootReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/reports/retrieveCloudPcTroubleshootReports")
                        end
                        ## 
                        ...
                        ## @return a retrieve_cloud_pc_troubleshoot_reports_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return RetrieveCloudPcTroubleshootReportsRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
