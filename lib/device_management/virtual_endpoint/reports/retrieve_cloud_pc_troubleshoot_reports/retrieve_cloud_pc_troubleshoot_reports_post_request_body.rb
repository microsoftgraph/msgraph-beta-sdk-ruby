...
require_relative '../../../../models/cloud_p_c_troubleshoot_report_type'
        ...
        module VirtualEndpoint
            module Reports
                module RetrieveCloudPcTroubleshootReports
                    class RetrieveCloudPcTroubleshootReportsPostRequestBody
                        ...
                        ## @return a retrieve_cloud_pc_troubleshoot_reports_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return RetrieveCloudPcTroubleshootReportsPostRequestBody.new
                        end
                        ## 
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "reportName" => lambda {|n| @report_name = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPCTroubleshootReportType) },
                        ...
                        ## @return a cloud_p_c_troubleshoot_report_type
                        ## 
                        def report_name
                            return @report_name
                        end
