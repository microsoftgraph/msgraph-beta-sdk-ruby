...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::GetTotalAggregatedRemoteConnectionReports
    class GetTotalAggregatedRemoteConnectionReportsPostRequestBody
        ...
        ## @return a get_total_aggregated_remote_connection_reports_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetTotalAggregatedRemoteConnectionReportsPostRequestBody.new
        end
        ## 
