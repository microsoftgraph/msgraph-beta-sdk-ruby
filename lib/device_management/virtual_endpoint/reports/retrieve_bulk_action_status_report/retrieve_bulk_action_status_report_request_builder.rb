...
require_relative './retrieve_bulk_action_status_report'

module MicrosoftGraphBeta
    module DeviceManagement
        module VirtualEndpoint
            module Reports
                module RetrieveBulkActionStatusReport
                    ## 
                    # Provides operations to call the retrieveBulkActionStatusReport method.
                    class RetrieveBulkActionStatusReportRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/reports/retrieveBulkActionStatusReport")
                        end
                        ## 
                        ...
                        ## @return a retrieve_bulk_action_status_report_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return RetrieveBulkActionStatusReportRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
