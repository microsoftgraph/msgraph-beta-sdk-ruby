        ...
        module VirtualEndpoint
            module Reports
                module RetrieveBulkActionStatusReport
                    class RetrieveBulkActionStatusReportPostRequestBody
                        ...
                        ## @return a retrieve_bulk_action_status_report_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return RetrieveBulkActionStatusReportPostRequestBody.new
                        end
                        ## 
