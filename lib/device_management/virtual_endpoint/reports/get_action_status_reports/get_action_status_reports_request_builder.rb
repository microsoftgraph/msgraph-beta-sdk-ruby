...
require_relative './get_action_status_reports'

module MicrosoftGraphBeta
    module DeviceManagement
        module VirtualEndpoint
            module Reports
                module GetActionStatusReports
                    ## 
                    # Provides operations to call the getActionStatusReports method.
                    class GetActionStatusReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/reports/getActionStatusReports")
                        end
                        ## 
                        ...
                        ## @return a get_action_status_reports_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return GetActionStatusReportsRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
