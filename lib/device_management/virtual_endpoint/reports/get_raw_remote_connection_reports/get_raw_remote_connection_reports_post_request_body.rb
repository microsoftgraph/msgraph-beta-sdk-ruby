        ...
        module VirtualEndpoint
            module Reports
                module GetRawRemoteConnectionReports
                    class GetRawRemoteConnectionReportsPostRequestBody
                        ...
                        ## @return a get_raw_remote_connection_reports_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return GetRawRemoteConnectionReportsPostRequestBody.new
                        end
                        ## 
