...
require_relative '../../../../models/cloud_p_c_connection_quality_report_type'
            ...
            module Reports
                module RetrieveConnectionQualityReports
                    class RetrieveConnectionQualityReportsPostRequestBody
                        ...
                        ## @return a retrieve_connection_quality_reports_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return RetrieveConnectionQualityReportsPostRequestBody.new
                        end
                        ## 
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "reportName" => lambda {|n| @report_name = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPCConnectionQualityReportType) },
                        ...
                        ## @return a cloud_p_c_connection_quality_report_type
                        ## 
                        def report_name
                            return @report_name
                        end
