...
require_relative '../../../../models/cloud_pc_disaster_recovery_report_name'
require_relative '../../../device_management'
require_relative '../../virtual_endpoint'
require_relative '../reports'
require_relative './retrieve_cross_region_disaster_recovery_report'

module MicrosoftGraphBeta
    module DeviceManagement
        module VirtualEndpoint
            module Reports
                module RetrieveCrossRegionDisasterRecoveryReport
                    class RetrieveCrossRegionDisasterRecoveryReportPostRequestBody
                        ...
                        ## @return a retrieve_cross_region_disaster_recovery_report_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return RetrieveCrossRegionDisasterRecoveryReportPostRequestBody.new
                        end
                        ## 
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "reportName" => lambda {|n| @report_name = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcDisasterRecoveryReportName) },
                        ...
                        ## @return a cloud_pc_disaster_recovery_report_name
                        ## 
                        def report_name
                            return @report_name
                        end
