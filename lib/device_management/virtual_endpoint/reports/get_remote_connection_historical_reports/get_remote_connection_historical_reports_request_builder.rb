...
require_relative './get_remote_connection_historical_reports'

module MicrosoftGraphBeta
    module DeviceManagement
        module VirtualEndpoint
            module Reports
                module GetRemoteConnectionHistoricalReports
                    ## 
                    # Provides operations to call the getRemoteConnectionHistoricalReports method.
                    class GetRemoteConnectionHistoricalReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/reports/getRemoteConnectionHistoricalReports")
                        end
                        ## 
                        ...
                        ## @return a get_remote_connection_historical_reports_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return GetRemoteConnectionHistoricalReportsRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
