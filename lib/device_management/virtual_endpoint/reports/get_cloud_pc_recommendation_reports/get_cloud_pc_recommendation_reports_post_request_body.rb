...
require_relative './get_cloud_pc_recommendation_reports'

module MicrosoftGraphBeta
    module DeviceManagement
        module VirtualEndpoint
            module Reports
                module GetCloudPcRecommendationReports
                    class GetCloudPcRecommendationReportsPostRequestBody
                        ...
                        ## @return a get_cloud_pc_recommendation_reports_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return GetCloudPcRecommendationReportsPostRequestBody.new
                        end
                        ## 
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "reportName" => lambda {|n| @report_name = n.get_enum_value(MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::GetCloudPcRecommendationReports::GetCloudPcRecommendationReportsPostRequestBodyReportName) },
                        ...
                        ## @return a get_cloud_pc_recommendation_reports_post_request_body_report_name
                        ## 
                        def report_name
                            return @report_name
                        end
