...
require_relative './microsoft_graph_get_remote_connection_historical_reports'

module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::MicrosoftGraphGetRemoteConnectionHistoricalReports
    class GetRemoteConnectionHistoricalReportsPostRequestBody
        ...
        ## @return a get_remote_connection_historical_reports_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetRemoteConnectionHistoricalReportsPostRequestBody.new
        end
        ## 
