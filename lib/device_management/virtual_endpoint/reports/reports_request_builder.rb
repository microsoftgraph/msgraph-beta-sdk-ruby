...
require_relative './get_cloud_pc_performance_report/get_cloud_pc_performance_report_request_builder'
...
require_relative './retrieve_bulk_action_status_report/retrieve_bulk_action_status_report_request_builder'
require_relative './retrieve_cloud_pc_tenant_metrics_report/retrieve_cloud_pc_tenant_metrics_report_request_builder'
require_relative './retrieve_cloud_pc_troubleshoot_reports/retrieve_cloud_pc_troubleshoot_reports_request_builder'
require_relative './retrieve_connection_quality_reports/retrieve_connection_quality_reports_request_builder'
require_relative './retrieve_cross_region_disaster_recovery_report/retrieve_cross_region_disaster_recovery_report_request_builder'
require_relative './retrieve_frontline_reports/retrieve_frontline_reports_request_builder'
        ...
        module VirtualEndpoint
            module Reports
                ...
                class ReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def get_cloud_pc_performance_report()
                        return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::GetCloudPcPerformanceReport::GetCloudPcPerformanceReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def retrieve_bulk_action_status_report()
                        return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::RetrieveBulkActionStatusReport::RetrieveBulkActionStatusReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the retrieveCloudPcTenantMetricsReport method.
                    def retrieve_cloud_pc_tenant_metrics_report()
                        return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::RetrieveCloudPcTenantMetricsReport::RetrieveCloudPcTenantMetricsReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the retrieveCloudPcTroubleshootReports method.
                    def retrieve_cloud_pc_troubleshoot_reports()
                        return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::RetrieveCloudPcTroubleshootReports::RetrieveCloudPcTroubleshootReportsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the retrieveConnectionQualityReports method.
                    def retrieve_connection_quality_reports()
                        return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::RetrieveConnectionQualityReports::RetrieveConnectionQualityReportsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the retrieveCrossRegionDisasterRecoveryReport method.
                    def retrieve_cross_region_disaster_recovery_report()
                        return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::RetrieveCrossRegionDisasterRecoveryReport::RetrieveCrossRegionDisasterRecoveryReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the retrieveFrontlineReports method.
                    def retrieve_frontline_reports()
                        return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::RetrieveFrontlineReports::RetrieveFrontlineReportsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/reports{?%24expand,%24select}")
                    end
                    ## 
