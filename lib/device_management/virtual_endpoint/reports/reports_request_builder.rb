...
require_relative './microsoft_graph_get_daily_aggregated_remote_connection_reports/get_daily_aggregated_remote_connection_reports_request_builder'
require_relative './microsoft_graph_get_real_time_remote_connection_latency_with_cloud_pc_id/get_real_time_remote_connection_latency_with_cloud_pc_id_request_builder'
require_relative './microsoft_graph_get_real_time_remote_connection_status_with_cloud_pc_id/get_real_time_remote_connection_status_with_cloud_pc_id_request_builder'
require_relative './microsoft_graph_get_remote_connection_historical_reports/get_remote_connection_historical_reports_request_builder'
require_relative './microsoft_graph_get_shared_use_license_usage_report/get_shared_use_license_usage_report_request_builder'
require_relative './microsoft_graph_get_total_aggregated_remote_connection_reports/get_total_aggregated_remote_connection_reports_request_builder'
require_relative './reports'

module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports
    ## 
    ...
    class ReportsRequestBuilder
        ...
        def microsoft_graph_get_daily_aggregated_remote_connection_reports()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::MicrosoftGraphGetDailyAggregatedRemoteConnectionReports::GetDailyAggregatedRemoteConnectionReportsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_remote_connection_historical_reports()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::MicrosoftGraphGetRemoteConnectionHistoricalReports::GetRemoteConnectionHistoricalReportsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_shared_use_license_usage_report()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::MicrosoftGraphGetSharedUseLicenseUsageReport::GetSharedUseLicenseUsageReportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_total_aggregated_remote_connection_reports()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::MicrosoftGraphGetTotalAggregatedRemoteConnectionReports::GetTotalAggregatedRemoteConnectionReportsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
