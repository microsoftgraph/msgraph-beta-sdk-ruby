...
require_relative './microsoft_graph_get_daily_aggregated_remote_connection_reports'

module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::MicrosoftGraphGetDailyAggregatedRemoteConnectionReports
    class GetDailyAggregatedRemoteConnectionReportsPostRequestBody
        ...
        ## @return a get_daily_aggregated_remote_connection_reports_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetDailyAggregatedRemoteConnectionReportsPostRequestBody.new
        end
        ## 
