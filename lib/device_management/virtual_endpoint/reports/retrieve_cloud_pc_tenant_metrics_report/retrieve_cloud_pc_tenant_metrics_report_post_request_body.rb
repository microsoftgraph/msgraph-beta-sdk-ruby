...
require_relative '../../../../models/cloud_p_c_performance_report_name'
require_relative '../../../device_management'
require_relative '../../virtual_endpoint'
require_relative '../reports'
require_relative './retrieve_cloud_pc_tenant_metrics_report'

module MicrosoftGraphBeta
    module DeviceManagement
        module VirtualEndpoint
            module Reports
                module RetrieveCloudPcTenantMetricsReport
                    class RetrieveCloudPcTenantMetricsReportPostRequestBody
                        ...
                        ## 
                        ## Instantiates a new RetrieveCloudPcTenantMetricsReportPostRequestBody and sets the default values.
                        ## @return a void
                        ## 
                        def initialize()
                        ...
                        ## @return a retrieve_cloud_pc_tenant_metrics_report_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return RetrieveCloudPcTenantMetricsReportPostRequestBody.new
                        end
                        ## 
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "reportName" => lambda {|n| @report_name = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPCPerformanceReportName) },
                        ...
                        ## @return a cloud_p_c_performance_report_name
                        ## 
                        def report_name
                            return @report_name
                        end
