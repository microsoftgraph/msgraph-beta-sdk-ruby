...
require_relative './get_inaccessible_cloud_pc_reports'

module MicrosoftGraphBeta
    module DeviceManagement
        module VirtualEndpoint
            module Reports
                module GetInaccessibleCloudPcReports
                    ## 
                    # Provides operations to call the getInaccessibleCloudPcReports method.
                    class GetInaccessibleCloudPcReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/reports/getInaccessibleCloudPcReports")
                        end
                        ## 
                        ...
                        ## @return a get_inaccessible_cloud_pc_reports_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return GetInaccessibleCloudPcReportsRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
