...
require_relative '../../../../models/cloud_p_c_inaccessible_report_name'
        ...
        module VirtualEndpoint
            module Reports
                module GetInaccessibleCloudPcReports
                    class GetInaccessibleCloudPcReportsPostRequestBody
                        ...
                        ## @return a get_inaccessible_cloud_pc_reports_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return GetInaccessibleCloudPcReportsPostRequestBody.new
                        end
                        ## 
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "reportName" => lambda {|n| @report_name = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPCInaccessibleReportName) },
                        ...
                        ## @return a cloud_p_c_inaccessible_report_name
                        ## 
                        def report_name
                            return @report_name
                        end
