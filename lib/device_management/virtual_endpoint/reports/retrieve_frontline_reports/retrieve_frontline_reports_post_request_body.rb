...
require_relative '../../../../models/cloud_p_c_frontline_report_type'
require_relative '../../../device_management'
require_relative '../../virtual_endpoint'
require_relative '../reports'
require_relative './retrieve_frontline_reports'

module MicrosoftGraphBeta
    module DeviceManagement
        module VirtualEndpoint
            module Reports
                module RetrieveFrontlineReports
                    class RetrieveFrontlineReportsPostRequestBody
                        ...
                        ## 
                        ## Instantiates a new RetrieveFrontlineReportsPostRequestBody and sets the default values.
                        ## @return a void
                        ## 
                        def initialize()
                        ...
                        ## @return a retrieve_frontline_reports_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return RetrieveFrontlineReportsPostRequestBody.new
                        end
                        ## 
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "reportName" => lambda {|n| @report_name = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPCFrontlineReportType) },
                        ...
                        ## @return a cloud_p_c_frontline_report_type
                        ## 
                        def report_name
                            return @report_name
                        end
