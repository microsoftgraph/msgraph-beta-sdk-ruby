...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::ExportJobs::Item
    ## 
    ...
    class CloudPcExportJobItemRequestBuilder
        ...
        ## @param cloudPcExportJobId key: id of cloudPcExportJob
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, cloud_pc_export_job_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/reports/exportJobs/{cloudPcExportJob%2Did}{?%24select,%24expand}"
