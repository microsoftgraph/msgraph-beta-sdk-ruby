        ...
        module VirtualEndpoint
            module Reports
                module GetConnectionQualityReports
                    class GetConnectionQualityReportsPostRequestBody
                        ...
                        ## @return a get_connection_quality_reports_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return GetConnectionQualityReportsPostRequestBody.new
                        end
                        ## 
