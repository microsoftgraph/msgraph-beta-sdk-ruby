...
require_relative './microsoft_graph_get_effective_permissions/microsoft_graph_get_effective_permissions_request_builder'
    ...
    module DeviceManagement
        module VirtualEndpoint
            ...
            class VirtualEndpointRequestBuilder
                ...
                def microsoft_graph_get_effective_permissions()
                    return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::MicrosoftGraphGetEffectivePermissions::MicrosoftGraphGetEffectivePermissionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
