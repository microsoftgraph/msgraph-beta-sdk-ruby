...
require_relative './microsoft_graph_get_effective_permissions/get_effective_permissions_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint
    ...
    class VirtualEndpointRequestBuilder
        ...
        def microsoft_graph_get_effective_permissions()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::MicrosoftGraphGetEffectivePermissions::GetEffectivePermissionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
