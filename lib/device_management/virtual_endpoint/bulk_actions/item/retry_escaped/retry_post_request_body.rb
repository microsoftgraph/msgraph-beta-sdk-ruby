                ...
                module Item
                    module Retry_escaped
                        class RetryPostRequestBody
                            ...
                            ## 
                            ## Instantiates a new RetryPostRequestBody and sets the default values.
                            ## @return a void
                            ## 
                            def initialize()
                            ...
                            ## @return a retry_post_request_body
                            ## 
                            def self.create_from_discriminator_value(parse_node)
                                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                return RetryPostRequestBody.new
                            end
                            ## 
