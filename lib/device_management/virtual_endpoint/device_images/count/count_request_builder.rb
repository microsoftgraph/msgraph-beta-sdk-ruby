...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::DeviceImages::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/deviceImages/$count{?%24search,%24filter}"
