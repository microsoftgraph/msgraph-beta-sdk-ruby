            ...
            module OnPremisesConnections
                module Item
                    module UpdateAdDomainPassword
                        ...
                        class UpdateAdDomainPasswordRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection%2Did}/updateAdDomainPassword")
                            end
                            ## 
                            ...
                            ## @return a update_ad_domain_password_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return UpdateAdDomainPasswordRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
