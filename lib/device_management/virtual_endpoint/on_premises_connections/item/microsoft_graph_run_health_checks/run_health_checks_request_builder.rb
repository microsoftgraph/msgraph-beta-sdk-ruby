...
require_relative './microsoft_graph_run_health_checks'

module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::OnPremisesConnections::Item::MicrosoftGraphRunHealthChecks
    ## 
    ...
    class RunHealthChecksRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection%2Did}/microsoft.graph.runHealthChecks"
