...
require_relative './microsoft_graph_update_ad_domain_password'

module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::OnPremisesConnections::Item::MicrosoftGraphUpdateAdDomainPassword
    class UpdateAdDomainPasswordPostRequestBody
        ...
        ## @param value Value to set for the ad_domain_password property.
        ## @return a void
        ## 
