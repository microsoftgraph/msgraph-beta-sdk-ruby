        ...
        module VirtualEndpoint
            module CloudPCs
                module GetProvisionedCloudPCsWithGroupIdWithServicePlanId
                    class GetProvisionedCloudPCsWithGroupIdWithServicePlanIdResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                        ...
                        ## @return a get_provisioned_cloud_p_cs_with_group_id_with_service_plan_id_response
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return GetProvisionedCloudPCsWithGroupIdWithServicePlanIdResponse.new
                        end
                        ## 
