                ...
                module GetProvisionedCloudPCsWithGroupIdWithServicePlanId
                    ...
                    class GetProvisionedCloudPCsWithGroupIdWithServicePlanIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter, group_id=nil, service_plan_id=nil)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/getProvisionedCloudPCs(groupId='{groupId}',servicePlanId='{servicePlanId}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::GetProvisionedCloudPCsWithGroupIdWithServicePlanId::GetProvisionedCloudPCsWithGroupIdWithServicePlanIdGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Invoke function getProvisionedCloudPCs
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
