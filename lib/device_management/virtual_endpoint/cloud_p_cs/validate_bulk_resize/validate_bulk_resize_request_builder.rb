                ...
                module ValidateBulkResize
                    ...
                    class ValidateBulkResizeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::ValidateBulkResize::ValidateBulkResizeResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Invoke action validateBulkResize
                        ## @param body The request body
