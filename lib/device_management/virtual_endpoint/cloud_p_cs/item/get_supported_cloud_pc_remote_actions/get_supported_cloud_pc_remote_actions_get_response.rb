            ...
            module CloudPCs
                module Item
                    module GetSupportedCloudPcRemoteActions
                        class GetSupportedCloudPcRemoteActionsGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                            ...
                            ## @return a get_supported_cloud_pc_remote_actions_get_response
                            ## 
                            def self.create_from_discriminator_value(parse_node)
                                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                return GetSupportedCloudPcRemoteActionsGetResponse.new
                            end
                            ## 
