                ...
                module Item
                    ...
                    class CloudPCItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def get_frontline_cloud_pc_access_state()
                            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::GetFrontlineCloudPcAccessState::GetFrontlineCloudPcAccessStateRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def power_off()
                            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::PowerOff::PowerOffRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the powerOn method.
                        def power_on()
                            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::PowerOn::PowerOnRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def retrieve_cloud_p_c_remote_action_results()
                            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::RetrieveCloudPCRemoteActionResults::RetrieveCloudPCRemoteActionResultsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the retrieveReviewStatus method.
                        def retrieve_review_status()
                            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::RetrieveReviewStatus::RetrieveReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the retrieveSnapshots method.
                        def retrieve_snapshots()
                            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::RetrieveSnapshots::RetrieveSnapshotsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def set_review_status()
                            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::SetReviewStatus::SetReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
