...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item
    ...
    class CloudPCItemRequestBuilder
        ...
        def microsoft_graph_change_user_account_type()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphChangeUserAccountType::ChangeUserAccountTypeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the endGracePeriod method.
        def microsoft_graph_end_grace_period()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphEndGracePeriod::EndGracePeriodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_cloud_pc_connectivity_history()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphGetCloudPcConnectivityHistory::GetCloudPcConnectivityHistoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getCloudPcLaunchInfo method.
        def microsoft_graph_get_cloud_pc_launch_info()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphGetCloudPcLaunchInfo::GetCloudPcLaunchInfoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_shift_work_cloud_pc_access_state()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphGetShiftWorkCloudPcAccessState::GetShiftWorkCloudPcAccessStateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_supported_cloud_pc_remote_actions()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphGetSupportedCloudPcRemoteActions::GetSupportedCloudPcRemoteActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reboot method.
        def microsoft_graph_reboot()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphReboot::RebootRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the rename method.
        def microsoft_graph_rename()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphRename::RenameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reprovision method.
        def microsoft_graph_reprovision()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphReprovision::ReprovisionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphRestore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the retryPartnerAgentInstallation method.
        def microsoft_graph_retry_partner_agent_installation()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphRetryPartnerAgentInstallation::RetryPartnerAgentInstallationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the troubleshoot method.
        def microsoft_graph_troubleshoot()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphTroubleshoot::TroubleshootRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
