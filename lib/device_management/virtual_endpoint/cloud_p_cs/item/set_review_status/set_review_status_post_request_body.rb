            ...
            module CloudPCs
                module Item
                    module SetReviewStatus
                        class SetReviewStatusPostRequestBody
                            ...
                            ## 
                            ## Instantiates a new SetReviewStatusPostRequestBody and sets the default values.
                            ## @return a void
                            ## 
                            def initialize()
                            ...
                            ## @return a set_review_status_post_request_body
                            ## 
                            def self.create_from_discriminator_value(parse_node)
                                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                return SetReviewStatusPostRequestBody.new
                            end
                            ## 
