...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::MicrosoftGraphRestore
    ## 
    ...
    class RestoreRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/microsoft.graph.restore"
