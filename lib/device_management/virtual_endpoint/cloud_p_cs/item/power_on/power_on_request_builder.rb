            ...
            module CloudPCs
                module Item
                    module PowerOn
                        ...
                        class PowerOnRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/powerOn")
                            end
                            ## 
                            ...
                            ## @return a power_on_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return PowerOnRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
