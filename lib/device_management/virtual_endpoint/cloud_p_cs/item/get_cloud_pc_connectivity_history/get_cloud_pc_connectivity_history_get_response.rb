            ...
            module CloudPCs
                module Item
                    module GetCloudPcConnectivityHistory
                        class GetCloudPcConnectivityHistoryGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                            ...
                            ## @return a get_cloud_pc_connectivity_history_get_response
                            ## 
                            def self.create_from_discriminator_value(parse_node)
                                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                return GetCloudPcConnectivityHistoryGetResponse.new
                            end
                            ## 
