...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item::Assignments::Item
    ## 
    ...
    class CloudPcProvisioningPolicyAssignmentItemRequestBuilder
        ...
        ## @param cloudPcProvisioningPolicyAssignmentId key: id of cloudPcProvisioningPolicyAssignment
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, cloud_pc_provisioning_policy_assignment_id=nil)
