...
require_relative './assigned_users/item/user_item_request_builder'
require_relative './item'
                    ...
                    module Assignments
                        module Item
                            ...
                            class CloudPcProvisioningPolicyAssignmentItemRequestBuilder
                                ...
                                def assigned_users()
                                    return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item::Assignments::Item::AssignedUsers::AssignedUsersRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                ## 
                                def assigned_users_by_id(id)
                                    raise StandardError, 'id cannot be null' if id.nil?
                                    url_tpl_params = @path_parameters.clone
                                    url_tpl_params["user%2Did"] = id
                                    return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item::Assignments::Item::AssignedUsers::Item::UserItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    ...
                                    @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}/assignments/{cloudPcProvisioningPolicyAssignment%2Did}{?%24select,%24expand}"
