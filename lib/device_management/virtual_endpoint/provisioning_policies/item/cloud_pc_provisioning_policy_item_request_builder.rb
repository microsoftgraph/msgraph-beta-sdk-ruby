...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item
    ...
    class CloudPcProvisioningPolicyItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param cloudPcProvisioningPolicyId key: id of cloudPcProvisioningPolicy
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, cloud_pc_provisioning_policy_id=nil)
