...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item
    ...
    class CloudPcProvisioningPolicyItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
