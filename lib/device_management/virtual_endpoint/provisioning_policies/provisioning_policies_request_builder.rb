...
require_relative './apply_config/apply_config_request_builder'
        ...
        module VirtualEndpoint
            module ProvisioningPolicies
                ...
                class ProvisioningPoliciesRequestBuilder
                    ...
                    def apply_config()
                        return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::ApplyConfig::ApplyConfigRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
