        ...
        module VirtualEndpoint
            module ProvisioningPolicies
                module ApplyConfig
                    ...
                    class ApplyConfigRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/applyConfig")
                        end
                        ## 
                        ...
                        ## @return a apply_config_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return ApplyConfigRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
