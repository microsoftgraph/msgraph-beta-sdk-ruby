        ...
        module ComanagedDevices
            module Item
                module RestoreCloudPc
                    ...
                    class RestoreCloudPcRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/restoreCloudPc")
                        end
                        ## 
                        ...
                        ## @return a restore_cloud_pc_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return RestoreCloudPcRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
