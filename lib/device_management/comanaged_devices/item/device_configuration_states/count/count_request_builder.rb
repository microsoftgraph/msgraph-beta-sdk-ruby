...
module MicrosoftGraphBeta::DeviceManagement::ComanagedDevices::Item::DeviceConfigurationStates::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/deviceConfigurationStates/$count{?%24search,%24filter}"
