...
module MicrosoftGraphBeta::DeviceManagement::ComanagedDevices::Item::DeviceHealthScriptStates::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/deviceHealthScriptStates/$count{?%24search,%24filter}"
