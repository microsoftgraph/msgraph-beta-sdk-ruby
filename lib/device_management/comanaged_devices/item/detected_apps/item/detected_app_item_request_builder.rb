...
module MicrosoftGraphBeta::DeviceManagement::ComanagedDevices::Item::DetectedApps::Item
    ## 
    ...
    class DetectedAppItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, detected_app_id=nil)
            ...
            @url_template = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/detectedApps/{detectedApp%2Did}{?%24select,%24expand}"
