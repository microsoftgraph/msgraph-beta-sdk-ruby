...
module MicrosoftGraphBeta::DeviceManagement::ComanagedDevices::Item::AssignmentFilterEvaluationStatusDetails::Item
    ## 
    ...
    class AssignmentFilterEvaluationStatusDetailsItemRequestBuilder
        ...
        ## @param assignmentFilterEvaluationStatusDetailsId key: id of assignmentFilterEvaluationStatusDetails
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, assignment_filter_evaluation_status_details_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/assignmentFilterEvaluationStatusDetails/{assignmentFilterEvaluationStatusDetails%2Did}{?%24select,%24expand}"
