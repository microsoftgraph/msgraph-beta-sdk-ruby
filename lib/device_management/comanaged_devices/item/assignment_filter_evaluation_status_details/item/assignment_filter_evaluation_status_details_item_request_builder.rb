            ...
            module Item
                module AssignmentFilterEvaluationStatusDetails
                    module Item
                        ...
                        class AssignmentFilterEvaluationStatusDetailsItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/assignmentFilterEvaluationStatusDetails/{assignmentFilterEvaluationStatusDetails%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/assignmentFilterEvaluationStatusDetails/{assignmentFilterEvaluationStatusDetails%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return AssignmentFilterEvaluationStatusDetailsItemRequestBuilder.new(raw_url, @request_adapter)
                            end
