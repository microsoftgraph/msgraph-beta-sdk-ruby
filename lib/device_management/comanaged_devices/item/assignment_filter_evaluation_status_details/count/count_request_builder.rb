...
module MicrosoftGraphBeta::DeviceManagement::ComanagedDevices::Item::AssignmentFilterEvaluationStatusDetails::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/assignmentFilterEvaluationStatusDetails/$count{?%24search,%24filter}"
