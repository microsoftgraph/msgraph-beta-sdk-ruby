        ...
        module ComanagedDevices
            module Item
                module SetCloudPcReviewStatus
                    ...
                    class SetCloudPcReviewStatusRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/setCloudPcReviewStatus")
                        end
                        ## 
                        ...
                        ## @return a set_cloud_pc_review_status_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return SetCloudPcReviewStatusRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
