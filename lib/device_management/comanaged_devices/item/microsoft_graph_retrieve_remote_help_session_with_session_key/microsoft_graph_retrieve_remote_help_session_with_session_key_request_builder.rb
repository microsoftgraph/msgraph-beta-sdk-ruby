...
require_relative './microsoft_graph_retrieve_remote_help_session_with_session_key'
...
module MicrosoftGraphBeta::DeviceManagement::ComanagedDevices::Item::MicrosoftGraphRetrieveRemoteHelpSessionWithSessionKey
    ...
    class MicrosoftGraphRetrieveRemoteHelpSessionWithSessionKeyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, session_key=nil)
            ...
            @url_template = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/microsoft.graph.retrieveRemoteHelpSession(sessionKey='{sessionKey}')"
