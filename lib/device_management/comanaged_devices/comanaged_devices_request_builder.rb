        ...
        module ComanagedDevices
            ...
            class ComanagedDevicesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def download_powerlift_app_diagnostic()
                    return MicrosoftGraphBeta::DeviceManagement::ComanagedDevices::DownloadPowerliftAppDiagnostic::DownloadPowerliftAppDiagnosticRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/comanagedDevices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
