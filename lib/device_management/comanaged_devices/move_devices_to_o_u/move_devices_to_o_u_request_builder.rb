            ...
            module MoveDevicesToOU
                ...
                class MoveDevicesToOURequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/comanagedDevices/moveDevicesToOU")
                    end
                    ## 
                    ...
                    ## @return a move_devices_to_o_u_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return MoveDevicesToOURequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
