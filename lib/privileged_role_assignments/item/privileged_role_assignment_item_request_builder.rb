...
module MicrosoftGraphBeta
    module PrivilegedRoleAssignments
        module Item
            ...
            class PrivilegedRoleAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}'
                ...
                def with_url(raw_url)
                    ...
                    return PrivilegedRoleAssignmentItemRequestBuilder.new(raw_url, @request_adapter)
                end
