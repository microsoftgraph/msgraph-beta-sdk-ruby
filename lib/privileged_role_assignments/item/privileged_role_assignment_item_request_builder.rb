...
require_relative './microsoft_graph_make_eligible/make_eligible_request_builder'
require_relative './microsoft_graph_make_permanent/make_permanent_request_builder'
...
module MicrosoftGraphBeta::PrivilegedRoleAssignments::Item
    ...
    class PrivilegedRoleAssignmentItemRequestBuilder
        ...
        def microsoft_graph_make_eligible()
            return MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::MicrosoftGraphMakeEligible::MakeEligibleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the makePermanent method.
        def microsoft_graph_make_permanent()
            return MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::MicrosoftGraphMakePermanent::MakePermanentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param privilegedRoleAssignmentId key: id of privilegedRoleAssignment
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, privileged_role_assignment_id=nil)
