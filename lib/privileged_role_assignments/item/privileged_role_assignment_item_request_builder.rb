...
require_relative './microsoft_graph_make_eligible/microsoft_graph_make_eligible_request_builder'
require_relative './microsoft_graph_make_permanent/microsoft_graph_make_permanent_request_builder'
...
module MicrosoftGraphBeta::PrivilegedRoleAssignments::Item
    ...
    class PrivilegedRoleAssignmentItemRequestBuilder
        ...
        def microsoft_graph_make_eligible()
            return MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::MicrosoftGraphMakeEligible::MicrosoftGraphMakeEligibleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the makePermanent method.
        def microsoft_graph_make_permanent()
            return MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::MicrosoftGraphMakePermanent::MicrosoftGraphMakePermanentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
