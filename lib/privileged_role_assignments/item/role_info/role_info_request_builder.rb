...
module MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::RoleInfo
    ...
    class RoleInfoRequestBuilder
        ...
        def microsoft_graph_self_activate()
            return MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::RoleInfo::MicrosoftGraphSelfActivate::SelfActivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the selfDeactivate method.
        def microsoft_graph_self_deactivate()
            return MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::RoleInfo::MicrosoftGraphSelfDeactivate::SelfDeactivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
