...
module MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::RoleInfo::Assignments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/assignments/$count{?%24search,%24filter}"
