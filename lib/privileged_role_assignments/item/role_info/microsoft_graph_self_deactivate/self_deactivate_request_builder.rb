...
require_relative './microsoft_graph_self_deactivate'

module MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::RoleInfo::MicrosoftGraphSelfDeactivate
    ## 
    ...
    class SelfDeactivateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/microsoft.graph.selfDeactivate"
