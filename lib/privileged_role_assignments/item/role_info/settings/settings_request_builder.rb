                ...
                module Settings
                    ...
                    class SettingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/settings{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/settings'
