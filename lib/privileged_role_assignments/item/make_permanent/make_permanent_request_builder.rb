    ...
    module PrivilegedRoleAssignments
        module Item
            module MakePermanent
                ...
                class MakePermanentRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/makePermanent")
                    end
                    ## 
                    ...
                    ## @return a make_permanent_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return MakePermanentRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
