...
module MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::MakePermanent
    ## 
    ...
    class MakePermanentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/microsoft.graph.makePermanent"
