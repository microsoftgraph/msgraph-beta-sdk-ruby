    ...
    module ThreatSubmission
        ...
        class ThreatSubmissionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/threatSubmission{?%24expand,%24select}")
            end
            ## 
            ...
            def to_patch_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/threatSubmission'
                request_info.path_parameters = @path_parameters
            ...
            ## @return a threat_submission_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return ThreatSubmissionRequestBuilder.new(raw_url, @request_adapter)
            end
