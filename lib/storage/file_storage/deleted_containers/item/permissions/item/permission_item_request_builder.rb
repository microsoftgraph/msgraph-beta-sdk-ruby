                    ...
                    module Permissions
                        module Item
                            ...
                            class PermissionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def grant()
                                    return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Permissions::Item::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the revokeGrants method.
                                def revoke_grants()
                                    return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Permissions::Item::RevokeGrants::RevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
