                    ...
                    module Columns
                        module Item
                            ...
                            class ColumnDefinitionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def source_column()
                                    return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Columns::Item::SourceColumn::SourceColumnRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/columns/{columnDefinition%2Did}{?%24expand,%24select}")
                                end
                                ## 
