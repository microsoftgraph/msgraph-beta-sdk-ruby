                                        ...
                                        module Match
                                            class MatchPostRequestBody
                                                ...
                                                def get_field_deserializers()
                                                    return {
                                                        "lookupArray" => lambda {|n| @lookup_array = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                                        ...
                                                        "matchType" => lambda {|n| @match_type = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                                    }
                                                end
                                                ## 
