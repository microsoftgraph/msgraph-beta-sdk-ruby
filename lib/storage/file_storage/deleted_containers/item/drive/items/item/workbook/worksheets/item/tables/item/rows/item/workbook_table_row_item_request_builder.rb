                                                    ...
                                                    module Rows
                                                        module Item
                                                            ...
                                                            class WorkbookTableRowItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                                ...
                                                                def range()
                                                                    return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Drive::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::RangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                                end
                                                                ## 
                                                                ...
                                                                def initialize(path_parameters, request_adapter)
                                                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/rows/{workbookTableRow%2Did}{?%24expand,%24select}")
                                                                end
                                                                ## 
