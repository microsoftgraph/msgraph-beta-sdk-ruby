                                        ...
                                        module If_escaped
                                            class IfPostRequestBody
                                                ...
                                                def get_field_deserializers()
                                                    return {
                                                        "logicalTest" => lambda {|n| @logical_test = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                                        "valueIfFalse" => lambda {|n| @value_if_false = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                                        "valueIfTrue" => lambda {|n| @value_if_true = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                                    }
                                                end
                                                ## 
