                                        ...
                                        module Item
                                            module Columns
                                                ...
                                                class ColumnsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                    ...
                                                    def add()
                                                        return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Drive::Items::Item::Workbook::Tables::Item::Columns::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    # Provides operations to call the count method.
                                                    def count()
                                                        return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Drive::Items::Item::Workbook::Tables::Item::Columns::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    ## Provides operations to manage the columns property of the microsoft.graph.workbookTable entity.
                                                    ...
                                                    def by_workbook_table_column_id(workbook_table_column_id)
                                                        ...
                                                        return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Drive::Items::Item::Workbook::Tables::Item::Columns::Item::WorkbookTableColumnItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                                    end
                                                    ## 
                                                    ...
                                                    def initialize(path_parameters, request_adapter)
                                                        super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                                    end
                                                    ## 
