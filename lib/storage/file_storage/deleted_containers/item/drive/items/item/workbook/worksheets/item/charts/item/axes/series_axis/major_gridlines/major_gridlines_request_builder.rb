                                                        ...
                                                        module SeriesAxis
                                                            module MajorGridlines
                                                                ...
                                                                class MajorGridlinesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                                    ...
                                                                    def format()
                                                                        return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Drive::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::SeriesAxis::MajorGridlines::Format::FormatRequestBuilder.new(@path_parameters, @request_adapter)
                                                                    end
                                                                    ## 
                                                                    ...
                                                                    def initialize(path_parameters, request_adapter)
                                                                        super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/seriesAxis/majorGridlines{?%24expand,%24select}")
                                                                    end
                                                                    ## 
