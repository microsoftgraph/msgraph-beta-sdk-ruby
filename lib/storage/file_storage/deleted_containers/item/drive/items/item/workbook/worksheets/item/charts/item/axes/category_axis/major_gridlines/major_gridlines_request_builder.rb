                                                        ...
                                                        module CategoryAxis
                                                            module MajorGridlines
                                                                ...
                                                                class MajorGridlinesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                                    ...
                                                                    def format()
                                                                        return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Drive::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::CategoryAxis::MajorGridlines::Format::FormatRequestBuilder.new(@path_parameters, @request_adapter)
                                                                    end
                                                                    ## 
                                                                    ...
                                                                    def initialize(path_parameters, request_adapter)
                                                                        super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/categoryAxis/majorGridlines{?%24expand,%24select}")
                                                                    end
                                                                    ## 
                                                                    ...
                                                                    def get(request_configuration=nil)
                                                                        ...
                                                                        error_mapping = Hash.new
                                                                        error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                                                                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartGridlines.create_from_discriminator_value(pn) }, error_mapping)
                                                                    end
                                                                    ## 
