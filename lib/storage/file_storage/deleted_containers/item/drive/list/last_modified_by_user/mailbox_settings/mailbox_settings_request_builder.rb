                                ...
                                module MailboxSettings
                                    ...
                                    class MailboxSettingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/lastModifiedByUser/mailboxSettings{?%24expand,%24select}")
                                        end
                                        ## 
