                                ...
                                module Item
                                    module DocumentSetVersions
                                        ...
                                        class DocumentSetVersionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def count()
                                                return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Drive::List::Items::Item::DocumentSetVersions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ## Provides operations to manage the documentSetVersions property of the microsoft.graph.listItem entity.
                                            ...
                                            def by_document_set_version_id(document_set_version_id)
                                                ...
                                                return MicrosoftGraphBeta::Storage::FileStorage::DeletedContainers::Item::Drive::List::Items::Item::DocumentSetVersions::Item::DocumentSetVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                            end
                                            ## 
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/documentSetVersions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                            end
                                            ## 
