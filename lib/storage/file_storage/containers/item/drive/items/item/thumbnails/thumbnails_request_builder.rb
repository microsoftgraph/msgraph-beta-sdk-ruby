                            ...
                            module Item
                                module Thumbnails
                                    ...
                                    class ThumbnailsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def count()
                                            return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Items::Item::Thumbnails::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ## Provides operations to manage the thumbnails property of the microsoft.graph.driveItem entity.
                                        ...
                                        def by_thumbnail_set_id(thumbnail_set_id)
                                            ...
                                            return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Items::Item::Thumbnails::Item::ThumbnailSetItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                        end
                                        ## 
