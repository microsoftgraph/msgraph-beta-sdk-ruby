                                        ...
                                        module Date
                                            class DatePostRequestBody
                                                ...
                                                def get_field_deserializers()
                                                    return {
                                                        "day" => lambda {|n| @day = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                                        "month" => lambda {|n| @month = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                                        "year" => lambda {|n| @year = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                                    }
                                                end
                                                ## 
