                            ...
                            module Item
                                module Analytics
                                    ...
                                    class AnalyticsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def all_time()
                                            return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Items::Item::Analytics::AllTime::AllTimeRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to manage the itemActivityStats property of the microsoft.graph.itemAnalytics entity.
                                        def item_activity_stats()
                                            return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Items::Item::Analytics::ItemActivityStats::ItemActivityStatsRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to manage the lastSevenDays property of the microsoft.graph.itemAnalytics entity.
                                        def last_seven_days()
                                            return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Items::Item::Analytics::LastSevenDays::LastSevenDaysRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
