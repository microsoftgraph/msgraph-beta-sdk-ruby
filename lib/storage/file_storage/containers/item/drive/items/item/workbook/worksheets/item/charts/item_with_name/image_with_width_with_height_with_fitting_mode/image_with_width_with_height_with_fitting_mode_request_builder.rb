                                                    ...
                                                    module ImageWithWidthWithHeightWithFittingMode
                                                        ...
                                                        class ImageWithWidthWithHeightWithFittingModeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                            ...
                                                            def get(request_configuration=nil)
                                                                ...
                                                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Items::Item::Workbook::Worksheets::Item::Charts::ItemWithName::ImageWithWidthWithHeightWithFittingMode::ImageWithWidthWithHeightWithFittingModeGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                                                            end
                                                            ## 
                                                            ## Invoke function image
                                                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
