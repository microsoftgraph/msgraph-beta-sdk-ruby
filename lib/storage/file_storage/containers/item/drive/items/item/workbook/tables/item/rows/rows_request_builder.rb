                                        ...
                                        module Item
                                            module Rows
                                                ...
                                                class RowsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                    ...
                                                    def add()
                                                        return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Items::Item::Workbook::Tables::Item::Rows::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    # Provides operations to call the count method.
                                                    def count()
                                                        return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Items::Item::Workbook::Tables::Item::Rows::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    ## Provides operations to manage the rows property of the microsoft.graph.workbookTable entity.
                                                    ...
                                                    def by_workbook_table_row_id(workbook_table_row_id)
                                                        ...
                                                        return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Items::Item::Workbook::Tables::Item::Rows::Item::WorkbookTableRowItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                                    end
                                                    ## 
