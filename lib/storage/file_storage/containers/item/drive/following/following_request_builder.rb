                    ...
                    module Drive
                        module Following
                            ...
                            class FollowingRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Following::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the following property of the microsoft.graph.drive entity.
                                ...
                                def by_drive_item_id(drive_item_id)
                                    ...
                                    return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Following::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
