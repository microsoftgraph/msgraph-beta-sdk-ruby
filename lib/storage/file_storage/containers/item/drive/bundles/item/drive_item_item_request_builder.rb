                        ...
                        module Bundles
                            module Item
                                ...
                                class DriveItemItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def content()
                                        return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Bundles::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the media for the storage entity.
                                    def content_stream()
                                        return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::Bundles::Item::ContentStream::ContentStreamRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
