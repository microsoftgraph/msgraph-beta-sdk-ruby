                                    ...
                                    module Activities
                                        module Item
                                            ...
                                            class ItemActivityOLDItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def drive_item()
                                                    return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::List::Items::Item::Activities::Item::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                # Provides operations to manage the listItem property of the microsoft.graph.itemActivityOLD entity.
                                                def list_item()
                                                    return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::List::Items::Item::Activities::Item::ListItem::ListItemRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24expand,%24select}")
                                                end
                                                ## 
