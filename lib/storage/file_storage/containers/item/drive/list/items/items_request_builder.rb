                        ...
                        module List
                            module Items
                                ...
                                class ItemsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def delta()
                                        return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::List::Items::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the items property of the microsoft.graph.list entity.
                                    ...
                                    def by_list_item_id(list_item_id)
                                        ...
                                        return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::List::Items::Item::ListItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
