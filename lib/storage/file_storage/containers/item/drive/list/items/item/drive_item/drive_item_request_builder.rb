                                ...
                                module Item
                                    module DriveItem
                                        ...
                                        class DriveItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def content()
                                                return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::List::Items::Item::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            # Provides operations to manage the media for the storage entity.
                                            def content_stream()
                                                return MicrosoftGraphBeta::Storage::FileStorage::Containers::Item::Drive::List::Items::Item::DriveItem::ContentStream::ContentStreamRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
