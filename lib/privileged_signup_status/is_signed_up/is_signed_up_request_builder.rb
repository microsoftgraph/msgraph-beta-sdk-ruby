    ...
    module PrivilegedSignupStatus
        module IsSignedUp
            ...
            class IsSignedUpRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                ## @return a Fiber of is_signed_up_get_response
                ## 
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::PrivilegedSignupStatus::IsSignedUp::IsSignedUpGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Invoke function isSignedUp
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ...
                def with_url(raw_url)
                    ...
                    return IsSignedUpRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
