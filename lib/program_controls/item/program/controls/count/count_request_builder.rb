...
module MicrosoftGraphBeta::ProgramControls::Item::Program::Controls::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/programControls/{programControl%2Did}/program/controls/$count{?%24search,%24filter}"
