        ...
        module Item
            module InvitedUserSponsors
                ...
                class InvitedUserSponsorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Invitations::Item::InvitedUserSponsors::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the invitedUserSponsors property of the microsoft.graph.invitation entity.
                    ...
                    def by_directory_object_id(directory_object_id)
                        ...
                        return MicrosoftGraphBeta::Invitations::Item::InvitedUserSponsors::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/invitations/{invitation%2Did}/invitedUserSponsors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                    end
                    ## 
