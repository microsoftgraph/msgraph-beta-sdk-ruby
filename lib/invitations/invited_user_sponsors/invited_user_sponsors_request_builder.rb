    ...
    module Invitations
        module InvitedUserSponsors
            ...
            class InvitedUserSponsorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::Invitations::InvitedUserSponsors::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the invitedUserSponsors property of the microsoft.graph.invitation entity.
                ...
                def by_directory_object_id(directory_object_id)
                    ...
                    return MicrosoftGraphBeta::Invitations::InvitedUserSponsors::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
