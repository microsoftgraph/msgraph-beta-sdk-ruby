        ...
        module InvitedUser
            ...
            class InvitedUserRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def mailbox_settings()
                    return MicrosoftGraphBeta::Invitations::InvitedUser::MailboxSettings::MailboxSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # The serviceProvisioningErrors property
                def service_provisioning_errors()
                    return MicrosoftGraphBeta::Invitations::InvitedUser::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
