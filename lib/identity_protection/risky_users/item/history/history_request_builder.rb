            ...
            module Item
                module History
                    ...
                    class HistoryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::IdentityProtection::RiskyUsers::Item::History::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the history property of the microsoft.graph.riskyUser entity.
                        ...
                        def by_risky_user_history_item_id(risky_user_history_item_id)
                            ...
                            return MicrosoftGraphBeta::IdentityProtection::RiskyUsers::Item::History::Item::RiskyUserHistoryItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
