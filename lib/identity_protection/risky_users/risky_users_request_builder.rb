        ...
        module RiskyUsers
            ...
            class RiskyUsersRequestBuilder
                ...
                def microsoft_graph_confirm_compromised()
                    return MicrosoftGraphBeta::IdentityProtection::RiskyUsers::MicrosoftGraphConfirmCompromised::MicrosoftGraphConfirmCompromisedRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the dismiss method.
                def microsoft_graph_dismiss()
                    return MicrosoftGraphBeta::IdentityProtection::RiskyUsers::MicrosoftGraphDismiss::MicrosoftGraphDismissRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
