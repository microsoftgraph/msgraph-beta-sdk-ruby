...
module MicrosoftGraphBeta
    module ApprovalWorkflowProviders
        module Item
            module BusinessFlowsWithRequestsAwaitingMyDecision
                module Count
                    ## 
                    ...
                    class CountRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider%2Did}/businessFlowsWithRequestsAwaitingMyDecision/$count{?%24filter,%24search}")
                        end
                        ## 
