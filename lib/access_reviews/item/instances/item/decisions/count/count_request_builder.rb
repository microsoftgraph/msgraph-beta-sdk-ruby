...
module MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::Decisions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/decisions/$count{?%24search,%24filter}"
