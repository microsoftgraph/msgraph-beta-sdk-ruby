...
module MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::Decisions
    ## 
    ...
    class DecisionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/decisions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
