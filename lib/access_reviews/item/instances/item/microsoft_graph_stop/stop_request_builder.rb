...
module MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::MicrosoftGraphStop
    ## 
    ...
    class StopRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/microsoft.graph.stop"
