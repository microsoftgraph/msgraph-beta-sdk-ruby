...
module MicrosoftGraphBeta::AccessReviews::Item::Decisions::Item
    ## 
    ...
    class AccessReviewDecisionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, access_review_decision_id=nil)
            ...
            @url_template = "{+baseurl}/accessReviews/{accessReview%2Did}/decisions/{accessReviewDecision%2Did}{?%24select,%24expand}"
