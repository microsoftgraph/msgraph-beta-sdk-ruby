...
module MicrosoftGraphBeta::AccessReviews::Item::MicrosoftGraphApplyDecisions
    ## 
    ...
    class MicrosoftGraphApplyDecisionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/accessReviews/{accessReview%2Did}/microsoft.graph.applyDecisions"
