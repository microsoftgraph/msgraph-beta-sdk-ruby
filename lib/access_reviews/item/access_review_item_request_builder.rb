...
module MicrosoftGraphBeta::AccessReviews::Item
    ...
    class AccessReviewItemRequestBuilder
        ...
        def microsoft_graph_apply_decisions()
            return MicrosoftGraphBeta::AccessReviews::Item::MicrosoftGraphApplyDecisions::ApplyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resetDecisions method.
        def microsoft_graph_reset_decisions()
            return MicrosoftGraphBeta::AccessReviews::Item::MicrosoftGraphResetDecisions::ResetDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendReminder method.
        def microsoft_graph_send_reminder()
            return MicrosoftGraphBeta::AccessReviews::Item::MicrosoftGraphSendReminder::SendReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the stop method.
        def microsoft_graph_stop()
            return MicrosoftGraphBeta::AccessReviews::Item::MicrosoftGraphStop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param accessReviewId key: id of accessReview
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, access_review_id=nil)
