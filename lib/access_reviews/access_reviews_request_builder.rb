...
module MicrosoftGraphBeta
    module AccessReviews
        ...
        class AccessReviewsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            ## 
            def by_access_review_id(access_review_id)
                raise StandardError, 'access_review_id cannot be null' if access_review_id.nil?
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/accessReviews{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/accessReviews'
                request_info.path_parameters = @path_parameters
