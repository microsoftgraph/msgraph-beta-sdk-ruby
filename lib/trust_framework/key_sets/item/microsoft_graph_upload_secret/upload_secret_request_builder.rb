...
require_relative './microsoft_graph_upload_secret'

module MicrosoftGraphBeta::TrustFramework::KeySets::Item::MicrosoftGraphUploadSecret
    ## 
    ...
    class UploadSecretRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/trustFramework/keySets/{trustFrameworkKeySet%2Did}/microsoft.graph.uploadSecret"
