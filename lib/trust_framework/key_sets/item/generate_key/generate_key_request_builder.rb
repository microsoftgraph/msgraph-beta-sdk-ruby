        ...
        module KeySets
            module Item
                module GenerateKey
                    ...
                    class GenerateKeyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/trustFramework/keySets/{trustFrameworkKeySet%2Did}/generateKey")
                        end
                        ## 
                        ...
                        ## @return a generate_key_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return GenerateKeyRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
