...
require_relative './upload_certificate'

module MicrosoftGraphBeta
    module TrustFramework
        module KeySets
            module Item
                module UploadCertificate
                    ## 
                    # Provides operations to call the uploadCertificate method.
                    class UploadCertificateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/trustFramework/keySets/{trustFrameworkKeySet%2Did}/uploadCertificate")
                        end
                        ## 
                        ...
                        ## @return a upload_certificate_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return UploadCertificateRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
