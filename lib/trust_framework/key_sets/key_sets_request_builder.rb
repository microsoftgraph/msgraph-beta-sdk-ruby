...
require_relative '../../models/trust_framework_key_set_collection_response'
require_relative '../trust_framework'
require_relative './count/count_request_builder'
require_relative './item/trust_framework_key_set_item_request_builder'
...
module MicrosoftGraphBeta
    module TrustFramework
        module KeySets
            ...
            class KeySetsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to count the resources in the collection.
                def count()
                    return MicrosoftGraphBeta::TrustFramework::KeySets::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the keySets property of the microsoft.graph.trustFramework entity.
                ...
                ## 
                def by_trust_framework_key_set_id(trust_framework_key_set_id)
                    raise StandardError, 'trust_framework_key_set_id cannot be null' if trust_framework_key_set_id.nil?
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/trustFramework/keySets{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ## Retrieve a list of trustFrameworkKeySets.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ## @return a Fiber of trust_framework_key_set_collection_response
                ## 
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TrustFrameworkKeySetCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/trustFramework/keySets'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a key_sets_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return KeySetsRequestBuilder.new(raw_url, @request_adapter)
                end
