...
module MicrosoftGraphBeta
    module TrustFramework
        ...
        class TrustFrameworkRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/trustFramework{?%24expand,%24select}")
            end
            ## 
            ## Get trustFramework
            ...
            def to_patch_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/trustFramework'
                request_info.path_parameters = @path_parameters
            ...
            ## @return a trust_framework_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return TrustFrameworkRequestBuilder.new(raw_url, @request_adapter)
            end
