...
module MicrosoftGraphBeta::PayloadResponse::Item
    ## 
    ...
    class PayloadResponseItemRequestBuilder
        ...
        ## @param payloadResponseId key: id of payloadResponse
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, payload_response_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/payloadResponse/{payloadResponse%2Did}{?%24select,%24expand}"
