    ...
    module RiskDetections
        ...
        class RiskDetectionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/riskDetections{?%24expand,%24filter,%24orderby,%24search,%24select,%24top}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/riskDetections'
                request_info.path_parameters = @path_parameters
