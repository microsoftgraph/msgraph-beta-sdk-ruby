    ...
    module Workplace
        module SensorDevices
            module IngestTelemetry
                ...
                class IngestTelemetryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/workplace/sensorDevices/ingestTelemetry")
                    end
                    ## 
                    ...
                    ## @return a ingest_telemetry_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return IngestTelemetryRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
