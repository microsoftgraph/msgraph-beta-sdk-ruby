...
require_relative '../models/certificate_authority_path'
    ...
    module CertificateAuthorities
        ...
        class CertificateAuthoritiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def certificate_based_application_configurations()
                return MicrosoftGraphBeta::CertificateAuthorities::CertificateBasedApplicationConfigurations::CertificateBasedApplicationConfigurationsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def mutual_tls_oauth_configurations()
                return MicrosoftGraphBeta::CertificateAuthorities::MutualTlsOauthConfigurations::MutualTlsOauthConfigurationsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/certificateAuthorities{?%24expand,%24select}")
            end
            ## 
            ## Get certificateAuthorities
            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
            ## @return a Fiber of certificate_authority_path
            ## 
