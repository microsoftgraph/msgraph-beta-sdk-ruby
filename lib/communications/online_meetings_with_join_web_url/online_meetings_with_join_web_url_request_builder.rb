...
require_relative './online_meetings_with_join_web_url'
...
module MicrosoftGraphBeta
    module Communications
        module OnlineMeetingsWithJoinWebUrl
            ## 
            # Provides operations to manage the onlineMeetings property of the microsoft.graph.cloudCommunications entity.
            class OnlineMeetingsWithJoinWebUrlRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to call the getVirtualAppointmentJoinWebUrl method.
                def get_virtual_appointment_join_web_url()
                    return MicrosoftGraphBeta::Communications::OnlineMeetingsWithJoinWebUrl::GetVirtualAppointmentJoinWebUrl::GetVirtualAppointmentJoinWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the sendVirtualAppointmentReminderSms method.
                def send_virtual_appointment_reminder_sms()
                    return MicrosoftGraphBeta::Communications::OnlineMeetingsWithJoinWebUrl::SendVirtualAppointmentReminderSms::SendVirtualAppointmentReminderSmsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the sendVirtualAppointmentSms method.
                def send_virtual_appointment_sms()
                    return MicrosoftGraphBeta::Communications::OnlineMeetingsWithJoinWebUrl::SendVirtualAppointmentSms::SendVirtualAppointmentSmsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                ## @return a void
                ## 
                def initialize(path_parameters, request_adapter, join_web_url=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/communications/onlineMeetings(joinWebUrl='{joinWebUrl}'){?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/communications/onlineMeetings(joinWebUrl='{joinWebUrl}')'
                ...
                def with_url(raw_url)
                    ...
                    return OnlineMeetingsWithJoinWebUrlRequestBuilder.new(raw_url, @request_adapter)
                end
