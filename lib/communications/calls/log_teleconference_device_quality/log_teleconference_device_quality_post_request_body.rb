...
module MicrosoftGraphBeta::Communications::Calls::LogTeleconferenceDeviceQuality
    class LogTeleconferenceDeviceQualityPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "quality" => lambda {|n| @quality = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeleconferenceDeviceQuality.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
