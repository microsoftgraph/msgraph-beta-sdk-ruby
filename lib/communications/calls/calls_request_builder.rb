...
module MicrosoftGraphBeta::Communications::Calls
    ## 
    ...
    class CallsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Communications::Calls::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the logTeleconferenceDeviceQuality method.
        def microsoft_graph_log_teleconference_device_quality()
            return MicrosoftGraphBeta::Communications::Calls::MicrosoftGraphLogTeleconferenceDeviceQuality::MicrosoftGraphLogTeleconferenceDeviceQualityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
