...
module MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphPlayPrompt
    class PlayPromptPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "loop" => lambda {|n| @loop = n.get_boolean_value() },
        ...
        def serialize(writer)
            ...
            writer.write_boolean_value("loop", @loop)
