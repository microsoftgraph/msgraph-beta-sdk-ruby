...
module MicrosoftGraphBeta::Communications::Calls::Item::Participants::MicrosoftGraphInvite
    class InvitePostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "participants" => lambda {|n| @participants = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::InvitationParticipantInfo.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
