...
module MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphChangeScreenSharingRole
    class ChangeScreenSharingRolePostRequestBody
        ...
        def get_field_deserializers()
            return {
                "role" => lambda {|n| @role = n.get_enum_value(MicrosoftGraphBeta::Models::ScreenSharingRole) },
            }
        end
        ## 
