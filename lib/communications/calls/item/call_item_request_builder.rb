...
module MicrosoftGraphBeta::Communications::Calls::Item
    ...
    class CallItemRequestBuilder
        ...
        def microsoft_graph_add_large_gallery_view()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphAddLargeGalleryView::AddLargeGalleryViewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the answer method.
        def microsoft_graph_answer()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphAnswer::AnswerRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancelMediaProcessing method.
        def microsoft_graph_cancel_media_processing()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphCancelMediaProcessing::CancelMediaProcessingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the changeScreenSharingRole method.
        def microsoft_graph_change_screen_sharing_role()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphChangeScreenSharingRole::ChangeScreenSharingRoleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the keepAlive method.
        def microsoft_graph_keep_alive()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphKeepAlive::KeepAliveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the mute method.
        def microsoft_graph_mute()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphMute::MuteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the playPrompt method.
        def microsoft_graph_play_prompt()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphPlayPrompt::PlayPromptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the record method.
        def microsoft_graph_record()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphRecord::RecordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the recordResponse method.
        def microsoft_graph_record_response()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphRecordResponse::RecordResponseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the redirect method.
        def microsoft_graph_redirect()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphRedirect::RedirectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reject method.
        def microsoft_graph_reject()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphReject::RejectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the subscribeToTone method.
        def microsoft_graph_subscribe_to_tone()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphSubscribeToTone::SubscribeToToneRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the transfer method.
        def microsoft_graph_transfer()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphTransfer::TransferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unmute method.
        def microsoft_graph_unmute()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphUnmute::UnmuteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRecordingStatus method.
        def microsoft_graph_update_recording_status()
            return MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphUpdateRecordingStatus::UpdateRecordingStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
