        ...
        module Calls
            module Item
                ...
                class CallItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def send_dtmf_tones()
                        return MicrosoftGraphBeta::Communications::Calls::Item::SendDtmfTones::SendDtmfTonesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the startRecording method.
                    def start_recording()
                        return MicrosoftGraphBeta::Communications::Calls::Item::StartRecording::StartRecordingRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the startTranscription method.
                    def start_transcription()
                        return MicrosoftGraphBeta::Communications::Calls::Item::StartTranscription::StartTranscriptionRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the stopRecording method.
                    def stop_recording()
                        return MicrosoftGraphBeta::Communications::Calls::Item::StopRecording::StopRecordingRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the stopTranscription method.
                    def stop_transcription()
                        return MicrosoftGraphBeta::Communications::Calls::Item::StopTranscription::StopTranscriptionRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
