            ...
            module Item
                module Record
                    class RecordPostRequestBody
                        ...
                        ## @return a record_post_request_body
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return RecordPostRequestBody.new
                        end
                        ## 
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "prompts" => lambda {|n| @prompts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Prompt.create_from_discriminator_value(pn) }) },
                                "stopTones" => lambda {|n| @stop_tones = n.get_collection_of_primitive_values(String) },
                                "streamWhileRecording" => lambda {|n| @stream_while_recording = n.get_boolean_value() },
                            }
                        end
                        ## 
                        ...
                        def serialize(writer)
                            ...
                            writer.write_boolean_value("streamWhileRecording", @stream_while_recording)
                        ...
                        ## @return a boolean
                        ## 
                        def stream_while_recording
                            return @stream_while_recording
                        end
                        ## 
                        ## Sets the streamWhileRecording property value. The streamWhileRecording property
                        ## @param value Value to set for the stream_while_recording property.
                        ## @return a void
                        ## 
                        def stream_while_recording=(value)
                            @stream_while_recording = value
                        end
                    end
                end
            end
