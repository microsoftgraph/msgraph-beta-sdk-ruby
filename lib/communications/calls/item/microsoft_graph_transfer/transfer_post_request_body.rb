...
module MicrosoftGraphBeta::Communications::Calls::Item::MicrosoftGraphTransfer
    class TransferPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "transferTarget" => lambda {|n| @transfer_target = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::InvitationParticipantInfo.create_from_discriminator_value(pn) }) },
                "transferee" => lambda {|n| @transferee = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ParticipantInfo.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
