...
module MicrosoftGraphBeta::Communications::Calls::Item::Answer
    class AnswerPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "acceptedModalities" => lambda {|n| @accepted_modalities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Modality.create_from_discriminator_value(pn) }) },
                "callbackUri" => lambda {|n| @callback_uri = n.get_string_value() },
                "callOptions" => lambda {|n| @call_options = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IncomingCallOptions.create_from_discriminator_value(pn) }) },
