                ...
                module Answer
                    class AnswerPostRequestBody
                        ...
                        def get_field_deserializers()
                            return {
                                "acceptedModalities" => lambda {|n| @accepted_modalities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Communications::Calls::Item::Answer::AnswerPostRequestBodyAcceptedModalities.create_from_discriminator_value(pn) }) },
