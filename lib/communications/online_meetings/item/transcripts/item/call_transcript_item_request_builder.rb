...
module MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Transcripts::Item
    ## 
    ...
    class CallTranscriptItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Transcripts::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param callTranscriptId key: id of callTranscript
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, call_transcript_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/transcripts/{callTranscript%2Did}{?%24select,%24expand}"
