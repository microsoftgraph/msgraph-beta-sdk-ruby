...
require_relative '../../../../models/meeting_registration'
require_relative '../../../../models/o_data_errors/o_data_error'
require_relative '../../../communications'
require_relative '../../online_meetings'
require_relative '../item'
require_relative './custom_questions/custom_questions_request_builder'
require_relative './custom_questions/item/meeting_registration_question_item_request_builder'
require_relative './registration'

module MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Registration
    ## 
    ...
    class RegistrationRequestBuilder
        ...
        def custom_questions()
            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Registration::CustomQuestions::CustomQuestionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration{?%24select,%24expand}"
        ...
        def custom_questions_by_id(id)
            ...
            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Registration::CustomQuestions::Item::MeetingRegistrationQuestionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
