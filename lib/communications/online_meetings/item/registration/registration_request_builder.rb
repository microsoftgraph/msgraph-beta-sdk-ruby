...
require_relative './registrants/registrants_request_builder'
            ...
            module Item
                module Registration
                    ...
                    class RegistrationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def registrants()
                            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Registration::Registrants::RegistrantsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration'
