...
module MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Registration::CustomQuestions::Item
    ## 
    ...
    class MeetingRegistrationQuestionItemRequestBuilder
        ...
        ## @param meetingRegistrationQuestionId key: id of meetingRegistrationQuestion
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, meeting_registration_question_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration/customQuestions/{meetingRegistrationQuestion%2Did}{?%24select,%24expand}"
