...
module MicrosoftGraphBeta::Communications::OnlineMeetings::Item::MeetingAttendanceReport
    ## 
    ...
    class MeetingAttendanceReportRequestBuilder
        ...
        def attendance_records()
            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::MeetingAttendanceReport::AttendanceRecords::AttendanceRecordsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def attendance_records_by_id(id)
            ...
            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::MeetingAttendanceReport::AttendanceRecords::Item::AttendanceRecordItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport{?%24select,%24expand}"
