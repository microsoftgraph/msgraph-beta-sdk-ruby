...
module MicrosoftGraphBeta::Communications::OnlineMeetings::Item::MeetingAttendanceReport::AttendanceRecords::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport/attendanceRecords/$count{?%24search,%24filter}"
