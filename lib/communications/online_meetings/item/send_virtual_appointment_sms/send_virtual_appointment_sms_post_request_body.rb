...
require_relative '../../../../models/virtual_appointment_sms_type'
                    ...
                    class SendVirtualAppointmentSmsPostRequestBody
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "smsType" => lambda {|n| @sms_type = n.get_enum_value(MicrosoftGraphBeta::Models::VirtualAppointmentSmsType) },
                            }
                        end
                        ## 
                        ...
                        ## @return a virtual_appointment_sms_type
                        ## 
                        def sms_type
                            return @sms_type
                        end
