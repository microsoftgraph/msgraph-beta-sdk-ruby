...
require_relative './transcripts/item/call_transcript_item_request_builder'
...
module MicrosoftGraphBeta::Communications::OnlineMeetings::Item
    ## 
    ...
    class OnlineMeetingItemRequestBuilder
        ...
        def virtual_appointment()
            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::VirtualAppointment::VirtualAppointmentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the attendanceReports property of the microsoft.graph.onlineMeeting entity.
        ...
        def attendance_reports_by_id(id)
            ...
            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::AttendanceReports::Item::MeetingAttendanceReportItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        ## 
        def transcripts_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["callTranscript%2Did"] = id
            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Transcripts::Item::CallTranscriptItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
