...
require_relative './ai_insights/ai_insights_request_builder'
        ...
        module OnlineMeetings
            module Item
                ...
                class OnlineMeetingItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def ai_insights()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::AiInsights::AiInsightsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the media for the cloudCommunications entity.
                    def alternative_recording()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::AlternativeRecording::AlternativeRecordingRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the attendanceReports property of the microsoft.graph.onlineMeetingBase entity.
                    def attendance_reports()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::AttendanceReports::AttendanceReportsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the media for the cloudCommunications entity.
                    def attendee_report()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::AttendeeReport::AttendeeReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the media for the cloudCommunications entity.
                    def broadcast_recording()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::BroadcastRecording::BroadcastRecordingRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getVirtualAppointmentJoinWebUrl method.
                    def get_virtual_appointment_join_web_url()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::GetVirtualAppointmentJoinWebUrl::GetVirtualAppointmentJoinWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def meeting_attendance_report()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::MeetingAttendanceReport::MeetingAttendanceReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the media for the cloudCommunications entity.
                    def recording()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Recording::RecordingRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the recordings property of the microsoft.graph.onlineMeeting entity.
                    def recordings()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Recordings::RecordingsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the registration property of the microsoft.graph.onlineMeeting entity.
                    def registration()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Registration::RegistrationRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the sendVirtualAppointmentReminderSms method.
                    def send_virtual_appointment_reminder_sms()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::SendVirtualAppointmentReminderSms::SendVirtualAppointmentReminderSmsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the sendVirtualAppointmentSms method.
                    def send_virtual_appointment_sms()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::SendVirtualAppointmentSms::SendVirtualAppointmentSmsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the transcripts property of the microsoft.graph.onlineMeeting entity.
                    def transcripts()
                        return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Transcripts::TranscriptsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
