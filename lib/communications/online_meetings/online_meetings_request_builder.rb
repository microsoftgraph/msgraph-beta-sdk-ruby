...
module MicrosoftGraphBeta::Communications::OnlineMeetings
    ## 
    ...
    class OnlineMeetingsRequestBuilder
        ...
        def microsoft_graph_create_or_get()
            return MicrosoftGraphBeta::Communications::OnlineMeetings::MicrosoftGraphCreateOrGet::MicrosoftGraphCreateOrGetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
