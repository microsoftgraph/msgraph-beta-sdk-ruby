...
require_relative '../../../models/call_records/pstn_blocked_users_log_row'
            ...
            module MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTime
                class GetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                    ...
                    def get_field_deserializers()
                        return super.merge({
                            "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecords::PstnBlockedUsersLogRow.create_from_discriminator_value(pn) }) },
                        })
                    end
                    ## 
