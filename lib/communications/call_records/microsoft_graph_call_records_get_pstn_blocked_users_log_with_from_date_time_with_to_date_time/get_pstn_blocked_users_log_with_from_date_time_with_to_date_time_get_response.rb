    ...
    module Communications
        module CallRecords
            module MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTime
                class GetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                    ...
                    ## @return a get_pstn_blocked_users_log_with_from_date_time_with_to_date_time_get_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeGetResponse.new
                    end
                    ## 
