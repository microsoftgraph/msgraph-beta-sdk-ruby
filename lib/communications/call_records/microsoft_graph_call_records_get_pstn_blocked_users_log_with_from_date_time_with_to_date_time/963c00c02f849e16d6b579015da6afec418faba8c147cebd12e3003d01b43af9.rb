    ...
    module Communications
        module CallRecords
            module MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTime
                ...
                class MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter, from_date_time=nil, to_date_time=nil)
                        super(path_parameters, request_adapter, "{+baseurl}/communications/callRecords/microsoft.graph.callRecords.getPstnBlockedUsersLog(fromDateTime={fromDateTime},toDateTime={toDateTime}){?%24top,%24skip,%24search,%24filter,%24count}")
                    end
                    ## 
                    ## Invoke function getPstnBlockedUsersLog
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of get_pstn_blocked_users_log_with_from_date_time_with_to_date_time_get_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Communications::CallRecords::MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTime::GetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Invoke function getPstnBlockedUsersLog
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ...
                    def with_url(raw_url)
                        ...
                        return MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeRequestBuilder.new(raw_url, @request_adapter)
                    end
