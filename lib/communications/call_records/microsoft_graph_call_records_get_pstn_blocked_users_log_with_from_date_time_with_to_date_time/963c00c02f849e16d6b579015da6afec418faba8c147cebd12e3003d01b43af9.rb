        ...
        module CallRecords
            module MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTime
                ...
                class MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a Fiber of get_pstn_blocked_users_log_with_from_date_time_with_to_date_time_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Communications::CallRecords::MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFromDateTimeWithToDateTime::GetPstnBlockedUsersLogWithFromDateTimeWithToDateTimeResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Invoke function getPstnBlockedUsersLog
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
