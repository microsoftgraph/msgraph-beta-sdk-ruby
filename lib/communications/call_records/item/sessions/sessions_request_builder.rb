                ...
                module Sessions
                    ...
                    class SessionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsSessionCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsSession.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Retrieve the list of sessions associated with a callRecord object.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
