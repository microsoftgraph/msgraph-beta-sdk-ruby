...
module MicrosoftGraphBeta::Communications::CallRecords::Item::Sessions::Item
    ## 
    ...
    class SessionItemRequestBuilder
        ...
        def segments()
            return MicrosoftGraphBeta::Communications::CallRecords::Item::Sessions::Item::Segments::SegmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
