...
module MicrosoftGraphBeta::Communications::CallRecords::GetPstnCallsWithFromDateTimeWithToDateTime
    ...
    class GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Communications::CallRecords::GetPstnCallsWithFromDateTimeWithToDateTime::GetPstnCallsWithFromDateTimeWithToDateTimeResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function getPstnCalls
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
