    ...
    module Communications
        ...
        class CommunicationsRequestBuilder
            ...
            def microsoft_graph_get_presences_by_user_id()
                return MicrosoftGraphBeta::Communications::MicrosoftGraphGetPresencesByUserId::MicrosoftGraphGetPresencesByUserIdRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
