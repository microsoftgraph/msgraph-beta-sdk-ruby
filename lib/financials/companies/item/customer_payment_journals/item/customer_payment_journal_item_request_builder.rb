...
require_relative '../../../../../models/customer_payment_journal'
...
module MicrosoftGraphBeta::Financials::Companies::Item::CustomerPaymentJournals::Item
    ## 
    ...
    class CustomerPaymentJournalItemRequestBuilder
        ...
        def account()
            return MicrosoftGraphBeta::Financials::Companies::Item::CustomerPaymentJournals::Item::Account::AccountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the customerPayments property of the microsoft.graph.customerPaymentJournal entity.
        def customer_payments()
            return MicrosoftGraphBeta::Financials::Companies::Item::CustomerPaymentJournals::Item::CustomerPayments::CustomerPaymentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param customerPaymentJournalId key: id of customerPaymentJournal
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, customer_payment_journal_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/customerPaymentJournals/{customerPaymentJournal%2Did}{?%24select,%24expand}"
        ...
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a Fiber of customer_payment_journal
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::CustomerPaymentJournal.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
