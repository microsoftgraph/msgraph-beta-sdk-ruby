...
module MicrosoftGraphBeta::Financials::Companies::Item::Items::Item::Picture::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/items/{item%2Did}/picture/$count{?%24search,%24filter}"
