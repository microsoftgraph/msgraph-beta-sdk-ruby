...
module MicrosoftGraphBeta::Financials::Companies::Item::Dimensions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/dimensions/$count{?%24search,%24filter}"
