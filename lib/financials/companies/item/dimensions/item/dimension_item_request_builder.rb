            ...
            module Item
                module Dimensions
                    module Item
                        ...
                        class DimensionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/financials/companies/{company%2Did}/dimensions/{dimension%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def with_url(raw_url)
                                ...
                                return DimensionItemRequestBuilder.new(raw_url, @request_adapter)
                            end
