...
module MicrosoftGraphBeta::Financials::Companies::Item::Dimensions::Item
    ## 
    ...
    class DimensionItemRequestBuilder
        ...
        ## @param dimensionId key: id of dimension
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, dimension_id=nil)
