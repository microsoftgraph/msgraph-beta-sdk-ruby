...
module MicrosoftGraphBeta::Financials::Companies::Item::PurchaseInvoices::Item
    ...
    class PurchaseInvoiceItemRequestBuilder
        ...
        def microsoft_graph_post()
            return MicrosoftGraphBeta::Financials::Companies::Item::PurchaseInvoices::Item::MicrosoftGraphPost::MicrosoftGraphPostRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
