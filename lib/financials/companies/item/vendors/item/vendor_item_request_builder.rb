...
module MicrosoftGraphBeta::Financials::Companies::Item::Vendors::Item
    ## 
    ...
    class VendorItemRequestBuilder
        ...
        def currency()
            return MicrosoftGraphBeta::Financials::Companies::Item::Vendors::Item::Currency::CurrencyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def payment_method()
            return MicrosoftGraphBeta::Financials::Companies::Item::Vendors::Item::PaymentMethod::PaymentMethodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the paymentTerm property of the microsoft.graph.vendor entity.
        def payment_term()
            return MicrosoftGraphBeta::Financials::Companies::Item::Vendors::Item::PaymentTerm::PaymentTermRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the picture property of the microsoft.graph.vendor entity.
        def picture()
            return MicrosoftGraphBeta::Financials::Companies::Item::Vendors::Item::Picture::PictureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param vendorId key: id of vendor
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, vendor_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/vendors/{vendor%2Did}{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Vendor.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ...
        def picture_by_id(id)
            ...
            return MicrosoftGraphBeta::Financials::Companies::Item::Vendors::Item::Picture::Item::PictureItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property vendors for financials
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
