...
module MicrosoftGraphBeta::Financials::Companies::Item::Vendors::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/vendors/$count{?%24search,%24filter}"
