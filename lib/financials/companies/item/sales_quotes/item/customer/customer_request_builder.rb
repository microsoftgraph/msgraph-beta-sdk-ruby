...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::Customer
    ## 
    ...
    class CustomerRequestBuilder
        ...
        def currency()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::Customer::Currency::CurrencyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def payment_method()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::Customer::PaymentMethod::PaymentMethodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the paymentTerm property of the microsoft.graph.customer entity.
        def payment_term()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::Customer::PaymentTerm::PaymentTermRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the picture property of the microsoft.graph.customer entity.
        def picture()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::Customer::Picture::PictureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def shipment_method()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::Customer::ShipmentMethod::ShipmentMethodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesQuotes/{salesQuote%2Did}/customer{?%24select,%24expand}"
        ...
        def picture_by_id(id)
            ...
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::Customer::Picture::Item::PictureItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property customer for financials
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
