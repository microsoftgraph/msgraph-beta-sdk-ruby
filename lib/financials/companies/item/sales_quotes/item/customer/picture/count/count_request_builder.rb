...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::Customer::Picture::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesQuotes/{salesQuote%2Did}/customer/picture/$count{?%24search,%24filter}"
