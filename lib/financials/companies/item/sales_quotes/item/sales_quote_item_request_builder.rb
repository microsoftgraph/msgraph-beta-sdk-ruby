...
require_relative './item'
require_relative './microsoft_graph_make_invoice/microsoft_graph_make_invoice_request_builder'
...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item
    ...
    class SalesQuoteItemRequestBuilder
        ...
        def microsoft_graph_make_invoice()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::MicrosoftGraphMakeInvoice::MicrosoftGraphMakeInvoiceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the send method.
        def microsoft_graph_send()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::MicrosoftGraphSend::MicrosoftGraphSendRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
