...
require_relative './item'
require_relative './microsoft_graph_make_invoice/make_invoice_request_builder'
...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item
    ...
    class SalesQuoteItemRequestBuilder
        ...
        def microsoft_graph_make_invoice()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::MicrosoftGraphMakeInvoice::MakeInvoiceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the send method.
        def microsoft_graph_send()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesQuotes::Item::MicrosoftGraphSend::SendRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param salesQuoteId key: id of salesQuote
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, sales_quote_id=nil)
