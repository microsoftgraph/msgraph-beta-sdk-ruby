...
module MicrosoftGraphBeta::Financials::Companies::Item::Customers::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/customers/$count{?%24search,%24filter}"
