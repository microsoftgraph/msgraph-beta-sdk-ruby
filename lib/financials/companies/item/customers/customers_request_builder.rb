...
module MicrosoftGraphBeta::Financials::Companies::Item::Customers
    ## 
    ...
    class CustomersRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/customers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
