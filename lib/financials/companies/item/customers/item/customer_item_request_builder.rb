...
module MicrosoftGraphBeta::Financials::Companies::Item::Customers::Item
    ## 
    ...
    class CustomerItemRequestBuilder
        ...
        def currency()
            return MicrosoftGraphBeta::Financials::Companies::Item::Customers::Item::Currency::CurrencyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def payment_method()
            return MicrosoftGraphBeta::Financials::Companies::Item::Customers::Item::PaymentMethod::PaymentMethodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the paymentTerm property of the microsoft.graph.customer entity.
        def payment_term()
            return MicrosoftGraphBeta::Financials::Companies::Item::Customers::Item::PaymentTerm::PaymentTermRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the picture property of the microsoft.graph.customer entity.
        def picture()
            return MicrosoftGraphBeta::Financials::Companies::Item::Customers::Item::Picture::PictureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def shipment_method()
            return MicrosoftGraphBeta::Financials::Companies::Item::Customers::Item::ShipmentMethod::ShipmentMethodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param customerId key: id of customer
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, customer_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/customers/{customer%2Did}{?%24select,%24expand}"
