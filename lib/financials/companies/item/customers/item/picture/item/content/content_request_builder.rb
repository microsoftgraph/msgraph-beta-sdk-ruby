...
module MicrosoftGraphBeta::Financials::Companies::Item::Customers::Item::Picture::Item::Content
    ## 
    ...
    class ContentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/customers/{customer%2Did}/picture/{picture%2Did}/content"
