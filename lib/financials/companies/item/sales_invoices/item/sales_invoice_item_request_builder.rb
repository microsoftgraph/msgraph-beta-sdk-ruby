...
require_relative './microsoft_graph_cancel_and_send/cancel_and_send_request_builder'
require_relative './microsoft_graph_post/post_request_builder'
require_relative './microsoft_graph_post_and_send/post_and_send_request_builder'
...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item
    ...
    class SalesInvoiceItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::MicrosoftGraphCancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancelAndSend method.
        def microsoft_graph_cancel_and_send()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::MicrosoftGraphCancelAndSend::CancelAndSendRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the post method.
        def microsoft_graph_post()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::MicrosoftGraphPost::PostRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the postAndSend method.
        def microsoft_graph_post_and_send()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::MicrosoftGraphPostAndSend::PostAndSendRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the send method.
        def microsoft_graph_send()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::MicrosoftGraphSend::SendRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param salesInvoiceId key: id of salesInvoice
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, sales_invoice_id=nil)
