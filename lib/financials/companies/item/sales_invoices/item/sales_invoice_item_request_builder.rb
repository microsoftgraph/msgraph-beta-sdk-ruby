...
require_relative './microsoft_graph_cancel_and_send/microsoft_graph_cancel_and_send_request_builder'
require_relative './microsoft_graph_post/microsoft_graph_post_request_builder'
require_relative './microsoft_graph_post_and_send/microsoft_graph_post_and_send_request_builder'
                    ...
                    module Item
                        ...
                        class SalesInvoiceItemRequestBuilder
                            ...
                            def microsoft_graph_cancel()
                                return MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the cancelAndSend method.
                            def microsoft_graph_cancel_and_send()
                                return MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::MicrosoftGraphCancelAndSend::MicrosoftGraphCancelAndSendRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the post method.
                            def microsoft_graph_post()
                                return MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::MicrosoftGraphPost::MicrosoftGraphPostRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the postAndSend method.
                            def microsoft_graph_post_and_send()
                                return MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::MicrosoftGraphPostAndSend::MicrosoftGraphPostAndSendRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the send method.
                            def microsoft_graph_send()
                                return MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::MicrosoftGraphSend::MicrosoftGraphSendRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
