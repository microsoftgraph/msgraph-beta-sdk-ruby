...
module MicrosoftGraphBeta::Financials::Companies::Item::TaxAreas::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/taxAreas/$count{?%24search,%24filter}"
