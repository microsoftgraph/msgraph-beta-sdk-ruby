...
require_relative './microsoft_graph_post/microsoft_graph_post_request_builder'
...
module MicrosoftGraphBeta::Financials::Companies::Item::Journals::Item
    ...
    class JournalItemRequestBuilder
        ...
        def microsoft_graph_post()
            return MicrosoftGraphBeta::Financials::Companies::Item::Journals::Item::MicrosoftGraphPost::MicrosoftGraphPostRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
