...
module MicrosoftGraphBeta::Financials::Companies::Item::Journals::Item
    ## 
    ...
    class JournalItemRequestBuilder
        ...
        def account()
            return MicrosoftGraphBeta::Financials::Companies::Item::Journals::Item::Account::AccountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the journalLines property of the microsoft.graph.journal entity.
        def journal_lines()
            return MicrosoftGraphBeta::Financials::Companies::Item::Journals::Item::JournalLines::JournalLinesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the post method.
        def microsoft_graph_post()
            return MicrosoftGraphBeta::Financials::Companies::Item::Journals::Item::MicrosoftGraphPost::PostRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param journalId key: id of journal
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, journal_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/journals/{journal%2Did}{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Journal.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the journalLines property of the microsoft.graph.journal entity.
        ...
        def journal_lines_by_id(id)
            ...
            return MicrosoftGraphBeta::Financials::Companies::Item::Journals::Item::JournalLines::Item::JournalLineItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
