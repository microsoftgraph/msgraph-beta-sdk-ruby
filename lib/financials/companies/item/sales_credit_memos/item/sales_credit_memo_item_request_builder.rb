...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesCreditMemos::Item
    ## 
    ...
    class SalesCreditMemoItemRequestBuilder
        ...
        ## @param salesCreditMemoId key: id of salesCreditMemo
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, sales_credit_memo_id=nil)
