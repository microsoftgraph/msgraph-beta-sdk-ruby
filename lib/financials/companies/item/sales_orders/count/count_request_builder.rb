...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesOrders::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesOrders/$count{?%24search,%24filter}"
