...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesOrders::Item
    ## 
    ...
    class SalesOrderItemRequestBuilder
        ...
        def currency()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesOrders::Item::Currency::CurrencyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the customer property of the microsoft.graph.salesOrder entity.
        def customer()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesOrders::Item::Customer::CustomerRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def payment_term()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesOrders::Item::PaymentTerm::PaymentTermRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def sales_order_lines()
            return MicrosoftGraphBeta::Financials::Companies::Item::SalesOrders::Item::SalesOrderLines::SalesOrderLinesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param salesOrderId key: id of salesOrder
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, sales_order_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesOrders/{salesOrder%2Did}{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SalesOrder.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
