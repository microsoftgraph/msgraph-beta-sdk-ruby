...
module MicrosoftGraphBeta::Places::Item
    ## 
    ...
    class PlaceItemRequestBuilder
        ...
        def microsoft_graph_room()
            return MicrosoftGraphBeta::Places::Item::MicrosoftGraphRoom::MicrosoftGraphRoomRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
