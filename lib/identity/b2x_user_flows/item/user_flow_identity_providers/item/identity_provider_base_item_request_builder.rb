...
module MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserFlowIdentityProviders::Item
    ## 
    ...
    class IdentityProviderBaseItemRequestBuilder
        ...
        def ref()
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserFlowIdentityProviders::Item::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
