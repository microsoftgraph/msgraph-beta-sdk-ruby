            ...
            module Item
                ...
                class B2xIdentityUserFlowItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def api_connector_configuration()
                        return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::ApiConnectorConfiguration::ApiConnectorConfigurationRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
