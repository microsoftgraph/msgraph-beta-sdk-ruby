...
module MicrosoftGraphBeta::Identity::B2xUserFlows::Item
    ## 
    ...
    class B2xIdentityUserFlowItemRequestBuilder
        ...
        def identity_providers()
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::IdentityProviders::IdentityProvidersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the languages property of the microsoft.graph.b2xIdentityUserFlow entity.
        def languages()
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::Languages::LanguagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_attribute_assignments()
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserAttributeAssignments::UserAttributeAssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_flow_identity_providers()
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserFlowIdentityProviders::UserFlowIdentityProvidersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::B2xIdentityUserFlow.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the identityProviders property of the microsoft.graph.b2xIdentityUserFlow entity.
        ...
        def identity_providers_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::IdentityProviders::Item::IdentityProviderItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the languages property of the microsoft.graph.b2xIdentityUserFlow entity.
        ## @param id Unique identifier of the item
        ...
        def languages_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::Languages::Item::UserFlowLanguageConfigurationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def user_attribute_assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserAttributeAssignments::Item::IdentityUserFlowAttributeAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Gets an item from the MicrosoftGraphBeta.identity.b2xUserFlows.item.userFlowIdentityProviders.item collection
        ## @param id Unique identifier of the item
        ...
        def user_flow_identity_providers_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserFlowIdentityProviders::Item::IdentityProviderBaseItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
