...
module MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserAttributeAssignments::MicrosoftGraphSetOrder
    class SetOrderPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "newAssignmentOrder" => lambda {|n| @new_assignment_order = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AssignmentOrder.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
