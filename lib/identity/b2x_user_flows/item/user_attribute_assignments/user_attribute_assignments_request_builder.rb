            ...
            module Item
                module UserAttributeAssignments
                    ...
                    class UserAttributeAssignmentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserAttributeAssignments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getOrder method.
                        def get_order()
                            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserAttributeAssignments::GetOrder::GetOrderRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the setOrder method.
                        def set_order()
                            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserAttributeAssignments::SetOrder::SetOrderRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the userAttributeAssignments property of the microsoft.graph.b2xIdentityUserFlow entity.
