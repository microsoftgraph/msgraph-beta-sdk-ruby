                ...
                module ApiConnectorConfiguration
                    module PostAttributeCollection
                        ...
                        class PostAttributeCollectionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def ref()
                                return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::ApiConnectorConfiguration::PostAttributeCollection::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the uploadClientCertificate method.
                            def upload_client_certificate()
                                return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::ApiConnectorConfiguration::PostAttributeCollection::UploadClientCertificate::UploadClientCertificateRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
