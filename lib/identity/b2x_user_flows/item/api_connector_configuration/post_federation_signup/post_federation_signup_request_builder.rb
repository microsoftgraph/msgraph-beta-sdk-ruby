                ...
                module ApiConnectorConfiguration
                    module PostFederationSignup
                        ...
                        class PostFederationSignupRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def ref()
                                return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::ApiConnectorConfiguration::PostFederationSignup::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the uploadClientCertificate method.
                            def upload_client_certificate()
                                return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::ApiConnectorConfiguration::PostFederationSignup::UploadClientCertificate::UploadClientCertificateRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def get(request_configuration=nil)
                                ...
                                error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                                error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IdentityApiConnector.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
