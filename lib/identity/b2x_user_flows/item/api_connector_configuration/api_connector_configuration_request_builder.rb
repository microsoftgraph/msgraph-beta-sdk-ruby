...
require_relative './pre_token_issuance/pre_token_issuance_request_builder'
                ...
                module ApiConnectorConfiguration
                    ...
                    class ApiConnectorConfigurationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def post_attribute_collection()
                            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::ApiConnectorConfiguration::PostAttributeCollection::PostAttributeCollectionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def post_federation_signup()
                            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::ApiConnectorConfiguration::PostFederationSignup::PostFederationSignupRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def pre_token_issuance()
                            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::ApiConnectorConfiguration::PreTokenIssuance::PreTokenIssuanceRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UserFlowApiConnectorConfiguration.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Configuration for enabling an API connector for use as part of the self-service sign-up user flow. You can only obtain the value of this object using Get userFlowApiConnectorConfiguration.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
