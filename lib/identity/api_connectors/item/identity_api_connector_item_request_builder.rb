...
module MicrosoftGraphBeta::Identity::ApiConnectors::Item
    ...
    class IdentityApiConnectorItemRequestBuilder
        ...
        def microsoft_graph_upload_client_certificate()
            return MicrosoftGraphBeta::Identity::ApiConnectors::Item::MicrosoftGraphUploadClientCertificate::UploadClientCertificateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
