...
module MicrosoftGraphBeta::Identity::ApiConnectors::Item
    ...
    class IdentityApiConnectorItemRequestBuilder
        ...
        def upload_client_certificate()
            return MicrosoftGraphBeta::Identity::ApiConnectors::Item::UploadClientCertificate::UploadClientCertificateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
