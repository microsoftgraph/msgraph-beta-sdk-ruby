...
module MicrosoftGraphBeta::Identity::IdentityProviders
    ## 
    ...
    class IdentityProvidersRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Identity::IdentityProviders::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the availableProviderTypes method.
        def microsoft_graph_available_provider_types()
            return MicrosoftGraphBeta::Identity::IdentityProviders::MicrosoftGraphAvailableProviderTypes::MicrosoftGraphAvailableProviderTypesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def post(body, request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IdentityProviderBase.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Get a collection of identity provider resources that are configured for a tenant, and that are derived from identityProviderBase. For an Azure AD tenant, the providers can be socialIdentityProviders or builtinIdentityProviders objects. For an Azure AD B2C, the providers can be socialIdentityProvider, openIdConnectIdentityProvider, or appleManagedIdentityProvider objects.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
