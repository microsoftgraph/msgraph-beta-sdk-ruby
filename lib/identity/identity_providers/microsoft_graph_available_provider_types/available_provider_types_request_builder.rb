...
module MicrosoftGraphBeta::Identity::IdentityProviders::MicrosoftGraphAvailableProviderTypes
    ...
    class AvailableProviderTypesRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Identity::IdentityProviders::MicrosoftGraphAvailableProviderTypes::AvailableProviderTypesResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function availableProviderTypes
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
