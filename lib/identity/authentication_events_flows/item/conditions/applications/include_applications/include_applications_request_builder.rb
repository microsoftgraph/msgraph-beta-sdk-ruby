                    ...
                    module Applications
                        module IncludeApplications
                            ...
                            class IncludeApplicationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::Identity::AuthenticationEventsFlows::Item::Conditions::Applications::IncludeApplications::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the includeApplications property of the microsoft.graph.authenticationConditionsApplications entity.
                                ...
                                def by_authentication_condition_application_app_id(authentication_condition_application_app_id)
                                    ...
                                    return MicrosoftGraphBeta::Identity::AuthenticationEventsFlows::Item::Conditions::Applications::IncludeApplications::Item::AuthenticationConditionApplicationAppItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}/conditions/applications/includeApplications{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                                end
                                ## 
