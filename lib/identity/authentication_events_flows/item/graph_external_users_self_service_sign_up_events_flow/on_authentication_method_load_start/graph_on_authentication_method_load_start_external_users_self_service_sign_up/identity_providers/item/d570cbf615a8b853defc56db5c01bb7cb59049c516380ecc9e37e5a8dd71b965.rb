                            ...
                            module IdentityProviders
                                module Item
                                    ...
                                    class IdentityProviderBaseItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def ref()
                                            return MicrosoftGraphBeta::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::OnAuthenticationMethodLoadStart::GraphOnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp::IdentityProviders::Item::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
