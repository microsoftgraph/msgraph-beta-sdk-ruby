                        ...
                        module Applications
                            ...
                            class ApplicationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def include_applications()
                                    return MicrosoftGraphBeta::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::Conditions::Applications::IncludeApplications::IncludeApplicationsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
