                    ...
                    module OnAttributeCollection
                        ...
                        class OnAttributeCollectionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def graph_on_attribute_collection_external_users_self_service_sign_up()
                                return MicrosoftGraphBeta::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::OnAttributeCollection::GraphOnAttributeCollectionExternalUsersSelfServiceSignUp::GraphOnAttributeCollectionExternalUsersSelfServiceSignUpRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}/graph.externalUsersSelfServiceSignUpEventsFlow/onAttributeCollection{?%24select,%24expand}")
                            end
                            ## 
                            ...
                            def get(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::OnAttributeCollectionHandler.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## The configuration for what to invoke when attributes are ready to be collected from the user.
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
