                            ...
                            module Attributes
                                module Item
                                    ...
                                    class IdentityUserFlowAttributeItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def ref()
                                            return MicrosoftGraphBeta::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::OnAttributeCollection::GraphOnAttributeCollectionExternalUsersSelfServiceSignUp::Attributes::Item::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
