...
require_relative './product_changes/product_changes_request_builder'
...
module MicrosoftGraphBeta
    module Identity
        ...
        class IdentityRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def product_changes()
                return MicrosoftGraphBeta::Identity::ProductChanges::ProductChangesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
