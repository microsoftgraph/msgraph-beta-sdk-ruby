...
require_relative './find_by_method_mode_with_authentication_method_modes/find_by_method_mode_with_authentication_method_modes_request_builder'
            ...
            module AuthenticationStrengths
                module Policies
                    ...
                    class PoliciesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the policies property of the microsoft.graph.authenticationStrengthRoot entity.
                        ...
                        def by_authentication_strength_policy_id(authentication_strength_policy_id)
                            ...
                            return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Item::AuthenticationStrengthPolicyItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/identity/conditionalAccess/authenticationStrengths/policies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        ## 
                        def find_by_method_mode_with_authentication_method_modes(authentication_method_modes)
                            raise StandardError, 'authentication_method_modes cannot be null' if authentication_method_modes.nil?
                            return FindByMethodModeWithAuthenticationMethodModesRequestBuilder.new(@path_parameters, @request_adapter, authenticationMethodModes)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationStrengthPolicyCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/identity/conditionalAccess/authenticationStrengths/policies'
                            request_info.path_parameters = @path_parameters
