...
require_relative './microsoft_graph_update_allowed_combinations'

module MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Item::MicrosoftGraphUpdateAllowedCombinations
    ## 
    ...
    class UpdateAllowedCombinationsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/conditionalAccess/authenticationStrengths/policies/{authenticationStrengthPolicy%2Did}/microsoft.graph.updateAllowedCombinations"
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UpdateAllowedCombinationsResult.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the allowedCombinations property of an authenticationStrengthPolicy object. To update other properties of an authenticationStrengthPolicy object, use the Update authenticationStrengthPolicy method.
        ## @param body The request body
