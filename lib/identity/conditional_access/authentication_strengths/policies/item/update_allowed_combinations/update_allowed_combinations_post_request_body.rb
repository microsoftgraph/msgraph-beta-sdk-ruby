                        ...
                        module UpdateAllowedCombinations
                            class UpdateAllowedCombinationsPostRequestBody
                                ...
                                def get_field_deserializers()
                                    return {
                                        "allowedCombinations" => lambda {|n| @allowed_combinations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Item::UpdateAllowedCombinations::UpdateAllowedCombinationsPostRequestBodyAllowedCombinations.create_from_discriminator_value(pn) }) },
                                    }
                                end
                                ## 
