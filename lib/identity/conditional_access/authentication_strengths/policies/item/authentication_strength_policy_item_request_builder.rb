...
module MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Item
    ## 
    ...
    class AuthenticationStrengthPolicyItemRequestBuilder
        ...
        def microsoft_graph_update_allowed_combinations()
            return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Item::MicrosoftGraphUpdateAllowedCombinations::MicrosoftGraphUpdateAllowedCombinationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the usage method.
        def microsoft_graph_usage()
            return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Item::MicrosoftGraphUsage::MicrosoftGraphUsageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/conditionalAccess/authenticationStrengths/policies/{authenticationStrengthPolicy%2Did}{?%24select,%24expand}"
