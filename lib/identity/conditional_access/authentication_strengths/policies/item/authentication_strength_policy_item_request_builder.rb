...
module MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Item
    ...
    class AuthenticationStrengthPolicyItemRequestBuilder
        ...
        def microsoft_graph_update_allowed_combinations()
            return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Item::MicrosoftGraphUpdateAllowedCombinations::UpdateAllowedCombinationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the usage method.
        def microsoft_graph_usage()
            return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Item::MicrosoftGraphUsage::UsageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
