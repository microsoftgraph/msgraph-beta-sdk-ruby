        ...
        module ConditionalAccess
            module Templates
                ...
                class TemplatesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Identity::ConditionalAccess::Templates::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the templates property of the microsoft.graph.conditionalAccessRoot entity.
                    ...
                    def by_conditional_access_template_id(conditional_access_template_id)
                        ...
                        return MicrosoftGraphBeta::Identity::ConditionalAccess::Templates::Item::ConditionalAccessTemplateItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessTemplateCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Get a list of the conditionalAccessTemplate objects and their properties. This API is available in the following national cloud deployments.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
