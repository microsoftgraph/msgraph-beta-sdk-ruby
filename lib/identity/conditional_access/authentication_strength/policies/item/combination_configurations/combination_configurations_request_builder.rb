...
module MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrength::Policies::Item::CombinationConfigurations
    ## 
    ...
    class CombinationConfigurationsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrength::Policies::Item::CombinationConfigurations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy%2Did}/combinationConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
