...
module MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrength::Policies::Item::MicrosoftGraphUsage
    ## 
    ...
    class UsageRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy%2Did}/microsoft.graph.usage()"
