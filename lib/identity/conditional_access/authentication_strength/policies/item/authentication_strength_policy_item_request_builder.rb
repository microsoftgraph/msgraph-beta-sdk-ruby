                    ...
                    module Item
                        ...
                        class AuthenticationStrengthPolicyItemRequestBuilder
                            ...
                            def update_allowed_combinations()
                                return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrength::Policies::Item::UpdateAllowedCombinations::UpdateAllowedCombinationsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def usage()
                                return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrength::Policies::Item::Usage::UsageRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the combinationConfigurations property of the microsoft.graph.authenticationStrengthPolicy entity.
