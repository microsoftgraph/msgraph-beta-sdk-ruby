...
module MicrosoftGraphBeta::Identity::B2cUserFlows::Item::UserFlowIdentityProviders::Item
    ## 
    ...
    class IdentityProviderBaseItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, identity_provider_base_id=nil)
            ...
            @url_template = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userFlowIdentityProviders/{identityProviderBase%2Did}{?%24select,%24expand}"
