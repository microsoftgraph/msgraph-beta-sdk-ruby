            ...
            module Item
                ...
                class B2cIdentityUserFlowItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return B2cIdentityUserFlowItemRequestBuilder.new(raw_url, @request_adapter)
                    end
