...
module MicrosoftGraphBeta::Identity::B2cUserFlows::Item::Languages::Item
    ## 
    ...
    class UserFlowLanguageConfigurationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}{?%24select,%24expand}"
