...
module MicrosoftGraphBeta::Identity::B2cUserFlows::Item::UserAttributeAssignments::Item
    ## 
    ...
    class IdentityUserFlowAttributeAssignmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, identity_user_flow_attribute_assignment_id=nil)
            ...
            @url_template = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/{identityUserFlowAttributeAssignment%2Did}{?%24select,%24expand}"
