            ...
            module Item
                module UserAttributeAssignments
                    ...
                    class UserAttributeAssignmentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Identity::B2cUserFlows::Item::UserAttributeAssignments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getOrder method.
                        def get_order()
                            return MicrosoftGraphBeta::Identity::B2cUserFlows::Item::UserAttributeAssignments::GetOrder::GetOrderRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the setOrder method.
                        def set_order()
                            return MicrosoftGraphBeta::Identity::B2cUserFlows::Item::UserAttributeAssignments::SetOrder::SetOrderRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the userAttributeAssignments property of the microsoft.graph.b2cIdentityUserFlow entity.
                        ...
                        def by_identity_user_flow_attribute_assignment_id(identity_user_flow_attribute_assignment_id)
                            ...
                            return MicrosoftGraphBeta::Identity::B2cUserFlows::Item::UserAttributeAssignments::Item::IdentityUserFlowAttributeAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IdentityUserFlowAttributeAssignmentCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IdentityUserFlowAttributeAssignment.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Get the identityUserFlowAttributeAssignment resources from the userAttributeAssignments navigation property in a b2cIdentityUserFlow.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments'
                            request_info.path_parameters = @path_parameters
