...
module MicrosoftGraphBeta::Subscriptions::Item
    ## 
    ...
    class SubscriptionItemRequestBuilder
        ...
        def microsoft_graph_reauthorize()
            return MicrosoftGraphBeta::Subscriptions::Item::MicrosoftGraphReauthorize::MicrosoftGraphReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
