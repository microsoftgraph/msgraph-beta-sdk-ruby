        ...
        module SignIns
            ...
            class SignInsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def confirm_compromised()
                    return MicrosoftGraphBeta::AuditLogs::SignIns::ConfirmCompromised::ConfirmCompromisedRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the confirmSafe method.
                def confirm_safe()
                    return MicrosoftGraphBeta::AuditLogs::SignIns::ConfirmSafe::ConfirmSafeRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
