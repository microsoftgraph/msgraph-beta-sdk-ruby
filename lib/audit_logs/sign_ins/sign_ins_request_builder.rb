...
require_relative './microsoft_graph_confirm_safe/microsoft_graph_confirm_safe_request_builder'
require_relative './sign_ins'

module MicrosoftGraphBeta::AuditLogs::SignIns
    ## 
    ...
    class SignInsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::AuditLogs::SignIns::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the confirmCompromised method.
        def microsoft_graph_confirm_compromised()
            return MicrosoftGraphBeta::AuditLogs::SignIns::MicrosoftGraphConfirmCompromised::MicrosoftGraphConfirmCompromisedRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the confirmSafe method.
        def microsoft_graph_confirm_safe()
            return MicrosoftGraphBeta::AuditLogs::SignIns::MicrosoftGraphConfirmSafe::MicrosoftGraphConfirmSafeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SignInCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
