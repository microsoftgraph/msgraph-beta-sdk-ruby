...
require_relative './microsoft_graph_confirm_safe/confirm_safe_request_builder'
...
module MicrosoftGraphBeta::AuditLogs::SignIns
    ...
    class SignInsRequestBuilder
        ...
        def microsoft_graph_confirm_compromised()
            return MicrosoftGraphBeta::AuditLogs::SignIns::MicrosoftGraphConfirmCompromised::ConfirmCompromisedRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the confirmSafe method.
        def microsoft_graph_confirm_safe()
            return MicrosoftGraphBeta::AuditLogs::SignIns::MicrosoftGraphConfirmSafe::ConfirmSafeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
