...
require_relative './directory_provisioning/item/provisioning_object_summary_item_request_builder'
...
module MicrosoftGraphBeta::AuditLogs
    ## 
    ...
    class AuditLogsRequestBuilder
        ...
        def directory_audits_by_id(id)
            ...
            return MicrosoftGraphBeta::AuditLogs::DirectoryAudits::Item::DirectoryAuditItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the directoryProvisioning property of the microsoft.graph.auditLogRoot entity.
        ## @param id Unique identifier of the item
        ...
        ## 
        def directory_provisioning_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
        ...
        def provisioning_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["provisioningObjectSummary%2Did"] = id
            return MicrosoftGraphBeta::AuditLogs::Provisioning::Item::ProvisioningObjectSummaryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the signIns property of the microsoft.graph.auditLogRoot entity.
        ## @param id Unique identifier of the item
        ...
        def sign_ins_by_id(id)
            ...
            return MicrosoftGraphBeta::AuditLogs::SignIns::Item::SignInItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get auditLogs
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
