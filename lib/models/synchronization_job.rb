...
module MicrosoftGraphBeta
    module Models
        class SynchronizationJob < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the bulk_upload property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "bulkUpload" => lambda {|n| @bulk_upload = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::BulkUpload.create_from_discriminator_value(pn) }) },
                    "schedule" => lambda {|n| @schedule = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationSchedule.create_from_discriminator_value(pn) }) },
                    "schema" => lambda {|n| @schema = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationSchema.create_from_discriminator_value(pn) }) },
                    "status" => lambda {|n| @status = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationStatus.create_from_discriminator_value(pn) }) },
                    "synchronizationJobSettings" => lambda {|n| @synchronization_job_settings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::KeyValuePair.create_from_discriminator_value(pn) }) },
