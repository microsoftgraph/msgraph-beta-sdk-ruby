...
module MicrosoftGraphBeta
    module Models
        class AuthenticationFailure < MicrosoftGraphBeta::Models::Entity
            ...
            @reason_code
            ## 
            ## Instantiates a new AuthenticationFailure and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return AuthenticationFailure.new
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "reasonCode" => lambda {|n| @reason_code = n.get_enum_value(MicrosoftGraphBeta::Models::AuthenticationFailureReasonCode) },
                })
            end
            ## 
            ...
            ## @return a authentication_failure_reason_code
            ## 
            def reason_code
                return @reason_code
            end
