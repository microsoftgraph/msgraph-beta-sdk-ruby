...
module MicrosoftGraphBeta
    module Models
        ...
        class ExcludedApps
            ...
            ## @param value Value to set for the info_path property.
            ## @return a void
            ## 
            def info_path=(value)
                @info_path = value
            ...
            ## @param value Value to set for the one_note property.
            ## @return a void
            ## 
            def one_note=(value)
                @one_note = value
            ...
            ## @param value Value to set for the power_point property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the share_point_designer property.
            ## @return a void
            ## 
