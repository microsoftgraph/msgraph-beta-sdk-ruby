...
module MicrosoftGraphBeta
    module Models
        class WorkbookChartSeries < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "format" => lambda {|n| @format = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartSeriesFormat.create_from_discriminator_value(pn) }) },
                    "name" => lambda {|n| @name = n.get_string_value() },
                    "points" => lambda {|n| @points = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartPoint.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
