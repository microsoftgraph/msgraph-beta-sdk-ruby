...
module MicrosoftGraphBeta
    module Models
        class SecurityFilePlanAppliedCategory < MicrosoftGraphBeta::Models::SecurityFilePlanDescriptorBase
            ...
            def get_field_deserializers()
                return super.merge({
                    "subcategory" => lambda {|n| @subcategory = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityFilePlanSubcategory.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
