...
module MicrosoftGraphBeta
    module Models
        ...
        class WindowsInformationProtectionPolicy < MicrosoftGraphBeta::Models::WindowsInformationProtection
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "pinLowercaseLetters" => lambda {|n| @pin_lowercase_letters = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsInformationProtectionPinCharacterRequirements) },
                    "pinMinimumLength" => lambda {|n| @pin_minimum_length = n.get_number_value() },
                    "pinSpecialCharacters" => lambda {|n| @pin_special_characters = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsInformationProtectionPinCharacterRequirements) },
                    "pinUppercaseLetters" => lambda {|n| @pin_uppercase_letters = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsInformationProtectionPinCharacterRequirements) },
