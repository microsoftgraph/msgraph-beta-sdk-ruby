...
module MicrosoftGraphBeta
    module Models
        class BackupRestoreRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "driveInclusionRules" => lambda {|n| @drive_inclusion_rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveProtectionRule.create_from_discriminator_value(pn) }) },
                    "driveProtectionUnits" => lambda {|n| @drive_protection_units = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveProtectionUnit.create_from_discriminator_value(pn) }) },
                    "driveProtectionUnitsBulkAdditionJobs" => lambda {|n| @drive_protection_units_bulk_addition_jobs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveProtectionUnitsBulkAdditionJob.create_from_discriminator_value(pn) }) },
                    "exchangeProtectionPolicies" => lambda {|n| @exchange_protection_policies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExchangeProtectionPolicy.create_from_discriminator_value(pn) }) },
                    "exchangeRestoreSessions" => lambda {|n| @exchange_restore_sessions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExchangeRestoreSession.create_from_discriminator_value(pn) }) },
                    "mailboxInclusionRules" => lambda {|n| @mailbox_inclusion_rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MailboxProtectionRule.create_from_discriminator_value(pn) }) },
                    "mailboxProtectionUnits" => lambda {|n| @mailbox_protection_units = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MailboxProtectionUnit.create_from_discriminator_value(pn) }) },
                    "mailboxProtectionUnitsBulkAdditionJobs" => lambda {|n| @mailbox_protection_units_bulk_addition_jobs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MailboxProtectionUnitsBulkAdditionJob.create_from_discriminator_value(pn) }) },
                    "oneDriveForBusinessProtectionPolicies" => lambda {|n| @one_drive_for_business_protection_policies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OneDriveForBusinessProtectionPolicy.create_from_discriminator_value(pn) }) },
                    "oneDriveForBusinessRestoreSessions" => lambda {|n| @one_drive_for_business_restore_sessions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OneDriveForBusinessRestoreSession.create_from_discriminator_value(pn) }) },
                    "protectionPolicies" => lambda {|n| @protection_policies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ProtectionPolicyBase.create_from_discriminator_value(pn) }) },
                    "protectionUnits" => lambda {|n| @protection_units = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ProtectionUnitBase.create_from_discriminator_value(pn) }) },
                    "restorePoints" => lambda {|n| @restore_points = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RestorePoint.create_from_discriminator_value(pn) }) },
                    "restoreSessions" => lambda {|n| @restore_sessions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RestoreSessionBase.create_from_discriminator_value(pn) }) },
                    "serviceApps" => lambda {|n| @service_apps = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ServiceApp.create_from_discriminator_value(pn) }) },
                    "serviceStatus" => lambda {|n| @service_status = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ServiceStatus.create_from_discriminator_value(pn) }) },
                    "sharePointProtectionPolicies" => lambda {|n| @share_point_protection_policies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SharePointProtectionPolicy.create_from_discriminator_value(pn) }) },
                    "sharePointRestoreSessions" => lambda {|n| @share_point_restore_sessions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SharePointRestoreSession.create_from_discriminator_value(pn) }) },
                    "siteInclusionRules" => lambda {|n| @site_inclusion_rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SiteProtectionRule.create_from_discriminator_value(pn) }) },
                    "siteProtectionUnits" => lambda {|n| @site_protection_units = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SiteProtectionUnit.create_from_discriminator_value(pn) }) },
                    "siteProtectionUnitsBulkAdditionJobs" => lambda {|n| @site_protection_units_bulk_addition_jobs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SiteProtectionUnitsBulkAdditionJob.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
