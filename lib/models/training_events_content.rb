    ...
    module Models
        class TrainingEventsContent
            ...
            def get_field_deserializers()
                return {
                    "assignedTrainingsInfos" => lambda {|n| @assigned_trainings_infos = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AssignedTrainingInfo.create_from_discriminator_value(pn) }) },
