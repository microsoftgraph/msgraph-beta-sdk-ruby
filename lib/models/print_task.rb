...
module MicrosoftGraphBeta
    module Models
        class PrintTask < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "status" => lambda {|n| @status = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PrintTaskStatus.create_from_discriminator_value(pn) }) },
                    "trigger" => lambda {|n| @trigger = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PrintTaskTrigger.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
