...
module MicrosoftGraphBeta
    module Models
        class SecurityContainerEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "image" => lambda {|n| @image = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityContainerImageEvidence.create_from_discriminator_value(pn) }) },
                    "isPrivileged" => lambda {|n| @is_privileged = n.get_boolean_value() },
                    "name" => lambda {|n| @name = n.get_string_value() },
                    "pod" => lambda {|n| @pod = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityKubernetesPodEvidence.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
