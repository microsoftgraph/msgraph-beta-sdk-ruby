...
module MicrosoftGraphBeta
    module Models
        class Event < MicrosoftGraphBeta::Models::OutlookItem
            ...
            ## @param value Value to set for the cancelled_occurrences property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the exception_occurrences property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "attendees" => lambda {|n| @attendees = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Attendee.create_from_discriminator_value(pn) }) },
                    ...
                    "exceptionOccurrences" => lambda {|n| @exception_occurrences = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Event.create_from_discriminator_value(pn) }) },
                    ...
                    "uid" => lambda {|n| @uid = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_string_value("occurrenceId", @occurrence_id)
                ...
                writer.write_string_value("uid", @uid)
