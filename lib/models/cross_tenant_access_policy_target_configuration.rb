    ...
    module Models
        class CrossTenantAccessPolicyTargetConfiguration
            ...
            def get_field_deserializers()
                return {
                    "accessType" => lambda {|n| @access_type = n.get_enum_value(MicrosoftGraphBeta::Models::CrossTenantAccessPolicyTargetConfigurationAccessType) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "targets" => lambda {|n| @targets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CrossTenantAccessPolicyTarget.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
