...
module MicrosoftGraphBeta
    module Models
        class UnifiedRbacResourceAction < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the authentication_context property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "authenticationContext" => lambda {|n| @authentication_context = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationContextClassReference.create_from_discriminator_value(pn) }) },
            ...
            ## @param value Value to set for the is_privileged property.
            ## @return a void
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("authenticationContext", @authentication_context)
