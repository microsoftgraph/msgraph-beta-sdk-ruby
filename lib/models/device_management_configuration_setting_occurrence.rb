...
module MicrosoftGraphBeta::Models
    class DeviceManagementConfigurationSettingOccurrence
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            return DeviceManagementConfigurationSettingOccurrence.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                "maxDeviceOccurrence" => lambda {|n| @max_device_occurrence = n.get_number_value() },
                "minDeviceOccurrence" => lambda {|n| @min_device_occurrence = n.get_number_value() },
        ...
        ## @return a integer
        ## 
        def max_device_occurrence
            return @max_device_occurrence
        end
        ## 
        ## Sets the maxDeviceOccurrence property value. Maximum times setting can be set on device.
        ## @param value Value to set for the max_device_occurrence property.
        ## @return a void
        ## 
        def max_device_occurrence=(value)
            @max_device_occurrence = value
        end
        ## 
        ...
        ## @return a integer
        ## 
        def min_device_occurrence
            return @min_device_occurrence
        end
        ## 
        ...
        ## @param value Value to set for the min_device_occurrence property.
        ## @return a void
        ## 
        def min_device_occurrence=(value)
            @min_device_occurrence = value
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_number_value("maxDeviceOccurrence", @max_device_occurrence)
            writer.write_number_value("minDeviceOccurrence", @min_device_occurrence)
