    ...
    module Models
        module IndustryData
            class ReferenceDefinition < MicrosoftGraphBeta::Models::Entity
                ...
                ## @param value Value to set for the is_disabled property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the reference_type property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the sort_index property.
                ## @return a void
                ## 
