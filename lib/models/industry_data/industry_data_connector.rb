...
module MicrosoftGraphBeta
    module Models
        module IndustryData
            class IndustryDataConnector < MicrosoftGraphBeta::Models::Entity
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return IndustryDataConnector.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "sourceSystem" => lambda {|n| @source_system = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryData::SourceSystemDefinition.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
