...
module MicrosoftGraphBeta
    module Models
        module IndustryData
            class IndustryDataRun < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "activities" => lambda {|n| @activities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IndustryData::IndustryDataRunActivity.create_from_discriminator_value(pn) }) },
