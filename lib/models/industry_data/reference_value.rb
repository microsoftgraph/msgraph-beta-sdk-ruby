            ...
            class ReferenceValue
                    ...
                    unless mapping_value_node.nil? then
                        ...
                        case mapping_value
                            ...
                            when "#microsoft.graph.industryData.userMatchTargetReferenceValue"
                                return UserMatchTargetReferenceValue.new
                            when "#microsoft.graph.industryData.yearReferenceValue"
                                return YearReferenceValue.new
                        end
                    end
                    return ReferenceValue.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "value" => lambda {|n| @value = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryData::ReferenceDefinition.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
