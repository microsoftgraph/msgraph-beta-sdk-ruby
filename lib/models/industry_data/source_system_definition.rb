...
module MicrosoftGraphBeta
    module Models
        module IndustryData
            class SourceSystemDefinition < MicrosoftGraphBeta::Models::Entity
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return SourceSystemDefinition.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "userMatchingSettings" => lambda {|n| @user_matching_settings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IndustryData::UserMatchingSetting.create_from_discriminator_value(pn) }) },
                ...
                ## @param value Value to set for the user_matching_settings property.
                ## @return a void
                ## 
