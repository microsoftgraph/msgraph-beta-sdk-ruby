...
module MicrosoftGraphBeta
    module Models
        class CloudPcBulkRemoteActionResult
            ...
            ## @return a cloud_pc_bulk_remote_action_result
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return CloudPcBulkRemoteActionResult.new
            end
            ## 
            ...
            ## @param value Value to set for the failed_device_ids property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the not_found_device_ids property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the not_supported_device_ids property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the successful_device_ids property.
            ## @return a void
            ## 
