...
module MicrosoftGraphBeta
    module Models
        class ServiceProvisioningResourceErrorDetail
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.serviceProvisioningLinkedResourceErrorDetail"
                            return ServiceProvisioningLinkedResourceErrorDetail.new
                    end
                end
                return ServiceProvisioningResourceErrorDetail.new
            end
            ## 
