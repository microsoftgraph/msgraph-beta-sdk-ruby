...
module MicrosoftGraphBeta
    module Models
        class ProtectionUnitBase < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "protectionSources" => lambda {|n| @protection_sources = n.get_enum_values(MicrosoftGraphBeta::Models::ProtectionSource) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ProtectionUnitStatus) },
                })
            end
            ## 
            ...
            ## @return a protection_source
            ## 
            def protection_sources
            ...
            ## @return a void
            ## 
            def protection_sources=(value)
                @protection_sources = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("protectionSources", @protection_sources)
