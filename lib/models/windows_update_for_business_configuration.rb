...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdateForBusinessConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
            ...
            ## 
            def device_update_states
                return @device_update_states
            end
            ## 
            ...
            ## @param value Value to set for the device_update_states property.
            ## @return a void
            ## 
            def device_update_states=(value)
                @device_update_states = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "autoRestartNotificationDismissal" => lambda {|n| @auto_restart_notification_dismissal = n.get_enum_value(MicrosoftGraphBeta::Models::AutoRestartNotificationDismissalMethod) },
                    "automaticUpdateMode" => lambda {|n| @automatic_update_mode = n.get_enum_value(MicrosoftGraphBeta::Models::AutomaticUpdateMode) },
                    "businessReadyUpdatesOnly" => lambda {|n| @business_ready_updates_only = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUpdateType) },
                    ...
                    "deviceUpdateStates" => lambda {|n| @device_update_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdateState.create_from_discriminator_value(pn) }) },
                    ...
                    "installationSchedule" => lambda {|n| @installation_schedule = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdateInstallScheduleType.create_from_discriminator_value(pn) }) },
                    ...
                    "prereleaseFeatures" => lambda {|n| @prerelease_features = n.get_enum_value(MicrosoftGraphBeta::Models::PrereleaseFeatures) },
                    ...
                    "updateNotificationLevel" => lambda {|n| @update_notification_level = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUpdateNotificationDisplayOption) },
                    "updateWeeks" => lambda {|n| @update_weeks = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUpdateForBusinessUpdateWeeks) },
                    "userPauseAccess" => lambda {|n| @user_pause_access = n.get_enum_value(MicrosoftGraphBeta::Models::Enablement) },
                    "userWindowsUpdateScanAccess" => lambda {|n| @user_windows_update_scan_access = n.get_enum_value(MicrosoftGraphBeta::Models::Enablement) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("deviceUpdateStates", @device_update_states)
