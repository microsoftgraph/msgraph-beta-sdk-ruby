...
module MicrosoftGraphBeta::Models
    class PasswordSingleSignOnField
        ...
        ## @param value Value to set for the customized_label property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the default_label property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the field_id property.
        ## @return a void
        ## 
        def field_id=(value)
            @field_id = value
