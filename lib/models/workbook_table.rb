...
module MicrosoftGraphBeta
    module Models
        class WorkbookTable < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "columns" => lambda {|n| @columns = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookTableColumn.create_from_discriminator_value(pn) }) },
                    ...
                    "rows" => lambda {|n| @rows = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookTableRow.create_from_discriminator_value(pn) }) },
                    ...
                    "sort" => lambda {|n| @sort = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookTableSort.create_from_discriminator_value(pn) }) },
