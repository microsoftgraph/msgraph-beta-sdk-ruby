...
module MicrosoftGraphBeta
    module Models
        class SecurityTenantAllowOrBlockListAction
            ...
            ## 
            ## Instantiates a new securityTenantAllowOrBlockListAction and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return SecurityTenantAllowOrBlockListAction.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "results" => lambda {|n| @results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityTenantAllowBlockListEntryResult.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
