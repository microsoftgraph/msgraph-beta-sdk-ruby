...
module MicrosoftGraphBeta
    module Models
        class EdiscoveryReviewSet < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "queries" => lambda {|n| @queries = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryReviewSetQuery.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
