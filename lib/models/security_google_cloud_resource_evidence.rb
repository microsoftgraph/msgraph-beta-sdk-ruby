...
module MicrosoftGraphBeta
    module Models
        class SecurityGoogleCloudResourceEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "locationType" => lambda {|n| @location_type = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityGoogleCloudResourceEvidenceLocationType) },
