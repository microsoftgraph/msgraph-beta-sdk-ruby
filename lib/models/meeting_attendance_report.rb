...
module MicrosoftGraphBeta
    module Models
        class MeetingAttendanceReport < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "attendanceRecords" => lambda {|n| @attendance_records = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AttendanceRecord.create_from_discriminator_value(pn) }) },
                    "externalEventInformation" => lambda {|n| @external_event_information = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::VirtualEventExternalInformation.create_from_discriminator_value(pn) }) },
