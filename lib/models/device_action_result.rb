        ...
        class DeviceActionResult
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.activateDeviceEsimActionResult"
                            return ActivateDeviceEsimActionResult.new
                        when "#microsoft.graph.changeAssignmentsActionResult"
                            return ChangeAssignmentsActionResult.new
                        when "#microsoft.graph.configurationManagerActionResult"
                        ...
                        when "#microsoft.graph.revokeAppleVppLicensesActionResult"
