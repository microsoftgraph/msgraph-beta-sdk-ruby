...
module MicrosoftGraphBeta::Models
    class OnPremisesDirectorySynchronization < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "configuration" => lambda {|n| @configuration = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnPremisesDirectorySynchronizationConfiguration.create_from_discriminator_value(pn) }) },
                "features" => lambda {|n| @features = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnPremisesDirectorySynchronizationFeature.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
