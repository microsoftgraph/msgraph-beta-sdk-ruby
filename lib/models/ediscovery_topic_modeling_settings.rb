...
module MicrosoftGraphBeta
    module Models
        class EdiscoveryTopicModelingSettings
            ...
            ## 
            ## Instantiates a new EdiscoveryTopicModelingSettings and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return EdiscoveryTopicModelingSettings.new
            end
            ## 
