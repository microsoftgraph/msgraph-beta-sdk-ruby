        ...
        class RestorePointSearchResponse
            ...
            def get_field_deserializers()
                return {
                    ...
                    "searchResults" => lambda {|n| @search_results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RestorePointSearchResult.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
