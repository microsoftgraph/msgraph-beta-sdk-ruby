...
module MicrosoftGraphBeta
    module Models
        class UnifiedRoleManagementPolicy < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "effectiveRules" => lambda {|n| @effective_rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleManagementPolicyRule.create_from_discriminator_value(pn) }) },
                    "isOrganizationDefault" => lambda {|n| @is_organization_default = n.get_boolean_value() },
                    "lastModifiedBy" => lambda {|n| @last_modified_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
                    "lastModifiedDateTime" => lambda {|n| @last_modified_date_time = n.get_date_time_value() },
                    "rules" => lambda {|n| @rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleManagementPolicyRule.create_from_discriminator_value(pn) }) },
