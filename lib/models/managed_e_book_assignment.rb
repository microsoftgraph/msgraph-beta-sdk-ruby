...
module MicrosoftGraphBeta
    module Models
        ...
        class ManagedEBookAssignment < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "installIntent" => lambda {|n| @install_intent = n.get_enum_value(MicrosoftGraphBeta::Models::InstallIntent) },
