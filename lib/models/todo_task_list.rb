...
module MicrosoftGraphBeta::Models
    class TodoTaskList < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "tasks" => lambda {|n| @tasks = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TodoTask.create_from_discriminator_value(pn) }) },
                "wellknownListName" => lambda {|n| @wellknown_list_name = n.get_enum_value(MicrosoftGraphBeta::Models::WellknownListName) },
            })
        end
        ## 
