...
module MicrosoftGraphBeta::Models
    class AuthenticationCombinationConfiguration < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "appliesToCombinations" => lambda {|n| @applies_to_combinations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationMethodModes.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
