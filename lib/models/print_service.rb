...
module MicrosoftGraphBeta
    module Models
        class PrintService < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "endpoints" => lambda {|n| @endpoints = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PrintServiceEndpoint.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
