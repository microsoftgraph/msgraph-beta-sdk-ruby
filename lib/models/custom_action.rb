...
module MicrosoftGraphBeta
    module Models
        class CustomAction < MicrosoftGraphBeta::Models::InformationProtectionAction
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "properties" => lambda {|n| @properties = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::KeyValuePair.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
