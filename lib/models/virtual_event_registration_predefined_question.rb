...
module MicrosoftGraphBeta
    module Models
        class VirtualEventRegistrationPredefinedQuestion < MicrosoftGraphBeta::Models::VirtualEventRegistrationQuestionBase
            ...
            def get_field_deserializers()
                return super.merge({
                    "label" => lambda {|n| @label = n.get_enum_value(MicrosoftGraphBeta::Models::VirtualEventRegistrationPredefinedQuestionLabel) },
                })
            end
            ## 
