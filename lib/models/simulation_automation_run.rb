...
module MicrosoftGraphBeta
    module Models
        class SimulationAutomationRun < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::SimulationAutomationRunStatus) },
                })
            end
            ## 
