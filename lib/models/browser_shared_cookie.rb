...
module MicrosoftGraphBeta::Models
    class BrowserSharedCookie < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "history" => lambda {|n| @history = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BrowserSharedCookieHistory.create_from_discriminator_value(pn) }) },
                ...
                "sourceEnvironment" => lambda {|n| @source_environment = n.get_enum_value(MicrosoftGraphBeta::Models::BrowserSharedCookieSourceEnvironment) },
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::BrowserSharedCookieStatus) },
            })
        end
        ## 
