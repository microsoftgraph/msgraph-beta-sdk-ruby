...
module MicrosoftGraphBeta
    module Models
        class SecurityDisableUserResponseAction < MicrosoftGraphBeta::Models::SecurityResponseAction
            ...
            ## @return a security_disable_user_response_action
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return SecurityDisableUserResponseAction.new
            end
            ## 
            ...
            ## @return a security_disable_user_entity_identifier
            ## 
            def identifier
                return @identifier
            end
