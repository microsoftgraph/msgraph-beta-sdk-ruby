...
module MicrosoftGraphBeta
    module Models
        class ParticipantJoiningNotification < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "call" => lambda {|n| @call = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Call.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
