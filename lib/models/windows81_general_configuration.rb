...
module MicrosoftGraphBeta
    module Models
        class Windows81GeneralConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
            ...
            @minimum_auto_install_classification
            ## 
            ...
            ## 
            # Possible values for automatic update classification.
            @updates_minimum_auto_install_classification
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "browserInternetSecurityLevel" => lambda {|n| @browser_internet_security_level = n.get_enum_value(MicrosoftGraphBeta::Models::InternetSiteSecurityLevel) },
                    "browserIntranetSecurityLevel" => lambda {|n| @browser_intranet_security_level = n.get_enum_value(MicrosoftGraphBeta::Models::SiteSecurityLevel) },
                    ...
                    "browserTrustedSitesSecurityLevel" => lambda {|n| @browser_trusted_sites_security_level = n.get_enum_value(MicrosoftGraphBeta::Models::SiteSecurityLevel) },
                    ...
                    "minimumAutoInstallClassification" => lambda {|n| @minimum_auto_install_classification = n.get_enum_value(MicrosoftGraphBeta::Models::UpdateClassification) },
                    ...
                    "updatesMinimumAutoInstallClassification" => lambda {|n| @updates_minimum_auto_install_classification = n.get_enum_value(MicrosoftGraphBeta::Models::UpdateClassification) },
                    "updatesRequireAutomaticUpdates" => lambda {|n| @updates_require_automatic_updates = n.get_boolean_value() },
                    "userAccountControlSettings" => lambda {|n| @user_account_control_settings = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUserAccountControlSettings) },
            ...
            ## @return a update_classification
            ## 
            def minimum_auto_install_classification
                return @minimum_auto_install_classification
            end
            ## 
            ## Sets the minimumAutoInstallClassification property value. Possible values for automatic update classification.
            ## @param value Value to set for the minimum_auto_install_classification property.
            ## @return a void
            ## 
            def minimum_auto_install_classification=(value)
                @minimum_auto_install_classification = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("minimumAutoInstallClassification", @minimum_auto_install_classification)
                ...
                writer.write_enum_value("updatesMinimumAutoInstallClassification", @updates_minimum_auto_install_classification)
            ...
            ## @return a update_classification
            ## 
            def updates_minimum_auto_install_classification
                return @updates_minimum_auto_install_classification
            end
            ## 
            ## Sets the updatesMinimumAutoInstallClassification property value. Possible values for automatic update classification.
            ## @param value Value to set for the updates_minimum_auto_install_classification property.
            ## @return a void
            ## 
            def updates_minimum_auto_install_classification=(value)
                @updates_minimum_auto_install_classification = value
            end
            ## 
