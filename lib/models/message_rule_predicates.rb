        ...
        class MessageRulePredicates
            ...
            def get_field_deserializers()
                return {
                    ...
                    "fromAddresses" => lambda {|n| @from_addresses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Recipient.create_from_discriminator_value(pn) }) },
                    ...
                    "importance" => lambda {|n| @importance = n.get_enum_value(MicrosoftGraphBeta::Models::MessageRulePredicatesImportance) },
                    ...
                    "messageActionFlag" => lambda {|n| @message_action_flag = n.get_enum_value(MicrosoftGraphBeta::Models::MessageRulePredicatesMessageActionFlag) },
                    ...
                    "sensitivity" => lambda {|n| @sensitivity = n.get_enum_value(MicrosoftGraphBeta::Models::MessageRulePredicatesSensitivity) },
                    "sentCcMe" => lambda {|n| @sent_cc_me = n.get_boolean_value() },
                    "sentOnlyToMe" => lambda {|n| @sent_only_to_me = n.get_boolean_value() },
                    "sentToAddresses" => lambda {|n| @sent_to_addresses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Recipient.create_from_discriminator_value(pn) }) },
                    ...
                    "withinSizeRange" => lambda {|n| @within_size_range = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SizeRange.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
