    ...
    class MobileAppAssignmentSettings
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    when "#microsoft.graph.androidManagedStoreAppAssignmentSettings"
                    ...
                    when "#microsoft.graph.macOsVppAppAssignmentSettings"
                    ...
                    when "#microsoft.graph.winGetAppAssignmentSettings"
