...
module MicrosoftGraphBeta
    module Models
        class RoleManagement
            ...
            ## @param value Value to set for the cloud_p_c property.
            ## @return a void
            ## 
            def cloud_p_c=(value)
                @cloud_p_c = value
            ...
            ## @param value Value to set for the device_management property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the enterprise_apps property.
            ## @return a void
            ## 
