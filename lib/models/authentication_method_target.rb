...
module MicrosoftGraphBeta
    module Models
        class AuthenticationMethodTarget < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "targetType" => lambda {|n| @target_type = n.get_enum_value(MicrosoftGraphBeta::Models::AuthenticationMethodTargetType) },
                })
            end
            ## 
