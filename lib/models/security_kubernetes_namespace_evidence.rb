...
module MicrosoftGraphBeta
    module Models
        class SecurityKubernetesNamespaceEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    "cluster" => lambda {|n| @cluster = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityKubernetesClusterEvidence.create_from_discriminator_value(pn) }) },
