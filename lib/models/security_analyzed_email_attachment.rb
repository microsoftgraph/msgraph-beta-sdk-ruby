...
module MicrosoftGraphBeta
    module Models
        class SecurityAnalyzedEmailAttachment
            ...
            @tenant_allow_block_list_detail_info
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "fileSize" => lambda {|n| @file_size = n.get_number_value() },
                    "fileType" => lambda {|n| @file_type = n.get_string_value() },
                    "malwareFamily" => lambda {|n| @malware_family = n.get_string_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "sha256" => lambda {|n| @sha256 = n.get_string_value() },
                    "tenantAllowBlockListDetailInfo" => lambda {|n| @tenant_allow_block_list_detail_info = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_number_value("fileSize", @file_size)
                writer.write_string_value("fileType", @file_type)
                writer.write_string_value("malwareFamily", @malware_family)
                writer.write_string_value("@odata.type", @odata_type)
                writer.write_string_value("sha256", @sha256)
                writer.write_string_value("tenantAllowBlockListDetailInfo", @tenant_allow_block_list_detail_info)
            ...
            ## @return a string
            ## 
            def tenant_allow_block_list_detail_info
                return @tenant_allow_block_list_detail_info
            end
            ## 
            ...
            ## @return a void
            ## 
            def tenant_allow_block_list_detail_info=(value)
                @tenant_allow_block_list_detail_info = value
            end
            ## 
