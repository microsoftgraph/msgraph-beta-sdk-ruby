        ...
        class SecurityRetentionLabel < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "dispositionReviewStages" => lambda {|n| @disposition_review_stages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityDispositionReviewStage.create_from_discriminator_value(pn) }) },
