        ...
        class IntegerRange
            ...
            def get_field_deserializers()
                return {
                    ...
                    "maximum" => lambda {|n| @maximum = n.get_object_value(lambda {|pn| Int64.create_from_discriminator_value(pn) }) },
                    "minimum" => lambda {|n| @minimum = n.get_object_value(lambda {|pn| Int64.create_from_discriminator_value(pn) }) },
