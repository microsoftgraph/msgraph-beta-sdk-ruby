...
module MicrosoftGraphBeta
    module Models
        class AuthenticationStrengthRoot < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the authentication_combinations property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "combinations" => lambda {|n| @combinations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationMethodModes.create_from_discriminator_value(pn) }) },
