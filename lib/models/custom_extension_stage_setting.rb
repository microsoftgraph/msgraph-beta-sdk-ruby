    ...
    module Models
        class CustomExtensionStageSetting < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "customExtension" => lambda {|n| @custom_extension = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CustomCalloutExtension.create_from_discriminator_value(pn) }) },
