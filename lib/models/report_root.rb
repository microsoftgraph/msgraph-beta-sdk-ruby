        ...
        class ReportRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "healthMonitoring" => lambda {|n| @health_monitoring = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::HealthMonitoringHealthMonitoringRoot.create_from_discriminator_value(pn) }) },
                    ...
                    "partners" => lambda {|n| @partners = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PartnersModelModelModelModelModelModelModelModel.create_from_discriminator_value(pn) }) },
            ...
            ## @return a void
            ## 
            def health_monitoring=(value)
                @health_monitoring = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("healthMonitoring", @health_monitoring)
