...
module MicrosoftGraphBeta
    module Models
        class ReportRoot < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the app_credential_sign_in_activities property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the service_principal_sign_in_activities property.
            ## @return a void
            ## 
