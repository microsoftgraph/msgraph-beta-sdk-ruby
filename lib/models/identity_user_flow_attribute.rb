...
module MicrosoftGraphBeta
    module Models
        class IdentityUserFlowAttribute < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "dataType" => lambda {|n| @data_type = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityUserFlowAttributeDataType) },
                    "description" => lambda {|n| @description = n.get_string_value() },
                    "displayName" => lambda {|n| @display_name = n.get_string_value() },
                    "userFlowAttributeType" => lambda {|n| @user_flow_attribute_type = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityUserFlowAttributeType) },
                })
            end
            ## 
