        ...
        class CallRecordsNetworkInfo
            ...
            def get_field_deserializers()
                return {
                    ...
                    "connectionType" => lambda {|n| @connection_type = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsNetworkConnectionType) },
                    ...
                    "networkTransportProtocol" => lambda {|n| @network_transport_protocol = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsNetworkTransportProtocol) },
                    ...
                    "traceRouteHops" => lambda {|n| @trace_route_hops = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsTraceRouteHop.create_from_discriminator_value(pn) }) },
                    "wifiBand" => lambda {|n| @wifi_band = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsWifiBand) },
                    ...
                    "wifiRadioType" => lambda {|n| @wifi_radio_type = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsWifiRadioType) },
