...
module MicrosoftGraphBeta
    module Models
        class UserSolutionRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "workingTimeSchedule" => lambda {|n| @working_time_schedule = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkingTimeSchedule.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
