...
module MicrosoftGraphBeta
    module Models
        class IndustryDataUserManagementOptions
            ...
            ## @return a industry_data_additional_user_attributes
            ## 
            ...
            ## 
            ## Instantiates a new IndustryDataUserManagementOptions and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return IndustryDataUserManagementOptions.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "additionalAttributes" => lambda {|n| @additional_attributes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataAdditionalUserAttributes.create_from_discriminator_value(pn) }) },
                    "additionalOptions" => lambda {|n| @additional_options = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataAdditionalUserOptions.create_from_discriminator_value(pn) }) },
