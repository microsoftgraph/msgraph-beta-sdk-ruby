...
module MicrosoftGraphBeta
    module Models
        ...
        class Win32LobAppRegistryRule < MicrosoftGraphBeta::Models::Win32LobAppRule
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "operationType" => lambda {|n| @operation_type = n.get_enum_value(MicrosoftGraphBeta::Models::Win32LobAppRegistryRuleOperationType) },
