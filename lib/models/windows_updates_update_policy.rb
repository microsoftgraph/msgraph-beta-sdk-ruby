...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdatesUpdatePolicy < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "audience" => lambda {|n| @audience = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesDeploymentAudience.create_from_discriminator_value(pn) }) },
                    "complianceChangeRules" => lambda {|n| @compliance_change_rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesComplianceChangeRule.create_from_discriminator_value(pn) }) },
                    "complianceChanges" => lambda {|n| @compliance_changes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesComplianceChange.create_from_discriminator_value(pn) }) },
