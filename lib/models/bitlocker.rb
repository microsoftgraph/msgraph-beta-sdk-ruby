...
module MicrosoftGraphBeta::Models
    class Bitlocker < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "recoveryKeys" => lambda {|n| @recovery_keys = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BitlockerRecoveryKey.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
