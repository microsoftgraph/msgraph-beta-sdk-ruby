...
module MicrosoftGraphBeta
    module Models
        class DeviceManagementConfigurationStringSettingValueDefinition < MicrosoftGraphBeta::Models::DeviceManagementConfigurationSettingValueDefinition
            ...
            ## @param value Value to set for the file_types property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the input_validation_schema property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the is_secret property.
            ## @return a void
            ## 
            def is_secret=(value)
                @is_secret = value
            ...
            ## @param value Value to set for the maximum_length property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the minimum_length property.
            ## @return a void
            ## 
