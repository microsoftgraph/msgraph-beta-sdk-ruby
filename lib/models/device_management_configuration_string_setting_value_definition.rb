...
module MicrosoftGraphBeta
    module Models
        ...
        class DeviceManagementConfigurationStringSettingValueDefinition < MicrosoftGraphBeta::Models::DeviceManagementConfigurationSettingValueDefinition
            ...
            ## @return a device_management_configuration_string_setting_value_definition_format
            ## 
            def format
                return @format
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "format" => lambda {|n| @format = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceManagementConfigurationStringSettingValueDefinitionFormat) },
