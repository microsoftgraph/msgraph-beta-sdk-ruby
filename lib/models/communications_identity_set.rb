...
module MicrosoftGraphBeta
    module Models
        class CommunicationsIdentitySet < MicrosoftGraphBeta::Models::IdentitySet
            ...
            ## @param value Value to set for the application_instance property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the asserted_identity property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the azure_communication_services_user property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "applicationInstance" => lambda {|n| @application_instance = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
                    "assertedIdentity" => lambda {|n| @asserted_identity = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
                    "azureCommunicationServicesUser" => lambda {|n| @azure_communication_services_user = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
                    "encrypted" => lambda {|n| @encrypted = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
                    "endpointType" => lambda {|n| @endpoint_type = n.get_enum_value(MicrosoftGraphBeta::Models::EndpointType) },
                    "guest" => lambda {|n| @guest = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
                    "onPremises" => lambda {|n| @on_premises = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
                    "phone" => lambda {|n| @phone = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## @param value Value to set for the on_premises property.
            ## @return a void
            ## 
