...
module MicrosoftGraphBeta
    module Models
        class WorkplaceSensorDeviceTelemetry
            ...
            ## @return a workplace_sensor_event_value
            ## 
            def event_value
                return @event_value
            end
            ...
            def get_field_deserializers()
                return {
                    ...
                    "eventValue" => lambda {|n| @event_value = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkplaceSensorEventValue.create_from_discriminator_value(pn) }) },
                    "intValue" => lambda {|n| @int_value = n.get_number_value() },
                    "locationHint" => lambda {|n| @location_hint = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("eventValue", @event_value)
                writer.write_number_value("intValue", @int_value)
                writer.write_string_value("locationHint", @location_hint)
