...
module MicrosoftGraphBeta
    module Models
        class MfaUserCountMetric < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a mfa_user_count_metric
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return MfaUserCountMetric.new
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "mfaType" => lambda {|n| @mfa_type = n.get_enum_value(MicrosoftGraphBeta::Models::MfaType) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("mfaType", @mfa_type)
            end
        end
    end
end
