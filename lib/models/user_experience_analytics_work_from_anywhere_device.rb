...
module MicrosoftGraphBeta
    module Models
        ...
        class UserExperienceAnalyticsWorkFromAnywhereDevice < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "upgradeEligibility" => lambda {|n| @upgrade_eligibility = n.get_enum_value(MicrosoftGraphBeta::Models::OperatingSystemUpgradeEligibility) },
