        ...
        class SearchBookmark < MicrosoftGraphBeta::Models::SearchSearchAnswer
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "keywords" => lambda {|n| @keywords = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SearchAnswerKeyword.create_from_discriminator_value(pn) }) },
                    ...
                    "state" => lambda {|n| @state = n.get_enum_value(MicrosoftGraphBeta::Models::SearchAnswerState) },
                    "targetedVariations" => lambda {|n| @targeted_variations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SearchAnswerVariant.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
