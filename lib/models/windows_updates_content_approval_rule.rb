...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdatesContentApprovalRule < MicrosoftGraphBeta::Models::WindowsUpdatesComplianceChangeRule
            ...
            ## @return a windows_updates_content_approval_rule
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "contentFilter" => lambda {|n| @content_filter = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesContentFilter.create_from_discriminator_value(pn) }) },
