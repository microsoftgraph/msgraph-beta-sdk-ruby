        ...
        class ApiApplication
            ...
            def get_field_deserializers()
                return {
                    ...
                    "oauth2PermissionScopes" => lambda {|n| @oauth2_permission_scopes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PermissionScope.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "preAuthorizedApplications" => lambda {|n| @pre_authorized_applications = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PreAuthorizedApplication.create_from_discriminator_value(pn) }) },
