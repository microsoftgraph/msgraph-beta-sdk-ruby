    ...
    module Models
        ...
        class Win32LobAppInstallExperience
            ...
            def get_field_deserializers()
                return {
                    "deviceRestartBehavior" => lambda {|n| @device_restart_behavior = n.get_enum_value(MicrosoftGraphBeta::Models::Win32LobAppRestartBehavior) },
                    "maxRunTimeInMinutes" => lambda {|n| @max_run_time_in_minutes = n.get_number_value() },
            ...
            ## @return a integer
            ## 
            def max_run_time_in_minutes
                return @max_run_time_in_minutes
            end
            ## 
            ...
            ## @return a void
            ## 
            def max_run_time_in_minutes=(value)
                @max_run_time_in_minutes = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_number_value("maxRunTimeInMinutes", @max_run_time_in_minutes)
