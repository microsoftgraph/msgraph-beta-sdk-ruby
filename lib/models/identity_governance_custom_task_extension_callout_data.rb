...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceCustomTaskExtensionCalloutData < MicrosoftGraphBeta::Models::CustomExtensionData
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "taskProcessingresult" => lambda {|n| @task_processingresult = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceTaskProcessingResult.create_from_discriminator_value(pn) }) },
                    "workflow" => lambda {|n| @workflow = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceWorkflow.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
