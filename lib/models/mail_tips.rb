    ...
    module Models
        class MailTips
            ...
            def get_field_deserializers()
                return {
                    "automaticReplies" => lambda {|n| @automatic_replies = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AutomaticRepliesMailTips.create_from_discriminator_value(pn) }) },
                    ...
                    "recipientScope" => lambda {|n| @recipient_scope = n.get_enum_value(MicrosoftGraphBeta::Models::MailTipsRecipientScope) },
