...
module MicrosoftGraphBeta::Models
    class WorkbookChart < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "axes" => lambda {|n| @axes = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartAxes.create_from_discriminator_value(pn) }) },
                "dataLabels" => lambda {|n| @data_labels = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartDataLabels.create_from_discriminator_value(pn) }) },
                "format" => lambda {|n| @format = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartAreaFormat.create_from_discriminator_value(pn) }) },
                ...
                "legend" => lambda {|n| @legend = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartLegend.create_from_discriminator_value(pn) }) },
                "name" => lambda {|n| @name = n.get_string_value() },
                "series" => lambda {|n| @series = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartSeries.create_from_discriminator_value(pn) }) },
                "title" => lambda {|n| @title = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartTitle.create_from_discriminator_value(pn) }) },
                ...
                "worksheet" => lambda {|n| @worksheet = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookWorksheet.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
