...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsTenantDetailedInformation < MicrosoftGraphBeta::Models::Entity
            ...
            ## 
            ## Instantiates a new managedTenantsTenantDetailedInformation and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
