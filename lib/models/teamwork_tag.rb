        ...
        class TeamworkTag < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "members" => lambda {|n| @members = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TeamworkTagMember.create_from_discriminator_value(pn) }) },
                    "tagType" => lambda {|n| @tag_type = n.get_enum_value(MicrosoftGraphBeta::Models::TeamworkTagTagType) },
