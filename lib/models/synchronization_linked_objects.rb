    ...
    module Models
        class SynchronizationLinkedObjects
            ...
            def get_field_deserializers()
                return {
                    "manager" => lambda {|n| @manager = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationJobSubject.create_from_discriminator_value(pn) }) },
                    "members" => lambda {|n| @members = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationJobSubject.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "owners" => lambda {|n| @owners = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationJobSubject.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
