...
module MicrosoftGraphBeta
    module Models
        class OnenotePage < MicrosoftGraphBeta::Models::OnenoteEntitySchemaObjectModel
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "links" => lambda {|n| @links = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PageLinks.create_from_discriminator_value(pn) }) },
                    ...
                    "parentSection" => lambda {|n| @parent_section = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnenoteSection.create_from_discriminator_value(pn) }) },
