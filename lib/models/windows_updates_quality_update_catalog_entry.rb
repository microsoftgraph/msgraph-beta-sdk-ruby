        ...
        class WindowsUpdatesQualityUpdateCatalogEntry < MicrosoftGraphBeta::Models::WindowsUpdatesSoftwareUpdateCatalogEntry
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "qualityUpdateCadence" => lambda {|n| @quality_update_cadence = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUpdatesQualityUpdateCatalogEntryQualityUpdateCadence) },
            ...
            ## @return a windows_updates_quality_update_catalog_entry_quality_update_cadence
            ## 
