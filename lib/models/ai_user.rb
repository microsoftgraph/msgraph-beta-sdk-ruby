...
module MicrosoftGraphBeta
    module Models
        class AiUser < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "interactionHistory" => lambda {|n| @interaction_history = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AiInteractionHistory.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
