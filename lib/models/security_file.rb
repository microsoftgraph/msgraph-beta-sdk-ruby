...
module MicrosoftGraphBeta
    module Models
        class SecurityFile < MicrosoftGraphBeta::Models::Entity
            ...
            @subject_title
            ## 
            ## Instantiates a new SecurityFile and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "extractedTextContent" => lambda {|n| @extracted_text_content = n.get_object_value(lambda {|pn| Base64url.create_from_discriminator_value(pn) }) },
                    "mediaType" => lambda {|n| @media_type = n.get_string_value() },
                    "name" => lambda {|n| @name = n.get_string_value() },
                    "otherProperties" => lambda {|n| @other_properties = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityStringValueDictionary.create_from_discriminator_value(pn) }) },
                    ...
                    "sourceType" => lambda {|n| @source_type = n.get_enum_values(MicrosoftGraphBeta::Models::SecuritySourceType) },
            ...
            ## @return a security_string_value_dictionary
            ## 
            ...
            ## @return a security_file_processing_status
            ## 
