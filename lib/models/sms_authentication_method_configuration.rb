...
module MicrosoftGraphBeta
    module Models
        class SmsAuthenticationMethodConfiguration < MicrosoftGraphBeta::Models::AuthenticationMethodConfiguration
            ...
            def get_field_deserializers()
                return super.merge({
                    "includeTargets" => lambda {|n| @include_targets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SmsAuthenticationMethodTarget.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
