        ...
        class AuthenticationAttributeCollectionPageViewConfiguration
            ...
            def get_field_deserializers()
                return {
                    ...
                    "inputs" => lambda {|n| @inputs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationAttributeCollectionInputConfiguration.create_from_discriminator_value(pn) }) },
