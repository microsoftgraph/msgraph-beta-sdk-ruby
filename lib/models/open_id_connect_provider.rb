...
module MicrosoftGraphBeta
    module Models
        class OpenIdConnectProvider < MicrosoftGraphBeta::Models::IdentityProvider
            ...
            ## @param value Value to set for the claims_mapping property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the domain_hint property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the metadata_url property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the response_mode property.
            ## @return a void
            ## 
