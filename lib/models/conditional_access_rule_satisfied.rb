...
module MicrosoftGraphBeta
    module Models
        class ConditionalAccessRuleSatisfied
            ...
            ## @return a conditional_access_rule_satisfied_conditional_access_condition
            ## 
            def conditional_access_condition
                return @conditional_access_condition
            end
            ## 
            ...
            ## @return a void
            ## 
            def conditional_access_condition=(value)
                @conditional_access_condition = value
            end
            ## 
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ConditionalAccessRuleSatisfied.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "conditionalAccessCondition" => lambda {|n| @conditional_access_condition = n.get_enum_value(MicrosoftGraphBeta::Models::ConditionalAccessRuleSatisfiedConditionalAccessCondition) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "ruleSatisfied" => lambda {|n| @rule_satisfied = n.get_enum_value(MicrosoftGraphBeta::Models::ConditionalAccessRuleSatisfiedRuleSatisfied) },
                }
            end
            ## 
            ...
            ## @return a conditional_access_rule_satisfied_rule_satisfied
            ## 
            def rule_satisfied
            ...
            ## @return a void
            ## 
            def rule_satisfied=(value)
                @rule_satisfied = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("conditionalAccessCondition", @conditional_access_condition)
                writer.write_string_value("@odata.type", @odata_type)
                writer.write_enum_value("ruleSatisfied", @rule_satisfied)
