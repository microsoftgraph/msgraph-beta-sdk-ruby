...
module MicrosoftGraphBeta
    module Models
        class VirtualEventRegistrationCustomQuestion < MicrosoftGraphBeta::Models::VirtualEventRegistrationQuestionBase
            ...
            ## @return a virtual_event_registration_custom_question_answer_input_type
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "answerInputType" => lambda {|n| @answer_input_type = n.get_enum_value(MicrosoftGraphBeta::Models::VirtualEventRegistrationCustomQuestionAnswerInputType) },
                })
            end
            ## 
