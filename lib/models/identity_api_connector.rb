...
module MicrosoftGraphBeta
    module Models
        class IdentityApiConnector < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "authenticationConfiguration" => lambda {|n| @authentication_configuration = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ApiAuthenticationConfigurationBase.create_from_discriminator_value(pn) }) },
