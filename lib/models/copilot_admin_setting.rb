...
module MicrosoftGraphBeta
    module Models
        class CopilotAdminSetting < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "limitedMode" => lambda {|n| @limited_mode = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CopilotAdminLimitedMode.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
