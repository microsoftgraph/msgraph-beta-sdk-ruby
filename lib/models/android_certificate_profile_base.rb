...
module MicrosoftGraphBeta::Models
    class AndroidCertificateProfileBase < MicrosoftGraphBeta::Models::DeviceConfiguration
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "rootCertificate" => lambda {|n| @root_certificate = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AndroidTrustedRootCertificate.create_from_discriminator_value(pn) }) },
