...
module MicrosoftGraphBeta
    module Models
        class SecurityCasesRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "ediscoveryCases" => lambda {|n| @ediscovery_cases = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityEdiscoveryCase.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
