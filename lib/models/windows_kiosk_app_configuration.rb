...
module MicrosoftGraphBeta
    module Models
        ...
        class WindowsKioskAppConfiguration
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.windowsKioskMultipleApps"
                            return WindowsKioskMultipleApps.new
                        when "#microsoft.graph.windowsKioskSingleUWPApp"
                            return WindowsKioskSingleUWPApp.new
                        when "#microsoft.graph.windowsKioskSingleWin32App"
                            return WindowsKioskSingleWin32App.new
                    end
                end
                return WindowsKioskAppConfiguration.new
            end
            ## 
