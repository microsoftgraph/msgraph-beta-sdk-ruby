    ...
    module Models
        class AccessReviewNotificationRecipientItem
            ...
            def get_field_deserializers()
                return {
                    "notificationRecipientScope" => lambda {|n| @notification_recipient_scope = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewNotificationRecipientScope.create_from_discriminator_value(pn) }) },
