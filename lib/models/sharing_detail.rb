        ...
        class SharingDetail
            ...
            def get_field_deserializers()
                return {
                    ...
                    "sharedBy" => lambda {|n| @shared_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::InsightIdentity.create_from_discriminator_value(pn) }) },
                    "sharedDateTime" => lambda {|n| @shared_date_time = n.get_date_time_value() },
                    "sharingReference" => lambda {|n| @sharing_reference = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ResourceReference.create_from_discriminator_value(pn) }) },
