...
module MicrosoftGraphBeta
    module Models
        class AccessPackageResource < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the access_package_resource_environment property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the added_by property.
            ## @return a void
            ## 
            def added_by=(value)
                @added_by = value
            ...
            ## @param value Value to set for the added_on property.
            ## @return a void
            ## 
            def added_on=(value)
                @added_on = value
            ...
            ## @param value Value to set for the is_pending_onboarding property.
            ## @return a void
            ## 
