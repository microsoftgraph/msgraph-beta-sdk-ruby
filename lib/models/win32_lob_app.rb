...
module MicrosoftGraphBeta
    module Models
        class Win32LobApp < MicrosoftGraphBeta::Models::MobileLobApp
            ...
            ## @param value Value to set for the allow_available_uninstall property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the detection_rules property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the requirement_rules property.
            ## @return a void
            ## 
