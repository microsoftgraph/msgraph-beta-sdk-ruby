...
module MicrosoftGraphBeta
    module Models
        class DelegatedAdminCustomer < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "serviceManagementDetails" => lambda {|n| @service_management_details = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DelegatedAdminServiceManagementDetail.create_from_discriminator_value(pn) }) },
