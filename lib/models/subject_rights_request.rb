    ...
    module Models
        class SubjectRightsRequest < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "approvers" => lambda {|n| @approvers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::User.create_from_discriminator_value(pn) }) },
                    ...
                    "collaborators" => lambda {|n| @collaborators = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::User.create_from_discriminator_value(pn) }) },
