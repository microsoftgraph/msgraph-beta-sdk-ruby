...
module MicrosoftGraphBeta
    module Models
        class SecurityDowngradeJustification
            ...
            ## 
            ## Instantiates a new securityDowngradeJustification and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return SecurityDowngradeJustification.new
            end
            ## 
