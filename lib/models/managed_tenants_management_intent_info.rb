...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsManagementIntentInfo
            ...
            ## 
            ## Instantiates a new managedTenantsManagementIntentInfo and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ManagedTenantsManagementIntentInfo.new
            end
            ## 
