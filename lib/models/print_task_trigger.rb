...
module MicrosoftGraphBeta
    module Models
        class PrintTaskTrigger < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "definition" => lambda {|n| @definition = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PrintTaskDefinition.create_from_discriminator_value(pn) }) },
                    "event" => lambda {|n| @event = n.get_enum_value(MicrosoftGraphBeta::Models::PrintEvent) },
                })
            end
            ## 
