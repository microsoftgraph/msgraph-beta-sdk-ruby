...
module MicrosoftGraphBeta
    module Models
        class UserExperienceAnalyticsDeviceScope < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the device_scope_name property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the owner_id property.
            ## @return a void
            ## 
            def owner_id=(value)
                @owner_id = value
            ...
            ## @param value Value to set for the value_object_id property.
            ## @return a void
            ## 
