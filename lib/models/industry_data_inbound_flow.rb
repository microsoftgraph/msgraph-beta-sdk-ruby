...
module MicrosoftGraphBeta
    module Models
        class IndustryDataInboundFlow < MicrosoftGraphBeta::Models::IndustryDataIndustryDataActivity
            ...
            ## @return a industry_data_inbound_domain
            ## 
            def data_domain
                return @data_domain
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    "dataConnector" => lambda {|n| @data_connector = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataIndustryDataConnector.create_from_discriminator_value(pn) }) },
                    "dataDomain" => lambda {|n| @data_domain = n.get_enum_value(MicrosoftGraphBeta::Models::IndustryDataInboundDomain) },
                    "effectiveDateTime" => lambda {|n| @effective_date_time = n.get_date_time_value() },
                    "expirationDateTime" => lambda {|n| @expiration_date_time = n.get_date_time_value() },
                    "year" => lambda {|n| @year = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataYearTimePeriodDefinition.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
