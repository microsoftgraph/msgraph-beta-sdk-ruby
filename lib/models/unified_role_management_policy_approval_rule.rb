...
module MicrosoftGraphBeta
    module Models
        class UnifiedRoleManagementPolicyApprovalRule < MicrosoftGraphBeta::Models::UnifiedRoleManagementPolicyRule
            ...
            def get_field_deserializers()
                return super.merge({
                    "setting" => lambda {|n| @setting = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ApprovalSettings.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
