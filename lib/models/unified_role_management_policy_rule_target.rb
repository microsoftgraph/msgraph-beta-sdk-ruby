        ...
        class UnifiedRoleManagementPolicyRuleTarget
            ...
            def get_field_deserializers()
                return {
                    ...
                    "operations" => lambda {|n| @operations = n.get_collection_of_primitive_values(String) },
                    "targetObjects" => lambda {|n| @target_objects = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_primitive_values("operations", @operations)
