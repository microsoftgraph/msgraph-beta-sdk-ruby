...
module MicrosoftGraphBeta
    module Models
        class FileStorage < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "containers" => lambda {|n| @containers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::FileStorageContainer.create_from_discriminator_value(pn) }) },
                    "deletedContainers" => lambda {|n| @deleted_containers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::FileStorageContainer.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
