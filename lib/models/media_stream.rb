    ...
    module Models
        class MediaStream
            ...
            def get_field_deserializers()
                return {
                    "direction" => lambda {|n| @direction = n.get_enum_value(MicrosoftGraphBeta::Models::MediaDirection) },
                    "label" => lambda {|n| @label = n.get_string_value() },
                    "mediaType" => lambda {|n| @media_type = n.get_enum_value(MicrosoftGraphBeta::Models::Modality) },
