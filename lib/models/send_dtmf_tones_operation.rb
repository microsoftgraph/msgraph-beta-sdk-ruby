...
module MicrosoftGraphBeta
    module Models
        class SendDtmfTonesOperation < MicrosoftGraphBeta::Models::CommsOperation
            ...
            def get_field_deserializers()
                return super.merge({
                    "completionReason" => lambda {|n| @completion_reason = n.get_enum_value(MicrosoftGraphBeta::Models::SendDtmfTonesOperationCompletionReason) },
                })
            end
            ## 
