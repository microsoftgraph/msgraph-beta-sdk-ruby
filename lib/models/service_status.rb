    ...
    module Models
        class ServiceStatus
            ...
            def get_field_deserializers()
                return {
                    "backupServiceConsumer" => lambda {|n| @backup_service_consumer = n.get_enum_value(MicrosoftGraphBeta::Models::BackupServiceConsumer) },
                    "disableReason" => lambda {|n| @disable_reason = n.get_enum_value(MicrosoftGraphBeta::Models::DisableReason) },
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::BackupServiceStatus) },
                }
            end
            ## 
