        ...
        class MessageRuleActions
            ...
            def get_field_deserializers()
                return {
                    ...
                    "forwardAsAttachmentTo" => lambda {|n| @forward_as_attachment_to = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Recipient.create_from_discriminator_value(pn) }) },
                    "forwardTo" => lambda {|n| @forward_to = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Recipient.create_from_discriminator_value(pn) }) },
                    "markAsRead" => lambda {|n| @mark_as_read = n.get_boolean_value() },
                    "markImportance" => lambda {|n| @mark_importance = n.get_enum_value(MicrosoftGraphBeta::Models::MessageRuleActionsMarkImportance) },
                    ...
                    "redirectTo" => lambda {|n| @redirect_to = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Recipient.create_from_discriminator_value(pn) }) },
