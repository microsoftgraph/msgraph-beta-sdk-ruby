...
module MicrosoftGraphBeta::Models
    class ImportedWindowsAutopilotDeviceIdentityUpload < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "deviceIdentities" => lambda {|n| @device_identities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ImportedWindowsAutopilotDeviceIdentity.create_from_discriminator_value(pn) }) },
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ImportedWindowsAutopilotDeviceIdentityUploadStatus) },
            })
        end
        ## 
