        ...
        class BookingSchedulingPolicy
            ...
            def get_field_deserializers()
                return {
                    ...
                    "customAvailabilities" => lambda {|n| @custom_availabilities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingsAvailabilityWindow.create_from_discriminator_value(pn) }) },
                    "generalAvailability" => lambda {|n| @general_availability = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::BookingsAvailability.create_from_discriminator_value(pn) }) },
