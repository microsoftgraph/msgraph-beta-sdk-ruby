...
module MicrosoftGraphBeta
    module Models
        class SecurityMailboxConfigurationEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "configurationType" => lambda {|n| @configuration_type = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityMailboxConfigurationType) },
