...
module MicrosoftGraphBeta
    module Models
        class PartnersModelModelModelModelModelModelModelModel < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "billing" => lambda {|n| @billing = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::.models.partners.billingBilling.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
