        ...
        class DeviceLogCollectionResponse < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "size" => lambda {|n| @size = n.get_object_value(lambda {|pn| DeviceLogCollectionResponse::DeviceLogCollectionResponseSize.create_from_discriminator_value(pn) }) },
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::AppLogUploadState) },
                })
            end
            ## 
            ...
            ## @return a device_log_collection_response_size
            ## 
            def size
                return @size
            end
            ...
            class DeviceLogCollectionResponseSize
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return DeviceLogCollectionResponseSize.new
                end
                ## 
