...
module MicrosoftGraphBeta
    module Models
        class MultiTenantOrganizationJoinRequestTransitionDetails
            ...
            ## @return a multi_tenant_organization_join_request_transition_details_desired_member_state
            ## 
            ...
            def get_field_deserializers()
                return {
                    "desiredMemberState" => lambda {|n| @desired_member_state = n.get_enum_value(MicrosoftGraphBeta::Models::MultiTenantOrganizationJoinRequestTransitionDetailsDesiredMemberState) },
                    "details" => lambda {|n| @details = n.get_string_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::MultiTenantOrganizationJoinRequestTransitionDetailsStatus) },
                }
            end
            ## 
            ...
            ## @return a multi_tenant_organization_join_request_transition_details_status
            ## 
            def status
                return @status
            end
