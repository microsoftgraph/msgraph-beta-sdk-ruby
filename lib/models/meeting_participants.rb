    ...
    module Models
        class MeetingParticipants
            ...
            def get_field_deserializers()
                return {
                    "attendees" => lambda {|n| @attendees = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MeetingParticipantInfo.create_from_discriminator_value(pn) }) },
                    "contributors" => lambda {|n| @contributors = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MeetingParticipantInfo.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "organizer" => lambda {|n| @organizer = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MeetingParticipantInfo.create_from_discriminator_value(pn) }) },
                    "producers" => lambda {|n| @producers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MeetingParticipantInfo.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("contributors", @contributors)
                writer.write_string_value("@odata.type", @odata_type)
                writer.write_object_value("organizer", @organizer)
                writer.write_collection_of_object_values("producers", @producers)
