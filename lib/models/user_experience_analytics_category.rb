...
module MicrosoftGraphBeta
    module Models
        ...
        class UserExperienceAnalyticsCategory < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "metricValues" => lambda {|n| @metric_values = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserExperienceAnalyticsMetric.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
