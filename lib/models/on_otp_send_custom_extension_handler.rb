...
module MicrosoftGraphBeta
    module Models
        class OnOtpSendCustomExtensionHandler < MicrosoftGraphBeta::Models::OnOtpSendHandler
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.onOtpSendCustomExtensionHandler"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a on_otp_send_custom_extension_handler
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return OnOtpSendCustomExtensionHandler.new
            end
            ## 
            ## Gets the customExtension property value. The customExtension property
            ## @return a on_otp_send_custom_extension
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "customExtension" => lambda {|n| @custom_extension = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnOtpSendCustomExtension.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
