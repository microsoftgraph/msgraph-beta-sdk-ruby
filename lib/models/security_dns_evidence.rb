...
module MicrosoftGraphBeta
    module Models
        class SecurityDnsEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    "dnsServerIp" => lambda {|n| @dns_server_ip = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIpEvidence.create_from_discriminator_value(pn) }) },
                    "domainName" => lambda {|n| @domain_name = n.get_string_value() },
                    "hostIpAddress" => lambda {|n| @host_ip_address = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIpEvidence.create_from_discriminator_value(pn) }) },
                    "ipAddresses" => lambda {|n| @ip_addresses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIpEvidence.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
