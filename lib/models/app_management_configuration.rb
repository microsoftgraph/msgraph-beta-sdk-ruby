    ...
    module Models
        class AppManagementConfiguration
            ...
            def get_field_deserializers()
                return {
                    "keyCredentials" => lambda {|n| @key_credentials = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::KeyCredentialConfiguration.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "passwordCredentials" => lambda {|n| @password_credentials = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PasswordCredentialConfiguration.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
