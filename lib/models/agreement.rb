...
module MicrosoftGraphBeta
    module Models
        class Agreement < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "acceptances" => lambda {|n| @acceptances = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AgreementAcceptance.create_from_discriminator_value(pn) }) },
                    "displayName" => lambda {|n| @display_name = n.get_string_value() },
                    "file" => lambda {|n| @file = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AgreementFile.create_from_discriminator_value(pn) }) },
                    "files" => lambda {|n| @files = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AgreementFileLocalization.create_from_discriminator_value(pn) }) },
                    ...
                    "termsExpiration" => lambda {|n| @terms_expiration = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TermsExpiration.create_from_discriminator_value(pn) }) },
