...
module MicrosoftGraphBeta
    module Models
        ...
        class UserExperienceAnalyticsDeviceScores < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "meanResourceSpikeTimeScore" => lambda {|n| @mean_resource_spike_time_score = n.get_object_value(lambda {|pn| UserExperienceAnalyticsDeviceScores::UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore.create_from_discriminator_value(pn) }) },
            ...
            ## @return a user_experience_analytics_device_scores_mean_resource_spike_time_score
            ## 
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsDeviceScoresMeanResourceSpikeTimeScore.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
