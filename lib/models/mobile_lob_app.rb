...
module MicrosoftGraphBeta
    module Models
        ...
        class MobileLobApp < MicrosoftGraphBeta::Models::MobileApp
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "contentVersions" => lambda {|n| @content_versions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MobileAppContent.create_from_discriminator_value(pn) }) },
