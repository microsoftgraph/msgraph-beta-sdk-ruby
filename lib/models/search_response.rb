...
module MicrosoftGraphBeta::Models
    class SearchResponse
        ...
        def get_field_deserializers()
            return {
                "hitsContainers" => lambda {|n| @hits_containers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SearchHitsContainer.create_from_discriminator_value(pn) }) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "queryAlterationResponse" => lambda {|n| @query_alteration_response = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AlterationResponse.create_from_discriminator_value(pn) }) },
                "resultTemplates" => lambda {|n| @result_templates = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ResultTemplateDictionary.create_from_discriminator_value(pn) }) },
