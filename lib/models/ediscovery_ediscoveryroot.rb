    ...
    module Models
        class EdiscoveryEdiscoveryroot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "cases" => lambda {|n| @cases = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryCase_escaped_escaped_escaped_escaped.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
