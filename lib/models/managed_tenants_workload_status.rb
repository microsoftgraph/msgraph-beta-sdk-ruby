...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsWorkloadStatus
            ...
            ## 
            ## Instantiates a new ManagedTenantsWorkloadStatus and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ManagedTenantsWorkloadStatus.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "onboardingStatus" => lambda {|n| @onboarding_status = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenantsWorkloadOnboardingStatus) },
                }
            end
            ## 
            ...
            ## @return a managed_tenants_workload_onboarding_status
            ## 
