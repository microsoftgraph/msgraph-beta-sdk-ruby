...
module MicrosoftGraphBeta::Models
    class PinnedChatMessageInfo < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "message" => lambda {|n| @message = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessage.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
