...
module MicrosoftGraphBeta
    module Models
        ...
        class AospDeviceOwnerScepCertificateProfile < MicrosoftGraphBeta::Models::AospDeviceOwnerCertificateProfileBase
            ...
            ## @return a aosp_device_owner_scep_certificate_profile_certificate_store
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "certificateStore" => lambda {|n| @certificate_store = n.get_enum_value(MicrosoftGraphBeta::Models::AospDeviceOwnerScepCertificateProfileCertificateStore) },
