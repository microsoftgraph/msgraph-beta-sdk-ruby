...
module MicrosoftGraphBeta
    module Models
        class IndustryDataIndustryDataRunEntityCountMetric
            ...
            ## 
            ## Instantiates a new IndustryDataIndustryDataRunEntityCountMetric and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return IndustryDataIndustryDataRunEntityCountMetric.new
            end
            ## 
