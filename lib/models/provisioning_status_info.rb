    ...
    module Models
        class ProvisioningStatusInfo
            ...
            def get_field_deserializers()
                return {
                    "errorInformation" => lambda {|n| @error_information = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ProvisioningErrorInfo.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ProvisioningStatusInfoStatus) },
                }
            end
            ## 
