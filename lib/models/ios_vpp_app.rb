...
module MicrosoftGraphBeta
    module Models
        class IosVppApp < MicrosoftGraphBeta::Models::MobileApp
            ...
            ## @return a ios_vpp_app_assigned_license
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "applicableDeviceType" => lambda {|n| @applicable_device_type = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IosDeviceType.create_from_discriminator_value(pn) }) },
                    "assignedLicenses" => lambda {|n| @assigned_licenses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IosVppAppAssignedLicense.create_from_discriminator_value(pn) }) },
                    ...
                    "revokeLicenseActionResults" => lambda {|n| @revoke_license_action_results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IosVppAppRevokeLicensesActionResult.create_from_discriminator_value(pn) }) },
            ...
            ## 
            def revoke_license_action_results
                return @revoke_license_action_results
            end
            ## 
            ## Sets the revokeLicenseActionResults property value. Results of revoke license actions on this app.
            ## @param value Value to set for the revoke_license_action_results property.
            ## @return a void
            ## 
            def revoke_license_action_results=(value)
                @revoke_license_action_results = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("revokeLicenseActionResults", @revoke_license_action_results)
