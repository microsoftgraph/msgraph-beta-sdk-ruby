...
module MicrosoftGraphBeta
    module Models
        class DriveItem < MicrosoftGraphBeta::Models::BaseItem
            ...
            def get_field_deserializers()
                return super.merge({
                    "activities" => lambda {|n| @activities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ItemActivityOLD.create_from_discriminator_value(pn) }) },
                    ...
                    "audio" => lambda {|n| @audio = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Audio.create_from_discriminator_value(pn) }) },
                    "bundle" => lambda {|n| @bundle = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Bundle.create_from_discriminator_value(pn) }) },
                    "cTag" => lambda {|n| @c_tag = n.get_string_value() },
                    "children" => lambda {|n| @children = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveItem.create_from_discriminator_value(pn) }) },
                    "content" => lambda {|n| @content = n.get_object_value(lambda {|pn| Base64url.create_from_discriminator_value(pn) }) },
                    "contentStream" => lambda {|n| @content_stream = n.get_object_value(lambda {|pn| Base64url.create_from_discriminator_value(pn) }) },
                    ...
                    "file" => lambda {|n| @file = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::File.create_from_discriminator_value(pn) }) },
                    "fileSystemInfo" => lambda {|n| @file_system_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::FileSystemInfo.create_from_discriminator_value(pn) }) },
                    "folder" => lambda {|n| @folder = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Folder.create_from_discriminator_value(pn) }) },
                    "image" => lambda {|n| @image = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Image.create_from_discriminator_value(pn) }) },
                    ...
                    "location" => lambda {|n| @location = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::GeoCoordinates.create_from_discriminator_value(pn) }) },
                    "malware" => lambda {|n| @malware = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Malware.create_from_discriminator_value(pn) }) },
                    "media" => lambda {|n| @media = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Media.create_from_discriminator_value(pn) }) },
                    "package" => lambda {|n| @package = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Package.create_from_discriminator_value(pn) }) },
                    "pendingOperations" => lambda {|n| @pending_operations = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PendingOperations.create_from_discriminator_value(pn) }) },
                    ...
                    "photo" => lambda {|n| @photo = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Photo.create_from_discriminator_value(pn) }) },
                    "publication" => lambda {|n| @publication = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PublicationFacet.create_from_discriminator_value(pn) }) },
                    "remoteItem" => lambda {|n| @remote_item = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::RemoteItem.create_from_discriminator_value(pn) }) },
                    "retentionLabel" => lambda {|n| @retention_label = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemRetentionLabel.create_from_discriminator_value(pn) }) },
                    "root" => lambda {|n| @root = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Root.create_from_discriminator_value(pn) }) },
                    "searchResult" => lambda {|n| @search_result = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SearchResult.create_from_discriminator_value(pn) }) },
                    "shared" => lambda {|n| @shared = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Shared.create_from_discriminator_value(pn) }) },
                    ...
                    "source" => lambda {|n| @source = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DriveItemSource.create_from_discriminator_value(pn) }) },
                    "specialFolder" => lambda {|n| @special_folder = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SpecialFolder.create_from_discriminator_value(pn) }) },
                    "subscriptions" => lambda {|n| @subscriptions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Subscription.create_from_discriminator_value(pn) }) },
                    "thumbnails" => lambda {|n| @thumbnails = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ThumbnailSet.create_from_discriminator_value(pn) }) },
                    "versions" => lambda {|n| @versions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveItemVersion.create_from_discriminator_value(pn) }) },
                    "video" => lambda {|n| @video = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Video.create_from_discriminator_value(pn) }) },
                    "viewpoint" => lambda {|n| @viewpoint = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DriveItemViewpoint.create_from_discriminator_value(pn) }) },
                    "webDavUrl" => lambda {|n| @web_dav_url = n.get_string_value() },
                    "workbook" => lambda {|n| @workbook = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Workbook.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("contentStream", @content_stream)
                ...
                writer.write_object_value("media", @media)
