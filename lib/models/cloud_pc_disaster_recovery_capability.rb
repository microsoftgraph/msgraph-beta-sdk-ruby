        ...
        class CloudPcDisasterRecoveryCapability
            ...
            def get_field_deserializers()
                return {
                    ...
                    "licenseType" => lambda {|n| @license_type = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcDisasterRecoveryLicenseType) },
            ...
            ## @return a cloud_pc_disaster_recovery_license_type
            ## 
            def license_type
                return @license_type
            end
