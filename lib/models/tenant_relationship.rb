        ...
        class TenantRelationship
            ...
            def get_field_deserializers()
                return {
                    ...
                    "managedTenants" => lambda {|n| @managed_tenants = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsManagedTenant.create_from_discriminator_value(pn) }) },
                    "multiTenantOrganization" => lambda {|n| @multi_tenant_organization = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MultiTenantOrganization.create_from_discriminator_value(pn) }) },
