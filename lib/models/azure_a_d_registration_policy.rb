    ...
    module Models
        class AzureADRegistrationPolicy
            ...
            def get_field_deserializers()
                return {
                    "allowedToRegister" => lambda {|n| @allowed_to_register = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DeviceRegistrationMembership.create_from_discriminator_value(pn) }) },
