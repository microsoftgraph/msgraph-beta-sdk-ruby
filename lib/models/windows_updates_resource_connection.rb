...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdatesResourceConnection < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "state" => lambda {|n| @state = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUpdatesResourceConnectionState) },
                })
            end
            ## 
            ...
            ## @return a windows_updates_resource_connection_state
            ## 
            def state
                return @state
            end
