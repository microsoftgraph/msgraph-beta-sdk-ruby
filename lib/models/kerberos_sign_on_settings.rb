...
module MicrosoftGraphBeta
    module Models
        class KerberosSignOnSettings
            ...
            ## @param value Value to set for the kerberos_service_principal_name property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the kerberos_sign_on_mapping_attribute_type property.
            ## @return a void
            ## 
