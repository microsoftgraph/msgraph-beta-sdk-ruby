...
module MicrosoftGraphBeta
    module Models
        class AwsPermissionsDefinition < MicrosoftGraphBeta::Models::PermissionsDefinition
            ...
            ## @return a aws_permissions_definition_action
            ## 
            def action_info
                return @action_info
            end
            ...
            ## @return a aws_permissions_definition
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "actionInfo" => lambda {|n| @action_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AwsPermissionsDefinitionAction.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
