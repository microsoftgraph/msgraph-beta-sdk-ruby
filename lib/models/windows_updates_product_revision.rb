        ...
        class WindowsUpdatesProductRevision < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "isHotpatchUpdate" => lambda {|n| @is_hotpatch_update = n.get_boolean_value() },
            ...
            ## @return a boolean
            ## 
            def is_hotpatch_update
                return @is_hotpatch_update
            end
            ## 
            ...
            ## @return a void
            ## 
            def is_hotpatch_update=(value)
                @is_hotpatch_update = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("isHotpatchUpdate", @is_hotpatch_update)
