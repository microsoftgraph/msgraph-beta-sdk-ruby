...
module MicrosoftGraphBeta
    module Models
        class AndroidWorkProfileVpnConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
            ...
            ## @param value Value to set for the always_on property.
            ## @return a void
            ## 
            def always_on=(value)
                @always_on = value
            ...
            ## @param value Value to set for the always_on_lockdown property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the targeted_package_ids property.
            ## @return a void
            ## 
