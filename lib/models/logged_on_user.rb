...
module MicrosoftGraphBeta::Models
    ...
    class LoggedOnUser
        ...
        def get_field_deserializers()
            return {
                "lastLogOnDateTime" => lambda {|n| @last_log_on_date_time = n.get_date_time_value() },
        ...
        ## @return a date_time
        ## 
        def last_log_on_date_time
            return @last_log_on_date_time
        end
        ## 
        ## Sets the lastLogOnDateTime property value. Date time when user logs on
        ## @param value Value to set for the last_log_on_date_time property.
        ## @return a void
        ## 
        def last_log_on_date_time=(value)
            @last_log_on_date_time = value
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_date_time_value("lastLogOnDateTime", @last_log_on_date_time)
