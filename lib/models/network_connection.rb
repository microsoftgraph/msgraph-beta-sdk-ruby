        ...
        class NetworkConnection
            ...
            def get_field_deserializers()
                return {
                    ...
                    "direction" => lambda {|n| @direction = n.get_enum_value(MicrosoftGraphBeta::Models::ConnectionDirection) },
                    ...
                    "protocol" => lambda {|n| @protocol = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityNetworkProtocol) },
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ConnectionStatus) },
