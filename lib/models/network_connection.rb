        ...
        class NetworkConnection
            ...
            def get_field_deserializers()
                return {
                    ...
                    "direction" => lambda {|n| @direction = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkConnectionDirection) },
                    ...
                    "protocol" => lambda {|n| @protocol = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkConnectionProtocol) },
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkConnectionStatus) },
