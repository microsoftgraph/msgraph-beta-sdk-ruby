    ...
    class NotebookLinks
        ...
        def get_field_deserializers()
            return {
                ...
                "oneNoteClientUrl" => lambda {|n| @one_note_client_url = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalLink.create_from_discriminator_value(pn) }) },
                "oneNoteWebUrl" => lambda {|n| @one_note_web_url = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalLink.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
