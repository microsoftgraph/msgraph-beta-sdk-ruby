...
module MicrosoftGraphBeta
    module Models
        class SecurityIoTDeviceEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "importance" => lambda {|n| @importance = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityIoTDeviceImportanceType) },
                    "ioTHub" => lambda {|n| @io_t_hub = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityAzureResourceEvidence.create_from_discriminator_value(pn) }) },
                    "ioTSecurityAgentId" => lambda {|n| @io_t_security_agent_id = n.get_string_value() },
                    "ipAddress" => lambda {|n| @ip_address = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIpEvidence.create_from_discriminator_value(pn) }) },
                    ...
                    "nics" => lambda {|n| @nics = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityNicEvidence.create_from_discriminator_value(pn) }) },
                    ...
                    "sourceRef" => lambda {|n| @source_ref = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityUrlEvidence.create_from_discriminator_value(pn) }) },
