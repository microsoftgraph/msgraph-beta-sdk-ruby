...
module MicrosoftGraphBeta
    module Models
        class AuthenticationStrengthPolicy < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "allowedCombinations" => lambda {|n| @allowed_combinations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationMethodModes.create_from_discriminator_value(pn) }) },
                    "combinationConfigurations" => lambda {|n| @combination_configurations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationCombinationConfiguration.create_from_discriminator_value(pn) }) },
