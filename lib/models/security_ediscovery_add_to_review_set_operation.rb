...
module MicrosoftGraphBeta
    module Models
        class SecurityEdiscoveryAddToReviewSetOperation < MicrosoftGraphBeta::Models::SecurityCaseOperation
            ...
            def get_field_deserializers()
                return super.merge({
                    "additionalDataOptions" => lambda {|n| @additional_data_options = n.get_enum_values(MicrosoftGraphBeta::Models::SecurityAdditionalDataOptions) },
                    ...
                    "itemsToInclude" => lambda {|n| @items_to_include = n.get_enum_values(MicrosoftGraphBeta::Models::SecurityItemsToInclude) },
