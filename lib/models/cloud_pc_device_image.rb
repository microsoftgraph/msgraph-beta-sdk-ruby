        ...
        class CloudPcDeviceImage < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "osVersionNumber" => lambda {|n| @os_version_number = n.get_string_value() },
            ...
            ## @return a void
            ## 
            def os_version_number=(value)
                @os_version_number = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("osVersionNumber", @os_version_number)
