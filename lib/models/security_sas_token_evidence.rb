...
module MicrosoftGraphBeta
    module Models
        class SecuritySasTokenEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "storageResource" => lambda {|n| @storage_resource = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityAzureResourceEvidence.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
