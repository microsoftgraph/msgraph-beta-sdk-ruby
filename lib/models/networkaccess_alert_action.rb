...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessAlertAction
            ...
            ## 
            ## Instantiates a new networkaccessAlertAction and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return NetworkaccessAlertAction.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "actionLink" => lambda {|n| @action_link = n.get_string_value() },
                    "actionText" => lambda {|n| @action_text = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_string_value("actionLink", @action_link)
                writer.write_string_value("actionText", @action_text)
