        ...
        class SingleSignOnExtension
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.credentialSingleSignOnExtension"
                        ...
                        when "#microsoft.graph.iosSingleSignOnExtension"
                            return IosSingleSignOnExtension.new
                        when "#microsoft.graph.kerberosSingleSignOnExtension"
                            return KerberosSingleSignOnExtension.new
                        ...
                        when "#microsoft.graph.macOSSingleSignOnExtension"
                            return MacOSSingleSignOnExtension.new
                        when "#microsoft.graph.redirectSingleSignOnExtension"
                            return RedirectSingleSignOnExtension.new
                    end
                end
                return SingleSignOnExtension.new
            end
            ## 
