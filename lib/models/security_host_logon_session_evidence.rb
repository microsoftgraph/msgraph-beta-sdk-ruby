...
module MicrosoftGraphBeta
    module Models
        class SecurityHostLogonSessionEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    "account" => lambda {|n| @account = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityUserEvidence.create_from_discriminator_value(pn) }) },
                    "endUtcDateTime" => lambda {|n| @end_utc_date_time = n.get_date_time_value() },
                    "host" => lambda {|n| @host = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityDeviceEvidence.create_from_discriminator_value(pn) }) },
