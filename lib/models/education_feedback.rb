    ...
    module Models
        class EducationFeedback
            ...
            def get_field_deserializers()
                return {
                    "feedbackBy" => lambda {|n| @feedback_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                    "feedbackDateTime" => lambda {|n| @feedback_date_time = n.get_date_time_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "text" => lambda {|n| @text = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationItemBody.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
