...
module MicrosoftGraphBeta
    module Models
        class SecurityTeamsMessageEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "deliveryAction" => lambda {|n| @delivery_action = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityTeamsMessageDeliveryAction) },
                    "deliveryLocation" => lambda {|n| @delivery_location = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityTeamsDeliveryLocation) },
                    "files" => lambda {|n| @files = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityFileEvidence.create_from_discriminator_value(pn) }) },
                    ...
                    "messageDirection" => lambda {|n| @message_direction = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityAntispamTeamsDirection) },
                    ...
                    "urls" => lambda {|n| @urls = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityUrlEvidence.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
