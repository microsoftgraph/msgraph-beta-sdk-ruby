...
module MicrosoftGraphBeta::Models
    ...
    class ManagedDeviceMobileAppConfigurationSettingState
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            return ManagedDeviceMobileAppConfigurationSettingState.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                ...
                "settingInstanceId" => lambda {|n| @setting_instance_id = n.get_string_value() },
                "settingName" => lambda {|n| @setting_name = n.get_string_value() },
                "sources" => lambda {|n| @sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SettingSource.create_from_discriminator_value(pn) }) },
        ...
        def serialize(writer)
            ...
            writer.write_string_value("settingInstanceId", @setting_instance_id)
        ...
        ## @return a string
        ## 
        def setting_instance_id
            return @setting_instance_id
        end
        ## 
        ## Sets the settingInstanceId property value. SettingInstanceId
        ## @param value Value to set for the setting_instance_id property.
        ## @return a void
        ## 
        def setting_instance_id=(value)
