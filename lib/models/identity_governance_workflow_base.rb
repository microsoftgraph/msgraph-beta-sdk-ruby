    ...
    module Models
        class IdentityGovernanceWorkflowBase
            ...
            def get_field_deserializers()
                return {
                    "category" => lambda {|n| @category = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityGovernanceLifecycleWorkflowCategory) },
                    ...
                    "executionConditions" => lambda {|n| @execution_conditions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceWorkflowExecutionConditions.create_from_discriminator_value(pn) }) },
                    ...
                    "tasks" => lambda {|n| @tasks = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceTask.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
