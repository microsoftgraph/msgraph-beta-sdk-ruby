...
module MicrosoftGraphBeta::Models::WindowsUpdates
    class Catalog < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "entries" => lambda {|n| @entries = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdates::CatalogEntry.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
