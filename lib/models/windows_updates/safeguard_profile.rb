        ...
        module WindowsUpdates
            class SafeguardProfile
                ...
                def get_field_deserializers()
                    return {
                        "category" => lambda {|n| @category = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUpdates::SafeguardCategory) },
