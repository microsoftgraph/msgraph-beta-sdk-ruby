        ...
        module WindowsUpdates
            class MonitoringSettings
                ...
                def get_field_deserializers()
                    return {
                        "monitoringRules" => lambda {|n| @monitoring_rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdates::MonitoringRule.create_from_discriminator_value(pn) }) },
                ...
                ## @param value Value to set for the monitoring_rules property.
                ## @return a void
                ## 
