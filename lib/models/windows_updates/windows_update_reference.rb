...
module MicrosoftGraphBeta::Models::WindowsUpdates
    class WindowsUpdateReference < MicrosoftGraphBeta::Models::WindowsUpdates::SoftwareUpdateReference
        ...
        def initialize()
            super
            @odata_type = "#microsoft.graph.windowsUpdates.windowsUpdateReference"
        end
        ## 
        ## Creates a new instance of the appropriate class based on discriminator value
        ## @param parseNode The parse node to use to read the discriminator value and create the object
        ## @return a windows_update_reference
        ## 
