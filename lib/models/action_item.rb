...
module MicrosoftGraphBeta
    module Models
        class ActionItem
            ...
            ## 
            ## Instantiates a new ActionItem and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def get_field_deserializers()
                return {
                    ...
                    "ownerDisplayName" => lambda {|n| @owner_display_name = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_string_value("ownerDisplayName", @owner_display_name)
