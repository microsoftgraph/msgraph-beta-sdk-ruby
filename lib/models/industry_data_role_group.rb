...
module MicrosoftGraphBeta
    module Models
        class IndustryDataRoleGroup < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "roles" => lambda {|n| @roles = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataRoleReferenceValue.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ## Gets the roles property value. The set of roles included in the role group.
            ## @return a industry_data_role_reference_value
            ## 
            def roles
                return @roles
            end
