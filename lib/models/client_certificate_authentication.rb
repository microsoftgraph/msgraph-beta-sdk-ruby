...
module MicrosoftGraphBeta::Models
    class ClientCertificateAuthentication < MicrosoftGraphBeta::Models::ApiAuthenticationConfigurationBase
        ...
        def get_field_deserializers()
            return super.merge({
                "certificateList" => lambda {|n| @certificate_list = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Pkcs12CertificateInformation.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
