    ...
    module Models
        ...
        class PrivilegeManagementElevationRequest < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "applicationDetail" => lambda {|n| @application_detail = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ApplicationDetail.create_from_discriminator_value(pn) }) },
