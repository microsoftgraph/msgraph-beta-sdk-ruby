...
module MicrosoftGraphBeta
    module Models
        ...
        class AndroidWorkProfilePkcsCertificateProfile < MicrosoftGraphBeta::Models::AndroidWorkProfileCertificateProfileBase
            ...
            ## @return a android_work_profile_pkcs_certificate_profile_certificate_store
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "certificateStore" => lambda {|n| @certificate_store = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidWorkProfilePkcsCertificateProfileCertificateStore) },
