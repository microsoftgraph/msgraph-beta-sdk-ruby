    ...
    module Models
        class PrivilegedAccessGroupEligibilitySchedule < MicrosoftGraphBeta::Models::PrivilegedAccessSchedule
            ...
            def get_field_deserializers()
                return super.merge({
                    "accessId" => lambda {|n| @access_id = n.get_enum_value(MicrosoftGraphBeta::Models::PrivilegedAccessGroupEligibilityScheduleAccessId) },
                    ...
                    "memberType" => lambda {|n| @member_type = n.get_enum_value(MicrosoftGraphBeta::Models::PrivilegedAccessGroupEligibilityScheduleMemberType) },
