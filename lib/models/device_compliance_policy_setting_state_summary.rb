...
module MicrosoftGraphBeta
    module Models
        class DeviceCompliancePolicySettingStateSummary < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "deviceComplianceSettingStates" => lambda {|n| @device_compliance_setting_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceComplianceSettingState.create_from_discriminator_value(pn) }) },
