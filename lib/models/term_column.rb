        ...
        class TermColumn
            ...
            def get_field_deserializers()
                return {
                    ...
                    "parentTerm" => lambda {|n| @parent_term = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TermStoreTerm.create_from_discriminator_value(pn) }) },
                    "showFullyQualifiedName" => lambda {|n| @show_fully_qualified_name = n.get_boolean_value() },
                    "termSet" => lambda {|n| @term_set = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TermStoreSet.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
