        ...
        class EventMessage < MicrosoftGraphBeta::Models::Message
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "meetingMessageType" => lambda {|n| @meeting_message_type = n.get_enum_value(MicrosoftGraphBeta::Models::EventMessageMeetingMessageType) },
                    ...
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::EventMessageType) },
                })
            end
            ## 
