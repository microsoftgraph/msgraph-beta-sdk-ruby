...
module MicrosoftGraphBeta
    module Models
        class Mention < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the client_reference property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the deep_link property.
            ## @return a void
            ## 
            def deep_link=(value)
                @deep_link = value
            ...
            ## @param value Value to set for the server_created_date_time property.
            ## @return a void
            ## 
