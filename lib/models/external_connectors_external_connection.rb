...
module MicrosoftGraphBeta
    module Models
        class ExternalConnectorsExternalConnection < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "activitySettings" => lambda {|n| @activity_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectorsActivitySettings.create_from_discriminator_value(pn) }) },
                    "complianceSettings" => lambda {|n| @compliance_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectorsComplianceSettings.create_from_discriminator_value(pn) }) },
                    ...
                    "operations" => lambda {|n| @operations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectorsConnectionOperation.create_from_discriminator_value(pn) }) },
