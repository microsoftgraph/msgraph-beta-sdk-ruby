...
module MicrosoftGraphBeta
    module Models
        class DirectorySetting < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "values" => lambda {|n| @values = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SettingValue.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
