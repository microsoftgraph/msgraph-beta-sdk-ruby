...
module MicrosoftGraphBeta::Models
    class MatchingLabel
        ...
        ## @param value Value to set for the application_mode property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the is_endpoint_protection_enabled property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the label_actions property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the tool_tip property.
        ## @return a void
        ## 
        def tool_tip=(value)
            @tool_tip = value
