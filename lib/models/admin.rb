...
require_relative './windows_updates/windows'
    ...
    class Admin
        ...
        def get_field_deserializers()
            return {
                ...
                "windows" => lambda {|n| @windows = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdates::Windows.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
