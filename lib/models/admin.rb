        ...
        class Admin
            ...
            def get_field_deserializers()
                return {
                    ...
                    "entra" => lambda {|n| @entra = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Entra.create_from_discriminator_value(pn) }) },
                    "exchange" => lambda {|n| @exchange = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExchangeAdmin.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("entra", @entra)
