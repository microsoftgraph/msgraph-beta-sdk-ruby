        ...
        class ApprovalSettings
            ...
            def get_field_deserializers()
                return {
                    ...
                    "approvalStages" => lambda {|n| @approval_stages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ApprovalStage.create_from_discriminator_value(pn) }) },
