...
module MicrosoftGraphBeta
    module Models
        class Goals < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "exportJobs" => lambda {|n| @export_jobs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::GoalsExportJob.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
