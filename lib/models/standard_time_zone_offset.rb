...
module MicrosoftGraphBeta
    module Models
        class StandardTimeZoneOffset
            ...
            ## @return a standard_time_zone_offset_day_of_week
            ## 
            def day_of_week
                return @day_of_week
            end
            ...
            def get_field_deserializers()
                return {
                    ...
                    "dayOfWeek" => lambda {|n| @day_of_week = n.get_enum_value(MicrosoftGraphBeta::Models::StandardTimeZoneOffsetDayOfWeek) },
