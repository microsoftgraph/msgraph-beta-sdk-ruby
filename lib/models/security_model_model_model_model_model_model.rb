...
module MicrosoftGraphBeta
    module Models
        class SecurityModelModelModelModelModelModel
            ...
            ## @return a void
            ## 
            def data_discovery=(value)
                @data_discovery = value
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "dataDiscovery" => lambda {|n| @data_discovery = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityDataDiscoveryRoot.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("dataDiscovery", @data_discovery)
