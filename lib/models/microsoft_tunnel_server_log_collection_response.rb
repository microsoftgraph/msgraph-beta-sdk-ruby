...
module MicrosoftGraphBeta
    module Models
        ...
        class MicrosoftTunnelServerLogCollectionResponse < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the expiry_date_time property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the server_id property.
            ## @return a void
            ## 
            def server_id=(value)
                @server_id = value
            ...
            ## @param value Value to set for the size_in_bytes property.
            ## @return a void
            ## 
