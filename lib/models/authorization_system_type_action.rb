...
module MicrosoftGraphBeta
    module Models
        class AuthorizationSystemTypeAction < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a authorization_system_type_action_action_type
            ## 
            def action_type
                return @action_type
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    "actionType" => lambda {|n| @action_type = n.get_enum_value(MicrosoftGraphBeta::Models::AuthorizationSystemTypeActionActionType) },
