            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        ...
                        when "#microsoft.graph.programResource"
                        ...
                        when "#microsoft.graph.security.submissionUserIdentity"
                        ...
                        when "#microsoft.graph.sourceProvisionedIdentity"
                            return SourceProvisionedIdentity.new
                        when "#microsoft.graph.targetProvisionedIdentity"
