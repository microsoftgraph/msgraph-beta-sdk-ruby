    ...
    module Models
        ...
        class KeyRealValuePair < MicrosoftGraphBeta::Models::KeyTypedValuePair
            ...
            def get_field_deserializers()
                return super.merge({
                    "value" => lambda {|n| @value = n.get_object_value(lambda {|pn| KeyRealValuePair::KeyRealValuePairValue.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## @return a key_real_value_pair_value
            ## 
            def value
                return @value
            end
            ...
            class KeyRealValuePairValue
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return KeyRealValuePairValue.new
                end
                ## 
