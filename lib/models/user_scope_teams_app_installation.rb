...
module MicrosoftGraphBeta
    module Models
        class UserScopeTeamsAppInstallation < MicrosoftGraphBeta::Models::TeamsAppInstallation
            ...
            def get_field_deserializers()
                return super.merge({
                    "chat" => lambda {|n| @chat = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Chat.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
