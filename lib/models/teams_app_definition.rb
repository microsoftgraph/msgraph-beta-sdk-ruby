...
module MicrosoftGraphBeta
    module Models
        class TeamsAppDefinition < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a teams_app_definition_allowed_installation_scopes
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "allowedInstallationScopes" => lambda {|n| @allowed_installation_scopes = n.get_enum_value(MicrosoftGraphBeta::Models::TeamsAppDefinitionAllowedInstallationScopes) },
                    ...
                    "publishingState" => lambda {|n| @publishing_state = n.get_enum_value(MicrosoftGraphBeta::Models::TeamsAppDefinitionPublishingState) },
