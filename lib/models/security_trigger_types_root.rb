...
module MicrosoftGraphBeta
    module Models
        class SecurityTriggerTypesRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "retentionEventTypes" => lambda {|n| @retention_event_types = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityRetentionEventType.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
