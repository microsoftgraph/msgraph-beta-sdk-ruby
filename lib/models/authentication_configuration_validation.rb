    ...
    module Models
        class AuthenticationConfigurationValidation
            ...
            def get_field_deserializers()
                return {
                    "errors" => lambda {|n| @errors = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::GenericError.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "warnings" => lambda {|n| @warnings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::GenericError.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
