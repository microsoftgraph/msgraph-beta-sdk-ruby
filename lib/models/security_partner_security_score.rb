...
module MicrosoftGraphBeta
    module Models
        class Models.partner.securityPartnerSecurityScore < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a partner_security_score_current_score
            ## 
            def current_score
            ...
            def get_field_deserializers()
                return super.merge({
                    "currentScore" => lambda {|n| @current_score = n.get_object_value(lambda {|pn| Models::Partner::SecurityPartnerSecurityScore::PartnerSecurityScoreCurrentScore.create_from_discriminator_value(pn) }) },
                    ...
                    "maxScore" => lambda {|n| @max_score = n.get_object_value(lambda {|pn| Models::Partner::SecurityPartnerSecurityScore::PartnerSecurityScoreMaxScore.create_from_discriminator_value(pn) }) },
            ...
            ## @return a partner_security_score_max_score
            ## 
            def max_score
                return @max_score
            end
            ...
            class PartnerSecurityScoreCurrentScore
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return PartnerSecurityScoreCurrentScore.new
                end
                ## 
            ...
            ## 
            # Composed type wrapper for classes float, ReferenceNumeric, string
            class PartnerSecurityScoreMaxScore
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type float
                @float
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return PartnerSecurityScoreMaxScore.new
                end
                ## 
                ## Gets the float property value. Composed type representation for type float
                ## @return a float
