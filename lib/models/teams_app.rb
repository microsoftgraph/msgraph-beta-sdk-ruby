...
module MicrosoftGraphBeta
    module Models
        class TeamsApp < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "appDefinitions" => lambda {|n| @app_definitions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TeamsAppDefinition.create_from_discriminator_value(pn) }) },
                    "displayName" => lambda {|n| @display_name = n.get_string_value() },
                    "distributionMethod" => lambda {|n| @distribution_method = n.get_enum_value(MicrosoftGraphBeta::Models::TeamsAppDistributionMethod) },
