...
module MicrosoftGraphBeta
    module Models
        class IndustryDataIndustryDataRunStatistics
            ...
            ## 
            ## Instantiates a new industryDataIndustryDataRunStatistics and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            ## @return a industry_data_industry_data_run_statistics
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return IndustryDataIndustryDataRunStatistics.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "activityStatistics" => lambda {|n| @activity_statistics = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataIndustryDataActivityStatistics.create_from_discriminator_value(pn) }) },
                    "inboundTotals" => lambda {|n| @inbound_totals = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataAggregatedInboundStatistics.create_from_discriminator_value(pn) }) },
