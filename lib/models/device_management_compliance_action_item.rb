...
module MicrosoftGraphBeta
    module Models
        ...
        class DeviceManagementComplianceActionItem < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a device_management_compliance_action_type
            ## 
            def action_type
                return @action_type
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    "actionType" => lambda {|n| @action_type = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceManagementComplianceActionType) },
