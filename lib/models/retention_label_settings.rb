    ...
    module Models
        class RetentionLabelSettings
            ...
            def get_field_deserializers()
                return {
                    "behaviorDuringRetentionPeriod" => lambda {|n| @behavior_during_retention_period = n.get_enum_value(MicrosoftGraphBeta::Models::RetentionLabelSettingsBehaviorDuringRetentionPeriod) },
