...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceWorkflow < MicrosoftGraphBeta::Models::IdentityGovernanceWorkflowBase
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "executionScope" => lambda {|n| @execution_scope = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceUserProcessingResult.create_from_discriminator_value(pn) }) },
                    "id" => lambda {|n| @id = n.get_string_value() },
                    "nextScheduleRunDateTime" => lambda {|n| @next_schedule_run_date_time = n.get_date_time_value() },
                    "runs" => lambda {|n| @runs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceRun.create_from_discriminator_value(pn) }) },
                    "taskReports" => lambda {|n| @task_reports = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceTaskReport.create_from_discriminator_value(pn) }) },
                    ...
                    "versions" => lambda {|n| @versions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceWorkflowVersion.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
