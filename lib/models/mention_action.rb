...
module MicrosoftGraphBeta::Models
    class MentionAction
        ...
        def get_field_deserializers()
            return {
                "mentionees" => lambda {|n| @mentionees = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
        ...
        def serialize(writer)
            ...
            writer.write_collection_of_object_values("mentionees", @mentionees)
