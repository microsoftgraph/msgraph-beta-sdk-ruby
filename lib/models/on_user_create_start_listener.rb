...
module MicrosoftGraphBeta
    module Models
        class OnUserCreateStartListener < MicrosoftGraphBeta::Models::AuthenticationEventListener
            ...
            def get_field_deserializers()
                return super.merge({
                    "handler" => lambda {|n| @handler = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnUserCreateStartHandler.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
