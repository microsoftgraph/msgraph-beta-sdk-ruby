...
module MicrosoftGraphBeta
    module Models
        class SecurityIntelligenceProfile < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "countriesOrRegionsOfOrigin" => lambda {|n| @countries_or_regions_of_origin = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIntelligenceProfileCountryOrRegionOfOrigin.create_from_discriminator_value(pn) }) },
                    "description" => lambda {|n| @description = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityFormattedContent.create_from_discriminator_value(pn) }) },
                    "firstActiveDateTime" => lambda {|n| @first_active_date_time = n.get_date_time_value() },
                    "indicators" => lambda {|n| @indicators = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIntelligenceProfileIndicator.create_from_discriminator_value(pn) }) },
                    "kind" => lambda {|n| @kind = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityIntelligenceProfileKind) },
                    "summary" => lambda {|n| @summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityFormattedContent.create_from_discriminator_value(pn) }) },
                    "targets" => lambda {|n| @targets = n.get_collection_of_primitive_values(String) },
                    "title" => lambda {|n| @title = n.get_string_value() },
                    "tradecraft" => lambda {|n| @tradecraft = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityFormattedContent.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
