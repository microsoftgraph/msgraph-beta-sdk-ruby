...
module MicrosoftGraphBeta
    module Models
        class TimeClockSettings
            ...
            ## @param value Value to set for the approved_location property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return {
                    "approvedLocation" => lambda {|n| @approved_location = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::GeoCoordinates.create_from_discriminator_value(pn) }) },
