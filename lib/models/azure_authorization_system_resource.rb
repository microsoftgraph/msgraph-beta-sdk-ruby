...
module MicrosoftGraphBeta
    module Models
        class AzureAuthorizationSystemResource < MicrosoftGraphBeta::Models::AuthorizationSystemResource
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.azureAuthorizationSystemResource"
            end
            ## 
