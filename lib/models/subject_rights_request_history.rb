        ...
        class SubjectRightsRequestHistory
            ...
            def get_field_deserializers()
                return {
                    ...
                    "stage" => lambda {|n| @stage = n.get_enum_value(MicrosoftGraphBeta::Models::SubjectRightsRequestStage) },
                    "stageStatus" => lambda {|n| @stage_status = n.get_enum_value(MicrosoftGraphBeta::Models::SubjectRightsRequestStageStatus) },
