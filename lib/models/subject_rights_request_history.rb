    ...
    module Models
        class SubjectRightsRequestHistory
            ...
            def get_field_deserializers()
                return {
                    "changedBy" => lambda {|n| @changed_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                    "eventDateTime" => lambda {|n| @event_date_time = n.get_date_time_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "stage" => lambda {|n| @stage = n.get_enum_value(MicrosoftGraphBeta::Models::SubjectRightsRequestHistoryStage) },
                    "stageStatus" => lambda {|n| @stage_status = n.get_enum_value(MicrosoftGraphBeta::Models::SubjectRightsRequestHistoryStageStatus) },
