...
module MicrosoftGraphBeta
    module Models
        ...
        class DeliveryOptimizationBandwidth
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.deliveryOptimizationBandwidthAbsolute"
                            return DeliveryOptimizationBandwidthAbsolute.new
                        when "#microsoft.graph.deliveryOptimizationBandwidthHoursWithPercentage"
                            return DeliveryOptimizationBandwidthHoursWithPercentage.new
                        when "#microsoft.graph.deliveryOptimizationBandwidthPercentage"
                            return DeliveryOptimizationBandwidthPercentage.new
                    end
                end
                return DeliveryOptimizationBandwidth.new
            end
            ## 
