...
module MicrosoftGraphBeta
    module Models
        class EdiscoveryCase_escaped_escaped_escaped_escaped < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a ediscovery_case_escaped_escaped_escaped_escaped
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return EdiscoveryCase_escaped_escaped_escaped_escaped.new
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "custodians" => lambda {|n| @custodians = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryCustodian.create_from_discriminator_value(pn) }) },
                    ...
                    "legalHolds" => lambda {|n| @legal_holds = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryLegalHold.create_from_discriminator_value(pn) }) },
                    "noncustodialDataSources" => lambda {|n| @noncustodial_data_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryNoncustodialDataSource.create_from_discriminator_value(pn) }) },
                    "operations" => lambda {|n| @operations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryCaseOperation.create_from_discriminator_value(pn) }) },
                    "reviewSets" => lambda {|n| @review_sets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryReviewSet.create_from_discriminator_value(pn) }) },
                    "settings" => lambda {|n| @settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryCaseSettings.create_from_discriminator_value(pn) }) },
                    "sourceCollections" => lambda {|n| @source_collections = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoverySourceCollection.create_from_discriminator_value(pn) }) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::EdiscoveryCaseStatus) },
                    "tags" => lambda {|n| @tags = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryTag.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## @return a ediscovery_legal_hold
            ## 
            def legal_holds
                return @legal_holds
            end
            ...
            ## @return a ediscovery_case_operation
            ## 
            def operations
                return @operations
            end
            ...
            ## @return a ediscovery_case_status
            ## 
            def status
                return @status
            end
