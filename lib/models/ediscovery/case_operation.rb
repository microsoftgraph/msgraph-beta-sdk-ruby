...
module MicrosoftGraphBeta
    module Models
        module Ediscovery
            class CaseOperation < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "action" => lambda {|n| @action = n.get_enum_value(MicrosoftGraphBeta::Models::Ediscovery::CaseAction) },
                        ...
                        "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::Ediscovery::CaseOperationStatus) },
                    })
                end
                ## 
