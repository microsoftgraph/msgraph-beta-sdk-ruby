            ...
            class DataSourceContainer < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "holdStatus" => lambda {|n| @hold_status = n.get_enum_value(MicrosoftGraphBeta::Models::Ediscovery::DataSourceHoldStatus) },
                        "lastIndexOperation" => lambda {|n| @last_index_operation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::CaseIndexOperation.create_from_discriminator_value(pn) }) },
                        "lastModifiedDateTime" => lambda {|n| @last_modified_date_time = n.get_date_time_value() },
                        "releasedDateTime" => lambda {|n| @released_date_time = n.get_date_time_value() },
                        "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::Ediscovery::DataSourceContainerStatus) },
                    })
                end
                ## 
