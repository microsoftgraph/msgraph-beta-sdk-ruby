...
module MicrosoftGraphBeta
    module Models
        module Ediscovery
            class CaseExportOperation < MicrosoftGraphBeta::Models::Ediscovery::CaseOperation
                ...
                ## @param value Value to set for the azure_blob_container property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the azure_blob_token property.
                ## @return a void
                ## 
                ...
                ## @return a case_export_operation
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return CaseExportOperation.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "exportOptions" => lambda {|n| @export_options = n.get_enum_value(MicrosoftGraphBeta::Models::Ediscovery::ExportOptions) },
                        "exportStructure" => lambda {|n| @export_structure = n.get_enum_value(MicrosoftGraphBeta::Models::Ediscovery::ExportFileStructure) },
                ...
                ## @param value Value to set for the output_folder_id property.
                ## @return a void
                ## 
