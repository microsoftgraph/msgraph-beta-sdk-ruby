...
module MicrosoftGraphBeta::Models::Ediscovery
    class UnifiedGroupSource < MicrosoftGraphBeta::Models::Ediscovery::DataSource
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "includedSources" => lambda {|n| @included_sources = n.get_enum_value(MicrosoftGraphBeta::Models::Ediscovery::SourceType) },
            })
        end
        ## 
