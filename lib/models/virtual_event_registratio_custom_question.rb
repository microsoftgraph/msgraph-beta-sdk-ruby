...
module MicrosoftGraphBeta
    module Models
        class VirtualEventRegistratioCustomQuestion < MicrosoftGraphBeta::Models::VirtualEventRegistrationQuestionBase
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.virtualEventRegistratioCustomQuestion"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a virtual_event_registratio_custom_question
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return VirtualEventRegistratioCustomQuestion.new
            end
            ## 
