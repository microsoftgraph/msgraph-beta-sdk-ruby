        ...
        class MfaCompletionMetric < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "mfaFailures" => lambda {|n| @mfa_failures = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MfaFailure.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("mfaFailures", @mfa_failures)
