...
module MicrosoftGraphBeta
    module Models
        class InferenceData
            ...
            ## @return a inference_data_confidence_score
            ## 
            ...
            def get_field_deserializers()
                return {
                    "confidenceScore" => lambda {|n| @confidence_score = n.get_object_value(lambda {|pn| InferenceData::InferenceDataConfidenceScore.create_from_discriminator_value(pn) }) },
            ...
            class InferenceDataConfidenceScore
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return InferenceDataConfidenceScore.new
                end
                ## 
