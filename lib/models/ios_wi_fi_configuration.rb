...
module MicrosoftGraphBeta
    module Models
        class IosWiFiConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
            ...
            ## @return a ios_wi_fi_configuration
            ## 
            ...
            ## @return a boolean
            ## 
            def disable_mac_address_randomization
                return @disable_mac_address_randomization
            end
            ## 
            ...
            ## @param value Value to set for the disable_mac_address_randomization property.
            ## @return a void
            ## 
            def disable_mac_address_randomization=(value)
                @disable_mac_address_randomization = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "disableMacAddressRandomization" => lambda {|n| @disable_mac_address_randomization = n.get_boolean_value() },
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("disableMacAddressRandomization", @disable_mac_address_randomization)
