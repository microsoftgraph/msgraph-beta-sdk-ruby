    ...
    class IncomingContext
        ...
        def get_field_deserializers()
            return {
                ...
                "onBehalfOf" => lambda {|n| @on_behalf_of = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                "sourceParticipantId" => lambda {|n| @source_participant_id = n.get_string_value() },
                "transferor" => lambda {|n| @transferor = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
