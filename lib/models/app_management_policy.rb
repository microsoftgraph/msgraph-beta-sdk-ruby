        ...
        class AppManagementPolicy < MicrosoftGraphBeta::Models::PolicyBase
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "restrictions" => lambda {|n| @restrictions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CustomAppManagementConfiguration.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
