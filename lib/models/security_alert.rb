...
module MicrosoftGraphBeta
    module Models
        class SecurityAlert < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "additionalData" => lambda {|n| @additional_data_property = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityDictionary.create_from_discriminator_value(pn) }) },
                    ...
                    "detectionSource" => lambda {|n| @detection_source = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityDetectionSource) },
                    ...
                    "evidence" => lambda {|n| @evidence = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityAlertEvidence.create_from_discriminator_value(pn) }) },
                    ...
                    "serviceSource" => lambda {|n| @service_source = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityServiceSource) },
                    "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityAlertSeverity) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityAlertStatus) },
