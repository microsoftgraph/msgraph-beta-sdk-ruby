...
module MicrosoftGraphBeta
    module Models
        class WorkbookChartAxis < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "format" => lambda {|n| @format = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartAxisFormat.create_from_discriminator_value(pn) }) },
                    "majorGridlines" => lambda {|n| @major_gridlines = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartGridlines.create_from_discriminator_value(pn) }) },
                    "majorUnit" => lambda {|n| @major_unit = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                    "maximum" => lambda {|n| @maximum = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                    "minimum" => lambda {|n| @minimum = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                    "minorGridlines" => lambda {|n| @minor_gridlines = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartGridlines.create_from_discriminator_value(pn) }) },
                    "minorUnit" => lambda {|n| @minor_unit = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                    "title" => lambda {|n| @title = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartAxisTitle.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
