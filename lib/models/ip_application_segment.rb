...
module MicrosoftGraphBeta
    module Models
        class IpApplicationSegment < MicrosoftGraphBeta::Models::ApplicationSegment
            ...
            ## @return a ip_application_segment_destination_type
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "destinationType" => lambda {|n| @destination_type = n.get_enum_value(MicrosoftGraphBeta::Models::IpApplicationSegmentDestinationType) },
                    "port" => lambda {|n| @port = n.get_number_value() },
                    "ports" => lambda {|n| @ports = n.get_collection_of_primitive_values(String) },
                    "protocol" => lambda {|n| @protocol = n.get_enum_value(MicrosoftGraphBeta::Models::IpApplicationSegmentProtocol) },
                })
            end
            ## 
            ...
            ## @return a ip_application_segment_protocol
            ## 
            def protocol
                return @protocol
            end
