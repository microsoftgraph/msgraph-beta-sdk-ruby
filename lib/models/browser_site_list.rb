...
module MicrosoftGraphBeta
    module Models
        ...
        class BrowserSiteList < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "publishedBy" => lambda {|n| @published_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                    "publishedDateTime" => lambda {|n| @published_date_time = n.get_date_time_value() },
                    "revision" => lambda {|n| @revision = n.get_string_value() },
                    "sharedCookies" => lambda {|n| @shared_cookies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BrowserSharedCookie.create_from_discriminator_value(pn) }) },
                    "sites" => lambda {|n| @sites = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BrowserSite.create_from_discriminator_value(pn) }) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::BrowserSiteListStatus) },
                })
            end
            ## 
