...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceRun < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "userProcessingResults" => lambda {|n| @user_processing_results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceUserProcessingResult.create_from_discriminator_value(pn) }) },
