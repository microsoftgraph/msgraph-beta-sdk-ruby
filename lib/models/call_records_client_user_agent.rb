...
module MicrosoftGraphBeta
    module Models
        class CallRecordsClientUserAgent < MicrosoftGraphBeta::Models::CallRecordsUserAgent
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "platform" => lambda {|n| @platform = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsClientPlatform) },
                    "productFamily" => lambda {|n| @product_family = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsProductFamily) },
                })
            end
            ## 
