...
module MicrosoftGraphBeta
    module Models
        class MailboxRestoreArtifact < MicrosoftGraphBeta::Models::RestoreArtifactBase
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "restoredItemCount" => lambda {|n| @restored_item_count = n.get_number_value() },
                })
            end
            ## 
            ...
            ## @return a integer
            ## 
            def restored_item_count
                return @restored_item_count
            end
            ## 
            ...
            ## @return a void
            ## 
            def restored_item_count=(value)
                @restored_item_count = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_number_value("restoredItemCount", @restored_item_count)
            end
        end
    end
end
