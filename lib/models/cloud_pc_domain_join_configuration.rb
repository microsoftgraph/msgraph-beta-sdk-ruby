...
module MicrosoftGraphBeta
    module Models
        class CloudPcDomainJoinConfiguration
            ...
            ## @return a cloud_pc_domain_join_configuration_domain_join_type
            ## 
            ...
            def get_field_deserializers()
                return {
                    "domainJoinType" => lambda {|n| @domain_join_type = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcDomainJoinConfigurationDomainJoinType) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "onPremisesConnectionId" => lambda {|n| @on_premises_connection_id = n.get_string_value() },
                    "regionGroup" => lambda {|n| @region_group = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcDomainJoinConfigurationRegionGroup) },
                    "regionName" => lambda {|n| @region_name = n.get_string_value() },
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcDomainJoinConfigurationType) },
                }
            end
            ## 
            ...
            ## @return a cloud_pc_domain_join_configuration_region_group
            ## 
            def region_group
                return @region_group
            end
            ...
            ## @return a cloud_pc_domain_join_configuration_type
            ## 
            def type
                return @type
            end
