...
module MicrosoftGraphBeta
    module Models
        class Subscription < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "notificationContentType" => lambda {|n| @notification_content_type = n.get_string_value() },
            ...
            ## @param value Value to set for the notification_content_type property.
            ## @return a void
            ## 
            def notification_content_type=(value)
                @notification_content_type = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("notificationContentType", @notification_content_type)
