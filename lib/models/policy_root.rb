    ...
    module Models
        class PolicyRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def federated_token_validation_policy
                return @federated_token_validation_policy
            end
            ## 
            ...
            ## @return a void
            ## 
            def federated_token_validation_policy=(value)
                @federated_token_validation_policy = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "federatedTokenValidationPolicy" => lambda {|n| @federated_token_validation_policy = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::FederatedTokenValidationPolicy.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("federatedTokenValidationPolicy", @federated_token_validation_policy)
