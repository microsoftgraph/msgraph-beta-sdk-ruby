...
module MicrosoftGraphBeta
    module Models
        class ScheduleChangeRequest < MicrosoftGraphBeta::Models::ChangeTrackedEntity
            ...
            def get_field_deserializers()
                return super.merge({
                    "assignedTo" => lambda {|n| @assigned_to = n.get_enum_value(MicrosoftGraphBeta::Models::ScheduleChangeRequestAssignedTo) },
                    ...
                    "state" => lambda {|n| @state = n.get_enum_value(MicrosoftGraphBeta::Models::ScheduleChangeRequestState) },
                })
            end
            ## 
