...
module MicrosoftGraphBeta
    module Models
        class DelegatedAdminAccessAssignment < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "accessContainer" => lambda {|n| @access_container = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DelegatedAdminAccessContainer.create_from_discriminator_value(pn) }) },
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::DelegatedAdminAccessAssignmentStatus) },
                })
            end
            ## 
