...
module MicrosoftGraphBeta
    module Models
        class CloudPcAuditEvent < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "activityOperationType" => lambda {|n| @activity_operation_type = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcAuditActivityOperationType) },
                    "activityResult" => lambda {|n| @activity_result = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcAuditActivityResult) },
                    "activityType" => lambda {|n| @activity_type = n.get_string_value() },
                    "actor" => lambda {|n| @actor = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CloudPcAuditActor.create_from_discriminator_value(pn) }) },
                    "category" => lambda {|n| @category = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcAuditCategory) },
                    ...
                    "resources" => lambda {|n| @resources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CloudPcAuditResource.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
