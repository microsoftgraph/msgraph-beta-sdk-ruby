        ...
        class MultiTenantOrganizationJoinRequestRecord < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "memberState" => lambda {|n| @member_state = n.get_enum_value(MicrosoftGraphBeta::Models::MultiTenantOrganizationJoinRequestRecordMemberState) },
                    "role" => lambda {|n| @role = n.get_enum_value(MicrosoftGraphBeta::Models::MultiTenantOrganizationJoinRequestRecordRole) },
            ...
            ## @return a multi_tenant_organization_join_request_record_member_state
            ## 
            def member_state
                return @member_state
            end
            ...
            ## @return a multi_tenant_organization_join_request_record_role
            ## 
            def role
                return @role
            end
