    ...
    module Models
        class AccessReviewScheduleSettings
            ...
            def get_field_deserializers()
                return {
                    "applyActions" => lambda {|n| @apply_actions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewApplyAction.create_from_discriminator_value(pn) }) },
