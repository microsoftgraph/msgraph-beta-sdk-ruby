...
module MicrosoftGraphBeta
    module Models
        class SharedPCConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
            ...
            ## @return a enablement
            ## 
            def fast_first_sign_in
                return @fast_first_sign_in
            end
            ## 
            ## Sets the fastFirstSignIn property value. Possible values of a property
            ## @param value Value to set for the fast_first_sign_in property.
            ## @return a void
            ## 
            def fast_first_sign_in=(value)
                @fast_first_sign_in = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "fastFirstSignIn" => lambda {|n| @fast_first_sign_in = n.get_enum_value(MicrosoftGraphBeta::Models::Enablement) },
                    ...
                    "localStorage" => lambda {|n| @local_storage = n.get_enum_value(MicrosoftGraphBeta::Models::Enablement) },
                    "maintenanceStartTime" => lambda {|n| @maintenance_start_time = n.get_time_value() },
                    "setAccountManager" => lambda {|n| @set_account_manager = n.get_enum_value(MicrosoftGraphBeta::Models::Enablement) },
                    "setEduPolicies" => lambda {|n| @set_edu_policies = n.get_enum_value(MicrosoftGraphBeta::Models::Enablement) },
                    "setPowerPolicies" => lambda {|n| @set_power_policies = n.get_enum_value(MicrosoftGraphBeta::Models::Enablement) },
                    "signInOnResume" => lambda {|n| @sign_in_on_resume = n.get_enum_value(MicrosoftGraphBeta::Models::Enablement) },
                })
            end
            ## 
            ...
            ## @param value Value to set for the local_storage property.
            ## @return a void
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("fastFirstSignIn", @fast_first_sign_in)
                ...
                writer.write_enum_value("localStorage", @local_storage)
                writer.write_time_value("maintenanceStartTime", @maintenance_start_time)
                writer.write_enum_value("setAccountManager", @set_account_manager)
                writer.write_enum_value("setEduPolicies", @set_edu_policies)
                writer.write_enum_value("setPowerPolicies", @set_power_policies)
                writer.write_enum_value("signInOnResume", @sign_in_on_resume)
            end
            ## 
            ...
            def set_account_manager
                return @set_account_manager
            end
            ## 
            ## Sets the setAccountManager property value. Possible values of a property
            ## @param value Value to set for the set_account_manager property.
            ## @return a void
            ## 
            def set_account_manager=(value)
                @set_account_manager = value
            end
            ## 
            ## Gets the setEduPolicies property value. Possible values of a property
            ## @return a enablement
            ## 
            def set_edu_policies
                return @set_edu_policies
            end
            ## 
            ## Sets the setEduPolicies property value. Possible values of a property
            ## @param value Value to set for the set_edu_policies property.
            ## @return a void
            ## 
            def set_edu_policies=(value)
                @set_edu_policies = value
            end
            ## 
            ## Gets the setPowerPolicies property value. Possible values of a property
            ## @return a enablement
            ## 
            def set_power_policies
                return @set_power_policies
            end
            ## 
            ## Sets the setPowerPolicies property value. Possible values of a property
            ## @param value Value to set for the set_power_policies property.
            ## @return a void
            ## 
            def set_power_policies=(value)
                @set_power_policies = value
            end
            ## 
            ## Gets the signInOnResume property value. Possible values of a property
            ## @return a enablement
            ## 
            def sign_in_on_resume
                return @sign_in_on_resume
            end
            ## 
            ## Sets the signInOnResume property value. Possible values of a property
            ## @param value Value to set for the sign_in_on_resume property.
            ## @return a void
            ## 
            def sign_in_on_resume=(value)
                @sign_in_on_resume = value
            end
        end
    end
end
