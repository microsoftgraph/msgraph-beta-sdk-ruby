    ...
    module Models
        class CrossTenantAccessPolicyB2BSetting
            ...
            def get_field_deserializers()
                return {
                    "applications" => lambda {|n| @applications = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CrossTenantAccessPolicyTargetConfiguration.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "usersAndGroups" => lambda {|n| @users_and_groups = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CrossTenantAccessPolicyTargetConfiguration.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
