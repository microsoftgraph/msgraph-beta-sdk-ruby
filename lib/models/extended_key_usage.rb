        ...
        class ExtendedKeyUsage
            ...
            def get_field_deserializers()
                return {
                    ...
                    "objectIdentifier" => lambda {|n| @object_identifier = n.get_string_value() },
            ...
            ## @param value Value to set for the object_identifier property.
            ## @return a void
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("objectIdentifier", @object_identifier)
