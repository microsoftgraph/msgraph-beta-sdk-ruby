...
module MicrosoftGraphBeta
    module Models
        class FederatedIdentityCredential < MicrosoftGraphBeta::Models::Entity
            ...
            ## 
            def claims_matching_expression
                return @claims_matching_expression
            end
            ## 
            ...
            ## @return a void
            ## 
            def claims_matching_expression=(value)
                @claims_matching_expression = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "claimsMatchingExpression" => lambda {|n| @claims_matching_expression = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::FederatedIdentityExpression.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("claimsMatchingExpression", @claims_matching_expression)
