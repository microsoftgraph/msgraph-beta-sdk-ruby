...
module MicrosoftGraphBeta
    module Models
        class ConditionalAccessSessionControls
            ...
            ## 
            def continuous_access_evaluation
                return @continuous_access_evaluation
            end
            ## 
            ## Sets the continuousAccessEvaluation property value. Session control for continuous access evaluation settings.
            ## @param value Value to set for the continuous_access_evaluation property.
            ## @return a void
            ## 
            def continuous_access_evaluation=(value)
                @continuous_access_evaluation = value
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "applicationEnforcedRestrictions" => lambda {|n| @application_enforced_restrictions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ApplicationEnforcedRestrictionsSessionControl.create_from_discriminator_value(pn) }) },
                    "cloudAppSecurity" => lambda {|n| @cloud_app_security = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CloudAppSecuritySessionControl.create_from_discriminator_value(pn) }) },
                    "continuousAccessEvaluation" => lambda {|n| @continuous_access_evaluation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ContinuousAccessEvaluationSessionControl.create_from_discriminator_value(pn) }) },
                    "disableResilienceDefaults" => lambda {|n| @disable_resilience_defaults = n.get_boolean_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "persistentBrowser" => lambda {|n| @persistent_browser = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PersistentBrowserSessionControl.create_from_discriminator_value(pn) }) },
                    "secureSignInSession" => lambda {|n| @secure_sign_in_session = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecureSignInSessionControl.create_from_discriminator_value(pn) }) },
                    "signInFrequency" => lambda {|n| @sign_in_frequency = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SignInFrequencySessionControl.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            ## @param value Value to set for the secure_sign_in_session property.
            ## @return a void
            ## 
            def secure_sign_in_session=(value)
                @secure_sign_in_session = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("continuousAccessEvaluation", @continuous_access_evaluation)
                ...
                writer.write_object_value("secureSignInSession", @secure_sign_in_session)
