...
module MicrosoftGraphBeta
    module Models
        class Customer < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the tax_area_display_name property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the tax_area_id property.
            ## @return a void
            ## 
