...
module MicrosoftGraphBeta
    module Models
        class SecuritySensitivityLabel < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "parent" => lambda {|n| @parent = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecuritySensitivityLabel.create_from_discriminator_value(pn) }) },
