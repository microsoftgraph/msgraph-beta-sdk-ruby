...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdatesItemBody
            ...
            ## 
            ## Instantiates a new WindowsUpdatesItemBody and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            ## @return a windows_updates_body_type
            ## 
            def content_type
                return @content_type
            end
            ...
            ## @return a windows_updates_item_body
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return WindowsUpdatesItemBody.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "contentType" => lambda {|n| @content_type = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUpdatesBodyType) },
