...
module MicrosoftGraphBeta
    module Models
        class IndustryDataIndustryDataRunActivity < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a industry_data_industry_data_activity
            ## 
            def activity
                return @activity
            end
            ...
            ## 
            ## Instantiates a new IndustryDataIndustryDataRunActivity and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            def get_field_deserializers()
                return super.merge({
                    "activity" => lambda {|n| @activity = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataIndustryDataActivity.create_from_discriminator_value(pn) }) },
