...
module MicrosoftGraphBeta
    module Models
        ...
        class WindowsWifiConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
            ...
            ## @param value Value to set for the connect_to_preferred_network property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the metered_connection_limit property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the proxy_setting property.
            ## @return a void
            ## 
