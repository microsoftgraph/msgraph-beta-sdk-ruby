...
require_relative './search/acronym'
require_relative './search/bookmark'
require_relative './search/qna'
    ...
    module Models
        class SearchEntity < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "acronyms" => lambda {|n| @acronyms = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Search::Acronym.create_from_discriminator_value(pn) }) },
                    "bookmarks" => lambda {|n| @bookmarks = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Search::Bookmark.create_from_discriminator_value(pn) }) },
                    "qnas" => lambda {|n| @qnas = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Search::Qna.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
