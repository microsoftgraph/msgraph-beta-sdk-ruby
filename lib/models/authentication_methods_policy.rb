        ...
        class AuthenticationMethodsPolicy < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "reportSuspiciousActivitySettings" => lambda {|n| @report_suspicious_activity_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ReportSuspiciousActivitySettings.create_from_discriminator_value(pn) }) },
                    "systemCredentialPreferences" => lambda {|n| @system_credential_preferences = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SystemCredentialPreferences.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## 
            def report_suspicious_activity_settings
                return @report_suspicious_activity_settings
            end
            ## 
            ...
            ## @param value Value to set for the report_suspicious_activity_settings property.
            ## @return a void
            ## 
            def report_suspicious_activity_settings=(value)
                @report_suspicious_activity_settings = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("reportSuspiciousActivitySettings", @report_suspicious_activity_settings)
                writer.write_object_value("systemCredentialPreferences", @system_credential_preferences)
            end
            ## 
            ...
            ## @return a system_credential_preferences
            ## 
            def system_credential_preferences
                return @system_credential_preferences
            end
            ## 
            ...
            ## @param value Value to set for the system_credential_preferences property.
            ## @return a void
            ## 
            def system_credential_preferences=(value)
                @system_credential_preferences = value
            end
        end
    end
end
