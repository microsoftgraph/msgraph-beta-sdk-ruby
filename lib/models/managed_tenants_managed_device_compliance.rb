...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsManagedDeviceCompliance < MicrosoftGraphBeta::Models::Entity
            ...
            ## 
            ## Instantiates a new ManagedTenantsManagedDeviceCompliance and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
