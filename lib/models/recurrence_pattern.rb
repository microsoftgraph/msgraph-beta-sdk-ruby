        ...
        class RecurrencePattern
            ...
            def get_field_deserializers()
                return {
                    ...
                    "daysOfWeek" => lambda {|n| @days_of_week = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RecurrencePatternDaysOfWeek.create_from_discriminator_value(pn) }) },
                    "firstDayOfWeek" => lambda {|n| @first_day_of_week = n.get_enum_value(MicrosoftGraphBeta::Models::RecurrencePatternFirstDayOfWeek) },
                    "index" => lambda {|n| @index = n.get_enum_value(MicrosoftGraphBeta::Models::RecurrencePatternIndex) },
                    "interval" => lambda {|n| @interval = n.get_number_value() },
                    "month" => lambda {|n| @month = n.get_number_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::RecurrencePatternType) },
                }
            end
            ## 
