        ...
        class RecurrencePattern
            ...
            def get_field_deserializers()
                return {
                    ...
                    "daysOfWeek" => lambda {|n| @days_of_week = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DayOfWeek.create_from_discriminator_value(pn) }) },
                    "firstDayOfWeek" => lambda {|n| @first_day_of_week = n.get_enum_value(MicrosoftGraphBeta::Models::DayOfWeek) },
                    "index" => lambda {|n| @index = n.get_enum_value(MicrosoftGraphBeta::Models::WeekIndex) },
