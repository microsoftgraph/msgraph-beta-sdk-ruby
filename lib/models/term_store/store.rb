...
module MicrosoftGraphBeta
    module Models
        module TermStore
            class Store < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "groups" => lambda {|n| @groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Group.create_from_discriminator_value(pn) }) },
