...
module MicrosoftGraphBeta
    module Models
        module TermStore
            class Relation < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "fromTerm" => lambda {|n| @from_term = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Term.create_from_discriminator_value(pn) }) },
                        "relationship" => lambda {|n| @relationship = n.get_enum_value(MicrosoftGraphBeta::Models::TermStore::RelationType) },
                        "set" => lambda {|n| @set = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Set.create_from_discriminator_value(pn) }) },
                        "toTerm" => lambda {|n| @to_term = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Term.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
