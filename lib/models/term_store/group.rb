...
module MicrosoftGraphBeta
    module Models
        module TermStore
            class Group < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "scope" => lambda {|n| @scope = n.get_enum_value(MicrosoftGraphBeta::Models::TermStore::TermGroupScope) },
                        "sets" => lambda {|n| @sets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Set.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
