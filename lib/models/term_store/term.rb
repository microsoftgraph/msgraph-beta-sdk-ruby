...
module MicrosoftGraphBeta::Models::TermStore
    class Term < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "descriptions" => lambda {|n| @descriptions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::LocalizedDescription.create_from_discriminator_value(pn) }) },
                "labels" => lambda {|n| @labels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::LocalizedLabel.create_from_discriminator_value(pn) }) },
                ...
                "set" => lambda {|n| @set = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Set.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
