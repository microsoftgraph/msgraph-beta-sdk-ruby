...
module MicrosoftGraphBeta
    module Models
        class SecurityAnalyzedEmailDlpRuleInfo
            ...
            ## 
            ## Instantiates a new SecurityAnalyzedEmailDlpRuleInfo and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return SecurityAnalyzedEmailDlpRuleInfo.new
            end
            ## 
