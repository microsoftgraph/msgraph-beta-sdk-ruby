...
module MicrosoftGraphBeta
    module Models
        class OnlineMeetingBase < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a online_meeting_base_anonymize_identity_for_roles
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "allowMeetingChat" => lambda {|n| @allow_meeting_chat = n.get_enum_value(MicrosoftGraphBeta::Models::OnlineMeetingBaseAllowMeetingChat) },
                    ...
                    "allowedPresenters" => lambda {|n| @allowed_presenters = n.get_enum_value(MicrosoftGraphBeta::Models::OnlineMeetingBaseAllowedPresenters) },
                    "anonymizeIdentityForRoles" => lambda {|n| @anonymize_identity_for_roles = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OnlineMeetingBaseAnonymizeIdentityForRoles.create_from_discriminator_value(pn) }) },
                    ...
                    "shareMeetingChatHistoryDefault" => lambda {|n| @share_meeting_chat_history_default = n.get_enum_value(MicrosoftGraphBeta::Models::OnlineMeetingBaseShareMeetingChatHistoryDefault) },
