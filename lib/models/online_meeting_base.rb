...
module MicrosoftGraphBeta
    module Models
        class OnlineMeetingBase < MicrosoftGraphBeta::Models::Entity
            ...
            @allow_copying_and_sharing_meeting_content
            ## 
            ...
            ## @return a boolean
            ## 
            def allow_copying_and_sharing_meeting_content
                return @allow_copying_and_sharing_meeting_content
            end
            ## 
            ...
            ## @return a void
            ## 
            def allow_copying_and_sharing_meeting_content=(value)
                @allow_copying_and_sharing_meeting_content = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "allowCopyingAndSharingMeetingContent" => lambda {|n| @allow_copying_and_sharing_meeting_content = n.get_boolean_value() },
                    "allowLiveShare" => lambda {|n| @allow_live_share = n.get_enum_value(MicrosoftGraphBeta::Models::MeetingLiveShareOptions) },
                    ...
                    "allowedLobbyAdmitters" => lambda {|n| @allowed_lobby_admitters = n.get_enum_value(MicrosoftGraphBeta::Models::AllowedLobbyAdmitterRoles) },
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("allowCopyingAndSharingMeetingContent", @allow_copying_and_sharing_meeting_content)
