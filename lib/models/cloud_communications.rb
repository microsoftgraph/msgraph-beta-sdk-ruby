...
module MicrosoftGraphBeta::Models
    class CloudCommunications < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "callRecords" => lambda {|n| @call_records = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecords::CallRecord.create_from_discriminator_value(pn) }) },
                ...
                "presences" => lambda {|n| @presences = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Presence.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
