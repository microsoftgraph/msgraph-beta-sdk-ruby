    ...
    module Models
        class CloudCommunications
            ...
            def get_field_deserializers()
                return {
                    "callRecords" => lambda {|n| @call_records = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsCallRecord.create_from_discriminator_value(pn) }) },
