...
module MicrosoftGraphBeta
    module Models
        class TodoTask < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "attachmentSessions" => lambda {|n| @attachment_sessions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AttachmentSession.create_from_discriminator_value(pn) }) },
                    "attachments" => lambda {|n| @attachments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AttachmentBase.create_from_discriminator_value(pn) }) },
                    ...
                    "checklistItems" => lambda {|n| @checklist_items = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ChecklistItem.create_from_discriminator_value(pn) }) },
                    ...
                    "linkedResources" => lambda {|n| @linked_resources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::LinkedResource.create_from_discriminator_value(pn) }) },
