    ...
    module Models
        class SiteCollection
            ...
            def get_field_deserializers()
                return {
                    "archivalDetails" => lambda {|n| @archival_details = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SiteArchivalDetails.create_from_discriminator_value(pn) }) },
