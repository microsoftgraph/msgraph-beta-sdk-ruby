    ...
    class SearchQuery
        ...
        def get_field_deserializers()
            return {
                ...
                "query_string" => lambda {|n| @query_string = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SearchQueryString.create_from_discriminator_value(pn) }) },
        ...
        def serialize(writer)
            ...
            writer.write_object_value("query_string", @query_string)
