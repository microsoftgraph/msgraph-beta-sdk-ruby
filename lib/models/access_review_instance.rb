...
module MicrosoftGraphBeta
    module Models
        class AccessReviewInstance < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "contactedReviewers" => lambda {|n| @contacted_reviewers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewReviewer.create_from_discriminator_value(pn) }) },
                    ...
                    "definition" => lambda {|n| @definition = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewScheduleDefinition.create_from_discriminator_value(pn) }) },
                    "endDateTime" => lambda {|n| @end_date_time = n.get_date_time_value() },
                    "errors" => lambda {|n| @errors = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewError.create_from_discriminator_value(pn) }) },
                    ...
                    "stages" => lambda {|n| @stages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewStage.create_from_discriminator_value(pn) }) },
