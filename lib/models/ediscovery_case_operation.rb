...
module MicrosoftGraphBeta
    module Models
        class EdiscoveryCaseOperation < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a ediscovery_case_operation_action
            ## 
            def action
                return @action
            end
            ...
            ## 
            ## Instantiates a new ediscoveryCaseOperation and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            def get_field_deserializers()
                return super.merge({
                    "action" => lambda {|n| @action = n.get_enum_value(MicrosoftGraphBeta::Models::EdiscoveryCaseOperationAction) },
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::EdiscoveryCaseOperationStatus) },
                })
            end
            ## 
            ...
            ## @return a ediscovery_case_operation_status
            ## 
            def status
                return @status
            end
