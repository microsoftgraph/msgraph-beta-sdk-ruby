        ...
        class NetworkaccessNetworkAccessTraffic
            ...
            def get_field_deserializers()
                return {
                    ...
                    "httpMethod" => lambda {|n| @http_method = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkaccessHttpMethod) },
                    ...
                    "operationStatus" => lambda {|n| @operation_status = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkaccessNetworkTrafficOperationStatus) },
                    ...
                    "popProcessingRegion" => lambda {|n| @pop_processing_region = n.get_string_value() },
                    ...
                    "responseCode" => lambda {|n| @response_code = n.get_number_value() },
                    ...
                    "vendorNames" => lambda {|n| @vendor_names = n.get_collection_of_primitive_values(String) },
                }
            end
            ## 
            ...
            ## @return a networkaccess_http_method
            ## 
            def http_method
                return @http_method
            end
            ...
            ## @return a networkaccess_network_traffic_operation_status
            ## 
            ...
            ## @return a string
            ## 
            def pop_processing_region
                return @pop_processing_region
            end
            ## 
            ...
            ## @return a void
            ## 
            def pop_processing_region=(value)
                @pop_processing_region = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("httpMethod", @http_method)
                ...
                writer.write_string_value("popProcessingRegion", @pop_processing_region)
                ...
                writer.write_number_value("responseCode", @response_code)
                ...
                writer.write_collection_of_primitive_values("vendorNames", @vendor_names)
