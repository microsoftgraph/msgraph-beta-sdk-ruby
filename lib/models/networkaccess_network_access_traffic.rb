...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessNetworkAccessTraffic
            ...
            ## @return a networkaccess_network_access_traffic_action
            ## 
            def action
                return @action
            end
            ...
            ## @return a networkaccess_network_access_traffic_device_category
            ## 
            def device_category
            ...
            def get_field_deserializers()
                return {
                    "action" => lambda {|n| @action = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkaccessNetworkAccessTrafficAction) },
                    ...
                    "deviceCategory" => lambda {|n| @device_category = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkaccessNetworkAccessTrafficDeviceCategory) },
                    ...
                    "networkProtocol" => lambda {|n| @network_protocol = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkaccessNetworkAccessTrafficNetworkProtocol) },
                    ...
                    "transportProtocol" => lambda {|n| @transport_protocol = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkaccessNetworkAccessTrafficTransportProtocol) },
            ...
            ## @return a networkaccess_network_access_traffic_network_protocol
            ## 
            ...
            ## @return a networkaccess_network_access_traffic_transport_protocol
            ## 
