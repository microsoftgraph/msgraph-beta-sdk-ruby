        ...
        class AttributeDefinition
            ...
            def get_field_deserializers()
                return {
                    ...
                    "apiExpressions" => lambda {|n| @api_expressions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::StringKeyStringValuePair.create_from_discriminator_value(pn) }) },
                    ...
                    "metadata" => lambda {|n| @metadata = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AttributeDefinitionMetadataEntry.create_from_discriminator_value(pn) }) },
                    "multivalued" => lambda {|n| @multivalued = n.get_boolean_value() },
                    "mutability" => lambda {|n| @mutability = n.get_enum_value(MicrosoftGraphBeta::Models::Mutability) },
                    "name" => lambda {|n| @name = n.get_string_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "referencedObjects" => lambda {|n| @referenced_objects = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ReferencedObject.create_from_discriminator_value(pn) }) },
