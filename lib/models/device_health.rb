...
module MicrosoftGraphBeta::Models
    class DeviceHealth
        ...
        def get_field_deserializers()
            return {
                "lastConnectionTime" => lambda {|n| @last_connection_time = n.get_date_time_value() },
        ...
        ## @param value Value to set for the last_connection_time property.
        ## @return a void
        ## 
        def last_connection_time=(value)
            @last_connection_time = value
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_date_time_value("lastConnectionTime", @last_connection_time)
