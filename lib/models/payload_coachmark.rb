...
module MicrosoftGraphBeta::Models
    class PayloadCoachmark
        ...
        ## @param value Value to set for the coachmark_location property.
        ## @return a void
        ## 
        ...
        def get_field_deserializers()
            return {
                "coachmarkLocation" => lambda {|n| @coachmark_location = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CoachmarkLocation.create_from_discriminator_value(pn) }) },
        ...
        ## @param value Value to set for the is_valid property.
        ## @return a void
        ## 
        def is_valid=(value)
            @is_valid = value
