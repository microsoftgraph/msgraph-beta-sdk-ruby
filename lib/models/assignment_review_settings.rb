...
module MicrosoftGraphBeta
    module Models
        class AssignmentReviewSettings
            ...
            ## @return a assignment_review_settings_access_review_timeout_behavior
            ## 
            ...
            def get_field_deserializers()
                return {
                    "accessReviewTimeoutBehavior" => lambda {|n| @access_review_timeout_behavior = n.get_enum_value(MicrosoftGraphBeta::Models::AssignmentReviewSettingsAccessReviewTimeoutBehavior) },
