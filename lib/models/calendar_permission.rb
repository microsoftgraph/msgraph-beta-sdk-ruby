...
module MicrosoftGraphBeta
    module Models
        class CalendarPermission < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "allowedRoles" => lambda {|n| @allowed_roles = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CalendarPermissionAllowedRoles.create_from_discriminator_value(pn) }) },
                    "emailAddress" => lambda {|n| @email_address = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EmailAddress.create_from_discriminator_value(pn) }) },
                    ...
                    "role" => lambda {|n| @role = n.get_enum_value(MicrosoftGraphBeta::Models::CalendarPermissionRole) },
                })
            end
            ## 
