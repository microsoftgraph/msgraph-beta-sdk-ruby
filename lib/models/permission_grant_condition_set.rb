...
module MicrosoftGraphBeta::Models
    class PermissionGrantConditionSet < MicrosoftGraphBeta::Models::Entity
        ...
        @certified_client_applications_only
        ## 
        ...
        ## @return a boolean
        ## 
        def certified_client_applications_only
            return @certified_client_applications_only
        end
        ## 
        ...
        ## @param value Value to set for the certified_client_applications_only property.
        ## @return a void
        ## 
        def certified_client_applications_only=(value)
            @certified_client_applications_only = value
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                "certifiedClientApplicationsOnly" => lambda {|n| @certified_client_applications_only = n.get_boolean_value() },
        ...
        def serialize(writer)
            ...
            super
            writer.write_boolean_value("certifiedClientApplicationsOnly", @certified_client_applications_only)
