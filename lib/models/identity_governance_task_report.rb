...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceTaskReport < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "task" => lambda {|n| @task = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceTask.create_from_discriminator_value(pn) }) },
                    "taskDefinition" => lambda {|n| @task_definition = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceTaskDefinition.create_from_discriminator_value(pn) }) },
