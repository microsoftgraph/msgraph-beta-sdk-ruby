...
module MicrosoftGraphBeta::Models
    class AndroidForWorkCustomConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
        ...
        def get_field_deserializers()
            return super.merge({
                "omaSettings" => lambda {|n| @oma_settings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OmaSetting.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
