...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsCredentialUserRegistrationsSummary < MicrosoftGraphBeta::Models::Entity
            ...
            @total_user_count
            ## 
            ## Instantiates a new ManagedTenantsCredentialUserRegistrationsSummary and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "tenantLicenseType" => lambda {|n| @tenant_license_type = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_string_value("tenantLicenseType", @tenant_license_type)
            ...
            ## @return a void
            ## 
            def tenant_license_type=(value)
                @tenant_license_type = value
            end
            ## 
