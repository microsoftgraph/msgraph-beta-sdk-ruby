    ...
    class DeviceHealthScript < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "detectionScriptContent" => lambda {|n| @detection_script_content = n.get_string_value() },
                ...
                "remediationScriptContent" => lambda {|n| @remediation_script_content = n.get_string_value() },
