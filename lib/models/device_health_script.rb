...
module MicrosoftGraphBeta
    module Models
        class DeviceHealthScript < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a device_health_script_type
            ## 
            def device_health_script_type
                return @device_health_script_type
            end
            ## 
            ## Sets the deviceHealthScriptType property value. Indicates the type of device script.
            ## @param value Value to set for the device_health_script_type property.
            ## @return a void
            ## 
            def device_health_script_type=(value)
                @device_health_script_type = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "deviceHealthScriptType" => lambda {|n| @device_health_script_type = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceHealthScriptType) },
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("deviceHealthScriptType", @device_health_script_type)
