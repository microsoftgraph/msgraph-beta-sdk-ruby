...
module MicrosoftGraphBeta
    module Models
        class AccessPackageAssignmentPolicy < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the access_review_settings property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the can_extend property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the custom_extension_handlers property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the verifiable_credential_settings property.
            ## @return a void
            ## 
