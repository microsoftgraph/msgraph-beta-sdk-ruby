...
module MicrosoftGraphBeta
    module Models
        class Printer < MicrosoftGraphBeta::Models::PrinterBase
            ...
            ## @param value Value to set for the accepting_jobs property.
            ## @return a void
            ## 
            def accepting_jobs=(value)
                @accepting_jobs = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "acceptingJobs" => lambda {|n| @accepting_jobs = n.get_boolean_value() },
                    ...
                    "share" => lambda {|n| @share = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PrinterShare.create_from_discriminator_value(pn) }) },
                    ...
                    "taskTriggers" => lambda {|n| @task_triggers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PrintTaskTrigger.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                super
                writer.write_boolean_value("acceptingJobs", @accepting_jobs)
