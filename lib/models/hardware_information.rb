...
module MicrosoftGraphBeta
    module Models
        ...
        class HardwareInformation
            ...
            ## @return a hardware_information_battery_level_percentage
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "batteryLevelPercentage" => lambda {|n| @battery_level_percentage = n.get_object_value(lambda {|pn| HardwareInformation::HardwareInformationBatteryLevelPercentage.create_from_discriminator_value(pn) }) },
            ...
            class HardwareInformationBatteryLevelPercentage
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return HardwareInformationBatteryLevelPercentage.new
                end
                ## 
