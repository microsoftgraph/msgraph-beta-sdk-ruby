    ...
    module Models
        class EmployeeExperience
            ...
            def get_field_deserializers()
                return {
                    "communities" => lambda {|n| @communities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Community.create_from_discriminator_value(pn) }) },
                    "engagementAsyncOperations" => lambda {|n| @engagement_async_operations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EngagementAsyncOperation.create_from_discriminator_value(pn) }) },
