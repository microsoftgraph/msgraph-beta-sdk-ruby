...
module MicrosoftGraphBeta
    module Models
        class VirtualEndpoint < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the bulk_actions property.
            ## @return a void
            ## 
            def bulk_actions=(value)
                @bulk_actions = value
            end
            ## 
            ...
            ## @param value Value to set for the front_line_service_plans property.
            ## @return a void
            ## 
            def front_line_service_plans=(value)
                @front_line_service_plans = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "bulkActions" => lambda {|n| @bulk_actions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CloudPcBulkAction.create_from_discriminator_value(pn) }) },
                    ...
                    "frontLineServicePlans" => lambda {|n| @front_line_service_plans = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CloudPcFrontLineServicePlan.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("bulkActions", @bulk_actions)
                ...
                writer.write_collection_of_object_values("frontLineServicePlans", @front_line_service_plans)
