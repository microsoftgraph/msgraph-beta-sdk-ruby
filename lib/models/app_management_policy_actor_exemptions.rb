...
module MicrosoftGraphBeta
    module Models
        class AppManagementPolicyActorExemptions
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return AppManagementPolicyActorExemptions.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "customSecurityAttributes" => lambda {|n| @custom_security_attributes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CustomSecurityAttributeExemption.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("customSecurityAttributes", @custom_security_attributes)
