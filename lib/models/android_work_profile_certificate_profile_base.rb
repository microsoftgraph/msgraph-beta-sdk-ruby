        ...
        class AndroidWorkProfileCertificateProfileBase < MicrosoftGraphBeta::Models::DeviceConfiguration
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "subjectAlternativeNameType" => lambda {|n| @subject_alternative_name_type = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidWorkProfileCertificateProfileBaseSubjectAlternativeNameType) },
            ...
            ## @return a android_work_profile_certificate_profile_base_subject_alternative_name_type
            ## 
