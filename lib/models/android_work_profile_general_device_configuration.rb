...
module MicrosoftGraphBeta
    module Models
        class AndroidWorkProfileGeneralDeviceConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
            ...
            @work_profile_block_personal_app_installs_from_unknown_sources
            ## 
            ...
            @work_profile_password_block_face_unlock
            ## 
            ...
            @work_profile_password_block_iris_unlock
            ## 
            ...
            ## @return a string
            ## 
            def allowed_google_account_domains
                return @allowed_google_account_domains
            end
            ## 
            ...
            ## @param value Value to set for the allowed_google_account_domains property.
            ## @return a void
            ## 
            def allowed_google_account_domains=(value)
                @allowed_google_account_domains = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "allowedGoogleAccountDomains" => lambda {|n| @allowed_google_account_domains = n.get_collection_of_primitive_values(String) },
                    "passwordBlockFaceUnlock" => lambda {|n| @password_block_face_unlock = n.get_boolean_value() },
                    "passwordBlockFingerprintUnlock" => lambda {|n| @password_block_fingerprint_unlock = n.get_boolean_value() },
                    "passwordBlockIrisUnlock" => lambda {|n| @password_block_iris_unlock = n.get_boolean_value() },
                    ...
                    "passwordRequiredType" => lambda {|n| @password_required_type = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidWorkProfileRequiredPasswordType) },
                    ...
                    "vpnEnableAlwaysOnLockdownMode" => lambda {|n| @vpn_enable_always_on_lockdown_mode = n.get_boolean_value() },
                    "workProfileAccountUse" => lambda {|n| @work_profile_account_use = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidWorkProfileAccountUse) },
                    "workProfileAllowAppInstallsFromUnknownSources" => lambda {|n| @work_profile_allow_app_installs_from_unknown_sources = n.get_boolean_value() },
                    "workProfileAllowWidgets" => lambda {|n| @work_profile_allow_widgets = n.get_boolean_value() },
                    ...
                    "workProfileBlockPersonalAppInstallsFromUnknownSources" => lambda {|n| @work_profile_block_personal_app_installs_from_unknown_sources = n.get_boolean_value() },
                    ...
                    "workProfileDataSharingType" => lambda {|n| @work_profile_data_sharing_type = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidWorkProfileCrossProfileDataSharingType) },
                    "workProfileDefaultAppPermissionPolicy" => lambda {|n| @work_profile_default_app_permission_policy = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidWorkProfileDefaultAppPermissionPolicyType) },
                    "workProfilePasswordBlockFaceUnlock" => lambda {|n| @work_profile_password_block_face_unlock = n.get_boolean_value() },
                    "workProfilePasswordBlockFingerprintUnlock" => lambda {|n| @work_profile_password_block_fingerprint_unlock = n.get_boolean_value() },
                    "workProfilePasswordBlockIrisUnlock" => lambda {|n| @work_profile_password_block_iris_unlock = n.get_boolean_value() },
            ...
            ## @return a boolean
            ## 
            def password_block_face_unlock
                return @password_block_face_unlock
            end
            ## 
            ## Sets the passwordBlockFaceUnlock property value. Indicates whether or not to block face unlock.
            ## @param value Value to set for the password_block_face_unlock property.
            ## @return a void
            ## 
            def password_block_face_unlock=(value)
                @password_block_face_unlock = value
            end
            ## 
            ...
            ## @return a boolean
            ## 
            def password_block_iris_unlock
                return @password_block_iris_unlock
            end
            ## 
            ## Sets the passwordBlockIrisUnlock property value. Indicates whether or not to block iris unlock.
            ## @param value Value to set for the password_block_iris_unlock property.
            ## @return a void
            ## 
            def password_block_iris_unlock=(value)
                @password_block_iris_unlock = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                super
                writer.write_collection_of_primitive_values("allowedGoogleAccountDomains", @allowed_google_account_domains)
                writer.write_boolean_value("passwordBlockFaceUnlock", @password_block_face_unlock)
                writer.write_boolean_value("passwordBlockFingerprintUnlock", @password_block_fingerprint_unlock)
                writer.write_boolean_value("passwordBlockIrisUnlock", @password_block_iris_unlock)
                ...
                writer.write_boolean_value("vpnEnableAlwaysOnLockdownMode", @vpn_enable_always_on_lockdown_mode)
                writer.write_enum_value("workProfileAccountUse", @work_profile_account_use)
                writer.write_boolean_value("workProfileAllowAppInstallsFromUnknownSources", @work_profile_allow_app_installs_from_unknown_sources)
                writer.write_boolean_value("workProfileAllowWidgets", @work_profile_allow_widgets)
                ...
                writer.write_boolean_value("workProfileBlockPersonalAppInstallsFromUnknownSources", @work_profile_block_personal_app_installs_from_unknown_sources)
                ...
                writer.write_boolean_value("workProfilePasswordBlockFaceUnlock", @work_profile_password_block_face_unlock)
                writer.write_boolean_value("workProfilePasswordBlockFingerprintUnlock", @work_profile_password_block_fingerprint_unlock)
                writer.write_boolean_value("workProfilePasswordBlockIrisUnlock", @work_profile_password_block_iris_unlock)
            ...
            ## @return a boolean
            ## 
            def vpn_enable_always_on_lockdown_mode
                return @vpn_enable_always_on_lockdown_mode
            end
            ## 
            ## Sets the vpnEnableAlwaysOnLockdownMode property value. Enable lockdown mode for always-on VPN.
            ## @param value Value to set for the vpn_enable_always_on_lockdown_mode property.
            ## @return a void
            ## 
            def vpn_enable_always_on_lockdown_mode=(value)
                @vpn_enable_always_on_lockdown_mode = value
            end
            ## 
            ## Gets the workProfileAccountUse property value. An enum representing possible values for account use in work profile.
            ## @return a android_work_profile_account_use
            ## 
            def work_profile_account_use
                return @work_profile_account_use
            end
            ## 
            ## Sets the workProfileAccountUse property value. An enum representing possible values for account use in work profile.
            ## @param value Value to set for the work_profile_account_use property.
            ## @return a void
            ## 
            def work_profile_account_use=(value)
                @work_profile_account_use = value
            end
            ## 
            ...
            ## @return a boolean
            ## 
            def work_profile_allow_app_installs_from_unknown_sources
                return @work_profile_allow_app_installs_from_unknown_sources
            end
            ## 
            ...
            ## @param value Value to set for the work_profile_allow_app_installs_from_unknown_sources property.
            ## @return a void
            ## 
            def work_profile_allow_app_installs_from_unknown_sources=(value)
                @work_profile_allow_app_installs_from_unknown_sources = value
            end
            ## 
            ## Gets the workProfileAllowWidgets property value. Allow widgets from work profile apps.
            ## @return a boolean
            ## 
            def work_profile_allow_widgets
                return @work_profile_allow_widgets
            end
            ## 
            ## Sets the workProfileAllowWidgets property value. Allow widgets from work profile apps.
            ## @param value Value to set for the work_profile_allow_widgets property.
            ## @return a void
            ## 
            def work_profile_allow_widgets=(value)
                @work_profile_allow_widgets = value
            end
            ## 
            ...
            ## @return a boolean
            ## 
            def work_profile_block_personal_app_installs_from_unknown_sources
                return @work_profile_block_personal_app_installs_from_unknown_sources
            end
            ## 
            ...
            ## @param value Value to set for the work_profile_block_personal_app_installs_from_unknown_sources property.
            ## @return a void
            ## 
            def work_profile_block_personal_app_installs_from_unknown_sources=(value)
                @work_profile_block_personal_app_installs_from_unknown_sources = value
            end
            ## 
            ...
            ## @return a boolean
            ## 
            def work_profile_password_block_face_unlock
                return @work_profile_password_block_face_unlock
            end
            ## 
            ...
            ## @param value Value to set for the work_profile_password_block_face_unlock property.
            ## @return a void
            ## 
            def work_profile_password_block_face_unlock=(value)
                @work_profile_password_block_face_unlock = value
            end
            ## 
            ...
            ## @return a boolean
            ## 
            def work_profile_password_block_iris_unlock
                return @work_profile_password_block_iris_unlock
            end
            ## 
            ...
            ## @param value Value to set for the work_profile_password_block_iris_unlock property.
            ## @return a void
            ## 
            def work_profile_password_block_iris_unlock=(value)
                @work_profile_password_block_iris_unlock = value
            end
            ## 
            ...
            ## @param value Value to set for the work_profile_required_password_complexity property.
            ## @return a void
            ## 
