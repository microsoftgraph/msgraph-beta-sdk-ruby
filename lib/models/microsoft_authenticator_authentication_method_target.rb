...
module MicrosoftGraphBeta::Models
    class MicrosoftAuthenticatorAuthenticationMethodTarget < MicrosoftGraphBeta::Models::AuthenticationMethodTarget
        ...
        def get_field_deserializers()
            return super.merge({
                "authenticationMode" => lambda {|n| @authentication_mode = n.get_enum_value(MicrosoftGraphBeta::Models::MicrosoftAuthenticatorAuthenticationMode) },
            })
        end
        ## 
