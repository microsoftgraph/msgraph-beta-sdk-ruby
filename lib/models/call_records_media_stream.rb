    ...
    module Models
        class CallRecordsMediaStream
            ...
            def get_field_deserializers()
                return {
                    "audioCodec" => lambda {|n| @audio_codec = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsMediaStreamAudioCodec) },
                    ...
                    "streamDirection" => lambda {|n| @stream_direction = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsMediaStreamDirection) },
                    "streamId" => lambda {|n| @stream_id = n.get_string_value() },
                    "videoCodec" => lambda {|n| @video_codec = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsMediaStreamVideoCodec) },
