        ...
        class CloudPcTenantEncryptionSetting
            ...
            def get_field_deserializers()
                return {
                    ...
                    "tenantDiskEncryptionType" => lambda {|n| @tenant_disk_encryption_type = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcTenantEncryptionSettingTenantDiskEncryptionType) },
                }
            end
            ## 
            ...
            ## @return a cloud_pc_tenant_encryption_setting_tenant_disk_encryption_type
            ## 
