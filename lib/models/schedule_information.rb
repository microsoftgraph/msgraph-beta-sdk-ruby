        ...
        class ScheduleInformation
            ...
            def get_field_deserializers()
                return {
                    ...
                    "error" => lambda {|n| @error = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::FreeBusyError.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "scheduleId" => lambda {|n| @schedule_id = n.get_string_value() },
                    "scheduleItems" => lambda {|n| @schedule_items = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ScheduleItem.create_from_discriminator_value(pn) }) },
