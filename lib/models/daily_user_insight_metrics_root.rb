        ...
        class DailyUserInsightMetricsRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "mfaTelecomFraud" => lambda {|n| @mfa_telecom_fraud = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MfaTelecomFraudMetric.create_from_discriminator_value(pn) }) },
            ...
            ## 
            def mfa_telecom_fraud
                return @mfa_telecom_fraud
            end
            ## 
            ...
            ## @return a void
            ## 
            def mfa_telecom_fraud=(value)
                @mfa_telecom_fraud = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("mfaTelecomFraud", @mfa_telecom_fraud)
