...
module MicrosoftGraphBeta
    module Models
        class SecurityIpAddress < MicrosoftGraphBeta::Models::SecurityHost
            ...
            def get_field_deserializers()
                return super.merge({
                    "autonomousSystem" => lambda {|n| @autonomous_system = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityAutonomousSystem.create_from_discriminator_value(pn) }) },
