...
module MicrosoftGraphBeta
    module Models
        class RiskyUser < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "history" => lambda {|n| @history = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RiskyUserHistoryItem.create_from_discriminator_value(pn) }) },
                    "isDeleted" => lambda {|n| @is_deleted = n.get_boolean_value() },
                    "isProcessing" => lambda {|n| @is_processing = n.get_boolean_value() },
                    "riskDetail" => lambda {|n| @risk_detail = n.get_enum_value(MicrosoftGraphBeta::Models::RiskyUserRiskDetail) },
                    "riskLastUpdatedDateTime" => lambda {|n| @risk_last_updated_date_time = n.get_date_time_value() },
                    "riskLevel" => lambda {|n| @risk_level = n.get_enum_value(MicrosoftGraphBeta::Models::RiskyUserRiskLevel) },
                    "riskState" => lambda {|n| @risk_state = n.get_enum_value(MicrosoftGraphBeta::Models::RiskyUserRiskState) },
