...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessDiscoveredApplicationSegmentReport
            ...
            @discovered_application_segment_id
            ## 
            ...
            ## 
            ## Instantiates a new networkaccessDiscoveredApplicationSegmentReport and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return NetworkaccessDiscoveredApplicationSegmentReport.new
            end
            ## 
            ...
            ## @return a string
            ## 
            def discovered_application_segment_id
                return @discovered_application_segment_id
            end
            ## 
            ...
            ## @return a void
            ## 
            def discovered_application_segment_id=(value)
                @discovered_application_segment_id = value
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "discoveredApplicationSegmentId" => lambda {|n| @discovered_application_segment_id = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_string_value("discoveredApplicationSegmentId", @discovered_application_segment_id)
