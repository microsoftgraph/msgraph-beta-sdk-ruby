...
module MicrosoftGraphBeta
    module Models
        class .models.partners.billingBillingReconciliation < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "billed" => lambda {|n| @billed = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::.models.partners.billingBilledReconciliation.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
