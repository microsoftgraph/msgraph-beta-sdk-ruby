        ...
        class Location
            ...
            def get_field_deserializers()
                return {
                    ...
                    "coordinates" => lambda {|n| @coordinates = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OutlookGeoCoordinates.create_from_discriminator_value(pn) }) },
                    "displayName" => lambda {|n| @display_name = n.get_string_value() },
                    "locationEmailAddress" => lambda {|n| @location_email_address = n.get_string_value() },
                    "locationType" => lambda {|n| @location_type = n.get_enum_value(MicrosoftGraphBeta::Models::LocationLocationType) },
                    "locationUri" => lambda {|n| @location_uri = n.get_string_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "uniqueId" => lambda {|n| @unique_id = n.get_string_value() },
                    "uniqueIdType" => lambda {|n| @unique_id_type = n.get_enum_value(MicrosoftGraphBeta::Models::LocationUniqueIdType) },
                }
            end
            ## 
