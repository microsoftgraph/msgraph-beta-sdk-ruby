...
module MicrosoftGraphBeta
    module Models
        class SecurityKubernetesPodEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    "containers" => lambda {|n| @containers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityContainerEvidence.create_from_discriminator_value(pn) }) },
                    "controller" => lambda {|n| @controller = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityKubernetesControllerEvidence.create_from_discriminator_value(pn) }) },
                    "ephemeralContainers" => lambda {|n| @ephemeral_containers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityContainerEvidence.create_from_discriminator_value(pn) }) },
                    "initContainers" => lambda {|n| @init_containers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityContainerEvidence.create_from_discriminator_value(pn) }) },
                    "labels" => lambda {|n| @labels = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityDictionary.create_from_discriminator_value(pn) }) },
                    "name" => lambda {|n| @name = n.get_string_value() },
                    "namespace" => lambda {|n| @namespace = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityKubernetesNamespaceEvidence.create_from_discriminator_value(pn) }) },
                    "podIp" => lambda {|n| @pod_ip = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIpEvidence.create_from_discriminator_value(pn) }) },
                    "serviceAccount" => lambda {|n| @service_account = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityKubernetesServiceAccountEvidence.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
