...
module MicrosoftGraphBeta
    module Models
        class SocialIdentitySource < MicrosoftGraphBeta::Models::IdentitySource
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "socialIdentitySourceType" => lambda {|n| @social_identity_source_type = n.get_enum_value(MicrosoftGraphBeta::Models::SocialIdentitySourceType) },
                })
            end
            ## 
