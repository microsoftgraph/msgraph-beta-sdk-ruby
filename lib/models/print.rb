    ...
    class Print
        ...
        def get_field_deserializers()
            return {
                ...
                "reports" => lambda {|n| @reports = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ReportRoot.create_from_discriminator_value(pn) }) },
        ...
        ## @param value Value to set for the printer_shares property.
        ## @return a void
        ## 
