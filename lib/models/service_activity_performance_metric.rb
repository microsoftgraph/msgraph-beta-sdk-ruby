...
module MicrosoftGraphBeta
    module Models
        class ServiceActivityPerformanceMetric
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ServiceActivityPerformanceMetric.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "percentage" => lambda {|n| @percentage = n.get_object_value(lambda {|pn| Double.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("percentage", @percentage)
