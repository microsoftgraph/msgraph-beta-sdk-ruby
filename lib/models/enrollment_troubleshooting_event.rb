...
module MicrosoftGraphBeta
    module Models
        class EnrollmentTroubleshootingEvent < MicrosoftGraphBeta::Models::DeviceManagementTroubleshootingEvent
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "enrollmentType" => lambda {|n| @enrollment_type = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceEnrollmentType) },
                    "failureCategory" => lambda {|n| @failure_category = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceEnrollmentFailureReason) },
