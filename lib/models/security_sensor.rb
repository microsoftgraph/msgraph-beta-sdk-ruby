...
module MicrosoftGraphBeta
    module Models
        class SecuritySensor < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "deploymentStatus" => lambda {|n| @deployment_status = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityDeploymentStatus) },
                    ...
                    "healthStatus" => lambda {|n| @health_status = n.get_enum_value(MicrosoftGraphBeta::Models::SecuritySensorHealthStatus) },
                    ...
                    "sensorType" => lambda {|n| @sensor_type = n.get_enum_value(MicrosoftGraphBeta::Models::SecuritySensorType) },
                    "settings" => lambda {|n| @settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecuritySensorSettings.create_from_discriminator_value(pn) }) },
