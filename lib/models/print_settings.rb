        ...
        class PrintSettings
            ...
            def get_field_deserializers()
                return {
                    ...
                    "printerDiscoverySettings" => lambda {|n| @printer_discovery_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PrinterDiscoverySettings.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
