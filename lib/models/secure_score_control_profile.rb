...
module MicrosoftGraphBeta
    module Models
        class SecureScoreControlProfile < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "complianceInformation" => lambda {|n| @compliance_information = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ComplianceInformation.create_from_discriminator_value(pn) }) },
                    "controlCategory" => lambda {|n| @control_category = n.get_string_value() },
                    "controlStateUpdates" => lambda {|n| @control_state_updates = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecureScoreControlStateUpdate.create_from_discriminator_value(pn) }) },
