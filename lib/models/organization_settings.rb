...
module MicrosoftGraphBeta
    module Models
        class OrganizationSettings < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the contact_insights property.
            ## @return a void
            ## 
            ...
            ## 
            ## Sets the itemInsights property value. Contains the properties that are configured by an administrator for the visibility of Microsoft Graph-derived insights, between a user and other items in Microsoft 365, such as documents or sites. List itemInsights returns the settings to display or return item insights in an organization.
            ## @param value Value to set for the item_insights property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the microsoft_application_data_access property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the people_insights property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the profile_card_properties property.
            ## @return a void
            ## 
