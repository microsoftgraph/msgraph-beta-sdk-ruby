        ...
        class VirtualEventTownhall < MicrosoftGraphBeta::Models::VirtualEvent
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "invitedAttendees" => lambda {|n| @invited_attendees = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
