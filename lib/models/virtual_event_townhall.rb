...
module MicrosoftGraphBeta
    module Models
        class VirtualEventTownhall < MicrosoftGraphBeta::Models::VirtualEvent
            ...
            ## @return a virtual_event_townhall_audience
            ## 
            def audience
                return @audience
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    "audience" => lambda {|n| @audience = n.get_enum_value(MicrosoftGraphBeta::Models::VirtualEventTownhallAudience) },
                    ...
                    "invitedAttendees" => lambda {|n| @invited_attendees = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CommunicationsUserIdentity.create_from_discriminator_value(pn) }) },
