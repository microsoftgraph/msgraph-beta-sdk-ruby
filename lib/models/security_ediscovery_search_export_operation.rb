    ...
    module Models
        class SecurityEdiscoverySearchExportOperation < MicrosoftGraphBeta::Models::SecurityCaseOperation
            ...
            def get_field_deserializers()
                return super.merge({
                    "additionalOptions" => lambda {|n| @additional_options = n.get_enum_values(MicrosoftGraphBeta::Models::SecurityAdditionalOptions) },
                    "cloudAttachmentVersion" => lambda {|n| @cloud_attachment_version = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityCloudAttachmentVersion) },
                    "description" => lambda {|n| @description = n.get_string_value() },
                    "displayName" => lambda {|n| @display_name = n.get_string_value() },
                    "documentVersion" => lambda {|n| @document_version = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityDocumentVersion) },
                    "exportCriteria" => lambda {|n| @export_criteria = n.get_enum_values(MicrosoftGraphBeta::Models::SecurityExportCriteria) },
                    ...
                    "exportFormat" => lambda {|n| @export_format = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityExportFormat) },
                    "exportLocation" => lambda {|n| @export_location = n.get_enum_values(MicrosoftGraphBeta::Models::SecurityExportLocation) },
