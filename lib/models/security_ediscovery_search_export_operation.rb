...
module MicrosoftGraphBeta
    module Models
        class SecurityEdiscoverySearchExportOperation < MicrosoftGraphBeta::Models::SecurityCaseOperation
            ...
            ## @return a security_ediscovery_search_export_operation_additional_options
            ## 
            ...
            ## @return a security_ediscovery_search_export_operation_export_criteria
            ## 
            def export_criteria
            ...
            ## @return a security_ediscovery_search_export_operation_export_format
            ## 
            def export_format
            ...
            ## @return a security_ediscovery_search_export_operation_export_location
            ## 
            def export_location
            ...
            def get_field_deserializers()
                return super.merge({
                    "additionalOptions" => lambda {|n| @additional_options = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityEdiscoverySearchExportOperationAdditionalOptions) },
                    "description" => lambda {|n| @description = n.get_string_value() },
                    "displayName" => lambda {|n| @display_name = n.get_string_value() },
                    "exportCriteria" => lambda {|n| @export_criteria = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityEdiscoverySearchExportOperationExportCriteria) },
                    ...
                    "exportFormat" => lambda {|n| @export_format = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityEdiscoverySearchExportOperationExportFormat) },
                    "exportLocation" => lambda {|n| @export_location = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityEdiscoverySearchExportOperationExportLocation) },
                    "exportSingleItems" => lambda {|n| @export_single_items = n.get_boolean_value() },
                    "search" => lambda {|n| @search = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityEdiscoverySearch.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
