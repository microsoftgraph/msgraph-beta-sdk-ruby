    ...
    module Models
        class ComplianceInformation
            ...
            def get_field_deserializers()
                return {
                    "certificationControls" => lambda {|n| @certification_controls = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CertificationControl.create_from_discriminator_value(pn) }) },
