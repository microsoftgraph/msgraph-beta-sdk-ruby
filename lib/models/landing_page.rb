        ...
        class LandingPage < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "details" => lambda {|n| @details = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::LandingPageDetail.create_from_discriminator_value(pn) }) },
                    ...
                    "source" => lambda {|n| @source = n.get_enum_value(MicrosoftGraphBeta::Models::LandingPageSource) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::LandingPageStatus) },
