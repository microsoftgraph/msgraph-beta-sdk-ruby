...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessRedundancyConfiguration
            ...
            ## 
            ## Instantiates a new NetworkaccessRedundancyConfiguration and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return NetworkaccessRedundancyConfiguration.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "redundancyTier" => lambda {|n| @redundancy_tier = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkaccessRedundancyTier) },
            ...
            ## @return a networkaccess_redundancy_tier
            ## 
            def redundancy_tier
