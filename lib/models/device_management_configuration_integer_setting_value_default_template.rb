...
module MicrosoftGraphBeta
    module Models
        ...
        class DeviceManagementConfigurationIntegerSettingValueDefaultTemplate
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.deviceManagementConfigurationIntegerSettingValueConstantDefaultTemplate"
                            return DeviceManagementConfigurationIntegerSettingValueConstantDefaultTemplate.new
                    end
                end
                return DeviceManagementConfigurationIntegerSettingValueDefaultTemplate.new
            end
            ## 
