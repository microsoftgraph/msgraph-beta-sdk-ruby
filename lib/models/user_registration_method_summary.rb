        ...
        class UserRegistrationMethodSummary
            ...
            def get_field_deserializers()
                return {
                    ...
                    "userRegistrationMethodCounts" => lambda {|n| @user_registration_method_counts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserRegistrationMethodCount.create_from_discriminator_value(pn) }) },
                    "userRoles" => lambda {|n| @user_roles = n.get_enum_value(MicrosoftGraphBeta::Models::UserRegistrationMethodSummaryUserRoles) },
                    "userTypes" => lambda {|n| @user_types = n.get_enum_value(MicrosoftGraphBeta::Models::UserRegistrationMethodSummaryUserTypes) },
                }
            end
            ## 
