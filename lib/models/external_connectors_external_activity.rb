...
module MicrosoftGraphBeta
    module Models
        class ExternalConnectorsExternalActivity < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "performedBy" => lambda {|n| @performed_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectorsIdentity.create_from_discriminator_value(pn) }) },
                    "startDateTime" => lambda {|n| @start_date_time = n.get_date_time_value() },
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::ExternalConnectorsExternalActivityType) },
                })
            end
            ## 
