...
module MicrosoftGraphBeta::Models
    class WindowsAssignedAccessProfile < MicrosoftGraphBeta::Models::Entity
        ...
        ## @param value Value to set for the app_user_model_ids property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the desktop_app_paths property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the user_accounts property.
        ## @return a void
        ## 
