...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessPolicy < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "policyRules" => lambda {|n| @policy_rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::NetworkaccessPolicyRule.create_from_discriminator_value(pn) }) },
            ...
            ## @return a networkaccess_policy_rule
            ## 
            def policy_rules
                return @policy_rules
            end
