...
module MicrosoftGraphBeta
    module Models
        class AuthorizationSystemInfo
            ...
            ## @return a authorization_system_type
            ## 
            ...
            def get_field_deserializers()
                return {
                    "authorizationSystemType" => lambda {|n| @authorization_system_type = n.get_enum_value(MicrosoftGraphBeta::Models::AuthorizationSystemType) },
