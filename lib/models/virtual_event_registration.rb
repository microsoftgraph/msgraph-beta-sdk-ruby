...
module MicrosoftGraphBeta
    module Models
        class VirtualEventRegistration < MicrosoftGraphBeta::Models::Entity
            ...
            @registrant_video_on_demand_web_url
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "registrantVideoOnDemandWebUrl" => lambda {|n| @registrant_video_on_demand_web_url = n.get_string_value() },
            ...
            ## @return a string
            ## 
            def registrant_video_on_demand_web_url
                return @registrant_video_on_demand_web_url
            end
            ## 
            ...
            ## @return a void
            ## 
            def registrant_video_on_demand_web_url=(value)
                @registrant_video_on_demand_web_url = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("registrantVideoOnDemandWebUrl", @registrant_video_on_demand_web_url)
