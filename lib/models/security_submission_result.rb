        ...
        class SecuritySubmissionResult
            ...
            def get_field_deserializers()
                return {
                    ...
                    "userMailboxSetting" => lambda {|n| @user_mailbox_setting = n.get_enum_value(MicrosoftGraphBeta::Models::SecuritySubmissionResultUserMailboxSetting) },
                }
            end
            ## 
            ...
            ## @return a security_submission_result_user_mailbox_setting
            ## 
