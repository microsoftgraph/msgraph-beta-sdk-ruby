        ...
        class AlterationResponse
            ...
            def get_field_deserializers()
                return {
                    ...
                    "queryAlteration" => lambda {|n| @query_alteration = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SearchAlteration.create_from_discriminator_value(pn) }) },
                    "queryAlterationType" => lambda {|n| @query_alteration_type = n.get_enum_value(MicrosoftGraphBeta::Models::AlterationResponseQueryAlterationType) },
                }
            end
            ## 
