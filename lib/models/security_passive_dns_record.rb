...
module MicrosoftGraphBeta
    module Models
        class SecurityPassiveDnsRecord < MicrosoftGraphBeta::Models::SecurityArtifact
            ...
            def get_field_deserializers()
                return super.merge({
                    "artifact" => lambda {|n| @artifact = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityArtifact.create_from_discriminator_value(pn) }) },
                    "collectedDateTime" => lambda {|n| @collected_date_time = n.get_date_time_value() },
                    "firstSeenDateTime" => lambda {|n| @first_seen_date_time = n.get_date_time_value() },
                    "lastSeenDateTime" => lambda {|n| @last_seen_date_time = n.get_date_time_value() },
                    "parentHost" => lambda {|n| @parent_host = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHost.create_from_discriminator_value(pn) }) },
