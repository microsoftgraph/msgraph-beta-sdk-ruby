...
module MicrosoftGraphBeta
    module Models
        class UserExperienceAnalyticsOverview < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "insights" => lambda {|n| @insights = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserExperienceAnalyticsInsight.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
