...
module MicrosoftGraphBeta
    module Models
        class CallRecordsSegment < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "media" => lambda {|n| @media = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsMedia.create_from_discriminator_value(pn) }) },
