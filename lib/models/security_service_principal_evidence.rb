...
module MicrosoftGraphBeta
    module Models
        class SecurityServicePrincipalEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "servicePrincipalType" => lambda {|n| @service_principal_type = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityServicePrincipalType) },
