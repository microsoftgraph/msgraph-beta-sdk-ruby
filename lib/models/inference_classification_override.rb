...
module MicrosoftGraphBeta
    module Models
        class InferenceClassificationOverride < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "classifyAs" => lambda {|n| @classify_as = n.get_enum_value(MicrosoftGraphBeta::Models::InferenceClassificationOverrideClassifyAs) },
                    "senderEmailAddress" => lambda {|n| @sender_email_address = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EmailAddress.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
