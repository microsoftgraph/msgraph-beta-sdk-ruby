...
module MicrosoftGraphBeta
    module Models
        class SubscribedSku < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "prepaidUnits" => lambda {|n| @prepaid_units = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::LicenseUnitsDetail.create_from_discriminator_value(pn) }) },
                    "servicePlans" => lambda {|n| @service_plans = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ServicePlanInfo.create_from_discriminator_value(pn) }) },
