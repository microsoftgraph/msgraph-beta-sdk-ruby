...
module MicrosoftGraphBeta
    module Models
        class IfEmptyTransformation < MicrosoftGraphBeta::Models::CustomClaimTransformation
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.ifEmptyTransformation"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a if_empty_transformation
            ## 
