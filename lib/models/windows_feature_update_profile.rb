...
module MicrosoftGraphBeta
    module Models
        ...
        class WindowsFeatureUpdateProfile < MicrosoftGraphBeta::Models::Entity
            ...
            @install_feature_updates_optional
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "installFeatureUpdatesOptional" => lambda {|n| @install_feature_updates_optional = n.get_boolean_value() },
            ...
            ## @return a boolean
            ## 
            def install_feature_updates_optional
                return @install_feature_updates_optional
            end
            ## 
            ## Sets the installFeatureUpdatesOptional property value. If true, the Windows 11 update will become optional
            ## @param value Value to set for the installFeatureUpdatesOptional property.
            ## @return a void
            ## 
            def install_feature_updates_optional=(value)
                @install_feature_updates_optional = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("installFeatureUpdatesOptional", @install_feature_updates_optional)
