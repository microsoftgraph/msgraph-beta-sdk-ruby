        ...
        class LocationConstraint
            ...
            def get_field_deserializers()
                return {
                    ...
                    "locations" => lambda {|n| @locations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::LocationConstraintItem.create_from_discriminator_value(pn) }) },
