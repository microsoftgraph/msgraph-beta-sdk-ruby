...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceGroupBasedSubjectSet < MicrosoftGraphBeta::Models::SubjectSet
            ...
            def get_field_deserializers()
                return super.merge({
                    "groups" => lambda {|n| @groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Group.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
