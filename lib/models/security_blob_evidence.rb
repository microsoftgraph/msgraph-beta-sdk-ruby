...
module MicrosoftGraphBeta
    module Models
        class SecurityBlobEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    "blobContainer" => lambda {|n| @blob_container = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityBlobContainerEvidence.create_from_discriminator_value(pn) }) },
                    "etag" => lambda {|n| @etag = n.get_string_value() },
                    "fileHashes" => lambda {|n| @file_hashes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityFileHash.create_from_discriminator_value(pn) }) },
