        ...
        class PlannerBucketCreation
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.plannerExternalBucketSource"
                            return PlannerExternalBucketSource.new
                    end
                end
                return PlannerBucketCreation.new
            end
            ## 
            ...
            ## @return a planner_bucket_creation_creation_source_kind
            ## 
            ...
            def get_field_deserializers()
                return {
                    "creationSourceKind" => lambda {|n| @creation_source_kind = n.get_enum_value(MicrosoftGraphBeta::Models::PlannerBucketCreationCreationSourceKind) },
