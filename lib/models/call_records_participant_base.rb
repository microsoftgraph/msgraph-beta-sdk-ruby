...
module MicrosoftGraphBeta
    module Models
        class CallRecordsParticipantBase < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "identity" => lambda {|n| @identity = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CommunicationsIdentitySet.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
