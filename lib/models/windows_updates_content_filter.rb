...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdatesContentFilter
            ...
            ## 
            ## Instantiates a new WindowsUpdatesContentFilter and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            ## @return a windows_updates_content_filter
            ## 
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        ...
                        when "#microsoft.graph.windowsUpdates.softwareUpdateFilter"
                            return WindowsUpdatesSoftwareUpdateFilter.new
                        when "#microsoft.graph.windowsUpdates.windowsUpdateFilter"
                            return WindowsUpdatesWindowsUpdateFilter.new
                    end
                end
                return WindowsUpdatesContentFilter.new
            end
            ## 
