...
module MicrosoftGraphBeta
    module Models
        class FilterOperatorSchema < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "arity" => lambda {|n| @arity = n.get_enum_value(MicrosoftGraphBeta::Models::ScopeOperatorType) },
                    "multivaluedComparisonType" => lambda {|n| @multivalued_comparison_type = n.get_enum_value(MicrosoftGraphBeta::Models::ScopeOperatorMultiValuedComparisonType) },
                    "supportedAttributeTypes" => lambda {|n| @supported_attribute_types = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AttributeType.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
