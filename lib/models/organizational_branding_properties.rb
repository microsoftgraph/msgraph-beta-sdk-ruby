...
module MicrosoftGraphBeta
    module Models
        class OrganizationalBrandingProperties < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the content_customization property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "contentCustomization" => lambda {|n| @content_customization = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ContentCustomization.create_from_discriminator_value(pn) }) },
                    ...
                    "loginPageLayoutConfiguration" => lambda {|n| @login_page_layout_configuration = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::LoginPageLayoutConfiguration.create_from_discriminator_value(pn) }) },
                    "loginPageTextVisibilitySettings" => lambda {|n| @login_page_text_visibility_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::LoginPageTextVisibilitySettings.create_from_discriminator_value(pn) }) },
