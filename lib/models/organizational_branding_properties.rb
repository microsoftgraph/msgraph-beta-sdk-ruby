    ...
    class OrganizationalBrandingProperties < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "customCSS" => lambda {|n| @custom_c_s_s = n.get_string_value() },
                ...
                "favicon" => lambda {|n| @favicon = n.get_string_value() },
                ...
                "headerLogo" => lambda {|n| @header_logo = n.get_string_value() },
                ...
                "squareLogoDark" => lambda {|n| @square_logo_dark = n.get_string_value() },
