...
module MicrosoftGraphBeta
    module Models
        class SecurityEdiscoveryFile < MicrosoftGraphBeta::Models::SecurityFile
            ...
            def get_field_deserializers()
                return super.merge({
                    "custodian" => lambda {|n| @custodian = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityEdiscoveryCustodian.create_from_discriminator_value(pn) }) },
