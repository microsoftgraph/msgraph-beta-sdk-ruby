...
module MicrosoftGraphBeta
    module Models
        ...
        class AndroidForWorkScepCertificateProfile < MicrosoftGraphBeta::Models::AndroidForWorkCertificateProfileBase
            ...
            ## @return a android_for_work_scep_certificate_profile_certificate_store
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "certificateStore" => lambda {|n| @certificate_store = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidForWorkScepCertificateProfileCertificateStore) },
