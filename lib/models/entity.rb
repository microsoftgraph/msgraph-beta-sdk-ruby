                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        ...
                        when "#microsoft.graph.approval"
                            return Approval.new
                        when "#microsoft.graph.approvalItem"
                            return ApprovalItem.new
                        when "#microsoft.graph.approvalItemRequest"
                            return ApprovalItemRequest.new
                        when "#microsoft.graph.approvalItemResponse"
                            return ApprovalItemResponse.new
                        when "#microsoft.graph.approvalOperation"
                            return ApprovalOperation.new
                        when "#microsoft.graph.approvalSolution"
                        ...
                        when "#microsoft.graph.authenticationFailure"
                        ...
                        when "#microsoft.graph.authenticationMethodDevice"
                        ...
                        when "#microsoft.graph.callAiInsight"
                        ...
                        when "#microsoft.graph.callSettings"
                        ...
                        when "#microsoft.graph.changeItemBase"
                        ...
                        when "#microsoft.graph.cloudCertificationAuthority"
                            return CloudCertificationAuthority.new
                        when "#microsoft.graph.cloudCertificationAuthorityLeafCertificate"
                        ...
                        when "#microsoft.graph.cloudLicensing.usageRight"
                        ...
                        when "#microsoft.graph.contentModel"
                        ...
                        when "#microsoft.graph.customClaimsPolicy"
                        ...
                        when "#microsoft.graph.customSecurityAttributeExemption"
                        ...
                        when "#microsoft.graph.delegationSettings"
                        ...
                        when "#microsoft.graph.documentProcessingJob"
                        ...
                        when "#microsoft.graph.endpoint"
                            return Endpoint.new
                        when "#microsoft.graph.endpointPrivilegeManagementProvisioningStatus"
                        ...
                        when "#microsoft.graph.exchangeAdmin"
                        ...
                        when "#microsoft.graph.exchangeSettings"
                        ...
                        when "#microsoft.graph.hardwareConfiguration"
                            return HardwareConfiguration.new
                        when "#microsoft.graph.hardwareConfigurationAssignment"
                            return HardwareConfigurationAssignment.new
                        when "#microsoft.graph.hardwareConfigurationDeviceState"
                            return HardwareConfigurationDeviceState.new
                        when "#microsoft.graph.hardwareConfigurationRunSummary"
                            return HardwareConfigurationRunSummary.new
                        when "#microsoft.graph.hardwareConfigurationUserState"
                        ...
                        when "#microsoft.graph.hardwarePasswordDetail"
                            return HardwarePasswordDetail.new
                        when "#microsoft.graph.hardwarePasswordInfo"
                            return HardwarePasswordInfo.new
                        when "#microsoft.graph.healthMonitoring.alert"
                            return HealthMonitoringAlert.new
                        when "#microsoft.graph.healthMonitoring.alertConfiguration"
                            return HealthMonitoringAlertConfiguration.new
                        when "#microsoft.graph.healthMonitoring.healthMonitoringRoot"
                        ...
                        when "#microsoft.graph.industryData.outboundProvisioningFlowSet"
                            return IndustryDataOutboundProvisioningFlowSet.new
                        when "#microsoft.graph.industryData.provisioningFlow"
                        ...
                        when "#microsoft.graph.mailbox"
                            return Mailbox.new
                        when "#microsoft.graph.mailboxFolder"
                        ...
                        when "#microsoft.graph.mailFolderOperation"
                        ...
                        when "#microsoft.graph.managedAppLogCollectionRequest"
                        ...
                        when "#microsoft.graph.managedDeviceWindowsOperatingSystemImage"
                        ...
                        when "#microsoft.graph.mfaFailure"
                            return MfaFailure.new
                        when "#microsoft.graph.mfaTelecomFraudMetric"
                            return MfaTelecomFraudMetric.new
                        when "#microsoft.graph.mfaUserCountMetric"
                        ...
                        when "#microsoft.graph.mobileAppCatalogPackage"
                        ...
                        when "#microsoft.graph.namePronunciationSettings"
                        ...
                        when "#microsoft.graph.partner.security.partnerSecurity"
                            return Models.partner.securityPartnerSecurity.new
                        when "#microsoft.graph.partner.security.partnerSecurityAlert"
                            return Models.partner.securityPartnerSecurityAlert.new
                        when "#microsoft.graph.partner.security.partnerSecurityScore"
                        ...
                        when "#microsoft.graph.partner.security.securityRequirement"
                            return Models.partner.securitySecurityRequirement.new
                        when "#microsoft.graph.partner.security.securityScoreHistory"
                        ...
                        when "#microsoft.graph.profileSource"
                        ...
                        when "#microsoft.graph.readingAssignmentSubmission"
                        ...
                        when "#microsoft.graph.reflectCheckInResponse"
                        ...
                        when "#microsoft.graph.reportsRoot"
                        ...
                        when "#microsoft.graph.security.cloudAppDiscoveryReport"
                        ...
                        when "#microsoft.graph.security.dataDiscoveryReport"
                            return SecurityDataDiscoveryReport.new
                        when "#microsoft.graph.security.dataDiscoveryRoot"
                        ...
                        when "#microsoft.graph.security.discoveredCloudAppDetail"
                            return SecurityDiscoveredCloudAppDetail.new
                        when "#microsoft.graph.security.discoveredCloudAppInfo"
                        ...
                        when "#microsoft.graph.security.ediscoveryCaseMember"
                        ...
                        when "#microsoft.graph.selfServiceSignUp"
                        ...
                        when "#microsoft.graph.teamInfo"
                            return TeamInfo.new
                        when "#microsoft.graph.teamsAdministration.teamsAdminRoot"
                            return TeamsAdministrationTeamsAdminRoot.new
                        when "#microsoft.graph.teamsAdministration.teamsPolicyAssignment"
                        ...
                        when "#microsoft.graph.teamsChannelPlanner"
                        ...
                        when "#microsoft.graph.uxSetting"
                        ...
                        when "#microsoft.graph.windowsQualityUpdatePolicy"
                            return WindowsQualityUpdatePolicy.new
                        when "#microsoft.graph.windowsQualityUpdatePolicyAssignment"
                        ...
                        when "#microsoft.graph.windowsUpdates.edition"
                        ...
                        when "#microsoft.graph.windowsUpdates.knownIssue"
                        ...
                        when "#microsoft.graph.windowsUpdates.product"
                        ...
                        when "#microsoft.graph.workplaceSensorDevice"
