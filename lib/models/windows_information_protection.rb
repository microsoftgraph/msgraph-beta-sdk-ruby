...
module MicrosoftGraphBeta
    module Models
        ...
        class WindowsInformationProtection < MicrosoftGraphBeta::Models::ManagedAppPolicy
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "dataRecoveryCertificate" => lambda {|n| @data_recovery_certificate = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionDataRecoveryCertificate.create_from_discriminator_value(pn) }) },
                    "enforcementLevel" => lambda {|n| @enforcement_level = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsInformationProtectionEnforcementLevel) },
                    "enterpriseDomain" => lambda {|n| @enterprise_domain = n.get_string_value() },
                    "enterpriseIPRanges" => lambda {|n| @enterprise_i_p_ranges = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionIPRangeCollection.create_from_discriminator_value(pn) }) },
                    "enterpriseIPRangesAreAuthoritative" => lambda {|n| @enterprise_i_p_ranges_are_authoritative = n.get_boolean_value() },
                    "enterpriseInternalProxyServers" => lambda {|n| @enterprise_internal_proxy_servers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionResourceCollection.create_from_discriminator_value(pn) }) },
                    "enterpriseNetworkDomainNames" => lambda {|n| @enterprise_network_domain_names = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionResourceCollection.create_from_discriminator_value(pn) }) },
                    "enterpriseProtectedDomainNames" => lambda {|n| @enterprise_protected_domain_names = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionResourceCollection.create_from_discriminator_value(pn) }) },
                    "enterpriseProxiedDomains" => lambda {|n| @enterprise_proxied_domains = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionProxiedDomainCollection.create_from_discriminator_value(pn) }) },
                    "enterpriseProxyServers" => lambda {|n| @enterprise_proxy_servers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionResourceCollection.create_from_discriminator_value(pn) }) },
                    "enterpriseProxyServersAreAuthoritative" => lambda {|n| @enterprise_proxy_servers_are_authoritative = n.get_boolean_value() },
                    "exemptAppLockerFiles" => lambda {|n| @exempt_app_locker_files = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionAppLockerFile.create_from_discriminator_value(pn) }) },
                    "exemptApps" => lambda {|n| @exempt_apps = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionApp.create_from_discriminator_value(pn) }) },
                    ...
                    "neutralDomainResources" => lambda {|n| @neutral_domain_resources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionResourceCollection.create_from_discriminator_value(pn) }) },
                    "protectedAppLockerFiles" => lambda {|n| @protected_app_locker_files = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionAppLockerFile.create_from_discriminator_value(pn) }) },
                    "protectedApps" => lambda {|n| @protected_apps = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionApp.create_from_discriminator_value(pn) }) },
                    ...
                    "smbAutoEncryptedFileExtensions" => lambda {|n| @smb_auto_encrypted_file_extensions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsInformationProtectionResourceCollection.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
