...
module MicrosoftGraphBeta
    module Models
        ...
        class AndroidDeviceOwnerSystemUpdateFreezePeriod
            ...
            ## @param value Value to set for the end_day property.
            ## @return a void
            ## 
            def end_day=(value)
                @end_day = value
            ...
            ## @param value Value to set for the end_month property.
            ## @return a void
            ## 
            def end_month=(value)
                @end_month = value
            ...
            ## @param value Value to set for the start_day property.
            ## @return a void
            ## 
            def start_day=(value)
                @start_day = value
            ...
            ## @param value Value to set for the start_month property.
            ## @return a void
            ## 
