        ...
        class DeviceManagementConfigurationSimpleSettingValueTemplate
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.deviceManagementConfigurationIntegerSettingValueTemplate"
                            return DeviceManagementConfigurationIntegerSettingValueTemplate.new
                        when "#microsoft.graph.deviceManagementConfigurationStringSettingValueTemplate"
                            return DeviceManagementConfigurationStringSettingValueTemplate.new
                    end
                end
                return DeviceManagementConfigurationSimpleSettingValueTemplate.new
            end
            ## 
