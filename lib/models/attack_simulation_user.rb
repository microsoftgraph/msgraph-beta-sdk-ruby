        ...
        class AttackSimulationUser
            ...
            def get_field_deserializers()
                return {
                    ...
                    "outOfOfficeDays" => lambda {|n| @out_of_office_days = n.get_number_value() },
            ...
            ## @param value Value to set for the out_of_office_days property.
            ## @return a void
            ## 
            def out_of_office_days=(value)
                @out_of_office_days = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_number_value("outOfOfficeDays", @out_of_office_days)
