...
module MicrosoftGraphBeta
    module Models
        class CloudPcProvisioningPolicy < MicrosoftGraphBeta::Models::Entity
            ...
            ## 
            def autopilot_configuration
                return @autopilot_configuration
            end
            ## 
            ...
            ## @return a void
            ## 
            def autopilot_configuration=(value)
                @autopilot_configuration = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "autopatch" => lambda {|n| @autopatch = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CloudPcProvisioningPolicyAutopatch.create_from_discriminator_value(pn) }) },
                    "autopilotConfiguration" => lambda {|n| @autopilot_configuration = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CloudPcAutopilotConfiguration.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("autopilotConfiguration", @autopilot_configuration)
