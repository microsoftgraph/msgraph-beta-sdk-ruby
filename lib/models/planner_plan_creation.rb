    ...
    class PlannerPlanCreation
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    when "#microsoft.graph.plannerExternalPlanSource"
                        return PlannerExternalPlanSource.new
                end
            end
            return PlannerPlanCreation.new
        end
        ## 
        ...
        ## @param value Value to set for the creation_source_kind property.
        ## @return a void
        ## 
        def creation_source_kind=(value)
            @creation_source_kind = value
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_enum_value("creationSourceKind", @creation_source_kind)
