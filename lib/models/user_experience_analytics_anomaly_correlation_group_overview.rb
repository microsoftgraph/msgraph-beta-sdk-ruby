...
module MicrosoftGraphBeta
    module Models
        ...
        class UserExperienceAnalyticsAnomalyCorrelationGroupOverview < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a user_experience_analytics_anomaly_correlation_group_overview_correlation_group_prevalence_percentage
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "correlationGroupPrevalencePercentage" => lambda {|n| @correlation_group_prevalence_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsAnomalyCorrelationGroupOverview::UserExperienceAnalyticsAnomalyCorrelationGroupOverviewCorrelationGroupPrevalencePercentage.create_from_discriminator_value(pn) }) },
            ...
            class UserExperienceAnalyticsAnomalyCorrelationGroupOverviewCorrelationGroupPrevalencePercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsAnomalyCorrelationGroupOverviewCorrelationGroupPrevalencePercentage.new
                end
                ## 
