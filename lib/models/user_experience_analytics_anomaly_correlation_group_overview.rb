...
module MicrosoftGraphBeta
    module Models
        ...
        class UserExperienceAnalyticsAnomalyCorrelationGroupOverview < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the anomaly_correlation_group_count property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the correlation_group_anomalous_device_count property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the correlation_group_at_risk_device_count property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the correlation_group_device_count property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the correlation_group_features property.
            ## @return a void
            ## 
            ...
            ## 
            ## Sets the correlationGroupId property value. The unique identifier for the correlation group which will uniquely identify one of the correlation group within an anomaly. The correlation Id can be mapped to the correlation group name by concatinating the correlation group features. Example of correlation group name which is the indicative of concatenated features names are  for names, Contoso manufacture 4.4.1 and Windows 11.22621.1485.
            ## @param value Value to set for the correlation_group_id property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the correlation_group_prevalence property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the correlation_group_prevalence_percentage property.
            ## @return a void
            ## 
