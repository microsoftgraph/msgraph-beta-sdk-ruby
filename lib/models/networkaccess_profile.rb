...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessProfile < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a networkaccess_profile
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "policies" => lambda {|n| @policies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::NetworkaccessPolicyLink.create_from_discriminator_value(pn) }) },
