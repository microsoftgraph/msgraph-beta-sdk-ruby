...
module MicrosoftGraphBeta::Models
    ...
    class DeliveryOptimizationMaxCacheSize
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    when "#microsoft.graph.deliveryOptimizationMaxCacheSizeAbsolute"
                        return DeliveryOptimizationMaxCacheSizeAbsolute.new
                    when "#microsoft.graph.deliveryOptimizationMaxCacheSizePercentage"
                        return DeliveryOptimizationMaxCacheSizePercentage.new
                end
            end
            return DeliveryOptimizationMaxCacheSize.new
        end
        ## 
