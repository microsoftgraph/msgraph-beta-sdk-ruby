...
module MicrosoftGraphBeta::Models
    class X509CertificateAuthenticationMethodConfigurationCollectionResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
        ...
        def get_field_deserializers()
            return super.merge({
                "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::X509CertificateAuthenticationMethodConfiguration.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
