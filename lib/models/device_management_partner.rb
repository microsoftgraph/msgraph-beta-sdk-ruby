...
module MicrosoftGraphBeta::Models
    ...
    class DeviceManagementPartner < MicrosoftGraphBeta::Models::Entity
        ...
        @when_partner_devices_will_be_marked_as_non_compliant
        ## 
        ...
        @when_partner_devices_will_be_removed
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "groupsRequiringPartnerEnrollment" => lambda {|n| @groups_requiring_partner_enrollment = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceManagementPartnerAssignment.create_from_discriminator_value(pn) }) },
                ...
                "partnerAppType" => lambda {|n| @partner_app_type = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceManagementPartnerAppType) },
                ...
                "whenPartnerDevicesWillBeMarkedAsNonCompliant" => lambda {|n| @when_partner_devices_will_be_marked_as_non_compliant = n.get_date_time_value() },
                ...
                "whenPartnerDevicesWillBeRemoved" => lambda {|n| @when_partner_devices_will_be_removed = n.get_date_time_value() },
        ...
        def serialize(writer)
            ...
            writer.write_date_time_value("whenPartnerDevicesWillBeMarkedAsNonCompliant", @when_partner_devices_will_be_marked_as_non_compliant)
            ...
            writer.write_date_time_value("whenPartnerDevicesWillBeRemoved", @when_partner_devices_will_be_removed)
        ...
        ## @return a date_time
        ## 
        def when_partner_devices_will_be_marked_as_non_compliant
            return @when_partner_devices_will_be_marked_as_non_compliant
        end
        ## 
        ...
        ## @return a void
        ## 
        def when_partner_devices_will_be_marked_as_non_compliant=(value)
            @when_partner_devices_will_be_marked_as_non_compliant = value
        end
        ## 
        ...
        ## @return a date_time
        ## 
        def when_partner_devices_will_be_removed
            return @when_partner_devices_will_be_removed
        end
        ## 
        ...
        ## @return a void
        ## 
        def when_partner_devices_will_be_removed=(value)
            @when_partner_devices_will_be_removed = value
        end
        ## 
