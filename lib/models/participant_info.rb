        ...
        class ParticipantInfo
            ...
            def get_field_deserializers()
                return {
                    ...
                    "platformId" => lambda {|n| @platform_id = n.get_string_value() },
            ...
            ## @return a identity_set
            ## 
            def non_anonymized_identity
                return @non_anonymized_identity
            end
            ## 
            ## Sets the nonAnonymizedIdentity property value. The nonAnonymizedIdentity property
            ## @param value Value to set for the non_anonymized_identity property.
            ## @return a void
            ## 
            def non_anonymized_identity=(value)
                @non_anonymized_identity = value
            end
            ## 
            ...
            ## @param value Value to set for the platform_id property.
            ## @return a void
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("nonAnonymizedIdentity", @non_anonymized_identity)
                writer.write_string_value("@odata.type", @odata_type)
                writer.write_string_value("participantId", @participant_id)
                writer.write_string_value("platformId", @platform_id)
