...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessAlertSeveritySummary
            ...
            ## 
            ## Instantiates a new NetworkaccessAlertSeveritySummary and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            ## @return a networkaccess_alert_severity_summary
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return NetworkaccessAlertSeveritySummary.new
            end
            ## 
