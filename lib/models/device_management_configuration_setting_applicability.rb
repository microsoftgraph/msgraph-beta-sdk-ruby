        ...
        class DeviceManagementConfigurationSettingApplicability
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.deviceManagementConfigurationApplicationSettingApplicability"
                            return DeviceManagementConfigurationApplicationSettingApplicability.new
            ...
            ## @param value Value to set for the device_mode property.
            ## @return a void
            ## 
