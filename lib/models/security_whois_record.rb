    ...
    module Models
        class SecurityWhoisRecord < MicrosoftGraphBeta::Models::SecurityWhoisBaseRecord
            ...
            def get_field_deserializers()
                return super.merge({
                    "history" => lambda {|n| @history = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityWhoisHistoryRecord.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
