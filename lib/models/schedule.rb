        ...
        class Schedule < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "openShifts" => lambda {|n| @open_shifts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OpenShift.create_from_discriminator_value(pn) }) },
                    "openShiftsEnabled" => lambda {|n| @open_shifts_enabled = n.get_boolean_value() },
                    "provisionStatus" => lambda {|n| @provision_status = n.get_enum_value(MicrosoftGraphBeta::Models::ScheduleProvisionStatus) },
                    ...
                    "startDayOfWeek" => lambda {|n| @start_day_of_week = n.get_enum_value(MicrosoftGraphBeta::Models::ScheduleStartDayOfWeek) },
                    ...
                    "timeClockSettings" => lambda {|n| @time_clock_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TimeClockSettings.create_from_discriminator_value(pn) }) },
                    "timeOffReasons" => lambda {|n| @time_off_reasons = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TimeOffReason.create_from_discriminator_value(pn) }) },
                    "timeOffRequests" => lambda {|n| @time_off_requests = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TimeOffRequest.create_from_discriminator_value(pn) }) },
            ...
            ## @return a schedule_start_day_of_week
            ## 
