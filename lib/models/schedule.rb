    ...
    class Schedule < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "provisionStatus" => lambda {|n| @provision_status = n.get_enum_value(MicrosoftGraphBeta::Models::OperationStatus) },
        ...
        ## @param value Value to set for the time_cards property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the time_clock_settings property.
        ## @return a void
        ## 
