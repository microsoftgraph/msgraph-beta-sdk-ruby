    ...
    module Models
        ...
        class IosNotificationSettings
            ...
            def get_field_deserializers()
                return {
                    "alertType" => lambda {|n| @alert_type = n.get_enum_value(MicrosoftGraphBeta::Models::IosNotificationAlertType) },
                    ...
                    "previewVisibility" => lambda {|n| @preview_visibility = n.get_enum_value(MicrosoftGraphBeta::Models::IosNotificationPreviewVisibility) },
            ...
            ## @return a ios_notification_preview_visibility
            ## 
            ...
            ## @param value Value to set for the preview_visibility property.
            ## @return a void
            ## 
            def preview_visibility=(value)
                @preview_visibility = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("previewVisibility", @preview_visibility)
