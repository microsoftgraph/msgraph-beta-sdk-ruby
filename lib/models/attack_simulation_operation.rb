        ...
        class AttackSimulationOperation < MicrosoftGraphBeta::Models::LongRunningOperation
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::AttackSimulationOperationType) },
                })
            end
            ## 
            ...
            ## @param value Value to set for the percentage_completed property.
            ## @return a void
            ## 
