...
module MicrosoftGraphBeta
    module Models
        class InternalDomainFederation < MicrosoftGraphBeta::Models::SamlOrWsFedProvider
            ...
            @default_interactive_authentication_method
            ## 
            ...
            ## @return a string
            ## 
            def default_interactive_authentication_method
                return @default_interactive_authentication_method
            end
            ## 
            ...
            ## @return a void
            ## 
            def default_interactive_authentication_method=(value)
                @default_interactive_authentication_method = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "defaultInteractiveAuthenticationMethod" => lambda {|n| @default_interactive_authentication_method = n.get_string_value() },
                    ...
                    "openIdConnectDiscoveryEndpoint" => lambda {|n| @open_id_connect_discovery_endpoint = n.get_string_value() },
                    "passwordChangeUri" => lambda {|n| @password_change_uri = n.get_string_value() },
            ...
            ## @return a string
            ## 
            def open_id_connect_discovery_endpoint
                return @open_id_connect_discovery_endpoint
            end
            ## 
            ...
            ## @return a void
            ## 
            def open_id_connect_discovery_endpoint=(value)
                @open_id_connect_discovery_endpoint = value
            end
            ## 
            ## Gets the passwordChangeUri property value. The passwordChangeUri property
            ## @return a string
            ## 
            def password_change_uri
                return @password_change_uri
            end
            ## 
            ...
            ## @return a void
            ## 
            def password_change_uri=(value)
                @password_change_uri = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("defaultInteractiveAuthenticationMethod", @default_interactive_authentication_method)
                ...
                writer.write_string_value("openIdConnectDiscoveryEndpoint", @open_id_connect_discovery_endpoint)
                writer.write_string_value("passwordChangeUri", @password_change_uri)
