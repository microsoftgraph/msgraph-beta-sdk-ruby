        ...
        class InternalDomainFederation < MicrosoftGraphBeta::Models::SamlOrWsFedProvider
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "federatedIdpMfaBehavior" => lambda {|n| @federated_idp_mfa_behavior = n.get_enum_value(MicrosoftGraphBeta::Models::InternalDomainFederationFederatedIdpMfaBehavior) },
                    ...
                    "promptLoginBehavior" => lambda {|n| @prompt_login_behavior = n.get_enum_value(MicrosoftGraphBeta::Models::InternalDomainFederationPromptLoginBehavior) },
