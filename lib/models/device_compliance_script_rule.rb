...
module MicrosoftGraphBeta::Models
    class DeviceComplianceScriptRule
        ...
        ## @param value Value to set for the device_compliance_script_rul_operator property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the device_compliance_script_rule_data_type property.
        ## @return a void
        ## 
