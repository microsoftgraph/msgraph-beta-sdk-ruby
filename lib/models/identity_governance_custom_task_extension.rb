...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceCustomTaskExtension < MicrosoftGraphBeta::Models::CustomCalloutExtension
            ...
            def get_field_deserializers()
                return super.merge({
                    "callbackConfiguration" => lambda {|n| @callback_configuration = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CustomExtensionCallbackConfiguration.create_from_discriminator_value(pn) }) },
