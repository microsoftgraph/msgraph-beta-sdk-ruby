    ...
    module Models
        ...
        class UserExperienceAnalyticsWorkFromAnywhereDevicesSummary
            ...
            def get_field_deserializers()
                return {
                    "autopilotDevicesSummary" => lambda {|n| @autopilot_devices_summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserExperienceAnalyticsAutopilotDevicesSummary.create_from_discriminator_value(pn) }) },
                    "cloudIdentityDevicesSummary" => lambda {|n| @cloud_identity_devices_summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserExperienceAnalyticsCloudIdentityDevicesSummary.create_from_discriminator_value(pn) }) },
                    "cloudManagementDevicesSummary" => lambda {|n| @cloud_management_devices_summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserExperienceAnalyticsCloudManagementDevicesSummary.create_from_discriminator_value(pn) }) },
                    ...
                    "windows10DevicesSummary" => lambda {|n| @windows10_devices_summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserExperienceAnalyticsWindows10DevicesSummary.create_from_discriminator_value(pn) }) },
