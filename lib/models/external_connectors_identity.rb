...
module MicrosoftGraphBeta
    module Models
        class ExternalConnectorsIdentity < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::ExternalConnectorsIdentityType) },
                })
            end
            ## 
