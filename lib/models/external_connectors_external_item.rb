...
module MicrosoftGraphBeta
    module Models
        class ExternalConnectorsExternalItem < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "acl" => lambda {|n| @acl = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectorsAcl.create_from_discriminator_value(pn) }) },
                    ...
                    "content" => lambda {|n| @content = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectorsExternalItemContent.create_from_discriminator_value(pn) }) },
                    "properties" => lambda {|n| @properties = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectorsProperties.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
