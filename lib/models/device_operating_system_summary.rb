...
module MicrosoftGraphBeta
    module Models
        ...
        class DeviceOperatingSystemSummary
            ...
            ## @return a integer
            ## 
            def aosp_user_associated_count
                return @aosp_user_associated_count
            end
            ## 
            ...
            ## @param value Value to set for the aosp_user_associated_count property.
            ## @return a void
            ## 
            def aosp_user_associated_count=(value)
                @aosp_user_associated_count = value
            end
            ## 
            ## Gets the aospUserlessCount property value. Number of AOSP userless Android devices. Valid values 0 to 2147483647
            ## @return a integer
            ## 
            def aosp_userless_count
                return @aosp_userless_count
            end
            ## 
            ## Sets the aospUserlessCount property value. Number of AOSP userless Android devices. Valid values 0 to 2147483647
            ## @param value Value to set for the aosp_userless_count property.
            ## @return a void
            ## 
            def aosp_userless_count=(value)
                @aosp_userless_count = value
            end
            ## 
            ## Gets the chromeOSCount property value. Number of Chrome OS devices. Valid values 0 to 2147483647
            ## @return a integer
            ## 
            def chrome_o_s_count
                return @chrome_o_s_count
            end
            ## 
            ## Sets the chromeOSCount property value. Number of Chrome OS devices. Valid values 0 to 2147483647
            ## @param value Value to set for the chrome_o_s_count property.
            ## @return a void
            ## 
            def chrome_o_s_count=(value)
                @chrome_o_s_count = value
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "aospUserAssociatedCount" => lambda {|n| @aosp_user_associated_count = n.get_number_value() },
                    "aospUserlessCount" => lambda {|n| @aosp_userless_count = n.get_number_value() },
                    "chromeOSCount" => lambda {|n| @chrome_o_s_count = n.get_number_value() },
                    "configMgrDeviceCount" => lambda {|n| @config_mgr_device_count = n.get_number_value() },
                    "iosCount" => lambda {|n| @ios_count = n.get_number_value() },
                    "linuxCount" => lambda {|n| @linux_count = n.get_number_value() },
            ...
            ## @param value Value to set for the linux_count property.
            ## @return a void
            ## 
            def linux_count=(value)
                @linux_count = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_number_value("aospUserAssociatedCount", @aosp_user_associated_count)
                writer.write_number_value("aospUserlessCount", @aosp_userless_count)
                writer.write_number_value("chromeOSCount", @chrome_o_s_count)
                writer.write_number_value("configMgrDeviceCount", @config_mgr_device_count)
                writer.write_number_value("iosCount", @ios_count)
                writer.write_number_value("linuxCount", @linux_count)
