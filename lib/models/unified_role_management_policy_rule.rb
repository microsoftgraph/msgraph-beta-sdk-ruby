...
module MicrosoftGraphBeta
    module Models
        class UnifiedRoleManagementPolicyRule < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "target" => lambda {|n| @target = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleManagementPolicyRuleTarget.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
