        ...
        class CloudPcPartnerAgentInstallResult
            ...
            def get_field_deserializers()
                return {
                    ...
                    "installStatus" => lambda {|n| @install_status = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcPartnerAgentInstallResultInstallStatus) },
                    "isThirdPartyPartner" => lambda {|n| @is_third_party_partner = n.get_boolean_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "partnerAgentName" => lambda {|n| @partner_agent_name = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcPartnerAgentInstallResultPartnerAgentName) },
            ...
            ## @return a cloud_pc_partner_agent_install_result_install_status
            ## 
            def install_status
            ...
            ## @return a cloud_pc_partner_agent_install_result_partner_agent_name
            ## 
