...
module MicrosoftGraphBeta
    module Models
        class UserRegistrationDetails < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a user_registration_details_default_mfa_method
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "defaultMfaMethod" => lambda {|n| @default_mfa_method = n.get_enum_value(MicrosoftGraphBeta::Models::UserRegistrationDetailsDefaultMfaMethod) },
                    ...
                    "userPreferredMethodForSecondaryAuthentication" => lambda {|n| @user_preferred_method_for_secondary_authentication = n.get_enum_value(MicrosoftGraphBeta::Models::UserRegistrationDetailsUserPreferredMethodForSecondaryAuthentication) },
                    "userPrincipalName" => lambda {|n| @user_principal_name = n.get_string_value() },
                    "userType" => lambda {|n| @user_type = n.get_enum_value(MicrosoftGraphBeta::Models::UserRegistrationDetailsUserType) },
                })
            end
            ## 
