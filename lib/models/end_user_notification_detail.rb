...
module MicrosoftGraphBeta
    module Models
        class EndUserNotificationDetail < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the email_content property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "sentFrom" => lambda {|n| @sent_from = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EmailIdentity.create_from_discriminator_value(pn) }) },
            ...
            ## @param value Value to set for the is_default_langauge property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the sent_from property.
            ## @return a void
            ## 
            def sent_from=(value)
                @sent_from = value
