...
module MicrosoftGraphBeta
    module Models
        class RiskyUserHistoryItem < MicrosoftGraphBeta::Models::RiskyUser
            ...
            def get_field_deserializers()
                return super.merge({
                    "activity" => lambda {|n| @activity = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::RiskUserActivity.create_from_discriminator_value(pn) }) },
