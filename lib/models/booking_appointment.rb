        ...
        class BookingAppointment < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "invoiceAmount" => lambda {|n| @invoice_amount = n.get_object_value(lambda {|pn| BookingAppointment::BookingAppointmentInvoiceAmount.create_from_discriminator_value(pn) }) },
            ...
            ## @return a booking_appointment_invoice_amount
            ## 
            def invoice_amount
            ...
            class BookingAppointmentInvoiceAmount
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return BookingAppointmentInvoiceAmount.new
                end
                ## 
