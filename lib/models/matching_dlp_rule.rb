...
module MicrosoftGraphBeta
    module Models
        class MatchingDlpRule
            ...
            ## @param value Value to set for the is_most_restrictive property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the policy_name property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the rule_mode property.
            ## @return a void
            ## 
            def rule_mode=(value)
                @rule_mode = value
