    ...
    module Models
        class CallRoute
            ...
            def get_field_deserializers()
                return {
                    "final" => lambda {|n| @final = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "original" => lambda {|n| @original = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                    "routingType" => lambda {|n| @routing_type = n.get_enum_value(MicrosoftGraphBeta::Models::RoutingType) },
                }
            end
            ## 
