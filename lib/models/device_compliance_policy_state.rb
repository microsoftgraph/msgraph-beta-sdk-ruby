...
module MicrosoftGraphBeta::Models
    ...
    class DeviceCompliancePolicyState < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "settingStates" => lambda {|n| @setting_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceCompliancePolicySettingState.create_from_discriminator_value(pn) }) },
