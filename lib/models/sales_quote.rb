...
module MicrosoftGraphBeta
    module Models
        class SalesQuote < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the accepted_date property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the document_date property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the sent_date property.
            ## @return a void
            ## 
            def sent_date=(value)
                @sent_date = value
            ...
            ## @param value Value to set for the valid_until_date property.
            ## @return a void
            ## 
