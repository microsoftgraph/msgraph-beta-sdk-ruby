        ...
        class SecuritySensorSettings
            ...
            def get_field_deserializers()
                return {
                    ...
                    "networkAdapters" => lambda {|n| @network_adapters = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityNetworkAdapter.create_from_discriminator_value(pn) }) },
