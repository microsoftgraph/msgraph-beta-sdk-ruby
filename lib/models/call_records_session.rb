...
module MicrosoftGraphBeta
    module Models
        class CallRecordsSession < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "callee" => lambda {|n| @callee = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsEndpoint.create_from_discriminator_value(pn) }) },
                    "caller" => lambda {|n| @caller = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsEndpoint.create_from_discriminator_value(pn) }) },
                    "endDateTime" => lambda {|n| @end_date_time = n.get_date_time_value() },
                    "failureInfo" => lambda {|n| @failure_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsFailureInfo.create_from_discriminator_value(pn) }) },
                    ...
                    "segments" => lambda {|n| @segments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsSegment.create_from_discriminator_value(pn) }) },
