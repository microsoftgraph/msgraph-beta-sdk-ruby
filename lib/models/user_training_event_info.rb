        ...
        class UserTrainingEventInfo
            ...
            def get_field_deserializers()
                return {
                    ...
                    "latestTrainingStatus" => lambda {|n| @latest_training_status = n.get_enum_value(MicrosoftGraphBeta::Models::UserTrainingEventInfoLatestTrainingStatus) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "trainingAssignedProperties" => lambda {|n| @training_assigned_properties = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserTrainingContentEventInfo.create_from_discriminator_value(pn) }) },
                    "trainingCompletedProperties" => lambda {|n| @training_completed_properties = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserTrainingContentEventInfo.create_from_discriminator_value(pn) }) },
                    "trainingUpdatedProperties" => lambda {|n| @training_updated_properties = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserTrainingContentEventInfo.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
