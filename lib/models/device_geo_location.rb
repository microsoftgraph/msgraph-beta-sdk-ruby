    ...
    class DeviceGeoLocation
        ...
        def get_field_deserializers()
            return {
                ...
                "lastCollectedDateTimeUtc" => lambda {|n| @last_collected_date_time_utc = n.get_date_time_value() },
        ...
        ## @return a date_time
        ## 
        def last_collected_date_time_utc
            return @last_collected_date_time_utc
        end
        ## 
        ## Sets the lastCollectedDateTimeUtc property value. Time at which location was recorded, relative to UTC
        ## @param value Value to set for the last_collected_date_time_utc property.
        ## @return a void
        ## 
        def last_collected_date_time_utc=(value)
            @last_collected_date_time_utc = value
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_date_time_value("lastCollectedDateTimeUtc", @last_collected_date_time_utc)
