...
module MicrosoftGraphBeta
    module Models
        class PermissionsManagement < MicrosoftGraphBeta::Models::Entity
            ...
            @scheduled_permissions_approvals
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "scheduledPermissionsApprovals" => lambda {|n| @scheduled_permissions_approvals = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Approval.create_from_discriminator_value(pn) }) },
            ...
            ## @return a approval
            ## 
            def scheduled_permissions_approvals
                return @scheduled_permissions_approvals
            end
            ## 
            ...
            ## @return a void
            ## 
            def scheduled_permissions_approvals=(value)
                @scheduled_permissions_approvals = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("scheduledPermissionsApprovals", @scheduled_permissions_approvals)
