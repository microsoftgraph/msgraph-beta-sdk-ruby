...
module MicrosoftGraphBeta
    module Models
        class .models.partners.billingManifest < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "blobs" => lambda {|n| @blobs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::.models.partners.billingBlob.create_from_discriminator_value(pn) }) },
