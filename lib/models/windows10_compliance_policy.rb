        ...
        class Windows10CompliancePolicy < MicrosoftGraphBeta::Models::DeviceCompliancePolicy
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "wslDistributions" => lambda {|n| @wsl_distributions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WslDistributionConfiguration.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("wslDistributions", @wsl_distributions)
            end
            ## 
            ...
            ## 
            def wsl_distributions
                return @wsl_distributions
            end
            ## 
            ...
            ## @return a void
            ## 
            def wsl_distributions=(value)
                @wsl_distributions = value
            end
        end
    end
end
