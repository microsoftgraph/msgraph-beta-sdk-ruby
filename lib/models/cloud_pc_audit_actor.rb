        ...
        class CloudPcAuditActor
            ...
            def get_field_deserializers()
                return {
                    ...
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcAuditActorType) },
                    "userId" => lambda {|n| @user_id = n.get_string_value() },
                    "userPermissions" => lambda {|n| @user_permissions = n.get_collection_of_primitive_values(String) },
                    "userPrincipalName" => lambda {|n| @user_principal_name = n.get_string_value() },
                    "userRoleScopeTags" => lambda {|n| @user_role_scope_tags = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CloudPcUserRoleScopeTagInfo.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            ## @param value Value to set for the remote_tenant_id property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the remote_user_id property.
            ## @return a void
            ## 
            ...
            ## @return a cloud_pc_audit_actor_type
            ## 
            def type
                return @type
            end
            ...
            ## @param value Value to set for the user_role_scope_tags property.
            ## @return a void
            ## 
