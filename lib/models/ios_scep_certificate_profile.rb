...
module MicrosoftGraphBeta
    module Models
        ...
        class IosScepCertificateProfile < MicrosoftGraphBeta::Models::IosCertificateProfileBase
            ...
            ## @return a ios_scep_certificate_profile_certificate_store
            ## 
            ...
            ## @return a ios_scep_certificate_profile
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "certificateStore" => lambda {|n| @certificate_store = n.get_enum_value(MicrosoftGraphBeta::Models::IosScepCertificateProfileCertificateStore) },
                    ...
                    "rootCertificate" => lambda {|n| @root_certificate = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IosTrustedRootCertificate.create_from_discriminator_value(pn) }) },
