        ...
        class RecentNotebook
            ...
            def get_field_deserializers()
                return {
                    ...
                    "links" => lambda {|n| @links = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::RecentNotebookLinks.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "sourceService" => lambda {|n| @source_service = n.get_enum_value(MicrosoftGraphBeta::Models::RecentNotebookSourceService) },
                }
            end
            ## 
