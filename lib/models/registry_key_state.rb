    ...
    module Models
        class RegistryKeyState
            ...
            def get_field_deserializers()
                return {
                    "hive" => lambda {|n| @hive = n.get_enum_value(MicrosoftGraphBeta::Models::RegistryHive) },
                    ...
                    "operation" => lambda {|n| @operation = n.get_enum_value(MicrosoftGraphBeta::Models::RegistryOperation) },
                    ...
                    "valueType" => lambda {|n| @value_type = n.get_enum_value(MicrosoftGraphBeta::Models::RegistryValueType) },
                }
            end
            ## 
