...
module MicrosoftGraphBeta::Models
    class TermsOfUseContainer < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "agreements" => lambda {|n| @agreements = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Agreement.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
