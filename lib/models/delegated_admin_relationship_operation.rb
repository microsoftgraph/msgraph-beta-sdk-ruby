...
module MicrosoftGraphBeta
    module Models
        class DelegatedAdminRelationshipOperation < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "operationType" => lambda {|n| @operation_type = n.get_enum_value(MicrosoftGraphBeta::Models::DelegatedAdminRelationshipOperationType) },
