...
module MicrosoftGraphBeta
    module Models
        class SecurityEdiscoveryNoncustodialDataSource < MicrosoftGraphBeta::Models::SecurityDataSourceContainer
            ...
            def get_field_deserializers()
                return super.merge({
                    "dataSource" => lambda {|n| @data_source = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityDataSource.create_from_discriminator_value(pn) }) },
