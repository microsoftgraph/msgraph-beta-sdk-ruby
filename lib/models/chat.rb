...
module MicrosoftGraphBeta
    module Models
        class Chat < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "onlineMeetingInfo" => lambda {|n| @online_meeting_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamworkOnlineMeetingInfo.create_from_discriminator_value(pn) }) },
                    "operations" => lambda {|n| @operations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TeamsAsyncOperation.create_from_discriminator_value(pn) }) },
                    ...
                    "pinnedMessages" => lambda {|n| @pinned_messages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PinnedChatMessageInfo.create_from_discriminator_value(pn) }) },
                    "tabs" => lambda {|n| @tabs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TeamsTab.create_from_discriminator_value(pn) }) },
                    "tenantId" => lambda {|n| @tenant_id = n.get_string_value() },
                    "topic" => lambda {|n| @topic = n.get_string_value() },
                    "viewpoint" => lambda {|n| @viewpoint = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChatViewpoint.create_from_discriminator_value(pn) }) },
