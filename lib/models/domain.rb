...
module MicrosoftGraphBeta
    module Models
        class Domain < MicrosoftGraphBeta::Models::Entity
            ...
            @shared_email_domain_invitations
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "domainNameReferences" => lambda {|n| @domain_name_references = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
                    "federationConfiguration" => lambda {|n| @federation_configuration = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::InternalDomainFederation.create_from_discriminator_value(pn) }) },
                    ...
                    "rootDomain" => lambda {|n| @root_domain = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Domain.create_from_discriminator_value(pn) }) },
                    "serviceConfigurationRecords" => lambda {|n| @service_configuration_records = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DomainDnsRecord.create_from_discriminator_value(pn) }) },
                    "sharedEmailDomainInvitations" => lambda {|n| @shared_email_domain_invitations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SharedEmailDomainInvitation.create_from_discriminator_value(pn) }) },
                    "state" => lambda {|n| @state = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DomainState.create_from_discriminator_value(pn) }) },
                    "supportedServices" => lambda {|n| @supported_services = n.get_collection_of_primitive_values(String) },
                    "verificationDnsRecords" => lambda {|n| @verification_dns_records = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DomainDnsRecord.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("sharedEmailDomainInvitations", @shared_email_domain_invitations)
            ...
            def shared_email_domain_invitations
                return @shared_email_domain_invitations
            end
            ## 
            ...
            ## @return a void
            ## 
            def shared_email_domain_invitations=(value)
                @shared_email_domain_invitations = value
            end
            ## 
