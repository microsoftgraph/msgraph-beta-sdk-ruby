...
module MicrosoftGraphBeta
    module Models
        class UserActivity < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "historyItems" => lambda {|n| @history_items = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ActivityHistoryItem.create_from_discriminator_value(pn) }) },
                    "lastModifiedDateTime" => lambda {|n| @last_modified_date_time = n.get_date_time_value() },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::UserActivityStatus) },
                    "userTimezone" => lambda {|n| @user_timezone = n.get_string_value() },
                    "visualElements" => lambda {|n| @visual_elements = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::VisualInfo.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
