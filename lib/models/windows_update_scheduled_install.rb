...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdateScheduledInstall < MicrosoftGraphBeta::Models::WindowsUpdateInstallScheduleType
            ...
            def get_field_deserializers()
                return super.merge({
                    "scheduledInstallDay" => lambda {|n| @scheduled_install_day = n.get_enum_value(MicrosoftGraphBeta::Models::WeeklySchedule) },
