...
module MicrosoftGraphBeta
    module Models
        class CloudLicensingGroupCloudLicensing
            ...
            ## 
            ## Instantiates a new CloudLicensingGroupCloudLicensing and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            ## @return a cloud_licensing_group_cloud_licensing
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return CloudLicensingGroupCloudLicensing.new
            end
            ## 
