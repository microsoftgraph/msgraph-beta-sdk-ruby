        ...
        module Security
            class EdiscoveryCaseSettings < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "ocr" => lambda {|n| @ocr = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::OcrSettings.create_from_discriminator_value(pn) }) },
                        "redundancyDetection" => lambda {|n| @redundancy_detection = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::RedundancyDetectionSettings.create_from_discriminator_value(pn) }) },
                        "topicModeling" => lambda {|n| @topic_modeling = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::TopicModelingSettings.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
