    ...
    module Models
        module Security
            class LabelsRoot < MicrosoftGraphBeta::Models::Entity
                ...
                ## @param value Value to set for the file_plan_references property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "authorities" => lambda {|n| @authorities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::AuthorityTemplate.create_from_discriminator_value(pn) }) },
                        "categories" => lambda {|n| @categories = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::CategoryTemplate.create_from_discriminator_value(pn) }) },
                        "citations" => lambda {|n| @citations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::CitationTemplate.create_from_discriminator_value(pn) }) },
                        "departments" => lambda {|n| @departments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::DepartmentTemplate.create_from_discriminator_value(pn) }) },
                        "filePlanReferences" => lambda {|n| @file_plan_references = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::FilePlanReferenceTemplate.create_from_discriminator_value(pn) }) },
