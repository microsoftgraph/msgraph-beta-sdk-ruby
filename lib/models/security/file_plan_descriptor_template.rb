...
module MicrosoftGraphBeta
    module Models
        module Security
            class FilePlanDescriptorTemplate < MicrosoftGraphBeta::Models::Entity
                ...
                ## @return a file_plan_descriptor_template
                ## 
                    ...
                    unless mapping_value_node.nil? then
                        ...
                        case mapping_value
                            ...
                            when "#microsoft.graph.security.subCategoryTemplate"
                                return SubCategoryTemplate.new
                        end
                    end
                    return FilePlanDescriptorTemplate.new
                end
                ## 
