...
module MicrosoftGraphBeta
    module Models
        module Security
            class RetentionLabel < MicrosoftGraphBeta::Models::Entity
                ...
                ## @return a action_after_retention_period
                ## 
                ...
                ## @param value Value to set for the action_after_retention_period property.
                ## @return a void
                ## 
                ...
                ## @return a default_record_behavior
                ## 
                ...
                ## @param value Value to set for the default_record_behavior property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the description_for_users property.
                ## @return a void
                ## 
                ...
                ## @return a disposition_review_stage
                ## 
                ...
                ## @param value Value to set for the disposition_review_stages property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "actionAfterRetentionPeriod" => lambda {|n| @action_after_retention_period = n.get_enum_value(MicrosoftGraphBeta::Models::Security::ActionAfterRetentionPeriod) },
                        ...
                        "defaultRecordBehavior" => lambda {|n| @default_record_behavior = n.get_enum_value(MicrosoftGraphBeta::Models::Security::DefaultRecordBehavior) },
                        ...
                        "descriptors" => lambda {|n| @descriptors = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::FilePlanDescriptor.create_from_discriminator_value(pn) }) },
                        "displayName" => lambda {|n| @display_name = n.get_string_value() },
                        "dispositionReviewStages" => lambda {|n| @disposition_review_stages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::DispositionReviewStage.create_from_discriminator_value(pn) }) },
                        ...
                        "retentionDuration" => lambda {|n| @retention_duration = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::RetentionDuration.create_from_discriminator_value(pn) }) },
                        "retentionEventType" => lambda {|n| @retention_event_type = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::RetentionEventType.create_from_discriminator_value(pn) }) },
                        "retentionTrigger" => lambda {|n| @retention_trigger = n.get_enum_value(MicrosoftGraphBeta::Models::Security::RetentionTrigger) },
                    })
                end
                ## 
                ...
                ## @param value Value to set for the is_in_use property.
                ## @return a void
                ## 
                def is_in_use=(value)
                    @is_in_use = value
                ...
                ## @param value Value to set for the label_to_be_applied property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the retention_duration property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the retention_trigger property.
                ## @return a void
                ## 
