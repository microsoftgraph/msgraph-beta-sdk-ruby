...
module MicrosoftGraphBeta
    module Models
        module Security
            class AllowFileResponseAction < MicrosoftGraphBeta::Models::Security::ResponseAction
                ...
                ## @return a allow_file_response_action
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "identifier" => lambda {|n| @identifier = n.get_enum_value(MicrosoftGraphBeta::Models::Security::FileEntityIdentifier) },
                    })
                end
                ## 
                ## Gets the identifier property value. The identifier property
                ## @return a file_entity_identifier
                ## 
                def identifier
                    return @identifier
                end
