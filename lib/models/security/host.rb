...
module MicrosoftGraphBeta
    module Models
        module Security
            class Host < MicrosoftGraphBeta::Models::Security::Artifact
                ...
                def get_field_deserializers()
                    return super.merge({
                        "childHostPairs" => lambda {|n| @child_host_pairs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::HostPair.create_from_discriminator_value(pn) }) },
                        "components" => lambda {|n| @components = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::HostComponent.create_from_discriminator_value(pn) }) },
                        "cookies" => lambda {|n| @cookies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::HostCookie.create_from_discriminator_value(pn) }) },
                        ...
                        "parentHostPairs" => lambda {|n| @parent_host_pairs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::HostPair.create_from_discriminator_value(pn) }) },
                        "passiveDns" => lambda {|n| @passive_dns = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::PassiveDnsRecord.create_from_discriminator_value(pn) }) },
                        "passiveDnsReverse" => lambda {|n| @passive_dns_reverse = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::PassiveDnsRecord.create_from_discriminator_value(pn) }) },
                        "reputation" => lambda {|n| @reputation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::HostReputation.create_from_discriminator_value(pn) }) },
                        "sslCertificates" => lambda {|n| @ssl_certificates = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::HostSslCertificate.create_from_discriminator_value(pn) }) },
                        ...
                        "trackers" => lambda {|n| @trackers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::HostTracker.create_from_discriminator_value(pn) }) },
                        "whois" => lambda {|n| @whois = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::WhoisRecord.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
