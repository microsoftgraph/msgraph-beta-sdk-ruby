            ...
            class EdiscoveryExportOperation < MicrosoftGraphBeta::Models::Security::CaseOperation
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "exportFileMetadata" => lambda {|n| @export_file_metadata = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::ExportFileMetadata.create_from_discriminator_value(pn) }) },
