...
module MicrosoftGraphBeta
    module Models
        module Security
            class KubernetesClusterEvidence < MicrosoftGraphBeta::Models::Security::AlertEvidence
                ...
                def get_field_deserializers()
                    return super.merge({
                        "cloudResource" => lambda {|n| @cloud_resource = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::AlertEvidence.create_from_discriminator_value(pn) }) },
                        "distribution" => lambda {|n| @distribution = n.get_string_value() },
                        "name" => lambda {|n| @name = n.get_string_value() },
                        "platform" => lambda {|n| @platform = n.get_enum_value(MicrosoftGraphBeta::Models::Security::KubernetesPlatform) },
