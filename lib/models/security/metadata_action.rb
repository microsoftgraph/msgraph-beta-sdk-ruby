...
module MicrosoftGraphBeta
    module Models
        module Security
            class MetadataAction < MicrosoftGraphBeta::Models::Security::InformationProtectionAction
                ...
                def get_field_deserializers()
                    return super.merge({
                        "metadataToAdd" => lambda {|n| @metadata_to_add = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::KeyValuePair.create_from_discriminator_value(pn) }) },
                ...
                ## @param value Value to set for the metadata_to_add property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the metadata_to_remove property.
                ## @return a void
                ## 
