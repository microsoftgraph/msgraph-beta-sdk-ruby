...
module MicrosoftGraphBeta
    module Models
        module Security
            class FilePlanDescriptor < MicrosoftGraphBeta::Models::Entity
                ...
                ## @param value Value to set for the authority_template property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the category_template property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the citation_template property.
                ## @return a void
                ## 
                ...
                ## @return a file_plan_descriptor
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return FilePlanDescriptor.new
                end
                ## 
                ...
                ## @param value Value to set for the department_template property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the file_plan_reference property.
                ## @return a void
                ## 
                ...
                ## @return a file_plan_reference_template
                ## 
                ...
                ## @param value Value to set for the file_plan_reference_template property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "authority" => lambda {|n| @authority = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::Authority.create_from_discriminator_value(pn) }) },
                        "authorityTemplate" => lambda {|n| @authority_template = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::AuthorityTemplate.create_from_discriminator_value(pn) }) },
                        "category" => lambda {|n| @category = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::AppliedCategory.create_from_discriminator_value(pn) }) },
                        "categoryTemplate" => lambda {|n| @category_template = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::CategoryTemplate.create_from_discriminator_value(pn) }) },
                        "citation" => lambda {|n| @citation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::Citation.create_from_discriminator_value(pn) }) },
                        "citationTemplate" => lambda {|n| @citation_template = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::CitationTemplate.create_from_discriminator_value(pn) }) },
                        "department" => lambda {|n| @department = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::Department.create_from_discriminator_value(pn) }) },
                        "departmentTemplate" => lambda {|n| @department_template = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::DepartmentTemplate.create_from_discriminator_value(pn) }) },
                        "filePlanReference" => lambda {|n| @file_plan_reference = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::FilePlanReference.create_from_discriminator_value(pn) }) },
                        "filePlanReferenceTemplate" => lambda {|n| @file_plan_reference_template = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::FilePlanReferenceTemplate.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
