...
module MicrosoftGraphBeta
    module Models
        module Security
            class WhoisRecord < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "abuse" => lambda {|n| @abuse = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::WhoisContact.create_from_discriminator_value(pn) }) },
                        "admin" => lambda {|n| @admin = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::WhoisContact.create_from_discriminator_value(pn) }) },
                        "billing" => lambda {|n| @billing = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::WhoisContact.create_from_discriminator_value(pn) }) },
                        ...
                        "nameservers" => lambda {|n| @nameservers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::WhoisNameserver.create_from_discriminator_value(pn) }) },
                        "noc" => lambda {|n| @noc = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::WhoisContact.create_from_discriminator_value(pn) }) },
                        "rawWhoisText" => lambda {|n| @raw_whois_text = n.get_string_value() },
                        "registrant" => lambda {|n| @registrant = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::WhoisContact.create_from_discriminator_value(pn) }) },
                        "registrar" => lambda {|n| @registrar = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::WhoisContact.create_from_discriminator_value(pn) }) },
                        "registrationDateTime" => lambda {|n| @registration_date_time = n.get_date_time_value() },
                        "technical" => lambda {|n| @technical = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::WhoisContact.create_from_discriminator_value(pn) }) },
                        "whoisServer" => lambda {|n| @whois_server = n.get_string_value() },
                        "zone" => lambda {|n| @zone = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::WhoisContact.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
