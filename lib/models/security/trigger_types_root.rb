...
module MicrosoftGraphBeta::Models::Security
    class TriggerTypesRoot < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "retentionEventTypes" => lambda {|n| @retention_event_types = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::RetentionEventType.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
