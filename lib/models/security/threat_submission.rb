...
module MicrosoftGraphBeta
    module Models
        module Security
            class ThreatSubmission < MicrosoftGraphBeta::Models::Entity
                ...
                ## @return a submission_admin_review
                ## 
                def admin_review
                    return @admin_review
                end
                ...
                ## @param value Value to set for the admin_review property.
                ## @return a void
                ## 
                ...
                ## @return a submission_client_source
                ## 
                def client_source
                ...
                ## @param value Value to set for the client_source property.
                ## @return a void
                ## 
                ...
                ## @return a submission_content_type
                ## 
                def content_type
                    return @content_type
                end
                    ...
                    unless mapping_value_node.nil? then
                        ...
                        case mapping_value
                            ...
                            when "#microsoft.graph.security.emailThreatSubmission"
                                return EmailThreatSubmission.new
                            ...
                            when "#microsoft.graph.security.urlThreatSubmission"
                                return UrlThreatSubmission.new
                        end
                    end
                    return ThreatSubmission.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "adminReview" => lambda {|n| @admin_review = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::SubmissionAdminReview.create_from_discriminator_value(pn) }) },
                        "category" => lambda {|n| @category = n.get_enum_value(MicrosoftGraphBeta::Models::Security::SubmissionCategory) },
                        "clientSource" => lambda {|n| @client_source = n.get_enum_value(MicrosoftGraphBeta::Models::Security::SubmissionClientSource) },
                        "contentType" => lambda {|n| @content_type = n.get_enum_value(MicrosoftGraphBeta::Models::Security::SubmissionContentType) },
                        "createdBy" => lambda {|n| @created_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::SubmissionUserIdentity.create_from_discriminator_value(pn) }) },
                        "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                        "result" => lambda {|n| @result = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::SubmissionResult.create_from_discriminator_value(pn) }) },
                        "source" => lambda {|n| @source = n.get_enum_value(MicrosoftGraphBeta::Models::Security::SubmissionSource) },
