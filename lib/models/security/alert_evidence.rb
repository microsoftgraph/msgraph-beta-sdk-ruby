            ...
            class AlertEvidence
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "remediationStatus" => lambda {|n| @remediation_status = n.get_enum_value(MicrosoftGraphBeta::Models::Security::EvidenceRemediationStatus) },
                        "remediationStatusDetails" => lambda {|n| @remediation_status_details = n.get_string_value() },
                        "roles" => lambda {|n| @roles = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::EvidenceRole.create_from_discriminator_value(pn) }) },
                        "tags" => lambda {|n| @tags = n.get_collection_of_primitive_values(String) },
                        "verdict" => lambda {|n| @verdict = n.get_enum_value(MicrosoftGraphBeta::Models::Security::EvidenceVerdict) },
                    }
                end
                ## 
