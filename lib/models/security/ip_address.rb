...
module MicrosoftGraphBeta
    module Models
        module Security
            class IpAddress < MicrosoftGraphBeta::Models::Security::Host
                ...
                def get_field_deserializers()
                    return super.merge({
                        "autonomousSystem" => lambda {|n| @autonomous_system = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::AutonomousSystem.create_from_discriminator_value(pn) }) },
