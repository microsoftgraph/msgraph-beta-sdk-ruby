...
module MicrosoftGraphBeta::Models::Security
    class ProcessEvidence < MicrosoftGraphBeta::Models::Security::AlertEvidence
        ...
        def get_field_deserializers()
            return super.merge({
                "detectionStatus" => lambda {|n| @detection_status = n.get_enum_value(MicrosoftGraphBeta::Models::Security::DetectionStatus) },
                "imageFile" => lambda {|n| @image_file = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::FileDetails.create_from_discriminator_value(pn) }) },
                ...
                "parentProcessImageFile" => lambda {|n| @parent_process_image_file = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::FileDetails.create_from_discriminator_value(pn) }) },
                ...
                "userAccount" => lambda {|n| @user_account = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::UserAccount.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
