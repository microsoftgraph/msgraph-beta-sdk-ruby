...
module MicrosoftGraphBeta
    module Models
        module Security
            class SslCertificate < MicrosoftGraphBeta::Models::Security::Artifact
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "issuer" => lambda {|n| @issuer = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::SslCertificateEntity.create_from_discriminator_value(pn) }) },
                        "lastSeenDateTime" => lambda {|n| @last_seen_date_time = n.get_date_time_value() },
                        "relatedHosts" => lambda {|n| @related_hosts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::Host.create_from_discriminator_value(pn) }) },
                        "serialNumber" => lambda {|n| @serial_number = n.get_string_value() },
                        "sha1" => lambda {|n| @sha1 = n.get_string_value() },
                        "subject" => lambda {|n| @subject = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::SslCertificateEntity.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
