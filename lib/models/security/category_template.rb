...
module MicrosoftGraphBeta
    module Models
        module Security
            class CategoryTemplate < MicrosoftGraphBeta::Models::Security::FilePlanDescriptorTemplate
                ...
                def get_field_deserializers()
                    return super.merge({
                        "subCategories" => lambda {|n| @sub_categories = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::SubCategoryTemplate.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
                ...
                ## @return a sub_category_template
                ## 
                def sub_categories
                ...
                ## @param value Value to set for the sub_categories property.
                ## @return a void
                ## 
