...
module MicrosoftGraphBeta
    module Models
        module Security
            class GoogleCloudResourceEvidence < MicrosoftGraphBeta::Models::Security::AlertEvidence
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "locationType" => lambda {|n| @location_type = n.get_enum_value(MicrosoftGraphBeta::Models::Security::GoogleCloudLocationType) },
