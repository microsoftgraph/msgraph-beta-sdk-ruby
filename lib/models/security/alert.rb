            ...
            class Alert < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "detectionSource" => lambda {|n| @detection_source = n.get_enum_value(MicrosoftGraphBeta::Models::Security::DetectionSource) },
                        ...
                        "evidence" => lambda {|n| @evidence = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::AlertEvidence.create_from_discriminator_value(pn) }) },
                        ...
                        "serviceSource" => lambda {|n| @service_source = n.get_enum_value(MicrosoftGraphBeta::Models::Security::ServiceSource) },
                        "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraphBeta::Models::Security::AlertSeverity) },
                        "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::Security::AlertStatus) },
