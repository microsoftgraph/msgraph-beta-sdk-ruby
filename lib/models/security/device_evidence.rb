...
module MicrosoftGraphBeta::Models::Security
    class DeviceEvidence < MicrosoftGraphBeta::Models::Security::AlertEvidence
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "defenderAvStatus" => lambda {|n| @defender_av_status = n.get_enum_value(MicrosoftGraphBeta::Models::Security::DefenderAvStatus) },
                "deviceDnsName" => lambda {|n| @device_dns_name = n.get_string_value() },
                "firstSeenDateTime" => lambda {|n| @first_seen_date_time = n.get_date_time_value() },
                "healthStatus" => lambda {|n| @health_status = n.get_enum_value(MicrosoftGraphBeta::Models::Security::DeviceHealthStatus) },
                "loggedOnUsers" => lambda {|n| @logged_on_users = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::LoggedOnUser.create_from_discriminator_value(pn) }) },
                "mdeDeviceId" => lambda {|n| @mde_device_id = n.get_string_value() },
                "onboardingStatus" => lambda {|n| @onboarding_status = n.get_enum_value(MicrosoftGraphBeta::Models::Security::OnboardingStatus) },
                ...
                "riskScore" => lambda {|n| @risk_score = n.get_enum_value(MicrosoftGraphBeta::Models::Security::DeviceRiskScore) },
                "version" => lambda {|n| @version = n.get_string_value() },
                "vmMetadata" => lambda {|n| @vm_metadata = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::VmMetadata.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
