        ...
        module Security
            class SubmissionAdminReview
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return SubmissionAdminReview.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "reviewResult" => lambda {|n| @review_result = n.get_enum_value(MicrosoftGraphBeta::Models::Security::SubmissionResultCategory) },
                    }
                end
                ## 
                ...
                ## @param value Value to set for the review_by property.
                ## @return a void
                ## 
                def review_by=(value)
                    @review_by = value
                ...
                ## @param value Value to set for the review_date_time property.
                ## @return a void
                ## 
