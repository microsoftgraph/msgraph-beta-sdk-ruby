...
module MicrosoftGraphBeta
    module Models
        module Security
            class BlobEvidence < MicrosoftGraphBeta::Models::Security::AlertEvidence
                ...
                def get_field_deserializers()
                    return super.merge({
                        "blobContainer" => lambda {|n| @blob_container = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::BlobContainerEvidence.create_from_discriminator_value(pn) }) },
                        "etag" => lambda {|n| @etag = n.get_string_value() },
                        "fileHashes" => lambda {|n| @file_hashes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::FileHash.create_from_discriminator_value(pn) }) },
