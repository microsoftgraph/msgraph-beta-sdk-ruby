...
module MicrosoftGraphBeta
    module Models
        module Security
            class PassiveDnsRecord < MicrosoftGraphBeta::Models::Security::Artifact
                ...
                def get_field_deserializers()
                    return super.merge({
                        "artifact" => lambda {|n| @artifact = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::Artifact.create_from_discriminator_value(pn) }) },
