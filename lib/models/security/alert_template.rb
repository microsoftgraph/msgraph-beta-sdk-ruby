            ...
            class AlertTemplate
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "impactedAssets" => lambda {|n| @impacted_assets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::ImpactedAsset.create_from_discriminator_value(pn) }) },
