...
module MicrosoftGraphBeta::Models::Security
    class EdiscoverySearch < MicrosoftGraphBeta::Models::Security::Search
        ...
        def get_field_deserializers()
            return super.merge({
                "additionalSources" => lambda {|n| @additional_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::DataSource.create_from_discriminator_value(pn) }) },
                "addToReviewSetOperation" => lambda {|n| @add_to_review_set_operation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryAddToReviewSetOperation.create_from_discriminator_value(pn) }) },
                "custodianSources" => lambda {|n| @custodian_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::DataSource.create_from_discriminator_value(pn) }) },
                "dataSourceScopes" => lambda {|n| @data_source_scopes = n.get_enum_value(MicrosoftGraphBeta::Models::Security::DataSourceScopes) },
                "lastEstimateStatisticsOperation" => lambda {|n| @last_estimate_statistics_operation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryEstimateOperation.create_from_discriminator_value(pn) }) },
                "noncustodialSources" => lambda {|n| @noncustodial_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryNoncustodialDataSource.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
