            ...
            class HuntingQueryResults
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "results" => lambda {|n| @results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::HuntingRowResult.create_from_discriminator_value(pn) }) },
                        "schema" => lambda {|n| @schema = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::SinglePropertySchema.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
