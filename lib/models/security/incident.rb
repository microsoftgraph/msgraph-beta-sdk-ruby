...
module MicrosoftGraphBeta
    module Models
        module Security
            class Incident < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "alerts" => lambda {|n| @alerts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::Alert.create_from_discriminator_value(pn) }) },
                        "assignedTo" => lambda {|n| @assigned_to = n.get_string_value() },
                        "classification" => lambda {|n| @classification = n.get_enum_value(MicrosoftGraphBeta::Models::Security::AlertClassification) },
                        "comments" => lambda {|n| @comments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::AlertComment.create_from_discriminator_value(pn) }) },
                        "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                        "customTags" => lambda {|n| @custom_tags = n.get_collection_of_primitive_values(String) },
                        "description" => lambda {|n| @description = n.get_string_value() },
                        "determination" => lambda {|n| @determination = n.get_enum_value(MicrosoftGraphBeta::Models::Security::AlertDetermination) },
                        ...
                        "recommendedHuntingQueries" => lambda {|n| @recommended_hunting_queries = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::RecommendedHuntingQuery.create_from_discriminator_value(pn) }) },
                        "redirectIncidentId" => lambda {|n| @redirect_incident_id = n.get_string_value() },
                        "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraphBeta::Models::Security::AlertSeverity) },
                        "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::Security::IncidentStatus) },
                ...
                ## @return a recommended_hunting_query
                ## 
                ...
                ## @param value Value to set for the recommended_hunting_queries property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the system_tags property.
                ## @return a void
                ## 
