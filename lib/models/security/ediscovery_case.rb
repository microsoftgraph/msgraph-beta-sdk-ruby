...
module MicrosoftGraphBeta
    module Models
        module Security
            class EdiscoveryCase < MicrosoftGraphBeta::Models::Security::Case_escaped
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "custodians" => lambda {|n| @custodians = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryCustodian.create_from_discriminator_value(pn) }) },
                        "externalId" => lambda {|n| @external_id = n.get_string_value() },
                        "legalHolds" => lambda {|n| @legal_holds = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryHoldPolicy.create_from_discriminator_value(pn) }) },
                        "noncustodialDataSources" => lambda {|n| @noncustodial_data_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryNoncustodialDataSource.create_from_discriminator_value(pn) }) },
                        "operations" => lambda {|n| @operations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::CaseOperation.create_from_discriminator_value(pn) }) },
                        "reviewSets" => lambda {|n| @review_sets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryReviewSet.create_from_discriminator_value(pn) }) },
                        "searches" => lambda {|n| @searches = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoverySearch.create_from_discriminator_value(pn) }) },
                        "settings" => lambda {|n| @settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryCaseSettings.create_from_discriminator_value(pn) }) },
