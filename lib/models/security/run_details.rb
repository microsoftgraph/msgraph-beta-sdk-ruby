        ...
        module Security
            class RunDetails
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return RunDetails.new
                end
                ## 
                ## Gets the errorCode property value. The errorCode property
                ## @return a hunting_rule_error_code
                ## 
                def error_code
                    return @error_code
                end
                ...
                def get_field_deserializers()
                    return {
                        "errorCode" => lambda {|n| @error_code = n.get_enum_value(MicrosoftGraphBeta::Models::Security::HuntingRuleErrorCode) },
                        ...
                        "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::Security::HuntingRuleRunStatus) },
                    }
                end
                ## 
                ...
                ## @return a hunting_rule_run_status
                ## 
                def status
                    return @status
                end
