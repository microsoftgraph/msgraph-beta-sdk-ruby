...
module MicrosoftGraphBeta
    module Models
        module Security
            class HostReputation < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "classification" => lambda {|n| @classification = n.get_enum_value(MicrosoftGraphBeta::Models::Security::HostReputationClassification) },
                        "rules" => lambda {|n| @rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::HostReputationRule.create_from_discriminator_value(pn) }) },
