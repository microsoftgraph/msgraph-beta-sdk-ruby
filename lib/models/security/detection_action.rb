        ...
        module Security
            class DetectionAction
                ...
                def get_field_deserializers()
                    return {
                        "alertTemplate" => lambda {|n| @alert_template = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::AlertTemplate.create_from_discriminator_value(pn) }) },
                        "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                        "organizationalScope" => lambda {|n| @organizational_scope = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::OrganizationalScope.create_from_discriminator_value(pn) }) },
                        "responseActions" => lambda {|n| @response_actions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::ResponseAction.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
