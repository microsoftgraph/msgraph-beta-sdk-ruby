...
module MicrosoftGraphBeta
    module Models
        module Security
            class ContainerImageEvidence < MicrosoftGraphBeta::Models::Security::AlertEvidence
                ...
                def get_field_deserializers()
                    return super.merge({
                        "digestImage" => lambda {|n| @digest_image = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::ContainerImageEvidence.create_from_discriminator_value(pn) }) },
                        "imageId" => lambda {|n| @image_id = n.get_string_value() },
                        "registry" => lambda {|n| @registry = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::ContainerRegistryEvidence.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
