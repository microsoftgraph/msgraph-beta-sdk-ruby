...
module MicrosoftGraphBeta::Models::Security
    class AddContentHeaderAction < MicrosoftGraphBeta::Models::Security::InformationProtectionAction
        ...
        ## @return a add_content_header_action
        ## 
        ...
        ## @param value Value to set for the font_color property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the font_name property.
        ## @return a void
        ## 
        def font_name=(value)
            @font_name = value
        ...
        ## @param value Value to set for the font_size property.
        ## @return a void
        ## 
        def font_size=(value)
            @font_size = value
        ...
        def get_field_deserializers()
            return super.merge({
                "alignment" => lambda {|n| @alignment = n.get_enum_value(MicrosoftGraphBeta::Models::Security::ContentAlignment) },
        ...
        ## @param value Value to set for the ui_element_name property.
        ## @return a void
        ## 
