...
module MicrosoftGraphBeta
    module Models
        module Security
            class HostSslCertificate < MicrosoftGraphBeta::Models::Security::Artifact
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "host" => lambda {|n| @host = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::Host.create_from_discriminator_value(pn) }) },
                        "lastSeenDateTime" => lambda {|n| @last_seen_date_time = n.get_date_time_value() },
                        "ports" => lambda {|n| @ports = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::HostSslCertificatePort.create_from_discriminator_value(pn) }) },
                        "sslCertificate" => lambda {|n| @ssl_certificate = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::SslCertificate.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
