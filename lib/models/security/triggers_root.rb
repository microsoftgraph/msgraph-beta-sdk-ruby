...
module MicrosoftGraphBeta
    module Models
        module Security
            class TriggersRoot < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "retentionEvents" => lambda {|n| @retention_events = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::RetentionEvent.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
