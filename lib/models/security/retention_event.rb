...
module MicrosoftGraphBeta
    module Models
        module Security
            class RetentionEvent < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "eventPropagationResults" => lambda {|n| @event_propagation_results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::EventPropagationResult.create_from_discriminator_value(pn) }) },
                        "eventQueries" => lambda {|n| @event_queries = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::EventQuery.create_from_discriminator_value(pn) }) },
                        "eventStatus" => lambda {|n| @event_status = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::RetentionEventStatus.create_from_discriminator_value(pn) }) },
