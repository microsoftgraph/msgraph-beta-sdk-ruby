...
module MicrosoftGraphBeta
    module Models
        module Security
            class EdiscoveryCustodian < MicrosoftGraphBeta::Models::Security::DataSourceContainer
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "lastIndexOperation" => lambda {|n| @last_index_operation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryIndexOperation.create_from_discriminator_value(pn) }) },
                        "siteSources" => lambda {|n| @site_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::SiteSource.create_from_discriminator_value(pn) }) },
                        "unifiedGroupSources" => lambda {|n| @unified_group_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::UnifiedGroupSource.create_from_discriminator_value(pn) }) },
                        "userSources" => lambda {|n| @user_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::UserSource.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
