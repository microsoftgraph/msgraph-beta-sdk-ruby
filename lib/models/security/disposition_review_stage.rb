...
module MicrosoftGraphBeta
    module Models
        module Security
            class DispositionReviewStage < MicrosoftGraphBeta::Models::Entity
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return DispositionReviewStage.new
                end
                ## 
                ...
                ## @param value Value to set for the reviewers_email_addresses property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the stage_number property.
                ## @return a void
                ## 
