...
module MicrosoftGraphBeta
    module Models
        module Security
            class AppliedCategory < MicrosoftGraphBeta::Models::Security::FilePlanDescriptorBase
                ...
                def get_field_deserializers()
                    return super.merge({
                        "subCategory" => lambda {|n| @sub_category = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::SubCategory.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
                ...
                ## @param value Value to set for the sub_category property.
                ## @return a void
                ## 
