...
module MicrosoftGraphBeta
    module Models
        module Security
            class KubernetesNamespaceEvidence < MicrosoftGraphBeta::Models::Security::AlertEvidence
                ...
                def get_field_deserializers()
                    return super.merge({
                        "cluster" => lambda {|n| @cluster = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::KubernetesClusterEvidence.create_from_discriminator_value(pn) }) },
