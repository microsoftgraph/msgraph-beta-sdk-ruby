...
module MicrosoftGraphBeta::Models::Security
    class UnifiedGroupSource < MicrosoftGraphBeta::Models::Security::DataSource
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "includedSources" => lambda {|n| @included_sources = n.get_enum_value(MicrosoftGraphBeta::Models::Security::SourceType) },
            })
        end
        ## 
