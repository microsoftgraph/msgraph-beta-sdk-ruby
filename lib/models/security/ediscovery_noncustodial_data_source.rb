...
module MicrosoftGraphBeta
    module Models
        module Security
            class EdiscoveryNoncustodialDataSource < MicrosoftGraphBeta::Models::Security::DataSourceContainer
                ...
                def get_field_deserializers()
                    return super.merge({
                        "dataSource" => lambda {|n| @data_source = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::DataSource.create_from_discriminator_value(pn) }) },
