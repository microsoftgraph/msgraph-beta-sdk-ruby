...
module MicrosoftGraphBeta
    module Models
        module Security
            class EmailThreatSubmission < MicrosoftGraphBeta::Models::Security::ThreatSubmission
                ...
                ## @param value Value to set for the attack_simulation_info property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "attackSimulationInfo" => lambda {|n| @attack_simulation_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::AttackSimulationInfo.create_from_discriminator_value(pn) }) },
                        "internetMessageId" => lambda {|n| @internet_message_id = n.get_string_value() },
                        "originalCategory" => lambda {|n| @original_category = n.get_enum_value(MicrosoftGraphBeta::Models::Security::SubmissionCategory) },
                        ...
                        "tenantAllowOrBlockListAction" => lambda {|n| @tenant_allow_or_block_list_action = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::TenantAllowOrBlockListAction.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
                ...
                ## @param value Value to set for the original_category property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the sender_i_p property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the tenant_allow_or_block_list_action property.
                ## @return a void
                ## 
