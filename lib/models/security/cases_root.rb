...
module MicrosoftGraphBeta
    module Models
        module Security
            class CasesRoot < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "ediscoveryCases" => lambda {|n| @ediscovery_cases = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryCase.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
