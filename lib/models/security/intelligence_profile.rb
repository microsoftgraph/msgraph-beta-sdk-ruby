            ...
            class IntelligenceProfile < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "countriesOrRegionsOfOrigin" => lambda {|n| @countries_or_regions_of_origin = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::IntelligenceProfileCountryOrRegionOfOrigin.create_from_discriminator_value(pn) }) },
