...
module MicrosoftGraphBeta
    module Models
        class MacOSLobApp < MicrosoftGraphBeta::Models::MobileLobApp
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "childApps" => lambda {|n| @child_apps = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MacOSLobChildApp.create_from_discriminator_value(pn) }) },
