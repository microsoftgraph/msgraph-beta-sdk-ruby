...
module MicrosoftGraphBeta
    module Models
        class CloudPcCrossRegionDisasterRecoverySetting
            ...
            @user_initiated_disaster_recovery_allowed
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "userInitiatedDisasterRecoveryAllowed" => lambda {|n| @user_initiated_disaster_recovery_allowed = n.get_boolean_value() },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("userInitiatedDisasterRecoveryAllowed", @user_initiated_disaster_recovery_allowed)
            ...
            ## @return a boolean
            ## 
            def user_initiated_disaster_recovery_allowed
                return @user_initiated_disaster_recovery_allowed
            end
            ## 
            ...
            ## @return a void
            ## 
            def user_initiated_disaster_recovery_allowed=(value)
                @user_initiated_disaster_recovery_allowed = value
            end
        end
    end
end
