...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessCrossTenantAccessSettings < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "networkPacketTaggingStatus" => lambda {|n| @network_packet_tagging_status = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkaccessStatus) },
                })
            end
            ## 
