...
module MicrosoftGraphBeta
    module Models
        class DeviceCompliancePolicyScript
            ...
            ## @param value Value to set for the device_compliance_script_id property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "rulesContent" => lambda {|n| @rules_content = n.get_string_value() },
                }
            end
            ## 
            ...
            ## @param value Value to set for the rules_content property.
            ## @return a void
            ## 
