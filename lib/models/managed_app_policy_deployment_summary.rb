        ...
        class ManagedAppPolicyDeploymentSummary < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "configurationDeploymentSummaryPerApp" => lambda {|n| @configuration_deployment_summary_per_app = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedAppPolicyDeploymentSummaryPerApp.create_from_discriminator_value(pn) }) },
