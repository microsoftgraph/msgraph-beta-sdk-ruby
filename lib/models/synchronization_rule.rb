    ...
    module Models
        class SynchronizationRule
            ...
            def get_field_deserializers()
                return {
                    "containerFilter" => lambda {|n| @container_filter = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ContainerFilter.create_from_discriminator_value(pn) }) },
                    "editable" => lambda {|n| @editable = n.get_boolean_value() },
                    "groupFilter" => lambda {|n| @group_filter = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::GroupFilter.create_from_discriminator_value(pn) }) },
                    "id" => lambda {|n| @id = n.get_string_value() },
                    "metadata" => lambda {|n| @metadata = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::StringKeyStringValuePair.create_from_discriminator_value(pn) }) },
                    "name" => lambda {|n| @name = n.get_string_value() },
                    "objectMappings" => lambda {|n| @object_mappings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ObjectMapping.create_from_discriminator_value(pn) }) },
