...
module MicrosoftGraphBeta
    module Models
        class BaseEndUserNotification
            ...
            ## @param value Value to set for the end_user_notification property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "endUserNotification" => lambda {|n| @end_user_notification = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EndUserNotification.create_from_discriminator_value(pn) }) },
