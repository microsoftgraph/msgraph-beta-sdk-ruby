        ...
        class MacOSEndpointProtectionConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "fileVaultInstitutionalRecoveryKeyCertificate" => lambda {|n| @file_vault_institutional_recovery_key_certificate = n.get_object_value(lambda {|pn| Base64url.create_from_discriminator_value(pn) }) },
