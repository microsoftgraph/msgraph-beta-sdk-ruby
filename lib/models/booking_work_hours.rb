    ...
    module Models
        ...
        class BookingWorkHours
            ...
            def get_field_deserializers()
                return {
                    "day" => lambda {|n| @day = n.get_enum_value(MicrosoftGraphBeta::Models::DayOfWeek) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "timeSlots" => lambda {|n| @time_slots = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingWorkTimeSlot.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
