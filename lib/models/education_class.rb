...
module MicrosoftGraphBeta
    module Models
        class EducationClass < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "assignmentCategories" => lambda {|n| @assignment_categories = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EducationCategory.create_from_discriminator_value(pn) }) },
                    "assignmentDefaults" => lambda {|n| @assignment_defaults = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationAssignmentDefaults.create_from_discriminator_value(pn) }) },
                    "assignmentSettings" => lambda {|n| @assignment_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationAssignmentSettings.create_from_discriminator_value(pn) }) },
                    ...
                    "course" => lambda {|n| @course = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationCourse.create_from_discriminator_value(pn) }) },
                    ...
                    "members" => lambda {|n| @members = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EducationUser.create_from_discriminator_value(pn) }) },
                    "modules" => lambda {|n| @modules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EducationModule.create_from_discriminator_value(pn) }) },
                    ...
                    "teachers" => lambda {|n| @teachers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EducationUser.create_from_discriminator_value(pn) }) },
                    "term" => lambda {|n| @term = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationTerm.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
