...
module MicrosoftGraphBeta::Models
    class ConversationMemberRoleUpdatedEventMessageDetail < MicrosoftGraphBeta::Models::EventMessageDetail
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "conversationMemberUser" => lambda {|n| @conversation_member_user = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamworkUserIdentity.create_from_discriminator_value(pn) }) },
