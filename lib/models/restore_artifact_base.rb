...
module MicrosoftGraphBeta
    module Models
        class RestoreArtifactBase < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "restorePoint" => lambda {|n| @restore_point = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::RestorePoint.create_from_discriminator_value(pn) }) },
                    "startDateTime" => lambda {|n| @start_date_time = n.get_date_time_value() },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ArtifactRestoreStatus) },
                })
            end
            ## 
