...
module MicrosoftGraphBeta
    module Models
        class AttributeMappingFunctionSchema < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "parameters" => lambda {|n| @parameters = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AttributeMappingParameterSchema.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
