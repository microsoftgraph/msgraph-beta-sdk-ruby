...
module MicrosoftGraphBeta::Models
    class Todo < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "lists" => lambda {|n| @lists = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TodoTaskList.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
