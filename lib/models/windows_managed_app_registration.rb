...
module MicrosoftGraphBeta
    module Models
        ...
        class WindowsManagedAppRegistration < MicrosoftGraphBeta::Models::ManagedAppRegistration
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.windowsManagedAppRegistration"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a windows_managed_app_registration
            ## 
