...
module MicrosoftGraphBeta
    module Models
        class SingleResourceAzurePermissionsDefinition < MicrosoftGraphBeta::Models::PermissionsDefinition
            ...
            ## @return a single_resource_azure_permissions_definition
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "actionInfo" => lambda {|n| @action_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AzurePermissionsDefinitionAction.create_from_discriminator_value(pn) }) },
