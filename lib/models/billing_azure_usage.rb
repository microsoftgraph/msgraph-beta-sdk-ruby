...
module MicrosoftGraphBeta
    module Models
        class .models.partners.billingAzureUsage < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "billed" => lambda {|n| @billed = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::.models.partners.billingBilledUsage.create_from_discriminator_value(pn) }) },
                    "unbilled" => lambda {|n| @unbilled = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::.models.partners.billingUnbilledUsage.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
