...
module MicrosoftGraphBeta::Models
    class AdvancedThreatProtectionOnboardingStateSummary < MicrosoftGraphBeta::Models::Entity
        ...
        ## @param value Value to set for the advanced_threat_protection_onboarding_device_setting_states property.
        ## @return a void
        ## 
        def advanced_threat_protection_onboarding_device_setting_states=(value)
            @advanced_threat_protection_onboarding_device_setting_states = value
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                "advancedThreatProtectionOnboardingDeviceSettingStates" => lambda {|n| @advanced_threat_protection_onboarding_device_setting_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AdvancedThreatProtectionOnboardingDeviceSettingState.create_from_discriminator_value(pn) }) },
                ...
                "notAssignedDeviceCount" => lambda {|n| @not_assigned_device_count = n.get_number_value() },
        ...
        ## @return a integer
        ## 
        def not_assigned_device_count
            return @not_assigned_device_count
        end
        ## 
        ## Sets the notAssignedDeviceCount property value. Number of not assigned devices
        ## @param value Value to set for the not_assigned_device_count property.
        ## @return a void
        ## 
        def not_assigned_device_count=(value)
            @not_assigned_device_count = value
        end
        ## 
        ...
        def serialize(writer)
            ...
            super
            writer.write_collection_of_object_values("advancedThreatProtectionOnboardingDeviceSettingStates", @advanced_threat_protection_onboarding_device_setting_states)
            ...
            writer.write_number_value("notAssignedDeviceCount", @not_assigned_device_count)
