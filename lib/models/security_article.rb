...
module MicrosoftGraphBeta
    module Models
        class SecurityArticle < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "body" => lambda {|n| @body = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityFormattedContent.create_from_discriminator_value(pn) }) },
                    "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                    "imageUrl" => lambda {|n| @image_url = n.get_string_value() },
                    "indicators" => lambda {|n| @indicators = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityArticleIndicator.create_from_discriminator_value(pn) }) },
