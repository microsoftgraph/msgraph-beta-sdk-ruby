    ...
    module Models
        class AttendeeAvailability
            ...
            def get_field_deserializers()
                return {
                    "attendee" => lambda {|n| @attendee = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AttendeeBase.create_from_discriminator_value(pn) }) },
                    "availability" => lambda {|n| @availability = n.get_enum_value(MicrosoftGraphBeta::Models::AttendeeAvailabilityAvailability) },
