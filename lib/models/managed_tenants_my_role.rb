...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsMyRole
            ...
            ## 
            ## Instantiates a new managedTenantsMyRole and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ManagedTenantsMyRole.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "assignments" => lambda {|n| @assignments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsRoleAssignment.create_from_discriminator_value(pn) }) },
