...
module MicrosoftGraphBeta::Models
    class EducationRubric < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "description" => lambda {|n| @description = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationItemBody.create_from_discriminator_value(pn) }) },
                ...
                "levels" => lambda {|n| @levels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RubricLevel.create_from_discriminator_value(pn) }) },
                "qualities" => lambda {|n| @qualities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RubricQuality.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
