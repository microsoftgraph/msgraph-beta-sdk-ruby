    ...
    module Models
        class PrivilegedAccessGroupAssignmentSchedule < MicrosoftGraphBeta::Models::PrivilegedAccessSchedule
            ...
            def get_field_deserializers()
                return super.merge({
                    "accessId" => lambda {|n| @access_id = n.get_enum_value(MicrosoftGraphBeta::Models::PrivilegedAccessGroupAssignmentScheduleAccessId) },
                    ...
                    "assignmentType" => lambda {|n| @assignment_type = n.get_enum_value(MicrosoftGraphBeta::Models::PrivilegedAccessGroupAssignmentScheduleAssignmentType) },
                    ...
                    "memberType" => lambda {|n| @member_type = n.get_enum_value(MicrosoftGraphBeta::Models::PrivilegedAccessGroupAssignmentScheduleMemberType) },
