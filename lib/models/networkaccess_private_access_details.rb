...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessPrivateAccessDetails
            ...
            ## @return a void
            ## 
            def app_segment_id=(value)
                @app_segment_id = value
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "appSegmentId" => lambda {|n| @app_segment_id = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_string_value("appSegmentId", @app_segment_id)
