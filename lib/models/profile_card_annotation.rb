        ...
        class ProfileCardAnnotation
            ...
            def get_field_deserializers()
                return {
                    ...
                    "localizations" => lambda {|n| @localizations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DisplayNameLocalization.create_from_discriminator_value(pn) }) },
