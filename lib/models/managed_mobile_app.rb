...
module MicrosoftGraphBeta
    module Models
        ...
        class ManagedMobileApp < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "mobileAppIdentifier" => lambda {|n| @mobile_app_identifier = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MobileAppIdentifier.create_from_discriminator_value(pn) }) },
