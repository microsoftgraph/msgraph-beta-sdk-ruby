...
module MicrosoftGraphBeta
    module Models
        class AppRoleAssignment < MicrosoftGraphBeta::Models::DirectoryObject
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "creationTimestamp" => lambda {|n| @creation_timestamp = n.get_date_time_value() },
            ...
            def serialize(writer)
                ...
                writer.write_date_time_value("creationTimestamp", @creation_timestamp)
