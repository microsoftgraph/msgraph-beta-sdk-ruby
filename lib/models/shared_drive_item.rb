...
module MicrosoftGraphBeta
    module Models
        class SharedDriveItem < MicrosoftGraphBeta::Models::BaseItem
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "permission" => lambda {|n| @permission = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Permission.create_from_discriminator_value(pn) }) },
