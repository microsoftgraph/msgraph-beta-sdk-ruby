...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsTenant < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a managed_tenants_tenant_contract
            ## 
            def contract
                return @contract
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    "contract" => lambda {|n| @contract = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsTenantContract.create_from_discriminator_value(pn) }) },
                    "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                    "displayName" => lambda {|n| @display_name = n.get_string_value() },
                    "lastUpdatedDateTime" => lambda {|n| @last_updated_date_time = n.get_date_time_value() },
                    "tenantId" => lambda {|n| @tenant_id = n.get_string_value() },
                    "tenantStatusInformation" => lambda {|n| @tenant_status_information = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsTenantStatusInformation.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
