...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessTrafficDistributionPoint
            ...
            ## 
            ## Instantiates a new networkaccessTrafficDistributionPoint and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            ## @return a networkaccess_traffic_distribution_point
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return NetworkaccessTrafficDistributionPoint.new
            end
            ## 
