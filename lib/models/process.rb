        ...
        class Process
            ...
            def get_field_deserializers()
                return {
                    ...
                    "fileHash" => lambda {|n| @file_hash = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::FileHash.create_from_discriminator_value(pn) }) },
                    "integrityLevel" => lambda {|n| @integrity_level = n.get_enum_value(MicrosoftGraphBeta::Models::ProcessIntegrityLevel) },
