...
module MicrosoftGraphBeta
    module Models
        class LabelingOptions
            ...
            ## @param value Value to set for the extended_properties property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "downgradeJustification" => lambda {|n| @downgrade_justification = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DowngradeJustification.create_from_discriminator_value(pn) }) },
                    "extendedProperties" => lambda {|n| @extended_properties = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::KeyValuePair.create_from_discriminator_value(pn) }) },
