...
module MicrosoftGraphBeta
    module Models
        class SecurityRemoveContentFooterAction < MicrosoftGraphBeta::Models::SecurityInformationProtectionAction
            include MicrosoftKiotaAbstractions::Parsable
            ## 
            # The name of the UI element of the footer to be removed.
            @ui_element_names
            ## 
            ## Instantiates a new securityRemoveContentFooterAction and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            ## @return a security_remove_content_footer_action
            ## 
