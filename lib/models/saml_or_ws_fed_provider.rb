...
module MicrosoftGraphBeta
    module Models
        class SamlOrWsFedProvider < MicrosoftGraphBeta::Models::IdentityProviderBase
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "preferredAuthenticationProtocol" => lambda {|n| @preferred_authentication_protocol = n.get_enum_value(MicrosoftGraphBeta::Models::SamlOrWsFedProviderPreferredAuthenticationProtocol) },
