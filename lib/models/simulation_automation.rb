...
module MicrosoftGraphBeta
    module Models
        class SimulationAutomation < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "runs" => lambda {|n| @runs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SimulationAutomationRun.create_from_discriminator_value(pn) }) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::SimulationAutomationStatus) },
                })
            end
            ## 
