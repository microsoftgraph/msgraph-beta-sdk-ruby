        ...
        class CrossTenantAccessPolicyConfigurationPartner
            ...
            def get_field_deserializers()
                return {
                    ...
                    "identitySynchronization" => lambda {|n| @identity_synchronization = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CrossTenantIdentitySyncPolicyPartner.create_from_discriminator_value(pn) }) },
            ...
            ## @param value Value to set for the tenant_restrictions property.
            ## @return a void
            ## 
