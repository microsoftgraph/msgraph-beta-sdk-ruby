...
module MicrosoftGraphBeta::Models
    class AuditActivityInitiator
        ...
        def get_field_deserializers()
            return {
                "app" => lambda {|n| @app = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AppIdentity.create_from_discriminator_value(pn) }) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "user" => lambda {|n| @user = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AuditUserIdentity.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
