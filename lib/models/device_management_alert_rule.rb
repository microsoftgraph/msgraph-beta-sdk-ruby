...
module MicrosoftGraphBeta
    module Models
        class DeviceManagementAlertRule < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a device_management_alert_rule_alert_rule_template
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "alertRuleTemplate" => lambda {|n| @alert_rule_template = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceManagementAlertRuleAlertRuleTemplate) },
                    ...
                    "notificationChannels" => lambda {|n| @notification_channels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceManagementNotificationChannel.create_from_discriminator_value(pn) }) },
                    "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceManagementAlertRuleSeverity) },
                    "threshold" => lambda {|n| @threshold = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DeviceManagementRuleThreshold.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## @return a device_management_notification_channel
            ## 
            ...
            ## @return a device_management_alert_rule_severity
            ## 
            def severity
                return @severity
            end
