...
module MicrosoftGraphBeta::Models
    class Edge < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "internetExplorerMode" => lambda {|n| @internet_explorer_mode = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::InternetExplorerMode.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
