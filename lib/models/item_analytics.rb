...
module MicrosoftGraphBeta
    module Models
        class ItemAnalytics < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "allTime" => lambda {|n| @all_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemActivityStat.create_from_discriminator_value(pn) }) },
                    "itemActivityStats" => lambda {|n| @item_activity_stats = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ItemActivityStat.create_from_discriminator_value(pn) }) },
                    "lastSevenDays" => lambda {|n| @last_seven_days = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemActivityStat.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
