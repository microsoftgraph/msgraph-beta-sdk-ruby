...
module MicrosoftGraphBeta::Models
    ...
    class DeviceHealthScriptRemediationHistory
        ...
        ## @return a device_health_script_remediation_history
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return DeviceHealthScriptRemediationHistory.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                "historyData" => lambda {|n| @history_data = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceHealthScriptRemediationHistoryData.create_from_discriminator_value(pn) }) },
        ...
        ## @param value Value to set for the history_data property.
        ## @return a void
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_collection_of_object_values("historyData", @history_data)
