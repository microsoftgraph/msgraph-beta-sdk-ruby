...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsManagementIntent < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "managementTemplates" => lambda {|n| @management_templates = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsManagementTemplateDetailedInfo.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
