...
module MicrosoftGraphBeta
    module Models
        class Team < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the discovery_settings property.
            ## @return a void
            ## 
            def discovery_settings=(value)
                @discovery_settings = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "allChannels" => lambda {|n| @all_channels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Channel.create_from_discriminator_value(pn) }) },
                    ...
                    "discoverySettings" => lambda {|n| @discovery_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamDiscoverySettings.create_from_discriminator_value(pn) }) },
                    "displayName" => lambda {|n| @display_name = n.get_string_value() },
                    "funSettings" => lambda {|n| @fun_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamFunSettings.create_from_discriminator_value(pn) }) },
                    "group" => lambda {|n| @group = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Group.create_from_discriminator_value(pn) }) },
                    "guestSettings" => lambda {|n| @guest_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamGuestSettings.create_from_discriminator_value(pn) }) },
                    "incomingChannels" => lambda {|n| @incoming_channels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Channel.create_from_discriminator_value(pn) }) },
                    ...
                    "isMembershipLimitedToOwners" => lambda {|n| @is_membership_limited_to_owners = n.get_boolean_value() },
                    "memberSettings" => lambda {|n| @member_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamMemberSettings.create_from_discriminator_value(pn) }) },
                    ...
                    "messagingSettings" => lambda {|n| @messaging_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamMessagingSettings.create_from_discriminator_value(pn) }) },
                    ...
                    "primaryChannel" => lambda {|n| @primary_channel = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Channel.create_from_discriminator_value(pn) }) },
                    "schedule" => lambda {|n| @schedule = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Schedule.create_from_discriminator_value(pn) }) },
                    "specialization" => lambda {|n| @specialization = n.get_enum_value(MicrosoftGraphBeta::Models::TeamSpecialization) },
                    "summary" => lambda {|n| @summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamSummary.create_from_discriminator_value(pn) }) },
                    "tags" => lambda {|n| @tags = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TeamworkTag.create_from_discriminator_value(pn) }) },
            ...
            ## @param value Value to set for the is_membership_limited_to_owners property.
            ## @return a void
            ## 
            def is_membership_limited_to_owners=(value)
                @is_membership_limited_to_owners = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("discoverySettings", @discovery_settings)
                ...
                writer.write_boolean_value("isMembershipLimitedToOwners", @is_membership_limited_to_owners)
                ...
                writer.write_object_value("templateDefinition", @template_definition)
            ...
            ## @param value Value to set for the template_definition property.
            ## @return a void
            ## 
            def template_definition=(value)
