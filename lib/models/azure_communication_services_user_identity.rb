...
module MicrosoftGraphBeta
    module Models
        class AzureCommunicationServicesUserIdentity < MicrosoftGraphBeta::Models::Identity
            ...
            ## @param value Value to set for the azure_communication_services_resource_id property.
            ## @return a void
            ## 
