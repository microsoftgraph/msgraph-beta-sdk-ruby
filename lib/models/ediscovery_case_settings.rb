...
module MicrosoftGraphBeta
    module Models
        class EdiscoveryCaseSettings < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "ocr" => lambda {|n| @ocr = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryOcrSettings.create_from_discriminator_value(pn) }) },
                    "redundancyDetection" => lambda {|n| @redundancy_detection = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryRedundancyDetectionSettings.create_from_discriminator_value(pn) }) },
                    "topicModeling" => lambda {|n| @topic_modeling = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryTopicModelingSettings.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ## Gets the ocr property value. The OCR (Optical Character Recognition) settings for the case.
            ## @return a ediscovery_ocr_settings
            ## 
            def ocr
                return @ocr
            end
            ...
            ## @return a ediscovery_redundancy_detection_settings
            ## 
