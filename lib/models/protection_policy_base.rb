...
module MicrosoftGraphBeta
    module Models
        class ProtectionPolicyBase < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "retentionSettings" => lambda {|n| @retention_settings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RetentionSetting.create_from_discriminator_value(pn) }) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ProtectionPolicyStatus) },
                })
            end
            ## 
