...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsManagementTemplateStepDeployment < MicrosoftGraphBeta::Models::Entity
            ...
            @tenant_id
            ## 
            ## Instantiates a new managedTenantsManagementTemplateStepDeployment and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            ## @return a managed_tenants_graph_a_p_i_error_details
            ## 
            def error
                return @error
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "error" => lambda {|n| @error = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsGraphAPIErrorDetails.create_from_discriminator_value(pn) }) },
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenantsManagementTemplateDeploymentStatus) },
                    "templateStepVersion" => lambda {|n| @template_step_version = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsManagementTemplateStepVersion.create_from_discriminator_value(pn) }) },
            ...
            ## @return a managed_tenants_management_template_deployment_status
            ## 
            def status
                return @status
            end
