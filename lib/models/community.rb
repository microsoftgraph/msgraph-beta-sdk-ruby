...
module MicrosoftGraphBeta
    module Models
        class Community < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "owners" => lambda {|n| @owners = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::User.create_from_discriminator_value(pn) }) },
                    "privacy" => lambda {|n| @privacy = n.get_enum_value(MicrosoftGraphBeta::Models::CommunityPrivacy) },
                })
            end
            ## 
