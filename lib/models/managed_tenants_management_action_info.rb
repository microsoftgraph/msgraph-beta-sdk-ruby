...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsManagementActionInfo
            ...
            ## 
            ## Instantiates a new managedTenantsManagementActionInfo and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ManagedTenantsManagementActionInfo.new
            end
            ## 
