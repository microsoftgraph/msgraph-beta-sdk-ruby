...
module MicrosoftGraphBeta
    module Models
        class KeyCredentialConfiguration
            ...
            ## @return a string
            ## 
            def certificate_based_application_configuration_ids
                return @certificate_based_application_configuration_ids
            end
            ## 
            ...
            ## @param value Value to set for the certificate_based_application_configuration_ids property.
            ## @return a void
            ## 
            def certificate_based_application_configuration_ids=(value)
                @certificate_based_application_configuration_ids = value
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "certificateBasedApplicationConfigurationIds" => lambda {|n| @certificate_based_application_configuration_ids = n.get_collection_of_primitive_values(String) },
                    ...
                    "restrictionType" => lambda {|n| @restriction_type = n.get_enum_value(MicrosoftGraphBeta::Models::AppKeyCredentialRestrictionType) },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_primitive_values("certificateBasedApplicationConfigurationIds", @certificate_based_application_configuration_ids)
