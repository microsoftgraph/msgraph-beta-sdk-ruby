        ...
        class AccessReviewHistoryDefinition < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "decisions" => lambda {|n| @decisions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewHistoryDecisionFilter.create_from_discriminator_value(pn) }) },
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::AccessReviewHistoryStatus) },
                })
            end
            ## 
