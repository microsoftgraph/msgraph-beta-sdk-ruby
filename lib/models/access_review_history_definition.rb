...
module MicrosoftGraphBeta
    module Models
        class AccessReviewHistoryDefinition < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "decisions" => lambda {|n| @decisions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewHistoryDefinitionDecisions.create_from_discriminator_value(pn) }) },
                    ...
                    "instances" => lambda {|n| @instances = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewHistoryInstance.create_from_discriminator_value(pn) }) },
                    ...
                    "scheduleSettings" => lambda {|n| @schedule_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewHistoryScheduleSettings.create_from_discriminator_value(pn) }) },
                    "scopes" => lambda {|n| @scopes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewScope.create_from_discriminator_value(pn) }) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::AccessReviewHistoryDefinitionStatus) },
                })
            end
            ## 
