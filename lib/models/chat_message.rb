...
module MicrosoftGraphBeta::Models
    class ChatMessage < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "attachments" => lambda {|n| @attachments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessageAttachment.create_from_discriminator_value(pn) }) },
                "body" => lambda {|n| @body = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemBody.create_from_discriminator_value(pn) }) },
                "channelIdentity" => lambda {|n| @channel_identity = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChannelIdentity.create_from_discriminator_value(pn) }) },
                ...
                "eventDetail" => lambda {|n| @event_detail = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EventMessageDetail.create_from_discriminator_value(pn) }) },
                "from" => lambda {|n| @from = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessageFromIdentitySet.create_from_discriminator_value(pn) }) },
                "hostedContents" => lambda {|n| @hosted_contents = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessageHostedContent.create_from_discriminator_value(pn) }) },
                "importance" => lambda {|n| @importance = n.get_enum_value(MicrosoftGraphBeta::Models::ChatMessageImportance) },
                ...
                "mentions" => lambda {|n| @mentions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessageMention.create_from_discriminator_value(pn) }) },
                "messageHistory" => lambda {|n| @message_history = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessageHistoryItem.create_from_discriminator_value(pn) }) },
                "messageType" => lambda {|n| @message_type = n.get_enum_value(MicrosoftGraphBeta::Models::ChatMessageType) },
                "onBehalfOf" => lambda {|n| @on_behalf_of = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessageFromIdentitySet.create_from_discriminator_value(pn) }) },
                "policyViolation" => lambda {|n| @policy_violation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessagePolicyViolation.create_from_discriminator_value(pn) }) },
                "reactions" => lambda {|n| @reactions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessageReaction.create_from_discriminator_value(pn) }) },
                "replies" => lambda {|n| @replies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessage.create_from_discriminator_value(pn) }) },
