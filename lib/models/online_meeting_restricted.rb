    ...
    module Models
        class OnlineMeetingRestricted
            ...
            def get_field_deserializers()
                return {
                    "contentSharingDisabled" => lambda {|n| @content_sharing_disabled = n.get_enum_value(MicrosoftGraphBeta::Models::OnlineMeetingRestrictedContentSharingDisabled) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "videoDisabled" => lambda {|n| @video_disabled = n.get_enum_value(MicrosoftGraphBeta::Models::OnlineMeetingRestrictedVideoDisabled) },
                }
            end
            ## 
