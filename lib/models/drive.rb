...
module MicrosoftGraphBeta
    module Models
        class Drive < MicrosoftGraphBeta::Models::BaseItem
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "bundles" => lambda {|n| @bundles = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveItem.create_from_discriminator_value(pn) }) },
                    "driveType" => lambda {|n| @drive_type = n.get_string_value() },
                    "following" => lambda {|n| @following = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveItem.create_from_discriminator_value(pn) }) },
                    "items" => lambda {|n| @items = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveItem.create_from_discriminator_value(pn) }) },
                    "list" => lambda {|n| @list = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::List.create_from_discriminator_value(pn) }) },
                    "owner" => lambda {|n| @owner = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                    "quota" => lambda {|n| @quota = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Quota.create_from_discriminator_value(pn) }) },
                    "root" => lambda {|n| @root = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DriveItem.create_from_discriminator_value(pn) }) },
                    "sharePointIds" => lambda {|n| @share_point_ids = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SharepointIds.create_from_discriminator_value(pn) }) },
                    "special" => lambda {|n| @special = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveItem.create_from_discriminator_value(pn) }) },
                    "system" => lambda {|n| @system = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SystemFacet.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
