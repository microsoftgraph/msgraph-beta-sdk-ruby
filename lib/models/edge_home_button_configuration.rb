...
module MicrosoftGraphBeta
    module Models
        ...
        class EdgeHomeButtonConfiguration
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.edgeHomeButtonHidden"
                            return EdgeHomeButtonHidden.new
                        when "#microsoft.graph.edgeHomeButtonLoadsStartPage"
                            return EdgeHomeButtonLoadsStartPage.new
                        when "#microsoft.graph.edgeHomeButtonOpensCustomURL"
                            return EdgeHomeButtonOpensCustomURL.new
                        when "#microsoft.graph.edgeHomeButtonOpensNewTab"
                            return EdgeHomeButtonOpensNewTab.new
                    end
                end
                return EdgeHomeButtonConfiguration.new
            end
            ## 
