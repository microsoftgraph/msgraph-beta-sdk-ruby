...
module MicrosoftGraphBeta
    module Models
        class CustomClaimBase
            ...
            ## 
            ## Instantiates a new CustomClaimBase and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.customClaim"
                            return CustomClaim.new
                        when "#microsoft.graph.samlNameIdClaim"
                            return SamlNameIdClaim.new
                    end
                end
                return CustomClaimBase.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "configurations" => lambda {|n| @configurations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CustomClaimConfiguration.create_from_discriminator_value(pn) }) },
