...
module MicrosoftGraphBeta
    module Models
        class SecurityAnalyzedEmailSenderDetail
            ...
            ## @return a date_time
            ## 
            def domain_creation_date_time
                return @domain_creation_date_time
            end
            ## 
            ...
            ## @return a void
            ## 
            def domain_creation_date_time=(value)
                @domain_creation_date_time = value
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "domainCreationDateTime" => lambda {|n| @domain_creation_date_time = n.get_date_time_value() },
                    "domainName" => lambda {|n| @domain_name = n.get_string_value() },
                    "domainOwner" => lambda {|n| @domain_owner = n.get_string_value() },
                    ...
                    "mailFromDomainName" => lambda {|n| @mail_from_domain_name = n.get_string_value() },
            ...
            ## @return a string
            ## 
            def mail_from_domain_name
                return @mail_from_domain_name
            end
            ## 
            ...
            ## @return a void
            ## 
            def mail_from_domain_name=(value)
                @mail_from_domain_name = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_date_time_value("domainCreationDateTime", @domain_creation_date_time)
                writer.write_string_value("domainName", @domain_name)
                writer.write_string_value("domainOwner", @domain_owner)
                ...
                writer.write_string_value("mailFromDomainName", @mail_from_domain_name)
