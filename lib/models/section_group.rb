...
module MicrosoftGraphBeta
    module Models
        class SectionGroup < MicrosoftGraphBeta::Models::OnenoteEntityHierarchyModel
            ...
            def get_field_deserializers()
                return super.merge({
                    "parentNotebook" => lambda {|n| @parent_notebook = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Notebook.create_from_discriminator_value(pn) }) },
                    "parentSectionGroup" => lambda {|n| @parent_section_group = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SectionGroup.create_from_discriminator_value(pn) }) },
