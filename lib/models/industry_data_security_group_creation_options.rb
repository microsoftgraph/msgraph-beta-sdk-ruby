...
module MicrosoftGraphBeta
    module Models
        class IndustryDataSecurityGroupCreationOptions
            ...
            ## 
            ## Instantiates a new IndustryDataSecurityGroupCreationOptions and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            ## @return a boolean
            ## 
            def create_based_on_role_group
                return @create_based_on_role_group
            end
            ## 
            ...
            ## @return a void
            ## 
            def create_based_on_role_group=(value)
                @create_based_on_role_group = value
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a industry_data_security_group_creation_options
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return IndustryDataSecurityGroupCreationOptions.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "createBasedOnRoleGroup" => lambda {|n| @create_based_on_role_group = n.get_boolean_value() },
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("createBasedOnRoleGroup", @create_based_on_role_group)
