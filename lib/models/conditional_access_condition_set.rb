        ...
        class ConditionalAccessConditionSet
            ...
            def get_field_deserializers()
                return {
                    ...
                    "servicePrincipalRiskLevels" => lambda {|n| @service_principal_risk_levels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RiskLevel.create_from_discriminator_value(pn) }) },
                    "signInRiskLevels" => lambda {|n| @sign_in_risk_levels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RiskLevel.create_from_discriminator_value(pn) }) },
