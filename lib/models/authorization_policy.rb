...
module MicrosoftGraphBeta
    module Models
        class AuthorizationPolicy < MicrosoftGraphBeta::Models::PolicyBase
            ...
            ## @param value Value to set for the default_user_role_overrides property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the enabled_preview_features property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the permission_grant_policy_ids_assigned_to_default_user_role property.
            ## @return a void
            ## 
