...
module MicrosoftGraphBeta
    module Models
        class EdiscoveryLegalHold < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "siteSources" => lambda {|n| @site_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoverySiteSource.create_from_discriminator_value(pn) }) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::EdiscoveryLegalHoldStatus) },
                    "unifiedGroupSources" => lambda {|n| @unified_group_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryUnifiedGroupSource.create_from_discriminator_value(pn) }) },
                    "userSources" => lambda {|n| @user_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EdiscoveryUserSource.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## @return a ediscovery_legal_hold_status
            ## 
            def status
                return @status
            end
