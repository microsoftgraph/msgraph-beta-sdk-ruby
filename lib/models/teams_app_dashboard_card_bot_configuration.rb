...
module MicrosoftGraphBeta
    module Models
        class TeamsAppDashboardCardBotConfiguration
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return TeamsAppDashboardCardBotConfiguration.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "botId" => lambda {|n| @bot_id = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_string_value("botId", @bot_id)
