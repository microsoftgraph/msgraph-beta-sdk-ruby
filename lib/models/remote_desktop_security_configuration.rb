...
module MicrosoftGraphBeta
    module Models
        class RemoteDesktopSecurityConfiguration < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "targetDeviceGroups" => lambda {|n| @target_device_groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TargetDeviceGroup.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
