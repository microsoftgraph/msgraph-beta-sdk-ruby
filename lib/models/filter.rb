    ...
    module Models
        class Filter
            ...
            def get_field_deserializers()
                return {
                    "categoryFilterGroups" => lambda {|n| @category_filter_groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::FilterGroup.create_from_discriminator_value(pn) }) },
                    "groups" => lambda {|n| @groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::FilterGroup.create_from_discriminator_value(pn) }) },
                    "inputFilterGroups" => lambda {|n| @input_filter_groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::FilterGroup.create_from_discriminator_value(pn) }) },
