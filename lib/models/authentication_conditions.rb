    ...
    module Models
        class AuthenticationConditions
            ...
            def get_field_deserializers()
                return {
                    "applications" => lambda {|n| @applications = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationConditionsApplications.create_from_discriminator_value(pn) }) },
