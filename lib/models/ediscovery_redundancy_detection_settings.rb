...
module MicrosoftGraphBeta
    module Models
        class EdiscoveryRedundancyDetectionSettings
            ...
            ## 
            ## Instantiates a new ediscoveryRedundancyDetectionSettings and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return EdiscoveryRedundancyDetectionSettings.new
            end
            ## 
