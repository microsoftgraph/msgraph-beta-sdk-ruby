...
module MicrosoftGraphBeta
    module Models
        module CallRecords
            class ServiceUserAgent < MicrosoftGraphBeta::Models::CallRecords::UserAgent
                ...
                def get_field_deserializers()
                    return super.merge({
                        "role" => lambda {|n| @role = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecords::ServiceRole) },
                    })
                end
                ## 
