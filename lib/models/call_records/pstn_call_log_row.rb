    ...
    module Models
        module CallRecords
            class PstnCallLogRow
                ...
                ## @param value Value to set for the client_local_ip_v4_address property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the client_local_ip_v6_address property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the client_public_ip_v4_address property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the client_public_ip_v6_address property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return {
                        "callDurationSource" => lambda {|n| @call_duration_source = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecords::PstnCallDurationSource) },
