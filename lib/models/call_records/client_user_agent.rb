...
module MicrosoftGraphBeta::Models::CallRecords
    class ClientUserAgent < MicrosoftGraphBeta::Models::CallRecords::UserAgent
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "platform" => lambda {|n| @platform = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecords::ClientPlatform) },
                "productFamily" => lambda {|n| @product_family = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecords::ProductFamily) },
            })
        end
        ## 
