        ...
        module CallRecords
            class MediaStream
                ...
                def get_field_deserializers()
                    return {
                        "audioCodec" => lambda {|n| @audio_codec = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecords::AudioCodec) },
                        ...
                        "streamDirection" => lambda {|n| @stream_direction = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecords::MediaStreamDirection) },
                        "streamId" => lambda {|n| @stream_id = n.get_string_value() },
                        "videoCodec" => lambda {|n| @video_codec = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecords::VideoCodec) },
