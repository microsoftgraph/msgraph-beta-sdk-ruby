...
module MicrosoftGraphBeta::Models::CallRecords
    class ParticipantEndpoint < MicrosoftGraphBeta::Models::CallRecords::Endpoint
        ...
        def get_field_deserializers()
            return super.merge({
                "feedback" => lambda {|n| @feedback = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CallRecords::UserFeedback.create_from_discriminator_value(pn) }) },
