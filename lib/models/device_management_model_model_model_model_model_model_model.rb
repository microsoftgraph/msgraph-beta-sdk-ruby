...
module MicrosoftGraphBeta
    module Models
        ...
        class DeviceManagementModelModelModelModelModelModelModel < MicrosoftGraphBeta::Models::Entity
            ...
            ## 
            def cloud_certification_authority
                return @cloud_certification_authority
            end
            ## 
            ...
            ## @return a void
            ## 
            def cloud_certification_authority=(value)
                @cloud_certification_authority = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "cloudCertificationAuthority" => lambda {|n| @cloud_certification_authority = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CloudCertificationAuthority.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("cloudCertificationAuthority", @cloud_certification_authority)
