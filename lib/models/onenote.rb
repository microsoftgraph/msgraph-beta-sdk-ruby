    ...
    module Models
        class Onenote < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "notebooks" => lambda {|n| @notebooks = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Notebook.create_from_discriminator_value(pn) }) },
                    "operations" => lambda {|n| @operations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OnenoteOperation.create_from_discriminator_value(pn) }) },
                    "pages" => lambda {|n| @pages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OnenotePage.create_from_discriminator_value(pn) }) },
                    "resources" => lambda {|n| @resources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OnenoteResource.create_from_discriminator_value(pn) }) },
                    "sectionGroups" => lambda {|n| @section_groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SectionGroup.create_from_discriminator_value(pn) }) },
                    "sections" => lambda {|n| @sections = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OnenoteSection.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
