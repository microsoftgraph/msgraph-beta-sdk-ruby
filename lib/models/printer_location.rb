    ...
    class PrinterLocation
        ...
        def get_field_deserializers()
            return {
                ...
                "roomNumber" => lambda {|n| @room_number = n.get_number_value() },
        ...
        ## @param value Value to set for the room_number property.
        ## @return a void
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_number_value("roomNumber", @room_number)
