...
module MicrosoftGraphBeta
    module Models
        class ExternalConnectorsItemIdResolver < MicrosoftGraphBeta::Models::ExternalConnectorsUrlToItemResolverBase
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "urlMatchInfo" => lambda {|n| @url_match_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectorsUrlMatchInfo.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
