...
module MicrosoftGraphBeta
    module Models
        class AndroidManagedStoreApp < MicrosoftGraphBeta::Models::MobileApp
            ...
            ## @param value Value to set for the app_tracks property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the is_system_app property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the supports_oem_config property.
            ## @return a void
            ## 
