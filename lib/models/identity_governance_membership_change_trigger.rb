...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceMembershipChangeTrigger < MicrosoftGraphBeta::Models::IdentityGovernanceWorkflowExecutionTrigger
            ...
            def get_field_deserializers()
                return super.merge({
                    "changeType" => lambda {|n| @change_type = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityGovernanceMembershipChangeType) },
                })
            end
            ## 
