...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceTriggerAndScopeBasedConditions < MicrosoftGraphBeta::Models::IdentityGovernanceWorkflowExecutionConditions
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "trigger" => lambda {|n| @trigger = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceWorkflowExecutionTrigger.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
