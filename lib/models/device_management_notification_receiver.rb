...
module MicrosoftGraphBeta
    module Models
        class DeviceManagementNotificationReceiver
            ...
            ## 
            ## Instantiates a new deviceManagementNotificationReceiver and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return DeviceManagementNotificationReceiver.new
            end
            ## 
