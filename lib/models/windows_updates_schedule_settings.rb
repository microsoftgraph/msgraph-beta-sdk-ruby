...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdatesScheduleSettings
            ...
            ## 
            ## Instantiates a new WindowsUpdatesScheduleSettings and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return WindowsUpdatesScheduleSettings.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "gradualRollout" => lambda {|n| @gradual_rollout = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesGradualRolloutSettings.create_from_discriminator_value(pn) }) },
            ...
            ## @return a windows_updates_gradual_rollout_settings
            ## 
            def gradual_rollout
