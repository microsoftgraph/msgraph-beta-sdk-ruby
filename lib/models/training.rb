    ...
    module Models
        class Training < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "availabilityStatus" => lambda {|n| @availability_status = n.get_enum_value(MicrosoftGraphBeta::Models::TrainingAvailabilityStatus) },
                    ...
                    "languageDetails" => lambda {|n| @language_details = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TrainingLanguageDetail.create_from_discriminator_value(pn) }) },
                    ...
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::TrainingType) },
                })
            end
            ## 
            ...
            ## @param value Value to set for the has_evaluation property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the language_details property.
            ## @return a void
            ## 
