    ...
    module Models
        class PresenceStatusMessage
            ...
            def get_field_deserializers()
                return {
                    "expiryDateTime" => lambda {|n| @expiry_date_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
                    "message" => lambda {|n| @message = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemBody.create_from_discriminator_value(pn) }) },
