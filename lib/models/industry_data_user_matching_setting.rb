...
module MicrosoftGraphBeta
    module Models
        class IndustryDataUserMatchingSetting
            ...
            ## 
            ## Instantiates a new industryDataUserMatchingSetting and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return IndustryDataUserMatchingSetting.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "matchTarget" => lambda {|n| @match_target = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataUserMatchTargetReferenceValue.create_from_discriminator_value(pn) }) },
                    ...
                    "sourceIdentifier" => lambda {|n| @source_identifier = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataIdentifierTypeReferenceValue.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
