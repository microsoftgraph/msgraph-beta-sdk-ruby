        ...
        class PlannerTaskCreation
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.plannerExternalTaskSource"
                            return PlannerExternalTaskSource.new
                        when "#microsoft.graph.plannerTeamsPublicationInfo"
                            return PlannerTeamsPublicationInfo.new
                    end
                end
                return PlannerTaskCreation.new
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("teamsPublicationInfo", @teams_publication_info)
            ...
            ## 
            def teams_publication_info
                return @teams_publication_info
            end
            ## 
            ...
            ## @param value Value to set for the teams_publication_info property.
            ## @return a void
            ## 
            def teams_publication_info=(value)
                @teams_publication_info = value
            end
        end
    end
end
