...
module MicrosoftGraphBeta
    module Models
        class DeletedTeam < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "channels" => lambda {|n| @channels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Channel.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
