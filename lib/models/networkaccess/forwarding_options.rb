...
module MicrosoftGraphBeta
    module Models
        module Networkaccess
            class ForwardingOptions < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "skipDnsLookupState" => lambda {|n| @skip_dns_lookup_state = n.get_enum_value(MicrosoftGraphBeta::Models::Networkaccess::Status) },
                    })
                end
                ## 
                ...
                ## @param value Value to set for the skip_dns_lookup_state property.
                ## @return a void
                ## 
