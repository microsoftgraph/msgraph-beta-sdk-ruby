...
module MicrosoftGraphBeta
    module Models
        module Networkaccess
            class Connectivity < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "branches" => lambda {|n| @branches = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Networkaccess::BranchSite.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
