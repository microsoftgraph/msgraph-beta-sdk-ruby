...
module MicrosoftGraphBeta
    module Models
        module Networkaccess
            class M365ForwardingRule < MicrosoftGraphBeta::Models::Networkaccess::ForwardingRule
                ...
                def get_field_deserializers()
                    return super.merge({
                        "category" => lambda {|n| @category = n.get_enum_value(MicrosoftGraphBeta::Models::Networkaccess::ForwardingCategory) },
                        "ports" => lambda {|n| @ports = n.get_collection_of_primitive_values(String) },
                        "protocol" => lambda {|n| @protocol = n.get_enum_value(MicrosoftGraphBeta::Models::Networkaccess::NetworkingProtocol) },
                    })
                end
                ## 
