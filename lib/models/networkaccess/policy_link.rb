...
module MicrosoftGraphBeta
    module Models
        module Networkaccess
            class PolicyLink < MicrosoftGraphBeta::Models::Entity
                    ...
                    unless mapping_value_node.nil? then
                        ...
                        case mapping_value
                            when "#microsoft.graph.networkaccess.forwardingPolicyLink"
                                return ForwardingPolicyLink.new
                        end
                    end
                    return PolicyLink.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "policy" => lambda {|n| @policy = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Networkaccess::Policy.create_from_discriminator_value(pn) }) },
