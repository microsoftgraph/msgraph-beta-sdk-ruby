...
module MicrosoftGraphBeta
    module Models
        module Networkaccess
            class ForwardingRule < MicrosoftGraphBeta::Models::Networkaccess::PolicyRule
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "destinations" => lambda {|n| @destinations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Networkaccess::RuleDestination.create_from_discriminator_value(pn) }) },
                        "ruleType" => lambda {|n| @rule_type = n.get_enum_value(MicrosoftGraphBeta::Models::Networkaccess::NetworkDestinationType) },
                    })
                end
                ## 
                ## Gets the ruleType property value. The ruleType property
                ## @return a network_destination_type
                ## 
                def rule_type
                    return @rule_type
                end
