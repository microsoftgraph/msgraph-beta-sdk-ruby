...
module MicrosoftGraphBeta::Models
    class UnifiedRoleManagementPolicyAssignment < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "policy" => lambda {|n| @policy = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleManagementPolicy.create_from_discriminator_value(pn) }) },
