        ...
        class Application < MicrosoftGraphBeta::Models::DirectoryObject
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "nativeAuthenticationApisEnabled" => lambda {|n| @native_authentication_apis_enabled = n.get_enum_values(MicrosoftGraphBeta::Models::NativeAuthenticationApisEnabled) },
