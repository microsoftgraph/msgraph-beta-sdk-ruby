...
module MicrosoftGraphBeta
    module Models
        class UserConsentRequest < MicrosoftGraphBeta::Models::Request
            ...
            def get_field_deserializers()
                return super.merge({
                    "approval" => lambda {|n| @approval = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Approval.create_from_discriminator_value(pn) }) },
