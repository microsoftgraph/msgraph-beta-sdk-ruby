...
module MicrosoftGraphBeta
    module Models
        class AccessPackageAssignmentRequestRequirements
            ...
            @verifiable_credential_requirement_status
            ## 
            ...
            ## @param value Value to set for the existing_answers property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "verifiableCredentialRequirementStatus" => lambda {|n| @verifiable_credential_requirement_status = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::VerifiableCredentialRequirementStatus.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            ## @param value Value to set for the is_custom_assignment_schedule_allowed property.
            ## @return a void
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("verifiableCredentialRequirementStatus", @verifiable_credential_requirement_status)
            ...
            ## @return a verifiable_credential_requirement_status
            ## 
            def verifiable_credential_requirement_status
                return @verifiable_credential_requirement_status
            end
            ## 
            ...
            ## @param value Value to set for the verifiable_credential_requirement_status property.
            ## @return a void
            ## 
            def verifiable_credential_requirement_status=(value)
                @verifiable_credential_requirement_status = value
            end
        end
    end
end
