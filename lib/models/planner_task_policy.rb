        ...
        class PlannerTaskPolicy
            ...
            def get_field_deserializers()
                return {
                    ...
                    "rules" => lambda {|n| @rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PlannerTaskRoleBasedRule.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
