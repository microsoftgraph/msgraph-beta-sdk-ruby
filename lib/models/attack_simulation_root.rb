...
module MicrosoftGraphBeta
    module Models
        class AttackSimulationRoot < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the end_user_notifications property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "endUserNotifications" => lambda {|n| @end_user_notifications = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EndUserNotification.create_from_discriminator_value(pn) }) },
                    "landingPages" => lambda {|n| @landing_pages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::LandingPage.create_from_discriminator_value(pn) }) },
                    "loginPages" => lambda {|n| @login_pages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::LoginPage.create_from_discriminator_value(pn) }) },
            ...
            ## @param value Value to set for the landing_pages property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the login_pages property.
            ## @return a void
            ## 
