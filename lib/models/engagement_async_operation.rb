...
module MicrosoftGraphBeta
    module Models
        class EngagementAsyncOperation < MicrosoftGraphBeta::Models::LongRunningOperation
            ...
            def get_field_deserializers()
                return super.merge({
                    "operationType" => lambda {|n| @operation_type = n.get_enum_value(MicrosoftGraphBeta::Models::EngagementAsyncOperationOperationType) },
            ...
            ## @return a engagement_async_operation_operation_type
            ## 
            def operation_type
