...
module MicrosoftGraphBeta
    module Models
        class NamedLocation < MicrosoftGraphBeta::Models::Entity
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.compliantNetworkNamedLocation"
                        ...
                        when "#microsoft.graph.privateLinkNamedLocation"
                            return PrivateLinkNamedLocation.new
                        when "#microsoft.graph.serviceTagNamedLocation"
