...
module MicrosoftGraphBeta
    module Models
        class Call < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the active_modalities property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the answered_by property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the meeting_capability property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the ringing_timeout_in_seconds property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the routing_policies property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the termination_reason property.
            ## @return a void
            ## 
