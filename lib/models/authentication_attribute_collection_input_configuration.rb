        ...
        class AuthenticationAttributeCollectionInputConfiguration
            ...
            def get_field_deserializers()
                return {
                    ...
                    "inputType" => lambda {|n| @input_type = n.get_enum_value(MicrosoftGraphBeta::Models::AuthenticationAttributeCollectionInputType) },
                    "label" => lambda {|n| @label = n.get_string_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "options" => lambda {|n| @options = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationAttributeCollectionOptionConfiguration.create_from_discriminator_value(pn) }) },
            ...
            ## @param value Value to set for the input_type property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the validation_reg_ex property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the write_to_directory property.
            ## @return a void
            ## 
