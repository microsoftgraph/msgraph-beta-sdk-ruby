        ...
        class AttributeMapping
            ...
            def get_field_deserializers()
                return {
                    ...
                    "flowBehavior" => lambda {|n| @flow_behavior = n.get_enum_value(MicrosoftGraphBeta::Models::AttributeFlowBehavior) },
                    "flowType" => lambda {|n| @flow_type = n.get_enum_value(MicrosoftGraphBeta::Models::AttributeFlowType) },
                    "matchingPriority" => lambda {|n| @matching_priority = n.get_number_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "source" => lambda {|n| @source = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AttributeMappingSource.create_from_discriminator_value(pn) }) },
