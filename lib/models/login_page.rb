        ...
        class LoginPage < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "source" => lambda {|n| @source = n.get_enum_value(MicrosoftGraphBeta::Models::LoginPageSource) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::LoginPageStatus) },
                })
            end
            ## 
