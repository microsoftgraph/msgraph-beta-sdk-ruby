...
module MicrosoftGraphBeta
    module Models
        ...
        class AndroidForWorkCompliancePolicy < MicrosoftGraphBeta::Models::DeviceCompliancePolicy
            ...
            ## @return a android_for_work_compliance_policy
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "workProfilePasswordRequiredType" => lambda {|n| @work_profile_password_required_type = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidForWorkRequiredPasswordType) },
            ...
            ## @return a void
            ## 
            def security_required_android_safety_net_evaluation_type=(value)
                @security_required_android_safety_net_evaluation_type = value
            end
            ## 
            ...
            ## @return a android_for_work_required_password_type
            ## 
