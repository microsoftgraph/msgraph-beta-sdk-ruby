...
module MicrosoftGraphBeta
    module Models
        class CalendarSharingMessage < MicrosoftGraphBeta::Models::Message
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "sharingMessageAction" => lambda {|n| @sharing_message_action = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CalendarSharingMessageAction.create_from_discriminator_value(pn) }) },
                    "sharingMessageActions" => lambda {|n| @sharing_message_actions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CalendarSharingMessageAction.create_from_discriminator_value(pn) }) },
