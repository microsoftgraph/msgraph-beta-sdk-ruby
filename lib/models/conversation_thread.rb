...
module MicrosoftGraphBeta
    module Models
        class ConversationThread < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "posts" => lambda {|n| @posts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Post.create_from_discriminator_value(pn) }) },
