...
module MicrosoftGraphBeta
    module Models
        class RestorePoint < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "protectionUnit" => lambda {|n| @protection_unit = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ProtectionUnitBase.create_from_discriminator_value(pn) }) },
