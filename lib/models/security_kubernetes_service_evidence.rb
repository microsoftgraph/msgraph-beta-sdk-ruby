...
module MicrosoftGraphBeta
    module Models
        class SecurityKubernetesServiceEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    "clusterIP" => lambda {|n| @cluster_i_p = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIpEvidence.create_from_discriminator_value(pn) }) },
                    "externalIPs" => lambda {|n| @external_i_ps = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIpEvidence.create_from_discriminator_value(pn) }) },
                    ...
                    "selector" => lambda {|n| @selector = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityDictionary.create_from_discriminator_value(pn) }) },
                    "servicePorts" => lambda {|n| @service_ports = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityKubernetesServicePort.create_from_discriminator_value(pn) }) },
                    "serviceType" => lambda {|n| @service_type = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityKubernetesServiceType) },
                })
            end
            ## 
