...
module MicrosoftGraphBeta
    module Models
        class CallRecordsServiceUserAgent < MicrosoftGraphBeta::Models::CallRecordsUserAgent
            ...
            def get_field_deserializers()
                return super.merge({
                    "role" => lambda {|n| @role = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsServiceRole) },
                })
            end
            ## 
