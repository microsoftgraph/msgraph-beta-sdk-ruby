...
module MicrosoftGraphBeta
    module Models
        class SecurityRemoveContentHeaderAction < MicrosoftGraphBeta::Models::SecurityInformationProtectionAction
            include MicrosoftKiotaAbstractions::Parsable
            ## 
            # The name of the UI element of the header to be removed.
            @ui_element_names
            ## 
            ## Instantiates a new SecurityRemoveContentHeaderAction and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            ## @return a security_remove_content_header_action
            ## 
