...
module MicrosoftGraphBeta
    module Models
        class Device < MicrosoftGraphBeta::Models::DirectoryObject
            ...
            ## @param value Value to set for the extension_attributes property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the is_management_restricted property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the is_rooted property.
            ## @return a void
            ## 
            def is_rooted=(value)
                @is_rooted = value
            ...
            ## @param value Value to set for the management_type property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the usage_rights property.
            ## @return a void
            ## 
