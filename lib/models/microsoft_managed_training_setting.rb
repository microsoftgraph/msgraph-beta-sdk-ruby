        ...
        class MicrosoftManagedTrainingSetting < MicrosoftGraphBeta::Models::TrainingSetting
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "trainingCompletionDuration" => lambda {|n| @training_completion_duration = n.get_enum_value(MicrosoftGraphBeta::Models::MicrosoftManagedTrainingSettingTrainingCompletionDuration) },
                })
            end
            ## 
