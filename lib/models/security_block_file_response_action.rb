...
module MicrosoftGraphBeta
    module Models
        class SecurityBlockFileResponseAction < MicrosoftGraphBeta::Models::SecurityResponseAction
            ...
            @identifier
            ## 
            ## Instantiates a new securityBlockFileResponseAction and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            ## @return a security_block_file_response_action
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return SecurityBlockFileResponseAction.new
            end
            ## 
