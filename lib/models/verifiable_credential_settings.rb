...
module MicrosoftGraphBeta
    module Models
        class VerifiableCredentialSettings
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return VerifiableCredentialSettings.new
            end
            ## 
            ...
            ## @param value Value to set for the credential_types property.
            ## @return a void
            ## 
            def credential_types=(value)
            ...
            def get_field_deserializers()
                return {
                    "credentialTypes" => lambda {|n| @credential_types = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::VerifiableCredentialType.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("credentialTypes", @credential_types)
