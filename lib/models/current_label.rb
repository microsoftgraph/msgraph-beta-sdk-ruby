...
module MicrosoftGraphBeta
    module Models
        class CurrentLabel
            ...
            ## @return a current_label_application_mode
            ## 
            ...
            def get_field_deserializers()
                return {
                    "applicationMode" => lambda {|n| @application_mode = n.get_enum_value(MicrosoftGraphBeta::Models::CurrentLabelApplicationMode) },
