...
module MicrosoftGraphBeta
    module Models
        class Invitation < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "invitedUser" => lambda {|n| @invited_user = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::User.create_from_discriminator_value(pn) }) },
                    ...
                    "invitedUserMessageInfo" => lambda {|n| @invited_user_message_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::InvitedUserMessageInfo.create_from_discriminator_value(pn) }) },
                    "invitedUserSponsors" => lambda {|n| @invited_user_sponsors = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
