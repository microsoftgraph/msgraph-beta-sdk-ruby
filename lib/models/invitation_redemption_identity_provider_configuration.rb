...
module MicrosoftGraphBeta
    module Models
        class InvitationRedemptionIdentityProviderConfiguration
            ...
            ## @return a invitation_redemption_identity_provider_configuration_fallback_identity_provider
            ## 
            ...
            def get_field_deserializers()
                return {
                    "fallbackIdentityProvider" => lambda {|n| @fallback_identity_provider = n.get_enum_value(MicrosoftGraphBeta::Models::InvitationRedemptionIdentityProviderConfigurationFallbackIdentityProvider) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "primaryIdentityProviderPrecedenceOrder" => lambda {|n| @primary_identity_provider_precedence_order = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::InvitationRedemptionIdentityProviderConfigurationPrimaryIdentityProviderPrecedenceOrder.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            ## @return a invitation_redemption_identity_provider_configuration_primary_identity_provider_precedence_order
            ## 
