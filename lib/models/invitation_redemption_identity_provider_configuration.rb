    ...
    module Models
        class InvitationRedemptionIdentityProviderConfiguration
            ...
            def get_field_deserializers()
                return {
                    "fallbackIdentityProvider" => lambda {|n| @fallback_identity_provider = n.get_enum_value(MicrosoftGraphBeta::Models::B2bIdentityProvidersType) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "primaryIdentityProviderPrecedenceOrder" => lambda {|n| @primary_identity_provider_precedence_order = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::B2bIdentityProvidersType.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
