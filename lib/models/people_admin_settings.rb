        ...
        class PeopleAdminSettings < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "namePronunciation" => lambda {|n| @name_pronunciation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::NamePronunciationSettings.create_from_discriminator_value(pn) }) },
            ...
            ## @return a void
            ## 
            def name_pronunciation=(value)
                @name_pronunciation = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("namePronunciation", @name_pronunciation)
