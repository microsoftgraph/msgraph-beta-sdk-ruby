...
module MicrosoftGraphBeta
    module Models
        class WindowsSetting < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "instances" => lambda {|n| @instances = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsSettingInstance.create_from_discriminator_value(pn) }) },
                    "payloadType" => lambda {|n| @payload_type = n.get_string_value() },
                    "settingType" => lambda {|n| @setting_type = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsSettingType) },
