...
module MicrosoftGraphBeta
    module Models
        class SecurityLabelsRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "authorities" => lambda {|n| @authorities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityAuthorityTemplate.create_from_discriminator_value(pn) }) },
                    "categories" => lambda {|n| @categories = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityCategoryTemplate.create_from_discriminator_value(pn) }) },
                    "citations" => lambda {|n| @citations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityCitationTemplate.create_from_discriminator_value(pn) }) },
                    "departments" => lambda {|n| @departments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityDepartmentTemplate.create_from_discriminator_value(pn) }) },
                    "filePlanReferences" => lambda {|n| @file_plan_references = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityFilePlanReferenceTemplate.create_from_discriminator_value(pn) }) },
                    "retentionLabels" => lambda {|n| @retention_labels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityRetentionLabel.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
