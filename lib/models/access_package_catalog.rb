    ...
    module Models
        class AccessPackageCatalog < MicrosoftGraphBeta::Models::Entity
            ...
            def access_package_custom_workflow_extensions
                return @access_package_custom_workflow_extensions
            end
            ## 
            ...
            ## @param value Value to set for the access_package_custom_workflow_extensions property.
            ## @return a void
            ## 
            def access_package_custom_workflow_extensions=(value)
                @access_package_custom_workflow_extensions = value
            end
            ## 
            ...
            ## @param value Value to set for the access_package_resource_roles property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the access_package_resource_scopes property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the access_package_resources property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the catalog_status property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the custom_access_package_workflow_extensions property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "accessPackageCustomWorkflowExtensions" => lambda {|n| @access_package_custom_workflow_extensions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CustomCalloutExtension.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                super
                writer.write_collection_of_object_values("accessPackageCustomWorkflowExtensions", @access_package_custom_workflow_extensions)
