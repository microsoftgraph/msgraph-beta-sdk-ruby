        ...
        class CopyNotebookModel
            ...
            def get_field_deserializers()
                return {
                    ...
                    "createdByIdentity" => lambda {|n| @created_by_identity = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                    ...
                    "lastModifiedByIdentity" => lambda {|n| @last_modified_by_identity = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                    ...
                    "userRole" => lambda {|n| @user_role = n.get_enum_value(MicrosoftGraphBeta::Models::CopyNotebookModelUserRole) },
                }
            end
            ## 
