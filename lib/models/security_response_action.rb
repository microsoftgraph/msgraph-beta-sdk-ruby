...
module MicrosoftGraphBeta
    module Models
        class SecurityResponseAction
            ...
            ## 
            ## Instantiates a new securityResponseAction and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        ...
                        when "#microsoft.graph.security.collectInvestigationPackageResponseAction"
                            return SecurityCollectInvestigationPackageResponseAction.new
                        ...
                        when "#microsoft.graph.security.markUserAsCompromisedResponseAction"
                            return SecurityMarkUserAsCompromisedResponseAction.new
                        ...
                        when "#microsoft.graph.security.restrictAppExecutionResponseAction"
                            return SecurityRestrictAppExecutionResponseAction.new
                        when "#microsoft.graph.security.runAntivirusScanResponseAction"
                            return SecurityRunAntivirusScanResponseAction.new
                ...
                return SecurityResponseAction.new
            end
            ## 
