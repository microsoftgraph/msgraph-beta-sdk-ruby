        ...
        module Search
            class IdentitySet
                ...
                def get_field_deserializers()
                    return {
                        "application" => lambda {|n| @application = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Search::Identity.create_from_discriminator_value(pn) }) },
                        "device" => lambda {|n| @device = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Search::Identity.create_from_discriminator_value(pn) }) },
                        "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                        "user" => lambda {|n| @user = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Search::Identity.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
