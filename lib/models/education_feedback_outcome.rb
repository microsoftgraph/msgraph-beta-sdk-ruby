...
module MicrosoftGraphBeta
    module Models
        class EducationFeedbackOutcome < MicrosoftGraphBeta::Models::EducationOutcome
            ...
            def get_field_deserializers()
                return super.merge({
                    "feedback" => lambda {|n| @feedback = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationFeedback.create_from_discriminator_value(pn) }) },
                    "publishedFeedback" => lambda {|n| @published_feedback = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationFeedback.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
