...
module MicrosoftGraphBeta::Models
    class InferenceClassification < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "overrides" => lambda {|n| @overrides = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::InferenceClassificationOverride.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
