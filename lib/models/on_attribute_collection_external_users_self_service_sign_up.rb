...
module MicrosoftGraphBeta
    module Models
        class OnAttributeCollectionExternalUsersSelfServiceSignUp < MicrosoftGraphBeta::Models::OnAttributeCollectionHandler
            ...
            ## @param value Value to set for the attribute_collection_page property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "attributeCollectionPage" => lambda {|n| @attribute_collection_page = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationAttributeCollectionPage.create_from_discriminator_value(pn) }) },
                    "attributes" => lambda {|n| @attributes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityUserFlowAttribute.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
