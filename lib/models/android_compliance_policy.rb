...
module MicrosoftGraphBeta
    module Models
        class AndroidCompliancePolicy < MicrosoftGraphBeta::Models::DeviceCompliancePolicy
            ...
            @security_block_device_administrator_managed_devices
            ## 
            ...
            ## @return a string
            ## 
            def condition_statement_id
                return @condition_statement_id
            end
            ## 
            ## Sets the conditionStatementId property value. Condition statement id.
            ## @param value Value to set for the condition_statement_id property.
            ## @return a void
            ## 
            def condition_statement_id=(value)
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "conditionStatementId" => lambda {|n| @condition_statement_id = n.get_string_value() },
                    ...
                    "passwordRequiredType" => lambda {|n| @password_required_type = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidRequiredPasswordType) },
                    ...
                    "requiredPasswordComplexity" => lambda {|n| @required_password_complexity = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidRequiredPasswordComplexity) },
                    "restrictedApps" => lambda {|n| @restricted_apps = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AppListItem.create_from_discriminator_value(pn) }) },
                    "securityBlockDeviceAdministratorManagedDevices" => lambda {|n| @security_block_device_administrator_managed_devices = n.get_boolean_value() },
            ...
            ## 
            def required_password_complexity
                return @required_password_complexity
            end
            ## 
            ...
            ## @param value Value to set for the required_password_complexity property.
            ## @return a void
            ## 
            def required_password_complexity=(value)
                @required_password_complexity = value
            end
            ## 
            ...
            ## @return a boolean
            ## 
            def security_block_device_administrator_managed_devices
                return @security_block_device_administrator_managed_devices
            end
            ## 
            ## Sets the securityBlockDeviceAdministratorManagedDevices property value. Block device administrator managed devices.
            ## @param value Value to set for the security_block_device_administrator_managed_devices property.
            ## @return a void
            ## 
            def security_block_device_administrator_managed_devices=(value)
                @security_block_device_administrator_managed_devices = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("conditionStatementId", @condition_statement_id)
                ...
                writer.write_enum_value("requiredPasswordComplexity", @required_password_complexity)
                writer.write_collection_of_object_values("restrictedApps", @restricted_apps)
                writer.write_boolean_value("securityBlockDeviceAdministratorManagedDevices", @security_block_device_administrator_managed_devices)
