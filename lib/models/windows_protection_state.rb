        ...
        class WindowsProtectionState < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "deviceState" => lambda {|n| @device_state = n.get_enum_values(MicrosoftGraphBeta::Models::WindowsDeviceHealthState) },
                    ...
                    "productStatus" => lambda {|n| @product_status = n.get_enum_values(MicrosoftGraphBeta::Models::WindowsDefenderProductStatus) },
