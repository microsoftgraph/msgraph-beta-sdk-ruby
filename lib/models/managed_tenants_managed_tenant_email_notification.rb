...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsManagedTenantEmailNotification < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a managed_tenants_email
            ## 
            def email_addresses
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "emailAddresses" => lambda {|n| @email_addresses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsEmail.create_from_discriminator_value(pn) }) },
