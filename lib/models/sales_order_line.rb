...
module MicrosoftGraphBeta::Models
    class SalesOrderLine < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "invoiceQuantity" => lambda {|n| @invoice_quantity = n.get_object_value(lambda {|pn| Decimal.create_from_discriminator_value(pn) }) },
                "invoicedQuantity" => lambda {|n| @invoiced_quantity = n.get_object_value(lambda {|pn| Decimal.create_from_discriminator_value(pn) }) },
                ...
                "shipQuantity" => lambda {|n| @ship_quantity = n.get_object_value(lambda {|pn| Decimal.create_from_discriminator_value(pn) }) },
                "shipmentDate" => lambda {|n| @shipment_date = n.get_date_value() },
                "shippedQuantity" => lambda {|n| @shipped_quantity = n.get_object_value(lambda {|pn| Decimal.create_from_discriminator_value(pn) }) },
        ...
        ## @param value Value to set for the invoice_discount_allocation property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the invoice_quantity property.
        ## @return a void
        ## 
        def invoice_quantity=(value)
            @invoice_quantity = value
        end
        ## 
        ...
        ## @param value Value to set for the invoiced_quantity property.
        ## @return a void
        ## 
        def invoiced_quantity=(value)
        ...
        def serialize(writer)
            ...
            writer.write_object_value("invoiceQuantity", @invoice_quantity)
            writer.write_object_value("invoicedQuantity", @invoiced_quantity)
            ...
            writer.write_object_value("shipQuantity", @ship_quantity)
            writer.write_date_value("shipmentDate", @shipment_date)
            writer.write_object_value("shippedQuantity", @shipped_quantity)
        ...
        ## @param value Value to set for the ship_quantity property.
        ## @return a void
        ## 
        def ship_quantity=(value)
            @ship_quantity = value
        end
        ## 
        ...
        ## @param value Value to set for the shipment_date property.
        ## @return a void
        ## 
        def shipment_date=(value)
            @shipment_date = value
        end
        ## 
        ...
        ## @param value Value to set for the shipped_quantity property.
        ## @return a void
        ## 
        def shipped_quantity=(value)
