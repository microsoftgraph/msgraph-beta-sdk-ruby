...
module MicrosoftGraphBeta
    module Models
        class ExternalConnectorsExternalGroup < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "members" => lambda {|n| @members = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectorsIdentity.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
