...
module MicrosoftGraphBeta
    module Models
        class SecurityIdentityContainer < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "healthIssues" => lambda {|n| @health_issues = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHealthIssue.create_from_discriminator_value(pn) }) },
                    "sensors" => lambda {|n| @sensors = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecuritySensor.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
