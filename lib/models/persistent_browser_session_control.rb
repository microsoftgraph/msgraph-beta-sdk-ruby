...
module MicrosoftGraphBeta
    module Models
        class PersistentBrowserSessionControl < MicrosoftGraphBeta::Models::ConditionalAccessSessionControl
            ...
            def get_field_deserializers()
                return super.merge({
                    "mode" => lambda {|n| @mode = n.get_enum_value(MicrosoftGraphBeta::Models::PersistentBrowserSessionControlMode) },
                })
            end
            ## 
