        ...
        class SharepointSettings < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "imageTaggingOption" => lambda {|n| @image_tagging_option = n.get_enum_value(MicrosoftGraphBeta::Models::ImageTaggingChoice) },
                    ...
                    "sharingCapability" => lambda {|n| @sharing_capability = n.get_enum_value(MicrosoftGraphBeta::Models::SharingCapabilities) },
                    "sharingDomainRestrictionMode" => lambda {|n| @sharing_domain_restriction_mode = n.get_enum_value(MicrosoftGraphBeta::Models::SharingDomainRestrictionMode) },
