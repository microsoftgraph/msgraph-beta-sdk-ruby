        ...
        class RequiredResourceAccess
            ...
            def get_field_deserializers()
                return {
                    ...
                    "resourceAccess" => lambda {|n| @resource_access = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ResourceAccess.create_from_discriminator_value(pn) }) },
