...
module MicrosoftGraphBeta
    module Models
        class OnAttributeCollectionSubmitListener < MicrosoftGraphBeta::Models::AuthenticationEventListener
            ...
            def get_field_deserializers()
                return super.merge({
                    "handler" => lambda {|n| @handler = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnAttributeCollectionSubmitHandler.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
