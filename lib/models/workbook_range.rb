...
module MicrosoftGraphBeta::Models
    class WorkbookRange < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "format" => lambda {|n| @format = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookRangeFormat.create_from_discriminator_value(pn) }) },
                ...
                "sort" => lambda {|n| @sort = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookRangeSort.create_from_discriminator_value(pn) }) },
