        ...
        class OpenNetworkAzureSecurityGroupFinding < MicrosoftGraphBeta::Models::Finding
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "virtualMachines" => lambda {|n| @virtual_machines = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::VirtualMachineDetails.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
