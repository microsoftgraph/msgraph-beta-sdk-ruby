...
module MicrosoftGraphBeta
    module Models
        class CloudClipboardItem < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "payloads" => lambda {|n| @payloads = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CloudClipboardItemPayload.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
