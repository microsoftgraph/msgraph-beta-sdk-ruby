    ...
    module Models
        class ChatMessagePolicyViolation
            ...
            def get_field_deserializers()
                return {
                    "dlpAction" => lambda {|n| @dlp_action = n.get_enum_value(MicrosoftGraphBeta::Models::ChatMessagePolicyViolationDlpAction) },
                    ...
                    "userAction" => lambda {|n| @user_action = n.get_enum_value(MicrosoftGraphBeta::Models::ChatMessagePolicyViolationUserAction) },
                    "verdictDetails" => lambda {|n| @verdict_details = n.get_enum_value(MicrosoftGraphBeta::Models::ChatMessagePolicyViolationVerdictDetails) },
                }
            end
            ## 
