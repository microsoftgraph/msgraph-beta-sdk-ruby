...
module MicrosoftGraphBeta
    module Models
        class PrintOperation < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "status" => lambda {|n| @status = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PrintOperationStatus.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
