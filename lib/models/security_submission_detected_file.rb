...
module MicrosoftGraphBeta
    module Models
        class SecuritySubmissionDetectedFile
            ...
            ## 
            ## Instantiates a new securitySubmissionDetectedFile and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return SecuritySubmissionDetectedFile.new
            end
            ## 
