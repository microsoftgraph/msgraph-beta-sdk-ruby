        ...
        class SecurityDiscoveredCloudAppInfo < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "dataTypes" => lambda {|n| @data_types = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityAppInfoUploadedDataTypes.create_from_discriminator_value(pn) }) },
                    ...
                    "logonUrls" => lambda {|n| @logon_urls = n.get_collection_of_primitive_values(String) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("dataTypes", @data_types)
                ...
                writer.write_collection_of_primitive_values("logonUrls", @logon_urls)
