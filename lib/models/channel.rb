...
module MicrosoftGraphBeta
    module Models
        class Channel < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a void
            ## 
            def get_all_members=(value)
                @get_all_members = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "getAllMembers" => lambda {|n| @get_all_members = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ConversationMember.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("getAllMembers", @get_all_members)
