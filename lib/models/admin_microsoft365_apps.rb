...
module MicrosoftGraphBeta
    module Models
        class AdminMicrosoft365Apps < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "installationOptions" => lambda {|n| @installation_options = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::M365AppsInstallationOptions.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
