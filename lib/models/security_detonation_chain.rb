...
module MicrosoftGraphBeta
    module Models
        class SecurityDetonationChain
            ...
            ## 
            ## Instantiates a new SecurityDetonationChain and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return SecurityDetonationChain.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "childNodes" => lambda {|n| @child_nodes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityDetonationChain.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("childNodes", @child_nodes)
