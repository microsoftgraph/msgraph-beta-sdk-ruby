...
module MicrosoftGraphBeta
    module Models
        class StartsWithTransformation < MicrosoftGraphBeta::Models::CustomClaimTransformation
            ...
            @value
            ## 
            ## Instantiates a new StartsWithTransformation and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
                @odata_type = "#microsoft.graph.startsWithTransformation"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a starts_with_transformation
            ## 
