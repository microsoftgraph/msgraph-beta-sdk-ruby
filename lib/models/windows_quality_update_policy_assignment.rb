...
module MicrosoftGraphBeta
    module Models
        ...
        class WindowsQualityUpdatePolicyAssignment < MicrosoftGraphBeta::Models::Entity
            include MicrosoftKiotaAbstractions::Parsable
            ## 
            # Base type for assignment targets.
            @target
            ## 
            ## Instantiates a new WindowsQualityUpdatePolicyAssignment and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return WindowsQualityUpdatePolicyAssignment.new
            end
            ## 
