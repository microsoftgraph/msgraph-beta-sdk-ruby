        ...
        class SecurityEmailThreatSubmission < MicrosoftGraphBeta::Models::SecurityThreatSubmission
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "originalCategory" => lambda {|n| @original_category = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityEmailThreatSubmissionOriginalCategory) },
            ...
            ## @return a security_email_threat_submission_original_category
            ## 
