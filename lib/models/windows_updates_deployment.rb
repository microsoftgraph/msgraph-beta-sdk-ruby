...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdatesDeployment < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "settings" => lambda {|n| @settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesDeploymentSettings.create_from_discriminator_value(pn) }) },
                    "state" => lambda {|n| @state = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesDeploymentState.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
