...
module MicrosoftGraphBeta
    module Models
        class PlannerPlan < MicrosoftGraphBeta::Models::PlannerDelta
            ...
            ## 
            def shared_with_containers
                return @shared_with_containers
            end
            ## 
            ## Sets the sharedWithContainers property value. The sharedWithContainers property
            ## @param value Value to set for the shared_with_containers property.
            ## @return a void
            ## 
            def shared_with_containers=(value)
                @shared_with_containers = value
            end
            ## 
