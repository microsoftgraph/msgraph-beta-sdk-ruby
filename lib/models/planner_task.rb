        ...
        class PlannerTask < MicrosoftGraphBeta::Models::PlannerDelta
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "bucketTaskBoardFormat" => lambda {|n| @bucket_task_board_format = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PlannerBucketTaskBoardTaskFormat.create_from_discriminator_value(pn) }) },
                    "checklistItemCount" => lambda {|n| @checklist_item_count = n.get_number_value() },
                    "completedBy" => lambda {|n| @completed_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                    ...
                    "creationSource" => lambda {|n| @creation_source = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PlannerTaskCreation.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("specifiedCompletionRequirements", @specified_completion_requirements)
            ...
            ## @param value Value to set for the specified_completion_requirements property.
            ## @return a void
            ## 
            def specified_completion_requirements=(value)
                @specified_completion_requirements = value
            end
            ## 
