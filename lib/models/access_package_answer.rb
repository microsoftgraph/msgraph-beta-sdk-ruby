    ...
    module Models
        class AccessPackageAnswer
            ...
            def get_field_deserializers()
                return {
                    "answeredQuestion" => lambda {|n| @answered_question = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AccessPackageQuestion.create_from_discriminator_value(pn) }) },
