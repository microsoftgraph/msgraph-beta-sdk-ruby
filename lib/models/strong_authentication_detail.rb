...
module MicrosoftGraphBeta
    module Models
        class StrongAuthenticationDetail < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the encrypted_pin_hash_history property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "encryptedPinHashHistory" => lambda {|n| @encrypted_pin_hash_history = n.get_object_value(lambda {|pn| Base64url.create_from_discriminator_value(pn) }) },
            ...
            ## @param value Value to set for the proofup_time property.
            ## @return a void
            ## 
