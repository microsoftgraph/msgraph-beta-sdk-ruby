        ...
        class MonthlyUserInsightMetricsRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "mfaRegisteredUsers" => lambda {|n| @mfa_registered_users = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MfaUserCountMetric.create_from_discriminator_value(pn) }) },
            ...
            ## @return a void
            ## 
            def mfa_registered_users=(value)
                @mfa_registered_users = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("mfaRegisteredUsers", @mfa_registered_users)
