...
module MicrosoftGraphBeta
    module Models
        class CallRecordsCallRecord < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "modalities" => lambda {|n| @modalities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsModality.create_from_discriminator_value(pn) }) },
                    "organizer" => lambda {|n| @organizer = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                    "organizer_v2" => lambda {|n| @organizer_v2 = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsOrganizer.create_from_discriminator_value(pn) }) },
                    ...
                    "participants_v2" => lambda {|n| @participants_v2 = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsParticipant.create_from_discriminator_value(pn) }) },
                    "sessions" => lambda {|n| @sessions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecordsSession.create_from_discriminator_value(pn) }) },
                    "startDateTime" => lambda {|n| @start_date_time = n.get_date_time_value() },
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordsCallType) },
