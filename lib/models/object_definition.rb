...
module MicrosoftGraphBeta::Models
    class ObjectDefinition
        ...
        def get_field_deserializers()
            return {
                "attributes" => lambda {|n| @attributes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AttributeDefinition.create_from_discriminator_value(pn) }) },
