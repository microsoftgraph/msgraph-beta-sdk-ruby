    ...
    module Models
        class AutomaticRepliesSetting
            ...
            def get_field_deserializers()
                return {
                    "externalAudience" => lambda {|n| @external_audience = n.get_enum_value(MicrosoftGraphBeta::Models::AutomaticRepliesSettingExternalAudience) },
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::AutomaticRepliesSettingStatus) },
                }
            end
            ## 
