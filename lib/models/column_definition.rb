...
module MicrosoftGraphBeta
    module Models
        class ColumnDefinition < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "boolean" => lambda {|n| @boolean = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::BooleanColumn.create_from_discriminator_value(pn) }) },
                    "calculated" => lambda {|n| @calculated = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CalculatedColumn.create_from_discriminator_value(pn) }) },
                    "choice" => lambda {|n| @choice = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChoiceColumn.create_from_discriminator_value(pn) }) },
                    "columnGroup" => lambda {|n| @column_group = n.get_string_value() },
                    "contentApprovalStatus" => lambda {|n| @content_approval_status = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ContentApprovalStatusColumn.create_from_discriminator_value(pn) }) },
                    "currency" => lambda {|n| @currency = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CurrencyColumn.create_from_discriminator_value(pn) }) },
                    "dateTime" => lambda {|n| @date_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeColumn.create_from_discriminator_value(pn) }) },
                    "defaultValue" => lambda {|n| @default_value = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DefaultColumnValue.create_from_discriminator_value(pn) }) },
                    "description" => lambda {|n| @description = n.get_string_value() },
                    "displayName" => lambda {|n| @display_name = n.get_string_value() },
                    "enforceUniqueValues" => lambda {|n| @enforce_unique_values = n.get_boolean_value() },
                    "geolocation" => lambda {|n| @geolocation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::GeolocationColumn.create_from_discriminator_value(pn) }) },
                    "hidden" => lambda {|n| @hidden = n.get_boolean_value() },
                    "hyperlinkOrPicture" => lambda {|n| @hyperlink_or_picture = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::HyperlinkOrPictureColumn.create_from_discriminator_value(pn) }) },
                    ...
                    "lookup" => lambda {|n| @lookup = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::LookupColumn.create_from_discriminator_value(pn) }) },
                    "name" => lambda {|n| @name = n.get_string_value() },
                    "number" => lambda {|n| @number = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::NumberColumn.create_from_discriminator_value(pn) }) },
                    "personOrGroup" => lambda {|n| @person_or_group = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PersonOrGroupColumn.create_from_discriminator_value(pn) }) },
                    ...
                    "sourceColumn" => lambda {|n| @source_column = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ColumnDefinition.create_from_discriminator_value(pn) }) },
                    "sourceContentType" => lambda {|n| @source_content_type = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ContentTypeInfo.create_from_discriminator_value(pn) }) },
                    "term" => lambda {|n| @term = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TermColumn.create_from_discriminator_value(pn) }) },
                    "text" => lambda {|n| @text = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TextColumn.create_from_discriminator_value(pn) }) },
                    "thumbnail" => lambda {|n| @thumbnail = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ThumbnailColumn.create_from_discriminator_value(pn) }) },
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::ColumnDefinitionType) },
                    "validation" => lambda {|n| @validation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ColumnValidation.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
