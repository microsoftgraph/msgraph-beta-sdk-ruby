    ...
    class UserExperienceAnalyticsInsight
        ...
        def get_field_deserializers()
            return {
                ...
                "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraphBeta::Models::UserExperienceAnalyticsInsightSeverity) },
                "userExperienceAnalyticsMetricId" => lambda {|n| @user_experience_analytics_metric_id = n.get_string_value() },
                "values" => lambda {|n| @values = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserExperienceAnalyticsInsightValue.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
