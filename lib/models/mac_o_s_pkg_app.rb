...
module MicrosoftGraphBeta
    module Models
        class MacOSPkgApp < MicrosoftGraphBeta::Models::MobileLobApp
            ...
            ## @param value Value to set for the included_apps property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the primary_bundle_id property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the primary_bundle_version property.
            ## @return a void
            ## 
