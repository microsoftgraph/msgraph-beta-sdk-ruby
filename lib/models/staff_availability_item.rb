    ...
    module Models
        class StaffAvailabilityItem
            ...
            def get_field_deserializers()
                return {
                    "availabilityItems" => lambda {|n| @availability_items = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AvailabilityItem.create_from_discriminator_value(pn) }) },
