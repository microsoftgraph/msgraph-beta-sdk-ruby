...
module MicrosoftGraphBeta
    module Models
        class SecurityTenantAllowBlockListEntryResult
            ...
            ## @return a security_tenant_allow_block_list_entry_result_entry_type
            ## 
            def entry_type
                return @entry_type
            end
            ...
            def get_field_deserializers()
                return {
                    "entryType" => lambda {|n| @entry_type = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityTenantAllowBlockListEntryResultEntryType) },
                    "expirationDateTime" => lambda {|n| @expiration_date_time = n.get_date_time_value() },
                    "identity" => lambda {|n| @identity = n.get_string_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityTenantAllowBlockListEntryResultStatus) },
            ...
            ## @return a security_tenant_allow_block_list_entry_result_status
            ## 
            def status
                return @status
            end
