...
module MicrosoftGraphBeta
    module Models
        class PlatformCredentialAuthenticationMethod < MicrosoftGraphBeta::Models::AuthenticationMethod
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "keyStrength" => lambda {|n| @key_strength = n.get_enum_value(MicrosoftGraphBeta::Models::PlatformCredentialAuthenticationMethodKeyStrength) },
                    "platform" => lambda {|n| @platform = n.get_enum_value(MicrosoftGraphBeta::Models::PlatformCredentialAuthenticationMethodPlatform) },
                })
            end
            ## 
            ## Gets the keyStrength property value. Key strength of this Platform Credential key. Possible values are: normal, weak, unknown.
            ## @return a platform_credential_authentication_method_key_strength
            ## 
            def key_strength
                return @key_strength
            end
            ...
            ## @return a platform_credential_authentication_method_platform
            ## 
            def platform
                return @platform
            end
