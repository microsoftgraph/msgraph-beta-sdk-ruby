...
module MicrosoftGraphBeta
    module Models
        class NetworkaccessBranchSite < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a networkaccess_branch_site_connectivity_state
            ## 
            ...
            ## 
            ## Instantiates a new networkaccessBranchSite and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "connectivityState" => lambda {|n| @connectivity_state = n.get_enum_value(MicrosoftGraphBeta::Models::NetworkaccessBranchSiteConnectivityState) },
