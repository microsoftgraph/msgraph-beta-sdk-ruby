...
module MicrosoftGraphBeta
    module Models
        class .models.partners.billingBilling < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "manifests" => lambda {|n| @manifests = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::.models.partners.billingManifest.create_from_discriminator_value(pn) }) },
                    "operations" => lambda {|n| @operations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::.models.partners.billingOperation.create_from_discriminator_value(pn) }) },
                    "reconciliation" => lambda {|n| @reconciliation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::.models.partners.billingBillingReconciliation.create_from_discriminator_value(pn) }) },
                    "usage" => lambda {|n| @usage = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::.models.partners.billingAzureUsage.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
