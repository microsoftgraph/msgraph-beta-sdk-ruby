...
module MicrosoftGraphBeta
    module Models
        ...
        class WindowsMicrosoftEdgeApp < MicrosoftGraphBeta::Models::MobileApp
            ...
            def get_field_deserializers()
                return super.merge({
                    "channel" => lambda {|n| @channel = n.get_enum_value(MicrosoftGraphBeta::Models::MicrosoftEdgeChannel) },
