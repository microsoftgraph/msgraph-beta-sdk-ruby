...
module MicrosoftGraphBeta
    module Models
        class WorkbookChartDataLabels < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "format" => lambda {|n| @format = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartDataLabelFormat.create_from_discriminator_value(pn) }) },
