...
module MicrosoftGraphBeta
    module Models
        ...
        class Win32CatalogApp < MicrosoftGraphBeta::Models::Win32LobApp
            ...
            @latest_upgrade_catalog_package
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "latestUpgradeCatalogPackage" => lambda {|n| @latest_upgrade_catalog_package = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MobileAppCatalogPackage.create_from_discriminator_value(pn) }) },
                    "mobileAppCatalogPackageId" => lambda {|n| @mobile_app_catalog_package_id = n.get_string_value() },
                    "referencedCatalogPackage" => lambda {|n| @referenced_catalog_package = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MobileAppCatalogPackage.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## 
            def latest_upgrade_catalog_package
                return @latest_upgrade_catalog_package
            end
            ## 
            ...
            ## @return a void
            ## 
            def latest_upgrade_catalog_package=(value)
                @latest_upgrade_catalog_package = value
            end
            ## 
            ...
            ## @return a mobile_app_catalog_package
            ## 
            def referenced_catalog_package
                return @referenced_catalog_package
            end
            ## 
            ...
            ## @return a void
            ## 
            def referenced_catalog_package=(value)
                @referenced_catalog_package = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                super
                writer.write_object_value("latestUpgradeCatalogPackage", @latest_upgrade_catalog_package)
                writer.write_string_value("mobileAppCatalogPackageId", @mobile_app_catalog_package_id)
                writer.write_object_value("referencedCatalogPackage", @referenced_catalog_package)
            end
        end
    end
end
