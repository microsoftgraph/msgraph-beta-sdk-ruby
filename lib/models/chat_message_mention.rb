    ...
    class ChatMessageMention
        ...
        def get_field_deserializers()
            return {
                ...
                "mentioned" => lambda {|n| @mentioned = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChatMessageMentionedIdentitySet.create_from_discriminator_value(pn) }) },
