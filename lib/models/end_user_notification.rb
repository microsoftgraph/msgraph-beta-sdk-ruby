        ...
        class EndUserNotification < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "details" => lambda {|n| @details = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EndUserNotificationDetail.create_from_discriminator_value(pn) }) },
                    ...
                    "notificationType" => lambda {|n| @notification_type = n.get_enum_value(MicrosoftGraphBeta::Models::EndUserNotificationType) },
            ...
            ## @param value Value to set for the supported_locales property.
            ## @return a void
            ## 
