        ...
        class EndUserNotification < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "notificationType" => lambda {|n| @notification_type = n.get_enum_value(MicrosoftGraphBeta::Models::EndUserNotificationNotificationType) },
                    "source" => lambda {|n| @source = n.get_enum_value(MicrosoftGraphBeta::Models::EndUserNotificationSource) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::EndUserNotificationStatus) },
