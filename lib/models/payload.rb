...
module MicrosoftGraphBeta
    module Models
        class Payload < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "brand" => lambda {|n| @brand = n.get_enum_value(MicrosoftGraphBeta::Models::PayloadBrand) },
                    "complexity" => lambda {|n| @complexity = n.get_enum_value(MicrosoftGraphBeta::Models::PayloadComplexity) },
                    ...
                    "detail" => lambda {|n| @detail = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PayloadDetail.create_from_discriminator_value(pn) }) },
                    "displayName" => lambda {|n| @display_name = n.get_string_value() },
                    "industry" => lambda {|n| @industry = n.get_enum_value(MicrosoftGraphBeta::Models::PayloadIndustry) },
                    ...
                    "platform" => lambda {|n| @platform = n.get_enum_value(MicrosoftGraphBeta::Models::PayloadDeliveryPlatform) },
                    ...
                    "simulationAttackType" => lambda {|n| @simulation_attack_type = n.get_enum_value(MicrosoftGraphBeta::Models::SimulationAttackType) },
                    "source" => lambda {|n| @source = n.get_enum_value(MicrosoftGraphBeta::Models::SimulationContentSource) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::SimulationContentStatus) },
                    "technique" => lambda {|n| @technique = n.get_enum_value(MicrosoftGraphBeta::Models::SimulationAttackTechnique) },
                    "theme" => lambda {|n| @theme = n.get_enum_value(MicrosoftGraphBeta::Models::PayloadTheme) },
                })
            end
            ## 
            ...
            ## 
            ## Gets the technique property value. The social engineering technique used in the attack simulation and training campaign. Supports $filter and $orderby. Possible values are: unknown, credentialHarvesting, attachmentMalware, driveByUrl, linkInAttachment, linkToMalwareFile, unknownFutureValue, oAuthConsentGrant, phishTraining. Use the Prefer: include-unknown-enum-members request header to get the following values from this evolvable enum: oAuthConsentGrant, phishTraining. For more information on the types of social engineering attack techniques, see simulations.
