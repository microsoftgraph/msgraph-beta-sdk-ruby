...
module MicrosoftGraphBeta
    module Models
        class ThreatAssessmentResult < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "resultType" => lambda {|n| @result_type = n.get_enum_value(MicrosoftGraphBeta::Models::ThreatAssessmentResultResultType) },
                })
            end
            ## 
