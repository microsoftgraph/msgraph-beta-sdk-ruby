    ...
    module Models
        class ThumbnailSet < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "large" => lambda {|n| @large = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Thumbnail.create_from_discriminator_value(pn) }) },
                    "medium" => lambda {|n| @medium = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Thumbnail.create_from_discriminator_value(pn) }) },
                    "small" => lambda {|n| @small = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Thumbnail.create_from_discriminator_value(pn) }) },
                    "source" => lambda {|n| @source = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Thumbnail.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
