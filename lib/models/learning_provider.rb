...
module MicrosoftGraphBeta
    module Models
        class LearningProvider < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "learningContents" => lambda {|n| @learning_contents = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::LearningContent.create_from_discriminator_value(pn) }) },
