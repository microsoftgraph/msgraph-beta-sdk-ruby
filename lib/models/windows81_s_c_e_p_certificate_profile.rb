...
module MicrosoftGraphBeta
    module Models
        ...
        class Windows81SCEPCertificateProfile < MicrosoftGraphBeta::Models::Windows81CertificateProfileBase
            ...
            ## @return a windows81_s_c_e_p_certificate_profile_certificate_store
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "certificateStore" => lambda {|n| @certificate_store = n.get_enum_value(MicrosoftGraphBeta::Models::Windows81SCEPCertificateProfileCertificateStore) },
