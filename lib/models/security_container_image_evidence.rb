...
module MicrosoftGraphBeta
    module Models
        class SecurityContainerImageEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    "digestImage" => lambda {|n| @digest_image = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityContainerImageEvidence.create_from_discriminator_value(pn) }) },
                    "imageId" => lambda {|n| @image_id = n.get_string_value() },
                    "registry" => lambda {|n| @registry = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityContainerRegistryEvidence.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
