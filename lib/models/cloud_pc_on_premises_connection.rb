...
module MicrosoftGraphBeta
    module Models
        class CloudPcOnPremisesConnection < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a cloud_pc_on_premises_connection_connection_type
            ## 
            def connection_type
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "connectionType" => lambda {|n| @connection_type = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcOnPremisesConnectionConnectionType) },
