...
module MicrosoftGraphBeta
    module Models
        class CloudPcOnPremisesConnection < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the ad_domain_name property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the ad_domain_username property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the health_check_status_details property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the in_use property.
            ## @return a void
            ## 
            def in_use=(value)
                @in_use = value
            ...
            ## @param value Value to set for the resource_group_id property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the virtual_network_id property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the virtual_network_location property.
            ## @return a void
            ## 
