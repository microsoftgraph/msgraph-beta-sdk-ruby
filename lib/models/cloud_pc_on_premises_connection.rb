        ...
        class CloudPcOnPremisesConnection < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "healthCheckPaused" => lambda {|n| @health_check_paused = n.get_boolean_value() },
                    ...
                    "inUseByCloudPc" => lambda {|n| @in_use_by_cloud_pc = n.get_boolean_value() },
            ...
            ## @return a boolean
            ## 
            def health_check_paused
                return @health_check_paused
            end
            ## 
            ...
            ## @return a void
            ## 
            def health_check_paused=(value)
                @health_check_paused = value
            end
            ## 
            ...
            ## @return a boolean
            ## 
            def in_use_by_cloud_pc
                return @in_use_by_cloud_pc
            end
            ## 
            ...
            ## @return a void
            ## 
            def in_use_by_cloud_pc=(value)
                @in_use_by_cloud_pc = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("healthCheckPaused", @health_check_paused)
                ...
                writer.write_boolean_value("inUseByCloudPc", @in_use_by_cloud_pc)
