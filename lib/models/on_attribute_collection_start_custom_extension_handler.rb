...
module MicrosoftGraphBeta
    module Models
        class OnAttributeCollectionStartCustomExtensionHandler < MicrosoftGraphBeta::Models::OnAttributeCollectionStartHandler
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "customExtension" => lambda {|n| @custom_extension = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnAttributeCollectionStartCustomExtension.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
