...
module MicrosoftGraphBeta
    module Models
        ...
        class DeviceManagementConfigurationPolicyTemplate < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the allow_unmanaged_settings property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the base_id property.
            ## @return a void
            ## 
            def base_id=(value)
                @base_id = value
            ...
            ## @param value Value to set for the display_version property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the lifecycle_state property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the setting_template_count property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the setting_templates property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the template_family property.
            ## @return a void
            ## 
