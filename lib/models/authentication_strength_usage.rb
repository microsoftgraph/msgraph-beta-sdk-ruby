    ...
    module Models
        class AuthenticationStrengthUsage
            ...
            def get_field_deserializers()
                return {
                    "mfa" => lambda {|n| @mfa = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessPolicy.create_from_discriminator_value(pn) }) },
                    "none" => lambda {|n| @none = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessPolicy.create_from_discriminator_value(pn) }) },
