...
module MicrosoftGraphBeta
    module Models
        ...
        class BookingBusiness < MicrosoftGraphBeta::Models::BookingNamedEntity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "appointments" => lambda {|n| @appointments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingAppointment.create_from_discriminator_value(pn) }) },
                    "bookingPageSettings" => lambda {|n| @booking_page_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::BookingPageSettings.create_from_discriminator_value(pn) }) },
                    "businessHours" => lambda {|n| @business_hours = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingWorkHours.create_from_discriminator_value(pn) }) },
                    "businessType" => lambda {|n| @business_type = n.get_string_value() },
                    "calendarView" => lambda {|n| @calendar_view = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingAppointment.create_from_discriminator_value(pn) }) },
                    "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                    "customQuestions" => lambda {|n| @custom_questions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingCustomQuestion.create_from_discriminator_value(pn) }) },
                    "customers" => lambda {|n| @customers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingCustomer.create_from_discriminator_value(pn) }) },
                    ...
                    "services" => lambda {|n| @services = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingService.create_from_discriminator_value(pn) }) },
                    "staffMembers" => lambda {|n| @staff_members = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingStaffMember.create_from_discriminator_value(pn) }) },
