...
module MicrosoftGraphBeta
    module Models
        class SecurityNetworkConnectionEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    "destinationAddress" => lambda {|n| @destination_address = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIpEvidence.create_from_discriminator_value(pn) }) },
                    "destinationPort" => lambda {|n| @destination_port = n.get_number_value() },
                    "protocol" => lambda {|n| @protocol = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityProtocolType) },
                    "sourceAddress" => lambda {|n| @source_address = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIpEvidence.create_from_discriminator_value(pn) }) },
