        ...
        module ManagedTenants
            class RoleAssignment
                ...
                def get_field_deserializers()
                    return {
                        "assignmentType" => lambda {|n| @assignment_type = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::DelegatedPrivilegeStatus) },
                        "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                        "roles" => lambda {|n| @roles = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::RoleDefinition.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
