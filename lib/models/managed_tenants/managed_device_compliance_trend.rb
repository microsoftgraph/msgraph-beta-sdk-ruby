    ...
    module Models
        module ManagedTenants
            class ManagedDeviceComplianceTrend < MicrosoftGraphBeta::Models::Entity
                ...
                ## @param value Value to set for the config_manager_device_count property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the count_date_time property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the in_grace_period_device_count property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the noncompliant_device_count property.
                ## @return a void
                ## 
