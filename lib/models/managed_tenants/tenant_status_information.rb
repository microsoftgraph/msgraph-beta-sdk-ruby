    ...
    module Models
        module ManagedTenants
            class TenantStatusInformation
                ...
                ## @param value Value to set for the delegated_privilege_status property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return {
                        "delegatedPrivilegeStatus" => lambda {|n| @delegated_privilege_status = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::DelegatedPrivilegeStatus) },
                        ...
                        "onboardingStatus" => lambda {|n| @onboarding_status = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::TenantOnboardingStatus) },
                        "tenantOnboardingEligibilityReason" => lambda {|n| @tenant_onboarding_eligibility_reason = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::TenantOnboardingEligibilityReason) },
                        "workloadStatuses" => lambda {|n| @workload_statuses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::WorkloadStatus.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
                ...
                ## @param value Value to set for the last_delegated_privilege_refresh_date_time property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the offboarded_by_user_id property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the offboarded_date_time property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the onboarded_by_user_id property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the onboarded_date_time property.
                ## @return a void
                ## 
                ...
                ## @return a tenant_onboarding_status
                ## 
                ...
                ## @return a tenant_onboarding_eligibility_reason
                ## 
                ...
                ## @param value Value to set for the tenant_onboarding_eligibility_reason property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the workload_statuses property.
                ## @return a void
                ## 
