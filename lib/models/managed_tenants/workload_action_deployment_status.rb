        ...
        module ManagedTenants
            class WorkloadActionDeploymentStatus
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return WorkloadActionDeploymentStatus.new
                end
                ## 
                ...
                ## @param value Value to set for the deployed_policy_id property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::WorkloadActionStatus) },
                    }
                end
                ## 
                ...
                ## @param value Value to set for the last_deployment_date_time property.
                ## @return a void
                ## 
                ...
                ## @return a workload_action_status
                ## 
                def status
                    return @status
                end
