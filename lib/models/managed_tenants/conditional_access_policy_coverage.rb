...
module MicrosoftGraphBeta::Models::ManagedTenants
    class ConditionalAccessPolicyCoverage < MicrosoftGraphBeta::Models::Entity
        ...
        ## @param value Value to set for the conditional_access_policy_state property.
        ## @return a void
        ## 
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            return ConditionalAccessPolicyCoverage.new
        end
        ## 
        ...
        ## @param value Value to set for the latest_policy_modified_date_time property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the requires_device_compliance property.
        ## @return a void
        ## 
