    ...
    module Models
        module ManagedTenants
            class AuditEvent < MicrosoftGraphBeta::Models::Entity
                ...
                ## @param value Value to set for the http_verb property.
                ## @return a void
                ## 
                def http_verb=(value)
                    @http_verb = value
                ...
                ## @param value Value to set for the initiated_by_app_id property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the initiated_by_upn property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the initiated_by_user_id property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the request_url property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the tenant_names property.
                ## @return a void
                ## 
