...
module MicrosoftGraphBeta
    module Models
        module ManagedTenants
            class ManagementActionDeploymentStatus
                ...
                ## @return a management_action_deployment_status
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return ManagementActionDeploymentStatus.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::ManagementActionStatus) },
                        "workloadActionDeploymentStatuses" => lambda {|n| @workload_action_deployment_statuses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::WorkloadActionDeploymentStatus.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
                ...
                ## @param value Value to set for the management_action_id property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the management_template_id property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the management_template_version property.
                ## @return a void
                ## 
                ...
                ## @return a management_action_status
                ## 
                def status
                    return @status
                end
                ...
                ## @return a workload_action_deployment_status
                ## 
                ...
                ## @param value Value to set for the workload_action_deployment_statuses property.
                ## @return a void
                ## 
