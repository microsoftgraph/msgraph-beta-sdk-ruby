    ...
    module Models
        module ManagedTenants
            class ManagedTenant < MicrosoftGraphBeta::Models::Entity
                ...
                ## @param value Value to set for the app_performances property.
                ## @return a void
                ## 
                ...
                ## @return a device_app_performance
                ## 
                ...
                ## @param value Value to set for the device_app_performances property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the device_health_statuses property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "appPerformances" => lambda {|n| @app_performances = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::AppPerformance.create_from_discriminator_value(pn) }) },
                        ...
                        "deviceAppPerformances" => lambda {|n| @device_app_performances = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::DeviceAppPerformance.create_from_discriminator_value(pn) }) },
                        ...
                        "deviceHealthStatuses" => lambda {|n| @device_health_statuses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::DeviceHealthStatus.create_from_discriminator_value(pn) }) },
