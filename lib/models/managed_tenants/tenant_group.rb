...
module MicrosoftGraphBeta::Models::ManagedTenants
    class TenantGroup < MicrosoftGraphBeta::Models::Entity
        ...
        ## @param value Value to set for the all_tenants_included property.
        ## @return a void
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "managementActions" => lambda {|n| @management_actions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementActionInfo.create_from_discriminator_value(pn) }) },
                "managementIntents" => lambda {|n| @management_intents = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementIntentInfo.create_from_discriminator_value(pn) }) },
        ...
        ## @return a management_action_info
        ## 
