...
module MicrosoftGraphBeta
    module Models
        module ManagedTenants
            class ManagementTemplate < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "parameters" => lambda {|n| @parameters = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::TemplateParameter.create_from_discriminator_value(pn) }) },
                        "priority" => lambda {|n| @priority = n.get_number_value() },
                        "provider" => lambda {|n| @provider = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::ManagementProvider) },
                        "userImpact" => lambda {|n| @user_impact = n.get_string_value() },
                        "version" => lambda {|n| @version = n.get_number_value() },
                        "workloadActions" => lambda {|n| @workload_actions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::WorkloadAction.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
                ...
                ## @param value Value to set for the information_links property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the workload_actions property.
                ## @return a void
                ## 
