...
module MicrosoftGraphBeta
    module Models
        module ManagedTenants
            class ManagedTenantAlertRuleDefinition < MicrosoftGraphBeta::Models::Entity
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return ManagedTenantAlertRuleDefinition.new
                end
                ## 
                ## Gets the definitionTemplate property value. The definitionTemplate property
                ## @return a alert_rule_definition_template
                ## 
                ...
                ## @param value Value to set for the definition_template property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "alertRules" => lambda {|n| @alert_rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagedTenantAlertRule.create_from_discriminator_value(pn) }) },
                        "createdByUserId" => lambda {|n| @created_by_user_id = n.get_string_value() },
                        "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                        "definitionTemplate" => lambda {|n| @definition_template = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::AlertRuleDefinitionTemplate.create_from_discriminator_value(pn) }) },
