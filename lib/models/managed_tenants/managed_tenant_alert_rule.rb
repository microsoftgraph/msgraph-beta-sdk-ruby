...
module MicrosoftGraphBeta
    module Models
        module ManagedTenants
            class ManagedTenantAlertRule < MicrosoftGraphBeta::Models::Entity
                ...
                ## @param value Value to set for the alert_display_name property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the alert_t_t_l property.
                ## @return a void
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return ManagedTenantAlertRule.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "alerts" => lambda {|n| @alerts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagedTenantAlert.create_from_discriminator_value(pn) }) },
                        ...
                        "notificationFinalDestinations" => lambda {|n| @notification_final_destinations = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::NotificationDestination) },
                        "ruleDefinition" => lambda {|n| @rule_definition = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagedTenantAlertRuleDefinition.create_from_discriminator_value(pn) }) },
                        "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::AlertSeverity) },
                        "targets" => lambda {|n| @targets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::NotificationTarget.create_from_discriminator_value(pn) }) },
                        "tenantIds" => lambda {|n| @tenant_ids = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::TenantInfo.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
                ...
                ## @return a notification_destination
                ## 
                ...
                ## @param value Value to set for the notification_final_destinations property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the rule_definition property.
                ## @return a void
                ## 
