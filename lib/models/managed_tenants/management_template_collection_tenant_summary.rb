    ...
    module Models
        module ManagedTenants
            class ManagementTemplateCollectionTenantSummary < MicrosoftGraphBeta::Models::Entity
                ...
                ## @param value Value to set for the regressed_steps_count property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the regressed_users_count property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the unlicensed_users_count property.
                ## @return a void
                ## 
