...
module MicrosoftGraphBeta::Models::ManagedTenants
    class ManagementTemplateStepVersion < MicrosoftGraphBeta::Models::Entity
        ...
        ## @param value Value to set for the accepted_for property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the content_markdown property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the template_step property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the version_information property.
        ## @return a void
        ## 
