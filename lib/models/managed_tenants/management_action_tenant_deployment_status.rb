...
module MicrosoftGraphBeta
    module Models
        module ManagedTenants
            class ManagementActionTenantDeploymentStatus < MicrosoftGraphBeta::Models::Entity
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return ManagementActionTenantDeploymentStatus.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "statuses" => lambda {|n| @statuses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementActionDeploymentStatus.create_from_discriminator_value(pn) }) },
                ...
                ## @param value Value to set for the tenant_group_id property.
                ## @return a void
                ## 
