...
module MicrosoftGraphBeta
    module Models
        module ManagedTenants
            class ManagementTemplateStepDeployment < MicrosoftGraphBeta::Models::Entity
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return ManagementTemplateStepDeployment.new
                end
                ## 
                ## Gets the error property value. The error property
                ## @return a graph_a_p_i_error_details
                ## 
                def error
                    return @error
                end
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "error" => lambda {|n| @error = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::GraphAPIErrorDetails.create_from_discriminator_value(pn) }) },
                        ...
                        "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::ManagementTemplateDeploymentStatus) },
                        "templateStepVersion" => lambda {|n| @template_step_version = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementTemplateStepVersion.create_from_discriminator_value(pn) }) },
                ...
                def serialize(writer)
                    ...
                    writer.write_object_value("templateStepVersion", @template_step_version)
                    writer.write_string_value("tenantId", @tenant_id)
                end
                ## 
                ## Gets the status property value. The status property
                ## @return a management_template_deployment_status
                ## 
                def status
                    return @status
                end
                ...
                def template_step_version
                    return @template_step_version
                end
                ## 
                ## Sets the templateStepVersion property value. The templateStepVersion property
                ## @param value Value to set for the template_step_version property.
                ## @return a void
                ## 
                def template_step_version=(value)
                    @template_step_version = value
                end
                ## 
