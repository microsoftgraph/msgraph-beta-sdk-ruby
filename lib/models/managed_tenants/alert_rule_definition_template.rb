...
module MicrosoftGraphBeta
    module Models
        module ManagedTenants
            class AlertRuleDefinitionTemplate
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return AlertRuleDefinitionTemplate.new
                end
                ## 
                ...
                ## @param value Value to set for the default_severity property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return {
                        "defaultSeverity" => lambda {|n| @default_severity = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::AlertSeverity) },
