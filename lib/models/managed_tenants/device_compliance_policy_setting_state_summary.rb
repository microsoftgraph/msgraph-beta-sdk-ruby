    ...
    module Models
        module ManagedTenants
            class DeviceCompliancePolicySettingStateSummary < MicrosoftGraphBeta::Models::Entity
                ...
                ## @param value Value to set for the intune_setting_id property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the pending_device_count property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the succeeded_device_count property.
                ## @return a void
                ## 
