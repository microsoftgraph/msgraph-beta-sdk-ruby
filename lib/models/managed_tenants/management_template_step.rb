...
module MicrosoftGraphBeta::Models::ManagedTenants
    class ManagementTemplateStep < MicrosoftGraphBeta::Models::Entity
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            return ManagementTemplateStep.new
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                "acceptedVersion" => lambda {|n| @accepted_version = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementTemplateStepVersion.create_from_discriminator_value(pn) }) },
                "category" => lambda {|n| @category = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::ManagementCategory) },
                ...
                "managementTemplate" => lambda {|n| @management_template = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementTemplate.create_from_discriminator_value(pn) }) },
                ...
                "versions" => lambda {|n| @versions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementTemplateStepVersion.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
        ...
        ## @param value Value to set for the management_template property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the portal_link property.
        ## @return a void
        ## 
