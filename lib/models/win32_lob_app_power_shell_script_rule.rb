...
module MicrosoftGraphBeta
    module Models
        ...
        class Win32LobAppPowerShellScriptRule < MicrosoftGraphBeta::Models::Win32LobAppRule
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "operationType" => lambda {|n| @operation_type = n.get_enum_value(MicrosoftGraphBeta::Models::Win32LobAppPowerShellScriptRuleOperationType) },
                    "operator" => lambda {|n| @operator = n.get_enum_value(MicrosoftGraphBeta::Models::Win32LobAppRuleOperator) },
                    "runAsAccount" => lambda {|n| @run_as_account = n.get_enum_value(MicrosoftGraphBeta::Models::Win32LobAppPowerShellScriptRuleRunAsAccount) },
