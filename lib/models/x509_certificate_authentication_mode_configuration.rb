        ...
        class X509CertificateAuthenticationModeConfiguration
            ...
            def get_field_deserializers()
                return {
                    ...
                    "x509CertificateAuthenticationDefaultMode" => lambda {|n| @x509_certificate_authentication_default_mode = n.get_enum_value(MicrosoftGraphBeta::Models::X509CertificateAuthenticationMode) },
                    "x509CertificateDefaultRequiredAffinityLevel" => lambda {|n| @x509_certificate_default_required_affinity_level = n.get_enum_value(MicrosoftGraphBeta::Models::X509CertificateAffinityLevel) },
                }
            end
            ## 
