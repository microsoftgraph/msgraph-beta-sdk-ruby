...
module MicrosoftGraphBeta
    module Models
        class SitePage < MicrosoftGraphBeta::Models::BaseItem
            ...
            ## @param value Value to set for the canvas_layout property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the page_layout property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the promotion_kind property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the show_comments property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the show_recommended_pages property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the title_area property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the web_parts property.
            ## @return a void
            ## 
            def web_parts=(value)
                @web_parts = value
