...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdatesKnowledgeBaseArticle < MicrosoftGraphBeta::Models::Entity
            include MicrosoftKiotaAbstractions::Parsable
            ## 
            # The URL of the knowledge base article. Read-only.
            @url
            ## 
            ## Instantiates a new windowsUpdatesKnowledgeBaseArticle and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
