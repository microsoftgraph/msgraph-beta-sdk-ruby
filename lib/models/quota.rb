    ...
    class Quota
        ...
        def get_field_deserializers()
            return {
                ...
                "storagePlanInformation" => lambda {|n| @storage_plan_information = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::StoragePlanInformation.create_from_discriminator_value(pn) }) },
