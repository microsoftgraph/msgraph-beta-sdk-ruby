        ...
        class IosWebContentFilterBase
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.iosWebContentFilterAutoFilter"
                            return IosWebContentFilterAutoFilter.new
                        when "#microsoft.graph.iosWebContentFilterSpecificWebsitesAccess"
                            return IosWebContentFilterSpecificWebsitesAccess.new
                    end
                end
                return IosWebContentFilterBase.new
            end
            ## 
