...
module MicrosoftGraphBeta
    module Models
        ...
        class UserExperienceAnalyticsRemoteConnection < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a user_experience_analytics_remote_connection_cloud_pc_failure_percentage
            ## 
            ...
            ## @return a user_experience_analytics_remote_connection_cloud_pc_round_trip_time
            ## 
            ...
            ## @return a user_experience_analytics_remote_connection_cloud_pc_sign_in_time
            ## 
            ...
            ## @return a user_experience_analytics_remote_connection_core_boot_time
            ## 
            def core_boot_time
            ...
            ## @return a user_experience_analytics_remote_connection_core_sign_in_time
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "cloudPcFailurePercentage" => lambda {|n| @cloud_pc_failure_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsRemoteConnection::UserExperienceAnalyticsRemoteConnectionCloudPcFailurePercentage.create_from_discriminator_value(pn) }) },
                    "cloudPcRoundTripTime" => lambda {|n| @cloud_pc_round_trip_time = n.get_object_value(lambda {|pn| UserExperienceAnalyticsRemoteConnection::UserExperienceAnalyticsRemoteConnectionCloudPcRoundTripTime.create_from_discriminator_value(pn) }) },
                    "cloudPcSignInTime" => lambda {|n| @cloud_pc_sign_in_time = n.get_object_value(lambda {|pn| UserExperienceAnalyticsRemoteConnection::UserExperienceAnalyticsRemoteConnectionCloudPcSignInTime.create_from_discriminator_value(pn) }) },
                    "coreBootTime" => lambda {|n| @core_boot_time = n.get_object_value(lambda {|pn| UserExperienceAnalyticsRemoteConnection::UserExperienceAnalyticsRemoteConnectionCoreBootTime.create_from_discriminator_value(pn) }) },
                    "coreSignInTime" => lambda {|n| @core_sign_in_time = n.get_object_value(lambda {|pn| UserExperienceAnalyticsRemoteConnection::UserExperienceAnalyticsRemoteConnectionCoreSignInTime.create_from_discriminator_value(pn) }) },
                    "deviceCount" => lambda {|n| @device_count = n.get_number_value() },
                    "deviceId" => lambda {|n| @device_id = n.get_string_value() },
                    "deviceName" => lambda {|n| @device_name = n.get_string_value() },
                    "manufacturer" => lambda {|n| @manufacturer = n.get_string_value() },
                    "model" => lambda {|n| @model = n.get_string_value() },
                    "remoteSignInTime" => lambda {|n| @remote_sign_in_time = n.get_object_value(lambda {|pn| UserExperienceAnalyticsRemoteConnection::UserExperienceAnalyticsRemoteConnectionRemoteSignInTime.create_from_discriminator_value(pn) }) },
            ...
            ## @return a user_experience_analytics_remote_connection_remote_sign_in_time
            ## 
            ...
            class UserExperienceAnalyticsRemoteConnectionCloudPcFailurePercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsRemoteConnectionCloudPcFailurePercentage.new
                end
                ## 
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsRemoteConnectionCloudPcRoundTripTime
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsRemoteConnectionCloudPcRoundTripTime.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsRemoteConnectionCloudPcSignInTime
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsRemoteConnectionCloudPcSignInTime.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsRemoteConnectionCoreBootTime
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsRemoteConnectionCoreBootTime.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsRemoteConnectionCoreSignInTime
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsRemoteConnectionCoreSignInTime.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsRemoteConnectionRemoteSignInTime
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsRemoteConnectionRemoteSignInTime.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
