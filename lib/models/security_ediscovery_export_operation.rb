        ...
        class SecurityEdiscoveryExportOperation < MicrosoftGraphBeta::Models::SecurityCaseOperation
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "exportOptions" => lambda {|n| @export_options = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityEdiscoveryExportOperationExportOptions) },
                    "exportStructure" => lambda {|n| @export_structure = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityEdiscoveryExportOperationExportStructure) },
