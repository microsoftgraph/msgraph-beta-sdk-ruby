    ...
    module Models
        class SecurityHost < MicrosoftGraphBeta::Models::SecurityArtifact
            ...
            def get_field_deserializers()
                return super.merge({
                    "childHostPairs" => lambda {|n| @child_host_pairs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHostPair.create_from_discriminator_value(pn) }) },
                    "components" => lambda {|n| @components = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHostComponent.create_from_discriminator_value(pn) }) },
                    "cookies" => lambda {|n| @cookies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHostCookie.create_from_discriminator_value(pn) }) },
                    ...
                    "trackers" => lambda {|n| @trackers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHostTracker.create_from_discriminator_value(pn) }) },
                    "whois" => lambda {|n| @whois = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityWhoisRecord.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
