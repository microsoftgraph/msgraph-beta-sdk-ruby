        ...
        class X509CertificateIssuerHintsConfiguration
            ...
            def get_field_deserializers()
                return {
                    ...
                    "state" => lambda {|n| @state = n.get_enum_value(MicrosoftGraphBeta::Models::X509CertificateIssuerHintsConfigurationState) },
                }
            end
            ## 
            ...
            ## @return a x509_certificate_issuer_hints_configuration_state
            ## 
            def state
                return @state
            end
