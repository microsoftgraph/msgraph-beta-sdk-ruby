...
module MicrosoftGraphBeta
    module Models
        class AwsEc2Instance < MicrosoftGraphBeta::Models::AwsIdentity
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.awsEc2Instance"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a aws_ec2_instance
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "resource" => lambda {|n| @resource = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AwsAuthorizationSystemResource.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
