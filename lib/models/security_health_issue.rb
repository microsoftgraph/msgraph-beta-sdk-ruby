...
module MicrosoftGraphBeta
    module Models
        class SecurityHealthIssue < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "healthIssueType" => lambda {|n| @health_issue_type = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityHealthIssueType) },
                    ...
                    "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityHealthIssueSeverity) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityHealthIssueStatus) },
                })
            end
            ## 
