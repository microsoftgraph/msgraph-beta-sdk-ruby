...
module MicrosoftGraphBeta
    module Models
        class UserLastSignInRecommendationInsightSetting < MicrosoftGraphBeta::Models::AccessReviewRecommendationInsightSetting
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "signInScope" => lambda {|n| @sign_in_scope = n.get_enum_value(MicrosoftGraphBeta::Models::UserLastSignInRecommendationInsightSettingSignInScope) },
                })
            end
            ## 
