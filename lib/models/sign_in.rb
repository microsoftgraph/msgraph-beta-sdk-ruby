        ...
        class SignIn < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "conditionalAccessAudiences" => lambda {|n| @conditional_access_audiences = n.get_collection_of_primitive_values(String) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_primitive_values("conditionalAccessAudiences", @conditional_access_audiences)
