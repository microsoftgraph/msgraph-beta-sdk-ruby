...
module MicrosoftGraphBeta
    module Models
        class SignIn < MicrosoftGraphBeta::Models::Entity
            ...
            @is_through_global_secure_access
            ## 
            ...
            ## 
            def conditional_access_audiences
                return @conditional_access_audiences
            end
            ## 
            ...
            ## @return a void
            ## 
            def conditional_access_audiences=(value)
                @conditional_access_audiences = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "conditionalAccessAudiences" => lambda {|n| @conditional_access_audiences = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessAudience.create_from_discriminator_value(pn) }) },
                    ...
                    "globalSecureAccessIpAddress" => lambda {|n| @global_secure_access_ip_address = n.get_string_value() },
                    ...
                    "isThroughGlobalSecureAccess" => lambda {|n| @is_through_global_secure_access = n.get_boolean_value() },
                    ...
                    "resourceOwnerTenantId" => lambda {|n| @resource_owner_tenant_id = n.get_string_value() },
                    ...
                    "tokenProtectionStatusDetails" => lambda {|n| @token_protection_status_details = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TokenProtectionStatusDetails.create_from_discriminator_value(pn) }) },
            ...
            ## @return a string
            ## 
            def global_secure_access_ip_address
                return @global_secure_access_ip_address
            end
            ## 
            ...
            ## @return a void
            ## 
            def global_secure_access_ip_address=(value)
                @global_secure_access_ip_address = value
            end
            ## 
            ...
            ## @return a boolean
            ## 
            def is_through_global_secure_access
                return @is_through_global_secure_access
            end
            ## 
            ...
            ## @return a void
            ## 
            def is_through_global_secure_access=(value)
                @is_through_global_secure_access = value
            end
            ## 
            ...
            ## @return a string
            ## 
            def resource_owner_tenant_id
                return @resource_owner_tenant_id
            end
            ## 
            ...
            ## @return a void
            ## 
            def resource_owner_tenant_id=(value)
                @resource_owner_tenant_id = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("conditionalAccessAudiences", @conditional_access_audiences)
                ...
                writer.write_string_value("globalSecureAccessIpAddress", @global_secure_access_ip_address)
                ...
                writer.write_boolean_value("isThroughGlobalSecureAccess", @is_through_global_secure_access)
                ...
                writer.write_string_value("resourceOwnerTenantId", @resource_owner_tenant_id)
                ...
                writer.write_object_value("tokenProtectionStatusDetails", @token_protection_status_details)
            ...
            ## 
            def token_protection_status_details
                return @token_protection_status_details
            end
            ## 
            ...
            ## @return a void
            ## 
            def token_protection_status_details=(value)
                @token_protection_status_details = value
            end
            ## 
