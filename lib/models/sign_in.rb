...
module MicrosoftGraphBeta
    module Models
        class SignIn < MicrosoftGraphBeta::Models::Entity
            ...
            ## @return a sign_in_app_token_protection_status
            ## 
            ...
            ## @return a sign_in_authentication_protocol
            ## 
            ...
            ## @return a sign_in_client_credential_type
            ## 
            ...
            ## @return a sign_in_cross_tenant_access_type
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "appTokenProtectionStatus" => lambda {|n| @app_token_protection_status = n.get_enum_value(MicrosoftGraphBeta::Models::SignInAppTokenProtectionStatus) },
                    ...
                    "authenticationProtocol" => lambda {|n| @authentication_protocol = n.get_enum_value(MicrosoftGraphBeta::Models::SignInAuthenticationProtocol) },
                    ...
                    "clientCredentialType" => lambda {|n| @client_credential_type = n.get_enum_value(MicrosoftGraphBeta::Models::SignInClientCredentialType) },
                    "conditionalAccessStatus" => lambda {|n| @conditional_access_status = n.get_enum_value(MicrosoftGraphBeta::Models::SignInConditionalAccessStatus) },
                    "correlationId" => lambda {|n| @correlation_id = n.get_string_value() },
                    "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                    "crossTenantAccessType" => lambda {|n| @cross_tenant_access_type = n.get_enum_value(MicrosoftGraphBeta::Models::SignInCrossTenantAccessType) },
                    ...
                    "incomingTokenType" => lambda {|n| @incoming_token_type = n.get_enum_value(MicrosoftGraphBeta::Models::SignInIncomingTokenType) },
                    ...
                    "originalTransferMethod" => lambda {|n| @original_transfer_method = n.get_enum_value(MicrosoftGraphBeta::Models::SignInOriginalTransferMethod) },
                    ...
                    "riskDetail" => lambda {|n| @risk_detail = n.get_enum_value(MicrosoftGraphBeta::Models::SignInRiskDetail) },
                    "riskEventTypes_v2" => lambda {|n| @risk_event_types_v2 = n.get_collection_of_primitive_values(String) },
                    "riskLevelAggregated" => lambda {|n| @risk_level_aggregated = n.get_enum_value(MicrosoftGraphBeta::Models::SignInRiskLevelAggregated) },
                    "riskLevelDuringSignIn" => lambda {|n| @risk_level_during_sign_in = n.get_enum_value(MicrosoftGraphBeta::Models::SignInRiskLevelDuringSignIn) },
                    "riskState" => lambda {|n| @risk_state = n.get_enum_value(MicrosoftGraphBeta::Models::SignInRiskState) },
                    ...
                    "signInIdentifierType" => lambda {|n| @sign_in_identifier_type = n.get_enum_value(MicrosoftGraphBeta::Models::SignInSignInIdentifierType) },
                    "signInTokenProtectionStatus" => lambda {|n| @sign_in_token_protection_status = n.get_enum_value(MicrosoftGraphBeta::Models::SignInSignInTokenProtectionStatus) },
                    ...
                    "tokenIssuerType" => lambda {|n| @token_issuer_type = n.get_enum_value(MicrosoftGraphBeta::Models::SignInTokenIssuerType) },
            ...
            ## @return a sign_in_incoming_token_type
            ## 
            ...
            ## @return a sign_in_original_transfer_method
            ## 
            ...
            ## @return a sign_in_sign_in_identifier_type
            ## 
            ...
            ## @return a sign_in_sign_in_token_protection_status
            ## 
            ...
            ## @return a sign_in_token_issuer_type
            ## 
