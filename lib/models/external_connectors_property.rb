        ...
        class ExternalConnectorsProperty
            ...
            def get_field_deserializers()
                return {
                    ...
                    "labels" => lambda {|n| @labels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectorsPropertyLabels.create_from_discriminator_value(pn) }) },
