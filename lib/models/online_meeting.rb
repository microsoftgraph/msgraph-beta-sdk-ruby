...
module MicrosoftGraphBeta
    module Models
        class OnlineMeeting < MicrosoftGraphBeta::Models::OnlineMeetingBase
            ...
            ## @return a online_meeting_capabilities
            ## 
            def capabilities
                return @capabilities
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "capabilities" => lambda {|n| @capabilities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OnlineMeetingCapabilities.create_from_discriminator_value(pn) }) },
