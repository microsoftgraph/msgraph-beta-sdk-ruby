    ...
    module Models
        class OnlineMeeting < MicrosoftGraphBeta::Models::OnlineMeetingBase
            ...
            def get_field_deserializers()
                return super.merge({
                    "aiInsights" => lambda {|n| @ai_insights = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallAiInsight.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                super
                writer.write_collection_of_object_values("aiInsights", @ai_insights)
