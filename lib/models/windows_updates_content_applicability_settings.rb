...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdatesContentApplicabilitySettings
            ...
            ## 
            ## Instantiates a new windowsUpdatesContentApplicabilitySettings and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return WindowsUpdatesContentApplicabilitySettings.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "safeguard" => lambda {|n| @safeguard = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesSafeguardSettings.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
