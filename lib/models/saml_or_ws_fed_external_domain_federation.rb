...
module MicrosoftGraphBeta
    module Models
        class SamlOrWsFedExternalDomainFederation < MicrosoftGraphBeta::Models::SamlOrWsFedProvider
            ...
            def get_field_deserializers()
                return super.merge({
                    "domains" => lambda {|n| @domains = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalDomainName.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
