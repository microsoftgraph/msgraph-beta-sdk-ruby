...
module MicrosoftGraphBeta::Models
    ...
    class ManagedDeviceMobileAppConfiguration < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "assignments" => lambda {|n| @assignments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedDeviceMobileAppConfigurationAssignment.create_from_discriminator_value(pn) }) },
                "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                "description" => lambda {|n| @description = n.get_string_value() },
                "deviceStatusSummary" => lambda {|n| @device_status_summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedDeviceMobileAppConfigurationDeviceSummary.create_from_discriminator_value(pn) }) },
                ...
                "userStatusSummary" => lambda {|n| @user_status_summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedDeviceMobileAppConfigurationUserSummary.create_from_discriminator_value(pn) }) },
