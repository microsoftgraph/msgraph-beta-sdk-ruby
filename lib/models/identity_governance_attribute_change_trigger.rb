...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceAttributeChangeTrigger < MicrosoftGraphBeta::Models::IdentityGovernanceWorkflowExecutionTrigger
            ...
            def get_field_deserializers()
                return super.merge({
                    "triggerAttributes" => lambda {|n| @trigger_attributes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceTriggerAttribute.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
