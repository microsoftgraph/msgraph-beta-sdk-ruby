...
module MicrosoftGraphBeta
    module Models
        class GovernanceResource < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the registered_root property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the role_assignment_requests property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the role_settings property.
            ## @return a void
            ## 
