...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsAggregatedPolicyCompliance < MicrosoftGraphBeta::Models::Entity
            ...
            ## 
            ## Instantiates a new managedTenantsAggregatedPolicyCompliance and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
