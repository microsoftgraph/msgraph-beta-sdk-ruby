    ...
    module Models
        class EducationAssignmentDefaults < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "addToCalendarAction" => lambda {|n| @add_to_calendar_action = n.get_enum_value(MicrosoftGraphBeta::Models::EducationAssignmentDefaultsAddToCalendarAction) },
                    "addedStudentAction" => lambda {|n| @added_student_action = n.get_enum_value(MicrosoftGraphBeta::Models::EducationAssignmentDefaultsAddedStudentAction) },
