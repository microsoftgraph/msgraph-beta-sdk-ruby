...
module MicrosoftGraphBeta
    module Models
        class WorkbookChartGridlinesFormat < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "line" => lambda {|n| @line = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartLineFormat.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
