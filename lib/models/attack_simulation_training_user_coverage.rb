...
module MicrosoftGraphBeta::Models
    class AttackSimulationTrainingUserCoverage
        ...
        def get_field_deserializers()
            return {
                "attackSimulationUser" => lambda {|n| @attack_simulation_user = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AttackSimulationUser.create_from_discriminator_value(pn) }) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "userTrainings" => lambda {|n| @user_trainings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserTrainingStatusInfo.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
