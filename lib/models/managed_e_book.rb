...
module MicrosoftGraphBeta
    module Models
        ...
        class ManagedEBook < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "assignments" => lambda {|n| @assignments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedEBookAssignment.create_from_discriminator_value(pn) }) },
                    "categories" => lambda {|n| @categories = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedEBookCategory.create_from_discriminator_value(pn) }) },
                    ...
                    "installSummary" => lambda {|n| @install_summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EBookInstallSummary.create_from_discriminator_value(pn) }) },
                    "largeCover" => lambda {|n| @large_cover = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MimeContent.create_from_discriminator_value(pn) }) },
                    ...
                    "userStateSummary" => lambda {|n| @user_state_summary = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserInstallStateSummary.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
