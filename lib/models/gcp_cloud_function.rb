...
module MicrosoftGraphBeta
    module Models
        class GcpCloudFunction < MicrosoftGraphBeta::Models::GcpIdentity
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.gcpCloudFunction"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a gcp_cloud_function
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "resource" => lambda {|n| @resource = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::GcpAuthorizationSystemResource.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
