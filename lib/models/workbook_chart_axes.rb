...
module MicrosoftGraphBeta::Models
    class WorkbookChartAxes < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "categoryAxis" => lambda {|n| @category_axis = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartAxis.create_from_discriminator_value(pn) }) },
                "seriesAxis" => lambda {|n| @series_axis = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartAxis.create_from_discriminator_value(pn) }) },
                "valueAxis" => lambda {|n| @value_axis = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartAxis.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
