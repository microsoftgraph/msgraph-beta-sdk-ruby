...
module MicrosoftGraphBeta
    module Models
        class EducationSynchronizationConnectionSettings
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.educationSynchronizationOAuth1ConnectionSettings"
                            return EducationSynchronizationOAuth1ConnectionSettings.new
                        when "#microsoft.graph.educationSynchronizationOAuth2ClientCredentialsConnectionSettings"
                            return EducationSynchronizationOAuth2ClientCredentialsConnectionSettings.new
                    end
                end
                return EducationSynchronizationConnectionSettings.new
            end
            ## 
