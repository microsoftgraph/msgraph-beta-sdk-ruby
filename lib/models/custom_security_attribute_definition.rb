...
module MicrosoftGraphBeta::Models
    class CustomSecurityAttributeDefinition < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "allowedValues" => lambda {|n| @allowed_values = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AllowedValue.create_from_discriminator_value(pn) }) },
