...
module MicrosoftGraphBeta
    module Models
        ...
        class AuditEvent < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "actor" => lambda {|n| @actor = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AuditActor.create_from_discriminator_value(pn) }) },
                    ...
                    "resources" => lambda {|n| @resources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuditResource.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
