    ...
    module Models
        class WorkingHours
            ...
            def get_field_deserializers()
                return {
                    "daysOfWeek" => lambda {|n| @days_of_week = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkingHoursDaysOfWeek.create_from_discriminator_value(pn) }) },
                    "endTime" => lambda {|n| @end_time = n.get_time_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "startTime" => lambda {|n| @start_time = n.get_time_value() },
                    "timeZone" => lambda {|n| @time_zone = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TimeZoneBase.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
