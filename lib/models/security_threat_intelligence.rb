    ...
    module Models
        class SecurityThreatIntelligence < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "articleIndicators" => lambda {|n| @article_indicators = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityArticleIndicator.create_from_discriminator_value(pn) }) },
                    "articles" => lambda {|n| @articles = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityArticle.create_from_discriminator_value(pn) }) },
                    "hostComponents" => lambda {|n| @host_components = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHostComponent.create_from_discriminator_value(pn) }) },
                    "hostCookies" => lambda {|n| @host_cookies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHostCookie.create_from_discriminator_value(pn) }) },
                    "hostPairs" => lambda {|n| @host_pairs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHostPair.create_from_discriminator_value(pn) }) },
                    "hostPorts" => lambda {|n| @host_ports = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHostPort.create_from_discriminator_value(pn) }) },
                    "hostSslCertificates" => lambda {|n| @host_ssl_certificates = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHostSslCertificate.create_from_discriminator_value(pn) }) },
                    "hostTrackers" => lambda {|n| @host_trackers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHostTracker.create_from_discriminator_value(pn) }) },
                    "hosts" => lambda {|n| @hosts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityHost.create_from_discriminator_value(pn) }) },
                    "intelProfiles" => lambda {|n| @intel_profiles = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIntelligenceProfile.create_from_discriminator_value(pn) }) },
                    "intelligenceProfileIndicators" => lambda {|n| @intelligence_profile_indicators = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityIntelligenceProfileIndicator.create_from_discriminator_value(pn) }) },
                    "passiveDnsRecords" => lambda {|n| @passive_dns_records = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityPassiveDnsRecord.create_from_discriminator_value(pn) }) },
