...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceTaskDefinition < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "parameters" => lambda {|n| @parameters = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceParameter.create_from_discriminator_value(pn) }) },
