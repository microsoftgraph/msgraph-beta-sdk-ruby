...
module MicrosoftGraphBeta
    module Models
        class EducationUser < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "assignments" => lambda {|n| @assignments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EducationAssignment.create_from_discriminator_value(pn) }) },
                    ...
                    "externalSource" => lambda {|n| @external_source = n.get_enum_value(MicrosoftGraphBeta::Models::EducationUserExternalSource) },
                    ...
                    "mailingAddress" => lambda {|n| @mailing_address = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PhysicalAddress.create_from_discriminator_value(pn) }) },
                    ...
                    "onPremisesInfo" => lambda {|n| @on_premises_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationOnPremisesInfo.create_from_discriminator_value(pn) }) },
                    ...
                    "primaryRole" => lambda {|n| @primary_role = n.get_enum_value(MicrosoftGraphBeta::Models::EducationUserRole) },
                    ...
                    "relatedContacts" => lambda {|n| @related_contacts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RelatedContact.create_from_discriminator_value(pn) }) },
                    "residenceAddress" => lambda {|n| @residence_address = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PhysicalAddress.create_from_discriminator_value(pn) }) },
                    "rubrics" => lambda {|n| @rubrics = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EducationRubric.create_from_discriminator_value(pn) }) },
                    ...
                    "student" => lambda {|n| @student = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationStudent.create_from_discriminator_value(pn) }) },
                    "surname" => lambda {|n| @surname = n.get_string_value() },
                    "taughtClasses" => lambda {|n| @taught_classes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EducationClass.create_from_discriminator_value(pn) }) },
                    "teacher" => lambda {|n| @teacher = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationTeacher.create_from_discriminator_value(pn) }) },
                    "usageLocation" => lambda {|n| @usage_location = n.get_string_value() },
                    "user" => lambda {|n| @user = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::User.create_from_discriminator_value(pn) }) },
