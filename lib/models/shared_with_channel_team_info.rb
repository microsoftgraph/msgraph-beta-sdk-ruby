...
module MicrosoftGraphBeta
    module Models
        class SharedWithChannelTeamInfo < MicrosoftGraphBeta::Models::TeamInfo
            ...
            def get_field_deserializers()
                return super.merge({
                    "allowedMembers" => lambda {|n| @allowed_members = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ConversationMember.create_from_discriminator_value(pn) }) },
