...
module MicrosoftGraphBeta
    module Models
        class OneDriveForBusinessRestoreSession < MicrosoftGraphBeta::Models::RestoreSessionBase
            ...
            def get_field_deserializers()
                return super.merge({
                    "driveRestoreArtifacts" => lambda {|n| @drive_restore_artifacts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveRestoreArtifact.create_from_discriminator_value(pn) }) },
                    "driveRestoreArtifactsBulkAdditionRequests" => lambda {|n| @drive_restore_artifacts_bulk_addition_requests = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DriveRestoreArtifactsBulkAdditionRequest.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
