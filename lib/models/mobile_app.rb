...
module MicrosoftGraphBeta
    module Models
        ...
        class MobileApp < MicrosoftGraphBeta::Models::Entity
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        ...
                        when "#microsoft.graph.macOSMdatpApp"
                            return MacOSMdatpApp.new
            ...
            ## @param value Value to set for the dependent_app_count property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "installSummary" => lambda {|n| @install_summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MobileAppInstallSummary.create_from_discriminator_value(pn) }) },
                    ...
                    "userStatuses" => lambda {|n| @user_statuses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserAppInstallStatus.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## @param value Value to set for the superseded_app_count property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the superseding_app_count property.
            ## @return a void
            ## 
