        ...
        class VirtualEventSession < MicrosoftGraphBeta::Models::OnlineMeetingBase
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "videoOnDemandWebUrl" => lambda {|n| @video_on_demand_web_url = n.get_string_value() },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("videoOnDemandWebUrl", @video_on_demand_web_url)
            end
            ## 
            ...
            ## @return a string
            ## 
            def video_on_demand_web_url
                return @video_on_demand_web_url
            end
            ## 
            ...
            ## @return a void
            ## 
            def video_on_demand_web_url=(value)
                @video_on_demand_web_url = value
            end
        end
    end
end
