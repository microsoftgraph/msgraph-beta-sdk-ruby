        ...
        class AuditResource
            ...
            def get_field_deserializers()
                return {
                    ...
                    "modifiedProperties" => lambda {|n| @modified_properties = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuditProperty.create_from_discriminator_value(pn) }) },
