...
module MicrosoftGraphBeta
    module Models
        class AccessReviewScheduleDefinition < MicrosoftGraphBeta::Models::Entity
            ...
            def backup_reviewers
                return @backup_reviewers
            end
            ## 
            ## Sets the backupReviewers property value. The backupReviewers property
            ## @param value Value to set for the backup_reviewers property.
            ## @return a void
            ## 
            def backup_reviewers=(value)
                @backup_reviewers = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "additionalNotificationRecipients" => lambda {|n| @additional_notification_recipients = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewNotificationRecipientItem.create_from_discriminator_value(pn) }) },
                    "backupReviewers" => lambda {|n| @backup_reviewers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewReviewerScope.create_from_discriminator_value(pn) }) },
                    ...
                    "instanceEnumerationScope" => lambda {|n| @instance_enumeration_scope = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewScope.create_from_discriminator_value(pn) }) },
                    "instances" => lambda {|n| @instances = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewInstance.create_from_discriminator_value(pn) }) },
                    ...
                    "scope" => lambda {|n| @scope = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewScope.create_from_discriminator_value(pn) }) },
                    ...
                    "stageSettings" => lambda {|n| @stage_settings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewStageSettings.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("backupReviewers", @backup_reviewers)
