            ...
            class Settings < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "idleSessionSignOut" => lambda {|n| @idle_session_sign_out = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TenantAdmin::IdleSessionSignOut.create_from_discriminator_value(pn) }) },
                        "imageTaggingOption" => lambda {|n| @image_tagging_option = n.get_enum_value(MicrosoftGraphBeta::Models::TenantAdmin::ImageTaggingChoice) },
                        ...
                        "sharingCapability" => lambda {|n| @sharing_capability = n.get_enum_value(MicrosoftGraphBeta::Models::TenantAdmin::SharingCapabilities) },
                        "sharingDomainRestrictionMode" => lambda {|n| @sharing_domain_restriction_mode = n.get_enum_value(MicrosoftGraphBeta::Models::TenantAdmin::SharingDomainRestrictionMode) },
