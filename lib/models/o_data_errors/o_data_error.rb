...
module MicrosoftGraphBeta::Models::ODataErrors
    class ODataError < MicrosoftKiotaAbstractions::ApiError
        ...
        def get_field_deserializers()
            return super.merge({
                "error" => lambda {|n| @error = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::MainError.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
