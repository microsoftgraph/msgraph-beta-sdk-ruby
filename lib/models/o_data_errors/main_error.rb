            ...
            class MainError
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "details" => lambda {|n| @details = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ErrorDetails.create_from_discriminator_value(pn) }) },
                        "innerError" => lambda {|n| @inner_error = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::InnerError.create_from_discriminator_value(pn) }) },
