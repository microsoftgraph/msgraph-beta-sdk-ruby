...
module MicrosoftGraphBeta
    module Models
        class MembershipOutlierInsight < MicrosoftGraphBeta::Models::GovernanceInsight
            ...
            def get_field_deserializers()
                return super.merge({
                    "container" => lambda {|n| @container = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
                    ...
                    "member" => lambda {|n| @member = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
                    "memberId" => lambda {|n| @member_id = n.get_string_value() },
                    "outlierContainerType" => lambda {|n| @outlier_container_type = n.get_enum_value(MicrosoftGraphBeta::Models::OutlierContainerType) },
                    "outlierMemberType" => lambda {|n| @outlier_member_type = n.get_enum_value(MicrosoftGraphBeta::Models::OutlierMemberType) },
                })
            end
            ## 
