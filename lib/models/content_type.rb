        ...
        class ContentType < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "base" => lambda {|n| @base = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ContentType.create_from_discriminator_value(pn) }) },
                    "baseTypes" => lambda {|n| @base_types = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ContentType.create_from_discriminator_value(pn) }) },
                    "columnLinks" => lambda {|n| @column_links = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ColumnLink.create_from_discriminator_value(pn) }) },
                    "columnPositions" => lambda {|n| @column_positions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ColumnDefinition.create_from_discriminator_value(pn) }) },
                    ...
                    "documentSet" => lambda {|n| @document_set = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DocumentSet.create_from_discriminator_value(pn) }) },
                    "documentTemplate" => lambda {|n| @document_template = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DocumentSetContent.create_from_discriminator_value(pn) }) },
                    ...
                    "order" => lambda {|n| @order = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ContentTypeOrder.create_from_discriminator_value(pn) }) },
