...
module MicrosoftGraphBeta
    module Models
        class SecurityAddContentFooterAction < MicrosoftGraphBeta::Models::SecurityInformationProtectionAction
            ...
            ## @return a security_content_alignment
            ## 
            def alignment
                return @alignment
            end
            ...
            ## 
            ## Instantiates a new SecurityAddContentFooterAction and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            ## @return a security_add_content_footer_action
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "alignment" => lambda {|n| @alignment = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityContentAlignment) },
