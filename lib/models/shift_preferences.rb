...
module MicrosoftGraphBeta
    module Models
        class ShiftPreferences < MicrosoftGraphBeta::Models::ChangeTrackedEntity
            ...
            def get_field_deserializers()
                return super.merge({
                    "availability" => lambda {|n| @availability = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ShiftAvailability.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
