...
module MicrosoftGraphBeta
    module Models
        class MacOsVppApp < MicrosoftGraphBeta::Models::MobileApp
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "assignedLicenses" => lambda {|n| @assigned_licenses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MacOsVppAppAssignedLicense.create_from_discriminator_value(pn) }) },
                    ...
                    "revokeLicenseActionResults" => lambda {|n| @revoke_license_action_results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MacOsVppAppRevokeLicensesActionResult.create_from_discriminator_value(pn) }) },
            ...
            ## @return a mac_os_vpp_app_revoke_licenses_action_result
            ## 
