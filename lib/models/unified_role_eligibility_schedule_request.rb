...
module MicrosoftGraphBeta::Models
    class UnifiedRoleEligibilityScheduleRequest < MicrosoftGraphBeta::Models::Request
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "targetSchedule" => lambda {|n| @target_schedule = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleEligibilitySchedule.create_from_discriminator_value(pn) }) },
