        ...
        class ProvisioningStep
            ...
            def get_field_deserializers()
                return {
                    ...
                    "details" => lambda {|n| @details = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DetailsInfo.create_from_discriminator_value(pn) }) },
                    "name" => lambda {|n| @name = n.get_string_value() },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "provisioningStepType" => lambda {|n| @provisioning_step_type = n.get_enum_value(MicrosoftGraphBeta::Models::ProvisioningStepProvisioningStepType) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ProvisioningStepStatus) },
                }
            end
            ## 
