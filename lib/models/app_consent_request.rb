...
module MicrosoftGraphBeta::Models
    class AppConsentRequest < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "pendingScopes" => lambda {|n| @pending_scopes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AppConsentRequestScope.create_from_discriminator_value(pn) }) },
                "userConsentRequests" => lambda {|n| @user_consent_requests = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserConsentRequest.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
