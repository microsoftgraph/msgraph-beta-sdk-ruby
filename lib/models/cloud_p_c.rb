...
module MicrosoftGraphBeta
    module Models
        class CloudPC < MicrosoftGraphBeta::Models::Entity
            ...
            @frontline_cloud_pc_availability
            ## 
            ...
            ## @return a frontline_cloud_pc_availability
            ## 
            def frontline_cloud_pc_availability
                return @frontline_cloud_pc_availability
            end
            ## 
            ...
            ## @return a void
            ## 
            def frontline_cloud_pc_availability=(value)
                @frontline_cloud_pc_availability = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "frontlineCloudPcAvailability" => lambda {|n| @frontline_cloud_pc_availability = n.get_enum_value(MicrosoftGraphBeta::Models::FrontlineCloudPcAvailability) },
                    ...
                    "productType" => lambda {|n| @product_type = n.get_enum_value(MicrosoftGraphBeta::Models::CloudPcProductType) },
            ...
            ## @return a cloud_pc_product_type
            ## 
            def product_type
                return @product_type
            end
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("frontlineCloudPcAvailability", @frontline_cloud_pc_availability)
                ...
                writer.write_enum_value("productType", @product_type)
