        ...
        class UserSimulationDetails
            ...
            def get_field_deserializers()
                return {
                    ...
                    "latestSimulationActivity" => lambda {|n| @latest_simulation_activity = n.get_string_value() },
            ...
            ## @return a string
            ## 
            def latest_simulation_activity
                return @latest_simulation_activity
            end
            ## 
            ## Sets the latestSimulationActivity property value. Indicates latest user activity.
            ## @param value Value to set for the latest_simulation_activity property.
            ## @return a void
            ## 
            def latest_simulation_activity=(value)
                @latest_simulation_activity = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("latestSimulationActivity", @latest_simulation_activity)
