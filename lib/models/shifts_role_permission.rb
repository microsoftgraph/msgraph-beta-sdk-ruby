...
module MicrosoftGraphBeta
    module Models
        class ShiftsRolePermission
            ...
            ## 
            ## Gets the allowedResourceActions property value. The allowedResourceActions property
            ## @return a string
            ## 
            ...
            ## 
            ## Sets the allowedResourceActions property value. The allowedResourceActions property
            ...
            ## 
            ## Instantiates a new ShiftsRolePermission and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ShiftsRolePermission.new
            end
            ## 
