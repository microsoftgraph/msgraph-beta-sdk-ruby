...
module MicrosoftGraphBeta::Models
    class CredentialUserRegistrationDetails < MicrosoftGraphBeta::Models::Entity
        ...
        ## @param value Value to set for the auth_methods property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the is_capable property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the is_registered property.
        ## @return a void
        ## 
