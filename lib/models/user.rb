...
module MicrosoftGraphBeta
    module Models
        class User < MicrosoftGraphBeta::Models::DirectoryObject
            ...
            ## @return a void
            ## 
            def cloud_licensing=(value)
                @cloud_licensing = value
            end
            ## 
            ...
            ## @return a void
            ## 
            def cloud_realtime_communication_info=(value)
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "cloudClipboard" => lambda {|n| @cloud_clipboard = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CloudClipboardRoot.create_from_discriminator_value(pn) }) },
                    "cloudLicensing" => lambda {|n| @cloud_licensing = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CloudLicensingUserCloudLicensing.create_from_discriminator_value(pn) }) },
                    ...
                    "cloudRealtimeCommunicationInfo" => lambda {|n| @cloud_realtime_communication_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CloudRealtimeCommunicationInfo.create_from_discriminator_value(pn) }) },
                    ...
                    "employeeExperience" => lambda {|n| @employee_experience = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EmployeeExperienceUser.create_from_discriminator_value(pn) }) },
                    ...
                    "invitedBy" => lambda {|n| @invited_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
                    "isLicenseReconciliationNeeded" => lambda {|n| @is_license_reconciliation_needed = n.get_boolean_value() },
                    ...
                    "onPremisesSipInfo" => lambda {|n| @on_premises_sip_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnPremisesSipInfo.create_from_discriminator_value(pn) }) },
                    ...
                    "security" => lambda {|n| @security = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecuritySecurity.create_from_discriminator_value(pn) }) },
                    ...
                    "solutions" => lambda {|n| @solutions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserSolutionRoot.create_from_discriminator_value(pn) }) },
                    "sponsors" => lambda {|n| @sponsors = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
            ...
            ## @return a boolean
            ## 
            def is_license_reconciliation_needed
                return @is_license_reconciliation_needed
            end
            ## 
            ...
            ## @return a void
            ## 
            def is_license_reconciliation_needed=(value)
            ...
            ## @return a void
            ## 
            def on_premises_sip_info=(value)
            ...
            def serialize(writer)
                ...
                writer.write_object_value("cloudLicensing", @cloud_licensing)
                writer.write_collection_of_object_values("cloudPCs", @cloud_p_cs)
                writer.write_object_value("cloudRealtimeCommunicationInfo", @cloud_realtime_communication_info)
                ...
                writer.write_boolean_value("isLicenseReconciliationNeeded", @is_license_reconciliation_needed)
                ...
                writer.write_object_value("onPremisesSipInfo", @on_premises_sip_info)
