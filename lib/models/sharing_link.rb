...
module MicrosoftGraphBeta::Models
    class SharingLink
        ...
        ## @return a string
        ## 
        def configurator_url
            return @configurator_url
        end
        ## 
        ## Sets the configuratorUrl property value. The configuratorUrl property
        ## @param value Value to set for the configurator_url property.
        ## @return a void
        ## 
        def configurator_url=(value)
            @configurator_url = value
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                "application" => lambda {|n| @application = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
                "configuratorUrl" => lambda {|n| @configurator_url = n.get_string_value() },
        ...
        def serialize(writer)
            ...
            writer.write_string_value("configuratorUrl", @configurator_url)
