...
module MicrosoftGraphBeta
    module Models
        class IndustryDataIndustryDataRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "sourceSystems" => lambda {|n| @source_systems = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataSourceSystemDefinition.create_from_discriminator_value(pn) }) },
                    "years" => lambda {|n| @years = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataYearTimePeriodDefinition.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## @return a industry_data_inbound_flow
            ## 
            def inbound_flows
