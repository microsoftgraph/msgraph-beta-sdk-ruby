...
module MicrosoftGraphBeta
    module Models
        class CloudClipboardRoot < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "items" => lambda {|n| @items = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CloudClipboardItem.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
