        ...
        class BucketAggregationDefinition
            ...
            def get_field_deserializers()
                return {
                    ...
                    "ranges" => lambda {|n| @ranges = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BucketAggregationRange.create_from_discriminator_value(pn) }) },
                    "sortBy" => lambda {|n| @sort_by = n.get_enum_value(MicrosoftGraphBeta::Models::BucketAggregationSortProperty) },
                }
            end
            ## 
