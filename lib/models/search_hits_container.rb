    ...
    module Models
        class SearchHitsContainer
            ...
            def get_field_deserializers()
                return {
                    "aggregations" => lambda {|n| @aggregations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SearchAggregation.create_from_discriminator_value(pn) }) },
                    "hits" => lambda {|n| @hits = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SearchHit.create_from_discriminator_value(pn) }) },
