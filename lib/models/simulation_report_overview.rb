        ...
        class SimulationReportOverview
            ...
            def get_field_deserializers()
                return {
                    ...
                    "recommendedActions" => lambda {|n| @recommended_actions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RecommendedAction.create_from_discriminator_value(pn) }) },
                    "resolvedTargetsCount" => lambda {|n| @resolved_targets_count = n.get_number_value() },
                    "simulationEventsContent" => lambda {|n| @simulation_events_content = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SimulationEventsContent.create_from_discriminator_value(pn) }) },
                    "trainingEventsContent" => lambda {|n| @training_events_content = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TrainingEventsContent.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
