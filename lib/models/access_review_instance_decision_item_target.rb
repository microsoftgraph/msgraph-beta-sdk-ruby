...
module MicrosoftGraphBeta
    module Models
        class AccessReviewInstanceDecisionItemTarget
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.accessReviewInstanceDecisionItemServicePrincipalTarget"
                            return AccessReviewInstanceDecisionItemServicePrincipalTarget.new
                        when "#microsoft.graph.accessReviewInstanceDecisionItemUserTarget"
                            return AccessReviewInstanceDecisionItemUserTarget.new
                    end
                end
                return AccessReviewInstanceDecisionItemTarget.new
            end
            ## 
