...
module MicrosoftGraphBeta::Models
    class AccessReviewInstanceDecisionItemAzureRoleResource < MicrosoftGraphBeta::Models::AccessReviewInstanceDecisionItemResource
        ...
        def get_field_deserializers()
            return super.merge({
                "scope" => lambda {|n| @scope = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewInstanceDecisionItemResource.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
