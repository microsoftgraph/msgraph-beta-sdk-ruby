        ...
        class Models.partner.securityPartnerSecurity < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "securityScore" => lambda {|n| @security_score = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Models.partner.securityPartnerSecurityScore.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("securityScore", @security_score)
            end
        end
    end
end
