...
module MicrosoftGraphBeta
    module Models
        ...
        class RemoteAssistancePartner < MicrosoftGraphBeta::Models::Entity
            ...
            @onboarding_request_expiry_date_time
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "onboardingRequestExpiryDateTime" => lambda {|n| @onboarding_request_expiry_date_time = n.get_date_time_value() },
                    "onboardingStatus" => lambda {|n| @onboarding_status = n.get_enum_value(MicrosoftGraphBeta::Models::RemoteAssistanceOnboardingStatus) },
            ...
            ## @return a date_time
            ## 
            def onboarding_request_expiry_date_time
                return @onboarding_request_expiry_date_time
            end
            ## 
            ...
            ## @param value Value to set for the onboarding_request_expiry_date_time property.
            ## @return a void
            ## 
            def onboarding_request_expiry_date_time=(value)
                @onboarding_request_expiry_date_time = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_date_time_value("onboardingRequestExpiryDateTime", @onboarding_request_expiry_date_time)
