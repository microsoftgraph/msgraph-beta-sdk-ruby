...
require_relative '../industry_data/industry_data_root'
        ...
        module ExternalConnectors
            class External
                ...
                def get_field_deserializers()
                    return {
                        "connections" => lambda {|n| @connections = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::ExternalConnection.create_from_discriminator_value(pn) }) },
                        "industryData" => lambda {|n| @industry_data = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryData::IndustryDataRoot.create_from_discriminator_value(pn) }) },
                ...
                ## @param value Value to set for the industry_data property.
                ## @return a void
                ## 
