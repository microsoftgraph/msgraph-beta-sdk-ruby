...
module MicrosoftGraphBeta::Models::ExternalConnectors
    class Acl
        ...
        def get_field_deserializers()
            return {
                "accessType" => lambda {|n| @access_type = n.get_enum_value(MicrosoftGraphBeta::Models::ExternalConnectors::AccessType) },
                "identitySource" => lambda {|n| @identity_source = n.get_enum_value(MicrosoftGraphBeta::Models::ExternalConnectors::IdentitySourceType) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::ExternalConnectors::AclType) },
        ...
        ## @param value Value to set for the identity_source property.
        ## @return a void
        ## 
