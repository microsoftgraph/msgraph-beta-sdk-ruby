...
module MicrosoftGraphBeta::Models::ExternalConnectors
    class ItemIdResolver < MicrosoftGraphBeta::Models::ExternalConnectors::UrlToItemResolverBase
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "urlMatchInfo" => lambda {|n| @url_match_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::UrlMatchInfo.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
