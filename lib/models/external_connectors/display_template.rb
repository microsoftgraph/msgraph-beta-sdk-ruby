            ...
            class DisplayTemplate
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "layout" => lambda {|n| @layout = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                        "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                        "priority" => lambda {|n| @priority = n.get_number_value() },
                        "rules" => lambda {|n| @rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::PropertyRule.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
