    ...
    class SearchSettings
        ...
        def get_field_deserializers()
            return {
                ...
                "searchResultTemplates" => lambda {|n| @search_result_templates = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::DisplayTemplate.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
