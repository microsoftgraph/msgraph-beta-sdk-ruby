            ...
            class PropertyRule
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "operation" => lambda {|n| @operation = n.get_enum_value(MicrosoftGraphBeta::Models::ExternalConnectors::RuleOperation) },
                        "property" => lambda {|n| @property = n.get_string_value() },
                        "values" => lambda {|n| @values = n.get_collection_of_primitive_values(String) },
                        "valuesJoinedBy" => lambda {|n| @values_joined_by = n.get_enum_value(MicrosoftGraphBeta::Models::BinaryOperator) },
                    }
                end
                ## 
