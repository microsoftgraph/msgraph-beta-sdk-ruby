            ...
            class Property
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "rankingHint" => lambda {|n| @ranking_hint = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::RankingHint.create_from_discriminator_value(pn) }) },
                ...
                ## @param value Value to set for the is_exact_match_required property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the ranking_hint property.
                ## @return a void
                ## 
