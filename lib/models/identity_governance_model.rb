    ...
    module Models
        class IdentityGovernanceModel
            ...
            def get_field_deserializers()
                return {
                    "accessReviews" => lambda {|n| @access_reviews = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewSet.create_from_discriminator_value(pn) }) },
                    "appConsent" => lambda {|n| @app_consent = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AppConsentApprovalRoute.create_from_discriminator_value(pn) }) },
                    ...
                    "lifecycleWorkflows" => lambda {|n| @lifecycle_workflows = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::LifecycleWorkflowsContainer.create_from_discriminator_value(pn) }) },
            ...
            ## @param value Value to set for the privileged_access property.
            ## @return a void
            ## 
            ...
            def role_management_alerts
                return @role_management_alerts
            end
            ## 
            ## Sets the roleManagementAlerts property value. The roleManagementAlerts property
            ## @param value Value to set for the role_management_alerts property.
            ## @return a void
            ## 
            def role_management_alerts=(value)
                @role_management_alerts = value
            end
            ## 
