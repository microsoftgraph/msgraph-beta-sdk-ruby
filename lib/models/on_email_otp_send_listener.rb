...
module MicrosoftGraphBeta
    module Models
        class OnEmailOtpSendListener < MicrosoftGraphBeta::Models::AuthenticationEventListener
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.onEmailOtpSendListener"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a on_email_otp_send_listener
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return OnEmailOtpSendListener.new
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "handler" => lambda {|n| @handler = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnOtpSendHandler.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
