...
module MicrosoftGraphBeta::Models
    class AndroidForWorkVpnConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
        ...
        ## @return a android_for_work_vpn_connection_type
        ## 
        def connection_type
        ...
        ## @return a android_for_work_vpn_configuration
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "connectionType" => lambda {|n| @connection_type = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidForWorkVpnConnectionType) },
                ...
                "identityCertificate" => lambda {|n| @identity_certificate = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AndroidForWorkCertificateProfileBase.create_from_discriminator_value(pn) }) },
