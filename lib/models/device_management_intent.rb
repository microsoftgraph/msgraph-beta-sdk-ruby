...
module MicrosoftGraphBeta
    module Models
        ...
        class DeviceManagementIntent < MicrosoftGraphBeta::Models::Entity
            ...
            @is_migrating_to_configuration_policy
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "isMigratingToConfigurationPolicy" => lambda {|n| @is_migrating_to_configuration_policy = n.get_boolean_value() },
            ...
            ## @return a boolean
            ## 
            def is_migrating_to_configuration_policy
                return @is_migrating_to_configuration_policy
            end
            ## 
            ...
            ## @param value Value to set for the is_migrating_to_configuration_policy property.
            ## @return a void
            ## 
            def is_migrating_to_configuration_policy=(value)
                @is_migrating_to_configuration_policy = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("isMigratingToConfigurationPolicy", @is_migrating_to_configuration_policy)
