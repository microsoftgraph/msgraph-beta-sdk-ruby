...
module MicrosoftGraphBeta
    module Models
        class SecurityProcessEvidence < MicrosoftGraphBeta::Models::SecurityAlertEvidence
            ...
            def get_field_deserializers()
                return super.merge({
                    "detectionStatus" => lambda {|n| @detection_status = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityProcessEvidenceDetectionStatus) },
                    "imageFile" => lambda {|n| @image_file = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityFileDetails.create_from_discriminator_value(pn) }) },
                    ...
                    "parentProcessImageFile" => lambda {|n| @parent_process_image_file = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityFileDetails.create_from_discriminator_value(pn) }) },
