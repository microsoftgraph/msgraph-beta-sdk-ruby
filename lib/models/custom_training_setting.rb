    ...
    module Models
        class CustomTrainingSetting < MicrosoftGraphBeta::Models::TrainingSetting
            ...
            def get_field_deserializers()
                return super.merge({
                    "assignedTo" => lambda {|n| @assigned_to = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CustomTrainingSettingAssignedTo.create_from_discriminator_value(pn) }) },
