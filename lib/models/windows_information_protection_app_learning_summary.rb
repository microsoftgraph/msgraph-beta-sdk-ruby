...
module MicrosoftGraphBeta
    module Models
        ...
        class WindowsInformationProtectionAppLearningSummary < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "applicationType" => lambda {|n| @application_type = n.get_enum_value(MicrosoftGraphBeta::Models::ApplicationType) },
