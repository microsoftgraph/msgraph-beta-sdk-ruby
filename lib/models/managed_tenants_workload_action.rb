...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsWorkloadAction
            ...
            ## @return a managed_tenants_workload_action_category
            ## 
            def category
                return @category
            end
            ...
            ## 
            ## Instantiates a new ManagedTenantsWorkloadAction and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ManagedTenantsWorkloadAction.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "category" => lambda {|n| @category = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenantsWorkloadActionCategory) },
                    ...
                    "settings" => lambda {|n| @settings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsSetting.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            ## @return a managed_tenants_setting
            ## 
            def settings
                return @settings
            end
