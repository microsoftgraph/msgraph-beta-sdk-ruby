        ...
        class RelatedPerson
            ...
            def get_field_deserializers()
                return {
                    ...
                    "relationship" => lambda {|n| @relationship = n.get_enum_value(MicrosoftGraphBeta::Models::RelatedPersonRelationship) },
            ...
            ## @return a related_person_relationship
            ## 
            def relationship
                return @relationship
            end
