...
module MicrosoftGraphBeta
    module Models
        ...
        class UserInstallStateSummary < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "deviceStates" => lambda {|n| @device_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceInstallState.create_from_discriminator_value(pn) }) },
