...
module MicrosoftGraphBeta
    module Models
        class Synchronization < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "jobs" => lambda {|n| @jobs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationJob.create_from_discriminator_value(pn) }) },
                    "secrets" => lambda {|n| @secrets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationSecretKeyStringValuePair.create_from_discriminator_value(pn) }) },
                    "templates" => lambda {|n| @templates = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationTemplate.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
