...
module MicrosoftGraphBeta
    module Models
        class SharePointRestoreSession < MicrosoftGraphBeta::Models::RestoreSessionBase
            ...
            def get_field_deserializers()
                return super.merge({
                    "siteRestoreArtifacts" => lambda {|n| @site_restore_artifacts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SiteRestoreArtifact.create_from_discriminator_value(pn) }) },
                    "siteRestoreArtifactsBulkAdditionRequests" => lambda {|n| @site_restore_artifacts_bulk_addition_requests = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SiteRestoreArtifactsBulkAdditionRequest.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
