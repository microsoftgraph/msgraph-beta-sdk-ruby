...
module MicrosoftGraphBeta
    module Models
        class EmailFileAssessmentRequest < MicrosoftGraphBeta::Models::ThreatAssessmentRequest
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "destinationRoutingReason" => lambda {|n| @destination_routing_reason = n.get_enum_value(MicrosoftGraphBeta::Models::EmailFileAssessmentRequestDestinationRoutingReason) },
