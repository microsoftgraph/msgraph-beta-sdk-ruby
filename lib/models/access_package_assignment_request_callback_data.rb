...
module MicrosoftGraphBeta
    module Models
        class AccessPackageAssignmentRequestCallbackData < MicrosoftGraphBeta::Models::CustomExtensionData
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "stage" => lambda {|n| @stage = n.get_enum_value(MicrosoftGraphBeta::Models::AccessPackageAssignmentRequestCallbackDataStage) },
