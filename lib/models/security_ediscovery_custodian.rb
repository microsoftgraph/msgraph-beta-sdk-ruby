...
module MicrosoftGraphBeta
    module Models
        class SecurityEdiscoveryCustodian < MicrosoftGraphBeta::Models::SecurityDataSourceContainer
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "lastIndexOperation" => lambda {|n| @last_index_operation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityEdiscoveryIndexOperation.create_from_discriminator_value(pn) }) },
                    ...
                    "unifiedGroupSources" => lambda {|n| @unified_group_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityUnifiedGroupSource.create_from_discriminator_value(pn) }) },
