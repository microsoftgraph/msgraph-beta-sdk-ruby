...
module MicrosoftGraphBeta::Models
    ...
    class PowerliftIncidentMetadata
        ...
        ## @param value Value to set for the client_version property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the created_at_date_time property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the easy_id property.
        ## @return a void
        ## 
        def easy_id=(value)
            @easy_id = value
        ...
        ## @param value Value to set for the file_names property.
        ## @return a void
        ## 
