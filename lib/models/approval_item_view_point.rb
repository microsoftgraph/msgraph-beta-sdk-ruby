...
module MicrosoftGraphBeta
    module Models
        class ApprovalItemViewPoint
            ...
            ## 
            ## Instantiates a new ApprovalItemViewPoint and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ApprovalItemViewPoint.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "roles" => lambda {|n| @roles = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ApproverRole.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
