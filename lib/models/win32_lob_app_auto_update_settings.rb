    ...
    module Models
        ...
        class Win32LobAppAutoUpdateSettings
            ...
            def get_field_deserializers()
                return {
                    "autoUpdateSupersededAppsState" => lambda {|n| @auto_update_superseded_apps_state = n.get_enum_value(MicrosoftGraphBeta::Models::Win32LobAutoUpdateSupersededAppsState) },
