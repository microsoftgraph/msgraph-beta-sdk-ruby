...
module MicrosoftGraphBeta
    module Models
        class M365AppsInstallationOptions < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "appsForMac" => lambda {|n| @apps_for_mac = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AppsInstallationOptionsForMac.create_from_discriminator_value(pn) }) },
                    "appsForWindows" => lambda {|n| @apps_for_windows = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AppsInstallationOptionsForWindows.create_from_discriminator_value(pn) }) },
                    "updateChannel" => lambda {|n| @update_channel = n.get_enum_value(MicrosoftGraphBeta::Models::AppsUpdateChannelType) },
                })
            end
            ## 
