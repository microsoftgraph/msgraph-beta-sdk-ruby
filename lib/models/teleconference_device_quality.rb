        ...
        class TeleconferenceDeviceQuality
            ...
            def get_field_deserializers()
                return {
                    ...
                    "mediaQualityList" => lambda {|n| @media_quality_list = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TeleconferenceDeviceMediaQuality.create_from_discriminator_value(pn) }) },
