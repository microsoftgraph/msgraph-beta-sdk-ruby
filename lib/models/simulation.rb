...
module MicrosoftGraphBeta
    module Models
        class Simulation < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the end_user_notification_setting property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the excluded_account_target property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "attackTechnique" => lambda {|n| @attack_technique = n.get_enum_value(MicrosoftGraphBeta::Models::SimulationAttackTechnique) },
                    "attackType" => lambda {|n| @attack_type = n.get_enum_value(MicrosoftGraphBeta::Models::SimulationAttackType) },
                    ...
                    "landingPage" => lambda {|n| @landing_page = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::LandingPage.create_from_discriminator_value(pn) }) },
                    ...
                    "loginPage" => lambda {|n| @login_page = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::LoginPage.create_from_discriminator_value(pn) }) },
                    "oAuthConsentAppDetail" => lambda {|n| @o_auth_consent_app_detail = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OAuthConsentAppDetail.create_from_discriminator_value(pn) }) },
                    "payload" => lambda {|n| @payload = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Payload.create_from_discriminator_value(pn) }) },
                    "payloadDeliveryPlatform" => lambda {|n| @payload_delivery_platform = n.get_enum_value(MicrosoftGraphBeta::Models::PayloadDeliveryPlatform) },
                    "report" => lambda {|n| @report = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SimulationReport.create_from_discriminator_value(pn) }) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::SimulationStatus) },
            ...
            ## @param value Value to set for the included_account_target property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the landing_page property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the login_page property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the o_auth_consent_app_detail property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the training_setting property.
            ## @return a void
            ## 
