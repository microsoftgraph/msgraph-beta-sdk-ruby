        ...
        class ProvisioningObjectSummary < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "sourceIdentity" => lambda {|n| @source_identity = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ProvisionedIdentity.create_from_discriminator_value(pn) }) },
                    "sourceSystem" => lambda {|n| @source_system = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ProvisioningSystem.create_from_discriminator_value(pn) }) },
                    "statusInfo" => lambda {|n| @status_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::StatusBase.create_from_discriminator_value(pn) }) },
                    "targetIdentity" => lambda {|n| @target_identity = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ProvisionedIdentity.create_from_discriminator_value(pn) }) },
                    "targetSystem" => lambda {|n| @target_system = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ProvisioningSystem.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("statusInfo", @status_info)
            ...
            ## @param value Value to set for the status_info property.
            ## @return a void
            ## 
