        ...
        class WindowsUpdatesQualityUpdateCveSeverityInformation
            ...
            def get_field_deserializers()
                return {
                    ...
                    "maxSeverity" => lambda {|n| @max_severity = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUpdatesQualityUpdateCveSeverityInformationMaxSeverity) },
            ...
            ## @return a windows_updates_quality_update_cve_severity_information_max_severity
            ## 
            def max_severity
                return @max_severity
            end
