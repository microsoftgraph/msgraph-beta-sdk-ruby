...
module MicrosoftGraphBeta
    module Models
        class ServicePrincipal < MicrosoftGraphBeta::Models::DirectoryObject
            ...
            @permission_grant_pre_approval_policies
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "addIns" => lambda {|n| @add_ins = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AddIn.create_from_discriminator_value(pn) }) },
                    ...
                    "appRoleAssignedTo" => lambda {|n| @app_role_assigned_to = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AppRoleAssignment.create_from_discriminator_value(pn) }) },
                    ...
                    "errorUrl" => lambda {|n| @error_url = n.get_string_value() },
                    ...
                    "passwordSingleSignOnSettings" => lambda {|n| @password_single_sign_on_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PasswordSingleSignOnSettings.create_from_discriminator_value(pn) }) },
                    "permissionGrantPreApprovalPolicies" => lambda {|n| @permission_grant_pre_approval_policies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PermissionGrantPreApprovalPolicy.create_from_discriminator_value(pn) }) },
                    "preferredSingleSignOnMode" => lambda {|n| @preferred_single_sign_on_mode = n.get_string_value() },
                    "preferredTokenSigningKeyEndDateTime" => lambda {|n| @preferred_token_signing_key_end_date_time = n.get_date_time_value() },
            ...
            ## @return a password_single_sign_on_settings
            ## 
            def password_single_sign_on_settings
                return @password_single_sign_on_settings
            end
            ## 
            ...
            ## @return a void
            ## 
            def password_single_sign_on_settings=(value)
            ...
            def permission_grant_pre_approval_policies
                return @permission_grant_pre_approval_policies
            end
            ## 
            ...
            ## @return a void
            ## 
            def permission_grant_pre_approval_policies=(value)
                @permission_grant_pre_approval_policies = value
            end
            ## 
            ...
            ## @return a void
            ## 
            def preferred_token_signing_key_end_date_time=(value)
            ...
            ## @return a void
            ## 
            def published_permission_scopes=(value)
            ...
            def serialize(writer)
                ...
                writer.write_string_value("errorUrl", @error_url)
                ...
                writer.write_object_value("passwordSingleSignOnSettings", @password_single_sign_on_settings)
                writer.write_collection_of_object_values("permissionGrantPreApprovalPolicies", @permission_grant_pre_approval_policies)
                writer.write_string_value("preferredSingleSignOnMode", @preferred_single_sign_on_mode)
                writer.write_date_time_value("preferredTokenSigningKeyEndDateTime", @preferred_token_signing_key_end_date_time)
