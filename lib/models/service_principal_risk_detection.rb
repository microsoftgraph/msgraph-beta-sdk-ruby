    ...
    module Models
        class ServicePrincipalRiskDetection < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "activity" => lambda {|n| @activity = n.get_enum_value(MicrosoftGraphBeta::Models::ServicePrincipalRiskDetectionActivity) },
                    ...
                    "detectionTimingType" => lambda {|n| @detection_timing_type = n.get_enum_value(MicrosoftGraphBeta::Models::ServicePrincipalRiskDetectionDetectionTimingType) },
                    ...
                    "riskDetail" => lambda {|n| @risk_detail = n.get_enum_value(MicrosoftGraphBeta::Models::ServicePrincipalRiskDetectionRiskDetail) },
                    "riskEventType" => lambda {|n| @risk_event_type = n.get_string_value() },
                    "riskLevel" => lambda {|n| @risk_level = n.get_enum_value(MicrosoftGraphBeta::Models::ServicePrincipalRiskDetectionRiskLevel) },
                    "riskState" => lambda {|n| @risk_state = n.get_enum_value(MicrosoftGraphBeta::Models::ServicePrincipalRiskDetectionRiskState) },
                    ...
                    "tokenIssuerType" => lambda {|n| @token_issuer_type = n.get_enum_value(MicrosoftGraphBeta::Models::ServicePrincipalRiskDetectionTokenIssuerType) },
                })
            end
            ## 
