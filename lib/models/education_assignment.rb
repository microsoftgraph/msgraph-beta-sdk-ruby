...
module MicrosoftGraphBeta
    module Models
        class EducationAssignment < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "assignTo" => lambda {|n| @assign_to = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationAssignmentRecipient.create_from_discriminator_value(pn) }) },
                    "assignedDateTime" => lambda {|n| @assigned_date_time = n.get_date_time_value() },
                    "categories" => lambda {|n| @categories = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EducationCategory.create_from_discriminator_value(pn) }) },
                    ...
                    "grading" => lambda {|n| @grading = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationAssignmentGradeType.create_from_discriminator_value(pn) }) },
                    "gradingCategory" => lambda {|n| @grading_category = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationGradingCategory.create_from_discriminator_value(pn) }) },
                    "gradingScheme" => lambda {|n| @grading_scheme = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationGradingScheme.create_from_discriminator_value(pn) }) },
                    "instructions" => lambda {|n| @instructions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationItemBody.create_from_discriminator_value(pn) }) },
                    ...
                    "resources" => lambda {|n| @resources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EducationAssignmentResource.create_from_discriminator_value(pn) }) },
                    "resourcesFolderUrl" => lambda {|n| @resources_folder_url = n.get_string_value() },
                    "rubric" => lambda {|n| @rubric = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationRubric.create_from_discriminator_value(pn) }) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::EducationAssignmentStatus) },
                    "submissions" => lambda {|n| @submissions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EducationSubmission.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("gradingScheme", @grading_scheme)
