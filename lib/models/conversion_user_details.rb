...
module MicrosoftGraphBeta
    module Models
        class ConversionUserDetails
            ...
            @converted_to_internal_user_date_time
            ## 
            ...
            ## @return a date_time
            ## 
            def converted_to_internal_user_date_time
                return @converted_to_internal_user_date_time
            end
            ## 
            ## Sets the convertedToInternalUserDateTime property value. The convertedToInternalUserDateTime property
            ## @param value Value to set for the convertedToInternalUserDateTime property.
            ## @return a void
            ## 
            def converted_to_internal_user_date_time=(value)
                @converted_to_internal_user_date_time = value
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a conversion_user_details
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return ConversionUserDetails.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "convertedToInternalUserDateTime" => lambda {|n| @converted_to_internal_user_date_time = n.get_date_time_value() },
            ...
            def serialize(writer)
                ...
                writer.write_date_time_value("convertedToInternalUserDateTime", @converted_to_internal_user_date_time)
