...
module MicrosoftGraphBeta
    module Models
        class SecurityCustomAction < MicrosoftGraphBeta::Models::SecurityInformationProtectionAction
            ...
            ## @return a security_custom_action
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "properties" => lambda {|n| @properties = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityKeyValuePair.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
