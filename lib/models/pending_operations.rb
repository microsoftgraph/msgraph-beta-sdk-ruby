        ...
        class PendingOperations
            ...
            def get_field_deserializers()
                return {
                    ...
                    "pendingContentUpdate" => lambda {|n| @pending_content_update = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PendingContentUpdate.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
