...
module MicrosoftGraphBeta
    module Models
        class AccessPackageResourceAttributeQuestion < MicrosoftGraphBeta::Models::AccessPackageResourceAttributeSource
            ...
            def get_field_deserializers()
                return super.merge({
                    "question" => lambda {|n| @question = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AccessPackageQuestion.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
