...
module MicrosoftGraphBeta
    module Models
        class SecurityEdiscoveryCaseSettings < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "ocr" => lambda {|n| @ocr = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityOcrSettings.create_from_discriminator_value(pn) }) },
                    "redundancyDetection" => lambda {|n| @redundancy_detection = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityRedundancyDetectionSettings.create_from_discriminator_value(pn) }) },
                    "topicModeling" => lambda {|n| @topic_modeling = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityTopicModelingSettings.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
