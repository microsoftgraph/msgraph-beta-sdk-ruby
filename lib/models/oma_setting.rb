        ...
        class OmaSetting
            ...
            def get_field_deserializers()
                return {
                    ...
                    "secretReferenceValueId" => lambda {|n| @secret_reference_value_id = n.get_string_value() },
                }
            end
            ## 
            ...
            ## @return a string
            ## 
            def secret_reference_value_id
                return @secret_reference_value_id
            end
            ## 
            ...
            ## @param value Value to set for the secret_reference_value_id property.
            ## @return a void
            ## 
            def secret_reference_value_id=(value)
                @secret_reference_value_id = value
            end
            ## 
