        ...
        class AutomaticRepliesMailTips
            ...
            def get_field_deserializers()
                return {
                    ...
                    "messageLanguage" => lambda {|n| @message_language = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::LocaleInfo.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "scheduledEndTime" => lambda {|n| @scheduled_end_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
                    "scheduledStartTime" => lambda {|n| @scheduled_start_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
