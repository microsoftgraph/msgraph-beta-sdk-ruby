...
module MicrosoftGraphBeta
    module Models
        class IndustryDataYearTimePeriodDefinition < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "year" => lambda {|n| @year = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataYearReferenceValue.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## @return a industry_data_year_reference_value
            ## 
            def year
                return @year
            end
