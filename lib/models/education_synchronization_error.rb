...
module MicrosoftGraphBeta::Models
    class EducationSynchronizationError < MicrosoftGraphBeta::Models::Entity
        ...
        ## @param value Value to set for the entry_type property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the joining_value property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the reportable_identifier property.
        ## @return a void
        ## 
