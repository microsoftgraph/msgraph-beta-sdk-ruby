        ...
        class PhoneAuthenticationMethod < MicrosoftGraphBeta::Models::AuthenticationMethod
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "phoneType" => lambda {|n| @phone_type = n.get_enum_value(MicrosoftGraphBeta::Models::AuthenticationPhoneType) },
                    "smsSignInState" => lambda {|n| @sms_sign_in_state = n.get_enum_value(MicrosoftGraphBeta::Models::AuthenticationMethodSignInState) },
                })
            end
            ## 
