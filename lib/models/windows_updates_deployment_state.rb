...
module MicrosoftGraphBeta
    module Models
        class WindowsUpdatesDeploymentState
            ...
            ## 
            ## Instantiates a new windowsUpdatesDeploymentState and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            ## @return a windows_updates_deployment_state
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return WindowsUpdatesDeploymentState.new
            end
            ## 
            ## Gets the effectiveValue property value. The effectiveValue property
            ## @return a windows_updates_deployment_state_value
            ## 
            def effective_value
            ...
            def get_field_deserializers()
                return {
                    "effectiveValue" => lambda {|n| @effective_value = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUpdatesDeploymentStateValue) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "reasons" => lambda {|n| @reasons = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesDeploymentStateReason.create_from_discriminator_value(pn) }) },
                    "requestedValue" => lambda {|n| @requested_value = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsUpdatesRequestedDeploymentStateValue) },
                }
            end
            ## 
            ...
            ## @return a windows_updates_deployment_state_reason
            ## 
            def reasons
                return @reasons
            end
            ...
            ## @return a windows_updates_requested_deployment_state_value
            ## 
            def requested_value
