    ...
    module Models
        class ExchangeRestoreSession < MicrosoftGraphBeta::Models::RestoreSessionBase
            ...
            def get_field_deserializers()
                return super.merge({
                    "granularMailboxRestoreArtifacts" => lambda {|n| @granular_mailbox_restore_artifacts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::GranularMailboxRestoreArtifact.create_from_discriminator_value(pn) }) },
                    ...
                    "mailboxRestoreArtifactsBulkAdditionRequests" => lambda {|n| @mailbox_restore_artifacts_bulk_addition_requests = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MailboxRestoreArtifactsBulkAdditionRequest.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
