...
module MicrosoftGraphBeta
    module Models
        module IdentityGovernance
            class TimeBasedAttributeTrigger < MicrosoftGraphBeta::Models::IdentityGovernance::WorkflowExecutionTrigger
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "timeBasedAttribute" => lambda {|n| @time_based_attribute = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityGovernance::WorkflowTriggerTimeBasedAttribute) },
                    })
                end
                ## 
