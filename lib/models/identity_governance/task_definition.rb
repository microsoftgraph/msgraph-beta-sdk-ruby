...
module MicrosoftGraphBeta::Models::IdentityGovernance
    class TaskDefinition < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "category" => lambda {|n| @category = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityGovernance::LifecycleTaskCategory) },
                "continueOnError" => lambda {|n| @continue_on_error = n.get_boolean_value() },
                "description" => lambda {|n| @description = n.get_string_value() },
                "displayName" => lambda {|n| @display_name = n.get_string_value() },
                "parameters" => lambda {|n| @parameters = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::Parameter.create_from_discriminator_value(pn) }) },
