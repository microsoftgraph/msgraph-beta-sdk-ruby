...
module MicrosoftGraphBeta
    module Models
        module IdentityGovernance
            class LifecycleWorkflowsContainer < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "customTaskExtensions" => lambda {|n| @custom_task_extensions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::CustomTaskExtension.create_from_discriminator_value(pn) }) },
                        ...
                        "settings" => lambda {|n| @settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::LifecycleManagementSettings.create_from_discriminator_value(pn) }) },
                        "taskDefinitions" => lambda {|n| @task_definitions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::TaskDefinition.create_from_discriminator_value(pn) }) },
                        "workflowTemplates" => lambda {|n| @workflow_templates = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::WorkflowTemplate.create_from_discriminator_value(pn) }) },
                        "workflows" => lambda {|n| @workflows = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::Workflow.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
