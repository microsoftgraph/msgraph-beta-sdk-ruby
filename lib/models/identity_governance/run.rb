...
module MicrosoftGraphBeta
    module Models
        module IdentityGovernance
            class Run < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "processingStatus" => lambda {|n| @processing_status = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityGovernance::LifecycleWorkflowProcessingStatus) },
                        ...
                        "taskProcessingResults" => lambda {|n| @task_processing_results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::TaskProcessingResult.create_from_discriminator_value(pn) }) },
                        ...
                        "userProcessingResults" => lambda {|n| @user_processing_results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::UserProcessingResult.create_from_discriminator_value(pn) }) },
                        "workflowExecutionType" => lambda {|n| @workflow_execution_type = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityGovernance::WorkflowExecutionType) },
                    })
                end
                ## 
