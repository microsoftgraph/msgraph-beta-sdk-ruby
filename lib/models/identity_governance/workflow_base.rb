        ...
        module IdentityGovernance
            class WorkflowBase
                ...
                def get_field_deserializers()
                    return {
                        "category" => lambda {|n| @category = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityGovernance::LifecycleWorkflowCategory) },
                        "createdBy" => lambda {|n| @created_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::User.create_from_discriminator_value(pn) }) },
                        "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                        "description" => lambda {|n| @description = n.get_string_value() },
                        "displayName" => lambda {|n| @display_name = n.get_string_value() },
                        "executionConditions" => lambda {|n| @execution_conditions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::WorkflowExecutionConditions.create_from_discriminator_value(pn) }) },
                        "isEnabled" => lambda {|n| @is_enabled = n.get_boolean_value() },
                        "isSchedulingEnabled" => lambda {|n| @is_scheduling_enabled = n.get_boolean_value() },
                        "lastModifiedBy" => lambda {|n| @last_modified_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::User.create_from_discriminator_value(pn) }) },
                        "lastModifiedDateTime" => lambda {|n| @last_modified_date_time = n.get_date_time_value() },
                        "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                        "tasks" => lambda {|n| @tasks = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::Task.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
