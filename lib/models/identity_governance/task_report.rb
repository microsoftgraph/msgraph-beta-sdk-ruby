...
module MicrosoftGraphBeta
    module Models
        module IdentityGovernance
            class TaskReport < MicrosoftGraphBeta::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "task" => lambda {|n| @task = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::Task.create_from_discriminator_value(pn) }) },
                        "taskDefinition" => lambda {|n| @task_definition = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::TaskDefinition.create_from_discriminator_value(pn) }) },
