...
module MicrosoftGraphBeta
    module Models
        module IdentityGovernance
            class CustomTaskExtensionCalloutData < MicrosoftGraphBeta::Models::CustomExtensionData
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "taskProcessingresult" => lambda {|n| @task_processingresult = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::TaskProcessingResult.create_from_discriminator_value(pn) }) },
                        "workflow" => lambda {|n| @workflow = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::Workflow.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
