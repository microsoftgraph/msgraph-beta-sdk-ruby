...
module MicrosoftGraphBeta
    module Models
        class DeviceLocalCredentialInfo < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "credentials" => lambda {|n| @credentials = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceLocalCredential.create_from_discriminator_value(pn) }) },
            ...
            ## @param value Value to set for the last_backup_date_time property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the refresh_date_time property.
            ## @return a void
            ## 
