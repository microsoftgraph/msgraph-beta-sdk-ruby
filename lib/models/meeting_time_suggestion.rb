    ...
    module Models
        class MeetingTimeSuggestion
            ...
            def get_field_deserializers()
                return {
                    "attendeeAvailability" => lambda {|n| @attendee_availability = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AttendeeAvailability.create_from_discriminator_value(pn) }) },
                    "confidence" => lambda {|n| @confidence = n.get_object_value(lambda {|pn| Double.create_from_discriminator_value(pn) }) },
                    "locations" => lambda {|n| @locations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Location.create_from_discriminator_value(pn) }) },
                    "meetingTimeSlot" => lambda {|n| @meeting_time_slot = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TimeSlot.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "order" => lambda {|n| @order = n.get_number_value() },
                    "organizerAvailability" => lambda {|n| @organizer_availability = n.get_enum_value(MicrosoftGraphBeta::Models::MeetingTimeSuggestionOrganizerAvailability) },
