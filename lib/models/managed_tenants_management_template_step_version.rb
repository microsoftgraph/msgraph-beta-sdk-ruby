...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsManagementTemplateStepVersion < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "acceptedFor" => lambda {|n| @accepted_for = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsManagementTemplateStep.create_from_discriminator_value(pn) }) },
                    ...
                    "deployments" => lambda {|n| @deployments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsManagementTemplateStepDeployment.create_from_discriminator_value(pn) }) },
                    ...
                    "templateStep" => lambda {|n| @template_step = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsManagementTemplateStep.create_from_discriminator_value(pn) }) },
