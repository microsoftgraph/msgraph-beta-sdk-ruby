...
module MicrosoftGraphBeta
    module Models
        class CloudPcProvisioningPolicyAssignment < MicrosoftGraphBeta::Models::Entity
            ...
            ## @param value Value to set for the assigned_users property.
            ## @return a void
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "assignedUsers" => lambda {|n| @assigned_users = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::User.create_from_discriminator_value(pn) }) },
