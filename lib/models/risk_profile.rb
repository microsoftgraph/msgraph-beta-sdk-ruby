    ...
    module Models
        class RiskProfile
            ...
            def get_field_deserializers()
                return {
                    "humanCount" => lambda {|n| @human_count = n.get_number_value() },
                    "nonHumanCount" => lambda {|n| @non_human_count = n.get_number_value() },
            ...
            ## @return a void
            ## 
            def non_human_count=(value)
                @non_human_count = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_number_value("humanCount", @human_count)
                writer.write_number_value("nonHumanCount", @non_human_count)
