            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        ...
                        when "#microsoft.graph.encryptContent"
                        ...
                        when "#microsoft.graph.markContent"
                            return MarkContent.new
                        when "#microsoft.graph.protectGroup"
                            return ProtectGroup.new
                        when "#microsoft.graph.protectOnlineMeetingAction"
                            return ProtectOnlineMeetingAction.new
                        when "#microsoft.graph.protectSite"
                            return ProtectSite.new
                    end
                end
                return LabelActionBase.new
            end
            ## 
