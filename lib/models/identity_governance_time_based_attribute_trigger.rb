...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceTimeBasedAttributeTrigger < MicrosoftGraphBeta::Models::IdentityGovernanceWorkflowExecutionTrigger
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "timeBasedAttribute" => lambda {|n| @time_based_attribute = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityGovernanceWorkflowTriggerTimeBasedAttribute) },
                })
            end
            ## 
