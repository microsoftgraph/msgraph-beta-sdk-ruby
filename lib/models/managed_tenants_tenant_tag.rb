...
module MicrosoftGraphBeta
    module Models
        class ManagedTenantsTenantTag < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "tenants" => lambda {|n| @tenants = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsTenantInfo.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
