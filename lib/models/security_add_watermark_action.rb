...
module MicrosoftGraphBeta
    module Models
        class SecurityAddWatermarkAction < MicrosoftGraphBeta::Models::SecurityInformationProtectionAction
            ...
            @ui_element_name
            ## 
            ## Instantiates a new securityAddWatermarkAction and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            ## @return a security_add_watermark_action
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "layout" => lambda {|n| @layout = n.get_enum_value(MicrosoftGraphBeta::Models::SecurityWatermarkLayout) },
            ...
            ## @return a security_watermark_layout
            ## 
            def layout
                return @layout
            end
