...
module MicrosoftGraphBeta
    module Models
        class IndustryDataInboundActivityResults < MicrosoftGraphBeta::Models::IndustryDataIndustryDataActivityStatistics
            ...
            @warnings
            ## 
            ## Instantiates a new IndustryDataInboundActivityResults and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
            ...
            ## @return a industry_data_inbound_activity_results
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "groups" => lambda {|n| @groups = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataIndustryDataRunEntityCountMetric.create_from_discriminator_value(pn) }) },
                    ...
                    "memberships" => lambda {|n| @memberships = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataIndustryDataRunEntityCountMetric.create_from_discriminator_value(pn) }) },
                    "organizations" => lambda {|n| @organizations = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataIndustryDataRunEntityCountMetric.create_from_discriminator_value(pn) }) },
                    "people" => lambda {|n| @people = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IndustryDataIndustryDataRunEntityCountMetric.create_from_discriminator_value(pn) }) },
            ...
            ## @return a industry_data_industry_data_run_entity_count_metric
            ## 
            def groups
                return @groups
            end
