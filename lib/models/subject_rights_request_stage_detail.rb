        ...
        class SubjectRightsRequestStageDetail
            ...
            def get_field_deserializers()
                return {
                    ...
                    "stage" => lambda {|n| @stage = n.get_enum_value(MicrosoftGraphBeta::Models::SubjectRightsRequestStageDetailStage) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::SubjectRightsRequestStageDetailStatus) },
                }
            end
            ## 
