...
module MicrosoftGraphBeta
    module Models
        class LearningAssignment < MicrosoftGraphBeta::Models::LearningCourseActivity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "assignmentType" => lambda {|n| @assignment_type = n.get_enum_value(MicrosoftGraphBeta::Models::AssignmentType) },
