...
module MicrosoftGraphBeta
    module Models
        class RoomList < MicrosoftGraphBeta::Models::Place
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "rooms" => lambda {|n| @rooms = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Room.create_from_discriminator_value(pn) }) },
                    "workspaces" => lambda {|n| @workspaces = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Workspace.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("workspaces", @workspaces)
            end
            ## 
