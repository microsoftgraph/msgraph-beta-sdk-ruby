        ...
        class Group < MicrosoftGraphBeta::Models::DirectoryObject
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "cloudLicensing" => lambda {|n| @cloud_licensing = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CloudLicensingGroupCloudLicensing.create_from_discriminator_value(pn) }) },
