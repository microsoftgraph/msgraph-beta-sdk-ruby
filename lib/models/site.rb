        ...
        class Site < MicrosoftGraphBeta::Models::BaseItem
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "pageTemplates" => lambda {|n| @page_templates = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PageTemplate.create_from_discriminator_value(pn) }) },
            ...
            ## @return a void
            ## 
            def page_templates=(value)
                @page_templates = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("pageTemplates", @page_templates)
