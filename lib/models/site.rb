        ...
        class Site < MicrosoftGraphBeta::Models::BaseItem
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "pages" => lambda {|n| @pages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SitePage.create_from_discriminator_value(pn) }) },
                    ...
                    "termStore" => lambda {|n| @term_store = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Store.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
