...
module MicrosoftGraphBeta
    module Models
        class IdentityGovernanceCustomTaskExtensionCallbackConfiguration < MicrosoftGraphBeta::Models::CustomExtensionCallbackConfiguration
            ...
            def get_field_deserializers()
                return super.merge({
                    "authorizedApps" => lambda {|n| @authorized_apps = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Application.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
