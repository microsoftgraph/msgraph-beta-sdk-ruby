    ...
    module Models
        class ConditionalAccessPlatforms
            ...
            def get_field_deserializers()
                return {
                    "excludePlatforms" => lambda {|n| @exclude_platforms = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessDevicePlatform.create_from_discriminator_value(pn) }) },
                    "includePlatforms" => lambda {|n| @include_platforms = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessDevicePlatform.create_from_discriminator_value(pn) }) },
