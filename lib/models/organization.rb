...
module MicrosoftGraphBeta
    module Models
        class Organization < MicrosoftGraphBeta::Models::DirectoryObject
            ...
            @on_premises_last_password_sync_date_time
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "onPremisesLastPasswordSyncDateTime" => lambda {|n| @on_premises_last_password_sync_date_time = n.get_date_time_value() },
            ...
            ## @return a date_time
            ## 
            def on_premises_last_password_sync_date_time
                return @on_premises_last_password_sync_date_time
            end
            ## 
            ...
            ## @param value Value to set for the on_premises_last_password_sync_date_time property.
            ## @return a void
            ## 
            def on_premises_last_password_sync_date_time=(value)
                @on_premises_last_password_sync_date_time = value
            end
            ## 
            ...
            def partner_information
                return @partner_information
            end
            ## 
            ## Sets the partnerInformation property value. The partnerInformation property
            ## @param value Value to set for the partner_information property.
            ## @return a void
            ## 
            def partner_information=(value)
                @partner_information = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_date_time_value("onPremisesLastPasswordSyncDateTime", @on_premises_last_password_sync_date_time)
                ...
                writer.write_object_value("partnerInformation", @partner_information)
