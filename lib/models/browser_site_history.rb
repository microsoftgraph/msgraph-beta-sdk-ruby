        ...
        class BrowserSiteHistory
            ...
            def get_field_deserializers()
                return {
                    ...
                    "compatibilityMode" => lambda {|n| @compatibility_mode = n.get_enum_value(MicrosoftGraphBeta::Models::BrowserSiteHistoryCompatibilityMode) },
                    ...
                    "mergeType" => lambda {|n| @merge_type = n.get_enum_value(MicrosoftGraphBeta::Models::BrowserSiteHistoryMergeType) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "publishedDateTime" => lambda {|n| @published_date_time = n.get_date_time_value() },
                    "targetEnvironment" => lambda {|n| @target_environment = n.get_enum_value(MicrosoftGraphBeta::Models::BrowserSiteHistoryTargetEnvironment) },
                }
            end
            ## 
