...
module MicrosoftGraphBeta
    module Models
        ...
        class ManagedAppRegistration < MicrosoftGraphBeta::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "appIdentifier" => lambda {|n| @app_identifier = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MobileAppIdentifier.create_from_discriminator_value(pn) }) },
                    "applicationVersion" => lambda {|n| @application_version = n.get_string_value() },
                    "appliedPolicies" => lambda {|n| @applied_policies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedAppPolicy.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_string_value("azureADDeviceId", @azure_a_d_device_id)
