...
module MicrosoftGraphBeta
    module Models
        ...
        class AndroidEnterpriseWiFiConfiguration < MicrosoftGraphBeta::Models::AndroidWiFiConfiguration
            ...
            ## @return a android_enterprise_wi_fi_configuration_authentication_method
            ## 
            ...
            ## @return a android_enterprise_wi_fi_configuration
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "authenticationMethod" => lambda {|n| @authentication_method = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidEnterpriseWiFiConfigurationAuthenticationMethod) },
                    "eapType" => lambda {|n| @eap_type = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidEapType) },
                    "identityCertificateForClientAuthentication" => lambda {|n| @identity_certificate_for_client_authentication = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AndroidCertificateProfileBase.create_from_discriminator_value(pn) }) },
                    "innerAuthenticationProtocolForEapTtls" => lambda {|n| @inner_authentication_protocol_for_eap_ttls = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidEnterpriseWiFiConfigurationInnerAuthenticationProtocolForEapTtls) },
                    "innerAuthenticationProtocolForPeap" => lambda {|n| @inner_authentication_protocol_for_peap = n.get_enum_value(MicrosoftGraphBeta::Models::AndroidEnterpriseWiFiConfigurationInnerAuthenticationProtocolForPeap) },
                    ...
                    "rootCertificateForServerValidation" => lambda {|n| @root_certificate_for_server_validation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AndroidTrustedRootCertificate.create_from_discriminator_value(pn) }) },
            ...
            ## @return a android_enterprise_wi_fi_configuration_inner_authentication_protocol_for_eap_ttls
            ## 
            ...
            ## @return a android_enterprise_wi_fi_configuration_inner_authentication_protocol_for_peap
            ## 
            ...
            ## @return a android_trusted_root_certificate
            ## 
