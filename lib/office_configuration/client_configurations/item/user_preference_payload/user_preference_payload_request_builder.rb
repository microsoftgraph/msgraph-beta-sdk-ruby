...
module MicrosoftGraphBeta
    module OfficeConfiguration
        module ClientConfigurations
            module Item
                module UserPreferencePayload
                    ## 
                    # Provides operations to manage the media for the officeConfiguration entity.
                    class UserPreferencePayloadRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/officeConfiguration/clientConfigurations/{officeClientConfiguration%2Did}/userPreferencePayload")
                        end
                        ## 
