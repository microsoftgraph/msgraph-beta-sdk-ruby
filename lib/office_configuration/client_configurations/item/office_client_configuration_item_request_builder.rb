...
module MicrosoftGraphBeta::OfficeConfiguration::ClientConfigurations::Item
    ...
    class OfficeClientConfigurationItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::OfficeConfiguration::ClientConfigurations::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
