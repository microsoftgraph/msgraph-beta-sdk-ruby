...
require_relative './assignments/item/office_client_configuration_assignment_item_request_builder'
...
module MicrosoftGraphBeta::OfficeConfiguration::ClientConfigurations::Item
    ## 
    ...
    class OfficeClientConfigurationItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::OfficeConfiguration::ClientConfigurations::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a office_client_configuration_assignment_item_request_builder
        ## 
        def assignments_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["officeClientConfigurationAssignment%2Did"] = id
            return MicrosoftGraphBeta::OfficeConfiguration::ClientConfigurations::Item::Assignments::Item::OfficeClientConfigurationAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Instantiates a new OfficeClientConfigurationItemRequestBuilder and sets the default values.
        ## @param officeClientConfigurationId key: id of officeClientConfiguration
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, office_client_configuration_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/officeConfiguration/clientConfigurations/{officeClientConfiguration%2Did}{?%24select,%24expand}"
