            ...
            module Item
                module Assignments
                    module Item
                        ...
                        class OfficeClientConfigurationAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/officeConfiguration/clientConfigurations/{officeClientConfiguration%2Did}/assignments/{officeClientConfigurationAssignment%2Did}{?%24select,%24expand}")
                            end
                            ## 
