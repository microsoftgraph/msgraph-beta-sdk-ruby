...
module MicrosoftGraphBeta::OfficeConfiguration::ClientConfigurations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/officeConfiguration/clientConfigurations/$count{?%24search,%24filter}"
