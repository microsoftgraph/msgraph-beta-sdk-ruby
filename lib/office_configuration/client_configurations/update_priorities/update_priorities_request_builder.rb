    ...
    module OfficeConfiguration
        module ClientConfigurations
            module UpdatePriorities
                ...
                class UpdatePrioritiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/officeConfiguration/clientConfigurations/updatePriorities")
                    end
                    ## 
