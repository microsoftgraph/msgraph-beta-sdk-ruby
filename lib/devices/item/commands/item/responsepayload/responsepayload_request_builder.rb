                    ...
                    module Responsepayload
                        ...
                        class ResponsepayloadRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/devices/{device%2Did}/commands/{command%2Did}/responsepayload{?%24select,%24expand}")
                            end
                            ## 
                            ...
                            ## @return a responsepayload_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return ResponsepayloadRequestBuilder.new(raw_url, @request_adapter)
                            end
