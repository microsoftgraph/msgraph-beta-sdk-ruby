...
module MicrosoftGraphBeta::Devices::Item::RegisteredOwners::MicrosoftGraphUser
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Devices::Item::RegisteredOwners::MicrosoftGraphUser::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
