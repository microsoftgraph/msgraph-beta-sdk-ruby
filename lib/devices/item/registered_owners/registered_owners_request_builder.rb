...
module MicrosoftGraphBeta::Devices::Item::RegisteredOwners
    ## 
    ...
    class RegisteredOwnersRequestBuilder
        ...
        def microsoft_graph_endpoint()
            return MicrosoftGraphBeta::Devices::Item::RegisteredOwners::MicrosoftGraphEndpoint::MicrosoftGraphEndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to servicePrincipal.
        def microsoft_graph_service_principal()
            return MicrosoftGraphBeta::Devices::Item::RegisteredOwners::MicrosoftGraphServicePrincipal::MicrosoftGraphServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::Devices::Item::RegisteredOwners::MicrosoftGraphUser::MicrosoftGraphUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
