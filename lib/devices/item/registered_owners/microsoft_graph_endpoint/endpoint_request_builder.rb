...
module MicrosoftGraphBeta::Devices::Item::RegisteredOwners::MicrosoftGraphEndpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Devices::Item::RegisteredOwners::MicrosoftGraphEndpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
