...
module MicrosoftGraphBeta::Devices::Item::RegisteredOwners::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Devices::Item::RegisteredOwners::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
