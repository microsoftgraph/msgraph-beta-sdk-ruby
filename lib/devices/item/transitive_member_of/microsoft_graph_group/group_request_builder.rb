...
module MicrosoftGraphBeta::Devices::Item::TransitiveMemberOf::MicrosoftGraphGroup
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Devices::Item::TransitiveMemberOf::MicrosoftGraphGroup::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
