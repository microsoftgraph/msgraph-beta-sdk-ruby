...
module MicrosoftGraphBeta::Devices::Item::TransitiveMemberOf::MicrosoftGraphServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Devices::Item::TransitiveMemberOf::MicrosoftGraphServicePrincipal::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
