...
module MicrosoftGraphBeta::Devices::Item::RegisteredUsers::MicrosoftGraphEndpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Devices::Item::RegisteredUsers::MicrosoftGraphEndpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
