...
module MicrosoftGraphBeta::Devices::Item::RegisteredUsers
    ...
    class RegisteredUsersRequestBuilder
        ...
        def microsoft_graph_endpoint()
            return MicrosoftGraphBeta::Devices::Item::RegisteredUsers::MicrosoftGraphEndpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to servicePrincipal.
        def microsoft_graph_service_principal()
            return MicrosoftGraphBeta::Devices::Item::RegisteredUsers::MicrosoftGraphServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::Devices::Item::RegisteredUsers::MicrosoftGraphUser::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
