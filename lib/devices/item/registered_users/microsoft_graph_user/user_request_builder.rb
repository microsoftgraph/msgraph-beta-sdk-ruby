...
module MicrosoftGraphBeta::Devices::Item::RegisteredUsers::MicrosoftGraphUser
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Devices::Item::RegisteredUsers::MicrosoftGraphUser::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
