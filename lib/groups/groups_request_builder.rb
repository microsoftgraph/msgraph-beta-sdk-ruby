...
module MicrosoftGraphBeta::Groups
    ## 
    ...
    class GroupsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Groups::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the evaluateDynamicMembership method.
        def microsoft_graph_evaluate_dynamic_membership()
            return MicrosoftGraphBeta::Groups::MicrosoftGraphEvaluateDynamicMembership::MicrosoftGraphEvaluateDynamicMembershipRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getByIds method.
        def microsoft_graph_get_by_ids()
            return MicrosoftGraphBeta::Groups::MicrosoftGraphGetByIds::MicrosoftGraphGetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getUserOwnedObjects method.
        def microsoft_graph_get_user_owned_objects()
            return MicrosoftGraphBeta::Groups::MicrosoftGraphGetUserOwnedObjects::MicrosoftGraphGetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validateProperties method.
        def microsoft_graph_validate_properties()
            return MicrosoftGraphBeta::Groups::MicrosoftGraphValidateProperties::MicrosoftGraphValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
