...
module MicrosoftGraphBeta::Groups::Item::GroupLifecyclePolicies::Item
    ...
    class GroupLifecyclePolicyItemRequestBuilder
        ...
        def add_group()
            return MicrosoftGraphBeta::Groups::Item::GroupLifecyclePolicies::Item::AddGroup::AddGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def remove_group()
            return MicrosoftGraphBeta::Groups::Item::GroupLifecyclePolicies::Item::RemoveGroup::RemoveGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
