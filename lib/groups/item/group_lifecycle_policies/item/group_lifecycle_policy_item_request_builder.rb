...
module MicrosoftGraphBeta::Groups::Item::GroupLifecyclePolicies::Item
    ...
    class GroupLifecyclePolicyItemRequestBuilder
        ...
        def microsoft_graph_add_group()
            return MicrosoftGraphBeta::Groups::Item::GroupLifecyclePolicies::Item::MicrosoftGraphAddGroup::AddGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeGroup method.
        def microsoft_graph_remove_group()
            return MicrosoftGraphBeta::Groups::Item::GroupLifecyclePolicies::Item::MicrosoftGraphRemoveGroup::RemoveGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
