                    ...
                    module AddGroup
                        ...
                        class AddGroupRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def post(body, request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Groups::Item::GroupLifecyclePolicies::Item::AddGroup::AddGroupResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Invoke action addGroup
                            ## @param body The request body
