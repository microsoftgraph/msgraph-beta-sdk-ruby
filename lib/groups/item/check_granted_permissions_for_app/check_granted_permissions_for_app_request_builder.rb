            ...
            module CheckGrantedPermissionsForApp
                ...
                class CheckGrantedPermissionsForAppRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def post(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Groups::Item::CheckGrantedPermissionsForApp::CheckGrantedPermissionsForAppPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Invoke action checkGrantedPermissionsForApp
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
