                ...
                module GetByIds
                    ...
                    class GetByIdsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Groups::Item::PermissionGrants::GetByIds::GetByIdsPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Return the directory objects specified in a list of IDs. Some common uses for this function are to: This API is supported in the following national cloud deployments.
                        ## @param body The request body
