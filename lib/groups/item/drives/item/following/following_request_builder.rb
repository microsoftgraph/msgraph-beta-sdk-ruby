...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Following
    ## 
    ...
    class FollowingRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Following::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
