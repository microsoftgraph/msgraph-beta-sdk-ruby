...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Following::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Following::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
