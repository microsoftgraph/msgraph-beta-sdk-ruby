...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Activities::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/activities/$count{?%24search,%24filter}"
