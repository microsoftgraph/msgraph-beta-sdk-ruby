...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::ListItem::CreateLink
    ## 
    ...
    class CreateLinkRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/microsoft.graph.createLink"
