...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Versions::Item
    ## 
    ...
    class DriveItemVersionItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Versions::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore_version()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Versions::Item::RestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
