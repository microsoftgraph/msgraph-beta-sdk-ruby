...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Permissions::Item::RevokeGrants
    ## 
    ...
    class RevokeGrantsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/permissions/{permission%2Did}/microsoft.graph.revokeGrants"
