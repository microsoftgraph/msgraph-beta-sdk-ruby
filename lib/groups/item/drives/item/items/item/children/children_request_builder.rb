...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Children
    ## 
    ...
    class ChildrenRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Children::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
