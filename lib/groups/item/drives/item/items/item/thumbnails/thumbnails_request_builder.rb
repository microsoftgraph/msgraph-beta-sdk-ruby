...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Thumbnails
    ## 
    ...
    class ThumbnailsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Thumbnails::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
