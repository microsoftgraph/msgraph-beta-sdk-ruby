...
module MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks
    ## 
    ...
    class NotebooksRequestBuilder
        ...
        def microsoft_graph_get_notebook_from_web_url()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::MicrosoftGraphGetNotebookFromWebUrl::MicrosoftGraphGetNotebookFromWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
