            ...
            module Onenote
                module Notebooks
                    ...
                    class NotebooksRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getNotebookFromWebUrl method.
                        def get_notebook_from_web_url()
                            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::GetNotebookFromWebUrl::GetNotebookFromWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the notebooks property of the microsoft.graph.onenote entity.
