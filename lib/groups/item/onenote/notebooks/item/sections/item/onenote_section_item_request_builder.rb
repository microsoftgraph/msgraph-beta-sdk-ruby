...
module MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::Item::Sections::Item
    ## 
    ...
    class OnenoteSectionItemRequestBuilder
        ...
        def microsoft_graph_copy_to_notebook()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::Item::Sections::Item::MicrosoftGraphCopyToNotebook::MicrosoftGraphCopyToNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSectionGroup method.
        def microsoft_graph_copy_to_section_group()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::Item::Sections::Item::MicrosoftGraphCopyToSectionGroup::MicrosoftGraphCopyToSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the pages property of the microsoft.graph.onenoteSection entity.
        def pages()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::Item::Sections::Item::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentNotebook property of the microsoft.graph.onenoteSection entity.
        def parent_notebook()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::Item::Sections::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def parent_section_group()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::Item::Sections::Item::ParentSectionGroup::ParentSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def pages_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::Item::Sections::Item::Pages::Item::OnenotePageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
