                    ...
                    module Item
                        ...
                        class NotebookItemRequestBuilder
                            ...
                            def microsoft_graph_copy_notebook()
                                return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::Item::MicrosoftGraphCopyNotebook::MicrosoftGraphCopyNotebookRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
