                ...
                module Pages
                    module Item
                        ...
                        class OnenotePageItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def copy_to_section()
                                return MicrosoftGraphBeta::Groups::Item::Onenote::Pages::Item::CopyToSection::CopyToSectionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the onenotePatchContent method.
                            def onenote_patch_content()
                                return MicrosoftGraphBeta::Groups::Item::Onenote::Pages::Item::OnenotePatchContent::OnenotePatchContentRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def preview()
                                return MicrosoftGraphBeta::Groups::Item::Onenote::Pages::Item::Preview::PreviewRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
