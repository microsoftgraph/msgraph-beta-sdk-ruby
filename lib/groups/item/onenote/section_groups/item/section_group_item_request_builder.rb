...
module MicrosoftGraphBeta::Groups::Item::Onenote::SectionGroups::Item
    ## 
    ...
    class SectionGroupItemRequestBuilder
        ...
        def parent_notebook()
            return MicrosoftGraphBeta::Groups::Item::Onenote::SectionGroups::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def parent_section_group()
            return MicrosoftGraphBeta::Groups::Item::Onenote::SectionGroups::Item::ParentSectionGroup::ParentSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def section_groups()
            return MicrosoftGraphBeta::Groups::Item::Onenote::SectionGroups::Item::SectionGroups::SectionGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
        def sections()
            return MicrosoftGraphBeta::Groups::Item::Onenote::SectionGroups::Item::Sections::SectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def section_groups_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Onenote::SectionGroups::Item::SectionGroups::Item::SectionGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
        ## @param id Unique identifier of the item
        ...
        def sections_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Onenote::SectionGroups::Item::Sections::Item::OnenoteSectionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property sectionGroups for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
