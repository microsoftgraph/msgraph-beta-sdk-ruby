...
module MicrosoftGraphBeta::Groups::Item::MicrosoftGraphEvaluateDynamicMembership
    ## 
    ...
    class EvaluateDynamicMembershipRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/microsoft.graph.evaluateDynamicMembership"
