...
module MicrosoftGraphBeta::Groups::Item::Calendar
    ## 
    ...
    class CalendarRequestBuilder
        ...
        def microsoft_graph_get_schedule()
            return MicrosoftGraphBeta::Groups::Item::Calendar::MicrosoftGraphGetSchedule::MicrosoftGraphGetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def calendar_permissions_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Calendar::CalendarPermissions::Item::CalendarPermissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the calendarView property of the microsoft.graph.calendar entity.
        ## @param id Unique identifier of the item
        ...
        def calendar_view_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Calendar::CalendarView::Item::EventItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def events_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["event%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::Calendar::Events::Item::EventItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Calendar::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the singleValueExtendedProperties property of the microsoft.graph.calendar entity.
        ## @param id Unique identifier of the item
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Calendar::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## The group's calendar. Read-only.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
