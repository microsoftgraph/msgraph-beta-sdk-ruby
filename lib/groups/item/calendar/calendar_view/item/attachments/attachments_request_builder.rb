...
module MicrosoftGraphBeta::Groups::Item::Calendar::CalendarView::Item::Attachments
    ...
    class AttachmentsRequestBuilder
        ...
        def microsoft_graph_create_upload_session()
            return MicrosoftGraphBeta::Groups::Item::Calendar::CalendarView::Item::Attachments::MicrosoftGraphCreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
