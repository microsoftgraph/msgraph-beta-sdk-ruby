                    ...
                    module Item
                        module Instances
                            ...
                            class InstancesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::Groups::Item::Calendar::CalendarView::Item::Instances::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the delta method.
                                def delta()
                                    return MicrosoftGraphBeta::Groups::Item::Calendar::CalendarView::Item::Instances::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the instances property of the microsoft.graph.event entity.
