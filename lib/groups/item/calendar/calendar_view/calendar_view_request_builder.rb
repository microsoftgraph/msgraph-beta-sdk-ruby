...
module MicrosoftGraphBeta::Groups::Item::Calendar::CalendarView
    ## 
    ...
    class CalendarViewRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Groups::Item::Calendar::CalendarView::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
