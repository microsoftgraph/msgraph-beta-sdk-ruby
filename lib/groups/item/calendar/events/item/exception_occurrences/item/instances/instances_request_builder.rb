...
module MicrosoftGraphBeta::Groups::Item::Calendar::Events::Item::ExceptionOccurrences::Item::Instances
    ## 
    ...
    class InstancesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Groups::Item::Calendar::Events::Item::ExceptionOccurrences::Item::Instances::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
