...
module MicrosoftGraphBeta::Groups::Item::Planner::Plans::Item::Buckets::Item
    ## 
    ...
    class PlannerBucketItemRequestBuilder
        ...
        def tasks()
            return MicrosoftGraphBeta::Groups::Item::Planner::Plans::Item::Buckets::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Planner::Plans::Item::Buckets::Item::Tasks::Item::PlannerTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property buckets for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
