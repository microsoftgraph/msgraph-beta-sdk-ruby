            ...
            module Planner
                module Plans
                    ...
                    class PlansRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Groups::Item::Planner::Plans::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the delta method.
                        def delta()
                            return MicrosoftGraphBeta::Groups::Item::Planner::Plans::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the plans property of the microsoft.graph.plannerGroup entity.
                        ...
                        def by_planner_plan_id(planner_plan_id)
                            ...
                            return MicrosoftGraphBeta::Groups::Item::Planner::Plans::Item::PlannerPlanItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
