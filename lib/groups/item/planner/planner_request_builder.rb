...
module MicrosoftGraphBeta::Groups::Item::Planner
    ## 
    ...
    class PlannerRequestBuilder
        ...
        def plans()
            return MicrosoftGraphBeta::Groups::Item::Planner::Plans::PlansRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PlannerGroup.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
