...
module MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item
    ...
    class ConversationThreadItemRequestBuilder
        ...
        def microsoft_graph_reply()
            return MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::MicrosoftGraphReply::MicrosoftGraphReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
