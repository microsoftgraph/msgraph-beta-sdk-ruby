...
module MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::Posts::Item::InReplyTo::MicrosoftGraphReply
    class ReplyPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "Post" => lambda {|n| @post = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Post.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
