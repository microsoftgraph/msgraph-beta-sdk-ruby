...
module MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::Posts::Item
    ## 
    ...
    class PostItemRequestBuilder
        ...
        def microsoft_graph_forward()
            return MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::Posts::Item::MicrosoftGraphForward::MicrosoftGraphForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reply method.
        def microsoft_graph_reply()
            return MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::Posts::Item::MicrosoftGraphReply::MicrosoftGraphReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
