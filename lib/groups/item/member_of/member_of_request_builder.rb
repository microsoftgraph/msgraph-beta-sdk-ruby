            ...
            module MemberOf
                ...
                class MemberOfRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def graph_administrative_unit()
                        return MicrosoftGraphBeta::Groups::Item::MemberOf::GraphAdministrativeUnit::GraphAdministrativeUnitRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to group.
                    def graph_group()
                        return MicrosoftGraphBeta::Groups::Item::MemberOf::GraphGroup::GraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the memberOf property of the microsoft.graph.group entity.
