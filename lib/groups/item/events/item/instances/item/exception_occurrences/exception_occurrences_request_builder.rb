...
module MicrosoftGraphBeta::Groups::Item::Events::Item::Instances::Item::ExceptionOccurrences
    ## 
    ...
    class ExceptionOccurrencesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Groups::Item::Events::Item::Instances::Item::ExceptionOccurrences::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
