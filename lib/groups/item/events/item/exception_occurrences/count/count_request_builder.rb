...
module MicrosoftGraphBeta::Groups::Item::Events::Item::ExceptionOccurrences::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/$count{?%24filter}"
