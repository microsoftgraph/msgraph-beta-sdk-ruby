...
module MicrosoftGraphBeta::Groups::Item::TransitiveMemberOf::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::TransitiveMemberOf::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
