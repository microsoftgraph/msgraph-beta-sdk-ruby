                ...
                module Add
                    ...
                    class AddRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Groups::Item::Sites::Add::AddPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Follow a user's site or multiple sites.
                        ## @param body The request body
