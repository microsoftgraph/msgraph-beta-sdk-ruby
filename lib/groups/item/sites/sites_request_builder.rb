...
module MicrosoftGraphBeta::Groups::Item::Sites
    ...
    class SitesRequestBuilder
        ...
        def microsoft_graph_add()
            return MicrosoftGraphBeta::Groups::Item::Sites::MicrosoftGraphAdd::AddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Groups::Item::Sites::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the remove method.
        def microsoft_graph_remove()
            return MicrosoftGraphBeta::Groups::Item::Sites::MicrosoftGraphRemove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
