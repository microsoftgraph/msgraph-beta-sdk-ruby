        ...
        module Item
            module Sites
                ...
                class SitesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def delta()
                        return MicrosoftGraphBeta::Groups::Item::Sites::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getAllSites method.
                    def get_all_sites()
                        return MicrosoftGraphBeta::Groups::Item::Sites::GetAllSites::GetAllSitesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
