            ...
            module Sites
                module Item
                    ...
                    class SiteItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def archive()
                            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Archive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def information_protection()
                            return MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::InformationProtectionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def last_modified_by_user()
                            return MicrosoftGraphBeta::Groups::Item::Sites::Item::LastModifiedByUser::LastModifiedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def page_templates()
                            return MicrosoftGraphBeta::Groups::Item::Sites::Item::PageTemplates::PageTemplatesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def unarchive()
                            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Unarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
