                            ...
                            module MailboxSettings
                                ...
                                class MailboxSettingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/lastModifiedByUser/mailboxSettings{?%24expand,%24select}")
                                    end
                                    ## 
                                    ...
                                    def to_patch_request_information(body, request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/lastModifiedByUser/mailboxSettings'
                                        request_info.path_parameters = @path_parameters
