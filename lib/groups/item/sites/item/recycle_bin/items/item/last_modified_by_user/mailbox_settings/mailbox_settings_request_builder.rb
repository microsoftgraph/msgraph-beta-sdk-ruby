                                    ...
                                    module MailboxSettings
                                        ...
                                        class MailboxSettingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/items/{recycleBinItem%2Did}/lastModifiedByUser/mailboxSettings{?%24select,%24expand}")
                                            end
                                            ## 
