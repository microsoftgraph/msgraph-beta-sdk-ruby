...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::SensitivityLabels
    ## 
    ...
    class SensitivityLabelsRequestBuilder
        ...
        def microsoft_graph_evaluate()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::SensitivityLabels::MicrosoftGraphEvaluate::MicrosoftGraphEvaluateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/sensitivityLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
