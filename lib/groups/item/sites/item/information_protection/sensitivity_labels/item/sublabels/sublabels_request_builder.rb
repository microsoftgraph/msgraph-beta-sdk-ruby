...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::SensitivityLabels::Item::Sublabels
    ...
    class SublabelsRequestBuilder
        ...
        def microsoft_graph_evaluate()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::SensitivityLabels::Item::Sublabels::MicrosoftGraphEvaluate::EvaluateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
