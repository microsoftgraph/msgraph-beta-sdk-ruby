...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::SensitivityLabels::Item::Sublabels::MicrosoftGraphEvaluate
    class EvaluatePostRequestBody
        ...
        ## @param value Value to set for the current_label property.
        ## @return a void
        ## 
        ...
        ## @param value Value to set for the discovered_sensitive_types property.
        ## @return a void
        ## 
