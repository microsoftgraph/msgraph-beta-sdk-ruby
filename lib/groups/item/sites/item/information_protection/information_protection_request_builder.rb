...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection
    ...
    class InformationProtectionRequestBuilder
        ...
        def decrypt_buffer()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::DecryptBuffer::DecryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the encryptBuffer method.
        def encrypt_buffer()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::EncryptBuffer::EncryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def sign_digest()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::SignDigest::SignDigestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def verify_signature()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::VerifySignature::VerifySignatureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
