...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::ThreatAssessmentRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/threatAssessmentRequests/$count{?%24search,%24filter}"
