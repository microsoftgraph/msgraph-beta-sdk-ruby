...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::Policy::Labels::MicrosoftGraphEvaluateRemoval
    ...
    class EvaluateRemovalRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels/microsoft.graph.evaluateRemoval"
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::Policy::Labels::MicrosoftGraphEvaluateRemoval::EvaluateRemovalResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Indicate to the consuming application what actions it should take to remove the label information. Given contentInfo as an input, which includes existing content metadata key/value pairs, the API returns an informationProtectionAction that contains some combination of one of more of the following: 
        ## @param body The request body
