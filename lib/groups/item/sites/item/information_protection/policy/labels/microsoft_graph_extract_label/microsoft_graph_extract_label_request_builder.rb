...
require_relative './microsoft_graph_extract_label'

module MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::Policy::Labels::MicrosoftGraphExtractLabel
    ## 
    ...
    class MicrosoftGraphExtractLabelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels/microsoft.graph.extractLabel"
