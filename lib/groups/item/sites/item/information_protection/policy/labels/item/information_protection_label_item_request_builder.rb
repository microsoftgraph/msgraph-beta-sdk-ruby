                        ...
                        module Policy
                            module Labels
                                module Item
                                    ...
                                    class InformationProtectionLabelItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}{?%24expand,%24select}")
                                        end
                                        ## 
                                        ...
                                        def to_delete_request_information(request_configuration=nil)
                                            ...
                                            request_info.url_template = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}'
                                        ...
                                        def with_url(raw_url)
                                            ...
                                            return InformationProtectionLabelItemRequestBuilder.new(raw_url, @request_adapter)
                                        end
