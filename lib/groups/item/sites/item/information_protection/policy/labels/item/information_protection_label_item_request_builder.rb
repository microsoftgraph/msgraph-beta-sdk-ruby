...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::Policy::Labels::Item
    ## 
    ...
    class InformationProtectionLabelItemRequestBuilder
        ...
        ## @param informationProtectionLabelId key: id of informationProtectionLabel
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, information_protection_label_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}{?%24select,%24expand}"
