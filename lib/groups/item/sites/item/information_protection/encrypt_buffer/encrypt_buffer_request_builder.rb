...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::EncryptBuffer
    ## 
    ...
    class EncryptBufferRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/microsoft.graph.encryptBuffer"
