...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::InformationProtection::Bitlocker::RecoveryKeys::Item
    ## 
    ...
    class BitlockerRecoveryKeyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, bitlocker_recovery_key_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey%2Did}{?%24select,%24expand}"
