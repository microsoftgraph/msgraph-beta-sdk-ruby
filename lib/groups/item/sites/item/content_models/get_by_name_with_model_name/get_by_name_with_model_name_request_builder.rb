                    ...
                    module ContentModels
                        module GetByNameWithModelName
                            ...
                            class GetByNameWithModelNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def add_to_drive()
                                    return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentModels::GetByNameWithModelName::AddToDrive::AddToDriveRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the getAppliedDrives method.
                                def get_applied_drives()
                                    return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentModels::GetByNameWithModelName::GetAppliedDrives::GetAppliedDrivesRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the removeFromDrive method.
                                def remove_from_drive()
                                    return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentModels::GetByNameWithModelName::RemoveFromDrive::RemoveFromDriveRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter, model_name=nil)
                                    super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentModels/getByName(modelName='{modelName}')")
                                end
                                ## 
