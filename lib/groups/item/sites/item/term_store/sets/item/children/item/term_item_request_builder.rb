...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::Sets::Item::Children::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def children()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::Sets::Item::Children::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def relations()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::Sets::Item::Children::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::Sets::Item::Children::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::Sets::Item::Children::Item::Children::Item::TermItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::Sets::Item::Children::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property children for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
