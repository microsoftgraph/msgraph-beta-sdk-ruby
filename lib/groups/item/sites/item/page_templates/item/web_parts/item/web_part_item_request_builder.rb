                                ...
                                module Item
                                    ...
                                    class WebPartItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def get_position_of_web_part()
                                            return MicrosoftGraphBeta::Groups::Item::Sites::Item::PageTemplates::Item::WebParts::Item::GetPositionOfWebPart::GetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/webParts/{webPart%2Did}{?%24expand,%24select}")
                                        end
                                        ## 
