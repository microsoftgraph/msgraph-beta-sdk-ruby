                            ...
                            module CanvasLayout
                                ...
                                class CanvasLayoutRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def horizontal_sections()
                                        return MicrosoftGraphBeta::Groups::Item::Sites::Item::PageTemplates::Item::CanvasLayout::HorizontalSections::HorizontalSectionsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def vertical_section()
                                        return MicrosoftGraphBeta::Groups::Item::Sites::Item::PageTemplates::Item::CanvasLayout::VerticalSection::VerticalSectionRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout{?%24expand,%24select}")
                                    end
                                    ## 
