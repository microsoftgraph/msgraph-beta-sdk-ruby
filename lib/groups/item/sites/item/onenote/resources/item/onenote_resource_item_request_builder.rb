...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::Resources::Item
    ## 
    ...
    class OnenoteResourceItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::Resources::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
