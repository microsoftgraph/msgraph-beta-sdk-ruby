                    ...
                    module Onenote
                        module Notebooks
                            ...
                            class NotebooksRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::Notebooks::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the getNotebookFromWebUrl method.
                                def get_notebook_from_web_url()
                                    return MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::Notebooks::GetNotebookFromWebUrl::GetNotebookFromWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the notebooks property of the microsoft.graph.onenote entity.
                                ...
                                def get(request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::NotebookCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
