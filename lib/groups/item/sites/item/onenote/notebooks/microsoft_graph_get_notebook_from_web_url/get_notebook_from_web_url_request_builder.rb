...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::Notebooks::MicrosoftGraphGetNotebookFromWebUrl
    ## 
    ...
    class GetNotebookFromWebUrlRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::CopyNotebookModel.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Retrieve the properties and relationships of a notebook object by using its URL path. The location can be user notebooks on Microsoft 365, group notebooks, or SharePoint site-hosted team notebooks on Microsoft 365.
        ## @param body The request body
