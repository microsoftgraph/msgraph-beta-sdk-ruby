...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::Notebooks::Item::SectionGroups::Item::Sections::Item::Pages::Item::MicrosoftGraphOnenotePatchContent
    class OnenotePatchContentPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "commands" => lambda {|n| @commands = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OnenotePatchContentCommand.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
