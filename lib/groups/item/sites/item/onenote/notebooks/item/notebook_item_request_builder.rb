...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::Notebooks::Item
    ...
    class NotebookItemRequestBuilder
        ...
        def microsoft_graph_copy_notebook()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::Notebooks::Item::MicrosoftGraphCopyNotebook::CopyNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
