...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::SectionGroups::Item::Sections::Item
    ...
    class OnenoteSectionItemRequestBuilder
        ...
        def microsoft_graph_copy_to_notebook()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::SectionGroups::Item::Sections::Item::MicrosoftGraphCopyToNotebook::CopyToNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSectionGroup method.
        def microsoft_graph_copy_to_section_group()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::SectionGroups::Item::Sections::Item::MicrosoftGraphCopyToSectionGroup::CopyToSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
