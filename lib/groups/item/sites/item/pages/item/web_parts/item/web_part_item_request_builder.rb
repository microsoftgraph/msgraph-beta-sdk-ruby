...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::WebParts::Item
    ...
    class WebPartItemRequestBuilder
        ...
        def get_position_of_web_part()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::WebParts::Item::GetPositionOfWebPart::GetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
