...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::WebParts::Item
    ## 
    ...
    class WebPartItemRequestBuilder
        ...
        def microsoft_graph_get_position_of_web_part()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::WebParts::Item::MicrosoftGraphGetPositionOfWebPart::GetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, web_part_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{sitePage%2Did}/webParts/{webPart%2Did}{?%24select,%24expand}"
