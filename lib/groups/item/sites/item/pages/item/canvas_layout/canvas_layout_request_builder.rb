...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::CanvasLayout
    ## 
    ...
    class CanvasLayoutRequestBuilder
        ...
        def horizontal_sections()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::CanvasLayout::HorizontalSections::HorizontalSectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def vertical_section()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::CanvasLayout::VerticalSection::VerticalSectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout{?%24select,%24expand}"
        ...
        def horizontal_sections_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::CanvasLayout::HorizontalSections::Item::HorizontalSectionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
