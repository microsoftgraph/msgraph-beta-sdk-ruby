...
require_relative './item'
require_relative './microsoft_graph_get_position_of_web_part/get_position_of_web_part_request_builder'

module MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::CanvasLayout::VerticalSection::Webparts::Item
    ## 
    ...
    class WebPartItemRequestBuilder
        ...
        def microsoft_graph_get_position_of_web_part()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::CanvasLayout::VerticalSection::Webparts::Item::MicrosoftGraphGetPositionOfWebPart::GetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param webPartId key: id of webPart
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, web_part_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/verticalSection/webparts/{webPart%2Did}{?%24select,%24expand}"
