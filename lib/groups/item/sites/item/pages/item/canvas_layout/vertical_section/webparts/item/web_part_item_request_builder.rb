...
require_relative './item'
require_relative './microsoft_graph_get_position_of_web_part/microsoft_graph_get_position_of_web_part_request_builder'
...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::CanvasLayout::VerticalSection::Webparts::Item
    ...
    class WebPartItemRequestBuilder
        ...
        def microsoft_graph_get_position_of_web_part()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::CanvasLayout::VerticalSection::Webparts::Item::MicrosoftGraphGetPositionOfWebPart::MicrosoftGraphGetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
