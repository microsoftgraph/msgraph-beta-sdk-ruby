                                ...
                                module Item
                                    module DriveItem
                                        ...
                                        class DriveItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def content()
                                                return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Items::Item::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            # Provides operations to manage the media for the group entity.
                                            def content_stream()
                                                return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Items::Item::DriveItem::ContentStream::ContentStreamRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
