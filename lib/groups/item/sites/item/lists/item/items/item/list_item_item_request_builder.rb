...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Items::Item
    ...
    class ListItemItemRequestBuilder
        ...
        def microsoft_graph_create_link()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Items::Item::MicrosoftGraphCreateLink::CreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
