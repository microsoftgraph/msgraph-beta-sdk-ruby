                                    ...
                                    module DocumentSetVersions
                                        module Item
                                            ...
                                            class DocumentSetVersionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def fields()
                                                    return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Items::Item::DocumentSetVersions::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                # Provides operations to call the restore method.
                                                def restore()
                                                    return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Items::Item::DocumentSetVersions::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
