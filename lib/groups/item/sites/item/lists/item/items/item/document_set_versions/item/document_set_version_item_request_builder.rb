...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Items::Item::DocumentSetVersions::Item
    ...
    class DocumentSetVersionItemRequestBuilder
        ...
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Items::Item::DocumentSetVersions::Item::MicrosoftGraphRestore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
