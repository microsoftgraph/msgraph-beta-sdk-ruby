...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item
    ## 
    ...
    class ListItemRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the columns property of the microsoft.graph.list entity.
        def columns()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Columns::ColumnsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the contentTypes property of the microsoft.graph.list entity.
        def content_types()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::ContentTypes::ContentTypesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the drive property of the microsoft.graph.list entity.
        def drive()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Drive::DriveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the items property of the microsoft.graph.list entity.
        def items()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.list entity.
        def operations()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def subscriptions()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Subscriptions::SubscriptionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def columns_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Columns::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def content_types_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::ContentTypes::Item::ContentTypeItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def items_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Items::Item::ListItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.list entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Operations::Item::RichLongRunningOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def subscriptions_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Subscriptions::Item::SubscriptionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property lists for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
