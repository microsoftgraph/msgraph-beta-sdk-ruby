...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Subscriptions::Item
    ## 
    ...
    class SubscriptionItemRequestBuilder
        ...
        def microsoft_graph_reauthorize()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Subscriptions::Item::MicrosoftGraphReauthorize::MicrosoftGraphReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
