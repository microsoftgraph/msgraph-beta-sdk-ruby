...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes::Item::MicrosoftGraphCopyToDefaultContentLocation
    class CopyToDefaultContentLocationPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "sourceFile" => lambda {|n| @source_file = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemReference.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
