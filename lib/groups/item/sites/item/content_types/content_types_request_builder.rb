...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes
    ## 
    ...
    class ContentTypesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addCopy method.
        def microsoft_graph_add_copy()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes::MicrosoftGraphAddCopy::MicrosoftGraphAddCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addCopyFromContentTypeHub method.
        def microsoft_graph_add_copy_from_content_type_hub()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes::MicrosoftGraphAddCopyFromContentTypeHub::MicrosoftGraphAddCopyFromContentTypeHubRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getCompatibleHubContentTypes method.
        def microsoft_graph_get_compatible_hub_content_types()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes::MicrosoftGraphGetCompatibleHubContentTypes::MicrosoftGraphGetCompatibleHubContentTypesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ContentTypeCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
