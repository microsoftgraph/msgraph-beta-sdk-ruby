...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes
    ...
    class ContentTypesRequestBuilder
        ...
        def microsoft_graph_add_copy()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes::MicrosoftGraphAddCopy::AddCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addCopyFromContentTypeHub method.
        def microsoft_graph_add_copy_from_content_type_hub()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes::MicrosoftGraphAddCopyFromContentTypeHub::AddCopyFromContentTypeHubRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getCompatibleHubContentTypes method.
        def microsoft_graph_get_compatible_hub_content_types()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes::MicrosoftGraphGetCompatibleHubContentTypes::GetCompatibleHubContentTypesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
