...
require_relative './microsoft_graph_revoke_grants/revoke_grants_request_builder'
...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Permissions::Item
    ...
    class PermissionItemRequestBuilder
        ...
        def microsoft_graph_grant()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Permissions::Item::MicrosoftGraphGrant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the revokeGrants method.
        def microsoft_graph_revoke_grants()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Permissions::Item::MicrosoftGraphRevokeGrants::RevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
