...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Permissions::Item::MicrosoftGraphRevokeGrants
    ## 
    ...
    class RevokeGrantsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/permissions/{permission%2Did}/microsoft.graph.revokeGrants"
