...
module MicrosoftGraphBeta::Groups::Item::TransitiveMembers
    ...
    class TransitiveMembersRequestBuilder
        ...
        def microsoft_graph_application()
            return MicrosoftGraphBeta::Groups::Item::TransitiveMembers::MicrosoftGraphApplication::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to device.
        def microsoft_graph_device()
            return MicrosoftGraphBeta::Groups::Item::TransitiveMembers::MicrosoftGraphDevice::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def microsoft_graph_group()
            return MicrosoftGraphBeta::Groups::Item::TransitiveMembers::MicrosoftGraphGroup::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to orgContact.
        def microsoft_graph_org_contact()
            return MicrosoftGraphBeta::Groups::Item::TransitiveMembers::MicrosoftGraphOrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to servicePrincipal.
        def microsoft_graph_service_principal()
            return MicrosoftGraphBeta::Groups::Item::TransitiveMembers::MicrosoftGraphServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::Groups::Item::TransitiveMembers::MicrosoftGraphUser::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
