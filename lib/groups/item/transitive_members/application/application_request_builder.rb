...
module MicrosoftGraphBeta::Groups::Item::TransitiveMembers::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::TransitiveMembers::Application::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
