...
module MicrosoftGraphBeta::Groups::Item::TransitiveMembers::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::TransitiveMembers::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
