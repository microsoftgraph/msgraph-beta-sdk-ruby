...
module MicrosoftGraphBeta::Groups::Item::Owners::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Owners::Application::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
