...
module MicrosoftGraphBeta::Groups::Item::Owners::MicrosoftGraphApplication
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Owners::MicrosoftGraphApplication::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
