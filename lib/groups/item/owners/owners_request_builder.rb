...
module MicrosoftGraphBeta::Groups::Item::Owners
    ...
    class OwnersRequestBuilder
        ...
        def application()
            return MicrosoftGraphBeta::Groups::Item::Owners::Application::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def device()
            return MicrosoftGraphBeta::Groups::Item::Owners::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def group()
            return MicrosoftGraphBeta::Groups::Item::Owners::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to orgContact.
        def org_contact()
            return MicrosoftGraphBeta::Groups::Item::Owners::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraphBeta::Groups::Item::Owners::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Groups::Item::Owners::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
