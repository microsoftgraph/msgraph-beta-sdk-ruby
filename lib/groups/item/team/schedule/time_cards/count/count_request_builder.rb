...
module MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeCards::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/schedule/timeCards/$count{?%24search,%24filter}"
