...
module MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeCards::Item
    ...
    class TimeCardItemRequestBuilder
        ...
        def clock_out()
            return MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeCards::Item::ClockOut::ClockOutRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the confirm method.
        def confirm()
            return MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeCards::Item::Confirm::ConfirmRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the endBreak method.
        def end_break()
            return MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeCards::Item::EndBreak::EndBreakRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def start_break()
            return MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeCards::Item::StartBreak::StartBreakRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
