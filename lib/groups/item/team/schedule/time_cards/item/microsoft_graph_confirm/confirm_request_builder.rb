...
module MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeCards::Item::MicrosoftGraphConfirm
    ## 
    ...
    class ConfirmRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/schedule/timeCards/{timeCard%2Did}/microsoft.graph.confirm"
