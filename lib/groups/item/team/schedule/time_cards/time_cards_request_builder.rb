...
module MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeCards
    ...
    class TimeCardsRequestBuilder
        ...
        def microsoft_graph_clock_in()
            return MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeCards::MicrosoftGraphClockIn::MicrosoftGraphClockInRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
