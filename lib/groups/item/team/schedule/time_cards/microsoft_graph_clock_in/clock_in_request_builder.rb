...
module MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeCards::MicrosoftGraphClockIn
    ## 
    ...
    class ClockInRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/schedule/timeCards/microsoft.graph.clockIn"
