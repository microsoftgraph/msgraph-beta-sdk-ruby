                        ...
                        module CheckMemberObjects
                            ...
                            class CheckMemberObjectsRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    ...
                                    @url_template = "{+baseurl}/groups/{group%2Did}/team/permissionGrants/{resourceSpecificPermissionGrant%2Did}/checkMemberObjects"
                                ...
                                def post(body, request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Groups::Item::Team::PermissionGrants::Item::CheckMemberObjects::CheckMemberObjectsResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Invoke action checkMemberObjects
                                ## @param body The request body
