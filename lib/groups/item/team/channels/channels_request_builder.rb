            ...
            module Team
                module Channels
                    ...
                    class ChannelsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def all_messages()
                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::AllMessages::AllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get_all_messages()
                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::GetAllMessages::GetAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getAllRetainedMessages method.
                        def get_all_retained_messages()
                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::GetAllRetainedMessages::GetAllRetainedMessagesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the channels property of the microsoft.graph.team entity.
