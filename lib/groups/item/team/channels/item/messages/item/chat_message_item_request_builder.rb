...
module MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Messages::Item
    ...
    class ChatMessageItemRequestBuilder
        ...
        def microsoft_graph_set_reaction()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Messages::Item::MicrosoftGraphSetReaction::SetReactionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the softDelete method.
        def microsoft_graph_soft_delete()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Messages::Item::MicrosoftGraphSoftDelete::SoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the undoSoftDelete method.
        def microsoft_graph_undo_soft_delete()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Messages::Item::MicrosoftGraphUndoSoftDelete::UndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unsetReaction method.
        def microsoft_graph_unset_reaction()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Messages::Item::MicrosoftGraphUnsetReaction::UnsetReactionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
