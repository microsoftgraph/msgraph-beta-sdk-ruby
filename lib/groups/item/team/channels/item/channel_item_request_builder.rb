                ...
                module Channels
                    module Item
                        ...
                        class ChannelItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def all_members()
                                return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::AllMembers::AllMembersRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the archive method.
                            def archive()
                                return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Archive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def planner()
                                return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Planner::PlannerRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def unarchive()
                                return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Unarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
