...
module MicrosoftGraphBeta::Groups::Item::Team::Channels::Item
    ...
    class ChannelItemRequestBuilder
        ...
        def microsoft_graph_complete_migration()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::MicrosoftGraphCompleteMigration::MicrosoftGraphCompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName::MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the provisionEmail method.
        def microsoft_graph_provision_email()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::MicrosoftGraphProvisionEmail::MicrosoftGraphProvisionEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeEmail method.
        def microsoft_graph_remove_email()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::MicrosoftGraphRemoveEmail::MicrosoftGraphRemoveEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
