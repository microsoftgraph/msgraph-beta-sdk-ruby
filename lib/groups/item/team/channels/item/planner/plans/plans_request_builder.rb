                        ...
                        module Planner
                            module Plans
                                ...
                                class PlansRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Planner::Plans::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the delta method.
                                    def delta()
                                        return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Planner::Plans::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the plans property of the microsoft.graph.teamsChannelPlanner entity.
                                    ...
                                    def by_planner_plan_id(planner_plan_id)
                                        ...
                                        return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Planner::Plans::Item::PlannerPlanItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/planner/plans{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                    end
                                    ## 
