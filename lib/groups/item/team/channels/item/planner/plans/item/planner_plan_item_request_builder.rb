                            ...
                            module Plans
                                module Item
                                    ...
                                    class PlannerPlanItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def archive()
                                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Planner::Plans::Item::Archive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to manage the buckets property of the microsoft.graph.plannerPlan entity.
                                        def buckets()
                                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Planner::Plans::Item::Buckets::BucketsRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to manage the details property of the microsoft.graph.plannerPlan entity.
                                        def details()
                                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Planner::Plans::Item::Details::DetailsRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the moveToContainer method.
                                        def move_to_container()
                                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Planner::Plans::Item::MoveToContainer::MoveToContainerRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to manage the tasks property of the microsoft.graph.plannerPlan entity.
                                        def tasks()
                                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Planner::Plans::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the unarchive method.
                                        def unarchive()
                                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Planner::Plans::Item::Unarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/planner/plans/{plannerPlan%2Did}{?%24expand,%24select}")
                                        end
                                        ## 
