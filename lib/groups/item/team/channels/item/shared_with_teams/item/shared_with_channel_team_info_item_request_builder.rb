...
module MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::SharedWithTeams::Item
    ## 
    ...
    class SharedWithChannelTeamInfoItemRequestBuilder
        ...
        def allowed_members()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::SharedWithTeams::Item::AllowedMembers::AllowedMembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
