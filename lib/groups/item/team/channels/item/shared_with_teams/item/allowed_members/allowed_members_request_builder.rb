                            ...
                            module Item
                                module AllowedMembers
                                    ...
                                    class AllowedMembersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def count()
                                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::SharedWithTeams::Item::AllowedMembers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ## Provides operations to manage the allowedMembers property of the microsoft.graph.sharedWithChannelTeamInfo entity.
                                        ...
                                        def by_conversation_member_id(conversation_member_id)
                                            ...
                                            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::SharedWithTeams::Item::AllowedMembers::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                        end
                                        ## 
