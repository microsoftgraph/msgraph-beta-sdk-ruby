            ...
            module Team
                module Members
                    ...
                    class MembersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def add()
                            return MicrosoftGraphBeta::Groups::Item::Team::Members::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to count the resources in the collection.
                        def count()
                            return MicrosoftGraphBeta::Groups::Item::Team::Members::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the remove method.
                        def remove()
                            return MicrosoftGraphBeta::Groups::Item::Team::Members::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the members property of the microsoft.graph.team entity.
