...
module MicrosoftGraphBeta::Groups::Item::Team::Owners
    ## 
    ...
    class OwnersRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/owners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
