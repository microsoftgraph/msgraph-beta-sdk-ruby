            ...
            module Team
                module AllChannels
                    ...
                    class AllChannelsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Groups::Item::Team::AllChannels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the allChannels property of the microsoft.graph.team entity.
                        ...
                        def by_channel_id(channel_id)
                            ...
                            return MicrosoftGraphBeta::Groups::Item::Team::AllChannels::Item::ChannelItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
