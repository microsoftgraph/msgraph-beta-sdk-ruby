                            ...
                            module HostedContents
                                module Item
                                    ...
                                    class ChatMessageHostedContentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def content()
                                            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages::Item::HostedContents::Item::Value::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
