                        ...
                        module Item
                            module Replies
                                ...
                                class RepliesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages::Item::Replies::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the delta method.
                                    def delta()
                                        return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages::Item::Replies::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the forwardToChat method.
                                    def forward_to_chat()
                                        return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages::Item::Replies::ForwardToChat::ForwardToChatRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the replyWithQuote method.
                                    def reply_with_quote()
                                        return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages::Item::Replies::ReplyWithQuote::ReplyWithQuoteRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the replies property of the microsoft.graph.chatMessage entity.
