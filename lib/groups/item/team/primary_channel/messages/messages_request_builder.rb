...
module MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages
    ## 
    ...
    class MessagesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
