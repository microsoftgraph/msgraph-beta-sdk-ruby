                ...
                module PrimaryChannel
                    module Messages
                        ...
                        class MessagesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the delta method.
                            def delta()
                                return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the forwardToChat method.
                            def forward_to_chat()
                                return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages::ForwardToChat::ForwardToChatRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the replyWithQuote method.
                            def reply_with_quote()
                                return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Messages::ReplyWithQuote::ReplyWithQuoteRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the messages property of the microsoft.graph.channel entity.
