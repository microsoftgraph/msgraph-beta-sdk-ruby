...
module MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel
    ...
    class PrimaryChannelRequestBuilder
        ...
        def microsoft_graph_complete_migration()
            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::MicrosoftGraphCompleteMigration::CompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name()
            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName::DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the provisionEmail method.
        def microsoft_graph_provision_email()
            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::MicrosoftGraphProvisionEmail::ProvisionEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeEmail method.
        def microsoft_graph_remove_email()
            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::MicrosoftGraphRemoveEmail::RemoveEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
