                ...
                module PrimaryChannel
                    ...
                    class PrimaryChannelRequestBuilder
                        ...
                        def complete_migration()
                            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::CompleteMigration::CompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the doesUserHaveAccess method.
                        def does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name()
                            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName::DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def provision_email()
                            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::ProvisionEmail::ProvisionEmailRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the removeEmail method.
                        def remove_email()
                            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::RemoveEmail::RemoveEmailRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
