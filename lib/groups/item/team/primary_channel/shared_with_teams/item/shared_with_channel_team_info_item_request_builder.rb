...
module MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::SharedWithTeams::Item
    ## 
    ...
    class SharedWithChannelTeamInfoItemRequestBuilder
        ...
        def allowed_members()
            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::SharedWithTeams::Item::AllowedMembers::AllowedMembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def allowed_members_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::SharedWithTeams::Item::AllowedMembers::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
