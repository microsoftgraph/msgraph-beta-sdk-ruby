...
module MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Tabs::Item
    ## 
    ...
    class TeamsTabItemRequestBuilder
        ...
        def teams_app()
            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Tabs::Item::TeamsApp::TeamsAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
