                ...
                module PrimaryChannel
                    module Planner
                        ...
                        class PlannerRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def plans()
                                return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::Planner::Plans::PlansRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/planner{?%24expand,%24select}")
                            end
                            ## 
