        ...
        module Item
            ...
            class GroupItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def delete_password_single_sign_on_credentials()
                    return MicrosoftGraphBeta::Groups::Item::DeletePasswordSingleSignOnCredentials::DeletePasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def get_password_single_sign_on_credentials()
                    return MicrosoftGraphBeta::Groups::Item::GetPasswordSingleSignOnCredentials::GetPasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def service_provisioning_errors()
                    return MicrosoftGraphBeta::Groups::Item::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
