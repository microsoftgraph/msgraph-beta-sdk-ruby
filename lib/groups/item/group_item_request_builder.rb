...
require_relative './microsoft_graph_evaluate_dynamic_membership/microsoft_graph_evaluate_dynamic_membership_request_builder'
...
module MicrosoftGraphBeta::Groups::Item
    ## 
    ...
    class GroupItemRequestBuilder
        ...
        def microsoft_graph_add_favorite()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphAddFavorite::MicrosoftGraphAddFavoriteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assignLicense method.
        def microsoft_graph_assign_license()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphAssignLicense::MicrosoftGraphAssignLicenseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkGrantedPermissionsForApp method.
        def microsoft_graph_check_granted_permissions_for_app()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphCheckGrantedPermissionsForApp::MicrosoftGraphCheckGrantedPermissionsForAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberGroups method.
        def microsoft_graph_check_member_groups()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphCheckMemberGroups::MicrosoftGraphCheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def microsoft_graph_check_member_objects()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphCheckMemberObjects::MicrosoftGraphCheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the evaluateDynamicMembership method.
        def microsoft_graph_evaluate_dynamic_membership()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphEvaluateDynamicMembership::MicrosoftGraphEvaluateDynamicMembershipRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberGroups method.
        def microsoft_graph_get_member_groups()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphGetMemberGroups::MicrosoftGraphGetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def microsoft_graph_get_member_objects()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphGetMemberObjects::MicrosoftGraphGetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeFavorite method.
        def microsoft_graph_remove_favorite()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphRemoveFavorite::MicrosoftGraphRemoveFavoriteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the renew method.
        def microsoft_graph_renew()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphRenew::MicrosoftGraphRenewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resetUnseenCount method.
        def microsoft_graph_reset_unseen_count()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphResetUnseenCount::MicrosoftGraphResetUnseenCountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphRestore::MicrosoftGraphRestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the subscribeByMail method.
        def microsoft_graph_subscribe_by_mail()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphSubscribeByMail::MicrosoftGraphSubscribeByMailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unsubscribeByMail method.
        def microsoft_graph_unsubscribe_by_mail()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphUnsubscribeByMail::MicrosoftGraphUnsubscribeByMailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validateProperties method.
        def microsoft_graph_validate_properties()
            return MicrosoftGraphBeta::Groups::Item::MicrosoftGraphValidateProperties::MicrosoftGraphValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        @url_template
        ## 
        ## Gets an item from the MicrosoftGraphBeta.groups.item.acceptedSenders.item collection
        ...
        def accepted_senders_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::AcceptedSenders::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the appRoleAssignments property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def app_role_assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::AppRoleAssignments::Item::AppRoleAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the calendarView property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def calendar_view_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::CalendarView::Item::EventItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def conversations_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Conversations::Item::ConversationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def drives_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::DriveItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the endpoints property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def endpoints_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Endpoints::Item::EndpointItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the events property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def events_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["event%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::Events::Item::EventItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the extensions property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def group_lifecycle_policies_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::GroupLifecyclePolicies::Item::GroupLifecyclePolicyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the memberOf property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def member_of_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::MemberOf::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Gets an item from the MicrosoftGraphBeta.groups.item.members.item collection
        ## @param id Unique identifier of the item
        ## @return a directory_object_item_request_builder
        ## 
        def members_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::Members::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the membersWithLicenseErrors property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def members_with_license_errors_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::MembersWithLicenseErrors::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Gets an item from the MicrosoftGraphBeta.groups.item.owners.item collection
        ## @param id Unique identifier of the item
        ## @return a directory_object_item_request_builder
        ## 
        def owners_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::Owners::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def permission_grants_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::PermissionGrants::Item::ResourceSpecificPermissionGrantItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the photos property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def photos_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Photos::Item::ProfilePhotoItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def settings_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Settings::Item::DirectorySettingItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sites property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def sites_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::SiteItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the threads property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def threads_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::ConversationThreadItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Deletes a group. When deleted, Microsoft 365 groups are moved to a temporary container and can be restored within 30 days. After that time, they are permanently deleted. This isn't applicable to Security groups and Distribution groups which are permanently deleted immediately. To learn more, see deletedItems.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def transitive_member_of_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::TransitiveMemberOf::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the transitiveMembers property of the microsoft.graph.group entity.
        ## @param id Unique identifier of the item
        ...
        def transitive_members_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::TransitiveMembers::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
