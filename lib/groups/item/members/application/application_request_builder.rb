...
module MicrosoftGraphBeta::Groups::Item::Members::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Members::Application::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
