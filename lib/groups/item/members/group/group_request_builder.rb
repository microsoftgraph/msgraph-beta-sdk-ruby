...
module MicrosoftGraphBeta::Groups::Item::Members::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Members::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
