...
module MicrosoftGraphBeta::Groups::Item::Members::MicrosoftGraphServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Members::MicrosoftGraphServicePrincipal::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
