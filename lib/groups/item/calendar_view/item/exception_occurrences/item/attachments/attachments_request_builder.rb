                        ...
                        module Item
                            module Attachments
                                ...
                                class AttachmentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Groups::Item::CalendarView::Item::ExceptionOccurrences::Item::Attachments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the createUploadSession method.
                                    def create_upload_session()
                                        return MicrosoftGraphBeta::Groups::Item::CalendarView::Item::ExceptionOccurrences::Item::Attachments::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the attachments property of the microsoft.graph.event entity.
                                    ...
                                    def by_attachment_id(attachment_id)
                                        ...
                                        return MicrosoftGraphBeta::Groups::Item::CalendarView::Item::ExceptionOccurrences::Item::Attachments::Item::AttachmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}")
                                    end
                                    ## 
                                    ...
                                    def to_post_request_information(body, request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments'
                                        request_info.path_parameters = @path_parameters
