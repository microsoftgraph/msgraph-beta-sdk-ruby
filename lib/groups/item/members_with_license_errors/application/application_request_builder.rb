...
module MicrosoftGraphBeta::Groups::Item::MembersWithLicenseErrors::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::MembersWithLicenseErrors::Application::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
