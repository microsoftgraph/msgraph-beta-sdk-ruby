...
module MicrosoftGraphBeta::Groups::Item::MembersWithLicenseErrors::MicrosoftGraphApplication
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::MembersWithLicenseErrors::MicrosoftGraphApplication::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
