...
module MicrosoftGraphBeta::Groups::Item::GetMemberGroups
    ## 
    ...
    class GetMemberGroupsRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Groups::Item::GetMemberGroups::GetMemberGroupsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Return all the group IDs for the groups that the specified user, group, service principal, organizational contact, device, or directory object is a member of. This function is transitive.
        ## @param body The request body
