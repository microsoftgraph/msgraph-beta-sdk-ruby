...
module MicrosoftGraphBeta::Groups::Item::Threads::Item
    ## 
    ...
    class ConversationThreadItemRequestBuilder
        ...
        def microsoft_graph_reply()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::MicrosoftGraphReply::MicrosoftGraphReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def posts()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::PostsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def posts_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::PostItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property threads for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
