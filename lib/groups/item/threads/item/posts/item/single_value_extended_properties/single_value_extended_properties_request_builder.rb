                        ...
                        module Item
                            module SingleValueExtendedProperties
                                ...
                                class SingleValueExtendedPropertiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::SingleValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the singleValueExtendedProperties property of the microsoft.graph.post entity.
