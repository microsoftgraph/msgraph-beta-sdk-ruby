...
module MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::Mentions::Item
    ## 
    ...
    class MentionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, mention_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/mentions/{mention%2Did}{?%24select,%24expand}"
