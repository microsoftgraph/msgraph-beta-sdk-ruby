...
module MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item
    ...
    class PostItemRequestBuilder
        ...
        def microsoft_graph_forward()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::MicrosoftGraphForward::ForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reply method.
        def microsoft_graph_reply()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::MicrosoftGraphReply::ReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
