...
module MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item
    ## 
    ...
    class PostItemRequestBuilder
        ...
        def attachments()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::Attachments::AttachmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the extensions property of the microsoft.graph.post entity.
        def extensions()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::Extensions::ExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the inReplyTo property of the microsoft.graph.post entity.
        def in_reply_to()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::InReplyToRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the mentions property of the microsoft.graph.post entity.
        def mentions()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::Mentions::MentionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the forward method.
        def microsoft_graph_forward()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::MicrosoftGraphForward::MicrosoftGraphForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reply method.
        def microsoft_graph_reply()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::MicrosoftGraphReply::MicrosoftGraphReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.post entity.
        def multi_value_extended_properties()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def attachments_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::Attachments::Item::AttachmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def mentions_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::Mentions::Item::MentionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.post entity.
        ## @param id Unique identifier of the item
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get posts from groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
