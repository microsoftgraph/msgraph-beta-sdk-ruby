...
module MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo
    ...
    class InReplyToRequestBuilder
        ...
        def microsoft_graph_forward()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::MicrosoftGraphForward::MicrosoftGraphForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reply method.
        def microsoft_graph_reply()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::MicrosoftGraphReply::MicrosoftGraphReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
