...
require_relative './item/connector_group_item_request_builder'
    ...
    module OnPremisesPublishingProfiles
        module Item
            module ConnectorGroups
                ...
                class ConnectorGroupsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## 
                    def by_connector_group_id(connector_group_id)
                        raise StandardError, 'connector_group_id cannot be null' if connector_group_id.nil?
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectorGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectorGroups'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a connector_groups_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return ConnectorGroupsRequestBuilder.new(raw_url, @request_adapter)
                    end
