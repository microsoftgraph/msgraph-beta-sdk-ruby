...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::ConnectorGroups::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectorGroups/$count{?%24search,%24filter}"
