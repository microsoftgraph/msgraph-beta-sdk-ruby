...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::ConnectorGroups::Item
    ## 
    ...
    class ConnectorGroupItemRequestBuilder
        ...
        ## @param connectorGroupId key: id of connectorGroup
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, connector_group_id=nil)
