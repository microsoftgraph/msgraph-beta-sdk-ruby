...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::PublishedResources::Item
    ## 
    ...
    class PublishedResourceItemRequestBuilder
        ...
        def agent_groups()
            return MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::PublishedResources::Item::AgentGroups::AgentGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param publishedResourceId key: id of publishedResource
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, published_resource_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/publishedResources/{publishedResource%2Did}{?%24select,%24expand}"
