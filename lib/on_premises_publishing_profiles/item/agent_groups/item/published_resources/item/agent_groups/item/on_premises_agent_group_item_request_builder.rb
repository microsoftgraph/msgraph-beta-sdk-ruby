...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::AgentGroups::Item::PublishedResources::Item::AgentGroups::Item
    ## 
    ...
    class OnPremisesAgentGroupItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, on_premises_agent_group_id1=nil)
            ...
            @url_template = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups/{onPremisesAgentGroup%2Did1}"
