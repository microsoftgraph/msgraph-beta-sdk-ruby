...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::Connectors::Item::MemberOf::Item
    ## 
    ...
    class ConnectorGroupItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, connector_group_id=nil)
            ...
            @url_template = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectors/{connector%2Did}/memberOf/{connectorGroup%2Did}"
