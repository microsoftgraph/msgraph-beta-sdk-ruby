...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item
    ...
    class OnPremisesPublishingProfileItemRequestBuilder
        ...
        ## @param onPremisesPublishingProfileId key: id of onPremisesPublishingProfile
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, on_premises_publishing_profile_id=nil)
