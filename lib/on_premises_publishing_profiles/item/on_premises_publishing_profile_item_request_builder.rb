...
require_relative './application_segments/application_segments_request_builder'
...
module MicrosoftGraphBeta
    module OnPremisesPublishingProfiles
        module Item
            ...
            class OnPremisesPublishingProfileItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def application_segments()
                    return MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::ApplicationSegments::ApplicationSegmentsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}{?%24expand,%24select}")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return OnPremisesPublishingProfileItemRequestBuilder.new(raw_url, @request_adapter)
                end
