...
module MicrosoftGraphBeta::TermStore::Groups::Item::Sets::Item::Terms::Item::Relations::Item::ToTerm
    ## 
    ...
    class ToTermRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}"
