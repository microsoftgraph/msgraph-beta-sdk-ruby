...
module MicrosoftGraphBeta::TermStore::Groups::Item::Sets::Item::Children::Item::Relations::Item
    ## 
    ...
    class RelationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, relation_id=nil)
            ...
            @url_template = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}"
