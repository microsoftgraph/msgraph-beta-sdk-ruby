...
module MicrosoftGraphBeta::TermStore::Groups::Item::Sets::Item::Relations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/relations/$count{?%24search,%24filter}"
