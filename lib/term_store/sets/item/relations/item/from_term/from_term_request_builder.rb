...
module MicrosoftGraphBeta::TermStore::Sets::Item::Relations::Item::FromTerm
    ## 
    ...
    class FromTermRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/relations/{relation%2Did}/fromTerm{?%24select,%24expand}"
