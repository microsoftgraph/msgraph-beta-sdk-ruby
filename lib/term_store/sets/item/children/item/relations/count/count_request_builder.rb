...
module MicrosoftGraphBeta::TermStore::Sets::Item::Children::Item::Relations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/children/{term%2Did}/relations/$count{?%24search,%24filter}"
