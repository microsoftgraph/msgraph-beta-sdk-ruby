...
module MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::Relations::Item
    ## 
    ...
    class RelationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, relation_id=nil)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/relations/{relation%2Did}{?%24select,%24expand}"
