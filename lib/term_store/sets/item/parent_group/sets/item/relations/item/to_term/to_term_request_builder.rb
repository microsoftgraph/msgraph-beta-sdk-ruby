...
module MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::Relations::Item::ToTerm
    ## 
    ...
    class ToTermRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/relations/{relation%2Did}/toTerm{?%24select,%24expand}"
