...
module MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/$count{?%24search,%24filter}"
