...
module MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup
    ## 
    ...
    class ParentGroupRequestBuilder
        ...
        def sets()
            return MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::SetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup{?%24select,%24expand}"
        ...
        def sets_by_id(id)
            ...
            return MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::SetItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property parentGroup for termStore
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
