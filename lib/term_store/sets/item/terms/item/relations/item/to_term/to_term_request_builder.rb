...
module MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Relations::Item::ToTerm
    ## 
    ...
    class ToTermRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}"
