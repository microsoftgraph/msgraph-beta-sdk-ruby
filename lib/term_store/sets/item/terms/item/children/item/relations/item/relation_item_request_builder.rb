...
module MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Children::Item::Relations::Item
    ## 
    ...
    class RelationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, relation_id=nil)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}{?%24select,%24expand}"
