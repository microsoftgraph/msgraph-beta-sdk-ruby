...
module MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def children()
            return MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def relations()
            return MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Children::Item::TermItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}{?%24select,%24expand}"
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property terms for termStore
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
