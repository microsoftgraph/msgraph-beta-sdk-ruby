...
module MicrosoftGraphBeta::MobilityManagementPolicies::Item::IncludedGroups::Item
    ## 
    ...
    class GroupItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/mobilityManagementPolicies/{mobilityManagementPolicy%2Did}/includedGroups/{group%2Did}"
