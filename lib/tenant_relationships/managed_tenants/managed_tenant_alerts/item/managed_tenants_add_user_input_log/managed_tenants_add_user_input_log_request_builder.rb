            ...
            module ManagedTenantAlerts
                module Item
                    module ManagedTenantsAddUserInputLog
                        ...
                        class ManagedTenantsAddUserInputLogRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managedTenantAlerts/{managedTenantAlert%2Did}/managedTenants.addUserInputLog")
                            end
                            ## 
