...
require_relative './managed_tenants_add_user_input_log/managed_tenants_add_user_input_log_request_builder'
            ...
            module ManagedTenantAlerts
                module Item
                    ...
                    class ManagedTenantAlertItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def managed_tenants_add_user_input_log()
                            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagedTenantAlerts::Item::ManagedTenantsAddUserInputLog::ManagedTenantsAddUserInputLogRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the alertLogs property of the microsoft.graph.managedTenants.managedTenantAlert entity.
