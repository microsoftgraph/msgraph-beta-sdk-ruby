...
require_relative './microsoft_graph_managed_tenants_add_user_input_log'
    ...
    module TenantRelationships
        module ManagedTenants
            module ManagedTenantAlerts
                module Item
                    module MicrosoftGraphManagedTenantsAddUserInputLog
                        ## 
                        # Provides operations to call the addUserInputLog method.
                        class MicrosoftGraphManagedTenantsAddUserInputLogRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managedTenantAlerts/{managedTenantAlert%2Did}/microsoft.graph.managedTenants.addUserInputLog")
                            end
                            ## 
                            ...
                            ## @return a microsoft_graph_managed_tenants_add_user_input_log_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return MicrosoftGraphManagedTenantsAddUserInputLogRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
