                    ...
                    module Deployments
                        module Item
                            module TemplateStepVersion
                                ...
                                class TemplateStepVersionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managementTemplateStepVersions/{managementTemplateStepVersion%2Did}/deployments/{managementTemplateStepDeployment%2Did}/templateStepVersion{?%24select,%24expand}")
                                    end
                                    ## 
                                    ...
                                    ## @return a template_step_version_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return TemplateStepVersionRequestBuilder.new(raw_url, @request_adapter)
                                    end
