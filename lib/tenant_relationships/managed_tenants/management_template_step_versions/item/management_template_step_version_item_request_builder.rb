...
require_relative '../../../../models/managed_tenants/management_template_step_version'
...
require_relative './deployments/item/management_template_step_deployment_item_request_builder'
require_relative './item'
require_relative './template_step/template_step_request_builder'

module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementTemplateStepVersions::Item
    ## 
    ...
    class ManagementTemplateStepVersionItemRequestBuilder
        ...
        ## @param managementTemplateStepVersionId key: id of managementTemplateStepVersion
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, management_template_step_version_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateStepVersions/{managementTemplateStepVersion%2Did}{?%24select,%24expand}"
        ...
        ## @return a management_template_step_deployment_item_request_builder
        ## 
        def deployments_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["managementTemplateStepDeployment%2Did"] = id
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementTemplateStepVersions::Item::Deployments::Item::ManagementTemplateStepDeploymentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get managementTemplateStepVersions from tenantRelationships
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a Fiber of management_template_step_version
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementTemplateStepVersion.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
