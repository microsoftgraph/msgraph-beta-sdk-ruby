...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::AuditEvents::Item
    ## 
    ...
    class AuditEventItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, audit_event_id=nil)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/auditEvents/{auditEvent%2Did}{?%24select,%24expand}"
