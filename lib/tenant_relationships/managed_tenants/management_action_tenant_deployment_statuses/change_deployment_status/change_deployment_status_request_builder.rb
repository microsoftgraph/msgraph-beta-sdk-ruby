...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementActionTenantDeploymentStatuses::ChangeDeploymentStatus
    ...
    class ChangeDeploymentStatusRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/managementActionTenantDeploymentStatuses/microsoft.graph.managedTenants.changeDeploymentStatus"
