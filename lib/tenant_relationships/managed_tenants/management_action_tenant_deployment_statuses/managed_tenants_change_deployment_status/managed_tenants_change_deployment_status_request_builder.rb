                ...
                module ManagedTenantsChangeDeploymentStatus
                    ...
                    class ManagedTenantsChangeDeploymentStatusRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managementActionTenantDeploymentStatuses/managedTenants.changeDeploymentStatus")
                        end
                        ## 
