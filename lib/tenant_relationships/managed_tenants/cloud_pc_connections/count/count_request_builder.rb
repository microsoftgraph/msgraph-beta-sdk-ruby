...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::CloudPcConnections::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/cloudPcConnections/$count{?%24search,%24filter}"
