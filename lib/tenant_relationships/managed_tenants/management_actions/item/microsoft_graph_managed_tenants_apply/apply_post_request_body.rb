...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementActions::Item::MicrosoftGraphManagedTenantsApply
    class ApplyPostRequestBody
        ...
        ## @param value Value to set for the include_all_users property.
        ## @return a void
        ## 
