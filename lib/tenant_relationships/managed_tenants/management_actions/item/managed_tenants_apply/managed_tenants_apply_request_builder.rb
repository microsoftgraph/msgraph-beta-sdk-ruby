...
require_relative './managed_tenants_apply'
    ...
    module TenantRelationships
        module ManagedTenants
            module ManagementActions
                module Item
                    module ManagedTenantsApply
                        ## 
                        # Provides operations to call the apply method.
                        class ManagedTenantsApplyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managementActions/{managementAction%2Did}/managedTenants.apply")
                            end
                            ## 
                            ## Invoke action apply
