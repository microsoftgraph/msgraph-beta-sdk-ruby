...
module MicrosoftGraphBeta
    module TenantRelationships
        module ManagedTenants
            module ManagedTenantEmailNotifications
                module Item
                    module Alert
                        ## 
                        ...
                        class AlertRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managedTenantEmailNotifications/{managedTenantEmailNotification%2Did}/alert{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            ## @return a alert_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return AlertRequestBuilder.new(raw_url, @request_adapter)
                            end
