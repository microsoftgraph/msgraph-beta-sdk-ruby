...
require_relative '../../../../models/managed_tenants/management_template_collection'
require_relative '../../../../models/o_data_errors/o_data_error'
require_relative '../../../tenant_relationships'
require_relative '../../managed_tenants'
require_relative '../management_template_collections'
...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementTemplateCollections::Item
    ## 
    ...
    class ManagementTemplateCollectionItemRequestBuilder
        ...
        def management_templates()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementTemplateCollections::Item::ManagementTemplates::ManagementTemplatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param managementTemplateCollectionId key: id of managementTemplateCollection
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, management_template_collection_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateCollections/{managementTemplateCollection%2Did}{?%24select,%24expand}"
        ...
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a Fiber of management_template_collection
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementTemplateCollection.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the managementTemplates property of the microsoft.graph.managedTenants.managementTemplateCollection entity.
        ...
        def management_templates_by_id(id)
            ...
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementTemplateCollections::Item::ManagementTemplates::Item::ManagementTemplateItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
