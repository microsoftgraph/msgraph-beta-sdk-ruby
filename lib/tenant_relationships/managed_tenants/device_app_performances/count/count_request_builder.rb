...
require_relative '../device_app_performances'
require_relative './count'

module MicrosoftGraphBeta
    module TenantRelationships
        module ManagedTenants
            module DeviceAppPerformances
                module Count
                    ## 
                    ...
                    class CountRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/deviceAppPerformances/$count{?%24search,%24filter}")
                        end
                        ## 
