...
require_relative '../../../models/managed_tenants/tenant_tag_collection_response'
        ...
        module ManagedTenants
            module TenantTags
                ...
                class TenantTagsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## 
                    ## Provides operations to manage the tenantTags property of the microsoft.graph.managedTenants.managedTenant entity.
                    ## @param tenant_tag_id Unique identifier of the item
                    ...
                    ## @return a Fiber of tenant_tag_collection_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::TenantTagCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
