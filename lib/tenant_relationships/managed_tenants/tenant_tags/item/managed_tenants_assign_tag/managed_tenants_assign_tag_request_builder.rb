...
require_relative './managed_tenants_assign_tag'
...
module MicrosoftGraphBeta
    module TenantRelationships
        module ManagedTenants
            module TenantTags
                module Item
                    module ManagedTenantsAssignTag
                        ## 
                        # Provides operations to call the assignTag method.
                        class ManagedTenantsAssignTagRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/tenantTags/{tenantTag%2Did}/managedTenants.assignTag")
                            end
                            ## 
