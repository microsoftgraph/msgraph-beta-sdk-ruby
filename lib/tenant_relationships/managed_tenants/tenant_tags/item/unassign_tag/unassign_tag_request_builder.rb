...
require_relative './unassign_tag'

module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Item::UnassignTag
    ## 
    ...
    class UnassignTagRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/tenantTags/{tenantTag%2Did}/microsoft.graph.managedTenants.unassignTag"
