...
require_relative './managed_tenants_assign_tag/managed_tenants_assign_tag_request_builder'
require_relative './managed_tenants_unassign_tag/managed_tenants_unassign_tag_request_builder'
            ...
            module TenantTags
                module Item
                    ...
                    class TenantTagItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def managed_tenants_assign_tag()
                            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Item::ManagedTenantsAssignTag::ManagedTenantsAssignTagRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the unassignTag method.
                        def managed_tenants_unassign_tag()
                            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Item::ManagedTenantsUnassignTag::ManagedTenantsUnassignTagRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
