...
require_relative './microsoft_graph_managed_tenants_assign_tag/assign_tag_request_builder'
require_relative './microsoft_graph_managed_tenants_unassign_tag/unassign_tag_request_builder'
...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Item
    ...
    class TenantTagItemRequestBuilder
        ...
        def microsoft_graph_managed_tenants_assign_tag()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Item::MicrosoftGraphManagedTenantsAssignTag::AssignTagRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unassignTag method.
        def microsoft_graph_managed_tenants_unassign_tag()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Item::MicrosoftGraphManagedTenantsUnassignTag::UnassignTagRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param tenantTagId key: id of tenantTag
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, tenant_tag_id=nil)
