...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Item::MicrosoftGraphManagedTenantsAssignTag
    class AssignTagPostRequestBody
        ...
        ## @return a assign_tag_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return AssignTagPostRequestBody.new
        end
        ## 
