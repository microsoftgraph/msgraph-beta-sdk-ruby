...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/tenantTags/$count{?%24search,%24filter}"
