...
require_relative '../../../models/managed_tenants_windows_protection_state_collection_response'
require_relative '../../../models/o_data_errors_o_data_error'
require_relative '../../tenant_relationships'
require_relative '../managed_tenants'
require_relative './count/count_request_builder'
require_relative './item/windows_protection_state_item_request_builder'
    ...
    module TenantRelationships
        module ManagedTenants
            module WindowsProtectionStates
                ...
                class WindowsProtectionStatesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## 
                    def by_windows_protection_state_id(windows_protection_state_id)
                        raise StandardError, 'windows_protection_state_id cannot be null' if windows_protection_state_id.nil?
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/windowsProtectionStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenantsWindowsProtectionStateCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/tenantRelationships/managedTenants/windowsProtectionStates'
                        request_info.path_parameters = @path_parameters
