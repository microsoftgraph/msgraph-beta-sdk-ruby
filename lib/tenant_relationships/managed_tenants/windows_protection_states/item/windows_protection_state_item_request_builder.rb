...
require_relative '../../../../models/managed_tenants_windows_protection_state'
...
module MicrosoftGraphBeta
    module TenantRelationships
        module ManagedTenants
            module WindowsProtectionStates
                module Item
                    ## 
                    ...
                    class WindowsProtectionStateItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/windowsProtectionStates/{windowsProtectionState%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ## @return a Fiber of managed_tenants_windows_protection_state
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/tenantRelationships/managedTenants/windowsProtectionStates/{windowsProtectionState%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return WindowsProtectionStateItemRequestBuilder.new(raw_url, @request_adapter)
                        end
