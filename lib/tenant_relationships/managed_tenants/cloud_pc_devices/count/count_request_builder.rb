...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::CloudPcDevices::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/cloudPcDevices/$count{?%24search,%24filter}"
