...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::DeviceCompliancePolicySettingStateSummaries::Item
    ...
    class DeviceCompliancePolicySettingStateSummaryItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, device_compliance_policy_setting_state_summary_id=nil)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummary%2Did}{?%24select,%24expand}"
