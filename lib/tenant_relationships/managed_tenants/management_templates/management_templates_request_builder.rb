...
require_relative '../../../models/managed_tenants/management_template_collection_response'
        ...
        module ManagedTenants
            module ManagementTemplates
                ...
                class ManagementTemplatesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## 
                    ## Provides operations to manage the managementTemplates property of the microsoft.graph.managedTenants.managedTenant entity.
                    ## @param management_template_id Unique identifier of the item
                    ...
                    ## @return a Fiber of management_template_collection_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementTemplateCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
