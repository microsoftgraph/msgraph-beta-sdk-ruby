...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementTemplates::Item::ManagementTemplateSteps::Item
    ## 
    ...
    class ManagementTemplateStepItemRequestBuilder
        ...
        ## @param managementTemplateStepId key: id of managementTemplateStep
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, management_template_step_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/managementTemplates/{managementTemplate%2Did}/managementTemplateSteps/{managementTemplateStep%2Did}{?%24select,%24expand}"
