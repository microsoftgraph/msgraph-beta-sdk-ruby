...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementTemplates::Item::ManagementTemplateSteps::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/managementTemplates/{managementTemplate%2Did}/managementTemplateSteps/$count{?%24search,%24filter}"
