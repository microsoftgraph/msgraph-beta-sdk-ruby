...
require_relative './microsoft_graph_managed_tenants_offboard_tenant/offboard_tenant_request_builder'
require_relative './microsoft_graph_managed_tenants_reset_tenant_onboarding_status/reset_tenant_onboarding_status_request_builder'
...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants::Item
    ...
    class TenantItemRequestBuilder
        ...
        def microsoft_graph_managed_tenants_offboard_tenant()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants::Item::MicrosoftGraphManagedTenantsOffboardTenant::OffboardTenantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_managed_tenants_reset_tenant_onboarding_status()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants::Item::MicrosoftGraphManagedTenantsResetTenantOnboardingStatus::ResetTenantOnboardingStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param tenantId key: id of tenant
        ## @return a void
        ## 
