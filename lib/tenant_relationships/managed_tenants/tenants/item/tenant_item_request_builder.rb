...
require_relative './managed_tenants_offboard_tenant/managed_tenants_offboard_tenant_request_builder'
require_relative './managed_tenants_reset_tenant_onboarding_status/managed_tenants_reset_tenant_onboarding_status_request_builder'
            ...
            module Tenants
                module Item
                    ...
                    class TenantItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def managed_tenants_offboard_tenant()
                            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants::Item::ManagedTenantsOffboardTenant::ManagedTenantsOffboardTenantRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the resetTenantOnboardingStatus method.
                        def managed_tenants_reset_tenant_onboarding_status()
                            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants::Item::ManagedTenantsResetTenantOnboardingStatus::ManagedTenantsResetTenantOnboardingStatusRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
