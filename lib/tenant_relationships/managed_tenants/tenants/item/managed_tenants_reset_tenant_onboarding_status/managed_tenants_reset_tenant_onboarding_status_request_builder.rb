...
require_relative './managed_tenants_reset_tenant_onboarding_status'
...
module MicrosoftGraphBeta
    module TenantRelationships
        module ManagedTenants
            module Tenants
                module Item
                    module ManagedTenantsResetTenantOnboardingStatus
                        ## 
                        # Provides operations to call the resetTenantOnboardingStatus method.
                        class ManagedTenantsResetTenantOnboardingStatusRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}/managedTenants.resetTenantOnboardingStatus")
                            end
                            ## 
