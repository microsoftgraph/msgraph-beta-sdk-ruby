...
require_relative './managed_tenants_offboard_tenant'
...
module MicrosoftGraphBeta
    module TenantRelationships
        module ManagedTenants
            module Tenants
                module Item
                    module ManagedTenantsOffboardTenant
                        ## 
                        # Provides operations to call the offboardTenant method.
                        class ManagedTenantsOffboardTenantRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}/managedTenants.offboardTenant")
                            end
                            ## 
