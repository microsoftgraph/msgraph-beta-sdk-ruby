...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::CloudPcsOverview::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/cloudPcsOverview/$count{?%24search,%24filter}"
