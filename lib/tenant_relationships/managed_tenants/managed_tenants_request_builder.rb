...
require_relative './app_performances/item/app_performance_item_request_builder'
...
require_relative './device_app_performances/item/device_app_performance_item_request_builder'
...
require_relative './device_health_statuses/item/device_health_status_item_request_builder'
    ...
    module TenantRelationships
        module ManagedTenants
            ...
            class ManagedTenantsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                ## Provides operations to manage the deviceAppPerformances property of the microsoft.graph.managedTenants.managedTenant entity.
                ## @param id Unique identifier of the item
                ## @return a device_app_performance_item_request_builder
                ## 
                def device_app_performances_by_id(id)
                    raise StandardError, 'id cannot be null' if id.nil?
                    url_tpl_params = @path_parameters.clone
                    url_tpl_params["deviceAppPerformance%2Did"] = id
                    return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::DeviceAppPerformances::Item::DeviceAppPerformanceItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ## Provides operations to manage the deviceCompliancePolicySettingStateSummaries property of the microsoft.graph.managedTenants.managedTenant entity.
                ## @param id Unique identifier of the item
                ...
                ## 
                def device_health_statuses_by_id(id)
                    raise StandardError, 'id cannot be null' if id.nil?
                    url_tpl_params = @path_parameters.clone
