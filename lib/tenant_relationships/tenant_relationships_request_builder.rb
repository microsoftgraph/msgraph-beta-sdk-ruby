...
require_relative './microsoft_graph_find_tenant_information_by_domain_name_with_domain_name/microsoft_graph_find_tenant_information_by_domain_name_with_domain_name_request_builder'
require_relative './microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id/microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id_request_builder'
    ...
    module TenantRelationships
        ...
        class TenantRelationshipsRequestBuilder
            ...
            def delegated_admin_customers_by_id(id)
                ...
                return MicrosoftGraphBeta::TenantRelationships::DelegatedAdminCustomers::Item::DelegatedAdminCustomerItemRequestBuilder.new(url_tpl_params, @request_adapter)
            end
            ## 
            ## Provides operations to manage the delegatedAdminRelationships property of the microsoft.graph.tenantRelationship entity.
            ## @param id Unique identifier of the item
            ...
            def delegated_admin_relationships_by_id(id)
                ...
                return MicrosoftGraphBeta::TenantRelationships::DelegatedAdminRelationships::Item::DelegatedAdminRelationshipItemRequestBuilder.new(url_tpl_params, @request_adapter)
            end
            ## 
            ...
            ## @return a microsoft_graph_find_tenant_information_by_domain_name_with_domain_name_request_builder
            ## 
            def microsoft_graph_find_tenant_information_by_domain_name_with_domain_name(domain_name)
                raise StandardError, 'domain_name cannot be null' if domain_name.nil?
                return MicrosoftGraphFindTenantInformationByDomainNameWithDomainNameRequestBuilder.new(@path_parameters, @request_adapter, domainName)
            end
            ## 
            ## Provides operations to call the findTenantInformationByTenantId method.
            ## @param tenantId Usage: tenantId='{tenantId}'
            ## @return a microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id_request_builder
            ## 
            def microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id(tenant_id)
                raise StandardError, 'tenant_id cannot be null' if tenant_id.nil?
                return MicrosoftGraphFindTenantInformationByTenantIdWithTenantIdRequestBuilder.new(@path_parameters, @request_adapter, tenantId)
            end
            ## 
