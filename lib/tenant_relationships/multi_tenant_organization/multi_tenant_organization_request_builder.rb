    ...
    module TenantRelationships
        module MultiTenantOrganization
            ...
            class MultiTenantOrganizationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def join_request()
                    return MicrosoftGraphBeta::TenantRelationships::MultiTenantOrganization::JoinRequest::JoinRequestRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the tenants property of the microsoft.graph.multiTenantOrganization entity.
                def tenants()
                    return MicrosoftGraphBeta::TenantRelationships::MultiTenantOrganization::Tenants::TenantsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def to_patch_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/tenantRelationships/multiTenantOrganization'
                    request_info.path_parameters = @path_parameters
