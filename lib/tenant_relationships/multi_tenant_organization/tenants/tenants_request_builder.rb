        ...
        module MultiTenantOrganization
            module Tenants
                ...
                class TenantsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::TenantRelationships::MultiTenantOrganization::Tenants::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the tenants property of the microsoft.graph.multiTenantOrganization entity.
                    ...
                    def by_multi_tenant_organization_member_id(multi_tenant_organization_member_id)
                        ...
                        return MicrosoftGraphBeta::TenantRelationships::MultiTenantOrganization::Tenants::Item::MultiTenantOrganizationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/tenantRelationships/multiTenantOrganization/tenants'
                        request_info.path_parameters = @path_parameters
