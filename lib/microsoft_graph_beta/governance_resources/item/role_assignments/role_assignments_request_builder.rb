...
module MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignments
    ## 
    ...
    class RoleAssignmentsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
