...
module MicrosoftGraphBeta::GovernanceResources::Item::RoleSettings::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleSettings/$count"
