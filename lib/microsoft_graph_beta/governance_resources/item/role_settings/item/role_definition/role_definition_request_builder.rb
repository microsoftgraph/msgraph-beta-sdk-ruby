...
module MicrosoftGraphBeta::GovernanceResources::Item::RoleSettings::Item::RoleDefinition
    ## 
    ...
    class RoleDefinitionRequestBuilder
        ...
        def resource()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleSettings::Item::RoleDefinition::Resource::ResourceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleSetting property of the microsoft.graph.governanceRoleDefinition entity.
        def role_setting()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleSettings::Item::RoleDefinition::RoleSetting::RoleSettingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleSettings/{governanceRoleSetting%2Did}/roleDefinition{?%24select,%24expand}"
