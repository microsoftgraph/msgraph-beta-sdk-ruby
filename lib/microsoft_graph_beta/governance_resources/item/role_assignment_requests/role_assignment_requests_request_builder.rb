...
module MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests
    ## 
    ...
    class RoleAssignmentRequestsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignmentRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## The collection of role assignment requests for the resource.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of governance_role_assignment_request_collection_response
        ## 
