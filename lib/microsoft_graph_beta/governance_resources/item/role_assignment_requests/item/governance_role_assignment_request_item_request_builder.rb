...
module MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item
    ## 
    ...
    class GovernanceRoleAssignmentRequestItemRequestBuilder
        ...
        def cancel()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resource()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item::Resource::ResourceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleDefinition property of the microsoft.graph.governanceRoleAssignmentRequest entity.
        def role_definition()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the subject property of the microsoft.graph.governanceRoleAssignmentRequest entity.
        def subject()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item::Subject::SubjectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRequest method.
        def update_request()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleAssignmentRequests::Item::UpdateRequest::UpdateRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24select,%24expand}"
