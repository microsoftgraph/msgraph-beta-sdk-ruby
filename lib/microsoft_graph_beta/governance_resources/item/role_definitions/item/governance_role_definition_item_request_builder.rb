...
module MicrosoftGraphBeta::GovernanceResources::Item::RoleDefinitions::Item
    ## 
    ...
    class GovernanceRoleDefinitionItemRequestBuilder
        ...
        def resource()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleDefinitions::Item::Resource::ResourceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleSetting property of the microsoft.graph.governanceRoleDefinition entity.
        def role_setting()
            return MicrosoftGraphBeta::GovernanceResources::Item::RoleDefinitions::Item::RoleSetting::RoleSettingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleDefinitions/{governanceRoleDefinition%2Did}{?%24select,%24expand}"
