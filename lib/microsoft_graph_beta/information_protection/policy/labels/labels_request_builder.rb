...
module MicrosoftGraphBeta::InformationProtection::Policy::Labels
    ## 
    ...
    class LabelsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::InformationProtection::Policy::Labels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the evaluateApplication method.
        def evaluate_application()
            return MicrosoftGraphBeta::InformationProtection::Policy::Labels::EvaluateApplication::EvaluateApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the evaluateClassificationResults method.
        def evaluate_classification_results()
            return MicrosoftGraphBeta::InformationProtection::Policy::Labels::EvaluateClassificationResults::EvaluateClassificationResultsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the evaluateRemoval method.
        def evaluate_removal()
            return MicrosoftGraphBeta::InformationProtection::Policy::Labels::EvaluateRemoval::EvaluateRemovalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the extractLabel method.
        def extract_label()
            return MicrosoftGraphBeta::InformationProtection::Policy::Labels::ExtractLabel::ExtractLabelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/informationProtection/policy/labels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get a collection of information protection labels available to the user or to the organization.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of information_protection_label_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of information_protection_label
        ## 
