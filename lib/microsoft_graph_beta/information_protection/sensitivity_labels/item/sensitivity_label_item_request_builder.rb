...
require_relative './sublabels/item/sensitivity_label_item_request_builder'
require_relative './sublabels/sublabels_request_builder'

module MicrosoftGraphBeta::InformationProtection::SensitivityLabels::Item
    ## 
    ...
    class SensitivityLabelItemRequestBuilder
        ...
        def sublabels()
            return MicrosoftGraphBeta::InformationProtection::SensitivityLabels::Item::Sublabels::SublabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}"
