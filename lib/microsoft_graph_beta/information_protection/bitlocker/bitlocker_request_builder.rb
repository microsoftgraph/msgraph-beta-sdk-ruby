...
module MicrosoftGraphBeta::InformationProtection::Bitlocker
    ## 
    ...
    class BitlockerRequestBuilder
        ...
        def recovery_keys()
            return MicrosoftGraphBeta::InformationProtection::Bitlocker::RecoveryKeys::RecoveryKeysRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def recovery_keys_by_id(id)
            ...
            return MicrosoftGraphBeta::InformationProtection::Bitlocker::RecoveryKeys::Item::BitlockerRecoveryKeyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get bitlocker from informationProtection
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
