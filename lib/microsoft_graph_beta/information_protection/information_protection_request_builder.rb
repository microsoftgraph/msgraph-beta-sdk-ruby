...
module MicrosoftGraphBeta::InformationProtection
    ...
    class InformationProtectionRequestBuilder
        ...
        def threat_assessment_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::InformationProtection::ThreatAssessmentRequests::Item::ThreatAssessmentRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
