...
module MicrosoftGraphBeta::Communications::Calls
    ...
    class CallsRequestBuilder
        ...
        def log_teleconference_device_quality()
            return MicrosoftGraphBeta::Communications::Calls::LogTeleconferenceDeviceQuality::LogTeleconferenceDeviceQualityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
