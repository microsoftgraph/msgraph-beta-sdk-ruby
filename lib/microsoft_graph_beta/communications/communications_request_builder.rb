...
module MicrosoftGraphBeta::Communications
    ## 
    ...
    class CommunicationsRequestBuilder
        ...
        def call_records()
            return MicrosoftGraphBeta::Communications::CallRecords::CallRecordsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the calls property of the microsoft.graph.cloudCommunications entity.
        def calls()
            return MicrosoftGraphBeta::Communications::Calls::CallsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getPresencesByUserId method.
        def get_presences_by_user_id()
            return MicrosoftGraphBeta::Communications::GetPresencesByUserId::GetPresencesByUserIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the onlineMeetings property of the microsoft.graph.cloudCommunications entity.
        def online_meetings()
            return MicrosoftGraphBeta::Communications::OnlineMeetings::OnlineMeetingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def presences()
            return MicrosoftGraphBeta::Communications::Presences::PresencesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def calls_by_id(id)
            ...
            return MicrosoftGraphBeta::Communications::Calls::Item::CallItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::CloudCommunications.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the onlineMeetings property of the microsoft.graph.cloudCommunications entity.
        ## @param id Unique identifier of the item
        ...
        def online_meetings_by_id(id)
            ...
            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::OnlineMeetingItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def presences_by_id(id)
            ...
            return MicrosoftGraphBeta::Communications::Presences::Item::PresenceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get communications
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
