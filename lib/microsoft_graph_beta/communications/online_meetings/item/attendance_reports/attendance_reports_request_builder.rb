...
module MicrosoftGraphBeta::Communications::OnlineMeetings::Item::AttendanceReports
    ## 
    ...
    class AttendanceReportsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Communications::OnlineMeetings::Item::AttendanceReports::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
