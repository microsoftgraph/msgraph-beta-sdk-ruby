...
module MicrosoftGraphBeta::Communications::OnlineMeetings::Item::Registration::CustomQuestions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/registration/customQuestions/$count"
