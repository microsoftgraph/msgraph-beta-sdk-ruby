...
require_relative '../remote_action_audits'
require_relative './count'

module MicrosoftGraphBeta::DeviceManagement::RemoteActionAudits::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/remoteActionAudits/$count"
