...
require_relative './item'
require_relative './presentation_values/item/group_policy_presentation_value_item_request_builder'
require_relative './presentation_values/presentation_values_request_builder'

module MicrosoftGraphBeta::DeviceManagement::GroupPolicyConfigurations::Item::DefinitionValues::Item
    ## 
    ...
    class GroupPolicyDefinitionValueItemRequestBuilder
        ...
        def definition()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyConfigurations::Item::DefinitionValues::Item::Definition::DefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def presentation_values()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyConfigurations::Item::DefinitionValues::Item::PresentationValues::PresentationValuesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/groupPolicyConfigurations/{groupPolicyConfiguration%2Did}/definitionValues/{groupPolicyDefinitionValue%2Did}{?%24select,%24expand}"
        ...
        ## The list of enabled or disabled group policy definition values for the configuration.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of group_policy_definition_value
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::GroupPolicyDefinitionValue.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property definitionValues in deviceManagement
        ## @param body The request body
        ...
        ## 
        def presentation_values_by_id(id)
