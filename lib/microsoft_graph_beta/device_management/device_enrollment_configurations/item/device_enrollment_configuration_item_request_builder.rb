...
module MicrosoftGraphBeta::DeviceManagement::DeviceEnrollmentConfigurations::Item
    ## 
    ...
    class DeviceEnrollmentConfigurationItemRequestBuilder
        ...
        def assign()
            return MicrosoftGraphBeta::DeviceManagement::DeviceEnrollmentConfigurations::Item::Assign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the assignments property of the microsoft.graph.deviceEnrollmentConfiguration entity.
        def assignments()
            return MicrosoftGraphBeta::DeviceManagement::DeviceEnrollmentConfigurations::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set_priority()
            return MicrosoftGraphBeta::DeviceManagement::DeviceEnrollmentConfigurations::Item::SetPriority::SetPriorityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceEnrollmentConfigurations::Item::Assignments::Item::EnrollmentConfigurationAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
