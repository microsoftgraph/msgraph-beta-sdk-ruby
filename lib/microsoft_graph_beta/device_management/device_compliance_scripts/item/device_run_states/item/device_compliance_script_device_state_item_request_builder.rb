...
module MicrosoftGraphBeta::DeviceManagement::DeviceComplianceScripts::Item::DeviceRunStates::Item
    ## 
    ...
    class DeviceComplianceScriptDeviceStateItemRequestBuilder
        ...
        def managed_device()
            return MicrosoftGraphBeta::DeviceManagement::DeviceComplianceScripts::Item::DeviceRunStates::Item::ManagedDevice::ManagedDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceComplianceScripts/{deviceComplianceScript%2Did}/deviceRunStates/{deviceComplianceScriptDeviceState%2Did}{?%24select,%24expand}"
        ...
        ## List of run states for the device compliance script across all devices
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of device_compliance_script_device_state
        ## 
