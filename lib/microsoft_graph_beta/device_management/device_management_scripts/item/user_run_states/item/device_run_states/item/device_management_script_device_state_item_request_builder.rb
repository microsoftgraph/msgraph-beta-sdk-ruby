...
module MicrosoftGraphBeta::DeviceManagement::DeviceManagementScripts::Item::UserRunStates::Item::DeviceRunStates::Item
    ## 
    ...
    class DeviceManagementScriptDeviceStateItemRequestBuilder
        ...
        def managed_device()
            return MicrosoftGraphBeta::DeviceManagement::DeviceManagementScripts::Item::UserRunStates::Item::DeviceRunStates::Item::ManagedDevice::ManagedDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceManagementScripts/{deviceManagementScript%2Did}/userRunStates/{deviceManagementScriptUserState%2Did}/deviceRunStates/{deviceManagementScriptDeviceState%2Did}{?%24select,%24expand}"
