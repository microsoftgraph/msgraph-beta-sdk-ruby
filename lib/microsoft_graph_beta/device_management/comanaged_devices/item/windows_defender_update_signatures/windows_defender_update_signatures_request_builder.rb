...
module MicrosoftGraphBeta::DeviceManagement::ComanagedDevices::Item::WindowsDefenderUpdateSignatures
    ## 
    ...
    class WindowsDefenderUpdateSignaturesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/microsoft.graph.windowsDefenderUpdateSignatures"
