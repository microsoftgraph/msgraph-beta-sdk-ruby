...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item
    ## 
    ...
    class GroupPolicyDefinitionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}{?%24select,%24expand}"
