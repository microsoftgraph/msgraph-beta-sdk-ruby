...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::NextVersionDefinition::PreviousVersionDefinition::Presentations::Item
    ## 
    ...
    class GroupPolicyPresentationItemRequestBuilder
        ...
        def definition()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::NextVersionDefinition::PreviousVersionDefinition::Presentations::Item::Definition::DefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/previousVersionDefinition/presentations/{groupPolicyPresentation%2Did}{?%24select,%24expand}"
