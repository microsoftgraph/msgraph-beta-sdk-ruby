...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition
    ## 
    ...
    class PreviousVersionDefinitionRequestBuilder
        ...
        def category()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::Category::CategoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the definitionFile property of the microsoft.graph.groupPolicyDefinition entity.
        def definition_file()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::DefinitionFile::DefinitionFileRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def next_version_definition()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::NextVersionDefinition::NextVersionDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def presentations()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::Presentations::PresentationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition{?%24select,%24expand}"
        ...
        ## Definition of the previous version of this definition
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of group_policy_definition
        ## 
