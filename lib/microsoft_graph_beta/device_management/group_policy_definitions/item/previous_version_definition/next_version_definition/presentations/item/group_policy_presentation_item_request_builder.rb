...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::NextVersionDefinition::Presentations::Item
    ## 
    ...
    class GroupPolicyPresentationItemRequestBuilder
        ...
        def definition()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::NextVersionDefinition::Presentations::Item::Definition::DefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition/nextVersionDefinition/presentations/{groupPolicyPresentation%2Did}{?%24select,%24expand}"
