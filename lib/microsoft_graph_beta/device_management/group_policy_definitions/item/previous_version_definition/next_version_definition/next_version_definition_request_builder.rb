...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::NextVersionDefinition
    ## 
    ...
    class NextVersionDefinitionRequestBuilder
        ...
        def category()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::NextVersionDefinition::Category::CategoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the definitionFile property of the microsoft.graph.groupPolicyDefinition entity.
        def definition_file()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::NextVersionDefinition::DefinitionFile::DefinitionFileRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def presentations()
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::NextVersionDefinition::Presentations::PresentationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition/nextVersionDefinition{?%24select,%24expand}"
        ...
        def presentations_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::GroupPolicyDefinitions::Item::PreviousVersionDefinition::NextVersionDefinition::Presentations::Item::GroupPolicyPresentationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
