...
module MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicySettingStateSummaries::Item
    ...
    class DeviceCompliancePolicySettingStateSummaryItemRequestBuilder
        ...
        def device_compliance_setting_states()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicySettingStateSummaries::Item::DeviceComplianceSettingStates::DeviceComplianceSettingStatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::DeviceCompliancePolicySettingStateSummary.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
