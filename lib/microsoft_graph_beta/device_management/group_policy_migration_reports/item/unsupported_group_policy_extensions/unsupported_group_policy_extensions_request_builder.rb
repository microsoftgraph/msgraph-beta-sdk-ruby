...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyMigrationReports::Item::UnsupportedGroupPolicyExtensions
    ...
    class UnsupportedGroupPolicyExtensionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/groupPolicyMigrationReports/{groupPolicyMigrationReport%2Did}/unsupportedGroupPolicyExtensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## A list of unsupported group policy extensions inside the Group Policy Object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of unsupported_group_policy_extension_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of unsupported_group_policy_extension
        ## 
