...
require_relative './assignments/item/windows_driver_update_profile_assignment_item_request_builder'
require_relative './driver_inventories/driver_inventories_request_builder'
require_relative './driver_inventories/item/windows_driver_update_inventory_item_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::WindowsDriverUpdateProfiles::Item
    ## 
    ...
    class WindowsDriverUpdateProfileItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/windowsDriverUpdateProfiles/{windowsDriverUpdateProfile%2Did}{?%24select,%24expand}"
        ...
        ## Provides operations to manage the driverInventories property of the microsoft.graph.windowsDriverUpdateProfile entity.
        ## @param id Unique identifier of the item
        ## @return a windows_driver_update_inventory_item_request_builder
        ## 
        def driver_inventories_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["windowsDriverUpdateInventory%2Did"] = id
            return MicrosoftGraphBeta::DeviceManagement::WindowsDriverUpdateProfiles::Item::DriverInventories::Item::WindowsDriverUpdateInventoryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## A collection of windows driver update profiles
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of windows_driver_update_profile
        ## 
