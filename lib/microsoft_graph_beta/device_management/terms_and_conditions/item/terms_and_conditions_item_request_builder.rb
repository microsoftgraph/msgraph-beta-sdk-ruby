...
require_relative './group_assignments/item/terms_and_conditions_group_assignment_item_request_builder'
require_relative './item'

module MicrosoftGraphBeta::DeviceManagement::TermsAndConditions::Item
    ## 
    ...
    class TermsAndConditionsItemRequestBuilder
        ...
        def acceptance_statuses()
            return MicrosoftGraphBeta::DeviceManagement::TermsAndConditions::Item::AcceptanceStatuses::AcceptanceStatusesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the assignments property of the microsoft.graph.termsAndConditions entity.
        def assignments()
            return MicrosoftGraphBeta::DeviceManagement::TermsAndConditions::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the groupAssignments property of the microsoft.graph.termsAndConditions entity.
        def group_assignments()
            return MicrosoftGraphBeta::DeviceManagement::TermsAndConditions::Item::GroupAssignments::GroupAssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def acceptance_statuses_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::TermsAndConditions::Item::AcceptanceStatuses::Item::TermsAndConditionsAcceptanceStatusItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the assignments property of the microsoft.graph.termsAndConditions entity.
        ## @param id Unique identifier of the item
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::TermsAndConditions::Item::Assignments::Item::TermsAndConditionsAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TermsAndConditions.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the groupAssignments property of the microsoft.graph.termsAndConditions entity.
        ## @param id Unique identifier of the item
        ## @return a terms_and_conditions_group_assignment_item_request_builder
        ## 
        def group_assignments_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["termsAndConditionsGroupAssignment%2Did"] = id
            return MicrosoftGraphBeta::DeviceManagement::TermsAndConditions::Item::GroupAssignments::Item::TermsAndConditionsGroupAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
