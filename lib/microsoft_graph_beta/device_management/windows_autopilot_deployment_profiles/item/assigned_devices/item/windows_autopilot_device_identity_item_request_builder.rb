...
module MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item
    ## 
    ...
    class WindowsAutopilotDeviceIdentityItemRequestBuilder
        ...
        def assign_resource_account_to_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::AssignResourceAccountToDevice::AssignResourceAccountToDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assignUserToDevice method.
        def assign_user_to_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::AssignUserToDevice::AssignUserToDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def deployment_profile()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::DeploymentProfile::DeploymentProfileRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def intended_deployment_profile()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::IntendedDeploymentProfile::IntendedDeploymentProfileRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def unassign_resource_account_from_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::UnassignResourceAccountFromDevice::UnassignResourceAccountFromDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unassignUserFromDevice method.
        def unassign_user_from_device()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::UnassignUserFromDevice::UnassignUserFromDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateDeviceProperties method.
        def update_device_properties()
            return MicrosoftGraphBeta::DeviceManagement::WindowsAutopilotDeploymentProfiles::Item::AssignedDevices::Item::UpdateDeviceProperties::UpdateDevicePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfile%2Did}/assignedDevices/{windowsAutopilotDeviceIdentity%2Did}{?%24select,%24expand}"
