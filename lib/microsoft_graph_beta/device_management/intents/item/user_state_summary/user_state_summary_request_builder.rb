...
module MicrosoftGraphBeta::DeviceManagement::Intents::Item::UserStateSummary
    ...
    class UserStateSummaryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/userStateSummary{?%24select,%24expand}"
        ...
        ## A summary of user states and counts of users that belong to corresponding state for all users that the intent is applied to
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of device_management_intent_user_state_summary
        ## 
