...
module MicrosoftGraphBeta::DeviceManagement::NotificationMessageTemplates::Item
    ## 
    ...
    class NotificationMessageTemplateItemRequestBuilder
        ...
        def localized_notification_messages()
            return MicrosoftGraphBeta::DeviceManagement::NotificationMessageTemplates::Item::LocalizedNotificationMessages::LocalizedNotificationMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def send_test_message()
            return MicrosoftGraphBeta::DeviceManagement::NotificationMessageTemplates::Item::SendTestMessage::SendTestMessageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::NotificationMessageTemplate.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the localizedNotificationMessages property of the microsoft.graph.notificationMessageTemplate entity.
        ...
        def localized_notification_messages_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::NotificationMessageTemplates::Item::LocalizedNotificationMessages::Item::LocalizedNotificationMessageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
