...
require_relative './generate_apple_push_notification_certificate_signing_request/generate_apple_push_notification_certificate_signing_request_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::ApplePushNotificationCertificate
    ...
    class ApplePushNotificationCertificateRequestBuilder
        ...
        def generate_apple_push_notification_certificate_signing_request()
            return MicrosoftGraphBeta::DeviceManagement::ApplePushNotificationCertificate::GenerateApplePushNotificationCertificateSigningRequest::GenerateApplePushNotificationCertificateSigningRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ApplePushNotificationCertificate.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
