...
require_relative './assignments/item/cloud_pc_provisioning_policy_assignment_item_request_builder'
require_relative './item'

module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item
    ## 
    ...
    class CloudPcProvisioningPolicyItemRequestBuilder
        ...
        def assign()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item::Assign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the assignments property of the microsoft.graph.cloudPcProvisioningPolicy entity.
        def assignments()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item::Assignments::Item::CloudPcProvisioningPolicyAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}{?%24select,%24expand}"
        ...
        ## Cloud PC provisioning policy.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of cloud_pc_provisioning_policy
        ## 
