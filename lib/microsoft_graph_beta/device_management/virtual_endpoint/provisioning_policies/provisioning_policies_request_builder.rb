...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies
    ## 
    ...
    class ProvisioningPoliciesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## List properties and relationships of the cloudPcProvisioningPolicy objects.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of cloud_pc_provisioning_policy_collection_response
        ## 
