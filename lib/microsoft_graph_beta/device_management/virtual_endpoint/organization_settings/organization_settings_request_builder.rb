...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::OrganizationSettings
    ## 
    ...
    class OrganizationSettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/organizationSettings{?%24select,%24expand}"
        ...
        ## Read the properties and relationships of the cloudPcOrganizationSettings from the current tenant. A tenant has only one **cloudPcOrganizationSettings** object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of cloud_pc_organization_settings
        ## 
