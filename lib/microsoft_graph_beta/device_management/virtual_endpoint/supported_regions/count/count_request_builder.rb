...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::SupportedRegions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/supportedRegions/$count"
