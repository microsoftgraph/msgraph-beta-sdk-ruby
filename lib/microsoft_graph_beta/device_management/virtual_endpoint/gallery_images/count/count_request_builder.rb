...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::GalleryImages::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/galleryImages/$count"
