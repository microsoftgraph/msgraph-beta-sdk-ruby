...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::ChangeUserAccountType
    ## 
    ...
    class ChangeUserAccountTypeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/microsoft.graph.changeUserAccountType"
