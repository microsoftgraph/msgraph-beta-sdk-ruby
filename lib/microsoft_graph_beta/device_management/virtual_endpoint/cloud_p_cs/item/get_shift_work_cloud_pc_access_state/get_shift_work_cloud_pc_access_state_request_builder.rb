...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item::GetShiftWorkCloudPcAccessState
    ## 
    ...
    class GetShiftWorkCloudPcAccessStateRequestBuilder
        ...
        ## Invoke function getShiftWorkCloudPcAccessState
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of shift_work_cloud_pc_access_state
        ## 
