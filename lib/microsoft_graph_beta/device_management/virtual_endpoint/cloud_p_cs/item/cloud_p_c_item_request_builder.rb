...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::CloudPCs::Item
    ...
    class CloudPCItemRequestBuilder
        ...
        ## Cloud managed virtual desktops.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of cloud_p_c
        ## 
        ...
        def get_cloud_pc_connectivity_history()
            return GetCloudPcConnectivityHistoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to call the getCloudPcLaunchInfo method.
        ## @return a get_cloud_pc_launch_info_request_builder
        ## 
        def get_cloud_pc_launch_info()
            return GetCloudPcLaunchInfoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get_shift_work_cloud_pc_access_state()
            return GetShiftWorkCloudPcAccessStateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get_supported_cloud_pc_remote_actions()
            return GetSupportedCloudPcRemoteActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Update the navigation property cloudPCs in deviceManagement
        ## @param body The request body
