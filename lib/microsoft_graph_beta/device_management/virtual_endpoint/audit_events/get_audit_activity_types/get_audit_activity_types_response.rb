...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::AuditEvents::GetAuditActivityTypes
    class GetAuditActivityTypesResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
        ...
        ## @return a get_audit_activity_types_response
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetAuditActivityTypesResponse.new
        end
        ## 
