...
require_relative './get_real_time_remote_connection_latency_with_cloud_pc_id'
...
module MicrosoftGraphBeta::DeviceManagement::VirtualEndpoint::Reports::GetRealTimeRemoteConnectionLatencyWithCloudPcId
    ...
    class GetRealTimeRemoteConnectionLatencyWithCloudPcIdRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, cloud_pc_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/virtualEndpoint/reports/microsoft.graph.getRealTimeRemoteConnectionLatency(cloudPcId='{cloudPcId}')"
