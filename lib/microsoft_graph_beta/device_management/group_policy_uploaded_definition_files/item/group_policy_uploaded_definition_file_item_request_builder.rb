...
require_relative './group_policy_operations/item/group_policy_operation_item_request_builder'
...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyUploadedDefinitionFiles::Item
    ...
    class GroupPolicyUploadedDefinitionFileItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/groupPolicyUploadedDefinitionFiles/{groupPolicyUploadedDefinitionFile%2Did}{?%24select,%24expand}"
        ...
        ## 
        def group_policy_operations_by_id(id)
