...
module MicrosoftGraphBeta::DeviceManagement::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item
    ...
    class AppLogCollectionRequestItemRequestBuilder
        ...
        def create_download_url()
            return MicrosoftGraphBeta::DeviceManagement::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item::CreateDownloadUrl::CreateDownloadUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/{appLogCollectionRequest%2Did}{?%24select,%24expand}"
