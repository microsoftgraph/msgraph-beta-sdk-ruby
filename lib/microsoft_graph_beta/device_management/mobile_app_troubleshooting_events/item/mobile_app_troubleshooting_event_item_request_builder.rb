...
module MicrosoftGraphBeta::DeviceManagement::MobileAppTroubleshootingEvents::Item
    ## 
    ...
    class MobileAppTroubleshootingEventItemRequestBuilder
        ...
        def app_log_collection_requests()
            return MicrosoftGraphBeta::DeviceManagement::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::AppLogCollectionRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def app_log_collection_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item::AppLogCollectionRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}{?%24select,%24expand}"
