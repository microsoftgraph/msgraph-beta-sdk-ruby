...
module MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::GetOmaSettingPlainTextValueWithSecretReferenceValueId
    ...
    class GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::DeviceManagement::DeviceConfigurations::Item::GetOmaSettingPlainTextValueWithSecretReferenceValueId::GetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function getOmaSettingPlainTextValue
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
