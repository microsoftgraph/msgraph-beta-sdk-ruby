...
module MicrosoftGraphBeta::DeviceManagement::RemoteAssistancePartners::Item
    ...
    class RemoteAssistancePartnerItemRequestBuilder
        ...
        def begin_onboarding()
            return MicrosoftGraphBeta::DeviceManagement::RemoteAssistancePartners::Item::BeginOnboarding::BeginOnboardingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the disconnect method.
        def disconnect()
            return MicrosoftGraphBeta::DeviceManagement::RemoteAssistancePartners::Item::Disconnect::DisconnectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
