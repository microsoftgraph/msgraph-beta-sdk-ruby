...
module MicrosoftGraphBeta::DeviceManagement::UserExperienceAnalyticsModelScores
    ...
    class UserExperienceAnalyticsModelScoresRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/userExperienceAnalyticsModelScores{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## User experience analytics model scores
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of user_experience_analytics_model_scores_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of user_experience_analytics_model_scores
        ## 
