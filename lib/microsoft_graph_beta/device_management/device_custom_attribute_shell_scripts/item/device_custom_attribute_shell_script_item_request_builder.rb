...
module MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item
    ...
    class DeviceCustomAttributeShellScriptItemRequestBuilder
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item::Assignments::Item::DeviceManagementScriptAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScript%2Did}{?%24select,%24expand}"
        ...
        def device_run_states_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item::DeviceRunStates::Item::DeviceManagementScriptDeviceStateItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## The list of device custom attribute shell scripts associated with the tenant.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of device_custom_attribute_shell_script
        ## 
        ...
        def group_assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item::GroupAssignments::Item::DeviceManagementScriptGroupAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property deviceCustomAttributeShellScripts in deviceManagement
        ## @param body The request body
        ...
        def user_run_states_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceCustomAttributeShellScripts::Item::UserRunStates::Item::DeviceManagementScriptUserStateItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
