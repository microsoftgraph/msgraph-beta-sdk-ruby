...
module MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item
    ## 
    ...
    class DeviceCompliancePolicyItemRequestBuilder
        ...
        def assign()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::Assign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the assignments property of the microsoft.graph.deviceCompliancePolicy entity.
        def assignments()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def device_setting_state_summaries()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::DeviceSettingStateSummaries::DeviceSettingStateSummariesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the deviceStatuses property of the microsoft.graph.deviceCompliancePolicy entity.
        def device_statuses()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::DeviceStatuses::DeviceStatusesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def device_status_overview()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::DeviceStatusOverview::DeviceStatusOverviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def schedule_actions_for_rules()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::ScheduleActionsForRules::ScheduleActionsForRulesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the scheduledActionsForRule property of the microsoft.graph.deviceCompliancePolicy entity.
        def scheduled_actions_for_rule()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::ScheduledActionsForRule::ScheduledActionsForRuleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_statuses()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::UserStatuses::UserStatusesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_status_overview()
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::UserStatusOverview::UserStatusOverviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the assignments property of the microsoft.graph.deviceCompliancePolicy entity.
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::Assignments::Item::DeviceCompliancePolicyAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def device_setting_state_summaries_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::DeviceSettingStateSummaries::Item::SettingStateDeviceSummaryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the deviceStatuses property of the microsoft.graph.deviceCompliancePolicy entity.
        ## @param id Unique identifier of the item
        ...
        def device_statuses_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::DeviceStatuses::Item::DeviceComplianceDeviceStatusItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::DeviceCompliancePolicy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ...
        def scheduled_actions_for_rule_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::ScheduledActionsForRule::Item::DeviceComplianceScheduledActionForRuleItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property deviceCompliancePolicies for deviceManagement
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def user_statuses_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::Item::UserStatuses::Item::DeviceComplianceUserStatusItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
