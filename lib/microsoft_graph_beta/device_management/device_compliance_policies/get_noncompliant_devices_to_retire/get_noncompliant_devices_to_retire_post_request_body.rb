...
module MicrosoftGraphBeta::DeviceManagement::DeviceCompliancePolicies::GetNoncompliantDevicesToRetire
    class GetNoncompliantDevicesToRetirePostRequestBody
        ...
        ## @return a get_noncompliant_devices_to_retire_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetNoncompliantDevicesToRetirePostRequestBody.new
        end
        ## 
