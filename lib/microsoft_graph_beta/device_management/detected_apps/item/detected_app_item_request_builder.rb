...
module MicrosoftGraphBeta::DeviceManagement::DetectedApps::Item
    ## 
    ...
    class DetectedAppItemRequestBuilder
        ...
        def managed_devices()
            return MicrosoftGraphBeta::DeviceManagement::DetectedApps::Item::ManagedDevices::ManagedDevicesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
