...
module MicrosoftGraphBeta::DeviceManagement::AndroidDeviceOwnerEnrollmentProfiles::Item
    ...
    class AndroidDeviceOwnerEnrollmentProfileItemRequestBuilder
        ...
        def create_token()
            return MicrosoftGraphBeta::DeviceManagement::AndroidDeviceOwnerEnrollmentProfiles::Item::CreateToken::CreateTokenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def revoke_token()
            return MicrosoftGraphBeta::DeviceManagement::AndroidDeviceOwnerEnrollmentProfiles::Item::RevokeToken::RevokeTokenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/androidDeviceOwnerEnrollmentProfiles/{androidDeviceOwnerEnrollmentProfile%2Did}{?%24select,%24expand}"
        ...
        ## Android device owner enrollment profile entities.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of android_device_owner_enrollment_profile
        ## 
