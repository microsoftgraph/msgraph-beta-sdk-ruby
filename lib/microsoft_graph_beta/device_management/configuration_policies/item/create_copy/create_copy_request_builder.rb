...
module MicrosoftGraphBeta::DeviceManagement::ConfigurationPolicies::Item::CreateCopy
    ## 
    ...
    class CreateCopyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy%2Did}/microsoft.graph.createCopy"
