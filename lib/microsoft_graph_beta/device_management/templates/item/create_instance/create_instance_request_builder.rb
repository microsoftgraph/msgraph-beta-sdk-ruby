...
module MicrosoftGraphBeta::DeviceManagement::Templates::Item::CreateInstance
    ## 
    ...
    class CreateInstanceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/templates/{deviceManagementTemplate%2Did}/microsoft.graph.createInstance"
