...
module MicrosoftGraphBeta::DeviceManagement::GroupPolicyCategories::Item::Definitions::Item
    ## 
    ...
    class GroupPolicyDefinitionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory%2Did}/definitions/{groupPolicyDefinition%2Did}{?%24select,%24expand}"
