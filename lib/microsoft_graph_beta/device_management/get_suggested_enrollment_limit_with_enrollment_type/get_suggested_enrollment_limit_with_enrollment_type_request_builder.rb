...
module MicrosoftGraphBeta::DeviceManagement::GetSuggestedEnrollmentLimitWithEnrollmentType
    ...
    class GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, enrollment_type=nil)
            ...
            @url_template = "{+baseurl}/deviceManagement/microsoft.graph.getSuggestedEnrollmentLimit(enrollmentType='{enrollmentType}')"
        ...
        ## Invoke function getSuggestedEnrollmentLimit
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of suggested_enrollment_limit
        ## 
