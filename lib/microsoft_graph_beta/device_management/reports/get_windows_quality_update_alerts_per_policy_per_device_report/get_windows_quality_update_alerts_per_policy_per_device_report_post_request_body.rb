...
require_relative './get_windows_quality_update_alerts_per_policy_per_device_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReport
    class GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody
        ...
        ## @return a get_windows_quality_update_alerts_per_policy_per_device_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody.new
        end
        ## 
