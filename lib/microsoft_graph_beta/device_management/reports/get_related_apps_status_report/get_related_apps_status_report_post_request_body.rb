...
module MicrosoftGraphBeta::DeviceManagement::Reports::GetRelatedAppsStatusReport
    class GetRelatedAppsStatusReportPostRequestBody
        ...
        ## @return a get_related_apps_status_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetRelatedAppsStatusReportPostRequestBody.new
        end
        ## 
