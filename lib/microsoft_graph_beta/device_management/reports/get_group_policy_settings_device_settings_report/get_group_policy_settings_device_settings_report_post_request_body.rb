...
module MicrosoftGraphBeta::DeviceManagement::Reports::GetGroupPolicySettingsDeviceSettingsReport
    ## 
    # Provides operations to call the getGroupPolicySettingsDeviceSettingsReport method.
    class GetGroupPolicySettingsDeviceSettingsReportPostRequestBody
        ...
        ## @return a get_group_policy_settings_device_settings_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetGroupPolicySettingsDeviceSettingsReportPostRequestBody.new
        end
        ## 
