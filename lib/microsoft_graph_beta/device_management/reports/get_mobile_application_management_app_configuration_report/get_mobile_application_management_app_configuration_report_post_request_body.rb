...
require_relative './get_mobile_application_management_app_configuration_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::GetMobileApplicationManagementAppConfigurationReport
    class GetMobileApplicationManagementAppConfigurationReportPostRequestBody
        ...
        ## @return a get_mobile_application_management_app_configuration_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetMobileApplicationManagementAppConfigurationReportPostRequestBody.new
        end
        ## 
