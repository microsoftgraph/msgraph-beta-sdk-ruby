...
module MicrosoftGraphBeta::DeviceManagement::Reports::GetUnhealthyDefenderAgentsReport
    class GetUnhealthyDefenderAgentsReportPostRequestBody
        ...
        ## @return a get_unhealthy_defender_agents_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetUnhealthyDefenderAgentsReportPostRequestBody.new
        end
        ## 
