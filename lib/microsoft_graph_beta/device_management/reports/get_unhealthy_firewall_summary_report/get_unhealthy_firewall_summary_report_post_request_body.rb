...
module MicrosoftGraphBeta::DeviceManagement::Reports::GetUnhealthyFirewallSummaryReport
    class GetUnhealthyFirewallSummaryReportPostRequestBody
        ...
        ## @return a get_unhealthy_firewall_summary_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetUnhealthyFirewallSummaryReportPostRequestBody.new
        end
        ## 
