...
require_relative './get_compliance_policies_report_for_device'
...
module MicrosoftGraphBeta::DeviceManagement::Reports::GetCompliancePoliciesReportForDevice
    ...
    class GetCompliancePoliciesReportForDevicePostRequestBody
        ...
        ## @return a get_compliance_policies_report_for_device_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetCompliancePoliciesReportForDevicePostRequestBody.new
        end
        ## 
