...
require_relative './get_apps_install_summary_report'
...
module MicrosoftGraphBeta::DeviceManagement::Reports::GetAppsInstallSummaryReport
    ...
    class GetAppsInstallSummaryReportPostRequestBody
        ...
        ## @return a get_apps_install_summary_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetAppsInstallSummaryReportPostRequestBody.new
        end
        ## 
