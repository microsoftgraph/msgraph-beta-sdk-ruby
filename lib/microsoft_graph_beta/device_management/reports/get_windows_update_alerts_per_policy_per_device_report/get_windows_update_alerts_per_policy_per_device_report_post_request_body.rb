...
module MicrosoftGraphBeta::DeviceManagement::Reports::GetWindowsUpdateAlertsPerPolicyPerDeviceReport
    ...
    class GetWindowsUpdateAlertsPerPolicyPerDeviceReportPostRequestBody
        ...
        ## @return a get_windows_update_alerts_per_policy_per_device_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetWindowsUpdateAlertsPerPolicyPerDeviceReportPostRequestBody.new
        end
        ## 
