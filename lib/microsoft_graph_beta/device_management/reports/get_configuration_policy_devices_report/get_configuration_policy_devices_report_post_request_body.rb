...
require_relative './get_configuration_policy_devices_report'

module MicrosoftGraphBeta::DeviceManagement::Reports::GetConfigurationPolicyDevicesReport
    class GetConfigurationPolicyDevicesReportPostRequestBody
        ...
        ## @return a get_configuration_policy_devices_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetConfigurationPolicyDevicesReportPostRequestBody.new
        end
        ## 
