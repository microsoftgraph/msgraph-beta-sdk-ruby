...
require_relative './exchange_on_premises_policy'
...
module MicrosoftGraphBeta::DeviceManagement::ExchangeOnPremisesPolicy
    ...
    class ExchangeOnPremisesPolicyRequestBuilder
        ...
        def conditional_access_settings()
            return MicrosoftGraphBeta::DeviceManagement::ExchangeOnPremisesPolicy::ConditionalAccessSettings::ConditionalAccessSettingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/exchangeOnPremisesPolicy{?%24select,%24expand}"
