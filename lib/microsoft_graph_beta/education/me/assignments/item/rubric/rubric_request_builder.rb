...
module MicrosoftGraphBeta::Education::Me::Assignments::Item::Rubric
    ## 
    ...
    class RubricRequestBuilder
        ...
        def ref()
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::Rubric::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
