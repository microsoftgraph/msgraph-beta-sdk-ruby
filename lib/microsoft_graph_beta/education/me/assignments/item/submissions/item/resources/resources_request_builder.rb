...
module MicrosoftGraphBeta::Education::Me::Assignments::Item::Submissions::Item::Resources
    ## 
    ...
    class ResourcesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::Submissions::Item::Resources::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
