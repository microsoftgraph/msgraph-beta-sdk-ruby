...
module MicrosoftGraphBeta::Education::Schools::Item
    ## 
    ...
    class EducationSchoolItemRequestBuilder
        ...
        def administrative_unit()
            return MicrosoftGraphBeta::Education::Schools::Item::AdministrativeUnit::AdministrativeUnitRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the classes property of the microsoft.graph.educationSchool entity.
        def classes()
            return MicrosoftGraphBeta::Education::Schools::Item::Classes::ClassesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def users()
            return MicrosoftGraphBeta::Education::Schools::Item::Users::UsersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Gets an item from the MicrosoftGraphBeta.education.schools.item.classes.item collection
        ...
        def classes_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Schools::Item::Classes::Item::EducationClassItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::EducationSchool.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ...
        ## 
        ## Gets an item from the MicrosoftGraphBeta.education.schools.item.users.item collection
        ## @param id Unique identifier of the item
        ...
        def users_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Schools::Item::Users::Item::EducationUserItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
