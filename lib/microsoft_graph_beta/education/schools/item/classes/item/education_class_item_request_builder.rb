...
module MicrosoftGraphBeta::Education::Schools::Item::Classes::Item
    ## 
    ...
    class EducationClassItemRequestBuilder
        ...
        def ref()
            return MicrosoftGraphBeta::Education::Schools::Item::Classes::Item::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
