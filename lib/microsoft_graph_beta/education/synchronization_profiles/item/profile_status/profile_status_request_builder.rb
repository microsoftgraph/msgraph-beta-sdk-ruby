...
module MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::ProfileStatus
    ## 
    ...
    class ProfileStatusRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/synchronizationProfiles/{educationSynchronizationProfile%2Did}/profileStatus{?%24select,%24expand}"
        ...
        ## Get the status of a specific school data synchronization profile in the tenant. The response will indicate the status of the sync.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of education_synchronization_profile_status
        ## 
