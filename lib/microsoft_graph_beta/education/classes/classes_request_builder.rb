...
module MicrosoftGraphBeta::Education::Classes
    ## 
    ...
    class ClassesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Education::Classes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::EducationClassCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
