...
module MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Rubric
    ## 
    ...
    class RubricRequestBuilder
        ...
        def ref()
            return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Rubric::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
