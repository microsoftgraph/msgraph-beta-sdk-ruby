...
module MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Submissions::Item::Outcomes
    ## 
    ...
    class OutcomesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Submissions::Item::Outcomes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
