...
module MicrosoftGraphBeta::Education::Classes::Item::AssignmentDefaults
    ## 
    ...
    class AssignmentDefaultsRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::EducationAssignmentDefaults.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
