...
module MicrosoftGraphBeta::Education::Classes::Item::Teachers::Item
    ## 
    ...
    class EducationUserItemRequestBuilder
        ...
        def ref()
            return MicrosoftGraphBeta::Education::Classes::Item::Teachers::Item::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
