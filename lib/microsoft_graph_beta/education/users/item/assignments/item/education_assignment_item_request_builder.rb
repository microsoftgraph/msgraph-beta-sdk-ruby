...
module MicrosoftGraphBeta::Education::Users::Item::Assignments::Item
    ## 
    ...
    class EducationAssignmentItemRequestBuilder
        ...
        def categories()
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::Item::Categories::CategoriesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def publish()
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::Item::Publish::PublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resources()
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::Item::Resources::ResourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the rubric property of the microsoft.graph.educationAssignment entity.
        def rubric()
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::Item::Rubric::RubricRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setUpFeedbackResourcesFolder method.
        def set_up_feedback_resources_folder()
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::Item::SetUpFeedbackResourcesFolder::SetUpFeedbackResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setUpResourcesFolder method.
        def set_up_resources_folder()
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::Item::SetUpResourcesFolder::SetUpResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the submissions property of the microsoft.graph.educationAssignment entity.
        def submissions()
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::Item::Submissions::SubmissionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Url template to use to build the URL for the current request builder
        @url_template
        ## 
        ## Gets an item from the MicrosoftGraphBeta.education.users.item.assignments.item.categories.item collection
        ...
        def categories_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::Item::Categories::Item::EducationCategoryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def resources_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::Item::Resources::Item::EducationAssignmentResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the submissions property of the microsoft.graph.educationAssignment entity.
        ## @param id Unique identifier of the item
        ...
        def submissions_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::Item::Submissions::Item::EducationSubmissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
