...
module MicrosoftGraphBeta::Education::Users::Item
    ## 
    ...
    class EducationUserItemRequestBuilder
        ...
        def assignments()
            return MicrosoftGraphBeta::Education::Users::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the classes property of the microsoft.graph.educationUser entity.
        def classes()
            return MicrosoftGraphBeta::Education::Users::Item::Classes::ClassesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def rubrics()
            return MicrosoftGraphBeta::Education::Users::Item::Rubrics::RubricsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the schools property of the microsoft.graph.educationUser entity.
        def schools()
            return MicrosoftGraphBeta::Education::Users::Item::Schools::SchoolsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the taughtClasses property of the microsoft.graph.educationUser entity.
        def taught_classes()
            return MicrosoftGraphBeta::Education::Users::Item::TaughtClasses::TaughtClassesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Education::Users::Item::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the assignments property of the microsoft.graph.educationUser entity.
        ...
        def classes_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Users::Item::Classes::Item::EducationClassItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
