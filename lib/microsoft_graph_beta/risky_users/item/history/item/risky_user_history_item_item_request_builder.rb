...
module MicrosoftGraphBeta::RiskyUsers::Item::History::Item
    ## 
    ...
    class RiskyUserHistoryItemItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/riskyUsers/{riskyUser%2Did}/history/{riskyUserHistoryItem%2Did}{?%24select,%24expand}"
