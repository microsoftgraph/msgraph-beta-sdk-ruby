...
module MicrosoftGraphBeta::AdministrativeUnits::Item::Members::Application::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.application/$count"
