...
module MicrosoftGraphBeta::AdministrativeUnits::Item
    ...
    class AdministrativeUnitItemRequestBuilder
        ...
        def check_member_groups()
            return MicrosoftGraphBeta::AdministrativeUnits::Item::CheckMemberGroups::CheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def check_member_objects()
            return MicrosoftGraphBeta::AdministrativeUnits::Item::CheckMemberObjects::CheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get_member_groups()
            return MicrosoftGraphBeta::AdministrativeUnits::Item::GetMemberGroups::GetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def get_member_objects()
            return MicrosoftGraphBeta::AdministrativeUnits::Item::GetMemberObjects::GetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore()
            return MicrosoftGraphBeta::AdministrativeUnits::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
