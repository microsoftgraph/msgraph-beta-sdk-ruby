...
require_relative '../../models/role_success_statistics'
...
module MicrosoftGraphBeta::PrivilegedSignupStatus::CompleteSetup
    ...
    class CompleteSetupResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
        ...
        ## @return a complete_setup_response
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return CompleteSetupResponse.new
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RoleSuccessStatistics.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
