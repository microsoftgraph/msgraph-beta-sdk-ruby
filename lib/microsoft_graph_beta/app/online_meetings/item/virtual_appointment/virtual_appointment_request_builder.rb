...
module MicrosoftGraphBeta::App::OnlineMeetings::Item::VirtualAppointment
    ## 
    ...
    class VirtualAppointmentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/virtualAppointment{?%24select,%24expand}"
        ...
        ## Get virtualAppointment from app
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of virtual_appointment
        ## 
