...
module MicrosoftGraphBeta::App::OnlineMeetings::Item::MeetingAttendanceReport::AttendanceRecords::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport/attendanceRecords/$count"
