...
require_relative '../models/comms_application'
...
module MicrosoftGraphBeta::App
    ...
    class AppRequestBuilder
        ...
        def calls()
            return MicrosoftGraphBeta::App::Calls::CallsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the onlineMeetings property of the microsoft.graph.commsApplication entity.
        def online_meetings()
            return MicrosoftGraphBeta::App::OnlineMeetings::OnlineMeetingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def calls_by_id(id)
            ...
            return MicrosoftGraphBeta::App::Calls::Item::CallItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app{?%24select,%24expand}"
        ...
        ## Get app
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of comms_application
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::CommsApplication.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the onlineMeetings property of the microsoft.graph.commsApplication entity.
        ## @param id Unique identifier of the item
