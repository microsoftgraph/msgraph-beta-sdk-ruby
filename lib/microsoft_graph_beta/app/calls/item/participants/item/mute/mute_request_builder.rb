...
module MicrosoftGraphBeta::App::Calls::Item::Participants::Item::Mute
    ## 
    ...
    class MuteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/calls/{call%2Did}/participants/{participant%2Did}/microsoft.graph.mute"
