...
require_relative '../../../../../models/mute_participants_operation'
require_relative '../../../../../models/o_data_errors/o_data_error'
require_relative '../../../../app'
require_relative '../../../calls'
require_relative '../../item'
require_relative '../participants'
require_relative './mute_all'

module MicrosoftGraphBeta::App::Calls::Item::Participants::MuteAll
    ## 
    ...
    class MuteAllRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/calls/{call%2Did}/participants/microsoft.graph.muteAll"
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of mute_participants_operation
        ## 
