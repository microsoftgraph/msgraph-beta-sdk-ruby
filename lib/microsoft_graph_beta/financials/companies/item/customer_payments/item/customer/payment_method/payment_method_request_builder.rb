...
module MicrosoftGraphBeta::Financials::Companies::Item::CustomerPayments::Item::Customer::PaymentMethod
    ## 
    ...
    class PaymentMethodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/customerPayments/{customerPayment%2Did}/customer/paymentMethod{?%24select,%24expand}"
