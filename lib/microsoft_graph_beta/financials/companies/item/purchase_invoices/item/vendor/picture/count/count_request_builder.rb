...
module MicrosoftGraphBeta::Financials::Companies::Item::PurchaseInvoices::Item::Vendor::Picture::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoices/{purchaseInvoice%2Did}/vendor/picture/$count"
