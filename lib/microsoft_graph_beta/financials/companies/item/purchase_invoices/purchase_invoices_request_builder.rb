...
module MicrosoftGraphBeta::Financials::Companies::Item::PurchaseInvoices
    ## 
    ...
    class PurchaseInvoicesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get purchaseInvoices from financials
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of purchase_invoice_collection_response
        ## 
