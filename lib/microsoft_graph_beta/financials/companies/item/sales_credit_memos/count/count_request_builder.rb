...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesCreditMemos::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/$count"
