...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesCreditMemoLines::Item::Account
    ## 
    ...
    class AccountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}/account{?%24select,%24expand}"
