...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesOrderLines::Item::Item::ItemCategory
    ## 
    ...
    class ItemCategoryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesOrderLines/{salesOrderLine%2Did}/item/itemCategory{?%24select,%24expand}"
