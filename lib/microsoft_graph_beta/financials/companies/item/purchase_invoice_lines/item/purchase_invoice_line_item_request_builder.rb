...
require_relative '../../../../../models/purchase_invoice_line'
...
module MicrosoftGraphBeta::Financials::Companies::Item::PurchaseInvoiceLines::Item
    ## 
    ...
    class PurchaseInvoiceLineItemRequestBuilder
        ...
        def account()
            return MicrosoftGraphBeta::Financials::Companies::Item::PurchaseInvoiceLines::Item::Account::AccountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the item property of the microsoft.graph.purchaseInvoiceLine entity.
        def item()
            return MicrosoftGraphBeta::Financials::Companies::Item::PurchaseInvoiceLines::Item::Item::ItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoiceLines/{purchaseInvoiceLine%2Did}{?%24select,%24expand}"
        ...
        ## Get purchaseInvoiceLines from financials
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of purchase_invoice_line
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PurchaseInvoiceLine.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property purchaseInvoiceLines in financials
        ## @param body The request body
