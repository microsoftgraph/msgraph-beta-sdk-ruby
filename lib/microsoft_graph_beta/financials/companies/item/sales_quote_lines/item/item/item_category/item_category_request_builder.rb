...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesQuoteLines::Item::Item::ItemCategory
    ## 
    ...
    class ItemCategoryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesQuoteLines/{salesQuoteLine%2Did}/item/itemCategory{?%24select,%24expand}"
