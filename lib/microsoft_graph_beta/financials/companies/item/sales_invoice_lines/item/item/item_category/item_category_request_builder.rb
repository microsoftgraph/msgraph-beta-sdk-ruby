...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoiceLines::Item::Item::ItemCategory
    ## 
    ...
    class ItemCategoryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesInvoiceLines/{salesInvoiceLine%2Did}/item/itemCategory{?%24select,%24expand}"
