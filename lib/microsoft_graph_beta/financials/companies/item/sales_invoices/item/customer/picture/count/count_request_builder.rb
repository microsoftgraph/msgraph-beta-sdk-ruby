...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::Customer::Picture::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesInvoices/{salesInvoice%2Did}/customer/picture/$count"
