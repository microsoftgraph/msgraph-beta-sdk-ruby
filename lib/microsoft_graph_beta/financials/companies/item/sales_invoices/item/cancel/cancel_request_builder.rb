...
module MicrosoftGraphBeta::Financials::Companies::Item::SalesInvoices::Item::Cancel
    ## 
    ...
    class CancelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/financials/companies/{company%2Did}/salesInvoices/{salesInvoice%2Did}/microsoft.graph.cancel"
