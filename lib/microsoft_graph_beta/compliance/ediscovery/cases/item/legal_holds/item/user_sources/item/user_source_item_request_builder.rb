...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::LegalHolds::Item::UserSources::Item
    ## 
    ...
    class UserSourceItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/userSources/{userSource%2Did}{?%24select,%24expand}"
