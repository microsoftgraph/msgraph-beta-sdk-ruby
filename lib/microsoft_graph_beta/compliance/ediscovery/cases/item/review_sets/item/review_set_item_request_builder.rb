...
require_relative '../../../../../../models/ediscovery/review_set'
...
require_relative './item'
require_relative './queries/item/review_set_query_item_request_builder'
require_relative './queries/queries_request_builder'

module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::ReviewSets::Item
    ## 
    ...
    class ReviewSetItemRequestBuilder
        ...
        def add_to_review_set()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::ReviewSets::Item::AddToReviewSet::AddToReviewSetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the export method.
        def export()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::ReviewSets::Item::Export::ExportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/reviewSets/{reviewSet%2Did}{?%24select,%24expand}"
        ...
        ## Returns a list of reviewSet objects in the case. Read-only. Nullable.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of review_set
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::ReviewSet.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property reviewSets in compliance
        ## @param body The request body
        ...
        def queries_by_id(id)
            ...
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::ReviewSets::Item::Queries::Item::ReviewSetQueryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
