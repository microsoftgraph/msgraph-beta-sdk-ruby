...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::ReviewSets::Item::Queries::Item
    ## 
    ...
    class ReviewSetQueryItemRequestBuilder
        ...
        def apply_tags()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::ReviewSets::Item::Queries::Item::ApplyTags::ApplyTagsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/reviewSets/{reviewSet%2Did}/queries/{reviewSetQuery%2Did}{?%24select,%24expand}"
