...
require_relative '../../../../../../models/ediscovery/source_collection'
...
require_relative './noncustodial_sources/item/noncustodial_data_source_item_request_builder'
...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item
    ## 
    ...
    class SourceCollectionItemRequestBuilder
        ...
        def estimate_statistics()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item::EstimateStatistics::EstimateStatisticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def purge_data()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item::PurgeData::PurgeDataRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def additional_sources_by_id(id)
            ...
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item::AdditionalSources::Item::DataSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}{?%24select,%24expand}"
        ...
        def custodian_sources_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["dataSource%2Did"] = id
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item::CustodianSources::Item::DataSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property sourceCollections for compliance
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        ## Returns a list of sourceCollection objects associated with this case.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of source_collection
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::SourceCollection.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the noncustodialSources property of the microsoft.graph.ediscovery.sourceCollection entity.
        ## @param id Unique identifier of the item
        ...
        def noncustodial_sources_by_id(id)
            ...
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item::NoncustodialSources::Item::NoncustodialDataSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property sourceCollections in compliance
        ## @param body The request body
