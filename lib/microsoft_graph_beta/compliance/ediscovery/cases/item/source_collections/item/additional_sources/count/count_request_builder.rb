...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Item::AdditionalSources::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/additionalSources/$count"
