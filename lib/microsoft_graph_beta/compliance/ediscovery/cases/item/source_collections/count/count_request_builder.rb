...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::SourceCollections::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/$count"
