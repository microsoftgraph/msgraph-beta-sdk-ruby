...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item
    ## 
    ...
    class CaseItemRequestBuilder
        ...
        def close()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Close::CloseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reopen()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Reopen::ReopenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
