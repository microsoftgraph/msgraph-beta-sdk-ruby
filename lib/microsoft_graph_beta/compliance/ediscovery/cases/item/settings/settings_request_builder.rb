...
require_relative '../../../../../models/ediscovery/case_settings'
...
module MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Settings
    ## 
    ...
    class SettingsRequestBuilder
        ...
        def reset_to_default()
            return MicrosoftGraphBeta::Compliance::Ediscovery::Cases::Item::Settings::ResetToDefault::ResetToDefaultRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/settings{?%24select,%24expand}"
        ...
        ## Read the properties and relationships of an eDiscovery caseSettings object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of case_settings
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::CaseSettings.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the properties of a an eDiscovery caseSettings object.
        ## @param body The request body
