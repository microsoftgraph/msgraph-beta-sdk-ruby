...
module MicrosoftGraphBeta::Chats::Item::PermissionGrants::ValidateProperties
    ## 
    ...
    class ValidatePropertiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/chats/{chat%2Did}/permissionGrants/microsoft.graph.validateProperties"
