...
module MicrosoftGraphBeta::Chats::Item::Messages
    ## 
    ...
    class MessagesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Chats::Item::Messages::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
