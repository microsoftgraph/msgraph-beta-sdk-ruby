...
module MicrosoftGraphBeta::Chats::Item::Messages::Item::Replies::Item::HostedContents
    ## 
    ...
    class HostedContentsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Chats::Item::Messages::Item::Replies::Item::HostedContents::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
