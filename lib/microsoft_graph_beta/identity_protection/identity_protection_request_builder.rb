...
module MicrosoftGraphBeta::IdentityProtection
    ...
    class IdentityProtectionRequestBuilder
        ...
        def risk_detections()
            return MicrosoftGraphBeta::IdentityProtection::RiskDetections::RiskDetectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the riskyServicePrincipals property of the microsoft.graph.identityProtectionRoot entity.
        def risky_service_principals()
            return MicrosoftGraphBeta::IdentityProtection::RiskyServicePrincipals::RiskyServicePrincipalsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the riskyUsers property of the microsoft.graph.identityProtectionRoot entity.
        def risky_users()
            return MicrosoftGraphBeta::IdentityProtection::RiskyUsers::RiskyUsersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the servicePrincipalRiskDetections property of the microsoft.graph.identityProtectionRoot entity.
        def service_principal_risk_detections()
            return MicrosoftGraphBeta::IdentityProtection::ServicePrincipalRiskDetections::ServicePrincipalRiskDetectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IdentityProtectionRoot.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update identityProtection
        ## @param body The request body
        ...
        def risk_detections_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityProtection::RiskDetections::Item::RiskDetectionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the riskyServicePrincipals property of the microsoft.graph.identityProtectionRoot entity.
        ## @param id Unique identifier of the item
        ...
        def risky_service_principals_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityProtection::RiskyServicePrincipals::Item::RiskyServicePrincipalItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the riskyUsers property of the microsoft.graph.identityProtectionRoot entity.
        ## @param id Unique identifier of the item
        ...
        def risky_users_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityProtection::RiskyUsers::Item::RiskyUserItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the servicePrincipalRiskDetections property of the microsoft.graph.identityProtectionRoot entity.
        ## @param id Unique identifier of the item
        ...
        def service_principal_risk_detections_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityProtection::ServicePrincipalRiskDetections::Item::ServicePrincipalRiskDetectionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
