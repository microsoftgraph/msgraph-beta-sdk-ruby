...
module MicrosoftGraphBeta::IdentityProtection::RiskyServicePrincipals::Item
    ## 
    ...
    class RiskyServicePrincipalItemRequestBuilder
        ...
        def history()
            return MicrosoftGraphBeta::IdentityProtection::RiskyServicePrincipals::Item::History::HistoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def history_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityProtection::RiskyServicePrincipals::Item::History::Item::RiskyServicePrincipalHistoryItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property riskyServicePrincipals in identityProtection
        ## @param body The request body
