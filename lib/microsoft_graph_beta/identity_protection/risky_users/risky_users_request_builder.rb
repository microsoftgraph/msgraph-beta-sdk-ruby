...
module MicrosoftGraphBeta::IdentityProtection::RiskyUsers
    ## 
    ...
    class RiskyUsersRequestBuilder
        ...
        def confirm_compromised()
            return MicrosoftGraphBeta::IdentityProtection::RiskyUsers::ConfirmCompromised::ConfirmCompromisedRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to count the resources in the collection.
        def count()
            return MicrosoftGraphBeta::IdentityProtection::RiskyUsers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the dismiss method.
        def dismiss()
            return MicrosoftGraphBeta::IdentityProtection::RiskyUsers::Dismiss::DismissRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::RiskyUserCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Create new navigation property to riskyUsers for identityProtection
        ## @param body The request body
