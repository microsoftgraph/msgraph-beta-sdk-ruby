...
module MicrosoftGraphBeta::IdentityProtection::RiskyUsers::Item
    ## 
    ...
    class RiskyUserItemRequestBuilder
        ...
        def history()
            return MicrosoftGraphBeta::IdentityProtection::RiskyUsers::Item::History::HistoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
