...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags
    ## 
    ...
    class TenantTagsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/tenantTags{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get a list of the tenantTag objects and their properties.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of tenant_tag_collection_response
        ## 
