...
require_relative './assign_tag/assign_tag_request_builder'
require_relative './item'
require_relative './unassign_tag/unassign_tag_request_builder'

module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Item
    ## 
    ...
    class TenantTagItemRequestBuilder
        ...
        def assign_tag()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Item::AssignTag::AssignTagRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def unassign_tag()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantTags::Item::UnassignTag::UnassignTagRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/tenantTags/{tenantTag%2Did}{?%24select,%24expand}"
