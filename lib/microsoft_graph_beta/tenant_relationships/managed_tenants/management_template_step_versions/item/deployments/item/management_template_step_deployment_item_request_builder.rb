...
require_relative '../../../../../../models/managed_tenants/management_template_step_deployment'
...
require_relative './item'
require_relative './template_step_version/template_step_version_request_builder'

module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementTemplateStepVersions::Item::Deployments::Item
    ## 
    ...
    class ManagementTemplateStepDeploymentItemRequestBuilder
        ...
        def change_deployment_status()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementTemplateStepVersions::Item::Deployments::Item::ChangeDeploymentStatus::ChangeDeploymentStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def template_step_version()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagementTemplateStepVersions::Item::Deployments::Item::TemplateStepVersion::TemplateStepVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateStepVersions/{managementTemplateStepVersion%2Did}/deployments/{managementTemplateStepDeployment%2Did}{?%24select,%24expand}"
        ...
        ## Get deployments from tenantRelationships
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of management_template_step_deployment
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagementTemplateStepDeployment.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property deployments in tenantRelationships
        ## @param body The request body
