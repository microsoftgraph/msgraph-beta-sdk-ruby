...
require_relative '../../../models/managed_tenants/tenant_collection_response'
...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants
    ## 
    ...
    class TenantsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/tenants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get a list of the tenant objects and their properties.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of tenant_collection_response
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::TenantCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Create new navigation property to tenants for tenantRelationships
        ## @param body The request body
