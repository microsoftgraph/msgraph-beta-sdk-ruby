...
require_relative './offboard_tenant/offboard_tenant_request_builder'
require_relative './reset_tenant_onboarding_status/reset_tenant_onboarding_status_request_builder'

module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants::Item
    ## 
    ...
    class TenantItemRequestBuilder
        ...
        def offboard_tenant()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants::Item::OffboardTenant::OffboardTenantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reset_tenant_onboarding_status()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants::Item::ResetTenantOnboardingStatus::ResetTenantOnboardingStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}{?%24select,%24expand}"
