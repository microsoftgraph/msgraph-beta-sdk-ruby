...
require_relative './offboard_tenant'

module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::Tenants::Item::OffboardTenant
    ## 
    ...
    class OffboardTenantRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}/microsoft.graph.managedTenants.offboardTenant"
