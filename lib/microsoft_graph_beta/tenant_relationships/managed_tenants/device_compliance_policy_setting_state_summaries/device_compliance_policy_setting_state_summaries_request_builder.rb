...
require_relative '../../../models/managed_tenants/device_compliance_policy_setting_state_summary'
require_relative '../../../models/managed_tenants/device_compliance_policy_setting_state_summary_collection_response'
...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::DeviceCompliancePolicySettingStateSummaries
    ...
    class DeviceCompliancePolicySettingStateSummariesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/deviceCompliancePolicySettingStateSummaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::DeviceCompliancePolicySettingStateSummaryCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ...
        def post(body, request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::DeviceCompliancePolicySettingStateSummary.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Get a list of the deviceCompliancePolicySettingStateSummary objects and their properties.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
