...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagedTenantAlerts::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/managedTenantAlerts/$count"
