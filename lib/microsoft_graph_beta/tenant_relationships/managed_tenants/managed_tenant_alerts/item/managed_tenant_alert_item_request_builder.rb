...
require_relative './add_user_input_log/add_user_input_log_request_builder'
...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagedTenantAlerts::Item
    ...
    class ManagedTenantAlertItemRequestBuilder
        ...
        def add_user_input_log()
            return MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagedTenantAlerts::Item::AddUserInputLog::AddUserInputLogRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
