...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagedTenantAlerts::Item::AlertRule
    ## 
    ...
    class AlertRuleRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/managedTenantAlerts/{managedTenantAlert%2Did}/alertRule{?%24select,%24expand}"
