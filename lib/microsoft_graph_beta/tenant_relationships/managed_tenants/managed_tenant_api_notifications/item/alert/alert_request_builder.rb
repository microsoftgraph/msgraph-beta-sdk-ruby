...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::ManagedTenantApiNotifications::Item::Alert
    ## 
    ...
    class AlertRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/managedTenantApiNotifications/{managedTenantApiNotification%2Did}/alert{?%24select,%24expand}"
        ...
        ## Get alert from tenantRelationships
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of managed_tenant_alert
        ## 
