...
require_relative './tenant_search'
...
module MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantGroups::TenantSearch
    ...
    class TenantSearchRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/managedTenants/tenantGroups/microsoft.graph.managedTenants.tenantSearch"
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of tenant_search_response
        ## 
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::TenantRelationships::ManagedTenants::TenantGroups::TenantSearch::TenantSearchResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
