...
module MicrosoftGraphBeta::TenantRelationships::DelegatedAdminRelationships::Item
    ## 
    ...
    class DelegatedAdminRelationshipItemRequestBuilder
        ...
        def access_assignments()
            return MicrosoftGraphBeta::TenantRelationships::DelegatedAdminRelationships::Item::AccessAssignments::AccessAssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.delegatedAdminRelationship entity.
        def operations()
            return MicrosoftGraphBeta::TenantRelationships::DelegatedAdminRelationships::Item::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def requests()
            return MicrosoftGraphBeta::TenantRelationships::DelegatedAdminRelationships::Item::Requests::RequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def access_assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::TenantRelationships::DelegatedAdminRelationships::Item::AccessAssignments::Item::DelegatedAdminAccessAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        ## The details of the delegated administrative privileges that a Microsoft partner has in a customer tenant.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of delegated_admin_relationship
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::DelegatedAdminRelationship.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.delegatedAdminRelationship entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::TenantRelationships::DelegatedAdminRelationships::Item::Operations::Item::DelegatedAdminRelationshipOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property delegatedAdminRelationships in tenantRelationships
        ## @param body The request body
        ...
        def requests_by_id(id)
            ...
            return MicrosoftGraphBeta::TenantRelationships::DelegatedAdminRelationships::Item::Requests::Item::DelegatedAdminRelationshipRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
