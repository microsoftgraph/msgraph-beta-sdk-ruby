...
module MicrosoftGraphBeta::TenantRelationships::FindTenantInformationByDomainNameWithDomainName
    ...
    class FindTenantInformationByDomainNameWithDomainNameRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, domain_name=nil)
            ...
            @url_template = "{+baseurl}/tenantRelationships/microsoft.graph.findTenantInformationByDomainName(domainName='{domainName}')"
        ...
        ## Invoke function findTenantInformationByDomainName
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of tenant_information
        ## 
