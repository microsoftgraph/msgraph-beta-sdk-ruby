...
module MicrosoftGraphBeta::DeviceAppManagement::AndroidManagedAppProtections::Item
    ## 
    ...
    class AndroidManagedAppProtectionItemRequestBuilder
        ...
        def apps()
            return MicrosoftGraphBeta::DeviceAppManagement::AndroidManagedAppProtections::Item::Apps::AppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def deployment_summary()
            return MicrosoftGraphBeta::DeviceAppManagement::AndroidManagedAppProtections::Item::DeploymentSummary::DeploymentSummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def apps_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::AndroidManagedAppProtections::Item::Apps::Item::ManagedMobileAppItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
