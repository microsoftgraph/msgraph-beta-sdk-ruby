...
module MicrosoftGraphBeta::DeviceAppManagement::DefaultManagedAppProtections::Item
    ## 
    ...
    class DefaultManagedAppProtectionItemRequestBuilder
        ...
        def apps()
            return MicrosoftGraphBeta::DeviceAppManagement::DefaultManagedAppProtections::Item::Apps::AppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def deployment_summary()
            return MicrosoftGraphBeta::DeviceAppManagement::DefaultManagedAppProtections::Item::DeploymentSummary::DeploymentSummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def apps_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::DefaultManagedAppProtections::Item::Apps::Item::ManagedMobileAppItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::DefaultManagedAppProtection.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property defaultManagedAppProtections in deviceAppManagement
        ## @param body The request body
