...
require_relative './update_relationships'

module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::UpdateRelationships
    class UpdateRelationshipsPostRequestBody
        ...
        ## @return a update_relationships_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return UpdateRelationshipsPostRequestBody.new
        end
        ## 
