...
require_relative '../../../../models/mobile_app_install_summary'
...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::Item::InstallSummary
    ## 
    ...
    class InstallSummaryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/installSummary{?%24select,%24expand}"
        ...
        ## Mobile App Install Summary.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of mobile_app_install_summary
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::MobileAppInstallSummary.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property installSummary in deviceAppManagement
        ## @param body The request body
