...
module MicrosoftGraphBeta::DeviceAppManagement::MobileApps::GetMobileAppCountWithStatus
    ...
    class GetMobileAppCountWithStatusRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, status=nil)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/mobileApps/microsoft.graph.getMobileAppCount(status='{status}')"
        ...
        ## Invoke function getMobileAppCount
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of get_mobile_app_count_with_status_response
        ## 
