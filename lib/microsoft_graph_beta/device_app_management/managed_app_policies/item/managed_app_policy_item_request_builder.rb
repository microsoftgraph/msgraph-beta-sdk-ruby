...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedAppPolicies::Item
    ## 
    ...
    class ManagedAppPolicyItemRequestBuilder
        ...
        def target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppPolicies::Item::TargetApps::TargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
