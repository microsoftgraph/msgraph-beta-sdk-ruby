...
module MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item
    ## 
    ...
    class ManagedDeviceMobileAppConfigurationItemRequestBuilder
        ...
        def assign()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::Assign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the assignments property of the microsoft.graph.managedDeviceMobileAppConfiguration entity.
        def assignments()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def device_statuses()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::DeviceStatuses::DeviceStatusesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def device_status_summary()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::DeviceStatusSummary::DeviceStatusSummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_statuses()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::UserStatuses::UserStatusesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_status_summary()
            return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::UserStatusSummary::UserStatusSummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the assignments property of the microsoft.graph.managedDeviceMobileAppConfiguration entity.
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::Assignments::Item::ManagedDeviceMobileAppConfigurationAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def device_statuses_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::DeviceStatuses::Item::ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## The Managed Device Mobile Application Configurations.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedDeviceMobileAppConfiguration.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property mobileAppConfigurations in deviceAppManagement
        ## @param body The request body
        ...
        def user_statuses_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::MobileAppConfigurations::Item::UserStatuses::Item::ManagedDeviceMobileAppConfigurationUserStatusItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
