...
module MicrosoftGraphBeta::DeviceAppManagement::IosManagedAppProtections::Item
    ## 
    ...
    class IosManagedAppProtectionItemRequestBuilder
        ...
        def apps()
            return MicrosoftGraphBeta::DeviceAppManagement::IosManagedAppProtections::Item::Apps::AppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the deploymentSummary property of the microsoft.graph.iosManagedAppProtection entity.
        def deployment_summary()
            return MicrosoftGraphBeta::DeviceAppManagement::IosManagedAppProtections::Item::DeploymentSummary::DeploymentSummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def apps_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::IosManagedAppProtections::Item::Apps::Item::ManagedMobileAppItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
