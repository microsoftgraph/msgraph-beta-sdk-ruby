...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::Categories
    ## 
    ...
    class CategoriesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedEBooks::Item::Categories::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## The list of categories for this eBook.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of managed_e_book_category_collection_response
        ## 
