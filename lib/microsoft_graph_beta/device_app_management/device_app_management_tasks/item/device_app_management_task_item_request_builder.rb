...
require_relative './update_status/update_status_request_builder'

module MicrosoftGraphBeta::DeviceAppManagement::DeviceAppManagementTasks::Item
    ## 
    ...
    class DeviceAppManagementTaskItemRequestBuilder
        ...
        def update_status()
            return MicrosoftGraphBeta::DeviceAppManagement::DeviceAppManagementTasks::Item::UpdateStatus::UpdateStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/deviceAppManagementTasks/{deviceAppManagementTask%2Did}{?%24select,%24expand}"
