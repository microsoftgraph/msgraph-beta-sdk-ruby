...
module MicrosoftGraphBeta::DeviceAppManagement::PolicySets::GetPolicySets
    class GetPolicySetsResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
        ...
        ## @return a get_policy_sets_response
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetPolicySetsResponse.new
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PolicySet.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
