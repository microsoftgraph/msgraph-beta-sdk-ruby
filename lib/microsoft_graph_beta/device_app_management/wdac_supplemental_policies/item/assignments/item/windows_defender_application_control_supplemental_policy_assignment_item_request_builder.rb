...
module MicrosoftGraphBeta::DeviceAppManagement::WdacSupplementalPolicies::Item::Assignments::Item
    ...
    class WindowsDefenderApplicationControlSupplementalPolicyAssignmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/wdacSupplementalPolicies/{windowsDefenderApplicationControlSupplementalPolicy%2Did}/assignments/{windowsDefenderApplicationControlSupplementalPolicyAssignment%2Did}{?%24select,%24expand}"
        ...
        ## The associated group assignments for this WindowsDefenderApplicationControl supplemental policy.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of windows_defender_application_control_supplemental_policy_assignment
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::WindowsDefenderApplicationControlSupplementalPolicyAssignment.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property assignments in deviceAppManagement
        ## @param body The request body
