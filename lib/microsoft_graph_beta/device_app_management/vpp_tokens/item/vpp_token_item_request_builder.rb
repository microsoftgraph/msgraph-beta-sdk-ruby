...
require_relative './revoke_licenses/revoke_licenses_request_builder'
require_relative './sync_licenses/sync_licenses_request_builder'

module MicrosoftGraphBeta::DeviceAppManagement::VppTokens::Item
    ## 
    ...
    class VppTokenItemRequestBuilder
        ...
        def revoke_licenses()
            return MicrosoftGraphBeta::DeviceAppManagement::VppTokens::Item::RevokeLicenses::RevokeLicensesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the syncLicenses method.
        def sync_licenses()
            return MicrosoftGraphBeta::DeviceAppManagement::VppTokens::Item::SyncLicenses::SyncLicensesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
