...
module MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item
    ...
    class TargetedManagedAppConfigurationItemRequestBuilder
        ...
        def assign()
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::Assign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::TargetedManagedAppConfigurations::Item::TargetApps::TargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
