...
require_relative './side_loading_keys/item/side_loading_key_item_request_builder'
require_relative './side_loading_keys/side_loading_keys_request_builder'
...
module MicrosoftGraphBeta::DeviceAppManagement
    ...
    class DeviceAppManagementRequestBuilder
        ...
        def side_loading_keys()
            return MicrosoftGraphBeta::DeviceAppManagement::SideLoadingKeys::SideLoadingKeysRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## Provides operations to manage the sideLoadingKeys property of the microsoft.graph.deviceAppManagement entity.
        ## @param id Unique identifier of the item
        ## @return a side_loading_key_item_request_builder
        ## 
        def side_loading_keys_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["sideLoadingKey%2Did"] = id
            return MicrosoftGraphBeta::DeviceAppManagement::SideLoadingKeys::Item::SideLoadingKeyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the targetedManagedAppConfigurations property of the microsoft.graph.deviceAppManagement entity.
        ## @param id Unique identifier of the item
