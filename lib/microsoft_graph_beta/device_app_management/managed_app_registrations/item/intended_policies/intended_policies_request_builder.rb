...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::IntendedPolicies
    ## 
    ...
    class IntendedPoliciesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::IntendedPolicies::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
