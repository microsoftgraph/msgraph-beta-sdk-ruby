...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::IntendedPolicies::Item
    ...
    class ManagedAppPolicyItemRequestBuilder
        ...
        def target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::IntendedPolicies::Item::TargetApps::TargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
