...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item
    ## 
    ...
    class ManagedAppRegistrationItemRequestBuilder
        ...
        def applied_policies()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::AppliedPolicies::AppliedPoliciesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def intended_policies()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::IntendedPolicies::IntendedPoliciesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.managedAppRegistration entity.
        def operations()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def applied_policies_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::AppliedPolicies::Item::ManagedAppPolicyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ManagedAppRegistration.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the intendedPolicies property of the microsoft.graph.managedAppRegistration entity.
        ## @param id Unique identifier of the item
        ...
        def intended_policies_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["managedAppPolicy%2Did"] = id
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::IntendedPolicies::Item::ManagedAppPolicyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.managedAppRegistration entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::Operations::Item::ManagedAppOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
