...
module MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::AppliedPolicies::Item
    ## 
    ...
    class ManagedAppPolicyItemRequestBuilder
        ...
        def target_apps()
            return MicrosoftGraphBeta::DeviceAppManagement::ManagedAppRegistrations::Item::AppliedPolicies::Item::TargetApps::TargetAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
