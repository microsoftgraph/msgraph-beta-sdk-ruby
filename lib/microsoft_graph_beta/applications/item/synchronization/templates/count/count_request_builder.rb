...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Templates::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/synchronization/templates/$count"
