...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Templates::Item::Schema::Directories::Item
    ...
    class DirectoryDefinitionItemRequestBuilder
        ...
        def discover()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Templates::Item::Schema::Directories::Item::Discover::DiscoverRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
