...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs
    ...
    class JobsRequestBuilder
        ...
        def validate_credentials()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::ValidateCredentials::ValidateCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
