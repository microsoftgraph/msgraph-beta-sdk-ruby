...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::Schema::Directories::Item
    ...
    class DirectoryDefinitionItemRequestBuilder
        ...
        def discover()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::Schema::Directories::Item::Discover::DiscoverRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
