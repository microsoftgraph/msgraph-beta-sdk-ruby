...
module MicrosoftGraphBeta::Applications::Item::TokenLifetimePolicies::Item
    ## 
    ...
    class TokenLifetimePolicyItemRequestBuilder
        ...
        def ref()
            return MicrosoftGraphBeta::Applications::Item::TokenLifetimePolicies::Item::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
