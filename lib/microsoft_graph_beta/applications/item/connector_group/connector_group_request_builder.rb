...
module MicrosoftGraphBeta::Applications::Item::ConnectorGroup
    ## 
    ...
    class ConnectorGroupRequestBuilder
        ...
        def ref()
            return MicrosoftGraphBeta::Applications::Item::ConnectorGroup::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/connectorGroup{?%24select,%24expand}"
