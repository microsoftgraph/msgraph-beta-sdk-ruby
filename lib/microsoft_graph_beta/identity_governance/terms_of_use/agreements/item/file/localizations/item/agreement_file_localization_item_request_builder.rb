...
module MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::File::Localizations::Item
    ## 
    ...
    class AgreementFileLocalizationItemRequestBuilder
        ...
        def versions()
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::File::Localizations::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
