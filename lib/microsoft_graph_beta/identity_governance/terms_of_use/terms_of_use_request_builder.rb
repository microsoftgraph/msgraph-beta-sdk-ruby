...
module MicrosoftGraphBeta::IdentityGovernance::TermsOfUse
    ## 
    ...
    class TermsOfUseRequestBuilder
        ...
        def agreement_acceptances()
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::AgreementAcceptances::AgreementAcceptancesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the agreements property of the microsoft.graph.termsOfUseContainer entity.
        def agreements()
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::AgreementsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def agreement_acceptances_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::AgreementAcceptances::Item::AgreementAcceptanceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the agreements property of the microsoft.graph.termsOfUseContainer entity.
        ## @param id Unique identifier of the item
        ...
        def agreements_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::AgreementItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TermsOfUseContainer.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property termsOfUse in identityGovernance
        ## @param body The request body
