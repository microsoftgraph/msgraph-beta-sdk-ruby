...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageResources::Item::AccessPackageResourceRoles::Item
    ## 
    ...
    class AccessPackageResourceRoleItemRequestBuilder
        ...
        def access_package_resource()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageResources::Item::AccessPackageResourceRoles::Item::AccessPackageResource::AccessPackageResourceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResources/{accessPackageResource%2Did}/accessPackageResourceRoles/{accessPackageResourceRole%2Did}{?%24select,%24expand}"
