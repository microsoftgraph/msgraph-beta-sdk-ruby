...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageCatalogs::Item::AccessPackages::Item::AccessPackageResourceRoleScopes::Item::AccessPackageResourceRole::AccessPackageResource::AccessPackageResourceScopes
    ## 
    ...
    class AccessPackageResourceScopesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageCatalogs::Item::AccessPackages::Item::AccessPackageResourceRoleScopes::Item::AccessPackageResourceRole::AccessPackageResource::AccessPackageResourceScopes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
