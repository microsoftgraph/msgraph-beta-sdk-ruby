...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignmentApprovals
    ...
    class AccessPackageAssignmentApprovalsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignmentApprovals::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
