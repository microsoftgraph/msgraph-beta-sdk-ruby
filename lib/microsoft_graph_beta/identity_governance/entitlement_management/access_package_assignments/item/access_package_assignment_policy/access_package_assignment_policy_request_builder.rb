...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackageAssignmentPolicy
    ...
    class AccessPackageAssignmentPolicyRequestBuilder
        ...
        def access_package()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackageAssignmentPolicy::AccessPackage::AccessPackageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def access_package_catalog()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackageAssignmentPolicy::AccessPackageCatalog::AccessPackageCatalogRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def custom_extension_handlers()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackageAssignmentPolicy::CustomExtensionHandlers::CustomExtensionHandlersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackageAssignmentPolicy{?%24select,%24expand}"
