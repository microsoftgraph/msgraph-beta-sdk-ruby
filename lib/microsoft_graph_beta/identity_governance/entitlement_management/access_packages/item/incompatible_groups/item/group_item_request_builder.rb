...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackages::Item::IncompatibleGroups::Item
    ## 
    ...
    class GroupItemRequestBuilder
        ...
        def ref()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackages::Item::IncompatibleGroups::Item::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
