...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackages::Item
    ...
    class AccessPackageItemRequestBuilder
        ...
        def get_applicable_policy_requirements()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackages::Item::GetApplicablePolicyRequirements::GetApplicablePolicyRequirementsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def move_to_catalog()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackages::Item::MoveToCatalog::MoveToCatalogRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
