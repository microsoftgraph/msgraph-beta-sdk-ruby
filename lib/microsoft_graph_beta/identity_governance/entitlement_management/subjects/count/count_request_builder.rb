...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::Subjects::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/subjects/$count"
