...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::TaskReports::Item::Task
    ## 
    ...
    class TaskRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/taskReports/{taskReport%2Did}/task{?%24select,%24expand}"
