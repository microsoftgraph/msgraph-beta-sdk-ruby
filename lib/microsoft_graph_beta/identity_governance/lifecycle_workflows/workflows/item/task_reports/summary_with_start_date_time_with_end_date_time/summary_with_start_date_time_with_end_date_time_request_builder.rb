...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::TaskReports::SummaryWithStartDateTimeWithEndDateTime
    ## 
    ...
    class SummaryWithStartDateTimeWithEndDateTimeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, end_date_time=nil, start_date_time=nil)
            ...
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/taskReports/microsoft.graph.identityGovernance.summary(startDateTime={startDateTime},endDateTime={endDateTime})"
        ...
        ## Invoke function summary
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of task_report_summary
        ## 
