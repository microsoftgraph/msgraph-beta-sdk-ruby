...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows
    ## 
    ...
    class WorkflowsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get a list of the deleted workflow objects and their properties.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of workflow_collection_response
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::WorkflowCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Create new navigation property to workflows for identityGovernance
        ## @param body The request body
