...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems
    ## 
    ...
    class DeletedItemsRequestBuilder
        ...
        def workflows()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::WorkflowsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems{?%24select,%24expand}"
        ...
        ## Deleted workflows in your lifecycle workflows instance.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of deleted_item_container
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::DeletedItemContainer.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property deletedItems in identityGovernance
        ## @param body The request body
        ...
        def workflows_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::WorkflowItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
