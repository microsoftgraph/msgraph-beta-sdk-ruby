...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::CustomTaskExtensions::Item::CreatedBy
    ## 
    ...
    class CreatedByRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension%2Did}/createdBy{?%24select,%24expand}"
