...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::WorkflowTemplates::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflowTemplates/$count"
