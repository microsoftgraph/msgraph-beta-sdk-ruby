...
module MicrosoftGraphBeta::IdentityGovernance::AppConsent::AppConsentRequests::Item
    ## 
    ...
    class AppConsentRequestItemRequestBuilder
        ...
        def user_consent_requests()
            return MicrosoftGraphBeta::IdentityGovernance::AppConsent::AppConsentRequests::Item::UserConsentRequests::UserConsentRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_consent_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::AppConsent::AppConsentRequests::Item::UserConsentRequests::Item::UserConsentRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
