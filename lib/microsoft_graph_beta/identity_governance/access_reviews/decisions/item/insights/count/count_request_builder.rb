...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Insights::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem%2Did}/insights/$count"
