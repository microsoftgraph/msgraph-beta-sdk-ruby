...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item
    ## 
    ...
    class AccessReviewInstanceDecisionItemItemRequestBuilder
        ...
        def insights()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Insights::InsightsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the instance property of the microsoft.graph.accessReviewInstanceDecisionItem entity.
        def instance()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::InstanceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem%2Did}{?%24select,%24expand}"
