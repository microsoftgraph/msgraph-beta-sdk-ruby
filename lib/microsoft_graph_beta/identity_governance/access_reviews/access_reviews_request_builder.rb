...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews
    ## 
    ...
    class AccessReviewsRequestBuilder
        ...
        def decisions()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::DecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the definitions property of the microsoft.graph.accessReviewSet entity.
        def definitions()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::DefinitionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the historyDefinitions property of the microsoft.graph.accessReviewSet entity.
        def history_definitions()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::HistoryDefinitionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def policy()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Policy::PolicyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def decisions_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::AccessReviewInstanceDecisionItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the definitions property of the microsoft.graph.accessReviewSet entity.
        ## @param id Unique identifier of the item
        ...
        def definitions_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::AccessReviewScheduleDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewSet.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the historyDefinitions property of the microsoft.graph.accessReviewSet entity.
        ## @param id Unique identifier of the item
        ...
        def history_definitions_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::Item::AccessReviewHistoryDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
