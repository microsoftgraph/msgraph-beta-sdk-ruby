...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::Item::Instances::Item
    ...
    class AccessReviewHistoryInstanceItemRequestBuilder
        ...
        def generate_download_uri()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::Item::Instances::Item::GenerateDownloadUri::GenerateDownloadUriRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
