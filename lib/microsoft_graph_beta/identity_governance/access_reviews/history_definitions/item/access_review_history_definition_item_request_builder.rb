...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::Item
    ## 
    ...
    class AccessReviewHistoryDefinitionItemRequestBuilder
        ...
        def instances()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::Item::Instances::InstancesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewHistoryDefinition.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the instances property of the microsoft.graph.accessReviewHistoryDefinition entity.
        ...
        def instances_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::Item::Instances::Item::AccessReviewHistoryInstanceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property historyDefinitions in identityGovernance
        ## @param body The request body
