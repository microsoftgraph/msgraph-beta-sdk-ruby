...
require_relative '../../models/continuous_access_evaluation_policy'
...
module MicrosoftGraphBeta::Identity::ContinuousAccessEvaluationPolicy
    ...
    class ContinuousAccessEvaluationPolicyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/continuousAccessEvaluationPolicy{?%24select,%24expand}"
        ...
        ## Read the properties and relationships of a continuousAccessEvaluationPolicy object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of continuous_access_evaluation_policy
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ContinuousAccessEvaluationPolicy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the properties of a continuousAccessEvaluationPolicy object.
        ## @param body The request body
