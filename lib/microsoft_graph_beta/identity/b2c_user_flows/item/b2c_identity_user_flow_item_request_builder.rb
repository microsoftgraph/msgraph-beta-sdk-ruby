...
module MicrosoftGraphBeta::Identity::B2cUserFlows::Item
    ## 
    ...
    class B2cIdentityUserFlowItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}{?%24select,%24expand}"
        ...
        ## Represents entry point for B2C identity userflows.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of b2c_identity_user_flow
        ## 
        ...
        ## 
        ## Gets an item from the MicrosoftGraphBeta.identity.b2cUserFlows.item.identityProviders.item collection
        ...
        def identity_providers_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::B2cUserFlows::Item::IdentityProviders::Item::IdentityProviderItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the languages property of the microsoft.graph.b2cIdentityUserFlow entity.
        ## @param id Unique identifier of the item
        ...
        def languages_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::B2cUserFlows::Item::Languages::Item::UserFlowLanguageConfigurationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property b2cUserFlows in identity
        ## @param body The request body
        ...
        def user_flow_identity_providers_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::B2cUserFlows::Item::UserFlowIdentityProviders::Item::IdentityProviderBaseItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
