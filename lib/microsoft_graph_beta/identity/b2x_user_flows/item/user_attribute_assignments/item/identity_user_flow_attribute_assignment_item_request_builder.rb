...
module MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserAttributeAssignments::Item
    ## 
    ...
    class IdentityUserFlowAttributeAssignmentItemRequestBuilder
        ...
        def user_attribute()
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::UserAttributeAssignments::Item::UserAttribute::UserAttributeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
