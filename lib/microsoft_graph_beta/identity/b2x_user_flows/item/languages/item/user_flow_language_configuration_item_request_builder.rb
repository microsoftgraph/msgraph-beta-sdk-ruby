...
module MicrosoftGraphBeta::Identity::B2xUserFlows::Item::Languages::Item
    ## 
    ...
    class UserFlowLanguageConfigurationItemRequestBuilder
        ...
        def default_pages()
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::Languages::Item::DefaultPages::DefaultPagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the overridesPages property of the microsoft.graph.userFlowLanguageConfiguration entity.
        def overrides_pages()
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::Languages::Item::OverridesPages::OverridesPagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def default_pages_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::Languages::Item::DefaultPages::Item::UserFlowLanguagePageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property languages for identity
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def overrides_pages_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["userFlowLanguagePage%2Did"] = id
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::Languages::Item::OverridesPages::Item::UserFlowLanguagePageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property languages in identity
        ## @param body The request body
