...
module MicrosoftGraphBeta::Identity::B2xUserFlows::Item::Languages::Item::DefaultPages::Item
    ## 
    ...
    class UserFlowLanguagePageItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Identity::B2xUserFlows::Item::Languages::Item::DefaultPages::Item::Value::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
