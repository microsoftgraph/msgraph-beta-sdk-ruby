...
module MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationContextClassReferences
    ...
    class AuthenticationContextClassReferencesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationContextClassReferences::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationContextClassReferenceCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
