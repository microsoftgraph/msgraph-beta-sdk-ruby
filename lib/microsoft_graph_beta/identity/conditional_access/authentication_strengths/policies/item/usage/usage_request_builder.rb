...
module MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationStrengths::Policies::Item::Usage
    ## 
    ...
    class UsageRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/conditionalAccess/authenticationStrengths/policies/{authenticationStrengthPolicy%2Did}/microsoft.graph.usage()"
        ...
        ## Invoke function usage
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of authentication_strength_usage
        ## 
