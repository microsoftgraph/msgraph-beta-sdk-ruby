...
module MicrosoftGraphBeta::Identity::ConditionalAccess
    ## 
    ...
    class ConditionalAccessRequestBuilder
        ...
        def authentication_context_class_references_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::ConditionalAccess::AuthenticationContextClassReferences::Item::AuthenticationContextClassReferenceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessRoot.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the namedLocations property of the microsoft.graph.conditionalAccessRoot entity.
        ## @param id Unique identifier of the item
        ...
        def named_locations_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::ConditionalAccess::NamedLocations::Item::NamedLocationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property conditionalAccess in identity
        ## @param body The request body
        ...
        def policies_by_id(id)
            ...
            return MicrosoftGraphBeta::Identity::ConditionalAccess::Policies::Item::ConditionalAccessPolicyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the templates property of the microsoft.graph.conditionalAccessRoot entity.
        ## @param id Unique identifier of the item
