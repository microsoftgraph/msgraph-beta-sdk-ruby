...
module MicrosoftGraphBeta::Print::TaskDefinitions::Item
    ## 
    ...
    class PrintTaskDefinitionItemRequestBuilder
        ...
        def tasks()
            return MicrosoftGraphBeta::Print::TaskDefinitions::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::TaskDefinitions::Item::Tasks::Item::PrintTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property taskDefinitions for print
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
