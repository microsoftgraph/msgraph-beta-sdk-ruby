...
module MicrosoftGraphBeta::Print::Reports::GetYammerActivityCountsWithPeriod
    ## 
    ...
    class GetYammerActivityCountsWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getYammerActivityCounts(period='{period}')"
