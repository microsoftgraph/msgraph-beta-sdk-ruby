...
module MicrosoftGraphBeta::Print::Reports::GetSharePointSiteUsageDetailWithDate
    ## 
    ...
    class GetSharePointSiteUsageDetailWithDateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, date=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getSharePointSiteUsageDetail(date={date})"
