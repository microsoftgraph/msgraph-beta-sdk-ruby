...
module MicrosoftGraphBeta::Print::Reports::GetM365AppPlatformUserCountsWithPeriod
    ## 
    ...
    class GetM365AppPlatformUserCountsWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getM365AppPlatformUserCounts(period='{period}')"
