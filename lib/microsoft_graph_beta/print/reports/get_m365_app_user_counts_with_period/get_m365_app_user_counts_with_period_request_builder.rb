...
module MicrosoftGraphBeta::Print::Reports::GetM365AppUserCountsWithPeriod
    ## 
    ...
    class GetM365AppUserCountsWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getM365AppUserCounts(period='{period}')"
