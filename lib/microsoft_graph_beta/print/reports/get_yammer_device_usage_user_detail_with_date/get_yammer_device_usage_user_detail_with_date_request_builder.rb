...
module MicrosoftGraphBeta::Print::Reports::GetYammerDeviceUsageUserDetailWithDate
    ## 
    ...
    class GetYammerDeviceUsageUserDetailWithDateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, date=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getYammerDeviceUsageUserDetail(date={date})"
