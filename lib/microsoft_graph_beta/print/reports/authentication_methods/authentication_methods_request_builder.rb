...
module MicrosoftGraphBeta::Print::Reports::AuthenticationMethods
    ...
    class AuthenticationMethodsRequestBuilder
        ...
        ## Container for navigation properties for Azure AD authentication methods resources.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of authentication_methods_root
        ## 
        ...
        def users_registered_by_feature()
            return UsersRegisteredByFeatureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to call the usersRegisteredByFeature method.
        ...
        def users_registered_by_method()
            return UsersRegisteredByMethodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to call the usersRegisteredByMethod method.
        ## @param includedUserRoles Usage: includedUserRoles='{includedUserRoles}'
