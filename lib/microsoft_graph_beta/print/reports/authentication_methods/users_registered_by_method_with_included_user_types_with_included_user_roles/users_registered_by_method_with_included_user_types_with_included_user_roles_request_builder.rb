...
module MicrosoftGraphBeta::Print::Reports::AuthenticationMethods::UsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRoles
    ...
    class UsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, included_user_roles=nil, included_user_types=nil)
            ...
            @url_template = "{+baseurl}/print/reports/authenticationMethods/microsoft.graph.usersRegisteredByMethod(includedUserTypes='{includedUserTypes}',includedUserRoles='{includedUserRoles}')"
        ...
        ## Invoke function usersRegisteredByMethod
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of user_registration_method_summary
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UserRegistrationMethodSummary.create_from_discriminator_value(pn) }, error_mapping)
        end
