...
module MicrosoftGraphBeta::Print::Reports::GetSharePointSiteUsagePagesWithPeriod
    ## 
    ...
    class GetSharePointSiteUsagePagesWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getSharePointSiteUsagePages(period='{period}')"
