...
module MicrosoftGraphBeta::Print::PrinterShares::Item
    ## 
    ...
    class PrinterShareItemRequestBuilder
        ...
        def allowed_groups()
            return MicrosoftGraphBeta::Print::PrinterShares::Item::AllowedGroups::AllowedGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the allowedUsers property of the microsoft.graph.printerShare entity.
        def allowed_users()
            return MicrosoftGraphBeta::Print::PrinterShares::Item::AllowedUsers::AllowedUsersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def printer()
            return MicrosoftGraphBeta::Print::PrinterShares::Item::Printer::PrinterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        @url_template
        ## 
        ## Gets an item from the MicrosoftGraphBeta.print.printerShares.item.allowedGroups.item collection
        ...
        def allowed_groups_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::PrinterShares::Item::AllowedGroups::Item::GroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Gets an item from the MicrosoftGraphBeta.print.printerShares.item.allowedUsers.item collection
        ## @param id Unique identifier of the item
        ...
        def allowed_users_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::PrinterShares::Item::AllowedUsers::Item::UserItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/printerShares/{printerShare%2Did}{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PrinterShare.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
