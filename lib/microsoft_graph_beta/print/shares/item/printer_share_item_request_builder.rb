...
module MicrosoftGraphBeta::Print::Shares::Item
    ## 
    ...
    class PrinterShareItemRequestBuilder
        ...
        def allowed_groups()
            return MicrosoftGraphBeta::Print::Shares::Item::AllowedGroups::AllowedGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the allowedUsers property of the microsoft.graph.printerShare entity.
        def allowed_users()
            return MicrosoftGraphBeta::Print::Shares::Item::AllowedUsers::AllowedUsersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def printer()
            return MicrosoftGraphBeta::Print::Shares::Item::Printer::PrinterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        @url_template
        ## 
        ## Gets an item from the MicrosoftGraphBeta.print.shares.item.allowedGroups.item collection
        ...
        def allowed_groups_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::Shares::Item::AllowedGroups::Item::GroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Gets an item from the MicrosoftGraphBeta.print.shares.item.allowedUsers.item collection
        ## @param id Unique identifier of the item
        ...
        def allowed_users_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::Shares::Item::AllowedUsers::Item::UserItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
