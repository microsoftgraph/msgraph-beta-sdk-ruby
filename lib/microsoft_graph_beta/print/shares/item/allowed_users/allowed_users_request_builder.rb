...
module MicrosoftGraphBeta::Print::Shares::Item::AllowedUsers
    ## 
    ...
    class AllowedUsersRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Print::Shares::Item::AllowedUsers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def ref()
            return MicrosoftGraphBeta::Print::Shares::Item::AllowedUsers::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
