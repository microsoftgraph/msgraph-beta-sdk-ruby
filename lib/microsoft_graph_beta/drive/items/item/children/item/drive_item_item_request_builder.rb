...
module MicrosoftGraphBeta::Drive::Items::Item::Children::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Drive::Items::Item::Children::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
