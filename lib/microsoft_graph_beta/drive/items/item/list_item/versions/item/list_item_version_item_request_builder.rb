...
module MicrosoftGraphBeta::Drive::Items::Item::ListItem::Versions::Item
    ## 
    ...
    class ListItemVersionItemRequestBuilder
        ...
        def fields()
            return MicrosoftGraphBeta::Drive::Items::Item::ListItem::Versions::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore_version()
            return MicrosoftGraphBeta::Drive::Items::Item::ListItem::Versions::Item::RestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
