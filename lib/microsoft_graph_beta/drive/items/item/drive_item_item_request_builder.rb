...
module MicrosoftGraphBeta::Drive::Items::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Drive::Items::Item::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the analytics property of the microsoft.graph.driveItem entity.
        def analytics()
            return MicrosoftGraphBeta::Drive::Items::Item::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assignSensitivityLabel method.
        def assign_sensitivity_label()
            return MicrosoftGraphBeta::Drive::Items::Item::AssignSensitivityLabel::AssignSensitivityLabelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkin method.
        def checkin()
            return MicrosoftGraphBeta::Drive::Items::Item::Checkin::CheckinRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkout method.
        def checkout()
            return MicrosoftGraphBeta::Drive::Items::Item::Checkout::CheckoutRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the children property of the microsoft.graph.driveItem entity.
        def children()
            return MicrosoftGraphBeta::Drive::Items::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the drive entity.
        def content()
            return MicrosoftGraphBeta::Drive::Items::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copy method.
        def copy()
            return MicrosoftGraphBeta::Drive::Items::Item::Copy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createLink method.
        def create_link()
            return MicrosoftGraphBeta::Drive::Items::Item::CreateLink::CreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createUploadSession method.
        def create_upload_session()
            return MicrosoftGraphBeta::Drive::Items::Item::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the extractSensitivityLabels method.
        def extract_sensitivity_labels()
            return MicrosoftGraphBeta::Drive::Items::Item::ExtractSensitivityLabels::ExtractSensitivityLabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the follow method.
        def follow()
            return MicrosoftGraphBeta::Drive::Items::Item::Follow::FollowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the invite method.
        def invite()
            return MicrosoftGraphBeta::Drive::Items::Item::Invite::InviteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the listItem property of the microsoft.graph.driveItem entity.
        def list_item()
            return MicrosoftGraphBeta::Drive::Items::Item::ListItem::ListItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def permissions()
            return MicrosoftGraphBeta::Drive::Items::Item::Permissions::PermissionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the preview method.
        def preview()
            return MicrosoftGraphBeta::Drive::Items::Item::Preview::PreviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore()
            return MicrosoftGraphBeta::Drive::Items::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the subscriptions property of the microsoft.graph.driveItem entity.
        def subscriptions()
            return MicrosoftGraphBeta::Drive::Items::Item::Subscriptions::SubscriptionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the thumbnails property of the microsoft.graph.driveItem entity.
        def thumbnails()
            return MicrosoftGraphBeta::Drive::Items::Item::Thumbnails::ThumbnailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unfollow method.
        def unfollow()
            return MicrosoftGraphBeta::Drive::Items::Item::Unfollow::UnfollowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def validate_permission()
            return MicrosoftGraphBeta::Drive::Items::Item::ValidatePermission::ValidatePermissionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the versions property of the microsoft.graph.driveItem entity.
        def versions()
            return MicrosoftGraphBeta::Drive::Items::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the activities property of the microsoft.graph.driveItem entity.
        ...
        def activities_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::Items::Item::Activities::Item::ItemActivityOLDItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the children property of the microsoft.graph.driveItem entity.
        ## @param id Unique identifier of the item
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::Items::Item::Children::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def permissions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::Items::Item::Permissions::Item::PermissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def subscriptions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::Items::Item::Subscriptions::Item::SubscriptionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the thumbnails property of the microsoft.graph.driveItem entity.
        ## @param id Unique identifier of the item
        ...
        def thumbnails_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::Items::Item::Thumbnails::Item::ThumbnailSetItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property items for drive
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::Items::Item::Versions::Item::DriveItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
