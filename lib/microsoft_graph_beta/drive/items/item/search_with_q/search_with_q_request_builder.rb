...
module MicrosoftGraphBeta::Drive::Items::Item::SearchWithQ
    ...
    class SearchWithQRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Drive::Items::Item::SearchWithQ::SearchWithQResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function search
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
