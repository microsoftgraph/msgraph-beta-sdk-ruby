...
module MicrosoftGraphBeta::Drive::Items::Item::Activities::Item
    ## 
    ...
    class ItemActivityOLDItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/items/{driveItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}"
