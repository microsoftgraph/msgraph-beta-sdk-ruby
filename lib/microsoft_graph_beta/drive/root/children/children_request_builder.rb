...
module MicrosoftGraphBeta::Drive::Root::Children
    ## 
    ...
    class ChildrenRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Drive::Root::Children::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
