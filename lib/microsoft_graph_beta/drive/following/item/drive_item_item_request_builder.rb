...
module MicrosoftGraphBeta::Drive::Following::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Drive::Following::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
