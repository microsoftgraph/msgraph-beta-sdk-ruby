...
module MicrosoftGraphBeta::Drive::List::Items::Item
    ## 
    ...
    class ListItemItemRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Drive::List::Items::Item::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the analytics property of the microsoft.graph.listItem entity.
        def analytics()
            return MicrosoftGraphBeta::Drive::List::Items::Item::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createLink method.
        def create_link()
            return MicrosoftGraphBeta::Drive::List::Items::Item::CreateLink::CreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the documentSetVersions property of the microsoft.graph.listItem entity.
        def document_set_versions()
            return MicrosoftGraphBeta::Drive::List::Items::Item::DocumentSetVersions::DocumentSetVersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the driveItem property of the microsoft.graph.listItem entity.
        def drive_item()
            return MicrosoftGraphBeta::Drive::List::Items::Item::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the fields property of the microsoft.graph.listItem entity.
        def fields()
            return MicrosoftGraphBeta::Drive::List::Items::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def versions()
            return MicrosoftGraphBeta::Drive::List::Items::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the activities property of the microsoft.graph.listItem entity.
        ...
        def activities_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::List::Items::Item::Activities::Item::ItemActivityOLDItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def document_set_versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::List::Items::Item::DocumentSetVersions::Item::DocumentSetVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::List::Items::Item::Versions::Item::ListItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
