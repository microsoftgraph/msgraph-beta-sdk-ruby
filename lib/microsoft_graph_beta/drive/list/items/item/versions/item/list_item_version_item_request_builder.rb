...
module MicrosoftGraphBeta::Drive::List::Items::Item::Versions::Item
    ## 
    ...
    class ListItemVersionItemRequestBuilder
        ...
        def fields()
            return MicrosoftGraphBeta::Drive::List::Items::Item::Versions::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore_version()
            return MicrosoftGraphBeta::Drive::List::Items::Item::Versions::Item::RestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
