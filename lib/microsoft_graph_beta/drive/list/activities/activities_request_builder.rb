...
module MicrosoftGraphBeta::Drive::List::Activities
    ## 
    ...
    class ActivitiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
