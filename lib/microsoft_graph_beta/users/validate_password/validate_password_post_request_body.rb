...
module MicrosoftGraphBeta::Users::ValidatePassword
    ## 
    # Provides operations to call the validatePassword method.
    class ValidatePasswordPostRequestBody
        ...
        ## @return a validate_password_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return ValidatePasswordPostRequestBody.new
        end
        ## 
