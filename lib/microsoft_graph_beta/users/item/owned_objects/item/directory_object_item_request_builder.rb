...
module MicrosoftGraphBeta::Users::Item::OwnedObjects::Item
    ## 
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def application()
            return MicrosoftGraphBeta::Users::Item::OwnedObjects::Item::Application::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def group()
            return MicrosoftGraphBeta::Users::Item::OwnedObjects::Item::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraphBeta::Users::Item::OwnedObjects::Item::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
