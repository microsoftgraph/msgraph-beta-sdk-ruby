...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item::Decisions::Item::Insights
    ## 
    ...
    class InsightsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item::Decisions::Item::Insights::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
