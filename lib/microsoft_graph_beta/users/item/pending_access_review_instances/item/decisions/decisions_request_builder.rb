...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions
    ## 
    ...
    class DecisionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def record_all_decisions()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::RecordAllDecisions::RecordAllDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
