...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Definition
    ## 
    ...
    class DefinitionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/definition{?%24select,%24expand}"
