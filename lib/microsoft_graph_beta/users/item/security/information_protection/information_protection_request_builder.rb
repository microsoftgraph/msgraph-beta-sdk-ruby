...
module MicrosoftGraphBeta::Users::Item::Security::InformationProtection
    ## 
    ...
    class InformationProtectionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/security/informationProtection{?%24select,%24expand}"
        ...
        def sensitivity_labels_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Security::InformationProtection::SensitivityLabels::Item::SensitivityLabelItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
