...
module MicrosoftGraphBeta::Users::Item::Security::InformationProtection::SensitivityLabels::EvaluateApplication
    ...
    class EvaluateApplicationRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::Security::InformationProtection::SensitivityLabels::EvaluateApplication::EvaluateApplicationResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
