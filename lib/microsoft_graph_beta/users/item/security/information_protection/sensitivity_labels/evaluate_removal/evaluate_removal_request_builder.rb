...
module MicrosoftGraphBeta::Users::Item::Security::InformationProtection::SensitivityLabels::EvaluateRemoval
    ...
    class EvaluateRemovalRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::Security::InformationProtection::SensitivityLabels::EvaluateRemoval::EvaluateRemovalResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
