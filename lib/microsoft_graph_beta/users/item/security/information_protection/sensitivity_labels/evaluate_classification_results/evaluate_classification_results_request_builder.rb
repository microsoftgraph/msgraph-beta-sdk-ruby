...
module MicrosoftGraphBeta::Users::Item::Security::InformationProtection::SensitivityLabels::EvaluateClassificationResults
    ...
    class EvaluateClassificationResultsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/microsoft.graph.security.evaluateClassificationResults"
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::Security::InformationProtection::SensitivityLabels::EvaluateClassificationResults::EvaluateClassificationResultsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
