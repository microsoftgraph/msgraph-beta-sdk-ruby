...
module MicrosoftGraphBeta::Users::Item::People::Item
    ## 
    ...
    class PersonItemRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Person.create_from_discriminator_value(pn) }, error_mapping)
        end
