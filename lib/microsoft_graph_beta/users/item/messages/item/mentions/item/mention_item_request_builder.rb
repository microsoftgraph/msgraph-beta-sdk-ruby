...
module MicrosoftGraphBeta::Users::Item::Messages::Item::Mentions::Item
    ## 
    ...
    class MentionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/messages/{message%2Did}/mentions/{mention%2Did}{?%24select,%24expand}"
