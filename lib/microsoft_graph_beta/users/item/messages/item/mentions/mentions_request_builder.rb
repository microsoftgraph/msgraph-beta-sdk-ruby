...
module MicrosoftGraphBeta::Users::Item::Messages::Item::Mentions
    ## 
    ...
    class MentionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/messages/{message%2Did}/mentions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
