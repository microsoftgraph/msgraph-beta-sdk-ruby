...
module MicrosoftGraphBeta::Users::Item::ContactFolders::Item::Contacts::Item::Extensions
    ## 
    ...
    class ExtensionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::ContactFolders::Item::Contacts::Item::Extensions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
