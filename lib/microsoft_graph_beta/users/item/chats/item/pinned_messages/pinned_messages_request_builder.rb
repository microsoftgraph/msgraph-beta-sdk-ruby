...
module MicrosoftGraphBeta::Users::Item::Chats::Item::PinnedMessages
    ## 
    ...
    class PinnedMessagesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::PinnedMessages::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
