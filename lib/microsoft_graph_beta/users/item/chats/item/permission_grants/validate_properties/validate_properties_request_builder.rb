...
module MicrosoftGraphBeta::Users::Item::Chats::Item::PermissionGrants::ValidateProperties
    ## 
    ...
    class ValidatePropertiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/permissionGrants/microsoft.graph.validateProperties"
