...
module MicrosoftGraphBeta::Users::Item::Chats::Item
    ## 
    ...
    class ChatItemRequestBuilder
        ...
        def installed_apps_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Chats::Item::InstalledApps::Item::TeamsAppInstallationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the members property of the microsoft.graph.chat entity.
        ## @param id Unique identifier of the item
        ...
        def members_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Members::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the messages property of the microsoft.graph.chat entity.
        ## @param id Unique identifier of the item
        ...
        def messages_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::ChatMessageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.chat entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Operations::Item::TeamsAsyncOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property chats in users
        ## @param body The request body
        ...
        def permission_grants_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Chats::Item::PermissionGrants::Item::ResourceSpecificPermissionGrantItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the pinnedMessages property of the microsoft.graph.chat entity.
        ## @param id Unique identifier of the item
        ...
        def pinned_messages_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Chats::Item::PinnedMessages::Item::PinnedChatMessageInfoItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tabs property of the microsoft.graph.chat entity.
        ## @param id Unique identifier of the item
        ...
        def tabs_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Tabs::Item::TeamsTabItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
