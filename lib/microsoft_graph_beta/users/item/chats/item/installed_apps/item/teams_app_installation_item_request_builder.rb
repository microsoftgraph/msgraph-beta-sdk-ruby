...
module MicrosoftGraphBeta::Users::Item::Chats::Item::InstalledApps::Item
    ## 
    ...
    class TeamsAppInstallationItemRequestBuilder
        ...
        def teams_app()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::InstalledApps::Item::TeamsApp::TeamsAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the teamsAppDefinition property of the microsoft.graph.teamsAppInstallation entity.
        def teams_app_definition()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::InstalledApps::Item::TeamsAppDefinition::TeamsAppDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the upgrade method.
        def upgrade()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::InstalledApps::Item::Upgrade::UpgradeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
