...
module MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item
    ## 
    ...
    class ChatMessageItemRequestBuilder
        ...
        def hosted_contents()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::HostedContents::HostedContentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def replies()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::Replies::RepliesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set_reaction()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::SetReaction::SetReactionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the softDelete method.
        def soft_delete()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::SoftDelete::SoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the undoSoftDelete method.
        def undo_soft_delete()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::UndoSoftDelete::UndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unsetReaction method.
        def unset_reaction()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::UnsetReaction::UnsetReactionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def hosted_contents_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::HostedContents::Item::ChatMessageHostedContentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def replies_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::Replies::Item::ChatMessageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property messages for users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
