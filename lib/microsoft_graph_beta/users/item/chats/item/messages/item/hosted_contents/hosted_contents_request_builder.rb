...
module MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::HostedContents
    ## 
    ...
    class HostedContentsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::HostedContents::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
