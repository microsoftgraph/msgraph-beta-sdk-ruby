...
module MicrosoftGraphBeta::Users::Item::Teamwork::InstalledApps::Item
    ## 
    ...
    class UserScopeTeamsAppInstallationItemRequestBuilder
        ...
        def chat()
            return MicrosoftGraphBeta::Users::Item::Teamwork::InstalledApps::Item::Chat::ChatRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
