...
module MicrosoftGraphBeta::Users::Item::Devices::Item::TransitiveMemberOf::Device::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.device/$count"
