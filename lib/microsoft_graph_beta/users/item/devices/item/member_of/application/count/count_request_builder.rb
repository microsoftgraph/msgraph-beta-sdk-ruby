...
module MicrosoftGraphBeta::Users::Item::Devices::Item::MemberOf::Application::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/microsoft.graph.application/$count"
