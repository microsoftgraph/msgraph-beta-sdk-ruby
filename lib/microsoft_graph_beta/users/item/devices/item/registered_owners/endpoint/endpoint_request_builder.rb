...
module MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredOwners::Endpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredOwners::Endpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
