...
module MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredUsers::Item::ServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}"
