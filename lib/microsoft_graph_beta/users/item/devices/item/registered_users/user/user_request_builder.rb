...
module MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredUsers::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredUsers::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
