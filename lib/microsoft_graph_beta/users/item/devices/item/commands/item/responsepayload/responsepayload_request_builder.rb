...
module MicrosoftGraphBeta::Users::Item::Devices::Item::Commands::Item::Responsepayload
    ## 
    ...
    class ResponsepayloadRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/commands/{command%2Did}/responsepayload{?%24select,%24expand}"
