...
module MicrosoftGraphBeta::Users::Item::DirectReports::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::DirectReports::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
