...
module MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::DetectedApps::Item
    ## 
    ...
    class DetectedAppItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/detectedApps/{detectedApp%2Did}{?%24select,%24expand}"
