...
module MicrosoftGraphBeta::Users::Item::Drives::Item::Items::Item::Permissions::Item
    ## 
    ...
    class PermissionItemRequestBuilder
        ...
        def grant()
            return MicrosoftGraphBeta::Users::Item::Drives::Item::Items::Item::Permissions::Item::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def revoke_grants()
            return MicrosoftGraphBeta::Users::Item::Drives::Item::Items::Item::Permissions::Item::RevokeGrants::RevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
