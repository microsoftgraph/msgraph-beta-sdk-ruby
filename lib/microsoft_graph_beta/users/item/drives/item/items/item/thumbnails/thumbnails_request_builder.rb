...
module MicrosoftGraphBeta::Users::Item::Drives::Item::Items::Item::Thumbnails
    ## 
    ...
    class ThumbnailsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Drives::Item::Items::Item::Thumbnails::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
