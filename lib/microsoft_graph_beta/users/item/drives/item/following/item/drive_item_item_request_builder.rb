...
module MicrosoftGraphBeta::Users::Item::Drives::Item::Following::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Users::Item::Drives::Item::Following::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
