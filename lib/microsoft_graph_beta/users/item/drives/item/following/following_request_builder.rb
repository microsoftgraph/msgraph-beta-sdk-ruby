...
module MicrosoftGraphBeta::Users::Item::Drives::Item::Following
    ## 
    ...
    class FollowingRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Drives::Item::Following::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
