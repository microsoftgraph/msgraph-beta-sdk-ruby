...
module MicrosoftGraphBeta::Users::Item::Drives::Item::List::ContentTypes::Item::Columns::Item
    ## 
    ...
    class ColumnDefinitionItemRequestBuilder
        ...
        def source_column()
            return MicrosoftGraphBeta::Users::Item::Drives::Item::List::ContentTypes::Item::Columns::Item::SourceColumn::SourceColumnRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
