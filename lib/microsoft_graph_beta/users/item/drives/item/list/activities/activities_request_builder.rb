...
module MicrosoftGraphBeta::Users::Item::Drives::Item::List::Activities
    ## 
    ...
    class ActivitiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
