...
module MicrosoftGraphBeta::Users::Item::Drives::Item::Bundles
    ## 
    ...
    class BundlesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Drives::Item::Bundles::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
