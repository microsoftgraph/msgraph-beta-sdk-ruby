...
module MicrosoftGraphBeta::Users::Item::Drives::Item::Root::Permissions::Item::RevokeGrants
    ## 
    ...
    class RevokeGrantsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/permissions/{permission%2Did}/microsoft.graph.revokeGrants"
