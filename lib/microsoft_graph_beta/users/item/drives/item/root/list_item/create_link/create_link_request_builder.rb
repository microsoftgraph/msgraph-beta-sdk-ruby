...
module MicrosoftGraphBeta::Users::Item::Drives::Item::Root::ListItem::CreateLink
    ## 
    ...
    class CreateLinkRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/microsoft.graph.createLink"
