...
module MicrosoftGraphBeta::Users::Item::InformationProtection::ThreatAssessmentRequests::Item
    ## 
    ...
    class ThreatAssessmentRequestItemRequestBuilder
        ...
        def results()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::ThreatAssessmentRequests::Item::Results::ResultsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}{?%24select,%24expand}"
        ...
        def results_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::InformationProtection::ThreatAssessmentRequests::Item::Results::Item::ThreatAssessmentResultItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
