...
module MicrosoftGraphBeta::Users::Item::InformationProtection::ThreatAssessmentRequests::Item::Results::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}/results/$count"
