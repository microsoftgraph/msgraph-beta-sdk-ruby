...
module MicrosoftGraphBeta::Users::Item::InformationProtection::Bitlocker::RecoveryKeys::Item
    ## 
    ...
    class BitlockerRecoveryKeyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey%2Did}{?%24select,%24expand}"
