...
module MicrosoftGraphBeta::Users::Item::InformationProtection::Bitlocker::RecoveryKeys::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/bitlocker/recoveryKeys/$count"
