...
module MicrosoftGraphBeta::Users::Item::InformationProtection::SensitivityLabels::Item::Sublabels::Item
    ## 
    ...
    class SensitivityLabelItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/{sensitivityLabel%2Did1}{?%24select,%24expand}"
