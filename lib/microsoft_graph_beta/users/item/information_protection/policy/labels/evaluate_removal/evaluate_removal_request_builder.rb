...
module MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::EvaluateRemoval
    ## 
    ...
    class EvaluateRemovalRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/microsoft.graph.evaluateRemoval"
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::EvaluateRemoval::EvaluateRemovalResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
