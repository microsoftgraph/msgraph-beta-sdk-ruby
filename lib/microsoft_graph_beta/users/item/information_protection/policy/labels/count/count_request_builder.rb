...
module MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/$count"
