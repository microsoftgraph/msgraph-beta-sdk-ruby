...
require_relative '../../../../models/information_protection_policy'
require_relative '../../../../models/o_data_errors/o_data_error'
require_relative '../../../users'
require_relative '../../item'
require_relative '../information_protection'
require_relative './labels/item/information_protection_label_item_request_builder'
require_relative './labels/labels_request_builder'
require_relative './policy'

module MicrosoftGraphBeta::Users::Item::InformationProtection::Policy
    ## 
    ...
    class PolicyRequestBuilder
        ...
        def labels()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::LabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/policy{?%24select,%24expand}"
        ...
        ## Get policy from users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of information_protection_policy
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::InformationProtectionPolicy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the labels property of the microsoft.graph.informationProtectionPolicy entity.
        ...
        def labels_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::Item::InformationProtectionLabelItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property policy in users
        ## @param body The request body
