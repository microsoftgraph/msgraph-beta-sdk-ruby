...
module MicrosoftGraphBeta::Users::Item::MemberOf::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::MemberOf::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
