...
require_relative '../../../../models/web_account'
require_relative '../../../../models/web_account_collection_response'
require_relative '../../../users'
require_relative '../../item'
require_relative '../profile'
require_relative './count/count_request_builder'
require_relative './web_accounts'

module MicrosoftGraphBeta::Users::Item::Profile::WebAccounts
    ## 
    ...
    class WebAccountsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Profile::WebAccounts::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/profile/webAccounts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Retrieve a list of webAccounts objects from the user's profile.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of web_account_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of web_account
        ## 
