...
module MicrosoftGraphBeta::Users::Item::Profile::WebAccounts::Item
    ## 
    ...
    class WebAccountItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/profile/webAccounts/{webAccount%2Did}{?%24select,%24expand}"
