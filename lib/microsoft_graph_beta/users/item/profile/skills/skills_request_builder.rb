...
require_relative '../../../../models/skill_proficiency'
require_relative '../../../../models/skill_proficiency_collection_response'
...
module MicrosoftGraphBeta::Users::Item::Profile::Skills
    ## 
    ...
    class SkillsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Profile::Skills::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/profile/skills{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Retrieve a list of skillProficiency objects in a user's profile.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of skill_proficiency_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of skill_proficiency
        ## 
