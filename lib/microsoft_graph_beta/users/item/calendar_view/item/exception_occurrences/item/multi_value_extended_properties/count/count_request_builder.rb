...
module MicrosoftGraphBeta::Users::Item::CalendarView::Item::ExceptionOccurrences::Item::MultiValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/multiValueExtendedProperties/$count"
