...
module MicrosoftGraphBeta::Users::Item::CalendarView::Item::Instances::Item::ExceptionOccurrences::Item::Calendar
    ## 
    ...
    class CalendarRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/calendar{?%24select}"
