...
module MicrosoftGraphBeta::Users::Item::CalendarView::Item::MultiValueExtendedProperties
    ## 
    ...
    class MultiValueExtendedPropertiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Item::MultiValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
