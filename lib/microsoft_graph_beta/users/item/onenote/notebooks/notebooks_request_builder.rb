...
module MicrosoftGraphBeta::Users::Item::Onenote::Notebooks
    ## 
    ...
    class NotebooksRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getNotebookFromWebUrl method.
        def get_notebook_from_web_url()
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::GetNotebookFromWebUrl::GetNotebookFromWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
