...
module MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Item
    ## 
    ...
    class NotebookItemRequestBuilder
        ...
        def copy_notebook()
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Item::CopyNotebook::CopyNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def section_groups()
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Item::SectionGroups::SectionGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sections property of the microsoft.graph.notebook entity.
        def sections()
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Item::Sections::SectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def section_groups_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Item::SectionGroups::Item::SectionGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sections property of the microsoft.graph.notebook entity.
        ## @param id Unique identifier of the item
        ...
        def sections_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Item::Sections::Item::OnenoteSectionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property notebooks for users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
