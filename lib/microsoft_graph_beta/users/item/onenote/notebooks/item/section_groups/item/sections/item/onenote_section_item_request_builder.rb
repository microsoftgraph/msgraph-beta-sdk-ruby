...
module MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Item::SectionGroups::Item::Sections::Item
    ...
    class OnenoteSectionItemRequestBuilder
        ...
        def copy_to_notebook()
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Item::SectionGroups::Item::Sections::Item::CopyToNotebook::CopyToNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSectionGroup method.
        def copy_to_section_group()
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Item::SectionGroups::Item::Sections::Item::CopyToSectionGroup::CopyToSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
