...
module MicrosoftGraphBeta::Users::Item::Onenote::SectionGroups::Item::Sections::Item
    ## 
    ...
    class OnenoteSectionItemRequestBuilder
        ...
        def copy_to_notebook()
            return MicrosoftGraphBeta::Users::Item::Onenote::SectionGroups::Item::Sections::Item::CopyToNotebook::CopyToNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSectionGroup method.
        def copy_to_section_group()
            return MicrosoftGraphBeta::Users::Item::Onenote::SectionGroups::Item::Sections::Item::CopyToSectionGroup::CopyToSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the pages property of the microsoft.graph.onenoteSection entity.
        def pages()
            return MicrosoftGraphBeta::Users::Item::Onenote::SectionGroups::Item::Sections::Item::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentNotebook property of the microsoft.graph.onenoteSection entity.
        def parent_notebook()
            return MicrosoftGraphBeta::Users::Item::Onenote::SectionGroups::Item::Sections::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def parent_section_group()
            return MicrosoftGraphBeta::Users::Item::Onenote::SectionGroups::Item::Sections::Item::ParentSectionGroup::ParentSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def pages_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Onenote::SectionGroups::Item::Sections::Item::Pages::Item::OnenotePageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property sections in users
        ## @param body The request body
