...
module MicrosoftGraphBeta::Users::Item::Contacts::Delta
    ## 
    ...
    class DeltaRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::Contacts::Delta::DeltaResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
