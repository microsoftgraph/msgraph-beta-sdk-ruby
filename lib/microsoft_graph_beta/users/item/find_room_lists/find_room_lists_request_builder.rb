...
module MicrosoftGraphBeta::Users::Item::FindRoomLists
    ## 
    ...
    class FindRoomListsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/microsoft.graph.findRoomLists(){?%24top,%24skip,%24search,%24filter,%24count}"
        ...
        ## Get the room lists defined in a tenant, as represented by their emailAddress objects. Tenants can organize meeting rooms into room lists. In this API, each meeting room and room list is represented by an emailAddress instance.You can get all the room lists in the tenant, get all the rooms in the tenant, or get all the rooms in a specific room list.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of find_room_lists_response
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::FindRoomLists::FindRoomListsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
