...
module MicrosoftGraphBeta::Users::Item::CreatedObjects
    ## 
    ...
    class CreatedObjectsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::CreatedObjects::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraphBeta::Users::Item::CreatedObjects::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
