...
module MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Registration
    ## 
    ...
    class RegistrationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/registration{?%24select,%24expand}"
        ...
        def custom_questions_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Registration::CustomQuestions::Item::MeetingRegistrationQuestionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
