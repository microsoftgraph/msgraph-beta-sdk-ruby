...
module MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Registration::CustomQuestions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/registration/customQuestions/$count"
