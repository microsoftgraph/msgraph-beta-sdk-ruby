...
module MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AttendanceReports
    ## 
    ...
    class AttendanceReportsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AttendanceReports::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
