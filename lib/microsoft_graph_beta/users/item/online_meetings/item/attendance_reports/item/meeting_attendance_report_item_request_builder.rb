...
module MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AttendanceReports::Item
    ## 
    ...
    class MeetingAttendanceReportItemRequestBuilder
        ...
        def attendance_records()
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AttendanceReports::Item::AttendanceRecords::AttendanceRecordsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
