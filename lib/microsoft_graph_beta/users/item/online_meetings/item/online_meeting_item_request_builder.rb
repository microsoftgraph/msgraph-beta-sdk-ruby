...
module MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item
    ## 
    ...
    class OnlineMeetingItemRequestBuilder
        ...
        def alternative_recording()
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AlternativeRecording::AlternativeRecordingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the attendanceReports property of the microsoft.graph.onlineMeeting entity.
        def attendance_reports()
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AttendanceReports::AttendanceReportsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the user entity.
        def attendee_report()
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AttendeeReport::AttendeeReportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def meeting_attendance_report()
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::MeetingAttendanceReport::MeetingAttendanceReportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        # Provides operations to manage the media for the user entity.
        def recording()
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Recording::RecordingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the registration property of the microsoft.graph.onlineMeeting entity.
        def registration()
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Registration::RegistrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def attendance_reports_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AttendanceReports::Item::MeetingAttendanceReportItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def transcripts_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Transcripts::Item::CallTranscriptItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
