...
module MicrosoftGraphBeta::Users::Item::RegisteredDevices::Item
    ## 
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def device()
            return MicrosoftGraphBeta::Users::Item::RegisteredDevices::Item::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def endpoint()
            return MicrosoftGraphBeta::Users::Item::RegisteredDevices::Item::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
