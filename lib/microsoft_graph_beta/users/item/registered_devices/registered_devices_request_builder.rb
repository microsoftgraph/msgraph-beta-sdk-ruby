...
module MicrosoftGraphBeta::Users::Item::RegisteredDevices
    ## 
    ...
    class RegisteredDevicesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::RegisteredDevices::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to device.
        def device()
            return MicrosoftGraphBeta::Users::Item::RegisteredDevices::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def endpoint()
            return MicrosoftGraphBeta::Users::Item::RegisteredDevices::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
