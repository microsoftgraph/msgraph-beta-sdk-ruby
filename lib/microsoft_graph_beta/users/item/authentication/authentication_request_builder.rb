...
module MicrosoftGraphBeta::Users::Item::Authentication
    ## 
    ...
    class AuthenticationRequestBuilder
        ...
        def email_methods()
            return MicrosoftGraphBeta::Users::Item::Authentication::EmailMethods::EmailMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the fido2Methods property of the microsoft.graph.authentication entity.
        def fido2_methods()
            return MicrosoftGraphBeta::Users::Item::Authentication::Fido2Methods::Fido2MethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the methods property of the microsoft.graph.authentication entity.
        def methods()
            return MicrosoftGraphBeta::Users::Item::Authentication::Methods::MethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the microsoftAuthenticatorMethods property of the microsoft.graph.authentication entity.
        def microsoft_authenticator_methods()
            return MicrosoftGraphBeta::Users::Item::Authentication::MicrosoftAuthenticatorMethods::MicrosoftAuthenticatorMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.authentication entity.
        def operations()
            return MicrosoftGraphBeta::Users::Item::Authentication::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def passwordless_microsoft_authenticator_methods()
            return MicrosoftGraphBeta::Users::Item::Authentication::PasswordlessMicrosoftAuthenticatorMethods::PasswordlessMicrosoftAuthenticatorMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the passwordMethods property of the microsoft.graph.authentication entity.
        def password_methods()
            return MicrosoftGraphBeta::Users::Item::Authentication::PasswordMethods::PasswordMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def temporary_access_pass_methods()
            return MicrosoftGraphBeta::Users::Item::Authentication::TemporaryAccessPassMethods::TemporaryAccessPassMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def windows_hello_for_business_methods()
            return MicrosoftGraphBeta::Users::Item::Authentication::WindowsHelloForBusinessMethods::WindowsHelloForBusinessMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def email_methods_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Authentication::EmailMethods::Item::EmailAuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the fido2Methods property of the microsoft.graph.authentication entity.
        ## @param id Unique identifier of the item
        ...
        def methods_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Authentication::Methods::Item::AuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the microsoftAuthenticatorMethods property of the microsoft.graph.authentication entity.
        ## @param id Unique identifier of the item
        ...
        def microsoft_authenticator_methods_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Authentication::MicrosoftAuthenticatorMethods::Item::MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.authentication entity.
        ## @param id Unique identifier of the item
        ...
        def password_methods_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Authentication::PasswordMethods::Item::PasswordAuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property authentication in users
        ## @param body The request body
        ...
        def software_oath_methods_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Authentication::SoftwareOathMethods::Item::SoftwareOathAuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the temporaryAccessPassMethods property of the microsoft.graph.authentication entity.
        ## @param id Unique identifier of the item
        ...
        def windows_hello_for_business_methods_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Authentication::WindowsHelloForBusinessMethods::Item::WindowsHelloForBusinessAuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
