...
module MicrosoftGraphBeta::Users::Item::Authentication::PasswordlessMicrosoftAuthenticatorMethods::Item::Device::TransitiveMemberOf::Item::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}"
