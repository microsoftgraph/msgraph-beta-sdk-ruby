...
module MicrosoftGraphBeta::Users::Item::Authentication::MicrosoftAuthenticatorMethods::Item::Device::RegisteredUsers::Endpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Authentication::MicrosoftAuthenticatorMethods::Item::Device::RegisteredUsers::Endpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
