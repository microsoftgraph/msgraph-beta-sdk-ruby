...
module MicrosoftGraphBeta::Users::Item::Authentication::Methods
    ## 
    ...
    class MethodsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Authentication::Methods::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
