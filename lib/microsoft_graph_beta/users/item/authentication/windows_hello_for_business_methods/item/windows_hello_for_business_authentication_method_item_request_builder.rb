...
module MicrosoftGraphBeta::Users::Item::Authentication::WindowsHelloForBusinessMethods::Item
    ## 
    ...
    class WindowsHelloForBusinessAuthenticationMethodItemRequestBuilder
        ...
        def device()
            return MicrosoftGraphBeta::Users::Item::Authentication::WindowsHelloForBusinessMethods::Item::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::WindowsHelloForBusinessAuthenticationMethod.create_from_discriminator_value(pn) }, error_mapping)
        end
