...
module MicrosoftGraphBeta::Users::Item::Outlook::SupportedLanguages
    ...
    class SupportedLanguagesRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::Outlook::SupportedLanguages::SupportedLanguagesResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
