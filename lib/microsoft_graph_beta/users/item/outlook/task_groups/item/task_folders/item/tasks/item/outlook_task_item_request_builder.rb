...
module MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item
    ...
    class OutlookTaskItemRequestBuilder
        ...
        def complete()
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item::Complete::CompleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
