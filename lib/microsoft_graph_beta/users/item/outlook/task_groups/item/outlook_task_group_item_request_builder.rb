...
module MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item
    ## 
    ...
    class OutlookTaskGroupItemRequestBuilder
        ...
        def task_folders()
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::TaskFoldersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/outlook/taskGroups/{outlookTaskGroup%2Did}{?%24select}"
