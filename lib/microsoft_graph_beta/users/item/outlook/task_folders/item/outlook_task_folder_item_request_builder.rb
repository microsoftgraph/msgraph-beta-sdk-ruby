...
module MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item
    ## 
    ...
    class OutlookTaskFolderItemRequestBuilder
        ...
        def multi_value_extended_properties()
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the tasks property of the microsoft.graph.outlookTaskFolder entity.
        def tasks()
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}{?%24select}"
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property taskFolders in users
        ## @param body The request body
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tasks property of the microsoft.graph.outlookTaskFolder entity.
        ## @param id Unique identifier of the item
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::Tasks::Item::OutlookTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
