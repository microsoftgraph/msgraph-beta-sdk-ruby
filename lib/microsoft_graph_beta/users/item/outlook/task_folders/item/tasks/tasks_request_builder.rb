...
module MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::Tasks
    ## 
    ...
    class TasksRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}/tasks{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
