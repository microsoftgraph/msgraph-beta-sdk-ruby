...
module MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::Tasks::Item::Complete
    ...
    class CompleteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}/microsoft.graph.complete"
        ...
        def post(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::Tasks::Item::Complete::CompleteResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
