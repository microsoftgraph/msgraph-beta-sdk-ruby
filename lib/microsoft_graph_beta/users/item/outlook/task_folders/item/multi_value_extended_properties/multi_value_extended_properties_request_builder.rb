...
module MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::MultiValueExtendedProperties
    ## 
    ...
    class MultiValueExtendedPropertiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::MultiValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
