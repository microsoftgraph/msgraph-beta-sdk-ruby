...
module MicrosoftGraphBeta::Users::Item::Outlook::Tasks::Item::Attachments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/outlook/tasks/{outlookTask%2Did}/attachments/$count"
