...
module MicrosoftGraphBeta::Users::Item::Outlook::Tasks::Item
    ## 
    ...
    class OutlookTaskItemRequestBuilder
        ...
        def attachments()
            return MicrosoftGraphBeta::Users::Item::Outlook::Tasks::Item::Attachments::AttachmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the complete method.
        def complete()
            return MicrosoftGraphBeta::Users::Item::Outlook::Tasks::Item::Complete::CompleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.outlookTask entity.
        def multi_value_extended_properties()
            return MicrosoftGraphBeta::Users::Item::Outlook::Tasks::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraphBeta::Users::Item::Outlook::Tasks::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def attachments_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Outlook::Tasks::Item::Attachments::Item::AttachmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/outlook/tasks/{outlookTask%2Did}{?%24select}"
        ...
        ## Get tasks from users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of outlook_task
        ## 
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Outlook::Tasks::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property tasks in users
        ## @param body The request body
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Outlook::Tasks::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
