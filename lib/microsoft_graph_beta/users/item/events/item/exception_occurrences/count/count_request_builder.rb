...
module MicrosoftGraphBeta::Users::Item::Events::Item::ExceptionOccurrences::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/events/{event%2Did}/exceptionOccurrences/$count"
