...
module MicrosoftGraphBeta::Users::Item::FindRooms
    ## 
    # Provides operations to call the findRooms method.
    class FindRoomsResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
        ...
        ## @return a find_rooms_response
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return FindRoomsResponse.new
        end
        ## 
