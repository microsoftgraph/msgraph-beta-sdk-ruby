...
module MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::UserConfigurations
    ## 
    ...
    class UserConfigurationsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::UserConfigurations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/userConfigurations{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
        ...
        ## Get userConfigurations from users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of user_configuration_collection_response
        ## 
