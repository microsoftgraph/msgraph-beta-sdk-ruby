...
require_relative './user_configurations/item/user_configuration_item_request_builder'
require_relative './user_configurations/user_configurations_request_builder'

module MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item
    ## 
    ...
    class MailFolderItemRequestBuilder
        ...
        def copy()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::Copy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the messageRules property of the microsoft.graph.mailFolder entity.
        def message_rules()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::MessageRules::MessageRulesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the messages property of the microsoft.graph.mailFolder entity.
        def messages()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::MessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the move method.
        def move()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::Move::MoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.mailFolder entity.
        def multi_value_extended_properties()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_configurations()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::UserConfigurations::UserConfigurationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def message_rules_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::MessageRules::Item::MessageRuleItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the messages property of the microsoft.graph.mailFolder entity.
        ## @param id Unique identifier of the item
        ...
        def messages_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MessageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.mailFolder entity.
        ## @param id Unique identifier of the item
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property childFolders for users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        ## 
        def user_configurations_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["userConfiguration%2Did"] = id
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::UserConfigurations::Item::UserConfigurationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
