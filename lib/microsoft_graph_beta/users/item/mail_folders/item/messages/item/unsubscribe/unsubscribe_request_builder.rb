...
module MicrosoftGraphBeta::Users::Item::MailFolders::Item::Messages::Item::Unsubscribe
    ## 
    ...
    class UnsubscribeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.unsubscribe"
