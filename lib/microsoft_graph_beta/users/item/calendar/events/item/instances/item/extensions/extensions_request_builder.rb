...
module MicrosoftGraphBeta::Users::Item::Calendar::Events::Item::Instances::Item::Extensions
    ## 
    ...
    class ExtensionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Calendar::Events::Item::Instances::Item::Extensions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
