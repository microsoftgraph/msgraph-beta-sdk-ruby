...
module MicrosoftGraphBeta::Users::Item::Activities::Item
    ## 
    ...
    class UserActivityItemRequestBuilder
        ...
        def history_items()
            return MicrosoftGraphBeta::Users::Item::Activities::Item::HistoryItems::HistoryItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
