...
module MicrosoftGraphBeta::Users::Item::ReminderViewWithStartDateTimeWithEndDateTime
    ...
    class ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::ReminderViewWithStartDateTimeWithEndDateTime::ReminderViewWithStartDateTimeWithEndDateTimeResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function reminderView
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
