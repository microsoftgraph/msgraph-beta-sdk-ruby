...
module MicrosoftGraphBeta::Users::Item::Settings::ContactMergeSuggestions
    ## 
    ...
    class ContactMergeSuggestionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/settings/contactMergeSuggestions{?%24select,%24expand}"
        ...
        ## Read the properties and relationships of a contactMergeSuggestions object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of contact_merge_suggestions
        ## 
