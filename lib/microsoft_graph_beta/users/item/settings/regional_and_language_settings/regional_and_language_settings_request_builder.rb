...
module MicrosoftGraphBeta::Users::Item::Settings::RegionalAndLanguageSettings
    ## 
    ...
    class RegionalAndLanguageSettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/settings/regionalAndLanguageSettings{?%24select,%24expand}"
        ...
        ## Get the properties of a regionalAndLanguageSettings object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of regional_and_language_settings
        ## 
