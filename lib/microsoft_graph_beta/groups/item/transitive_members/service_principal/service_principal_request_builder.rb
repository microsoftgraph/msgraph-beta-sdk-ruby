...
module MicrosoftGraphBeta::Groups::Item::TransitiveMembers::ServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::TransitiveMembers::ServicePrincipal::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
