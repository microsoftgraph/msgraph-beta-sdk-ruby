...
module MicrosoftGraphBeta::Groups::Item::Members::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Members::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
