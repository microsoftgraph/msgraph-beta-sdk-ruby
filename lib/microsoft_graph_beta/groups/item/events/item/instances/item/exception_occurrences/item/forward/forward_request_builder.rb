...
module MicrosoftGraphBeta::Groups::Item::Events::Item::Instances::Item::ExceptionOccurrences::Item::Forward
    ## 
    ...
    class ForwardRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/microsoft.graph.forward"
