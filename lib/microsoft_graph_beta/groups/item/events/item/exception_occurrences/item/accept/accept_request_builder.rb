...
module MicrosoftGraphBeta::Groups::Item::Events::Item::ExceptionOccurrences::Item::Accept
    ## 
    ...
    class AcceptRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/microsoft.graph.accept"
