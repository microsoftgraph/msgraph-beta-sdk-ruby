...
module MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::Posts::Item::InReplyTo::Attachments
    ## 
    ...
    class AttachmentsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::Posts::Item::InReplyTo::Attachments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createUploadSession method.
        def create_upload_session()
            return MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::Posts::Item::InReplyTo::Attachments::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
