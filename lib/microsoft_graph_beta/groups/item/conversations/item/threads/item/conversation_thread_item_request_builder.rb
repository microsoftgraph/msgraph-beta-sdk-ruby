...
module MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item
    ## 
    ...
    class ConversationThreadItemRequestBuilder
        ...
        def posts()
            return MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::Posts::PostsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reply method.
        def reply()
            return MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::Reply::ReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ConversationThread.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property threads in groups
        ## @param body The request body
        ...
        def posts_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::Item::Posts::Item::PostItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
