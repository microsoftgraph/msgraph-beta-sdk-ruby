...
module MicrosoftGraphBeta::Groups::Item::Conversations::Item
    ## 
    ...
    class ConversationItemRequestBuilder
        ...
        def threads()
            return MicrosoftGraphBeta::Groups::Item::Conversations::Item::Threads::ThreadsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
