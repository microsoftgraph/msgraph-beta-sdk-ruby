...
module MicrosoftGraphBeta::Groups::Item::AcceptedSenders
    ## 
    ...
    class AcceptedSendersRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::AcceptedSenders::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def ref()
            return MicrosoftGraphBeta::Groups::Item::AcceptedSenders::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
