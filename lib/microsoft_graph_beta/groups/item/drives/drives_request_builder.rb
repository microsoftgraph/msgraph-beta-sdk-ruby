...
module MicrosoftGraphBeta::Groups::Item::Drives
    ## 
    ...
    class DrivesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Drives::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
