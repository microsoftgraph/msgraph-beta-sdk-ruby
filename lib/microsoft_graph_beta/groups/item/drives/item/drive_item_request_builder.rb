...
module MicrosoftGraphBeta::Groups::Item::Drives::Item
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the bundles property of the microsoft.graph.drive entity.
        def bundles()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Bundles::BundlesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the following property of the microsoft.graph.drive entity.
        def following()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Following::FollowingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the items property of the microsoft.graph.drive entity.
        def items()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the list property of the microsoft.graph.drive entity.
        def list()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::List::ListRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def root()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Root::RootRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the special property of the microsoft.graph.drive entity.
        def special()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Special::SpecialRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def activities_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Activities::Item::ItemActivityOLDItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the bundles property of the microsoft.graph.drive entity.
        ## @param id Unique identifier of the item
        ...
        def bundles_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Bundles::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def following_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Following::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## The group's drives. Read-only.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def items_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property drives in groups
        ## @param body The request body
        ...
        def special_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Special::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
