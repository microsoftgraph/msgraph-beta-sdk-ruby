...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Bundles::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Bundles::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
