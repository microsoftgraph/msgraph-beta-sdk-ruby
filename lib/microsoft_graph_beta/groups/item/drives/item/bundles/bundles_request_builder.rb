...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Bundles
    ## 
    ...
    class BundlesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Bundles::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
