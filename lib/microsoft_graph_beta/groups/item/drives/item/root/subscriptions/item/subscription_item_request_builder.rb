...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Root::Subscriptions::Item
    ## 
    ...
    class SubscriptionItemRequestBuilder
        ...
        def reauthorize()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Root::Subscriptions::Item::Reauthorize::ReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
