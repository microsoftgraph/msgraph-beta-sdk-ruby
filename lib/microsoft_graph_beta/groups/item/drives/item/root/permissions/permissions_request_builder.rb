...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Root::Permissions
    ## 
    ...
    class PermissionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Root::Permissions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
