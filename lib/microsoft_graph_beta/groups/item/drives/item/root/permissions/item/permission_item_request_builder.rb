...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Root::Permissions::Item
    ## 
    ...
    class PermissionItemRequestBuilder
        ...
        def grant()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Root::Permissions::Item::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def revoke_grants()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Root::Permissions::Item::RevokeGrants::RevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
