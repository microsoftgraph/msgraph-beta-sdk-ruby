...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::List::Items::Item::CreateLink
    ## 
    ...
    class CreateLinkRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/microsoft.graph.createLink"
