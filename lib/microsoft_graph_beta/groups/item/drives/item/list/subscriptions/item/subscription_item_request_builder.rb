...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::List::Subscriptions::Item
    ## 
    ...
    class SubscriptionItemRequestBuilder
        ...
        def reauthorize()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::List::Subscriptions::Item::Reauthorize::ReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
