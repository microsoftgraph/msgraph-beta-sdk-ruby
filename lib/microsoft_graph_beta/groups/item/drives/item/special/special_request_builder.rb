...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Special
    ## 
    ...
    class SpecialRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Drives::Item::Special::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
