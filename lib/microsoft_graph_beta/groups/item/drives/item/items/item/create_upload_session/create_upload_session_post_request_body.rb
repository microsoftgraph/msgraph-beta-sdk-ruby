...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::CreateUploadSession
    class CreateUploadSessionPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "item" => lambda {|n| @item = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DriveItemUploadableProperties.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
