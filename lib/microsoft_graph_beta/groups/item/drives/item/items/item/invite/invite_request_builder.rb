...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Invite
    ## 
    ...
    class InviteRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Invite::InviteResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
