...
module MicrosoftGraphBeta::Groups::Item::Drives::Item::Items::Item::Preview
    class PreviewPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "allowEdit" => lambda {|n| @allow_edit = n.get_boolean_value() },
                "chromeless" => lambda {|n| @chromeless = n.get_boolean_value() },
                "page" => lambda {|n| @page = n.get_string_value() },
                "viewer" => lambda {|n| @viewer = n.get_string_value() },
        ...
        def serialize(writer)
            ...
            writer.write_boolean_value("allowEdit", @allow_edit)
            writer.write_boolean_value("chromeless", @chromeless)
            writer.write_string_value("page", @page)
            writer.write_string_value("viewer", @viewer)
