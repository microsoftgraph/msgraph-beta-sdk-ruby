...
module MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::GetRecentNotebooksWithIncludePersonalNotebooks
    ...
    class GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::GetRecentNotebooksWithIncludePersonalNotebooks::GetRecentNotebooksWithIncludePersonalNotebooksResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function getRecentNotebooks
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
