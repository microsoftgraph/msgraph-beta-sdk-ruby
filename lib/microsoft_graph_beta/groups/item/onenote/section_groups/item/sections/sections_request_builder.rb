...
module MicrosoftGraphBeta::Groups::Item::Onenote::SectionGroups::Item::Sections
    ## 
    ...
    class SectionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Onenote::SectionGroups::Item::Sections::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
