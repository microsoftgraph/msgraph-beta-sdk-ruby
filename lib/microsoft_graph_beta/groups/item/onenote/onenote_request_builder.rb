...
module MicrosoftGraphBeta::Groups::Item::Onenote
    ## 
    ...
    class OnenoteRequestBuilder
        ...
        def notebooks()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::NotebooksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.onenote entity.
        def operations()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the pages property of the microsoft.graph.onenote entity.
        def pages()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resources()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Resources::ResourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sectionGroups property of the microsoft.graph.onenote entity.
        def section_groups()
            return MicrosoftGraphBeta::Groups::Item::Onenote::SectionGroups::SectionGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sections property of the microsoft.graph.onenote entity.
        def sections()
            return MicrosoftGraphBeta::Groups::Item::Onenote::Sections::SectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def notebooks_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Onenote::Notebooks::Item::NotebookItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def resources_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Onenote::Resources::Item::OnenoteResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sectionGroups property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
