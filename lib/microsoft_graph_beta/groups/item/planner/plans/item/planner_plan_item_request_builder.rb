...
module MicrosoftGraphBeta::Groups::Item::Planner::Plans::Item
    ## 
    ...
    class PlannerPlanItemRequestBuilder
        ...
        def buckets_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Planner::Plans::Item::Buckets::Item::PlannerBucketItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Planner::Plans::Item::Tasks::Item::PlannerTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
