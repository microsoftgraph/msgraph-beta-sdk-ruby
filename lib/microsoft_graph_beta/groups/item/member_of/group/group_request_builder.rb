...
module MicrosoftGraphBeta::Groups::Item::MemberOf::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::MemberOf::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
