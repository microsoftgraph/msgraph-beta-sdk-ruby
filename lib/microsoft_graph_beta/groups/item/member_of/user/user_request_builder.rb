...
module MicrosoftGraphBeta::Groups::Item::MemberOf::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::MemberOf::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
