...
module MicrosoftGraphBeta::Groups::Item::CalendarView::Item::ExceptionOccurrences::Item::SingleValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/singleValueExtendedProperties/$count"
