...
module MicrosoftGraphBeta::Groups::Item::CalendarView::Item::ExceptionOccurrences::Item::Instances::Item::SingleValueExtendedProperties::Item
    ## 
    ...
    class SingleValueLegacyExtendedPropertyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty%2Did}{?%24select,%24expand}"
