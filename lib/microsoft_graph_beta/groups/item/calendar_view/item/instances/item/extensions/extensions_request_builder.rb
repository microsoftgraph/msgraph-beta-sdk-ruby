...
module MicrosoftGraphBeta::Groups::Item::CalendarView::Item::Instances::Item::Extensions
    ## 
    ...
    class ExtensionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::CalendarView::Item::Instances::Item::Extensions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
