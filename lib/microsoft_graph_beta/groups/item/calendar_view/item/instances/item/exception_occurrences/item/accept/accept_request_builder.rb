...
module MicrosoftGraphBeta::Groups::Item::CalendarView::Item::Instances::Item::ExceptionOccurrences::Item::Accept
    ## 
    ...
    class AcceptRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/microsoft.graph.accept"
