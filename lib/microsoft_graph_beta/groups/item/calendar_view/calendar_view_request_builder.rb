...
module MicrosoftGraphBeta::Groups::Item::CalendarView
    ## 
    ...
    class CalendarViewRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::CalendarView::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
