...
module MicrosoftGraphBeta::Groups::Item::Owners::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Owners::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
