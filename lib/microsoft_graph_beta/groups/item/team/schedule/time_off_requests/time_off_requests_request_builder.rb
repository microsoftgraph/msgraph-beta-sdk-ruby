...
module MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeOffRequests
    ## 
    ...
    class TimeOffRequestsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Team::Schedule::TimeOffRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
