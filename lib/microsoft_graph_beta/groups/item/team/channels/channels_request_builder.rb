...
module MicrosoftGraphBeta::Groups::Item::Team::Channels
    ## 
    ...
    class ChannelsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
