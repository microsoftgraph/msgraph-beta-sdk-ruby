...
module MicrosoftGraphBeta::Groups::Item::Team::Channels::Item
    ## 
    ...
    class ChannelItemRequestBuilder
        ...
        def members_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Members::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the messages property of the microsoft.graph.channel entity.
        ## @param id Unique identifier of the item
        ...
        def messages_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Messages::Item::ChatMessageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def shared_with_teams_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::SharedWithTeams::Item::SharedWithChannelTeamInfoItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tabs property of the microsoft.graph.channel entity.
        ## @param id Unique identifier of the item
        ...
        def tabs_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Tabs::Item::TeamsTabItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property channels for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
