...
module MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Messages
    ## 
    ...
    class MessagesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::Messages::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
