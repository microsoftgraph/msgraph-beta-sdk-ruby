...
module MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::SharedWithTeams
    ## 
    ...
    class SharedWithTeamsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Team::Channels::Item::SharedWithTeams::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
