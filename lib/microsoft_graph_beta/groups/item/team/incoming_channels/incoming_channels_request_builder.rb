...
module MicrosoftGraphBeta::Groups::Item::Team::IncomingChannels
    ## 
    ...
    class IncomingChannelsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Team::IncomingChannels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
