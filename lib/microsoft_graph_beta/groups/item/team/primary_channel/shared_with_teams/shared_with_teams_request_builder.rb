...
module MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::SharedWithTeams
    ## 
    ...
    class SharedWithTeamsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Team::PrimaryChannel::SharedWithTeams::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
