...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Permissions::Item
    ...
    class PermissionItemRequestBuilder
        ...
        def grant()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Permissions::Item::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def revoke_grants()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Permissions::Item::RevokeGrants::RevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
