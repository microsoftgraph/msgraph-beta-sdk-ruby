...
module MicrosoftGraphBeta::Groups::Item::Sites::Item
    ## 
    ...
    class SiteItemRequestBuilder
        ...
        def analytics()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def drive()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Drive::DriveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the drives property of the microsoft.graph.site entity.
        def drives()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Drives::DrivesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the externalColumns property of the microsoft.graph.site entity.
        def external_columns()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::ExternalColumns::ExternalColumnsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the items property of the microsoft.graph.site entity.
        def items()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the lists property of the microsoft.graph.site entity.
        def lists()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::ListsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the onenote property of the microsoft.graph.site entity.
        def onenote()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::OnenoteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.site entity.
        def operations()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the pages property of the microsoft.graph.site entity.
        def pages()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def term_store()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::TermStoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def columns_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Columns::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def content_types_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::ContentTypes::Item::ContentTypeItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the drives property of the microsoft.graph.site entity.
        ## @param id Unique identifier of the item
        ...
        def drives_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Drives::Item::DriveItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the externalColumns property of the microsoft.graph.site entity.
        ## @param id Unique identifier of the item
        ...
        def external_columns_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["columnDefinition%2Did"] = id
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::ExternalColumns::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def items_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Items::Item::BaseItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the lists property of the microsoft.graph.site entity.
        ## @param id Unique identifier of the item
        ...
        def lists_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::ListItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.site entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Operations::Item::RichLongRunningOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the pages property of the microsoft.graph.site entity.
        ## @param id Unique identifier of the item
        ...
        def pages_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Pages::Item::SitePageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def permissions_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Permissions::Item::PermissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sites property of the microsoft.graph.site entity.
        ## @param id Unique identifier of the item
        ...
        def sites_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Sites::Item::SiteItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## The list of SharePoint sites in this group. Access the default site with /sites/root.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
