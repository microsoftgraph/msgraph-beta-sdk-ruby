...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Activities
    ## 
    ...
    class ActivitiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
