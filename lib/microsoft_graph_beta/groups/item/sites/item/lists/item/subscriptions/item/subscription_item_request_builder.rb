...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Subscriptions::Item
    ...
    class SubscriptionItemRequestBuilder
        ...
        def reauthorize()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Lists::Item::Subscriptions::Item::Reauthorize::ReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
