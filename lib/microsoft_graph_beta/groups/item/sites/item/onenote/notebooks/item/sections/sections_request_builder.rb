...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::Notebooks::Item::Sections
    ## 
    ...
    class SectionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::Onenote::Notebooks::Item::Sections::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
