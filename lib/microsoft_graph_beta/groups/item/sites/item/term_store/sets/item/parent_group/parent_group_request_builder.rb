...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::Sets::Item::ParentGroup
    ## 
    ...
    class ParentGroupRequestBuilder
        ...
        def sets()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::SetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
