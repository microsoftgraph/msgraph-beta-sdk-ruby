...
module MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::Groups::Item::Sets::Item::Relations
    ## 
    ...
    class RelationsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Groups::Item::Sites::Item::TermStore::Groups::Item::Sets::Item::Relations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
