...
module MicrosoftGraphBeta::Groups::Item::Sites
    ## 
    ...
    class SitesRequestBuilder
        ...
        def add()
            return MicrosoftGraphBeta::Groups::Item::Sites::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to count the resources in the collection.
        def count()
            return MicrosoftGraphBeta::Groups::Item::Sites::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def remove()
            return MicrosoftGraphBeta::Groups::Item::Sites::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
