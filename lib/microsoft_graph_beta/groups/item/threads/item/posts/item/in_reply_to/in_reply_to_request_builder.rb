...
module MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo
    ## 
    ...
    class InReplyToRequestBuilder
        ...
        def attachments()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::Attachments::AttachmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the extensions property of the microsoft.graph.post entity.
        def extensions()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::Extensions::ExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the forward method.
        def forward()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::Forward::ForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the mentions property of the microsoft.graph.post entity.
        def mentions()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::Mentions::MentionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.post entity.
        def multi_value_extended_properties()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reply()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::Reply::ReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def attachments_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::Attachments::Item::AttachmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## The earlier post that this post is replying to in the conversationThread. Read-only. Supports $expand.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def mentions_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::Mentions::Item::MentionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.post entity.
        ## @param id Unique identifier of the item
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the singleValueExtendedProperties property of the microsoft.graph.post entity.
        ## @param id Unique identifier of the item
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::InReplyTo::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
