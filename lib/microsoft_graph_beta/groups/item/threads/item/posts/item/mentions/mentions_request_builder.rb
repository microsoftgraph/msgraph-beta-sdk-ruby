...
module MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::Mentions
    ## 
    ...
    class MentionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/mentions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
