...
module MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item
    ...
    class PostItemRequestBuilder
        ...
        def forward()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::Forward::ForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reply()
            return MicrosoftGraphBeta::Groups::Item::Threads::Item::Posts::Item::Reply::ReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
