...
module MicrosoftGraphBeta::Models
    class DocumentSetVersion < MicrosoftGraphBeta::Models::ListItemVersion
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "items" => lambda {|n| @items = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DocumentSetVersionItem.create_from_discriminator_value(pn) }) },
