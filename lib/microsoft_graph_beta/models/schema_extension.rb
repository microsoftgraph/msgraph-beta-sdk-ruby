...
module MicrosoftGraphBeta::Models
    class SchemaExtension < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "properties" => lambda {|n| @properties = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExtensionSchemaProperty.create_from_discriminator_value(pn) }) },
