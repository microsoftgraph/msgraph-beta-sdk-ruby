...
module MicrosoftGraphBeta::Models
    class WorkbookWorksheet < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "charts" => lambda {|n| @charts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChart.create_from_discriminator_value(pn) }) },
                ...
                "pivotTables" => lambda {|n| @pivot_tables = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookPivotTable.create_from_discriminator_value(pn) }) },
                "position" => lambda {|n| @position = n.get_number_value() },
                "protection" => lambda {|n| @protection = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookWorksheetProtection.create_from_discriminator_value(pn) }) },
