...
module MicrosoftGraphBeta::Models
    class Windows10TeamGeneralConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "miracastChannel" => lambda {|n| @miracast_channel = n.get_enum_value(MicrosoftGraphBeta::Models::MiracastChannel) },
                ...
                "welcomeScreenMeetingInformation" => lambda {|n| @welcome_screen_meeting_information = n.get_enum_value(MicrosoftGraphBeta::Models::WelcomeScreenMeetingInformation) },
            })
        end
        ## 
