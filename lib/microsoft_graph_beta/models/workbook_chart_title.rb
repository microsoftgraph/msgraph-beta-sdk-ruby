...
module MicrosoftGraphBeta::Models
    class WorkbookChartTitle < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "format" => lambda {|n| @format = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartTitleFormat.create_from_discriminator_value(pn) }) },
