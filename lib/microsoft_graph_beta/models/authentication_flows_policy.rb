    ...
    class AuthenticationFlowsPolicy < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "selfServiceSignUp" => lambda {|n| @self_service_sign_up = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SelfServiceSignUpAuthenticationFlowConfiguration.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
