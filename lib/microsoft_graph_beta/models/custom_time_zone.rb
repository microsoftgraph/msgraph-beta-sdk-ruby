...
module MicrosoftGraphBeta::Models
    class CustomTimeZone < MicrosoftGraphBeta::Models::TimeZoneBase
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "daylightOffset" => lambda {|n| @daylight_offset = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DaylightTimeZoneOffset.create_from_discriminator_value(pn) }) },
                "standardOffset" => lambda {|n| @standard_offset = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::StandardTimeZoneOffset.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
