...
module MicrosoftGraphBeta::Models
    class PlannerAssignedToTaskBoardTaskFormat < MicrosoftGraphBeta::Models::PlannerDelta
        ...
        def get_field_deserializers()
            return super.merge({
                "orderHintsByAssignee" => lambda {|n| @order_hints_by_assignee = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PlannerOrderHintsByAssignee.create_from_discriminator_value(pn) }) },
