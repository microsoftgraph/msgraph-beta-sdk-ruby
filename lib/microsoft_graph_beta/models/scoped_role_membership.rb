...
module MicrosoftGraphBeta::Models
    class ScopedRoleMembership < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "roleMemberInfo" => lambda {|n| @role_member_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Identity.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
