    ...
    class SimulationReport
        ...
        def get_field_deserializers()
            return {
                ...
                "overview" => lambda {|n| @overview = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SimulationReportOverview.create_from_discriminator_value(pn) }) },
                "simulationUsers" => lambda {|n| @simulation_users = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserSimulationDetails.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
