    ...
    class ParseExpressionResponse
        ...
        def get_field_deserializers()
            return {
                ...
                "parsedExpression" => lambda {|n| @parsed_expression = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AttributeMappingSource.create_from_discriminator_value(pn) }) },
