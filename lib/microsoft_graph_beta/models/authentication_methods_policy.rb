...
module MicrosoftGraphBeta::Models
    class AuthenticationMethodsPolicy < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "authenticationMethodConfigurations" => lambda {|n| @authentication_method_configurations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationMethodConfiguration.create_from_discriminator_value(pn) }) },
                ...
                "registrationEnforcement" => lambda {|n| @registration_enforcement = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::RegistrationEnforcement.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
