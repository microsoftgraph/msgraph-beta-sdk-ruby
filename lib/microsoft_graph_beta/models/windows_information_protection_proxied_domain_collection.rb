    ...
    class WindowsInformationProtectionProxiedDomainCollection
        ...
        def get_field_deserializers()
            return {
                ...
                "proxiedDomains" => lambda {|n| @proxied_domains = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ProxiedDomain.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
