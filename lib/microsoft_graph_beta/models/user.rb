...
module MicrosoftGraphBeta::Models
    class User < MicrosoftGraphBeta::Models::DirectoryObject
        ...
        def app_consent_requests_for_approval
            return @app_consent_requests_for_approval
        end
        ## 
        ...
        ## @return a void
        ## 
        def app_consent_requests_for_approval=(value)
            @app_consent_requests_for_approval = value
        end
        ## 
        ...
        def app_role_assigned_resources
            return @app_role_assigned_resources
        end
        ## 
        ...
        ## @return a void
        ## 
        def app_role_assigned_resources=(value)
            @app_role_assigned_resources = value
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "activities" => lambda {|n| @activities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserActivity.create_from_discriminator_value(pn) }) },
                "ageGroup" => lambda {|n| @age_group = n.get_string_value() },
                "agreementAcceptances" => lambda {|n| @agreement_acceptances = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AgreementAcceptance.create_from_discriminator_value(pn) }) },
                "analytics" => lambda {|n| @analytics = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserAnalytics.create_from_discriminator_value(pn) }) },
                "appConsentRequestsForApproval" => lambda {|n| @app_consent_requests_for_approval = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AppConsentRequest.create_from_discriminator_value(pn) }) },
                "appRoleAssignedResources" => lambda {|n| @app_role_assigned_resources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ServicePrincipal.create_from_discriminator_value(pn) }) },
                ...
                "approvals" => lambda {|n| @approvals = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Approval.create_from_discriminator_value(pn) }) },
                ...
                "authentication" => lambda {|n| @authentication = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Authentication.create_from_discriminator_value(pn) }) },
                "authorizationInfo" => lambda {|n| @authorization_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AuthorizationInfo.create_from_discriminator_value(pn) }) },
                ...
                "calendarGroups" => lambda {|n| @calendar_groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CalendarGroup.create_from_discriminator_value(pn) }) },
                "calendars" => lambda {|n| @calendars = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Calendar.create_from_discriminator_value(pn) }) },
                ...
                "chats" => lambda {|n| @chats = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Chat.create_from_discriminator_value(pn) }) },
                ...
                "contactFolders" => lambda {|n| @contact_folders = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ContactFolder.create_from_discriminator_value(pn) }) },
                ...
                "deviceKeys" => lambda {|n| @device_keys = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceKey.create_from_discriminator_value(pn) }) },
                "deviceManagementTroubleshootingEvents" => lambda {|n| @device_management_troubleshooting_events = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceManagementTroubleshootingEvent.create_from_discriminator_value(pn) }) },
                "devices" => lambda {|n| @devices = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Device.create_from_discriminator_value(pn) }) },
                "directReports" => lambda {|n| @direct_reports = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
                ...
                "employeeOrgData" => lambda {|n| @employee_org_data = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EmployeeOrgData.create_from_discriminator_value(pn) }) },
                ...
                "externalUserStateChangeDateTime" => lambda {|n| @external_user_state_change_date_time = n.get_string_value() },
                "faxNumber" => lambda {|n| @fax_number = n.get_string_value() },
                "followedSites" => lambda {|n| @followed_sites = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Site.create_from_discriminator_value(pn) }) },
                "givenName" => lambda {|n| @given_name = n.get_string_value() },
                "hireDate" => lambda {|n| @hire_date = n.get_date_time_value() },
                "identities" => lambda {|n| @identities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ObjectIdentity.create_from_discriminator_value(pn) }) },
                "imAddresses" => lambda {|n| @im_addresses = n.get_collection_of_primitive_values(String) },
                "inferenceClassification" => lambda {|n| @inference_classification = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::InferenceClassification.create_from_discriminator_value(pn) }) },
                ...
                "insights" => lambda {|n| @insights = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemInsights.create_from_discriminator_value(pn) }) },
                ...
                "joinedGroups" => lambda {|n| @joined_groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Group.create_from_discriminator_value(pn) }) },
                "joinedTeams" => lambda {|n| @joined_teams = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Team.create_from_discriminator_value(pn) }) },
                ...
                "licenseAssignmentStates" => lambda {|n| @license_assignment_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::LicenseAssignmentState.create_from_discriminator_value(pn) }) },
                "licenseDetails" => lambda {|n| @license_details = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::LicenseDetails.create_from_discriminator_value(pn) }) },
                "mail" => lambda {|n| @mail = n.get_string_value() },
                "mailboxSettings" => lambda {|n| @mailbox_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MailboxSettings.create_from_discriminator_value(pn) }) },
                "mailFolders" => lambda {|n| @mail_folders = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MailFolder.create_from_discriminator_value(pn) }) },
                ...
                "manager" => lambda {|n| @manager = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
                ...
                "mobileAppIntentAndStates" => lambda {|n| @mobile_app_intent_and_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MobileAppIntentAndState.create_from_discriminator_value(pn) }) },
                ...
                "notifications" => lambda {|n| @notifications = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Notification.create_from_discriminator_value(pn) }) },
                "oauth2PermissionGrants" => lambda {|n| @oauth2_permission_grants = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OAuth2PermissionGrant.create_from_discriminator_value(pn) }) },
                ...
                "onPremisesExtensionAttributes" => lambda {|n| @on_premises_extension_attributes = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnPremisesExtensionAttributes.create_from_discriminator_value(pn) }) },
                ...
                "outlook" => lambda {|n| @outlook = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OutlookUser.create_from_discriminator_value(pn) }) },
                "ownedDevices" => lambda {|n| @owned_devices = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
                "ownedObjects" => lambda {|n| @owned_objects = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
                ...
                "pendingAccessReviewInstances" => lambda {|n| @pending_access_review_instances = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewInstance.create_from_discriminator_value(pn) }) },
                "people" => lambda {|n| @people = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Person.create_from_discriminator_value(pn) }) },
                ...
                "planner" => lambda {|n| @planner = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PlannerUser.create_from_discriminator_value(pn) }) },
                ...
                "presence" => lambda {|n| @presence = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Presence.create_from_discriminator_value(pn) }) },
                "print" => lambda {|n| @print = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserPrint.create_from_discriminator_value(pn) }) },
                "profile" => lambda {|n| @profile = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Profile.create_from_discriminator_value(pn) }) },
                ...
                "registeredDevices" => lambda {|n| @registered_devices = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
                ...
                "scopedRoleMemberOf" => lambda {|n| @scoped_role_member_of = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ScopedRoleMembership.create_from_discriminator_value(pn) }) },
                "security" => lambda {|n| @security = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::Security.create_from_discriminator_value(pn) }) },
                "securityIdentifier" => lambda {|n| @security_identifier = n.get_string_value() },
                "settings" => lambda {|n| @settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserSettings.create_from_discriminator_value(pn) }) },
                ...
                "teamwork" => lambda {|n| @teamwork = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UserTeamwork.create_from_discriminator_value(pn) }) },
                "todo" => lambda {|n| @todo = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Todo.create_from_discriminator_value(pn) }) },
                ...
                "transitiveReports" => lambda {|n| @transitive_reports = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DirectoryObject.create_from_discriminator_value(pn) }) },
        ...
        def mobile_app_intent_and_states
            return @mobile_app_intent_and_states
        end
        ## 
        ...
        ## @return a void
        ## 
        def mobile_app_intent_and_states=(value)
            @mobile_app_intent_and_states = value
        end
        ## 
        ...
        ## @return a void
        ## 
        def pending_access_review_instances=(value)
        ...
        def serialize(writer)
            ...
            writer.write_collection_of_object_values("appConsentRequestsForApproval", @app_consent_requests_for_approval)
            writer.write_collection_of_object_values("appRoleAssignedResources", @app_role_assigned_resources)
            writer.write_collection_of_object_values("appRoleAssignments", @app_role_assignments)
            writer.write_collection_of_object_values("approvals", @approvals)
            ...
            writer.write_collection_of_object_values("deviceKeys", @device_keys)
            ...
            writer.write_string_value("externalUserStateChangeDateTime", @external_user_state_change_date_time)
            ...
            writer.write_collection_of_object_values("joinedGroups", @joined_groups)
            ...
            writer.write_collection_of_object_values("mobileAppIntentAndStates", @mobile_app_intent_and_states)
            ...
            writer.write_collection_of_object_values("notifications", @notifications)
            ...
            writer.write_collection_of_object_values("pendingAccessReviewInstances", @pending_access_review_instances)
            ...
            writer.write_object_value("profile", @profile)
            ...
            writer.write_collection_of_object_values("transitiveReports", @transitive_reports)
