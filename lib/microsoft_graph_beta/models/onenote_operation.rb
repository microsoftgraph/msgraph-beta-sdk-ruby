...
module MicrosoftGraphBeta::Models
    class OnenoteOperation < MicrosoftGraphBeta::Models::Operation
        ...
        def get_field_deserializers()
            return super.merge({
                "error" => lambda {|n| @error = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::OnenoteOperationError.create_from_discriminator_value(pn) }) },
