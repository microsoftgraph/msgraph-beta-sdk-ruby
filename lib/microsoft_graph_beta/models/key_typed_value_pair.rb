    ...
    class KeyTypedValuePair
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    when "#microsoft.graph.keyBooleanValuePair"
                        return KeyBooleanValuePair.new
                    when "#microsoft.graph.keyIntegerValuePair"
                        return KeyIntegerValuePair.new
                    when "#microsoft.graph.keyRealValuePair"
                        return KeyRealValuePair.new
                    when "#microsoft.graph.keyStringValuePair"
                        return KeyStringValuePair.new
                end
            end
            return KeyTypedValuePair.new
        end
        ## 
