...
module MicrosoftGraphBeta::Models
    class IosHomeScreenFolder < MicrosoftGraphBeta::Models::IosHomeScreenItem
        ...
        def get_field_deserializers()
            return super.merge({
                "pages" => lambda {|n| @pages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IosHomeScreenFolderPage.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
