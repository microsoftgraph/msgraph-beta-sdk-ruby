...
module MicrosoftGraphBeta::Models
    class UsedInsight < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "lastUsed" => lambda {|n| @last_used = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UsageDetails.create_from_discriminator_value(pn) }) },
