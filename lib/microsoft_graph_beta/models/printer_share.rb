    ...
    class PrinterShare < MicrosoftGraphBeta::Models::PrinterBase
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "allowedGroups" => lambda {|n| @allowed_groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Group.create_from_discriminator_value(pn) }) },
                "allowedUsers" => lambda {|n| @allowed_users = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::User.create_from_discriminator_value(pn) }) },
                "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                "printer" => lambda {|n| @printer = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Printer.create_from_discriminator_value(pn) }) },
                "viewPoint" => lambda {|n| @view_point = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PrinterShareViewpoint.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
