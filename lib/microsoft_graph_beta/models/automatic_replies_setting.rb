...
module MicrosoftGraphBeta::Models
    class AutomaticRepliesSetting
        ...
        def get_field_deserializers()
            return {
                "externalAudience" => lambda {|n| @external_audience = n.get_enum_value(MicrosoftGraphBeta::Models::ExternalAudienceScope) },
                ...
                "scheduledEndDateTime" => lambda {|n| @scheduled_end_date_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
                "scheduledStartDateTime" => lambda {|n| @scheduled_start_date_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::AutomaticRepliesStatus) },
            }
        end
        ## 
