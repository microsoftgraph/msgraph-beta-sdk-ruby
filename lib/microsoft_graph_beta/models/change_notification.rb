...
module MicrosoftGraphBeta::Models
    class ChangeNotification
        ...
        def get_field_deserializers()
            return {
                "changeType" => lambda {|n| @change_type = n.get_enum_value(MicrosoftGraphBeta::Models::ChangeType) },
                "clientState" => lambda {|n| @client_state = n.get_string_value() },
                "encryptedContent" => lambda {|n| @encrypted_content = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChangeNotificationEncryptedContent.create_from_discriminator_value(pn) }) },
                "id" => lambda {|n| @id = n.get_string_value() },
                "lifecycleEvent" => lambda {|n| @lifecycle_event = n.get_enum_value(MicrosoftGraphBeta::Models::LifecycleEventType) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "resource" => lambda {|n| @resource = n.get_string_value() },
                "resourceData" => lambda {|n| @resource_data = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ResourceData.create_from_discriminator_value(pn) }) },
