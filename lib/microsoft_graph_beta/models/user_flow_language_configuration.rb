...
module MicrosoftGraphBeta::Models
    class UserFlowLanguageConfiguration < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "defaultPages" => lambda {|n| @default_pages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserFlowLanguagePage.create_from_discriminator_value(pn) }) },
                "displayName" => lambda {|n| @display_name = n.get_string_value() },
                "isEnabled" => lambda {|n| @is_enabled = n.get_boolean_value() },
                "overridesPages" => lambda {|n| @overrides_pages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserFlowLanguagePage.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
