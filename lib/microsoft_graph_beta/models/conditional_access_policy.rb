...
module MicrosoftGraphBeta::Models
    ...
    class ConditionalAccessPolicy < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "conditions" => lambda {|n| @conditions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessConditionSet.create_from_discriminator_value(pn) }) },
                "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                "description" => lambda {|n| @description = n.get_string_value() },
                "displayName" => lambda {|n| @display_name = n.get_string_value() },
                "grantControls" => lambda {|n| @grant_controls = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessGrantControls.create_from_discriminator_value(pn) }) },
                "modifiedDateTime" => lambda {|n| @modified_date_time = n.get_date_time_value() },
                "sessionControls" => lambda {|n| @session_controls = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessSessionControls.create_from_discriminator_value(pn) }) },
                "state" => lambda {|n| @state = n.get_enum_value(MicrosoftGraphBeta::Models::ConditionalAccessPolicyState) },
            })
        end
        ## 
