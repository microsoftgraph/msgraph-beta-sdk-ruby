    ...
    class DlpNotification
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    when "#microsoft.graph.dlpWindowsDevicesNotification"
                        return DlpWindowsDevicesNotification.new
                end
            end
            return DlpNotification.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                "author" => lambda {|n| @author = n.get_string_value() },
        ...
        def serialize(writer)
            ...
            writer.write_string_value("author", @author)
