...
module MicrosoftGraphBeta::Models
    ...
    class PrintTaskDefinition < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "createdBy" => lambda {|n| @created_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AppIdentity.create_from_discriminator_value(pn) }) },
