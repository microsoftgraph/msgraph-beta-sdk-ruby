...
module MicrosoftGraphBeta::Models
    ...
    class AndroidDeviceOwnerGlobalProxy
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    when "#microsoft.graph.androidDeviceOwnerGlobalProxyAutoConfig"
                        return AndroidDeviceOwnerGlobalProxyAutoConfig.new
                    when "#microsoft.graph.androidDeviceOwnerGlobalProxyDirect"
                        return AndroidDeviceOwnerGlobalProxyDirect.new
                end
            end
            return AndroidDeviceOwnerGlobalProxy.new
        end
        ## 
