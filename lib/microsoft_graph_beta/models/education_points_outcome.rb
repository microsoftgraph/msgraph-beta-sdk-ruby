...
module MicrosoftGraphBeta::Models
    class EducationPointsOutcome < MicrosoftGraphBeta::Models::EducationOutcome
        ...
        def get_field_deserializers()
            return super.merge({
                "points" => lambda {|n| @points = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationAssignmentPointsGrade.create_from_discriminator_value(pn) }) },
                "publishedPoints" => lambda {|n| @published_points = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::EducationAssignmentPointsGrade.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
