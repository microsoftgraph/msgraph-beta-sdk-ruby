    ...
    class VppLicensingType
        ...
        def get_field_deserializers()
            return {
                ...
                "supportDeviceLicensing" => lambda {|n| @support_device_licensing = n.get_boolean_value() },
                ...
                "supportUserLicensing" => lambda {|n| @support_user_licensing = n.get_boolean_value() },
            }
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_boolean_value("supportDeviceLicensing", @support_device_licensing)
            ...
            writer.write_boolean_value("supportUserLicensing", @support_user_licensing)
        ...
        ## @return a boolean
        ## 
        def support_device_licensing
            return @support_device_licensing
        end
        ## 
        ...
        ## @return a void
        ## 
        def support_device_licensing=(value)
            @support_device_licensing = value
        end
        ## 
        ...
        ## @return a boolean
        ## 
        def support_user_licensing
            return @support_user_licensing
        end
        ## 
        ...
        ## @return a void
        ## 
        def support_user_licensing=(value)
            @support_user_licensing = value
        end
    end
end
