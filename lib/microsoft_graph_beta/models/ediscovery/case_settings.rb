...
module MicrosoftGraphBeta::Models::Ediscovery
    class CaseSettings < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "ocr" => lambda {|n| @ocr = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::OcrSettings.create_from_discriminator_value(pn) }) },
                "redundancyDetection" => lambda {|n| @redundancy_detection = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::RedundancyDetectionSettings.create_from_discriminator_value(pn) }) },
                "topicModeling" => lambda {|n| @topic_modeling = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::TopicModelingSettings.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
