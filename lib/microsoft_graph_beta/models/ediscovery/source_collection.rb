...
module MicrosoftGraphBeta::Models::Ediscovery
    class SourceCollection < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "additionalSources" => lambda {|n| @additional_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::DataSource.create_from_discriminator_value(pn) }) },
                "addToReviewSetOperation" => lambda {|n| @add_to_review_set_operation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::AddToReviewSetOperation.create_from_discriminator_value(pn) }) },
                ...
                "custodianSources" => lambda {|n| @custodian_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::DataSource.create_from_discriminator_value(pn) }) },
                "dataSourceScopes" => lambda {|n| @data_source_scopes = n.get_enum_value(MicrosoftGraphBeta::Models::Ediscovery::DataSourceScopes) },
                "description" => lambda {|n| @description = n.get_string_value() },
                "displayName" => lambda {|n| @display_name = n.get_string_value() },
                "lastEstimateStatisticsOperation" => lambda {|n| @last_estimate_statistics_operation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::EstimateStatisticsOperation.create_from_discriminator_value(pn) }) },
                ...
                "noncustodialSources" => lambda {|n| @noncustodial_sources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Ediscovery::NoncustodialDataSource.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
        ## Gets the lastEstimateStatisticsOperation property value. The last estimate operation associated with the sourceCollection.
        ## @return a estimate_statistics_operation
        ## 
