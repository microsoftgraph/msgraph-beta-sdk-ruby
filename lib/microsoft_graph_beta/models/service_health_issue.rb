...
module MicrosoftGraphBeta::Models
    class ServiceHealthIssue < MicrosoftGraphBeta::Models::ServiceAnnouncementBase
        ...
        def get_field_deserializers()
            return super.merge({
                "classification" => lambda {|n| @classification = n.get_enum_value(MicrosoftGraphBeta::Models::ServiceHealthClassificationType) },
                ...
                "origin" => lambda {|n| @origin = n.get_enum_value(MicrosoftGraphBeta::Models::ServiceHealthOrigin) },
                "posts" => lambda {|n| @posts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ServiceHealthIssuePost.create_from_discriminator_value(pn) }) },
                "service" => lambda {|n| @service = n.get_string_value() },
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ServiceHealthStatus) },
            })
        end
        ## 
