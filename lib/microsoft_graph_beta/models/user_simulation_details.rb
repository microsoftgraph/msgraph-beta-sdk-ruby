    ...
    class UserSimulationDetails
        ...
        def get_field_deserializers()
            return {
                ...
                "simulationEvents" => lambda {|n| @simulation_events = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserSimulationEventInfo.create_from_discriminator_value(pn) }) },
                "simulationUser" => lambda {|n| @simulation_user = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AttackSimulationUser.create_from_discriminator_value(pn) }) },
                "trainingEvents" => lambda {|n| @training_events = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserTrainingEventInfo.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
