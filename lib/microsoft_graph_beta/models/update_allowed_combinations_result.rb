    ...
    class UpdateAllowedCombinationsResult
        ...
        def get_field_deserializers()
            return {
                ...
                "currentCombinations" => lambda {|n| @current_combinations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationMethodModes.create_from_discriminator_value(pn) }) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "previousCombinations" => lambda {|n| @previous_combinations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationMethodModes.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
