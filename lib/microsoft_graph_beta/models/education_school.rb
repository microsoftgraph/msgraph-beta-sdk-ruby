...
module MicrosoftGraphBeta::Models
    class EducationSchool < MicrosoftGraphBeta::Models::EducationOrganization
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "administrativeUnit" => lambda {|n| @administrative_unit = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AdministrativeUnit.create_from_discriminator_value(pn) }) },
