...
module MicrosoftGraphBeta::Models
    class Attendee < MicrosoftGraphBeta::Models::AttendeeBase
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "status" => lambda {|n| @status = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ResponseStatus.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
