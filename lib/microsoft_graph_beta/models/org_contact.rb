...
module MicrosoftGraphBeta::Models
    ...
    class OrgContact < MicrosoftGraphBeta::Models::DirectoryObject
        ...
        def get_field_deserializers()
            return super.merge({
                "addresses" => lambda {|n| @addresses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::PhysicalOfficeAddress.create_from_discriminator_value(pn) }) },
