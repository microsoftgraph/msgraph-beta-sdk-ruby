    ...
    class SubjectRightsRequestDetail
        ...
        def get_field_deserializers()
            return {
                ...
                "insightCounts" => lambda {|n| @insight_counts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::KeyValuePair.create_from_discriminator_value(pn) }) },
                ...
                "productItemCounts" => lambda {|n| @product_item_counts = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::KeyValuePair.create_from_discriminator_value(pn) }) },
