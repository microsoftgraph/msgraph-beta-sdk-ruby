...
module MicrosoftGraphBeta::Models
    class ServiceUpdateMessage < MicrosoftGraphBeta::Models::ServiceAnnouncementBase
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "attachments" => lambda {|n| @attachments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ServiceAnnouncementAttachment.create_from_discriminator_value(pn) }) },
                ...
                "category" => lambda {|n| @category = n.get_enum_value(MicrosoftGraphBeta::Models::ServiceUpdateCategory) },
                ...
                "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraphBeta::Models::ServiceUpdateSeverity) },
                "tags" => lambda {|n| @tags = n.get_collection_of_primitive_values(String) },
                "viewPoint" => lambda {|n| @view_point = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ServiceUpdateMessageViewpoint.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
