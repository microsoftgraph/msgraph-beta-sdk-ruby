...
module MicrosoftGraphBeta::Models
    ...
    class OnenoteSection < MicrosoftGraphBeta::Models::OnenoteEntityHierarchyModel
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "links" => lambda {|n| @links = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SectionLinks.create_from_discriminator_value(pn) }) },
