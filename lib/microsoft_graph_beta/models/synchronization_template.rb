...
module MicrosoftGraphBeta::Models
    class SynchronizationTemplate < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "metadata" => lambda {|n| @metadata = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MetadataEntry.create_from_discriminator_value(pn) }) },
