...
module MicrosoftGraphBeta::Models
    class MessageRule < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "actions" => lambda {|n| @actions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MessageRuleActions.create_from_discriminator_value(pn) }) },
                "conditions" => lambda {|n| @conditions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MessageRulePredicates.create_from_discriminator_value(pn) }) },
                "displayName" => lambda {|n| @display_name = n.get_string_value() },
                "exceptions" => lambda {|n| @exceptions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MessageRulePredicates.create_from_discriminator_value(pn) }) },
