...
module MicrosoftGraphBeta::Models
    ...
    class BookingService < MicrosoftGraphBeta::Models::BookingNamedEntity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "defaultPriceType" => lambda {|n| @default_price_type = n.get_enum_value(MicrosoftGraphBeta::Models::BookingPriceType) },
                "defaultReminders" => lambda {|n| @default_reminders = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingReminder.create_from_discriminator_value(pn) }) },
                ...
                "schedulingPolicy" => lambda {|n| @scheduling_policy = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::BookingSchedulingPolicy.create_from_discriminator_value(pn) }) },
