...
module MicrosoftGraphBeta::Models
    class GovernanceRuleSetting
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            return GovernanceRuleSetting.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                ...
                "ruleIdentifier" => lambda {|n| @rule_identifier = n.get_string_value() },
        ...
        def serialize(writer)
            ...
            writer.write_string_value("ruleIdentifier", @rule_identifier)
