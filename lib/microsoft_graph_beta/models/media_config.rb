    ...
    class MediaConfig
        ...
        def get_field_deserializers()
            return {
                ...
                "removeFromDefaultAudioGroup" => lambda {|n| @remove_from_default_audio_group = n.get_boolean_value() },
            }
        end
        ## 
        ...
        ## @return a void
        ## 
        def remove_from_default_audio_group=(value)
            @remove_from_default_audio_group = value
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_boolean_value("removeFromDefaultAudioGroup", @remove_from_default_audio_group)
