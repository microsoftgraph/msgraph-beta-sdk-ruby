    ...
    class IosNetworkUsageRule
        ...
        def get_field_deserializers()
            return {
                ...
                "managedApps" => lambda {|n| @managed_apps = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AppListItem.create_from_discriminator_value(pn) }) },
