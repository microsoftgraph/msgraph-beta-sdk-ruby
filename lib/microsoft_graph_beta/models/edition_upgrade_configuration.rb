...
module MicrosoftGraphBeta::Models
    class EditionUpgradeConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "licenseType" => lambda {|n| @license_type = n.get_enum_value(MicrosoftGraphBeta::Models::EditionUpgradeLicenseType) },
                "productKey" => lambda {|n| @product_key = n.get_string_value() },
                "targetEdition" => lambda {|n| @target_edition = n.get_enum_value(MicrosoftGraphBeta::Models::Windows10EditionType) },
                "windowsSMode" => lambda {|n| @windows_s_mode = n.get_enum_value(MicrosoftGraphBeta::Models::WindowsSModeConfiguration) },
            })
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_enum_value("windowsSMode", @windows_s_mode)
        end
        ## 
        ...
        ## @return a windows_s_mode_configuration
        ## 
        def windows_s_mode
            return @windows_s_mode
        end
        ## 
        ...
        ## @return a void
        ## 
        def windows_s_mode=(value)
            @windows_s_mode = value
        end
    end
end
