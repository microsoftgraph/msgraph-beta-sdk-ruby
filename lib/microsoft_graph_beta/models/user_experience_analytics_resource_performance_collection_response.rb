...
module MicrosoftGraphBeta::Models
    class UserExperienceAnalyticsResourcePerformanceCollectionResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
        ...
        ## @return a user_experience_analytics_resource_performance_collection_response
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return UserExperienceAnalyticsResourcePerformanceCollectionResponse.new
        end
        ## 
