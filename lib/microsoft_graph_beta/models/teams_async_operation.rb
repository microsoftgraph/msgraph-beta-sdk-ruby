...
module MicrosoftGraphBeta::Models
    class TeamsAsyncOperation < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "operationType" => lambda {|n| @operation_type = n.get_enum_value(MicrosoftGraphBeta::Models::TeamsAsyncOperationType) },
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::TeamsAsyncOperationStatus) },
