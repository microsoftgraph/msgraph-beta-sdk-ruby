...
module MicrosoftGraphBeta::Models
    ...
    class DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate
        ...
        ## @return a device_management_configuration_option_definition_template
        ## 
        def allowed_options
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            return DeviceManagementConfigurationChoiceSettingValueDefinitionTemplate.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                "allowedOptions" => lambda {|n| @allowed_options = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceManagementConfigurationOptionDefinitionTemplate.create_from_discriminator_value(pn) }) },
        ...
        def serialize(writer)
            ...
            writer.write_collection_of_object_values("allowedOptions", @allowed_options)
