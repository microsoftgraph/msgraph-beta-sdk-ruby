...
module MicrosoftGraphBeta::Models
    ...
    class DeviceManagementExchangeConnector < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "exchangeConnectorType" => lambda {|n| @exchange_connector_type = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceManagementExchangeConnectorType) },
                ...
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceManagementExchangeConnectorStatus) },
