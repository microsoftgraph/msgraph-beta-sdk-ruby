...
module MicrosoftGraphBeta::Models
    class Notebook < MicrosoftGraphBeta::Models::OnenoteEntityHierarchyModel
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "links" => lambda {|n| @links = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::NotebookLinks.create_from_discriminator_value(pn) }) },
                ...
                "userRole" => lambda {|n| @user_role = n.get_enum_value(MicrosoftGraphBeta::Models::OnenoteUserRole) },
            })
        end
        ## 
