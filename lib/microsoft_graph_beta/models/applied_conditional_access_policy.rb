    ...
    class AppliedConditionalAccessPolicy
        ...
        def get_field_deserializers()
            return {
                ...
                "conditionsNotSatisfied" => lambda {|n| @conditions_not_satisfied = n.get_enum_value(MicrosoftGraphBeta::Models::ConditionalAccessConditions) },
                "conditionsSatisfied" => lambda {|n| @conditions_satisfied = n.get_enum_value(MicrosoftGraphBeta::Models::ConditionalAccessConditions) },
        ...
        def serialize(writer)
            ...
            writer.write_enum_value("conditionsNotSatisfied", @conditions_not_satisfied)
            writer.write_enum_value("conditionsSatisfied", @conditions_satisfied)
