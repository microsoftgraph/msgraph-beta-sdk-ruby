...
module MicrosoftGraphBeta::Models
    class CalendarSharingMessageAction
        ...
        def get_field_deserializers()
            return {
                "action" => lambda {|n| @action = n.get_enum_value(MicrosoftGraphBeta::Models::CalendarSharingAction) },
                "actionType" => lambda {|n| @action_type = n.get_enum_value(MicrosoftGraphBeta::Models::CalendarSharingActionType) },
                "importance" => lambda {|n| @importance = n.get_enum_value(MicrosoftGraphBeta::Models::CalendarSharingActionImportance) },
