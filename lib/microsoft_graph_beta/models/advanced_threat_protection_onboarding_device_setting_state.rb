...
module MicrosoftGraphBeta::Models
    ...
    class AdvancedThreatProtectionOnboardingDeviceSettingState < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "platformType" => lambda {|n| @platform_type = n.get_enum_value(MicrosoftGraphBeta::Models::DeviceType) },
