...
module MicrosoftGraphBeta::Models
    class MediaContentRatingIreland
        ...
        def get_field_deserializers()
            return {
                "movieRating" => lambda {|n| @movie_rating = n.get_enum_value(MicrosoftGraphBeta::Models::RatingIrelandMoviesType) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "tvRating" => lambda {|n| @tv_rating = n.get_enum_value(MicrosoftGraphBeta::Models::RatingIrelandTelevisionType) },
            }
        end
        ## 
