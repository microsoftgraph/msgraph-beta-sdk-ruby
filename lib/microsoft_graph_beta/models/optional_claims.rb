...
module MicrosoftGraphBeta::Models
    class OptionalClaims
        ...
        def get_field_deserializers()
            return {
                "accessToken" => lambda {|n| @access_token = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OptionalClaim.create_from_discriminator_value(pn) }) },
                "idToken" => lambda {|n| @id_token = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OptionalClaim.create_from_discriminator_value(pn) }) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "saml2Token" => lambda {|n| @saml2_token = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::OptionalClaim.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
