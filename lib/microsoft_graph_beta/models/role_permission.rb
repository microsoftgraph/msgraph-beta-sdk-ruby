    ...
    class RolePermission
        ...
        def get_field_deserializers()
            return {
                ...
                "resourceActions" => lambda {|n| @resource_actions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ResourceAction.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
