    ...
    class ConditionalAccessUsers
        ...
        def get_field_deserializers()
            return {
                ...
                "excludeGuestsOrExternalUsers" => lambda {|n| @exclude_guests_or_external_users = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessGuestsOrExternalUsers.create_from_discriminator_value(pn) }) },
                ...
                "includeGuestsOrExternalUsers" => lambda {|n| @include_guests_or_external_users = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessGuestsOrExternalUsers.create_from_discriminator_value(pn) }) },
