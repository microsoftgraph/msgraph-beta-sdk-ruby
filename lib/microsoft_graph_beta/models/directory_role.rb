...
module MicrosoftGraphBeta::Models
    class DirectoryRole < MicrosoftGraphBeta::Models::DirectoryObject
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "scopedMembers" => lambda {|n| @scoped_members = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ScopedRoleMembership.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
