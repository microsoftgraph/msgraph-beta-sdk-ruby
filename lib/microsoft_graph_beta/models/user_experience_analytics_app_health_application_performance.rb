...
module MicrosoftGraphBeta::Models
    ...
    class UserExperienceAnalyticsAppHealthApplicationPerformance < MicrosoftGraphBeta::Models::Entity
        ...
        ## @return a void
        ## 
        def app_health_status=(value)
            @app_health_status = value
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "appHealthStatus" => lambda {|n| @app_health_status = n.get_string_value() },
        ...
        def serialize(writer)
            ...
            writer.write_string_value("appHealthStatus", @app_health_status)
