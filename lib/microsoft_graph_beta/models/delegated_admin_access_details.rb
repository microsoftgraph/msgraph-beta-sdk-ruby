    ...
    class DelegatedAdminAccessDetails
        ...
        def get_field_deserializers()
            return {
                ...
                "unifiedRoles" => lambda {|n| @unified_roles = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRole.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
