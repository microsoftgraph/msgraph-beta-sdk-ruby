...
module MicrosoftGraphBeta::Models
    class EdgeSearchEngine < MicrosoftGraphBeta::Models::EdgeSearchEngineBase
        ...
        def get_field_deserializers()
            return super.merge({
                "edgeSearchEngineType" => lambda {|n| @edge_search_engine_type = n.get_enum_value(MicrosoftGraphBeta::Models::EdgeSearchEngineType) },
            })
        end
        ## 
