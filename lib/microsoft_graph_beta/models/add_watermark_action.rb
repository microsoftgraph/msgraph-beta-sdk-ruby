...
module MicrosoftGraphBeta::Models
    class AddWatermarkAction < MicrosoftGraphBeta::Models::InformationProtectionAction
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "layout" => lambda {|n| @layout = n.get_enum_value(MicrosoftGraphBeta::Models::WatermarkLayout) },
