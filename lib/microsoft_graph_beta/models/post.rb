...
module MicrosoftGraphBeta::Models
    class Post < MicrosoftGraphBeta::Models::OutlookItem
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "newParticipants" => lambda {|n| @new_participants = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Recipient.create_from_discriminator_value(pn) }) },
