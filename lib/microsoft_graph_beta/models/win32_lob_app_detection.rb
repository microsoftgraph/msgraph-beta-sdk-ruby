    ...
    class Win32LobAppDetection
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    when "#microsoft.graph.win32LobAppFileSystemDetection"
                        return Win32LobAppFileSystemDetection.new
                    when "#microsoft.graph.win32LobAppPowerShellScriptDetection"
                        return Win32LobAppPowerShellScriptDetection.new
                    when "#microsoft.graph.win32LobAppProductCodeDetection"
                        return Win32LobAppProductCodeDetection.new
                    when "#microsoft.graph.win32LobAppRegistryDetection"
                        return Win32LobAppRegistryDetection.new
                end
            end
            return Win32LobAppDetection.new
        end
        ## 
