...
module MicrosoftGraphBeta::Models
    class EducationRubricOutcome < MicrosoftGraphBeta::Models::EducationOutcome
        ...
        def get_field_deserializers()
            return super.merge({
                "publishedRubricQualityFeedback" => lambda {|n| @published_rubric_quality_feedback = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RubricQualityFeedbackModel.create_from_discriminator_value(pn) }) },
                "publishedRubricQualitySelectedLevels" => lambda {|n| @published_rubric_quality_selected_levels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RubricQualitySelectedColumnModel.create_from_discriminator_value(pn) }) },
                "rubricQualityFeedback" => lambda {|n| @rubric_quality_feedback = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RubricQualityFeedbackModel.create_from_discriminator_value(pn) }) },
                "rubricQualitySelectedLevels" => lambda {|n| @rubric_quality_selected_levels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RubricQualitySelectedColumnModel.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
