...
module MicrosoftGraphBeta::Models
    class AgreementFileProperties < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "fileData" => lambda {|n| @file_data = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AgreementFileData.create_from_discriminator_value(pn) }) },
