    ...
    class ActivitySettings
        ...
        def get_field_deserializers()
            return {
                ...
                "urlToItemResolvers" => lambda {|n| @url_to_item_resolvers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::UrlToItemResolverBase.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
