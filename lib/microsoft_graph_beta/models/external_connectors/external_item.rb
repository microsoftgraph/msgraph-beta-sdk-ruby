...
module MicrosoftGraphBeta::Models::ExternalConnectors
    class ExternalItem < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "acl" => lambda {|n| @acl = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::Acl.create_from_discriminator_value(pn) }) },
                "activities" => lambda {|n| @activities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::ExternalActivity.create_from_discriminator_value(pn) }) },
                "content" => lambda {|n| @content = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::ExternalItemContent.create_from_discriminator_value(pn) }) },
                "properties" => lambda {|n| @properties = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::Properties.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
