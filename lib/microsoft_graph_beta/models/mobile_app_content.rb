...
module MicrosoftGraphBeta::Models
    ...
    class MobileAppContent < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "files" => lambda {|n| @files = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MobileAppContentFile.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
