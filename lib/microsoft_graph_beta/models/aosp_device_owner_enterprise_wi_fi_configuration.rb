...
module MicrosoftGraphBeta::Models
    class AospDeviceOwnerEnterpriseWiFiConfiguration < MicrosoftGraphBeta::Models::AospDeviceOwnerWiFiConfiguration
        ...
        ## @return a aosp_device_owner_enterprise_wi_fi_configuration
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "identityCertificateForClientAuthentication" => lambda {|n| @identity_certificate_for_client_authentication = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AospDeviceOwnerCertificateProfileBase.create_from_discriminator_value(pn) }) },
                ...
                "rootCertificateForServerValidation" => lambda {|n| @root_certificate_for_server_validation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AospDeviceOwnerTrustedRootCertificate.create_from_discriminator_value(pn) }) },
