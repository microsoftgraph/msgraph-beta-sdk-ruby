...
module MicrosoftGraphBeta::Models
    class BroadcastMeetingSettings
        ...
        def get_field_deserializers()
            return {
                "allowedAudience" => lambda {|n| @allowed_audience = n.get_enum_value(MicrosoftGraphBeta::Models::BroadcastMeetingAudience) },
                "captions" => lambda {|n| @captions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::BroadcastMeetingCaptionSettings.create_from_discriminator_value(pn) }) },
