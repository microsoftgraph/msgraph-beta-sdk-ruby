...
module MicrosoftGraphBeta::Models
    class EventMessage < MicrosoftGraphBeta::Models::Message
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "event" => lambda {|n| @event = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Event.create_from_discriminator_value(pn) }) },
                ...
                "meetingMessageType" => lambda {|n| @meeting_message_type = n.get_enum_value(MicrosoftGraphBeta::Models::MeetingMessageType) },
                ...
                "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraphBeta::Models::EventType) },
            })
        end
        ## 
