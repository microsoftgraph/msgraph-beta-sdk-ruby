    ...
    class ContentInfo
        ...
        def get_field_deserializers()
            return {
                ...
                "metadata" => lambda {|n| @metadata = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Security::KeyValuePair.create_from_discriminator_value(pn) }) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "state" => lambda {|n| @state = n.get_enum_value(MicrosoftGraphBeta::Models::Security::ContentState) },
            }
        end
        ## 
