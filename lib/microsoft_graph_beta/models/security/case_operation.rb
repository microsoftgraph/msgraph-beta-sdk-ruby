...
module MicrosoftGraphBeta::Models::Security
    class CaseOperation < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "action" => lambda {|n| @action = n.get_enum_value(MicrosoftGraphBeta::Models::Security::CaseAction) },
                ...
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::Security::CaseOperationStatus) },
            })
        end
        ## 
