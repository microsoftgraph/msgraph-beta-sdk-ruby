...
module MicrosoftGraphBeta::Models::Security
    class FileEvidence < MicrosoftGraphBeta::Models::Security::AlertEvidence
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "fileDetails" => lambda {|n| @file_details = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::FileDetails.create_from_discriminator_value(pn) }) },
