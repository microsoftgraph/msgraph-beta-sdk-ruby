...
module MicrosoftGraphBeta::Models::Security
    class AnalyzedMessageEvidence < MicrosoftGraphBeta::Models::Security::AlertEvidence
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "p1Sender" => lambda {|n| @p1_sender = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::EmailSender.create_from_discriminator_value(pn) }) },
                "p2Sender" => lambda {|n| @p2_sender = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::EmailSender.create_from_discriminator_value(pn) }) },
