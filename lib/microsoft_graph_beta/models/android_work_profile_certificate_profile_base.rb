...
module MicrosoftGraphBeta::Models
    class AndroidWorkProfileCertificateProfileBase < MicrosoftGraphBeta::Models::DeviceConfiguration
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "rootCertificate" => lambda {|n| @root_certificate = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AndroidWorkProfileTrustedRootCertificate.create_from_discriminator_value(pn) }) },
