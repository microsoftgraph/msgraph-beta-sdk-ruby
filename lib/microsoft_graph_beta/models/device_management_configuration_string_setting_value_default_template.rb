...
module MicrosoftGraphBeta::Models
    ...
    class DeviceManagementConfigurationStringSettingValueDefaultTemplate
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    when "#microsoft.graph.deviceManagementConfigurationStringSettingValueConstantDefaultTemplate"
                        return DeviceManagementConfigurationStringSettingValueConstantDefaultTemplate.new
                end
            end
            return DeviceManagementConfigurationStringSettingValueDefaultTemplate.new
        end
        ## 
