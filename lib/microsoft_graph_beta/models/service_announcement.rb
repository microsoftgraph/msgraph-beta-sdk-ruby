...
module MicrosoftGraphBeta::Models
    class ServiceAnnouncement < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "healthOverviews" => lambda {|n| @health_overviews = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ServiceHealth.create_from_discriminator_value(pn) }) },
                "issues" => lambda {|n| @issues = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ServiceHealthIssue.create_from_discriminator_value(pn) }) },
                "messages" => lambda {|n| @messages = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ServiceUpdateMessage.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
