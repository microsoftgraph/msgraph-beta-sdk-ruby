...
module MicrosoftGraphBeta::Models
    class InternetExplorerMode < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "siteLists" => lambda {|n| @site_lists = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BrowserSiteList.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
