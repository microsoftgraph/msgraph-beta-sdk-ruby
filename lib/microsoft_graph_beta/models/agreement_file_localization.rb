...
module MicrosoftGraphBeta::Models
    ...
    class AgreementFileLocalization < MicrosoftGraphBeta::Models::AgreementFileProperties
        ...
        def get_field_deserializers()
            return super.merge({
                "versions" => lambda {|n| @versions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AgreementFileVersion.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
