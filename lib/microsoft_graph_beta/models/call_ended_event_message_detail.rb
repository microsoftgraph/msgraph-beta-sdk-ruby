...
module MicrosoftGraphBeta::Models
    class CallEndedEventMessageDetail < MicrosoftGraphBeta::Models::EventMessageDetail
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "callEventType" => lambda {|n| @call_event_type = n.get_enum_value(MicrosoftGraphBeta::Models::TeamworkCallEventType) },
                "callId" => lambda {|n| @call_id = n.get_string_value() },
                "callParticipants" => lambda {|n| @call_participants = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallParticipantInfo.create_from_discriminator_value(pn) }) },
