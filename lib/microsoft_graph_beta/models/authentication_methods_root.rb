...
module MicrosoftGraphBeta::Models
    class AuthenticationMethodsRoot < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "userRegistrationDetails" => lambda {|n| @user_registration_details = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserRegistrationDetails.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
