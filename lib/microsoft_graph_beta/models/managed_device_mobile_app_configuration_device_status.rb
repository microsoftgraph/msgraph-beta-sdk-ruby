...
module MicrosoftGraphBeta::Models
    ...
    class ManagedDeviceMobileAppConfigurationDeviceStatus < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "platform" => lambda {|n| @platform = n.get_number_value() },
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ComplianceStatus) },
        ...
        def serialize(writer)
            ...
            writer.write_number_value("platform", @platform)
