    ...
    class Reminder
        ...
        def get_field_deserializers()
            return {
                ...
                "eventEndTime" => lambda {|n| @event_end_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
                "eventId" => lambda {|n| @event_id = n.get_string_value() },
                "eventLocation" => lambda {|n| @event_location = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Location.create_from_discriminator_value(pn) }) },
                "eventStartTime" => lambda {|n| @event_start_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
                "eventSubject" => lambda {|n| @event_subject = n.get_string_value() },
                "eventWebLink" => lambda {|n| @event_web_link = n.get_string_value() },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "reminderFireTime" => lambda {|n| @reminder_fire_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
