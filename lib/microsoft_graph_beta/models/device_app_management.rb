    ...
    class DeviceAppManagement < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "sideLoadingKeys" => lambda {|n| @side_loading_keys = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SideLoadingKey.create_from_discriminator_value(pn) }) },
        ...
        def serialize(writer)
            ...
            writer.write_collection_of_object_values("sideLoadingKeys", @side_loading_keys)
        ...
        ## @return a void
        ## 
        def side_loading_keys=(value)
            @side_loading_keys = value
        end
        ## 
