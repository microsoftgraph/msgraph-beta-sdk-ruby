    ...
    class SearchAlteration
        ...
        def get_field_deserializers()
            return {
                ...
                "alteredQueryTokens" => lambda {|n| @altered_query_tokens = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AlteredQueryToken.create_from_discriminator_value(pn) }) },
