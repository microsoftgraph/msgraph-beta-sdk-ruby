...
module MicrosoftGraphBeta::Models
    ...
    class Alert < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "alertDetections" => lambda {|n| @alert_detections = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AlertDetection.create_from_discriminator_value(pn) }) },
                ...
                "cloudAppStates" => lambda {|n| @cloud_app_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CloudAppSecurityState.create_from_discriminator_value(pn) }) },
                ...
                "fileStates" => lambda {|n| @file_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::FileSecurityState.create_from_discriminator_value(pn) }) },
                "historyStates" => lambda {|n| @history_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AlertHistoryState.create_from_discriminator_value(pn) }) },
                "hostStates" => lambda {|n| @host_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::HostSecurityState.create_from_discriminator_value(pn) }) },
                "incidentIds" => lambda {|n| @incident_ids = n.get_collection_of_primitive_values(String) },
                "investigationSecurityStates" => lambda {|n| @investigation_security_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::InvestigationSecurityState.create_from_discriminator_value(pn) }) },
                ...
                "messageSecurityStates" => lambda {|n| @message_security_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MessageSecurityState.create_from_discriminator_value(pn) }) },
                "networkConnections" => lambda {|n| @network_connections = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::NetworkConnection.create_from_discriminator_value(pn) }) },
                "processes" => lambda {|n| @processes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Process.create_from_discriminator_value(pn) }) },
                "recommendedActions" => lambda {|n| @recommended_actions = n.get_collection_of_primitive_values(String) },
                "registryKeyStates" => lambda {|n| @registry_key_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RegistryKeyState.create_from_discriminator_value(pn) }) },
                "securityResources" => lambda {|n| @security_resources = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SecurityResource.create_from_discriminator_value(pn) }) },
                "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraphBeta::Models::AlertSeverity) },
                ...
                "triggers" => lambda {|n| @triggers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AlertTrigger.create_from_discriminator_value(pn) }) },
                "uriClickSecurityStates" => lambda {|n| @uri_click_security_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UriClickSecurityState.create_from_discriminator_value(pn) }) },
                "userStates" => lambda {|n| @user_states = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserSecurityState.create_from_discriminator_value(pn) }) },
