...
module MicrosoftGraphBeta::Models
    class EducationSynchronizationDataProvider
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    when "#microsoft.graph.educationCsvDataProvider"
                        return EducationCsvDataProvider.new
                    when "#microsoft.graph.educationOneRosterApiDataProvider"
                        return EducationOneRosterApiDataProvider.new
                    when "#microsoft.graph.educationPowerSchoolDataProvider"
                        return EducationPowerSchoolDataProvider.new
                end
            end
            return EducationSynchronizationDataProvider.new
        end
        ## 
