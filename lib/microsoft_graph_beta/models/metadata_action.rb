...
module MicrosoftGraphBeta::Models
    class MetadataAction < MicrosoftGraphBeta::Models::InformationProtectionAction
        ...
        def get_field_deserializers()
            return super.merge({
                "metadataToAdd" => lambda {|n| @metadata_to_add = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::KeyValuePair.create_from_discriminator_value(pn) }) },
