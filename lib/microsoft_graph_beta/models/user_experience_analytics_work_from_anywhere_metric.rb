...
module MicrosoftGraphBeta::Models
    ...
    class UserExperienceAnalyticsWorkFromAnywhereMetric < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "metricDevices" => lambda {|n| @metric_devices = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserExperienceAnalyticsWorkFromAnywhereDevice.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
