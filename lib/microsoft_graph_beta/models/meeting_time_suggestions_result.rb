    ...
    class MeetingTimeSuggestionsResult
        ...
        def get_field_deserializers()
            return {
                ...
                "meetingTimeSuggestions" => lambda {|n| @meeting_time_suggestions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MeetingTimeSuggestion.create_from_discriminator_value(pn) }) },
