...
module MicrosoftGraphBeta::Models
    ...
    class MicrosoftTunnelSite < MicrosoftGraphBeta::Models::Entity
        ...
        ## @return a boolean
        ## 
        def enable_certificate_pinning
            return @enable_certificate_pinning
        end
        ## 
        ...
        ## @return a void
        ## 
        def enable_certificate_pinning=(value)
            @enable_certificate_pinning = value
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "enableCertificatePinning" => lambda {|n| @enable_certificate_pinning = n.get_boolean_value() },
        ...
        def serialize(writer)
            ...
            writer.write_boolean_value("enableCertificatePinning", @enable_certificate_pinning)
