...
module MicrosoftGraphBeta::Models
    ...
    class DeviceComplianceScheduledActionForRule < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "scheduledActionConfigurations" => lambda {|n| @scheduled_action_configurations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DeviceComplianceActionItem.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
