...
module MicrosoftGraphBeta::Models::WindowsUpdates
    class FeatureUpdateReference < MicrosoftGraphBeta::Models::WindowsUpdates::WindowsUpdateReference
        ...
        def initialize()
            super
            @odata_type = "#microsoft.graph.windowsUpdates.featureUpdateReference"
        end
        ## 
        ## Creates a new instance of the appropriate class based on discriminator value
        ## @param parseNode The parse node to use to read the discriminator value and create the object
        ## @return a feature_update_reference
        ## 
