...
module MicrosoftGraphBeta::Models
    class SynchronizationStatus
        ...
        def get_field_deserializers()
            return {
                "code" => lambda {|n| @code = n.get_enum_value(MicrosoftGraphBeta::Models::SynchronizationStatusCode) },
                ...
                "lastExecution" => lambda {|n| @last_execution = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationTaskExecution.create_from_discriminator_value(pn) }) },
                "lastSuccessfulExecution" => lambda {|n| @last_successful_execution = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationTaskExecution.create_from_discriminator_value(pn) }) },
                "lastSuccessfulExecutionWithExports" => lambda {|n| @last_successful_execution_with_exports = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationTaskExecution.create_from_discriminator_value(pn) }) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "progress" => lambda {|n| @progress = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationProgress.create_from_discriminator_value(pn) }) },
                "quarantine" => lambda {|n| @quarantine = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationQuarantine.create_from_discriminator_value(pn) }) },
                ...
                "synchronizedEntryCountByType" => lambda {|n| @synchronized_entry_count_by_type = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::StringKeyLongValuePair.create_from_discriminator_value(pn) }) },
