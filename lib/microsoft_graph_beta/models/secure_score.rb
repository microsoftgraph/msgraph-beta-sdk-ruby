...
module MicrosoftGraphBeta::Models
    ...
    class SecureScore < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "averageComparativeScores" => lambda {|n| @average_comparative_scores = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AverageComparativeScore.create_from_discriminator_value(pn) }) },
                "azureTenantId" => lambda {|n| @azure_tenant_id = n.get_string_value() },
                "controlScores" => lambda {|n| @control_scores = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ControlScore.create_from_discriminator_value(pn) }) },
