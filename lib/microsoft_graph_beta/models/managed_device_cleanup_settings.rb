...
module MicrosoftGraphBeta::Models
    ...
    class ManagedDeviceCleanupSettings
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            return ManagedDeviceCleanupSettings.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                "deviceInactivityBeforeRetirementInDays" => lambda {|n| @device_inactivity_before_retirement_in_days = n.get_string_value() },
        ...
        def serialize(writer)
            ...
            writer.write_string_value("deviceInactivityBeforeRetirementInDays", @device_inactivity_before_retirement_in_days)
