    ...
    class SynchronizationTaskExecution
        ...
        def get_field_deserializers()
            return {
                ...
                "error" => lambda {|n| @error = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationError.create_from_discriminator_value(pn) }) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "state" => lambda {|n| @state = n.get_enum_value(MicrosoftGraphBeta::Models::SynchronizationTaskExecutionResult) },
