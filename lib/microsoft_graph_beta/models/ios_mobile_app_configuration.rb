...
module MicrosoftGraphBeta::Models
    class IosMobileAppConfiguration < MicrosoftGraphBeta::Models::ManagedDeviceMobileAppConfiguration
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "settings" => lambda {|n| @settings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AppConfigurationSettingItem.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
