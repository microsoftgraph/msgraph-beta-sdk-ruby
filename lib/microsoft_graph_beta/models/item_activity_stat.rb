...
module MicrosoftGraphBeta::Models
    class ItemActivityStat < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "access" => lambda {|n| @access = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemActionStat.create_from_discriminator_value(pn) }) },
                "activities" => lambda {|n| @activities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ItemActivity.create_from_discriminator_value(pn) }) },
                "create" => lambda {|n| @create = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemActionStat.create_from_discriminator_value(pn) }) },
                "delete" => lambda {|n| @delete = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemActionStat.create_from_discriminator_value(pn) }) },
                "edit" => lambda {|n| @edit = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemActionStat.create_from_discriminator_value(pn) }) },
                "endDateTime" => lambda {|n| @end_date_time = n.get_date_time_value() },
                "incompleteData" => lambda {|n| @incomplete_data = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IncompleteData.create_from_discriminator_value(pn) }) },
                "isTrending" => lambda {|n| @is_trending = n.get_boolean_value() },
                "move" => lambda {|n| @move = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemActionStat.create_from_discriminator_value(pn) }) },
