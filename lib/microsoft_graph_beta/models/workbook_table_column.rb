...
module MicrosoftGraphBeta::Models
    ...
    class WorkbookTableColumn < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "filter" => lambda {|n| @filter = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookFilter.create_from_discriminator_value(pn) }) },
