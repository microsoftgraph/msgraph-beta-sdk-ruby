...
module MicrosoftGraphBeta::Models
    class UserTeamwork < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "associatedTeams" => lambda {|n| @associated_teams = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AssociatedTeamInfo.create_from_discriminator_value(pn) }) },
                "installedApps" => lambda {|n| @installed_apps = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserScopeTeamsAppInstallation.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
