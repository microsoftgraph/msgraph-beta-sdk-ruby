...
module MicrosoftGraphBeta::Models::IdentityGovernance
    class CustomTaskExtensionCallbackData < MicrosoftGraphBeta::Models::CustomExtensionData
        ...
        def get_field_deserializers()
            return super.merge({
                "operationStatus" => lambda {|n| @operation_status = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityGovernance::CustomTaskExtensionOperationStatus) },
            })
        end
        ## 
