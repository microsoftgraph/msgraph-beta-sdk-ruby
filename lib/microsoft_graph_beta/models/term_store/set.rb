...
module MicrosoftGraphBeta::Models::TermStore
    class Set < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "children" => lambda {|n| @children = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Term.create_from_discriminator_value(pn) }) },
                "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                "description" => lambda {|n| @description = n.get_string_value() },
                "localizedNames" => lambda {|n| @localized_names = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::LocalizedName.create_from_discriminator_value(pn) }) },
                "parentGroup" => lambda {|n| @parent_group = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Group.create_from_discriminator_value(pn) }) },
                "properties" => lambda {|n| @properties = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::KeyValue.create_from_discriminator_value(pn) }) },
                "relations" => lambda {|n| @relations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Relation.create_from_discriminator_value(pn) }) },
                "terms" => lambda {|n| @terms = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TermStore::Term.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
