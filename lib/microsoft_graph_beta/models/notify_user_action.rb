    ...
    class NotifyUserAction < MicrosoftGraphBeta::Models::DlpActionInfo
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "overrideOption" => lambda {|n| @override_option = n.get_enum_value(MicrosoftGraphBeta::Models::OverrideOption) },
        ...
        def serialize(writer)
            ...
            writer.write_enum_value("overrideOption", @override_option)
