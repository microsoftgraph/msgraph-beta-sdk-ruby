    ...
    class IdentityProtectionRoot
        ...
        def get_field_deserializers()
            return {
                ...
                "riskDetections" => lambda {|n| @risk_detections = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RiskDetection.create_from_discriminator_value(pn) }) },
                "riskyServicePrincipals" => lambda {|n| @risky_service_principals = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RiskyServicePrincipal.create_from_discriminator_value(pn) }) },
                "riskyUsers" => lambda {|n| @risky_users = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::RiskyUser.create_from_discriminator_value(pn) }) },
                "servicePrincipalRiskDetections" => lambda {|n| @service_principal_risk_detections = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ServicePrincipalRiskDetection.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
