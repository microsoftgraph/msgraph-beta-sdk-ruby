...
module MicrosoftGraphBeta::Models
    class DocumentSet
        ...
        def get_field_deserializers()
            return {
                "allowedContentTypes" => lambda {|n| @allowed_content_types = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ContentTypeInfo.create_from_discriminator_value(pn) }) },
                "defaultContents" => lambda {|n| @default_contents = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::DocumentSetContent.create_from_discriminator_value(pn) }) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "propagateWelcomePageChanges" => lambda {|n| @propagate_welcome_page_changes = n.get_boolean_value() },
                "sharedColumns" => lambda {|n| @shared_columns = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ColumnDefinition.create_from_discriminator_value(pn) }) },
                "shouldPrefixNameToFile" => lambda {|n| @should_prefix_name_to_file = n.get_boolean_value() },
                "welcomePageColumns" => lambda {|n| @welcome_page_columns = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ColumnDefinition.create_from_discriminator_value(pn) }) },
