...
module MicrosoftGraphBeta::Models
    class UnifiedRoleAssignmentScheduleInstance < MicrosoftGraphBeta::Models::UnifiedRoleScheduleInstanceBase
        ...
        def get_field_deserializers()
            return super.merge({
                "activatedUsing" => lambda {|n| @activated_using = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleEligibilityScheduleInstance.create_from_discriminator_value(pn) }) },
