...
module MicrosoftGraphBeta::Models::Search
    ...
    class SearchAnswer < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "lastModifiedBy" => lambda {|n| @last_modified_by = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Search::IdentitySet.create_from_discriminator_value(pn) }) },
