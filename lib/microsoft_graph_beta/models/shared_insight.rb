...
module MicrosoftGraphBeta::Models
    class SharedInsight < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "lastShared" => lambda {|n| @last_shared = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SharingDetail.create_from_discriminator_value(pn) }) },
                "lastSharedMethod" => lambda {|n| @last_shared_method = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Entity.create_from_discriminator_value(pn) }) },
                ...
                "resourceReference" => lambda {|n| @resource_reference = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ResourceReference.create_from_discriminator_value(pn) }) },
                "resourceVisualization" => lambda {|n| @resource_visualization = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ResourceVisualization.create_from_discriminator_value(pn) }) },
                "sharingHistory" => lambda {|n| @sharing_history = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SharingDetail.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
