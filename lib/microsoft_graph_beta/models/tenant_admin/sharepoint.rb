...
module MicrosoftGraphBeta::Models::TenantAdmin
    class Sharepoint < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "settings" => lambda {|n| @settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TenantAdmin::Settings.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
