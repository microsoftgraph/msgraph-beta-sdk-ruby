    ...
    class Channel < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "moderationSettings" => lambda {|n| @moderation_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChannelModerationSettings.create_from_discriminator_value(pn) }) },
                "sharedWithTeams" => lambda {|n| @shared_with_teams = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SharedWithChannelTeamInfo.create_from_discriminator_value(pn) }) },
                "summary" => lambda {|n| @summary = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ChannelSummary.create_from_discriminator_value(pn) }) },
        ...
        ## @return a void
        ## 
        def moderation_settings=(value)
            @moderation_settings = value
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_object_value("moderationSettings", @moderation_settings)
