...
module MicrosoftGraphBeta::Models
    ...
    class MailFolder < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "childFolders" => lambda {|n| @child_folders = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MailFolder.create_from_discriminator_value(pn) }) },
                ...
                "userConfigurations" => lambda {|n| @user_configurations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserConfiguration.create_from_discriminator_value(pn) }) },
        ...
        def serialize(writer)
            ...
            writer.write_collection_of_object_values("userConfigurations", @user_configurations)
        ...
        ## @return a void
        ## 
        def user_configurations=(value)
            @user_configurations = value
        end
        ## 
