...
module MicrosoftGraphBeta::Models
    class IpNamedLocation < MicrosoftGraphBeta::Models::NamedLocation
        ...
        def get_field_deserializers()
            return super.merge({
                "ipRanges" => lambda {|n| @ip_ranges = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IpRange.create_from_discriminator_value(pn) }) },
