...
module MicrosoftGraphBeta::Models
    ...
    class ImportedWindowsAutopilotDeviceIdentity < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "state" => lambda {|n| @state = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ImportedWindowsAutopilotDeviceIdentityState.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
