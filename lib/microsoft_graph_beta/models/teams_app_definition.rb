...
module MicrosoftGraphBeta::Models
    class TeamsAppDefinition < MicrosoftGraphBeta::Models::Entity
        ...
        ## @return a void
        ## 
        def allowed_installation_scopes=(value)
            @allowed_installation_scopes = value
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "outlineIcon" => lambda {|n| @outline_icon = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamsAppIcon.create_from_discriminator_value(pn) }) },
                "publishingState" => lambda {|n| @publishing_state = n.get_enum_value(MicrosoftGraphBeta::Models::TeamsAppPublishingState) },
                "shortdescription" => lambda {|n| @shortdescription = n.get_string_value() },
        ...
        def serialize(writer)
            ...
            super
            writer.write_enum_value("allowedInstallationScopes", @allowed_installation_scopes)
            ...
            writer.write_object_value("outlineIcon", @outline_icon)
            writer.write_enum_value("publishingState", @publishing_state)
            writer.write_string_value("shortdescription", @shortdescription)
