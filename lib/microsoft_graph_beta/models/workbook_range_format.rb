...
module MicrosoftGraphBeta::Models
    class WorkbookRangeFormat < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "borders" => lambda {|n| @borders = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookRangeBorder.create_from_discriminator_value(pn) }) },
                "columnWidth" => lambda {|n| @column_width = n.get_object_value(lambda {|pn| Double.create_from_discriminator_value(pn) }) },
                "fill" => lambda {|n| @fill = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookRangeFill.create_from_discriminator_value(pn) }) },
                "font" => lambda {|n| @font = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookRangeFont.create_from_discriminator_value(pn) }) },
                "horizontalAlignment" => lambda {|n| @horizontal_alignment = n.get_string_value() },
                "protection" => lambda {|n| @protection = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookFormatProtection.create_from_discriminator_value(pn) }) },
