...
module MicrosoftGraphBeta::Models
    ...
    class DeliveryOptimizationGroupIdSource
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    when "#microsoft.graph.deliveryOptimizationGroupIdCustom"
                        return DeliveryOptimizationGroupIdCustom.new
                    when "#microsoft.graph.deliveryOptimizationGroupIdSourceOptions"
                        return DeliveryOptimizationGroupIdSourceOptions.new
                end
            end
            return DeliveryOptimizationGroupIdSource.new
        end
        ## 
