...
module MicrosoftGraphBeta::Models
    ...
    class WorkbookOperation < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "error" => lambda {|n| @error = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookOperationError.create_from_discriminator_value(pn) }) },
                "resourceLocation" => lambda {|n| @resource_location = n.get_string_value() },
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::WorkbookOperationStatus) },
            })
        end
        ## 
