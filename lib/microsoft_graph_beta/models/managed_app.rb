...
module MicrosoftGraphBeta::Models
    class ManagedApp < MicrosoftGraphBeta::Models::MobileApp
        ...
        def get_field_deserializers()
            return super.merge({
                "appAvailability" => lambda {|n| @app_availability = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedAppAvailability) },
