...
module MicrosoftGraphBeta::Models
    class BookingCustomerInformation < MicrosoftGraphBeta::Models::BookingCustomerInformationBase
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "customQuestionAnswers" => lambda {|n| @custom_question_answers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::BookingQuestionAnswer.create_from_discriminator_value(pn) }) },
