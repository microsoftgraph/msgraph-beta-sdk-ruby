...
module MicrosoftGraphBeta::Models
    ...
    class Permission < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "grantedTo" => lambda {|n| @granted_to = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                "grantedToIdentities" => lambda {|n| @granted_to_identities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                "grantedToIdentitiesV2" => lambda {|n| @granted_to_identities_v2 = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SharePointIdentitySet.create_from_discriminator_value(pn) }) },
                "grantedToV2" => lambda {|n| @granted_to_v2 = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SharePointIdentitySet.create_from_discriminator_value(pn) }) },
                "hasPassword" => lambda {|n| @has_password = n.get_boolean_value() },
                "inheritedFrom" => lambda {|n| @inherited_from = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemReference.create_from_discriminator_value(pn) }) },
                "invitation" => lambda {|n| @invitation = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SharingInvitation.create_from_discriminator_value(pn) }) },
                "link" => lambda {|n| @link = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SharingLink.create_from_discriminator_value(pn) }) },
