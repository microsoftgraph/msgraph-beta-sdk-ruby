...
module MicrosoftGraphBeta::Models
    class MacOSCompliancePolicy < MicrosoftGraphBeta::Models::DeviceCompliancePolicy
        ...
        @os_maximum_build_version
        ## 
        # Maximum MacOS version.
        @os_maximum_version
        ## 
        # Minimum MacOS build version.
        @os_minimum_build_version
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "osMaximumBuildVersion" => lambda {|n| @os_maximum_build_version = n.get_string_value() },
                "osMaximumVersion" => lambda {|n| @os_maximum_version = n.get_string_value() },
                "osMinimumBuildVersion" => lambda {|n| @os_minimum_build_version = n.get_string_value() },
        ...
        ## @return a string
        ## 
        def os_maximum_build_version
            return @os_maximum_build_version
        end
        ## 
        ...
        ## @return a void
        ## 
        def os_maximum_build_version=(value)
            @os_maximum_build_version = value
        end
        ## 
        ...
        ## @return a string
        ## 
        def os_minimum_build_version
            return @os_minimum_build_version
        end
        ## 
        ...
        ## @return a void
        ## 
        def os_minimum_build_version=(value)
            @os_minimum_build_version = value
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_string_value("osMaximumBuildVersion", @os_maximum_build_version)
            writer.write_string_value("osMaximumVersion", @os_maximum_version)
            writer.write_string_value("osMinimumBuildVersion", @os_minimum_build_version)
