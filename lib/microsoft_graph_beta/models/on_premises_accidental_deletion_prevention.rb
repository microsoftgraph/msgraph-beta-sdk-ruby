    ...
    class OnPremisesAccidentalDeletionPrevention
        ...
        def get_field_deserializers()
            return {
                ...
                "synchronizationPreventionType" => lambda {|n| @synchronization_prevention_type = n.get_enum_value(MicrosoftGraphBeta::Models::OnPremisesDirectorySynchronizationDeletionPreventionType) },
            }
        end
        ## 
