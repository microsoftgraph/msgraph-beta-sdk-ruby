    ...
    class Win32LobAppAssignmentSettings < MicrosoftGraphBeta::Models::MobileAppAssignmentSettings
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "restartSettings" => lambda {|n| @restart_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Win32LobAppRestartSettings.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
