...
module MicrosoftGraphBeta::Models
    class Win32LobAppProductCodeRule < MicrosoftGraphBeta::Models::Win32LobAppRule
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "productVersionOperator" => lambda {|n| @product_version_operator = n.get_enum_value(MicrosoftGraphBeta::Models::Win32LobAppRuleOperator) },
            })
        end
        ## 
