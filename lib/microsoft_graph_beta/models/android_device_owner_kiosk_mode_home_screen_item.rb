...
module MicrosoftGraphBeta::Models
    ...
    class AndroidDeviceOwnerKioskModeHomeScreenItem
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            unless mapping_value_node.nil? then
                ...
                case mapping_value
                    ...
                    when "#microsoft.graph.androidDeviceOwnerKioskModeFolderItem"
                        return AndroidDeviceOwnerKioskModeFolderItem.new
                    when "#microsoft.graph.androidDeviceOwnerKioskModeManagedFolderReference"
            ...
            return AndroidDeviceOwnerKioskModeHomeScreenItem.new
        end
        ## 
