...
module MicrosoftGraphBeta::Models
    class AuthenticationMethodModeDetail < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "authenticationMethod" => lambda {|n| @authentication_method = n.get_enum_value(MicrosoftGraphBeta::Models::BaseAuthenticationMethod) },
