...
module MicrosoftGraphBeta::Models
    class AuthenticationMethodFeatureConfiguration
        ...
        def get_field_deserializers()
            return {
                "excludeTarget" => lambda {|n| @exclude_target = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::FeatureTarget.create_from_discriminator_value(pn) }) },
                "includeTarget" => lambda {|n| @include_target = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::FeatureTarget.create_from_discriminator_value(pn) }) },
