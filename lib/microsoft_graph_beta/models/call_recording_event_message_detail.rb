...
module MicrosoftGraphBeta::Models
    class CallRecordingEventMessageDetail < MicrosoftGraphBeta::Models::EventMessageDetail
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "callRecordingStatus" => lambda {|n| @call_recording_status = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecordingStatus) },
