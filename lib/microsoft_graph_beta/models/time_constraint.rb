...
module MicrosoftGraphBeta::Models
    class TimeConstraint
        ...
        def get_field_deserializers()
            return {
                "activityDomain" => lambda {|n| @activity_domain = n.get_enum_value(MicrosoftGraphBeta::Models::ActivityDomain) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "timeSlots" => lambda {|n| @time_slots = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TimeSlot.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
