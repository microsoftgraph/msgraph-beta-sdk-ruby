...
module MicrosoftGraphBeta::Models
    class Workbook < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "application" => lambda {|n| @application = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookApplication.create_from_discriminator_value(pn) }) },
                "comments" => lambda {|n| @comments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookComment.create_from_discriminator_value(pn) }) },
                "functions" => lambda {|n| @functions = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookFunctions.create_from_discriminator_value(pn) }) },
                "names" => lambda {|n| @names = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookNamedItem.create_from_discriminator_value(pn) }) },
                "operations" => lambda {|n| @operations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookOperation.create_from_discriminator_value(pn) }) },
                "tables" => lambda {|n| @tables = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookTable.create_from_discriminator_value(pn) }) },
                "worksheets" => lambda {|n| @worksheets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookWorksheet.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
