...
module MicrosoftGraphBeta::Models::ManagedTenants
    class ManagedTenantAlertLog < MicrosoftGraphBeta::Models::Entity
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            return ManagedTenantAlertLog.new
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "content" => lambda {|n| @content = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::AlertLogContent.create_from_discriminator_value(pn) }) },
