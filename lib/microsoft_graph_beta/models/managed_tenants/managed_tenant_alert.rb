...
module MicrosoftGraphBeta::Models::ManagedTenants
    class ManagedTenantAlert < MicrosoftGraphBeta::Models::Entity
        ...
        ## @return a alert_data_reference_string
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                "alertData" => lambda {|n| @alert_data = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::AlertData.create_from_discriminator_value(pn) }) },
                "alertDataReferenceStrings" => lambda {|n| @alert_data_reference_strings = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::AlertDataReferenceString.create_from_discriminator_value(pn) }) },
                "alertLogs" => lambda {|n| @alert_logs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagedTenantAlertLog.create_from_discriminator_value(pn) }) },
                "alertRule" => lambda {|n| @alert_rule = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagedTenantAlertRule.create_from_discriminator_value(pn) }) },
                "alertRuleDisplayName" => lambda {|n| @alert_rule_display_name = n.get_string_value() },
                "apiNotifications" => lambda {|n| @api_notifications = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagedTenantApiNotification.create_from_discriminator_value(pn) }) },
                ...
                "emailNotifications" => lambda {|n| @email_notifications = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ManagedTenants::ManagedTenantEmailNotification.create_from_discriminator_value(pn) }) },
                ...
                "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::AlertSeverity) },
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::ManagedTenants::AlertStatus) },
