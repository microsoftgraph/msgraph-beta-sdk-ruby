...
module MicrosoftGraphBeta::Models
    class Win32LobAppFileSystemRule < MicrosoftGraphBeta::Models::Win32LobAppRule
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "operationType" => lambda {|n| @operation_type = n.get_enum_value(MicrosoftGraphBeta::Models::Win32LobAppFileSystemOperationType) },
