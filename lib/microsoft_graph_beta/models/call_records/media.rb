...
module MicrosoftGraphBeta::Models::CallRecords
    class Media
        ...
        def get_field_deserializers()
            return {
                "calleeDevice" => lambda {|n| @callee_device = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CallRecords::DeviceInfo.create_from_discriminator_value(pn) }) },
                "calleeNetwork" => lambda {|n| @callee_network = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CallRecords::NetworkInfo.create_from_discriminator_value(pn) }) },
                "callerDevice" => lambda {|n| @caller_device = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CallRecords::DeviceInfo.create_from_discriminator_value(pn) }) },
                "callerNetwork" => lambda {|n| @caller_network = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CallRecords::NetworkInfo.create_from_discriminator_value(pn) }) },
                "label" => lambda {|n| @label = n.get_string_value() },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "streams" => lambda {|n| @streams = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecords::MediaStream.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
