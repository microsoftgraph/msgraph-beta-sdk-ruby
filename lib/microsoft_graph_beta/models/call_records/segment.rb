...
module MicrosoftGraphBeta::Models::CallRecords
    ...
    class Segment < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "media" => lambda {|n| @media = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::CallRecords::Media.create_from_discriminator_value(pn) }) },
