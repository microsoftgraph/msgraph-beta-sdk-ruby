    ...
    class UserFeedback
        ...
        def get_field_deserializers()
            return {
                ...
                "rating" => lambda {|n| @rating = n.get_enum_value(MicrosoftGraphBeta::Models::CallRecords::UserFeedbackRating) },
                "text" => lambda {|n| @text = n.get_string_value() },
                "tokens" => lambda {|n| @tokens = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::CallRecords::FeedbackTokenSet.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
