...
module MicrosoftGraphBeta::Models
    class GroupPolicyPresentationDecimalTextBox < MicrosoftGraphBeta::Models::GroupPolicyUploadedPresentation
        ...
        ## @return a group_policy_presentation_decimal_text_box
        ## 
