...
module MicrosoftGraphBeta::Models
    class ItemActivity < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "access" => lambda {|n| @access = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AccessAction.create_from_discriminator_value(pn) }) },
