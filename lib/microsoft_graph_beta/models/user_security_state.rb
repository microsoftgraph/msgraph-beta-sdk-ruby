    ...
    class UserSecurityState
        ...
        def get_field_deserializers()
            return {
                ...
                "emailRole" => lambda {|n| @email_role = n.get_enum_value(MicrosoftGraphBeta::Models::EmailRole) },
                ...
                "logonType" => lambda {|n| @logon_type = n.get_enum_value(MicrosoftGraphBeta::Models::LogonType) },
                ...
                "userAccountType" => lambda {|n| @user_account_type = n.get_enum_value(MicrosoftGraphBeta::Models::UserAccountSecurityType) },
