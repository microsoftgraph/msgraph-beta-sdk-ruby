...
module MicrosoftGraphBeta::Models
    class LocateDeviceActionResult < MicrosoftGraphBeta::Models::DeviceActionResult
        ...
        def get_field_deserializers()
            return super.merge({
                "deviceLocation" => lambda {|n| @device_location = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DeviceGeoLocation.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
