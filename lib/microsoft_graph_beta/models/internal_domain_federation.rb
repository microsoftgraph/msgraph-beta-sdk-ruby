...
module MicrosoftGraphBeta::Models
    class InternalDomainFederation < MicrosoftGraphBeta::Models::SamlOrWsFedProvider
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "federatedIdpMfaBehavior" => lambda {|n| @federated_idp_mfa_behavior = n.get_enum_value(MicrosoftGraphBeta::Models::FederatedIdpMfaBehavior) },
                ...
                "promptLoginBehavior" => lambda {|n| @prompt_login_behavior = n.get_enum_value(MicrosoftGraphBeta::Models::PromptLoginBehavior) },
                "signingCertificateUpdateStatus" => lambda {|n| @signing_certificate_update_status = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SigningCertificateUpdateStatus.create_from_discriminator_value(pn) }) },
