...
module MicrosoftGraphBeta::Models
    class UnifiedRoleAssignmentScheduleRequest < MicrosoftGraphBeta::Models::Request
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "activatedUsing" => lambda {|n| @activated_using = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleEligibilitySchedule.create_from_discriminator_value(pn) }) },
                ...
                "targetSchedule" => lambda {|n| @target_schedule = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleAssignmentSchedule.create_from_discriminator_value(pn) }) },
