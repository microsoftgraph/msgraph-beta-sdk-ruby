...
module MicrosoftGraphBeta::Models
    class DelegatedAdminRelationshipRequest < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "action" => lambda {|n| @action = n.get_enum_value(MicrosoftGraphBeta::Models::DelegatedAdminRelationshipRequestAction) },
                "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                "lastModifiedDateTime" => lambda {|n| @last_modified_date_time = n.get_date_time_value() },
                "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraphBeta::Models::DelegatedAdminRelationshipRequestStatus) },
            })
        end
        ## 
