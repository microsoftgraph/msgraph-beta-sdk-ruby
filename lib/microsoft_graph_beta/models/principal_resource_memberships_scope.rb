...
module MicrosoftGraphBeta::Models
    class PrincipalResourceMembershipsScope < MicrosoftGraphBeta::Models::AccessReviewScope
        ...
        def get_field_deserializers()
            return super.merge({
                "principalScopes" => lambda {|n| @principal_scopes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewScope.create_from_discriminator_value(pn) }) },
                "resourceScopes" => lambda {|n| @resource_scopes = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewScope.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
