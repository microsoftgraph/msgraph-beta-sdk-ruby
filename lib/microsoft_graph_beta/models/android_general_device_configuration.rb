...
module MicrosoftGraphBeta::Models
    class AndroidGeneralDeviceConfiguration < MicrosoftGraphBeta::Models::DeviceConfiguration
        ...
        ## @return a boolean
        ## 
        def date_and_time_block_changes
            return @date_and_time_block_changes
        end
        ## 
        ...
        ## @return a void
        ## 
        def date_and_time_block_changes=(value)
            @date_and_time_block_changes = value
        end
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "appsHideList" => lambda {|n| @apps_hide_list = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AppListItem.create_from_discriminator_value(pn) }) },
                "appsInstallAllowList" => lambda {|n| @apps_install_allow_list = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AppListItem.create_from_discriminator_value(pn) }) },
                "appsLaunchBlockList" => lambda {|n| @apps_launch_block_list = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AppListItem.create_from_discriminator_value(pn) }) },
                ...
                "dateAndTimeBlockChanges" => lambda {|n| @date_and_time_block_changes = n.get_boolean_value() },
                ...
                "webBrowserCookieSettings" => lambda {|n| @web_browser_cookie_settings = n.get_enum_value(MicrosoftGraphBeta::Models::WebBrowserCookieSettings) },
        ...
        def serialize(writer)
            ...
            writer.write_boolean_value("dateAndTimeBlockChanges", @date_and_time_block_changes)
