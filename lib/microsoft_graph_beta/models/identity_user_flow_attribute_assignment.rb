...
module MicrosoftGraphBeta::Models
    ...
    class IdentityUserFlowAttributeAssignment < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "userAttribute" => lambda {|n| @user_attribute = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityUserFlowAttribute.create_from_discriminator_value(pn) }) },
                "userAttributeValues" => lambda {|n| @user_attribute_values = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserAttributeValuesItem.create_from_discriminator_value(pn) }) },
                "userInputType" => lambda {|n| @user_input_type = n.get_enum_value(MicrosoftGraphBeta::Models::IdentityUserFlowAttributeInputType) },
            })
        end
        ## 
