...
module MicrosoftGraphBeta::Models
    class AndroidDeviceOwnerEnterpriseWiFiConfiguration < MicrosoftGraphBeta::Models::AndroidDeviceOwnerWiFiConfiguration
        ...
        ## @return a android_device_owner_enterprise_wi_fi_configuration
        ## 
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "identityCertificateForClientAuthentication" => lambda {|n| @identity_certificate_for_client_authentication = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AndroidDeviceOwnerCertificateProfileBase.create_from_discriminator_value(pn) }) },
