...
module MicrosoftGraphBeta::Models
    class ProfileCardProperty < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "annotations" => lambda {|n| @annotations = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ProfileCardAnnotation.create_from_discriminator_value(pn) }) },
