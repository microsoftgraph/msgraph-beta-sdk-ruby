...
module MicrosoftGraphBeta::Models
    class MicrosoftAuthenticatorAuthenticationMethodConfiguration < MicrosoftGraphBeta::Models::AuthenticationMethodConfiguration
        ...
        def get_field_deserializers()
            return super.merge({
                "featureSettings" => lambda {|n| @feature_settings = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::MicrosoftAuthenticatorFeatureSettings.create_from_discriminator_value(pn) }) },
                "includeTargets" => lambda {|n| @include_targets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::MicrosoftAuthenticatorAuthenticationMethodTarget.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
