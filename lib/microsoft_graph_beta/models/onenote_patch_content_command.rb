...
module MicrosoftGraphBeta::Models
    class OnenotePatchContentCommand
        ...
        def get_field_deserializers()
            return {
                "action" => lambda {|n| @action = n.get_enum_value(MicrosoftGraphBeta::Models::OnenotePatchActionType) },
                "content" => lambda {|n| @content = n.get_string_value() },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "position" => lambda {|n| @position = n.get_enum_value(MicrosoftGraphBeta::Models::OnenotePatchInsertPosition) },
