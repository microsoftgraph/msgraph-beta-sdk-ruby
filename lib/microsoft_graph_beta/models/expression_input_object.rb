...
module MicrosoftGraphBeta::Models
    class ExpressionInputObject
        ...
        def get_field_deserializers()
            return {
                "definition" => lambda {|n| @definition = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ObjectDefinition.create_from_discriminator_value(pn) }) },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "properties" => lambda {|n| @properties = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::StringKeyObjectValuePair.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
