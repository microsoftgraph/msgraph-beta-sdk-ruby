...
module MicrosoftGraphBeta::Models
    class WorkbookChartGridlines < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "format" => lambda {|n| @format = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookChartGridlinesFormat.create_from_discriminator_value(pn) }) },
