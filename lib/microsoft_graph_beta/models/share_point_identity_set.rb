...
module MicrosoftGraphBeta::Models
    class SharePointIdentitySet < MicrosoftGraphBeta::Models::IdentitySet
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "siteGroup" => lambda {|n| @site_group = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SharePointIdentity.create_from_discriminator_value(pn) }) },
                "siteUser" => lambda {|n| @site_user = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SharePointIdentity.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
