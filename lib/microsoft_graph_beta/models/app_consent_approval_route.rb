...
module MicrosoftGraphBeta::Models
    class AppConsentApprovalRoute < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                "appConsentRequests" => lambda {|n| @app_consent_requests = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AppConsentRequest.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
