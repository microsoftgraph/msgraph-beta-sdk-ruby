...
module MicrosoftGraphBeta::Models
    ...
    class IosUpdateDeviceStatus < MicrosoftGraphBeta::Models::Entity
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "installStatus" => lambda {|n| @install_status = n.get_enum_value(MicrosoftGraphBeta::Models::IosUpdatesInstallStatus) },
