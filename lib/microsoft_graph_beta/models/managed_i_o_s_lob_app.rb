...
module MicrosoftGraphBeta::Models
    class ManagedIOSLobApp < MicrosoftGraphBeta::Models::ManagedMobileLobApp
        ...
        def get_field_deserializers()
            return super.merge({
                ...
                "minimumSupportedOperatingSystem" => lambda {|n| @minimum_supported_operating_system = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IosMinimumOperatingSystem.create_from_discriminator_value(pn) }) },
