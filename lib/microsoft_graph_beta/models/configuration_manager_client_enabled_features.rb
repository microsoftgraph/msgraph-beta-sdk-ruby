...
module MicrosoftGraphBeta::Models
    ...
    class ConfigurationManagerClientEnabledFeatures
        ...
        ## @return a void
        ## 
        def endpoint_protection=(value)
            @endpoint_protection = value
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                ...
                "endpointProtection" => lambda {|n| @endpoint_protection = n.get_boolean_value() },
                "inventory" => lambda {|n| @inventory = n.get_boolean_value() },
                "modernApps" => lambda {|n| @modern_apps = n.get_boolean_value() },
                "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                "officeApps" => lambda {|n| @office_apps = n.get_boolean_value() },
        ...
        def serialize(writer)
            ...
            writer.write_boolean_value("endpointProtection", @endpoint_protection)
            writer.write_boolean_value("inventory", @inventory)
            writer.write_boolean_value("modernApps", @modern_apps)
            writer.write_string_value("@odata.type", @odata_type)
            writer.write_boolean_value("officeApps", @office_apps)
