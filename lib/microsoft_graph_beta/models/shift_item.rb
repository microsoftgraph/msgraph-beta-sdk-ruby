...
module MicrosoftGraphBeta::Models
    class ShiftItem < MicrosoftGraphBeta::Models::ScheduleEntity
        ...
        def get_field_deserializers()
            return super.merge({
                "activities" => lambda {|n| @activities = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ShiftActivity.create_from_discriminator_value(pn) }) },
