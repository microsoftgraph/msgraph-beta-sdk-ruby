...
module MicrosoftGraphBeta::Models
    class AggregationOption
        ...
        def get_field_deserializers()
            return {
                "bucketDefinition" => lambda {|n| @bucket_definition = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::BucketAggregationDefinition.create_from_discriminator_value(pn) }) },
