    ...
    class ConditionalAccessClientApplications
        ...
        def get_field_deserializers()
            return {
                ...
                "servicePrincipalFilter" => lambda {|n| @service_principal_filter = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ConditionalAccessFilter.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
