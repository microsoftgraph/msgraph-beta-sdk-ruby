...
module MicrosoftGraphBeta::Models
    class RegistrationEnforcement
        ...
        def get_field_deserializers()
            return {
                "authenticationMethodsRegistrationCampaign" => lambda {|n| @authentication_methods_registration_campaign = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationMethodsRegistrationCampaign.create_from_discriminator_value(pn) }) },
