...
module MicrosoftGraphBeta::Agreements::Item::File
    ## 
    ...
    class FileRequestBuilder
        ...
        def localizations()
            return MicrosoftGraphBeta::Agreements::Item::File::Localizations::LocalizationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
