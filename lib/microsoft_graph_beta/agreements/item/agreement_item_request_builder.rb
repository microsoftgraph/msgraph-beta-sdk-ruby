...
module MicrosoftGraphBeta::Agreements::Item
    ## 
    ...
    class AgreementItemRequestBuilder
        ...
        def acceptances()
            return MicrosoftGraphBeta::Agreements::Item::Acceptances::AcceptancesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the file property of the microsoft.graph.agreement entity.
        def file()
            return MicrosoftGraphBeta::Agreements::Item::File::FileRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the files property of the microsoft.graph.agreement entity.
        def files()
            return MicrosoftGraphBeta::Agreements::Item::Files::FilesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def acceptances_by_id(id)
            ...
            return MicrosoftGraphBeta::Agreements::Item::Acceptances::Item::AgreementAcceptanceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def files_by_id(id)
            ...
            return MicrosoftGraphBeta::Agreements::Item::Files::Item::AgreementFileLocalizationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
