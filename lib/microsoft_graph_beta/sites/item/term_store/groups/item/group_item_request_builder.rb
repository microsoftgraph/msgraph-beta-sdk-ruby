...
module MicrosoftGraphBeta::Sites::Item::TermStore::Groups::Item
    ## 
    ...
    class GroupItemRequestBuilder
        ...
        def sets()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Groups::Item::Sets::SetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
