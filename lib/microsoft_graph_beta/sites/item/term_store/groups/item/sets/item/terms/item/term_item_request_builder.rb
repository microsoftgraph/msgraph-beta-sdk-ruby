...
module MicrosoftGraphBeta::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def children()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def relations()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraphBeta::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item::Children::Item::TermItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraphBeta::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
