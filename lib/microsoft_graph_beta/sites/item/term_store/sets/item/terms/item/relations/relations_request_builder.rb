...
module MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Terms::Item::Relations
    ## 
    ...
    class RelationsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Terms::Item::Relations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
