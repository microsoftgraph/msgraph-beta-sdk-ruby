...
module MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Children::Item::Relations
    ## 
    ...
    class RelationsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Children::Item::Relations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
