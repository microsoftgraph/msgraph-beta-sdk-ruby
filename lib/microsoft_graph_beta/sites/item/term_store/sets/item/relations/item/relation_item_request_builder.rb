...
module MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Relations::Item
    ## 
    ...
    class RelationItemRequestBuilder
        ...
        def from_term()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Relations::Item::FromTerm::FromTermRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Relations::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the toTerm property of the microsoft.graph.termStore.relation entity.
        def to_term()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::Relations::Item::ToTerm::ToTermRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
