...
module MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::ParentGroup
    ## 
    ...
    class ParentGroupRequestBuilder
        ...
        def sets()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::SetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
