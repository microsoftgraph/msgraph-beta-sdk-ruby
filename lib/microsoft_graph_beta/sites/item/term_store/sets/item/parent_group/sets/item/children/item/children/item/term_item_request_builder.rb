...
module MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Children::Item::Children::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def relations()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Children::Item::Children::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Children::Item::Children::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraphBeta::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Children::Item::Children::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
