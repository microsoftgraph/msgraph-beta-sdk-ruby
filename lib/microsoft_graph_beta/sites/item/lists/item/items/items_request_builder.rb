...
module MicrosoftGraphBeta::Sites::Item::Lists::Item::Items
    ## 
    ...
    class ItemsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Sites::Item::Lists::Item::Items::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
