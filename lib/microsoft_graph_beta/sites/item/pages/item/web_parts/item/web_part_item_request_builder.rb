...
module MicrosoftGraphBeta::Sites::Item::Pages::Item::WebParts::Item
    ## 
    ...
    class WebPartItemRequestBuilder
        ...
        def get_position_of_web_part()
            return MicrosoftGraphBeta::Sites::Item::Pages::Item::WebParts::Item::GetPositionOfWebPart::GetPositionOfWebPartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/webParts/{webPart%2Did}{?%24select,%24expand}"
