...
module MicrosoftGraphBeta::Sites::Item::Onenote::Notebooks::GetRecentNotebooksWithIncludePersonalNotebooks
    ...
    class GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Sites::Item::Onenote::Notebooks::GetRecentNotebooksWithIncludePersonalNotebooks::GetRecentNotebooksWithIncludePersonalNotebooksResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
