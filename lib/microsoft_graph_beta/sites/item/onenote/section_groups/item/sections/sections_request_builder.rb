...
module MicrosoftGraphBeta::Sites::Item::Onenote::SectionGroups::Item::Sections
    ## 
    ...
    class SectionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Sites::Item::Onenote::SectionGroups::Item::Sections::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
