...
module MicrosoftGraphBeta::Sites::Item::ContentTypes
    ## 
    ...
    class ContentTypesRequestBuilder
        ...
        def add_copy()
            return MicrosoftGraphBeta::Sites::Item::ContentTypes::AddCopy::AddCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addCopyFromContentTypeHub method.
        def add_copy_from_content_type_hub()
            return MicrosoftGraphBeta::Sites::Item::ContentTypes::AddCopyFromContentTypeHub::AddCopyFromContentTypeHubRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to count the resources in the collection.
        def count()
            return MicrosoftGraphBeta::Sites::Item::ContentTypes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
