...
module MicrosoftGraphBeta::Sites::Item::Columns::Item
    ## 
    ...
    class ColumnDefinitionItemRequestBuilder
        ...
        def source_column()
            return MicrosoftGraphBeta::Sites::Item::Columns::Item::SourceColumn::SourceColumnRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
