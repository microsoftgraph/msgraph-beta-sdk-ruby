...
module MicrosoftGraphBeta::DirectoryRoles::Item::Members::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::DirectoryRoles::Item::Members::Application::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
