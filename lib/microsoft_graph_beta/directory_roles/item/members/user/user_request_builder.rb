...
module MicrosoftGraphBeta::DirectoryRoles::Item::Members::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::DirectoryRoles::Item::Members::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
