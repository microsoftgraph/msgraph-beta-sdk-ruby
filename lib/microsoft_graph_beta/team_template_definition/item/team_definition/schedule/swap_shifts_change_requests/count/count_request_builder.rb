...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Schedule::SwapShiftsChangeRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/swapShiftsChangeRequests/$count"
