...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::SharedWithTeams::Item
    ## 
    ...
    class SharedWithChannelTeamInfoItemRequestBuilder
        ...
        def allowed_members()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::SharedWithTeams::Item::AllowedMembers::AllowedMembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def allowed_members_by_id(id)
            ...
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::SharedWithTeams::Item::AllowedMembers::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}"
