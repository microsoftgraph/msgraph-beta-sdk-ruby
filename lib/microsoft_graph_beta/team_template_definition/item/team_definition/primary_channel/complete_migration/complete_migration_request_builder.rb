...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::CompleteMigration
    ## 
    ...
    class CompleteMigrationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/microsoft.graph.completeMigration"
