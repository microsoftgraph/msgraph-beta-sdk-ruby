...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Archive
    ## 
    ...
    class ArchiveRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/microsoft.graph.archive"
