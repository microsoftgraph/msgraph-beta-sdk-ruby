...
module MicrosoftGraphBeta::Me::Todo::Lists::Item
    ## 
    ...
    class TodoTaskListItemRequestBuilder
        ...
        def extensions()
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Extensions::ExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tasks()
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## The task lists in the users mailbox.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
