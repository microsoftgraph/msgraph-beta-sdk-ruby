...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item
    ## 
    ...
    class AccessReviewInstanceDecisionItemItemRequestBuilder
        ...
        def insights()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Insights::InsightsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the instance property of the microsoft.graph.accessReviewInstanceDecisionItem entity.
        def instance()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::InstanceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}{?%24select,%24expand}"
        ...
        def insights_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Insights::Item::GovernanceInsightItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
