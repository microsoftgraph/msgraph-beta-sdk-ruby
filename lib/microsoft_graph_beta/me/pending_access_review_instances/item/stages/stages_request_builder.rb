...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages
    ## 
    ...
    class StagesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
