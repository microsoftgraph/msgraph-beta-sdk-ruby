...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item::Decisions::Item
    ## 
    ...
    class AccessReviewInstanceDecisionItemItemRequestBuilder
        ...
        def insights()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item::Decisions::Item::Insights::InsightsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did1}{?%24select,%24expand}"
