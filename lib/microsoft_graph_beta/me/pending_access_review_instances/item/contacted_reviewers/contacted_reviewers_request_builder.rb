...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::ContactedReviewers
    ## 
    ...
    class ContactedReviewersRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::ContactedReviewers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/contactedReviewers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
