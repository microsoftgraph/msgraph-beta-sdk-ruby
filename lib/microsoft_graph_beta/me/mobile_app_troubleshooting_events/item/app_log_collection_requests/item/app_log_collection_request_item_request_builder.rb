...
module MicrosoftGraphBeta::Me::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item
    ...
    class AppLogCollectionRequestItemRequestBuilder
        ...
        def create_download_url()
            return MicrosoftGraphBeta::Me::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item::CreateDownloadUrl::CreateDownloadUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
