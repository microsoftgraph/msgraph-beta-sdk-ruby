...
require_relative './app_log_collection_requests/item/app_log_collection_request_item_request_builder'
require_relative './item'

module MicrosoftGraphBeta::Me::MobileAppTroubleshootingEvents::Item
    ## 
    ...
    class MobileAppTroubleshootingEventItemRequestBuilder
        ...
        def app_log_collection_requests()
            return MicrosoftGraphBeta::Me::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::AppLogCollectionRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## 
        def app_log_collection_requests_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["appLogCollectionRequest%2Did"] = id
            return MicrosoftGraphBeta::Me::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item::AppLogCollectionRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}{?%24select,%24expand}"
        ...
        ## The list of mobile app troubleshooting events for this user.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of mobile_app_troubleshooting_event
        ## 
