...
module MicrosoftGraphBeta::Me::OwnedObjects
    ...
    class OwnedObjectsRequestBuilder
        ...
        def application()
            return MicrosoftGraphBeta::Me::OwnedObjects::Application::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def group()
            return MicrosoftGraphBeta::Me::OwnedObjects::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraphBeta::Me::OwnedObjects::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
