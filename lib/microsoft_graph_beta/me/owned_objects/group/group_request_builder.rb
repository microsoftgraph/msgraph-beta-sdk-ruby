...
module MicrosoftGraphBeta::Me::OwnedObjects::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::OwnedObjects::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
