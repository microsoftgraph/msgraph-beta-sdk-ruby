...
module MicrosoftGraphBeta::Me::CloudPCs
    ## 
    ...
    class CloudPCsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/cloudPCs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## List the cloudPC devices that are attributed to the signed-in user. 
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of cloud_p_c_collection_response
        ## 
