...
module MicrosoftGraphBeta::Me::ContactFolders::Item::Contacts::Item::SingleValueExtendedProperties
    ## 
    ...
    class SingleValueExtendedPropertiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::ContactFolders::Item::Contacts::Item::SingleValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
