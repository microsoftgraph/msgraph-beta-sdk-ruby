...
module MicrosoftGraphBeta::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item::Extensions
    ## 
    ...
    class ExtensionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item::Extensions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
