...
module MicrosoftGraphBeta::Me::OnlineMeetings::Item::MeetingAttendanceReport
    ## 
    ...
    class MeetingAttendanceReportRequestBuilder
        ...
        def attendance_records()
            return MicrosoftGraphBeta::Me::OnlineMeetings::Item::MeetingAttendanceReport::AttendanceRecords::AttendanceRecordsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport{?%24select,%24expand}"
