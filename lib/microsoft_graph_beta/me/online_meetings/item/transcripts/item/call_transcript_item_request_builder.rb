...
module MicrosoftGraphBeta::Me::OnlineMeetings::Item::Transcripts::Item
    ## 
    ...
    class CallTranscriptItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Me::OnlineMeetings::Item::Transcripts::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/transcripts/{callTranscript%2Did}{?%24select,%24expand}"
