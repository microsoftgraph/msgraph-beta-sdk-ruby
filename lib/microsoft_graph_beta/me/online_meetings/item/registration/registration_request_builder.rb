...
module MicrosoftGraphBeta::Me::OnlineMeetings::Item::Registration
    ## 
    ...
    class RegistrationRequestBuilder
        ...
        def custom_questions()
            return MicrosoftGraphBeta::Me::OnlineMeetings::Item::Registration::CustomQuestions::CustomQuestionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/registration{?%24select,%24expand}"
        ...
        ## Get the externalMeetingRegistration details associated with an onlineMeeting.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of meeting_registration
        ## 
