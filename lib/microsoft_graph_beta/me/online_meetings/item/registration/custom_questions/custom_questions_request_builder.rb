...
module MicrosoftGraphBeta::Me::OnlineMeetings::Item::Registration::CustomQuestions
    ## 
    ...
    class CustomQuestionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/registration/customQuestions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
