...
module MicrosoftGraphBeta::Me::OnlineMeetings::Item::Registration::CustomQuestions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/registration/customQuestions/$count"
