...
module MicrosoftGraphBeta::Me::OnlineMeetings::Item::AttendanceReports
    ## 
    ...
    class AttendanceReportsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::OnlineMeetings::Item::AttendanceReports::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
