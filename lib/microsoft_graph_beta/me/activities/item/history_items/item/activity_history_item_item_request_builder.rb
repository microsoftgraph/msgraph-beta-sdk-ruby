...
module MicrosoftGraphBeta::Me::Activities::Item::HistoryItems::Item
    ## 
    ...
    class ActivityHistoryItemItemRequestBuilder
        ...
        def activity()
            return MicrosoftGraphBeta::Me::Activities::Item::HistoryItems::Item::Activity::ActivityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
