...
module MicrosoftGraphBeta::Me::Activities::Item
    ...
    class UserActivityItemRequestBuilder
        ...
        def history_items()
            return MicrosoftGraphBeta::Me::Activities::Item::HistoryItems::HistoryItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def history_items_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Activities::Item::HistoryItems::Item::ActivityHistoryItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
