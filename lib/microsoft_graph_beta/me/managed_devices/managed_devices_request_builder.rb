...
module MicrosoftGraphBeta::Me::ManagedDevices
    ## 
    ...
    class ManagedDevicesRequestBuilder
        ...
        def bulk_reprovision_cloud_pc()
            return MicrosoftGraphBeta::Me::ManagedDevices::BulkReprovisionCloudPc::BulkReprovisionCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the bulkRestoreCloudPc method.
        def bulk_restore_cloud_pc()
            return MicrosoftGraphBeta::Me::ManagedDevices::BulkRestoreCloudPc::BulkRestoreCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the bulkSetCloudPcReviewStatus method.
        def bulk_set_cloud_pc_review_status()
            return MicrosoftGraphBeta::Me::ManagedDevices::BulkSetCloudPcReviewStatus::BulkSetCloudPcReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to count the resources in the collection.
        def count()
            return MicrosoftGraphBeta::Me::ManagedDevices::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the downloadAppDiagnostics method.
        def download_app_diagnostics()
            return MicrosoftGraphBeta::Me::ManagedDevices::DownloadAppDiagnostics::DownloadAppDiagnosticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the executeAction method.
        def execute_action()
            return MicrosoftGraphBeta::Me::ManagedDevices::ExecuteAction::ExecuteActionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the moveDevicesToOU method.
        def move_devices_to_o_u()
            return MicrosoftGraphBeta::Me::ManagedDevices::MoveDevicesToOU::MoveDevicesToOURequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
