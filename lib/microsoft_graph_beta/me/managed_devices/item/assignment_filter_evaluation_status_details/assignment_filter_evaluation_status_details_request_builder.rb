...
module MicrosoftGraphBeta::Me::ManagedDevices::Item::AssignmentFilterEvaluationStatusDetails
    ## 
    ...
    class AssignmentFilterEvaluationStatusDetailsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/assignmentFilterEvaluationStatusDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Managed device mobile app configuration states for this device.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of assignment_filter_evaluation_status_details_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of assignment_filter_evaluation_status_details
        ## 
