...
module MicrosoftGraphBeta::Me::ManagedDevices::Item::RetrieveRemoteHelpSessionWithSessionKey
    ## 
    ...
    class RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, session_key=nil)
            ...
            @url_template = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/microsoft.graph.retrieveRemoteHelpSession(sessionKey='{sessionKey}')"
        ...
        ## Invoke function retrieveRemoteHelpSession
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of retrieve_remote_help_session_response
        ## 
