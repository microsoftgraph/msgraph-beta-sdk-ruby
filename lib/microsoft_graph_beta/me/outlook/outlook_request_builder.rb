...
require_relative './task_folders/item/outlook_task_folder_item_request_builder'
require_relative './task_folders/task_folders_request_builder'
require_relative './task_groups/item/outlook_task_group_item_request_builder'
...
module MicrosoftGraphBeta::Me::Outlook
    ## 
    ...
    class OutlookRequestBuilder
        ...
        def master_categories()
            return MicrosoftGraphBeta::Me::Outlook::MasterCategories::MasterCategoriesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def task_folders()
            return MicrosoftGraphBeta::Me::Outlook::TaskFolders::TaskFoldersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the taskGroups property of the microsoft.graph.outlookUser entity.
        def task_groups()
            return MicrosoftGraphBeta::Me::Outlook::TaskGroups::TaskGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the tasks property of the microsoft.graph.outlookUser entity.
        def tasks()
            return MicrosoftGraphBeta::Me::Outlook::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def master_categories_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Outlook::MasterCategories::Item::OutlookCategoryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        ## 
        def task_folders_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["outlookTaskFolder%2Did"] = id
            return MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item::OutlookTaskFolderItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the taskGroups property of the microsoft.graph.outlookUser entity.
        ## @param id Unique identifier of the item
        ## @return a outlook_task_group_item_request_builder
        ## 
        def task_groups_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["outlookTaskGroup%2Did"] = id
            return MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::OutlookTaskGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tasks property of the microsoft.graph.outlookUser entity.
        ## @param id Unique identifier of the item
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Outlook::Tasks::Item::OutlookTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
