...
module MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item
    ## 
    ...
    class OutlookTaskFolderItemRequestBuilder
        ...
        def multi_value_extended_properties()
            return MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the tasks property of the microsoft.graph.outlookTaskFolder entity.
        def tasks()
            return MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder%2Did}{?%24select}"
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item::Tasks::Item::OutlookTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property taskFolders for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
