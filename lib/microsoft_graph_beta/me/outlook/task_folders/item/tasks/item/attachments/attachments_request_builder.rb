...
module MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item::Tasks::Item::Attachments
    ...
    class AttachmentsRequestBuilder
        ...
        def create_upload_session()
            return MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item::Tasks::Item::Attachments::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
