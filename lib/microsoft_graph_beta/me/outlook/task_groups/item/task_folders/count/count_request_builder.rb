...
module MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::TaskFolders::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders/$count"
