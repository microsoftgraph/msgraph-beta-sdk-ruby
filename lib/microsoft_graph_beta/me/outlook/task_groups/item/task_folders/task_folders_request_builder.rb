...
module MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::TaskFolders
    ## 
    ...
    class TaskFoldersRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
        ...
        ## Get Outlook task folders in a specific outlookTaskGroup.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of outlook_task_folder_collection_response
        ## 
