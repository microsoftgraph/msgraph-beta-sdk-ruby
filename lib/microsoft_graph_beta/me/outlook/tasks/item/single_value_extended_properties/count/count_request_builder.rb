...
module MicrosoftGraphBeta::Me::Outlook::Tasks::Item::SingleValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/tasks/{outlookTask%2Did}/singleValueExtendedProperties/$count"
