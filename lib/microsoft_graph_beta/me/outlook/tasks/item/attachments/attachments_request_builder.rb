...
module MicrosoftGraphBeta::Me::Outlook::Tasks::Item::Attachments
    ## 
    ...
    class AttachmentsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Outlook::Tasks::Item::Attachments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createUploadSession method.
        def create_upload_session()
            return MicrosoftGraphBeta::Me::Outlook::Tasks::Item::Attachments::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/tasks/{outlookTask%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
