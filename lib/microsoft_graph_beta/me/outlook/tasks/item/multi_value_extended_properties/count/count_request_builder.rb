...
module MicrosoftGraphBeta::Me::Outlook::Tasks::Item::MultiValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/tasks/{outlookTask%2Did}/multiValueExtendedProperties/$count"
