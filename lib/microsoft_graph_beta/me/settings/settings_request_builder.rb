...
module MicrosoftGraphBeta::Me::Settings
    ## 
    ...
    class SettingsRequestBuilder
        ...
        def contact_merge_suggestions()
            return MicrosoftGraphBeta::Me::Settings::ContactMergeSuggestions::ContactMergeSuggestionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the itemInsights property of the microsoft.graph.userSettings entity.
        def item_insights()
            return MicrosoftGraphBeta::Me::Settings::ItemInsights::ItemInsightsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def regional_and_language_settings()
            return MicrosoftGraphBeta::Me::Settings::RegionalAndLanguageSettings::RegionalAndLanguageSettingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def shift_preferences()
            return MicrosoftGraphBeta::Me::Settings::ShiftPreferences::ShiftPreferencesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
