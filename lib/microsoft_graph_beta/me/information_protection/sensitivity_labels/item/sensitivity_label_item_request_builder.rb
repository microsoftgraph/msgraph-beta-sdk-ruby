...
module MicrosoftGraphBeta::Me::InformationProtection::SensitivityLabels::Item
    ...
    class SensitivityLabelItemRequestBuilder
        ...
        def sublabels()
            return MicrosoftGraphBeta::Me::InformationProtection::SensitivityLabels::Item::Sublabels::SublabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}"
