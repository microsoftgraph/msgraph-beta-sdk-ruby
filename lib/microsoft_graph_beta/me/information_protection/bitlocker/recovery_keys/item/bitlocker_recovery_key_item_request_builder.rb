...
module MicrosoftGraphBeta::Me::InformationProtection::Bitlocker::RecoveryKeys::Item
    ## 
    ...
    class BitlockerRecoveryKeyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey%2Did}{?%24select,%24expand}"
