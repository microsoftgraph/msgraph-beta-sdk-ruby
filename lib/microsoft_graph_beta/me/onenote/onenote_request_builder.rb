...
module MicrosoftGraphBeta::Me::Onenote
    ## 
    ...
    class OnenoteRequestBuilder
        ...
        def notebooks()
            return MicrosoftGraphBeta::Me::Onenote::Notebooks::NotebooksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.onenote entity.
        def operations()
            return MicrosoftGraphBeta::Me::Onenote::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the pages property of the microsoft.graph.onenote entity.
        def pages()
            return MicrosoftGraphBeta::Me::Onenote::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resources()
            return MicrosoftGraphBeta::Me::Onenote::Resources::ResourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sectionGroups property of the microsoft.graph.onenote entity.
        def section_groups()
            return MicrosoftGraphBeta::Me::Onenote::SectionGroups::SectionGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sections property of the microsoft.graph.onenote entity.
        def sections()
            return MicrosoftGraphBeta::Me::Onenote::Sections::SectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Onenote::Operations::Item::OnenoteOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the pages property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def pages_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Onenote::Pages::Item::OnenotePageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property onenote in me
        ## @param body The request body
        ...
        def resources_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Onenote::Resources::Item::OnenoteResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sectionGroups property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
