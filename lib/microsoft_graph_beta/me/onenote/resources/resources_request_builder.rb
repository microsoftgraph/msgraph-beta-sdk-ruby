...
module MicrosoftGraphBeta::Me::Onenote::Resources
    ## 
    ...
    class ResourcesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Onenote::Resources::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
