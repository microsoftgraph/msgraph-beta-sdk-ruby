...
module MicrosoftGraphBeta::Me::Onenote::Resources::Item
    ## 
    ...
    class OnenoteResourceItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Me::Onenote::Resources::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
