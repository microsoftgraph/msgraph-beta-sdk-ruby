...
module MicrosoftGraphBeta::Me::Onenote::Pages::Item
    ## 
    ...
    class OnenotePageItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Me::Onenote::Pages::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSection method.
        def copy_to_section()
            return MicrosoftGraphBeta::Me::Onenote::Pages::Item::CopyToSection::CopyToSectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the onenotePatchContent method.
        def onenote_patch_content()
            return MicrosoftGraphBeta::Me::Onenote::Pages::Item::OnenotePatchContent::OnenotePatchContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentNotebook property of the microsoft.graph.onenotePage entity.
        def parent_notebook()
            return MicrosoftGraphBeta::Me::Onenote::Pages::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentSection property of the microsoft.graph.onenotePage entity.
        def parent_section()
            return MicrosoftGraphBeta::Me::Onenote::Pages::Item::ParentSection::ParentSectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
