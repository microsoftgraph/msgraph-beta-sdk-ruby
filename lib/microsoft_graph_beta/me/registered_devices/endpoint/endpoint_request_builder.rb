...
module MicrosoftGraphBeta::Me::RegisteredDevices::Endpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::RegisteredDevices::Endpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
