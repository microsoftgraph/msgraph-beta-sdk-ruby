...
module MicrosoftGraphBeta::Me::MailFolders::Item
    ...
    class MailFolderItemRequestBuilder
        ...
        def copy()
            return MicrosoftGraphBeta::Me::MailFolders::Item::Copy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def move()
            return MicrosoftGraphBeta::Me::MailFolders::Item::Move::MoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
