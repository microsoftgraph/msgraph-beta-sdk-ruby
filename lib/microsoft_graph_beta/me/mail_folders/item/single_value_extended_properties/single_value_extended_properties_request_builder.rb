...
module MicrosoftGraphBeta::Me::MailFolders::Item::SingleValueExtendedProperties
    ## 
    ...
    class SingleValueExtendedPropertiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::MailFolders::Item::SingleValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
