...
module MicrosoftGraphBeta::Me::Approvals
    ## 
    ...
    class ApprovalsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Approvals::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/approvals{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
