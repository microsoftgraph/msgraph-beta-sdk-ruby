...
module MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars
    ## 
    ...
    class CalendarsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
