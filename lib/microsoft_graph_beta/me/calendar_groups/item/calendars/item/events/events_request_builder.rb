...
module MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::Events
    ## 
    ...
    class EventsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::Events::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
