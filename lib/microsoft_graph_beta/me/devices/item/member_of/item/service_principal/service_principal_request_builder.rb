...
module MicrosoftGraphBeta::Me::Devices::Item::MemberOf::Item::ServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}"
