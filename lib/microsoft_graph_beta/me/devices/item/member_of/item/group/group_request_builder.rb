...
module MicrosoftGraphBeta::Me::Devices::Item::MemberOf::Item::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.group{?%24select,%24expand}"
