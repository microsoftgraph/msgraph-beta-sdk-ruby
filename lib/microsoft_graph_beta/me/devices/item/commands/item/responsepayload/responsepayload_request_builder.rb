...
module MicrosoftGraphBeta::Me::Devices::Item::Commands::Item::Responsepayload
    ## 
    ...
    class ResponsepayloadRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/commands/{command%2Did}/responsepayload{?%24select,%24expand}"
