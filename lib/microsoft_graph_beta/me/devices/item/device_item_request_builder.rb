...
module MicrosoftGraphBeta::Me::Devices::Item
    ## 
    ...
    class DeviceItemRequestBuilder
        ...
        def member_of()
            return MicrosoftGraphBeta::Me::Devices::Item::MemberOf::MemberOfRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def registered_owners()
            return MicrosoftGraphBeta::Me::Devices::Item::RegisteredOwners::RegisteredOwnersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def transitive_member_of()
            return MicrosoftGraphBeta::Me::Devices::Item::TransitiveMemberOf::TransitiveMemberOfRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def usage_rights()
            return MicrosoftGraphBeta::Me::Devices::Item::UsageRights::UsageRightsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the commands property of the microsoft.graph.device entity.
        ...
        def commands_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Devices::Item::Commands::Item::CommandItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}{?%24select,%24expand}"
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Devices::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get devices from me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def member_of_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Devices::Item::MemberOf::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        ## 
        ## Gets an item from the MicrosoftGraphBeta.me.devices.item.registeredOwners.item collection
        ## @param id Unique identifier of the item
        ## @return a directory_object_item_request_builder
        ## 
        def registered_owners_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Me::Devices::Item::RegisteredOwners::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the registeredUsers property of the microsoft.graph.device entity.
        ## @param id Unique identifier of the item
        ...
        def registered_users_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Me::Devices::Item::RegisteredUsers::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property devices for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def transitive_member_of_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Me::Devices::Item::TransitiveMemberOf::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the usageRights property of the microsoft.graph.device entity.
        ## @param id Unique identifier of the item
        ...
        def usage_rights_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Devices::Item::UsageRights::Item::UsageRightItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
