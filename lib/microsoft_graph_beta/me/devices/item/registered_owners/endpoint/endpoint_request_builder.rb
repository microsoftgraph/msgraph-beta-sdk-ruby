...
module MicrosoftGraphBeta::Me::Devices::Item::RegisteredOwners::Endpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Devices::Item::RegisteredOwners::Endpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
