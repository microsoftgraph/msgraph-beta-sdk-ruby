...
module MicrosoftGraphBeta::Me::Devices::Item::RegisteredUsers
    ...
    class RegisteredUsersRequestBuilder
        ...
        def endpoint()
            return MicrosoftGraphBeta::Me::Devices::Item::RegisteredUsers::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraphBeta::Me::Devices::Item::RegisteredUsers::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Me::Devices::Item::RegisteredUsers::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
