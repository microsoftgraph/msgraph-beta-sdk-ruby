...
module MicrosoftGraphBeta::Me::Calendar::AllowedCalendarSharingRolesWithUser
    ## 
    ...
    class AllowedCalendarSharingRolesWithUserRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Me::Calendar::AllowedCalendarSharingRolesWithUser::AllowedCalendarSharingRolesWithUserResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
