...
module MicrosoftGraphBeta::Me::Calendar::CalendarView::Item::ExceptionOccurrences::Item::Instances::Item::Attachments
    ...
    class AttachmentsRequestBuilder
        ...
        def create_upload_session()
            return MicrosoftGraphBeta::Me::Calendar::CalendarView::Item::ExceptionOccurrences::Item::Instances::Item::Attachments::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
