...
module MicrosoftGraphBeta::Me::Calendar::MultiValueExtendedProperties
    ## 
    ...
    class MultiValueExtendedPropertiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Calendar::MultiValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
