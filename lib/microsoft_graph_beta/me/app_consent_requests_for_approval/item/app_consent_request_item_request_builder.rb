...
module MicrosoftGraphBeta::Me::AppConsentRequestsForApproval::Item
    ## 
    ...
    class AppConsentRequestItemRequestBuilder
        ...
        def user_consent_requests()
            return MicrosoftGraphBeta::Me::AppConsentRequestsForApproval::Item::UserConsentRequests::UserConsentRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/appConsentRequestsForApproval/{appConsentRequest%2Did}{?%24select,%24expand}"
        ...
        def user_consent_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::AppConsentRequestsForApproval::Item::UserConsentRequests::Item::UserConsentRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
