...
module MicrosoftGraphBeta::Me::CalendarView::Item::Instances::Item::ExceptionOccurrences::Item::Attachments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/attachments/$count"
