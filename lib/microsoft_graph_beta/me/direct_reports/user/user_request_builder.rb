...
module MicrosoftGraphBeta::Me::DirectReports::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::DirectReports::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
