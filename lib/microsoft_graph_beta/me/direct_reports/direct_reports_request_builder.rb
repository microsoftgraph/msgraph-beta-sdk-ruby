...
module MicrosoftGraphBeta::Me::DirectReports
    ...
    class DirectReportsRequestBuilder
        ...
        def org_contact()
            return MicrosoftGraphBeta::Me::DirectReports::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Me::DirectReports::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
