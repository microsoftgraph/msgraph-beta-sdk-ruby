...
require_relative './passwordless_microsoft_authenticator_methods/item/passwordless_microsoft_authenticator_authentication_method_item_request_builder'
...
module MicrosoftGraphBeta::Me::Authentication
    ## 
    ...
    class AuthenticationRequestBuilder
        ...
        def email_methods()
            return MicrosoftGraphBeta::Me::Authentication::EmailMethods::EmailMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the fido2Methods property of the microsoft.graph.authentication entity.
        def fido2_methods()
            return MicrosoftGraphBeta::Me::Authentication::Fido2Methods::Fido2MethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the methods property of the microsoft.graph.authentication entity.
        def methods()
            return MicrosoftGraphBeta::Me::Authentication::Methods::MethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the microsoftAuthenticatorMethods property of the microsoft.graph.authentication entity.
        def microsoft_authenticator_methods()
            return MicrosoftGraphBeta::Me::Authentication::MicrosoftAuthenticatorMethods::MicrosoftAuthenticatorMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.authentication entity.
        def operations()
            return MicrosoftGraphBeta::Me::Authentication::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def passwordless_microsoft_authenticator_methods()
            return MicrosoftGraphBeta::Me::Authentication::PasswordlessMicrosoftAuthenticatorMethods::PasswordlessMicrosoftAuthenticatorMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the passwordMethods property of the microsoft.graph.authentication entity.
        def password_methods()
            return MicrosoftGraphBeta::Me::Authentication::PasswordMethods::PasswordMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def phone_methods()
            return MicrosoftGraphBeta::Me::Authentication::PhoneMethods::PhoneMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def software_oath_methods()
            return MicrosoftGraphBeta::Me::Authentication::SoftwareOathMethods::SoftwareOathMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the temporaryAccessPassMethods property of the microsoft.graph.authentication entity.
        def temporary_access_pass_methods()
            return MicrosoftGraphBeta::Me::Authentication::TemporaryAccessPassMethods::TemporaryAccessPassMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def windows_hello_for_business_methods()
            return MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::WindowsHelloForBusinessMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def fido2_methods_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Authentication::Fido2Methods::Item::Fido2AuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get authentication from me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def microsoft_authenticator_methods_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Authentication::MicrosoftAuthenticatorMethods::Item::MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.authentication entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Authentication::Operations::Item::LongRunningOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the passwordlessMicrosoftAuthenticatorMethods property of the microsoft.graph.authentication entity.
        ## @param id Unique identifier of the item
        ...
        ## 
        def passwordless_microsoft_authenticator_methods_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did"] = id
            return MicrosoftGraphBeta::Me::Authentication::PasswordlessMicrosoftAuthenticatorMethods::Item::PasswordlessMicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the passwordMethods property of the microsoft.graph.authentication entity.
        ## @param id Unique identifier of the item
        ...
        def temporary_access_pass_methods_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Authentication::TemporaryAccessPassMethods::Item::TemporaryAccessPassAuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the windowsHelloForBusinessMethods property of the microsoft.graph.authentication entity.
        ## @param id Unique identifier of the item
