...
module MicrosoftGraphBeta::Me::Authentication::Methods::Item::EnableSmsSignIn
    ## 
    ...
    class EnableSmsSignInRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/authentication/methods/{authenticationMethod%2Did}/microsoft.graph.enableSmsSignIn"
