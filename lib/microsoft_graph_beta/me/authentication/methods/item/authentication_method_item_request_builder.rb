...
module MicrosoftGraphBeta::Me::Authentication::Methods::Item
    ...
    class AuthenticationMethodItemRequestBuilder
        ...
        def disable_sms_sign_in()
            return MicrosoftGraphBeta::Me::Authentication::Methods::Item::DisableSmsSignIn::DisableSmsSignInRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the enableSmsSignIn method.
        def enable_sms_sign_in()
            return MicrosoftGraphBeta::Me::Authentication::Methods::Item::EnableSmsSignIn::EnableSmsSignInRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reset_password()
            return MicrosoftGraphBeta::Me::Authentication::Methods::Item::ResetPassword::ResetPasswordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
