...
module MicrosoftGraphBeta::Me::Authentication::PasswordlessMicrosoftAuthenticatorMethods::Item::Device::TransitiveMemberOf::Item::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.group{?%24select,%24expand}"
