...
module MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::RegisteredUsers::Item
    ## 
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def endpoint()
            return MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::RegisteredUsers::Item::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::RegisteredUsers::Item::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::RegisteredUsers::Item::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
