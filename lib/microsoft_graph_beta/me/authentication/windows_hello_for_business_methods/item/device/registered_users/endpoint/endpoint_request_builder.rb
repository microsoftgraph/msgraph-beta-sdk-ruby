...
module MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::RegisteredUsers::Endpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::RegisteredUsers::Endpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
