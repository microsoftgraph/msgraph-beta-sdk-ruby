...
module MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::TransitiveMemberOf::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::TransitiveMemberOf::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
