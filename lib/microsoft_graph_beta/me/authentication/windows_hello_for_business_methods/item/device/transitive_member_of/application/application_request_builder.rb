...
module MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::TransitiveMemberOf::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::TransitiveMemberOf::Application::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
