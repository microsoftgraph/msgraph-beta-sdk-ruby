...
module MicrosoftGraphBeta::Me::Drives::Item::Items
    ## 
    ...
    class ItemsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
