...
module MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem
    ## 
    ...
    class ListItemRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the analytics property of the microsoft.graph.listItem entity.
        def analytics()
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createLink method.
        def create_link()
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::CreateLink::CreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the documentSetVersions property of the microsoft.graph.listItem entity.
        def document_set_versions()
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::DocumentSetVersions::DocumentSetVersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the driveItem property of the microsoft.graph.listItem entity.
        def drive_item()
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the fields property of the microsoft.graph.listItem entity.
        def fields()
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def versions()
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the activities property of the microsoft.graph.listItem entity.
        ...
        def activities_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::Activities::Item::ItemActivityOLDItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def document_set_versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::DocumentSetVersions::Item::DocumentSetVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## For drives in SharePoint, the associated document library list item. Read-only. Nullable.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::Versions::Item::ListItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
