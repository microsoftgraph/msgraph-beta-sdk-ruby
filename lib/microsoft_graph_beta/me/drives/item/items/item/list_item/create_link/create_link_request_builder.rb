...
module MicrosoftGraphBeta::Me::Drives::Item::Items::Item::ListItem::CreateLink
    ## 
    ...
    class CreateLinkRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/microsoft.graph.createLink"
