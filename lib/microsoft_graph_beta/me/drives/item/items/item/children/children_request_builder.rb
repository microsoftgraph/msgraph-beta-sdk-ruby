...
module MicrosoftGraphBeta::Me::Drives::Item::Items::Item::Children
    ## 
    ...
    class ChildrenRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::Children::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
