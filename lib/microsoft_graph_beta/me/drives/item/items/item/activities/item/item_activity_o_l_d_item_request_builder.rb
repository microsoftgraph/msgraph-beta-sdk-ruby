...
module MicrosoftGraphBeta::Me::Drives::Item::Items::Item::Activities::Item
    ## 
    ...
    class ItemActivityOLDItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}"
