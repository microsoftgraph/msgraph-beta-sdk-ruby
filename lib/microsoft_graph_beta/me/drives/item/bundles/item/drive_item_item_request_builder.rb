...
module MicrosoftGraphBeta::Me::Drives::Item::Bundles::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Me::Drives::Item::Bundles::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
