...
module MicrosoftGraphBeta::Me::Drives::Item::Bundles
    ## 
    ...
    class BundlesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Drives::Item::Bundles::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
