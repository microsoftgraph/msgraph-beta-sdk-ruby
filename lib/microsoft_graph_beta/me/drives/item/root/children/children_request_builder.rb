...
module MicrosoftGraphBeta::Me::Drives::Item::Root::Children
    ## 
    ...
    class ChildrenRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Drives::Item::Root::Children::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
