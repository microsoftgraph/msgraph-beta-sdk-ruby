...
module MicrosoftGraphBeta::Me::Drives::Item::Root::Thumbnails
    ## 
    ...
    class ThumbnailsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Drives::Item::Root::Thumbnails::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
