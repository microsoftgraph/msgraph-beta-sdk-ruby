...
module MicrosoftGraphBeta::Me::Drives::Item::Root::ListItem::Activities::Item::DriveItem::Content
    ## 
    ...
    class ContentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/activities/{itemActivityOLD%2Did}/driveItem/content"
