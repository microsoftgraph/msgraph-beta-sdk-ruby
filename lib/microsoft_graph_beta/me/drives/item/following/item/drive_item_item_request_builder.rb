...
module MicrosoftGraphBeta::Me::Drives::Item::Following::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Me::Drives::Item::Following::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
