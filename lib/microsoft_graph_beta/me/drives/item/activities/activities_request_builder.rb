...
module MicrosoftGraphBeta::Me::Drives::Item::Activities
    ## 
    ...
    class ActivitiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Drives::Item::Activities::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
