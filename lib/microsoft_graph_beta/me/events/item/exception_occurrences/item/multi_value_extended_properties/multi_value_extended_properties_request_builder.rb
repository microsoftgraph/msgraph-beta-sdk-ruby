...
module MicrosoftGraphBeta::Me::Events::Item::ExceptionOccurrences::Item::MultiValueExtendedProperties
    ## 
    ...
    class MultiValueExtendedPropertiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Events::Item::ExceptionOccurrences::Item::MultiValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
