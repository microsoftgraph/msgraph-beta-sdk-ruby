...
module MicrosoftGraphBeta::Me::Calendars::Item::CalendarView::Item::Instances::Item::ExceptionOccurrences::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/$count"
