...
module MicrosoftGraphBeta::Me::Calendars::Item::Events::Item::Instances::Item::MultiValueExtendedProperties
    ## 
    ...
    class MultiValueExtendedPropertiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Calendars::Item::Events::Item::Instances::Item::MultiValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
