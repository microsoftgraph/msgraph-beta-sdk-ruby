...
module MicrosoftGraphBeta::Me::Calendars::Item::SingleValueExtendedProperties
    ## 
    ...
    class SingleValueExtendedPropertiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Calendars::Item::SingleValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
