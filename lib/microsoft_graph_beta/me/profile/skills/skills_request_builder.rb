...
module MicrosoftGraphBeta::Me::Profile::Skills
    ## 
    ...
    class SkillsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Profile::Skills::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/profile/skills{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
