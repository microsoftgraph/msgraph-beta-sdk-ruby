...
module MicrosoftGraphBeta::Me::InferenceClassification::Overrides
    ## 
    ...
    class OverridesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::InferenceClassification::Overrides::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
