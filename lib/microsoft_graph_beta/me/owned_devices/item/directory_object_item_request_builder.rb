...
module MicrosoftGraphBeta::Me::OwnedDevices::Item
    ## 
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def device()
            return MicrosoftGraphBeta::Me::OwnedDevices::Item::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def endpoint()
            return MicrosoftGraphBeta::Me::OwnedDevices::Item::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
