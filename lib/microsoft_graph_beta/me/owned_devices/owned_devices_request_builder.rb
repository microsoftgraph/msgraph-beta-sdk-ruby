...
module MicrosoftGraphBeta::Me::OwnedDevices
    ## 
    ...
    class OwnedDevicesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::OwnedDevices::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to device.
        def device()
            return MicrosoftGraphBeta::Me::OwnedDevices::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def endpoint()
            return MicrosoftGraphBeta::Me::OwnedDevices::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
