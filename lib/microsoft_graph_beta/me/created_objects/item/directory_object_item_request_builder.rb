...
module MicrosoftGraphBeta::Me::CreatedObjects::Item
    ## 
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def service_principal()
            return MicrosoftGraphBeta::Me::CreatedObjects::Item::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
