...
module MicrosoftGraphBeta::Me::Chats::Item::PermissionGrants
    ## 
    ...
    class PermissionGrantsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Chats::Item::PermissionGrants::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getByIds method.
        def get_by_ids()
            return MicrosoftGraphBeta::Me::Chats::Item::PermissionGrants::GetByIds::GetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getUserOwnedObjects method.
        def get_user_owned_objects()
            return MicrosoftGraphBeta::Me::Chats::Item::PermissionGrants::GetUserOwnedObjects::GetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def validate_properties()
            return MicrosoftGraphBeta::Me::Chats::Item::PermissionGrants::ValidateProperties::ValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/chats/{chat%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
