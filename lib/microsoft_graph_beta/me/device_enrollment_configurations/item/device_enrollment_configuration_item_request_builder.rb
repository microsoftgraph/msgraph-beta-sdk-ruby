...
module MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::Item
    ...
    class DeviceEnrollmentConfigurationItemRequestBuilder
        ...
        def assign()
            return MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::Item::Assign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set_priority()
            return MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::Item::SetPriority::SetPriorityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
