...
module MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::HasPayloadLinks
    ...
    class HasPayloadLinksRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::HasPayloadLinks::HasPayloadLinksResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
