...
module MicrosoftGraphBeta::Me::Security::InformationProtection
    ## 
    ...
    class InformationProtectionRequestBuilder
        ...
        def label_policy_settings()
            return MicrosoftGraphBeta::Me::Security::InformationProtection::LabelPolicySettings::LabelPolicySettingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def sensitivity_labels()
            return MicrosoftGraphBeta::Me::Security::InformationProtection::SensitivityLabels::SensitivityLabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/security/informationProtection{?%24select,%24expand}"
