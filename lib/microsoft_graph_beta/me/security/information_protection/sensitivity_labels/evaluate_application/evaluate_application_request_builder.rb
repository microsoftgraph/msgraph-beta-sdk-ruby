...
module MicrosoftGraphBeta::Me::Security::InformationProtection::SensitivityLabels::EvaluateApplication
    ...
    class EvaluateApplicationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/security/informationProtection/sensitivityLabels/microsoft.graph.security.evaluateApplication"
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Me::Security::InformationProtection::SensitivityLabels::EvaluateApplication::EvaluateApplicationResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
