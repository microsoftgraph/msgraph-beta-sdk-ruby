...
module MicrosoftGraphBeta::Me::AgreementAcceptances
    ## 
    ...
    class AgreementAcceptancesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::AgreementAcceptances::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
