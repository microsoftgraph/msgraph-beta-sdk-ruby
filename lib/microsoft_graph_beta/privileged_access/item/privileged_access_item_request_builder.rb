...
require_relative './resources/item/governance_resource_item_request_builder'
...
module MicrosoftGraphBeta::PrivilegedAccess::Item
    ## 
    ...
    class PrivilegedAccessItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}{?%24select,%24expand}"
        ...
        ## Get entity from privilegedAccess by key
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of privileged_access
        ## 
        ...
        def resources_by_id(id)
            ...
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::GovernanceResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleAssignmentRequests property of the microsoft.graph.privilegedAccess entity.
        ## @param id Unique identifier of the item
        ...
        def role_assignment_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignmentRequests::Item::GovernanceRoleAssignmentRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleAssignments property of the microsoft.graph.privilegedAccess entity.
        ## @param id Unique identifier of the item
        ...
        def role_assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignments::Item::GovernanceRoleAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleDefinitions property of the microsoft.graph.privilegedAccess entity.
        ## @param id Unique identifier of the item
        ...
        def role_definitions_by_id(id)
            ...
            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleDefinitions::Item::GovernanceRoleDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleSettings property of the microsoft.graph.privilegedAccess entity.
        ## @param id Unique identifier of the item
