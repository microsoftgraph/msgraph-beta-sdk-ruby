...
module MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignments::Item
    ## 
    ...
    class GovernanceRoleAssignmentItemRequestBuilder
        ...
        def linked_eligible_role_assignment()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignments::Item::LinkedEligibleRoleAssignment::LinkedEligibleRoleAssignmentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resource()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignments::Item::Resource::ResourceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleDefinition property of the microsoft.graph.governanceRoleAssignment entity.
        def role_definition()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignments::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the subject property of the microsoft.graph.governanceRoleAssignment entity.
        def subject()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignments::Item::Subject::SubjectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleAssignments/{governanceRoleAssignment%2Did}{?%24select,%24expand}"
        ...
        ## The collection of role assignments for the resource.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of governance_role_assignment
        ## 
