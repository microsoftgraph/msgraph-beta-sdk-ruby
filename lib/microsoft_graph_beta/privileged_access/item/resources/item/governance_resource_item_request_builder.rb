...
module MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item
    ## 
    ...
    class GovernanceResourceItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}{?%24select,%24expand}"
        ...
        ## A collection of resources for the provider.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of governance_resource
        ## 
        ...
        def role_assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignments::Item::GovernanceRoleAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleDefinitions property of the microsoft.graph.governanceResource entity.
        ## @param id Unique identifier of the item
        ...
        def role_definitions_by_id(id)
            ...
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleDefinitions::Item::GovernanceRoleDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleSettings property of the microsoft.graph.governanceResource entity.
        ## @param id Unique identifier of the item
        ...
        def role_settings_by_id(id)
            ...
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleSettings::Item::GovernanceRoleSettingItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
