...
module MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions
    ## 
    ...
    class SessionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/dataClassification/exactMatchDataStores/{exactMatchDataStore%2Did}/sessions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get sessions from dataClassification
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of exact_match_session_collection_response
        ## 
