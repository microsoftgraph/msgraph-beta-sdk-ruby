...
require_relative './upload_agent/upload_agent_request_builder'

module MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item
    ## 
    ...
    class ExactMatchSessionItemRequestBuilder
        ...
        def cancel()
            return MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the commit method.
        def commit()
            return MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item::Commit::CommitRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def renew()
            return MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item::Renew::RenewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def upload_agent()
            return MicrosoftGraphBeta::DataClassification::ExactMatchDataStores::Item::Sessions::Item::UploadAgent::UploadAgentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/dataClassification/exactMatchDataStores/{exactMatchDataStore%2Did}/sessions/{exactMatchSession%2Did}{?%24select,%24expand}"
        ...
        ## Get sessions from dataClassification
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of exact_match_session
        ## 
