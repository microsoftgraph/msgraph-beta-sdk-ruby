...
module MicrosoftGraphBeta::DataClassification::ClassifyFileJobs::Item
    ## 
    ...
    class JobResponseBaseItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/dataClassification/classifyFileJobs/{jobResponseBase%2Did}{?%24select,%24expand}"
