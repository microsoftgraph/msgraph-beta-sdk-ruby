...
module MicrosoftGraphBeta::DataClassification::SensitivityLabels::Item
    ## 
    ...
    class SensitivityLabelItemRequestBuilder
        ...
        def sublabels()
            return MicrosoftGraphBeta::DataClassification::SensitivityLabels::Item::Sublabels::SublabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/dataClassification/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}"
        ...
        def sublabels_by_id(id)
            ...
            return MicrosoftGraphBeta::DataClassification::SensitivityLabels::Item::Sublabels::Item::SensitivityLabelItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
