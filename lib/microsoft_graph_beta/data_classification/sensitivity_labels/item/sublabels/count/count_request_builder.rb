...
module MicrosoftGraphBeta::DataClassification::SensitivityLabels::Item::Sublabels::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/dataClassification/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/$count"
