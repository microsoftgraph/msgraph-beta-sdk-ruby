...
module MicrosoftGraphBeta::AccessReviews::Item::Instances::Item
    ## 
    ...
    class AccessReviewItemRequestBuilder
        ...
        def apply_decisions()
            return MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::ApplyDecisions::ApplyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the decisions property of the microsoft.graph.accessReview entity.
        def decisions()
            return MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::Decisions::DecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the myDecisions property of the microsoft.graph.accessReview entity.
        def my_decisions()
            return MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::MyDecisions::MyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reset_decisions()
            return MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::ResetDecisions::ResetDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the reviewers property of the microsoft.graph.accessReview entity.
        def reviewers()
            return MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::Reviewers::ReviewersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendReminder method.
        def send_reminder()
            return MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::SendReminder::SendReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the stop method.
        def stop()
            return MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::Stop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}{?%24select,%24expand}"
        ...
        def decisions_by_id(id)
            ...
            return MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::Decisions::Item::AccessReviewDecisionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property instances for accessReviews
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def my_decisions_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["accessReviewDecision%2Did"] = id
            return MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::MyDecisions::Item::AccessReviewDecisionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property instances in accessReviews
        ## @param body The request body
        ...
        def reviewers_by_id(id)
            ...
            return MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::Reviewers::Item::AccessReviewReviewerItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
