...
module MicrosoftGraphBeta::AccessReviews::Item::Instances::Item::MyDecisions::Item
    ## 
    ...
    class AccessReviewDecisionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/accessReviews/{accessReview%2Did}/instances/{accessReview%2Did1}/myDecisions/{accessReviewDecision%2Did}{?%24select,%24expand}"
        ...
        ## The collection of decisions for the caller, if the caller is a reviewer.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of access_review_decision
        ## 
