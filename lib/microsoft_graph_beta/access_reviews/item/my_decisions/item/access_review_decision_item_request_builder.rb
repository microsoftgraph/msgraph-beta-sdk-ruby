...
module MicrosoftGraphBeta::AccessReviews::Item::MyDecisions::Item
    ## 
    ...
    class AccessReviewDecisionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/accessReviews/{accessReview%2Did}/myDecisions/{accessReviewDecision%2Did}{?%24select,%24expand}"
