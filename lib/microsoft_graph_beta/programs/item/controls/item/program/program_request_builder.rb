...
module MicrosoftGraphBeta::Programs::Item::Controls::Item::Program
    ## 
    ...
    class ProgramRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/programs/{program%2Did}/controls/{programControl%2Did}/program{?%24select,%24expand}"
