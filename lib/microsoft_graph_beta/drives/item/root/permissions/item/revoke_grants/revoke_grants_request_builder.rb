...
module MicrosoftGraphBeta::Drives::Item::Root::Permissions::Item::RevokeGrants
    ## 
    ...
    class RevokeGrantsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/root/permissions/{permission%2Did}/microsoft.graph.revokeGrants"
