...
module MicrosoftGraphBeta::Drives::Item::Activities::Item::DriveItem::Content
    ## 
    ...
    class ContentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}/driveItem/content"
