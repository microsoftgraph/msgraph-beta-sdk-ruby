...
module MicrosoftGraphBeta::Drives::Item::List::Items::Item
    ## 
    ...
    class ListItemItemRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Drives::Item::List::Items::Item::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the analytics property of the microsoft.graph.listItem entity.
        def analytics()
            return MicrosoftGraphBeta::Drives::Item::List::Items::Item::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createLink method.
        def create_link()
            return MicrosoftGraphBeta::Drives::Item::List::Items::Item::CreateLink::CreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the documentSetVersions property of the microsoft.graph.listItem entity.
        def document_set_versions()
            return MicrosoftGraphBeta::Drives::Item::List::Items::Item::DocumentSetVersions::DocumentSetVersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the driveItem property of the microsoft.graph.listItem entity.
        def drive_item()
            return MicrosoftGraphBeta::Drives::Item::List::Items::Item::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the fields property of the microsoft.graph.listItem entity.
        def fields()
            return MicrosoftGraphBeta::Drives::Item::List::Items::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def versions()
            return MicrosoftGraphBeta::Drives::Item::List::Items::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the activities property of the microsoft.graph.listItem entity.
        ...
        def activities_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::List::Items::Item::Activities::Item::ItemActivityOLDItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def document_set_versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::List::Items::Item::DocumentSetVersions::Item::DocumentSetVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## All items contained in the list.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::List::Items::Item::Versions::Item::ListItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
