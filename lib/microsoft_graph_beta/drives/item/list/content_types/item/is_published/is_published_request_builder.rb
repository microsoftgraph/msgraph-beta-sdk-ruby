...
module MicrosoftGraphBeta::Drives::Item::List::ContentTypes::Item::IsPublished
    ## 
    ...
    class IsPublishedRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Drives::Item::List::ContentTypes::Item::IsPublished::IsPublishedResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function isPublished
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
