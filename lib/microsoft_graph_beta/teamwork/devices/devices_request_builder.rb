...
require_relative '../../models/teamwork_device_collection_response'
require_relative '../teamwork'
require_relative './count/count_request_builder'
require_relative './devices'

module MicrosoftGraphBeta::Teamwork::Devices
    ## 
    ...
    class DevicesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Teamwork::Devices::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamwork/devices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get a list of all Microsoft Teams-enabled devices provisioned for a tenant.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of teamwork_device_collection_response
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TeamworkDeviceCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Create new navigation property to devices for teamwork
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of teamwork_device
        ## 
