...
require_relative '../../../../models/teamwork_device_health'
require_relative '../../../teamwork'
require_relative '../../devices'
require_relative '../item'
require_relative './health'

module MicrosoftGraphBeta::Teamwork::Devices::Item::Health
    ## 
    ...
    class HealthRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamwork/devices/{teamworkDevice%2Did}/health{?%24select,%24expand}"
        ...
        ## Get the health details of a Microsoft Teams-enabled device. Device health is calculated based on the device configuration and other device parameters.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of teamwork_device_health
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TeamworkDeviceHealth.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property health in teamwork
        ## @param body The request body
