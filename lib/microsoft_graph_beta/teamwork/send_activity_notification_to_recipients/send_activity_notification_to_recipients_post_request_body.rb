...
module MicrosoftGraphBeta::Teamwork::SendActivityNotificationToRecipients
    class SendActivityNotificationToRecipientsPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "recipients" => lambda {|n| @recipients = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::TeamworkNotificationRecipient.create_from_discriminator_value(pn) }) },
