...
module MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::Messages::Item::Replies
    ## 
    ...
    class RepliesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::Messages::Item::Replies::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
