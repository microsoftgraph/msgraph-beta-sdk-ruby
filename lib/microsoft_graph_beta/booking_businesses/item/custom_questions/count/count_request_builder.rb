...
module MicrosoftGraphBeta::BookingBusinesses::Item::CustomQuestions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/customQuestions/$count"
