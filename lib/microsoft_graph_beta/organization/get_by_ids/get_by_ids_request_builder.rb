...
module MicrosoftGraphBeta::Organization::GetByIds
    ## 
    ...
    class GetByIdsRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Organization::GetByIds::GetByIdsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
