...
module MicrosoftGraphBeta::Organization::Item::Settings::ItemInsights
    ## 
    ...
    class ItemInsightsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/organization/{organization%2Did}/settings/itemInsights{?%24select,%24expand}"
