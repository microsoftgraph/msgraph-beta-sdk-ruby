...
module MicrosoftGraphBeta::Organization::Item::Settings::ContactInsights
    ## 
    ...
    class ContactInsightsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/organization/{organization%2Did}/settings/contactInsights{?%24select,%24expand}"
        ...
        ## Get the properties of an insightsSettings object for displaying or returning contact insights in an organization.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of insights_settings
        ## 
