...
require_relative '../../../../models/microsoft_application_data_access_settings'
require_relative '../../../../models/o_data_errors/o_data_error'
require_relative '../../../organization'
require_relative '../../item'
require_relative '../settings'
require_relative './microsoft_application_data_access'

module MicrosoftGraphBeta::Organization::Item::Settings::MicrosoftApplicationDataAccess
    ## 
    ...
    class MicrosoftApplicationDataAccessRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/organization/{organization%2Did}/settings/microsoftApplicationDataAccess{?%24select,%24expand}"
        ...
        ## Get the _settings_ in a microsoftApplicationDataAccessSettings object that specify access from Microsoft applications to Microsoft 365 user data in an organization.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of microsoft_application_data_access_settings
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::MicrosoftApplicationDataAccessSettings.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the settings in a microsoftApplicationDataAccessSettings object that specify access from Microsoft applications to Microsoft 365 user data in an organization.
        ## @param body The request body
