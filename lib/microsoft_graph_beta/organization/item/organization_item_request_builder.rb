...
require_relative './activate_service/activate_service_request_builder'
...
module MicrosoftGraphBeta::Organization::Item
    ...
    class OrganizationItemRequestBuilder
        ...
        def activate_service()
            return MicrosoftGraphBeta::Organization::Item::ActivateService::ActivateServiceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def check_member_groups()
            return MicrosoftGraphBeta::Organization::Item::CheckMemberGroups::CheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def check_member_objects()
            return MicrosoftGraphBeta::Organization::Item::CheckMemberObjects::CheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get_member_groups()
            return MicrosoftGraphBeta::Organization::Item::GetMemberGroups::GetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def get_member_objects()
            return MicrosoftGraphBeta::Organization::Item::GetMemberObjects::GetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore()
            return MicrosoftGraphBeta::Organization::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setMobileDeviceManagementAuthority method.
        def set_mobile_device_management_authority()
            return MicrosoftGraphBeta::Organization::Item::SetMobileDeviceManagementAuthority::SetMobileDeviceManagementAuthorityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
