...
module MicrosoftGraphBeta::Organization::Item::Branding
    ## 
    ...
    class BrandingRequestBuilder
        ...
        def background_image()
            return MicrosoftGraphBeta::Organization::Item::Branding::BackgroundImage::BackgroundImageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organization entity.
        def banner_logo()
            return MicrosoftGraphBeta::Organization::Item::Branding::BannerLogo::BannerLogoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organization entity.
        def custom_c_s_s()
            return MicrosoftGraphBeta::Organization::Item::Branding::CustomCSS::CustomCSSRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organization entity.
        def favicon()
            return MicrosoftGraphBeta::Organization::Item::Branding::Favicon::FaviconRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organization entity.
        def header_logo()
            return MicrosoftGraphBeta::Organization::Item::Branding::HeaderLogo::HeaderLogoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the localizations property of the microsoft.graph.organizationalBranding entity.
        def localizations()
            return MicrosoftGraphBeta::Organization::Item::Branding::Localizations::LocalizationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        # Provides operations to manage the media for the organization entity.
        def square_logo()
            return MicrosoftGraphBeta::Organization::Item::Branding::SquareLogo::SquareLogoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organization entity.
        def square_logo_dark()
            return MicrosoftGraphBeta::Organization::Item::Branding::SquareLogoDark::SquareLogoDarkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::OrganizationalBranding.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the localizations property of the microsoft.graph.organizationalBranding entity.
        ...
        def localizations_by_id(id)
            ...
            return MicrosoftGraphBeta::Organization::Item::Branding::Localizations::Item::OrganizationalBrandingLocalizationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the properties of the default branding object specified by the organizationalBranding resource.
        ## @param body The request body
