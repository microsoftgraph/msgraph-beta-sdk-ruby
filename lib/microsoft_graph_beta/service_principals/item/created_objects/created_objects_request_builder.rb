...
module MicrosoftGraphBeta::ServicePrincipals::Item::CreatedObjects
    ## 
    ...
    class CreatedObjectsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::CreatedObjects::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraphBeta::ServicePrincipals::Item::CreatedObjects::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
