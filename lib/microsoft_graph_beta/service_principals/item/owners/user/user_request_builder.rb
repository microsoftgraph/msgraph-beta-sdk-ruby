...
module MicrosoftGraphBeta::ServicePrincipals::Item::Owners::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
