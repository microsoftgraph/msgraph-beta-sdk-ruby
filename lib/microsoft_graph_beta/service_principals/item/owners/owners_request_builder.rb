...
module MicrosoftGraphBeta::ServicePrincipals::Item::Owners
    ## 
    ...
    class OwnersRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def endpoint()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def ref()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
