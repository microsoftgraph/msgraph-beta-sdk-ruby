...
module MicrosoftGraphBeta::ServicePrincipals::Item::LicenseDetails::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/licenseDetails/$count"
