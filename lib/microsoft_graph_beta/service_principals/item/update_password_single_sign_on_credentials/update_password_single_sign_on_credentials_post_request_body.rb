...
module MicrosoftGraphBeta::ServicePrincipals::Item::UpdatePasswordSingleSignOnCredentials
    ## 
    # Provides operations to call the updatePasswordSingleSignOnCredentials method.
    class UpdatePasswordSingleSignOnCredentialsPostRequestBody
        ...
        ## @return a update_password_single_sign_on_credentials_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return UpdatePasswordSingleSignOnCredentialsPostRequestBody.new
        end
        ## 
