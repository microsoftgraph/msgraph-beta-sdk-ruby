...
module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::Item::Schema::Directories::Item
    ## 
    ...
    class DirectoryDefinitionItemRequestBuilder
        ...
        def discover()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::Item::Schema::Directories::Item::Discover::DiscoverRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories/{directoryDefinition%2Did}{?%24select,%24expand}"
