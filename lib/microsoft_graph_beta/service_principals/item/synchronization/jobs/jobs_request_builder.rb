...
module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs
    ...
    class JobsRequestBuilder
        ...
        def validate_credentials()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::ValidateCredentials::ValidateCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## List existing jobs for a given application instance (service principal).
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of synchronization_job_collection_response
        ## 
