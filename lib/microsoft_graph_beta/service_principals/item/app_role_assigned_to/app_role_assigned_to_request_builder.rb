...
module MicrosoftGraphBeta::ServicePrincipals::Item::AppRoleAssignedTo
    ## 
    ...
    class AppRoleAssignedToRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::AppRoleAssignedTo::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
