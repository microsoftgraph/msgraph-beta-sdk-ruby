...
module MicrosoftGraphBeta::Directory::ImpactedResources::Item
    ...
    class RecommendationResourceItemRequestBuilder
        ...
        def complete()
            return MicrosoftGraphBeta::Directory::ImpactedResources::Item::Complete::CompleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the dismiss method.
        def dismiss()
            return MicrosoftGraphBeta::Directory::ImpactedResources::Item::Dismiss::DismissRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def postpone()
            return MicrosoftGraphBeta::Directory::ImpactedResources::Item::Postpone::PostponeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reactivate method.
        def reactivate()
            return MicrosoftGraphBeta::Directory::ImpactedResources::Item::Reactivate::ReactivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/impactedResources/{recommendationResource%2Did}{?%24select,%24expand}"
        ...
        ## Get impactedResources from directory
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of recommendation_resource
        ## 
