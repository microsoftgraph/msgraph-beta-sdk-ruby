...
module MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::Members::ServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::Members::ServicePrincipal::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
