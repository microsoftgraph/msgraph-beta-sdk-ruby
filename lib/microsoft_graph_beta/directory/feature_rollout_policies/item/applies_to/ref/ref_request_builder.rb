...
module MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::Ref
    ## 
    ...
    class RefRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}/appliesTo/$ref{?%24top,%24skip,%24search,%24filter,%24count,%24orderby}"
