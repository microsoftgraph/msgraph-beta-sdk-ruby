...
module MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo
    ## 
    ...
    class AppliesToRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getByIds method.
        def get_by_ids()
            return MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::GetByIds::GetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getUserOwnedObjects method.
        def get_user_owned_objects()
            return MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::GetUserOwnedObjects::GetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def ref()
            return MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def validate_properties()
            return MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::ValidateProperties::ValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}/appliesTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
