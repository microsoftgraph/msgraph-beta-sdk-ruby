...
module MicrosoftGraphBeta::Directory::Recommendations
    ## 
    ...
    class RecommendationsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/recommendations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get recommendations from directory
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of recommendation_collection_response
        ## 
