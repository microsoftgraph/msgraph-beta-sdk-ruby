...
module MicrosoftGraphBeta::Directory::Recommendations::Item
    ## 
    ...
    class RecommendationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/recommendations/{recommendation%2Did}{?%24select,%24expand}"
        ...
        def impacted_resources_by_id(id)
            ...
            return MicrosoftGraphBeta::Directory::Recommendations::Item::ImpactedResources::Item::RecommendationResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
