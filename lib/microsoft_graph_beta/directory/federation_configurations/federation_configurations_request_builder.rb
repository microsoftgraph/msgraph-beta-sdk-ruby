...
module MicrosoftGraphBeta::Directory::FederationConfigurations
    ## 
    ...
    class FederationConfigurationsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Directory::FederationConfigurations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
