...
module MicrosoftGraphBeta::Connections::Item::Groups::Item
    ## 
    ...
    class ExternalGroupItemRequestBuilder
        ...
        def members()
            return MicrosoftGraphBeta::Connections::Item::Groups::Item::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
