...
module MicrosoftGraphBeta::Connections::Item::Items::Item::Activities::Item
    ## 
    ...
    class ExternalActivityItemRequestBuilder
        ...
        def performed_by()
            return MicrosoftGraphBeta::Connections::Item::Items::Item::Activities::Item::PerformedBy::PerformedByRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}/activities/{externalActivity%2Did}{?%24select,%24expand}"
