...
require_relative './upload_pkcs12'

module MicrosoftGraphBeta::TrustFramework::KeySets::Item::UploadPkcs12
    ## 
    ...
    class UploadPkcs12RequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/trustFramework/keySets/{trustFrameworkKeySet%2Did}/microsoft.graph.uploadPkcs12"
