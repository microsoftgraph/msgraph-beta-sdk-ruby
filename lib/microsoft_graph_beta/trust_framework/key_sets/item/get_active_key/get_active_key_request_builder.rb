...
module MicrosoftGraphBeta::TrustFramework::KeySets::Item::GetActiveKey
    ## 
    ...
    class GetActiveKeyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/trustFramework/keySets/{trustFrameworkKeySet%2Did}/microsoft.graph.getActiveKey()"
