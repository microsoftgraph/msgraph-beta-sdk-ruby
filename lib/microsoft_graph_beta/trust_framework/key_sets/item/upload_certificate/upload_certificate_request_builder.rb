...
module MicrosoftGraphBeta::TrustFramework::KeySets::Item::UploadCertificate
    ## 
    ...
    class UploadCertificateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/trustFramework/keySets/{trustFrameworkKeySet%2Did}/microsoft.graph.uploadCertificate"
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of trust_framework_key
        ## 
