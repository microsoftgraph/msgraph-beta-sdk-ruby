...
module MicrosoftGraphBeta::GovernanceRoleSettings::Item
    ## 
    ...
    class GovernanceRoleSettingItemRequestBuilder
        ...
        def resource()
            return MicrosoftGraphBeta::GovernanceRoleSettings::Item::Resource::ResourceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleDefinition property of the microsoft.graph.governanceRoleSetting entity.
        def role_definition()
            return MicrosoftGraphBeta::GovernanceRoleSettings::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}{?%24select,%24expand}"
