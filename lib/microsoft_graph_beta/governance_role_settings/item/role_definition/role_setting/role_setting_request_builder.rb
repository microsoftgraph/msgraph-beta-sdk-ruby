...
module MicrosoftGraphBeta::GovernanceRoleSettings::Item::RoleDefinition::RoleSetting
    ## 
    ...
    class RoleSettingRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}/roleDefinition/roleSetting{?%24select,%24expand}"
