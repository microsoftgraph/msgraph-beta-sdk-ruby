...
module MicrosoftGraphBeta::GovernanceRoleSettings::Item::RoleDefinition
    ## 
    ...
    class RoleDefinitionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}/roleDefinition{?%24select,%24expand}"
