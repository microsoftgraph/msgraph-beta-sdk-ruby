...
module MicrosoftGraphBeta::Shares::Item::Permission
    ## 
    ...
    class PermissionRequestBuilder
        ...
        def grant()
            return MicrosoftGraphBeta::Shares::Item::Permission::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def revoke_grants()
            return MicrosoftGraphBeta::Shares::Item::Permission::RevokeGrants::RevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
