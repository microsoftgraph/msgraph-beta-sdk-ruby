...
module MicrosoftGraphBeta::Shares::Item::ListItem
    ## 
    ...
    class ListItemRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Shares::Item::ListItem::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the analytics property of the microsoft.graph.listItem entity.
        def analytics()
            return MicrosoftGraphBeta::Shares::Item::ListItem::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createLink method.
        def create_link()
            return MicrosoftGraphBeta::Shares::Item::ListItem::CreateLink::CreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the documentSetVersions property of the microsoft.graph.listItem entity.
        def document_set_versions()
            return MicrosoftGraphBeta::Shares::Item::ListItem::DocumentSetVersions::DocumentSetVersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the driveItem property of the microsoft.graph.listItem entity.
        def drive_item()
            return MicrosoftGraphBeta::Shares::Item::ListItem::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the fields property of the microsoft.graph.listItem entity.
        def fields()
            return MicrosoftGraphBeta::Shares::Item::ListItem::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def versions()
            return MicrosoftGraphBeta::Shares::Item::ListItem::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the activities property of the microsoft.graph.listItem entity.
        ...
        def activities_by_id(id)
            ...
            return MicrosoftGraphBeta::Shares::Item::ListItem::Activities::Item::ItemActivityOLDItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def document_set_versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Shares::Item::ListItem::DocumentSetVersions::Item::DocumentSetVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Shares::Item::ListItem::Versions::Item::ListItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
