...
module MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item
    ## 
    ...
    class ContentTypeItemRequestBuilder
        ...
        def associate_with_hub_sites()
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::AssociateWithHubSites::AssociateWithHubSitesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the base property of the microsoft.graph.contentType entity.
        def base()
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::Base::BaseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the baseTypes property of the microsoft.graph.contentType entity.
        def base_types()
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::BaseTypes::BaseTypesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
        def column_links()
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::ColumnLinks::ColumnLinksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the columnPositions property of the microsoft.graph.contentType entity.
        def column_positions()
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::ColumnPositions::ColumnPositionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the columns property of the microsoft.graph.contentType entity.
        def columns()
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::Columns::ColumnsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToDefaultContentLocation method.
        def copy_to_default_content_location()
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::CopyToDefaultContentLocation::CopyToDefaultContentLocationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def publish()
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::Publish::PublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def unpublish()
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::Unpublish::UnpublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def base_types_by_id(id)
            ...
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::BaseTypes::Item::ContentTypeItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
        ## @param id Unique identifier of the item
        ...
        def column_links_by_id(id)
            ...
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::ColumnLinks::Item::ColumnLinkItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the columnPositions property of the microsoft.graph.contentType entity.
        ## @param id Unique identifier of the item
        ...
        def column_positions_by_id(id)
            ...
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::ColumnPositions::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the columns property of the microsoft.graph.contentType entity.
        ## @param id Unique identifier of the item
        ...
        def columns_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["columnDefinition%2Did"] = id
            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::Item::Columns::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
