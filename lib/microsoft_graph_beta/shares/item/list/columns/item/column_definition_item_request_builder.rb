...
module MicrosoftGraphBeta::Shares::Item::List::Columns::Item
    ## 
    ...
    class ColumnDefinitionItemRequestBuilder
        ...
        def source_column()
            return MicrosoftGraphBeta::Shares::Item::List::Columns::Item::SourceColumn::SourceColumnRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
