...
module MicrosoftGraphBeta::Shares::Item::List::Items::Item::DocumentSetVersions::Item
    ## 
    ...
    class DocumentSetVersionItemRequestBuilder
        ...
        def restore()
            return MicrosoftGraphBeta::Shares::Item::List::Items::Item::DocumentSetVersions::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
