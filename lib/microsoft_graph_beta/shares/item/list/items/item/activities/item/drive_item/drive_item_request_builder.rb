...
module MicrosoftGraphBeta::Shares::Item::List::Items::Item::Activities::Item::DriveItem
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}"
