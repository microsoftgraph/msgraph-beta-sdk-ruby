...
module MicrosoftGraphBeta::Shares::Item::List::Items::Item::Activities::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/activities/$count"
