...
module MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Children::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def relations()
            return MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Children::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Children::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}"
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Children::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property children for termStore
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
