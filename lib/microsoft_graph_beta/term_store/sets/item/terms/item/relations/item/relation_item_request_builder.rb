...
module MicrosoftGraphBeta::TermStore::Sets::Item::Terms::Item::Relations::Item
    ## 
    ...
    class RelationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}"
