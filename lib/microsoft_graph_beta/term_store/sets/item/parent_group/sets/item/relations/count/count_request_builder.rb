...
module MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::Relations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/relations/$count"
