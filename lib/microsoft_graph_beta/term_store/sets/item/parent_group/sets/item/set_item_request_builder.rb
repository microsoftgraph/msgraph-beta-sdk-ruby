...
module MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item
    ## 
    ...
    class SetItemRequestBuilder
        ...
        def children()
            return MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def relations()
            return MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def terms()
            return MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::Terms::TermsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::Children::Item::TermItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}{?%24select,%24expand}"
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the terms property of the microsoft.graph.termStore.set entity.
        ## @param id Unique identifier of the item
        ...
        def terms_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["term%2Did"] = id
            return MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::Terms::Item::TermItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
