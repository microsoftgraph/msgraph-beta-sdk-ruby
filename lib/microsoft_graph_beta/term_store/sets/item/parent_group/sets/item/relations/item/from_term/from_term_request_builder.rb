...
module MicrosoftGraphBeta::TermStore::Sets::Item::ParentGroup::Sets::Item::Relations::Item::FromTerm
    ## 
    ...
    class FromTermRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/relations/{relation%2Did}/fromTerm{?%24select,%24expand}"
