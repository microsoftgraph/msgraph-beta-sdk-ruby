...
module MicrosoftGraphBeta::TermStore::Sets::Item::Children::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def children()
            return MicrosoftGraphBeta::TermStore::Sets::Item::Children::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def relations()
            return MicrosoftGraphBeta::TermStore::Sets::Item::Children::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraphBeta::TermStore::Sets::Item::Children::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/sets/{set%2Did}/children/{term%2Did}{?%24select,%24expand}"
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraphBeta::TermStore::Sets::Item::Children::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
