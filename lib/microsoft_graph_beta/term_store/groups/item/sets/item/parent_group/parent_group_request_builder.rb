...
module MicrosoftGraphBeta::TermStore::Groups::Item::Sets::Item::ParentGroup
    ## 
    ...
    class ParentGroupRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/parentGroup{?%24select,%24expand}"
