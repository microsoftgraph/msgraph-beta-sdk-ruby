...
module MicrosoftGraphBeta::TermStore::Groups::Item::Sets::Item::Terms::Item::Children::Item::Set
    ## 
    ...
    class SetRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}/set{?%24select,%24expand}"
