...
module MicrosoftGraphBeta::TermStore::Groups::Item::Sets::Item::Relations::Item::Set
    ## 
    ...
    class SetRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/relations/{relation%2Did}/set{?%24select,%24expand}"
