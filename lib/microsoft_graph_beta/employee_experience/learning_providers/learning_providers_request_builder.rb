...
module MicrosoftGraphBeta::EmployeeExperience::LearningProviders
    ...
    class LearningProvidersRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::EmployeeExperience::LearningProviders::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## Get a list of the learningProvider resources registered in Viva Learning for a tenant.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of learning_provider_collection_response
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::LearningProviderCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Create a new learningProvider object and register it with Viva Learning using the specified display name and logos for different themes.
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of learning_provider
        ## 
