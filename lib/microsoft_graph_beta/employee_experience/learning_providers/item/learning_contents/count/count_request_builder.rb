...
module MicrosoftGraphBeta::EmployeeExperience::LearningProviders::Item::LearningContents::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningContents/$count"
