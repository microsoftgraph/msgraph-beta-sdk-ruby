...
module MicrosoftGraphBeta::EmployeeExperience::LearningProviders::Item::LearningContents::Item
    ## 
    ...
    class LearningContentItemRequestBuilder
        ...
        ## Learning catalog items for the provider.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of learning_content
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::LearningContent.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property learningContents in employeeExperience
        ## @param body The request body
