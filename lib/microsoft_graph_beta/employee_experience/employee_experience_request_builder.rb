...
module MicrosoftGraphBeta::EmployeeExperience
    ...
    class EmployeeExperienceRequestBuilder
        ...
        ## Get employeeExperience
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of employee_experience
        ## 
        ...
        def learning_providers_by_id(id)
            ...
            return MicrosoftGraphBeta::EmployeeExperience::LearningProviders::Item::LearningProviderItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update employeeExperience
        ## @param body The request body
