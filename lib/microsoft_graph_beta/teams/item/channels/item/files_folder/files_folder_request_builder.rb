...
module MicrosoftGraphBeta::Teams::Item::Channels::Item::FilesFolder
    ## 
    ...
    class FilesFolderRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::FilesFolder::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
