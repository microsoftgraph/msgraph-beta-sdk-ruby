...
module MicrosoftGraphBeta::Teams::Item::Channels::Item::Tabs::Item
    ## 
    ...
    class TeamsTabItemRequestBuilder
        ...
        def teams_app()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Tabs::Item::TeamsApp::TeamsAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
