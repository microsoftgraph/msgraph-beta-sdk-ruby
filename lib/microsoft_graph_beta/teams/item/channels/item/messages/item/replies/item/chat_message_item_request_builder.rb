...
module MicrosoftGraphBeta::Teams::Item::Channels::Item::Messages::Item::Replies::Item
    ...
    class ChatMessageItemRequestBuilder
        ...
        def hosted_contents()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Messages::Item::Replies::Item::HostedContents::HostedContentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set_reaction()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Messages::Item::Replies::Item::SetReaction::SetReactionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the softDelete method.
        def soft_delete()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Messages::Item::Replies::Item::SoftDelete::SoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the undoSoftDelete method.
        def undo_soft_delete()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Messages::Item::Replies::Item::UndoSoftDelete::UndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unsetReaction method.
        def unset_reaction()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Messages::Item::Replies::Item::UnsetReaction::UnsetReactionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def hosted_contents_by_id(id)
            ...
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Messages::Item::Replies::Item::HostedContents::Item::ChatMessageHostedContentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
