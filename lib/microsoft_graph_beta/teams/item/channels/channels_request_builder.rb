...
module MicrosoftGraphBeta::Teams::Item::Channels
    ## 
    ...
    class ChannelsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Teams::Item::Channels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
