...
module MicrosoftGraphBeta::Teams::Item::Tags::Item
    ## 
    ...
    class TeamworkTagItemRequestBuilder
        ...
        def members()
            return MicrosoftGraphBeta::Teams::Item::Tags::Item::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def members_by_id(id)
            ...
            return MicrosoftGraphBeta::Teams::Item::Tags::Item::Members::Item::TeamworkTagMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
