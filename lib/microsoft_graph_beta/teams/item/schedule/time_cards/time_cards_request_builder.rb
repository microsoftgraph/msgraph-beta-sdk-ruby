...
module MicrosoftGraphBeta::Teams::Item::Schedule::TimeCards
    ## 
    ...
    class TimeCardsRequestBuilder
        ...
        def clock_in()
            return MicrosoftGraphBeta::Teams::Item::Schedule::TimeCards::ClockIn::ClockInRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to count the resources in the collection.
        def count()
            return MicrosoftGraphBeta::Teams::Item::Schedule::TimeCards::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/schedule/timeCards{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
