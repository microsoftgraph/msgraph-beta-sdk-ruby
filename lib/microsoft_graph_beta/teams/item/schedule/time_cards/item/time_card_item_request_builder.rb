...
module MicrosoftGraphBeta::Teams::Item::Schedule::TimeCards::Item
    ## 
    ...
    class TimeCardItemRequestBuilder
        ...
        def clock_out()
            return MicrosoftGraphBeta::Teams::Item::Schedule::TimeCards::Item::ClockOut::ClockOutRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the confirm method.
        def confirm()
            return MicrosoftGraphBeta::Teams::Item::Schedule::TimeCards::Item::Confirm::ConfirmRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the endBreak method.
        def end_break()
            return MicrosoftGraphBeta::Teams::Item::Schedule::TimeCards::Item::EndBreak::EndBreakRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def start_break()
            return MicrosoftGraphBeta::Teams::Item::Schedule::TimeCards::Item::StartBreak::StartBreakRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/schedule/timeCards/{timeCard%2Did}{?%24select,%24expand}"
        ...
        ## Get timeCards from teams
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of time_card
        ## 
