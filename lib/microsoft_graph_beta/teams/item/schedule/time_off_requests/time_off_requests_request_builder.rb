...
module MicrosoftGraphBeta::Teams::Item::Schedule::TimeOffRequests
    ## 
    ...
    class TimeOffRequestsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Teams::Item::Schedule::TimeOffRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
