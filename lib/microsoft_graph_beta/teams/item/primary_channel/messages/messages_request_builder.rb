...
module MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages
    ## 
    ...
    class MessagesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
