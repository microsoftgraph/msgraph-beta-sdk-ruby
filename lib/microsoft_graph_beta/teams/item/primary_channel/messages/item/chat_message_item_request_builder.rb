...
module MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages::Item
    ...
    class ChatMessageItemRequestBuilder
        ...
        def set_reaction()
            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages::Item::SetReaction::SetReactionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the softDelete method.
        def soft_delete()
            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages::Item::SoftDelete::SoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the undoSoftDelete method.
        def undo_soft_delete()
            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages::Item::UndoSoftDelete::UndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unsetReaction method.
        def unset_reaction()
            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages::Item::UnsetReaction::UnsetReactionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
