...
module MicrosoftGraphBeta::Teams::Item::PrimaryChannel::SharedWithTeams::Item
    ## 
    ...
    class SharedWithChannelTeamInfoItemRequestBuilder
        ...
        def allowed_members()
            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::SharedWithTeams::Item::AllowedMembers::AllowedMembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
