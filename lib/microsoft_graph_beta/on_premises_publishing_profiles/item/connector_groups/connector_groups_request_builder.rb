...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::ConnectorGroups
    ## 
    ...
    class ConnectorGroupsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::ConnectorGroups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectorGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of connector_group
        ## 
