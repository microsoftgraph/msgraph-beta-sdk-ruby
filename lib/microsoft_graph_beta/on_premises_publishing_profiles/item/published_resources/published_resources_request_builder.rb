...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::PublishedResources
    ## 
    ...
    class PublishedResourcesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::PublishedResources::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/publishedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Retrieve a list of publishedResource objects.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of published_resource_collection_response
        ## 
