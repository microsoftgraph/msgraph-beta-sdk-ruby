...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::Connectors::Item::MemberOf::Ref
    ## 
    ...
    class RefRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectors/{connector%2Did}/memberOf/$ref{?%24top,%24skip,%24search,%24filter,%24count,%24orderby}"
