...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::AgentGroups::Item
    ## 
    ...
    class OnPremisesAgentGroupItemRequestBuilder
        ...
        def agents()
            return MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::AgentGroups::Item::Agents::AgentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def published_resources()
            return MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::AgentGroups::Item::PublishedResources::PublishedResourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}{?%24select,%24expand}"
