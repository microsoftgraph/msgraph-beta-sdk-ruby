...
module MicrosoftGraphBeta::OnPremisesPublishingProfiles::Item::AgentGroups::Item::PublishedResources::Item
    ## 
    ...
    class PublishedResourceItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}{?%24select,%24expand}"
        ...
        ## List of publishedResource that are assigned to an onPremisesAgentGroup. Read-only. Nullable.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of published_resource
        ## 
