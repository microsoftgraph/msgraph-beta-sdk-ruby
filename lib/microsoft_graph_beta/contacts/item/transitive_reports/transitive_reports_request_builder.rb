...
require_relative './transitive_reports'

module MicrosoftGraphBeta::Contacts::Item::TransitiveReports
    ## 
    ...
    class TransitiveReportsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Contacts::Item::TransitiveReports::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/contacts/{orgContact%2Did}/transitiveReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
