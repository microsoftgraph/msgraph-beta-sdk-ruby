...
module MicrosoftGraphBeta::Contacts::Item::DirectReports::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Contacts::Item::DirectReports::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
