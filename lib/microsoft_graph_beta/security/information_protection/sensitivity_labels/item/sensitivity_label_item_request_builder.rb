...
module MicrosoftGraphBeta::Security::InformationProtection::SensitivityLabels::Item
    ## 
    ...
    class SensitivityLabelItemRequestBuilder
        ...
        def parent()
            return MicrosoftGraphBeta::Security::InformationProtection::SensitivityLabels::Item::Parent::ParentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}"
