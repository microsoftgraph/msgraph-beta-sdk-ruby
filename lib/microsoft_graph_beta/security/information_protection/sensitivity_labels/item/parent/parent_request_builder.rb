...
module MicrosoftGraphBeta::Security::InformationProtection::SensitivityLabels::Item::Parent
    ## 
    ...
    class ParentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/parent{?%24select,%24expand}"
