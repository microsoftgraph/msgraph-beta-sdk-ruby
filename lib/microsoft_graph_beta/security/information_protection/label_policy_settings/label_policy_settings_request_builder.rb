...
module MicrosoftGraphBeta::Security::InformationProtection::LabelPolicySettings
    ## 
    ...
    class LabelPolicySettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/informationProtection/labelPolicySettings{?%24select,%24expand}"
