...
require_relative './cancel_security_action/cancel_security_action_request_builder'
require_relative './item'

module MicrosoftGraphBeta::Security::SecurityActions::Item
    ## 
    ...
    class SecurityActionItemRequestBuilder
        ...
        def cancel_security_action()
            return MicrosoftGraphBeta::Security::SecurityActions::Item::CancelSecurityAction::CancelSecurityActionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/securityActions/{securityAction%2Did}{?%24select,%24expand}"
