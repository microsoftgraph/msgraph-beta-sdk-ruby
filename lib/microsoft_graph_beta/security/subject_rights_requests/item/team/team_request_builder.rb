...
module MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::Team
    ## 
    ...
    class TeamRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/team{?%24select,%24expand}"
