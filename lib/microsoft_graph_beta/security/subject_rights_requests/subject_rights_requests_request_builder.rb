...
module MicrosoftGraphBeta::Security::SubjectRightsRequests
    ## 
    ...
    class SubjectRightsRequestsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Security::SubjectRightsRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/subjectRightsRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
