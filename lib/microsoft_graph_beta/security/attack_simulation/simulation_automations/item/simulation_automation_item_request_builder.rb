...
module MicrosoftGraphBeta::Security::AttackSimulation::SimulationAutomations::Item
    ## 
    ...
    class SimulationAutomationItemRequestBuilder
        ...
        def runs()
            return MicrosoftGraphBeta::Security::AttackSimulation::SimulationAutomations::Item::Runs::RunsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SimulationAutomation.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ...
        def runs_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::AttackSimulation::SimulationAutomations::Item::Runs::Item::SimulationAutomationRunItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property simulationAutomations for security
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
