...
module MicrosoftGraphBeta::Security::AttackSimulation::SimulationAutomations::Item::Runs::Item
    ## 
    ...
    class SimulationAutomationRunItemRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SimulationAutomationRun.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
