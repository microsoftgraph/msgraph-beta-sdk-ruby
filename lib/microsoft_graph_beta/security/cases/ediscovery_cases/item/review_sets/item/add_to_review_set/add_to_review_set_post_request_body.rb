...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::AddToReviewSet
    ## 
    ...
    class AddToReviewSetPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "additionalDataOptions" => lambda {|n| @additional_data_options = n.get_enum_value(MicrosoftGraphBeta::Models::Security::AdditionalDataOptions) },
                "search" => lambda {|n| @search = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoverySearch.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
