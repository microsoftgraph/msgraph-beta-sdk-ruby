...
require_relative '../../../../../../../../models/security/ediscovery_file'
...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Files::Item
    ## 
    ...
    class EdiscoveryFileItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/files/{ediscoveryFile%2Did}{?%24select,%24expand}"
        ...
        ## Represents files within the review set.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_file
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryFile.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property files in security
        ## @param body The request body
        ...
        def tags_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Files::Item::Tags::Item::EdiscoveryReviewTagItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
