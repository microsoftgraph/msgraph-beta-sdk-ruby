...
require_relative './files/item/ediscovery_file_item_request_builder'
require_relative './item'
...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item
    ## 
    ...
    class EdiscoveryReviewSetItemRequestBuilder
        ...
        def add_to_review_set()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::AddToReviewSet::AddToReviewSetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the export method.
        def export()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Export::ExportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the files property of the microsoft.graph.security.ediscoveryReviewSet entity.
        def files()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Files::FilesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def queries()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::QueriesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def files_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Files::Item::EdiscoveryFileItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Returns a list of eDiscoveryReviewSet objects in the case.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryReviewSet.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property reviewSets in security
        ## @param body The request body
        ...
        def queries_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::EdiscoveryReviewSetQueryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
