...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item
    ## 
    ...
    class EdiscoverySearchItemRequestBuilder
        ...
        def additional_sources()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::AdditionalSources::AdditionalSourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def add_to_review_set_operation()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::AddToReviewSetOperation::AddToReviewSetOperationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def custodian_sources()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::CustodianSources::CustodianSourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the estimateStatistics method.
        def estimate_statistics()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::EstimateStatistics::EstimateStatisticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def last_estimate_statistics_operation()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::LastEstimateStatisticsOperation::LastEstimateStatisticsOperationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the noncustodialSources property of the microsoft.graph.security.ediscoverySearch entity.
        def noncustodial_sources()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::NoncustodialSources::NoncustodialSourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def purge_data()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::PurgeData::PurgeDataRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def additional_sources_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::AdditionalSources::Item::DataSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def custodian_sources_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["dataSource%2Did"] = id
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::CustodianSources::Item::DataSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoverySearch.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the noncustodialSources property of the microsoft.graph.security.ediscoverySearch entity.
        ## @param id Unique identifier of the item
        ...
        def noncustodial_sources_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::NoncustodialSources::Item::EdiscoveryNoncustodialDataSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
