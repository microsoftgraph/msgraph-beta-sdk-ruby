...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::LastIndexOperation
    ## 
    ...
    class LastIndexOperationRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryIndexOperation.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Operation entity that represents the latest indexing for the non-custodial data source.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
