...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item
    ## 
    ...
    class EdiscoveryNoncustodialDataSourceItemRequestBuilder
        ...
        def apply_hold()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::ApplyHold::ApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def data_source()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::DataSource::DataSourceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def last_index_operation()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::LastIndexOperation::LastIndexOperationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def release()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::Release::ReleaseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeHold method.
        def remove_hold()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::RemoveHold::RemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def update_index()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::UpdateIndex::UpdateIndexRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryNoncustodialDataSource.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
