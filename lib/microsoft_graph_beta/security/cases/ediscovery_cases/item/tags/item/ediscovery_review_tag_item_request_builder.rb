...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Tags::Item
    ## 
    ...
    class EdiscoveryReviewTagItemRequestBuilder
        ...
        def child_tags()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Tags::Item::ChildTags::ChildTagsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parent property of the microsoft.graph.security.ediscoveryReviewTag entity.
        def parent()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Tags::Item::Parent::ParentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def child_tags_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Tags::Item::ChildTags::Item::EdiscoveryReviewTagItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryReviewTag.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property tags in security
        ## @param body The request body
