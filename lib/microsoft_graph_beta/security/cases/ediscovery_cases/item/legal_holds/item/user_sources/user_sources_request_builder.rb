...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::LegalHolds::Item::UserSources
    ## 
    ...
    class UserSourcesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::LegalHolds::Item::UserSources::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/legalHolds/{ediscoveryHoldPolicy%2Did}/userSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
