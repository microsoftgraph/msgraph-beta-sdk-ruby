...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::UnifiedGroupSources::Item
    ## 
    ...
    class UnifiedGroupSourceItemRequestBuilder
        ...
        def group()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::UnifiedGroupSources::Item::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
