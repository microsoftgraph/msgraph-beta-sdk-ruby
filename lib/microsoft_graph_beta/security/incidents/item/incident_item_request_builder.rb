...
module MicrosoftGraphBeta::Security::Incidents::Item
    ## 
    ...
    class IncidentItemRequestBuilder
        ...
        def alerts()
            return MicrosoftGraphBeta::Security::Incidents::Item::Alerts::AlertsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
