...
require_relative '../../../../models/security/retention_label'
...
require_relative './disposition_review_stages/item/disposition_review_stage_item_request_builder'
require_relative './item'
require_relative './retention_event_type/retention_event_type_request_builder'

module MicrosoftGraphBeta::Security::Labels::RetentionLabels::Item
    ## 
    ...
    class RetentionLabelItemRequestBuilder
        ...
        def disposition_review_stages()
            return MicrosoftGraphBeta::Security::Labels::RetentionLabels::Item::DispositionReviewStages::DispositionReviewStagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def retention_event_type()
            return MicrosoftGraphBeta::Security::Labels::RetentionLabels::Item::RetentionEventType::RetentionEventTypeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}{?%24select,%24expand}"
        ...
        ## 
        def disposition_review_stages_by_id(id)
        ...
        ## Get retentionLabels from security
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of retention_label
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::RetentionLabel.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property retentionLabels in security
        ## @param body The request body
