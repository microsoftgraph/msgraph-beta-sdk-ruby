...
module MicrosoftGraphBeta::ApprovalWorkflowProviders
    ...
    class ApprovalWorkflowProvidersRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/approvalWorkflowProviders{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get entities from approvalWorkflowProviders
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of approval_workflow_provider_collection_response
        ## 
