...
module MicrosoftGraphBeta::OfficeConfiguration::ClientConfigurations::Item::Assignments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/officeConfiguration/clientConfigurations/{officeClientConfiguration%2Did}/assignments/$count"
