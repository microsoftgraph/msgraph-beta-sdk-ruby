...
module MicrosoftGraphBeta::PrivilegedApproval::Item
    ## 
    ...
    class PrivilegedApprovalItemRequestBuilder
        ...
        def request()
            return MicrosoftGraphBeta::PrivilegedApproval::Item::Request::RequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def role_info()
            return MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::RoleInfoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}{?%24select,%24expand}"
