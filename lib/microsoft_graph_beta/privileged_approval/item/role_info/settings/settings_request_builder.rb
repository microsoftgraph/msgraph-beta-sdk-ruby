...
module MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::Settings
    ## 
    ...
    class SettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/settings{?%24select,%24expand}"
