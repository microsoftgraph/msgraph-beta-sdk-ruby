...
module MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo
    ## 
    ...
    class RoleInfoRequestBuilder
        ...
        def assignments()
            return MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def self_activate()
            return MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::SelfActivate::SelfActivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the selfDeactivate method.
        def self_deactivate()
            return MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::SelfDeactivate::SelfDeactivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the settings property of the microsoft.graph.privilegedRole entity.
        def settings()
            return MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::Settings::SettingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the summary property of the microsoft.graph.privilegedRole entity.
        def summary()
            return MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::Summary::SummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::Assignments::Item::PrivilegedRoleAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo{?%24select,%24expand}"
        ...
        ## Get roleInfo from privilegedApproval
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of privileged_role
        ## 
