...
module MicrosoftGraphBeta::GovernanceRoleDefinitions::Item::Resource
    ## 
    ...
    class ResourceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceRoleDefinitions/{governanceRoleDefinition%2Did}/resource{?%24select,%24expand}"
