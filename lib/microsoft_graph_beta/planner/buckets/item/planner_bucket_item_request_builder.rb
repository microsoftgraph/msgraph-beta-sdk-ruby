...
module MicrosoftGraphBeta::Planner::Buckets::Item
    ## 
    ...
    class PlannerBucketItemRequestBuilder
        ...
        def tasks()
            return MicrosoftGraphBeta::Planner::Buckets::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraphBeta::Planner::Buckets::Item::Tasks::Item::PlannerTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
