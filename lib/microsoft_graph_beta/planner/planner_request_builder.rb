...
require_relative './rosters/item/planner_roster_item_request_builder'
...
module MicrosoftGraphBeta::Planner
    ## 
    ...
    class PlannerRequestBuilder
        ...
        def buckets_by_id(id)
            ...
            return MicrosoftGraphBeta::Planner::Buckets::Item::PlannerBucketItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def plans_by_id(id)
            ...
            return MicrosoftGraphBeta::Planner::Plans::Item::PlannerPlanItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the rosters property of the microsoft.graph.planner entity.
        ## @param id Unique identifier of the item
        ...
        ## 
        def rosters_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["plannerRoster%2Did"] = id
            return MicrosoftGraphBeta::Planner::Rosters::Item::PlannerRosterItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tasks property of the microsoft.graph.planner entity.
        ## @param id Unique identifier of the item
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraphBeta::Planner::Tasks::Item::PlannerTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
