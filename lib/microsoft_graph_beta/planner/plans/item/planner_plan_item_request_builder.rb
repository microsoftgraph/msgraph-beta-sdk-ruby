...
module MicrosoftGraphBeta::Planner::Plans::Item
    ## 
    ...
    class PlannerPlanItemRequestBuilder
        ...
        def buckets()
            return MicrosoftGraphBeta::Planner::Plans::Item::Buckets::BucketsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def buckets_by_id(id)
            ...
            return MicrosoftGraphBeta::Planner::Plans::Item::Buckets::Item::PlannerBucketItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraphBeta::Planner::Plans::Item::Tasks::Item::PlannerTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property plans for planner
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
