...
module MicrosoftGraphBeta::External::Connections::Item::Groups::Item
    ## 
    ...
    class ExternalGroupItemRequestBuilder
        ...
        def members()
            return MicrosoftGraphBeta::External::Connections::Item::Groups::Item::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
