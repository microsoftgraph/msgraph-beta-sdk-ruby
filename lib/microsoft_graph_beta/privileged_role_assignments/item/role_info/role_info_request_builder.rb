...
module MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::RoleInfo
    ## 
    ...
    class RoleInfoRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo{?%24select,%24expand}"
