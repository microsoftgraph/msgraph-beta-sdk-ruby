...
module MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::RoleInfo::Summary
    ## 
    ...
    class SummaryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/summary{?%24select,%24expand}"
        ...
        ## Retrieve the properties and relationships of privilegedRoleSummary object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of privileged_role_summary
        ## 
