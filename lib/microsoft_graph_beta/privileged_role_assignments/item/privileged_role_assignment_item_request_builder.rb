...
require_relative './make_eligible/make_eligible_request_builder'
require_relative './make_permanent/make_permanent_request_builder'
require_relative './role_info/role_info_request_builder'

module MicrosoftGraphBeta::PrivilegedRoleAssignments::Item
    ## 
    ...
    class PrivilegedRoleAssignmentItemRequestBuilder
        ...
        def make_eligible()
            return MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::MakeEligible::MakeEligibleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the makePermanent method.
        def make_permanent()
            return MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::MakePermanent::MakePermanentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def role_info()
            return MicrosoftGraphBeta::PrivilegedRoleAssignments::Item::RoleInfo::RoleInfoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}{?%24select,%24expand}"
