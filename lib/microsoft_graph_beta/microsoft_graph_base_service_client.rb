...
module MicrosoftGraphBeta
    ...
    class MicrosoftGraphBaseServiceClient
        ...
        def workbooks()
            return MicrosoftGraphBeta::Workbooks::WorkbooksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the collection of accessReviewDecision entities.
        ...
        def workbooks_by_id(id)
            ...
            return MicrosoftGraphBeta::Workbooks::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
    end
end
