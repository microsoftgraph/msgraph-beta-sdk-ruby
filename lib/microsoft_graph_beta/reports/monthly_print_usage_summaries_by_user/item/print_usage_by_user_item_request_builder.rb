...
module MicrosoftGraphBeta::Reports::MonthlyPrintUsageSummariesByUser::Item
    ## 
    ...
    class PrintUsageByUserItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/reports/monthlyPrintUsageSummariesByUser/{printUsageByUser%2Did}{?%24select,%24expand}"
