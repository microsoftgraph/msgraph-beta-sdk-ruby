...
module MicrosoftGraphBeta::GovernanceRoleAssignmentRequests::Item::RoleDefinition::RoleSetting
    ## 
    ...
    class RoleSettingRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/roleDefinition/roleSetting{?%24select,%24expand}"
