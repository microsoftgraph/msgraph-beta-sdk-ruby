...
module MicrosoftGraphBeta::GovernanceRoleAssignmentRequests::Item::Resource
    ## 
    ...
    class ResourceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/resource{?%24select,%24expand}"
