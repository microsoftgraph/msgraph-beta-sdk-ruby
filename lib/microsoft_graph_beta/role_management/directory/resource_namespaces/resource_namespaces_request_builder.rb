...
module MicrosoftGraphBeta::RoleManagement::Directory::ResourceNamespaces
    ## 
    ...
    class ResourceNamespacesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::RoleManagement::Directory::ResourceNamespaces::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/resourceNamespaces{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
