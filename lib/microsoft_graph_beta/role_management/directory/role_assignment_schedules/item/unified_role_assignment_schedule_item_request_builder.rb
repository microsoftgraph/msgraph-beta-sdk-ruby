...
module MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentSchedules::Item
    ## 
    ...
    class UnifiedRoleAssignmentScheduleItemRequestBuilder
        ...
        def activated_using()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentSchedules::Item::ActivatedUsing::ActivatedUsingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
