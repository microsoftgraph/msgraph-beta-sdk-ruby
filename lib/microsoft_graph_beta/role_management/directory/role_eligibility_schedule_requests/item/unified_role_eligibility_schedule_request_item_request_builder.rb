...
module MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item
    ...
    class UnifiedRoleEligibilityScheduleRequestItemRequestBuilder
        ...
        def cancel()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
