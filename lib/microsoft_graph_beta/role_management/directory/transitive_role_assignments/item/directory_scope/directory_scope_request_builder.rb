...
module MicrosoftGraphBeta::RoleManagement::Directory::TransitiveRoleAssignments::Item::DirectoryScope
    ## 
    ...
    class DirectoryScopeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/directoryScope{?%24select,%24expand}"
