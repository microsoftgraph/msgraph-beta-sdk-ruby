...
module MicrosoftGraphBeta::RoleManagement::Directory::TransitiveRoleAssignments::Item
    ## 
    ...
    class UnifiedRoleAssignmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}"
