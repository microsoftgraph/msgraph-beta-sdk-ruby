...
module MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item
    ...
    class UnifiedRoleAssignmentScheduleRequestItemRequestBuilder
        ...
        def cancel()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
