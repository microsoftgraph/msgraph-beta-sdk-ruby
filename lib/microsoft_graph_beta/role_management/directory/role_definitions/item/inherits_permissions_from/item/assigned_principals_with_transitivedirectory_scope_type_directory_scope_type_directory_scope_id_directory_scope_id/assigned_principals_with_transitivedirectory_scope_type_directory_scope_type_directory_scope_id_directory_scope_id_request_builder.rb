...
module MicrosoftGraphBeta::RoleManagement::Directory::RoleDefinitions::Item::InheritsPermissionsFrom::Item::AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeId
    ...
    class AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::RoleManagement::Directory::RoleDefinitions::Item::InheritsPermissionsFrom::Item::AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeId::AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function assignedPrincipals
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
