...
module MicrosoftGraphBeta::RoleManagement::Directory::RoleDefinitions::Item::InheritsPermissionsFrom
    ## 
    ...
    class InheritsPermissionsFromRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleDefinitions::Item::InheritsPermissionsFrom::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
