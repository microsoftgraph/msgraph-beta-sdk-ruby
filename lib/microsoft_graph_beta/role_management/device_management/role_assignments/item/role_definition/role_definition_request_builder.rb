...
module MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleAssignments::Item::RoleDefinition
    ## 
    ...
    class RoleDefinitionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/deviceManagement/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/roleDefinition{?%24select,%24expand}"
