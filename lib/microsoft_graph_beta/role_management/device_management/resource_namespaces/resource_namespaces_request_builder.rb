...
module MicrosoftGraphBeta::RoleManagement::DeviceManagement::ResourceNamespaces
    ## 
    ...
    class ResourceNamespacesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::ResourceNamespaces::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/deviceManagement/resourceNamespaces{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get resourceNamespaces from roleManagement
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of unified_rbac_resource_namespace_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of unified_rbac_resource_namespace
        ## 
