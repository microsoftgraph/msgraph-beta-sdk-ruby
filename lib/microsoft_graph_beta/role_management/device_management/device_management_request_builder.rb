...
module MicrosoftGraphBeta::RoleManagement::DeviceManagement
    ## 
    ...
    class DeviceManagementRequestBuilder
        ...
        def resource_namespaces()
            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::ResourceNamespaces::ResourceNamespacesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleAssignments property of the microsoft.graph.rbacApplicationMultiple entity.
        def role_assignments()
            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleAssignments::RoleAssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleDefinitions property of the microsoft.graph.rbacApplicationMultiple entity.
        def role_definitions()
            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleDefinitions::RoleDefinitionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/deviceManagement{?%24select,%24expand}"
        ...
        def resource_namespaces_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::ResourceNamespaces::Item::UnifiedRbacResourceNamespaceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleAssignments property of the microsoft.graph.rbacApplicationMultiple entity.
        ## @param id Unique identifier of the item
