...
module MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::Item::ResourceActions::Item::ResourceScope
    ## 
    ...
    class ResourceScopeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}/resourceScope{?%24select,%24expand}"
        ...
        ## Get resourceScope from roleManagement
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of unified_rbac_resource_scope
        ## 
