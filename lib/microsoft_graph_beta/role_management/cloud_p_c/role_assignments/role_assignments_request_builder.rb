...
module MicrosoftGraphBeta::RoleManagement::CloudPC::RoleAssignments
    ## 
    ...
    class RoleAssignmentsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::RoleManagement::CloudPC::RoleAssignments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get a list of unifiedRoleAssignmentMultiple objects for an RBAC provider. The following RBAC providers are currently supported:- Cloud PC - device management (Intune) For other Microsoft 365 applications (like Azure AD), use unifiedRoleAssignment.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of unified_role_assignment_multiple_collection_response
        ## 
