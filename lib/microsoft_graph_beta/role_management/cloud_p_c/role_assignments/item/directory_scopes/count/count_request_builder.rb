...
module MicrosoftGraphBeta::RoleManagement::CloudPC::RoleAssignments::Item::DirectoryScopes::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/directoryScopes/$count"
