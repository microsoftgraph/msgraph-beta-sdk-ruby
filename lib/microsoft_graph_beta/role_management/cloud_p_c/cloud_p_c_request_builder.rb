...
module MicrosoftGraphBeta::RoleManagement::CloudPC
    ## 
    ...
    class CloudPCRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC{?%24select,%24expand}"
        ...
        ## Get cloudPC from roleManagement
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of rbac_application_multiple
        ## 
