...
module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignmentScheduleInstances::Item
    ## 
    ...
    class UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder
        ...
        def activated_using()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignmentScheduleInstances::Item::ActivatedUsing::ActivatedUsingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
