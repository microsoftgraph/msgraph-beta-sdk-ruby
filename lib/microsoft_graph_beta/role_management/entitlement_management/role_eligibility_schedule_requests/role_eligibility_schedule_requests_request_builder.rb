...
module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleEligibilityScheduleRequests
    ...
    class RoleEligibilityScheduleRequestsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleEligibilityScheduleRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
