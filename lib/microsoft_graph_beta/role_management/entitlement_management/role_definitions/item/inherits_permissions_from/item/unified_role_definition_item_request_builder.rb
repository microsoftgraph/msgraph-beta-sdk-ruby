...
require_relative './assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id/assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id_request_builder'
require_relative './item'

module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleDefinitions::Item::InheritsPermissionsFrom::Item
    ## 
