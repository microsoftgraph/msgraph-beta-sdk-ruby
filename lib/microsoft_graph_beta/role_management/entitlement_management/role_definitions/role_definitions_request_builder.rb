...
module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleDefinitions
    ## 
    ...
    class RoleDefinitionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleDefinitions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
