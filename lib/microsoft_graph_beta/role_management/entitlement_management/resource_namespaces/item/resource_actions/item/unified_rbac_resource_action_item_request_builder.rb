...
module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::ResourceNamespaces::Item::ResourceActions::Item
    ## 
    ...
    class UnifiedRbacResourceActionItemRequestBuilder
        ...
        def resource_scope()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::ResourceNamespaces::Item::ResourceActions::Item::ResourceScope::ResourceScopeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24select,%24expand}"
