...
module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::TransitiveRoleAssignments::Item::DirectoryScope
    ## 
    ...
    class DirectoryScopeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/directoryScope{?%24select,%24expand}"
