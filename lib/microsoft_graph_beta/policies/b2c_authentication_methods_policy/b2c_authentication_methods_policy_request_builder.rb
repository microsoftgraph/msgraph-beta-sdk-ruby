...
require_relative '../../models/b2c_authentication_methods_policy'
...
module MicrosoftGraphBeta::Policies::B2cAuthenticationMethodsPolicy
    ...
    class B2cAuthenticationMethodsPolicyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/b2cAuthenticationMethodsPolicy{?%24select,%24expand}"
        ...
        ## Read the properties of a b2cAuthenticationMethodsPolicy object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of b2c_authentication_methods_policy
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::B2cAuthenticationMethodsPolicy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the properties of a b2cAuthenticationMethodsPolicy object.
        ## @param body The request body
