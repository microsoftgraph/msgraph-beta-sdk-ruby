...
module MicrosoftGraphBeta::Policies::PermissionGrantPolicies::Item
    ## 
    ...
    class PermissionGrantPolicyItemRequestBuilder
        ...
        def excludes()
            return MicrosoftGraphBeta::Policies::PermissionGrantPolicies::Item::Excludes::ExcludesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the includes property of the microsoft.graph.permissionGrantPolicy entity.
        def includes()
            return MicrosoftGraphBeta::Policies::PermissionGrantPolicies::Item::Includes::IncludesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def excludes_by_id(id)
            ...
            return MicrosoftGraphBeta::Policies::PermissionGrantPolicies::Item::Excludes::Item::PermissionGrantConditionSetItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PermissionGrantPolicy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the includes property of the microsoft.graph.permissionGrantPolicy entity.
        ## @param id Unique identifier of the item
        ...
        def includes_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["permissionGrantConditionSet%2Did"] = id
            return MicrosoftGraphBeta::Policies::PermissionGrantPolicies::Item::Includes::Item::PermissionGrantConditionSetItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
