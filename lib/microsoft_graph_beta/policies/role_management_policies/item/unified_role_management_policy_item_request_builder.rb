...
module MicrosoftGraphBeta::Policies::RoleManagementPolicies::Item
    ## 
    ...
    class UnifiedRoleManagementPolicyItemRequestBuilder
        ...
        def effective_rules()
            return MicrosoftGraphBeta::Policies::RoleManagementPolicies::Item::EffectiveRules::EffectiveRulesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def rules()
            return MicrosoftGraphBeta::Policies::RoleManagementPolicies::Item::Rules::RulesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def effective_rules_by_id(id)
            ...
            return MicrosoftGraphBeta::Policies::RoleManagementPolicies::Item::EffectiveRules::Item::UnifiedRoleManagementPolicyRuleItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleManagementPolicy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ...
        def rules_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["unifiedRoleManagementPolicyRule%2Did"] = id
            return MicrosoftGraphBeta::Policies::RoleManagementPolicies::Item::Rules::Item::UnifiedRoleManagementPolicyRuleItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property roleManagementPolicies for policies
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
