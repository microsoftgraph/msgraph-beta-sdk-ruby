...
module MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy
    ## 
    ...
    class CrossTenantAccessPolicyRequestBuilder
        ...
        def default()
            return MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Default::DefaultRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def partners_by_id(id)
            ...
            return MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Partners::Item::CrossTenantAccessPolicyConfigurationPartnerTenantItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the properties of a cross-tenant access policy.
        ## @param body The request body
