...
module MicrosoftGraphBeta::Policies::MobileAppManagementPolicies::Item::IncludedGroups::Item
    ## 
    ...
    class GroupItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/mobileAppManagementPolicies/{mobilityManagementPolicy%2Did}/includedGroups/{group%2Did}"
