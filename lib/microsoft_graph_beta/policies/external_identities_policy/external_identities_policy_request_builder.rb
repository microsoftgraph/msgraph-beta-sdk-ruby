...
require_relative '../../models/external_identities_policy'
require_relative '../../models/o_data_errors/o_data_error'
require_relative '../policies'
require_relative './external_identities_policy'

module MicrosoftGraphBeta::Policies::ExternalIdentitiesPolicy
    ## 
    ...
    class ExternalIdentitiesPolicyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/externalIdentitiesPolicy{?%24select,%24expand}"
        ...
        ## Read the properties and relationships of the tenant-wide externalIdentitiesPolicy object that controls whether external users can leave an Azure AD tenant via self-service controls.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of external_identities_policy
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ExternalIdentitiesPolicy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the settings of the tenant-wide externalIdentitiesPolicy object that controls whether external users can leave an Azure AD tenant via self-service controls.
        ## @param body The request body
