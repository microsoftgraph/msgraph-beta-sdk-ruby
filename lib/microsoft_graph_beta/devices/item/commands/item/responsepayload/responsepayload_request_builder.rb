...
module MicrosoftGraphBeta::Devices::Item::Commands::Item::Responsepayload
    ## 
    ...
    class ResponsepayloadRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/devices/{device%2Did}/commands/{command%2Did}/responsepayload{?%24select,%24expand}"
