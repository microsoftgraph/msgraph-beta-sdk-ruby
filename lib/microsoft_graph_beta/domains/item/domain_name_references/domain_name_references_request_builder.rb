...
module MicrosoftGraphBeta::Domains::Item::DomainNameReferences
    ## 
    ...
    class DomainNameReferencesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Domains::Item::DomainNameReferences::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
