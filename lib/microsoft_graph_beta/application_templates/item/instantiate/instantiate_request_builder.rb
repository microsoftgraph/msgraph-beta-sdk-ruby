...
module MicrosoftGraphBeta::ApplicationTemplates::Item::Instantiate
    ## 
    ...
    class InstantiateRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ApplicationServicePrincipal.create_from_discriminator_value(pn) }, error_mapping)
        end
