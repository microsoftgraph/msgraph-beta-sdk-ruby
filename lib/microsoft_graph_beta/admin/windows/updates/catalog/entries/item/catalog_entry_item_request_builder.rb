...
require_relative '../../../../../../models/windows_updates/catalog_entry'
...
module MicrosoftGraphBeta::Admin::Windows::Updates::Catalog::Entries::Item
    ## 
    ...
    class CatalogEntryItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/windows/updates/catalog/entries/{catalogEntry%2Did}{?%24select,%24expand}"
        ...
        ## Lists the content that you can approve for deployment. Read-only.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of catalog_entry
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdates::CatalogEntry.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property entries in admin
        ## @param body The request body
