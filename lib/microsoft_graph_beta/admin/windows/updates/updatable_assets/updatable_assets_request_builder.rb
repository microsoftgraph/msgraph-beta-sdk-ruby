...
require_relative './enroll_assets/enroll_assets_request_builder'
require_relative './enroll_assets_by_id/enroll_assets_by_id_request_builder'
require_relative './unenroll_assets/unenroll_assets_request_builder'
require_relative './unenroll_assets_by_id/unenroll_assets_by_id_request_builder'
...
module MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets
    ...
    class UpdatableAssetsRequestBuilder
        ...
        def enroll_assets()
            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::EnrollAssets::EnrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the enrollAssetsById method.
        def enroll_assets_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::EnrollAssetsById::EnrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def unenroll_assets()
            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::UnenrollAssets::UnenrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unenrollAssetsById method.
        def unenroll_assets_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::UnenrollAssetsById::UnenrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## Get a list of azureADDevice objects and their properties. This operation filters on the fully qualified resource type, `microsoft.graph.windowsUpdates.azureADDevice`, which inherits from updatableAsset.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of updatable_asset_collection_response
        ## 
