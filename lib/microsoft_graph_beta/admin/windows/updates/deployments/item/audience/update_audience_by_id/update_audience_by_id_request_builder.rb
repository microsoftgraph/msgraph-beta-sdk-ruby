...
require_relative './update_audience_by_id'

module MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::UpdateAudienceById
    ## 
    ...
    class UpdateAudienceByIdRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/microsoft.graph.windowsUpdates.updateAudienceById"
