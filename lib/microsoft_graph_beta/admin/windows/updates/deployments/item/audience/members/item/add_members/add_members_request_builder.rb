...
module MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Members::Item::AddMembers
    ## 
    ...
    class AddMembersRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/{updatableAsset%2Did}/microsoft.graph.windowsUpdates.addMembers"
