...
module MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions
    ## 
    ...
    class ExclusionsRequestBuilder
        ...
        def enroll_assets()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions::EnrollAssets::EnrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the enrollAssetsById method.
        def enroll_assets_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions::EnrollAssetsById::EnrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def unenroll_assets()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions::UnenrollAssets::UnenrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unenrollAssetsById method.
        def unenroll_assets_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions::UnenrollAssetsById::UnenrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
