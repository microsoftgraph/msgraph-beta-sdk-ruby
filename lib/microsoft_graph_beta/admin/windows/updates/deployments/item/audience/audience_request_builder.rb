...
require_relative './update_audience/update_audience_request_builder'
require_relative './update_audience_by_id/update_audience_by_id_request_builder'

module MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience
    ## 
    ...
    class AudienceRequestBuilder
        ...
        def update_audience()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::UpdateAudience::UpdateAudienceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateAudienceById method.
        def update_audience_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::UpdateAudienceById::UpdateAudienceByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience{?%24select,%24expand}"
        ...
        ## Specifies the audience to which content is deployed.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of deployment_audience
        ## 
