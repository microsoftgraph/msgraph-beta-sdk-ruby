...
require_relative '../../models/windows_updates/windows'
require_relative '../admin'
require_relative './updates/updates_request_builder'
require_relative './windows'

module MicrosoftGraphBeta::Admin::Windows
    ## 
    ...
    class WindowsRequestBuilder
        ...
        def updates()
            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/windows{?%24select,%24expand}"
        ...
        ## A container for all Windows Update for Business deployment service functionality. Read-only.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of windows
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdates::Windows.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property windows in admin
        ## @param body The request body
