...
module MicrosoftGraphBeta::Admin::ServiceAnnouncement
    ## 
    ...
    class ServiceAnnouncementRequestBuilder
        ...
        def health_overviews()
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::HealthOverviews::HealthOverviewsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the issues property of the microsoft.graph.serviceAnnouncement entity.
        def issues()
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::Issues::IssuesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the messages property of the microsoft.graph.serviceAnnouncement entity.
        def messages()
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::Messages::MessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ServiceAnnouncement.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the healthOverviews property of the microsoft.graph.serviceAnnouncement entity.
        ...
        def health_overviews_by_id(id)
            ...
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::HealthOverviews::Item::ServiceHealthItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the issues property of the microsoft.graph.serviceAnnouncement entity.
        ## @param id Unique identifier of the item
        ...
        def issues_by_id(id)
            ...
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::Issues::Item::ServiceHealthIssueItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the messages property of the microsoft.graph.serviceAnnouncement entity.
        ## @param id Unique identifier of the item
        ...
        def messages_by_id(id)
            ...
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::Messages::Item::ServiceUpdateMessageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
