...
module MicrosoftGraphBeta::Admin::ServiceAnnouncement::Messages::Item
    ## 
    ...
    class ServiceUpdateMessageItemRequestBuilder
        ...
        def attachments()
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::Messages::Item::Attachments::AttachmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the admin entity.
        def attachments_archive()
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::Messages::Item::AttachmentsArchive::AttachmentsArchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def attachments_by_id(id)
            ...
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::Messages::Item::Attachments::Item::ServiceAnnouncementAttachmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ServiceUpdateMessage.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property messages in admin
        ## @param body The request body
