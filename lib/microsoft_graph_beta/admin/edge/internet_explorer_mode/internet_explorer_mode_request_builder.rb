...
module MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode
    ## 
    ...
    class InternetExplorerModeRequestBuilder
        ...
        def site_lists()
            return MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode::SiteLists::SiteListsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/edge/internetExplorerMode{?%24select,%24expand}"
        ...
        ## A container for Internet Explorer mode resources.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of internet_explorer_mode
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::InternetExplorerMode.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property internetExplorerMode in admin
        ## @param body The request body
        ...
        def site_lists_by_id(id)
            ...
            return MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode::SiteLists::Item::BrowserSiteListItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
