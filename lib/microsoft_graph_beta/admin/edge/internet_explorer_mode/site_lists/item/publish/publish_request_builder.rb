...
module MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode::SiteLists::Item::Publish
    ## 
    ...
    class PublishRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/microsoft.graph.publish"
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of browser_site_list
        ## 
