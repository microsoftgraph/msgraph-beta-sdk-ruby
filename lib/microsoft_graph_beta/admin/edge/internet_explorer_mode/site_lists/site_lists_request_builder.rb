...
module MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode::SiteLists
    ...
    class SiteListsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode::SiteLists::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/edge/internetExplorerMode/siteLists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get a list of the browserSiteList objects and their properties.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of browser_site_list_collection_response
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::BrowserSiteListCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Create a new browserSiteList object to support Internet Explorer mode.
        ## @param body The request body
