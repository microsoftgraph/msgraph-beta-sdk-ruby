...
require_relative '../../models/tenant_admin/sharepoint'
require_relative '../admin'
require_relative './settings/settings_request_builder'
require_relative './sharepoint'

module MicrosoftGraphBeta::Admin::Sharepoint
    ## 
    ...
    class SharepointRequestBuilder
        ...
        def settings()
            return MicrosoftGraphBeta::Admin::Sharepoint::Settings::SettingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/sharepoint{?%24select,%24expand}"
        ...
        ## A container for administrative resources to manage tenant-level settings for SharePoint and OneDrive.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of sharepoint
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TenantAdmin::Sharepoint.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property sharepoint in admin
        ## @param body The request body
