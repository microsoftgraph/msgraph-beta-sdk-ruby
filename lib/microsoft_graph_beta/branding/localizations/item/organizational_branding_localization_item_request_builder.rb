...
module MicrosoftGraphBeta::Branding::Localizations::Item
    ## 
    ...
    class OrganizationalBrandingLocalizationItemRequestBuilder
        ...
        def background_image()
            return MicrosoftGraphBeta::Branding::Localizations::Item::BackgroundImage::BackgroundImageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organizationalBranding entity.
        def banner_logo()
            return MicrosoftGraphBeta::Branding::Localizations::Item::BannerLogo::BannerLogoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organizationalBranding entity.
        def custom_c_s_s()
            return MicrosoftGraphBeta::Branding::Localizations::Item::CustomCSS::CustomCSSRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organizationalBranding entity.
        def favicon()
            return MicrosoftGraphBeta::Branding::Localizations::Item::Favicon::FaviconRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organizationalBranding entity.
        def header_logo()
            return MicrosoftGraphBeta::Branding::Localizations::Item::HeaderLogo::HeaderLogoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        # Provides operations to manage the media for the organizationalBranding entity.
        def square_logo()
            return MicrosoftGraphBeta::Branding::Localizations::Item::SquareLogo::SquareLogoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organizationalBranding entity.
        def square_logo_dark()
            return MicrosoftGraphBeta::Branding::Localizations::Item::SquareLogoDark::SquareLogoDarkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
