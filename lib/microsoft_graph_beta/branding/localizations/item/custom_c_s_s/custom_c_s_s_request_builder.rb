...
module MicrosoftGraphBeta::Branding::Localizations::Item::CustomCSS
    ## 
    ...
    class CustomCSSRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/branding/localizations/{organizationalBrandingLocalization%2Did}/customCSS"
