...
module MicrosoftGraphBeta::Branding::Localizations::Item::HeaderLogo
    ## 
    ...
    class HeaderLogoRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/branding/localizations/{organizationalBrandingLocalization%2Did}/headerLogo"
