...
module MicrosoftGraphBeta::Branding::Localizations
    ## 
    ...
    class LocalizationsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Branding::Localizations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
