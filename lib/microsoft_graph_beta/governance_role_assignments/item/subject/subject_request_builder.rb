...
module MicrosoftGraphBeta::GovernanceRoleAssignments::Item::Subject
    ## 
    ...
    class SubjectRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}/subject{?%24select,%24expand}"
