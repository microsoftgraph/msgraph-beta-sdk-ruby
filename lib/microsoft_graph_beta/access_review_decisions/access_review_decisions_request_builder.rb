...
module MicrosoftGraphBeta::AccessReviewDecisions
    ...
    class AccessReviewDecisionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/accessReviewDecisions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get entities from accessReviewDecisions
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of access_review_decision_collection_response
        ## 
