...
module MicrosoftGraphBeta::AppCatalogs::TeamsApps::Item::AppDefinitions
    ## 
    ...
    class AppDefinitionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::AppCatalogs::TeamsApps::Item::AppDefinitions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TeamsAppDefinitionCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
