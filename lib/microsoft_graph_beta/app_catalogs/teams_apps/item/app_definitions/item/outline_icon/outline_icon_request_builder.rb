...
module MicrosoftGraphBeta::AppCatalogs::TeamsApps::Item::AppDefinitions::Item::OutlineIcon
    ## 
    ...
    class OutlineIconRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/appCatalogs/teamsApps/{teamsApp%2Did}/appDefinitions/{teamsAppDefinition%2Did}/outlineIcon{?%24select,%24expand}"
        ...
        ## Retrieve a Teams app icon associated with a specific definition of an app.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of teams_app_icon
        ## 
