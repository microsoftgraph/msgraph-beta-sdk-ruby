...
module MicrosoftGraphBeta::Workbooks::Item::Children
    ## 
    ...
    class ChildrenRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Workbooks::Item::Children::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
