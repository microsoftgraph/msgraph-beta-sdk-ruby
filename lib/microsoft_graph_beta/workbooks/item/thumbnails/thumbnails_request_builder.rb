...
module MicrosoftGraphBeta::Workbooks::Item::Thumbnails
    ## 
    ...
    class ThumbnailsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Workbooks::Item::Thumbnails::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
