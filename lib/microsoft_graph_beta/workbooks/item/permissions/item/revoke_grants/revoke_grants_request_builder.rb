...
module MicrosoftGraphBeta::Workbooks::Item::Permissions::Item::RevokeGrants
    ## 
    ...
    class RevokeGrantsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/workbooks/{driveItem%2Did}/permissions/{permission%2Did}/microsoft.graph.revokeGrants"
