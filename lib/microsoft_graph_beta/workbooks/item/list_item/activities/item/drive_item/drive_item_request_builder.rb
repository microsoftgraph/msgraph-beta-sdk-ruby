...
module MicrosoftGraphBeta::Workbooks::Item::ListItem::Activities::Item::DriveItem
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Workbooks::Item::ListItem::Activities::Item::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/workbooks/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}"
