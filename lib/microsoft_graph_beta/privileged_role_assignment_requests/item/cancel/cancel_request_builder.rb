...
module MicrosoftGraphBeta::PrivilegedRoleAssignmentRequests::Item::Cancel
    ## 
    ...
    class CancelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/microsoft.graph.cancel"
