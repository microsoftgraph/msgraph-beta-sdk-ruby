...
module MicrosoftGraphBeta::PrivilegedRoleAssignmentRequests::Item::RoleInfo::Settings
    ## 
    ...
    class SettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/settings{?%24select,%24expand}"
