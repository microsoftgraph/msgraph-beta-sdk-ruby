...
module MicrosoftGraphBeta::PrivilegedRoleAssignmentRequests::Item::RoleInfo::SelfActivate
    ## 
    ...
    class SelfActivateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/microsoft.graph.selfActivate"
