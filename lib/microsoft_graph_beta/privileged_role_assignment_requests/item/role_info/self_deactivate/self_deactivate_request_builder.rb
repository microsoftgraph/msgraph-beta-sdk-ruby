...
module MicrosoftGraphBeta::PrivilegedRoleAssignmentRequests::Item::RoleInfo::SelfDeactivate
    ## 
    ...
    class SelfDeactivateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/microsoft.graph.selfDeactivate"
