...
module MicrosoftGraphBeta::Users::Item::Calendars::Item::CalendarView::Item::ExceptionOccurrences
    ## 
    ...
    class ExceptionOccurrencesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Users::Item::Calendars::Item::CalendarView::Item::ExceptionOccurrences::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
