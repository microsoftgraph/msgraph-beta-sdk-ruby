...
module MicrosoftGraphBeta::Users::Item::Calendars::Item::Events
    ## 
    ...
    class EventsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Users::Item::Calendars::Item::Events::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
