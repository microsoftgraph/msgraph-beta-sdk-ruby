...
module MicrosoftGraphBeta::Users::Item::Calendars::Item::Events::Item::ExceptionOccurrences::Item::Instances::Item::Attachments::Item
    ## 
    ...
    class AttachmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, attachment_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/attachments/{attachment%2Did}{?%24select,%24expand}"
