                ...
                module Item
                    module MultiValueExtendedProperties
                        ...
                        class MultiValueExtendedPropertiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::Users::Item::Calendars::Item::MultiValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.calendar entity.
                            ...
                            def by_multi_value_legacy_extended_property_id(multi_value_legacy_extended_property_id)
                                ...
                                return MicrosoftGraphBeta::Users::Item::Calendars::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
