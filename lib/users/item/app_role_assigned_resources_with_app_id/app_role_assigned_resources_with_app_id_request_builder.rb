...
require_relative './app_role_assigned_resources_with_app_id'

module MicrosoftGraphBeta
    module Users
        module Item
            module AppRoleAssignedResourcesWithAppId
                ## 
                # Provides operations to manage the appRoleAssignedResources property of the microsoft.graph.user entity.
                class AppRoleAssignedResourcesWithAppIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter, app_id=nil)
                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/appRoleAssignedResources(appId='{appId}'){?%24select,%24expand}")
                    end
                    ## 
                    ...
                    def with_url(raw_url)
                        ...
                        return AppRoleAssignedResourcesWithAppIdRequestBuilder.new(raw_url, @request_adapter)
                    end
