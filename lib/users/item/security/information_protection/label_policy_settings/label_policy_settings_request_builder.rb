...
module MicrosoftGraphBeta::Users::Item::Security::InformationProtection::LabelPolicySettings
    ## 
    ...
    class LabelPolicySettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/security/informationProtection/labelPolicySettings{?%24select,%24expand}"
