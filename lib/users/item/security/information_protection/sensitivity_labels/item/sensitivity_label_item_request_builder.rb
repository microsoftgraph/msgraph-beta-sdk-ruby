...
module MicrosoftGraphBeta::Users::Item::Security::InformationProtection::SensitivityLabels::Item
    ## 
    ...
    class SensitivityLabelItemRequestBuilder
        ...
        ## @param sensitivityLabelId key: id of sensitivityLabel
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, sensitivity_label_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}"
