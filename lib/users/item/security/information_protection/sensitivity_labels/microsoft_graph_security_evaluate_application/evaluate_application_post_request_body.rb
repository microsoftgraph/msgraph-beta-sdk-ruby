...
require_relative '../../../../../../models/security_labeling_options'
                            ...
                            class EvaluateApplicationPostRequestBody
                                ...
                                def get_field_deserializers()
                                    return {
                                        ...
                                        "labelingOptions" => lambda {|n| @labeling_options = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SecurityLabelingOptions.create_from_discriminator_value(pn) }) },
                                    }
                                end
                                ## 
