...
require_relative '../../../../../../models/security/labeling_options'
...
module MicrosoftGraphBeta::Users::Item::Security::InformationProtection::SensitivityLabels::MicrosoftGraphSecurityEvaluateApplication
    class EvaluateApplicationPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "labelingOptions" => lambda {|n| @labeling_options = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Security::LabelingOptions.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
