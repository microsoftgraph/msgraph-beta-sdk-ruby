...
require_relative '../../../../models/security_information_protection'
                ...
                module InformationProtection
                    ...
                    class InformationProtectionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def label_policy_settings()
                            return MicrosoftGraphBeta::Users::Item::Security::InformationProtection::LabelPolicySettings::LabelPolicySettingsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def sensitivity_labels()
                            return MicrosoftGraphBeta::Users::Item::Security::InformationProtection::SensitivityLabels::SensitivityLabelsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/security/informationProtection{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ## @return a Fiber of security_information_protection
                        ## 
                        def get(request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SecurityInformationProtection.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/users/{user%2Did}/security/informationProtection'
