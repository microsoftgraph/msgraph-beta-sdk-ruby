...
require_relative './item/skill_proficiency_item_request_builder'
        ...
        module Item
            module Profile
                module Skills
                    ...
                    class SkillsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## 
                        def by_skill_proficiency_id(skill_proficiency_id)
                            raise StandardError, 'skill_proficiency_id cannot be null' if skill_proficiency_id.nil?
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/profile/skills{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/users/{user%2Did}/profile/skills'
                            request_info.path_parameters = @path_parameters
