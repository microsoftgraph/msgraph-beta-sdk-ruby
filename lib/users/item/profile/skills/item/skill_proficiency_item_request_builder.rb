...
module MicrosoftGraphBeta::Users::Item::Profile::Skills::Item
    ## 
    ...
    class SkillProficiencyItemRequestBuilder
        ...
        ## @param skillProficiencyId key: id of skillProficiency
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, skill_proficiency_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/users/{user%2Did}/profile/skills/{skillProficiency%2Did}{?%24select,%24expand}"
