            ...
            module Profile
                module Skills
                    module Item
                        ...
                        class SkillProficiencyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/profile/skills/{skillProficiency%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/users/{user%2Did}/profile/skills/{skillProficiency%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return SkillProficiencyItemRequestBuilder.new(raw_url, @request_adapter)
                            end
