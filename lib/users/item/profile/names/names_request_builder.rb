...
require_relative '../../../../models/person_name'
require_relative '../../../../models/person_name_collection_response'
require_relative '../../../users'
require_relative '../../item'
require_relative '../profile'
require_relative './count/count_request_builder'
require_relative './item/person_name_item_request_builder'
            ...
            module Profile
                module Names
                    ...
                    class NamesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Users::Item::Profile::Names::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the names property of the microsoft.graph.profile entity.
                        ...
                        ## 
                        def by_person_name_id(person_name_id)
                            raise StandardError, 'person_name_id cannot be null' if person_name_id.nil?
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/profile/names{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/users/{user%2Did}/profile/names'
                            request_info.path_parameters = @path_parameters
