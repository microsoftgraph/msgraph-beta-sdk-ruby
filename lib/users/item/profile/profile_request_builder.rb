...
module MicrosoftGraphBeta::Users::Item::Profile
    ## 
    ...
    class ProfileRequestBuilder
        ...
        def account_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Account::Item::UserAccountInformationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the addresses property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def addresses_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Addresses::Item::ItemAddressItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the anniversaries property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def anniversaries_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Anniversaries::Item::PersonAnnualEventItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the awards property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def awards_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Awards::Item::PersonAwardItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the certifications property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def certifications_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Certifications::Item::PersonCertificationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/profile{?%24select,%24expand}"
        ...
        def educational_activities_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::EducationalActivities::Item::EducationalActivityItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the emails property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def emails_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Emails::Item::ItemEmailItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def interests_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Interests::Item::PersonInterestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the languages property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def languages_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Languages::Item::LanguageProficiencyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the names property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def names_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Names::Item::PersonNameItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the notes property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def notes_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Notes::Item::PersonAnnotationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def patents_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Patents::Item::ItemPatentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the phones property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def phones_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Phones::Item::ItemPhoneItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the positions property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def positions_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Positions::Item::WorkPositionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the projects property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def projects_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Projects::Item::ProjectParticipationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the publications property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def publications_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Publications::Item::ItemPublicationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the skills property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def skills_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Skills::Item::SkillProficiencyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Deletes a profile object from a user's account.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def web_accounts_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::WebAccounts::Item::WebAccountItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the websites property of the microsoft.graph.profile entity.
        ## @param id Unique identifier of the item
        ...
        def websites_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Profile::Websites::Item::PersonWebsiteItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
