...
module MicrosoftGraphBeta::Users::Item::Calendar::Events
    ## 
    ...
    class EventsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Users::Item::Calendar::Events::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
