...
module MicrosoftGraphBeta::Users::Item::Calendar::CalendarView::Item::ExceptionOccurrences::Item::Attachments::Item
    ## 
    ...
    class AttachmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, attachment_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments/{attachment%2Did}{?%24select,%24expand}"
