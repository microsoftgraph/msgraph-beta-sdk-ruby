...
module MicrosoftGraphBeta::Users::Item::Calendar::CalendarView::Item::ExceptionOccurrences::Item::Instances::Item::Attachments
    ...
    class AttachmentsRequestBuilder
        ...
        def microsoft_graph_create_upload_session()
            return MicrosoftGraphBeta::Users::Item::Calendar::CalendarView::Item::ExceptionOccurrences::Item::Instances::Item::Attachments::MicrosoftGraphCreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
