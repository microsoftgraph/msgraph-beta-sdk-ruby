...
module MicrosoftGraphBeta::Users::Item::Calendar::CalendarView::Item::Instances::Item::ExceptionOccurrences::Item::Attachments::MicrosoftGraphCreateUploadSession
    ## 
    ...
    class MicrosoftGraphCreateUploadSessionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/attachments/microsoft.graph.createUploadSession"
