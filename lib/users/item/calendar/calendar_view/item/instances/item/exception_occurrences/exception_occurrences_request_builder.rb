...
module MicrosoftGraphBeta::Users::Item::Calendar::CalendarView::Item::Instances::Item::ExceptionOccurrences
    ...
    class ExceptionOccurrencesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Users::Item::Calendar::CalendarView::Item::Instances::Item::ExceptionOccurrences::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
