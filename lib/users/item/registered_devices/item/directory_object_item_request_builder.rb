                ...
                module Item
                    ...
                    class DirectoryObjectItemRequestBuilder
                        ...
                        def microsoft_graph_device()
                            return MicrosoftGraphBeta::Users::Item::RegisteredDevices::Item::MicrosoftGraphDevice::MicrosoftGraphDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Casts the previous resource to endpoint.
                        def microsoft_graph_endpoint()
                            return MicrosoftGraphBeta::Users::Item::RegisteredDevices::Item::MicrosoftGraphEndpoint::MicrosoftGraphEndpointRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
