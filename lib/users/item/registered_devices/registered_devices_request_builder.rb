...
module MicrosoftGraphBeta::Users::Item::RegisteredDevices
    ...
    class RegisteredDevicesRequestBuilder
        ...
        def microsoft_graph_device()
            return MicrosoftGraphBeta::Users::Item::RegisteredDevices::MicrosoftGraphDevice::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def microsoft_graph_endpoint()
            return MicrosoftGraphBeta::Users::Item::RegisteredDevices::MicrosoftGraphEndpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
