            ...
            module RegisteredDevices
                ...
                class RegisteredDevicesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def graph_app_role_assignment()
                        return MicrosoftGraphBeta::Users::Item::RegisteredDevices::GraphAppRoleAssignment::GraphAppRoleAssignmentRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to device.
                    def graph_device()
                        return MicrosoftGraphBeta::Users::Item::RegisteredDevices::GraphDevice::GraphDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to endpoint.
                    def graph_endpoint()
                        return MicrosoftGraphBeta::Users::Item::RegisteredDevices::GraphEndpoint::GraphEndpointRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the registeredDevices property of the microsoft.graph.user entity.
