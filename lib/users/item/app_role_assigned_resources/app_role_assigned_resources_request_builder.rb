...
module MicrosoftGraphBeta::Users::Item::AppRoleAssignedResources
    ## 
    ...
    class AppRoleAssignedResourcesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/appRoleAssignedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
