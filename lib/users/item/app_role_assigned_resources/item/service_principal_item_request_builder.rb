...
module MicrosoftGraphBeta::Users::Item::AppRoleAssignedResources::Item
    ## 
    ...
    class ServicePrincipalItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/appRoleAssignedResources/{servicePrincipal%2Did}{?%24select,%24expand}"
