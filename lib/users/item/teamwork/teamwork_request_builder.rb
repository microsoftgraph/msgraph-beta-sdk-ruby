...
module MicrosoftGraphBeta::Users::Item::Teamwork
    ## 
    ...
    class TeamworkRequestBuilder
        ...
        def associated_teams()
            return MicrosoftGraphBeta::Users::Item::Teamwork::AssociatedTeams::AssociatedTeamsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the installedApps property of the microsoft.graph.userTeamwork entity.
        def installed_apps()
            return MicrosoftGraphBeta::Users::Item::Teamwork::InstalledApps::InstalledAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendActivityNotification method.
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraphBeta::Users::Item::Teamwork::MicrosoftGraphSendActivityNotification::MicrosoftGraphSendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def associated_teams_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Teamwork::AssociatedTeams::Item::AssociatedTeamInfoItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UserTeamwork.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the installedApps property of the microsoft.graph.userTeamwork entity.
        ## @param id Unique identifier of the item
        ...
        def installed_apps_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Teamwork::InstalledApps::Item::UserScopeTeamsAppInstallationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
