...
module MicrosoftGraphBeta::Users::Item::Teamwork
    ...
    class TeamworkRequestBuilder
        ...
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraphBeta::Users::Item::Teamwork::MicrosoftGraphSendActivityNotification::SendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
