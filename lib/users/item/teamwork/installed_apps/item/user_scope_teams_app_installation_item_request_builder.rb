                ...
                module InstalledApps
                    module Item
                        ...
                        class UserScopeTeamsAppInstallationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def teams_app()
                                return MicrosoftGraphBeta::Users::Item::Teamwork::InstalledApps::Item::TeamsApp::TeamsAppRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the teamsAppDefinition property of the microsoft.graph.teamsAppInstallation entity.
                            def teams_app_definition()
                                return MicrosoftGraphBeta::Users::Item::Teamwork::InstalledApps::Item::TeamsAppDefinition::TeamsAppDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
