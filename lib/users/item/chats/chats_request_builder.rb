        ...
        module Item
            module Chats
                ...
                class ChatsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def all_messages()
                        return MicrosoftGraphBeta::Users::Item::Chats::AllMessages::AllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def get_all_messages()
                        return MicrosoftGraphBeta::Users::Item::Chats::GetAllMessages::GetAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getAllRetainedMessages method.
                    def get_all_retained_messages()
                        return MicrosoftGraphBeta::Users::Item::Chats::GetAllRetainedMessages::GetAllRetainedMessagesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the chats property of the microsoft.graph.user entity.
