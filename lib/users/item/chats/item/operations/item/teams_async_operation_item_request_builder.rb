...
module MicrosoftGraphBeta::Users::Item::Chats::Item::Operations::Item
    ## 
    ...
    class TeamsAsyncOperationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, teams_async_operation_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/operations/{teamsAsyncOperation%2Did}{?%24select,%24expand}"
