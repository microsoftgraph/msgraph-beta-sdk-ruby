                        ...
                        module Item
                            ...
                            class TeamsAppInstallationItemRequestBuilder
                                ...
                                def microsoft_graph_upgrade()
                                    return MicrosoftGraphBeta::Users::Item::Chats::Item::InstalledApps::Item::MicrosoftGraphUpgrade::MicrosoftGraphUpgradeRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
