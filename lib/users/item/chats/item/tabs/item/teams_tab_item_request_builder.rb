...
module MicrosoftGraphBeta::Users::Item::Chats::Item::Tabs::Item
    ## 
    ...
    class TeamsTabItemRequestBuilder
        ...
        def teams_app()
            return MicrosoftGraphBeta::Users::Item::Chats::Item::Tabs::Item::TeamsApp::TeamsAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
