                                ...
                                module Item
                                    module HostedContents
                                        ...
                                        class HostedContentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def count()
                                                return MicrosoftGraphBeta::Users::Item::Chats::Item::Messages::Item::Replies::Item::HostedContents::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ## Provides operations to manage the hostedContents property of the microsoft.graph.chatMessage entity.
