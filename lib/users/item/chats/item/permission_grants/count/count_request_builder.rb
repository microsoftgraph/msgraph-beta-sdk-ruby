...
module MicrosoftGraphBeta::Users::Item::Chats::Item::PermissionGrants::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/permissionGrants/$count{?%24search,%24filter}"
