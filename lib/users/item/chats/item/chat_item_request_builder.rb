                ...
                module Item
                    ...
                    class ChatItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def complete_migration()
                            return MicrosoftGraphBeta::Users::Item::Chats::Item::CompleteMigration::CompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def remove_all_access_for_user()
                            return MicrosoftGraphBeta::Users::Item::Chats::Item::RemoveAllAccessForUser::RemoveAllAccessForUserRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
