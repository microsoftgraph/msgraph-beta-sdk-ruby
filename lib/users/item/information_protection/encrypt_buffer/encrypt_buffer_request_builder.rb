...
module MicrosoftGraphBeta::Users::Item::InformationProtection::EncryptBuffer
    ## 
    ...
    class EncryptBufferRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/microsoft.graph.encryptBuffer"
