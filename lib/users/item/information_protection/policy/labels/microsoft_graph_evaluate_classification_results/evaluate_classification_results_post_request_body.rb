...
require_relative '../../../../../../models/classification_result'
...
module MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::MicrosoftGraphEvaluateClassificationResults
    class EvaluateClassificationResultsPostRequestBody
        ...
        ## @param value Value to set for the classification_results property.
        ## @return a void
        ## 
        ...
        def get_field_deserializers()
            return {
                "classificationResults" => lambda {|n| @classification_results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ClassificationResult.create_from_discriminator_value(pn) }) },
