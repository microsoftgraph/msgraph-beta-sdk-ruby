...
module MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::MicrosoftGraphExtractLabel
    ## 
    ...
    class ExtractLabelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/microsoft.graph.extractLabel"
