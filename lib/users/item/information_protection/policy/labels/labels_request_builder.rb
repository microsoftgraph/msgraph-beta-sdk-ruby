                    ...
                    module Labels
                        ...
                        class LabelsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def evaluate_application()
                                return MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::EvaluateApplication::EvaluateApplicationRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the evaluateClassificationResults method.
                            def evaluate_classification_results()
                                return MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::EvaluateClassificationResults::EvaluateClassificationResultsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the evaluateRemoval method.
                            def evaluate_removal()
                                return MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::EvaluateRemoval::EvaluateRemovalRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the extractLabel method.
                            def extract_label()
                                return MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::ExtractLabel::ExtractLabelRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the labels property of the microsoft.graph.informationProtectionPolicy entity.
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
                            ...
                            def to_post_request_information(body, request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/users/{user%2Did}/informationProtection/policy/labels'
                                request_info.path_parameters = @path_parameters
