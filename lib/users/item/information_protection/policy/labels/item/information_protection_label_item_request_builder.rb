...
module MicrosoftGraphBeta::Users::Item::InformationProtection::Policy::Labels::Item
    ## 
    ...
    class InformationProtectionLabelItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, information_protection_label_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}{?%24select,%24expand}"
