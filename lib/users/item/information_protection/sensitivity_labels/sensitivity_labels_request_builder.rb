...
module MicrosoftGraphBeta::Users::Item::InformationProtection::SensitivityLabels
    ...
    class SensitivityLabelsRequestBuilder
        ...
        def microsoft_graph_evaluate()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::SensitivityLabels::MicrosoftGraphEvaluate::EvaluateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
