...
module MicrosoftGraphBeta::Users::Item::InformationProtection::SensitivityLabels::Item::Sublabels
    ...
    class SublabelsRequestBuilder
        ...
        def microsoft_graph_evaluate()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::SensitivityLabels::Item::Sublabels::MicrosoftGraphEvaluate::EvaluateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
