...
require_relative './microsoft_graph_decrypt_buffer/microsoft_graph_decrypt_buffer_request_builder'
require_relative './microsoft_graph_encrypt_buffer/microsoft_graph_encrypt_buffer_request_builder'
require_relative './microsoft_graph_sign_digest/microsoft_graph_sign_digest_request_builder'
require_relative './microsoft_graph_verify_signature/microsoft_graph_verify_signature_request_builder'
...
module MicrosoftGraphBeta::Users::Item::InformationProtection
    ## 
    ...
    class InformationProtectionRequestBuilder
        ...
        def microsoft_graph_decrypt_buffer()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::MicrosoftGraphDecryptBuffer::MicrosoftGraphDecryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the encryptBuffer method.
        def microsoft_graph_encrypt_buffer()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::MicrosoftGraphEncryptBuffer::MicrosoftGraphEncryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the signDigest method.
        def microsoft_graph_sign_digest()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::MicrosoftGraphSignDigest::MicrosoftGraphSignDigestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the verifySignature method.
        def microsoft_graph_verify_signature()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::MicrosoftGraphVerifySignature::MicrosoftGraphVerifySignatureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection{?%24select,%24expand}"
        ...
        def data_loss_prevention_policies_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::InformationProtection::DataLossPreventionPolicies::Item::DataLossPreventionPolicyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def sensitivity_labels_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::InformationProtection::SensitivityLabels::Item::SensitivityLabelItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the threatAssessmentRequests property of the microsoft.graph.informationProtection entity.
        ## @param id Unique identifier of the item
        ...
        def threat_assessment_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::InformationProtection::ThreatAssessmentRequests::Item::ThreatAssessmentRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property informationProtection for users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
