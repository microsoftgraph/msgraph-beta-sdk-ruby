...
require_relative './microsoft_graph_decrypt_buffer/decrypt_buffer_request_builder'
require_relative './microsoft_graph_encrypt_buffer/encrypt_buffer_request_builder'
require_relative './microsoft_graph_sign_digest/sign_digest_request_builder'
require_relative './microsoft_graph_verify_signature/verify_signature_request_builder'
...
module MicrosoftGraphBeta::Users::Item::InformationProtection
    ...
    class InformationProtectionRequestBuilder
        ...
        def microsoft_graph_decrypt_buffer()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::MicrosoftGraphDecryptBuffer::DecryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the encryptBuffer method.
        def microsoft_graph_encrypt_buffer()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::MicrosoftGraphEncryptBuffer::EncryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the signDigest method.
        def microsoft_graph_sign_digest()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::MicrosoftGraphSignDigest::SignDigestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the verifySignature method.
        def microsoft_graph_verify_signature()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::MicrosoftGraphVerifySignature::VerifySignatureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
