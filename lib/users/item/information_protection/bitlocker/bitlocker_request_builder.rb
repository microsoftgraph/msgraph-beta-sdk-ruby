...
module MicrosoftGraphBeta::Users::Item::InformationProtection::Bitlocker
    ## 
    ...
    class BitlockerRequestBuilder
        ...
        def recovery_keys()
            return MicrosoftGraphBeta::Users::Item::InformationProtection::Bitlocker::RecoveryKeys::RecoveryKeysRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/informationProtection/bitlocker{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Bitlocker.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the recoveryKeys property of the microsoft.graph.bitlocker entity.
