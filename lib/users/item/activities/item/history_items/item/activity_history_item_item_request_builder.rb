...
module MicrosoftGraphBeta::Users::Item::Activities::Item::HistoryItems::Item
    ## 
    ...
    class ActivityHistoryItemItemRequestBuilder
        ...
        def activity()
            return MicrosoftGraphBeta::Users::Item::Activities::Item::HistoryItems::Item::Activity::ActivityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
