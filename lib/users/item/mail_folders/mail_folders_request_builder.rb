...
module MicrosoftGraphBeta::Users::Item::MailFolders
    ## 
    ...
    class MailFoldersRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Users::Item::MailFolders::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
