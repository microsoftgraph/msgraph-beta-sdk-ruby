...
module MicrosoftGraphBeta::Users::Item::MailFolders::Item
    ...
    class MailFolderItemRequestBuilder
        ...
        def microsoft_graph_copy()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::MicrosoftGraphCopy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the move method.
        def microsoft_graph_move()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::MicrosoftGraphMove::MoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
