                        ...
                        module Item
                            ...
                            class MailFolderItemRequestBuilder
                                ...
                                def microsoft_graph_copy()
                                    return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::MicrosoftGraphCopy::MicrosoftGraphCopyRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the move method.
                                def microsoft_graph_move()
                                    return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::MicrosoftGraphMove::MicrosoftGraphMoveRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
