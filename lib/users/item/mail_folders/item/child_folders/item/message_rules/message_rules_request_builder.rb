...
module MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::MessageRules
    ## 
    ...
    class MessageRulesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::MessageRules::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
