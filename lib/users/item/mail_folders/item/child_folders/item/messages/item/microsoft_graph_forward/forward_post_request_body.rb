...
module MicrosoftGraphBeta::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphForward
    class ForwardPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "Message" => lambda {|n| @message = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Message.create_from_discriminator_value(pn) }) },
