...
module MicrosoftGraphBeta::Users::Item::MailFolders::Item::UserConfigurations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/userConfigurations/$count{?%24filter}"
