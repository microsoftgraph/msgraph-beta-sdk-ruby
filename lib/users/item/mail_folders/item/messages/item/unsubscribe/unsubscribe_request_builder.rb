                    ...
                    module Messages
                        module Item
                            module Unsubscribe
                                ...
                                class UnsubscribeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/unsubscribe")
                                    end
                                    ## 
                                    ...
                                    ## @return a unsubscribe_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return UnsubscribeRequestBuilder.new(raw_url, @request_adapter)
                                    end
                                end
                            end
                        end
