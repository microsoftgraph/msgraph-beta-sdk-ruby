...
module MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::DeviceHealthScriptStates::WithIdWithPolicyIdWithDeviceId
    ## 
    ...
    class WithIdWithPolicyIdWithDeviceIdRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, device_id=nil, id=nil, policy_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates/id='{id}',policyId='{policyId}',deviceId='{deviceId}'{?%24select,%24expand}"
