...
module MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::DeviceHealthScriptStates
    ## 
    ...
    class DeviceHealthScriptStatesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::DeviceHealthScriptStates::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## 
        ## Provides operations to manage the deviceHealthScriptStates property of the microsoft.graph.managedDevice entity.
        ## @param deviceId key: deviceId of deviceHealthScriptPolicyState
        ## @param id key: id of deviceHealthScriptPolicyState
        ## @param policyId key: policyId of deviceHealthScriptPolicyState
