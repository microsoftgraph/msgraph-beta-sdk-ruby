                ...
                module Item
                    ...
                    class ManagedDeviceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def change_assignments()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::ChangeAssignments::ChangeAssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initiate_device_attestation()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::InitiateDeviceAttestation::InitiateDeviceAttestationRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def pause_configuration_refresh()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::PauseConfigurationRefresh::PauseConfigurationRefreshRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
