                ...
                module Item
                    ...
                    class ManagedDeviceItemRequestBuilder
                        ...
                        def microsoft_graph_activate_device_esim()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphActivateDeviceEsim::MicrosoftGraphActivateDeviceEsimRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the bypassActivationLock method.
                        def microsoft_graph_bypass_activation_lock()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphBypassActivationLock::MicrosoftGraphBypassActivationLockRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the cleanWindowsDevice method.
                        def microsoft_graph_clean_windows_device()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphCleanWindowsDevice::MicrosoftGraphCleanWindowsDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def microsoft_graph_create_device_log_collection_request()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphCreateDeviceLogCollectionRequest::MicrosoftGraphCreateDeviceLogCollectionRequestRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the createRemoteHelpSession method.
                        def microsoft_graph_create_remote_help_session()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphCreateRemoteHelpSession::MicrosoftGraphCreateRemoteHelpSessionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the deleteUserFromSharedAppleDevice method.
                        def microsoft_graph_delete_user_from_shared_apple_device()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphDeleteUserFromSharedAppleDevice::MicrosoftGraphDeleteUserFromSharedAppleDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the deprovision method.
                        def microsoft_graph_deprovision()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphDeprovision::MicrosoftGraphDeprovisionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the disable method.
                        def microsoft_graph_disable()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphDisable::MicrosoftGraphDisableRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the disableLostMode method.
                        def microsoft_graph_disable_lost_mode()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphDisableLostMode::MicrosoftGraphDisableLostModeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the enableLostMode method.
                        def microsoft_graph_enable_lost_mode()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphEnableLostMode::MicrosoftGraphEnableLostModeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the endRemoteHelpSession method.
                        def microsoft_graph_end_remote_help_session()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphEndRemoteHelpSession::MicrosoftGraphEndRemoteHelpSessionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the enrollNowAction method.
                        def microsoft_graph_enroll_now_action()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphEnrollNowAction::MicrosoftGraphEnrollNowActionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def microsoft_graph_get_cloud_pc_remote_action_results()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphGetCloudPcRemoteActionResults::MicrosoftGraphGetCloudPcRemoteActionResultsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getCloudPcReviewStatus method.
                        def microsoft_graph_get_cloud_pc_review_status()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphGetCloudPcReviewStatus::MicrosoftGraphGetCloudPcReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getFileVaultKey method.
                        def microsoft_graph_get_file_vault_key()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphGetFileVaultKey::MicrosoftGraphGetFileVaultKeyRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getNonCompliantSettings method.
                        def microsoft_graph_get_non_compliant_settings()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphGetNonCompliantSettings::MicrosoftGraphGetNonCompliantSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getOemWarranty method.
                        def microsoft_graph_get_oem_warranty()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphGetOemWarranty::MicrosoftGraphGetOemWarrantyRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def microsoft_graph_initiate_mobile_device_management_key_recovery()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphInitiateMobileDeviceManagementKeyRecovery::MicrosoftGraphInitiateMobileDeviceManagementKeyRecoveryRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def microsoft_graph_initiate_on_demand_proactive_remediation()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphInitiateOnDemandProactiveRemediation::MicrosoftGraphInitiateOnDemandProactiveRemediationRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the locateDevice method.
                        def microsoft_graph_locate_device()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphLocateDevice::MicrosoftGraphLocateDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the logoutSharedAppleDeviceActiveUser method.
                        def microsoft_graph_logout_shared_apple_device_active_user()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphLogoutSharedAppleDeviceActiveUser::MicrosoftGraphLogoutSharedAppleDeviceActiveUserRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the overrideComplianceState method.
                        def microsoft_graph_override_compliance_state()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphOverrideComplianceState::MicrosoftGraphOverrideComplianceStateRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the playLostModeSound method.
                        def microsoft_graph_play_lost_mode_sound()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphPlayLostModeSound::MicrosoftGraphPlayLostModeSoundRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the rebootNow method.
                        def microsoft_graph_reboot_now()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRebootNow::MicrosoftGraphRebootNowRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the recoverPasscode method.
                        def microsoft_graph_recover_passcode()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRecoverPasscode::MicrosoftGraphRecoverPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the reenable method.
                        def microsoft_graph_reenable()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphReenable::MicrosoftGraphReenableRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the remoteLock method.
                        def microsoft_graph_remote_lock()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRemoteLock::MicrosoftGraphRemoteLockRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def microsoft_graph_remove_device_firmware_configuration_interface_management()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRemoveDeviceFirmwareConfigurationInterfaceManagement::MicrosoftGraphRemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the reprovisionCloudPc method.
                        def microsoft_graph_reprovision_cloud_pc()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphReprovisionCloudPc::MicrosoftGraphReprovisionCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the requestRemoteAssistance method.
                        def microsoft_graph_request_remote_assistance()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRequestRemoteAssistance::MicrosoftGraphRequestRemoteAssistanceRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def microsoft_graph_request_remote_help_session_access()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRequestRemoteHelpSessionAccess::MicrosoftGraphRequestRemoteHelpSessionAccessRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the resetPasscode method.
                        def microsoft_graph_reset_passcode()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphResetPasscode::MicrosoftGraphResetPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the resizeCloudPc method.
                        def microsoft_graph_resize_cloud_pc()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphResizeCloudPc::MicrosoftGraphResizeCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the restoreCloudPc method.
                        def microsoft_graph_restore_cloud_pc()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRestoreCloudPc::MicrosoftGraphRestoreCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the retire method.
                        def microsoft_graph_retire()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRetire::MicrosoftGraphRetireRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the revokeAppleVppLicenses method.
                        def microsoft_graph_revoke_apple_vpp_licenses()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRevokeAppleVppLicenses::MicrosoftGraphRevokeAppleVppLicensesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the rotateBitLockerKeys method.
                        def microsoft_graph_rotate_bit_locker_keys()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRotateBitLockerKeys::MicrosoftGraphRotateBitLockerKeysRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the rotateFileVaultKey method.
                        def microsoft_graph_rotate_file_vault_key()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphRotateFileVaultKey::MicrosoftGraphRotateFileVaultKeyRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def microsoft_graph_send_custom_notification_to_company_portal()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphSendCustomNotificationToCompanyPortal::MicrosoftGraphSendCustomNotificationToCompanyPortalRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the setCloudPcReviewStatus method.
                        def microsoft_graph_set_cloud_pc_review_status()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphSetCloudPcReviewStatus::MicrosoftGraphSetCloudPcReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the setDeviceName method.
                        def microsoft_graph_set_device_name()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphSetDeviceName::MicrosoftGraphSetDeviceNameRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the shutDown method.
                        def microsoft_graph_shut_down()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphShutDown::MicrosoftGraphShutDownRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the syncDevice method.
                        def microsoft_graph_sync_device()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphSyncDevice::MicrosoftGraphSyncDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def microsoft_graph_trigger_configuration_manager_action()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphTriggerConfigurationManagerAction::MicrosoftGraphTriggerConfigurationManagerActionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the updateWindowsDeviceAccount method.
                        def microsoft_graph_update_windows_device_account()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphUpdateWindowsDeviceAccount::MicrosoftGraphUpdateWindowsDeviceAccountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the windowsDefenderScan method.
                        def microsoft_graph_windows_defender_scan()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphWindowsDefenderScan::MicrosoftGraphWindowsDefenderScanRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the windowsDefenderUpdateSignatures method.
                        def microsoft_graph_windows_defender_update_signatures()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphWindowsDefenderUpdateSignatures::MicrosoftGraphWindowsDefenderUpdateSignaturesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the wipe method.
                        def microsoft_graph_wipe()
                            return MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphWipe::MicrosoftGraphWipeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
