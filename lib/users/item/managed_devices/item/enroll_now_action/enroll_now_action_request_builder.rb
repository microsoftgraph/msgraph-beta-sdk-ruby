...
module MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::EnrollNowAction
    ## 
    ...
    class EnrollNowActionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/microsoft.graph.enrollNowAction"
