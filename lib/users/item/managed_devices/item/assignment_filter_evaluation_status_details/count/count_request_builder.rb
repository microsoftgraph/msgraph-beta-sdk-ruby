...
module MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::AssignmentFilterEvaluationStatusDetails::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/assignmentFilterEvaluationStatusDetails/$count{?%24search,%24filter}"
