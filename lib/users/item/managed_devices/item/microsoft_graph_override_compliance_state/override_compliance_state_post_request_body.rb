...
module MicrosoftGraphBeta::Users::Item::ManagedDevices::Item::MicrosoftGraphOverrideComplianceState
    class OverrideComplianceStatePostRequestBody
        ...
        ## @param value Value to set for the remediation_url property.
        ## @return a void
        ## 
