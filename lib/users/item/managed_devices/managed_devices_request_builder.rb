            ...
            module ManagedDevices
                ...
                class ManagedDevicesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def bulk_reprovision_cloud_pc()
                        return MicrosoftGraphBeta::Users::Item::ManagedDevices::BulkReprovisionCloudPc::BulkReprovisionCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the bulkRestoreCloudPc method.
                    def bulk_restore_cloud_pc()
                        return MicrosoftGraphBeta::Users::Item::ManagedDevices::BulkRestoreCloudPc::BulkRestoreCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the bulkSetCloudPcReviewStatus method.
                    def bulk_set_cloud_pc_review_status()
                        return MicrosoftGraphBeta::Users::Item::ManagedDevices::BulkSetCloudPcReviewStatus::BulkSetCloudPcReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def download_app_diagnostics()
                        return MicrosoftGraphBeta::Users::Item::ManagedDevices::DownloadAppDiagnostics::DownloadAppDiagnosticsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the downloadPowerliftAppDiagnostic method.
                    def download_powerlift_app_diagnostic()
                        return MicrosoftGraphBeta::Users::Item::ManagedDevices::DownloadPowerliftAppDiagnostic::DownloadPowerliftAppDiagnosticRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the executeAction method.
                    def execute_action()
                        return MicrosoftGraphBeta::Users::Item::ManagedDevices::ExecuteAction::ExecuteActionRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the moveDevicesToOU method.
                    def move_devices_to_o_u()
                        return MicrosoftGraphBeta::Users::Item::ManagedDevices::MoveDevicesToOU::MoveDevicesToOURequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
