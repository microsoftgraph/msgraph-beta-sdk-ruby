...
module MicrosoftGraphBeta::Users::Item::MemberOf::MicrosoftGraphApplication
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::MemberOf::MicrosoftGraphApplication::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
