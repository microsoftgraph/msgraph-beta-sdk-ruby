...
module MicrosoftGraphBeta::Users::Item::MemberOf::MicrosoftGraphGroup
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::MemberOf::MicrosoftGraphGroup::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
