...
module MicrosoftGraphBeta::Users::Item::CreatedObjects::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def microsoft_graph_service_principal()
            return MicrosoftGraphBeta::Users::Item::CreatedObjects::Item::MicrosoftGraphServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
