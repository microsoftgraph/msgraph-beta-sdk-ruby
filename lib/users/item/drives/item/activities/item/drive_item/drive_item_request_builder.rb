...
module MicrosoftGraphBeta::Users::Item::Drives::Item::Activities::Item::DriveItem
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Users::Item::Drives::Item::Activities::Item::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}"
