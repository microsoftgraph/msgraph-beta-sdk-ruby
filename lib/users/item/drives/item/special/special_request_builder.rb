...
module MicrosoftGraphBeta::Users::Item::Drives::Item::Special
    ## 
    ...
    class SpecialRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Drives::Item::Special::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
