...
module MicrosoftGraphBeta::Users::Item::Drives::Item::List::Items::Item::CreateLink
    ## 
    ...
    class CreateLinkRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/microsoft.graph.createLink"
