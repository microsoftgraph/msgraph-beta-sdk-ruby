...
require_relative './contact_merge_suggestions/contact_merge_suggestions_request_builder'
require_relative './exchange/exchange_request_builder'
require_relative './item_insights/item_insights_request_builder'
require_relative './regional_and_language_settings/regional_and_language_settings_request_builder'
            ...
            module Settings
                ...
                class SettingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def contact_merge_suggestions()
                        return MicrosoftGraphBeta::Users::Item::Settings::ContactMergeSuggestions::ContactMergeSuggestionsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the exchange property of the microsoft.graph.userSettings entity.
                    def exchange()
                        return MicrosoftGraphBeta::Users::Item::Settings::Exchange::ExchangeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the itemInsights property of the microsoft.graph.userSettings entity.
                    def item_insights()
                        return MicrosoftGraphBeta::Users::Item::Settings::ItemInsights::ItemInsightsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def regional_and_language_settings()
                        return MicrosoftGraphBeta::Users::Item::Settings::RegionalAndLanguageSettings::RegionalAndLanguageSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def shift_preferences()
                        return MicrosoftGraphBeta::Users::Item::Settings::ShiftPreferences::ShiftPreferencesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the storage property of the microsoft.graph.userSettings entity.
                    def storage()
                        return MicrosoftGraphBeta::Users::Item::Settings::Storage::StorageRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the windows property of the microsoft.graph.userSettings entity.
                    def windows()
                        return MicrosoftGraphBeta::Users::Item::Settings::Windows::WindowsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        error_mapping = Hash.new
                        error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UserSettings.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
