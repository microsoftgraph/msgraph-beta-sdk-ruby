...
module MicrosoftGraphBeta::Users::Item::Authentication::PasswordlessMicrosoftAuthenticatorMethods::Item::Device::MemberOf::Item::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/memberOf/{directoryObject%2Did}/microsoft.graph.application{?%24select,%24expand}"
