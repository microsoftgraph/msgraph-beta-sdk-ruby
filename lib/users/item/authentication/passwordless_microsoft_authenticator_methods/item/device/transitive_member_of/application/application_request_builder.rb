...
module MicrosoftGraphBeta::Users::Item::Authentication::PasswordlessMicrosoftAuthenticatorMethods::Item::Device::TransitiveMemberOf::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Authentication::PasswordlessMicrosoftAuthenticatorMethods::Item::Device::TransitiveMemberOf::Application::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf/microsoft.graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
