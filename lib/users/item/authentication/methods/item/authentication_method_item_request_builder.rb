...
module MicrosoftGraphBeta::Users::Item::Authentication::Methods::Item
    ...
    class AuthenticationMethodItemRequestBuilder
        ...
        def microsoft_graph_disable_sms_sign_in()
            return MicrosoftGraphBeta::Users::Item::Authentication::Methods::Item::MicrosoftGraphDisableSmsSignIn::MicrosoftGraphDisableSmsSignInRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the enableSmsSignIn method.
        def microsoft_graph_enable_sms_sign_in()
            return MicrosoftGraphBeta::Users::Item::Authentication::Methods::Item::MicrosoftGraphEnableSmsSignIn::MicrosoftGraphEnableSmsSignInRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resetPassword method.
        def microsoft_graph_reset_password()
            return MicrosoftGraphBeta::Users::Item::Authentication::Methods::Item::MicrosoftGraphResetPassword::MicrosoftGraphResetPasswordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
