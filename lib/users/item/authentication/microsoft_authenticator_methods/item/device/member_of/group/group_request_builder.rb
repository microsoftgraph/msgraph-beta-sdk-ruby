...
module MicrosoftGraphBeta::Users::Item::Authentication::MicrosoftAuthenticatorMethods::Item::Device::MemberOf::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Authentication::MicrosoftAuthenticatorMethods::Item::Device::MemberOf::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
