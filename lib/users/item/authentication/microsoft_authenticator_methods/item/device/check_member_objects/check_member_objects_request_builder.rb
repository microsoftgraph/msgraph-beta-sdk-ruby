...
module MicrosoftGraphBeta::Users::Item::Authentication::MicrosoftAuthenticatorMethods::Item::Device::CheckMemberObjects
    ...
    class CheckMemberObjectsRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::Authentication::MicrosoftAuthenticatorMethods::Item::Device::CheckMemberObjects::CheckMemberObjectsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke action checkMemberObjects
        ## @param body The request body
