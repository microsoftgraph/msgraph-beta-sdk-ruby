            ...
            module Authentication
                module PhoneMethods
                    ...
                    class PhoneMethodsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Users::Item::Authentication::PhoneMethods::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the phoneMethods property of the microsoft.graph.authentication entity.
                        ...
                        def by_phone_authentication_method_id(phone_authentication_method_id)
                            ...
                            return MicrosoftGraphBeta::Users::Item::Authentication::PhoneMethods::Item::PhoneAuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PhoneAuthenticationMethodCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
