...
module MicrosoftGraphBeta::Users::Item::ContactFolders::Item::ChildFolders::Item
    ## 
    ...
    class ContactFolderItemRequestBuilder
        ...
        def contacts()
            return MicrosoftGraphBeta::Users::Item::ContactFolders::Item::ChildFolders::Item::Contacts::ContactsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def multi_value_extended_properties()
            return MicrosoftGraphBeta::Users::Item::ContactFolders::Item::ChildFolders::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraphBeta::Users::Item::ContactFolders::Item::ChildFolders::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def contacts_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::ContactFolders::Item::ChildFolders::Item::Contacts::Item::ContactItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::ContactFolders::Item::ChildFolders::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::ContactFolders::Item::ChildFolders::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property childFolders for users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
