            ...
            module VirtualEvents
                module Webinars
                    ...
                    class WebinarsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Users::Item::VirtualEvents::Webinars::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the webinars property of the microsoft.graph.userVirtualEventsRoot entity.
                        ...
                        def by_virtual_event_webinar_id(virtual_event_webinar_id)
                            ...
                            return MicrosoftGraphBeta::Users::Item::VirtualEvents::Webinars::Item::VirtualEventWebinarItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/virtualEvents/webinars{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
