...
module MicrosoftGraphBeta::Users::Item::Todo::Lists::Item::Tasks::Item::Attachments::Item
    ## 
    ...
    class AttachmentBaseItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Users::Item::Todo::Lists::Item::Tasks::Item::Attachments::Item::Value::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
