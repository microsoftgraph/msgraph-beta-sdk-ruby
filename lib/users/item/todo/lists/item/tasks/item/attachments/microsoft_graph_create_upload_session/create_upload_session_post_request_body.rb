...
module MicrosoftGraphBeta::Users::Item::Todo::Lists::Item::Tasks::Item::Attachments::MicrosoftGraphCreateUploadSession
    class CreateUploadSessionPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "attachmentInfo" => lambda {|n| @attachment_info = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AttachmentInfo.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
