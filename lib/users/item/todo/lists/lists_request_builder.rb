...
module MicrosoftGraphBeta::Users::Item::Todo::Lists
    ## 
    ...
    class ListsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Users::Item::Todo::Lists::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
