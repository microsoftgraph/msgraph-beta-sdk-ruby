...
module MicrosoftGraphBeta::Users::Item::Todo
    ## 
    ...
    class TodoRequestBuilder
        ...
        def lists()
            return MicrosoftGraphBeta::Users::Item::Todo::Lists::ListsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Todo.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the lists property of the microsoft.graph.todo entity.
        ...
        def lists_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Todo::Lists::Item::TodoTaskListItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
