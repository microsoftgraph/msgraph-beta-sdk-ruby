...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions
    ...
    class DecisionsRequestBuilder
        ...
        def microsoft_graph_record_all_decisions()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::MicrosoftGraphRecordAllDecisions::RecordAllDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
