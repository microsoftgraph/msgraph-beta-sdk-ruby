...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::MicrosoftGraphRecordAllDecisions
    ## 
    ...
    class RecordAllDecisionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions/microsoft.graph.recordAllDecisions"
