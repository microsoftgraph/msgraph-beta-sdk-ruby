...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item
    ...
    class AccessReviewStageItemRequestBuilder
        ...
        def stop()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item::Stop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
