...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item
    ## 
    ...
    class AccessReviewStageItemRequestBuilder
        ...
        def decisions()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item::Decisions::DecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the stop method.
        def microsoft_graph_stop()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item::MicrosoftGraphStop::MicrosoftGraphStopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/stages/{accessReviewStage%2Did}{?%24select,%24expand}"
