...
require_relative './microsoft_graph_record_all_decisions/microsoft_graph_record_all_decisions_request_builder'

module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item::Decisions
    ## 
    ...
    class DecisionsRequestBuilder
        ...
        def microsoft_graph_record_all_decisions()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item::Decisions::MicrosoftGraphRecordAllDecisions::MicrosoftGraphRecordAllDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/stages/{accessReviewStage%2Did}/decisions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
