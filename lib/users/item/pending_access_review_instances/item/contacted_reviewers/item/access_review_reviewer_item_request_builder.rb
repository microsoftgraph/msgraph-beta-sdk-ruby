...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::ContactedReviewers::Item
    ## 
    ...
    class AccessReviewReviewerItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, access_review_reviewer_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/contactedReviewers/{accessReviewReviewer%2Did}{?%24select,%24expand}"
