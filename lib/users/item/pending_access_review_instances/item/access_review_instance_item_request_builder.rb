...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item
    ...
    class AccessReviewInstanceItemRequestBuilder
        ...
        def accept_recommendations()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::AcceptRecommendations::AcceptRecommendationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyDecisions method.
        def apply_decisions()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::ApplyDecisions::ApplyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the batchRecordDecisions method.
        def batch_record_decisions()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::BatchRecordDecisions::BatchRecordDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reset_decisions()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::ResetDecisions::ResetDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendReminder method.
        def send_reminder()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::SendReminder::SendReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def stop()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
