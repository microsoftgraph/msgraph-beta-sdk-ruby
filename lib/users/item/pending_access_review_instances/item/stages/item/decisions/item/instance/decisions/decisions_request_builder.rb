...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::Decisions
    ...
    class DecisionsRequestBuilder
        ...
        def microsoft_graph_record_all_decisions()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::Decisions::MicrosoftGraphRecordAllDecisions::RecordAllDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
