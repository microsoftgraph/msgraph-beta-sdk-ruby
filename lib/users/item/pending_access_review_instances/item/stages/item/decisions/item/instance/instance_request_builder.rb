                                    ...
                                    module Instance
                                        ...
                                        class InstanceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def accept_recommendations()
                                                return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::AcceptRecommendations::AcceptRecommendationsRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            # Provides operations to call the applyDecisions method.
                                            def apply_decisions()
                                                return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::ApplyDecisions::ApplyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            # Provides operations to call the batchRecordDecisions method.
                                            def batch_record_decisions()
                                                return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::BatchRecordDecisions::BatchRecordDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ...
                                            def reset_decisions()
                                                return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::ResetDecisions::ResetDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            # Provides operations to call the sendReminder method.
                                            def send_reminder()
                                                return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::SendReminder::SendReminderRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            # Provides operations to call the stop method.
                                            def stop()
                                                return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::Stop::StopRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            # Provides operations to call the stopApplyDecisions method.
                                            def stop_apply_decisions()
                                                return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::StopApplyDecisions::StopApplyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance{?%24expand,%24select}")
                                            end
                                            ## 
                                            ...
                                            def to_delete_request_information(request_configuration=nil)
                                                ...
                                                request_info.url_template = '{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance'
