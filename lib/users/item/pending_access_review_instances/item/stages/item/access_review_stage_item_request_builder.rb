...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item
    ...
    class AccessReviewStageItemRequestBuilder
        ...
        def microsoft_graph_stop()
            return MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::Stages::Item::MicrosoftGraphStop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
