...
module MicrosoftGraphBeta::Users::Item::PendingAccessReviewInstances::Item::MicrosoftGraphStop
    ## 
    ...
    class StopRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/microsoft.graph.stop"
