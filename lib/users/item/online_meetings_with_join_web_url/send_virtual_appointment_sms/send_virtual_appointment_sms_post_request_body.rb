                ...
                module SendVirtualAppointmentSms
                    class SendVirtualAppointmentSmsPostRequestBody
                        ...
                        def get_field_deserializers()
                            return {
                                "attendees" => lambda {|n| @attendees = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AttendeeNotificationInfo.create_from_discriminator_value(pn) }) },
                                "messageType" => lambda {|n| @message_type = n.get_enum_value(MicrosoftGraphBeta::Models::VirtualAppointmentMessageType) },
                            }
                        end
                        ## 
