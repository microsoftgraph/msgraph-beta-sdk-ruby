...
module MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item
    ## 
    ...
    class DeviceEnrollmentConfigurationItemRequestBuilder
        ...
        def assignments()
            return MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assign method.
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setPriority method.
        def microsoft_graph_set_priority()
            return MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item::MicrosoftGraphSetPriority::MicrosoftGraphSetPriorityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item::Assignments::Item::EnrollmentConfigurationAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::DeviceEnrollmentConfiguration.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
