...
module MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item
    ...
    class DeviceEnrollmentConfigurationItemRequestBuilder
        ...
        def assign()
            return MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item::Assign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set_priority()
            return MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item::SetPriority::SetPriorityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
