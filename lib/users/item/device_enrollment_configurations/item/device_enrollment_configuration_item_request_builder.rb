...
module MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item
    ...
    class DeviceEnrollmentConfigurationItemRequestBuilder
        ...
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item::MicrosoftGraphAssign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setPriority method.
        def microsoft_graph_set_priority()
            return MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item::MicrosoftGraphSetPriority::SetPriorityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
