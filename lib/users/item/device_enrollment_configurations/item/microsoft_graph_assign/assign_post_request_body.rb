...
module MicrosoftGraphBeta::Users::Item::DeviceEnrollmentConfigurations::Item::MicrosoftGraphAssign
    class AssignPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "enrollmentConfigurationAssignments" => lambda {|n| @enrollment_configuration_assignments = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::EnrollmentConfigurationAssignment.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
