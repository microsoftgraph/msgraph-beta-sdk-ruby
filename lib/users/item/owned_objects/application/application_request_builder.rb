...
module MicrosoftGraphBeta::Users::Item::OwnedObjects::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::OwnedObjects::Application::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
