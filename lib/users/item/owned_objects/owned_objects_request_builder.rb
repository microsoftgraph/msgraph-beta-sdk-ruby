...
module MicrosoftGraphBeta::Users::Item::OwnedObjects
    ...
    class OwnedObjectsRequestBuilder
        ...
        def application()
            return MicrosoftGraphBeta::Users::Item::OwnedObjects::Application::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def group()
            return MicrosoftGraphBeta::Users::Item::OwnedObjects::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraphBeta::Users::Item::OwnedObjects::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
