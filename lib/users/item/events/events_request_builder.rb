...
module MicrosoftGraphBeta::Users::Item::Events
    ## 
    ...
    class EventsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Events::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Users::Item::Events::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
