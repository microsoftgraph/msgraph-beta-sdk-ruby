...
module MicrosoftGraphBeta::Users::Item::Events::Item::ExceptionOccurrences::Item::MicrosoftGraphDecline
    ## 
    ...
    class DeclineRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/microsoft.graph.decline"
