...
module MicrosoftGraphBeta::Users::Item::CloudPCs::Item::MicrosoftGraphRename
    ## 
    ...
    class RenameRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}/microsoft.graph.rename"
