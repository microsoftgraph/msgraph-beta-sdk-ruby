                    ...
                    module Reprovision
                        class ReprovisionPostRequestBody
                            ...
                            def get_field_deserializers()
                                return {
                                    "osVersion" => lambda {|n| @os_version = n.get_enum_value(MicrosoftGraphBeta::Users::Item::CloudPCs::Item::Reprovision::ReprovisionPostRequestBodyOsVersion) },
                                    "userAccountType" => lambda {|n| @user_account_type = n.get_enum_value(MicrosoftGraphBeta::Users::Item::CloudPCs::Item::Reprovision::ReprovisionPostRequestBodyUserAccountType) },
                                }
                            end
                            ## 
                            ## Gets the osVersion property value. The osVersion property
                            ## @return a reprovision_post_request_body_os_version
                            ## 
                            def os_version
                                return @os_version
                            end
                            ...
                            ## @return a reprovision_post_request_body_user_account_type
                            ## 
