...
require_relative '../item'
require_relative './microsoft_graph_end_grace_period'

module MicrosoftGraphBeta::Users::Item::CloudPCs::Item::MicrosoftGraphEndGracePeriod
    ## 
    ...
    class EndGracePeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}/microsoft.graph.endGracePeriod"
