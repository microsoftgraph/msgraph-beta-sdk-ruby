...
module MicrosoftGraphBeta::Users::Item::CloudPCs::Item::MicrosoftGraphRestore
    ## 
    ...
    class RestoreRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}/microsoft.graph.restore"
