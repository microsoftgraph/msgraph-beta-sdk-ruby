                ...
                module Item
                    module GetShiftWorkCloudPcAccessState
                        ...
                        class GetShiftWorkCloudPcAccessStateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            ## @return a Fiber of get_shift_work_cloud_pc_access_state_get_response
                            ## 
                            def get(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::CloudPCs::Item::GetShiftWorkCloudPcAccessState::GetShiftWorkCloudPcAccessStateGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Invoke function getShiftWorkCloudPcAccessState
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
