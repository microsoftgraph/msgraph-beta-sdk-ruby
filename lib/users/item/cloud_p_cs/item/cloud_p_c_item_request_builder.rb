...
require_relative './item'
require_relative './power_off/power_off_request_builder'
require_relative './power_on/power_on_request_builder'
...
require_relative './retrieve_cloud_p_c_remote_action_results/retrieve_cloud_p_c_remote_action_results_request_builder'
require_relative './retrieve_review_status/retrieve_review_status_request_builder'
require_relative './retrieve_snapshots/retrieve_snapshots_request_builder'
require_relative './retry_partner_agent_installation/retry_partner_agent_installation_request_builder'
require_relative './set_review_status/set_review_status_request_builder'
            ...
            module CloudPCs
                module Item
                    ...
                    class CloudPCItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def create_snapshot()
                            return MicrosoftGraphBeta::Users::Item::CloudPCs::Item::CreateSnapshot::CreateSnapshotRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get_frontline_cloud_pc_access_state()
                            return MicrosoftGraphBeta::Users::Item::CloudPCs::Item::GetFrontlineCloudPcAccessState::GetFrontlineCloudPcAccessStateRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def power_off()
                            return MicrosoftGraphBeta::Users::Item::CloudPCs::Item::PowerOff::PowerOffRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the powerOn method.
                        def power_on()
                            return MicrosoftGraphBeta::Users::Item::CloudPCs::Item::PowerOn::PowerOnRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def resize()
                            return MicrosoftGraphBeta::Users::Item::CloudPCs::Item::Resize::ResizeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def retrieve_cloud_p_c_remote_action_results()
                            return MicrosoftGraphBeta::Users::Item::CloudPCs::Item::RetrieveCloudPCRemoteActionResults::RetrieveCloudPCRemoteActionResultsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the retrieveReviewStatus method.
                        def retrieve_review_status()
                            return MicrosoftGraphBeta::Users::Item::CloudPCs::Item::RetrieveReviewStatus::RetrieveReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the retrieveSnapshots method.
                        def retrieve_snapshots()
                            return MicrosoftGraphBeta::Users::Item::CloudPCs::Item::RetrieveSnapshots::RetrieveSnapshotsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def set_review_status()
                            return MicrosoftGraphBeta::Users::Item::CloudPCs::Item::SetReviewStatus::SetReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}{?%24expand,%24select}")
                        end
                        ## 
