...
module MicrosoftGraphBeta::Users::Item::CalendarView::Item
    ...
    class EventItemRequestBuilder
        ...
        def microsoft_graph_accept()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Item::MicrosoftGraphAccept::MicrosoftGraphAcceptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancel method.
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the decline method.
        def microsoft_graph_decline()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Item::MicrosoftGraphDecline::MicrosoftGraphDeclineRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the dismissReminder method.
        def microsoft_graph_dismiss_reminder()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Item::MicrosoftGraphDismissReminder::MicrosoftGraphDismissReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the forward method.
        def microsoft_graph_forward()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Item::MicrosoftGraphForward::MicrosoftGraphForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the snoozeReminder method.
        def microsoft_graph_snooze_reminder()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Item::MicrosoftGraphSnoozeReminder::MicrosoftGraphSnoozeReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the tentativelyAccept method.
        def microsoft_graph_tentatively_accept()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Item::MicrosoftGraphTentativelyAccept::MicrosoftGraphTentativelyAcceptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
