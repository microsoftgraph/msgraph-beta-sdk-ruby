...
module MicrosoftGraphBeta::Users::Item::CalendarView::Item::ExceptionOccurrences::Item::Attachments
    ...
    class AttachmentsRequestBuilder
        ...
        def microsoft_graph_create_upload_session()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Item::ExceptionOccurrences::Item::Attachments::MicrosoftGraphCreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
