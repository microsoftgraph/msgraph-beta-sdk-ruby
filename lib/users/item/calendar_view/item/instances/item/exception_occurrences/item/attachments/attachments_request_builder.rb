...
module MicrosoftGraphBeta::Users::Item::CalendarView::Item::Instances::Item::ExceptionOccurrences::Item::Attachments
    ...
    class AttachmentsRequestBuilder
        ...
        def microsoft_graph_create_upload_session()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Item::Instances::Item::ExceptionOccurrences::Item::Attachments::MicrosoftGraphCreateUploadSession::MicrosoftGraphCreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
