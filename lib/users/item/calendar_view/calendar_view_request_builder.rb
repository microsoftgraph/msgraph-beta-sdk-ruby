...
module MicrosoftGraphBeta::Users::Item::CalendarView
    ## 
    ...
    class CalendarViewRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::CalendarView::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Users::Item::CalendarView::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
