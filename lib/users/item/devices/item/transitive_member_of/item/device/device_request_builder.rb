...
module MicrosoftGraphBeta::Users::Item::Devices::Item::TransitiveMemberOf::Item::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}"
