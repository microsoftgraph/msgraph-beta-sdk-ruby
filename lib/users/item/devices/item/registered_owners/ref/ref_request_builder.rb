                        ...
                        module Ref
                            ...
                            class RefRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/$ref?@id={%40id}{&%24count,%24filter,%24orderby,%24search,%24skip,%24top}")
                                end
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/$ref?@id={%40id}'
                                ...
                                def to_get_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/$ref{?%24count,%24filter,%24orderby,%24search,%24skip,%24top}'
                                    request_info.path_parameters = @path_parameters
                                ...
                                def to_post_request_information(body, request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/$ref'
                                    request_info.path_parameters = @path_parameters
