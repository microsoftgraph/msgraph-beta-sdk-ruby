...
module MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredOwners::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredOwners::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
