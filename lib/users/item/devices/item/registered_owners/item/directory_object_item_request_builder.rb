...
module MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredOwners::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def microsoft_graph_endpoint()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredOwners::Item::MicrosoftGraphEndpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to servicePrincipal.
        def microsoft_graph_service_principal()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredOwners::Item::MicrosoftGraphServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredOwners::Item::MicrosoftGraphUser::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
