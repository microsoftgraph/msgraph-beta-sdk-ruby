...
module MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredUsers::Item::MicrosoftGraphEndpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/microsoft.graph.endpoint{?%24select,%24expand}"
