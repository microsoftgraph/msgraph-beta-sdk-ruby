                    ...
                    module MemberOf
                        ...
                        class MemberOfRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def graph_administrative_unit()
                                return MicrosoftGraphBeta::Users::Item::Devices::Item::MemberOf::GraphAdministrativeUnit::GraphAdministrativeUnitRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Casts the previous resource to group.
                            def graph_group()
                                return MicrosoftGraphBeta::Users::Item::Devices::Item::MemberOf::GraphGroup::GraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the memberOf property of the microsoft.graph.device entity.
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
