...
module MicrosoftGraphBeta::Users::Item::Devices::Item::MemberOf::Device::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/microsoft.graph.device/$count{?%24search,%24filter}"
