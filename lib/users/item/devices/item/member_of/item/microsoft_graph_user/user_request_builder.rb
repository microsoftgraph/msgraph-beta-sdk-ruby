...
module MicrosoftGraphBeta::Users::Item::Devices::Item::MemberOf::Item::MicrosoftGraphUser
    ## 
    ...
    class UserRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}"
