...
module MicrosoftGraphBeta::Users::Item::Devices::Item
    ## 
    ...
    class DeviceItemRequestBuilder
        ...
        def commands()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::Commands::CommandsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the extensions property of the microsoft.graph.device entity.
        def extensions()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::Extensions::ExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the memberOf property of the microsoft.graph.device entity.
        def member_of()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::MemberOf::MemberOfRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberGroups method.
        def microsoft_graph_check_member_groups()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::MicrosoftGraphCheckMemberGroups::MicrosoftGraphCheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def microsoft_graph_check_member_objects()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::MicrosoftGraphCheckMemberObjects::MicrosoftGraphCheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberGroups method.
        def microsoft_graph_get_member_groups()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::MicrosoftGraphGetMemberGroups::MicrosoftGraphGetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def microsoft_graph_get_member_objects()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::MicrosoftGraphGetMemberObjects::MicrosoftGraphGetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::MicrosoftGraphRestore::MicrosoftGraphRestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def registered_owners()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredOwners::RegisteredOwnersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the registeredUsers property of the microsoft.graph.device entity.
        def registered_users()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredUsers::RegisteredUsersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def transitive_member_of()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::TransitiveMemberOf::TransitiveMemberOfRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def usage_rights()
            return MicrosoftGraphBeta::Users::Item::Devices::Item::UsageRights::UsageRightsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the commands property of the microsoft.graph.device entity.
        ...
        def commands_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Devices::Item::Commands::Item::CommandItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}{?%24select,%24expand}"
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Devices::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def member_of_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Devices::Item::MemberOf::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        ## 
        ## Gets an item from the MicrosoftGraphBeta.users.item.devices.item.registeredOwners.item collection
        ## @param id Unique identifier of the item
        ## @return a directory_object_item_request_builder
        ## 
        def registered_owners_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredOwners::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the registeredUsers property of the microsoft.graph.device entity.
        ## @param id Unique identifier of the item
        ...
        def registered_users_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Users::Item::Devices::Item::RegisteredUsers::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property devices for users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def transitive_member_of_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["directoryObject%2Did"] = id
            return MicrosoftGraphBeta::Users::Item::Devices::Item::TransitiveMemberOf::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the usageRights property of the microsoft.graph.device entity.
        ## @param id Unique identifier of the item
        ...
        def usage_rights_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Devices::Item::UsageRights::Item::UsageRightItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
