...
require_relative './device_template/device_template_request_builder'
            ...
            module Devices
                module Item
                    ...
                    class DeviceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def device_template()
                            return MicrosoftGraphBeta::Users::Item::Devices::Item::DeviceTemplate::DeviceTemplateRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}{?%24expand,%24select}")
                        end
                        ## 
