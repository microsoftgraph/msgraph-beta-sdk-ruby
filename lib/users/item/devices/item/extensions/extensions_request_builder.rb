...
module MicrosoftGraphBeta::Users::Item::Devices::Item::Extensions
    ## 
    ...
    class ExtensionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/extensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
