...
module MicrosoftGraphBeta::Users::Item::JoinedGroups::MicrosoftGraphValidateProperties
    ## 
    ...
    class ValidatePropertiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedGroups/microsoft.graph.validateProperties"
