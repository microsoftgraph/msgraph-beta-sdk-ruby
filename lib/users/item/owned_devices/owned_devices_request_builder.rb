...
module MicrosoftGraphBeta::Users::Item::OwnedDevices
    ...
    class OwnedDevicesRequestBuilder
        ...
        def microsoft_graph_device()
            return MicrosoftGraphBeta::Users::Item::OwnedDevices::MicrosoftGraphDevice::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def microsoft_graph_endpoint()
            return MicrosoftGraphBeta::Users::Item::OwnedDevices::MicrosoftGraphEndpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
