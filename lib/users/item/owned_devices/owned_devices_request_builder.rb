...
module MicrosoftGraphBeta::Users::Item::OwnedDevices
    ...
    class OwnedDevicesRequestBuilder
        ...
        def device()
            return MicrosoftGraphBeta::Users::Item::OwnedDevices::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def endpoint()
            return MicrosoftGraphBeta::Users::Item::OwnedDevices::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
