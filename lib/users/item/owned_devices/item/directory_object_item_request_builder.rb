...
module MicrosoftGraphBeta::Users::Item::OwnedDevices::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def device()
            return MicrosoftGraphBeta::Users::Item::OwnedDevices::Item::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def endpoint()
            return MicrosoftGraphBeta::Users::Item::OwnedDevices::Item::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
