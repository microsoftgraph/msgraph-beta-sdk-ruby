                ...
                module Item
                    module UserConsentRequests
                        module FilterByCurrentUserWithOn
                            class FilterByCurrentUserWithOnGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                                ...
                                def get_field_deserializers()
                                    return super.merge({
                                        "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::UserConsentRequest.create_from_discriminator_value(pn) }) },
                                    })
                                end
                                ## 
