...
module MicrosoftGraphBeta::Users::Item::Onenote::Sections
    ## 
    ...
    class SectionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Onenote::Sections::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
