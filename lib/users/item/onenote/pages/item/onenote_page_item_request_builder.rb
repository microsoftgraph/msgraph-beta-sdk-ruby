...
module MicrosoftGraphBeta::Users::Item::Onenote::Pages::Item
    ## 
    ...
    class OnenotePageItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Users::Item::Onenote::Pages::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSection method.
        def microsoft_graph_copy_to_section()
            return MicrosoftGraphBeta::Users::Item::Onenote::Pages::Item::MicrosoftGraphCopyToSection::MicrosoftGraphCopyToSectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the onenotePatchContent method.
        def microsoft_graph_onenote_patch_content()
            return MicrosoftGraphBeta::Users::Item::Onenote::Pages::Item::MicrosoftGraphOnenotePatchContent::MicrosoftGraphOnenotePatchContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the preview method.
        def microsoft_graph_preview()
            return MicrosoftGraphBeta::Users::Item::Onenote::Pages::Item::MicrosoftGraphPreview::MicrosoftGraphPreviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentNotebook property of the microsoft.graph.onenotePage entity.
        def parent_notebook()
            return MicrosoftGraphBeta::Users::Item::Onenote::Pages::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentSection property of the microsoft.graph.onenotePage entity.
        def parent_section()
            return MicrosoftGraphBeta::Users::Item::Onenote::Pages::Item::ParentSection::ParentSectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
