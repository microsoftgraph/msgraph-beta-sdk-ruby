...
module MicrosoftGraphBeta::Users::Item::Onenote
    ## 
    ...
    class OnenoteRequestBuilder
        ...
        def notebooks()
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::NotebooksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.onenote entity.
        def operations()
            return MicrosoftGraphBeta::Users::Item::Onenote::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the pages property of the microsoft.graph.onenote entity.
        def pages()
            return MicrosoftGraphBeta::Users::Item::Onenote::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resources()
            return MicrosoftGraphBeta::Users::Item::Onenote::Resources::ResourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sectionGroups property of the microsoft.graph.onenote entity.
        def section_groups()
            return MicrosoftGraphBeta::Users::Item::Onenote::SectionGroups::SectionGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sections property of the microsoft.graph.onenote entity.
        def sections()
            return MicrosoftGraphBeta::Users::Item::Onenote::Sections::SectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def notebooks_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Onenote::Notebooks::Item::NotebookItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Onenote::Operations::Item::OnenoteOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the pages property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def pages_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Onenote::Pages::Item::OnenotePageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def resources_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Onenote::Resources::Item::OnenoteResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sectionGroups property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def section_groups_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Onenote::SectionGroups::Item::SectionGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sections property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def sections_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Onenote::Sections::Item::OnenoteSectionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property onenote for users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
