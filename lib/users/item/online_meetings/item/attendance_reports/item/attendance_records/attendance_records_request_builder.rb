                        ...
                        module Item
                            module AttendanceRecords
                                ...
                                class AttendanceRecordsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AttendanceReports::Item::AttendanceRecords::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the attendanceRecords property of the microsoft.graph.meetingAttendanceReport entity.
                                    ...
                                    def by_attendance_record_id(attendance_record_id)
                                        ...
                                        return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AttendanceReports::Item::AttendanceRecords::Item::AttendanceRecordItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
