...
module MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::MeetingAttendanceReport::AttendanceRecords::Item
    ## 
    ...
    class AttendanceRecordItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, attendance_record_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport/attendanceRecords/{attendanceRecord%2Did}{?%24select,%24expand}"
