            ...
            module OnlineMeetings
                module Item
                    ...
                    class OnlineMeetingItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def ai_insights()
                            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::AiInsights::AiInsightsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def broadcast_recording()
                            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::BroadcastRecording::BroadcastRecordingRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getVirtualAppointmentJoinWebUrl method.
                        def get_virtual_appointment_join_web_url()
                            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::GetVirtualAppointmentJoinWebUrl::GetVirtualAppointmentJoinWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def recordings()
                            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Recordings::RecordingsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def send_virtual_appointment_reminder_sms()
                            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::SendVirtualAppointmentReminderSms::SendVirtualAppointmentReminderSmsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the sendVirtualAppointmentSms method.
                        def send_virtual_appointment_sms()
                            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::SendVirtualAppointmentSms::SendVirtualAppointmentSmsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
