                        ...
                        class SendVirtualAppointmentReminderSmsPostRequestBody
                            ...
                            def get_field_deserializers()
                                return {
                                    ...
                                    "remindBeforeTimeInMinutesType" => lambda {|n| @remind_before_time_in_minutes_type = n.get_enum_value(MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::SendVirtualAppointmentReminderSms::SendVirtualAppointmentReminderSmsPostRequestBodyRemindBeforeTimeInMinutesType) },
                                }
                            end
                            ## 
                            ...
                            ## @return a send_virtual_appointment_reminder_sms_post_request_body_remind_before_time_in_minutes_type
                            ## 
