...
module MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::VirtualAppointment
    ## 
    ...
    class VirtualAppointmentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/virtualAppointment{?%24select,%24expand}"
