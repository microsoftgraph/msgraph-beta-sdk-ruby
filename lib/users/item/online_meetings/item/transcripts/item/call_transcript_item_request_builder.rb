...
module MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Transcripts::Item
    ## 
    ...
    class CallTranscriptItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Transcripts::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, call_transcript_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/transcripts/{callTranscript%2Did}{?%24select,%24expand}"
