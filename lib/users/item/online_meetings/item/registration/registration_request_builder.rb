                    ...
                    module Registration
                        ...
                        class RegistrationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def custom_questions()
                                return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Registration::CustomQuestions::CustomQuestionsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the registrants property of the microsoft.graph.meetingRegistrationBase entity.
                            def registrants()
                                return MicrosoftGraphBeta::Users::Item::OnlineMeetings::Item::Registration::Registrants::RegistrantsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/registration{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/registration'
