...
module MicrosoftGraphBeta::Users::Item::OnlineMeetings
    ## 
    ...
    class OnlineMeetingsRequestBuilder
        ...
        def microsoft_graph_create_or_get()
            return MicrosoftGraphBeta::Users::Item::OnlineMeetings::MicrosoftGraphCreateOrGet::MicrosoftGraphCreateOrGetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
