...
module MicrosoftGraphBeta::Users::Item::Messages::Item::Attachments
    ...
    class AttachmentsRequestBuilder
        ...
        def create_upload_session()
            return MicrosoftGraphBeta::Users::Item::Messages::Item::Attachments::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
