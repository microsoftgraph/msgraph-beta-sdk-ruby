    ...
    class TranslateExchangeIdsPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "SourceIdType" => lambda {|n| @source_id_type = n.get_enum_value(MicrosoftGraphBeta::Models::ExchangeIdFormat) },
                "TargetIdType" => lambda {|n| @target_id_type = n.get_enum_value(MicrosoftGraphBeta::Models::ExchangeIdFormat) },
            }
        end
        ## 
