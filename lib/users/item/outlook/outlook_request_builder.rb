...
module MicrosoftGraphBeta::Users::Item::Outlook
    ## 
    ...
    class OutlookRequestBuilder
        ...
        def microsoft_graph_supported_languages()
            return MicrosoftGraphBeta::Users::Item::Outlook::MicrosoftGraphSupportedLanguages::MicrosoftGraphSupportedLanguagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the supportedTimeZones method.
        def microsoft_graph_supported_time_zones()
            return MicrosoftGraphBeta::Users::Item::Outlook::MicrosoftGraphSupportedTimeZones::MicrosoftGraphSupportedTimeZonesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def master_categories_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Outlook::MasterCategories::Item::OutlookCategoryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to call the supportedTimeZones method.
        ...
        def task_folders_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::OutlookTaskFolderItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the taskGroups property of the microsoft.graph.outlookUser entity.
        ## @param id Unique identifier of the item
        ...
        def task_groups_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::OutlookTaskGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tasks property of the microsoft.graph.outlookUser entity.
        ## @param id Unique identifier of the item
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::Outlook::Tasks::Item::OutlookTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Selective Outlook services available to the user. Read-only. Nullable.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
