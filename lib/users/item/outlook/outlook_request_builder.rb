...
module MicrosoftGraphBeta::Users::Item::Outlook
    ...
    class OutlookRequestBuilder
        ...
        def microsoft_graph_supported_languages()
            return MicrosoftGraphBeta::Users::Item::Outlook::MicrosoftGraphSupportedLanguages::SupportedLanguagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the supportedTimeZones method.
        def microsoft_graph_supported_time_zones()
            return MicrosoftGraphBeta::Users::Item::Outlook::MicrosoftGraphSupportedTimeZones::SupportedTimeZonesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
