...
module MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::Tasks::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}/tasks/$count{?%24filter}"
