                            ...
                            module Item
                                ...
                                class OutlookTaskItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def permanent_delete()
                                        return MicrosoftGraphBeta::Users::Item::Outlook::TaskFolders::Item::Tasks::Item::PermanentDelete::PermanentDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}{?%24expand,%24select}")
                                    end
                                    ## 
