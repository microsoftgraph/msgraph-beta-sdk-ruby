...
module MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item::Attachments
    ...
    class AttachmentsRequestBuilder
        ...
        def microsoft_graph_create_upload_session()
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item::Attachments::MicrosoftGraphCreateUploadSession::MicrosoftGraphCreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
