...
module MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item::MultiValueExtendedProperties::Item
    ## 
    ...
    class MultiValueLegacyExtendedPropertyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, multi_value_legacy_extended_property_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty%2Did}{?%24select,%24expand}"
