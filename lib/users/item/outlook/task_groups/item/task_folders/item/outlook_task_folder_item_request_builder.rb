                            ...
                            module Item
                                ...
                                class OutlookTaskFolderItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def permanent_delete()
                                        return MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::Item::PermanentDelete::PermanentDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders/{outlookTaskFolder%2Did}{?%24expand,%24select}")
                                    end
                                    ## 
