...
module MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item
    ...
    class OutlookTaskItemRequestBuilder
        ...
        def microsoft_graph_complete()
            return MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item::MicrosoftGraphComplete::CompleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
