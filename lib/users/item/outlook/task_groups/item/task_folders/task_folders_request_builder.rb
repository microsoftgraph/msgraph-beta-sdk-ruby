...
require_relative '../../../../../../models/outlook_task_folder_collection_response'
...
require_relative './item/outlook_task_folder_item_request_builder'
                ...
                module TaskGroups
                    module Item
                        module TaskFolders
                            ...
                            class TaskFoldersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                
                                ## 
                                # Provides operations to count the resources in the collection.
                                def count()
                                    return MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the taskFolders property of the microsoft.graph.outlookTaskGroup entity.
                                ...
                                ## 
                                def by_outlook_task_folder_id(outlook_task_folder_id)
                                    raise StandardError, 'outlook_task_folder_id cannot be null' if outlook_task_folder_id.nil?
                                    url_tpl_params = @path_parameters.clone
                                    url_tpl_params["outlookTaskFolder%2Did"] = outlook_task_folder_id
                                    return MicrosoftGraphBeta::Users::Item::Outlook::TaskGroups::Item::TaskFolders::Item::OutlookTaskFolderItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}")
                                end
                                ## 
                                ...
                                def to_post_request_information(body, request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/users/{user%2Did}/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders'
                                    request_info.path_parameters = @path_parameters
