...
require_relative './retrieve_managed_devices_with_app_installation_issues/retrieve_managed_devices_with_app_installation_issues_request_builder'
        ...
        module Item
            ...
            class UserItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def managed_app_log_collection_requests()
                    return MicrosoftGraphBeta::Users::Item::ManagedAppLogCollectionRequests::ManagedAppLogCollectionRequestsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def retrieve_managed_devices_with_app_installation_issues()
                    return MicrosoftGraphBeta::Users::Item::RetrieveManagedDevicesWithAppInstallationIssues::RetrieveManagedDevicesWithAppInstallationIssuesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def solutions()
                    return MicrosoftGraphBeta::Users::Item::Solutions::SolutionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
