...
require_relative './microsoft_graph_wipe_managed_app_registration_by_device_tag'

module MicrosoftGraphBeta
    module Users
        module Item
            module MicrosoftGraphWipeManagedAppRegistrationByDeviceTag
                class WipeManagedAppRegistrationByDeviceTagPostRequestBody
                    ...
                    ## @return a wipe_managed_app_registration_by_device_tag_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return WipeManagedAppRegistrationByDeviceTagPostRequestBody.new
                    end
                    ## 
