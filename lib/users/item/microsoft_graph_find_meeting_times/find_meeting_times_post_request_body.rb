...
module MicrosoftGraphBeta::Users::Item::MicrosoftGraphFindMeetingTimes
    class FindMeetingTimesPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "attendees" => lambda {|n| @attendees = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AttendeeBase.create_from_discriminator_value(pn) }) },
                "isOrganizerOptional" => lambda {|n| @is_organizer_optional = n.get_boolean_value() },
                "locationConstraint" => lambda {|n| @location_constraint = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::LocationConstraint.create_from_discriminator_value(pn) }) },
                ...
                "timeConstraint" => lambda {|n| @time_constraint = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TimeConstraint.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
