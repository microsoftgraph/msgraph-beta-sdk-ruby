...
module MicrosoftGraphBeta::Users::Item::DirectReports::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def org_contact()
            return MicrosoftGraphBeta::Users::Item::DirectReports::Item::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Users::Item::DirectReports::Item::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
