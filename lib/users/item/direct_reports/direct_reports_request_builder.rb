...
module MicrosoftGraphBeta::Users::Item::DirectReports
    ...
    class DirectReportsRequestBuilder
        ...
        def microsoft_graph_org_contact()
            return MicrosoftGraphBeta::Users::Item::DirectReports::MicrosoftGraphOrgContact::MicrosoftGraphOrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::Users::Item::DirectReports::MicrosoftGraphUser::MicrosoftGraphUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
