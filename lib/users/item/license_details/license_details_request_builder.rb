        ...
        module Item
            module LicenseDetails
                ...
                class LicenseDetailsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Users::Item::LicenseDetails::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getTeamsLicensingDetails method.
                    def get_teams_licensing_details()
                        return MicrosoftGraphBeta::Users::Item::LicenseDetails::GetTeamsLicensingDetails::GetTeamsLicensingDetailsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the licenseDetails property of the microsoft.graph.user entity.
