...
module MicrosoftGraphBeta::Users::Item::CalendarGroups::Item::Calendars::Item::CalendarView::Item::ExceptionOccurrences::Item::Instances::Item::Extensions::Item
    ## 
    ...
    class ExtensionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, extension_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/extensions/{extension%2Did}{?%24select,%24expand}"
