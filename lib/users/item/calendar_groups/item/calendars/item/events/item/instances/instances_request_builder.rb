                                ...
                                module Item
                                    module Instances
                                        ...
                                        class InstancesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def delta()
                                                return MicrosoftGraphBeta::Users::Item::CalendarGroups::Item::Calendars::Item::Events::Item::Instances::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ## Provides operations to manage the instances property of the microsoft.graph.event entity.
