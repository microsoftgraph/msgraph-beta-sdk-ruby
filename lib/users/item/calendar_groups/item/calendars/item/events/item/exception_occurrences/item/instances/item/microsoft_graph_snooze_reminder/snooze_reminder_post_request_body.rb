...
module MicrosoftGraphBeta::Users::Item::CalendarGroups::Item::Calendars::Item::Events::Item::ExceptionOccurrences::Item::Instances::Item::MicrosoftGraphSnoozeReminder
    class SnoozeReminderPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "NewReminderTime" => lambda {|n| @new_reminder_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
