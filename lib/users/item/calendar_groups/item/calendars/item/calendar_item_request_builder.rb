                        ...
                        module Item
                            ...
                            class CalendarItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def permanent_delete()
                                    return MicrosoftGraphBeta::Users::Item::CalendarGroups::Item::Calendars::Item::PermanentDelete::PermanentDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
