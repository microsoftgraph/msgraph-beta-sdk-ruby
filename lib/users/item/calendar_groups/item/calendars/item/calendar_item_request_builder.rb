...
module MicrosoftGraphBeta::Users::Item::CalendarGroups::Item::Calendars::Item
    ...
    class CalendarItemRequestBuilder
        ...
        def microsoft_graph_get_schedule()
            return MicrosoftGraphBeta::Users::Item::CalendarGroups::Item::Calendars::Item::MicrosoftGraphGetSchedule::GetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
