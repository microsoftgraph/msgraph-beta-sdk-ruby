                        ...
                        module Item
                            module CalendarPermissions
                                ...
                                class CalendarPermissionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Users::Item::CalendarGroups::Item::Calendars::Item::CalendarPermissions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the calendarPermissions property of the microsoft.graph.calendar entity.
                                    ...
                                    def by_calendar_permission_id(calendar_permission_id)
                                        ...
                                        return MicrosoftGraphBeta::Users::Item::CalendarGroups::Item::Calendars::Item::CalendarPermissions::Item::CalendarPermissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def get(request_configuration=nil)
                                        ...
                                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::CalendarPermissionCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                                    end
                                    ## 
                                    ...
                                    def post(body, request_configuration=nil)
                                        ...
                                        error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                                        error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::CalendarPermission.create_from_discriminator_value(pn) }, error_mapping)
                                    end
                                    ## 
                                    ## The permissions of the users with whom the calendar is shared.
                                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
