                        ...
                        module Item
                            module SingleValueExtendedProperties
                                ...
                                class SingleValueExtendedPropertiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Users::Item::CalendarGroups::Item::Calendars::Item::SingleValueExtendedProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the singleValueExtendedProperties property of the microsoft.graph.calendar entity.
                                    ...
                                    def by_single_value_legacy_extended_property_id(single_value_legacy_extended_property_id)
                                        ...
                                        return MicrosoftGraphBeta::Users::Item::CalendarGroups::Item::Calendars::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
