        ...
        module Item
            module FollowedSites
                ...
                class FollowedSitesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def add()
                        return MicrosoftGraphBeta::Users::Item::FollowedSites::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to count the resources in the collection.
                    def count()
                        return MicrosoftGraphBeta::Users::Item::FollowedSites::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the remove method.
                    def remove()
                        return MicrosoftGraphBeta::Users::Item::FollowedSites::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the followedSites property of the microsoft.graph.user entity.
