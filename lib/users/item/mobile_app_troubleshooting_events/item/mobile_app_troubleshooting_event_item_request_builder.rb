...
module MicrosoftGraphBeta::Users::Item::MobileAppTroubleshootingEvents::Item
    ## 
    ...
    class MobileAppTroubleshootingEventItemRequestBuilder
        ...
        def app_log_collection_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::Users::Item::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item::AppLogCollectionRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Instantiates a new MobileAppTroubleshootingEventItemRequestBuilder and sets the default values.
        ## @param mobileAppTroubleshootingEventId key: id of mobileAppTroubleshootingEvent
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, mobile_app_troubleshooting_event_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/users/{user%2Did}/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}{?%24select,%24expand}"
