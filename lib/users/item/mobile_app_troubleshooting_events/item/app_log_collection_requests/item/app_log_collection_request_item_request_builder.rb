...
module MicrosoftGraphBeta::Users::Item::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item
    ...
    class AppLogCollectionRequestItemRequestBuilder
        ...
        def microsoft_graph_create_download_url()
            return MicrosoftGraphBeta::Users::Item::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item::MicrosoftGraphCreateDownloadUrl::CreateDownloadUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
