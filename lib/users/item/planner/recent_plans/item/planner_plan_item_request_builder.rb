...
module MicrosoftGraphBeta::Users::Item::Planner::RecentPlans::Item
    ## 
    ...
    class PlannerPlanItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/planner/recentPlans/{plannerPlan%2Did}{?%24select,%24expand}"
