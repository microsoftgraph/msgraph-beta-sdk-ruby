            ...
            module IsManagedAppUserBlocked
                ...
                class IsManagedAppUserBlockedRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Users::Item::IsManagedAppUserBlocked::IsManagedAppUserBlockedGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Gets the blocked state of a managed app user.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
