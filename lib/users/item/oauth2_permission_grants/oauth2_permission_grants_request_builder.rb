...
module MicrosoftGraphBeta::Users::Item::Oauth2PermissionGrants
    ## 
    ...
    class Oauth2PermissionGrantsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Users::Item::Oauth2PermissionGrants::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
