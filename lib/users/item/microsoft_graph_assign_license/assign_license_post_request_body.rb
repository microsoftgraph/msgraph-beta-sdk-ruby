...
module MicrosoftGraphBeta::Users::Item::MicrosoftGraphAssignLicense
    class AssignLicensePostRequestBody
        ...
        def get_field_deserializers()
            return {
                "addLicenses" => lambda {|n| @add_licenses = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::AssignedLicense.create_from_discriminator_value(pn) }) },
