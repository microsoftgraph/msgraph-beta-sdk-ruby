    ...
    module Users
        module Item
            module InvitedBy
                ...
                class InvitedByRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/invitedBy{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    ## @return a invited_by_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return InvitedByRequestBuilder.new(raw_url, @request_adapter)
                    end
