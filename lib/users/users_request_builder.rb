...
require_relative './microsoft_graph_get_managed_app_blocked_users/microsoft_graph_get_managed_app_blocked_users_request_builder'
require_relative './microsoft_graph_get_user_owned_objects/microsoft_graph_get_user_owned_objects_request_builder'
require_relative './microsoft_graph_validate_password/microsoft_graph_validate_password_request_builder'
require_relative './microsoft_graph_validate_properties/microsoft_graph_validate_properties_request_builder'
require_relative './users'

module MicrosoftGraphBeta::Users
    ## 
    ...
    class UsersRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Users::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getByIds method.
        def microsoft_graph_get_by_ids()
            return MicrosoftGraphBeta::Users::MicrosoftGraphGetByIds::MicrosoftGraphGetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getManagedAppBlockedUsers method.
        def microsoft_graph_get_managed_app_blocked_users()
            return MicrosoftGraphBeta::Users::MicrosoftGraphGetManagedAppBlockedUsers::MicrosoftGraphGetManagedAppBlockedUsersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getUserOwnedObjects method.
        def microsoft_graph_get_user_owned_objects()
            return MicrosoftGraphBeta::Users::MicrosoftGraphGetUserOwnedObjects::MicrosoftGraphGetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validatePassword method.
        def microsoft_graph_validate_password()
            return MicrosoftGraphBeta::Users::MicrosoftGraphValidatePassword::MicrosoftGraphValidatePasswordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validateProperties method.
        def microsoft_graph_validate_properties()
            return MicrosoftGraphBeta::Users::MicrosoftGraphValidateProperties::MicrosoftGraphValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
