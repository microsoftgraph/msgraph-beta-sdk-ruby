...
require_relative './microsoft_graph_get_managed_app_blocked_users/get_managed_app_blocked_users_request_builder'
require_relative './microsoft_graph_get_user_owned_objects/get_user_owned_objects_request_builder'
require_relative './microsoft_graph_validate_password/validate_password_request_builder'
...
module MicrosoftGraphBeta::Users
    ...
    class UsersRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Users::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getByIds method.
        def microsoft_graph_get_by_ids()
            return MicrosoftGraphBeta::Users::MicrosoftGraphGetByIds::GetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getManagedAppBlockedUsers method.
        def microsoft_graph_get_managed_app_blocked_users()
            return MicrosoftGraphBeta::Users::MicrosoftGraphGetManagedAppBlockedUsers::GetManagedAppBlockedUsersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getUserOwnedObjects method.
        def microsoft_graph_get_user_owned_objects()
            return MicrosoftGraphBeta::Users::MicrosoftGraphGetUserOwnedObjects::GetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validatePassword method.
        def microsoft_graph_validate_password()
            return MicrosoftGraphBeta::Users::MicrosoftGraphValidatePassword::ValidatePasswordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validateProperties method.
        def microsoft_graph_validate_properties()
            return MicrosoftGraphBeta::Users::MicrosoftGraphValidateProperties::ValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
