...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance
    ...
    class InstanceRequestBuilder
        ...
        def microsoft_graph_accept_recommendations()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::MicrosoftGraphAcceptRecommendations::AcceptRecommendationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyDecisions method.
        def microsoft_graph_apply_decisions()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::MicrosoftGraphApplyDecisions::ApplyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the batchRecordDecisions method.
        def microsoft_graph_batch_record_decisions()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::MicrosoftGraphBatchRecordDecisions::BatchRecordDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resetDecisions method.
        def microsoft_graph_reset_decisions()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::MicrosoftGraphResetDecisions::ResetDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendReminder method.
        def microsoft_graph_send_reminder()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::MicrosoftGraphSendReminder::SendReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the stop method.
        def microsoft_graph_stop()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::MicrosoftGraphStop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
