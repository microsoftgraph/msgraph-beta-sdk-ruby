...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::Stages::Item::Decisions::MicrosoftGraphRecordAllDecisions
    ## 
    ...
    class MicrosoftGraphRecordAllDecisionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/stages/{accessReviewStage%2Did}/decisions/microsoft.graph.recordAllDecisions"
