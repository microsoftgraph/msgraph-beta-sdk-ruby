...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::Stages::Item
    ...
    class AccessReviewStageItemRequestBuilder
        ...
        def microsoft_graph_stop()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::Stages::Item::MicrosoftGraphStop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
