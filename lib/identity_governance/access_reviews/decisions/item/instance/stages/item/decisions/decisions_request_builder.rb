...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::Stages::Item::Decisions
    ...
    class DecisionsRequestBuilder
        ...
        def microsoft_graph_record_all_decisions()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::Stages::Item::Decisions::MicrosoftGraphRecordAllDecisions::RecordAllDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
