...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Item::Instance::MicrosoftGraphAcceptRecommendations
    ## 
    ...
    class AcceptRecommendationsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/microsoft.graph.acceptRecommendations"
