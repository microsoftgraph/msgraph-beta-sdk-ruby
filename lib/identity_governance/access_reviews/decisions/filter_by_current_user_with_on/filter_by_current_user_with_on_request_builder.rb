                ...
                module FilterByCurrentUserWithOn
                    ...
                    class FilterByCurrentUserWithOnRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::FilterByCurrentUserWithOn::FilterByCurrentUserWithOnResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Invoke function filterByCurrentUser
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
