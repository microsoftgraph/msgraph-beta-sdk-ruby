...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Decisions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/accessReviews/decisions/$count{?%24search,%24filter}"
