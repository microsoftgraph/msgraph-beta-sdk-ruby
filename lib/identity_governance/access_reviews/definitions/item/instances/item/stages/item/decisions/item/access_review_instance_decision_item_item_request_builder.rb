...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Decisions::Item
    ## 
    ...
    class AccessReviewInstanceDecisionItemItemRequestBuilder
        ...
        def insights()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Decisions::Item::Insights::InsightsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the instance property of the microsoft.graph.accessReviewInstanceDecisionItem entity.
        def instance()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Decisions::Item::Instance::InstanceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def insights_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Decisions::Item::Insights::Item::GovernanceInsightItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
