...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Decisions::Item::Instance::Decisions::Item
    ## 
    ...
    class AccessReviewInstanceDecisionItemItemRequestBuilder
        ...
        def insights()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Decisions::Item::Instance::Decisions::Item::Insights::InsightsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, access_review_instance_decision_item_id1=nil)
            ...
            @url_template = "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/decisions/{accessReviewInstanceDecisionItem%2Did1}{?%24select,%24expand}"
        ...
        def insights_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Decisions::Item::Instance::Decisions::Item::Insights::Item::GovernanceInsightItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
