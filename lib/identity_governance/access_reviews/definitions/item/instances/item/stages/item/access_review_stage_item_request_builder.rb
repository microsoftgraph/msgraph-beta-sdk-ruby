...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item
    ...
    class AccessReviewStageItemRequestBuilder
        ...
        def stop()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Stop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
