                                    ...
                                    module Decisions
                                        ...
                                        class DecisionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def record_all_decisions()
                                                return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Decisions::RecordAllDecisions::RecordAllDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ## Provides operations to manage the decisions property of the microsoft.graph.accessReviewStage entity.
