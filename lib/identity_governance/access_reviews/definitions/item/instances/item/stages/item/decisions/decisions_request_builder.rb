                                ...
                                module Item
                                    module Decisions
                                        ...
                                        class DecisionsRequestBuilder
                                            ...
                                            def count()
                                                return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Decisions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            # Provides operations to call the recordAllDecisions method.
                                            def microsoft_graph_record_all_decisions()
                                                return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::Stages::Item::Decisions::MicrosoftGraphRecordAllDecisions::MicrosoftGraphRecordAllDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
