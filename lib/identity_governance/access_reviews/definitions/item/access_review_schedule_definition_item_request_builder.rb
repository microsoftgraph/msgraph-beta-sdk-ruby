...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item
    ## 
    ...
    class AccessReviewScheduleDefinitionItemRequestBuilder
        ...
        def microsoft_graph_stop()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::MicrosoftGraphStop::MicrosoftGraphStopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def instances_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::AccessReviewInstanceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
