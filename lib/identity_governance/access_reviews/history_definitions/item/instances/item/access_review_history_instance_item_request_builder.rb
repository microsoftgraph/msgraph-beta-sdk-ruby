...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::Item::Instances::Item
    ...
    class AccessReviewHistoryInstanceItemRequestBuilder
        ...
        def microsoft_graph_generate_download_uri()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::Item::Instances::Item::MicrosoftGraphGenerateDownloadUri::GenerateDownloadUriRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
