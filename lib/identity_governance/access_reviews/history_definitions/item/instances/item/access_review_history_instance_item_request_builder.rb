...
module MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::Item::Instances::Item
    ## 
    ...
    class AccessReviewHistoryInstanceItemRequestBuilder
        ...
        def microsoft_graph_generate_download_uri()
            return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::HistoryDefinitions::Item::Instances::Item::MicrosoftGraphGenerateDownloadUri::MicrosoftGraphGenerateDownloadUriRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewHistoryInstance.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
