...
module MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::Files::Item
    ## 
    ...
    class AgreementFileLocalizationItemRequestBuilder
        ...
        def versions()
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::Files::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::Files::Item::Versions::Item::AgreementFileVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
