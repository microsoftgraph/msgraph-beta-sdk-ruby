...
module MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::File
    ## 
    ...
    class FileRequestBuilder
        ...
        def localizations()
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::File::Localizations::LocalizationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AgreementFile.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the localizations property of the microsoft.graph.agreementFile entity.
        ...
        def localizations_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::File::Localizations::Item::AgreementFileLocalizationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
