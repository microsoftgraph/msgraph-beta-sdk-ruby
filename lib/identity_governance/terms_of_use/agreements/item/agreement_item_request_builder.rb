...
module MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item
    ## 
    ...
    class AgreementItemRequestBuilder
        ...
        def acceptances()
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::Acceptances::AcceptancesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the file property of the microsoft.graph.agreement entity.
        def file()
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::File::FileRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the files property of the microsoft.graph.agreement entity.
        def files()
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::Files::FilesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def acceptances_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::Acceptances::Item::AgreementAcceptanceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def files_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::Agreements::Item::Files::Item::AgreementFileLocalizationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Agreement.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
