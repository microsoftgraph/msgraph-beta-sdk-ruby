...
require_relative '../permissions_request_changes'
require_relative './count'

module MicrosoftGraphBeta
    module IdentityGovernance
        module PermissionsManagement
            module PermissionsRequestChanges
                module Count
                    ## 
                    ...
                    class CountRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/permissionsManagement/permissionsRequestChanges/$count{?%24filter,%24search}")
                        end
                        ## 
