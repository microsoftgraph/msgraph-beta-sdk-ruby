...
require_relative './permissions_analytics/permissions_analytics_request_builder'
...
module MicrosoftGraphBeta
    module IdentityGovernance
        ...
        class IdentityGovernanceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def access_reviews()
                return MicrosoftGraphBeta::IdentityGovernance::AccessReviews::AccessReviewsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the appConsent property of the microsoft.graph.identityGovernance entity.
            def app_consent()
                return MicrosoftGraphBeta::IdentityGovernance::AppConsent::AppConsentRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the entitlementManagement property of the microsoft.graph.identityGovernance entity.
            def entitlement_management()
                return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::EntitlementManagementRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def permissions_analytics()
                return MicrosoftGraphBeta::IdentityGovernance::PermissionsAnalytics::PermissionsAnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def privileged_access()
                return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::PrivilegedAccessRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the roleManagementAlerts property of the microsoft.graph.identityGovernance entity.
            def role_management_alerts()
                return MicrosoftGraphBeta::IdentityGovernance::RoleManagementAlerts::RoleManagementAlertsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the termsOfUse property of the microsoft.graph.identityGovernance entity.
            def terms_of_use()
                return MicrosoftGraphBeta::IdentityGovernance::TermsOfUse::TermsOfUseRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceModelModelModelModelModelModel.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
