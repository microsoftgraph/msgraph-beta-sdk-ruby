                                ...
                                module Item
                                    ...
                                    class TaskProcessingResultItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def microsoft_graph_identity_governance_resume()
                                            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Tasks::Item::TaskProcessingResults::Item::MicrosoftGraphIdentityGovernanceResume::MicrosoftGraphIdentityGovernanceResumeRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to manage the subject property of the microsoft.graph.identityGovernance.taskProcessingResult entity.
                                        def subject()
                                            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Tasks::Item::TaskProcessingResults::Item::Subject::SubjectRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to manage the task property of the microsoft.graph.identityGovernance.taskProcessingResult entity.
                                        def task()
                                            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Tasks::Item::TaskProcessingResults::Item::Task::TaskRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
