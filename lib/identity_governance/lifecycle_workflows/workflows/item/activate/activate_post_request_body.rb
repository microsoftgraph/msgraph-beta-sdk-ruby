...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Activate
    class ActivatePostRequestBody
        ...
        def get_field_deserializers()
            return {
                "subjects" => lambda {|n| @subjects = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::User.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
