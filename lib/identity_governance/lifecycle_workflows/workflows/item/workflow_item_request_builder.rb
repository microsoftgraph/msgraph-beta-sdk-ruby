...
require_relative './microsoft_graph_identity_governance_activate/activate_request_builder'
require_relative './microsoft_graph_identity_governance_create_new_version/create_new_version_request_builder'
require_relative './microsoft_graph_identity_governance_restore/restore_request_builder'
...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item
    ## 
    ...
    class WorkflowItemRequestBuilder
        ...
        def microsoft_graph_identity_governance_activate()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::MicrosoftGraphIdentityGovernanceActivate::ActivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createNewVersion method.
        def microsoft_graph_identity_governance_create_new_version()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::MicrosoftGraphIdentityGovernanceCreateNewVersion::CreateNewVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_identity_governance_restore()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::MicrosoftGraphIdentityGovernanceRestore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param workflowId key: id of workflow
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, workflow_id=nil)
