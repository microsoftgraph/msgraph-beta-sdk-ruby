...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item
    ...
    class WorkflowItemRequestBuilder
        ...
        def activate()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Activate::ActivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createNewVersion method.
        def create_new_version()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::CreateNewVersion::CreateNewVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
