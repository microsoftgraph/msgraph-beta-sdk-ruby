            ...
            module Workflows
                module Item
                    ...
                    class WorkflowItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def created_by()
                            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::CreatedBy::CreatedByRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def last_modified_by()
                            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::LastModifiedBy::LastModifiedByRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def tasks()
                            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceWorkflow.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
