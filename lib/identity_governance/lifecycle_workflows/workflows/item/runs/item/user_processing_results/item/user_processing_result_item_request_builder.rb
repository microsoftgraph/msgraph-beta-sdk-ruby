                                ...
                                module Item
                                    ...
                                    class UserProcessingResultItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def get(request_configuration=nil)
                                            ...
                                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceUserProcessingResult.create_from_discriminator_value(pn) }, error_mapping)
                                        end
                                        ## 
                                        ## Get the user processing result of a user processing result of a run.
                                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
