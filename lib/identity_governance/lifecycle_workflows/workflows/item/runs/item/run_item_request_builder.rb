...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Runs::Item
    ## 
    ...
    class RunItemRequestBuilder
        ...
        def task_processing_results()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Runs::Item::TaskProcessingResults::TaskProcessingResultsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_processing_results()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Runs::Item::UserProcessingResults::UserProcessingResultsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, run_id=nil)
            ...
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs/{run%2Did}{?%24select,%24expand}"
        ...
        def task_processing_results_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Runs::Item::TaskProcessingResults::Item::TaskProcessingResultItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get runs from identityGovernance
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
