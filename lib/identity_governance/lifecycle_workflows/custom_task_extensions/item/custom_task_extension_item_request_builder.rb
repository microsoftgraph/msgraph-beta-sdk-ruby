...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::CustomTaskExtensions::Item
    ## 
    ...
    class CustomTaskExtensionItemRequestBuilder
        ...
        def created_by()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::CustomTaskExtensions::Item::CreatedBy::CreatedByRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def last_modified_by()
            return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::CustomTaskExtensions::Item::LastModifiedBy::LastModifiedByRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param customTaskExtensionId key: id of customTaskExtension
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, custom_task_extension_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension%2Did}{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::CustomTaskExtension.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
