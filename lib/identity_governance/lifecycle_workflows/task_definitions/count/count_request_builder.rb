...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::TaskDefinitions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/taskDefinitions/$count{?%24search,%24filter}"
