...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::WorkflowTemplates::Item::Tasks::Item::TaskProcessingResults::Item::Subject
    ## 
    ...
    class SubjectRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflowTemplates/{workflowTemplate%2Did}/tasks/{task%2Did}/taskProcessingResults/{taskProcessingResult%2Did}/subject{?%24select,%24expand}"
