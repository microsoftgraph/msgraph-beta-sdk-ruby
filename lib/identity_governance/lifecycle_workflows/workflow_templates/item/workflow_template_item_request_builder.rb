...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::WorkflowTemplates::Item
    ## 
    ...
    class WorkflowTemplateItemRequestBuilder
        ...
        ## @param workflowTemplateId key: id of workflowTemplate
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, workflow_template_id=nil)
