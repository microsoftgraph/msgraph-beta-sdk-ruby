        ...
        module LifecycleWorkflows
            module Insights
                module Ic71652b80f5b1945fff04eeef0b3fba39f8ce338a5f6894852169faa5fdfa802
                    class TopWorkflowsProcessedSummaryWithStartDateTimeWithEndDateTimeGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                        ...
                        def get_field_deserializers()
                            return super.merge({
                                "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceTopWorkflowsInsightsSummary.create_from_discriminator_value(pn) }) },
                            })
                        end
                        ## 
