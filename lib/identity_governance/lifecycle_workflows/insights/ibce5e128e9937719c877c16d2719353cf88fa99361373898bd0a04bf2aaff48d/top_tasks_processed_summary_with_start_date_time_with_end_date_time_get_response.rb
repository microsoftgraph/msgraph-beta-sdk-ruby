        ...
        module LifecycleWorkflows
            module Insights
                module Ibce5e128e9937719c877c16d2719353cf88fa99361373898bd0a04bf2aaff48d
                    class TopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                        ...
                        def get_field_deserializers()
                            return super.merge({
                                "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceTopTasksInsightsSummary.create_from_discriminator_value(pn) }) },
                            })
                        end
                        ## 
