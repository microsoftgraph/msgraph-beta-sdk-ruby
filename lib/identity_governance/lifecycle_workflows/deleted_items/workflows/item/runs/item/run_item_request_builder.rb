...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::Runs::Item
    ## 
    ...
    class RunItemRequestBuilder
        ...
        ## @param runId key: id of run
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, run_id=nil)
