...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::Runs::Item::UserProcessingResults::SummaryWithStartDateTimeWithEndDateTime
    ## 
    ...
    class SummaryWithStartDateTimeWithEndDateTimeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, end_date_time=nil, start_date_time=nil)
            ...
            @url_template = "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/runs/{run%2Did}/userProcessingResults/microsoft.graph.identityGovernance.summary(startDateTime={startDateTime},endDateTime={endDateTime})"
