...
module MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::UserProcessingResults::Item::TaskProcessingResults::Item::MicrosoftGraphIdentityGovernanceResume
    class ResumePostRequestBody
        ...
        def get_field_deserializers()
            return {
                "data" => lambda {|n| @data = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernance::CustomTaskExtensionCallbackData.create_from_discriminator_value(pn) }) },
