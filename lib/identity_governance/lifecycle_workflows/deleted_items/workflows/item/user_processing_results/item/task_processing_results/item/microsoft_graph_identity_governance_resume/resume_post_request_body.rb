                                        ...
                                        module MicrosoftGraphIdentityGovernanceResume
                                            class ResumePostRequestBody
                                                ...
                                                def get_field_deserializers()
                                                    return {
                                                        "data" => lambda {|n| @data = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::IdentityGovernanceCustomTaskExtensionCallbackData.create_from_discriminator_value(pn) }) },
