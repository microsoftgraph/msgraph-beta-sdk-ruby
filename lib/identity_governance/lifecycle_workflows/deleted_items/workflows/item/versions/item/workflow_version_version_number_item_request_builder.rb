                        ...
                        module Versions
                            module Item
                                ...
                                class WorkflowVersionVersionNumberItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def created_by()
                                        return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::Versions::Item::CreatedBy::CreatedByRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def last_modified_by()
                                        return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::Versions::Item::LastModifiedBy::LastModifiedByRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the tasks property of the microsoft.graph.identityGovernance.workflowBase entity.
                                    def tasks()
                                        return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::Versions::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
