                ...
                module Workflows
                    module Item
                        module IdentityGovernanceRestore
                            ...
                            class IdentityGovernanceRestoreRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/identityGovernance.restore")
                                end
                                ## 
