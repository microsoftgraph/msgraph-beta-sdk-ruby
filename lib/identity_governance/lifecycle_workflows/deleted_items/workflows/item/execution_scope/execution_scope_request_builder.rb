                        ...
                        module ExecutionScope
                            ...
                            class ExecutionScopeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def by_user_processing_result_id(user_processing_result_id)
                                    ...
                                    return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::ExecutionScope::Item::UserProcessingResultItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
