                    ...
                    module Item
                        ...
                        class WorkflowItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def identity_governance_activate()
                                return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::IdentityGovernanceActivate::IdentityGovernanceActivateRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the createNewVersion method.
                            def identity_governance_create_new_version()
                                return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::IdentityGovernanceCreateNewVersion::IdentityGovernanceCreateNewVersionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the restore method.
                            def identity_governance_restore()
                                return MicrosoftGraphBeta::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::IdentityGovernanceRestore::IdentityGovernanceRestoreRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
