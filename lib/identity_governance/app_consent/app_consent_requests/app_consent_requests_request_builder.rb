        ...
        module AppConsent
            module AppConsentRequests
                ...
                class AppConsentRequestsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::IdentityGovernance::AppConsent::AppConsentRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the appConsentRequests property of the microsoft.graph.appConsentApprovalRoute entity.
                    ...
                    def by_app_consent_request_id(app_consent_request_id)
                        ...
                        return MicrosoftGraphBeta::IdentityGovernance::AppConsent::AppConsentRequests::Item::AppConsentRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
