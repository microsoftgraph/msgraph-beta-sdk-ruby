...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackages::Item
    ...
    class AccessPackageItemRequestBuilder
        ...
        def microsoft_graph_get_applicable_policy_requirements()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackages::Item::MicrosoftGraphGetApplicablePolicyRequirements::GetApplicablePolicyRequirementsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the moveToCatalog method.
        def microsoft_graph_move_to_catalog()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackages::Item::MicrosoftGraphMoveToCatalog::MoveToCatalogRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
