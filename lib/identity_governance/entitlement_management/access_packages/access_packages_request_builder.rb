        ...
        module EntitlementManagement
            module AccessPackages
                ...
                class AccessPackagesRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackages::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the Search method.
                    def microsoft_graph_search()
                        return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackages::MicrosoftGraphSearch::MicrosoftGraphSearchRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
