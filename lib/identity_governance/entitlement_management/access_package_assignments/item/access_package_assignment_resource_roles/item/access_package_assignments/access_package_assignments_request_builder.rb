                        ...
                        module Item
                            module AccessPackageAssignments
                                ...
                                class AccessPackageAssignmentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    ## 
                                    ## Provides operations to manage the accessPackageAssignments property of the microsoft.graph.accessPackageAssignmentResourceRole entity.
                                    ## @param access_package_assignment_id1 Unique identifier of the item
                                    ## @return a access_package_assignment_item_request_builder
                                    ## 
                                    def by_access_package_assignment_id1(access_package_assignment_id1)
                                        raise StandardError, 'access_package_assignment_id1 cannot be null' if access_package_assignment_id1.nil?
