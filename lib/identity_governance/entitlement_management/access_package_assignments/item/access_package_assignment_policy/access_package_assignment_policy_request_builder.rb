            ...
            module AccessPackageAssignments
                module Item
                    module AccessPackageAssignmentPolicy
                        ...
                        class AccessPackageAssignmentPolicyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def custom_extension_stage_settings()
                                return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackageAssignmentPolicy::CustomExtensionStageSettings::CustomExtensionStageSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackageAssignmentPolicy{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackageAssignmentPolicy'
                            ...
                            ## @return a access_package_assignment_policy_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return AccessPackageAssignmentPolicyRequestBuilder.new(raw_url, @request_adapter)
                            end
