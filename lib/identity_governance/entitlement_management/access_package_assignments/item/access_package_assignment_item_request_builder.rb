...
require_relative './access_package_assignment_policy/access_package_assignment_policy_request_builder'
...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item
    ## 
    ...
    class AccessPackageAssignmentItemRequestBuilder
        ...
        def access_package()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackage::AccessPackageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def access_package_assignment_policy()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackageAssignmentPolicy::AccessPackageAssignmentPolicyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def access_package_assignment_requests()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackageAssignmentRequests::AccessPackageAssignmentRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def access_package_assignment_resource_roles()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackageAssignmentResourceRoles::AccessPackageAssignmentResourceRolesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reprocess method.
        def microsoft_graph_reprocess()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::MicrosoftGraphReprocess::MicrosoftGraphReprocessRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def target()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::Target::TargetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def access_package_assignment_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackageAssignmentRequests::Item::AccessPackageAssignmentRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the accessPackageAssignmentResourceRoles property of the microsoft.graph.accessPackageAssignment entity.
        ## @param id Unique identifier of the item
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}{?%24select,%24expand}"
