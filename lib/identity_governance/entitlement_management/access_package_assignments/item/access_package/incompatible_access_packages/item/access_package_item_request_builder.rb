...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackage::IncompatibleAccessPackages::Item
    ## 
    ...
    class AccessPackageItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, access_package_id=nil)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackage/incompatibleAccessPackages/{accessPackage%2Did}"
