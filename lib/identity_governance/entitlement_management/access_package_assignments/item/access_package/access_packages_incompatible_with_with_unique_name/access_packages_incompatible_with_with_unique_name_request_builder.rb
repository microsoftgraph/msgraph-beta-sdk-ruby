...
require_relative './access_packages_incompatible_with_with_unique_name'
            ...
            module AccessPackageAssignments
                module Item
                    module AccessPackage
                        module AccessPackagesIncompatibleWithWithUniqueName
                            ## 
                            # Provides operations to manage the accessPackagesIncompatibleWith property of the microsoft.graph.accessPackage entity.
                            class AccessPackagesIncompatibleWithWithUniqueNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter, unique_name=nil)
                                    super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackage/accessPackagesIncompatibleWith(uniqueName='{uniqueName}'){?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def with_url(raw_url)
                                    ...
                                    return AccessPackagesIncompatibleWithWithUniqueNameRequestBuilder.new(raw_url, @request_adapter)
                                end
