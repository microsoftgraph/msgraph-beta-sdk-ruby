...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackage
    ## 
    ...
    class AccessPackageRequestBuilder
        ...
        def microsoft_graph_get_applicable_policy_requirements()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackage::MicrosoftGraphGetApplicablePolicyRequirements::MicrosoftGraphGetApplicablePolicyRequirementsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the moveToCatalog method.
        def microsoft_graph_move_to_catalog()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::Item::AccessPackage::MicrosoftGraphMoveToCatalog::MicrosoftGraphMoveToCatalogRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
