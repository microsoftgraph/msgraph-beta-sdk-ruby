...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignments::AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageId
    ...
    class AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, access_package_id=nil, incompatible_access_package_id=nil)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/microsoft.graph.additionalAccess(accessPackageId='{accessPackageId}',incompatibleAccessPackageId='{incompatibleAccessPackageId}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
