                ...
                module AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageId
                    ...
                    class AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter, access_package_id=nil, incompatible_access_package_id=nil)
                            super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/additionalAccess(accessPackageId='{accessPackageId}',incompatibleAccessPackageId='{incompatibleAccessPackageId}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
