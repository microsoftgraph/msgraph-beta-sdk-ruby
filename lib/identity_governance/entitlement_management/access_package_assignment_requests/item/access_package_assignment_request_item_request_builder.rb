...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignmentRequests::Item
    ...
    class AccessPackageAssignmentRequestItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignmentRequests::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reprocess method.
        def microsoft_graph_reprocess()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageAssignmentRequests::Item::MicrosoftGraphReprocess::MicrosoftGraphReprocessRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
