...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::ConnectedOrganizations::Item
    ## 
    ...
    class ConnectedOrganizationItemRequestBuilder
        ...
        def external_sponsors()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::ConnectedOrganizations::Item::ExternalSponsors::ExternalSponsorsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def internal_sponsors()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::ConnectedOrganizations::Item::InternalSponsors::InternalSponsorsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## 
        ## Gets an item from the MicrosoftGraphBeta.identityGovernance.entitlementManagement.connectedOrganizations.item.externalSponsors.item collection
        ...
        def external_sponsors_by_id(id)
            ...
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::ConnectedOrganizations::Item::ExternalSponsors::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ConnectedOrganization.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
