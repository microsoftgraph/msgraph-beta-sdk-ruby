                ...
                module Item
                    module ExternalSponsors
                        ...
                        class ExternalSponsorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def delta()
                                return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::ConnectedOrganizations::Item::ExternalSponsors::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
