                ...
                module Item
                    module ExternalSponsors
                        module GetUserOwnedObjects
                            ...
                            class GetUserOwnedObjectsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/connectedOrganizations/{connectedOrganization%2Did}/externalSponsors/getUserOwnedObjects")
                                end
                                ## 
                                ...
                                ## @return a get_user_owned_objects_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return GetUserOwnedObjectsRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
