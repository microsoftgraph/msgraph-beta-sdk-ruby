...
require_relative './microsoft_graph_get_user_owned_objects'

module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::ConnectedOrganizations::Item::ExternalSponsors::MicrosoftGraphGetUserOwnedObjects
    ## 
    ...
    class GetUserOwnedObjectsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/connectedOrganizations/{connectedOrganization%2Did}/externalSponsors/microsoft.graph.getUserOwnedObjects"
