...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageCatalogs::Item::AccessPackages
    ...
    class AccessPackagesRequestBuilder
        ...
        def microsoft_graph_search()
            return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageCatalogs::Item::AccessPackages::MicrosoftGraphSearch::SearchRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
