                                        ...
                                        module Item
                                            ...
                                            class CustomExtensionStageSettingItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def custom_extension()
                                                    return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageCatalogs::Item::AccessPackages::Item::AccessPackageAssignmentPolicies::Item::CustomExtensionStageSettings::Item::CustomExtension::CustomExtensionRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
