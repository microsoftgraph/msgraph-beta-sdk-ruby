...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageCatalogs::Item::AccessPackageResourceRoles::Item::AccessPackageResource::AccessPackageResourceScopes::Item::AccessPackageResource::AccessPackageResourceRoles::Item
    ## 
    ...
    class AccessPackageResourceRoleItemRequestBuilder
        ...
        ## @param accessPackageResourceRoleId1 key: id of accessPackageResourceRole
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, access_package_resource_role_id1=nil)
