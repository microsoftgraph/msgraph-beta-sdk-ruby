                ...
                module FilterByCurrentUserWithOn
                    ...
                    class FilterByCurrentUserWithOnRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AssignmentRequests::FilterByCurrentUserWithOn::FilterByCurrentUserWithOnGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## In Microsoft Entra Entitlement Management, retrieve a list of accessPackageAssignmentRequest objects filtered on the signed-in user.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
