...
require_relative './access_packages_with_unique_name'
...
module MicrosoftGraphBeta
    module IdentityGovernance
        module EntitlementManagement
            module AccessPackagesWithUniqueName
                ## 
                # Provides operations to manage the accessPackages property of the microsoft.graph.entitlementManagement entity.
                class AccessPackagesWithUniqueNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to call the getApplicablePolicyRequirements method.
                    def get_applicable_policy_requirements()
                        return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackagesWithUniqueName::GetApplicablePolicyRequirements::GetApplicablePolicyRequirementsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the moveToCatalog method.
                    def move_to_catalog()
                        return MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackagesWithUniqueName::MoveToCatalog::MoveToCatalogRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter, unique_name=nil)
                        super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages(uniqueName='{uniqueName}'){?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def with_url(raw_url)
                        ...
                        return AccessPackagesWithUniqueNameRequestBuilder.new(raw_url, @request_adapter)
                    end
