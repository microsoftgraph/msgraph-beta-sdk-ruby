                ...
                module GetApplicablePolicyRequirements
                    ...
                    class GetApplicablePolicyRequirementsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages(uniqueName='{uniqueName}')/getApplicablePolicyRequirements")
                        end
                        ## 
                        ...
                        def post(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackagesWithUniqueName::GetApplicablePolicyRequirements::GetApplicablePolicyRequirementsPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## In Microsoft Entra entitlement management, this action retrieves a list of accessPackageAssignmentRequestRequirements objects that the currently signed-in user can use to create an accessPackageAssignmentRequest.  Each requirement object corresponds to an access package assignment policy that the currently signed-in user is allowed to request an assignment for.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
