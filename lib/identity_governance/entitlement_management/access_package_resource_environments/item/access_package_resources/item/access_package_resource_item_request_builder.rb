...
module MicrosoftGraphBeta::IdentityGovernance::EntitlementManagement::AccessPackageResourceEnvironments::Item::AccessPackageResources::Item
    ## 
    ...
    class AccessPackageResourceItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, access_package_resource_id=nil)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResourceEnvironments/{accessPackageResourceEnvironment%2Did}/accessPackageResources/{accessPackageResource%2Did}{?%24select,%24expand}"
