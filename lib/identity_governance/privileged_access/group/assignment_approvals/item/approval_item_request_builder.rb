                ...
                module AssignmentApprovals
                    module Item
                        ...
                        class ApprovalItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def steps()
                                return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentApprovals::Item::Steps::StepsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
