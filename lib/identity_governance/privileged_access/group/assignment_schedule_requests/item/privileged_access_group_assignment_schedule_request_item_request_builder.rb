...
module MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item
    ## 
    ...
    class PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder
        ...
        def activated_using()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item::ActivatedUsing::ActivatedUsingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def group()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancel method.
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item::MicrosoftGraphCancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def principal()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def target_schedule()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item::TargetSchedule::TargetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param privilegedAccessGroupAssignmentScheduleRequestId key: id of privilegedAccessGroupAssignmentScheduleRequest
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, privileged_access_group_assignment_schedule_request_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleRequests/{privilegedAccessGroupAssignmentScheduleRequest%2Did}{?%24select,%24expand}"
