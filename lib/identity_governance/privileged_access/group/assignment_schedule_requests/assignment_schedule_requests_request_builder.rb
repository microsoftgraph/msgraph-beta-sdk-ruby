            ...
            module Group
                module AssignmentScheduleRequests
                    ...
                    class AssignmentScheduleRequestsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the assignmentScheduleRequests property of the microsoft.graph.privilegedAccessGroup entity.
                        ## @param privileged_access_group_assignment_schedule_request_id Unique identifier of the item
