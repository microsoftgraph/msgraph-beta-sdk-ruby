...
module MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::EligibilitySchedules
    ## 
    ...
    class EligibilitySchedulesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::EligibilitySchedules::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilitySchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PrivilegedAccessGroupEligibilityScheduleCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
