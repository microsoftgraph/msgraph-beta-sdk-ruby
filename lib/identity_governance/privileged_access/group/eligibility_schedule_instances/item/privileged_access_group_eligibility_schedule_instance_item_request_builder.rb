...
module MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::EligibilityScheduleInstances::Item
    ## 
    ...
    class PrivilegedAccessGroupEligibilityScheduleInstanceItemRequestBuilder
        ...
        def group()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::EligibilityScheduleInstances::Item::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def principal()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::EligibilityScheduleInstances::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param privilegedAccessGroupEligibilityScheduleInstanceId key: id of privilegedAccessGroupEligibilityScheduleInstance
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, privileged_access_group_eligibility_schedule_instance_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilityScheduleInstances/{privilegedAccessGroupEligibilityScheduleInstance%2Did}{?%24select,%24expand}"
