...
module MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::EligibilityScheduleRequests::Item
    ...
    class PrivilegedAccessGroupEligibilityScheduleRequestItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::EligibilityScheduleRequests::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
