...
module MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::EligibilityScheduleRequests::Item
    ...
    class PrivilegedAccessGroupEligibilityScheduleRequestItemRequestBuilder
        ...
        def cancel()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::EligibilityScheduleRequests::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
