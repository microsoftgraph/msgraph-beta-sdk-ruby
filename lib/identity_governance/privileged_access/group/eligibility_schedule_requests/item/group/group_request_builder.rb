                        ...
                        module Group
                            ...
                            class GroupRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def service_provisioning_errors()
                                    return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::EligibilityScheduleRequests::Item::Group::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
