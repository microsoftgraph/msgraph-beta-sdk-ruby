...
module MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentSchedules::Item
    ## 
    ...
    class PrivilegedAccessGroupAssignmentScheduleItemRequestBuilder
        ...
        def activated_using()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentSchedules::Item::ActivatedUsing::ActivatedUsingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the group property of the microsoft.graph.privilegedAccessGroupAssignmentSchedule entity.
        def group()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentSchedules::Item::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def principal()
            return MicrosoftGraphBeta::IdentityGovernance::PrivilegedAccess::Group::AssignmentSchedules::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param privilegedAccessGroupAssignmentScheduleId key: id of privilegedAccessGroupAssignmentSchedule
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, privileged_access_group_assignment_schedule_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentSchedules/{privilegedAccessGroupAssignmentSchedule%2Did}{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PrivilegedAccessGroupAssignmentSchedule.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
