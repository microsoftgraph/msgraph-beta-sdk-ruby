...
module MicrosoftGraphBeta
    module Chats
        ...
        class ChatsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def all_messages()
                return MicrosoftGraphBeta::Chats::AllMessages::AllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def get_all_messages()
                return MicrosoftGraphBeta::Chats::GetAllMessages::GetAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the getAllRetainedMessages method.
            def get_all_retained_messages()
                return MicrosoftGraphBeta::Chats::GetAllRetainedMessages::GetAllRetainedMessagesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ## Provides operations to manage the collection of chat entities.
