...
module MicrosoftGraphBeta::Chats
    ...
    class ChatsRequestBuilder
        ...
        def microsoft_graph_all_messages()
            return MicrosoftGraphBeta::Chats::MicrosoftGraphAllMessages::AllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAllMessages method.
        def microsoft_graph_get_all_messages()
            return MicrosoftGraphBeta::Chats::MicrosoftGraphGetAllMessages::GetAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
