        ...
        module Item
            ...
            class ChatItemRequestBuilder
                ...
                def microsoft_graph_hide_for_user()
                    return MicrosoftGraphBeta::Chats::Item::MicrosoftGraphHideForUser::MicrosoftGraphHideForUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the markChatReadForUser method.
                def microsoft_graph_mark_chat_read_for_user()
                    return MicrosoftGraphBeta::Chats::Item::MicrosoftGraphMarkChatReadForUser::MicrosoftGraphMarkChatReadForUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the markChatUnreadForUser method.
                def microsoft_graph_mark_chat_unread_for_user()
                    return MicrosoftGraphBeta::Chats::Item::MicrosoftGraphMarkChatUnreadForUser::MicrosoftGraphMarkChatUnreadForUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the sendActivityNotification method.
                def microsoft_graph_send_activity_notification()
                    return MicrosoftGraphBeta::Chats::Item::MicrosoftGraphSendActivityNotification::MicrosoftGraphSendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the unhideForUser method.
                def microsoft_graph_unhide_for_user()
                    return MicrosoftGraphBeta::Chats::Item::MicrosoftGraphUnhideForUser::MicrosoftGraphUnhideForUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
