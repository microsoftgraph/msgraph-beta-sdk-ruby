        ...
        module Item
            module PinnedMessages
                ...
                class PinnedMessagesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Chats::Item::PinnedMessages::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the pinnedMessages property of the microsoft.graph.chat entity.
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PinnedChatMessageInfoCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
