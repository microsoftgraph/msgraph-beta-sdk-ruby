...
module MicrosoftGraphBeta::Chats::Item::PermissionGrants::Item::MicrosoftGraphRestore
    ## 
    ...
    class RestoreRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/chats/{chat%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/microsoft.graph.restore"
