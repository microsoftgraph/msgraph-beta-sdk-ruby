...
module MicrosoftGraphBeta::Chats::Item::PermissionGrants
    ## 
    ...
    class PermissionGrantsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Chats::Item::PermissionGrants::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getByIds method.
        def microsoft_graph_get_by_ids()
            return MicrosoftGraphBeta::Chats::Item::PermissionGrants::MicrosoftGraphGetByIds::MicrosoftGraphGetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getUserOwnedObjects method.
        def microsoft_graph_get_user_owned_objects()
            return MicrosoftGraphBeta::Chats::Item::PermissionGrants::MicrosoftGraphGetUserOwnedObjects::MicrosoftGraphGetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validateProperties method.
        def microsoft_graph_validate_properties()
            return MicrosoftGraphBeta::Chats::Item::PermissionGrants::MicrosoftGraphValidateProperties::MicrosoftGraphValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/chats/{chat%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
