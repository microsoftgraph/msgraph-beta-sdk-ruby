...
module MicrosoftGraphBeta::Chats::Item::PermissionGrants::MicrosoftGraphGetUserOwnedObjects
    ## 
    ...
    class GetUserOwnedObjectsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/chats/{chat%2Did}/permissionGrants/microsoft.graph.getUserOwnedObjects"
