        ...
        module Item
            module TokenLifetimePolicies
                ...
                class TokenLifetimePoliciesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Applications::Item::TokenLifetimePolicies::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the collection of application entities.
                    def ref()
                        return MicrosoftGraphBeta::Applications::Item::TokenLifetimePolicies::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Gets an item from the MicrosoftGraphBeta.applications.item.tokenLifetimePolicies.item collection
                    ...
                    def by_token_lifetime_policy_id(token_lifetime_policy_id)
                        ...
                        return MicrosoftGraphBeta::Applications::Item::TokenLifetimePolicies::Item::TokenLifetimePolicyItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TokenLifetimePolicyCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## List the tokenLifetimePolicy objects that are assigned to an application or servicePrincipal. Only one object is returned in the collection because only one tokenLifetimePolicy can be assigned to an application. This API is supported in the following national cloud deployments.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
