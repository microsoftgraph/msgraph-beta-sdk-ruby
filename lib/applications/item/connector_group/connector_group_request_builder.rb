    ...
    module Applications
        module Item
            module ConnectorGroup
                ...
                class ConnectorGroupRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/applications/{application%2Did}/connectorGroup{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    ## @return a connector_group_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return ConnectorGroupRequestBuilder.new(raw_url, @request_adapter)
                    end
