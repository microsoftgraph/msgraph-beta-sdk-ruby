...
module MicrosoftGraphBeta::Applications::Item::MicrosoftGraphAddKey
    class AddKeyPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "passwordCredential" => lambda {|n| @password_credential = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PasswordCredential.create_from_discriminator_value(pn) }) },
