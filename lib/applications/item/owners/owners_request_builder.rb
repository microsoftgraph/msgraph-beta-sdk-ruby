            ...
            module Owners
                ...
                class OwnersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def graph_app_role_assignment()
                        return MicrosoftGraphBeta::Applications::Item::Owners::GraphAppRoleAssignment::GraphAppRoleAssignmentRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to endpoint.
                    def graph_endpoint()
                        return MicrosoftGraphBeta::Applications::Item::Owners::GraphEndpoint::GraphEndpointRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to servicePrincipal.
                    def graph_service_principal()
                        return MicrosoftGraphBeta::Applications::Item::Owners::GraphServicePrincipal::GraphServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to user.
                    def graph_user()
                        return MicrosoftGraphBeta::Applications::Item::Owners::GraphUser::GraphUserRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
