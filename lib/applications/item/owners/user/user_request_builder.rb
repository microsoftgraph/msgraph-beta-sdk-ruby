...
module MicrosoftGraphBeta::Applications::Item::Owners::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Applications::Item::Owners::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
