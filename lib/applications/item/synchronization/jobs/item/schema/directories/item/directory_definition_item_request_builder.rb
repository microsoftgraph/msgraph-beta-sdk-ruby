...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::Schema::Directories::Item
    ...
    class DirectoryDefinitionItemRequestBuilder
        ...
        def microsoft_graph_discover()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::Schema::Directories::Item::MicrosoftGraphDiscover::DiscoverRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, directory_definition_id=nil)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories/{directoryDefinition%2Did}{?%24select,%24expand}"
