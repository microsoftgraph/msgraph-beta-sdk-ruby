...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::Schema::Directories::Item::MicrosoftGraphDiscover
    ## 
    ...
    class DiscoverRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories/{directoryDefinition%2Did}/microsoft.graph.discover"
