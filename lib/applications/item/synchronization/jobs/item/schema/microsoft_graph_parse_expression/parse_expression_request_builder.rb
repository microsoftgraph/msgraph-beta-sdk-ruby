...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::Schema::MicrosoftGraphParseExpression
    ## 
    ...
    class ParseExpressionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/microsoft.graph.parseExpression"
