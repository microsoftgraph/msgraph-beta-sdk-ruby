...
require_relative '../item'
require_relative './microsoft_graph_validate_credentials'

module MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::MicrosoftGraphValidateCredentials
    class ValidateCredentialsPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "credentials" => lambda {|n| @credentials = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationSecretKeyStringValuePair.create_from_discriminator_value(pn) }) },
