...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::MicrosoftGraphPause
    ## 
    ...
    class PauseRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/microsoft.graph.pause"
