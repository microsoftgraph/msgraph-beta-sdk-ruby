...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item
    ...
    class SynchronizationJobItemRequestBuilder
        ...
        def pause()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::Pause::PauseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the provisionOnDemand method.
        def provision_on_demand()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::ProvisionOnDemand::ProvisionOnDemandRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restart()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::Restart::RestartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def start()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::Start::StartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the stop method.
        def stop()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::Stop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def validate_credentials()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Item::ValidateCredentials::ValidateCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
