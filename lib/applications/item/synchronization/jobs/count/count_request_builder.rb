...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Jobs::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/synchronization/jobs/$count{?%24search,%24filter}"
