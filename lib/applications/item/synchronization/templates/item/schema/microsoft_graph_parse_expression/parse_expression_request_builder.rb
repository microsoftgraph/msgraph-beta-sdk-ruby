...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Templates::Item::Schema::MicrosoftGraphParseExpression
    ## 
    ...
    class ParseExpressionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/microsoft.graph.parseExpression"
