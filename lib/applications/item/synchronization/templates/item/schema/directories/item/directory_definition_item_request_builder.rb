...
require_relative './item'
require_relative './microsoft_graph_discover/discover_request_builder'

module MicrosoftGraphBeta::Applications::Item::Synchronization::Templates::Item::Schema::Directories::Item
    ## 
    ...
    class DirectoryDefinitionItemRequestBuilder
        ...
        def microsoft_graph_discover()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Templates::Item::Schema::Directories::Item::MicrosoftGraphDiscover::DiscoverRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param directoryDefinitionId key: id of directoryDefinition
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, directory_definition_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/applications/{application%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/directories/{directoryDefinition%2Did}{?%24select,%24expand}"
