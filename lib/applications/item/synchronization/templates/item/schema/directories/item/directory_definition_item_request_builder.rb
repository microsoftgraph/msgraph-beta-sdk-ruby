...
require_relative './item'
require_relative './microsoft_graph_discover/microsoft_graph_discover_request_builder'
...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Templates::Item::Schema::Directories::Item
    ...
    class DirectoryDefinitionItemRequestBuilder
        ...
        def microsoft_graph_discover()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Templates::Item::Schema::Directories::Item::MicrosoftGraphDiscover::MicrosoftGraphDiscoverRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
