...
module MicrosoftGraphBeta::Applications::Item::Synchronization
    ...
    class SynchronizationRequestBuilder
        ...
        def microsoft_graph_acquire_access_token()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::MicrosoftGraphAcquireAccessToken::MicrosoftGraphAcquireAccessTokenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the Ping method.
        def microsoft_graph_ping()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::MicrosoftGraphPing::MicrosoftGraphPingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def secrets()
            return MicrosoftGraphBeta::Applications::Item::Synchronization::Secrets::SecretsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
