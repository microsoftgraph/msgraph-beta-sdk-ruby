...
module MicrosoftGraphBeta::Applications::Item::Synchronization::Secrets::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/synchronization/secrets/$count{?%24search,%24filter}"
