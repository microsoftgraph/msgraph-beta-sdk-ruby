...
module MicrosoftGraphBeta::Applications::Item
    ...
    class ApplicationItemRequestBuilder
        ...
        def microsoft_graph_add_key()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphAddKey::AddKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addPassword method.
        def microsoft_graph_add_password()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphAddPassword::AddPasswordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberGroups method.
        def microsoft_graph_check_member_groups()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphCheckMemberGroups::CheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def microsoft_graph_check_member_objects()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphCheckMemberObjects::CheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberGroups method.
        def microsoft_graph_get_member_groups()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphGetMemberGroups::GetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def microsoft_graph_get_member_objects()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphGetMemberObjects::GetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeKey method.
        def microsoft_graph_remove_key()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphRemoveKey::RemoveKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removePassword method.
        def microsoft_graph_remove_password()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphRemovePassword::RemovePasswordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphRestore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setVerifiedPublisher method.
        def microsoft_graph_set_verified_publisher()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphSetVerifiedPublisher::SetVerifiedPublisherRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unsetVerifiedPublisher method.
        def microsoft_graph_unset_verified_publisher()
            return MicrosoftGraphBeta::Applications::Item::MicrosoftGraphUnsetVerifiedPublisher::UnsetVerifiedPublisherRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
