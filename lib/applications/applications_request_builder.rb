    ...
    module Applications
        ...
        class ApplicationsRequestBuilder
            ...
            def microsoft_graph_delta()
                return MicrosoftGraphBeta::Applications::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the getByIds method.
            def microsoft_graph_get_by_ids()
                return MicrosoftGraphBeta::Applications::MicrosoftGraphGetByIds::MicrosoftGraphGetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the getUserOwnedObjects method.
            def microsoft_graph_get_user_owned_objects()
                return MicrosoftGraphBeta::Applications::MicrosoftGraphGetUserOwnedObjects::MicrosoftGraphGetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the validateProperties method.
            def microsoft_graph_validate_properties()
                return MicrosoftGraphBeta::Applications::MicrosoftGraphValidateProperties::MicrosoftGraphValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
