...
require_relative './device_templates/device_templates_request_builder'
    ...
    module Templates
        ...
        class TemplatesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def device_templates()
                return MicrosoftGraphBeta::Templates::DeviceTemplates::DeviceTemplatesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/templates{?%24expand,%24select}")
            end
            ## 
            ## Get templates
            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
            ## @return a Fiber of template
            ## 
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Template.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
            ## Update templates
