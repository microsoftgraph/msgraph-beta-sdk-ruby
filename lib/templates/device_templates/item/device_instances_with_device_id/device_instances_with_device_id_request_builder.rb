...
require_relative './device_instances_with_device_id'

module MicrosoftGraphBeta
    module Templates
        module DeviceTemplates
            module Item
                module DeviceInstancesWithDeviceId
                    ## 
                    # Provides operations to manage the deviceInstances property of the microsoft.graph.deviceTemplate entity.
                    class DeviceInstancesWithDeviceIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter, device_id=nil)
                            super(path_parameters, request_adapter, "{+baseurl}/templates/deviceTemplates/{deviceTemplate%2Did}/deviceInstances(deviceId='{deviceId}'){?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return DeviceInstancesWithDeviceIdRequestBuilder.new(raw_url, @request_adapter)
                        end
