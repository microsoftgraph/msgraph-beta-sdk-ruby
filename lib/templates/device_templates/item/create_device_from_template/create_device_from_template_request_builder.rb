        ...
        module DeviceTemplates
            module Item
                module CreateDeviceFromTemplate
                    ...
                    class CreateDeviceFromTemplateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/templates/deviceTemplates/{deviceTemplate%2Did}/createDeviceFromTemplate")
                        end
                        ## 
                        ...
                        ## @return a create_device_from_template_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return CreateDeviceFromTemplateRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
