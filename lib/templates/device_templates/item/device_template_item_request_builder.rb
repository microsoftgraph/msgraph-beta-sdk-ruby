            ...
            module Item
                ...
                class DeviceTemplateItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def create_device_from_template()
                        return MicrosoftGraphBeta::Templates::DeviceTemplates::Item::CreateDeviceFromTemplate::CreateDeviceFromTemplateRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def device_instances()
                        return MicrosoftGraphBeta::Templates::DeviceTemplates::Item::DeviceInstances::DeviceInstancesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the owners property of the microsoft.graph.deviceTemplate entity.
                    def owners()
                        return MicrosoftGraphBeta::Templates::DeviceTemplates::Item::Owners::OwnersRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/templates/deviceTemplates/{deviceTemplate%2Did}{?%24expand,%24select}")
                    end
                    ## 
