...
require_relative './contact_insights'

module MicrosoftGraphBeta
    module Organization
        module Item
            module Settings
                module ContactInsights
                    ## 
                    # Provides operations to manage the contactInsights property of the microsoft.graph.organizationSettings entity.
                    class ContactInsightsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/organization/{organization%2Did}/settings/contactInsights{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/organization/{organization%2Did}/settings/contactInsights'
                        ...
                        ## @return a contact_insights_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return ContactInsightsRequestBuilder.new(raw_url, @request_adapter)
                        end
