...
module MicrosoftGraphBeta::Organization::Item::Settings::ProfileCardProperties::Item
    ## 
    ...
    class ProfileCardPropertyItemRequestBuilder
        ...
        ## @param profileCardPropertyId key: id of profileCardProperty
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, profile_card_property_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/organization/{organization%2Did}/settings/profileCardProperties/{profileCardProperty%2Did}{?%24select,%24expand}"
