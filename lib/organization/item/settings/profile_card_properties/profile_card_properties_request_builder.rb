...
module MicrosoftGraphBeta::Organization::Item::Settings::ProfileCardProperties
    ## 
    ...
    class ProfileCardPropertiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Organization::Item::Settings::ProfileCardProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/organization/{organization%2Did}/settings/profileCardProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
