...
require_relative './activate_service'

module MicrosoftGraphBeta
    module Organization
        module Item
            module ActivateService
                class ActivateServicePostRequestBody
                    ...
                    ## @return a activate_service_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return ActivateServicePostRequestBody.new
                    end
                    ## 
