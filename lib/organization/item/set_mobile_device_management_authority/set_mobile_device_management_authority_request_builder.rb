            ...
            module SetMobileDeviceManagementAuthority
                ...
                class SetMobileDeviceManagementAuthorityRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def post(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Organization::Item::SetMobileDeviceManagementAuthority::SetMobileDeviceManagementAuthorityPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Set mobile device management authority
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
