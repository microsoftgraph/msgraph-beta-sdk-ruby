...
require_relative './partner_information/partner_information_request_builder'
        ...
        module Item
            ...
            class OrganizationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def partner_information()
                    return MicrosoftGraphBeta::Organization::Item::PartnerInformation::PartnerInformationRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
