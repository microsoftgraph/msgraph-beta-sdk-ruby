...
module MicrosoftGraphBeta::Organization::Item::Branding::Localizations
    ## 
    ...
    class LocalizationsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Organization::Item::Branding::Localizations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::OrganizationalBrandingLocalizationCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
