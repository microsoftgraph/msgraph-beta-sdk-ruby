...
module MicrosoftGraphBeta::Branding::Localizations::Item::Favicon
    ## 
    ...
    class FaviconRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/branding/localizations/{organizationalBrandingLocalization%2Did}/favicon"
