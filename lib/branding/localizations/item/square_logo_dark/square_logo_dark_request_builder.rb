...
module MicrosoftGraphBeta::Branding::Localizations::Item::SquareLogoDark
    ## 
    ...
    class SquareLogoDarkRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/branding/localizations/{organizationalBrandingLocalization%2Did}/squareLogoDark"
