...
module MicrosoftGraphBeta
    module DeviceLocalCredentials
        ...
        class DeviceLocalCredentialsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def count()
                return MicrosoftGraphBeta::DeviceLocalCredentials::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ## Provides operations to manage the collection of deviceLocalCredentialInfo entities.
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/deviceLocalCredentials{?%24count,%24filter,%24orderby,%24search,%24select,%24top}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/deviceLocalCredentials'
                request_info.path_parameters = @path_parameters
