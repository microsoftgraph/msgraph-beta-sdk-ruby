...
module MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::AttachmentSessions::Item
    ## 
    ...
    class AttachmentSessionItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::AttachmentSessions::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
