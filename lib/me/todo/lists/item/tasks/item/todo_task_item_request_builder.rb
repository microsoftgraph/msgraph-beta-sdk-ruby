...
module MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item
    ## 
    ...
    class TodoTaskItemRequestBuilder
        ...
        def attachments()
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::Attachments::AttachmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the attachmentSessions property of the microsoft.graph.todoTask entity.
        def attachment_sessions()
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::AttachmentSessions::AttachmentSessionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the checklistItems property of the microsoft.graph.todoTask entity.
        def checklist_items()
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::ChecklistItems::ChecklistItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the extensions property of the microsoft.graph.todoTask entity.
        def extensions()
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::Extensions::ExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the linkedResources property of the microsoft.graph.todoTask entity.
        def linked_resources()
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::LinkedResources::LinkedResourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def attachments_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::Attachments::Item::AttachmentBaseItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the attachmentSessions property of the microsoft.graph.todoTask entity.
        ## @param id Unique identifier of the item
        ...
        def attachment_sessions_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::AttachmentSessions::Item::AttachmentSessionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the checklistItems property of the microsoft.graph.todoTask entity.
        ## @param id Unique identifier of the item
        ...
        def checklist_items_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::ChecklistItems::Item::ChecklistItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TodoTask.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the linkedResources property of the microsoft.graph.todoTask entity.
        ## @param id Unique identifier of the item
        ...
        def linked_resources_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::LinkedResources::Item::LinkedResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
