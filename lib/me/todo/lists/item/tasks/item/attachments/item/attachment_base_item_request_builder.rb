...
module MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::Attachments::Item
    ## 
    ...
    class AttachmentBaseItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::Attachments::Item::Value::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
