                        ...
                        module Item
                            module Attachments
                                ...
                                class AttachmentsRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::Attachments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the createUploadSession method.
                                    def microsoft_graph_create_upload_session()
                                        return MicrosoftGraphBeta::Me::Todo::Lists::Item::Tasks::Item::Attachments::MicrosoftGraphCreateUploadSession::MicrosoftGraphCreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
