...
module MicrosoftGraphBeta::Me::MicrosoftGraphFindRoomsWithRoomList
    class FindRoomsWithRoomListResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
        ...
        ## @return a find_rooms_with_room_list_response
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return FindRoomsWithRoomListResponse.new
        end
        ## 
