    ...
    module Me
        module Sponsors
            ...
            class SponsorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::Me::Sponsors::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the sponsors property of the microsoft.graph.user entity.
                ...
                def by_directory_object_id(directory_object_id)
                    ...
                    return MicrosoftGraphBeta::Me::Sponsors::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/me/sponsors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                end
                ## 
