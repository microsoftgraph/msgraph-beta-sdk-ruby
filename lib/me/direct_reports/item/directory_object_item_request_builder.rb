...
module MicrosoftGraphBeta::Me::DirectReports::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def microsoft_graph_org_contact()
            return MicrosoftGraphBeta::Me::DirectReports::Item::MicrosoftGraphOrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::Me::DirectReports::Item::MicrosoftGraphUser::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
