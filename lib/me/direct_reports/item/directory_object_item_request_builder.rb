...
module MicrosoftGraphBeta::Me::DirectReports::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def org_contact()
            return MicrosoftGraphBeta::Me::DirectReports::Item::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Me::DirectReports::Item::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
