        ...
        module DirectReports
            ...
            class DirectReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def graph_org_contact()
                    return MicrosoftGraphBeta::Me::DirectReports::GraphOrgContact::GraphOrgContactRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to user.
                def graph_user()
                    return MicrosoftGraphBeta::Me::DirectReports::GraphUser::GraphUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the directReports property of the microsoft.graph.user entity.
