...
module MicrosoftGraphBeta::Me::DirectReports
    ...
    class DirectReportsRequestBuilder
        ...
        def microsoft_graph_org_contact()
            return MicrosoftGraphBeta::Me::DirectReports::MicrosoftGraphOrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::Me::DirectReports::MicrosoftGraphUser::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
