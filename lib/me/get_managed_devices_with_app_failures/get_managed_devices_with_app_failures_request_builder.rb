        ...
        module GetManagedDevicesWithAppFailures
            ...
            class GetManagedDevicesWithAppFailuresRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Me::GetManagedDevicesWithAppFailures::GetManagedDevicesWithAppFailuresResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Retrieves the list of devices with failed apps
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
