...
module MicrosoftGraphBeta::Me::CalendarGroups::Item
    ## 
    ...
    class CalendarGroupItemRequestBuilder
        ...
        def calendars()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::CalendarsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def calendars_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::CalendarItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
