...
module MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::Events::Item::Attachments
    ...
    class AttachmentsRequestBuilder
        ...
        def create_upload_session()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::Events::Item::Attachments::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
