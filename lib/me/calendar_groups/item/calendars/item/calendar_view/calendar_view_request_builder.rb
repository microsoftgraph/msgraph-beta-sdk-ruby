                    ...
                    module Item
                        module CalendarView
                            ...
                            class CalendarViewRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the delta method.
                                def delta()
                                    return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the calendarView property of the microsoft.graph.calendar entity.
                                ...
                                def by_event_id(event_id)
                                    ...
                                    return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Item::EventItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
