                            ...
                            module Item
                                module Attachments
                                    ...
                                    class AttachmentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def count()
                                            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Item::Attachments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the createUploadSession method.
                                        def create_upload_session()
                                            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Item::Attachments::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ## Provides operations to manage the attachments property of the microsoft.graph.event entity.
                                        ...
                                        def by_attachment_id(attachment_id)
                                            ...
                                            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Item::Attachments::Item::AttachmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                        end
                                        ## 
