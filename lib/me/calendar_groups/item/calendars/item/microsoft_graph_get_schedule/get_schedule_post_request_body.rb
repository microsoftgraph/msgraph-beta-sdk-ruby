...
module MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::MicrosoftGraphGetSchedule
    class GetSchedulePostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "EndTime" => lambda {|n| @end_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
                "Schedules" => lambda {|n| @schedules = n.get_collection_of_primitive_values(String) },
                "StartTime" => lambda {|n| @start_time = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::DateTimeTimeZone.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
