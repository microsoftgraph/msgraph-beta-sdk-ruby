...
module MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item
    ...
    class CalendarItemRequestBuilder
        ...
        def microsoft_graph_get_schedule()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::MicrosoftGraphGetSchedule::GetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
