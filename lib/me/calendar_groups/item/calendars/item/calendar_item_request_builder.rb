...
module MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item
    ## 
    ...
    class CalendarItemRequestBuilder
        ...
        def calendar_permissions()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::CalendarPermissions::CalendarPermissionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the calendarView property of the microsoft.graph.calendar entity.
        def calendar_view()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::CalendarView::CalendarViewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the events property of the microsoft.graph.calendar entity.
        def events()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::Events::EventsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getSchedule method.
        def microsoft_graph_get_schedule()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::MicrosoftGraphGetSchedule::MicrosoftGraphGetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.calendar entity.
        def multi_value_extended_properties()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def events_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["event%2Did"] = id
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::Events::Item::EventItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::CalendarGroups::Item::Calendars::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property calendars for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
