...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::MicrosoftGraphFilterByCurrentUserWithOn
    ## 
    ...
    class FilterByCurrentUserWithOnRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, on=nil)
            ...
            @url_template = "{+baseurl}/me/pendingAccessReviewInstances/microsoft.graph.filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Me::PendingAccessReviewInstances::MicrosoftGraphFilterByCurrentUserWithOn::FilterByCurrentUserWithOnResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function filterByCurrentUser
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
