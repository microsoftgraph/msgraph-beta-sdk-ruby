...
module MicrosoftGraphBeta
    module Me
        module PendingAccessReviewInstances
            ...
            class PendingAccessReviewInstancesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to count the resources in the collection.
                def count()
                    return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the pendingAccessReviewInstances property of the microsoft.graph.user entity.
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/me/pendingAccessReviewInstances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AccessReviewInstanceCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                ## @return a pending_access_review_instances_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return PendingAccessReviewInstancesRequestBuilder.new(raw_url, @request_adapter)
                end
