...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item
    ...
    class AccessReviewInstanceItemRequestBuilder
        ...
        def accept_recommendations()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::AcceptRecommendations::AcceptRecommendationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyDecisions method.
        def apply_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::ApplyDecisions::ApplyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the batchRecordDecisions method.
        def batch_record_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::BatchRecordDecisions::BatchRecordDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reset_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::ResetDecisions::ResetDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendReminder method.
        def send_reminder()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::SendReminder::SendReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def stop()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
