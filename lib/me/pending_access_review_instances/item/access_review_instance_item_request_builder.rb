...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item
    ## 
    ...
    class AccessReviewInstanceItemRequestBuilder
        ...
        def contacted_reviewers()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::ContactedReviewers::ContactedReviewersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the decisions property of the microsoft.graph.accessReviewInstance entity.
        def decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::DecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the definition property of the microsoft.graph.accessReviewInstance entity.
        def definition()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Definition::DefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the acceptRecommendations method.
        def microsoft_graph_accept_recommendations()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::MicrosoftGraphAcceptRecommendations::MicrosoftGraphAcceptRecommendationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyDecisions method.
        def microsoft_graph_apply_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::MicrosoftGraphApplyDecisions::MicrosoftGraphApplyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the batchRecordDecisions method.
        def microsoft_graph_batch_record_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::MicrosoftGraphBatchRecordDecisions::MicrosoftGraphBatchRecordDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resetDecisions method.
        def microsoft_graph_reset_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::MicrosoftGraphResetDecisions::MicrosoftGraphResetDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendReminder method.
        def microsoft_graph_send_reminder()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::MicrosoftGraphSendReminder::MicrosoftGraphSendReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the stop method.
        def microsoft_graph_stop()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::MicrosoftGraphStop::MicrosoftGraphStopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def stages()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::StagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}{?%24select,%24expand}"
        ...
        def contacted_reviewers_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::ContactedReviewers::Item::AccessReviewReviewerItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the decisions property of the microsoft.graph.accessReviewInstance entity.
        ## @param id Unique identifier of the item
        ...
        def decisions_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::AccessReviewInstanceDecisionItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def stages_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::Item::AccessReviewStageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property pendingAccessReviewInstances for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
