...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::ContactedReviewers::Item
    ## 
    ...
    class AccessReviewReviewerItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, access_review_reviewer_id=nil)
            ...
            @url_template = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/contactedReviewers/{accessReviewReviewer%2Did}{?%24select,%24expand}"
