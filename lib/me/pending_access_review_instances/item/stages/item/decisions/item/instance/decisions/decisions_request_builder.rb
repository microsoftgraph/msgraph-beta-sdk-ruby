...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::Decisions
    ...
    class DecisionsRequestBuilder
        ...
        def microsoft_graph_record_all_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::Item::Decisions::Item::Instance::Decisions::MicrosoftGraphRecordAllDecisions::MicrosoftGraphRecordAllDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
