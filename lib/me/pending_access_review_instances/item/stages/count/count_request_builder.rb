...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Stages::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/$count{?%24search,%24filter}"
