...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions
    ## 
    ...
    class DecisionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the recordAllDecisions method.
        def microsoft_graph_record_all_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::MicrosoftGraphRecordAllDecisions::MicrosoftGraphRecordAllDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
