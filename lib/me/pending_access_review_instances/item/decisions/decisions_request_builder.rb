...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions
    ...
    class DecisionsRequestBuilder
        ...
        def microsoft_graph_record_all_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::MicrosoftGraphRecordAllDecisions::RecordAllDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
