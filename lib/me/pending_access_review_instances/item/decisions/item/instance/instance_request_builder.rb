                        ...
                        module Instance
                            ...
                            class InstanceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def stop_apply_decisions()
                                    return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::StopApplyDecisions::StopApplyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
