...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance
    ...
    class InstanceRequestBuilder
        ...
        def accept_recommendations()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::AcceptRecommendations::AcceptRecommendationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyDecisions method.
        def apply_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::ApplyDecisions::ApplyDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the batchRecordDecisions method.
        def batch_record_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::BatchRecordDecisions::BatchRecordDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reset_decisions()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::ResetDecisions::ResetDecisionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendReminder method.
        def send_reminder()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::SendReminder::SendReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def stop()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stop::StopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
