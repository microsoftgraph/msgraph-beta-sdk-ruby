...
module MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item
    ## 
    ...
    class AccessReviewStageItemRequestBuilder
        ...
        def microsoft_graph_stop()
            return MicrosoftGraphBeta::Me::PendingAccessReviewInstances::Item::Decisions::Item::Instance::Stages::Item::MicrosoftGraphStop::MicrosoftGraphStopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/stages/{accessReviewStage%2Did}{?%24select,%24expand}"
