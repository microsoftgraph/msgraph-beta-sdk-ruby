...
module MicrosoftGraphBeta::Me::Calendars::Item::Events::Item::ExceptionOccurrences
    ...
    class ExceptionOccurrencesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::Calendars::Item::Events::Item::ExceptionOccurrences::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
