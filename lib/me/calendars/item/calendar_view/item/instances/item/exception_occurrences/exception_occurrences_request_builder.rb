...
module MicrosoftGraphBeta::Me::Calendars::Item::CalendarView::Item::Instances::Item::ExceptionOccurrences
    ## 
    ...
    class ExceptionOccurrencesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Calendars::Item::CalendarView::Item::Instances::Item::ExceptionOccurrences::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::Calendars::Item::CalendarView::Item::Instances::Item::ExceptionOccurrences::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
