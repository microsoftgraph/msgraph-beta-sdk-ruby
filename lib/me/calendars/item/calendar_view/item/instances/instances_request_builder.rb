...
module MicrosoftGraphBeta::Me::Calendars::Item::CalendarView::Item::Instances
    ## 
    ...
    class InstancesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::Calendars::Item::CalendarView::Item::Instances::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
