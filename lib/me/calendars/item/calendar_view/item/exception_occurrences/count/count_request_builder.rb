...
module MicrosoftGraphBeta::Me::Calendars::Item::CalendarView::Item::ExceptionOccurrences::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences/$count{?%24filter}"
