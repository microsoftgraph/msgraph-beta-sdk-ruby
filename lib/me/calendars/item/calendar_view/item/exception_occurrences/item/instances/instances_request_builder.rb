...
module MicrosoftGraphBeta::Me::Calendars::Item::CalendarView::Item::ExceptionOccurrences::Item::Instances
    ...
    class InstancesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::Calendars::Item::CalendarView::Item::ExceptionOccurrences::Item::Instances::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
