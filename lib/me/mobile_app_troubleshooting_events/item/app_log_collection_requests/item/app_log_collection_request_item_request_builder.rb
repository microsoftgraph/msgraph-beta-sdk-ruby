...
module MicrosoftGraphBeta::Me::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item
    ...
    class AppLogCollectionRequestItemRequestBuilder
        ...
        def microsoft_graph_create_download_url()
            return MicrosoftGraphBeta::Me::MobileAppTroubleshootingEvents::Item::AppLogCollectionRequests::Item::MicrosoftGraphCreateDownloadUrl::MicrosoftGraphCreateDownloadUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
