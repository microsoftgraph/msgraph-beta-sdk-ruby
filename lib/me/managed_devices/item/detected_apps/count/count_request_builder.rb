...
module MicrosoftGraphBeta::Me::ManagedDevices::Item::DetectedApps::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/detectedApps/$count{?%24search,%24filter}"
