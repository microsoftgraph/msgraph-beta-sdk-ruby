...
module MicrosoftGraphBeta::Me::ManagedDevices::Item::DetectedApps::Item
    ## 
    ...
    class DetectedAppItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, detected_app_id=nil)
            ...
            @url_template = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/detectedApps/{detectedApp%2Did}{?%24select,%24expand}"
