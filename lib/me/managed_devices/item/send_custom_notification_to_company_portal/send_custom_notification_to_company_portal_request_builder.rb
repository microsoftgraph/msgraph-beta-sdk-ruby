        ...
        module ManagedDevices
            module Item
                module SendCustomNotificationToCompanyPortal
                    ...
                    class SendCustomNotificationToCompanyPortalRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/sendCustomNotificationToCompanyPortal")
                        end
                        ## 
                        ...
                        ## @return a send_custom_notification_to_company_portal_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return SendCustomNotificationToCompanyPortalRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
