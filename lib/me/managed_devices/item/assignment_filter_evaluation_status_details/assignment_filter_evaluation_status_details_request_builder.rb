            ...
            module Item
                module AssignmentFilterEvaluationStatusDetails
                    ...
                    class AssignmentFilterEvaluationStatusDetailsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Me::ManagedDevices::Item::AssignmentFilterEvaluationStatusDetails::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the assignmentFilterEvaluationStatusDetails property of the microsoft.graph.managedDevice entity.
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/assignmentFilterEvaluationStatusDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                        end
                        ## 
