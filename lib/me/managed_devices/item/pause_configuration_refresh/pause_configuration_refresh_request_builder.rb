        ...
        module ManagedDevices
            module Item
                module PauseConfigurationRefresh
                    ...
                    class PauseConfigurationRefreshRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/managedDevices/{managedDevice%2Did}/pauseConfigurationRefresh")
                        end
                        ## 
                        ...
                        ## @return a pause_configuration_refresh_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return PauseConfigurationRefreshRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
