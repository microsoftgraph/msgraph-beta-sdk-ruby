...
module MicrosoftGraphBeta::Me::ManagedDevices::Item::DeviceHealthScriptStates
    ## 
    ...
    class DeviceHealthScriptStatesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::DeviceHealthScriptStates::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/deviceHealthScriptStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
