...
module MicrosoftGraphBeta::Me::ManagedDevices::Item
    ## 
    ...
    class ManagedDeviceItemRequestBuilder
        ...
        def microsoft_graph_activate_device_esim()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphActivateDeviceEsim::ActivateDeviceEsimRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the bypassActivationLock method.
        def microsoft_graph_bypass_activation_lock()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphBypassActivationLock::BypassActivationLockRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cleanWindowsDevice method.
        def microsoft_graph_clean_windows_device()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphCleanWindowsDevice::CleanWindowsDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_create_device_log_collection_request()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphCreateDeviceLogCollectionRequest::CreateDeviceLogCollectionRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createRemoteHelpSession method.
        def microsoft_graph_create_remote_help_session()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphCreateRemoteHelpSession::CreateRemoteHelpSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the deleteUserFromSharedAppleDevice method.
        def microsoft_graph_delete_user_from_shared_apple_device()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphDeleteUserFromSharedAppleDevice::DeleteUserFromSharedAppleDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the deprovision method.
        def microsoft_graph_deprovision()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphDeprovision::DeprovisionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the disable method.
        def microsoft_graph_disable()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphDisable::DisableRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the disableLostMode method.
        def microsoft_graph_disable_lost_mode()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphDisableLostMode::DisableLostModeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the enableLostMode method.
        def microsoft_graph_enable_lost_mode()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphEnableLostMode::EnableLostModeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the endRemoteHelpSession method.
        def microsoft_graph_end_remote_help_session()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphEndRemoteHelpSession::EndRemoteHelpSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the enrollNowAction method.
        def microsoft_graph_enroll_now_action()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphEnrollNowAction::EnrollNowActionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_cloud_pc_remote_action_results()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphGetCloudPcRemoteActionResults::GetCloudPcRemoteActionResultsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getCloudPcReviewStatus method.
        def microsoft_graph_get_cloud_pc_review_status()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphGetCloudPcReviewStatus::GetCloudPcReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getFileVaultKey method.
        def microsoft_graph_get_file_vault_key()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphGetFileVaultKey::GetFileVaultKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getNonCompliantSettings method.
        def microsoft_graph_get_non_compliant_settings()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphGetNonCompliantSettings::GetNonCompliantSettingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getOemWarranty method.
        def microsoft_graph_get_oem_warranty()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphGetOemWarranty::GetOemWarrantyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_initiate_mobile_device_management_key_recovery()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphInitiateMobileDeviceManagementKeyRecovery::InitiateMobileDeviceManagementKeyRecoveryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_initiate_on_demand_proactive_remediation()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphInitiateOnDemandProactiveRemediation::InitiateOnDemandProactiveRemediationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the locateDevice method.
        def microsoft_graph_locate_device()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphLocateDevice::LocateDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the logoutSharedAppleDeviceActiveUser method.
        def microsoft_graph_logout_shared_apple_device_active_user()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphLogoutSharedAppleDeviceActiveUser::LogoutSharedAppleDeviceActiveUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the overrideComplianceState method.
        def microsoft_graph_override_compliance_state()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphOverrideComplianceState::OverrideComplianceStateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the playLostModeSound method.
        def microsoft_graph_play_lost_mode_sound()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphPlayLostModeSound::PlayLostModeSoundRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the rebootNow method.
        def microsoft_graph_reboot_now()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRebootNow::RebootNowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the recoverPasscode method.
        def microsoft_graph_recover_passcode()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRecoverPasscode::RecoverPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reenable method.
        def microsoft_graph_reenable()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphReenable::ReenableRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the remoteLock method.
        def microsoft_graph_remote_lock()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRemoteLock::RemoteLockRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_remove_device_firmware_configuration_interface_management()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRemoveDeviceFirmwareConfigurationInterfaceManagement::RemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reprovisionCloudPc method.
        def microsoft_graph_reprovision_cloud_pc()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphReprovisionCloudPc::ReprovisionCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the requestRemoteAssistance method.
        def microsoft_graph_request_remote_assistance()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRequestRemoteAssistance::RequestRemoteAssistanceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_request_remote_help_session_access()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRequestRemoteHelpSessionAccess::RequestRemoteHelpSessionAccessRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resetPasscode method.
        def microsoft_graph_reset_passcode()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphResetPasscode::ResetPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resizeCloudPc method.
        def microsoft_graph_resize_cloud_pc()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphResizeCloudPc::ResizeCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restoreCloudPc method.
        def microsoft_graph_restore_cloud_pc()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRestoreCloudPc::RestoreCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the retire method.
        def microsoft_graph_retire()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRetire::RetireRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the revokeAppleVppLicenses method.
        def microsoft_graph_revoke_apple_vpp_licenses()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRevokeAppleVppLicenses::RevokeAppleVppLicensesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the rotateBitLockerKeys method.
        def microsoft_graph_rotate_bit_locker_keys()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRotateBitLockerKeys::RotateBitLockerKeysRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the rotateFileVaultKey method.
        def microsoft_graph_rotate_file_vault_key()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphRotateFileVaultKey::RotateFileVaultKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_send_custom_notification_to_company_portal()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphSendCustomNotificationToCompanyPortal::SendCustomNotificationToCompanyPortalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setCloudPcReviewStatus method.
        def microsoft_graph_set_cloud_pc_review_status()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphSetCloudPcReviewStatus::SetCloudPcReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setDeviceName method.
        def microsoft_graph_set_device_name()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphSetDeviceName::SetDeviceNameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the shutDown method.
        def microsoft_graph_shut_down()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphShutDown::ShutDownRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the syncDevice method.
        def microsoft_graph_sync_device()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphSyncDevice::SyncDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_trigger_configuration_manager_action()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphTriggerConfigurationManagerAction::TriggerConfigurationManagerActionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateWindowsDeviceAccount method.
        def microsoft_graph_update_windows_device_account()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphUpdateWindowsDeviceAccount::UpdateWindowsDeviceAccountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the windowsDefenderScan method.
        def microsoft_graph_windows_defender_scan()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphWindowsDefenderScan::WindowsDefenderScanRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the windowsDefenderUpdateSignatures method.
        def microsoft_graph_windows_defender_update_signatures()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphWindowsDefenderUpdateSignatures::WindowsDefenderUpdateSignaturesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the wipe method.
        def microsoft_graph_wipe()
            return MicrosoftGraphBeta::Me::ManagedDevices::Item::MicrosoftGraphWipe::WipeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
