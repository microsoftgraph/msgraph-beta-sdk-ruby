            ...
            module Item
                ...
                class ManagedDeviceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def pause_configuration_refresh()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::PauseConfigurationRefresh::PauseConfigurationRefreshRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
