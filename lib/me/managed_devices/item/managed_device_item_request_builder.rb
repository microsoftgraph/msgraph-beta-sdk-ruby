            ...
            module Item
                ...
                class ManagedDeviceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def activate_device_esim()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::ActivateDeviceEsim::ActivateDeviceEsimRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def bypass_activation_lock()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::BypassActivationLock::BypassActivationLockRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the cleanWindowsDevice method.
                    def clean_windows_device()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::CleanWindowsDevice::CleanWindowsDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the createDeviceLogCollectionRequest method.
                    def create_device_log_collection_request()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::CreateDeviceLogCollectionRequest::CreateDeviceLogCollectionRequestRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the createRemoteHelpSession method.
                    def create_remote_help_session()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::CreateRemoteHelpSession::CreateRemoteHelpSessionRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the deleteUserFromSharedAppleDevice method.
                    def delete_user_from_shared_apple_device()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::DeleteUserFromSharedAppleDevice::DeleteUserFromSharedAppleDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the deprovision method.
                    def deprovision()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::Deprovision::DeprovisionRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def disable()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::Disable::DisableRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the disableLostMode method.
                    def disable_lost_mode()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::DisableLostMode::DisableLostModeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the enableLostMode method.
                    def enable_lost_mode()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::EnableLostMode::EnableLostModeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the endRemoteHelpSession method.
                    def end_remote_help_session()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::EndRemoteHelpSession::EndRemoteHelpSessionRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the enrollNowAction method.
                    def enroll_now_action()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::EnrollNowAction::EnrollNowActionRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getCloudPcRemoteActionResults method.
                    def get_cloud_pc_remote_action_results()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::GetCloudPcRemoteActionResults::GetCloudPcRemoteActionResultsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getCloudPcReviewStatus method.
                    def get_cloud_pc_review_status()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::GetCloudPcReviewStatus::GetCloudPcReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getFileVaultKey method.
                    def get_file_vault_key()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::GetFileVaultKey::GetFileVaultKeyRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getNonCompliantSettings method.
                    def get_non_compliant_settings()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::GetNonCompliantSettings::GetNonCompliantSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getOemWarranty method.
                    def get_oem_warranty()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::GetOemWarranty::GetOemWarrantyRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initiate_mobile_device_management_key_recovery()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::InitiateMobileDeviceManagementKeyRecovery::InitiateMobileDeviceManagementKeyRecoveryRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the initiateOnDemandProactiveRemediation method.
                    def initiate_on_demand_proactive_remediation()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::InitiateOnDemandProactiveRemediation::InitiateOnDemandProactiveRemediationRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the locateDevice method.
                    def locate_device()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::LocateDevice::LocateDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def logout_shared_apple_device_active_user()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::LogoutSharedAppleDeviceActiveUser::LogoutSharedAppleDeviceActiveUserRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def override_compliance_state()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::OverrideComplianceState::OverrideComplianceStateRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the playLostModeSound method.
                    def play_lost_mode_sound()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::PlayLostModeSound::PlayLostModeSoundRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the rebootNow method.
                    def reboot_now()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RebootNow::RebootNowRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the recoverPasscode method.
                    def recover_passcode()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RecoverPasscode::RecoverPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the reenable method.
                    def reenable()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::Reenable::ReenableRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the remoteLock method.
                    def remote_lock()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RemoteLock::RemoteLockRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def remove_device_firmware_configuration_interface_management()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RemoveDeviceFirmwareConfigurationInterfaceManagement::RemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the reprovisionCloudPc method.
                    def reprovision_cloud_pc()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::ReprovisionCloudPc::ReprovisionCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the requestRemoteAssistance method.
                    def request_remote_assistance()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RequestRemoteAssistance::RequestRemoteAssistanceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the requestRemoteHelpSessionAccess method.
                    def request_remote_help_session_access()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RequestRemoteHelpSessionAccess::RequestRemoteHelpSessionAccessRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the resetPasscode method.
                    def reset_passcode()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::ResetPasscode::ResetPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the resizeCloudPc method.
                    def resize_cloud_pc()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::ResizeCloudPc::ResizeCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the restoreCloudPc method.
                    def restore_cloud_pc()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RestoreCloudPc::RestoreCloudPcRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the retire method.
                    def retire()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::Retire::RetireRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the revokeAppleVppLicenses method.
                    def revoke_apple_vpp_licenses()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RevokeAppleVppLicenses::RevokeAppleVppLicensesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the rotateBitLockerKeys method.
                    def rotate_bit_locker_keys()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RotateBitLockerKeys::RotateBitLockerKeysRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the rotateFileVaultKey method.
                    def rotate_file_vault_key()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RotateFileVaultKey::RotateFileVaultKeyRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the rotateLocalAdminPassword method.
                    def rotate_local_admin_password()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::RotateLocalAdminPassword::RotateLocalAdminPasswordRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def send_custom_notification_to_company_portal()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::SendCustomNotificationToCompanyPortal::SendCustomNotificationToCompanyPortalRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the setCloudPcReviewStatus method.
                    def set_cloud_pc_review_status()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::SetCloudPcReviewStatus::SetCloudPcReviewStatusRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the setDeviceName method.
                    def set_device_name()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::SetDeviceName::SetDeviceNameRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the shutDown method.
                    def shut_down()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::ShutDown::ShutDownRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the syncDevice method.
                    def sync_device()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::SyncDevice::SyncDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the triggerConfigurationManagerAction method.
                    def trigger_configuration_manager_action()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::TriggerConfigurationManagerAction::TriggerConfigurationManagerActionRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the updateWindowsDeviceAccount method.
                    def update_windows_device_account()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::UpdateWindowsDeviceAccount::UpdateWindowsDeviceAccountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def windows_defender_scan()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::WindowsDefenderScan::WindowsDefenderScanRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the windowsDefenderUpdateSignatures method.
                    def windows_defender_update_signatures()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::WindowsDefenderUpdateSignatures::WindowsDefenderUpdateSignaturesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def wipe()
                        return MicrosoftGraphBeta::Me::ManagedDevices::Item::Wipe::WipeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the assignmentFilterEvaluationStatusDetails property of the microsoft.graph.managedDevice entity.
