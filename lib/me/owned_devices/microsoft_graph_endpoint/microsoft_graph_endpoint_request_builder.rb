...
module MicrosoftGraphBeta::Me::OwnedDevices::MicrosoftGraphEndpoint
    ## 
    ...
    class MicrosoftGraphEndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::OwnedDevices::MicrosoftGraphEndpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
