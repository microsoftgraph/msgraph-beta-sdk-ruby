...
module MicrosoftGraphBeta::Me::OwnedDevices::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def microsoft_graph_device()
            return MicrosoftGraphBeta::Me::OwnedDevices::Item::MicrosoftGraphDevice::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def microsoft_graph_endpoint()
            return MicrosoftGraphBeta::Me::OwnedDevices::Item::MicrosoftGraphEndpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
