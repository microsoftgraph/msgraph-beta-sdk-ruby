    ...
    module Me
        module OwnedDevices
            ...
            class OwnedDevicesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def graph_device()
                    return MicrosoftGraphBeta::Me::OwnedDevices::GraphDevice::GraphDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to endpoint.
                def graph_endpoint()
                    return MicrosoftGraphBeta::Me::OwnedDevices::GraphEndpoint::GraphEndpointRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the ownedDevices property of the microsoft.graph.user entity.
