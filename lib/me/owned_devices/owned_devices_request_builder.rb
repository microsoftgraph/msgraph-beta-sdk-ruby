...
module MicrosoftGraphBeta::Me::OwnedDevices
    ...
    class OwnedDevicesRequestBuilder
        ...
        def microsoft_graph_device()
            return MicrosoftGraphBeta::Me::OwnedDevices::MicrosoftGraphDevice::MicrosoftGraphDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def microsoft_graph_endpoint()
            return MicrosoftGraphBeta::Me::OwnedDevices::MicrosoftGraphEndpoint::MicrosoftGraphEndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
