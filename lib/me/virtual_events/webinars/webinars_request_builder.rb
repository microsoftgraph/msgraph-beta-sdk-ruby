        ...
        module VirtualEvents
            module Webinars
                ...
                class WebinarsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Me::VirtualEvents::Webinars::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the webinars property of the microsoft.graph.userVirtualEventsRoot entity.
                    ...
                    def by_virtual_event_webinar_id(virtual_event_webinar_id)
                        ...
                        return MicrosoftGraphBeta::Me::VirtualEvents::Webinars::Item::VirtualEventWebinarItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/me/virtualEvents/webinars{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                    end
                    ## 
