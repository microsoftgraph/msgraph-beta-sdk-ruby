...
module MicrosoftGraphBeta::Me::JoinedGroups
    ...
    class JoinedGroupsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::JoinedGroups::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the evaluateDynamicMembership method.
        def microsoft_graph_evaluate_dynamic_membership()
            return MicrosoftGraphBeta::Me::JoinedGroups::MicrosoftGraphEvaluateDynamicMembership::EvaluateDynamicMembershipRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getByIds method.
        def microsoft_graph_get_by_ids()
            return MicrosoftGraphBeta::Me::JoinedGroups::MicrosoftGraphGetByIds::GetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getUserOwnedObjects method.
        def microsoft_graph_get_user_owned_objects()
            return MicrosoftGraphBeta::Me::JoinedGroups::MicrosoftGraphGetUserOwnedObjects::GetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validateProperties method.
        def microsoft_graph_validate_properties()
            return MicrosoftGraphBeta::Me::JoinedGroups::MicrosoftGraphValidateProperties::ValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
