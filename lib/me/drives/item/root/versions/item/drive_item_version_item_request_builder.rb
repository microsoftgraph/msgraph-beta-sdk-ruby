...
module MicrosoftGraphBeta::Me::Drives::Item::Root::Versions::Item
    ## 
    ...
    class DriveItemVersionItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Me::Drives::Item::Root::Versions::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore_version()
            return MicrosoftGraphBeta::Me::Drives::Item::Root::Versions::Item::RestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
