...
module MicrosoftGraphBeta::Me::Drives::Item::Following
    ## 
    ...
    class FollowingRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Drives::Item::Following::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
