...
module MicrosoftGraphBeta::Me::Drives::Item::List::Items::Item::Activities::Item
    ## 
    ...
    class ItemActivityOLDItemRequestBuilder
        ...
        def drive_item()
            return MicrosoftGraphBeta::Me::Drives::Item::List::Items::Item::Activities::Item::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the listItem property of the microsoft.graph.itemActivityOLD entity.
        def list_item()
            return MicrosoftGraphBeta::Me::Drives::Item::List::Items::Item::Activities::Item::ListItem::ListItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}"
