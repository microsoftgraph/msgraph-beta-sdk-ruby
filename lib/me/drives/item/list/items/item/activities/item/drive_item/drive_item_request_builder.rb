...
module MicrosoftGraphBeta::Me::Drives::Item::List::Items::Item::Activities::Item::DriveItem
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Me::Drives::Item::List::Items::Item::Activities::Item::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24select,%24expand}"
