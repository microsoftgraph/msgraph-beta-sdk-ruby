...
module MicrosoftGraphBeta::Me::Drives::Item::List::ContentTypes
    ## 
    ...
    class ContentTypesRequestBuilder
        ...
        def add_copy()
            return MicrosoftGraphBeta::Me::Drives::Item::List::ContentTypes::AddCopy::AddCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addCopyFromContentTypeHub method.
        def add_copy_from_content_type_hub()
            return MicrosoftGraphBeta::Me::Drives::Item::List::ContentTypes::AddCopyFromContentTypeHub::AddCopyFromContentTypeHubRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to count the resources in the collection.
        def count()
            return MicrosoftGraphBeta::Me::Drives::Item::List::ContentTypes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
