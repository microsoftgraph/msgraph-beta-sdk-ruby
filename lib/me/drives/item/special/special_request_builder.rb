...
module MicrosoftGraphBeta::Me::Drives::Item::Special
    ## 
    ...
    class SpecialRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Drives::Item::Special::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
