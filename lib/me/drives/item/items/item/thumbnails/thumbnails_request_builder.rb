...
module MicrosoftGraphBeta::Me::Drives::Item::Items::Item::Thumbnails
    ## 
    ...
    class ThumbnailsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Drives::Item::Items::Item::Thumbnails::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
