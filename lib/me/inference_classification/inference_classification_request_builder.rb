...
module MicrosoftGraphBeta::Me::InferenceClassification
    ## 
    ...
    class InferenceClassificationRequestBuilder
        ...
        def overrides()
            return MicrosoftGraphBeta::Me::InferenceClassification::Overrides::OverridesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def overrides_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::InferenceClassification::Overrides::Item::InferenceClassificationOverrideItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
