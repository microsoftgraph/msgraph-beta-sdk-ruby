...
module MicrosoftGraphBeta::Me::TransitiveMemberOf::MicrosoftGraphApplication
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::TransitiveMemberOf::MicrosoftGraphApplication::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
