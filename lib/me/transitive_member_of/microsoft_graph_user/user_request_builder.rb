...
module MicrosoftGraphBeta::Me::TransitiveMemberOf::MicrosoftGraphUser
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::TransitiveMemberOf::MicrosoftGraphUser::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
