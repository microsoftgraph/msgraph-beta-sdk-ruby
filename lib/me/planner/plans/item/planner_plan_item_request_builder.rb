...
module MicrosoftGraphBeta::Me::Planner::Plans::Item
    ## 
    ...
    class PlannerPlanItemRequestBuilder
        ...
        def buckets()
            return MicrosoftGraphBeta::Me::Planner::Plans::Item::Buckets::BucketsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the details property of the microsoft.graph.plannerPlan entity.
        def details()
            return MicrosoftGraphBeta::Me::Planner::Plans::Item::Details::DetailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tasks()
            return MicrosoftGraphBeta::Me::Planner::Plans::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def buckets_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Planner::Plans::Item::Buckets::Item::PlannerBucketItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
