...
module MicrosoftGraphBeta::Me::Chats
    ## 
    ...
    class ChatsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Chats::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the allMessages method.
        def microsoft_graph_all_messages()
            return MicrosoftGraphBeta::Me::Chats::MicrosoftGraphAllMessages::MicrosoftGraphAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAllMessages method.
        def microsoft_graph_get_all_messages()
            return MicrosoftGraphBeta::Me::Chats::MicrosoftGraphGetAllMessages::MicrosoftGraphGetAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ChatCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
