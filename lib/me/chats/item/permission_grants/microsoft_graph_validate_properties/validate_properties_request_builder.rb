...
module MicrosoftGraphBeta::Me::Chats::Item::PermissionGrants::MicrosoftGraphValidateProperties
    ## 
    ...
    class ValidatePropertiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/chats/{chat%2Did}/permissionGrants/microsoft.graph.validateProperties"
