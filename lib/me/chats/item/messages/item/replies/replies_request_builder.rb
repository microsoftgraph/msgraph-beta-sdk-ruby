...
module MicrosoftGraphBeta::Me::Chats::Item::Messages::Item::Replies
    ## 
    ...
    class RepliesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Chats::Item::Messages::Item::Replies::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::Chats::Item::Messages::Item::Replies::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
