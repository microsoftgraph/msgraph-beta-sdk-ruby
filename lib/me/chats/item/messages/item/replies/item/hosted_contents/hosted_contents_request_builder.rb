...
module MicrosoftGraphBeta::Me::Chats::Item::Messages::Item::Replies::Item::HostedContents
    ## 
    ...
    class HostedContentsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Chats::Item::Messages::Item::Replies::Item::HostedContents::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
