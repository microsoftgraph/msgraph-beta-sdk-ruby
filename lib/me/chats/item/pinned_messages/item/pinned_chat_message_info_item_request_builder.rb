...
module MicrosoftGraphBeta::Me::Chats::Item::PinnedMessages::Item
    ## 
    ...
    class PinnedChatMessageInfoItemRequestBuilder
        ...
        def message()
            return MicrosoftGraphBeta::Me::Chats::Item::PinnedMessages::Item::Message::MessageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
