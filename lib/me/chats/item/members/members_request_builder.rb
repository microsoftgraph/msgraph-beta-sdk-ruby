            ...
            module Item
                module Members
                    ...
                    class MembersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def add()
                            return MicrosoftGraphBeta::Me::Chats::Item::Members::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to count the resources in the collection.
                        def count()
                            return MicrosoftGraphBeta::Me::Chats::Item::Members::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the members property of the microsoft.graph.chat entity.
