...
module MicrosoftGraphBeta::Me::Chats::Item::Members
    ## 
    ...
    class MembersRequestBuilder
        ...
        def microsoft_graph_add()
            return MicrosoftGraphBeta::Me::Chats::Item::Members::MicrosoftGraphAdd::MicrosoftGraphAddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
