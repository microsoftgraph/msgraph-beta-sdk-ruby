...
module MicrosoftGraphBeta::Me::Chats::Item
    ...
    class ChatItemRequestBuilder
        ...
        def microsoft_graph_hide_for_user()
            return MicrosoftGraphBeta::Me::Chats::Item::MicrosoftGraphHideForUser::HideForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the markChatReadForUser method.
        def microsoft_graph_mark_chat_read_for_user()
            return MicrosoftGraphBeta::Me::Chats::Item::MicrosoftGraphMarkChatReadForUser::MarkChatReadForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the markChatUnreadForUser method.
        def microsoft_graph_mark_chat_unread_for_user()
            return MicrosoftGraphBeta::Me::Chats::Item::MicrosoftGraphMarkChatUnreadForUser::MarkChatUnreadForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendActivityNotification method.
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraphBeta::Me::Chats::Item::MicrosoftGraphSendActivityNotification::SendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unhideForUser method.
        def microsoft_graph_unhide_for_user()
            return MicrosoftGraphBeta::Me::Chats::Item::MicrosoftGraphUnhideForUser::UnhideForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
