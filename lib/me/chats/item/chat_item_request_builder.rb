...
module MicrosoftGraphBeta::Me::Chats::Item
    ## 
    ...
    class ChatItemRequestBuilder
        ...
        def installed_apps()
            return MicrosoftGraphBeta::Me::Chats::Item::InstalledApps::InstalledAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the lastMessagePreview property of the microsoft.graph.chat entity.
        def last_message_preview()
            return MicrosoftGraphBeta::Me::Chats::Item::LastMessagePreview::LastMessagePreviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the members property of the microsoft.graph.chat entity.
        def members()
            return MicrosoftGraphBeta::Me::Chats::Item::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the messages property of the microsoft.graph.chat entity.
        def messages()
            return MicrosoftGraphBeta::Me::Chats::Item::Messages::MessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the hideForUser method.
        def microsoft_graph_hide_for_user()
            return MicrosoftGraphBeta::Me::Chats::Item::MicrosoftGraphHideForUser::MicrosoftGraphHideForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the markChatReadForUser method.
        def microsoft_graph_mark_chat_read_for_user()
            return MicrosoftGraphBeta::Me::Chats::Item::MicrosoftGraphMarkChatReadForUser::MicrosoftGraphMarkChatReadForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the markChatUnreadForUser method.
        def microsoft_graph_mark_chat_unread_for_user()
            return MicrosoftGraphBeta::Me::Chats::Item::MicrosoftGraphMarkChatUnreadForUser::MicrosoftGraphMarkChatUnreadForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendActivityNotification method.
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraphBeta::Me::Chats::Item::MicrosoftGraphSendActivityNotification::MicrosoftGraphSendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unhideForUser method.
        def microsoft_graph_unhide_for_user()
            return MicrosoftGraphBeta::Me::Chats::Item::MicrosoftGraphUnhideForUser::MicrosoftGraphUnhideForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.chat entity.
        def operations()
            return MicrosoftGraphBeta::Me::Chats::Item::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def permission_grants()
            return MicrosoftGraphBeta::Me::Chats::Item::PermissionGrants::PermissionGrantsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the pinnedMessages property of the microsoft.graph.chat entity.
        def pinned_messages()
            return MicrosoftGraphBeta::Me::Chats::Item::PinnedMessages::PinnedMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tabs()
            return MicrosoftGraphBeta::Me::Chats::Item::Tabs::TabsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def installed_apps_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Chats::Item::InstalledApps::Item::TeamsAppInstallationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the members property of the microsoft.graph.chat entity.
        ## @param id Unique identifier of the item
        ...
        def members_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Chats::Item::Members::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the messages property of the microsoft.graph.chat entity.
        ## @param id Unique identifier of the item
        ...
        def permission_grants_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Chats::Item::PermissionGrants::Item::ResourceSpecificPermissionGrantItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the pinnedMessages property of the microsoft.graph.chat entity.
        ## @param id Unique identifier of the item
        ...
        def pinned_messages_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Chats::Item::PinnedMessages::Item::PinnedChatMessageInfoItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tabs property of the microsoft.graph.chat entity.
        ## @param id Unique identifier of the item
