...
module MicrosoftGraphBeta::Me::Security
    ## 
    ...
    class SecurityRequestBuilder
        ...
        def information_protection()
            return MicrosoftGraphBeta::Me::Security::InformationProtection::InformationProtectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/security{?%24select,%24expand}"
