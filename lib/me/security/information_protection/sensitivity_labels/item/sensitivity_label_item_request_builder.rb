...
module MicrosoftGraphBeta::Me::Security::InformationProtection::SensitivityLabels::Item
    ## 
    ...
    class SensitivityLabelItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, sensitivity_label_id=nil)
            ...
            @url_template = "{+baseurl}/me/security/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}"
