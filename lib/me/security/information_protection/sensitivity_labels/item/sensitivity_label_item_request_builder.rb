                ...
                module SensitivityLabels
                    module Item
                        ...
                        class SensitivityLabelItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def parent()
                                return MicrosoftGraphBeta::Me::Security::InformationProtection::SensitivityLabels::Item::Parent::ParentRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/me/security/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}")
                            end
                            ## 
