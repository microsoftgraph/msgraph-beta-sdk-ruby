...
module MicrosoftGraphBeta::Me::OnlineMeetings::Item
    ## 
    ...
    class OnlineMeetingItemRequestBuilder
        ...
        def attendance_reports_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::OnlineMeetings::Item::AttendanceReports::Item::MeetingAttendanceReportItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def transcripts_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::OnlineMeetings::Item::Transcripts::Item::CallTranscriptItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
