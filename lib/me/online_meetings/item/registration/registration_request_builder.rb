            ...
            module Item
                module Registration
                    ...
                    class RegistrationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def registrants()
                            return MicrosoftGraphBeta::Me::OnlineMeetings::Item::Registration::Registrants::RegistrantsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/registration{?%24select,%24expand}")
                        end
                        ## 
