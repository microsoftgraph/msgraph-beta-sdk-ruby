...
module MicrosoftGraphBeta::Me::OnlineMeetings::Item::Registration::CustomQuestions::Item
    ## 
    ...
    class MeetingRegistrationQuestionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, meeting_registration_question_id=nil)
            ...
            @url_template = "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/registration/customQuestions/{meetingRegistrationQuestion%2Did}{?%24select,%24expand}"
