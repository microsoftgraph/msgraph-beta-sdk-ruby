...
module MicrosoftGraphBeta::Me::ContactFolders
    ## 
    ...
    class ContactFoldersRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::ContactFolders::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::ContactFolders::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
