...
module MicrosoftGraphBeta::Me::ContactFolders::Item::ChildFolders::MicrosoftGraphDelta
    class DeltaResponse < MicrosoftGraphBeta::Models::BaseDeltaFunctionResponse
        ...
        def get_field_deserializers()
            return super.merge({
                "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ContactFolder.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
