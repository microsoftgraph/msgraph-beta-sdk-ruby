...
module MicrosoftGraphBeta::Me::Onenote::Notebooks::Item
    ...
    class NotebookItemRequestBuilder
        ...
        def microsoft_graph_copy_notebook()
            return MicrosoftGraphBeta::Me::Onenote::Notebooks::Item::MicrosoftGraphCopyNotebook::MicrosoftGraphCopyNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
