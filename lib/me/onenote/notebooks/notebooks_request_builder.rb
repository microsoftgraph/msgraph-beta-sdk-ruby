        ...
        module Onenote
            module Notebooks
                ...
                class NotebooksRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Me::Onenote::Notebooks::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getNotebookFromWebUrl method.
                    def get_notebook_from_web_url()
                        return MicrosoftGraphBeta::Me::Onenote::Notebooks::GetNotebookFromWebUrl::GetNotebookFromWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the notebooks property of the microsoft.graph.onenote entity.
                    ...
                    def by_notebook_id(notebook_id)
                        ...
                        return MicrosoftGraphBeta::Me::Onenote::Notebooks::Item::NotebookItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
