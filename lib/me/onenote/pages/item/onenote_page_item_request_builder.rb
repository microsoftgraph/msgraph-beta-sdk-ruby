                ...
                module Item
                    ...
                    class OnenotePageItemRequestBuilder
                        ...
                        def microsoft_graph_copy_to_section()
                            return MicrosoftGraphBeta::Me::Onenote::Pages::Item::MicrosoftGraphCopyToSection::MicrosoftGraphCopyToSectionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the onenotePatchContent method.
                        def microsoft_graph_onenote_patch_content()
                            return MicrosoftGraphBeta::Me::Onenote::Pages::Item::MicrosoftGraphOnenotePatchContent::MicrosoftGraphOnenotePatchContentRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the preview method.
                        def microsoft_graph_preview()
                            return MicrosoftGraphBeta::Me::Onenote::Pages::Item::MicrosoftGraphPreview::MicrosoftGraphPreviewRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
