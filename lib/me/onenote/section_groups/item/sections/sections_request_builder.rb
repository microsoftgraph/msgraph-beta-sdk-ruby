...
module MicrosoftGraphBeta::Me::Onenote::SectionGroups::Item::Sections
    ## 
    ...
    class SectionsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Onenote::SectionGroups::Item::Sections::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
