        ...
        module Onenote
            module Sections
                ...
                class SectionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Me::Onenote::Sections::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the sections property of the microsoft.graph.onenote entity.
                    ...
                    def by_onenote_section_id(onenote_section_id)
                        ...
                        return MicrosoftGraphBeta::Me::Onenote::Sections::Item::OnenoteSectionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
