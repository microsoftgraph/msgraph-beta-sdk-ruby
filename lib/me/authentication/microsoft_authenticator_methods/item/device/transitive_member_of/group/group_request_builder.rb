...
module MicrosoftGraphBeta::Me::Authentication::MicrosoftAuthenticatorMethods::Item::Device::TransitiveMemberOf::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Authentication::MicrosoftAuthenticatorMethods::Item::Device::TransitiveMemberOf::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
