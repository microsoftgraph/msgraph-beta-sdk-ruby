...
module MicrosoftGraphBeta::Me::Authentication::MicrosoftAuthenticatorMethods::Item::Device::RegisteredOwners::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Authentication::MicrosoftAuthenticatorMethods::Item::Device::RegisteredOwners::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
