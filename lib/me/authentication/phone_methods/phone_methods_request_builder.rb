        ...
        module Authentication
            module PhoneMethods
                ...
                class PhoneMethodsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Me::Authentication::PhoneMethods::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the phoneMethods property of the microsoft.graph.authentication entity.
                    ...
                    def by_phone_authentication_method_id(phone_authentication_method_id)
                        ...
                        return MicrosoftGraphBeta::Me::Authentication::PhoneMethods::Item::PhoneAuthenticationMethodItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
