...
module MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::RegisteredUsers::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::RegisteredUsers::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
