...
module MicrosoftGraphBeta::Me::Authentication::PasswordlessMicrosoftAuthenticatorMethods::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/authentication/passwordlessMicrosoftAuthenticatorMethods/$count{?%24search,%24filter}"
