...
require_relative '../../../../models/passwordless_microsoft_authenticator_authentication_method'
require_relative '../../../me'
...
module MicrosoftGraphBeta::Me::Authentication::PasswordlessMicrosoftAuthenticatorMethods::Item
    ## 
    ...
    class PasswordlessMicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder
        ...
        def device()
            return MicrosoftGraphBeta::Me::Authentication::PasswordlessMicrosoftAuthenticatorMethods::Item::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param passwordlessMicrosoftAuthenticatorAuthenticationMethodId key: id of passwordlessMicrosoftAuthenticatorAuthenticationMethod
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, passwordless_microsoft_authenticator_authentication_method_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/me/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}{?%24select,%24expand}"
