        ...
        module Authentication
            module PasswordlessMicrosoftAuthenticatorMethods
                module Item
                    ...
                    class PasswordlessMicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}{?%24select,%24expand}")
                        end
                        ## 
