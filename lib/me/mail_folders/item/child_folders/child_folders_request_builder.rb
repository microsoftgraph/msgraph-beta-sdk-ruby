...
module MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders
    ## 
    ...
    class ChildFoldersRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
