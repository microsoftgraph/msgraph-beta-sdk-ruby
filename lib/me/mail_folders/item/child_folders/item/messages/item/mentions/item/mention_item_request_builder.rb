...
module MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::Messages::Item::Mentions::Item
    ## 
    ...
    class MentionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, mention_id=nil)
            ...
            @url_template = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/mentions/{mention%2Did}{?%24select,%24expand}"
