...
module MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item
    ...
    class MailFolderItemRequestBuilder
        ...
        def copy()
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::Copy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def move()
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::Move::MoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
