...
module MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item
    ## 
    ...
    class MailFolderItemRequestBuilder
        ...
        def message_rules()
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::MessageRules::MessageRulesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the messages property of the microsoft.graph.mailFolder entity.
        def messages()
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::Messages::MessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copy method.
        def microsoft_graph_copy()
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::MicrosoftGraphCopy::MicrosoftGraphCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the move method.
        def microsoft_graph_move()
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::MicrosoftGraphMove::MicrosoftGraphMoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.mailFolder entity.
        def multi_value_extended_properties()
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_configurations()
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::UserConfigurations::UserConfigurationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def message_rules_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::MessageRules::Item::MessageRuleItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the messages property of the microsoft.graph.mailFolder entity.
        ## @param id Unique identifier of the item
        ...
        def messages_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::Messages::Item::MessageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.mailFolder entity.
        ## @param id Unique identifier of the item
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::MailFolders::Item::ChildFolders::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property childFolders for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
