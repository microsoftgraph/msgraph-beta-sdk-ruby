...
module MicrosoftGraphBeta::Me::MailFolders::Item::Messages::Item::Mentions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/mentions/$count{?%24filter}"
