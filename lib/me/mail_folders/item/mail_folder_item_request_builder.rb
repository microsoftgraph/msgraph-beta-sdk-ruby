...
module MicrosoftGraphBeta::Me::MailFolders::Item
    ...
    class MailFolderItemRequestBuilder
        ...
        def microsoft_graph_copy()
            return MicrosoftGraphBeta::Me::MailFolders::Item::MicrosoftGraphCopy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the move method.
        def microsoft_graph_move()
            return MicrosoftGraphBeta::Me::MailFolders::Item::MicrosoftGraphMove::MoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
