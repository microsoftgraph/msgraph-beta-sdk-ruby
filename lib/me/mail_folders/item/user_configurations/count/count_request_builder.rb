...
module MicrosoftGraphBeta::Me::MailFolders::Item::UserConfigurations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/userConfigurations/$count{?%24filter}"
