...
module MicrosoftGraphBeta::Me::MailFolders
    ## 
    ...
    class MailFoldersRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::MailFolders::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::MailFolders::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
