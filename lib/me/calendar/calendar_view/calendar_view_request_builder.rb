...
module MicrosoftGraphBeta::Me::Calendar::CalendarView
    ## 
    ...
    class CalendarViewRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::Calendar::CalendarView::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
