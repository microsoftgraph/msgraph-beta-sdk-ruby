        ...
        module Calendar
            module CalendarPermissions
                ...
                class CalendarPermissionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Me::Calendar::CalendarPermissions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the calendarPermissions property of the microsoft.graph.calendar entity.
                    ...
                    def by_calendar_permission_id(calendar_permission_id)
                        ...
                        return MicrosoftGraphBeta::Me::Calendar::CalendarPermissions::Item::CalendarPermissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
