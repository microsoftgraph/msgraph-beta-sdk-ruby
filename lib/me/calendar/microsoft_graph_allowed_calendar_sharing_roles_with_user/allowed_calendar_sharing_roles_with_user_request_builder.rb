...
module MicrosoftGraphBeta::Me::Calendar::MicrosoftGraphAllowedCalendarSharingRolesWithUser
    ...
    class AllowedCalendarSharingRolesWithUserRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Me::Calendar::MicrosoftGraphAllowedCalendarSharingRolesWithUser::AllowedCalendarSharingRolesWithUserResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function allowedCalendarSharingRoles
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
