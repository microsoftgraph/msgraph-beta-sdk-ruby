                        ...
                        module Item
                            module ExceptionOccurrences
                                ...
                                class ExceptionOccurrencesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def delta()
                                        return MicrosoftGraphBeta::Me::Calendar::Events::Item::Instances::Item::ExceptionOccurrences::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the exceptionOccurrences property of the microsoft.graph.event entity.
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/me/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}")
                                    end
                                    ## 
