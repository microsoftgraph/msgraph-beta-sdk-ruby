...
module MicrosoftGraphBeta::Me::Teamwork
    ...
    class TeamworkRequestBuilder
        ...
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraphBeta::Me::Teamwork::MicrosoftGraphSendActivityNotification::SendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
