...
module MicrosoftGraphBeta::Me::CalendarView
    ## 
    ...
    class CalendarViewRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::CalendarView::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::CalendarView::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
