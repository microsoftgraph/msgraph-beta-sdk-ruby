...
module MicrosoftGraphBeta::Me::CalendarView::Item::ExceptionOccurrences::Item::Calendar
    ## 
    ...
    class CalendarRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/calendar{?%24select}"
