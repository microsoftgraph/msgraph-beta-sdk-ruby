...
module MicrosoftGraphBeta::Me::CalendarView::Item::ExceptionOccurrences::Item::Instances::Item::Calendar
    ## 
    ...
    class CalendarRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/calendar{?%24select}"
