...
module MicrosoftGraphBeta::Me::OwnedObjects::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def application()
            return MicrosoftGraphBeta::Me::OwnedObjects::Item::Application::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def group()
            return MicrosoftGraphBeta::Me::OwnedObjects::Item::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraphBeta::Me::OwnedObjects::Item::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
