...
module MicrosoftGraphBeta::Me::OwnedObjects::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::OwnedObjects::Application::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
