...
module MicrosoftGraphBeta::Me::RegisteredDevices::MicrosoftGraphEndpoint
    ## 
    ...
    class MicrosoftGraphEndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::RegisteredDevices::MicrosoftGraphEndpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
