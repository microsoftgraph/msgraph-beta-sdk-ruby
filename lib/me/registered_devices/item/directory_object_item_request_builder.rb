        ...
        module RegisteredDevices
            module Item
                ...
                class DirectoryObjectItemRequestBuilder
                    ...
                    def graph_device()
                        return MicrosoftGraphBeta::Me::RegisteredDevices::Item::GraphDevice::GraphDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to endpoint.
                    def graph_endpoint()
                        return MicrosoftGraphBeta::Me::RegisteredDevices::Item::GraphEndpoint::GraphEndpointRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
