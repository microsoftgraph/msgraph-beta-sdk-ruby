...
module MicrosoftGraphBeta::Me::RegisteredDevices
    ...
    class RegisteredDevicesRequestBuilder
        ...
        def device()
            return MicrosoftGraphBeta::Me::RegisteredDevices::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def endpoint()
            return MicrosoftGraphBeta::Me::RegisteredDevices::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
