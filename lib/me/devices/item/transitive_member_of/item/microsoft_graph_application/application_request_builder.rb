...
module MicrosoftGraphBeta::Me::Devices::Item::TransitiveMemberOf::Item::MicrosoftGraphApplication
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.application{?%24select,%24expand}"
