...
module MicrosoftGraphBeta::Me::Devices::Item::TransitiveMemberOf::Device::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.device/$count"
