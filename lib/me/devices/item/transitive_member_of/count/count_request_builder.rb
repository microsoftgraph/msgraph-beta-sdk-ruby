...
module MicrosoftGraphBeta::Me::Devices::Item::TransitiveMemberOf::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/$count{?%24search,%24filter}"
