                ...
                module TransitiveMemberOf
                    ...
                    class TransitiveMemberOfRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def graph_administrative_unit()
                            return MicrosoftGraphBeta::Me::Devices::Item::TransitiveMemberOf::GraphAdministrativeUnit::GraphAdministrativeUnitRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Casts the previous resource to group.
                        def graph_group()
                            return MicrosoftGraphBeta::Me::Devices::Item::TransitiveMemberOf::GraphGroup::GraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the transitiveMemberOf property of the microsoft.graph.device entity.
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                        end
                        ## 
