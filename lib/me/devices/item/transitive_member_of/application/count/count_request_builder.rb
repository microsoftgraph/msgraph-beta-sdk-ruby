...
module MicrosoftGraphBeta::Me::Devices::Item::TransitiveMemberOf::Application::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.application/$count{?%24search,%24filter}"
