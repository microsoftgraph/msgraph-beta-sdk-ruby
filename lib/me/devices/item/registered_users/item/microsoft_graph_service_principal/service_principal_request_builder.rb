...
module MicrosoftGraphBeta::Me::Devices::Item::RegisteredUsers::Item::MicrosoftGraphServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}"
