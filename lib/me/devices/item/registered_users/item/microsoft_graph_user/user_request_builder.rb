...
module MicrosoftGraphBeta::Me::Devices::Item::RegisteredUsers::Item::MicrosoftGraphUser
    ## 
    ...
    class UserRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}"
