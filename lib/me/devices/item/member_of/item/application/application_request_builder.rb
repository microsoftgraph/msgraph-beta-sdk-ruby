...
module MicrosoftGraphBeta::Me::Devices::Item::MemberOf::Item::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.application{?%24select,%24expand}"
