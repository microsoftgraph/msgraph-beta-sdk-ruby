...
module MicrosoftGraphBeta::Me::Devices::Item::RegisteredOwners::Item::MicrosoftGraphEndpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/microsoft.graph.endpoint{?%24select,%24expand}"
