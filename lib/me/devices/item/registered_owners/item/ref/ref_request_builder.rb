...
module MicrosoftGraphBeta::Me::Devices::Item::RegisteredOwners::Item::Ref
    ## 
    ...
    class RefRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/$ref{?%40id*}"
