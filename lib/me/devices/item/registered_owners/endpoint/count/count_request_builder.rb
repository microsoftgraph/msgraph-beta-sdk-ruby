...
module MicrosoftGraphBeta::Me::Devices::Item::RegisteredOwners::Endpoint::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/devices/{device%2Did}/registeredOwners/microsoft.graph.endpoint/$count{?%24search,%24filter}"
