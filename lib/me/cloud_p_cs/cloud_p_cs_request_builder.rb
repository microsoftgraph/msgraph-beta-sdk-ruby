    ...
    module Me
        module CloudPCs
            ...
            class CloudPCsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def bulk_resize()
                    return MicrosoftGraphBeta::Me::CloudPCs::BulkResize::BulkResizeRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to count the resources in the collection.
                def count()
                    return MicrosoftGraphBeta::Me::CloudPCs::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the validateBulkResize method.
                def validate_bulk_resize()
                    return MicrosoftGraphBeta::Me::CloudPCs::ValidateBulkResize::ValidateBulkResizeRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the cloudPCs property of the microsoft.graph.user entity.
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/me/cloudPCs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                end
                ## 
