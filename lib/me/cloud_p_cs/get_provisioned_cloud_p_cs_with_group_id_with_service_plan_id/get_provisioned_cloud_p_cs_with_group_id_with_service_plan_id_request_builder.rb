            ...
            module GetProvisionedCloudPCsWithGroupIdWithServicePlanId
                ...
                class GetProvisionedCloudPCsWithGroupIdWithServicePlanIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter, group_id=nil, service_plan_id=nil)
                        super(path_parameters, request_adapter, "{+baseurl}/me/cloudPCs/getProvisionedCloudPCs(groupId='{groupId}',servicePlanId='{servicePlanId}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}")
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Me::CloudPCs::GetProvisionedCloudPCsWithGroupIdWithServicePlanId::GetProvisionedCloudPCsWithGroupIdWithServicePlanIdGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Invoke function getProvisionedCloudPCs
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
