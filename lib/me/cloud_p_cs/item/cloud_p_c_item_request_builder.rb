...
module MicrosoftGraphBeta::Me::CloudPCs::Item
    ...
    class CloudPCItemRequestBuilder
        ...
        def microsoft_graph_change_user_account_type()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphChangeUserAccountType::ChangeUserAccountTypeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the endGracePeriod method.
        def microsoft_graph_end_grace_period()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphEndGracePeriod::EndGracePeriodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_cloud_pc_connectivity_history()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphGetCloudPcConnectivityHistory::GetCloudPcConnectivityHistoryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getCloudPcLaunchInfo method.
        def microsoft_graph_get_cloud_pc_launch_info()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphGetCloudPcLaunchInfo::GetCloudPcLaunchInfoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_shift_work_cloud_pc_access_state()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphGetShiftWorkCloudPcAccessState::GetShiftWorkCloudPcAccessStateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_supported_cloud_pc_remote_actions()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphGetSupportedCloudPcRemoteActions::GetSupportedCloudPcRemoteActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reboot method.
        def microsoft_graph_reboot()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphReboot::RebootRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the rename method.
        def microsoft_graph_rename()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphRename::RenameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reprovision method.
        def microsoft_graph_reprovision()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphReprovision::ReprovisionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphRestore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the retryPartnerAgentInstallation method.
        def microsoft_graph_retry_partner_agent_installation()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphRetryPartnerAgentInstallation::RetryPartnerAgentInstallationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the troubleshoot method.
        def microsoft_graph_troubleshoot()
            return MicrosoftGraphBeta::Me::CloudPCs::Item::MicrosoftGraphTroubleshoot::TroubleshootRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
