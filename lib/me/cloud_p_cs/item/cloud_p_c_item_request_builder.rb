            ...
            module Item
                ...
                class CloudPCItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def get_cloud_pc_connectivity_history()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::GetCloudPcConnectivityHistory::GetCloudPcConnectivityHistoryRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def get_shift_work_cloud_pc_access_state()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::GetShiftWorkCloudPcAccessState::GetShiftWorkCloudPcAccessStateRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getSupportedCloudPcRemoteActions method.
                    def get_supported_cloud_pc_remote_actions()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::GetSupportedCloudPcRemoteActions::GetSupportedCloudPcRemoteActionsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the powerOff method.
                    def power_off()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::PowerOff::PowerOffRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the powerOn method.
                    def power_on()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::PowerOn::PowerOnRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the reboot method.
                    def reboot()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::Reboot::RebootRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the rename method.
                    def rename()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::Rename::RenameRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def restore()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the retryPartnerAgentInstallation method.
                    def retry_partner_agent_installation()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::RetryPartnerAgentInstallation::RetryPartnerAgentInstallationRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the start method.
                    def start()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::Start::StartRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the stop method.
                    def stop()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::Stop::StopRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the troubleshoot method.
                    def troubleshoot()
                        return MicrosoftGraphBeta::Me::CloudPCs::Item::Troubleshoot::TroubleshootRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/me/cloudPCs/{cloudPC%2Did}{?%24select,%24expand}")
                    end
                    ## 
