        ...
        module CloudPCs
            module Item
                module PowerOff
                    ...
                    class PowerOffRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/powerOff")
                        end
                        ## 
                        ...
                        ## @return a power_off_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return PowerOffRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
