            ...
            module ValidateBulkResize
                ...
                class ValidateBulkResizeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/me/cloudPCs/validateBulkResize")
                    end
                    ## 
                    ...
                    def post(body, request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Me::CloudPCs::ValidateBulkResize::ValidateBulkResizePostResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Validate that a set of cloudPC devices meet the requirements to be bulk resized. This API is available in the following national cloud deployments.
                    ## @param body The request body
