    ...
    module Me
        ...
        class MeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def delete_password_single_sign_on_credentials()
                return MicrosoftGraphBeta::Me::DeletePasswordSingleSignOnCredentials::DeletePasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def employee_experience()
                return MicrosoftGraphBeta::Me::EmployeeExperience::EmployeeExperienceRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def get_password_single_sign_on_credentials()
                return MicrosoftGraphBeta::Me::GetPasswordSingleSignOnCredentials::GetPasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def permission_grants()
                return MicrosoftGraphBeta::Me::PermissionGrants::PermissionGrantsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def sponsors()
                return MicrosoftGraphBeta::Me::Sponsors::SponsorsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
