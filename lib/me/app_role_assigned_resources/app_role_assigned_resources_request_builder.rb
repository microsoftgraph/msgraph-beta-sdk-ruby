...
module MicrosoftGraphBeta::Me::AppRoleAssignedResources
    ## 
    ...
    class AppRoleAssignedResourcesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::AppRoleAssignedResources::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/appRoleAssignedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
