...
module MicrosoftGraphBeta::Me::InformationProtection::ThreatAssessmentRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/informationProtection/threatAssessmentRequests/$count{?%24search,%24filter}"
