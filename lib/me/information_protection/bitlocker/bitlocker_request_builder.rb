...
module MicrosoftGraphBeta::Me::InformationProtection::Bitlocker
    ## 
    ...
    class BitlockerRequestBuilder
        ...
        def recovery_keys()
            return MicrosoftGraphBeta::Me::InformationProtection::Bitlocker::RecoveryKeys::RecoveryKeysRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/informationProtection/bitlocker{?%24select,%24expand}"
