            ...
            module Bitlocker
                module RecoveryKeys
                    ...
                    class RecoveryKeysRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Me::InformationProtection::Bitlocker::RecoveryKeys::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the recoveryKeys property of the microsoft.graph.bitlocker entity.
                        ...
                        def by_bitlocker_recovery_key_id(bitlocker_recovery_key_id)
                            ...
                            return MicrosoftGraphBeta::Me::InformationProtection::Bitlocker::RecoveryKeys::Item::BitlockerRecoveryKeyItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/informationProtection/bitlocker/recoveryKeys{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                        end
                        ## 
