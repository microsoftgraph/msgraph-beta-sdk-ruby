...
module MicrosoftGraphBeta::Me::InformationProtection::Bitlocker::RecoveryKeys::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/informationProtection/bitlocker/recoveryKeys/$count{?%24search,%24filter}"
