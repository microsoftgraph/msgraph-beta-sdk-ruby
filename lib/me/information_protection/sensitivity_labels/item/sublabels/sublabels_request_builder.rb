...
module MicrosoftGraphBeta::Me::InformationProtection::SensitivityLabels::Item::Sublabels
    ## 
    ...
    class SublabelsRequestBuilder
        ...
        def microsoft_graph_evaluate()
            return MicrosoftGraphBeta::Me::InformationProtection::SensitivityLabels::Item::Sublabels::MicrosoftGraphEvaluate::MicrosoftGraphEvaluateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
