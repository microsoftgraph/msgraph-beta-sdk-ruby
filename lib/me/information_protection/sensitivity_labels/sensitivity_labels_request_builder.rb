...
module MicrosoftGraphBeta::Me::InformationProtection::SensitivityLabels
    ...
    class SensitivityLabelsRequestBuilder
        ...
        def microsoft_graph_evaluate()
            return MicrosoftGraphBeta::Me::InformationProtection::SensitivityLabels::MicrosoftGraphEvaluate::EvaluateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
