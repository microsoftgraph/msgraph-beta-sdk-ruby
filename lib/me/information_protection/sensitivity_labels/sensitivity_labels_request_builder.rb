...
module MicrosoftGraphBeta::Me::InformationProtection::SensitivityLabels
    ## 
    ...
    class SensitivityLabelsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::InformationProtection::SensitivityLabels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the evaluate method.
        def microsoft_graph_evaluate()
            return MicrosoftGraphBeta::Me::InformationProtection::SensitivityLabels::MicrosoftGraphEvaluate::MicrosoftGraphEvaluateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/informationProtection/sensitivityLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
