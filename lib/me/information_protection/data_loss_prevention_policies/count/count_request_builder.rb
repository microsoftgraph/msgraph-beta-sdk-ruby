...
module MicrosoftGraphBeta::Me::InformationProtection::DataLossPreventionPolicies::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/informationProtection/dataLossPreventionPolicies/$count{?%24search,%24filter}"
