...
module MicrosoftGraphBeta::Me::InformationProtection
    ...
    class InformationProtectionRequestBuilder
        ...
        def microsoft_graph_decrypt_buffer()
            return MicrosoftGraphBeta::Me::InformationProtection::MicrosoftGraphDecryptBuffer::DecryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the encryptBuffer method.
        def microsoft_graph_encrypt_buffer()
            return MicrosoftGraphBeta::Me::InformationProtection::MicrosoftGraphEncryptBuffer::EncryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the signDigest method.
        def microsoft_graph_sign_digest()
            return MicrosoftGraphBeta::Me::InformationProtection::MicrosoftGraphSignDigest::SignDigestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the verifySignature method.
        def microsoft_graph_verify_signature()
            return MicrosoftGraphBeta::Me::InformationProtection::MicrosoftGraphVerifySignature::VerifySignatureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
