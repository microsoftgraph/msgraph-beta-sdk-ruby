                ...
                module Labels
                    ...
                    class LabelsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def evaluate_application()
                            return MicrosoftGraphBeta::Me::InformationProtection::Policy::Labels::EvaluateApplication::EvaluateApplicationRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the evaluateClassificationResults method.
                        def evaluate_classification_results()
                            return MicrosoftGraphBeta::Me::InformationProtection::Policy::Labels::EvaluateClassificationResults::EvaluateClassificationResultsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the evaluateRemoval method.
                        def evaluate_removal()
                            return MicrosoftGraphBeta::Me::InformationProtection::Policy::Labels::EvaluateRemoval::EvaluateRemovalRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the extractLabel method.
                        def extract_label()
                            return MicrosoftGraphBeta::Me::InformationProtection::Policy::Labels::ExtractLabel::ExtractLabelRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the labels property of the microsoft.graph.informationProtectionPolicy entity.
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/informationProtection/policy/labels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                        end
                        ## 
