...
require_relative '../../../../../models/labeling_options'
require_relative '../../../../me'
require_relative '../../../information_protection'
require_relative '../../policy'
require_relative '../labels'
require_relative './microsoft_graph_evaluate_application'

module MicrosoftGraphBeta::Me::InformationProtection::Policy::Labels::MicrosoftGraphEvaluateApplication
    class EvaluateApplicationPostRequestBody
        ...
        ## @return a evaluate_application_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return EvaluateApplicationPostRequestBody.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                ...
                "labelingOptions" => lambda {|n| @labeling_options = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::LabelingOptions.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
        ...
        ## @param value Value to set for the labeling_options property.
        ## @return a void
        ## 
        def labeling_options=(value)
            @labeling_options = value
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_object_value("labelingOptions", @labeling_options)
