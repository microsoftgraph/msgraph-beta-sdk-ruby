...
module MicrosoftGraphBeta::Me::InformationProtection::Policy::Labels::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/informationProtection/policy/labels/$count{?%24search,%24filter}"
