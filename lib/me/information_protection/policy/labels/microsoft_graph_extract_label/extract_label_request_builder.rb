...
module MicrosoftGraphBeta::Me::InformationProtection::Policy::Labels::MicrosoftGraphExtractLabel
    ## 
    ...
    class ExtractLabelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/informationProtection/policy/labels/microsoft.graph.extractLabel"
