        ...
        module MemberOf
            ...
            class MemberOfRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def graph_administrative_unit()
                    return MicrosoftGraphBeta::Me::MemberOf::GraphAdministrativeUnit::GraphAdministrativeUnitRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to directoryRole.
                def graph_directory_role()
                    return MicrosoftGraphBeta::Me::MemberOf::GraphDirectoryRole::GraphDirectoryRoleRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Casts the previous resource to group.
                def graph_group()
                    return MicrosoftGraphBeta::Me::MemberOf::GraphGroup::GraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the memberOf property of the microsoft.graph.user entity.
