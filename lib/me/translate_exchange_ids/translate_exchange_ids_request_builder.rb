        ...
        module TranslateExchangeIds
            ...
            class TranslateExchangeIdsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def post(body, request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Me::TranslateExchangeIds::TranslateExchangeIdsPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Translate identifiers of Outlook-related resources between formats. This API is available in the following national cloud deployments.
                ## @param body The request body
