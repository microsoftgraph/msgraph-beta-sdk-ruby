...
require_relative './item'
require_relative './microsoft_graph_complete/microsoft_graph_complete_request_builder'
...
module MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item
    ...
    class OutlookTaskItemRequestBuilder
        ...
        def microsoft_graph_complete()
            return MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item::MicrosoftGraphComplete::MicrosoftGraphCompleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
