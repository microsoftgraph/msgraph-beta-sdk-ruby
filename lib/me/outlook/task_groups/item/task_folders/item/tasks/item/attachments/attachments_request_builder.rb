...
module MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item::Attachments
    ...
    class AttachmentsRequestBuilder
        ...
        def microsoft_graph_create_upload_session()
            return MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item::Attachments::MicrosoftGraphCreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
