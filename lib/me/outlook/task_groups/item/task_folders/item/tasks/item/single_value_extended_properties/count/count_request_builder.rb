...
module MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::TaskFolders::Item::Tasks::Item::SingleValueExtendedProperties::Count
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}/singleValueExtendedProperties/$count"
