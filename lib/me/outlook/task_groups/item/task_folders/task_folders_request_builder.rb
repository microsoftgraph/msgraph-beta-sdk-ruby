                ...
                module Item
                    module TaskFolders
                        ...
                        class TaskFoldersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::TaskFolders::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the taskFolders property of the microsoft.graph.outlookTaskGroup entity.
                            ...
                            def by_outlook_task_folder_id(outlook_task_folder_id)
                                ...
                                return MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::TaskFolders::Item::OutlookTaskFolderItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}")
                            end
                            ## 
