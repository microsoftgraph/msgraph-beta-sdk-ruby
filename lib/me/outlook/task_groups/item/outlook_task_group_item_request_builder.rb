...
require_relative '../../../../models/outlook_task_group'
require_relative '../../../me'
...
module MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item
    ## 
    ...
    class OutlookTaskGroupItemRequestBuilder
        ...
        def task_folders()
            return MicrosoftGraphBeta::Me::Outlook::TaskGroups::Item::TaskFolders::TaskFoldersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param outlookTaskGroupId key: id of outlookTaskGroup
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, outlook_task_group_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/me/outlook/taskGroups/{outlookTaskGroup%2Did}{?%24select}"
        ...
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a Fiber of outlook_task_group
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::OutlookTaskGroup.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
