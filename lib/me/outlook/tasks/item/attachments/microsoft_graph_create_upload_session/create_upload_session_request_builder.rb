...
module MicrosoftGraphBeta::Me::Outlook::Tasks::Item::Attachments::MicrosoftGraphCreateUploadSession
    ## 
    ...
    class CreateUploadSessionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/tasks/{outlookTask%2Did}/attachments/microsoft.graph.createUploadSession"
