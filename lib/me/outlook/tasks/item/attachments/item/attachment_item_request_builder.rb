...
module MicrosoftGraphBeta::Me::Outlook::Tasks::Item::Attachments::Item
    ## 
    ...
    class AttachmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/tasks/{outlookTask%2Did}/attachments/{attachment%2Did}{?%24select,%24expand}"
