...
module MicrosoftGraphBeta::Me::Outlook::Tasks::Item
    ## 
    ...
    class OutlookTaskItemRequestBuilder
        ...
        def attachments()
            return MicrosoftGraphBeta::Me::Outlook::Tasks::Item::Attachments::AttachmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the complete method.
        def microsoft_graph_complete()
            return MicrosoftGraphBeta::Me::Outlook::Tasks::Item::MicrosoftGraphComplete::MicrosoftGraphCompleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.outlookTask entity.
        def multi_value_extended_properties()
            return MicrosoftGraphBeta::Me::Outlook::Tasks::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraphBeta::Me::Outlook::Tasks::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def attachments_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Outlook::Tasks::Item::Attachments::Item::AttachmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/tasks/{outlookTask%2Did}{?%24select}"
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::Outlook::Tasks::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
