...
module MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item::Tasks::Item
    ## 
    ...
    class OutlookTaskItemRequestBuilder
        ...
        def microsoft_graph_complete()
            return MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item::Tasks::Item::MicrosoftGraphComplete::CompleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
