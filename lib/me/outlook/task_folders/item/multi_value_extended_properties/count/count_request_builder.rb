...
module MicrosoftGraphBeta::Me::Outlook::TaskFolders::Item::MultiValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder%2Did}/multiValueExtendedProperties/$count{?%24search,%24filter}"
