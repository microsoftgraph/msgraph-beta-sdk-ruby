        ...
        module Outlook
            ...
            class OutlookRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def supported_languages()
                    return MicrosoftGraphBeta::Me::Outlook::SupportedLanguages::SupportedLanguagesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the supportedTimeZones method.
                def supported_time_zones()
                    return MicrosoftGraphBeta::Me::Outlook::SupportedTimeZones::SupportedTimeZonesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
