...
module MicrosoftGraphBeta::Me::Outlook
    ...
    class OutlookRequestBuilder
        ...
        def microsoft_graph_supported_languages()
            return MicrosoftGraphBeta::Me::Outlook::MicrosoftGraphSupportedLanguages::SupportedLanguagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the supportedTimeZones method.
        def microsoft_graph_supported_time_zones()
            return MicrosoftGraphBeta::Me::Outlook::MicrosoftGraphSupportedTimeZones::SupportedTimeZonesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
