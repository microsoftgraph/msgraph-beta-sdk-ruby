...
module MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::Item::Assignments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}/assignments/$count{?%24search,%24filter}"
