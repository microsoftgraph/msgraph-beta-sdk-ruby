...
module MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::Item
    ## 
    ...
    class DeviceEnrollmentConfigurationItemRequestBuilder
        ...
        def assignments()
            return MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assign method.
        def microsoft_graph_assign()
            return MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::Item::MicrosoftGraphAssign::MicrosoftGraphAssignRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setPriority method.
        def microsoft_graph_set_priority()
            return MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::Item::MicrosoftGraphSetPriority::MicrosoftGraphSetPriorityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::Me::DeviceEnrollmentConfigurations::Item::Assignments::Item::EnrollmentConfigurationAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}{?%24select,%24expand}"
