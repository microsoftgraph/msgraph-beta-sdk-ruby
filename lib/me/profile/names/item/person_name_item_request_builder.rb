...
module MicrosoftGraphBeta::Me::Profile::Names::Item
    ## 
    ...
    class PersonNameItemRequestBuilder
        ...
        ## @param personNameId key: id of personName
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, person_name_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/me/profile/names/{personName%2Did}{?%24select,%24expand}"
