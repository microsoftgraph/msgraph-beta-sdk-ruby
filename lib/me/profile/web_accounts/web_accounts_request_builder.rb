...
require_relative './item/web_account_item_request_builder'
    ...
    module Me
        module Profile
            module WebAccounts
                ...
                class WebAccountsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to count the resources in the collection.
                    def count()
                        return MicrosoftGraphBeta::Me::Profile::WebAccounts::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the webAccounts property of the microsoft.graph.profile entity.
                    ## @param web_account_id Unique identifier of the item
                    ## @return a web_account_item_request_builder
                    ## 
                    def by_web_account_id(web_account_id)
                        raise StandardError, 'web_account_id cannot be null' if web_account_id.nil?
