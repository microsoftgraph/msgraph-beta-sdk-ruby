...
module MicrosoftGraphBeta::Me::Profile::WebAccounts::Item
    ## 
    ...
    class WebAccountItemRequestBuilder
        ...
        ## @param webAccountId key: id of webAccount
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, web_account_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/me/profile/webAccounts/{webAccount%2Did}{?%24select,%24expand}"
