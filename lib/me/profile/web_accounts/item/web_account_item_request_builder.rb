        ...
        module Profile
            module WebAccounts
                module Item
                    ...
                    class WebAccountItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/profile/webAccounts/{webAccount%2Did}{?%24select,%24expand}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return WebAccountItemRequestBuilder.new(raw_url, @request_adapter)
                        end
