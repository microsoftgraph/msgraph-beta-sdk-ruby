        ...
        module Profile
            module Notes
                module Item
                    ...
                    class PersonAnnotationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/profile/notes/{personAnnotation%2Did}{?%24select,%24expand}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return PersonAnnotationItemRequestBuilder.new(raw_url, @request_adapter)
                        end
