        ...
        module Profile
            module Positions
                module Item
                    ...
                    class WorkPositionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/profile/positions/{workPosition%2Did}{?%24select,%24expand}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return WorkPositionItemRequestBuilder.new(raw_url, @request_adapter)
                        end
