...
module MicrosoftGraphBeta::Me::Events::Item::Instances::Item::ExceptionOccurrences
    ...
    class ExceptionOccurrencesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::Events::Item::Instances::Item::ExceptionOccurrences::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
