...
module MicrosoftGraphBeta::Me::Events::Item::Instances
    ## 
    ...
    class InstancesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Me::Events::Item::Instances::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Me::Events::Item::Instances::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
