...
module MicrosoftGraphBeta::Me::Events::Item::ExceptionOccurrences::Item::Attachments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments/$count{?%24filter}"
