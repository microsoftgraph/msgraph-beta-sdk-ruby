...
module MicrosoftGraphBeta::Me::Events::Item::ExceptionOccurrences::Item::MicrosoftGraphForward
    ## 
    ...
    class ForwardRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/microsoft.graph.forward"
