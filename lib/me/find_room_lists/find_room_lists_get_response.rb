...
module MicrosoftGraphBeta
    module Me
        module FindRoomLists
            class FindRoomListsGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                ...
                ## @return a find_room_lists_get_response
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return FindRoomListsGetResponse.new
                end
                ## 
