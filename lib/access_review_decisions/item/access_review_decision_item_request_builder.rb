...
module MicrosoftGraphBeta::AccessReviewDecisions::Item
    ...
    class AccessReviewDecisionItemRequestBuilder
        ...
        ## @param accessReviewDecisionId key: id of accessReviewDecision
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, access_review_decision_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/accessReviewDecisions/{accessReviewDecision%2Did}{?%24select,%24expand}"
