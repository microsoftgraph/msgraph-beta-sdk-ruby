...
module MicrosoftGraphBeta::PrivilegedAccess::Item::RoleDefinitions::Item::Resource
    ## 
    ...
    class ResourceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleDefinitions/{governanceRoleDefinition%2Did}/resource{?%24select,%24expand}"
