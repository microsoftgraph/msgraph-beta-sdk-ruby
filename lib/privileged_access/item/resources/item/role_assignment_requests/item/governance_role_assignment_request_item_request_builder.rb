...
require_relative './microsoft_graph_update_request/update_request_request_builder'
...
module MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item
    ## 
    ...
    class GovernanceRoleAssignmentRequestItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item::MicrosoftGraphCancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRequest method.
        def microsoft_graph_update_request()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item::MicrosoftGraphUpdateRequest::UpdateRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resource()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item::Resource::ResourceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleDefinition property of the microsoft.graph.governanceRoleAssignmentRequest entity.
        def role_definition()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the subject property of the microsoft.graph.governanceRoleAssignmentRequest entity.
        def subject()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item::Subject::SubjectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param governanceRoleAssignmentRequestId key: id of governanceRoleAssignmentRequest
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, governance_role_assignment_request_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24select,%24expand}"
