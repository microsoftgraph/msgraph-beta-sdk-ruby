...
require_relative './microsoft_graph_update_request/microsoft_graph_update_request_request_builder'
...
module MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item
    ...
    class GovernanceRoleAssignmentRequestItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRequest method.
        def microsoft_graph_update_request()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item::MicrosoftGraphUpdateRequest::MicrosoftGraphUpdateRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
