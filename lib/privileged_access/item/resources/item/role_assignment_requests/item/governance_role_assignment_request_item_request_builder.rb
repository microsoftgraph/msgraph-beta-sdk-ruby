                    ...
                    module RoleAssignmentRequests
                        module Item
                            ...
                            class GovernanceRoleAssignmentRequestItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def cancel()
                                    return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def update_request()
                                    return MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleAssignmentRequests::Item::UpdateRequest::UpdateRequestRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}'
