...
module MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::RoleDefinitions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleDefinitions/$count{?%24search,%24filter}"
