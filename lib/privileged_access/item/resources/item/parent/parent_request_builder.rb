...
module MicrosoftGraphBeta::PrivilegedAccess::Item::Resources::Item::Parent
    ## 
    ...
    class ParentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/parent{?%24select,%24expand}"
