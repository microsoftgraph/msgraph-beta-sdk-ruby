...
module MicrosoftGraphBeta::PrivilegedAccess::Item::RoleSettings::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleSettings/$count{?%24search,%24filter}"
