...
module MicrosoftGraphBeta::PrivilegedAccess::Item::RoleSettings::Item
    ## 
    ...
    class GovernanceRoleSettingItemRequestBuilder
        ...
        ## @param governanceRoleSettingId key: id of governanceRoleSetting
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, governance_role_setting_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleSettings/{governanceRoleSetting%2Did}{?%24select,%24expand}"
