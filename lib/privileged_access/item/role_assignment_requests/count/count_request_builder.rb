...
module MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignmentRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignmentRequests/$count{?%24search,%24filter}"
