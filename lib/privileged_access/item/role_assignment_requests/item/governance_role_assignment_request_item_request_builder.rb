...
module MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignmentRequests::Item
    ## 
    ...
    class GovernanceRoleAssignmentRequestItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignmentRequests::Item::MicrosoftGraphCancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRequest method.
        def microsoft_graph_update_request()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignmentRequests::Item::MicrosoftGraphUpdateRequest::UpdateRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resource()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignmentRequests::Item::Resource::ResourceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleDefinition property of the microsoft.graph.governanceRoleAssignmentRequest entity.
        def role_definition()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignmentRequests::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the subject property of the microsoft.graph.governanceRoleAssignmentRequest entity.
        def subject()
            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignmentRequests::Item::Subject::SubjectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, governance_role_assignment_request_id=nil)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24select,%24expand}"
