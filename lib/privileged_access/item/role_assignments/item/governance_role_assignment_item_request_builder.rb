                ...
                module Item
                    ...
                    class GovernanceRoleAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def linked_eligible_role_assignment()
                            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignments::Item::LinkedEligibleRoleAssignment::LinkedEligibleRoleAssignmentRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the resource property of the microsoft.graph.governanceRoleAssignment entity.
                        def resource()
                            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignments::Item::Resource::ResourceRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the roleDefinition property of the microsoft.graph.governanceRoleAssignment entity.
                        def role_definition()
                            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignments::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the subject property of the microsoft.graph.governanceRoleAssignment entity.
                        def subject()
                            return MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignments::Item::Subject::SubjectRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments/{governanceRoleAssignment%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments/{governanceRoleAssignment%2Did}'
