...
module MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignments::Item::Subject
    ## 
    ...
    class SubjectRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments/{governanceRoleAssignment%2Did}/subject{?%24select,%24expand}"
