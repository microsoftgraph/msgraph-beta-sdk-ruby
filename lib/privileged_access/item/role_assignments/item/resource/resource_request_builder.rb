...
module MicrosoftGraphBeta::PrivilegedAccess::Item::RoleAssignments::Item::Resource
    ## 
    ...
    class ResourceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments/{governanceRoleAssignment%2Did}/resource{?%24select,%24expand}"
