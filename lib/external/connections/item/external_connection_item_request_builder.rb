...
module MicrosoftGraphBeta::External::Connections::Item
    ## 
    ...
    class ExternalConnectionItemRequestBuilder
        ...
        def groups()
            return MicrosoftGraphBeta::External::Connections::Item::Groups::GroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the items property of the microsoft.graph.externalConnectors.externalConnection entity.
        def items()
            return MicrosoftGraphBeta::External::Connections::Item::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.externalConnectors.externalConnection entity.
        def operations()
            return MicrosoftGraphBeta::External::Connections::Item::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def quota()
            return MicrosoftGraphBeta::External::Connections::Item::Quota::QuotaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def schema()
            return MicrosoftGraphBeta::External::Connections::Item::Schema::SchemaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def groups_by_id(id)
            ...
            return MicrosoftGraphBeta::External::Connections::Item::Groups::Item::ExternalGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the items property of the microsoft.graph.externalConnectors.externalConnection entity.
        ## @param id Unique identifier of the item
        ...
        def items_by_id(id)
            ...
            return MicrosoftGraphBeta::External::Connections::Item::Items::Item::ExternalItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.externalConnectors.externalConnection entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::External::Connections::Item::Operations::Item::ConnectionOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
