...
module MicrosoftGraphBeta
    module External
        ...
        class ExternalRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def connections()
                return MicrosoftGraphBeta::External::Connections::ConnectionsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the industryData property of the microsoft.graph.externalConnectors.external entity.
            def industry_data()
                return MicrosoftGraphBeta::External::IndustryData::IndustryDataRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ## Provides operations to manage the connections property of the microsoft.graph.externalConnectors.external entity.
            ...
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ExternalConnectors::External.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
            ## Update external
