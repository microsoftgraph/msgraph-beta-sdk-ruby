...
require_relative './outbound_provisioning_flow_sets/outbound_provisioning_flow_sets_request_builder'
        ...
        module IndustryData
            ...
            class IndustryDataRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def outbound_provisioning_flow_sets()
                    return MicrosoftGraphBeta::External::IndustryData::OutboundProvisioningFlowSets::OutboundProvisioningFlowSetsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
