...
require_relative './microsoft_graph_industry_data_start'

module MicrosoftGraphBeta
    module External
        module IndustryData
            module Runs
                module MicrosoftGraphIndustryDataStart
                    ## 
                    # Provides operations to call the start method.
                    class MicrosoftGraphIndustryDataStartRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/external/industryData/runs/microsoft.graph.industryData.start")
                        end
                        ## 
                        ...
                        ## @return a microsoft_graph_industry_data_start_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return MicrosoftGraphIndustryDataStartRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
