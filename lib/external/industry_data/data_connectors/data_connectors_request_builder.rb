...
require_relative '../../../models/industry_data/industry_data_connector_collection_response'
        ...
        module IndustryData
            module DataConnectors
                ...
                class DataConnectorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## 
                    ## Provides operations to manage the dataConnectors property of the microsoft.graph.industryData.industryDataRoot entity.
                    ## @param industry_data_connector_id Unique identifier of the item
                    ...
                    ## @return a Fiber of industry_data_connector_collection_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IndustryData::IndustryDataConnectorCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
