        ...
        module IndustryData
            module Years
                module Item
                    ...
                    class YearTimePeriodDefinitionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/external/industryData/years/{yearTimePeriodDefinition%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/external/industryData/years/{yearTimePeriodDefinition%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return YearTimePeriodDefinitionItemRequestBuilder.new(raw_url, @request_adapter)
                        end
