...
require_relative './data_connector'
            ...
            module InboundFlows
                module Item
                    module DataConnector
                        ...
                        class DataConnectorRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/external/industryData/inboundFlows/{inboundFlow%2Did}/dataConnector{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            ## @return a data_connector_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return DataConnectorRequestBuilder.new(raw_url, @request_adapter)
                            end
