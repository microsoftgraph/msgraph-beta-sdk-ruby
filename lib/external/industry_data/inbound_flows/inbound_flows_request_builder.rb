...
require_relative '../../../models/industry_data/inbound_flow_collection_response'
        ...
        module IndustryData
            module InboundFlows
                ...
                class InboundFlowsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## 
                    ## Provides operations to manage the inboundFlows property of the microsoft.graph.industryData.industryDataRoot entity.
                    ## @param inbound_flow_id Unique identifier of the item
                    ...
                    ## @return a Fiber of inbound_flow_collection_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::IndustryData::InboundFlowCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
