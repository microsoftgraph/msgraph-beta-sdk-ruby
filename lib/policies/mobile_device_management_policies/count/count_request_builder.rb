...
module MicrosoftGraphBeta::Policies::MobileDeviceManagementPolicies::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/mobileDeviceManagementPolicies/$count{?%24search,%24filter}"
