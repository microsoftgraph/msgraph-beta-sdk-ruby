...
module MicrosoftGraphBeta::Policies::MobileDeviceManagementPolicies::Item::IncludedGroups::Item
    ## 
    ...
    class GroupItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, group_id=nil)
            ...
            @url_template = "{+baseurl}/policies/mobileDeviceManagementPolicies/{mobilityManagementPolicy%2Did}/includedGroups/{group%2Did}"
