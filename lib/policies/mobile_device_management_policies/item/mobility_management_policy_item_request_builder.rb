...
module MicrosoftGraphBeta::Policies::MobileDeviceManagementPolicies::Item
    ## 
    ...
    class MobilityManagementPolicyItemRequestBuilder
        ...
        def included_groups()
            return MicrosoftGraphBeta::Policies::MobileDeviceManagementPolicies::Item::IncludedGroups::IncludedGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/mobileDeviceManagementPolicies/{mobilityManagementPolicy%2Did}{?%24select,%24expand}"
        ...
        def included_groups_by_id(id)
            ...
            return MicrosoftGraphBeta::Policies::MobileDeviceManagementPolicies::Item::IncludedGroups::Item::GroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
