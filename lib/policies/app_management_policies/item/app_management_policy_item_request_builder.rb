...
module MicrosoftGraphBeta::Policies::AppManagementPolicies::Item
    ## 
    ...
    class AppManagementPolicyItemRequestBuilder
        ...
        def applies_to()
            return MicrosoftGraphBeta::Policies::AppManagementPolicies::Item::AppliesTo::AppliesToRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def applies_to_by_id(id)
            ...
            return MicrosoftGraphBeta::Policies::AppManagementPolicies::Item::AppliesTo::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Instantiates a new AppManagementPolicyItemRequestBuilder and sets the default values.
        ## @param appManagementPolicyId key: id of appManagementPolicy
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, app_management_policy_id=nil)
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AppManagementPolicy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
