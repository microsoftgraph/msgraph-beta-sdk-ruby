...
module MicrosoftGraphBeta::Policies::AppManagementPolicies::Item::AppliesTo::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/appManagementPolicies/{appManagementPolicy%2Did}/appliesTo/$count"
