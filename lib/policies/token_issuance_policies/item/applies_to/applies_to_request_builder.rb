            ...
            module Item
                module AppliesTo
                    ...
                    class AppliesToRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Policies::TokenIssuancePolicies::Item::AppliesTo::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the appliesTo property of the microsoft.graph.stsPolicy entity.
                        ...
                        def by_directory_object_id(directory_object_id)
                            ...
                            return MicrosoftGraphBeta::Policies::TokenIssuancePolicies::Item::AppliesTo::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
