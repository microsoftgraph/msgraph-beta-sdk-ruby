...
module MicrosoftGraphBeta::Policies::PermissionGrantPolicies::Item::Excludes
    ## 
    ...
    class ExcludesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Policies::PermissionGrantPolicies::Item::Excludes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
