...
module MicrosoftGraphBeta::Policies::RoleManagementPolicyAssignments::Item
    ## 
    ...
    class UnifiedRoleManagementPolicyAssignmentItemRequestBuilder
        ...
        def policy()
            return MicrosoftGraphBeta::Policies::RoleManagementPolicyAssignments::Item::Policy::PolicyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
