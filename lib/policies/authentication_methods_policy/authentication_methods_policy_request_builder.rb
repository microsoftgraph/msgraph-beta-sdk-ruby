        ...
        module AuthenticationMethodsPolicy
            ...
            class AuthenticationMethodsPolicyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def authentication_method_configurations()
                    return MicrosoftGraphBeta::Policies::AuthenticationMethodsPolicy::AuthenticationMethodConfigurations::AuthenticationMethodConfigurationsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the authenticationMethodConfigurations property of the microsoft.graph.authenticationMethodsPolicy entity.
