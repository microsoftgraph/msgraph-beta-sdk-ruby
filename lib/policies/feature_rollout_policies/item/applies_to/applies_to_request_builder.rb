...
module MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo
    ...
    class AppliesToRequestBuilder
        ...
        def microsoft_graph_get_by_ids()
            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::MicrosoftGraphGetByIds::GetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getUserOwnedObjects method.
        def microsoft_graph_get_user_owned_objects()
            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::MicrosoftGraphGetUserOwnedObjects::GetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validateProperties method.
        def microsoft_graph_validate_properties()
            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::MicrosoftGraphValidateProperties::ValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
