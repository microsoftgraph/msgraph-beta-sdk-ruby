            ...
            module Item
                module AppliesTo
                    ...
                    class AppliesToRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the delta method.
                        def delta()
                            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getByIds method.
                        def get_by_ids()
                            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::GetByIds::GetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getUserOwnedObjects method.
                        def get_user_owned_objects()
                            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::GetUserOwnedObjects::GetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the collection of policyRoot entities.
                        def ref()
                            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the validateProperties method.
                        def validate_properties()
                            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::ValidateProperties::ValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Gets an item from the MicrosoftGraphBeta.policies.featureRolloutPolicies.item.appliesTo.item collection
                        ...
                        def by_directory_object_id(directory_object_id)
                            ...
                            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
