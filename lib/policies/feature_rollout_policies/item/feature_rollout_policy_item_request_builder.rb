...
module MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item
    ## 
    ...
    class FeatureRolloutPolicyItemRequestBuilder
        ...
        def applies_to()
            return MicrosoftGraphBeta::Policies::FeatureRolloutPolicies::Item::AppliesTo::AppliesToRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
