            ...
            module Templates
                ...
                class TemplatesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def multi_tenant_organization_identity_synchronization()
                        return MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Templates::MultiTenantOrganizationIdentitySynchronization::MultiTenantOrganizationIdentitySynchronizationRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def multi_tenant_organization_partner_configuration()
                        return MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Templates::MultiTenantOrganizationPartnerConfiguration::MultiTenantOrganizationPartnerConfigurationRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/policies/crossTenantAccessPolicy/templates{?%24select,%24expand}")
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PolicyTemplate.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
