...
module MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Default
    ...
    class DefaultRequestBuilder
        ...
        def reset_to_system_default()
            return MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Default::ResetToSystemDefault::ResetToSystemDefaultRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
