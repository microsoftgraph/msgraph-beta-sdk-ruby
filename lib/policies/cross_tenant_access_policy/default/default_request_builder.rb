...
module MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Default
    ...
    class DefaultRequestBuilder
        ...
        def microsoft_graph_reset_to_system_default()
            return MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Default::MicrosoftGraphResetToSystemDefault::ResetToSystemDefaultRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
