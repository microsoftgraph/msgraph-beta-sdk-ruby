...
module MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Default
    ## 
    ...
    class DefaultRequestBuilder
        ...
        def microsoft_graph_reset_to_system_default()
            return MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Default::MicrosoftGraphResetToSystemDefault::MicrosoftGraphResetToSystemDefaultRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::CrossTenantAccessPolicyConfigurationDefault.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
