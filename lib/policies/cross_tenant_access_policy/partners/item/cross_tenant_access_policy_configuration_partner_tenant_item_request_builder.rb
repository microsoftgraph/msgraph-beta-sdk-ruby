...
module MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Partners::Item
    ## 
    ...
    class CrossTenantAccessPolicyConfigurationPartnerTenantItemRequestBuilder
        ...
        def identity_synchronization()
            return MicrosoftGraphBeta::Policies::CrossTenantAccessPolicy::Partners::Item::IdentitySynchronization::IdentitySynchronizationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
