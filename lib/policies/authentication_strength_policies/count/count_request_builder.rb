...
module MicrosoftGraphBeta::Policies::AuthenticationStrengthPolicies::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/authenticationStrengthPolicies/$count{?%24search,%24filter}"
