...
module MicrosoftGraphBeta::Policies::AuthenticationStrengthPolicies::Item::MicrosoftGraphUsage
    ## 
    ...
    class UsageRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/microsoft.graph.usage()"
