            ...
            module FindByMethodModeWithAuthenticationMethodModes
                ...
                class FindByMethodModeWithAuthenticationMethodModesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter, authentication_method_modes=nil)
                        super(path_parameters, request_adapter, "{+baseurl}/policies/authenticationStrengthPolicies/findByMethodMode(authenticationMethodModes={authenticationMethodModes}){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Policies::AuthenticationStrengthPolicies::FindByMethodModeWithAuthenticationMethodModes::FindByMethodModeWithAuthenticationMethodModesGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Get a list of the authenticationStrengthPolicy objects and their properties filtered to only include policies that include the authentication method mode specified in the request.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
