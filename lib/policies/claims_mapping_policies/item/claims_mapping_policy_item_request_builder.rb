        ...
        module ClaimsMappingPolicies
            module Item
                ...
                class ClaimsMappingPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def applies_to()
                        return MicrosoftGraphBeta::Policies::ClaimsMappingPolicies::Item::AppliesTo::AppliesToRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::ClaimsMappingPolicy.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
