...
module MicrosoftGraphBeta::Planner::Plans::Item::Buckets::Item
    ## 
    ...
    class PlannerBucketItemRequestBuilder
        ...
        def tasks()
            return MicrosoftGraphBeta::Planner::Plans::Item::Buckets::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
