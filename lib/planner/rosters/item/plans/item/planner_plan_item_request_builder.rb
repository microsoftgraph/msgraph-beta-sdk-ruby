...
module MicrosoftGraphBeta::Planner::Rosters::Item::Plans::Item
    ## 
    ...
    class PlannerPlanItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/planner/rosters/{plannerRoster%2Did}/plans/{plannerPlan%2Did}{?%24select,%24expand}"
