...
require_relative '../../../models/planner_roster'
require_relative '../../planner'
require_relative '../rosters'
require_relative './item'
require_relative './members/item/planner_roster_member_item_request_builder'
...
module MicrosoftGraphBeta::Planner::Rosters::Item
    ## 
    ...
    class PlannerRosterItemRequestBuilder
        ...
        def members()
            return MicrosoftGraphBeta::Planner::Rosters::Item::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def plans()
            return MicrosoftGraphBeta::Planner::Rosters::Item::Plans::PlansRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param plannerRosterId key: id of plannerRoster
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, planner_roster_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/planner/rosters/{plannerRoster%2Did}{?%24select,%24expand}"
        ...
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a Fiber of planner_roster
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PlannerRoster.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Provides operations to manage the members property of the microsoft.graph.plannerRoster entity.
        ...
        def plans_by_id(id)
            ...
            return MicrosoftGraphBeta::Planner::Rosters::Item::Plans::Item::PlannerPlanItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property rosters for planner
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
