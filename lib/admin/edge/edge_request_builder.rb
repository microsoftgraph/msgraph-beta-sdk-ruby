...
module MicrosoftGraphBeta::Admin::Edge
    ## 
    ...
    class EdgeRequestBuilder
        ...
        def internet_explorer_mode()
            return MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode::InternetExplorerModeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/edge{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Edge.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
