...
module MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode::SiteLists::Item
    ## 
    ...
    class BrowserSiteListItemRequestBuilder
        ...
        def microsoft_graph_publish()
            return MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode::SiteLists::Item::MicrosoftGraphPublish::PublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param browserSiteListId key: id of browserSiteList
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, browser_site_list_id=nil)
