...
module MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode::SiteLists::Item
    ...
    class BrowserSiteListItemRequestBuilder
        ...
        def microsoft_graph_publish()
            return MicrosoftGraphBeta::Admin::Edge::InternetExplorerMode::SiteLists::Item::MicrosoftGraphPublish::MicrosoftGraphPublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
