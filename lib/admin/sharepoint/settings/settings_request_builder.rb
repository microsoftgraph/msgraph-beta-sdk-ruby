...
require_relative '../../../models/tenant_admin/settings'
require_relative '../../admin'
require_relative '../sharepoint'
require_relative './settings'

module MicrosoftGraphBeta::Admin::Sharepoint::Settings
    ## 
    ...
    class SettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/sharepoint/settings{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TenantAdmin::Settings.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
