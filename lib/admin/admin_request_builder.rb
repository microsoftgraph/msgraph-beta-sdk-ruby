...
require_relative './entra/entra_request_builder'
...
module MicrosoftGraphBeta
    module Admin
        ...
        class AdminRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def entra()
                return MicrosoftGraphBeta::Admin::Entra::EntraRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the exchange property of the microsoft.graph.admin entity.
            def exchange()
                return MicrosoftGraphBeta::Admin::Exchange::ExchangeRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def microsoft365_apps()
                return MicrosoftGraphBeta::Admin::Microsoft365Apps::Microsoft365AppsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
