                ...
                module UpdatableAssets
                    ...
                    class UpdatableAssetsRequestBuilder
                        ...
                        def windows_updates_enroll_assets()
                            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::WindowsUpdatesEnrollAssets::WindowsUpdatesEnrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the enrollAssetsById method.
                        def windows_updates_enroll_assets_by_id()
                            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::WindowsUpdatesEnrollAssetsById::WindowsUpdatesEnrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the unenrollAssets method.
                        def windows_updates_unenroll_assets()
                            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::WindowsUpdatesUnenrollAssets::WindowsUpdatesUnenrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the unenrollAssetsById method.
                        def windows_updates_unenroll_assets_by_id()
                            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::WindowsUpdatesUnenrollAssetsById::WindowsUpdatesUnenrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
