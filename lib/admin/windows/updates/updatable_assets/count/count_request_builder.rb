...
module MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/windows/updates/updatableAssets/$count{?%24search,%24filter}"
