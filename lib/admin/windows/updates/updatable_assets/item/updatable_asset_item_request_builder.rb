...
module MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::Item
    ...
    class UpdatableAssetItemRequestBuilder
        ...
        def add_members()
            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::Item::AddMembers::AddMembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addMembersById method.
        def add_members_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::Item::AddMembersById::AddMembersByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def remove_members()
            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::Item::RemoveMembers::RemoveMembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeMembersById method.
        def remove_members_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::Item::RemoveMembersById::RemoveMembersByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
