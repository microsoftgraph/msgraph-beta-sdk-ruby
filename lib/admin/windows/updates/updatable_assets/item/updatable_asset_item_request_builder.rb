                    ...
                    module Item
                        ...
                        class UpdatableAssetItemRequestBuilder
                            ...
                            def windows_updates_add_members()
                                return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::Item::WindowsUpdatesAddMembers::WindowsUpdatesAddMembersRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the addMembersById method.
                            def windows_updates_add_members_by_id()
                                return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::Item::WindowsUpdatesAddMembersById::WindowsUpdatesAddMembersByIdRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the removeMembers method.
                            def windows_updates_remove_members()
                                return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::Item::WindowsUpdatesRemoveMembers::WindowsUpdatesRemoveMembersRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the removeMembersById method.
                            def windows_updates_remove_members_by_id()
                                return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatableAssets::Item::WindowsUpdatesRemoveMembersById::WindowsUpdatesRemoveMembersByIdRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
