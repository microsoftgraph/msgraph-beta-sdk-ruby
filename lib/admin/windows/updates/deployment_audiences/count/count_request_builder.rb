...
module MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/windows/updates/deploymentAudiences/$count{?%24search,%24filter}"
