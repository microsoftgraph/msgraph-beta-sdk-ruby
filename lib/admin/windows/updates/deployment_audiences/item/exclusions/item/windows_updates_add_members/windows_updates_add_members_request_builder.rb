...
require_relative '../item'
require_relative './windows_updates_add_members'
            ...
            module Updates
                module DeploymentAudiences
                    module Item
                        module Exclusions
                            module Item
                                module WindowsUpdatesAddMembers
                                    ## 
                                    # Provides operations to call the addMembers method.
                                    class WindowsUpdatesAddMembersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/exclusions/{updatableAsset%2Did}/windowsUpdates.addMembers")
                                        end
                                        ## 
