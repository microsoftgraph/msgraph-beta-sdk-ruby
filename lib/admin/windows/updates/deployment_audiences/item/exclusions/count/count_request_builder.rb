...
module MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::Exclusions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/exclusions/$count{?%24search,%24filter}"
