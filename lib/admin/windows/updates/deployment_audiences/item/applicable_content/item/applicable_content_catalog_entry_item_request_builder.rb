                        ...
                        module ApplicableContent
                            module Item
                                ...
                                class ApplicableContentCatalogEntryItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def catalog_entry()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::ApplicableContent::Item::CatalogEntry::CatalogEntryRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the matchedDevices property of the microsoft.graph.windowsUpdates.applicableContent entity.
                                    def matched_devices()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::ApplicableContent::Item::MatchedDevices::MatchedDevicesRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/applicableContent/{applicableContent%2DcatalogEntryId}{?%24expand,%24select}")
                                    end
                                    ## 
                                    ...
                                    def to_delete_request_information(request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/applicableContent/{applicableContent%2DcatalogEntryId}'
