                    ...
                    module Item
                        ...
                        class DeploymentAudienceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def applicable_content()
                                return MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::ApplicableContent::ApplicableContentRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return DeploymentAudienceItemRequestBuilder.new(raw_url, @request_adapter)
                            end
