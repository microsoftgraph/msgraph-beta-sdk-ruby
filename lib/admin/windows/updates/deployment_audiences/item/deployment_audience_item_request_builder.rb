...
require_relative './microsoft_graph_windows_updates_update_audience/update_audience_request_builder'
require_relative './microsoft_graph_windows_updates_update_audience_by_id/update_audience_by_id_request_builder'

module MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item
    ## 
    ...
    class DeploymentAudienceItemRequestBuilder
        ...
        def microsoft_graph_windows_updates_update_audience()
            return MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::MicrosoftGraphWindowsUpdatesUpdateAudience::UpdateAudienceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateAudienceById method.
        def microsoft_graph_windows_updates_update_audience_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::MicrosoftGraphWindowsUpdatesUpdateAudienceById::UpdateAudienceByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param deploymentAudienceId key: id of deploymentAudience
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, deployment_audience_id=nil)
