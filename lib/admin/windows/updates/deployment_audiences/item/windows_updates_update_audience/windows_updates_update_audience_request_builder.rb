...
require_relative './windows_updates_update_audience'
        ...
        module Windows
            module Updates
                module DeploymentAudiences
                    module Item
                        module WindowsUpdatesUpdateAudience
                            ## 
                            # Provides operations to call the updateAudience method.
                            class WindowsUpdatesUpdateAudienceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/windowsUpdates.updateAudience")
                                end
                                ## 
