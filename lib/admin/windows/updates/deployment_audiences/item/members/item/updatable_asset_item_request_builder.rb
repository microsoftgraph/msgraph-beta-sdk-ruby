...
module MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::Members::Item
    ## 
    ...
    class UpdatableAssetItemRequestBuilder
        ...
        def microsoft_graph_windows_updates_add_members()
            return MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::Members::Item::MicrosoftGraphWindowsUpdatesAddMembers::AddMembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addMembersById method.
        def microsoft_graph_windows_updates_add_members_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::Members::Item::MicrosoftGraphWindowsUpdatesAddMembersById::AddMembersByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeMembers method.
        def microsoft_graph_windows_updates_remove_members()
            return MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::Members::Item::MicrosoftGraphWindowsUpdatesRemoveMembers::RemoveMembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeMembersById method.
        def microsoft_graph_windows_updates_remove_members_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::DeploymentAudiences::Item::Members::Item::MicrosoftGraphWindowsUpdatesRemoveMembersById::RemoveMembersByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
