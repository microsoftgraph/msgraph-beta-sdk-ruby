...
require_relative './windows_updates_update_audience_by_id'
        ...
        module Windows
            module Updates
                module DeploymentAudiences
                    module Item
                        module WindowsUpdatesUpdateAudienceById
                            ## 
                            # Provides operations to call the updateAudienceById method.
                            class WindowsUpdatesUpdateAudienceByIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/windowsUpdates.updateAudienceById")
                                end
                                ## 
