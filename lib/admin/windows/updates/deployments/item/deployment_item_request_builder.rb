...
module MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item
    ## 
    ...
    class DeploymentItemRequestBuilder
        ...
        ## @param deploymentId key: id of deployment
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, deployment_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}{?%24select,%24expand}"
