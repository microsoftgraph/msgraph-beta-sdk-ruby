...
module MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience
    ...
    class AudienceRequestBuilder
        ...
        def microsoft_graph_windows_updates_update_audience()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::MicrosoftGraphWindowsUpdatesUpdateAudience::UpdateAudienceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateAudienceById method.
        def microsoft_graph_windows_updates_update_audience_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::MicrosoftGraphWindowsUpdatesUpdateAudienceById::UpdateAudienceByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
