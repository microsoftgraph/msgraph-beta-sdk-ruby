                        ...
                        module Audience
                            ...
                            class AudienceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def windows_updates_update_audience()
                                    return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::WindowsUpdatesUpdateAudience::WindowsUpdatesUpdateAudienceRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the updateAudienceById method.
                                def windows_updates_update_audience_by_id()
                                    return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::WindowsUpdatesUpdateAudienceById::WindowsUpdatesUpdateAudienceByIdRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience{?%24select,%24expand}")
                                end
                                ## 
