                        ...
                        module Audience
                            module Members
                                ...
                                class MembersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Members::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the enrollAssets method.
                                    def microsoft_graph_windows_updates_enroll_assets()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Members::MicrosoftGraphWindowsUpdatesEnrollAssets::MicrosoftGraphWindowsUpdatesEnrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the enrollAssetsById method.
                                    def microsoft_graph_windows_updates_enroll_assets_by_id()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Members::MicrosoftGraphWindowsUpdatesEnrollAssetsById::MicrosoftGraphWindowsUpdatesEnrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the unenrollAssets method.
                                    def microsoft_graph_windows_updates_unenroll_assets()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Members::MicrosoftGraphWindowsUpdatesUnenrollAssets::MicrosoftGraphWindowsUpdatesUnenrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the unenrollAssetsById method.
                                    def microsoft_graph_windows_updates_unenroll_assets_by_id()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Members::MicrosoftGraphWindowsUpdatesUnenrollAssetsById::MicrosoftGraphWindowsUpdatesUnenrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the members property of the microsoft.graph.windowsUpdates.deploymentAudience entity.
                                    ...
                                    def by_updatable_asset_id(updatable_asset_id)
                                        ...
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Members::Item::UpdatableAssetItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                    end
                                    ## 
                                    ...
                                    def to_post_request_information(body, request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members'
                                        request_info.path_parameters = @path_parameters
