...
module MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/exclusions/$count{?%24search,%24filter}"
