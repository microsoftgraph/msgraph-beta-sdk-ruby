...
module MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions
    ...
    class ExclusionsRequestBuilder
        ...
        def microsoft_graph_windows_updates_enroll_assets()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions::MicrosoftGraphWindowsUpdatesEnrollAssets::EnrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the enrollAssetsById method.
        def microsoft_graph_windows_updates_enroll_assets_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions::MicrosoftGraphWindowsUpdatesEnrollAssetsById::EnrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unenrollAssets method.
        def microsoft_graph_windows_updates_unenroll_assets()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions::MicrosoftGraphWindowsUpdatesUnenrollAssets::UnenrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unenrollAssetsById method.
        def microsoft_graph_windows_updates_unenroll_assets_by_id()
            return MicrosoftGraphBeta::Admin::Windows::Updates::Deployments::Item::Audience::Exclusions::MicrosoftGraphWindowsUpdatesUnenrollAssetsById::UnenrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
