                        ...
                        module Audience
                            ...
                            class AudienceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def applicable_content()
                                    return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::ApplicableContent::ApplicableContentRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def microsoft_graph_windows_updates_update_audience()
                                    return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::MicrosoftGraphWindowsUpdatesUpdateAudience::MicrosoftGraphWindowsUpdatesUpdateAudienceRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the updateAudienceById method.
                                def microsoft_graph_windows_updates_update_audience_by_id()
                                    return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::MicrosoftGraphWindowsUpdatesUpdateAudienceById::MicrosoftGraphWindowsUpdatesUpdateAudienceByIdRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience'
