                            ...
                            module Exclusions
                                module Item
                                    module MicrosoftGraphWindowsUpdatesRemoveMembersById
                                        ...
                                        class MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/exclusions/{updatableAsset%2Did}/microsoft.graph.windowsUpdates.removeMembersById")
                                            end
                                            ## 
                                            ...
                                            ## @return a microsoft_graph_windows_updates_remove_members_by_id_request_builder
                                            ## 
                                            def with_url(raw_url)
                                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                return MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilder.new(raw_url, @request_adapter)
                                            end
                                        end
                                    end
                                end
