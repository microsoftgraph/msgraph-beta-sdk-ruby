                            ...
                            module Exclusions
                                ...
                                class ExclusionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def windows_updates_enroll_assets()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::Exclusions::WindowsUpdatesEnrollAssets::WindowsUpdatesEnrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the enrollAssetsById method.
                                    def windows_updates_enroll_assets_by_id()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::Exclusions::WindowsUpdatesEnrollAssetsById::WindowsUpdatesEnrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the unenrollAssets method.
                                    def windows_updates_unenroll_assets()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::Exclusions::WindowsUpdatesUnenrollAssets::WindowsUpdatesUnenrollAssetsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the unenrollAssetsById method.
                                    def windows_updates_unenroll_assets_by_id()
                                        return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::Exclusions::WindowsUpdatesUnenrollAssetsById::WindowsUpdatesUnenrollAssetsByIdRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the exclusions property of the microsoft.graph.windowsUpdates.deploymentAudience entity.
