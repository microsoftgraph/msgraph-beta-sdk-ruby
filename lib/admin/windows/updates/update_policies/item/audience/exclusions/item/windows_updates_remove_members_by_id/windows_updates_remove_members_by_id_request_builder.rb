...
require_relative '../item'
require_relative './windows_updates_remove_members_by_id'
                ...
                module UpdatePolicies
                    module Item
                        module Audience
                            module Exclusions
                                module Item
                                    module WindowsUpdatesRemoveMembersById
                                        ## 
                                        # Provides operations to call the removeMembersById method.
                                        class WindowsUpdatesRemoveMembersByIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/exclusions/{updatableAsset%2Did}/windowsUpdates.removeMembersById")
                                            end
                                            ## 
