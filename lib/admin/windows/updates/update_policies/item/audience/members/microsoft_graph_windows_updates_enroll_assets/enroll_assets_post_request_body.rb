...
require_relative '../../../../../../../../models/windows_updates_update_category'
                        ...
                        module Audience
                            module Members
                                module MicrosoftGraphWindowsUpdatesEnrollAssets
                                    class EnrollAssetsPostRequestBody
                                        ...
                                        ## @return a enroll_assets_post_request_body
                                        ## 
                                        def self.create_from_discriminator_value(parse_node)
                                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                            return EnrollAssetsPostRequestBody.new
                                        end
                                        ## 
                                        ...
                                        def get_field_deserializers()
                                            return {
                                                "assets" => lambda {|n| @assets = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesUpdatableAsset.create_from_discriminator_value(pn) }) },
