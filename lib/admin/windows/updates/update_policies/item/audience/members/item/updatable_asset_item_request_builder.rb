                                ...
                                module Item
                                    ...
                                    class UpdatableAssetItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def microsoft_graph_windows_updates_add_members()
                                            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::Members::Item::MicrosoftGraphWindowsUpdatesAddMembers::MicrosoftGraphWindowsUpdatesAddMembersRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the addMembersById method.
                                        def microsoft_graph_windows_updates_add_members_by_id()
                                            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::Members::Item::MicrosoftGraphWindowsUpdatesAddMembersById::MicrosoftGraphWindowsUpdatesAddMembersByIdRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the removeMembers method.
                                        def microsoft_graph_windows_updates_remove_members()
                                            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::Members::Item::MicrosoftGraphWindowsUpdatesRemoveMembers::MicrosoftGraphWindowsUpdatesRemoveMembersRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the removeMembersById method.
                                        def microsoft_graph_windows_updates_remove_members_by_id()
                                            return MicrosoftGraphBeta::Admin::Windows::Updates::UpdatePolicies::Item::Audience::Members::Item::MicrosoftGraphWindowsUpdatesRemoveMembersById::MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/members/{updatableAsset%2Did}{?%24expand,%24select}")
                                        end
                                        ## 
                                        ...
                                        def to_delete_request_information(request_configuration=nil)
                                            ...
                                            request_info.url_template = '{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/members/{updatableAsset%2Did}'
