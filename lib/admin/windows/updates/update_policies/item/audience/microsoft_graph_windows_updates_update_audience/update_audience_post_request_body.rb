...
require_relative './microsoft_graph_windows_updates_update_audience'
        ...
        module Windows
            module Updates
                module UpdatePolicies
                    module Item
                        module Audience
                            module MicrosoftGraphWindowsUpdatesUpdateAudience
                                class UpdateAudiencePostRequestBody
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            "addExclusions" => lambda {|n| @add_exclusions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesUpdatableAsset.create_from_discriminator_value(pn) }) },
                                            "addMembers" => lambda {|n| @add_members = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesUpdatableAsset.create_from_discriminator_value(pn) }) },
                                            "removeExclusions" => lambda {|n| @remove_exclusions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesUpdatableAsset.create_from_discriminator_value(pn) }) },
                                            "removeMembers" => lambda {|n| @remove_members = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::WindowsUpdatesUpdatableAsset.create_from_discriminator_value(pn) }) },
                                        }
                                    end
                                    ## 
