...
require_relative './products/products_request_builder'
        ...
        module Windows
            module Updates
                ...
                class UpdatesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def products()
                        return MicrosoftGraphBeta::Admin::Windows::Updates::Products::ProductsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/admin/windows/updates{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/admin/windows/updates'
