...
require_relative './deployment_audiences/item/deployment_audience_item_request_builder'
...
require_relative './update_policies/item/update_policy_item_request_builder'
...
module MicrosoftGraphBeta::Admin::Windows::Updates
    ...
    class UpdatesRequestBuilder
        ...
        ## 
        def deployment_audiences_by_id(id)
