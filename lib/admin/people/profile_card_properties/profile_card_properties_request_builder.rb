        ...
        module People
            module ProfileCardProperties
                ...
                class ProfileCardPropertiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Admin::People::ProfileCardProperties::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the profileCardProperties property of the microsoft.graph.peopleAdminSettings entity.
                    ...
                    def by_profile_card_property_id(profile_card_property_id)
                        ...
                        return MicrosoftGraphBeta::Admin::People::ProfileCardProperties::Item::ProfileCardPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
