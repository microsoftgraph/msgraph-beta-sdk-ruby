...
module MicrosoftGraphBeta::Admin::ServiceAnnouncement::Issues::Item
    ...
    class ServiceHealthIssueItemRequestBuilder
        ...
        def microsoft_graph_incident_report()
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::Issues::Item::MicrosoftGraphIncidentReport::IncidentReportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
