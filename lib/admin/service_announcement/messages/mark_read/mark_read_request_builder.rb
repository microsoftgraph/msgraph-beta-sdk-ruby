                ...
                module MarkRead
                    ...
                    class MarkReadRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Admin::ServiceAnnouncement::Messages::MarkRead::MarkReadPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Mark a list of serviceUpdateMessages as read for the signed in user. This API is available in the following national cloud deployments.
                        ## @param body The request body
