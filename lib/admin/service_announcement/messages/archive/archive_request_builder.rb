                ...
                module Archive
                    ...
                    class ArchiveRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Admin::ServiceAnnouncement::Messages::Archive::ArchivePostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Archive a list of serviceUpdateMessages for the signed in user. This API is available in the following national cloud deployments.
                        ## @param body The request body
