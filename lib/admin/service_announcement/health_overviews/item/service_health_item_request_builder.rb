...
module MicrosoftGraphBeta::Admin::ServiceAnnouncement::HealthOverviews::Item
    ## 
    ...
    class ServiceHealthItemRequestBuilder
        ...
        def issues()
            return MicrosoftGraphBeta::Admin::ServiceAnnouncement::HealthOverviews::Item::Issues::IssuesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
