        ...
        module Item
            module Root
                ...
                class RootRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def content()
                        return MicrosoftGraphBeta::Shares::Item::Root::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the media for the sharedDriveItem entity.
                    def content_stream()
                        return MicrosoftGraphBeta::Shares::Item::Root::ContentStream::ContentStreamRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
