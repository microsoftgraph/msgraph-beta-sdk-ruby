        ...
        module Item
            module Items
                ...
                class ItemsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Shares::Item::Items::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the items property of the microsoft.graph.sharedDriveItem entity.
                    ...
                    def by_drive_item_id(drive_item_id)
                        ...
                        return MicrosoftGraphBeta::Shares::Item::Items::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
