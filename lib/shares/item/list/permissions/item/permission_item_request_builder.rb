                ...
                module Permissions
                    module Item
                        ...
                        class PermissionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def grant()
                                return MicrosoftGraphBeta::Shares::Item::List::Permissions::Item::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the revokeGrants method.
                            def revoke_grants()
                                return MicrosoftGraphBeta::Shares::Item::List::Permissions::Item::RevokeGrants::RevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/permissions/{permission%2Did}{?%24expand,%24select}")
                            end
                            ## 
