            ...
            module List
                module ContentTypes
                    ...
                    class ContentTypesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def add_copy()
                            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::AddCopy::AddCopyRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the addCopyFromContentTypeHub method.
                        def add_copy_from_content_type_hub()
                            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::AddCopyFromContentTypeHub::AddCopyFromContentTypeHubRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get_compatible_hub_content_types()
                            return MicrosoftGraphBeta::Shares::Item::List::ContentTypes::GetCompatibleHubContentTypes::GetCompatibleHubContentTypesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the contentTypes property of the microsoft.graph.list entity.
