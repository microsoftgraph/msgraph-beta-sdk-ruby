                    ...
                    module Item
                        module DriveItem
                            ...
                            class DriveItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def content()
                                    return MicrosoftGraphBeta::Shares::Item::List::Items::Item::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the media for the sharedDriveItem entity.
                                def content_stream()
                                    return MicrosoftGraphBeta::Shares::Item::List::Items::Item::DriveItem::ContentStream::ContentStreamRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
