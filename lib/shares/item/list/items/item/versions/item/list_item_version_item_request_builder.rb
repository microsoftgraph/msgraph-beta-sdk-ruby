...
module MicrosoftGraphBeta::Shares::Item::List::Items::Item::Versions::Item
    ## 
    ...
    class ListItemVersionItemRequestBuilder
        ...
        def fields()
            return MicrosoftGraphBeta::Shares::Item::List::Items::Item::Versions::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restoreVersion method.
        def microsoft_graph_restore_version()
            return MicrosoftGraphBeta::Shares::Item::List::Items::Item::Versions::Item::MicrosoftGraphRestoreVersion::MicrosoftGraphRestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
