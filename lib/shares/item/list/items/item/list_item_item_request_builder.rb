...
module MicrosoftGraphBeta::Shares::Item::List::Items::Item
    ## 
    ...
    class ListItemItemRequestBuilder
        ...
        def microsoft_graph_create_link()
            return MicrosoftGraphBeta::Shares::Item::List::Items::Item::MicrosoftGraphCreateLink::MicrosoftGraphCreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Shares::Item::List::Items::Item::Versions::Item::ListItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
