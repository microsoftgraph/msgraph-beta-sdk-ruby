...
module MicrosoftGraphBeta::Shares::Item::List::Items::Item::Activities::Item
    ## 
    ...
    class ItemActivityOLDItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, item_activity_o_l_d_id=nil)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}"
