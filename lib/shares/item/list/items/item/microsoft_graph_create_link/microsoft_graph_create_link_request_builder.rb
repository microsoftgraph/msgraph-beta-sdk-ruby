...
module MicrosoftGraphBeta::Shares::Item::List::Items::Item::MicrosoftGraphCreateLink
    ## 
    ...
    class MicrosoftGraphCreateLinkRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/microsoft.graph.createLink"
