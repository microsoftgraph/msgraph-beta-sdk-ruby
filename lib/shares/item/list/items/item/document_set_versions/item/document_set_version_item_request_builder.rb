                            ...
                            module Item
                                ...
                                class DocumentSetVersionItemRequestBuilder
                                    ...
                                    def microsoft_graph_restore()
                                        return MicrosoftGraphBeta::Shares::Item::List::Items::Item::DocumentSetVersions::Item::MicrosoftGraphRestore::MicrosoftGraphRestoreRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
