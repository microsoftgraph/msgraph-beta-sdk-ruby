                    ...
                    module Item
                        module DocumentSetVersions
                            ...
                            class DocumentSetVersionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::Shares::Item::List::Items::Item::DocumentSetVersions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the documentSetVersions property of the microsoft.graph.listItem entity.
                                ...
                                def by_document_set_version_id(document_set_version_id)
                                    ...
                                    return MicrosoftGraphBeta::Shares::Item::List::Items::Item::DocumentSetVersions::Item::DocumentSetVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
