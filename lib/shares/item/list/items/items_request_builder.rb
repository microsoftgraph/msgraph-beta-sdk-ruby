...
module MicrosoftGraphBeta::Shares::Item::List::Items
    ## 
    ...
    class ItemsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Shares::Item::List::Items::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Shares::Item::List::Items::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
