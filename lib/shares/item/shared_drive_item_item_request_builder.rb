    ...
    module Shares
        module Item
            ...
            class SharedDriveItemItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def created_by_user()
                    return MicrosoftGraphBeta::Shares::Item::CreatedByUser::CreatedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the driveItem property of the microsoft.graph.sharedDriveItem entity.
                def drive_item()
                    return MicrosoftGraphBeta::Shares::Item::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the items property of the microsoft.graph.sharedDriveItem entity.
                def items()
                    return MicrosoftGraphBeta::Shares::Item::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the lastModifiedByUser property of the microsoft.graph.baseItem entity.
                def last_modified_by_user()
                    return MicrosoftGraphBeta::Shares::Item::LastModifiedByUser::LastModifiedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the list property of the microsoft.graph.sharedDriveItem entity.
                def list()
                    return MicrosoftGraphBeta::Shares::Item::List::ListRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the listItem property of the microsoft.graph.sharedDriveItem entity.
                def list_item()
                    return MicrosoftGraphBeta::Shares::Item::ListItem::ListItemRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the permission property of the microsoft.graph.sharedDriveItem entity.
                def permission()
                    return MicrosoftGraphBeta::Shares::Item::Permission::PermissionRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the root property of the microsoft.graph.sharedDriveItem entity.
                def root()
                    return MicrosoftGraphBeta::Shares::Item::Root::RootRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the site property of the microsoft.graph.sharedDriveItem entity.
                def site()
                    return MicrosoftGraphBeta::Shares::Item::Site::SiteRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
