            ...
            module Permission
                ...
                class PermissionRequestBuilder
                    ...
                    def microsoft_graph_grant()
                        return MicrosoftGraphBeta::Shares::Item::Permission::MicrosoftGraphGrant::MicrosoftGraphGrantRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the revokeGrants method.
                    def microsoft_graph_revoke_grants()
                        return MicrosoftGraphBeta::Shares::Item::Permission::MicrosoftGraphRevokeGrants::MicrosoftGraphRevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
