...
module MicrosoftGraphBeta::Shares::Item::Permission
    ...
    class PermissionRequestBuilder
        ...
        def microsoft_graph_grant()
            return MicrosoftGraphBeta::Shares::Item::Permission::MicrosoftGraphGrant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the revokeGrants method.
        def microsoft_graph_revoke_grants()
            return MicrosoftGraphBeta::Shares::Item::Permission::MicrosoftGraphRevokeGrants::RevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
