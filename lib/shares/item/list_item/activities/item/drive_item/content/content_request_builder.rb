...
module MicrosoftGraphBeta::Shares::Item::ListItem::Activities::Item::DriveItem::Content
    ## 
    ...
    class ContentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}/driveItem/content"
