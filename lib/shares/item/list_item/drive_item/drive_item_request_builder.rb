...
module MicrosoftGraphBeta::Shares::Item::ListItem::DriveItem
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Shares::Item::ListItem::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
