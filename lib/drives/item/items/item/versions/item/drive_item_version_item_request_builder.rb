...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Versions::Item
    ## 
    ...
    class DriveItemVersionItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Versions::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restoreVersion method.
        def microsoft_graph_restore_version()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Versions::Item::MicrosoftGraphRestoreVersion::MicrosoftGraphRestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
