...
require_relative '../item'
require_relative './microsoft_graph_revoke_grants'

module MicrosoftGraphBeta::Drives::Item::Items::Item::Permissions::Item::MicrosoftGraphRevokeGrants
    ## 
    ...
    class RevokeGrantsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/permissions/{permission%2Did}/microsoft.graph.revokeGrants"
