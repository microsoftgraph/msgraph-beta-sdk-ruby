...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Permissions::Item
    ...
    class PermissionItemRequestBuilder
        ...
        def microsoft_graph_grant()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Permissions::Item::MicrosoftGraphGrant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the revokeGrants method.
        def microsoft_graph_revoke_grants()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Permissions::Item::MicrosoftGraphRevokeGrants::RevokeGrantsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
