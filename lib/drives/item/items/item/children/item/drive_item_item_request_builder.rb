                    ...
                    module Children
                        module Item
                            ...
                            class DriveItemItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def content()
                                    return MicrosoftGraphBeta::Drives::Item::Items::Item::Children::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the media for the drive entity.
                                def content_stream()
                                    return MicrosoftGraphBeta::Drives::Item::Items::Item::Children::Item::ContentStream::ContentStreamRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
