...
require_relative './activities/item/item_activity_o_l_d_item_request_builder'
...
require_relative './microsoft_graph_assign_sensitivity_label/microsoft_graph_assign_sensitivity_label_request_builder'
...
require_relative './microsoft_graph_extract_sensitivity_labels/microsoft_graph_extract_sensitivity_labels_request_builder'
...
module MicrosoftGraphBeta::Drives::Item::Items::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the analytics property of the microsoft.graph.driveItem entity.
        def analytics()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the children property of the microsoft.graph.driveItem entity.
        def children()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the drive entity.
        def content()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the listItem property of the microsoft.graph.driveItem entity.
        def list_item()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::ListItem::ListItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assignSensitivityLabel method.
        def microsoft_graph_assign_sensitivity_label()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphAssignSensitivityLabel::MicrosoftGraphAssignSensitivityLabelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkin method.
        def microsoft_graph_checkin()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphCheckin::MicrosoftGraphCheckinRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkout method.
        def microsoft_graph_checkout()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphCheckout::MicrosoftGraphCheckoutRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copy method.
        def microsoft_graph_copy()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphCopy::MicrosoftGraphCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createLink method.
        def microsoft_graph_create_link()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphCreateLink::MicrosoftGraphCreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createUploadSession method.
        def microsoft_graph_create_upload_session()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphCreateUploadSession::MicrosoftGraphCreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the extractSensitivityLabels method.
        def microsoft_graph_extract_sensitivity_labels()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphExtractSensitivityLabels::MicrosoftGraphExtractSensitivityLabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the follow method.
        def microsoft_graph_follow()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphFollow::MicrosoftGraphFollowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the invite method.
        def microsoft_graph_invite()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphInvite::MicrosoftGraphInviteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the preview method.
        def microsoft_graph_preview()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphPreview::MicrosoftGraphPreviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphRestore::MicrosoftGraphRestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unfollow method.
        def microsoft_graph_unfollow()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphUnfollow::MicrosoftGraphUnfollowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validatePermission method.
        def microsoft_graph_validate_permission()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphValidatePermission::MicrosoftGraphValidatePermissionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def permissions()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Permissions::PermissionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def subscriptions()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Subscriptions::SubscriptionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the thumbnails property of the microsoft.graph.driveItem entity.
        def thumbnails()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Thumbnails::ThumbnailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def versions()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the workbook property of the microsoft.graph.driveItem entity.
        def workbook()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::WorkbookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the activities property of the microsoft.graph.driveItem entity.
        ...
        def activities_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Activities::Item::ItemActivityOLDItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the children property of the microsoft.graph.driveItem entity.
        ## @param id Unique identifier of the item
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Children::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def permissions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Permissions::Item::PermissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the subscriptions property of the microsoft.graph.driveItem entity.
        ## @param id Unique identifier of the item
        ...
        def subscriptions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Subscriptions::Item::SubscriptionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the thumbnails property of the microsoft.graph.driveItem entity.
        ## @param id Unique identifier of the item
        ...
        def thumbnails_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Thumbnails::Item::ThumbnailSetItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property items for drives
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Versions::Item::DriveItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
