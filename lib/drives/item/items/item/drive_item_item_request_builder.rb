...
require_relative './microsoft_graph_assign_sensitivity_label/assign_sensitivity_label_request_builder'
...
require_relative './microsoft_graph_extract_sensitivity_labels/extract_sensitivity_labels_request_builder'
...
module MicrosoftGraphBeta::Drives::Item::Items::Item
    ...
    class DriveItemItemRequestBuilder
        ...
        def microsoft_graph_assign_sensitivity_label()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphAssignSensitivityLabel::AssignSensitivityLabelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkin method.
        def microsoft_graph_checkin()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphCheckin::CheckinRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkout method.
        def microsoft_graph_checkout()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphCheckout::CheckoutRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copy method.
        def microsoft_graph_copy()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphCopy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createLink method.
        def microsoft_graph_create_link()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphCreateLink::CreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createUploadSession method.
        def microsoft_graph_create_upload_session()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphCreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the extractSensitivityLabels method.
        def microsoft_graph_extract_sensitivity_labels()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphExtractSensitivityLabels::ExtractSensitivityLabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the follow method.
        def microsoft_graph_follow()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphFollow::FollowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the invite method.
        def microsoft_graph_invite()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphInvite::InviteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the preview method.
        def microsoft_graph_preview()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphPreview::PreviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphRestore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unfollow method.
        def microsoft_graph_unfollow()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphUnfollow::UnfollowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validatePermission method.
        def microsoft_graph_validate_permission()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphValidatePermission::ValidatePermissionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
