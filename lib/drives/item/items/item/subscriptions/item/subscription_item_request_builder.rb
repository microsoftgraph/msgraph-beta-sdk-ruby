...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Subscriptions::Item
    ...
    class SubscriptionItemRequestBuilder
        ...
        def microsoft_graph_reauthorize()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Subscriptions::Item::MicrosoftGraphReauthorize::ReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
