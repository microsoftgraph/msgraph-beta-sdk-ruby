...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Analytics::ItemActivityStats::Item::Activities::Item
    ## 
    ...
    class ItemActivityItemRequestBuilder
        ...
        def drive_item()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Analytics::ItemActivityStats::Item::Activities::Item::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
