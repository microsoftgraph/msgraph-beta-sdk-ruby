...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Analytics
    ## 
    ...
    class AnalyticsRequestBuilder
        ...
        def item_activity_stats_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Analytics::ItemActivityStats::Item::ItemActivityStatItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
