...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphOddLPrice
    class OddLPricePostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "lastInterest" => lambda {|n| @last_interest = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
