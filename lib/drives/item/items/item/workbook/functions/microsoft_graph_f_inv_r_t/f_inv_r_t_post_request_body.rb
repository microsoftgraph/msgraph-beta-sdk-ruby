...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphF_Inv_RT
    class F_Inv_RTPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "degFreedom1" => lambda {|n| @deg_freedom1 = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                "degFreedom2" => lambda {|n| @deg_freedom2 = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
