...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphCumIPmt
    class CumIPmtPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "endPeriod" => lambda {|n| @end_period = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                ...
                "startPeriod" => lambda {|n| @start_period = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
