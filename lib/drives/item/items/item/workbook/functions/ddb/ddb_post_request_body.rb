                                ...
                                class DdbPostRequestBody
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            ...
                                            "factor" => lambda {|n| @factor = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                            "life" => lambda {|n| @life = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
