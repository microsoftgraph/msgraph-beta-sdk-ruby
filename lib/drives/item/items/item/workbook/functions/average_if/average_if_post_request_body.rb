                            ...
                            module AverageIf
                                class AverageIfPostRequestBody
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            "averageRange" => lambda {|n| @average_range = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                            ...
                                            "range" => lambda {|n| @range = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                        }
                                    end
                                    ## 
