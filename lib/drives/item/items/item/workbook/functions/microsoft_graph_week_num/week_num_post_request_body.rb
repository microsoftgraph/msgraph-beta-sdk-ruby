...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphWeekNum
    class WeekNumPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "returnType" => lambda {|n| @return_type = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                "serialNumber" => lambda {|n| @serial_number = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
