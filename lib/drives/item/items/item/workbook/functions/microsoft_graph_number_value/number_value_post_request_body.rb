...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphNumberValue
    class NumberValuePostRequestBody
        ...
        def get_field_deserializers()
            return {
                "decimalSeparator" => lambda {|n| @decimal_separator = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                "groupSeparator" => lambda {|n| @group_separator = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
