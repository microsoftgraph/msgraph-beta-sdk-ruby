                            ...
                            module Convert
                                class ConvertPostRequestBody
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            "fromUnit" => lambda {|n| @from_unit = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                            "number" => lambda {|n| @number = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                            "toUnit" => lambda {|n| @to_unit = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                        }
                                    end
                                    ## 
