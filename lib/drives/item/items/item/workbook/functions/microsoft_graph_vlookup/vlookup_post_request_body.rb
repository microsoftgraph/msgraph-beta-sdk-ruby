...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphVlookup
    class VlookupPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "colIndexNum" => lambda {|n| @col_index_num = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
