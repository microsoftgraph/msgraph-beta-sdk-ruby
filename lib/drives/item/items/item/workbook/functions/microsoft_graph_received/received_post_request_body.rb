...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphReceived
    class ReceivedPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "investment" => lambda {|n| @investment = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
