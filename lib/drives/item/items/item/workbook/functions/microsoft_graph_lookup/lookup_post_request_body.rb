...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphLookup
    class LookupPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "lookupVector" => lambda {|n| @lookup_vector = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                "resultVector" => lambda {|n| @result_vector = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
