...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphImSub
    class ImSubPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "inumber1" => lambda {|n| @inumber1 = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                "inumber2" => lambda {|n| @inumber2 = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
