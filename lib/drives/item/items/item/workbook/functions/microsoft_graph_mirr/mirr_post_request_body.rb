...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphMirr
    class MirrPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "financeRate" => lambda {|n| @finance_rate = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                "reinvestRate" => lambda {|n| @reinvest_rate = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
