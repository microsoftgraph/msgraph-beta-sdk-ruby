...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphAccrInt
    class AccrIntPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "calcMethod" => lambda {|n| @calc_method = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                "firstInterest" => lambda {|n| @first_interest = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                ...
                "par" => lambda {|n| @par = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
