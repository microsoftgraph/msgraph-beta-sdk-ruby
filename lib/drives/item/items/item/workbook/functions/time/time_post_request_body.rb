                            ...
                            module Time
                                class TimePostRequestBody
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            "hour" => lambda {|n| @hour = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                            "minute" => lambda {|n| @minute = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                            "second" => lambda {|n| @second = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                        }
                                    end
                                    ## 
