...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphPriceDisc
    class PriceDiscPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "discount" => lambda {|n| @discount = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
