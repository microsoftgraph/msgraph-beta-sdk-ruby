...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphGeStep
    class GeStepPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "step" => lambda {|n| @step = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
