                                ...
                                class RankEqPostRequestBody
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            ...
                                            "order" => lambda {|n| @order = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                            "ref" => lambda {|n| @ref = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                        }
                                    end
                                    ## 
