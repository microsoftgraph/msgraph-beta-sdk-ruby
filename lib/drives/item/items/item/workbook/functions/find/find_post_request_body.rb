                            ...
                            module Find
                                class FindPostRequestBody
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            "findText" => lambda {|n| @find_text = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                            ...
                                            "withinText" => lambda {|n| @within_text = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                                        }
                                    end
                                    ## 
