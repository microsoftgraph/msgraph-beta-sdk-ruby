...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphDollarDe
    class DollarDePostRequestBody
        ...
        def get_field_deserializers()
            return {
                "fraction" => lambda {|n| @fraction = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
                "fractionalDollar" => lambda {|n| @fractional_dollar = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
