...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphDollarFr
    class DollarFrPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "decimalDollar" => lambda {|n| @decimal_dollar = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
