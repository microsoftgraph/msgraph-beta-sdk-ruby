...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Comments::Item
    ## 
    ...
    class WorkbookCommentItemRequestBuilder
        ...
        def replies()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Comments::Item::Replies::RepliesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def replies_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Comments::Item::Replies::Item::WorkbookCommentReplyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property comments for drives
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
