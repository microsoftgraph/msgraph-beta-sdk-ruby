                                        ...
                                        module Task
                                            module Changes
                                                ...
                                                class ChangesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                    ...
                                                    def count()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Comments::Item::Replies::Item::Task::Changes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    ## Provides operations to manage the changes property of the microsoft.graph.workbookDocumentTask entity.
                                                    ...
                                                    def by_workbook_document_task_change_id(workbook_document_task_change_id)
                                                        ...
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Comments::Item::Replies::Item::Task::Changes::Item::WorkbookDocumentTaskChangeItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                                    end
                                                    ## 
                                                    ...
                                                    def initialize(path_parameters, request_adapter)
                                                        super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/replies/{workbookCommentReply%2Did}/task/changes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                                    end
                                                    ## 
                                                    ...
                                                    def to_post_request_information(body, request_configuration=nil)
                                                        ...
                                                        request_info.url_template = '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/replies/{workbookCommentReply%2Did}/task/changes'
                                                        request_info.path_parameters = @path_parameters
