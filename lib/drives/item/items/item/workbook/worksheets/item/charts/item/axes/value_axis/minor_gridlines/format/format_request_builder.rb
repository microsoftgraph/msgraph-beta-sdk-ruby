...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::ValueAxis::MinorGridlines::Format
    ## 
    ...
    class FormatRequestBuilder
        ...
        def line()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::ValueAxis::MinorGridlines::Format::Line::LineRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
