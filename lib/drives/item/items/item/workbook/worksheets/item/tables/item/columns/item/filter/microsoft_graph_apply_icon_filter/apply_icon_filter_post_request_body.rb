...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyIconFilter
    class ApplyIconFilterPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "icon" => lambda {|n| @icon = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookIcon.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
