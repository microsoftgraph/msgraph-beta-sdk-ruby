...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Series::Item
    ## 
    ...
    class WorkbookChartSeriesItemRequestBuilder
        ...
        def format()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Series::Item::Format::FormatRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def points()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Series::Item::Points::PointsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
