...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Protection
    ## 
    ...
    class ProtectionRequestBuilder
        ...
        def microsoft_graph_protect()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Protection::MicrosoftGraphProtect::MicrosoftGraphProtectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unprotect method.
        def microsoft_graph_unprotect()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Protection::MicrosoftGraphUnprotect::MicrosoftGraphUnprotectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
