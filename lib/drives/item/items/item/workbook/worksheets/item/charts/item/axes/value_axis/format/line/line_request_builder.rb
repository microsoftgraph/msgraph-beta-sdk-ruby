                                                ...
                                                module Format
                                                    module Line
                                                        ...
                                                        class LineRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                            ...
                                                            def clear()
                                                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::ValueAxis::Format::Line::Clear::ClearRequestBuilder.new(@path_parameters, @request_adapter)
                                                            end
                                                            ## 
