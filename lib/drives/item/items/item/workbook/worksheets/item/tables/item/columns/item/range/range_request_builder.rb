                                            ...
                                            module Item
                                                module Range
                                                    ...
                                                    class RangeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                        ...
                                                        def clear()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::Clear::ClearRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the columnsAfter method.
                                                        def columns_after()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::ColumnsAfter::ColumnsAfterRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the columnsBefore method.
                                                        def columns_before()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::ColumnsBefore::ColumnsBeforeRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the delete method.
                                                        def delete_path()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::Delete::DeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the entireColumn method.
                                                        def entire_column()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::EntireColumn::EntireColumnRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the entireRow method.
                                                        def entire_row()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::EntireRow::EntireRowRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to manage the format property of the microsoft.graph.workbookRange entity.
                                                        def format()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::Format::FormatRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the insert method.
                                                        def insert()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::Insert::InsertRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the lastCell method.
                                                        def last_cell()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::LastCell::LastCellRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the lastColumn method.
                                                        def last_column()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::LastColumn::LastColumnRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the lastRow method.
                                                        def last_row()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::LastRow::LastRowRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the merge method.
                                                        def merge()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::Merge::MergeRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the rowsAbove method.
                                                        def rows_above()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::RowsAbove::RowsAboveRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the rowsBelow method.
                                                        def rows_below()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::RowsBelow::RowsBelowRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to manage the sort property of the microsoft.graph.workbookRange entity.
                                                        def sort()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::Sort::SortRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the unmerge method.
                                                        def unmerge()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::Unmerge::UnmergeRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the usedRange method.
                                                        def used_range()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::UsedRange::UsedRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the visibleView method.
                                                        def visible_view()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::VisibleView::VisibleViewRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to manage the worksheet property of the microsoft.graph.workbookRange entity.
                                                        def worksheet()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::Worksheet::WorksheetRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
