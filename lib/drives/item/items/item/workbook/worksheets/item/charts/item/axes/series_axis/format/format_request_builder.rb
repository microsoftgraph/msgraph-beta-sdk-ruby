...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::SeriesAxis::Format
    ## 
    ...
    class FormatRequestBuilder
        ...
        def font()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::SeriesAxis::Format::Font::FontRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the line property of the microsoft.graph.workbookChartAxisFormat entity.
        def line()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::SeriesAxis::Format::Line::LineRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
