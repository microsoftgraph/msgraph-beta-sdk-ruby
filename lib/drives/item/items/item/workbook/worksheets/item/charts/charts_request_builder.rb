...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts
    ...
    class ChartsRequestBuilder
        ...
        def microsoft_graph_add()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::MicrosoftGraphAdd::AddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
