...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::SeriesAxis::Format::Line
    ...
    class LineRequestBuilder
        ...
        def microsoft_graph_clear()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::SeriesAxis::Format::Line::MicrosoftGraphClear::ClearRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
