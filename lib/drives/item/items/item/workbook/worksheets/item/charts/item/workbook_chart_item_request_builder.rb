...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item
    ...
    class WorkbookChartItemRequestBuilder
        ...
        def microsoft_graph_image()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::MicrosoftGraphImage::ImageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setData method.
        def microsoft_graph_set_data()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::MicrosoftGraphSetData::SetDataRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setPosition method.
        def microsoft_graph_set_position()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::MicrosoftGraphSetPosition::SetPositionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
