...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item
    ## 
    ...
    class WorkbookChartItemRequestBuilder
        ...
        def axes()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::AxesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the dataLabels property of the microsoft.graph.workbookChart entity.
        def data_labels()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::DataLabels::DataLabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the format property of the microsoft.graph.workbookChart entity.
        def format()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Format::FormatRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the legend property of the microsoft.graph.workbookChart entity.
        def legend()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Legend::LegendRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the image method.
        def microsoft_graph_image()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::MicrosoftGraphImage::MicrosoftGraphImageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setData method.
        def microsoft_graph_set_data()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::MicrosoftGraphSetData::MicrosoftGraphSetDataRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setPosition method.
        def microsoft_graph_set_position()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::MicrosoftGraphSetPosition::MicrosoftGraphSetPositionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def series()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Series::SeriesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the title property of the microsoft.graph.workbookChart entity.
        def title()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Title::TitleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def worksheet()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Worksheet::WorksheetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def series_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Series::Item::WorkbookChartSeriesItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property charts for drives
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
