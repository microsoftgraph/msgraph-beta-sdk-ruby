                                ...
                                module Charts
                                    module Item
                                        ...
                                        class WorkbookChartItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def image()
                                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Image::ImageRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ...
                                            def set_data()
                                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::SetData::SetDataRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            # Provides operations to call the setPosition method.
                                            def set_position()
                                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::SetPosition::SetPositionRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
