...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item
    ## 
    ...
    class WorkbookWorksheetItemRequestBuilder
        ...
        def charts()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::ChartsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the range method.
        def microsoft_graph_range()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::MicrosoftGraphRange::MicrosoftGraphRangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the usedRange method.
        def microsoft_graph_used_range()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::MicrosoftGraphUsedRange::MicrosoftGraphUsedRangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the names property of the microsoft.graph.workbookWorksheet entity.
        def names()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Names::NamesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def pivot_tables()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::PivotTables::PivotTablesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the protection property of the microsoft.graph.workbookWorksheet entity.
        def protection()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Protection::ProtectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tables()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::TablesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def charts_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::WorkbookChartItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::WorkbookWorksheet.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ...
        def names_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Names::Item::WorkbookNamedItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def pivot_tables_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::PivotTables::Item::WorkbookPivotTableItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tables property of the microsoft.graph.workbookWorksheet entity.
        ## @param id Unique identifier of the item
        ...
        def tables_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::WorkbookTableItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property worksheets for drives
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
