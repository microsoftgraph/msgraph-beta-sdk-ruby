                                    ...
                                    module Item
                                        module Rows
                                            ...
                                            class RowsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def add()
                                                    return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                ...
                                                def by_workbook_table_row_id(workbook_table_row_id)
                                                    ...
                                                    return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::WorkbookTableRowItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                                end
                                                ## 
