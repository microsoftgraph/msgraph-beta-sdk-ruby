...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Title::Format::Fill
    ## 
    ...
    class FillRequestBuilder
        ...
        def microsoft_graph_clear()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Title::Format::Fill::MicrosoftGraphClear::MicrosoftGraphClearRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setSolidColor method.
        def microsoft_graph_set_solid_color()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Title::Format::Fill::MicrosoftGraphSetSolidColor::MicrosoftGraphSetSolidColorRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
