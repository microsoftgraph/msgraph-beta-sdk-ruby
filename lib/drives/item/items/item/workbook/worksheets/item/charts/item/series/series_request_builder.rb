                                    ...
                                    module Item
                                        module Series
                                            ...
                                            class SeriesRequestBuilder
                                                ...
                                                def count()
                                                    return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Series::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                # Provides operations to call the count method.
                                                def microsoft_graph_count()
                                                    return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Series::MicrosoftGraphCount::MicrosoftGraphCountRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
