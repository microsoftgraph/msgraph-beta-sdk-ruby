...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::MicrosoftGraphAdd
    class AddPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "sourceData" => lambda {|n| @source_data = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::Json.create_from_discriminator_value(pn) }) },
