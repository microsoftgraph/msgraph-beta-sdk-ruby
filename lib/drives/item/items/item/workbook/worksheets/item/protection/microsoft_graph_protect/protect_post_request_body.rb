...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Protection::MicrosoftGraphProtect
    class ProtectPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "options" => lambda {|n| @options = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::WorkbookWorksheetProtectionOptions.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
