                                            ...
                                            module SeriesAxis
                                                module MajorGridlines
                                                    ...
                                                    class MajorGridlinesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                        ...
                                                        def format()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::SeriesAxis::MajorGridlines::Format::FormatRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
