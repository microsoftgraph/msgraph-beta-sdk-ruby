                                    ...
                                    module Item
                                        ...
                                        class WorkbookPivotTableItemRequestBuilder
                                            ...
                                            def microsoft_graph_refresh()
                                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::PivotTables::Item::MicrosoftGraphRefresh::MicrosoftGraphRefreshRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ...
                                            def worksheet()
                                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::PivotTables::Item::Worksheet::WorksheetRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
