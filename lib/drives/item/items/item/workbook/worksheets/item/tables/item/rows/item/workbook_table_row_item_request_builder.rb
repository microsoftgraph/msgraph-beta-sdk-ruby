                                        ...
                                        module Rows
                                            module Item
                                                ...
                                                class WorkbookTableRowItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                    ...
                                                    def range()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::RangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
