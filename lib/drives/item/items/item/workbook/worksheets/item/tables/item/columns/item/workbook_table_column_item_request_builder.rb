                                        ...
                                        module Columns
                                            module Item
                                                ...
                                                class WorkbookTableColumnItemRequestBuilder
                                                    ...
                                                    def data_body_range()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::DataBodyRange::DataBodyRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    ...
                                                    def header_row_range()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::HeaderRowRange::HeaderRowRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    ...
                                                    def range()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Range::RangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    ...
                                                    def total_row_range()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::TotalRowRange::TotalRowRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
