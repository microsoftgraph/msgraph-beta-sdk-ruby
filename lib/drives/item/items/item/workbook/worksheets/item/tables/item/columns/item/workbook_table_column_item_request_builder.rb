                                        ...
                                        module Columns
                                            module Item
                                                ...
                                                class WorkbookTableColumnItemRequestBuilder
                                                    ...
                                                    def filter()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::Filter::FilterRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    # Provides operations to call the dataBodyRange method.
                                                    def microsoft_graph_data_body_range()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::MicrosoftGraphDataBodyRange::MicrosoftGraphDataBodyRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    # Provides operations to call the headerRowRange method.
                                                    def microsoft_graph_header_row_range()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::MicrosoftGraphHeaderRowRange::MicrosoftGraphHeaderRowRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    # Provides operations to call the range method.
                                                    def microsoft_graph_range()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::MicrosoftGraphRange::MicrosoftGraphRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
                                                    # Provides operations to call the totalRowRange method.
                                                    def microsoft_graph_total_row_range()
                                                        return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Columns::Item::MicrosoftGraphTotalRowRange::MicrosoftGraphTotalRowRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
