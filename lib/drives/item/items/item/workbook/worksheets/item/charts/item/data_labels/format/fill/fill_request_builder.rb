...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::DataLabels::Format::Fill
    ...
    class FillRequestBuilder
        ...
        def microsoft_graph_clear()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::DataLabels::Format::Fill::MicrosoftGraphClear::ClearRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setSolidColor method.
        def microsoft_graph_set_solid_color()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::DataLabels::Format::Fill::MicrosoftGraphSetSolidColor::SetSolidColorRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
