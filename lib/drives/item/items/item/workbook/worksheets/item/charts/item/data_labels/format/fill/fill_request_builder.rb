                                            ...
                                            module Format
                                                module Fill
                                                    ...
                                                    class FillRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                        ...
                                                        def clear()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::DataLabels::Format::Fill::Clear::ClearRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the setSolidColor method.
                                                        def set_solid_color()
                                                            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::DataLabels::Format::Fill::SetSolidColor::SetSolidColorRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
