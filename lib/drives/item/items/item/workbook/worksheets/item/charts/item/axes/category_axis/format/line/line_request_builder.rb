                                                ...
                                                module Format
                                                    module Line
                                                        ...
                                                        class LineRequestBuilder
                                                            ...
                                                            def clear()
                                                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::CategoryAxis::Format::Line::Clear::ClearRequestBuilder.new(@path_parameters, @request_adapter)
                                                            end
                                                            ## 
