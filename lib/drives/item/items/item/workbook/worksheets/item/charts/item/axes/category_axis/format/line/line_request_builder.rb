...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::CategoryAxis::Format::Line
    ...
    class LineRequestBuilder
        ...
        def microsoft_graph_clear()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::CategoryAxis::Format::Line::MicrosoftGraphClear::MicrosoftGraphClearRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
