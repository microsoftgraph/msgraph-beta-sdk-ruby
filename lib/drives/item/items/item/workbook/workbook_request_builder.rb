                ...
                module Item
                    module Workbook
                        ...
                        class WorkbookRequestBuilder
                            ...
                            def close_session()
                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::CloseSession::CloseSessionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def create_session()
                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::CreateSession::CreateSessionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def refresh_session()
                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::RefreshSession::RefreshSessionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
