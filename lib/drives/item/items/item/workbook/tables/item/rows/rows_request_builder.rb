...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Rows
    ## 
    ...
    class RowsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Rows::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the add method.
        def microsoft_graph_add()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Rows::MicrosoftGraphAdd::MicrosoftGraphAddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the count method.
        def microsoft_graph_count()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Rows::MicrosoftGraphCount::MicrosoftGraphCountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
