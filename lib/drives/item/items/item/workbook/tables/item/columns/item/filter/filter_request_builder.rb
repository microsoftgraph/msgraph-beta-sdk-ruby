...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter
    ## 
    ...
    class FilterRequestBuilder
        ...
        def microsoft_graph_apply()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApply::MicrosoftGraphApplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyBottomItemsFilter method.
        def microsoft_graph_apply_bottom_items_filter()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyBottomItemsFilter::MicrosoftGraphApplyBottomItemsFilterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyBottomPercentFilter method.
        def microsoft_graph_apply_bottom_percent_filter()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyBottomPercentFilter::MicrosoftGraphApplyBottomPercentFilterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyCellColorFilter method.
        def microsoft_graph_apply_cell_color_filter()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyCellColorFilter::MicrosoftGraphApplyCellColorFilterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyCustomFilter method.
        def microsoft_graph_apply_custom_filter()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyCustomFilter::MicrosoftGraphApplyCustomFilterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyDynamicFilter method.
        def microsoft_graph_apply_dynamic_filter()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyDynamicFilter::MicrosoftGraphApplyDynamicFilterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyFontColorFilter method.
        def microsoft_graph_apply_font_color_filter()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyFontColorFilter::MicrosoftGraphApplyFontColorFilterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyIconFilter method.
        def microsoft_graph_apply_icon_filter()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyIconFilter::MicrosoftGraphApplyIconFilterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyTopItemsFilter method.
        def microsoft_graph_apply_top_items_filter()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyTopItemsFilter::MicrosoftGraphApplyTopItemsFilterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyTopPercentFilter method.
        def microsoft_graph_apply_top_percent_filter()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyTopPercentFilter::MicrosoftGraphApplyTopPercentFilterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyValuesFilter method.
        def microsoft_graph_apply_values_filter()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphApplyValuesFilter::MicrosoftGraphApplyValuesFilterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the clear method.
        def microsoft_graph_clear()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Columns::Item::Filter::MicrosoftGraphClear::MicrosoftGraphClearRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
