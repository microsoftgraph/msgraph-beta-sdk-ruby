...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Sort
    ## 
    ...
    class SortRequestBuilder
        ...
        def microsoft_graph_apply()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Sort::MicrosoftGraphApply::MicrosoftGraphApplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the clear method.
        def microsoft_graph_clear()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Sort::MicrosoftGraphClear::MicrosoftGraphClearRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reapply method.
        def microsoft_graph_reapply()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Sort::MicrosoftGraphReapply::MicrosoftGraphReapplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
