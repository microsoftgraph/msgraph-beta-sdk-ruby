                                    ...
                                    module Item
                                        ...
                                        class WorkbookTableRowItemRequestBuilder
                                            ...
                                            def microsoft_graph_range()
                                                return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Tables::Item::Rows::Item::MicrosoftGraphRange::MicrosoftGraphRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
