                    ...
                    module Workbook
                        module Names
                            ...
                            class NamesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def add()
                                    return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Names::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the addFormulaLocal method.
                                def add_formula_local()
                                    return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Names::AddFormulaLocal::AddFormulaLocalRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
