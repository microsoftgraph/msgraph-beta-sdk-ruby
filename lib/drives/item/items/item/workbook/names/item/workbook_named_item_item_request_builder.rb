...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Names::Item
    ## 
    ...
    class WorkbookNamedItemItemRequestBuilder
        ...
        def microsoft_graph_range()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Names::Item::MicrosoftGraphRange::MicrosoftGraphRangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def worksheet()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Names::Item::Worksheet::WorksheetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
