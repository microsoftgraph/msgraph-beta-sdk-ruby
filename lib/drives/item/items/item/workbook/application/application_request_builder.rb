...
module MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Application
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def microsoft_graph_calculate()
            return MicrosoftGraphBeta::Drives::Item::Items::Item::Workbook::Application::MicrosoftGraphCalculate::MicrosoftGraphCalculateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
