...
require_relative '../item'
require_relative './microsoft_graph_assign_sensitivity_label'

module MicrosoftGraphBeta::Drives::Item::Items::Item::MicrosoftGraphAssignSensitivityLabel
    class AssignSensitivityLabelPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "assignmentMethod" => lambda {|n| @assignment_method = n.get_enum_value(MicrosoftGraphBeta::Models::SensitivityLabelAssignmentMethod) },
