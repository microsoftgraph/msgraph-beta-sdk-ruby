                ...
                module Item
                    module DriveItem
                        ...
                        class DriveItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def content()
                                return MicrosoftGraphBeta::Drives::Item::Activities::Item::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the media for the drive entity.
                            def content_stream()
                                return MicrosoftGraphBeta::Drives::Item::Activities::Item::DriveItem::ContentStream::ContentStreamRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}/driveItem{?%24expand,%24select}")
                            end
                            ## 
