...
module MicrosoftGraphBeta::Drives::Item::Activities::Item::ListItem
    ## 
    ...
    class ListItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}"
