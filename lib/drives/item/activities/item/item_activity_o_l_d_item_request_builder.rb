            ...
            module Activities
                module Item
                    ...
                    class ItemActivityOLDItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def drive_item()
                            return MicrosoftGraphBeta::Drives::Item::Activities::Item::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the listItem property of the microsoft.graph.itemActivityOLD entity.
                        def list_item()
                            return MicrosoftGraphBeta::Drives::Item::Activities::Item::ListItem::ListItemRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/drives/{drive%2Did}/activities/{itemActivityOLD%2Did}'
