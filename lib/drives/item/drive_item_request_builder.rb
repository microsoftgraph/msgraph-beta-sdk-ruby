...
module MicrosoftGraphBeta::Drives::Item
    ...
    class DriveItemRequestBuilder
        ...
        def microsoft_graph_recent()
            return MicrosoftGraphBeta::Drives::Item::MicrosoftGraphRecent::RecentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sharedWithMe method.
        def microsoft_graph_shared_with_me()
            return MicrosoftGraphBeta::Drives::Item::MicrosoftGraphSharedWithMe::SharedWithMeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
