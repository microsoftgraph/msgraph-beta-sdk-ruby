    ...
    module Drives
        module Item
            ...
            class DriveItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def created_by_user()
                    return MicrosoftGraphBeta::Drives::Item::CreatedByUser::CreatedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def last_modified_by_user()
                    return MicrosoftGraphBeta::Drives::Item::LastModifiedByUser::LastModifiedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
