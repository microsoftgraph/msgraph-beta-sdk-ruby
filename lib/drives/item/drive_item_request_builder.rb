...
module MicrosoftGraphBeta::Drives::Item
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def microsoft_graph_recent()
            return MicrosoftGraphBeta::Drives::Item::MicrosoftGraphRecent::MicrosoftGraphRecentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sharedWithMe method.
        def microsoft_graph_shared_with_me()
            return MicrosoftGraphBeta::Drives::Item::MicrosoftGraphSharedWithMe::MicrosoftGraphSharedWithMeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def bundles_by_id(id)
            ...
            return MicrosoftGraphBeta::Drives::Item::Bundles::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def following_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraphBeta::Drives::Item::Following::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def items_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraphBeta::Drives::Item::Items::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
