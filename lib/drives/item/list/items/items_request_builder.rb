...
module MicrosoftGraphBeta::Drives::Item::List::Items
    ## 
    ...
    class ItemsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Drives::Item::List::Items::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
