                    ...
                    module Item
                        ...
                        class ListItemItemRequestBuilder
                            ...
                            def microsoft_graph_create_link()
                                return MicrosoftGraphBeta::Drives::Item::List::Items::Item::MicrosoftGraphCreateLink::MicrosoftGraphCreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
