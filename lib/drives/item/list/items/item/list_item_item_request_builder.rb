                ...
                module Items
                    module Item
                        ...
                        class ListItemItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def created_by_user()
                                return MicrosoftGraphBeta::Drives::Item::List::Items::Item::CreatedByUser::CreatedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def last_modified_by_user()
                                return MicrosoftGraphBeta::Drives::Item::List::Items::Item::LastModifiedByUser::LastModifiedByUserRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the permissions property of the microsoft.graph.listItem entity.
                            def permissions()
                                return MicrosoftGraphBeta::Drives::Item::List::Items::Item::Permissions::PermissionsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
