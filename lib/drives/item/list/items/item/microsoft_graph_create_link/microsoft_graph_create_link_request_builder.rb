...
module MicrosoftGraphBeta::Drives::Item::List::Items::Item::MicrosoftGraphCreateLink
    ## 
    ...
    class MicrosoftGraphCreateLinkRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/microsoft.graph.createLink"
