                ...
                module Activities
                    ...
                    class ActivitiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/list/activities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/drives/{drive%2Did}/list/activities'
                            request_info.path_parameters = @path_parameters
