...
module MicrosoftGraphBeta::Drives::Item::List::Subscriptions::Item
    ## 
    ...
    class SubscriptionItemRequestBuilder
        ...
        def microsoft_graph_reauthorize()
            return MicrosoftGraphBeta::Drives::Item::List::Subscriptions::Item::MicrosoftGraphReauthorize::MicrosoftGraphReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
