...
module MicrosoftGraphBeta::Drives::Item::List::ContentTypes
    ...
    class ContentTypesRequestBuilder
        ...
        def microsoft_graph_add_copy()
            return MicrosoftGraphBeta::Drives::Item::List::ContentTypes::MicrosoftGraphAddCopy::AddCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addCopyFromContentTypeHub method.
        def microsoft_graph_add_copy_from_content_type_hub()
            return MicrosoftGraphBeta::Drives::Item::List::ContentTypes::MicrosoftGraphAddCopyFromContentTypeHub::AddCopyFromContentTypeHubRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getCompatibleHubContentTypes method.
        def microsoft_graph_get_compatible_hub_content_types()
            return MicrosoftGraphBeta::Drives::Item::List::ContentTypes::MicrosoftGraphGetCompatibleHubContentTypes::GetCompatibleHubContentTypesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
