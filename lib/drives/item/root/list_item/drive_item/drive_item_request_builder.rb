...
module MicrosoftGraphBeta::Drives::Item::Root::ListItem::DriveItem
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Drives::Item::Root::ListItem::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
