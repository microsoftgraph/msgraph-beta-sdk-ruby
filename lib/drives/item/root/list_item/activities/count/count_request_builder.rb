...
module MicrosoftGraphBeta::Drives::Item::Root::ListItem::Activities::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/root/listItem/activities/$count{?%24search,%24filter}"
