...
module MicrosoftGraphBeta::DirectorySettingTemplates::MicrosoftGraphValidateProperties
    ## 
    ...
    class ValidatePropertiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directorySettingTemplates/microsoft.graph.validateProperties"
