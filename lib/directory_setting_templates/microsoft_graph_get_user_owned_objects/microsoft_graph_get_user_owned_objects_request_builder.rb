...
module MicrosoftGraphBeta::DirectorySettingTemplates::MicrosoftGraphGetUserOwnedObjects
    ## 
    ...
    class MicrosoftGraphGetUserOwnedObjectsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directorySettingTemplates/microsoft.graph.getUserOwnedObjects"
