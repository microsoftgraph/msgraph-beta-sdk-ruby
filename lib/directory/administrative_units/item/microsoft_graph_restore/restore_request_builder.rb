...
module MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::MicrosoftGraphRestore
    ## 
    ...
    class RestoreRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/microsoft.graph.restore"
