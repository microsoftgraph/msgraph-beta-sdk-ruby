                ...
                module GetMemberObjects
                    ...
                    class GetMemberObjectsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/getMemberObjects")
                        end
                        ## 
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::GetMemberObjects::GetMemberObjectsPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Invoke action getMemberObjects
                        ## @param body The request body
