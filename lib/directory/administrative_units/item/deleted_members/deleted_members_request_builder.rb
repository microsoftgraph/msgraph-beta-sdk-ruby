...
require_relative './deleted_members'
...
module MicrosoftGraphBeta
    module Directory
        module AdministrativeUnits
            module Item
                module DeletedMembers
                    ## 
                    # Provides operations to manage the deletedMembers property of the microsoft.graph.administrativeUnit entity.
                    class DeletedMembersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to count the resources in the collection.
                        def count()
                            return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::DeletedMembers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the deletedMembers property of the microsoft.graph.administrativeUnit entity.
                        ...
                        def by_directory_object_id(directory_object_id)
                            ...
                            return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::DeletedMembers::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/deletedMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        ## @return a deleted_members_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return DeletedMembersRequestBuilder.new(raw_url, @request_adapter)
                        end
