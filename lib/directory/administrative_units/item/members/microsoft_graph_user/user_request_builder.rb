...
module MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::Members::MicrosoftGraphUser
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::Members::MicrosoftGraphUser::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
