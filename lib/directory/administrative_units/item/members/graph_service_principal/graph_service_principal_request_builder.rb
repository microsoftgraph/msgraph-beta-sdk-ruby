                ...
                module Members
                    module GraphServicePrincipal
                        ...
                        class GraphServicePrincipalRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::Members::GraphServicePrincipal::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
