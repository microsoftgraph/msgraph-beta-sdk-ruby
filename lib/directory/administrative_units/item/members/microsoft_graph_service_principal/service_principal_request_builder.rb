...
module MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::Members::MicrosoftGraphServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::Members::MicrosoftGraphServicePrincipal::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
