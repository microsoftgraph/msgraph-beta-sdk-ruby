...
module MicrosoftGraphBeta::Directory::AdministrativeUnits::Item
    ...
    class AdministrativeUnitItemRequestBuilder
        ...
        def microsoft_graph_check_member_groups()
            return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::MicrosoftGraphCheckMemberGroups::CheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def microsoft_graph_check_member_objects()
            return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::MicrosoftGraphCheckMemberObjects::CheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberGroups method.
        def microsoft_graph_get_member_groups()
            return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::MicrosoftGraphGetMemberGroups::GetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def microsoft_graph_get_member_objects()
            return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::MicrosoftGraphGetMemberObjects::GetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::MicrosoftGraphRestore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
