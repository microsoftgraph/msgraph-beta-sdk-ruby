...
require_relative './deleted_members/deleted_members_request_builder'
        ...
        module AdministrativeUnits
            module Item
                ...
                class AdministrativeUnitItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def deleted_members()
                        return MicrosoftGraphBeta::Directory::AdministrativeUnits::Item::DeletedMembers::DeletedMembersRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
