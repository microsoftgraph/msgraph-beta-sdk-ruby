...
module MicrosoftGraphBeta::Directory::AdministrativeUnits::MicrosoftGraphGetUserOwnedObjects
    ## 
    ...
    class GetUserOwnedObjectsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/administrativeUnits/microsoft.graph.getUserOwnedObjects"
