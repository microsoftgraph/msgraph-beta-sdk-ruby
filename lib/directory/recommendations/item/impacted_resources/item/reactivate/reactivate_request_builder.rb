                ...
                module ImpactedResources
                    module Item
                        module Reactivate
                            ...
                            class ReactivateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}/impactedResources/{impactedResource%2Did}/reactivate")
                                end
                                ## 
                                ...
                                ## @return a reactivate_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return ReactivateRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
