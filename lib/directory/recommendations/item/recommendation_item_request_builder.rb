    ...
    module Directory
        module Recommendations
            module Item
                ...
                class RecommendationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to call the complete method.
                    def complete()
                        return MicrosoftGraphBeta::Directory::Recommendations::Item::Complete::CompleteRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the dismiss method.
                    def dismiss()
                        return MicrosoftGraphBeta::Directory::Recommendations::Item::Dismiss::DismissRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def impacted_resources()
                        return MicrosoftGraphBeta::Directory::Recommendations::Item::ImpactedResources::ImpactedResourcesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the postpone method.
                    def postpone()
                        return MicrosoftGraphBeta::Directory::Recommendations::Item::Postpone::PostponeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the reactivate method.
                    def reactivate()
                        return MicrosoftGraphBeta::Directory::Recommendations::Item::Reactivate::ReactivateRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/directory/recommendations/{recommendation%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return RecommendationItemRequestBuilder.new(raw_url, @request_adapter)
                    end
