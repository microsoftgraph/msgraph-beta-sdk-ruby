...
module MicrosoftGraphBeta::Directory::Recommendations::Item::MicrosoftGraphDismiss
    ## 
    ...
    class MicrosoftGraphDismissRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/recommendations/{recommendation%2Did}/microsoft.graph.dismiss"
