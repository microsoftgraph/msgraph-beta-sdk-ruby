...
module MicrosoftGraphBeta::Directory::Recommendations::Item::MicrosoftGraphPostpone
    ## 
    ...
    class PostponeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/recommendations/{recommendation%2Did}/microsoft.graph.postpone"
