...
module MicrosoftGraphBeta::Directory::Recommendations::Item::MicrosoftGraphComplete
    ## 
    ...
    class CompleteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/recommendations/{recommendation%2Did}/microsoft.graph.complete"
