...
module MicrosoftGraphBeta::Directory::DeletedItems
    ...
    class DeletedItemsRequestBuilder
        ...
        def application()
            return MicrosoftGraphBeta::Directory::DeletedItems::Application::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get_user_owned_objects()
            return MicrosoftGraphBeta::Directory::DeletedItems::GetUserOwnedObjects::GetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def group()
            return MicrosoftGraphBeta::Directory::DeletedItems::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Directory::DeletedItems::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
