...
module MicrosoftGraphBeta::Directory::DeletedItems
    ## 
    ...
    class DeletedItemsRequestBuilder
        ...
        def microsoft_graph_application()
            return MicrosoftGraphBeta::Directory::DeletedItems::MicrosoftGraphApplication::MicrosoftGraphApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getByIds method.
        def microsoft_graph_get_by_ids()
            return MicrosoftGraphBeta::Directory::DeletedItems::MicrosoftGraphGetByIds::MicrosoftGraphGetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getUserOwnedObjects method.
        def microsoft_graph_get_user_owned_objects()
            return MicrosoftGraphBeta::Directory::DeletedItems::MicrosoftGraphGetUserOwnedObjects::MicrosoftGraphGetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def microsoft_graph_group()
            return MicrosoftGraphBeta::Directory::DeletedItems::MicrosoftGraphGroup::MicrosoftGraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::Directory::DeletedItems::MicrosoftGraphUser::MicrosoftGraphUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validateProperties method.
        def microsoft_graph_validate_properties()
            return MicrosoftGraphBeta::Directory::DeletedItems::MicrosoftGraphValidateProperties::MicrosoftGraphValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
