...
module MicrosoftGraphBeta::Directory::DeletedItems::MicrosoftGraphApplication
    ## 
    ...
    class MicrosoftGraphApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Directory::DeletedItems::MicrosoftGraphApplication::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
