                ...
                module Item
                    ...
                    class CertificateBasedAuthPkiItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def certificate_authorities()
                            return MicrosoftGraphBeta::Directory::PublicKeyInfrastructure::CertificateBasedAuthConfigurations::Item::CertificateAuthorities::CertificateAuthoritiesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the upload method.
                        def upload()
                            return MicrosoftGraphBeta::Directory::PublicKeyInfrastructure::CertificateBasedAuthConfigurations::Item::Upload::UploadRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::CertificateBasedAuthPki.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
