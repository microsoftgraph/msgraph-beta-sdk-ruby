...
module MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item
    ## 
    ...
    class FeatureRolloutPolicyItemRequestBuilder
        ...
        def applies_to()
            return MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::AppliesToRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        @url_template
        ## 
        ## Gets an item from the MicrosoftGraphBeta.directory.featureRolloutPolicies.item.appliesTo.item collection
        ...
        def applies_to_by_id(id)
            ...
            return MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, feature_rollout_policy_id=nil)
            ...
            @url_template = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::FeatureRolloutPolicy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
