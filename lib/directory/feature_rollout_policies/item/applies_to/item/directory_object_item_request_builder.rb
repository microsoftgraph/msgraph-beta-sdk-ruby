...
module MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::Item
    ## 
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, directory_object_id=nil)
            ...
            @url_template = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}/appliesTo/{directoryObject%2Did}"
