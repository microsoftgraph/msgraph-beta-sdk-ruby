                ...
                module AppliesTo
                    ...
                    class AppliesToRequestBuilder
                        ...
                        def microsoft_graph_get_by_ids()
                            return MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::MicrosoftGraphGetByIds::MicrosoftGraphGetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getUserOwnedObjects method.
                        def microsoft_graph_get_user_owned_objects()
                            return MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::MicrosoftGraphGetUserOwnedObjects::MicrosoftGraphGetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the validateProperties method.
                        def microsoft_graph_validate_properties()
                            return MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::MicrosoftGraphValidateProperties::MicrosoftGraphValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
