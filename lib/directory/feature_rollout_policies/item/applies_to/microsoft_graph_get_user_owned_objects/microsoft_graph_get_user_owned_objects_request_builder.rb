...
module MicrosoftGraphBeta::Directory::FeatureRolloutPolicies::Item::AppliesTo::MicrosoftGraphGetUserOwnedObjects
    ## 
    ...
    class MicrosoftGraphGetUserOwnedObjectsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}/appliesTo/microsoft.graph.getUserOwnedObjects"
