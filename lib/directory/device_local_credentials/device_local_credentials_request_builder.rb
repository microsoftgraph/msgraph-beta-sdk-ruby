    ...
    module Directory
        module DeviceLocalCredentials
            ...
            class DeviceLocalCredentialsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::Directory::DeviceLocalCredentials::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the deviceLocalCredentials property of the microsoft.graph.directory entity.
                ...
                def by_device_local_credential_info_id(device_local_credential_info_id)
                    ...
                    return MicrosoftGraphBeta::Directory::DeviceLocalCredentials::Item::DeviceLocalCredentialInfoItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
