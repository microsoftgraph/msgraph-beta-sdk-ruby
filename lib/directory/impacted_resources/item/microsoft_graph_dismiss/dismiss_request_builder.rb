...
module MicrosoftGraphBeta::Directory::ImpactedResources::Item::MicrosoftGraphDismiss
    ## 
    ...
    class DismissRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/impactedResources/{impactedResource%2Did}/microsoft.graph.dismiss"
