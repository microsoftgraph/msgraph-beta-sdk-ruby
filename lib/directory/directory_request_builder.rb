    ...
    module Directory
        ...
        class DirectoryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def authentication_method_devices()
                return MicrosoftGraphBeta::Directory::AuthenticationMethodDevices::AuthenticationMethodDevicesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def public_key_infrastructure()
                return MicrosoftGraphBeta::Directory::PublicKeyInfrastructure::PublicKeyInfrastructureRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def templates()
                return MicrosoftGraphBeta::Directory::Templates::TemplatesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
