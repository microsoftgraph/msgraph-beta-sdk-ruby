        ...
        module Templates
            ...
            class TemplatesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def device_templates()
                    return MicrosoftGraphBeta::Directory::Templates::DeviceTemplates::DeviceTemplatesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/directory/templates{?%24expand,%24select}")
                end
                ## 
