...
module MicrosoftGraphBeta::Directory::SharedEmailDomains::Item
    ## 
    ...
    class SharedEmailDomainItemRequestBuilder
        ...
        ## @param sharedEmailDomainId key: id of sharedEmailDomain
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, shared_email_domain_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/directory/sharedEmailDomains/{sharedEmailDomain%2Did}{?%24select,%24expand}"
