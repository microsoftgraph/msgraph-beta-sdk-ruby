...
module MicrosoftGraphBeta::Print::Reports::MicrosoftGraphGetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTime
    class GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
        ...
        def get_field_deserializers()
            return super.merge({
                "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::ArchivedPrintJob.create_from_discriminator_value(pn) }) },
            })
        end
        ## 
