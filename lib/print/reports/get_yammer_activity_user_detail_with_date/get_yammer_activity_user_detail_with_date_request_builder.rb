...
module MicrosoftGraphBeta::Print::Reports::GetYammerActivityUserDetailWithDate
    ## 
    ...
    class GetYammerActivityUserDetailWithDateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, date=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getYammerActivityUserDetail(date={date})"
