...
module MicrosoftGraphBeta::Print::Reports::GetYammerActivityUserDetailWithPeriod
    ## 
    ...
    class GetYammerActivityUserDetailWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getYammerActivityUserDetail(period='{period}')"
