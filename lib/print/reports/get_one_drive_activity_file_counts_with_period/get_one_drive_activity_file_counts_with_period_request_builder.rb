...
module MicrosoftGraphBeta::Print::Reports::GetOneDriveActivityFileCountsWithPeriod
    ## 
    ...
    class GetOneDriveActivityFileCountsWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getOneDriveActivityFileCounts(period='{period}')"
