...
module MicrosoftGraphBeta::Print::Reports::MonthlyPrintUsageSummariesByUser::Item
    ## 
    ...
    class PrintUsageByUserItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/reports/monthlyPrintUsageSummariesByUser/{printUsageByUser%2Did}{?%24select,%24expand}"
