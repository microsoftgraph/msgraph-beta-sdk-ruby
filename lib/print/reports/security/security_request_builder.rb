...
module MicrosoftGraphBeta::Print::Reports::Security
    ## 
    ...
    class SecurityRequestBuilder
        ...
        def microsoft_graph_get_attack_simulation_repeat_offenders()
            return MicrosoftGraphBeta::Print::Reports::Security::MicrosoftGraphGetAttackSimulationRepeatOffenders::MicrosoftGraphGetAttackSimulationRepeatOffendersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAttackSimulationSimulationUserCoverage method.
        def microsoft_graph_get_attack_simulation_simulation_user_coverage()
            return MicrosoftGraphBeta::Print::Reports::Security::MicrosoftGraphGetAttackSimulationSimulationUserCoverage::MicrosoftGraphGetAttackSimulationSimulationUserCoverageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAttackSimulationTrainingUserCoverage method.
        def microsoft_graph_get_attack_simulation_training_user_coverage()
            return MicrosoftGraphBeta::Print::Reports::Security::MicrosoftGraphGetAttackSimulationTrainingUserCoverage::MicrosoftGraphGetAttackSimulationTrainingUserCoverageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/reports/security{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SecurityReportsRoot.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
