...
module MicrosoftGraphBeta::Print::Reports::GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTime
    ## 
    ...
    class GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTimeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, end_date_time=nil, printer_id=nil, start_date_time=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getPrinterArchivedPrintJobs(printerId='{printerId}',startDateTime={startDateTime},endDateTime={endDateTime}){?%24top,%24skip,%24search,%24filter,%24count}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Print::Reports::GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTime::GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTimeResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function getPrinterArchivedPrintJobs
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
