...
module MicrosoftGraphBeta::Print::Reports::GetOffice365ActiveUserCountsWithPeriod
    ...
    class GetOffice365ActiveUserCountsWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getOffice365ActiveUserCounts(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
