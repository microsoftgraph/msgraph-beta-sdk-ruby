            ...
            module AuthenticationMethods
                ...
                class AuthenticationMethodsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def users_registered_by_feature()
                        return MicrosoftGraphBeta::Print::Reports::AuthenticationMethods::UsersRegisteredByFeature::UsersRegisteredByFeatureRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the usersRegisteredByMethod method.
                    def users_registered_by_method()
                        return MicrosoftGraphBeta::Print::Reports::AuthenticationMethods::UsersRegisteredByMethod::UsersRegisteredByMethodRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/print/reports/authenticationMethods{?%24select,%24expand}")
                    end
                    ## 
