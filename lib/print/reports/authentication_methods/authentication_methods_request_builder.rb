...
module MicrosoftGraphBeta::Print::Reports::AuthenticationMethods
    ...
    class AuthenticationMethodsRequestBuilder
        ...
        def microsoft_graph_users_registered_by_feature()
            return MicrosoftGraphBeta::Print::Reports::AuthenticationMethods::MicrosoftGraphUsersRegisteredByFeature::UsersRegisteredByFeatureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the usersRegisteredByMethod method.
        def microsoft_graph_users_registered_by_method()
            return MicrosoftGraphBeta::Print::Reports::AuthenticationMethods::MicrosoftGraphUsersRegisteredByMethod::UsersRegisteredByMethodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
