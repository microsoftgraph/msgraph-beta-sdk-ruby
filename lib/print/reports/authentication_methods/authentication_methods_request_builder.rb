...
require_relative './microsoft_graph_users_registered_by_feature/microsoft_graph_users_registered_by_feature_request_builder'
require_relative './microsoft_graph_users_registered_by_feature_with_included_user_types_with_included_user_roles/19063931cb1406486e4aeaf9759d84659ce0df23bd04bb6e5fa119f7dc5f8012'
require_relative './microsoft_graph_users_registered_by_method/microsoft_graph_users_registered_by_method_request_builder'
require_relative './microsoft_graph_users_registered_by_method_with_included_user_types_with_included_user_roles/d448e9d3a306d8f93140b5cefc7e3b8d08dd4aa10590d4c210405924853f46a6'
...
module MicrosoftGraphBeta::Print::Reports::AuthenticationMethods
    ## 
    ...
    class AuthenticationMethodsRequestBuilder
        ...
        def microsoft_graph_users_registered_by_feature()
            return MicrosoftGraphBeta::Print::Reports::AuthenticationMethods::MicrosoftGraphUsersRegisteredByFeature::MicrosoftGraphUsersRegisteredByFeatureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the usersRegisteredByMethod method.
        def microsoft_graph_users_registered_by_method()
            return MicrosoftGraphBeta::Print::Reports::AuthenticationMethods::MicrosoftGraphUsersRegisteredByMethod::MicrosoftGraphUsersRegisteredByMethodRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_registration_details()
            return MicrosoftGraphBeta::Print::Reports::AuthenticationMethods::UserRegistrationDetails::UserRegistrationDetailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/reports/authenticationMethods{?%24select,%24expand}"
        ...
        ## @return a microsoft_graph_users_registered_by_feature_with_included_user_types_with_included_user_roles_request_builder
        ## 
        def microsoft_graph_users_registered_by_feature_with_included_user_types_with_included_user_roles(included_user_roles, included_user_types)
            ...
            return MicrosoftGraphUsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilder.new(@path_parameters, @request_adapter, includedUserRoles, includedUserTypes)
        end
        ## 
        ## Provides operations to call the usersRegisteredByMethod method.
        ## @param includedUserRoles Usage: includedUserRoles='{includedUserRoles}'
        ## @param includedUserTypes Usage: includedUserTypes='{includedUserTypes}'
        ## @return a microsoft_graph_users_registered_by_method_with_included_user_types_with_included_user_roles_request_builder
        ## 
        def microsoft_graph_users_registered_by_method_with_included_user_types_with_included_user_roles(included_user_roles, included_user_types)
            raise StandardError, 'included_user_roles cannot be null' if included_user_roles.nil?
            raise StandardError, 'included_user_types cannot be null' if included_user_types.nil?
            return MicrosoftGraphUsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder.new(@path_parameters, @request_adapter, includedUserRoles, includedUserTypes)
        end
        ## 
        ...
        def user_registration_details_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::Reports::AuthenticationMethods::UserRegistrationDetails::Item::UserRegistrationDetailsItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
