...
module MicrosoftGraphBeta::Print::Reports::GetOneDriveUsageAccountCountsWithPeriod
    ## 
    ...
    class GetOneDriveUsageAccountCountsWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getOneDriveUsageAccountCounts(period='{period}')"
