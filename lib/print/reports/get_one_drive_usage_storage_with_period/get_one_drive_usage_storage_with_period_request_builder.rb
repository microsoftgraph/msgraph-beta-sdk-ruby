...
module MicrosoftGraphBeta::Print::Reports::GetOneDriveUsageStorageWithPeriod
    ## 
    ...
    class GetOneDriveUsageStorageWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getOneDriveUsageStorage(period='{period}')"
