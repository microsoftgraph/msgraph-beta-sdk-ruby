...
require_relative './microsoft_graph_get_azure_a_d_application_sign_in_summary_with_period/microsoft_graph_get_azure_a_d_application_sign_in_summary_with_period_request_builder'
require_relative './microsoft_graph_get_browser_distribution_user_counts_with_period/microsoft_graph_get_browser_distribution_user_counts_with_period_request_builder'
require_relative './microsoft_graph_get_browser_user_counts_with_period/microsoft_graph_get_browser_user_counts_with_period_request_builder'
require_relative './microsoft_graph_get_browser_user_detail_with_period/microsoft_graph_get_browser_user_detail_with_period_request_builder'
require_relative './microsoft_graph_get_credential_usage_summary_with_period/microsoft_graph_get_credential_usage_summary_with_period_request_builder'
require_relative './microsoft_graph_get_credential_user_registration_count/microsoft_graph_get_credential_user_registration_count_request_builder'
...
require_relative './microsoft_graph_get_forms_user_activity_counts_with_period/microsoft_graph_get_forms_user_activity_counts_with_period_request_builder'
require_relative './microsoft_graph_get_forms_user_activity_user_counts_with_period/microsoft_graph_get_forms_user_activity_user_counts_with_period_request_builder'
require_relative './microsoft_graph_get_forms_user_activity_user_detail_with_date/microsoft_graph_get_forms_user_activity_user_detail_with_date_request_builder'
require_relative './microsoft_graph_get_forms_user_activity_user_detail_with_period/microsoft_graph_get_forms_user_activity_user_detail_with_period_request_builder'
...
require_relative './microsoft_graph_get_relying_party_detailed_summary_with_period/microsoft_graph_get_relying_party_detailed_summary_with_period_request_builder'
...
require_relative './microsoft_graph_get_teams_device_usage_distribution_total_user_counts_with_period/microsoft_graph_get_teams_device_usage_distribution_total_user_counts_with_period_request_builder'
...
require_relative './microsoft_graph_get_teams_device_usage_total_user_counts_with_period/microsoft_graph_get_teams_device_usage_total_user_counts_with_period_request_builder'
...
require_relative './microsoft_graph_get_teams_team_activity_counts_with_period/microsoft_graph_get_teams_team_activity_counts_with_period_request_builder'
require_relative './microsoft_graph_get_teams_team_activity_detail_with_date/microsoft_graph_get_teams_team_activity_detail_with_date_request_builder'
require_relative './microsoft_graph_get_teams_team_activity_detail_with_period/microsoft_graph_get_teams_team_activity_detail_with_period_request_builder'
require_relative './microsoft_graph_get_teams_team_activity_distribution_counts_with_period/microsoft_graph_get_teams_team_activity_distribution_counts_with_period_request_builder'
require_relative './microsoft_graph_get_teams_team_counts_with_period/microsoft_graph_get_teams_team_counts_with_period_request_builder'
...
require_relative './microsoft_graph_get_teams_user_activity_distribution_total_user_counts_with_period/microsoft_graph_get_teams_user_activity_distribution_total_user_counts_with_period_request_builder'
require_relative './microsoft_graph_get_teams_user_activity_distribution_user_counts_with_period/microsoft_graph_get_teams_user_activity_distribution_user_counts_with_period_request_builder'
require_relative './microsoft_graph_get_teams_user_activity_total_counts_with_period/microsoft_graph_get_teams_user_activity_total_counts_with_period_request_builder'
require_relative './microsoft_graph_get_teams_user_activity_total_distribution_counts_with_period/microsoft_graph_get_teams_user_activity_total_distribution_counts_with_period_request_builder'
require_relative './microsoft_graph_get_teams_user_activity_total_user_counts_with_period/microsoft_graph_get_teams_user_activity_total_user_counts_with_period_request_builder'
...
require_relative './microsoft_graph_managed_device_enrollment_abandonment_details_with_skip_with_top_with_filter_with_skip_token/96d13a04ce3690b60a23fa64bbc97c0727fd49eef3f1ab66a96a796757803962'
require_relative './microsoft_graph_managed_device_enrollment_abandonment_summary_with_skip_with_top_with_filter_with_skip_token/108787db92abfbf48968ffa18ac4bd92d149d8f6b95a91f57b982b4cc5800ffb'
...
require_relative './microsoft_graph_managed_device_enrollment_failure_trends/microsoft_graph_managed_device_enrollment_failure_trends_request_builder'
...
module MicrosoftGraphBeta::Print::Reports
    ## 
    ...
    class ReportsRequestBuilder
        ...
        def application_sign_in_detailed_summary()
            return MicrosoftGraphBeta::Print::Reports::ApplicationSignInDetailedSummary::ApplicationSignInDetailedSummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the authenticationMethods property of the microsoft.graph.reportRoot entity.
        def authentication_methods()
            return MicrosoftGraphBeta::Print::Reports::AuthenticationMethods::AuthenticationMethodsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def credential_user_registration_details()
            return MicrosoftGraphBeta::Print::Reports::CredentialUserRegistrationDetails::CredentialUserRegistrationDetailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the dailyPrintUsage property of the microsoft.graph.reportRoot entity.
        def daily_print_usage()
            return MicrosoftGraphBeta::Print::Reports::DailyPrintUsage::DailyPrintUsageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the dailyPrintUsageByPrinter property of the microsoft.graph.reportRoot entity.
        def daily_print_usage_by_printer()
            return MicrosoftGraphBeta::Print::Reports::DailyPrintUsageByPrinter::DailyPrintUsageByPrinterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the dailyPrintUsageByUser property of the microsoft.graph.reportRoot entity.
        def daily_print_usage_by_user()
            return MicrosoftGraphBeta::Print::Reports::DailyPrintUsageByUser::DailyPrintUsageByUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def daily_print_usage_summaries_by_printer()
            return MicrosoftGraphBeta::Print::Reports::DailyPrintUsageSummariesByPrinter::DailyPrintUsageSummariesByPrinterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def daily_print_usage_summaries_by_user()
            return MicrosoftGraphBeta::Print::Reports::DailyPrintUsageSummariesByUser::DailyPrintUsageSummariesByUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_device_configuration_device_activity()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphDeviceConfigurationDeviceActivity::MicrosoftGraphDeviceConfigurationDeviceActivityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_device_configuration_user_activity()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphDeviceConfigurationUserActivity::MicrosoftGraphDeviceConfigurationUserActivityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAttackSimulationRepeatOffenders method.
        def microsoft_graph_get_attack_simulation_repeat_offenders()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphGetAttackSimulationRepeatOffenders::MicrosoftGraphGetAttackSimulationRepeatOffendersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAttackSimulationSimulationUserCoverage method.
        def microsoft_graph_get_attack_simulation_simulation_user_coverage()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphGetAttackSimulationSimulationUserCoverage::MicrosoftGraphGetAttackSimulationSimulationUserCoverageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAttackSimulationTrainingUserCoverage method.
        def microsoft_graph_get_attack_simulation_training_user_coverage()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphGetAttackSimulationTrainingUserCoverage::MicrosoftGraphGetAttackSimulationTrainingUserCoverageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getCredentialUserRegistrationCount method.
        def microsoft_graph_get_credential_user_registration_count()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphGetCredentialUserRegistrationCount::MicrosoftGraphGetCredentialUserRegistrationCountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getOffice365ActivationCounts method.
        def microsoft_graph_get_office365_activation_counts()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphGetOffice365ActivationCounts::MicrosoftGraphGetOffice365ActivationCountsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getOffice365ActivationsUserCounts method.
        def microsoft_graph_get_office365_activations_user_counts()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphGetOffice365ActivationsUserCounts::MicrosoftGraphGetOffice365ActivationsUserCountsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getOffice365ActivationsUserDetail method.
        def microsoft_graph_get_office365_activations_user_detail()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphGetOffice365ActivationsUserDetail::MicrosoftGraphGetOffice365ActivationsUserDetailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the managedDeviceEnrollmentFailureDetails method.
        def microsoft_graph_managed_device_enrollment_failure_details()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphManagedDeviceEnrollmentFailureDetails::MicrosoftGraphManagedDeviceEnrollmentFailureDetailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the managedDeviceEnrollmentFailureTrends method.
        def microsoft_graph_managed_device_enrollment_failure_trends()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphManagedDeviceEnrollmentFailureTrends::MicrosoftGraphManagedDeviceEnrollmentFailureTrendsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the managedDeviceEnrollmentTopFailures method.
        def microsoft_graph_managed_device_enrollment_top_failures()
            return MicrosoftGraphBeta::Print::Reports::MicrosoftGraphManagedDeviceEnrollmentTopFailures::MicrosoftGraphManagedDeviceEnrollmentTopFailuresRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the monthlyPrintUsageByPrinter property of the microsoft.graph.reportRoot entity.
        def monthly_print_usage_by_printer()
            return MicrosoftGraphBeta::Print::Reports::MonthlyPrintUsageByPrinter::MonthlyPrintUsageByPrinterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the monthlyPrintUsageByUser property of the microsoft.graph.reportRoot entity.
        def monthly_print_usage_by_user()
            return MicrosoftGraphBeta::Print::Reports::MonthlyPrintUsageByUser::MonthlyPrintUsageByUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def monthly_print_usage_summaries_by_printer()
            return MicrosoftGraphBeta::Print::Reports::MonthlyPrintUsageSummariesByPrinter::MonthlyPrintUsageSummariesByPrinterRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def monthly_print_usage_summaries_by_user()
            return MicrosoftGraphBeta::Print::Reports::MonthlyPrintUsageSummariesByUser::MonthlyPrintUsageSummariesByUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def security()
            return MicrosoftGraphBeta::Print::Reports::Security::SecurityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_credential_usage_details()
            return MicrosoftGraphBeta::Print::Reports::UserCredentialUsageDetails::UserCredentialUsageDetailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the applicationSignInDetailedSummary property of the microsoft.graph.reportRoot entity.
        ...
        def application_sign_in_detailed_summary_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::Reports::ApplicationSignInDetailedSummary::Item::ApplicationSignInDetailedSummaryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/reports{?%24select,%24expand}"
        ...
        def daily_print_usage_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::Reports::DailyPrintUsage::Item::PrintUsageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the dailyPrintUsageByPrinter property of the microsoft.graph.reportRoot entity.
        ## @param id Unique identifier of the item
        ...
        def daily_print_usage_by_printer_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::Reports::DailyPrintUsageByPrinter::Item::PrintUsageByPrinterItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the dailyPrintUsageByUser property of the microsoft.graph.reportRoot entity.
        ## @param id Unique identifier of the item
        ...
        ## @return a microsoft_graph_get_azure_a_d_application_sign_in_summary_with_period_request_builder
        ## 
        def microsoft_graph_get_azure_a_d_application_sign_in_summary_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetAzureADApplicationSignInSummaryWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getBrowserDistributionUserCounts method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_browser_distribution_user_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_browser_distribution_user_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetBrowserDistributionUserCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getBrowserUserCounts method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_browser_user_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_browser_user_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetBrowserUserCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getBrowserUserDetail method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_browser_user_detail_with_period_request_builder
        ## 
        def microsoft_graph_get_browser_user_detail_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetBrowserUserDetailWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getCredentialUsageSummary method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_credential_usage_summary_with_period_request_builder
        ## 
        def microsoft_graph_get_credential_usage_summary_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetCredentialUsageSummaryWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ...
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_forms_user_activity_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_forms_user_activity_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetFormsUserActivityCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getFormsUserActivityUserCounts method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_forms_user_activity_user_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_forms_user_activity_user_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetFormsUserActivityUserCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getFormsUserActivityUserDetail method.
        ## @param date Usage: date={date}
        ## @return a microsoft_graph_get_forms_user_activity_user_detail_with_date_request_builder
        ## 
        def microsoft_graph_get_forms_user_activity_user_detail_with_date(date)
            raise StandardError, 'date cannot be null' if date.nil?
            return MicrosoftGraphGetFormsUserActivityUserDetailWithDateRequestBuilder.new(@path_parameters, @request_adapter, date)
        end
        ## 
        ## Provides operations to call the getFormsUserActivityUserDetail method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_forms_user_activity_user_detail_with_period_request_builder
        ## 
        def microsoft_graph_get_forms_user_activity_user_detail_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetFormsUserActivityUserDetailWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ...
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_relying_party_detailed_summary_with_period_request_builder
        ## 
        def microsoft_graph_get_relying_party_detailed_summary_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetRelyingPartyDetailedSummaryWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ...
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_device_usage_distribution_total_user_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_device_usage_distribution_total_user_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsDeviceUsageDistributionTotalUserCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ...
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_device_usage_total_user_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_device_usage_total_user_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsDeviceUsageTotalUserCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ...
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_team_activity_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_team_activity_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsTeamActivityCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getTeamsTeamActivityDetail method.
        ## @param date Usage: date={date}
        ## @return a microsoft_graph_get_teams_team_activity_detail_with_date_request_builder
        ## 
        def microsoft_graph_get_teams_team_activity_detail_with_date(date)
            raise StandardError, 'date cannot be null' if date.nil?
            return MicrosoftGraphGetTeamsTeamActivityDetailWithDateRequestBuilder.new(@path_parameters, @request_adapter, date)
        end
        ## 
        ## Provides operations to call the getTeamsTeamActivityDetail method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_team_activity_detail_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_team_activity_detail_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsTeamActivityDetailWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getTeamsTeamActivityDistributionCounts method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_team_activity_distribution_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_team_activity_distribution_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsTeamActivityDistributionCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getTeamsTeamCounts method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_team_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_team_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsTeamCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ...
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_user_activity_distribution_total_user_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_user_activity_distribution_total_user_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsUserActivityDistributionTotalUserCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getTeamsUserActivityDistributionUserCounts method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_user_activity_distribution_user_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_user_activity_distribution_user_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsUserActivityDistributionUserCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getTeamsUserActivityTotalCounts method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_user_activity_total_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_user_activity_total_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsUserActivityTotalCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getTeamsUserActivityTotalDistributionCounts method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_user_activity_total_distribution_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_user_activity_total_distribution_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsUserActivityTotalDistributionCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ## Provides operations to call the getTeamsUserActivityTotalUserCounts method.
        ## @param period Usage: period='{period}'
        ## @return a microsoft_graph_get_teams_user_activity_total_user_counts_with_period_request_builder
        ## 
        def microsoft_graph_get_teams_user_activity_total_user_counts_with_period(period)
            raise StandardError, 'period cannot be null' if period.nil?
            return MicrosoftGraphGetTeamsUserActivityTotalUserCountsWithPeriodRequestBuilder.new(@path_parameters, @request_adapter, period)
        end
        ## 
        ...
        ## @return a microsoft_graph_managed_device_enrollment_abandonment_details_with_skip_with_top_with_filter_with_skip_token_request_builder
        ## 
        def microsoft_graph_managed_device_enrollment_abandonment_details_with_skip_with_top_with_filter_with_skip_token(filter, skip, skip_token, top)
            ...
            return MicrosoftGraphManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder.new(@path_parameters, @request_adapter, filter, skip, skipToken, top)
        end
        ## 
        ...
        ## @param skipToken Usage: skipToken='{skipToken}'
        ## @param top Usage: top={top}
        ## @return a microsoft_graph_managed_device_enrollment_abandonment_summary_with_skip_with_top_with_filter_with_skip_token_request_builder
        ## 
        def microsoft_graph_managed_device_enrollment_abandonment_summary_with_skip_with_top_with_filter_with_skip_token(filter, skip, skip_token, top)
            raise StandardError, 'filter cannot be null' if filter.nil?
            raise StandardError, 'skip cannot be null' if skip.nil?
            raise StandardError, 'skip_token cannot be null' if skip_token.nil?
            raise StandardError, 'top cannot be null' if top.nil?
            return MicrosoftGraphManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTopWithFilterWithSkipTokenRequestBuilder.new(@path_parameters, @request_adapter, filter, skip, skipToken, top)
        end
        ## 
        ## Provides operations to call the managedDeviceEnrollmentFailureDetails method.
        ## @param filter Usage: filter='{filter}'
        ...
        def user_credential_usage_details_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::Reports::UserCredentialUsageDetails::Item::UserCredentialUsageDetailsItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
