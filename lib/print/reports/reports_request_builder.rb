        ...
        module Reports
            ...
            class ReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def device_configuration_device_activity()
                    return MicrosoftGraphBeta::Print::Reports::DeviceConfigurationDeviceActivity::DeviceConfigurationDeviceActivityRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the deviceConfigurationUserActivity method.
                def device_configuration_user_activity()
                    return MicrosoftGraphBeta::Print::Reports::DeviceConfigurationUserActivity::DeviceConfigurationUserActivityRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getAttackSimulationRepeatOffenders method.
                def get_attack_simulation_repeat_offenders()
                    return MicrosoftGraphBeta::Print::Reports::GetAttackSimulationRepeatOffenders::GetAttackSimulationRepeatOffendersRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getAttackSimulationSimulationUserCoverage method.
                def get_attack_simulation_simulation_user_coverage()
                    return MicrosoftGraphBeta::Print::Reports::GetAttackSimulationSimulationUserCoverage::GetAttackSimulationSimulationUserCoverageRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getAttackSimulationTrainingUserCoverage method.
                def get_attack_simulation_training_user_coverage()
                    return MicrosoftGraphBeta::Print::Reports::GetAttackSimulationTrainingUserCoverage::GetAttackSimulationTrainingUserCoverageRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getCredentialUserRegistrationCount method.
                def get_credential_user_registration_count()
                    return MicrosoftGraphBeta::Print::Reports::GetCredentialUserRegistrationCount::GetCredentialUserRegistrationCountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getOffice365ActivationCounts method.
                def get_office365_activation_counts()
                    return MicrosoftGraphBeta::Print::Reports::GetOffice365ActivationCounts::GetOffice365ActivationCountsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getOffice365ActivationsUserCounts method.
                def get_office365_activations_user_counts()
                    return MicrosoftGraphBeta::Print::Reports::GetOffice365ActivationsUserCounts::GetOffice365ActivationsUserCountsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the getOffice365ActivationsUserDetail method.
                def get_office365_activations_user_detail()
                    return MicrosoftGraphBeta::Print::Reports::GetOffice365ActivationsUserDetail::GetOffice365ActivationsUserDetailRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the managedDeviceEnrollmentFailureDetails method.
                def managed_device_enrollment_failure_details()
                    return MicrosoftGraphBeta::Print::Reports::ManagedDeviceEnrollmentFailureDetails::ManagedDeviceEnrollmentFailureDetailsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the managedDeviceEnrollmentFailureTrends method.
                def managed_device_enrollment_failure_trends()
                    return MicrosoftGraphBeta::Print::Reports::ManagedDeviceEnrollmentFailureTrends::ManagedDeviceEnrollmentFailureTrendsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the managedDeviceEnrollmentTopFailures method.
                def managed_device_enrollment_top_failures()
                    return MicrosoftGraphBeta::Print::Reports::ManagedDeviceEnrollmentTopFailures::ManagedDeviceEnrollmentTopFailuresRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/print/reports{?%24select,%24expand}")
                end
                ## 
                ## Provides operations to manage the credentialUserRegistrationDetails property of the microsoft.graph.reportRoot entity.
                ## @param id Unique identifier of the item
