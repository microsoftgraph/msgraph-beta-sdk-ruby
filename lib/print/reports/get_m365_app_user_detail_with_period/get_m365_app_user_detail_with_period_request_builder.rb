...
module MicrosoftGraphBeta::Print::Reports::GetM365AppUserDetailWithPeriod
    ## 
    ...
    class GetM365AppUserDetailWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/print/reports/microsoft.graph.getM365AppUserDetail(period='{period}')"
