            ...
            module Item
                module AllowedGroups
                    ...
                    class AllowedGroupsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Print::Shares::Item::AllowedGroups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the collection of print entities.
                        def ref()
                            return MicrosoftGraphBeta::Print::Shares::Item::AllowedGroups::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
