                    ...
                    module Item
                        ...
                        class GroupItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def service_provisioning_errors()
                                return MicrosoftGraphBeta::Print::Shares::Item::AllowedGroups::Item::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
