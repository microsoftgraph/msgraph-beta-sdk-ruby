                        ...
                        module Documents
                            module Item
                                ...
                                class PrintDocumentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def content()
                                        return MicrosoftGraphBeta::Print::Shares::Item::Jobs::Item::Documents::Item::Value::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the createUploadSession method.
                                    def create_upload_session()
                                        return MicrosoftGraphBeta::Print::Shares::Item::Jobs::Item::Documents::Item::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
