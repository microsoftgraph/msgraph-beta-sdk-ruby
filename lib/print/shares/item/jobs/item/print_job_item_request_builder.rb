                ...
                module Jobs
                    module Item
                        ...
                        class PrintJobItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def abort()
                                return MicrosoftGraphBeta::Print::Shares::Item::Jobs::Item::Abort::AbortRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the cancel method.
                            def cancel()
                                return MicrosoftGraphBeta::Print::Shares::Item::Jobs::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the cancelPrintJob method.
                            def cancel_print_job()
                                return MicrosoftGraphBeta::Print::Shares::Item::Jobs::Item::CancelPrintJob::CancelPrintJobRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the documents property of the microsoft.graph.printJob entity.
                            def documents()
                                return MicrosoftGraphBeta::Print::Shares::Item::Jobs::Item::Documents::DocumentsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the redirect method.
                            def redirect()
                                return MicrosoftGraphBeta::Print::Shares::Item::Jobs::Item::Redirect::RedirectRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the start method.
                            def start()
                                return MicrosoftGraphBeta::Print::Shares::Item::Jobs::Item::Start::StartRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the startPrintJob method.
                            def start_print_job()
                                return MicrosoftGraphBeta::Print::Shares::Item::Jobs::Item::StartPrintJob::StartPrintJobRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the tasks property of the microsoft.graph.printJob entity.
                            def tasks()
                                return MicrosoftGraphBeta::Print::Shares::Item::Jobs::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
