...
module MicrosoftGraphBeta::Print::Services::Item
    ## 
    ...
    class PrintServiceItemRequestBuilder
        ...
        def endpoints()
            return MicrosoftGraphBeta::Print::Services::Item::Endpoints::EndpointsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def endpoints_by_id(id)
            ...
            return MicrosoftGraphBeta::Print::Services::Item::Endpoints::Item::PrintServiceEndpointItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PrintService.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
