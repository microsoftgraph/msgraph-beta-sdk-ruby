...
module MicrosoftGraphBeta::Print::Printers
    ## 
    ...
    class PrintersRequestBuilder
        ...
        def microsoft_graph_create()
            return MicrosoftGraphBeta::Print::Printers::MicrosoftGraphCreate::MicrosoftGraphCreateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
