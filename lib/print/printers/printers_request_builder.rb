    ...
    module Print
        module Printers
            ...
            class PrintersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::Print::Printers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the create method.
                def create()
                    return MicrosoftGraphBeta::Print::Printers::Create::CreateRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the printers property of the microsoft.graph.print entity.
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::PrinterCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
