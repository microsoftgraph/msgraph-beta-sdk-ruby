...
module MicrosoftGraphBeta::Print::Printers::MicrosoftGraphCreate
    class CreatePostRequestBody
        ...
        def get_field_deserializers()
            return {
                "certificateSigningRequest" => lambda {|n| @certificate_signing_request = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PrintCertificateSigningRequest.create_from_discriminator_value(pn) }) },
