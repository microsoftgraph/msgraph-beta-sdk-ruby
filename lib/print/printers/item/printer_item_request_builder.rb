...
require_relative './get_capabilities/get_capabilities_request_builder'
require_relative './item'
require_relative './jobs/jobs_request_builder'
require_relative './reset_defaults/reset_defaults_request_builder'
            ...
            module Item
                ...
                class PrinterItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def get_capabilities()
                        return MicrosoftGraphBeta::Print::Printers::Item::GetCapabilities::GetCapabilitiesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the jobs property of the microsoft.graph.printerBase entity.
                    def jobs()
                        return MicrosoftGraphBeta::Print::Printers::Item::Jobs::JobsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the resetDefaults method.
                    def reset_defaults()
                        return MicrosoftGraphBeta::Print::Printers::Item::ResetDefaults::ResetDefaultsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the restoreFactoryDefaults method.
                    def restore_factory_defaults()
                        return MicrosoftGraphBeta::Print::Printers::Item::RestoreFactoryDefaults::RestoreFactoryDefaultsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
