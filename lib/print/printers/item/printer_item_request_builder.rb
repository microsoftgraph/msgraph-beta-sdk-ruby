...
require_relative './microsoft_graph_get_capabilities/microsoft_graph_get_capabilities_request_builder'
require_relative './microsoft_graph_reset_defaults/microsoft_graph_reset_defaults_request_builder'
            ...
            module Item
                ...
                class PrinterItemRequestBuilder
                    ...
                    def microsoft_graph_get_capabilities()
                        return MicrosoftGraphBeta::Print::Printers::Item::MicrosoftGraphGetCapabilities::MicrosoftGraphGetCapabilitiesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the resetDefaults method.
                    def microsoft_graph_reset_defaults()
                        return MicrosoftGraphBeta::Print::Printers::Item::MicrosoftGraphResetDefaults::MicrosoftGraphResetDefaultsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the restoreFactoryDefaults method.
                    def microsoft_graph_restore_factory_defaults()
                        return MicrosoftGraphBeta::Print::Printers::Item::MicrosoftGraphRestoreFactoryDefaults::MicrosoftGraphRestoreFactoryDefaultsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
