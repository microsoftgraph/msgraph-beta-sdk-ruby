...
module MicrosoftGraphBeta::Print::PrinterShares::Item::AllowedGroups::Item
    ## 
    ...
    class GroupItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, group_id=nil)
            ...
            @url_template = "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedGroups/{group%2Did}"
