...
module MicrosoftGraphBeta::Print::PrinterShares::Item::AllowedGroups
    ## 
    ...
    class AllowedGroupsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Print::PrinterShares::Item::AllowedGroups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def ref()
            return MicrosoftGraphBeta::Print::PrinterShares::Item::AllowedGroups::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
