...
module MicrosoftGraphBeta::Print::PrinterShares::Item::AllowedUsers::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedUsers/$count{?%24search,%24filter}"
