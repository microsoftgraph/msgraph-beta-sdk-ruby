...
module MicrosoftGraphBeta::Print::PrinterShares::Item::AllowedUsers::Item::Ref
    ## 
    ...
    class RefRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedUsers/{user%2Did}/$ref{?%40id*}"
