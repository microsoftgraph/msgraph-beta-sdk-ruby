                                ...
                                module CreateUploadSession
                                    class CreateUploadSessionPostRequestBody
                                        ...
                                        def get_field_deserializers()
                                            return {
                                                "properties" => lambda {|n| @properties = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::PrintDocumentUploadProperties.create_from_discriminator_value(pn) }) },
                                            }
                                        end
                                        ## 
