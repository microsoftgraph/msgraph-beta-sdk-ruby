...
module MicrosoftGraphBeta::DirectoryRoles::Item::Members::MicrosoftGraphGroup
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::DirectoryRoles::Item::Members::MicrosoftGraphGroup::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
