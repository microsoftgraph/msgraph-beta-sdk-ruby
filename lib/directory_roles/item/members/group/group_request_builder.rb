...
module MicrosoftGraphBeta::DirectoryRoles::Item::Members::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::DirectoryRoles::Item::Members::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
