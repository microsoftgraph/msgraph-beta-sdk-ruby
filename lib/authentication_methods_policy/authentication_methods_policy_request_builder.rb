...
module MicrosoftGraphBeta::AuthenticationMethodsPolicy
    ...
    class AuthenticationMethodsPolicyRequestBuilder
        ...
        def authentication_method_configurations()
            return MicrosoftGraphBeta::AuthenticationMethodsPolicy::AuthenticationMethodConfigurations::AuthenticationMethodConfigurationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AuthenticationMethodsPolicy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
