                    ...
                    module ExternalConnectorsAddActivities
                        ...
                        class ExternalConnectorsAddActivitiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}/externalConnectors.addActivities")
                            end
                            ## 
                            ...
                            def post(body, request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Connections::Item::Items::Item::ExternalConnectorsAddActivities::AddActivitiesResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Invoke action addActivities
                            ## @param body The request body
