...
module MicrosoftGraphBeta::Connections::Item::Items::Item
    ## 
    ...
    class ExternalItemItemRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Connections::Item::Items::Item::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addActivities method.
        def microsoft_graph_external_connectors_add_activities()
            return MicrosoftGraphBeta::Connections::Item::Items::Item::MicrosoftGraphExternalConnectorsAddActivities::AddActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def activities_by_id(id)
            ...
            return MicrosoftGraphBeta::Connections::Item::Items::Item::Activities::Item::ExternalActivityItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
