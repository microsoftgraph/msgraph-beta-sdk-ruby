...
module MicrosoftGraphBeta::Connections::Item::Items::Item
    ...
    class ExternalItemItemRequestBuilder
        ...
        def microsoft_graph_external_connectors_add_activities()
            return MicrosoftGraphBeta::Connections::Item::Items::Item::MicrosoftGraphExternalConnectorsAddActivities::MicrosoftGraphExternalConnectorsAddActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
