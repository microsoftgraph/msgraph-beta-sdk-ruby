...
module MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::Errors::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/synchronizationProfiles/{educationSynchronizationProfile%2Did}/errors/$count{?%24search,%24filter}"
