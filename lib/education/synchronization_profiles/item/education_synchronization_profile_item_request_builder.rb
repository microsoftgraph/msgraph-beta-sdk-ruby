...
require_relative './microsoft_graph_reset/microsoft_graph_reset_request_builder'
require_relative './microsoft_graph_resume/microsoft_graph_resume_request_builder'
require_relative './microsoft_graph_start/microsoft_graph_start_request_builder'
require_relative './microsoft_graph_upload_url/microsoft_graph_upload_url_request_builder'
...
module MicrosoftGraphBeta::Education::SynchronizationProfiles::Item
    ...
    class EducationSynchronizationProfileItemRequestBuilder
        ...
        def microsoft_graph_pause()
            return MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::MicrosoftGraphPause::MicrosoftGraphPauseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reset method.
        def microsoft_graph_reset()
            return MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::MicrosoftGraphReset::MicrosoftGraphResetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resume method.
        def microsoft_graph_resume()
            return MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::MicrosoftGraphResume::MicrosoftGraphResumeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the start method.
        def microsoft_graph_start()
            return MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::MicrosoftGraphStart::MicrosoftGraphStartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the uploadUrl method.
        def microsoft_graph_upload_url()
            return MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::MicrosoftGraphUploadUrl::MicrosoftGraphUploadUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
