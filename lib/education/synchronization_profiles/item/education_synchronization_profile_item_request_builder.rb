...
require_relative './errors/item/education_synchronization_error_item_request_builder'
require_relative './item'
require_relative './microsoft_graph_pause/pause_request_builder'
require_relative './microsoft_graph_reset/reset_request_builder'
require_relative './microsoft_graph_resume/resume_request_builder'
require_relative './microsoft_graph_start/start_request_builder'
require_relative './microsoft_graph_upload_url/upload_url_request_builder'
require_relative './profile_status/profile_status_request_builder'

module MicrosoftGraphBeta::Education::SynchronizationProfiles::Item
    ## 
    ...
    class EducationSynchronizationProfileItemRequestBuilder
        ...
        def microsoft_graph_pause()
            return MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::MicrosoftGraphPause::PauseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reset method.
        def microsoft_graph_reset()
            return MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::MicrosoftGraphReset::ResetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resume method.
        def microsoft_graph_resume()
            return MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::MicrosoftGraphResume::ResumeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the start method.
        def microsoft_graph_start()
            return MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::MicrosoftGraphStart::StartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the uploadUrl method.
        def microsoft_graph_upload_url()
            return MicrosoftGraphBeta::Education::SynchronizationProfiles::Item::MicrosoftGraphUploadUrl::UploadUrlRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param educationSynchronizationProfileId key: id of educationSynchronizationProfile
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, education_synchronization_profile_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/education/synchronizationProfiles/{educationSynchronizationProfile%2Did}{?%24select,%24expand}"
