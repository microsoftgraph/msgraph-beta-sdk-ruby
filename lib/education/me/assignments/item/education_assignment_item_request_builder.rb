...
module MicrosoftGraphBeta::Education::Me::Assignments::Item
    ...
    class EducationAssignmentItemRequestBuilder
        ...
        def microsoft_graph_publish()
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::MicrosoftGraphPublish::PublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setUpFeedbackResourcesFolder method.
        def microsoft_graph_set_up_feedback_resources_folder()
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::MicrosoftGraphSetUpFeedbackResourcesFolder::SetUpFeedbackResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setUpResourcesFolder method.
        def microsoft_graph_set_up_resources_folder()
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::MicrosoftGraphSetUpResourcesFolder::SetUpResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
