...
module MicrosoftGraphBeta::Education::Me::Assignments::Item
    ## 
    ...
    class EducationAssignmentItemRequestBuilder
        ...
        def microsoft_graph_publish()
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::MicrosoftGraphPublish::MicrosoftGraphPublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setUpFeedbackResourcesFolder method.
        def microsoft_graph_set_up_feedback_resources_folder()
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::MicrosoftGraphSetUpFeedbackResourcesFolder::MicrosoftGraphSetUpFeedbackResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setUpResourcesFolder method.
        def microsoft_graph_set_up_resources_folder()
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::MicrosoftGraphSetUpResourcesFolder::MicrosoftGraphSetUpResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        @url_template
        ## 
        ## Gets an item from the MicrosoftGraphBeta.education.me.assignments.item.categories.item collection
        ...
        def categories_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::Categories::Item::EducationCategoryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def resources_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::Resources::Item::EducationAssignmentResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the submissions property of the microsoft.graph.educationAssignment entity.
        ## @param id Unique identifier of the item
        ...
        def submissions_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::Submissions::Item::EducationSubmissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property assignments for education
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
