...
module MicrosoftGraphBeta::Education::Me::Assignments
    ## 
    ...
    class AssignmentsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Education::Me::Assignments::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
