...
module MicrosoftGraphBeta::Education::Me
    ## 
    ...
    class MeRequestBuilder
        ...
        def assignments()
            return MicrosoftGraphBeta::Education::Me::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the classes property of the microsoft.graph.educationUser entity.
        def classes()
            return MicrosoftGraphBeta::Education::Me::Classes::ClassesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def rubrics()
            return MicrosoftGraphBeta::Education::Me::Rubrics::RubricsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the schools property of the microsoft.graph.educationUser entity.
        def schools()
            return MicrosoftGraphBeta::Education::Me::Schools::SchoolsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the taughtClasses property of the microsoft.graph.educationUser entity.
        def taught_classes()
            return MicrosoftGraphBeta::Education::Me::TaughtClasses::TaughtClassesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraphBeta::Education::Me::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the assignments property of the microsoft.graph.educationUser entity.
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Me::Assignments::Item::EducationAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the classes property of the microsoft.graph.educationUser entity.
        ## @param id Unique identifier of the item
        ...
        def classes_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Me::Classes::Item::EducationClassItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def taught_classes_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["educationClass%2Did"] = id
            return MicrosoftGraphBeta::Education::Me::TaughtClasses::Item::EducationClassItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property me for education
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
