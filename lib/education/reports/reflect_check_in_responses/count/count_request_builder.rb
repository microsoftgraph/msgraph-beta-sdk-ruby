...
require_relative '../reflect_check_in_responses'
require_relative './count'

module MicrosoftGraphBeta
    module Education
        module Reports
            module ReflectCheckInResponses
                module Count
                    ## 
                    ...
                    class CountRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/education/reports/reflectCheckInResponses/$count{?%24filter,%24search}")
                        end
                        ## 
