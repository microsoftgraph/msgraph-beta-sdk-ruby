...
module MicrosoftGraphBeta::Education::Classes::Item
    ## 
    ...
    class EducationClassItemRequestBuilder
        ...
        def assignment_categories()
            return MicrosoftGraphBeta::Education::Classes::Item::AssignmentCategories::AssignmentCategoriesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignment_defaults()
            return MicrosoftGraphBeta::Education::Classes::Item::AssignmentDefaults::AssignmentDefaultsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the assignments property of the microsoft.graph.educationClass entity.
        def assignments()
            return MicrosoftGraphBeta::Education::Classes::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignment_settings()
            return MicrosoftGraphBeta::Education::Classes::Item::AssignmentSettings::AssignmentSettingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the group property of the microsoft.graph.educationClass entity.
        def group()
            return MicrosoftGraphBeta::Education::Classes::Item::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the members property of the microsoft.graph.educationClass entity.
        def members()
            return MicrosoftGraphBeta::Education::Classes::Item::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def schools()
            return MicrosoftGraphBeta::Education::Classes::Item::Schools::SchoolsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the teachers property of the microsoft.graph.educationClass entity.
        def teachers()
            return MicrosoftGraphBeta::Education::Classes::Item::Teachers::TeachersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignment_categories_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Classes::Item::AssignmentCategories::Item::EducationCategoryItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the assignments property of the microsoft.graph.educationClass entity.
        ## @param id Unique identifier of the item
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::EducationAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::EducationClass.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Gets an item from the MicrosoftGraphBeta.education.classes.item.members.item collection
        ## @param id Unique identifier of the item
        ...
        def members_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Classes::Item::Members::Item::EducationUserItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def schools_by_id(id)
            ...
            return MicrosoftGraphBeta::Education::Classes::Item::Schools::Item::EducationSchoolItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Gets an item from the MicrosoftGraphBeta.education.classes.item.teachers.item collection
        ## @param id Unique identifier of the item
        ## @return a education_user_item_request_builder
        ## 
        def teachers_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["educationUser%2Did"] = id
            return MicrosoftGraphBeta::Education::Classes::Item::Teachers::Item::EducationUserItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property classes for education
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
