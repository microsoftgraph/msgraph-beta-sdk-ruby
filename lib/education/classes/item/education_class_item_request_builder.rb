            ...
            module Item
                ...
                class EducationClassItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def get_recently_modified_submissions()
                        return MicrosoftGraphBeta::Education::Classes::Item::GetRecentlyModifiedSubmissions::GetRecentlyModifiedSubmissionsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def modules()
                        return MicrosoftGraphBeta::Education::Classes::Item::Modules::ModulesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
