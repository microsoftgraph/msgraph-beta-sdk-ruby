                ...
                module Modules
                    module Item
                        ...
                        class EducationModuleItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def pin()
                                return MicrosoftGraphBeta::Education::Classes::Item::Modules::Item::Pin::PinRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the publish method.
                            def publish()
                                return MicrosoftGraphBeta::Education::Classes::Item::Modules::Item::Publish::PublishRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the resources property of the microsoft.graph.educationModule entity.
                            def resources()
                                return MicrosoftGraphBeta::Education::Classes::Item::Modules::Item::Resources::ResourcesRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the setUpResourcesFolder method.
                            def set_up_resources_folder()
                                return MicrosoftGraphBeta::Education::Classes::Item::Modules::Item::SetUpResourcesFolder::SetUpResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the unpin method.
                            def unpin()
                                return MicrosoftGraphBeta::Education::Classes::Item::Modules::Item::Unpin::UnpinRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
