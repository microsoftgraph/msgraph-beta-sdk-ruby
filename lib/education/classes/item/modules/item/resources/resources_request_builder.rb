                    ...
                    module Item
                        module Resources
                            ...
                            class ResourcesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::Education::Classes::Item::Modules::Item::Resources::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the resources property of the microsoft.graph.educationModule entity.
                                ## @param education_module_resource_id Unique identifier of the item
                                ...
                                def by_education_module_resource_id(education_module_resource_id)
                                    ...
                                    return MicrosoftGraphBeta::Education::Classes::Item::Modules::Item::Resources::Item::EducationModuleResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
