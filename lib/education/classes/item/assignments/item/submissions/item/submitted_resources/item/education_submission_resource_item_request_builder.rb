                                    ...
                                    module Item
                                        ...
                                        class EducationSubmissionResourceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def dependent_resources()
                                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Submissions::Item::SubmittedResources::Item::DependentResources::DependentResourcesRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
