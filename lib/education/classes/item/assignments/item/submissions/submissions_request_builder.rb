                    ...
                    module Item
                        module Submissions
                            ...
                            class SubmissionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Submissions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the submissions property of the microsoft.graph.educationAssignment entity.
                                ...
                                def by_education_submission_id(education_submission_id)
                                    ...
                                    return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Submissions::Item::EducationSubmissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
                                ...
                                def get(request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::EducationSubmissionCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
