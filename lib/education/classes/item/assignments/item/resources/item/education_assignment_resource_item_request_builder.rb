                            ...
                            module Item
                                ...
                                class EducationAssignmentResourceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def dependent_resources()
                                        return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Resources::Item::DependentResources::DependentResourcesRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
