                ...
                module Assignments
                    module Item
                        ...
                        class EducationAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def activate()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Activate::ActivateRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the categories property of the microsoft.graph.educationAssignment entity.
                            def categories()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Categories::CategoriesRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the deactivate method.
                            def deactivate()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Deactivate::DeactivateRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def grading_category()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::GradingCategory::GradingCategoryRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the gradingScheme property of the microsoft.graph.educationAssignment entity.
                            def grading_scheme()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::GradingScheme::GradingSchemeRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the publish method.
                            def publish()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Publish::PublishRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the resources property of the microsoft.graph.educationAssignment entity.
                            def resources()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Resources::ResourcesRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the rubric property of the microsoft.graph.educationAssignment entity.
                            def rubric()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Rubric::RubricRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the setUpFeedbackResourcesFolder method.
                            def set_up_feedback_resources_folder()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::SetUpFeedbackResourcesFolder::SetUpFeedbackResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the setUpResourcesFolder method.
                            def set_up_resources_folder()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::SetUpResourcesFolder::SetUpResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the submissions property of the microsoft.graph.educationAssignment entity.
                            def submissions()
                                return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Item::Submissions::SubmissionsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
