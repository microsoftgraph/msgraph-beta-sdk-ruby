            ...
            module Item
                module Assignments
                    ...
                    class AssignmentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the delta method.
                        def delta()
                            return MicrosoftGraphBeta::Education::Classes::Item::Assignments::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the assignments property of the microsoft.graph.educationClass entity.
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::EducationAssignmentCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
