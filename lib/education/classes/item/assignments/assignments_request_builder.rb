...
module MicrosoftGraphBeta::Education::Classes::Item::Assignments
    ## 
    ...
    class AssignmentsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Education::Classes::Item::Assignments::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
