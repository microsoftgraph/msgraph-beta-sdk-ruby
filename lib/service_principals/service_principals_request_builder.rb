...
module MicrosoftGraphBeta
    module ServicePrincipals
        ...
        class ServicePrincipalsRequestBuilder
            ...
            def delta()
                return MicrosoftGraphBeta::ServicePrincipals::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the getByIds method.
            def get_by_ids()
                return MicrosoftGraphBeta::ServicePrincipals::GetByIds::GetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the getUserOwnedObjects method.
            def get_user_owned_objects()
                return MicrosoftGraphBeta::ServicePrincipals::GetUserOwnedObjects::GetUserOwnedObjectsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def validate_properties()
                return MicrosoftGraphBeta::ServicePrincipals::ValidateProperties::ValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
