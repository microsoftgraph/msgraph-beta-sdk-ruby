...
module MicrosoftGraphBeta::ServicePrincipals::Item::Oauth2PermissionGrants
    ## 
    ...
    class Oauth2PermissionGrantsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Oauth2PermissionGrants::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
