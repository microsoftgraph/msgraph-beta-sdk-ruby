...
module MicrosoftGraphBeta::ServicePrincipals::Item::HomeRealmDiscoveryPolicies::Item
    ## 
    ...
    class HomeRealmDiscoveryPolicyItemRequestBuilder
        ...
        def ref()
            return MicrosoftGraphBeta::ServicePrincipals::Item::HomeRealmDiscoveryPolicies::Item::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
