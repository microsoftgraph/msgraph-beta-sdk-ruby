            ...
            module RemoteDesktopSecurityConfiguration
                module TargetDeviceGroups
                    ...
                    class TargetDeviceGroupsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::ServicePrincipals::Item::RemoteDesktopSecurityConfiguration::TargetDeviceGroups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the targetDeviceGroups property of the microsoft.graph.remoteDesktopSecurityConfiguration entity.
                        ...
                        def by_target_device_group_id(target_device_group_id)
                            ...
                            return MicrosoftGraphBeta::ServicePrincipals::Item::RemoteDesktopSecurityConfiguration::TargetDeviceGroups::Item::TargetDeviceGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::TargetDeviceGroupCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
