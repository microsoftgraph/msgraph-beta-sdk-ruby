            ...
            module RemoteDesktopSecurityConfiguration
                ...
                class RemoteDesktopSecurityConfigurationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def target_device_groups()
                        return MicrosoftGraphBeta::ServicePrincipals::Item::RemoteDesktopSecurityConfiguration::TargetDeviceGroups::TargetDeviceGroupsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        error_mapping = Hash.new
                        error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::RemoteDesktopSecurityConfiguration.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
