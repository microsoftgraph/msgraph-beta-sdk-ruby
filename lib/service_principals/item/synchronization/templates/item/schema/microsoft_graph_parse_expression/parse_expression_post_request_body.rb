...
require_relative './microsoft_graph_parse_expression'

module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Templates::Item::Schema::MicrosoftGraphParseExpression
    class ParseExpressionPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "targetAttributeDefinition" => lambda {|n| @target_attribute_definition = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::AttributeDefinition.create_from_discriminator_value(pn) }) },
                "testInputObject" => lambda {|n| @test_input_object = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ExpressionInputObject.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
