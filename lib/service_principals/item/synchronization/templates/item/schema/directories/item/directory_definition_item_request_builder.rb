...
module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Templates::Item::Schema::Directories::Item
    ...
    class DirectoryDefinitionItemRequestBuilder
        ...
        def microsoft_graph_discover()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Templates::Item::Schema::Directories::Item::MicrosoftGraphDiscover::DiscoverRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
