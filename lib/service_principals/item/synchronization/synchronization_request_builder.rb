...
require_relative './microsoft_graph_acquire_access_token/acquire_access_token_request_builder'
require_relative './microsoft_graph_ping/ping_request_builder'
...
module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization
    ...
    class SynchronizationRequestBuilder
        ...
        def microsoft_graph_acquire_access_token()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::MicrosoftGraphAcquireAccessToken::AcquireAccessTokenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the Ping method.
        def microsoft_graph_ping()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::MicrosoftGraphPing::PingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
