...
require_relative './microsoft_graph_acquire_access_token/microsoft_graph_acquire_access_token_request_builder'
require_relative './microsoft_graph_ping/microsoft_graph_ping_request_builder'
...
module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization
    ## 
    ...
    class SynchronizationRequestBuilder
        ...
        def jobs()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::JobsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the acquireAccessToken method.
        def microsoft_graph_acquire_access_token()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::MicrosoftGraphAcquireAccessToken::MicrosoftGraphAcquireAccessTokenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the Ping method.
        def microsoft_graph_ping()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::MicrosoftGraphPing::MicrosoftGraphPingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def secrets()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Secrets::SecretsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the templates property of the microsoft.graph.synchronization entity.
        def templates()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Templates::TemplatesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization{?%24select,%24expand}"
        ...
        def jobs_by_id(id)
            ...
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::Item::SynchronizationJobItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def templates_by_id(id)
            ...
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Templates::Item::SynchronizationTemplateItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property synchronization for servicePrincipals
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
