...
require_relative '../item'
require_relative './microsoft_graph_provision_on_demand'

module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::Item::MicrosoftGraphProvisionOnDemand
    class ProvisionOnDemandPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "parameters" => lambda {|n| @parameters = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationJobApplicationParameters.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
