...
module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::Item::MicrosoftGraphStart
    ## 
    ...
    class StartRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/microsoft.graph.start"
