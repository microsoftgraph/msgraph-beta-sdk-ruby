...
require_relative '../item'
require_relative './microsoft_graph_pause'

module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::Item::MicrosoftGraphPause
    ## 
    ...
    class PauseRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/microsoft.graph.pause"
