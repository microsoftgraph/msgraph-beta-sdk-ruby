...
module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::Item::Schema::Directories::Item
    ...
    class DirectoryDefinitionItemRequestBuilder
        ...
        def microsoft_graph_discover()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::Item::Schema::Directories::Item::MicrosoftGraphDiscover::DiscoverRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
