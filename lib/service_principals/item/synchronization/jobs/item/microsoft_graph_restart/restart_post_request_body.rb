...
require_relative '../item'
require_relative './microsoft_graph_restart'

module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::Item::MicrosoftGraphRestart
    class RestartPostRequestBody
        ...
        def get_field_deserializers()
            return {
                "criteria" => lambda {|n| @criteria = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationJobRestartCriteria.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
