...
module MicrosoftGraphBeta::ServicePrincipals::Item::Synchronization::Jobs::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/$count{?%24search,%24filter}"
