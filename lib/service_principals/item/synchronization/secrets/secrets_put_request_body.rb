                ...
                module Secrets
                    class SecretsPutRequestBody
                        ...
                        def get_field_deserializers()
                            return {
                                "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::SynchronizationSecretKeyStringValuePair.create_from_discriminator_value(pn) }) },
                            }
                        end
                        ## 
