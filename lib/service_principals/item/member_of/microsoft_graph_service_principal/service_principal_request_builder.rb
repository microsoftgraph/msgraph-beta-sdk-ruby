...
module MicrosoftGraphBeta::ServicePrincipals::Item::MemberOf::MicrosoftGraphServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MemberOf::MicrosoftGraphServicePrincipal::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
