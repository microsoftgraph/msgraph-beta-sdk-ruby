...
module MicrosoftGraphBeta::ServicePrincipals::Item::MemberOf::MicrosoftGraphUser
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MemberOf::MicrosoftGraphUser::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
