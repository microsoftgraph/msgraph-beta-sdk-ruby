                ...
                module Item
                    ...
                    class DirectoryObjectItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def graph_administrative_unit()
                            return MicrosoftGraphBeta::ServicePrincipals::Item::MemberOf::Item::GraphAdministrativeUnit::GraphAdministrativeUnitRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Casts the previous resource to directoryRole.
                        def graph_directory_role()
                            return MicrosoftGraphBeta::ServicePrincipals::Item::MemberOf::Item::GraphDirectoryRole::GraphDirectoryRoleRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Casts the previous resource to group.
                        def graph_group()
                            return MicrosoftGraphBeta::ServicePrincipals::Item::MemberOf::Item::GraphGroup::GraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
