...
module MicrosoftGraphBeta::ServicePrincipals::Item::ClaimsMappingPolicies::Item
    ## 
    ...
    class ClaimsMappingPolicyItemRequestBuilder
        ...
        def ref()
            return MicrosoftGraphBeta::ServicePrincipals::Item::ClaimsMappingPolicies::Item::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
