                ...
                module Item
                    ...
                    class DirectoryObjectItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def graph_service_principal()
                            return MicrosoftGraphBeta::ServicePrincipals::Item::CreatedObjects::Item::GraphServicePrincipal::GraphServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
