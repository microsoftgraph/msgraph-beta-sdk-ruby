...
module MicrosoftGraphBeta::ServicePrincipals::Item::CreatedObjects::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def service_principal()
            return MicrosoftGraphBeta::ServicePrincipals::Item::CreatedObjects::Item::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
