...
module MicrosoftGraphBeta::ServicePrincipals::Item::CreatedObjects::Item
    ## 
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def microsoft_graph_service_principal()
            return MicrosoftGraphBeta::ServicePrincipals::Item::CreatedObjects::Item::MicrosoftGraphServicePrincipal::MicrosoftGraphServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
