            ...
            module CreatedObjects
                ...
                class CreatedObjectsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def graph_service_principal()
                        return MicrosoftGraphBeta::ServicePrincipals::Item::CreatedObjects::GraphServicePrincipal::GraphServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the createdObjects property of the microsoft.graph.servicePrincipal entity.
