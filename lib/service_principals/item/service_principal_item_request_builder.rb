...
require_relative './claims_policy/claims_policy_request_builder'
    ...
    module ServicePrincipals
        module Item
            ...
            class ServicePrincipalItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def claims_policy()
                    return MicrosoftGraphBeta::ServicePrincipals::Item::ClaimsPolicy::ClaimsPolicyRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def permission_grant_pre_approval_policies()
                    return MicrosoftGraphBeta::ServicePrincipals::Item::PermissionGrantPreApprovalPolicies::PermissionGrantPreApprovalPoliciesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def remote_desktop_security_configuration()
                    return MicrosoftGraphBeta::ServicePrincipals::Item::RemoteDesktopSecurityConfiguration::RemoteDesktopSecurityConfigurationRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
