...
require_relative './microsoft_graph_create_password_single_sign_on_credentials/microsoft_graph_create_password_single_sign_on_credentials_request_builder'
require_relative './microsoft_graph_delete_password_single_sign_on_credentials/microsoft_graph_delete_password_single_sign_on_credentials_request_builder'
...
require_relative './microsoft_graph_get_password_single_sign_on_credentials/microsoft_graph_get_password_single_sign_on_credentials_request_builder'
require_relative './microsoft_graph_restore/microsoft_graph_restore_request_builder'
require_relative './microsoft_graph_update_password_single_sign_on_credentials/microsoft_graph_update_password_single_sign_on_credentials_request_builder'
...
module MicrosoftGraphBeta::ServicePrincipals::Item
    ...
    class ServicePrincipalItemRequestBuilder
        ...
        def microsoft_graph_add_token_signing_certificate()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphAddTokenSigningCertificate::MicrosoftGraphAddTokenSigningCertificateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberGroups method.
        def microsoft_graph_check_member_groups()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphCheckMemberGroups::MicrosoftGraphCheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def microsoft_graph_check_member_objects()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphCheckMemberObjects::MicrosoftGraphCheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createPasswordSingleSignOnCredentials method.
        def microsoft_graph_create_password_single_sign_on_credentials()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphCreatePasswordSingleSignOnCredentials::MicrosoftGraphCreatePasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the deletePasswordSingleSignOnCredentials method.
        def microsoft_graph_delete_password_single_sign_on_credentials()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphDeletePasswordSingleSignOnCredentials::MicrosoftGraphDeletePasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberGroups method.
        def microsoft_graph_get_member_groups()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphGetMemberGroups::MicrosoftGraphGetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def microsoft_graph_get_member_objects()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphGetMemberObjects::MicrosoftGraphGetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getPasswordSingleSignOnCredentials method.
        def microsoft_graph_get_password_single_sign_on_credentials()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphGetPasswordSingleSignOnCredentials::MicrosoftGraphGetPasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphRestore::MicrosoftGraphRestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updatePasswordSingleSignOnCredentials method.
        def microsoft_graph_update_password_single_sign_on_credentials()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphUpdatePasswordSingleSignOnCredentials::MicrosoftGraphUpdatePasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
