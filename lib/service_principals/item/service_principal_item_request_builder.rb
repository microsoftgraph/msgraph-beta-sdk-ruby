...
require_relative './microsoft_graph_create_password_single_sign_on_credentials/create_password_single_sign_on_credentials_request_builder'
require_relative './microsoft_graph_delete_password_single_sign_on_credentials/delete_password_single_sign_on_credentials_request_builder'
...
require_relative './microsoft_graph_get_password_single_sign_on_credentials/get_password_single_sign_on_credentials_request_builder'
require_relative './microsoft_graph_restore/restore_request_builder'
require_relative './microsoft_graph_update_password_single_sign_on_credentials/update_password_single_sign_on_credentials_request_builder'
...
module MicrosoftGraphBeta::ServicePrincipals::Item
    ...
    class ServicePrincipalItemRequestBuilder
        ...
        def microsoft_graph_add_token_signing_certificate()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphAddTokenSigningCertificate::AddTokenSigningCertificateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberGroups method.
        def microsoft_graph_check_member_groups()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphCheckMemberGroups::CheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def microsoft_graph_check_member_objects()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphCheckMemberObjects::CheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_create_password_single_sign_on_credentials()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphCreatePasswordSingleSignOnCredentials::CreatePasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_delete_password_single_sign_on_credentials()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphDeletePasswordSingleSignOnCredentials::DeletePasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberGroups method.
        def microsoft_graph_get_member_groups()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphGetMemberGroups::GetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def microsoft_graph_get_member_objects()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphGetMemberObjects::GetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_get_password_single_sign_on_credentials()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphGetPasswordSingleSignOnCredentials::GetPasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphRestore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_update_password_single_sign_on_credentials()
            return MicrosoftGraphBeta::ServicePrincipals::Item::MicrosoftGraphUpdatePasswordSingleSignOnCredentials::UpdatePasswordSingleSignOnCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
