...
module MicrosoftGraphBeta::ServicePrincipals::Item::Owners
    ...
    class OwnersRequestBuilder
        ...
        def microsoft_graph_endpoint()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::MicrosoftGraphEndpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to servicePrincipal.
        def microsoft_graph_service_principal()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::MicrosoftGraphServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::MicrosoftGraphUser::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
