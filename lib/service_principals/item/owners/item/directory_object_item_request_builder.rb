...
module MicrosoftGraphBeta::ServicePrincipals::Item::Owners::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def microsoft_graph_endpoint()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::Item::MicrosoftGraphEndpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to servicePrincipal.
        def microsoft_graph_service_principal()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::Item::MicrosoftGraphServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraphBeta::ServicePrincipals::Item::Owners::Item::MicrosoftGraphUser::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
