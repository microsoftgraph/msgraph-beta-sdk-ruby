...
module MicrosoftGraphBeta::ServicePrincipals::Item::TransitiveMemberOf::MicrosoftGraphGroup
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::TransitiveMemberOf::MicrosoftGraphGroup::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
