            ...
            module TransitiveMemberOf
                module GraphAdministrativeUnit
                    ...
                    class GraphAdministrativeUnitRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::ServicePrincipals::Item::TransitiveMemberOf::GraphAdministrativeUnit::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
