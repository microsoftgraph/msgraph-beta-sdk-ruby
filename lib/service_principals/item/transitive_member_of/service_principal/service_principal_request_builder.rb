...
module MicrosoftGraphBeta::ServicePrincipals::Item::TransitiveMemberOf::ServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::TransitiveMemberOf::ServicePrincipal::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
