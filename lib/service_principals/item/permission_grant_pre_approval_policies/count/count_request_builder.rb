...
require_relative '../permission_grant_pre_approval_policies'
require_relative './count'

module MicrosoftGraphBeta
    module ServicePrincipals
        module Item
            module PermissionGrantPreApprovalPolicies
                module Count
                    ## 
                    ...
                    class CountRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/permissionGrantPreApprovalPolicies/$count{?%24filter,%24search}")
                        end
                        ## 
