...
module MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::Endpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::Endpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
