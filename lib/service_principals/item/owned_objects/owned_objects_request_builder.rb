            ...
            module OwnedObjects
                ...
                class OwnedObjectsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def graph_application()
                        return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::GraphApplication::GraphApplicationRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to appRoleAssignment.
                    def graph_app_role_assignment()
                        return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::GraphAppRoleAssignment::GraphAppRoleAssignmentRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to endpoint.
                    def graph_endpoint()
                        return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::GraphEndpoint::GraphEndpointRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to group.
                    def graph_group()
                        return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::GraphGroup::GraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to servicePrincipal.
                    def graph_service_principal()
                        return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::GraphServicePrincipal::GraphServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the ownedObjects property of the microsoft.graph.servicePrincipal entity.
