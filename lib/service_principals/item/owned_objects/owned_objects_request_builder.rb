...
module MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects
    ...
    class OwnedObjectsRequestBuilder
        ...
        def microsoft_graph_application()
            return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphApplication::MicrosoftGraphApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def microsoft_graph_endpoint()
            return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphEndpoint::MicrosoftGraphEndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def microsoft_graph_group()
            return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphGroup::MicrosoftGraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to servicePrincipal.
        def microsoft_graph_service_principal()
            return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphServicePrincipal::MicrosoftGraphServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
