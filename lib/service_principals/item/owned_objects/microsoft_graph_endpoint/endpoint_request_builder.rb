...
module MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphEndpoint
    ## 
    ...
    class EndpointRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphEndpoint::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
