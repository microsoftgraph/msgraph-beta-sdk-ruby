...
module MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphApplication
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphApplication::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
