...
module MicrosoftGraphBeta::ServicePrincipals::Item::DeletePasswordSingleSignOnCredentials
    ## 
    ...
    class DeletePasswordSingleSignOnCredentialsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/microsoft.graph.deletePasswordSingleSignOnCredentials"
