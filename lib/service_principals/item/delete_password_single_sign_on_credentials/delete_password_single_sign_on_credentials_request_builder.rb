    ...
    module ServicePrincipals
        module Item
            module DeletePasswordSingleSignOnCredentials
                ...
                class DeletePasswordSingleSignOnCredentialsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/deletePasswordSingleSignOnCredentials")
                    end
                    ## 
                    ...
                    ## @return a delete_password_single_sign_on_credentials_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return DeletePasswordSingleSignOnCredentialsRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
