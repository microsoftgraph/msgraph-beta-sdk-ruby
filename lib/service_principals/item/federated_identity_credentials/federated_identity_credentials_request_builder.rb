...
module MicrosoftGraphBeta::ServicePrincipals::Item::FederatedIdentityCredentials
    ## 
    ...
    class FederatedIdentityCredentialsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::ServicePrincipals::Item::FederatedIdentityCredentials::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
