...
module MicrosoftGraphBeta::ServicePrincipals::MicrosoftGraphGetUserOwnedObjects
    ## 
    ...
    class MicrosoftGraphGetUserOwnedObjectsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/microsoft.graph.getUserOwnedObjects"
