    ...
    module Teams
        module Item
            module TemplateDefinition
                ...
                class TemplateDefinitionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/teams/{team%2Did}/templateDefinition{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    ## @return a template_definition_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return TemplateDefinitionRequestBuilder.new(raw_url, @request_adapter)
                    end
