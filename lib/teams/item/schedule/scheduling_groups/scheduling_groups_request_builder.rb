            ...
            module Schedule
                module SchedulingGroups
                    ...
                    class SchedulingGroupsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Teams::Item::Schedule::SchedulingGroups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the schedulingGroups property of the microsoft.graph.schedule entity.
                        ...
                        def by_scheduling_group_id(scheduling_group_id)
                            ...
                            return MicrosoftGraphBeta::Teams::Item::Schedule::SchedulingGroups::Item::SchedulingGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
