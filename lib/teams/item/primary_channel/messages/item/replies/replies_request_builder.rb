...
module MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages::Item::Replies
    ## 
    ...
    class RepliesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages::Item::Replies::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
