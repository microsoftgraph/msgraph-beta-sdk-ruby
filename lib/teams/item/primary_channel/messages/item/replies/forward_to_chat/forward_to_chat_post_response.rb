                    ...
                    module Item
                        module Replies
                            module ForwardToChat
                                class ForwardToChatPostResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                                    ...
                                    ## @return a forward_to_chat_post_response
                                    ## 
                                    def self.create_from_discriminator_value(parse_node)
                                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                        return ForwardToChatPostResponse.new
                                    end
                                    ## 
