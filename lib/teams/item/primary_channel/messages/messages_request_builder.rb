...
module MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages
    ...
    class MessagesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Messages::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
