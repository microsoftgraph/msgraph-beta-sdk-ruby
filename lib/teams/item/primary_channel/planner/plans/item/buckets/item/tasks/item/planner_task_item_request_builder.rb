                                        ...
                                        module Item
                                            ...
                                            class PlannerTaskItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def assigned_to_task_board_format()
                                                    return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Planner::Plans::Item::Buckets::Item::Tasks::Item::AssignedToTaskBoardFormat::AssignedToTaskBoardFormatRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                # Provides operations to manage the bucketTaskBoardFormat property of the microsoft.graph.plannerTask entity.
                                                def bucket_task_board_format()
                                                    return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Planner::Plans::Item::Buckets::Item::Tasks::Item::BucketTaskBoardFormat::BucketTaskBoardFormatRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                # Provides operations to manage the details property of the microsoft.graph.plannerTask entity.
                                                def details()
                                                    return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Planner::Plans::Item::Buckets::Item::Tasks::Item::Details::DetailsRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                # Provides operations to manage the progressTaskBoardFormat property of the microsoft.graph.plannerTask entity.
                                                def progress_task_board_format()
                                                    return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Planner::Plans::Item::Buckets::Item::Tasks::Item::ProgressTaskBoardFormat::ProgressTaskBoardFormatRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/teams/{team%2Did}/primaryChannel/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}{?%24expand,%24select}")
                                                end
                                                ## 
