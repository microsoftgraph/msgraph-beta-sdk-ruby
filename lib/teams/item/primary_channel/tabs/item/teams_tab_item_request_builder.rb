...
module MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Tabs::Item
    ## 
    ...
    class TeamsTabItemRequestBuilder
        ...
        def teams_app()
            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::Tabs::Item::TeamsApp::TeamsAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
