            ...
            module PrimaryChannel
                module FilesFolder
                    ...
                    class FilesFolderRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def content()
                            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::FilesFolder::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the media for the team entity.
                        def content_stream()
                            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::FilesFolder::ContentStream::ContentStreamRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
