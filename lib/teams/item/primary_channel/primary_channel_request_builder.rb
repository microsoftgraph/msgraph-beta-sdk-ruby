...
module MicrosoftGraphBeta::Teams::Item::PrimaryChannel
    ...
    class PrimaryChannelRequestBuilder
        ...
        def microsoft_graph_does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name()
            return MicrosoftGraphBeta::Teams::Item::PrimaryChannel::I36f5b8477c6e0b8381f1fe57d51b36baa914f57f3b0c51db1cfca75bc34f6227::MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
