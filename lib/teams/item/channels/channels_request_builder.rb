...
module MicrosoftGraphBeta::Teams::Item::Channels
    ...
    class ChannelsRequestBuilder
        ...
        def microsoft_graph_all_messages()
            return MicrosoftGraphBeta::Teams::Item::Channels::MicrosoftGraphAllMessages::MicrosoftGraphAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAllMessages method.
        def microsoft_graph_get_all_messages()
            return MicrosoftGraphBeta::Teams::Item::Channels::MicrosoftGraphGetAllMessages::MicrosoftGraphGetAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
