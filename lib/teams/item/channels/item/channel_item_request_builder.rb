...
module MicrosoftGraphBeta::Teams::Item::Channels::Item
    ## 
    ...
    class ChannelItemRequestBuilder
        ...
        def files_folder()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::FilesFolder::FilesFolderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the members property of the microsoft.graph.channel entity.
        def members()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the messages property of the microsoft.graph.channel entity.
        def messages()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Messages::MessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the completeMigration method.
        def microsoft_graph_complete_migration()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::MicrosoftGraphCompleteMigration::MicrosoftGraphCompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName::MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the provisionEmail method.
        def microsoft_graph_provision_email()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::MicrosoftGraphProvisionEmail::MicrosoftGraphProvisionEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeEmail method.
        def microsoft_graph_remove_email()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::MicrosoftGraphRemoveEmail::MicrosoftGraphRemoveEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def shared_with_teams()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::SharedWithTeams::SharedWithTeamsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the tabs property of the microsoft.graph.channel entity.
        def tabs()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Tabs::TabsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def members_by_id(id)
            ...
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Members::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the messages property of the microsoft.graph.channel entity.
        ## @param id Unique identifier of the item
        ...
        def shared_with_teams_by_id(id)
            ...
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::SharedWithTeams::Item::SharedWithChannelTeamInfoItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tabs property of the microsoft.graph.channel entity.
        ## @param id Unique identifier of the item
        ...
        def tabs_by_id(id)
            ...
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Tabs::Item::TeamsTabItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property channels for teams
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
