...
module MicrosoftGraphBeta::Teams::Item::Channels::Item::SharedWithTeams::Item::AllowedMembers
    ## 
    ...
    class AllowedMembersRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::SharedWithTeams::Item::AllowedMembers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
