...
module MicrosoftGraphBeta::Teams::Item::Channels::Item::Messages
    ## 
    ...
    class MessagesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Teams::Item::Channels::Item::Messages::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
