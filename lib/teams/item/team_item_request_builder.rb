...
module MicrosoftGraphBeta::Teams::Item
    ...
    class TeamItemRequestBuilder
        ...
        def microsoft_graph_archive()
            return MicrosoftGraphBeta::Teams::Item::MicrosoftGraphArchive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the clone method.
        def microsoft_graph_clone()
            return MicrosoftGraphBeta::Teams::Item::MicrosoftGraphClone::CloneRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the completeMigration method.
        def microsoft_graph_complete_migration()
            return MicrosoftGraphBeta::Teams::Item::MicrosoftGraphCompleteMigration::CompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendActivityNotification method.
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraphBeta::Teams::Item::MicrosoftGraphSendActivityNotification::SendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unarchive method.
        def microsoft_graph_unarchive()
            return MicrosoftGraphBeta::Teams::Item::MicrosoftGraphUnarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
