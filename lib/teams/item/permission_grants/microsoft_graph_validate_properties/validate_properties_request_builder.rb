...
module MicrosoftGraphBeta::Teams::Item::PermissionGrants::MicrosoftGraphValidateProperties
    ## 
    ...
    class ValidatePropertiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/permissionGrants/microsoft.graph.validateProperties"
