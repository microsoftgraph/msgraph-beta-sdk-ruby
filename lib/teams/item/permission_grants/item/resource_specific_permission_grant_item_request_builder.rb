...
module MicrosoftGraphBeta::Teams::Item::PermissionGrants::Item
    ...
    class ResourceSpecificPermissionGrantItemRequestBuilder
        ...
        def check_member_groups()
            return MicrosoftGraphBeta::Teams::Item::PermissionGrants::Item::CheckMemberGroups::CheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def check_member_objects()
            return MicrosoftGraphBeta::Teams::Item::PermissionGrants::Item::CheckMemberObjects::CheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberGroups method.
        def get_member_groups()
            return MicrosoftGraphBeta::Teams::Item::PermissionGrants::Item::GetMemberGroups::GetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def get_member_objects()
            return MicrosoftGraphBeta::Teams::Item::PermissionGrants::Item::GetMemberObjects::GetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore()
            return MicrosoftGraphBeta::Teams::Item::PermissionGrants::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
