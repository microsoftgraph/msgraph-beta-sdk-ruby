        ...
        module Item
            ...
            class GovernanceRoleAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def linked_eligible_role_assignment()
                    return MicrosoftGraphBeta::GovernanceRoleAssignments::Item::LinkedEligibleRoleAssignment::LinkedEligibleRoleAssignmentRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the resource property of the microsoft.graph.governanceRoleAssignment entity.
                def resource()
                    return MicrosoftGraphBeta::GovernanceRoleAssignments::Item::Resource::ResourceRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the roleDefinition property of the microsoft.graph.governanceRoleAssignment entity.
                def role_definition()
                    return MicrosoftGraphBeta::GovernanceRoleAssignments::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the subject property of the microsoft.graph.governanceRoleAssignment entity.
                def subject()
                    return MicrosoftGraphBeta::GovernanceRoleAssignments::Item::Subject::SubjectRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}'
