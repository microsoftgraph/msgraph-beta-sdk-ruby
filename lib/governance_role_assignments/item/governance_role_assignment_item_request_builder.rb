...
module MicrosoftGraphBeta::GovernanceRoleAssignments::Item
    ## 
    ...
    class GovernanceRoleAssignmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}{?%24select,%24expand}"
