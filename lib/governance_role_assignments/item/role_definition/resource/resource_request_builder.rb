...
module MicrosoftGraphBeta::GovernanceRoleAssignments::Item::RoleDefinition::Resource
    ## 
    ...
    class ResourceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}/roleDefinition/resource{?%24select,%24expand}"
