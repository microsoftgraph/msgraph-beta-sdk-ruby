...
require_relative './shared_email_domain_invitations/item/shared_email_domain_invitation_item_request_builder'
...
module MicrosoftGraphBeta::Domains::Item
    ## 
    ...
    class DomainItemRequestBuilder
        ...
        def microsoft_graph_force_delete()
            return MicrosoftGraphBeta::Domains::Item::MicrosoftGraphForceDelete::MicrosoftGraphForceDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the promote method.
        def microsoft_graph_promote()
            return MicrosoftGraphBeta::Domains::Item::MicrosoftGraphPromote::MicrosoftGraphPromoteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the verify method.
        def microsoft_graph_verify()
            return MicrosoftGraphBeta::Domains::Item::MicrosoftGraphVerify::MicrosoftGraphVerifyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def domain_name_references_by_id(id)
            ...
            return MicrosoftGraphBeta::Domains::Item::DomainNameReferences::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the federationConfiguration property of the microsoft.graph.domain entity.
        ## @param id Unique identifier of the item
        ...
        def federation_configuration_by_id(id)
            ...
            return MicrosoftGraphBeta::Domains::Item::FederationConfiguration::Item::InternalDomainFederationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def service_configuration_records_by_id(id)
            ...
            return MicrosoftGraphBeta::Domains::Item::ServiceConfigurationRecords::Item::DomainDnsRecordItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sharedEmailDomainInvitations property of the microsoft.graph.domain entity.
        ## @param id Unique identifier of the item
        ...
        ## 
        def shared_email_domain_invitations_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
        ...
        def verification_dns_records_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["domainDnsRecord%2Did"] = id
            return MicrosoftGraphBeta::Domains::Item::VerificationDnsRecords::Item::DomainDnsRecordItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
