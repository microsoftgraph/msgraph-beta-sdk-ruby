...
module MicrosoftGraphBeta::Domains::Item
    ...
    class DomainItemRequestBuilder
        ...
        def microsoft_graph_force_delete()
            return MicrosoftGraphBeta::Domains::Item::MicrosoftGraphForceDelete::ForceDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the promote method.
        def microsoft_graph_promote()
            return MicrosoftGraphBeta::Domains::Item::MicrosoftGraphPromote::PromoteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the verify method.
        def microsoft_graph_verify()
            return MicrosoftGraphBeta::Domains::Item::MicrosoftGraphVerify::VerifyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
