...
require_relative './promote_to_initial/promote_to_initial_request_builder'
        ...
        module Item
            ...
            class DomainItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def promote_to_initial()
                    return MicrosoftGraphBeta::Domains::Item::PromoteToInitial::PromoteToInitialRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the rootDomain property of the microsoft.graph.domain entity.
                def root_domain()
                    return MicrosoftGraphBeta::Domains::Item::RootDomain::RootDomainRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
