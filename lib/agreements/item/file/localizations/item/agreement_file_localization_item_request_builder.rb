...
module MicrosoftGraphBeta::Agreements::Item::File::Localizations::Item
    ## 
    ...
    class AgreementFileLocalizationItemRequestBuilder
        ...
        def versions()
            return MicrosoftGraphBeta::Agreements::Item::File::Localizations::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Agreements::Item::File::Localizations::Item::Versions::Item::AgreementFileVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
