...
module MicrosoftGraphBeta::Agreements::Item::Files::Item
    ## 
    ...
    class AgreementFileLocalizationItemRequestBuilder
        ...
        def versions()
            return MicrosoftGraphBeta::Agreements::Item::Files::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraphBeta::Agreements::Item::Files::Item::Versions::Item::AgreementFileVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
