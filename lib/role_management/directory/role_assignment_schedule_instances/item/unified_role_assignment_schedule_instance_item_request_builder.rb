            ...
            module RoleAssignmentScheduleInstances
                module Item
                    ...
                    class UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def activated_using()
                            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleInstances::Item::ActivatedUsing::ActivatedUsingRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the appScope property of the microsoft.graph.unifiedRoleScheduleInstanceBase entity.
                        def app_scope()
                            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleInstances::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the directoryScope property of the microsoft.graph.unifiedRoleScheduleInstanceBase entity.
                        def directory_scope()
                            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleInstances::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the principal property of the microsoft.graph.unifiedRoleScheduleInstanceBase entity.
                        def principal()
                            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleInstances::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the roleDefinition property of the microsoft.graph.unifiedRoleScheduleInstanceBase entity.
                        def role_definition()
                            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleInstances::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
