...
require_relative './role_schedule_instancesdirectory_scope_id_directory_scope_id_app_scope_id_app_scope_id_principal_id_principal_id_role_definition_id_role_definition_id/bbf95d1e964edfb115b600e4ade1567efacd34d7c04a0e9e27e9067c81a38415'
require_relative './role_schedulesdirectory_scope_id_directory_scope_id_app_scope_id_app_scope_id_principal_id_principal_id_role_definition_id_role_definition_id/55d640cf09d685d8ddb80e6c832fa0f6a0a0efd04bb7674d9dff3722869d0cb3'
...
module MicrosoftGraphBeta::RoleManagement::Directory
    ## 
    ...
    class DirectoryRequestBuilder
        ...
        def resource_namespaces()
            return MicrosoftGraphBeta::RoleManagement::Directory::ResourceNamespaces::ResourceNamespacesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def role_assignment_approvals()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentApprovals::RoleAssignmentApprovalsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleAssignments property of the microsoft.graph.rbacApplication entity.
        def role_assignments()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignments::RoleAssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleAssignmentScheduleInstances property of the microsoft.graph.rbacApplication entity.
        def role_assignment_schedule_instances()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleInstances::RoleAssignmentScheduleInstancesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleAssignmentScheduleRequests property of the microsoft.graph.rbacApplication entity.
        def role_assignment_schedule_requests()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::RoleAssignmentScheduleRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleAssignmentSchedules property of the microsoft.graph.rbacApplication entity.
        def role_assignment_schedules()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentSchedules::RoleAssignmentSchedulesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleDefinitions property of the microsoft.graph.rbacApplication entity.
        def role_definitions()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleDefinitions::RoleDefinitionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleEligibilityScheduleInstances property of the microsoft.graph.rbacApplication entity.
        def role_eligibility_schedule_instances()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleInstances::RoleEligibilityScheduleInstancesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleEligibilityScheduleRequests property of the microsoft.graph.rbacApplication entity.
        def role_eligibility_schedule_requests()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::RoleEligibilityScheduleRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the roleEligibilitySchedules property of the microsoft.graph.rbacApplication entity.
        def role_eligibility_schedules()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilitySchedules::RoleEligibilitySchedulesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def transitive_role_assignments()
            return MicrosoftGraphBeta::RoleManagement::Directory::TransitiveRoleAssignments::TransitiveRoleAssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resource_namespaces_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::Directory::ResourceNamespaces::Item::UnifiedRbacResourceNamespaceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleAssignmentApprovals property of the microsoft.graph.rbacApplication entity.
        ## @param id Unique identifier of the item
        ...
        def role_assignment_approvals_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentApprovals::Item::ApprovalItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleAssignments property of the microsoft.graph.rbacApplication entity.
        ## @param id Unique identifier of the item
        ...
        def role_assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignments::Item::UnifiedRoleAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleAssignmentScheduleInstances property of the microsoft.graph.rbacApplication entity.
        ## @param id Unique identifier of the item
        ...
        def role_assignment_schedule_instances_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleInstances::Item::UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleAssignmentScheduleRequests property of the microsoft.graph.rbacApplication entity.
        ## @param id Unique identifier of the item
        ...
        def role_assignment_schedule_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::UnifiedRoleAssignmentScheduleRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleAssignmentSchedules property of the microsoft.graph.rbacApplication entity.
        ## @param id Unique identifier of the item
        ...
        def role_assignment_schedules_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentSchedules::Item::UnifiedRoleAssignmentScheduleItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleDefinitions property of the microsoft.graph.rbacApplication entity.
        ## @param id Unique identifier of the item
        ...
        def role_definitions_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleDefinitions::Item::UnifiedRoleDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleEligibilityScheduleInstances property of the microsoft.graph.rbacApplication entity.
        ## @param id Unique identifier of the item
        ...
        def role_eligibility_schedule_instances_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleInstances::Item::UnifiedRoleEligibilityScheduleInstanceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleEligibilityScheduleRequests property of the microsoft.graph.rbacApplication entity.
        ## @param id Unique identifier of the item
        ...
        def role_eligibility_schedule_requests_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item::UnifiedRoleEligibilityScheduleRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the roleEligibilitySchedules property of the microsoft.graph.rbacApplication entity.
        ## @param id Unique identifier of the item
        ...
        def role_eligibility_schedules_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilitySchedules::Item::UnifiedRoleEligibilityScheduleItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def role_schedule_instancesdirectory_scope_id_directory_scope_id_app_scope_id_app_scope_id_principal_id_principal_id_role_definition_id_role_definition_id()
            return RoleScheduleInstancesdirectoryScopeIdDirectoryScopeIdAppScopeIdAppScopeIdPrincipalIdPrincipalIdRoleDefinitionIdRoleDefinitionIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to call the roleSchedules method.
        ## @return a role_schedulesdirectory_scope_id_directory_scope_id_app_scope_id_app_scope_id_principal_id_principal_id_role_definition_id_role_definition_id_request_builder
        ## 
        def role_schedulesdirectory_scope_id_directory_scope_id_app_scope_id_app_scope_id_principal_id_principal_id_role_definition_id_role_definition_id()
            return RoleSchedulesdirectoryScopeIdDirectoryScopeIdAppScopeIdAppScopeIdPrincipalIdPrincipalIdRoleDefinitionIdRoleDefinitionIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Delete navigation property directory for roleManagement
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def transitive_role_assignments_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["unifiedRoleAssignment%2Did"] = id
            return MicrosoftGraphBeta::RoleManagement::Directory::TransitiveRoleAssignments::Item::UnifiedRoleAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
