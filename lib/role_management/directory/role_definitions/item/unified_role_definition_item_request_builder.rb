...
module MicrosoftGraphBeta::RoleManagement::Directory::RoleDefinitions::Item
    ## 
    ...
    class UnifiedRoleDefinitionItemRequestBuilder
        ...
        def microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleDefinitions::Item::MicrosoftGraphAssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeId::AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
