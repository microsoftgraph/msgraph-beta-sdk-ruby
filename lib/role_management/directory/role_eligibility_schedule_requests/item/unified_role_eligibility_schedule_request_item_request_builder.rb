...
module MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item
    ## 
    ...
    class UnifiedRoleEligibilityScheduleRequestItemRequestBuilder
        ...
        def app_scope()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def directory_scope()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancel method.
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def principal()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def role_definition()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def target_schedule()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item::TargetSchedule::TargetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
