...
module MicrosoftGraphBeta::RoleManagement::Directory::ResourceNamespaces::Item
    ...
    class UnifiedRbacResourceNamespaceItemRequestBuilder
        ...
        def microsoft_graph_import_resource_actions()
            return MicrosoftGraphBeta::RoleManagement::Directory::ResourceNamespaces::Item::MicrosoftGraphImportResourceActions::ImportResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
