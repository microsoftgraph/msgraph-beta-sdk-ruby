...
module MicrosoftGraphBeta::RoleManagement::Directory::ResourceNamespaces::Item
    ...
    class UnifiedRbacResourceNamespaceItemRequestBuilder
        ...
        def import_resource_actions()
            return MicrosoftGraphBeta::RoleManagement::Directory::ResourceNamespaces::Item::ImportResourceActions::ImportResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
