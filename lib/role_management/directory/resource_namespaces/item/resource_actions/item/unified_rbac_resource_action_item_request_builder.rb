...
module MicrosoftGraphBeta::RoleManagement::Directory::ResourceNamespaces::Item::ResourceActions::Item
    ...
    class UnifiedRbacResourceActionItemRequestBuilder
        ...
        def resource_scope()
            return MicrosoftGraphBeta::RoleManagement::Directory::ResourceNamespaces::Item::ResourceActions::Item::ResourceScope::ResourceScopeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param unifiedRbacResourceActionId key: id of unifiedRbacResourceAction
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, unified_rbac_resource_action_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/roleManagement/directory/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24select,%24expand}"
