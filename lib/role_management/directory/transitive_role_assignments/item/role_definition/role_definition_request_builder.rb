...
module MicrosoftGraphBeta::RoleManagement::Directory::TransitiveRoleAssignments::Item::RoleDefinition
    ## 
    ...
    class RoleDefinitionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/roleDefinition{?%24select,%24expand}"
