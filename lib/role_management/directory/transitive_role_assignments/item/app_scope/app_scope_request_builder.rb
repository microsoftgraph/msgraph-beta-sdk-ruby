...
module MicrosoftGraphBeta::RoleManagement::Directory::TransitiveRoleAssignments::Item::AppScope
    ## 
    ...
    class AppScopeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/appScope{?%24select,%24expand}"
