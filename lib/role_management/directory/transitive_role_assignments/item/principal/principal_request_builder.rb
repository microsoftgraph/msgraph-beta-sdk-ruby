...
module MicrosoftGraphBeta::RoleManagement::Directory::TransitiveRoleAssignments::Item::Principal
    ## 
    ...
    class PrincipalRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/principal{?%24select,%24expand}"
