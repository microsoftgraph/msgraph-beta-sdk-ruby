...
module MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item
    ## 
    ...
    class UnifiedRoleAssignmentScheduleRequestItemRequestBuilder
        ...
        def activated_using()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::ActivatedUsing::ActivatedUsingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the appScope property of the microsoft.graph.unifiedRoleAssignmentScheduleRequest entity.
        def app_scope()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def directory_scope()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancel method.
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def principal()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def role_definition()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def target_schedule()
            return MicrosoftGraphBeta::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::TargetSchedule::TargetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
