...
module MicrosoftGraphBeta::RoleManagement::CloudPC::RoleAssignments::Item::DirectoryScopes
    ## 
    ...
    class DirectoryScopesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/directoryScopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
