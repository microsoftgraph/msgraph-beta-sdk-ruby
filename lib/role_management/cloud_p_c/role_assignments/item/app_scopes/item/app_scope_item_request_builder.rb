...
module MicrosoftGraphBeta::RoleManagement::CloudPC::RoleAssignments::Item::AppScopes::Item
    ## 
    ...
    class AppScopeItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, app_scope_id=nil)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/appScopes/{appScope%2Did}{?%24select,%24expand}"
