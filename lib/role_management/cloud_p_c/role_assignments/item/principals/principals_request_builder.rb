...
module MicrosoftGraphBeta::RoleManagement::CloudPC::RoleAssignments::Item::Principals
    ## 
    ...
    class PrincipalsRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::RoleManagement::CloudPC::RoleAssignments::Item::Principals::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/principals{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
