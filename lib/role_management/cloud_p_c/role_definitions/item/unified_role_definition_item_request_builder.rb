...
module MicrosoftGraphBeta::RoleManagement::CloudPC::RoleDefinitions::Item
    ## 
    ...
    class UnifiedRoleDefinitionItemRequestBuilder
        ...
        def inherits_permissions_from()
            return MicrosoftGraphBeta::RoleManagement::CloudPC::RoleDefinitions::Item::InheritsPermissionsFrom::InheritsPermissionsFromRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id()
            return MicrosoftGraphBeta::RoleManagement::CloudPC::RoleDefinitions::Item::Ib6625b1e860cb80d36e16d94bcc2725982547397100fa9fb5121a899e62435c3::MicrosoftGraphAssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC/roleDefinitions/{unifiedRoleDefinition%2Did}{?%24select,%24expand}"
        ...
        def inherits_permissions_from_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::CloudPC::RoleDefinitions::Item::InheritsPermissionsFrom::Item::UnifiedRoleDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
