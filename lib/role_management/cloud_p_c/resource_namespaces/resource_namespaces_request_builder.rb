        ...
        module CloudPC
            module ResourceNamespaces
                ...
                class ResourceNamespacesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the resourceNamespaces property of the microsoft.graph.rbacApplicationMultiple entity.
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/roleManagement/cloudPC/resourceNamespaces{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/roleManagement/cloudPC/resourceNamespaces'
                        request_info.path_parameters = @path_parameters
