...
module MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC/resourceNamespaces/$count{?%24search,%24filter}"
