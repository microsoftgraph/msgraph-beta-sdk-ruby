...
module MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::Item::ResourceActions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/$count{?%24search,%24filter}"
