                ...
                module Item
                    ...
                    class UnifiedRbacResourceNamespaceItemRequestBuilder
                        ...
                        def microsoft_graph_import_resource_actions()
                            return MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::Item::MicrosoftGraphImportResourceActions::MicrosoftGraphImportResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
