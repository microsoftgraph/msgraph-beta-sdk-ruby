...
module MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::Item
    ...
    class UnifiedRbacResourceNamespaceItemRequestBuilder
        ...
        def microsoft_graph_import_resource_actions()
            return MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::Item::MicrosoftGraphImportResourceActions::ImportResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resource_actions()
            return MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::Item::ResourceActions::ResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, unified_rbac_resource_namespace_id=nil)
            ...
            @url_template = "{+baseurl}/roleManagement/cloudPC/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24select,%24expand}"
        ...
        def resource_actions_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::Item::ResourceActions::Item::UnifiedRbacResourceActionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property resourceNamespaces for roleManagement
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
