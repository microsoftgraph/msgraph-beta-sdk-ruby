...
require_relative '../../models/rbac_application_multiple'
...
require_relative './role_assignments/item/unified_role_assignment_multiple_item_request_builder'
...
module MicrosoftGraphBeta
    module RoleManagement
        module CloudPC
            ...
            class CloudPCRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def resource_namespaces()
                    return MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::ResourceNamespacesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the roleAssignments property of the microsoft.graph.rbacApplicationMultiple entity.
                def role_assignments()
                    return MicrosoftGraphBeta::RoleManagement::CloudPC::RoleAssignments::RoleAssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the roleDefinitions property of the microsoft.graph.rbacApplicationMultiple entity.
                def role_definitions()
                    return MicrosoftGraphBeta::RoleManagement::CloudPC::RoleDefinitions::RoleDefinitionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/roleManagement/cloudPC{?%24select,%24expand}")
                end
                ## 
                ...
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ## @return a Fiber of rbac_application_multiple
                ## 
                def get(request_configuration=nil)
                    ...
                    error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                    error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::RbacApplicationMultiple.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def resource_namespaces_by_id(id)
                    ...
                    return MicrosoftGraphBeta::RoleManagement::CloudPC::ResourceNamespaces::Item::UnifiedRbacResourceNamespaceItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ## Provides operations to manage the roleAssignments property of the microsoft.graph.rbacApplicationMultiple entity.
                ## @param id Unique identifier of the item
                ...
                def role_assignments_by_id(id)
                    ...
                    return MicrosoftGraphBeta::RoleManagement::CloudPC::RoleAssignments::Item::UnifiedRoleAssignmentMultipleItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ## Provides operations to manage the roleDefinitions property of the microsoft.graph.rbacApplicationMultiple entity.
                ## @param id Unique identifier of the item
