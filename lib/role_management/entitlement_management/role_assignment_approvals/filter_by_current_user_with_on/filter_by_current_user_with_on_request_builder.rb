                ...
                module FilterByCurrentUserWithOn
                    ...
                    class FilterByCurrentUserWithOnRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter, on=nil)
                            ...
                            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentApprovals/filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
