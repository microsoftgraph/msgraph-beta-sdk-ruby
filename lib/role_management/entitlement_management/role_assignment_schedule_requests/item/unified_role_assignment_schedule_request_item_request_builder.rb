...
module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignmentScheduleRequests::Item
    ## 
    ...
    class UnifiedRoleAssignmentScheduleRequestItemRequestBuilder
        ...
        def activated_using()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignmentScheduleRequests::Item::ActivatedUsing::ActivatedUsingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the appScope property of the microsoft.graph.unifiedRoleAssignmentScheduleRequest entity.
        def app_scope()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignmentScheduleRequests::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def directory_scope()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignmentScheduleRequests::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancel method.
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignmentScheduleRequests::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def principal()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignmentScheduleRequests::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def role_definition()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignmentScheduleRequests::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def target_schedule()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignmentScheduleRequests::Item::TargetSchedule::TargetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleAssignmentScheduleRequest.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
