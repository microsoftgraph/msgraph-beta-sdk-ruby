                    ...
                    module ImportResourceActions
                        ...
                        class ImportResourceActionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/importResourceActions")
                            end
                            ## 
                            ...
                            ## @return a import_resource_actions_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return ImportResourceActionsRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
