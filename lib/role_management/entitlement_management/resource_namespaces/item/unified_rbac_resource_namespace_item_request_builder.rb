...
require_relative './import_resource_actions/import_resource_actions_request_builder'
...
module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::ResourceNamespaces::Item
    ...
    class UnifiedRbacResourceNamespaceItemRequestBuilder
        ...
        def import_resource_actions()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::ResourceNamespaces::Item::ImportResourceActions::ImportResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
