...
require_relative './microsoft_graph_import_resource_actions/import_resource_actions_request_builder'
...
module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::ResourceNamespaces::Item
    ## 
    ...
    class UnifiedRbacResourceNamespaceItemRequestBuilder
        ...
        def microsoft_graph_import_resource_actions()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::ResourceNamespaces::Item::MicrosoftGraphImportResourceActions::ImportResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resource_actions()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::ResourceNamespaces::Item::ResourceActions::ResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param unifiedRbacResourceNamespaceId key: id of unifiedRbacResourceNamespace
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, unified_rbac_resource_namespace_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24select,%24expand}"
        ...
        def resource_actions_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::ResourceNamespaces::Item::ResourceActions::Item::UnifiedRbacResourceActionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property resourceNamespaces for roleManagement
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
