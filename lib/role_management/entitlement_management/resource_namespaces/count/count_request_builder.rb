...
module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::ResourceNamespaces::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/$count{?%24search,%24filter}"
