            ...
            module RoleEligibilitySchedules
                module Item
                    ...
                    class UnifiedRoleEligibilityScheduleItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def app_scope()
                            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleEligibilitySchedules::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the directoryScope property of the microsoft.graph.unifiedRoleScheduleBase entity.
                        def directory_scope()
                            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleEligibilitySchedules::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the principal property of the microsoft.graph.unifiedRoleScheduleBase entity.
                        def principal()
                            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleEligibilitySchedules::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the roleDefinition property of the microsoft.graph.unifiedRoleScheduleBase entity.
                        def role_definition()
                            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleEligibilitySchedules::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleEligibilitySchedule.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
