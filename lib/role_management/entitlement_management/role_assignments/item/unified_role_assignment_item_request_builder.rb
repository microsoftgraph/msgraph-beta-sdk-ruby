...
module MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignments::Item
    ## 
    ...
    class UnifiedRoleAssignmentItemRequestBuilder
        ...
        def app_scope()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignments::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the directoryScope property of the microsoft.graph.unifiedRoleAssignment entity.
        def directory_scope()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignments::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def principal()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignments::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def role_definition()
            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::RoleAssignments::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
