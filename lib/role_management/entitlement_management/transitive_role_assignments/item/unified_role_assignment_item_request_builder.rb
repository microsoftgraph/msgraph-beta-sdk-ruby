            ...
            module TransitiveRoleAssignments
                module Item
                    ...
                    class UnifiedRoleAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def app_scope()
                            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::TransitiveRoleAssignments::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the directoryScope property of the microsoft.graph.unifiedRoleAssignment entity.
                        def directory_scope()
                            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::TransitiveRoleAssignments::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the principal property of the microsoft.graph.unifiedRoleAssignment entity.
                        def principal()
                            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::TransitiveRoleAssignments::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the roleDefinition property of the microsoft.graph.unifiedRoleAssignment entity.
                        def role_definition()
                            return MicrosoftGraphBeta::RoleManagement::EntitlementManagement::TransitiveRoleAssignments::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}'
