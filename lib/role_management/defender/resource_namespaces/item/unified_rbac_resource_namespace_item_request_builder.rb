                ...
                module Item
                    ...
                    class UnifiedRbacResourceNamespaceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def import_resource_actions()
                            return MicrosoftGraphBeta::RoleManagement::Defender::ResourceNamespaces::Item::ImportResourceActions::ImportResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def resource_actions()
                            return MicrosoftGraphBeta::RoleManagement::Defender::ResourceNamespaces::Item::ResourceActions::ResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/defender/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24expand,%24select}")
                        end
                        ## 
