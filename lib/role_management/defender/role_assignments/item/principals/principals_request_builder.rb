                ...
                module Item
                    module Principals
                        ...
                        class PrincipalsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::RoleManagement::Defender::RoleAssignments::Item::Principals::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the principals property of the microsoft.graph.unifiedRoleAssignmentMultiple entity.
                            ...
                            def by_directory_object_id(directory_object_id)
                                ...
                                return MicrosoftGraphBeta::RoleManagement::Defender::RoleAssignments::Item::Principals::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/roleManagement/defender/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/principals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
