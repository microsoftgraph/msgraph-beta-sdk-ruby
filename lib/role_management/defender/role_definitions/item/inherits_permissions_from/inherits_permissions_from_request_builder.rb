                ...
                module Item
                    module InheritsPermissionsFrom
                        ...
                        class InheritsPermissionsFromRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::RoleManagement::Defender::RoleDefinitions::Item::InheritsPermissionsFrom::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the inheritsPermissionsFrom property of the microsoft.graph.unifiedRoleDefinition entity.
                            ...
                            def by_unified_role_definition_id1(unified_role_definition_id1)
                                ...
                                return MicrosoftGraphBeta::RoleManagement::Defender::RoleDefinitions::Item::InheritsPermissionsFrom::Item::UnifiedRoleDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/roleManagement/defender/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
