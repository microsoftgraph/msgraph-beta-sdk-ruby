                        ...
                        module Item
                            ...
                            class UnifiedRoleDefinitionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id()
                                    return MicrosoftGraphBeta::RoleManagement::Defender::RoleDefinitions::Item::InheritsPermissionsFrom::Item::Iac00e1fd46fdc1e8edf1d18c92cfc62eb1105b22faca96b71d457d6777a7857a::AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/roleManagement/defender/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom/{unifiedRoleDefinition%2Did1}{?%24expand,%24select}")
                                end
                                ## 
