...
module MicrosoftGraphBeta::RoleManagement::DeviceManagement::ResourceNamespaces::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/deviceManagement/resourceNamespaces/$count{?%24search,%24filter}"
