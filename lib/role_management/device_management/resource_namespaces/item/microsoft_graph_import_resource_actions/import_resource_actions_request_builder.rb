...
require_relative './microsoft_graph_import_resource_actions'

module MicrosoftGraphBeta::RoleManagement::DeviceManagement::ResourceNamespaces::Item::MicrosoftGraphImportResourceActions
    ## 
    ...
    class ImportResourceActionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/deviceManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/microsoft.graph.importResourceActions"
