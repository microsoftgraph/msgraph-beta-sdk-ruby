...
module MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleAssignments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/deviceManagement/roleAssignments/$count{?%24search,%24filter}"
