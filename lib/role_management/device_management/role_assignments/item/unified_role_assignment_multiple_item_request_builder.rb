            ...
            module RoleAssignments
                module Item
                    ...
                    class UnifiedRoleAssignmentMultipleItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def app_scopes()
                            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleAssignments::Item::AppScopes::AppScopesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def directory_scopes()
                            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleAssignments::Item::DirectoryScopes::DirectoryScopesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the principals property of the microsoft.graph.unifiedRoleAssignmentMultiple entity.
                        def principals()
                            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleAssignments::Item::Principals::PrincipalsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the roleDefinition property of the microsoft.graph.unifiedRoleAssignmentMultiple entity.
                        def role_definition()
                            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleAssignments::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/deviceManagement/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/roleManagement/deviceManagement/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}'
