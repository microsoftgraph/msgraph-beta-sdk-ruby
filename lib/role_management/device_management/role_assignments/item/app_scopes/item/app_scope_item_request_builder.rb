...
module MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleAssignments::Item::AppScopes::Item
    ## 
    ...
    class AppScopeItemRequestBuilder
        ...
        ## @param appScopeId key: id of appScope
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, app_scope_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/roleManagement/deviceManagement/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/appScopes/{appScope%2Did}{?%24select,%24expand}"
