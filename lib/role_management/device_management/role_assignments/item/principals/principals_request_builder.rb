            ...
            module RoleAssignments
                module Item
                    module Principals
                        ...
                        class PrincipalsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            
                            ## 
                            # Provides operations to count the resources in the collection.
                            def count()
                                return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleAssignments::Item::Principals::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the principals property of the microsoft.graph.unifiedRoleAssignmentMultiple entity.
                            ...
                            def by_directory_object_id(directory_object_id)
                                ...
                                return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleAssignments::Item::Principals::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/roleManagement/deviceManagement/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/principals{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                            end
                            ## 
                            ...
                            ## @return a principals_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return PrincipalsRequestBuilder.new(raw_url, @request_adapter)
                            end
