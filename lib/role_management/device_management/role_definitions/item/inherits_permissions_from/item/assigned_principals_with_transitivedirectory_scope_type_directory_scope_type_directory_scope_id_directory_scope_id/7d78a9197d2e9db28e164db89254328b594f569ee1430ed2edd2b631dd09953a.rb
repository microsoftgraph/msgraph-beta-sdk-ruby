...
require_relative '../item'
require_relative './ab713a580d770e68af1429ea439923e88b025c1584724cc99475dcc30a7e3a70'

module MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleDefinitions::Item::InheritsPermissionsFrom::Item::AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeId
    ## 
    ...
    class AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleDefinitions::Item::InheritsPermissionsFrom::Item::AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeId::AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function assignedPrincipals
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
