...
module MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleDefinitions::Item::InheritsPermissionsFrom::Item
    ...
    class UnifiedRoleDefinitionItemRequestBuilder
        ...
        def microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id()
            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleDefinitions::Item::InheritsPermissionsFrom::Item::MicrosoftGraphAssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeId::AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, unified_role_definition_id1=nil)
            ...
            @url_template = "{+baseurl}/roleManagement/deviceManagement/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom/{unifiedRoleDefinition%2Did1}{?%24select,%24expand}"
