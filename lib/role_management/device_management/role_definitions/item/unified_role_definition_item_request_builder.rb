...
require_relative './microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id/102192579282e47564893dfc0217f056a7ced6375487570ae3d07a0a6072f7a7'

module MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleDefinitions::Item
    ## 
    ...
    class UnifiedRoleDefinitionItemRequestBuilder
        ...
        def inherits_permissions_from()
            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleDefinitions::Item::InheritsPermissionsFrom::InheritsPermissionsFromRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id()
            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleDefinitions::Item::MicrosoftGraphAssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeId::MicrosoftGraphAssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/deviceManagement/roleDefinitions/{unifiedRoleDefinition%2Did}{?%24select,%24expand}"
        ...
        def inherits_permissions_from_by_id(id)
            ...
            return MicrosoftGraphBeta::RoleManagement::DeviceManagement::RoleDefinitions::Item::InheritsPermissionsFrom::Item::UnifiedRoleDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
