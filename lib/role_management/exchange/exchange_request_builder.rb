...
require_relative './custom_app_scopes/custom_app_scopes_request_builder'
        ...
        module Exchange
            ...
            class ExchangeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def custom_app_scopes()
                    return MicrosoftGraphBeta::RoleManagement::Exchange::CustomAppScopes::CustomAppScopesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/roleManagement/exchange{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/roleManagement/exchange'
                ...
                ## @return a exchange_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return ExchangeRequestBuilder.new(raw_url, @request_adapter)
                end
