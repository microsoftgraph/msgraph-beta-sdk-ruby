...
require_relative '../../models/unified_rbac_application'
...
module MicrosoftGraphBeta
    module RoleManagement
        module Exchange
            ...
            class ExchangeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def resource_namespaces()
                    return MicrosoftGraphBeta::RoleManagement::Exchange::ResourceNamespaces::ResourceNamespacesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the roleAssignments property of the microsoft.graph.unifiedRbacApplication entity.
                def role_assignments()
                    return MicrosoftGraphBeta::RoleManagement::Exchange::RoleAssignments::RoleAssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the roleDefinitions property of the microsoft.graph.unifiedRbacApplication entity.
                def role_definitions()
                    return MicrosoftGraphBeta::RoleManagement::Exchange::RoleDefinitions::RoleDefinitionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def transitive_role_assignments()
                    return MicrosoftGraphBeta::RoleManagement::Exchange::TransitiveRoleAssignments::TransitiveRoleAssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/roleManagement/exchange{?%24select,%24expand}")
                end
                ## 
                ...
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ## @return a Fiber of unified_rbac_application
                ## 
                def get(request_configuration=nil)
                    ...
                    error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                    error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRbacApplication.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def resource_namespaces_by_id(id)
                    ...
                    return MicrosoftGraphBeta::RoleManagement::Exchange::ResourceNamespaces::Item::UnifiedRbacResourceNamespaceItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ## Provides operations to manage the roleAssignments property of the microsoft.graph.unifiedRbacApplication entity.
                ## @param id Unique identifier of the item
                ...
                def role_assignments_by_id(id)
                    ...
                    return MicrosoftGraphBeta::RoleManagement::Exchange::RoleAssignments::Item::UnifiedRoleAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ## Provides operations to manage the roleDefinitions property of the microsoft.graph.unifiedRbacApplication entity.
                ## @param id Unique identifier of the item
                ...
                def role_definitions_by_id(id)
                    ...
                    return MicrosoftGraphBeta::RoleManagement::Exchange::RoleDefinitions::Item::UnifiedRoleDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ## Delete navigation property exchange for roleManagement
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ...
                def transitive_role_assignments_by_id(id)
                    ...
                    url_tpl_params = @path_parameters.clone
                    url_tpl_params["unifiedRoleAssignment%2Did"] = id
                    return MicrosoftGraphBeta::RoleManagement::Exchange::TransitiveRoleAssignments::Item::UnifiedRoleAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
