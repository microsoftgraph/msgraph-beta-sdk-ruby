                ...
                module Item
                    ...
                    class UnifiedRbacResourceNamespaceItemRequestBuilder
                        ...
                        def microsoft_graph_import_resource_actions()
                            return MicrosoftGraphBeta::RoleManagement::Exchange::ResourceNamespaces::Item::MicrosoftGraphImportResourceActions::MicrosoftGraphImportResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def resource_actions()
                            return MicrosoftGraphBeta::RoleManagement::Exchange::ResourceNamespaces::Item::ResourceActions::ResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            ...
                            @url_template = "{+baseurl}/roleManagement/exchange/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24select,%24expand}"
