                ...
                module Item
                    ...
                    class UnifiedRbacResourceNamespaceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def import_resource_actions()
                            return MicrosoftGraphBeta::RoleManagement::Exchange::ResourceNamespaces::Item::ImportResourceActions::ImportResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/exchange/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24select,%24expand}")
                        end
                        ## 
