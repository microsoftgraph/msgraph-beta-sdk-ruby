                ...
                module RoleAssignmentSchedules
                    module Item
                        ...
                        class UnifiedRoleAssignmentScheduleItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def activated_using()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleAssignmentSchedules::Item::ActivatedUsing::ActivatedUsingRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the appScope property of the microsoft.graph.unifiedRoleScheduleBase entity.
                            def app_scope()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleAssignmentSchedules::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the directoryScope property of the microsoft.graph.unifiedRoleScheduleBase entity.
                            def directory_scope()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleAssignmentSchedules::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the principal property of the microsoft.graph.unifiedRoleScheduleBase entity.
                            def principal()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleAssignmentSchedules::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the roleDefinition property of the microsoft.graph.unifiedRoleScheduleBase entity.
                            def role_definition()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleAssignmentSchedules::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}'
