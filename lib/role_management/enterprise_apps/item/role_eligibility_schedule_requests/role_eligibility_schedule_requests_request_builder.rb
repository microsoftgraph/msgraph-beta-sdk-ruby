            ...
            module Item
                module RoleEligibilityScheduleRequests
                    ...
                    class RoleEligibilityScheduleRequestsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleEligibilityScheduleRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the roleEligibilityScheduleRequests property of the microsoft.graph.rbacApplication entity.
                        ...
                        def by_unified_role_eligibility_schedule_request_id(unified_role_eligibility_schedule_request_id)
                            ...
                            return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleEligibilityScheduleRequests::Item::UnifiedRoleEligibilityScheduleRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UnifiedRoleEligibilityScheduleRequestCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleRequests'
                            request_info.path_parameters = @path_parameters
