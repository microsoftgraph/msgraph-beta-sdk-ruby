                ...
                module RoleEligibilityScheduleInstances
                    module Item
                        ...
                        class UnifiedRoleEligibilityScheduleInstanceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def app_scope()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleEligibilityScheduleInstances::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the directoryScope property of the microsoft.graph.unifiedRoleScheduleInstanceBase entity.
                            def directory_scope()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleEligibilityScheduleInstances::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the principal property of the microsoft.graph.unifiedRoleScheduleInstanceBase entity.
                            def principal()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleEligibilityScheduleInstances::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the roleDefinition property of the microsoft.graph.unifiedRoleScheduleInstanceBase entity.
                            def role_definition()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleEligibilityScheduleInstances::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance%2Did}'
