            ...
            module Item
                module RoleAssignmentScheduleRequests
                    ...
                    class RoleAssignmentScheduleRequestsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleAssignmentScheduleRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the roleAssignmentScheduleRequests property of the microsoft.graph.rbacApplication entity.
                        ...
                        def by_unified_role_assignment_schedule_request_id(unified_role_assignment_schedule_request_id)
                            ...
                            return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::RoleAssignmentScheduleRequests::Item::UnifiedRoleAssignmentScheduleRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentScheduleRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentScheduleRequests'
                            request_info.path_parameters = @path_parameters
