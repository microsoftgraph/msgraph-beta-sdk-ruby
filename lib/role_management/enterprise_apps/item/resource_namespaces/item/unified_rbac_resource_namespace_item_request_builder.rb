                    ...
                    module Item
                        ...
                        class UnifiedRbacResourceNamespaceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def import_resource_actions()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::ResourceNamespaces::Item::ImportResourceActions::ImportResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def resource_actions()
                                return MicrosoftGraphBeta::RoleManagement::EnterpriseApps::Item::ResourceNamespaces::Item::ResourceActions::ResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}'
