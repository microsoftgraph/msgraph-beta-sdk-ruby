...
require_relative '../models/networkaccess/network_access_root'
    ...
    module NetworkAccess
        ...
        class NetworkAccessRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/networkAccess{?%24select,%24expand}")
            end
            ## 
            ## Get networkAccess
            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
            ## @return a Fiber of network_access_root
            ## 
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Networkaccess::NetworkAccessRoot.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
