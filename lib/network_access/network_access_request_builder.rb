...
require_relative './microsoft_graph_networkaccess_onboard/microsoft_graph_networkaccess_onboard_request_builder'
...
require_relative './tenant_status/tenant_status_request_builder'

module MicrosoftGraphBeta
    module NetworkAccess
        ## 
        # Provides operations to manage the networkAccessRoot singleton.
        class NetworkAccessRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            
            ## 
            # Provides operations to manage the alerts property of the microsoft.graph.networkaccess.networkAccessRoot entity.
            def alerts()
                return MicrosoftGraphBeta::NetworkAccess::Alerts::AlertsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def forwarding_policies()
                return MicrosoftGraphBeta::NetworkAccess::ForwardingPolicies::ForwardingPoliciesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def forwarding_profiles()
                return MicrosoftGraphBeta::NetworkAccess::ForwardingProfiles::ForwardingProfilesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the logs property of the microsoft.graph.networkaccess.networkAccessRoot entity.
            def logs()
                return MicrosoftGraphBeta::NetworkAccess::Logs::LogsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the onboard method.
            def microsoft_graph_networkaccess_onboard()
                return MicrosoftGraphBeta::NetworkAccess::MicrosoftGraphNetworkaccessOnboard::MicrosoftGraphNetworkaccessOnboardRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the reports property of the microsoft.graph.networkaccess.networkAccessRoot entity.
            def reports()
                return MicrosoftGraphBeta::NetworkAccess::Reports::ReportsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the settings property of the microsoft.graph.networkaccess.networkAccessRoot entity.
            def settings()
                return MicrosoftGraphBeta::NetworkAccess::Settings::SettingsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the tenantStatus property of the microsoft.graph.networkaccess.networkAccessRoot entity.
            def tenant_status()
                return MicrosoftGraphBeta::NetworkAccess::TenantStatus::TenantStatusRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/networkAccess{?%24expand,%24select}")
            end
            ## 
            ## Get networkAccess
            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
            ## @return a Fiber of networkaccess_network_access_root
            ## 
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::NetworkaccessNetworkAccessRoot.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
            ...
            def to_patch_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/networkAccess'
                request_info.path_parameters = @path_parameters
