...
require_relative './i54bfa886d0b80c9018ae47d3feb632e5e16de4020343030c846da456fc63d908/89190756680fe9c9ac0ed3b4bb81f9823858f64a5467f15058d60a46c7e96e01'
...
require_relative './icbf10b1744d7cc53778839476a051a77d1525cc34f78076d5b84a19c2771d695/a1327a59c705c2d297ed9011b3b579cfcd29cc33313b9d07c6409e94582fc1a7'
    ...
    module NetworkAccess
        module Reports
            ...
            class ReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                ## @param end_date_time Usage: endDateTime={endDateTime}
                ## @param start_date_time Usage: startDateTime={startDateTime}
                ## @return a microsoft_graph_networkaccess_usage_profiling_with_start_date_time_with_end_date_time_with_aggregated_bydiscovered_application_segment_id_discovered_application_segment_id_request_builder
                ## 
                def microsoft_graph_networkaccess_usage_profiling_with_start_date_time_with_end_date_time_with_aggregated_bydiscovered_application_segment_id_discovered_application_segment_id(aggregated_by, end_date_time, start_date_time)
                    raise StandardError, 'aggregated_by cannot be null' if aggregated_by.nil?
                    raise StandardError, 'end_date_time cannot be null' if end_date_time.nil?
                    raise StandardError, 'start_date_time cannot be null' if start_date_time.nil?
                    return MicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedBydiscoveredApplicationSegmentIdDiscoveredApplicationSegmentIdRequestBuilder.new(@path_parameters, @request_adapter, aggregatedBy, endDateTime, startDateTime)
                end
                ## 
                ## Provides operations to call the userReport method.
                ## @param end_date_time Usage: endDateTime={endDateTime}
                ## @param start_date_time Usage: startDateTime={startDateTime}
                ## @return a microsoft_graph_networkaccess_user_report_with_start_date_time_with_end_date_timediscovered_application_segment_id_discovered_application_segment_id_request_builder
                ## 
                def microsoft_graph_networkaccess_user_report_with_start_date_time_with_end_date_timediscovered_application_segment_id_discovered_application_segment_id(end_date_time, start_date_time)
                    raise StandardError, 'end_date_time cannot be null' if end_date_time.nil?
                    raise StandardError, 'start_date_time cannot be null' if start_date_time.nil?
                    return MicrosoftGraphNetworkaccessUserReportWithStartDateTimeWithEndDateTimediscoveredApplicationSegmentIdDiscoveredApplicationSegmentIdRequestBuilder.new(@path_parameters, @request_adapter, endDateTime, startDateTime)
                end
                ## 
