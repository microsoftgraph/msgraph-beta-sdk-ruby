...
require_relative './ibb1761e8f4b71b58e0bb13ed61636be60dc98a866a13b31f86302866188eccaf/529de449870867b7c96118de0736627fe682983d2a3451477d9b4dd915c8eb5d'
    ...
    module NetworkAccess
        module Reports
            ...
            class ReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                ## @param end_date_time Usage: endDateTime={endDateTime}
                ## @param start_date_time Usage: startDateTime={startDateTime}
                ## @return a microsoft_graph_networkaccess_get_discovered_application_segment_report_with_start_date_time_with_end_date_time_request_builder
                ## 
                def microsoft_graph_networkaccess_get_discovered_application_segment_report_with_start_date_time_with_end_date_time(end_date_time, start_date_time)
                    raise StandardError, 'end_date_time cannot be null' if end_date_time.nil?
                    raise StandardError, 'start_date_time cannot be null' if start_date_time.nil?
                    return MicrosoftGraphNetworkaccessGetDiscoveredApplicationSegmentReportWithStartDateTimeWithEndDateTimeRequestBuilder.new(@path_parameters, @request_adapter, endDateTime, startDateTime)
                end
                ## 
