...
require_relative './i04c72b096974f2df87da816ba94f6dcec076ef0883a20bfdb96366ad791f9bf6/a1115c081d0a37dc38fc101014597fac6719e82cead01a971bfbb82ed2dfd483'
...
require_relative './ibdf840c8f996d42533cca3e19cb695e8c2ffbc985a109b9a06603ddfe9e2f85b/afb93f1ca7c846504159327a9f62ef935f79eaffbcfa9ce139699635ba01cc04'
require_relative './ic845ee52259285810e08f8cec6bf96e4ac20df67baf08fb5e049906d5526e2f4/7c7b86a2c4a1c42e6b84277563d331e623a7792c5c9d44d3c61ae53c125111ee'
        ...
        module Reports
            ...
            class ReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/networkAccess/reports{?%24expand,%24select}")
                end
                ## 
                ...
                ## @param end_date_time Usage: endDateTime={endDateTime}
                ## @param start_date_time Usage: startDateTime={startDateTime}
                ## @return a microsoft_graph_networkaccess_get_discovered_application_segment_report_with_start_date_time_with_end_date_timeuser_id_user_id_request_builder
                ## 
                def microsoft_graph_networkaccess_get_discovered_application_segment_report_with_start_date_time_with_end_date_timeuser_id_user_id(end_date_time, start_date_time)
                    raise StandardError, 'end_date_time cannot be null' if end_date_time.nil?
                    raise StandardError, 'start_date_time cannot be null' if start_date_time.nil?
                    return MicrosoftGraphNetworkaccessGetDiscoveredApplicationSegmentReportWithStartDateTimeWithEndDateTimeuserIdUserIdRequestBuilder.new(@path_parameters, @request_adapter, endDateTime, startDateTime)
                end
                ## 
                ...
                ## @param end_date_time Usage: endDateTime={endDateTime}
                ## @param start_date_time Usage: startDateTime={startDateTime}
                ## @return a microsoft_graph_networkaccess_usage_profiling_with_start_date_time_with_end_date_time_with_aggregated_bydiscovered_application_segment_id_discovered_application_segment_id_application_id_application_id_request_builder
                ## 
                def microsoft_graph_networkaccess_usage_profiling_with_start_date_time_with_end_date_time_with_aggregated_bydiscovered_application_segment_id_discovered_application_segment_id_application_id_application_id(aggregated_by, end_date_time, start_date_time)
                    raise StandardError, 'aggregated_by cannot be null' if aggregated_by.nil?
                    raise StandardError, 'end_date_time cannot be null' if end_date_time.nil?
                    raise StandardError, 'start_date_time cannot be null' if start_date_time.nil?
                    return MicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedBydiscoveredApplicationSegmentIdDiscoveredApplicationSegmentIdApplicationIdApplicationIdRequestBuilder.new(@path_parameters, @request_adapter, aggregatedBy, endDateTime, startDateTime)
                end
                ## 
                ## Provides operations to call the userReport method.
                ## @param end_date_time Usage: endDateTime={endDateTime}
                ## @param start_date_time Usage: startDateTime={startDateTime}
                ## @return a microsoft_graph_networkaccess_user_report_with_start_date_time_with_end_date_timediscovered_application_segment_id_discovered_application_segment_id_application_id_application_id_request_builder
                ## 
                def microsoft_graph_networkaccess_user_report_with_start_date_time_with_end_date_timediscovered_application_segment_id_discovered_application_segment_id_application_id_application_id(end_date_time, start_date_time)
                    raise StandardError, 'end_date_time cannot be null' if end_date_time.nil?
                    raise StandardError, 'start_date_time cannot be null' if start_date_time.nil?
                    return MicrosoftGraphNetworkaccessUserReportWithStartDateTimeWithEndDateTimediscoveredApplicationSegmentIdDiscoveredApplicationSegmentIdApplicationIdApplicationIdRequestBuilder.new(@path_parameters, @request_adapter, endDateTime, startDateTime)
                end
                ## 
