    ...
    module NetworkAccess
        module Reports
            module I01b9f442408d60f27a157c149e658e0dd4589bba9f5e28a6b86daedb95b03165
                class UsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                    ...
                    ## @return a usage_profiling_with_start_date_time_with_end_date_time_with_aggregated_by_get_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return UsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedByGetResponse.new
                    end
                    ## 
