        ...
        module Alerts
            module Item
                ...
                class AlertItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def policy()
                        return MicrosoftGraphBeta::NetworkAccess::Alerts::Item::Policy::PolicyRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/networkAccess/alerts/{alert%2Did}{?%24expand,%24select}")
                    end
                    ## 
