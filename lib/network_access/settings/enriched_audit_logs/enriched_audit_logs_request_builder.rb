...
require_relative '../../../models/networkaccess_enriched_audit_logs'
            ...
            module EnrichedAuditLogs
                ...
                class EnrichedAuditLogsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/networkAccess/settings/enrichedAuditLogs{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/networkAccess/settings/enrichedAuditLogs'
