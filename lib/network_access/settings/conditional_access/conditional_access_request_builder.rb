...
require_relative '../../../models/networkaccess_conditional_access_settings'
            ...
            module ConditionalAccess
                ...
                class ConditionalAccessRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/networkAccess/settings/conditionalAccess{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of networkaccess_conditional_access_settings
                    ## 
                    def get(request_configuration=nil)
                        ...
                        error_mapping = Hash.new
                        error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::NetworkaccessConditionalAccessSettings.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/networkAccess/settings/conditionalAccess'
