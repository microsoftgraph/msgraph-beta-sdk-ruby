...
require_relative '../../../models/networkaccess/cross_tenant_access_settings'
        ...
        module Settings
            module CrossTenantAccess
                ...
                class CrossTenantAccessRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of cross_tenant_access_settings
                    ## 
                    def get(request_configuration=nil)
                        ...
                        error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                        error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Networkaccess::CrossTenantAccessSettings.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
