...
require_relative '../../../../models/networkaccess/policy_rule_delta'
                ...
                module MicrosoftGraphNetworkaccessUpdatePolicyRules
                    class UpdatePolicyRulesPostRequestBody
                        ...
                        def get_field_deserializers()
                            return {
                                "rules" => lambda {|n| @rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::Networkaccess::PolicyRuleDelta.create_from_discriminator_value(pn) }) },
                            }
                        end
                        ## 
