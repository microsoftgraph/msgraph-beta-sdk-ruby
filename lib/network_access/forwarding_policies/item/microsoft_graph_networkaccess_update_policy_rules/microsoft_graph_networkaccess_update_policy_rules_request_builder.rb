        ...
        module ForwardingPolicies
            module Item
                module MicrosoftGraphNetworkaccessUpdatePolicyRules
                    ...
                    class MicrosoftGraphNetworkaccessUpdatePolicyRulesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/networkAccess/forwardingPolicies/{forwardingPolicy%2Did}/microsoft.graph.networkaccess.updatePolicyRules")
                        end
                        ## 
                        ...
                        ## @return a microsoft_graph_networkaccess_update_policy_rules_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return MicrosoftGraphNetworkaccessUpdatePolicyRulesRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
