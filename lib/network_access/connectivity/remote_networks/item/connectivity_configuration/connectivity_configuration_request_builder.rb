...
require_relative '../../../../../models/networkaccess_remote_network_connectivity_configuration'
                ...
                module Item
                    module ConnectivityConfiguration
                        ...
                        class ConnectivityConfigurationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def links()
                                return MicrosoftGraphBeta::NetworkAccess::Connectivity::RemoteNetworks::Item::ConnectivityConfiguration::Links::LinksRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/connectivityConfiguration{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                            ## @return a Fiber of networkaccess_remote_network_connectivity_configuration
                            ## 
                            def get(request_configuration=nil)
                                ...
                                error_mapping = Hash.new
                                error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::NetworkaccessRemoteNetworkConnectivityConfiguration.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/connectivityConfiguration'
                            ...
                            ## @return a connectivity_configuration_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return ConnectivityConfigurationRequestBuilder.new(raw_url, @request_adapter)
                            end
