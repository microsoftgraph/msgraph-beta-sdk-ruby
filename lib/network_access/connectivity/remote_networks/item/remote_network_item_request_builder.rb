        ...
        module Connectivity
            module RemoteNetworks
                module Item
                    ...
                    class RemoteNetworkItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def connectivity_configuration()
                            return MicrosoftGraphBeta::NetworkAccess::Connectivity::RemoteNetworks::Item::ConnectivityConfiguration::ConnectivityConfigurationRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the deviceLinks property of the microsoft.graph.networkaccess.remoteNetwork entity.
                        def device_links()
                            return MicrosoftGraphBeta::NetworkAccess::Connectivity::RemoteNetworks::Item::DeviceLinks::DeviceLinksRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def forwarding_profiles()
                            return MicrosoftGraphBeta::NetworkAccess::Connectivity::RemoteNetworks::Item::ForwardingProfiles::ForwardingProfilesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return RemoteNetworkItemRequestBuilder.new(raw_url, @request_adapter)
                        end
