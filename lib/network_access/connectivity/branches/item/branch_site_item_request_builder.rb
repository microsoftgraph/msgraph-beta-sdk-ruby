            ...
            module Branches
                module Item
                    ...
                    class BranchSiteItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def device_links()
                            return MicrosoftGraphBeta::NetworkAccess::Connectivity::Branches::Item::DeviceLinks::DeviceLinksRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def forwarding_profiles()
                            return MicrosoftGraphBeta::NetworkAccess::Connectivity::Branches::Item::ForwardingProfiles::ForwardingProfilesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}'
