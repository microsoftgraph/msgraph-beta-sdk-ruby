...
module MicrosoftGraphBeta::GovernanceRoleAssignmentRequests::Item
    ...
    class GovernanceRoleAssignmentRequestItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::GovernanceRoleAssignmentRequests::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRequest method.
        def microsoft_graph_update_request()
            return MicrosoftGraphBeta::GovernanceRoleAssignmentRequests::Item::MicrosoftGraphUpdateRequest::MicrosoftGraphUpdateRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
