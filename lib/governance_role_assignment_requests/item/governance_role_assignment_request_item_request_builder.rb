...
module MicrosoftGraphBeta::GovernanceRoleAssignmentRequests::Item
    ...
    class GovernanceRoleAssignmentRequestItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::GovernanceRoleAssignmentRequests::Item::MicrosoftGraphCancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRequest method.
        def microsoft_graph_update_request()
            return MicrosoftGraphBeta::GovernanceRoleAssignmentRequests::Item::MicrosoftGraphUpdateRequest::UpdateRequestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, governance_role_assignment_request_id=nil)
            ...
            @url_template = "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24select,%24expand}"
