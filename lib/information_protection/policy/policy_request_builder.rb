...
module MicrosoftGraphBeta::InformationProtection::Policy
    ## 
    ...
    class PolicyRequestBuilder
        ...
        def labels()
            return MicrosoftGraphBeta::InformationProtection::Policy::Labels::LabelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/informationProtection/policy{?%24select,%24expand}"
        ...
        def labels_by_id(id)
            ...
            return MicrosoftGraphBeta::InformationProtection::Policy::Labels::Item::InformationProtectionLabelItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
