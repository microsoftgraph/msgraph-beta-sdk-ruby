...
module MicrosoftGraphBeta::InformationProtection::DataLossPreventionPolicies::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/informationProtection/dataLossPreventionPolicies/$count{?%24search,%24filter}"
