...
module MicrosoftGraphBeta::InformationProtection::SensitivityLabels::Item::Sublabels::Item
    ## 
    ...
    class SensitivityLabelItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, sensitivity_label_id1=nil)
            ...
            @url_template = "{+baseurl}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/{sensitivityLabel%2Did1}{?%24select,%24expand}"
