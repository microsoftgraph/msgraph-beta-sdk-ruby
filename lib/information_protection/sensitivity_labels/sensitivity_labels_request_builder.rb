    ...
    module InformationProtection
        module SensitivityLabels
            ...
            class SensitivityLabelsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::InformationProtection::SensitivityLabels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the evaluate method.
                def evaluate()
                    return MicrosoftGraphBeta::InformationProtection::SensitivityLabels::Evaluate::EvaluateRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the sensitivityLabels property of the microsoft.graph.informationProtection entity.
                ...
                def by_sensitivity_label_id(sensitivity_label_id)
                    ...
                    return MicrosoftGraphBeta::InformationProtection::SensitivityLabels::Item::SensitivityLabelItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/informationProtection/sensitivityLabels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/informationProtection/sensitivityLabels'
                    request_info.path_parameters = @path_parameters
