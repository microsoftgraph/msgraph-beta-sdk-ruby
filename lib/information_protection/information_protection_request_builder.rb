...
module MicrosoftGraphBeta::InformationProtection
    ...
    class InformationProtectionRequestBuilder
        ...
        def microsoft_graph_decrypt_buffer()
            return MicrosoftGraphBeta::InformationProtection::MicrosoftGraphDecryptBuffer::MicrosoftGraphDecryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the encryptBuffer method.
        def microsoft_graph_encrypt_buffer()
            return MicrosoftGraphBeta::InformationProtection::MicrosoftGraphEncryptBuffer::MicrosoftGraphEncryptBufferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the signDigest method.
        def microsoft_graph_sign_digest()
            return MicrosoftGraphBeta::InformationProtection::MicrosoftGraphSignDigest::MicrosoftGraphSignDigestRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the verifySignature method.
        def microsoft_graph_verify_signature()
            return MicrosoftGraphBeta::InformationProtection::MicrosoftGraphVerifySignature::MicrosoftGraphVerifySignatureRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
