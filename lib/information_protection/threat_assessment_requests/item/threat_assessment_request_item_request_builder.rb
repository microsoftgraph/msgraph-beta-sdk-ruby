...
module MicrosoftGraphBeta::InformationProtection::ThreatAssessmentRequests::Item
    ## 
    ...
    class ThreatAssessmentRequestItemRequestBuilder
        ...
        def results()
            return MicrosoftGraphBeta::InformationProtection::ThreatAssessmentRequests::Item::Results::ResultsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def results_by_id(id)
            ...
            return MicrosoftGraphBeta::InformationProtection::ThreatAssessmentRequests::Item::Results::Item::ThreatAssessmentResultItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property threatAssessmentRequests for informationProtection
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
