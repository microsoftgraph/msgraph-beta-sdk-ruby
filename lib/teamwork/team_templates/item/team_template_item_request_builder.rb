...
require_relative './definitions/item/team_template_definition_item_request_builder'
require_relative './item'

module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item
    ## 
    ...
    class TeamTemplateItemRequestBuilder
        ...
        ## @param teamTemplateId key: id of teamTemplate
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, team_template_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}{?%24select,%24expand}"
