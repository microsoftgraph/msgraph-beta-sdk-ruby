    ...
    module Teamwork
        module TeamTemplates
            module Item
                ...
                class TeamTemplateItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to manage the definitions property of the microsoft.graph.teamTemplate entity.
                    def definitions()
                        return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::DefinitionsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return TeamTemplateItemRequestBuilder.new(raw_url, @request_adapter)
                    end
