...
module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/$count{?%24search,%24filter}"
