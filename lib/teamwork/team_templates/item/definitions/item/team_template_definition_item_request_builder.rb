...
module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item
    ## 
    ...
    class TeamTemplateDefinitionItemRequestBuilder
        ...
        ## @param teamTemplateDefinitionId key: id of teamTemplateDefinition
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, team_template_definition_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}{?%24select,%24expand}"
