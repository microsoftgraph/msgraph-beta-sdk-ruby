...
module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::IncomingChannels::Item
    ## 
    ...
    class ChannelItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, channel_id=nil)
            ...
            @url_template = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/incomingChannels/{channel%2Did}{?%24select,%24expand}"
