...
require_relative './microsoft_graph_all_messages/all_messages_request_builder'
...
module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::Channels
    ...
    class ChannelsRequestBuilder
        ...
        def microsoft_graph_all_messages()
            return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::Channels::MicrosoftGraphAllMessages::AllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAllMessages method.
        def microsoft_graph_get_all_messages()
            return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::Channels::MicrosoftGraphGetAllMessages::GetAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
