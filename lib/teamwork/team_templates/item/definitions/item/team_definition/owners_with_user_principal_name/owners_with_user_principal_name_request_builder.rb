                            ...
                            module OwnersWithUserPrincipalName
                                ...
                                class OwnersWithUserPrincipalNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter, user_principal_name=nil)
                                        super(path_parameters, request_adapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/owners(userPrincipalName='{userPrincipalName}'){?%24expand,%24select}")
                                    end
                                    ## 
