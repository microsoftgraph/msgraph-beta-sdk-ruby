...
module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::Operations::Item
    ## 
    ...
    class TeamsAsyncOperationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, teams_async_operation_id=nil)
            ...
            @url_template = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/operations/{teamsAsyncOperation%2Did}{?%24select,%24expand}"
