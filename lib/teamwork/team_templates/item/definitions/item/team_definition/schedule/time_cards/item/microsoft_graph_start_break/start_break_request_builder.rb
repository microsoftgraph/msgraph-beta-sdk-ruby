...
require_relative '../item'
require_relative './microsoft_graph_start_break'

module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::Schedule::TimeCards::Item::MicrosoftGraphStartBreak
    ## 
    ...
    class StartBreakRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}/microsoft.graph.startBreak"
