...
require_relative './microsoft_graph_clock_in/clock_in_request_builder'
...
module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::Schedule::TimeCards
    ...
    class TimeCardsRequestBuilder
        ...
        def microsoft_graph_clock_in()
            return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::Schedule::TimeCards::MicrosoftGraphClockIn::ClockInRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
