...
require_relative './microsoft_graph_clock_in/microsoft_graph_clock_in_request_builder'
require_relative './time_cards'

module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::Schedule::TimeCards
    ## 
    ...
    class TimeCardsRequestBuilder
        ...
        def microsoft_graph_clock_in()
            return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::Schedule::TimeCards::MicrosoftGraphClockIn::MicrosoftGraphClockInRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
