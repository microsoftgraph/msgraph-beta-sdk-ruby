...
module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::Schedule::OfferShiftRequests::Item
    ## 
    ...
    class OfferShiftRequestItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, offer_shift_request_id=nil)
            ...
            @url_template = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/offerShiftRequests/{offerShiftRequest%2Did}{?%24select,%24expand}"
