...
module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition
    ...
    class TeamDefinitionRequestBuilder
        ...
        def microsoft_graph_archive()
            return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::MicrosoftGraphArchive::MicrosoftGraphArchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the clone method.
        def microsoft_graph_clone()
            return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::MicrosoftGraphClone::MicrosoftGraphCloneRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the completeMigration method.
        def microsoft_graph_complete_migration()
            return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::MicrosoftGraphCompleteMigration::MicrosoftGraphCompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendActivityNotification method.
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::MicrosoftGraphSendActivityNotification::MicrosoftGraphSendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unarchive method.
        def microsoft_graph_unarchive()
            return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::MicrosoftGraphUnarchive::MicrosoftGraphUnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
