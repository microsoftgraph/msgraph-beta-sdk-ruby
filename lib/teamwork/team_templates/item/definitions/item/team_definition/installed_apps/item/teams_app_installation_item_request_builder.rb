...
module MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::InstalledApps::Item
    ...
    class TeamsAppInstallationItemRequestBuilder
        ...
        def microsoft_graph_upgrade()
            return MicrosoftGraphBeta::Teamwork::TeamTemplates::Item::Definitions::Item::TeamDefinition::InstalledApps::Item::MicrosoftGraphUpgrade::UpgradeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
