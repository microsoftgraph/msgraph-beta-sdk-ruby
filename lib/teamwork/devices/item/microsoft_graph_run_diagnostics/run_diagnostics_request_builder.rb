...
require_relative './microsoft_graph_run_diagnostics'

module MicrosoftGraphBeta::Teamwork::Devices::Item::MicrosoftGraphRunDiagnostics
    ## 
    ...
    class RunDiagnosticsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamwork/devices/{teamworkDevice%2Did}/microsoft.graph.runDiagnostics"
