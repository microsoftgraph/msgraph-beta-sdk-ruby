        ...
        module Devices
            module Item
                module RunDiagnostics
                    ...
                    class RunDiagnosticsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/teamwork/devices/{teamworkDevice%2Did}/runDiagnostics")
                        end
                        ## 
                        ...
                        ## @return a run_diagnostics_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return RunDiagnosticsRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
