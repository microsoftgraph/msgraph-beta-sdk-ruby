...
require_relative './microsoft_graph_run_diagnostics/run_diagnostics_request_builder'
require_relative './microsoft_graph_update_software/update_software_request_builder'
require_relative './operations/item/teamwork_device_operation_item_request_builder'
require_relative './operations/operations_request_builder'

module MicrosoftGraphBeta::Teamwork::Devices::Item
    ## 
    ...
    class TeamworkDeviceItemRequestBuilder
        ...
        def microsoft_graph_restart()
            return MicrosoftGraphBeta::Teamwork::Devices::Item::MicrosoftGraphRestart::RestartRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the runDiagnostics method.
        def microsoft_graph_run_diagnostics()
            return MicrosoftGraphBeta::Teamwork::Devices::Item::MicrosoftGraphRunDiagnostics::RunDiagnosticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateSoftware method.
        def microsoft_graph_update_software()
            return MicrosoftGraphBeta::Teamwork::Devices::Item::MicrosoftGraphUpdateSoftware::UpdateSoftwareRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param teamworkDeviceId key: id of teamworkDevice
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, teamwork_device_id=nil)
