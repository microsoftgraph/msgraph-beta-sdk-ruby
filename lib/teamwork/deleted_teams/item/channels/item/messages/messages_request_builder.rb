...
module MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::Messages
    ## 
    ...
    class MessagesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::Messages::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
