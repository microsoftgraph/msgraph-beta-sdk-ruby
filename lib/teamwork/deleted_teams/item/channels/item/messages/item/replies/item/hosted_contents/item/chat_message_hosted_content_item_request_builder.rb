                                        ...
                                        module HostedContents
                                            module Item
                                                ...
                                                class ChatMessageHostedContentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                    ...
                                                    def content()
                                                        return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::Messages::Item::Replies::Item::HostedContents::Item::Value::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                                    end
                                                    ## 
