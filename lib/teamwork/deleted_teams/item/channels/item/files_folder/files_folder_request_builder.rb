                    ...
                    module Item
                        module FilesFolder
                            ...
                            class FilesFolderRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def content()
                                    return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::FilesFolder::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the media for the teamwork entity.
                                def content_stream()
                                    return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::FilesFolder::ContentStream::ContentStreamRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
