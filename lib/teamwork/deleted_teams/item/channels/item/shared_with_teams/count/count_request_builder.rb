...
module MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::SharedWithTeams::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/sharedWithTeams/$count"
