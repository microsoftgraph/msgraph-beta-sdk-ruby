...
module MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item
    ## 
    ...
    class ChannelItemRequestBuilder
        ...
        def microsoft_graph_complete_migration()
            return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::MicrosoftGraphCompleteMigration::MicrosoftGraphCompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name()
            return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName::MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the provisionEmail method.
        def microsoft_graph_provision_email()
            return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::MicrosoftGraphProvisionEmail::MicrosoftGraphProvisionEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeEmail method.
        def microsoft_graph_remove_email()
            return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::MicrosoftGraphRemoveEmail::MicrosoftGraphRemoveEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def shared_with_teams_by_id(id)
            ...
            return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::SharedWithTeams::Item::SharedWithChannelTeamInfoItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tabs property of the microsoft.graph.channel entity.
        ## @param id Unique identifier of the item
