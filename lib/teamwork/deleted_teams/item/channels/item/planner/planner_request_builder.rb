                    ...
                    module Item
                        module Planner
                            ...
                            class PlannerRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def plans()
                                    return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::Item::Planner::Plans::PlansRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/planner{?%24expand,%24select}")
                                end
                                ## 
