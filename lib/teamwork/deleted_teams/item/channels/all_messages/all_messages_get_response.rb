    ...
    module Teamwork
        module DeletedTeams
            module Item
                module Channels
                    module AllMessages
                        class AllMessagesGetResponse < MicrosoftGraphBeta::Models::BaseCollectionPaginationCountResponse
                            ...
                            ## @return a all_messages_get_response
                            ## 
                            def self.create_from_discriminator_value(parse_node)
                                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                return AllMessagesGetResponse.new
                            end
                            ## 
