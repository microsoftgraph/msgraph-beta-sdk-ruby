...
module MicrosoftGraphBeta::Teamwork::DeletedTeams::Item
    ## 
    ...
    class DeletedTeamItemRequestBuilder
        ...
        def channels()
            return MicrosoftGraphBeta::Teamwork::DeletedTeams::Item::Channels::ChannelsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param deletedTeamId key: id of deletedTeam
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, deleted_team_id=nil)
