...
module MicrosoftGraphBeta::GovernanceRoleDefinitions::Item::RoleSetting
    ## 
    ...
    class RoleSettingRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/governanceRoleDefinitions/{governanceRoleDefinition%2Did}/roleSetting{?%24select,%24expand}"
