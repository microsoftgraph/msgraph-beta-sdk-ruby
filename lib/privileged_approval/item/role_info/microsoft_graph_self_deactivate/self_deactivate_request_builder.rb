...
module MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::MicrosoftGraphSelfDeactivate
    ## 
    ...
    class SelfDeactivateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/microsoft.graph.selfDeactivate"
