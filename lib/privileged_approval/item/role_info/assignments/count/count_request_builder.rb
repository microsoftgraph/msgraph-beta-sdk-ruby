...
module MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::Assignments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/assignments/$count{?%24search,%24filter}"
