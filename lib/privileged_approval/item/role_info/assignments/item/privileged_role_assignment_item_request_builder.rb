...
module MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::Assignments::Item
    ## 
    ...
    class PrivilegedRoleAssignmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, privileged_role_assignment_id=nil)
            ...
            @url_template = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/assignments/{privilegedRoleAssignment%2Did}{?%24select,%24expand}"
