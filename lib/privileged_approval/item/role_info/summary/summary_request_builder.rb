...
module MicrosoftGraphBeta::PrivilegedApproval::Item::RoleInfo::Summary
    ## 
    ...
    class SummaryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/summary{?%24select,%24expand}"
