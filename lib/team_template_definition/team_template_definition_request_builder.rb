...
module MicrosoftGraphBeta
    module TeamTemplateDefinition
        ...
        class TeamTemplateDefinitionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            
            ## 
            # Provides operations to count the resources in the collection.
            def count()
                return MicrosoftGraphBeta::TeamTemplateDefinition::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ## Provides operations to manage the collection of teamTemplateDefinition entities.
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/teamTemplateDefinition{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/teamTemplateDefinition'
                request_info.path_parameters = @path_parameters
            ...
            ## @return a team_template_definition_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return TeamTemplateDefinitionRequestBuilder.new(raw_url, @request_adapter)
            end
