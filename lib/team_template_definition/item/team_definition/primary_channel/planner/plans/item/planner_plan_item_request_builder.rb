                        ...
                        module Plans
                            module Item
                                ...
                                class PlannerPlanItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def archive()
                                        return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::Planner::Plans::Item::Archive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the buckets property of the microsoft.graph.plannerPlan entity.
                                    def buckets()
                                        return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::Planner::Plans::Item::Buckets::BucketsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the details property of the microsoft.graph.plannerPlan entity.
                                    def details()
                                        return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::Planner::Plans::Item::Details::DetailsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the moveToContainer method.
                                    def move_to_container()
                                        return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::Planner::Plans::Item::MoveToContainer::MoveToContainerRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the tasks property of the microsoft.graph.plannerPlan entity.
                                    def tasks()
                                        return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::Planner::Plans::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the unarchive method.
                                    def unarchive()
                                        return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::Planner::Plans::Item::Unarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/planner/plans/{plannerPlan%2Did}{?%24expand,%24select}")
                                    end
                                    ## 
