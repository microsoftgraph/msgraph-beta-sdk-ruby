                        ...
                        module Remove
                            ...
                            class RemoveRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/allMembers/remove")
                                end
                                ## 
                                ...
                                def post(body, request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PrimaryChannel::AllMembers::Remove::RemovePostResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ## Remove multiple members from a team in a single request. The response provides details about which memberships could and couldn't be removed.
                                ## @param body The request body
