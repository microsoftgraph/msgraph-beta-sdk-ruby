...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Members::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/members/$count{?%24search,%24filter}"
