...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphUnarchive
    ## 
    ...
    class UnarchiveRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/microsoft.graph.unarchive"
