...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PermissionGrants::GetUserOwnedObjects
    ## 
    ...
    class GetUserOwnedObjectsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/permissionGrants/microsoft.graph.getUserOwnedObjects"
