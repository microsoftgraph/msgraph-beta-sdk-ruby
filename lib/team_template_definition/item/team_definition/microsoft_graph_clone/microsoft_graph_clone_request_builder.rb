...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphClone
    ## 
    ...
    class MicrosoftGraphCloneRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/microsoft.graph.clone"
