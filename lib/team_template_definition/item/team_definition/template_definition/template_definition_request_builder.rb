...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::TemplateDefinition
    ## 
    ...
    class TemplateDefinitionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/templateDefinition{?%24select,%24expand}"
