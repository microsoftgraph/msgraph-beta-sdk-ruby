...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::AllChannels::Item
    ## 
    ...
    class ChannelItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, channel_id=nil)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/allChannels/{channel%2Did}{?%24select,%24expand}"
