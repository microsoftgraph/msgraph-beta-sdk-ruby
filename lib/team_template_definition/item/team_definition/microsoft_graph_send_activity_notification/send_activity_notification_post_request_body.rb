...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphSendActivityNotification
    class SendActivityNotificationPostRequestBody
        ...
        def get_field_deserializers()
            return {
                ...
                "previewText" => lambda {|n| @preview_text = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::ItemBody.create_from_discriminator_value(pn) }) },
                "recipient" => lambda {|n| @recipient = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamworkNotificationRecipient.create_from_discriminator_value(pn) }) },
                "templateParameters" => lambda {|n| @template_parameters = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraphBeta::Models::KeyValuePair.create_from_discriminator_value(pn) }) },
                "topic" => lambda {|n| @topic = n.get_object_value(lambda {|pn| MicrosoftGraphBeta::Models::TeamworkActivityTopic.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
