...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Channels::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/$count{?%24search,%24filter}"
