                    ...
                    module Item
                        module Messages
                            ...
                            class MessagesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Channels::Item::Messages::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the delta method.
                                def delta()
                                    return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Channels::Item::Messages::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the forwardToChat method.
                                def forward_to_chat()
                                    return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Channels::Item::Messages::ForwardToChat::ForwardToChatRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the replyWithQuote method.
                                def reply_with_quote()
                                    return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Channels::Item::Messages::ReplyWithQuote::ReplyWithQuoteRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the messages property of the microsoft.graph.channel entity.
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/messages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
