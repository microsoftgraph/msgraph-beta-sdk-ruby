...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition
    ...
    class TeamDefinitionRequestBuilder
        ...
        def microsoft_graph_archive()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphArchive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the clone method.
        def microsoft_graph_clone()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphClone::CloneRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the completeMigration method.
        def microsoft_graph_complete_migration()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphCompleteMigration::CompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendActivityNotification method.
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphSendActivityNotification::SendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unarchive method.
        def microsoft_graph_unarchive()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphUnarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
