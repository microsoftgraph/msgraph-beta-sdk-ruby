...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition
    ## 
    ...
    class TeamDefinitionRequestBuilder
        ...
        def microsoft_graph_archive()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphArchive::MicrosoftGraphArchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the clone method.
        def microsoft_graph_clone()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphClone::MicrosoftGraphCloneRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the completeMigration method.
        def microsoft_graph_complete_migration()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphCompleteMigration::MicrosoftGraphCompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendActivityNotification method.
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphSendActivityNotification::MicrosoftGraphSendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unarchive method.
        def microsoft_graph_unarchive()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::MicrosoftGraphUnarchive::MicrosoftGraphUnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def all_channels_by_id(id)
            ...
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::AllChannels::Item::ChannelItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the channels property of the microsoft.graph.team entity.
        ## @param id Unique identifier of the item
        ...
        def channels_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["channel%2Did"] = id
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Channels::Item::ChannelItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition{?%24select,%24expand}"
        ...
        def incoming_channels_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["channel%2Did"] = id
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::IncomingChannels::Item::ChannelItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the installedApps property of the microsoft.graph.team entity.
        ## @param id Unique identifier of the item
        ...
        def installed_apps_by_id(id)
            ...
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::InstalledApps::Item::TeamsAppInstallationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the members property of the microsoft.graph.team entity.
        ## @param id Unique identifier of the item
        ...
        def members_by_id(id)
            ...
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Members::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.team entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Operations::Item::TeamsAsyncOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the owners property of the microsoft.graph.team entity.
        ## @param id Unique identifier of the item
        ...
        def owners_by_id(id)
            ...
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Owners::Item::UserItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def permission_grants_by_id(id)
            ...
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::PermissionGrants::Item::ResourceSpecificPermissionGrantItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tags property of the microsoft.graph.team entity.
        ## @param id Unique identifier of the item
        ...
        def tags_by_id(id)
            ...
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Tags::Item::TeamworkTagItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property teamDefinition for teamTemplateDefinition
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
