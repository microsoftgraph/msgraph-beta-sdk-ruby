...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Schedule::TimesOff::Item
    ## 
    ...
    class TimeOffItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, time_off_id=nil)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timesOff/{timeOff%2Did}{?%24select}"
