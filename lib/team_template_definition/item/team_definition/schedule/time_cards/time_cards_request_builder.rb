...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Schedule::TimeCards
    ...
    class TimeCardsRequestBuilder
        ...
        def microsoft_graph_clock_in()
            return MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Schedule::TimeCards::MicrosoftGraphClockIn::ClockInRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
