...
require_relative './microsoft_graph_clock_in'

module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Schedule::TimeCards::MicrosoftGraphClockIn
    ## 
    ...
    class ClockInRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/microsoft.graph.clockIn"
