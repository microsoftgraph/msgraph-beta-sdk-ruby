...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Schedule::TimeOffRequests::Item
    ## 
    ...
    class TimeOffRequestItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, time_off_request_id=nil)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeOffRequests/{timeOffRequest%2Did}{?%24select}"
