...
module MicrosoftGraphBeta::TeamTemplateDefinition::Item::TeamDefinition::Schedule::Shifts::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/shifts/$count{?%24search,%24filter}"
