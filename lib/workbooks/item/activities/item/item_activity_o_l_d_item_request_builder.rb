...
module MicrosoftGraphBeta::Workbooks::Item::Activities::Item
    ## 
    ...
    class ItemActivityOLDItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/workbooks/{driveItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}"
