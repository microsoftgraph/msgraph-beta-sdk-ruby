...
module MicrosoftGraphBeta::AdministrativeUnits::Item::ScopedRoleMembers::Item
    ## 
    ...
    class ScopedRoleMembershipItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, scoped_role_membership_id=nil)
            ...
            @url_template = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/scopedRoleMembers/{scopedRoleMembership%2Did}{?%24select,%24expand}"
