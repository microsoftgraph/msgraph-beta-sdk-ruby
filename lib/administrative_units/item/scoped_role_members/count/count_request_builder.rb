...
module MicrosoftGraphBeta::AdministrativeUnits::Item::ScopedRoleMembers::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/scopedRoleMembers/$count{?%24search,%24filter}"
