...
module MicrosoftGraphBeta::AdministrativeUnits::Item::Members::Item::MicrosoftGraphApplication
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/microsoft.graph.application{?%24select,%24expand}"
