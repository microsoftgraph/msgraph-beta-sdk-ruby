...
module MicrosoftGraphBeta::AdministrativeUnits::Item::Members::Item::ServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}"
