...
module MicrosoftGraphBeta::AdministrativeUnits::Item::Members::Item::MicrosoftGraphDevice
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}"
