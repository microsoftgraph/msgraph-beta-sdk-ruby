...
module MicrosoftGraphBeta::AdministrativeUnits::Item::Members::Item::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}"
