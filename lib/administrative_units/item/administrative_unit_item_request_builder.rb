    ...
    module AdministrativeUnits
        module Item
            ...
            class AdministrativeUnitItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def deleted_members()
                    return MicrosoftGraphBeta::AdministrativeUnits::Item::DeletedMembers::DeletedMembersRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}{?%24expand,%24select}")
                end
                ## 
