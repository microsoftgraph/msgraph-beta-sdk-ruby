...
module MicrosoftGraphBeta::AdministrativeUnits::MicrosoftGraphGetUserOwnedObjects
    ## 
    ...
    class GetUserOwnedObjectsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/administrativeUnits/microsoft.graph.getUserOwnedObjects"
