...
module MicrosoftGraphBeta::AppCatalogs
    ## 
    ...
    class AppCatalogsRequestBuilder
        ...
        def teams_apps()
            return MicrosoftGraphBeta::AppCatalogs::TeamsApps::TeamsAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::AppCatalogs.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update appCatalogs
