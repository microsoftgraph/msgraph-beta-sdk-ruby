...
module MicrosoftGraphBeta::Privacy
    ## 
    ...
    class PrivacyRequestBuilder
        ...
        def subject_rights_requests()
            return MicrosoftGraphBeta::Privacy::SubjectRightsRequests::SubjectRightsRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Privacy.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update privacy
