    ...
    module Privacy
        module SubjectRightsRequests
            ...
            class SubjectRightsRequestsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::Privacy::SubjectRightsRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the subjectRightsRequests property of the microsoft.graph.privacy entity.
                ...
                def by_subject_rights_request_id(subject_rights_request_id)
                    ...
                    return MicrosoftGraphBeta::Privacy::SubjectRightsRequests::Item::SubjectRightsRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SubjectRightsRequestCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
