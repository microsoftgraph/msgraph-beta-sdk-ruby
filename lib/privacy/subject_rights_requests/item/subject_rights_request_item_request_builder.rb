...
require_relative './approvers/item/user_item_request_builder'
require_relative './collaborators/collaborators_request_builder'
require_relative './collaborators/item/user_item_request_builder'
        ...
        module SubjectRightsRequests
            module Item
                ...
                class SubjectRightsRequestItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## 
                    def approvers_by_id(id)
                        raise StandardError, 'id cannot be null' if id.nil?
                        url_tpl_params = @path_parameters.clone
                        url_tpl_params["user%2Did"] = id
                        return MicrosoftGraphBeta::Privacy::SubjectRightsRequests::Item::Approvers::Item::UserItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the collaborators property of the microsoft.graph.subjectRightsRequest entity.
                    ## @param id Unique identifier of the item
                    ## @return a user_item_request_builder
                    ## 
                    def collaborators_by_id(id)
                        raise StandardError, 'id cannot be null' if id.nil?
                        url_tpl_params = @path_parameters.clone
                        url_tpl_params["user%2Did"] = id
                        return MicrosoftGraphBeta::Privacy::SubjectRightsRequests::Item::Collaborators::Item::UserItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def notes_by_id(id)
                        ...
                        return MicrosoftGraphBeta::Privacy::SubjectRightsRequests::Item::Notes::Item::AuthoredNoteItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
