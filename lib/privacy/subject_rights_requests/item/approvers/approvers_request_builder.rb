            ...
            module Item
                module Approvers
                    ...
                    class ApproversRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Privacy::SubjectRightsRequests::Item::Approvers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            ...
                            @url_template = "{+baseurl}/privacy/subjectRightsRequests/{subjectRightsRequest%2Did}/approvers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
