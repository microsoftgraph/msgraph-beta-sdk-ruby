                    ...
                    module Item
                        ...
                        class UserItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def mailbox_settings()
                                return MicrosoftGraphBeta::Privacy::SubjectRightsRequests::Item::Collaborators::Item::MailboxSettings::MailboxSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # The serviceProvisioningErrors property
                            def service_provisioning_errors()
                                return MicrosoftGraphBeta::Privacy::SubjectRightsRequests::Item::Collaborators::Item::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
