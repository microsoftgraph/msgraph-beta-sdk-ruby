...
require_relative '../privileged_roles'
require_relative './assignments/assignments_request_builder'
require_relative './assignments/item/privileged_role_assignment_item_request_builder'
require_relative './item'
require_relative './microsoft_graph_self_activate/self_activate_request_builder'
require_relative './microsoft_graph_self_deactivate/self_deactivate_request_builder'
require_relative './settings/settings_request_builder'
require_relative './summary/summary_request_builder'

module MicrosoftGraphBeta::PrivilegedRoles::Item
    ## 
    ...
    class PrivilegedRoleItemRequestBuilder
        ...
        def assignments()
            return MicrosoftGraphBeta::PrivilegedRoles::Item::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the selfActivate method.
        def microsoft_graph_self_activate()
            return MicrosoftGraphBeta::PrivilegedRoles::Item::MicrosoftGraphSelfActivate::SelfActivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the selfDeactivate method.
        def microsoft_graph_self_deactivate()
            return MicrosoftGraphBeta::PrivilegedRoles::Item::MicrosoftGraphSelfDeactivate::SelfDeactivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def settings()
            return MicrosoftGraphBeta::PrivilegedRoles::Item::Settings::SettingsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the summary property of the microsoft.graph.privilegedRole entity.
        def summary()
            return MicrosoftGraphBeta::PrivilegedRoles::Item::Summary::SummaryRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def assignments_by_id(id)
            ...
            return MicrosoftGraphBeta::PrivilegedRoles::Item::Assignments::Item::PrivilegedRoleAssignmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Instantiates a new PrivilegedRoleItemRequestBuilder and sets the default values.
        ## @param pathParameters Path parameters for the request
        ## @param privilegedRoleId key: id of privilegedRole
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, privileged_role_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/privilegedRoles/{privilegedRole%2Did}{?%24select,%24expand}"
