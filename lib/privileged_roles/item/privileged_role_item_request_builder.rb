...
module MicrosoftGraphBeta::PrivilegedRoles::Item
    ...
    class PrivilegedRoleItemRequestBuilder
        ...
        def microsoft_graph_self_activate()
            return MicrosoftGraphBeta::PrivilegedRoles::Item::MicrosoftGraphSelfActivate::MicrosoftGraphSelfActivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the selfDeactivate method.
        def microsoft_graph_self_deactivate()
            return MicrosoftGraphBeta::PrivilegedRoles::Item::MicrosoftGraphSelfDeactivate::MicrosoftGraphSelfDeactivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
