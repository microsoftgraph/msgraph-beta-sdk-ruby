...
module MicrosoftGraphBeta
    module PrivilegedRoles
        module Item
            ...
            class PrivilegedRoleItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def self_activate()
                    return MicrosoftGraphBeta::PrivilegedRoles::Item::SelfActivate::SelfActivateRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the selfDeactivate method.
                def self_deactivate()
                    return MicrosoftGraphBeta::PrivilegedRoles::Item::SelfDeactivate::SelfDeactivateRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/privilegedRoles/{privilegedRole%2Did}{?%24select,%24expand}")
                end
                ## 
