...
module MicrosoftGraphBeta::PrivilegedRoles::Item::MicrosoftGraphSelfDeactivate
    ## 
    ...
    class MicrosoftGraphSelfDeactivateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/privilegedRoles/{privilegedRole%2Did}/microsoft.graph.selfDeactivate"
