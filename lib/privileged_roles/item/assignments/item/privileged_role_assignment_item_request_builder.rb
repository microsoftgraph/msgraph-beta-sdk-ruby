...
module MicrosoftGraphBeta::PrivilegedRoles::Item::Assignments::Item
    ## 
    ...
    class PrivilegedRoleAssignmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, privileged_role_assignment_id=nil)
            ...
            @url_template = "{+baseurl}/privilegedRoles/{privilegedRole%2Did}/assignments/{privilegedRoleAssignment%2Did}{?%24select,%24expand}"
