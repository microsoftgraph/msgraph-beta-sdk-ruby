...
module MicrosoftGraphBeta::DirectoryRoleTemplates::MicrosoftGraphGetUserOwnedObjects
    ## 
    ...
    class MicrosoftGraphGetUserOwnedObjectsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directoryRoleTemplates/microsoft.graph.getUserOwnedObjects"
