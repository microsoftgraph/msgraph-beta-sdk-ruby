        ...
        module AvailableProviderTypes
            ...
            class AvailableProviderTypesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::IdentityProviders::AvailableProviderTypes::AvailableProviderTypesGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Retrieves all identity provider types available in a directory.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
