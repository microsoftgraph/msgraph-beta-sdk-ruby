...
module MicrosoftGraphBeta::IdentityProviders
    ...
    class IdentityProvidersRequestBuilder
        ...
        def microsoft_graph_available_provider_types()
            return MicrosoftGraphBeta::IdentityProviders::MicrosoftGraphAvailableProviderTypes::MicrosoftGraphAvailableProviderTypesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
