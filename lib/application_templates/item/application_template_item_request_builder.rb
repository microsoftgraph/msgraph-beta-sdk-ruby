...
module MicrosoftGraphBeta::ApplicationTemplates::Item
    ## 
    ...
    class ApplicationTemplateItemRequestBuilder
        ...
        def microsoft_graph_instantiate()
            return MicrosoftGraphBeta::ApplicationTemplates::Item::MicrosoftGraphInstantiate::MicrosoftGraphInstantiateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
