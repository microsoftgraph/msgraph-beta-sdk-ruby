...
module MicrosoftGraphBeta::BookingBusinesses::Item::CalendarView::Item
    ## 
    ...
    class BookingAppointmentItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::BookingBusinesses::Item::CalendarView::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/calendarView/{bookingAppointment%2Did}{?start*,end*,%24select,%24expand}"
