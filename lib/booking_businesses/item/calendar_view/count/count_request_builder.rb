...
module MicrosoftGraphBeta::BookingBusinesses::Item::CalendarView::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/calendarView/$count{?%24search,%24filter}"
