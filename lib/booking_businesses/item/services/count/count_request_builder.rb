...
module MicrosoftGraphBeta::BookingBusinesses::Item::Services::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/services/$count{?%24search,%24filter}"
