...
module MicrosoftGraphBeta::BookingBusinesses::Item::Appointments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/appointments/$count{?%24search,%24filter}"
