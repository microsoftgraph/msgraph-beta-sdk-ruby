        ...
        module OnlineMeetingsWithJoinWebUrl
            ...
            class OnlineMeetingsWithJoinWebUrlRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def get_virtual_appointment_join_web_url()
                    return MicrosoftGraphBeta::App::OnlineMeetingsWithJoinWebUrl::GetVirtualAppointmentJoinWebUrl::GetVirtualAppointmentJoinWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the sendVirtualAppointmentReminderSms method.
                def send_virtual_appointment_reminder_sms()
                    return MicrosoftGraphBeta::App::OnlineMeetingsWithJoinWebUrl::SendVirtualAppointmentReminderSms::SendVirtualAppointmentReminderSmsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the sendVirtualAppointmentSms method.
                def send_virtual_appointment_sms()
                    return MicrosoftGraphBeta::App::OnlineMeetingsWithJoinWebUrl::SendVirtualAppointmentSms::SendVirtualAppointmentSmsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter, join_web_url=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/app/onlineMeetings(joinWebUrl='{joinWebUrl}'){?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/app/onlineMeetings(joinWebUrl='{joinWebUrl}')'
