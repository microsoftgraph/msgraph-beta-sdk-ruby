...
module MicrosoftGraphBeta::App::Calls::Item::ContentSharingSessions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/calls/{call%2Did}/contentSharingSessions/$count{?%24search,%24filter}"
