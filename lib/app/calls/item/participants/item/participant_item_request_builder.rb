...
module MicrosoftGraphBeta::App::Calls::Item::Participants::Item
    ## 
    ...
    class ParticipantItemRequestBuilder
        ...
        def microsoft_graph_mute()
            return MicrosoftGraphBeta::App::Calls::Item::Participants::Item::MicrosoftGraphMute::MicrosoftGraphMuteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the startHoldMusic method.
        def microsoft_graph_start_hold_music()
            return MicrosoftGraphBeta::App::Calls::Item::Participants::Item::MicrosoftGraphStartHoldMusic::MicrosoftGraphStartHoldMusicRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the stopHoldMusic method.
        def microsoft_graph_stop_hold_music()
            return MicrosoftGraphBeta::App::Calls::Item::Participants::Item::MicrosoftGraphStopHoldMusic::MicrosoftGraphStopHoldMusicRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/calls/{call%2Did}/participants/{participant%2Did}{?%24select,%24expand}"
