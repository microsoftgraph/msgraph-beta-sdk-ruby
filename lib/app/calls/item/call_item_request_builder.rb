...
require_relative './microsoft_graph_record/microsoft_graph_record_request_builder'
...
module MicrosoftGraphBeta::App::Calls::Item
    ## 
    ...
    class CallItemRequestBuilder
        ...
        def microsoft_graph_add_large_gallery_view()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphAddLargeGalleryView::MicrosoftGraphAddLargeGalleryViewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the answer method.
        def microsoft_graph_answer()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphAnswer::MicrosoftGraphAnswerRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancelMediaProcessing method.
        def microsoft_graph_cancel_media_processing()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphCancelMediaProcessing::MicrosoftGraphCancelMediaProcessingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the changeScreenSharingRole method.
        def microsoft_graph_change_screen_sharing_role()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphChangeScreenSharingRole::MicrosoftGraphChangeScreenSharingRoleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the keepAlive method.
        def microsoft_graph_keep_alive()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphKeepAlive::MicrosoftGraphKeepAliveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the mute method.
        def microsoft_graph_mute()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphMute::MicrosoftGraphMuteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the playPrompt method.
        def microsoft_graph_play_prompt()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphPlayPrompt::MicrosoftGraphPlayPromptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the record method.
        def microsoft_graph_record()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphRecord::MicrosoftGraphRecordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the recordResponse method.
        def microsoft_graph_record_response()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphRecordResponse::MicrosoftGraphRecordResponseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the redirect method.
        def microsoft_graph_redirect()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphRedirect::MicrosoftGraphRedirectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reject method.
        def microsoft_graph_reject()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphReject::MicrosoftGraphRejectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the subscribeToTone method.
        def microsoft_graph_subscribe_to_tone()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphSubscribeToTone::MicrosoftGraphSubscribeToToneRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the transfer method.
        def microsoft_graph_transfer()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphTransfer::MicrosoftGraphTransferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unmute method.
        def microsoft_graph_unmute()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphUnmute::MicrosoftGraphUnmuteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRecordingStatus method.
        def microsoft_graph_update_recording_status()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphUpdateRecordingStatus::MicrosoftGraphUpdateRecordingStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/calls/{call%2Did}{?%24select,%24expand}"
        ...
        def content_sharing_sessions_by_id(id)
            ...
            return MicrosoftGraphBeta::App::Calls::Item::ContentSharingSessions::Item::ContentSharingSessionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
