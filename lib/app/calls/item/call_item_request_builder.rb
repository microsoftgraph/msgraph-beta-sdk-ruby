...
require_relative './microsoft_graph_record/record_request_builder'
...
module MicrosoftGraphBeta::App::Calls::Item
    ...
    class CallItemRequestBuilder
        ...
        def microsoft_graph_add_large_gallery_view()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphAddLargeGalleryView::AddLargeGalleryViewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the answer method.
        def microsoft_graph_answer()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphAnswer::AnswerRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancelMediaProcessing method.
        def microsoft_graph_cancel_media_processing()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphCancelMediaProcessing::CancelMediaProcessingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the changeScreenSharingRole method.
        def microsoft_graph_change_screen_sharing_role()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphChangeScreenSharingRole::ChangeScreenSharingRoleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the keepAlive method.
        def microsoft_graph_keep_alive()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphKeepAlive::KeepAliveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the mute method.
        def microsoft_graph_mute()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphMute::MuteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the playPrompt method.
        def microsoft_graph_play_prompt()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphPlayPrompt::PlayPromptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the record method.
        def microsoft_graph_record()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphRecord::RecordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the recordResponse method.
        def microsoft_graph_record_response()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphRecordResponse::RecordResponseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the redirect method.
        def microsoft_graph_redirect()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphRedirect::RedirectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reject method.
        def microsoft_graph_reject()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphReject::RejectRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the subscribeToTone method.
        def microsoft_graph_subscribe_to_tone()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphSubscribeToTone::SubscribeToToneRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the transfer method.
        def microsoft_graph_transfer()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphTransfer::TransferRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unmute method.
        def microsoft_graph_unmute()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphUnmute::UnmuteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateRecordingStatus method.
        def microsoft_graph_update_recording_status()
            return MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphUpdateRecordingStatus::UpdateRecordingStatusRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
