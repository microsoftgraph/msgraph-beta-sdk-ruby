...
module MicrosoftGraphBeta::App::Calls::Item::MicrosoftGraphUpdateRecordingStatus
    ## 
    ...
    class UpdateRecordingStatusRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/calls/{call%2Did}/microsoft.graph.updateRecordingStatus"
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::UpdateRecordingStatusOperation.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the application's recording status associated with a call. This requires the use of the Teams policy-based recording solution.
        ## @param body The request body
