...
module MicrosoftGraphBeta::App::Calls
    ## 
    ...
    class CallsRequestBuilder
        ...
        def microsoft_graph_log_teleconference_device_quality()
            return MicrosoftGraphBeta::App::Calls::MicrosoftGraphLogTeleconferenceDeviceQuality::MicrosoftGraphLogTeleconferenceDeviceQualityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/calls{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
