...
module MicrosoftGraphBeta::App::Calls
    ...
    class CallsRequestBuilder
        ...
        def microsoft_graph_log_teleconference_device_quality()
            return MicrosoftGraphBeta::App::Calls::MicrosoftGraphLogTeleconferenceDeviceQuality::LogTeleconferenceDeviceQualityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
