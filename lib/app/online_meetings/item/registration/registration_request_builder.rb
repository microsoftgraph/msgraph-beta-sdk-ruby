...
module MicrosoftGraphBeta::App::OnlineMeetings::Item::Registration
    ## 
    ...
    class RegistrationRequestBuilder
        ...
        def custom_questions()
            return MicrosoftGraphBeta::App::OnlineMeetings::Item::Registration::CustomQuestions::CustomQuestionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/registration{?%24select,%24expand}"
        ...
        def custom_questions_by_id(id)
            ...
            return MicrosoftGraphBeta::App::OnlineMeetings::Item::Registration::CustomQuestions::Item::MeetingRegistrationQuestionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
