...
module MicrosoftGraphBeta::App::OnlineMeetings::Item::Transcripts::Item
    ## 
    ...
    class CallTranscriptItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, call_transcript_id=nil)
            ...
            @url_template = "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/transcripts/{callTranscript%2Did}{?%24select,%24expand}"
