...
module MicrosoftGraphBeta::App::OnlineMeetings::Item::Transcripts::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/transcripts/$count{?%24search,%24filter}"
