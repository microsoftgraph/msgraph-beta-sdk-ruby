...
module MicrosoftGraphBeta::App::OnlineMeetings::Item::Transcripts
    ## 
    ...
    class TranscriptsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/transcripts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
