...
module MicrosoftGraphBeta::App::OnlineMeetings::Item::AttendanceReports::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/$count{?%24search,%24filter}"
