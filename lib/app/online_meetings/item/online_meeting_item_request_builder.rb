        ...
        module OnlineMeetings
            module Item
                ...
                class OnlineMeetingItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def ai_insights()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::AiInsights::AiInsightsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the media for the commsApplication entity.
                    def alternative_recording()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::AlternativeRecording::AlternativeRecordingRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the attendanceReports property of the microsoft.graph.onlineMeetingBase entity.
                    def attendance_reports()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::AttendanceReports::AttendanceReportsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the media for the commsApplication entity.
                    def attendee_report()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::AttendeeReport::AttendeeReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the media for the commsApplication entity.
                    def broadcast_recording()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::BroadcastRecording::BroadcastRecordingRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getVirtualAppointmentJoinWebUrl method.
                    def get_virtual_appointment_join_web_url()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::GetVirtualAppointmentJoinWebUrl::GetVirtualAppointmentJoinWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def meeting_attendance_report()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::MeetingAttendanceReport::MeetingAttendanceReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the media for the commsApplication entity.
                    def recording()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::Recording::RecordingRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the recordings property of the microsoft.graph.onlineMeeting entity.
                    def recordings()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::Recordings::RecordingsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the registration property of the microsoft.graph.onlineMeeting entity.
                    def registration()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::Registration::RegistrationRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the sendVirtualAppointmentReminderSms method.
                    def send_virtual_appointment_reminder_sms()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::SendVirtualAppointmentReminderSms::SendVirtualAppointmentReminderSmsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the sendVirtualAppointmentSms method.
                    def send_virtual_appointment_sms()
                        return MicrosoftGraphBeta::App::OnlineMeetings::Item::SendVirtualAppointmentSms::SendVirtualAppointmentSmsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}{?%24expand,%24select}")
                    end
                    ## 
