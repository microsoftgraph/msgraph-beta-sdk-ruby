                    ...
                    class SendVirtualAppointmentReminderSmsPostRequestBody
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "remindBeforeTimeInMinutesType" => lambda {|n| @remind_before_time_in_minutes_type = n.get_enum_value(MicrosoftGraphBeta::App::OnlineMeetings::Item::SendVirtualAppointmentReminderSms::SendVirtualAppointmentReminderSmsPostRequestBodyRemindBeforeTimeInMinutesType) },
                            }
                        end
                        ## 
