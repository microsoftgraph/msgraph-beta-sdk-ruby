                    ...
                    class SendVirtualAppointmentSmsPostRequestBody
                        ...
                        def get_field_deserializers()
                            return {
                                ...
                                "smsType" => lambda {|n| @sms_type = n.get_enum_value(MicrosoftGraphBeta::App::OnlineMeetings::Item::SendVirtualAppointmentSms::SendVirtualAppointmentSmsPostRequestBodySmsType) },
                            }
                        end
                        ## 
