    ...
    module App
        module OnlineMeetings
            ...
            class OnlineMeetingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::App::OnlineMeetings::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the createOrGet method.
                def create_or_get()
                    return MicrosoftGraphBeta::App::OnlineMeetings::CreateOrGet::CreateOrGetRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def get_all_recordingsmeeting_organizer_user_id_meeting_organizer_user_id_with_start_date_time_with_end_date_time()
                    return MicrosoftGraphBeta::App::OnlineMeetings::Ibe4c23e921ad9fcaa5c959c34e393ba839c959ee578ec95fd69bc2d9aa0b2597::GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerUserIdWithStartDateTimeWithEndDateTimeRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def get_all_transcriptsmeeting_organizer_user_id_meeting_organizer_user_id_with_start_date_time_with_end_date_time()
                    return MicrosoftGraphBeta::App::OnlineMeetings::I056e0011aad1cfd99d94f2d6b75f21d85f8b7cfe3c3983a69234033a5ffcd08b::GetAllTranscriptsmeetingOrganizerUserIdMeetingOrganizerUserIdWithStartDateTimeWithEndDateTimeRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the onlineMeetings property of the microsoft.graph.commsApplication entity.
                ...
                def by_online_meeting_id(online_meeting_id)
                    ...
                    return MicrosoftGraphBeta::App::OnlineMeetings::Item::OnlineMeetingItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/app/onlineMeetings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
