...
module MicrosoftGraphBeta::App::OnlineMeetings
    ## 
    ...
    class OnlineMeetingsRequestBuilder
        ...
        def microsoft_graph_create_or_get()
            return MicrosoftGraphBeta::App::OnlineMeetings::MicrosoftGraphCreateOrGet::MicrosoftGraphCreateOrGetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/app/onlineMeetings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
