    ...
    module App
        ...
        class AppRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/app{?%24expand,%24select}")
            end
            ## 
            ## Get app
            ...
            def to_patch_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/app'
                request_info.path_parameters = @path_parameters
            ...
            ## @return a app_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return AppRequestBuilder.new(raw_url, @request_adapter)
            end
