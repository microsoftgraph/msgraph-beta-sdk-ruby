...
module MicrosoftGraphBeta
    module EmployeeExperience
        ...
        class EmployeeExperienceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def communities()
                return MicrosoftGraphBeta::EmployeeExperience::Communities::CommunitiesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def engagement_async_operations()
                return MicrosoftGraphBeta::EmployeeExperience::EngagementAsyncOperations::EngagementAsyncOperationsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def learning_course_activities()
                return MicrosoftGraphBeta::EmployeeExperience::LearningCourseActivities::LearningCourseActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the learningProviders property of the microsoft.graph.employeeExperience entity.
            def learning_providers()
                return MicrosoftGraphBeta::EmployeeExperience::LearningProviders::LearningProvidersRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::EmployeeExperience.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
