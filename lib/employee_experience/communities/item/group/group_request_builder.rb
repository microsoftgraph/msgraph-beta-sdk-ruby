                ...
                module Group
                    ...
                    class GroupRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def service_provisioning_errors()
                            return MicrosoftGraphBeta::EmployeeExperience::Communities::Item::Group::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/employeeExperience/communities/{community%2Did}/group{?%24select,%24expand}")
                        end
                        ## 
