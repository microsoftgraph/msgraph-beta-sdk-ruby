        ...
        module Communities
            module Item
                ...
                class CommunityItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def group()
                        return MicrosoftGraphBeta::EmployeeExperience::Communities::Item::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the owners property of the microsoft.graph.community entity.
                    def owners()
                        return MicrosoftGraphBeta::EmployeeExperience::Communities::Item::Owners::OwnersRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/employeeExperience/communities/{community%2Did}{?%24select,%24expand}")
                    end
                    ## 
