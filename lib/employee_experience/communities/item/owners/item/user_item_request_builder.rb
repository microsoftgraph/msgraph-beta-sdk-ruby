                    ...
                    module Item
                        ...
                        class UserItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def mailbox_settings()
                                return MicrosoftGraphBeta::EmployeeExperience::Communities::Item::Owners::Item::MailboxSettings::MailboxSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # The serviceProvisioningErrors property
                            def service_provisioning_errors()
                                return MicrosoftGraphBeta::EmployeeExperience::Communities::Item::Owners::Item::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/employeeExperience/communities/{community%2Did}/owners/{user%2Did}{?%24select,%24expand}")
                            end
                            ## 
