    ...
    module EmployeeExperience
        module LearningCourseActivities
            ...
            class LearningCourseActivitiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraphBeta::EmployeeExperience::LearningCourseActivities::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the learningCourseActivities property of the microsoft.graph.employeeExperience entity.
                ...
                def by_learning_course_activity_id(learning_course_activity_id)
                    ...
                    return MicrosoftGraphBeta::EmployeeExperience::LearningCourseActivities::Item::LearningCourseActivityItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
