...
module MicrosoftGraphBeta
    module EmployeeExperience
        module Goals
            ...
            class GoalsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to manage the exportJobs property of the microsoft.graph.goals entity.
                def export_jobs()
                    return MicrosoftGraphBeta::EmployeeExperience::Goals::ExportJobs::ExportJobsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/employeeExperience/goals{?%24expand,%24select}")
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    error_mapping = Hash.new
                    error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Goals.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/employeeExperience/goals'
                ...
                ## @return a goals_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return GoalsRequestBuilder.new(raw_url, @request_adapter)
                end
