            ...
            module Item
                module LearningCourseActivities
                    ...
                    class LearningCourseActivitiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::EmployeeExperience::LearningProviders::Item::LearningCourseActivities::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the learningCourseActivities property of the microsoft.graph.learningProvider entity.
                        ...
                        def by_learning_course_activity_id(learning_course_activity_id)
                            ...
                            return MicrosoftGraphBeta::EmployeeExperience::LearningProviders::Item::LearningCourseActivities::Item::LearningCourseActivityItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::LearningCourseActivityCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::LearningCourseActivity.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Get learningCourseActivities from employeeExperience
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
