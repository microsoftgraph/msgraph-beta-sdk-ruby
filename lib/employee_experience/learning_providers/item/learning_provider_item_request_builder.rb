...
module MicrosoftGraphBeta::EmployeeExperience::LearningProviders::Item
    ## 
    ...
    class LearningProviderItemRequestBuilder
        ...
        ## @param learningProviderId key: id of learningProvider
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, learning_provider_id=nil)
