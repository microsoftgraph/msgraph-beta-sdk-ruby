            ...
            module Item
                module LearningContents
                    ...
                    class LearningContentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::EmployeeExperience::LearningProviders::Item::LearningContents::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the learningContents property of the microsoft.graph.learningProvider entity.
                        ...
                        def by_learning_content_id(learning_content_id)
                            ...
                            return MicrosoftGraphBeta::EmployeeExperience::LearningProviders::Item::LearningContents::Item::LearningContentItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::LearningContentCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
