...
module MicrosoftGraphBeta::Drive::Root::ListItem::Activities
    ## 
    ...
    class ActivitiesRequestBuilder
        ...
        def count()
            return MicrosoftGraphBeta::Drive::Root::ListItem::Activities::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/root/listItem/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
