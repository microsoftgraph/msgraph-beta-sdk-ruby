...
module MicrosoftGraphBeta::Drive::Root::Children::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraphBeta::Drive::Root::Children::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
