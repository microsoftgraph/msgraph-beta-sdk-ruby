...
module MicrosoftGraphBeta::Drive
    ## 
    ...
    class DriveRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Drive::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the bundles property of the microsoft.graph.drive entity.
        def bundles()
            return MicrosoftGraphBeta::Drive::Bundles::BundlesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the following property of the microsoft.graph.drive entity.
        def following()
            return MicrosoftGraphBeta::Drive::Following::FollowingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the items property of the microsoft.graph.drive entity.
        def items()
            return MicrosoftGraphBeta::Drive::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the list property of the microsoft.graph.drive entity.
        def list()
            return MicrosoftGraphBeta::Drive::List::ListRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def root()
            return MicrosoftGraphBeta::Drive::Root::RootRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the special property of the microsoft.graph.drive entity.
        def special()
            return MicrosoftGraphBeta::Drive::Special::SpecialRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def activities_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::Activities::Item::ItemActivityOLDItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the bundles property of the microsoft.graph.drive entity.
        ## @param id Unique identifier of the item
        ...
        def bundles_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::Bundles::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def following_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraphBeta::Drive::Following::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get drive
        ...
        def items_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraphBeta::Drive::Items::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update drive
        ...
        def special_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraphBeta::Drive::Special::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get drive
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
