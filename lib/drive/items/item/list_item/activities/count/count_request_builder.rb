...
module MicrosoftGraphBeta::Drive::Items::Item::ListItem::Activities::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/activities/$count{?%24search,%24filter}"
