...
module MicrosoftGraphBeta::Drive::Items::Item::ListItem::Activities::Item
    ...
    class ItemActivityOLDItemRequestBuilder
        ...
        def drive_item()
            return MicrosoftGraphBeta::Drive::Items::Item::ListItem::Activities::Item::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the listItem property of the microsoft.graph.itemActivityOLD entity.
        def list_item()
            return MicrosoftGraphBeta::Drive::Items::Item::ListItem::Activities::Item::ListItem::ListItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}{?%24select,%24expand}"
