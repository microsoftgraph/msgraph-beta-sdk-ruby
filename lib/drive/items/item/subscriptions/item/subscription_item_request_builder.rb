...
module MicrosoftGraphBeta::Drive::Items::Item::Subscriptions::Item
    ## 
    ...
    class SubscriptionItemRequestBuilder
        ...
        def reauthorize()
            return MicrosoftGraphBeta::Drive::Items::Item::Subscriptions::Item::Reauthorize::ReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
