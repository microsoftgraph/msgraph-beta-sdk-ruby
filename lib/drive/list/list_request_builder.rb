...
module MicrosoftGraphBeta::Drive::List
    ## 
    ...
    class ListRequestBuilder
        ...
        def activities()
            return MicrosoftGraphBeta::Drive::List::Activities::ActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the columns property of the microsoft.graph.list entity.
        def columns()
            return MicrosoftGraphBeta::Drive::List::Columns::ColumnsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the contentTypes property of the microsoft.graph.list entity.
        def content_types()
            return MicrosoftGraphBeta::Drive::List::ContentTypes::ContentTypesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the drive property of the microsoft.graph.list entity.
        def drive()
            return MicrosoftGraphBeta::Drive::List::Drive::DriveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the items property of the microsoft.graph.list entity.
        def items()
            return MicrosoftGraphBeta::Drive::List::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.list entity.
        def operations()
            return MicrosoftGraphBeta::Drive::List::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def subscriptions()
            return MicrosoftGraphBeta::Drive::List::Subscriptions::SubscriptionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def columns_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::List::Columns::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def content_types_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::List::ContentTypes::Item::ContentTypeItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def items_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::List::Items::Item::ListItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.list entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::List::Operations::Item::RichLongRunningOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def subscriptions_by_id(id)
            ...
            return MicrosoftGraphBeta::Drive::List::Subscriptions::Item::SubscriptionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property list for drive
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
