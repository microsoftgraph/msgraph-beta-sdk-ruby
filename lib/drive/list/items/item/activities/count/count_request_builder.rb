...
module MicrosoftGraphBeta::Drive::List::Items::Item::Activities::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/items/{listItem%2Did}/activities/$count{?%24search,%24filter}"
