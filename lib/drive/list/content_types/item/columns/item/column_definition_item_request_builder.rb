...
module MicrosoftGraphBeta::Drive::List::ContentTypes::Item::Columns::Item
    ## 
    ...
    class ColumnDefinitionItemRequestBuilder
        ...
        def source_column()
            return MicrosoftGraphBeta::Drive::List::ContentTypes::Item::Columns::Item::SourceColumn::SourceColumnRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
