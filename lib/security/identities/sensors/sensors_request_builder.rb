        ...
        module Identities
            module Sensors
                ...
                class SensorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Security::Identities::Sensors::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getDeploymentAccessKey method.
                    def microsoft_graph_security_get_deployment_access_key()
                        return MicrosoftGraphBeta::Security::Identities::Sensors::MicrosoftGraphSecurityGetDeploymentAccessKey::MicrosoftGraphSecurityGetDeploymentAccessKeyRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getDeploymentPackageUri method.
                    def microsoft_graph_security_get_deployment_package_uri()
                        return MicrosoftGraphBeta::Security::Identities::Sensors::MicrosoftGraphSecurityGetDeploymentPackageUri::MicrosoftGraphSecurityGetDeploymentPackageUriRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def microsoft_graph_security_regenerate_deployment_access_key()
                        return MicrosoftGraphBeta::Security::Identities::Sensors::MicrosoftGraphSecurityRegenerateDeploymentAccessKey::MicrosoftGraphSecurityRegenerateDeploymentAccessKeyRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the sensors property of the microsoft.graph.security.identityContainer entity.
                    ...
                    def by_sensor_id(sensor_id)
                        ...
                        return MicrosoftGraphBeta::Security::Identities::Sensors::Item::SensorItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SecuritySensorCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ...
                    def post(body, request_configuration=nil)
                        ...
                        error_mapping = Hash.new
                        error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SecuritySensor.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Get sensors from security
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
