        ...
        module AttackSimulation
            module Simulations
                ...
                class SimulationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraphBeta::Security::AttackSimulation::Simulations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the simulations property of the microsoft.graph.attackSimulationRoot entity.
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SimulationCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
