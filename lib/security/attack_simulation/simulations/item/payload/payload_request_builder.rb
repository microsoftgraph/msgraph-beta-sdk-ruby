...
module MicrosoftGraphBeta::Security::AttackSimulation::Simulations::Item::Payload
    ## 
    ...
    class PayloadRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/attackSimulation/simulations/{simulation%2Did}/payload{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Payload.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Get payload from security
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
