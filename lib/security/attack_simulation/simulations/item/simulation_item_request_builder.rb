            ...
            module Simulations
                module Item
                    ...
                    class SimulationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def landing_page()
                            return MicrosoftGraphBeta::Security::AttackSimulation::Simulations::Item::LandingPage::LandingPageRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the loginPage property of the microsoft.graph.simulation entity.
                        def login_page()
                            return MicrosoftGraphBeta::Security::AttackSimulation::Simulations::Item::LoginPage::LoginPageRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the payload property of the microsoft.graph.simulation entity.
                        def payload()
                            return MicrosoftGraphBeta::Security::AttackSimulation::Simulations::Item::Payload::PayloadRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
