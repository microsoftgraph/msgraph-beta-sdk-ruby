        ...
        module AttackSimulation
            ...
            class AttackSimulationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def end_user_notifications()
                    return MicrosoftGraphBeta::Security::AttackSimulation::EndUserNotifications::EndUserNotificationsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the landingPages property of the microsoft.graph.attackSimulationRoot entity.
                def landing_pages()
                    return MicrosoftGraphBeta::Security::AttackSimulation::LandingPages::LandingPagesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the loginPages property of the microsoft.graph.attackSimulationRoot entity.
                def login_pages()
                    return MicrosoftGraphBeta::Security::AttackSimulation::LoginPages::LoginPagesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
