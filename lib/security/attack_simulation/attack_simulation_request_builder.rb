...
require_relative './operations/item/attack_simulation_operation_item_request_builder'
require_relative './operations/operations_request_builder'
require_relative './payloads/item/payload_item_request_builder'
...
module MicrosoftGraphBeta::Security::AttackSimulation
    ## 
    ...
    class AttackSimulationRequestBuilder
        ...
        def operations()
            return MicrosoftGraphBeta::Security::AttackSimulation::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def payloads()
            return MicrosoftGraphBeta::Security::AttackSimulation::Payloads::PayloadsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def simulation_automations()
            return MicrosoftGraphBeta::Security::AttackSimulation::SimulationAutomations::SimulationAutomationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::AttackSimulation::Operations::Item::AttackSimulationOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        ## 
        def payloads_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["payload%2Did"] = id
            return MicrosoftGraphBeta::Security::AttackSimulation::Payloads::Item::PayloadItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the simulationAutomations property of the microsoft.graph.attackSimulationRoot entity.
        ## @param id Unique identifier of the item
        ...
        def simulation_automations_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::AttackSimulation::SimulationAutomations::Item::SimulationAutomationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the simulations property of the microsoft.graph.attackSimulationRoot entity.
        ## @param id Unique identifier of the item
        ...
        def simulations_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::AttackSimulation::Simulations::Item::SimulationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property attackSimulation for security
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
