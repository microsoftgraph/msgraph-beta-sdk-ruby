...
module MicrosoftGraphBeta::Security::SubjectRightsRequests::Item
    ...
    class SubjectRightsRequestItemRequestBuilder
        ...
        def microsoft_graph_get_final_attachment()
            return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::MicrosoftGraphGetFinalAttachment::GetFinalAttachmentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getFinalReport method.
        def microsoft_graph_get_final_report()
            return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::MicrosoftGraphGetFinalReport::GetFinalReportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
