...
module MicrosoftGraphBeta::Security::SubjectRightsRequests::Item
    ## 
    ...
    class SubjectRightsRequestItemRequestBuilder
        ...
        def microsoft_graph_get_final_attachment()
            return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::MicrosoftGraphGetFinalAttachment::MicrosoftGraphGetFinalAttachmentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getFinalReport method.
        def microsoft_graph_get_final_report()
            return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::MicrosoftGraphGetFinalReport::MicrosoftGraphGetFinalReportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
