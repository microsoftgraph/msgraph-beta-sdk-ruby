        ...
        module SubjectRightsRequests
            module Item
                ...
                class SubjectRightsRequestItemRequestBuilder
                    ...
                    def approvers()
                        return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::Approvers::ApproversRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the collaborators property of the microsoft.graph.subjectRightsRequest entity.
                    def collaborators()
                        return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::Collaborators::CollaboratorsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getFinalAttachment method.
                    def get_final_attachment()
                        return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::GetFinalAttachment::GetFinalAttachmentRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getFinalReport method.
                    def get_final_report()
                        return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::GetFinalReport::GetFinalReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the notes property of the microsoft.graph.subjectRightsRequest entity.
                    def notes()
                        return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::Notes::NotesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def team()
                        return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::Team::TeamRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def approvers_by_id(id)
                        ...
                        return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::Approvers::Item::UserItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the collaborators property of the microsoft.graph.subjectRightsRequest entity.
                    ## @param id Unique identifier of the item
                    ...
                    def collaborators_by_id(id)
                        ...
                        url_tpl_params = @path_parameters.clone
                        url_tpl_params["user%2Did"] = id
                        return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::Collaborators::Item::UserItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        ...
                        @url_template = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}{?%24select,%24expand}"
                    ...
                    def notes_by_id(id)
                        ...
                        return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::Notes::Item::AuthoredNoteItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
