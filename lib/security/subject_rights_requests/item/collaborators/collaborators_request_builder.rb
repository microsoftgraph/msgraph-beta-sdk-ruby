            ...
            module Item
                module Collaborators
                    ...
                    class CollaboratorsRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::Collaborators::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            ...
                            @url_template = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/collaborators{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
