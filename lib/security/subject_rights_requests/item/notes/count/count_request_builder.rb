...
module MicrosoftGraphBeta::Security::SubjectRightsRequests::Item::Notes::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes/$count{?%24search,%24filter}"
