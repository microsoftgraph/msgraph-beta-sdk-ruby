...
require_relative '../models/security_model_model_model_model_model_model'
...
require_relative './data_discovery/data_discovery_request_builder'
...
require_relative './partner/partner_request_builder'
...
module MicrosoftGraphBeta
    module Security
        ...
        class SecurityRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def data_discovery()
                return MicrosoftGraphBeta::Security::DataDiscovery::DataDiscoveryRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def identities()
                return MicrosoftGraphBeta::Security::Identities::IdentitiesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def partner()
                return MicrosoftGraphBeta::Security::Partner::PartnerRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            ## @return a Fiber of security_model_model_model_model_model_model
            ## 
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SecurityModelModelModelModelModelModel.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
            ## Update security
