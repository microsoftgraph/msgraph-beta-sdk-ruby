...
require_relative './security_score/security_score_request_builder'
    ...
    module Security
        module Partner
            ...
            class PartnerRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def security_score()
                    return MicrosoftGraphBeta::Security::Partner::SecurityScore::SecurityScoreRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
