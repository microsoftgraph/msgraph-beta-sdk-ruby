            ...
            module WhoisRecords
                module Item
                    ...
                    class WhoisRecordItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def history()
                            return MicrosoftGraphBeta::Security::ThreatIntelligence::WhoisRecords::Item::History::HistoryRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the host property of the microsoft.graph.security.whoisBaseRecord entity.
                        def host()
                            return MicrosoftGraphBeta::Security::ThreatIntelligence::WhoisRecords::Item::Host::HostRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
