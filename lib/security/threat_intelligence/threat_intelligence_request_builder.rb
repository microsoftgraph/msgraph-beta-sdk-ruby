        ...
        module ThreatIntelligence
            ...
            class ThreatIntelligenceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def host_ssl_certificates()
                    return MicrosoftGraphBeta::Security::ThreatIntelligence::HostSslCertificates::HostSslCertificatesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def ssl_certificates()
                    return MicrosoftGraphBeta::Security::ThreatIntelligence::SslCertificates::SslCertificatesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the subdomains property of the microsoft.graph.security.threatIntelligence entity.
                def subdomains()
                    return MicrosoftGraphBeta::Security::ThreatIntelligence::Subdomains::SubdomainsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                    error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SecurityThreatIntelligence.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
