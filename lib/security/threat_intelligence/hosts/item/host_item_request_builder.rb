...
require_relative './components/item/host_component_item_request_builder'
require_relative './cookies/cookies_request_builder'
require_relative './cookies/item/host_cookie_item_request_builder'
require_relative './item'
require_relative './passive_dns/item/passive_dns_record_item_request_builder'
require_relative './passive_dns/passive_dns_request_builder'
require_relative './passive_dns_reverse/item/passive_dns_record_item_request_builder'
...
require_relative './trackers/item/host_tracker_item_request_builder'
            ...
            module Hosts
                module Item
                    ...
                    class HostItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## 
                        def components_by_id(id)
                            raise StandardError, 'id cannot be null' if id.nil?
                            url_tpl_params = @path_parameters.clone
                            url_tpl_params["hostComponent%2Did"] = id
                            return MicrosoftGraphBeta::Security::ThreatIntelligence::Hosts::Item::Components::Item::HostComponentItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        ## 
                        def cookies_by_id(id)
                            raise StandardError, 'id cannot be null' if id.nil?
                            url_tpl_params = @path_parameters.clone
                            url_tpl_params["hostCookie%2Did"] = id
                            return MicrosoftGraphBeta::Security::ThreatIntelligence::Hosts::Item::Cookies::Item::HostCookieItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        ## 
                        def passive_dns_by_id(id)
                            raise StandardError, 'id cannot be null' if id.nil?
                            url_tpl_params = @path_parameters.clone
                            url_tpl_params["passiveDnsRecord%2Did"] = id
                            return MicrosoftGraphBeta::Security::ThreatIntelligence::Hosts::Item::PassiveDns::Item::PassiveDnsRecordItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the passiveDnsReverse property of the microsoft.graph.security.host entity.
                        ## @param id Unique identifier of the item
                        ## @return a passive_dns_record_item_request_builder
                        ## 
                        def passive_dns_reverse_by_id(id)
                            raise StandardError, 'id cannot be null' if id.nil?
                            url_tpl_params = @path_parameters.clone
                            url_tpl_params["passiveDnsRecord%2Did"] = id
