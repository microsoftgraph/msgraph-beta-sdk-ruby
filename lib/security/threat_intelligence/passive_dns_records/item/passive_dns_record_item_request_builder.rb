            ...
            module PassiveDnsRecords
                module Item
                    ...
                    class PassiveDnsRecordItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def artifact()
                            return MicrosoftGraphBeta::Security::ThreatIntelligence::PassiveDnsRecords::Item::Artifact::ArtifactRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the parentHost property of the microsoft.graph.security.passiveDnsRecord entity.
                        def parent_host()
                            return MicrosoftGraphBeta::Security::ThreatIntelligence::PassiveDnsRecords::Item::ParentHost::ParentHostRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
