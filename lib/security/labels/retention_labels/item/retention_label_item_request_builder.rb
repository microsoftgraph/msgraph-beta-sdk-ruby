            ...
            module RetentionLabels
                module Item
                    ...
                    class RetentionLabelItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def descriptors()
                            return MicrosoftGraphBeta::Security::Labels::RetentionLabels::Item::Descriptors::DescriptorsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}{?%24select,%24expand}")
                        end
                        ## 
