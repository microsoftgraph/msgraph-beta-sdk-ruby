                            ...
                            module LastEstimateStatisticsOperation
                                ...
                                class LastEstimateStatisticsOperationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def get(request_configuration=nil)
                                        ...
                                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SecurityEdiscoveryEstimateOperation.create_from_discriminator_value(pn) }, error_mapping)
                                    end
                                    ## 
                                    ## Get the last ediscoveryEstimateOperation objects and their properties.
                                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
