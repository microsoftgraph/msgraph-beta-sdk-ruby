                            ...
                            module SecurityPurgeData
                                class PurgeDataPostRequestBody
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            "purgeAreas" => lambda {|n| @purge_areas = n.get_enum_value(MicrosoftGraphBeta::Models::Security::PurgeAreas) },
                                            "purgeType" => lambda {|n| @purge_type = n.get_enum_value(MicrosoftGraphBeta::Models::Security::PurgeType) },
                                        }
                                    end
                                    ## 
