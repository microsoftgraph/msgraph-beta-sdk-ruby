                        ...
                        module Item
                            module MicrosoftGraphSecurityExportReport
                                class ExportReportPostRequestBody
                                    ...
                                    ## @return a export_report_post_request_body_additional_options
                                    ## 
                                    ...
                                    ## @return a export_report_post_request_body_export_criteria
                                    ## 
                                    def export_criteria
                                    ...
                                    ## @return a export_report_post_request_body_export_location
                                    ## 
                                    def export_location
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            "additionalOptions" => lambda {|n| @additional_options = n.get_enum_value(MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::MicrosoftGraphSecurityExportReport::ExportReportPostRequestBodyAdditionalOptions) },
                                            "description" => lambda {|n| @description = n.get_string_value() },
                                            "displayName" => lambda {|n| @display_name = n.get_string_value() },
                                            "exportCriteria" => lambda {|n| @export_criteria = n.get_enum_value(MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::MicrosoftGraphSecurityExportReport::ExportReportPostRequestBodyExportCriteria) },
                                            "exportLocation" => lambda {|n| @export_location = n.get_enum_value(MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::MicrosoftGraphSecurityExportReport::ExportReportPostRequestBodyExportLocation) },
                                        }
                                    end
                                    ## 
