                        ...
                        module Item
                            ...
                            class EdiscoverySearchItemRequestBuilder
                                ...
                                def security_estimate_statistics()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::SecurityEstimateStatistics::SecurityEstimateStatisticsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the purgeData method.
                                def security_purge_data()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::SecurityPurgeData::SecurityPurgeDataRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
