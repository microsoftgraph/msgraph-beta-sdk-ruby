...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item
    ...
    class EdiscoverySearchItemRequestBuilder
        ...
        def microsoft_graph_security_estimate_statistics()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::MicrosoftGraphSecurityEstimateStatistics::EstimateStatisticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the purgeData method.
        def microsoft_graph_security_purge_data()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::MicrosoftGraphSecurityPurgeData::PurgeDataRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
