                    ...
                    module Settings
                        ...
                        class SettingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def security_reset_to_default()
                                return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Settings::SecurityResetToDefault::SecurityResetToDefaultRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
