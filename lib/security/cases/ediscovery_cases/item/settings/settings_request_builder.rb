...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Settings
    ...
    class SettingsRequestBuilder
        ...
        def microsoft_graph_security_reset_to_default()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Settings::MicrosoftGraphSecurityResetToDefault::ResetToDefaultRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
