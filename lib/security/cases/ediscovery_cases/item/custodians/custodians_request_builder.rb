                ...
                module Item
                    module Custodians
                        ...
                        class CustodiansRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the applyHold method.
                            def security_apply_hold()
                                return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::SecurityApplyHold::SecurityApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the removeHold method.
                            def security_remove_hold()
                                return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::SecurityRemoveHold::SecurityRemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the custodians property of the microsoft.graph.security.ediscoveryCase entity.
                            ...
                            def get(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryCustodianCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ...
                            def post(body, request_configuration=nil)
                                ...
                                error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                                error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryCustodian.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Get a list of the custodian objects and their properties.
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
