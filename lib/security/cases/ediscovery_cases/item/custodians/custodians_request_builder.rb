                    ...
                    module Custodians
                        ...
                        class CustodiansRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def microsoft_graph_security_apply_hold()
                                return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::MicrosoftGraphSecurityApplyHold::MicrosoftGraphSecurityApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
