...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item
    ...
    class EdiscoveryCustodianItemRequestBuilder
        ...
        def microsoft_graph_security_activate()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::MicrosoftGraphSecurityActivate::ActivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyHold method.
        def microsoft_graph_security_apply_hold()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::MicrosoftGraphSecurityApplyHold::ApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the release method.
        def microsoft_graph_security_release()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::MicrosoftGraphSecurityRelease::ReleaseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeHold method.
        def microsoft_graph_security_remove_hold()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::MicrosoftGraphSecurityRemoveHold::RemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateIndex method.
        def microsoft_graph_security_update_index()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::MicrosoftGraphSecurityUpdateIndex::UpdateIndexRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
