                        ...
                        module Item
                            ...
                            class EdiscoveryCustodianItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def security_activate()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::SecurityActivate::SecurityActivateRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the applyHold method.
                                def security_apply_hold()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::SecurityApplyHold::SecurityApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the release method.
                                def security_release()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::SecurityRelease::SecurityReleaseRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the removeHold method.
                                def security_remove_hold()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::SecurityRemoveHold::SecurityRemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the updateIndex method.
                                def security_update_index()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::SecurityUpdateIndex::SecurityUpdateIndexRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
