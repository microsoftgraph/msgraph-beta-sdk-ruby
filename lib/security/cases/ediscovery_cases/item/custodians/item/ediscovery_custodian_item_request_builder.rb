...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item
    ## 
    ...
    class EdiscoveryCustodianItemRequestBuilder
        ...
        def last_index_operation()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::LastIndexOperation::LastIndexOperationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the activate method.
        def microsoft_graph_security_activate()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::MicrosoftGraphSecurityActivate::MicrosoftGraphSecurityActivateRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the applyHold method.
        def microsoft_graph_security_apply_hold()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::MicrosoftGraphSecurityApplyHold::MicrosoftGraphSecurityApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the release method.
        def microsoft_graph_security_release()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::MicrosoftGraphSecurityRelease::MicrosoftGraphSecurityReleaseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeHold method.
        def microsoft_graph_security_remove_hold()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::MicrosoftGraphSecurityRemoveHold::MicrosoftGraphSecurityRemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateIndex method.
        def microsoft_graph_security_update_index()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::MicrosoftGraphSecurityUpdateIndex::MicrosoftGraphSecurityUpdateIndexRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def site_sources()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::SiteSources::SiteSourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the unifiedGroupSources property of the microsoft.graph.security.ediscoveryCustodian entity.
        def unified_group_sources()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::UnifiedGroupSources::UnifiedGroupSourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user_sources()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::UserSources::UserSourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def site_sources_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::SiteSources::Item::SiteSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property custodians for security
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def unified_group_sources_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::UnifiedGroupSources::Item::UnifiedGroupSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the userSources property of the microsoft.graph.security.ediscoveryCustodian entity.
        ## @param id Unique identifier of the item
