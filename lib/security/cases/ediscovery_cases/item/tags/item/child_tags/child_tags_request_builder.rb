                            ...
                            module ChildTags
                                ...
                                class ChildTagsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def get(request_configuration=nil)
                                        ...
                                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SecurityEdiscoveryReviewTagCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                                    end
                                    ## 
                                    ## Returns the tags that are a child of a tag.
                                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
