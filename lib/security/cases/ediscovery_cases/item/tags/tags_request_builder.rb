                    ...
                    module Tags
                        ...
                        class TagsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def security_as_hierarchy()
                                return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Tags::SecurityAsHierarchy::SecurityAsHierarchyRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
