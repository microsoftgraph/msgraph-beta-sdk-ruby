                    ...
                    module Tags
                        ...
                        class TagsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def microsoft_graph_security_as_hierarchy()
                                return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Tags::MicrosoftGraphSecurityAsHierarchy::MicrosoftGraphSecurityAsHierarchyRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the tags property of the microsoft.graph.security.ediscoveryCase entity.
