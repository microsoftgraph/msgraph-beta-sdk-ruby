...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::LegalHolds::Item
    ## 
    ...
    class EdiscoveryHoldPolicyItemRequestBuilder
        ...
        ## @param ediscoveryHoldPolicyId key: id of ediscoveryHoldPolicy
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, ediscovery_hold_policy_id=nil)
