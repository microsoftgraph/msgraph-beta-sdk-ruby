...
require_relative './item'
require_relative './run/run_request_builder'
...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item
    ...
    class EdiscoveryReviewSetQueryItemRequestBuilder
        ...
        def apply_tags()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::ApplyTags::ApplyTagsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the export method.
        def export()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::Export::ExportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a run_request_builder
        ## 
        def run()
            return RunRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Delete navigation property queries for security
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
