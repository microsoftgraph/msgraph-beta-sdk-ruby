...
require_relative './security_export/security_export_request_builder'
require_relative './security_run/security_run_request_builder'
                                ...
                                module Item
                                    ...
                                    class EdiscoveryReviewSetQueryItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def security_apply_tags()
                                            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::SecurityApplyTags::SecurityApplyTagsRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the export method.
                                        def security_export()
                                            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::SecurityExport::SecurityExportRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the run method.
                                        def security_run()
                                            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::SecurityRun::SecurityRunRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
