...
require_relative './microsoft_graph_security_run/microsoft_graph_security_run_request_builder'

module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item
    ## 
    ...
    class EdiscoveryReviewSetQueryItemRequestBuilder
        ...
        def microsoft_graph_security_apply_tags()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::MicrosoftGraphSecurityApplyTags::MicrosoftGraphSecurityApplyTagsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the export method.
        def microsoft_graph_security_export()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::MicrosoftGraphSecurityExport::MicrosoftGraphSecurityExportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the run method.
        def microsoft_graph_security_run()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::MicrosoftGraphSecurityRun::MicrosoftGraphSecurityRunRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::EdiscoveryReviewSetQuery.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
