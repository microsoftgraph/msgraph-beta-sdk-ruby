...
require_relative './microsoft_graph_security_export/export_request_builder'
require_relative './microsoft_graph_security_run/run_request_builder'
...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item
    ...
    class EdiscoveryReviewSetQueryItemRequestBuilder
        ...
        def microsoft_graph_security_apply_tags()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::MicrosoftGraphSecurityApplyTags::ApplyTagsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the export method.
        def microsoft_graph_security_export()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::MicrosoftGraphSecurityExport::ExportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the run method.
        def microsoft_graph_security_run()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries::Item::MicrosoftGraphSecurityRun::RunRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
