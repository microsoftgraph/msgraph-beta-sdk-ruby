                            ...
                            module MicrosoftGraphSecurityAddToReviewSet
                                class AddToReviewSetPostRequestBody
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            "additionalDataOptions" => lambda {|n| @additional_data_options = n.get_enum_value(MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::MicrosoftGraphSecurityAddToReviewSet::AddToReviewSetPostRequestBodyAdditionalDataOptions) },
