                                ...
                                module Item
                                    module Tags
                                        ...
                                        class TagsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def count()
                                                return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Files::Item::Tags::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ## Provides operations to manage the tags property of the microsoft.graph.security.ediscoveryFile entity.
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/files/{ediscoveryFile%2Did}/tags{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                                            end
                                            ## 
