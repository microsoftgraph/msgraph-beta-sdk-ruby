                        ...
                        module Item
                            ...
                            class EdiscoveryReviewSetItemRequestBuilder
                                ...
                                def security_add_to_review_set()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::SecurityAddToReviewSet::SecurityAddToReviewSetRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the export method.
                                def security_export()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::SecurityExport::SecurityExportRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
