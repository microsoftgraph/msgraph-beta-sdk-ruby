                        ...
                        module Item
                            ...
                            class EdiscoveryNoncustodialDataSourceItemRequestBuilder
                                ...
                                def microsoft_graph_security_apply_hold()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::MicrosoftGraphSecurityApplyHold::MicrosoftGraphSecurityApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the release method.
                                def microsoft_graph_security_release()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::MicrosoftGraphSecurityRelease::MicrosoftGraphSecurityReleaseRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the removeHold method.
                                def microsoft_graph_security_remove_hold()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::MicrosoftGraphSecurityRemoveHold::MicrosoftGraphSecurityRemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the updateIndex method.
                                def microsoft_graph_security_update_index()
                                    return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::MicrosoftGraphSecurityUpdateIndex::MicrosoftGraphSecurityUpdateIndexRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
