...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item
    ...
    class EdiscoveryCaseItemRequestBuilder
        ...
        def close()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Close::CloseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reopen()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Reopen::ReopenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
