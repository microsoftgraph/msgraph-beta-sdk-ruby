...
require_relative './legal_holds/item/ediscovery_hold_policy_item_request_builder'
...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item
    ## 
    ...
    class EdiscoveryCaseItemRequestBuilder
        ...
        def microsoft_graph_security_close()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::MicrosoftGraphSecurityClose::MicrosoftGraphSecurityCloseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reopen method.
        def microsoft_graph_security_reopen()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::MicrosoftGraphSecurityReopen::MicrosoftGraphSecurityReopenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def custodians_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Custodians::Item::EdiscoveryCustodianItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        ## Provides operations to manage the legalHolds property of the microsoft.graph.security.ediscoveryCase entity.
        ## @param id Unique identifier of the item
        ## @return a ediscovery_hold_policy_item_request_builder
        ## 
        def legal_holds_by_id(id)
            raise StandardError, 'id cannot be null' if id.nil?
            url_tpl_params = @path_parameters.clone
            url_tpl_params["ediscoveryHoldPolicy%2Did"] = id
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::LegalHolds::Item::EdiscoveryHoldPolicyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the noncustodialDataSources property of the microsoft.graph.security.ediscoveryCase entity.
        ## @param id Unique identifier of the item
        ...
        def noncustodial_data_sources_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::EdiscoveryNoncustodialDataSourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.security.ediscoveryCase entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Operations::Item::CaseOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def review_sets_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::EdiscoveryReviewSetItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the searches property of the microsoft.graph.security.ediscoveryCase entity.
        ## @param id Unique identifier of the item
        ...
        def searches_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Searches::Item::EdiscoverySearchItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tags property of the microsoft.graph.security.ediscoveryCase entity.
        ## @param id Unique identifier of the item
        ...
        def tags_by_id(id)
            ...
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::Tags::Item::EdiscoveryReviewTagItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property ediscoveryCases for security
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
