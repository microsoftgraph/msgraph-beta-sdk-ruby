...
module MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item
    ...
    class EdiscoveryCaseItemRequestBuilder
        ...
        def microsoft_graph_security_close()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::MicrosoftGraphSecurityClose::CloseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reopen method.
        def microsoft_graph_security_reopen()
            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::MicrosoftGraphSecurityReopen::ReopenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
