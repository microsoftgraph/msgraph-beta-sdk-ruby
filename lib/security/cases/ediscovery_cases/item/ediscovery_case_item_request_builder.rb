...
require_relative './case_members/case_members_request_builder'
            ...
            module EdiscoveryCases
                module Item
                    ...
                    class EdiscoveryCaseItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def case_members()
                            return MicrosoftGraphBeta::Security::Cases::EdiscoveryCases::Item::CaseMembers::CaseMembersRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraphBeta::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SecurityEdiscoveryCase.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
