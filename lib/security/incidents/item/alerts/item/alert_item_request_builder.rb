...
module MicrosoftGraphBeta::Security::Incidents::Item::Alerts::Item
    ## 
    ...
    class AlertItemRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::Security::Alert.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## The list of related alerts. Supports $expand.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
