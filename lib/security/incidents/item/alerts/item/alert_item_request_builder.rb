                ...
                module Alerts
                    module Item
                        ...
                        class AlertItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def comments()
                                return MicrosoftGraphBeta::Security::Incidents::Item::Alerts::Item::Comments::CommentsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def get(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraphBeta::Models::SecurityAlert.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## The list of related alerts. Supports $expand.
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
