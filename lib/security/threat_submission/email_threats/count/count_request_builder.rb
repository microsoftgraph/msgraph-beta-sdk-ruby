...
module MicrosoftGraphBeta::Security::ThreatSubmission::EmailThreats::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/threatSubmission/emailThreats/$count{?%24search,%24filter}"
