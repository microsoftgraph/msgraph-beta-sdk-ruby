...
module MicrosoftGraphBeta::Security::ThreatSubmission::FileThreats::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/threatSubmission/fileThreats/$count{?%24search,%24filter}"
