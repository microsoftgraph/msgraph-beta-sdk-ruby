...
module MicrosoftGraphBeta::Security::Triggers::RetentionEvents::Item
    ## 
    ...
    class RetentionEventItemRequestBuilder
        ...
        def retention_event_type()
            return MicrosoftGraphBeta::Security::Triggers::RetentionEvents::Item::RetentionEventType::RetentionEventTypeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param retentionEventId key: id of retentionEvent
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, retention_event_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/security/triggers/retentionEvents/{retentionEvent%2Did}{?%24select,%24expand}"
