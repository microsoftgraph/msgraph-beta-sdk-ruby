                    ...
                    module Item
                        ...
                        class PrivilegedRoleAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/assignments/{privilegedRoleAssignment%2Did}{?%24select,%24expand}")
                            end
                            ## 
