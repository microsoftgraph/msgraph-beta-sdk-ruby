        ...
        module Item
            module RoleInfo
                ...
                class RoleInfoRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def self_activate()
                        return MicrosoftGraphBeta::PrivilegedRoleAssignmentRequests::Item::RoleInfo::SelfActivate::SelfActivateRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the selfDeactivate method.
                    def self_deactivate()
                        return MicrosoftGraphBeta::PrivilegedRoleAssignmentRequests::Item::RoleInfo::SelfDeactivate::SelfDeactivateRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo'
