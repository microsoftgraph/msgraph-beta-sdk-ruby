...
module MicrosoftGraphBeta
    module PrivilegedRoleAssignmentRequests
        module Item
            ...
            class PrivilegedRoleAssignmentRequestItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to call the cancel method.
                def cancel()
                    return MicrosoftGraphBeta::PrivilegedRoleAssignmentRequests::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the roleInfo property of the microsoft.graph.privilegedRoleAssignmentRequest entity.
                def role_info()
                    return MicrosoftGraphBeta::PrivilegedRoleAssignmentRequests::Item::RoleInfo::RoleInfoRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}'
                ...
                def with_url(raw_url)
                    ...
                    return PrivilegedRoleAssignmentRequestItemRequestBuilder.new(raw_url, @request_adapter)
                end
