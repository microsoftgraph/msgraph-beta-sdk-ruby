...
module MicrosoftGraphBeta::PrivilegedRoleAssignmentRequests::Item
    ...
    class PrivilegedRoleAssignmentRequestItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraphBeta::PrivilegedRoleAssignmentRequests::Item::MicrosoftGraphCancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @param privilegedRoleAssignmentRequestId key: id of privilegedRoleAssignmentRequest
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, privileged_role_assignment_request_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}{?%24select,%24expand}"
